...
The repository contains both `Nim` and `C` code - see [`seaqt`](https://github.com/seaqt/seaqt) for a `C` version that can be used stand-alone or as a base for other languages.
...
| 6.5+       | https://github.com/seaqt/nim-seaqt/tree/qt-6.5  |
| 6.8+       | https://github.com/seaqt/nim-seaqt/tree/qt-6.8  |
| 6.11+      | https://github.com/seaqt/nim-seaqt/tree/qt-6.11 |
