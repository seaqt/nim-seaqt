...
{.compile("gen_qwebhistoryinterface.cpp", QtWebKitCFlags).}
...
type cQWebHistoryInterfaceVTable {.pure.} = object
  ...
  historyContains*: proc(self: pointer, url: struct_seaqt_string): bool {.cdecl, raises: [], gcsafe.}
  addHistoryEntry*: proc(self: pointer, url: struct_seaqt_string): void {.cdecl, raises: [], gcsafe.}
...
proc historyContains*(self: gen_qwebhistoryinterface_types.QWebHistoryInterface, url: openArray[char]): bool =
  fcQWebHistoryInterface_historyContains(self.h, struct_seaqt_string(data: if len(url) > 0: addr url[0] else: nil, len: csize_t(len(url))))
...
proc fcQWebHistoryInterface_vtable_callback_historyContains(self: pointer, url: struct_seaqt_string): bool {.cdecl.} =
  let vtbl = cast[ptr QWebHistoryInterfaceVTable](fcQWebHistoryInterface_vdata(self)[])
  let self = QWebHistoryInterface(h: self)
  let vurl_ms = url
...
proc fcQWebHistoryInterface_vtable_callback_addHistoryEntry(self: pointer, url: struct_seaqt_string): void {.cdecl.} =
  let vtbl = cast[ptr QWebHistoryInterfaceVTable](fcQWebHistoryInterface_vdata(self)[])
  let self = QWebHistoryInterface(h: self)
  let vurl_ms = url
  let vurlx_ret = string.fromBytes(vurl_ms)
...
proc fcQWebHistoryInterface_method_callback_historyContains(self: pointer, url: struct_seaqt_string): bool {.cdecl.} =
  let inst = cast[VirtualQWebHistoryInterface](fcQWebHistoryInterface_vdata(self)[])
  let vurl_ms = url
  let vurlx_ret = string.fromBytes(vurl_ms)
  c_free(vurl_ms.data)
...
proc fcQWebHistoryInterface_method_callback_addHistoryEntry(self: pointer, url: struct_seaqt_string): void {.cdecl.} =
  let inst = cast[VirtualQWebHistoryInterface](fcQWebHistoryInterface_vdata(self)[])
  let vurl_ms = url
  let vurlx_ret = string.fromBytes(vurl_ms)
  c_free(vurl_ms.data)
...
proc create*(T: type gen_qwebhistoryinterface_types.QWebHistoryInterface,
  ...
  let tmp = gen_qwebhistoryinterface_types.QWebHistoryInterface(h: fcQWebHistoryInterface_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQWebHistoryInterface_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qwebhistoryinterface_types.QWebHistoryInterface,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQWebHistoryInterface_vtable_callback_disconnectNotify
  let tmp = gen_qwebhistoryinterface_types.QWebHistoryInterface(h: fcQWebHistoryInterface_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQWebHistoryInterface_vdata(tmp.h)[] = addr(vtbl[])
  tmp
...
proc create*(T: type gen_qwebhistoryinterface_types.QWebHistoryInterface,
  ...
  inst[].h = fcQWebHistoryInterface_new(addr(cQWebHistoryInterface_mvtbl), csize_t(sizeof(pointer)))
  fcQWebHistoryInterface_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qwebhistoryinterface_types.QWebHistoryInterface,
    ...
    inst: VirtualQWebHistoryInterface) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQWebHistoryInterface_new2(addr(cQWebHistoryInterface_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQWebHistoryInterface_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
