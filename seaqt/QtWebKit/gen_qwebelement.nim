...
proc fcQWebElement_findAll(self: pointer, selectorQuery: struct_seaqt_string): pointer {.importc: "QWebElement_findAll".}
proc fcQWebElement_findFirst(self: pointer, selectorQuery: struct_seaqt_string): pointer {.importc: "QWebElement_findFirst".}
proc fcQWebElement_setPlainText(self: pointer, text: struct_seaqt_string): void {.importc: "QWebElement_setPlainText".}
proc fcQWebElement_toPlainText(self: pointer): struct_seaqt_string {.importc: "QWebElement_toPlainText".}
proc fcQWebElement_setOuterXml(self: pointer, markup: struct_seaqt_string): void {.importc: "QWebElement_setOuterXml".}
proc fcQWebElement_toOuterXml(self: pointer): struct_seaqt_string {.importc: "QWebElement_toOuterXml".}
proc fcQWebElement_setInnerXml(self: pointer, markup: struct_seaqt_string): void {.importc: "QWebElement_setInnerXml".}
...
proc fcQWebElement_removeAttributeNS(self: pointer, namespaceUri: struct_seaqt_string, name: struct_seaqt_string): void {.importc: "QWebElement_removeAttributeNS".}
proc fcQWebElement_hasAttributes(self: pointer): bool {.importc: "QWebElement_hasAttributes".}
proc fcQWebElement_attributeNames(self: pointer): struct_seaqt_array {.importc: "QWebElement_attributeNames".}
proc fcQWebElement_classes(self: pointer): struct_seaqt_array {.importc: "QWebElement_classes".}
proc fcQWebElement_hasClass(self: pointer, name: struct_seaqt_string): bool {.importc: "QWebElement_hasClass".}
proc fcQWebElement_addClass(self: pointer, name: struct_seaqt_string): void {.importc: "QWebElement_addClass".}
proc fcQWebElement_removeClass(self: pointer, name: struct_seaqt_string): void {.importc: "QWebElement_removeClass".}
proc fcQWebElement_toggleClass(self: pointer, name: struct_seaqt_string): void {.importc: "QWebElement_toggleClass".}
...
proc fcQWebElement_tagName(self: pointer): struct_seaqt_string {.importc: "QWebElement_tagName".}
proc fcQWebElement_prefix(self: pointer): struct_seaqt_string {.importc: "QWebElement_prefix".}
proc fcQWebElement_localName(self: pointer): struct_seaqt_string {.importc: "QWebElement_localName".}
proc fcQWebElement_namespaceUri(self: pointer): struct_seaqt_string {.importc: "QWebElement_namespaceUri".}
...
proc findAll*(self: gen_qwebelement_types.QWebElement, selectorQuery: openArray[char]): gen_qwebelement_types.QWebElementCollection =
  gen_qwebelement_types.QWebElementCollection(h: fcQWebElement_findAll(self.h, struct_seaqt_string(data: if len(selectorQuery) > 0: addr selectorQuery[0] else: nil, len: csize_t(len(selectorQuery)))))

proc findFirst*(self: gen_qwebelement_types.QWebElement, selectorQuery: openArray[char]): gen_qwebelement_types.QWebElement =
  gen_qwebelement_types.QWebElement(h: fcQWebElement_findFirst(self.h, struct_seaqt_string(data: if len(selectorQuery) > 0: addr selectorQuery[0] else: nil, len: csize_t(len(selectorQuery)))))

proc setPlainText*(self: gen_qwebelement_types.QWebElement, text: openArray[char]): void =
  fcQWebElement_setPlainText(self.h, struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))))
...
proc setOuterXml*(self: gen_qwebelement_types.QWebElement, markup: openArray[char]): void =
  fcQWebElement_setOuterXml(self.h, struct_seaqt_string(data: if len(markup) > 0: addr markup[0] else: nil, len: csize_t(len(markup))))
...
proc setInnerXml*(self: gen_qwebelement_types.QWebElement, markup: openArray[char]): void =
  fcQWebElement_setInnerXml(self.h, struct_seaqt_string(data: if len(markup) > 0: addr markup[0] else: nil, len: csize_t(len(markup))))
...
proc setAttribute*(self: gen_qwebelement_types.QWebElement, name: openArray[char], value: openArray[char]): void =
  fcQWebElement_setAttribute(self.h, struct_seaqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name))), struct_seaqt_string(data: if len(value) > 0: addr value[0] else: nil, len: csize_t(len(value))))
...
proc hasAttribute*(self: gen_qwebelement_types.QWebElement, name: openArray[char]): bool =
  fcQWebElement_hasAttribute(self.h, struct_seaqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name))))

proc hasAttributeNS*(self: gen_qwebelement_types.QWebElement, namespaceUri: openArray[char], name: openArray[char]): bool =
  fcQWebElement_hasAttributeNS(self.h, struct_seaqt_string(data: if len(namespaceUri) > 0: addr namespaceUri[0] else: nil, len: csize_t(len(namespaceUri))), struct_seaqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name))))

proc removeAttribute*(self: gen_qwebelement_types.QWebElement, name: openArray[char]): void =
  fcQWebElement_removeAttribute(self.h, struct_seaqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name))))

proc removeAttributeNS*(self: gen_qwebelement_types.QWebElement, namespaceUri: openArray[char], name: openArray[char]): void =
  fcQWebElement_removeAttributeNS(self.h, struct_seaqt_string(data: if len(namespaceUri) > 0: addr namespaceUri[0] else: nil, len: csize_t(len(namespaceUri))), struct_seaqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name))))
...
proc hasClass*(self: gen_qwebelement_types.QWebElement, name: openArray[char]): bool =
  fcQWebElement_hasClass(self.h, struct_seaqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name))))

proc addClass*(self: gen_qwebelement_types.QWebElement, name: openArray[char]): void =
  fcQWebElement_addClass(self.h, struct_seaqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name))))

proc removeClass*(self: gen_qwebelement_types.QWebElement, name: openArray[char]): void =
  fcQWebElement_removeClass(self.h, struct_seaqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name))))

proc toggleClass*(self: gen_qwebelement_types.QWebElement, name: openArray[char]): void =
  fcQWebElement_toggleClass(self.h, struct_seaqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name))))
...
proc evaluateJavaScript*(self: gen_qwebelement_types.QWebElement, scriptSource: openArray[char]): gen_qvariant_types.QVariant =
  gen_qvariant_types.QVariant(h: fcQWebElement_evaluateJavaScript(self.h, struct_seaqt_string(data: if len(scriptSource) > 0: addr scriptSource[0] else: nil, len: csize_t(len(scriptSource)))))

proc styleProperty*(self: gen_qwebelement_types.QWebElement, name: openArray[char], strategy: cint): string =
  let v_ms = fcQWebElement_styleProperty(self.h, struct_seaqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name))), cint(strategy))
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc create*(T: type gen_qwebelement_types.QWebElement): gen_qwebelement_types.QWebElement =
  let tmp = gen_qwebelement_types.QWebElement(h: fcQWebElement_new())
  tmp
proc create*(T: type gen_qwebelement_types.QWebElement,
  ...
  let tmp = gen_qwebelement_types.QWebElement(h: fcQWebElement_new2(param1.h))
  tmp
...
proc create*(T: type gen_qwebelement_types.QWebElementCollection): gen_qwebelement_types.QWebElementCollection =
  let tmp = gen_qwebelement_types.QWebElementCollection(h: fcQWebElementCollection_new())
  tmp
proc create*(T: type gen_qwebelement_types.QWebElementCollection,
  ...
  let tmp = gen_qwebelement_types.QWebElementCollection(h: fcQWebElementCollection_new2(contextElement.h, struct_seaqt_string(data: if len(query) > 0: addr query[0] else: nil, len: csize_t(len(query)))))
  tmp
proc create*(T: type gen_qwebelement_types.QWebElementCollection,
    param1: gen_qwebelement_types.QWebElementCollection): gen_qwebelement_types.QWebElementCollection =
  let tmp = gen_qwebelement_types.QWebElementCollection(h: fcQWebElementCollection_new3(param1.h))
  tmp
...
proc create*(T: type gen_qwebelement_types.QWebElementCollectionconst_iterator,
  ...
  let tmp = gen_qwebelement_types.QWebElementCollectionconst_iterator(h: fcQWebElementCollectionconst_iterator_new(collection_x.h, index))
  tmp
proc create*(T: type gen_qwebelement_types.QWebElementCollectionconst_iterator,
    o: gen_qwebelement_types.QWebElementCollectionconst_iterator): gen_qwebelement_types.QWebElementCollectionconst_iterator =
  let tmp = gen_qwebelement_types.QWebElementCollectionconst_iterator(h: fcQWebElementCollectionconst_iterator_new2(o.h))
  tmp
...
proc create*(T: type gen_qwebelement_types.QWebElementCollectioniterator,
  ...
  let tmp = gen_qwebelement_types.QWebElementCollectioniterator(h: fcQWebElementCollectioniterator_new(collection_x.h, index))
  tmp
proc create*(T: type gen_qwebelement_types.QWebElementCollectioniterator,
    o: gen_qwebelement_types.QWebElementCollectioniterator): gen_qwebelement_types.QWebElementCollectioniterator =
  let tmp = gen_qwebelement_types.QWebElementCollectioniterator(h: fcQWebElementCollectioniterator_new2(o.h))
  tmp
