...
{.compile("gen_qwebsettings.cpp", QtWebKitCFlags).}
...
proc fcQWebSettings_setFontFamily(self: pointer, which: cint, family: struct_seaqt_string): void {.importc: "QWebSettings_setFontFamily".}
proc fcQWebSettings_fontFamily(self: pointer, which: cint): struct_seaqt_string {.importc: "QWebSettings_fontFamily".}
...
proc fcQWebSettings_setDefaultTextEncoding(self: pointer, encoding: struct_seaqt_string): void {.importc: "QWebSettings_setDefaultTextEncoding".}
proc fcQWebSettings_defaultTextEncoding(self: pointer): struct_seaqt_string {.importc: "QWebSettings_defaultTextEncoding".}
proc fcQWebSettings_setIconDatabasePath(location: struct_seaqt_string): void {.importc: "QWebSettings_setIconDatabasePath".}
proc fcQWebSettings_iconDatabasePath(): struct_seaqt_string {.importc: "QWebSettings_iconDatabasePath".}
...
proc fcQWebSettings_setPluginSearchPaths(paths: struct_seaqt_array): void {.importc: "QWebSettings_setPluginSearchPaths".}
proc fcQWebSettings_pluginSearchPaths(): struct_seaqt_array {.importc: "QWebSettings_pluginSearchPaths".}
...
proc fcQWebSettings_setOfflineStoragePath(path: struct_seaqt_string): void {.importc: "QWebSettings_setOfflineStoragePath".}
proc fcQWebSettings_offlineStoragePath(): struct_seaqt_string {.importc: "QWebSettings_offlineStoragePath".}
...
proc fcQWebSettings_setOfflineWebApplicationCachePath(path: struct_seaqt_string): void {.importc: "QWebSettings_setOfflineWebApplicationCachePath".}
proc fcQWebSettings_offlineWebApplicationCachePath(): struct_seaqt_string {.importc: "QWebSettings_offlineWebApplicationCachePath".}
...
proc fcQWebSettings_setLocalStoragePath(self: pointer, path: struct_seaqt_string): void {.importc: "QWebSettings_setLocalStoragePath".}
proc fcQWebSettings_localStoragePath(self: pointer): struct_seaqt_string {.importc: "QWebSettings_localStoragePath".}
...
proc setIconDatabasePath*(_: type gen_qwebsettings_types.QWebSettings, location: openArray[char]): void =
  fcQWebSettings_setIconDatabasePath(struct_seaqt_string(data: if len(location) > 0: addr location[0] else: nil, len: csize_t(len(location))))
...
proc setPluginSearchPaths*(_: type gen_qwebsettings_types.QWebSettings, paths: openArray[string]): void =
  ...
  fcQWebSettings_setPluginSearchPaths(struct_seaqt_array(len: csize_t(len(paths)), data: if len(paths) == 0: nil else: addr(paths_CArray[0])))
...
proc setOfflineStoragePath*(_: type gen_qwebsettings_types.QWebSettings, path: openArray[char]): void =
  fcQWebSettings_setOfflineStoragePath(struct_seaqt_string(data: if len(path) > 0: addr path[0] else: nil, len: csize_t(len(path))))
...
proc setOfflineWebApplicationCachePath*(_: type gen_qwebsettings_types.QWebSettings, path: openArray[char]): void =
  fcQWebSettings_setOfflineWebApplicationCachePath(struct_seaqt_string(data: if len(path) > 0: addr path[0] else: nil, len: csize_t(len(path))))
...
proc setLocalStoragePath*(self: gen_qwebsettings_types.QWebSettings, path: openArray[char]): void =
  fcQWebSettings_setLocalStoragePath(self.h, struct_seaqt_string(data: if len(path) > 0: addr path[0] else: nil, len: csize_t(len(path))))
...
proc setCSSMediaType*(self: gen_qwebsettings_types.QWebSettings, cSSMediaType: openArray[char]): void =
  fcQWebSettings_setCSSMediaType(self.h, struct_seaqt_string(data: if len(cSSMediaType) > 0: addr cSSMediaType[0] else: nil, len: csize_t(len(cSSMediaType))))
