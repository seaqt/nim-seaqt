...
import
  ...
  ./gen_qwebsockethandshakeoptions_types
export
...
proc fcQWebSocket_handshakeOptions(self: pointer): pointer {.importc: "QWebSocket_handshakeOptions".}
proc fcQWebSocket_origin(self: pointer): struct_seaqt_string {.importc: "QWebSocket_origin".}
proc fcQWebSocket_subprotocol(self: pointer): struct_seaqt_string {.importc: "QWebSocket_subprotocol".}
...
proc fcQWebSocket_continueInterruptedHandshake(self: pointer): void {.importc: "QWebSocket_continueInterruptedHandshake".}
...
proc fcQWebSocket_openUrlOptions(self: pointer, url: pointer, options: pointer): void {.importc: "QWebSocket_open_url_options".}
proc fcQWebSocket_openRequestOptions(self: pointer, request: pointer, options: pointer): void {.importc: "QWebSocket_open_request_options".}
...
proc fcQWebSocket_authenticationRequired(self: pointer, authenticator: pointer): void {.importc: "QWebSocket_authenticationRequired".}
proc fcQWebSocket_connect_authenticationRequired(self: pointer, slot: int, callback: proc (slot: int, authenticator: pointer) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QWebSocket_connect_authenticationRequired".}
...
proc fcQWebSocket_errorOccurred(self: pointer, error: cint): void {.importc: "QWebSocket_errorOccurred".}
proc fcQWebSocket_connect_errorOccurred(self: pointer, slot: int, callback: proc (slot: int, error: cint) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QWebSocket_connect_errorOccurred".}
...
proc fcQWebSocket_peerVerifyError(self: pointer, error: pointer): void {.importc: "QWebSocket_peerVerifyError".}
proc fcQWebSocket_connect_peerVerifyError(self: pointer, slot: int, callback: proc (slot: int, error: pointer) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QWebSocket_connect_peerVerifyError".}
...
proc fcQWebSocket_alertSent(self: pointer, level: cint, typeVal: cint, description: struct_seaqt_string): void {.importc: "QWebSocket_alertSent".}
proc fcQWebSocket_connect_alertSent(self: pointer, slot: int, callback: proc (slot: int, level: cint, typeVal: cint, description: struct_seaqt_string) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QWebSocket_connect_alertSent".}
proc fcQWebSocket_alertReceived(self: pointer, level: cint, typeVal: cint, description: struct_seaqt_string): void {.importc: "QWebSocket_alertReceived".}
proc fcQWebSocket_connect_alertReceived(self: pointer, slot: int, callback: proc (slot: int, level: cint, typeVal: cint, description: struct_seaqt_string) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QWebSocket_connect_alertReceived".}
proc fcQWebSocket_handshakeInterruptedOnError(self: pointer, error: pointer): void {.importc: "QWebSocket_handshakeInterruptedOnError".}
proc fcQWebSocket_connect_handshakeInterruptedOnError(self: pointer, slot: int, callback: proc (slot: int, error: pointer) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QWebSocket_connect_handshakeInterruptedOnError".}
...
proc handshakeOptions*(self: gen_qwebsocket_types.QWebSocket): gen_qwebsockethandshakeoptions_types.QWebSocketHandshakeOptions =
  gen_qwebsockethandshakeoptions_types.QWebSocketHandshakeOptions(h: fcQWebSocket_handshakeOptions(self.h), owned: true)
...
proc subprotocol*(self: gen_qwebsocket_types.QWebSocket): string =
  let v_ms = fcQWebSocket_subprotocol(self.h)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc continueInterruptedHandshake*(self: gen_qwebsocket_types.QWebSocket): void =
  fcQWebSocket_continueInterruptedHandshake(self.h)
...
proc open*(self: gen_qwebsocket_types.QWebSocket, url: gen_qurl_types.QUrl, options: gen_qwebsockethandshakeoptions_types.QWebSocketHandshakeOptions): void =
  fcQWebSocket_openUrlOptions(self.h, url.h, options.h)

proc open*(self: gen_qwebsocket_types.QWebSocket, request: gen_qnetworkrequest_types.QNetworkRequest, options: gen_qwebsockethandshakeoptions_types.QWebSocketHandshakeOptions): void =
  fcQWebSocket_openRequestOptions(self.h, request.h, options.h)
...
proc authenticationRequired*(self: gen_qwebsocket_types.QWebSocket, authenticator: gen_qauthenticator_types.QAuthenticator): void =
  fcQWebSocket_authenticationRequired(self.h, authenticator.h)

type QWebSocketauthenticationRequiredSlot* = proc(authenticator: gen_qauthenticator_types.QAuthenticator)
proc fcQWebSocket_slot_callback_authenticationRequired(slot: int, authenticator: pointer) {.cdecl.} =
  let nimfunc = cast[ptr QWebSocketauthenticationRequiredSlot](cast[pointer](slot))
  let slotval1 = gen_qauthenticator_types.QAuthenticator(h: authenticator, owned: false)

  nimfunc[](slotval1)

proc fcQWebSocket_slot_callback_authenticationRequired_release(slot: int) {.cdecl.} =
  let nimfunc = cast[ref QWebSocketauthenticationRequiredSlot](cast[pointer](slot))
  GC_unref(nimfunc)

proc onAuthenticationRequired*(self: gen_qwebsocket_types.QWebSocket, slot: QWebSocketauthenticationRequiredSlot) =
  var tmp = new QWebSocketauthenticationRequiredSlot
  tmp[] = slot
  GC_ref(tmp)
  fcQWebSocket_connect_authenticationRequired(self.h, cast[int](addr tmp[]), fcQWebSocket_slot_callback_authenticationRequired, fcQWebSocket_slot_callback_authenticationRequired_release)
...
proc errorOccurred*(self: gen_qwebsocket_types.QWebSocket, error: cint): void =
  fcQWebSocket_errorOccurred(self.h, cint(error))

type QWebSocketerrorOccurredSlot* = proc(error: cint)
proc fcQWebSocket_slot_callback_errorOccurred(slot: int, error: cint) {.cdecl.} =
  let nimfunc = cast[ptr QWebSocketerrorOccurredSlot](cast[pointer](slot))
  let slotval1 = cint(error)

  nimfunc[](slotval1)

proc fcQWebSocket_slot_callback_errorOccurred_release(slot: int) {.cdecl.} =
  let nimfunc = cast[ref QWebSocketerrorOccurredSlot](cast[pointer](slot))
  GC_unref(nimfunc)

proc onErrorOccurred*(self: gen_qwebsocket_types.QWebSocket, slot: QWebSocketerrorOccurredSlot) =
  var tmp = new QWebSocketerrorOccurredSlot
  tmp[] = slot
  GC_ref(tmp)
  fcQWebSocket_connect_errorOccurred(self.h, cast[int](addr tmp[]), fcQWebSocket_slot_callback_errorOccurred, fcQWebSocket_slot_callback_errorOccurred_release)
...
proc peerVerifyError*(self: gen_qwebsocket_types.QWebSocket, error: gen_qsslerror_types.QSslError): void =
  fcQWebSocket_peerVerifyError(self.h, error.h)

type QWebSocketpeerVerifyErrorSlot* = proc(error: gen_qsslerror_types.QSslError)
proc fcQWebSocket_slot_callback_peerVerifyError(slot: int, error: pointer) {.cdecl.} =
  let nimfunc = cast[ptr QWebSocketpeerVerifyErrorSlot](cast[pointer](slot))
  let slotval1 = gen_qsslerror_types.QSslError(h: error, owned: false)

  nimfunc[](slotval1)

proc fcQWebSocket_slot_callback_peerVerifyError_release(slot: int) {.cdecl.} =
  let nimfunc = cast[ref QWebSocketpeerVerifyErrorSlot](cast[pointer](slot))
  GC_unref(nimfunc)

proc onPeerVerifyError*(self: gen_qwebsocket_types.QWebSocket, slot: QWebSocketpeerVerifyErrorSlot) =
  var tmp = new QWebSocketpeerVerifyErrorSlot
  tmp[] = slot
  GC_ref(tmp)
  fcQWebSocket_connect_peerVerifyError(self.h, cast[int](addr tmp[]), fcQWebSocket_slot_callback_peerVerifyError, fcQWebSocket_slot_callback_peerVerifyError_release)
...
proc alertSent*(self: gen_qwebsocket_types.QWebSocket, level: cint, typeVal: cint, description: openArray[char]): void =
  fcQWebSocket_alertSent(self.h, cint(level), cint(typeVal), struct_seaqt_string(data: if len(description) > 0: addr description[0] else: nil, len: csize_t(len(description))))

type QWebSocketalertSentSlot* = proc(level: cint, typeVal: cint, description: openArray[char])
proc fcQWebSocket_slot_callback_alertSent(slot: int, level: cint, typeVal: cint, description: struct_seaqt_string) {.cdecl.} =
  let nimfunc = cast[ptr QWebSocketalertSentSlot](cast[pointer](slot))
...
proc fcQWebSocket_slot_callback_alertSent_release(slot: int) {.cdecl.} =
  let nimfunc = cast[ref QWebSocketalertSentSlot](cast[pointer](slot))
  GC_unref(nimfunc)

proc onAlertSent*(self: gen_qwebsocket_types.QWebSocket, slot: QWebSocketalertSentSlot) =
  var tmp = new QWebSocketalertSentSlot
  tmp[] = slot
  GC_ref(tmp)
  fcQWebSocket_connect_alertSent(self.h, cast[int](addr tmp[]), fcQWebSocket_slot_callback_alertSent, fcQWebSocket_slot_callback_alertSent_release)

proc alertReceived*(self: gen_qwebsocket_types.QWebSocket, level: cint, typeVal: cint, description: openArray[char]): void =
  fcQWebSocket_alertReceived(self.h, cint(level), cint(typeVal), struct_seaqt_string(data: if len(description) > 0: addr description[0] else: nil, len: csize_t(len(description))))

type QWebSocketalertReceivedSlot* = proc(level: cint, typeVal: cint, description: openArray[char])
proc fcQWebSocket_slot_callback_alertReceived(slot: int, level: cint, typeVal: cint, description: struct_seaqt_string) {.cdecl.} =
  let nimfunc = cast[ptr QWebSocketalertReceivedSlot](cast[pointer](slot))
  let slotval1 = cint(level)
...
proc fcQWebSocket_slot_callback_alertReceived_release(slot: int) {.cdecl.} =
  let nimfunc = cast[ref QWebSocketalertReceivedSlot](cast[pointer](slot))
  GC_unref(nimfunc)

proc onAlertReceived*(self: gen_qwebsocket_types.QWebSocket, slot: QWebSocketalertReceivedSlot) =
  var tmp = new QWebSocketalertReceivedSlot
  tmp[] = slot
  GC_ref(tmp)
  fcQWebSocket_connect_alertReceived(self.h, cast[int](addr tmp[]), fcQWebSocket_slot_callback_alertReceived, fcQWebSocket_slot_callback_alertReceived_release)

proc handshakeInterruptedOnError*(self: gen_qwebsocket_types.QWebSocket, error: gen_qsslerror_types.QSslError): void =
  fcQWebSocket_handshakeInterruptedOnError(self.h, error.h)

type QWebSockethandshakeInterruptedOnErrorSlot* = proc(error: gen_qsslerror_types.QSslError)
proc fcQWebSocket_slot_callback_handshakeInterruptedOnError(slot: int, error: pointer) {.cdecl.} =
  let nimfunc = cast[ptr QWebSockethandshakeInterruptedOnErrorSlot](cast[pointer](slot))
  let slotval1 = gen_qsslerror_types.QSslError(h: error, owned: false)

  nimfunc[](slotval1)

proc fcQWebSocket_slot_callback_handshakeInterruptedOnError_release(slot: int) {.cdecl.} =
  let nimfunc = cast[ref QWebSockethandshakeInterruptedOnErrorSlot](cast[pointer](slot))
  GC_unref(nimfunc)

proc onHandshakeInterruptedOnError*(self: gen_qwebsocket_types.QWebSocket, slot: QWebSockethandshakeInterruptedOnErrorSlot) =
  var tmp = new QWebSockethandshakeInterruptedOnErrorSlot
  tmp[] = slot
  GC_ref(tmp)
  fcQWebSocket_connect_handshakeInterruptedOnError(self.h, cast[int](addr tmp[]), fcQWebSocket_slot_callback_handshakeInterruptedOnError, fcQWebSocket_slot_callback_handshakeInterruptedOnError_release)
