...
import
  ...
  ../QtNetwork/gen_qsslsocket_types,
...
proc fcQWebSocketServer_setSocketDescriptor(self: pointer, socketDescriptor: uint): bool {.importc: "QWebSocketServer_setSocketDescriptor".}
proc fcQWebSocketServer_socketDescriptor(self: pointer): uint {.importc: "QWebSocketServer_socketDescriptor".}
...
proc fcQWebSocketServer_setSupportedSubprotocols(self: pointer, protocols: struct_seaqt_array): void {.importc: "QWebSocketServer_setSupportedSubprotocols".}
proc fcQWebSocketServer_supportedSubprotocols(self: pointer): struct_seaqt_array {.importc: "QWebSocketServer_supportedSubprotocols".}
...
proc fcQWebSocketServer_sslErrorsOccurred(self: pointer, socket: pointer, errors: struct_seaqt_array): void {.importc: "QWebSocketServer_sslErrorsOccurred".}
proc fcQWebSocketServer_connect_sslErrorsOccurred(self: pointer, slot: int, callback: proc (slot: int, socket: pointer, errors: struct_seaqt_array) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QWebSocketServer_connect_sslErrorsOccurred".}
...
proc fcQWebSocketServer_alertSent(self: pointer, level: cint, typeVal: cint, description: struct_seaqt_string): void {.importc: "QWebSocketServer_alertSent".}
proc fcQWebSocketServer_connect_alertSent(self: pointer, slot: int, callback: proc (slot: int, level: cint, typeVal: cint, description: struct_seaqt_string) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QWebSocketServer_connect_alertSent".}
proc fcQWebSocketServer_alertReceived(self: pointer, level: cint, typeVal: cint, description: struct_seaqt_string): void {.importc: "QWebSocketServer_alertReceived".}
proc fcQWebSocketServer_connect_alertReceived(self: pointer, slot: int, callback: proc (slot: int, level: cint, typeVal: cint, description: struct_seaqt_string) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QWebSocketServer_connect_alertReceived".}
proc fcQWebSocketServer_handshakeInterruptedOnError(self: pointer, error: pointer): void {.importc: "QWebSocketServer_handshakeInterruptedOnError".}
proc fcQWebSocketServer_connect_handshakeInterruptedOnError(self: pointer, slot: int, callback: proc (slot: int, error: pointer) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QWebSocketServer_connect_handshakeInterruptedOnError".}
...
proc metaObject*(self: gen_qwebsocketserver_types.QWebSocketServer): gen_qobjectdefs_types.QMetaObject =
  gen_qobjectdefs_types.QMetaObject(h: fcQWebSocketServer_metaObject(self.h), owned: false)
...
proc serverAddress*(self: gen_qwebsocketserver_types.QWebSocketServer): gen_qhostaddress_types.QHostAddress =
  gen_qhostaddress_types.QHostAddress(h: fcQWebSocketServer_serverAddress(self.h), owned: true)

proc serverUrl*(self: gen_qwebsocketserver_types.QWebSocketServer): gen_qurl_types.QUrl =
  gen_qurl_types.QUrl(h: fcQWebSocketServer_serverUrl(self.h), owned: true)

proc secureMode*(self: gen_qwebsocketserver_types.QWebSocketServer): cint =
  cint(fcQWebSocketServer_secureMode(self.h))

proc setSocketDescriptor*(self: gen_qwebsocketserver_types.QWebSocketServer, socketDescriptor: uint): bool =
  fcQWebSocketServer_setSocketDescriptor(self.h, socketDescriptor)

proc socketDescriptor*(self: gen_qwebsocketserver_types.QWebSocketServer): uint =
...
proc nextPendingConnection*(self: gen_qwebsocketserver_types.QWebSocketServer): gen_qwebsocket_types.QWebSocket =
  gen_qwebsocket_types.QWebSocket(h: fcQWebSocketServer_nextPendingConnection(self.h), owned: false)
...
proc setSupportedSubprotocols*(self: gen_qwebsocketserver_types.QWebSocketServer, protocols: openArray[string]): void =
  ...
  fcQWebSocketServer_setSupportedSubprotocols(self.h, struct_seaqt_array(len: csize_t(len(protocols)), data: if len(protocols) == 0: nil else: addr(protocols_CArray[0])))

proc supportedSubprotocols*(self: gen_qwebsocketserver_types.QWebSocketServer): seq[string] =
  var v_ma = fcQWebSocketServer_supportedSubprotocols(self.h)
...
proc proxy*(self: gen_qwebsocketserver_types.QWebSocketServer): gen_qnetworkproxy_types.QNetworkProxy =
  gen_qnetworkproxy_types.QNetworkProxy(h: fcQWebSocketServer_proxy(self.h), owned: true)
...
proc sslConfiguration*(self: gen_qwebsocketserver_types.QWebSocketServer): gen_qsslconfiguration_types.QSslConfiguration =
  gen_qsslconfiguration_types.QSslConfiguration(h: fcQWebSocketServer_sslConfiguration(self.h), owned: true)
...
proc fcQWebSocketServer_slot_callback_originAuthenticationRequired(slot: int, pAuthenticator: pointer) {.cdecl.} =
  ...
  let slotval1 = gen_qwebsocketcorsauthenticator_types.QWebSocketCorsAuthenticator(h: pAuthenticator, owned: false)
...
proc sslErrorsOccurred*(self: gen_qwebsocketserver_types.QWebSocketServer, socket: gen_qsslsocket_types.QSslSocket, errors: openArray[gen_qsslerror_types.QSslError]): void =
  var errors_CArray = newSeq[pointer](len(errors))
  for i in 0..<len(errors):
    errors_CArray[i] = errors[i].h

  fcQWebSocketServer_sslErrorsOccurred(self.h, socket.h, struct_seaqt_array(len: csize_t(len(errors)), data: if len(errors) == 0: nil else: addr(errors_CArray[0])))

type QWebSocketServersslErrorsOccurredSlot* = proc(socket: gen_qsslsocket_types.QSslSocket, errors: openArray[gen_qsslerror_types.QSslError])
proc fcQWebSocketServer_slot_callback_sslErrorsOccurred(slot: int, socket: pointer, errors: struct_seaqt_array) {.cdecl.} =
  let nimfunc = cast[ptr QWebSocketServersslErrorsOccurredSlot](cast[pointer](slot))
...
proc fcQWebSocketServer_slot_callback_sslErrorsOccurred_release(slot: int) {.cdecl.} =
  let nimfunc = cast[ref QWebSocketServersslErrorsOccurredSlot](cast[pointer](slot))
  GC_unref(nimfunc)

proc onSslErrorsOccurred*(self: gen_qwebsocketserver_types.QWebSocketServer, slot: QWebSocketServersslErrorsOccurredSlot) =
  var tmp = new QWebSocketServersslErrorsOccurredSlot
  tmp[] = slot
  GC_ref(tmp)
  fcQWebSocketServer_connect_sslErrorsOccurred(self.h, cast[int](addr tmp[]), fcQWebSocketServer_slot_callback_sslErrorsOccurred, fcQWebSocketServer_slot_callback_sslErrorsOccurred_release)
...
proc alertSent*(self: gen_qwebsocketserver_types.QWebSocketServer, level: cint, typeVal: cint, description: openArray[char]): void =
  fcQWebSocketServer_alertSent(self.h, cint(level), cint(typeVal), struct_seaqt_string(data: if len(description) > 0: addr description[0] else: nil, len: csize_t(len(description))))

type QWebSocketServeralertSentSlot* = proc(level: cint, typeVal: cint, description: openArray[char])
proc fcQWebSocketServer_slot_callback_alertSent(slot: int, level: cint, typeVal: cint, description: struct_seaqt_string) {.cdecl.} =
  let nimfunc = cast[ptr QWebSocketServeralertSentSlot](cast[pointer](slot))
...
proc fcQWebSocketServer_slot_callback_alertSent_release(slot: int) {.cdecl.} =
  let nimfunc = cast[ref QWebSocketServeralertSentSlot](cast[pointer](slot))
  GC_unref(nimfunc)

proc onAlertSent*(self: gen_qwebsocketserver_types.QWebSocketServer, slot: QWebSocketServeralertSentSlot) =
  var tmp = new QWebSocketServeralertSentSlot
  tmp[] = slot
  GC_ref(tmp)
  fcQWebSocketServer_connect_alertSent(self.h, cast[int](addr tmp[]), fcQWebSocketServer_slot_callback_alertSent, fcQWebSocketServer_slot_callback_alertSent_release)

proc alertReceived*(self: gen_qwebsocketserver_types.QWebSocketServer, level: cint, typeVal: cint, description: openArray[char]): void =
  fcQWebSocketServer_alertReceived(self.h, cint(level), cint(typeVal), struct_seaqt_string(data: if len(description) > 0: addr description[0] else: nil, len: csize_t(len(description))))

type QWebSocketServeralertReceivedSlot* = proc(level: cint, typeVal: cint, description: openArray[char])
proc fcQWebSocketServer_slot_callback_alertReceived(slot: int, level: cint, typeVal: cint, description: struct_seaqt_string) {.cdecl.} =
  let nimfunc = cast[ptr QWebSocketServeralertReceivedSlot](cast[pointer](slot))
  let slotval1 = cint(level)
...
proc fcQWebSocketServer_slot_callback_alertReceived_release(slot: int) {.cdecl.} =
  let nimfunc = cast[ref QWebSocketServeralertReceivedSlot](cast[pointer](slot))
  GC_unref(nimfunc)

proc onAlertReceived*(self: gen_qwebsocketserver_types.QWebSocketServer, slot: QWebSocketServeralertReceivedSlot) =
  var tmp = new QWebSocketServeralertReceivedSlot
  tmp[] = slot
  GC_ref(tmp)
  fcQWebSocketServer_connect_alertReceived(self.h, cast[int](addr tmp[]), fcQWebSocketServer_slot_callback_alertReceived, fcQWebSocketServer_slot_callback_alertReceived_release)

proc handshakeInterruptedOnError*(self: gen_qwebsocketserver_types.QWebSocketServer, error: gen_qsslerror_types.QSslError): void =
  fcQWebSocketServer_handshakeInterruptedOnError(self.h, error.h)

type QWebSocketServerhandshakeInterruptedOnErrorSlot* = proc(error: gen_qsslerror_types.QSslError)
proc fcQWebSocketServer_slot_callback_handshakeInterruptedOnError(slot: int, error: pointer) {.cdecl.} =
  let nimfunc = cast[ptr QWebSocketServerhandshakeInterruptedOnErrorSlot](cast[pointer](slot))
  let slotval1 = gen_qsslerror_types.QSslError(h: error, owned: false)

  nimfunc[](slotval1)

proc fcQWebSocketServer_slot_callback_handshakeInterruptedOnError_release(slot: int) {.cdecl.} =
  let nimfunc = cast[ref QWebSocketServerhandshakeInterruptedOnErrorSlot](cast[pointer](slot))
  GC_unref(nimfunc)

proc onHandshakeInterruptedOnError*(self: gen_qwebsocketserver_types.QWebSocketServer, slot: QWebSocketServerhandshakeInterruptedOnErrorSlot) =
  var tmp = new QWebSocketServerhandshakeInterruptedOnErrorSlot
  tmp[] = slot
  GC_ref(tmp)
  fcQWebSocketServer_connect_handshakeInterruptedOnError(self.h, cast[int](addr tmp[]), fcQWebSocketServer_slot_callback_handshakeInterruptedOnError, fcQWebSocketServer_slot_callback_handshakeInterruptedOnError_release)
...
type QWebSocketServerVTable* {.inheritable, pure.} = object
...
proc QWebSocketServermetaObject*(self: gen_qwebsocketserver_types.QWebSocketServer): gen_qobjectdefs_types.QMetaObject =
  gen_qobjectdefs_types.QMetaObject(h: fcQWebSocketServer_virtualbase_metaObject(self.h), owned: false)
...
proc QWebSocketServernextPendingConnection*(self: gen_qwebsocketserver_types.QWebSocketServer): gen_qwebsocket_types.QWebSocket =
  gen_qwebsocket_types.QWebSocket(h: fcQWebSocketServer_virtualbase_nextPendingConnection(self.h), owned: false)
...
proc sender*(self: gen_qwebsocketserver_types.QWebSocketServer): gen_qobject_types.QObject =
  gen_qobject_types.QObject(h: fcQWebSocketServer_protectedbase_sender(self.h), owned: false)
...
proc create*(T: type gen_qwebsocketserver_types.QWebSocketServer,
  ...
  let tmp = gen_qwebsocketserver_types.QWebSocketServer(h: fcQWebSocketServer_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(serverName) > 0: addr serverName[0] else: nil, len: csize_t(len(serverName))), cint(secureMode)), owned: true)
...
proc create*(T: type gen_qwebsocketserver_types.QWebSocketServer,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQWebSocketServer_vtable_callback_disconnectNotify
  let tmp = gen_qwebsocketserver_types.QWebSocketServer(h: fcQWebSocketServer_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(serverName) > 0: addr serverName[0] else: nil, len: csize_t(len(serverName))), cint(secureMode), parent.h), owned: true)
  fcQWebSocketServer_vdata(tmp.h)[] = addr(vtbl[])
  tmp
