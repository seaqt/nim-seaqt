...
proc fcQQuickTransform_trUtf8S(s: cstring): struct_seaqt_string {.importc: "QQuickTransform_trUtf8_s".}
...
proc fcQQuickTransform_trUtf8SC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QQuickTransform_trUtf8_s_c".}
proc fcQQuickTransform_trUtf8SCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QQuickTransform_trUtf8_s_c_n".}
...
proc fcQQuickItem_trUtf8S(s: cstring): struct_seaqt_string {.importc: "QQuickItem_trUtf8_s".}
...
proc fcQQuickItem_trUtf8SC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QQuickItem_trUtf8_s_c".}
proc fcQQuickItem_trUtf8SCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QQuickItem_trUtf8_s_c_n".}
...
proc trUtf8*(_: type gen_qquickitem_types.QQuickTransform, s: cstring): string =
  let v_ms = fcQQuickTransform_trUtf8S(s)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc trUtf8*(_: type gen_qquickitem_types.QQuickItem, s: cstring): string =
  let v_ms = fcQQuickItem_trUtf8S(s)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc fcQQuickItem_vtable_callback_windowDeactivateEvent(self: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QQuickItemVTable](fcQQuickItem_vdata(self)[])
  let self = QQuickItem(h: self)
  vtbl[].windowDeactivateEvent(self)

proc fcQQuickItem_vtable_callback_geometryChanged(self: pointer, newGeometry: pointer, oldGeometry: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QQuickItemVTable](fcQQuickItem_vdata(self)[])
  let self = QQuickItem(h: self)
...
method windowDeactivateEvent*(self: VirtualQQuickItem): void {.base.} =
  QQuickItemwindowDeactivateEvent(self[])
method geometryChanged*(self: VirtualQQuickItem, newGeometry: gen_qrect_types.QRectF, oldGeometry: gen_qrect_types.QRectF): void {.base.} =
  QQuickItemgeometryChanged(self[], newGeometry, oldGeometry)
...
proc fcQQuickItem_method_callback_windowDeactivateEvent(self: pointer): void {.cdecl.} =
  let inst = cast[VirtualQQuickItem](fcQQuickItem_vdata(self)[])
  inst.windowDeactivateEvent()

proc fcQQuickItem_method_callback_geometryChanged(self: pointer, newGeometry: pointer, oldGeometry: pointer): void {.cdecl.} =
  let inst = cast[VirtualQQuickItem](fcQQuickItem_vdata(self)[])
  let slotval1 = gen_qrect_types.QRectF(h: newGeometry, owned: false)
  let slotval2 = gen_qrect_types.QRectF(h: oldGeometry, owned: false)
...
proc create*(T: type gen_qquickitem_types.QQuickItem,
  ...
  if not isNil(vtbl[].windowDeactivateEvent):
    vtbl[].vtbl.windowDeactivateEvent = fcQQuickItem_vtable_callback_windowDeactivateEvent
  if not isNil(vtbl[].geometryChanged):
    vtbl[].vtbl.geometryChanged = fcQQuickItem_vtable_callback_geometryChanged
...
const cQQuickItem_mvtbl = cQQuickItemVTable(
  ...
  windowDeactivateEvent: fcQQuickItem_method_callback_windowDeactivateEvent,
  geometryChanged: fcQQuickItem_method_callback_geometryChanged,
