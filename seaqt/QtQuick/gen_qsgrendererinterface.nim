...
template Direct3D12*(_: type QSGRendererInterfaceGraphicsApiEnum): untyped = 8
...
template GraphicsQueueFamilyIndexResource*(_: type QSGRendererInterfaceResourceEnum): untyped = 15
template GraphicsQueueIndexResource*(_: type QSGRendererInterfaceResourceEnum): untyped = 16
...
proc fcQSGRendererInterface_getResource_QQuickWindow_QSGRendererInterface_Resource(self: pointer, window: pointer, resource: cint): pointer {.importc: "QSGRendererInterface_getResource_QQuickWindow_QSGRendererInterface_Resource".}
proc fcQSGRendererInterface_getResource_QQuickWindowChar(self: pointer, window: pointer, resource: cstring): pointer {.importc: "QSGRendererInterface_getResource_QQuickWindow_char".}
...
proc fcQSGRendererInterface_operatorAssign(self: pointer, fromVal: pointer): void {.importc: "QSGRendererInterface_operatorAssign".}
...
proc getResource*(self: gen_qsgrendererinterface_types.QSGRendererInterface, window: gen_qquickwindow_types.QQuickWindow, resource: cint): pointer =
  fcQSGRendererInterface_getResource_QQuickWindow_QSGRendererInterface_Resource(self.h, window.h, cint(resource))
...
proc getResource*(self: gen_qsgrendererinterface_types.QSGRendererInterface, window: gen_qquickwindow_types.QQuickWindow, resource: cstring): pointer =
  fcQSGRendererInterface_getResource_QQuickWindowChar(self.h, window.h, resource)
...
proc operatorAssign*(self: gen_qsgrendererinterface_types.QSGRendererInterface, fromVal: gen_qsgrendererinterface_types.QSGRendererInterface): void =
  fcQSGRendererInterface_operatorAssign(self.h, fromVal.h)
