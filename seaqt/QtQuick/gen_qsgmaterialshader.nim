...
type QSGMaterialShaderGraphicsPipelineStateBlendOpEnum* = distinct cint
template Add*(_: type QSGMaterialShaderGraphicsPipelineStateBlendOpEnum): untyped = 0
template Subtract*(_: type QSGMaterialShaderGraphicsPipelineStateBlendOpEnum): untyped = 1
template ReverseSubtract*(_: type QSGMaterialShaderGraphicsPipelineStateBlendOpEnum): untyped = 2
template Min*(_: type QSGMaterialShaderGraphicsPipelineStateBlendOpEnum): untyped = 3
template Max*(_: type QSGMaterialShaderGraphicsPipelineStateBlendOpEnum): untyped = 4
...
proc fcQSGMaterialShader_protectedbase_setShaderFileName_stage_filename(self: pointer, stage: cint, filename: struct_seaqt_string): void {.importc: "QSGMaterialShader_protectedbase_setShaderFileName_stage_filename".}
proc fcQSGMaterialShader_protectedbase_setShaderFileName_stage_filename_viewCount(self: pointer, stage: cint, filename: struct_seaqt_string, viewCount: cint): void {.importc: "QSGMaterialShader_protectedbase_setShaderFileName_stage_filename_viewCount".}
...
proc fcQSGMaterialShaderRenderState_combinedMatrixIndex(self: pointer, index: int64): pointer {.importc: "QSGMaterialShader__RenderState_combinedMatrix_index".}
...
proc fcQSGMaterialShaderRenderState_projectionMatrixIndex(self: pointer, index: int64): pointer {.importc: "QSGMaterialShader__RenderState_projectionMatrix_index".}
proc fcQSGMaterialShaderRenderState_projectionMatrixCount(self: pointer): int64 {.importc: "QSGMaterialShader__RenderState_projectionMatrixCount".}
...
proc fcQSGMaterialShaderGraphicsPipelineState_separateBlendFactors(self: pointer): bool {.importc: "QSGMaterialShader__GraphicsPipelineState_separateBlendFactors".}
proc fcQSGMaterialShaderGraphicsPipelineState_setSeparateBlendFactors(self: pointer, separateBlendFactors: bool): void {.importc: "QSGMaterialShader__GraphicsPipelineState_setSeparateBlendFactors".}
proc fcQSGMaterialShaderGraphicsPipelineState_srcAlpha(self: pointer): cint {.importc: "QSGMaterialShader__GraphicsPipelineState_srcAlpha".}
proc fcQSGMaterialShaderGraphicsPipelineState_setSrcAlpha(self: pointer, srcAlpha: cint): void {.importc: "QSGMaterialShader__GraphicsPipelineState_setSrcAlpha".}
proc fcQSGMaterialShaderGraphicsPipelineState_dstAlpha(self: pointer): cint {.importc: "QSGMaterialShader__GraphicsPipelineState_dstAlpha".}
proc fcQSGMaterialShaderGraphicsPipelineState_setDstAlpha(self: pointer, dstAlpha: cint): void {.importc: "QSGMaterialShader__GraphicsPipelineState_setDstAlpha".}
proc fcQSGMaterialShaderGraphicsPipelineState_opColor(self: pointer): cint {.importc: "QSGMaterialShader__GraphicsPipelineState_opColor".}
proc fcQSGMaterialShaderGraphicsPipelineState_setOpColor(self: pointer, opColor: cint): void {.importc: "QSGMaterialShader__GraphicsPipelineState_setOpColor".}
proc fcQSGMaterialShaderGraphicsPipelineState_opAlpha(self: pointer): cint {.importc: "QSGMaterialShader__GraphicsPipelineState_opAlpha".}
proc fcQSGMaterialShaderGraphicsPipelineState_setOpAlpha(self: pointer, opAlpha: cint): void {.importc: "QSGMaterialShader__GraphicsPipelineState_setOpAlpha".}
...
proc setShaderFileName*(self: gen_qsgmaterialshader_types.QSGMaterialShader, stage: cint, filename: openArray[char]): void =
  fcQSGMaterialShader_protectedbase_setShaderFileName_stage_filename(self.h, cint(stage), struct_seaqt_string(data: if len(filename) > 0: addr filename[0] else: nil, len: csize_t(len(filename))))

proc setShaderFileName*(self: gen_qsgmaterialshader_types.QSGMaterialShader, stage: cint, filename: openArray[char], viewCount: cint): void =
  fcQSGMaterialShader_protectedbase_setShaderFileName_stage_filename_viewCount(self.h, cint(stage), struct_seaqt_string(data: if len(filename) > 0: addr filename[0] else: nil, len: csize_t(len(filename))), viewCount)
...
proc combinedMatrix*(self: gen_qsgmaterialshader_types.QSGMaterialShaderRenderState, index: int64): gen_qmatrix4x4_types.QMatrix4x4 =
  gen_qmatrix4x4_types.QMatrix4x4(h: fcQSGMaterialShaderRenderState_combinedMatrixIndex(self.h, index), owned: true)
...
proc projectionMatrix*(self: gen_qsgmaterialshader_types.QSGMaterialShaderRenderState, index: int64): gen_qmatrix4x4_types.QMatrix4x4 =
  gen_qmatrix4x4_types.QMatrix4x4(h: fcQSGMaterialShaderRenderState_projectionMatrixIndex(self.h, index), owned: true)

proc projectionMatrixCount*(self: gen_qsgmaterialshader_types.QSGMaterialShaderRenderState): int64 =
  fcQSGMaterialShaderRenderState_projectionMatrixCount(self.h)
...
proc separateBlendFactors*(self: gen_qsgmaterialshader_types.QSGMaterialShaderGraphicsPipelineState): bool =
  fcQSGMaterialShaderGraphicsPipelineState_separateBlendFactors(self.h)

proc setSeparateBlendFactors*(self: gen_qsgmaterialshader_types.QSGMaterialShaderGraphicsPipelineState, separateBlendFactors: bool): void =
  fcQSGMaterialShaderGraphicsPipelineState_setSeparateBlendFactors(self.h, separateBlendFactors)

proc srcAlpha*(self: gen_qsgmaterialshader_types.QSGMaterialShaderGraphicsPipelineState): cint =
  cint(fcQSGMaterialShaderGraphicsPipelineState_srcAlpha(self.h))

proc setSrcAlpha*(self: gen_qsgmaterialshader_types.QSGMaterialShaderGraphicsPipelineState, srcAlpha: cint): void =
  fcQSGMaterialShaderGraphicsPipelineState_setSrcAlpha(self.h, cint(srcAlpha))

proc dstAlpha*(self: gen_qsgmaterialshader_types.QSGMaterialShaderGraphicsPipelineState): cint =
  cint(fcQSGMaterialShaderGraphicsPipelineState_dstAlpha(self.h))

proc setDstAlpha*(self: gen_qsgmaterialshader_types.QSGMaterialShaderGraphicsPipelineState, dstAlpha: cint): void =
  fcQSGMaterialShaderGraphicsPipelineState_setDstAlpha(self.h, cint(dstAlpha))

proc opColor*(self: gen_qsgmaterialshader_types.QSGMaterialShaderGraphicsPipelineState): cint =
  cint(fcQSGMaterialShaderGraphicsPipelineState_opColor(self.h))

proc setOpColor*(self: gen_qsgmaterialshader_types.QSGMaterialShaderGraphicsPipelineState, opColor: cint): void =
  fcQSGMaterialShaderGraphicsPipelineState_setOpColor(self.h, cint(opColor))

proc opAlpha*(self: gen_qsgmaterialshader_types.QSGMaterialShaderGraphicsPipelineState): cint =
  cint(fcQSGMaterialShaderGraphicsPipelineState_opAlpha(self.h))

proc setOpAlpha*(self: gen_qsgmaterialshader_types.QSGMaterialShaderGraphicsPipelineState, opAlpha: cint): void =
  fcQSGMaterialShaderGraphicsPipelineState_setOpAlpha(self.h, cint(opAlpha))
