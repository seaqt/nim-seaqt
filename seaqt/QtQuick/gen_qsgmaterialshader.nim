...
proc fcQSGMaterialShader_new(vtbl: pointer, vdata: csize_t): ptr cQSGMaterialShader {.importc: "QSGMaterialShader_new".}
...
proc create*(T: type gen_qsgmaterialshader_types.QSGMaterialShader,
  ...
  let tmp = gen_qsgmaterialshader_types.QSGMaterialShader(h: fcQSGMaterialShader_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))))
  fcQSGMaterialShader_vdata(tmp.h)[] = addr(vtbl[])
  tmp
...
proc blendConstant*(self: gen_qsgmaterialshader_types.QSGMaterialShaderGraphicsPipelineState): gen_qcolor_types.QColor =
  gen_qcolor_types.QColor(h: fcQSGMaterialShaderGraphicsPipelineState_blendConstant(self.h))
