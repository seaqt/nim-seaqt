...
proc fcQQuickRenderControl_trUtf8(s: cstring): struct_seaqt_string {.importc: "QQuickRenderControl_trUtf8".}
...
proc fcQQuickRenderControl_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QQuickRenderControl_trUtf82".}
proc fcQQuickRenderControl_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QQuickRenderControl_trUtf83".}
