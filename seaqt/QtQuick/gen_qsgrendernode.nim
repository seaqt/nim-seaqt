...
proc fcQSGRenderNode_projectionMatrix(self: pointer): pointer {.importc: "QSGRenderNode_projectionMatrix".}
proc fcQSGRenderNode_projectionMatrixIndex(self: pointer, index: int64): pointer {.importc: "QSGRenderNode_projectionMatrix_index".}
...
proc fcQSGRenderNode_new(vtbl: pointer, vdata: csize_t): ptr cQSGRenderNode {.importc: "QSGRenderNode_new".}
...
proc projectionMatrix*(self: gen_qsgrendernode_types.QSGRenderNode): gen_qmatrix4x4_types.QMatrix4x4 =
  gen_qmatrix4x4_types.QMatrix4x4(h: fcQSGRenderNode_projectionMatrix(self.h), owned: false)

proc projectionMatrix*(self: gen_qsgrendernode_types.QSGRenderNode, index: int64): gen_qmatrix4x4_types.QMatrix4x4 =
  gen_qmatrix4x4_types.QMatrix4x4(h: fcQSGRenderNode_projectionMatrixIndex(self.h, index), owned: false)
...
proc create*(T: type gen_qsgrendernode_types.QSGRenderNode,
  ...
  if not isNil(vtbl[].prepare):
    vtbl[].vtbl.prepare = fcQSGRenderNode_vtable_callback_prepare
  ...
  let tmp = gen_qsgrendernode_types.QSGRenderNode(h: fcQSGRenderNode_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQSGRenderNode_vdata(tmp.h)[] = addr(vtbl[])
  tmp
const cQSGRenderNode_mvtbl = cQSGRenderNodeVTable(
  ...
  prepare: fcQSGRenderNode_method_callback_prepare,
