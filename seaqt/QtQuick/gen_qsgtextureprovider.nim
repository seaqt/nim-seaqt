...
proc fcQSGTextureProvider_trUtf8(s: cstring): struct_seaqt_string {.importc: "QSGTextureProvider_trUtf8".}
...
proc fcQSGTextureProvider_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QSGTextureProvider_trUtf82".}
proc fcQSGTextureProvider_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QSGTextureProvider_trUtf83".}
