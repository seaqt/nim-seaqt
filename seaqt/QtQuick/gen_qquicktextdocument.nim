...
proc miqt_exec_method_cQQuickTextDocument_metaObject(vtbl: pointer, inst: pointer): pointer {.cdecl.} =
  let vtbl = cast[VirtualQQuickTextDocument](cast[uint](vtbl) - uint(offsetOf(VirtualQQuickTextDocument, vtbl)))
...
proc miqt_exec_method_cQQuickTextDocument_metacast(vtbl: pointer, inst: pointer, param1: cstring): pointer {.cdecl.} =
  let vtbl = cast[VirtualQQuickTextDocument](cast[uint](vtbl) - uint(offsetOf(VirtualQQuickTextDocument, vtbl)))
  let slotval1 = (param1)
...
proc miqt_exec_method_cQQuickTextDocument_metacall(vtbl: pointer, inst: pointer, param1: cint, param2: cint, param3: pointer): cint {.cdecl.} =
  let vtbl = cast[VirtualQQuickTextDocument](cast[uint](vtbl) - uint(offsetOf(VirtualQQuickTextDocument, vtbl)))
  let slotval1 = cint(param1)
  let slotval2 = param2
  let slotval3 = param3
...
proc miqt_exec_method_cQQuickTextDocument_event(vtbl: pointer, inst: pointer, event: pointer): bool {.cdecl.} =
  let vtbl = cast[VirtualQQuickTextDocument](cast[uint](vtbl) - uint(offsetOf(VirtualQQuickTextDocument, vtbl)))
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
...
proc miqt_exec_method_cQQuickTextDocument_eventFilter(vtbl: pointer, inst: pointer, watched: pointer, event: pointer): bool {.cdecl.} =
  let vtbl = cast[VirtualQQuickTextDocument](cast[uint](vtbl) - uint(offsetOf(VirtualQQuickTextDocument, vtbl)))
  let slotval1 = gen_qobject_types.QObject(h: watched, owned: false)
  let slotval2 = gen_qcoreevent_types.QEvent(h: event, owned: false)
...
proc miqt_exec_method_cQQuickTextDocument_timerEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQQuickTextDocument](cast[uint](vtbl) - uint(offsetOf(VirtualQQuickTextDocument, vtbl)))
  let slotval1 = gen_qcoreevent_types.QTimerEvent(h: event, owned: false)
...
proc miqt_exec_method_cQQuickTextDocument_childEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQQuickTextDocument](cast[uint](vtbl) - uint(offsetOf(VirtualQQuickTextDocument, vtbl)))
  let slotval1 = gen_qcoreevent_types.QChildEvent(h: event, owned: false)
...
proc miqt_exec_method_cQQuickTextDocument_customEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQQuickTextDocument](cast[uint](vtbl) - uint(offsetOf(VirtualQQuickTextDocument, vtbl)))
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
...
proc miqt_exec_method_cQQuickTextDocument_connectNotify(vtbl: pointer, inst: pointer, signal: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQQuickTextDocument](cast[uint](vtbl) - uint(offsetOf(VirtualQQuickTextDocument, vtbl)))
  let slotval1 = gen_qmetaobject_types.QMetaMethod(h: signal, owned: false)
...
proc miqt_exec_method_cQQuickTextDocument_disconnectNotify(vtbl: pointer, inst: pointer, signal: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQQuickTextDocument](cast[uint](vtbl) - uint(offsetOf(VirtualQQuickTextDocument, vtbl)))
  let slotval1 = gen_qmetaobject_types.QMetaMethod(h: signal, owned: false)
...
proc create*(T: type gen_qquicktextdocument_types.QQuickTextDocument,
  ...
  gen_qquicktextdocument_types.QQuickTextDocument(h: fcQQuickTextDocument_new(addr(vtbl[].vtbl), parent.h), owned: true)

proc create*(T: type gen_qquicktextdocument_types.QQuickTextDocument,
    parent: gen_qquickitem_types.QQuickItem,
    vtbl: VirtualQQuickTextDocument) =

  vtbl[].vtbl.destructor = proc(vtbl: ptr cQQuickTextDocumentVTable, _: ptr cQQuickTextDocument) {.cdecl.} =
    let vtbl = cast[ptr typeof(VirtualQQuickTextDocument()[])](cast[uint](vtbl) - uint(offsetOf(VirtualQQuickTextDocument, vtbl)))
    vtbl[].h = nil
    vtbl[].owned = false
  vtbl[].vtbl.metaObject = miqt_exec_method_cQQuickTextDocument_metaObject
  vtbl[].vtbl.metacast = miqt_exec_method_cQQuickTextDocument_metacast
  vtbl[].vtbl.metacall = miqt_exec_method_cQQuickTextDocument_metacall
  vtbl[].vtbl.event = miqt_exec_method_cQQuickTextDocument_event
  vtbl[].vtbl.eventFilter = miqt_exec_method_cQQuickTextDocument_eventFilter
  vtbl[].vtbl.timerEvent = miqt_exec_method_cQQuickTextDocument_timerEvent
  vtbl[].vtbl.childEvent = miqt_exec_method_cQQuickTextDocument_childEvent
  vtbl[].vtbl.customEvent = miqt_exec_method_cQQuickTextDocument_customEvent
  vtbl[].vtbl.connectNotify = miqt_exec_method_cQQuickTextDocument_connectNotify
  vtbl[].vtbl.disconnectNotify = miqt_exec_method_cQQuickTextDocument_disconnectNotify
  if vtbl[].h != nil: delete(move(vtbl[]))
  vtbl[].h = fcQQuickTextDocument_new(addr(vtbl[].vtbl), parent.h)
  vtbl[].owned = true
