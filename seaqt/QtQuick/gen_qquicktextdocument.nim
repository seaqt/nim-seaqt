...
proc fcQQuickTextDocument_trUtf8(s: cstring): struct_seaqt_string {.importc: "QQuickTextDocument_trUtf8".}
...
proc fcQQuickTextDocument_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QQuickTextDocument_trUtf82".}
proc fcQQuickTextDocument_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QQuickTextDocument_trUtf83".}
