...
proc fcQQuickTextureFactory_trUtf8S(s: cstring): struct_seaqt_string {.importc: "QQuickTextureFactory_trUtf8_s".}
...
proc fcQQuickTextureFactory_trUtf8SC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QQuickTextureFactory_trUtf8_s_c".}
proc fcQQuickTextureFactory_trUtf8SCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QQuickTextureFactory_trUtf8_s_c_n".}
...
proc fcQQuickTextureFactory_new(vtbl: pointer, vdata: csize_t): ptr cQQuickTextureFactory {.importc: "QQuickTextureFactory_new".}
...
proc fcQQuickImageResponse_trUtf8S(s: cstring): struct_seaqt_string {.importc: "QQuickImageResponse_trUtf8_s".}
...
proc fcQQuickImageResponse_trUtf8SC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QQuickImageResponse_trUtf8_s_c".}
proc fcQQuickImageResponse_trUtf8SCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QQuickImageResponse_trUtf8_s_c_n".}
...
type cQQuickImageResponseVTable {.pure.} = object
  ...
  errorString*: proc(self: pointer): struct_seaqt_string {.cdecl, raises: [], gcsafe.}
...
proc fcQQuickImageResponse_virtualbase_errorString(self: pointer): struct_seaqt_string {.importc: "QQuickImageResponse_virtualbase_errorString".}
...
proc fcQQuickImageResponse_new(vtbl: pointer, vdata: csize_t): ptr cQQuickImageResponse {.importc: "QQuickImageResponse_new".}
...
proc fcQQuickImageProvider_operatorAssign(self: pointer, fromVal: pointer): void {.importc: "QQuickImageProvider_operatorAssign".}
...
type cQQuickImageProviderVTable {.pure.} = object
  ...
  requestImage*: proc(self: pointer, id: struct_seaqt_string, size: pointer, requestedSize: pointer): pointer {.cdecl, raises: [], gcsafe.}
  requestPixmap*: proc(self: pointer, id: struct_seaqt_string, size: pointer, requestedSize: pointer): pointer {.cdecl, raises: [], gcsafe.}
  requestTexture*: proc(self: pointer, id: struct_seaqt_string, size: pointer, requestedSize: pointer): pointer {.cdecl, raises: [], gcsafe.}
...
proc fcQQuickImageProvider_virtualbase_requestImage(self: pointer, id: struct_seaqt_string, size: pointer, requestedSize: pointer): pointer {.importc: "QQuickImageProvider_virtualbase_requestImage".}
proc fcQQuickImageProvider_virtualbase_requestPixmap(self: pointer, id: struct_seaqt_string, size: pointer, requestedSize: pointer): pointer {.importc: "QQuickImageProvider_virtualbase_requestPixmap".}
proc fcQQuickImageProvider_virtualbase_requestTexture(self: pointer, id: struct_seaqt_string, size: pointer, requestedSize: pointer): pointer {.importc: "QQuickImageProvider_virtualbase_requestTexture".}
...
proc fcQQuickImageProvider_new2(vtbl: pointer, vdata: csize_t, fromVal: pointer): ptr cQQuickImageProvider {.importc: "QQuickImageProvider_new_from".}
proc fcQQuickImageProvider_new3(vtbl: pointer, vdata: csize_t, typeVal: cint, flags: cint): ptr cQQuickImageProvider {.importc: "QQuickImageProvider_new_type_flags".}
...
proc fcQQuickAsyncImageProvider_operatorAssign(self: pointer, fromVal: pointer): void {.importc: "QQuickAsyncImageProvider_operatorAssign".}
proc fcQQuickAsyncImageProvider_vdata(self: pointer): ptr pointer {.importc: "QQuickAsyncImageProvider_vdata".}
proc fvdata_cQQuickAsyncImageProvider(self: pointer): pointer {.importc: "vdata_QQuickAsyncImageProvider".}

type cQQuickAsyncImageProviderVTable {.pure.} = object
  destructor*: proc(self: pointer) {.cdecl, raises:[], gcsafe.}
  requestImageResponse*: proc(self: pointer, id: struct_seaqt_string, requestedSize: pointer): pointer {.cdecl, raises: [], gcsafe.}
  imageType*: proc(self: pointer): cint {.cdecl, raises: [], gcsafe.}
  flags*: proc(self: pointer): cint {.cdecl, raises: [], gcsafe.}
  requestImage*: proc(self: pointer, id: struct_seaqt_string, size: pointer, requestedSize: pointer): pointer {.cdecl, raises: [], gcsafe.}
  requestPixmap*: proc(self: pointer, id: struct_seaqt_string, size: pointer, requestedSize: pointer): pointer {.cdecl, raises: [], gcsafe.}
...
proc fcQQuickAsyncImageProvider_virtualbase_requestImage(self: pointer, id: struct_seaqt_string, size: pointer, requestedSize: pointer): pointer {.importc: "QQuickAsyncImageProvider_virtualbase_requestImage".}
proc fcQQuickAsyncImageProvider_virtualbase_requestPixmap(self: pointer, id: struct_seaqt_string, size: pointer, requestedSize: pointer): pointer {.importc: "QQuickAsyncImageProvider_virtualbase_requestPixmap".}
proc fcQQuickAsyncImageProvider_virtualbase_requestTexture(self: pointer, id: struct_seaqt_string, size: pointer, requestedSize: pointer): pointer {.importc: "QQuickAsyncImageProvider_virtualbase_requestTexture".}
proc fcQQuickAsyncImageProvider_new(vtbl: pointer, vdata: csize_t): ptr cQQuickAsyncImageProvider {.importc: "QQuickAsyncImageProvider_new".}
proc fcQQuickAsyncImageProvider_new2(vtbl: pointer, vdata: csize_t, fromVal: pointer): ptr cQQuickAsyncImageProvider {.importc: "QQuickAsyncImageProvider_new_from".}
...
proc trUtf8*(_: type gen_qquickimageprovider_types.QQuickTextureFactory, s: cstring): string =
  let v_ms = fcQQuickTextureFactory_trUtf8S(s)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc create*(T: type gen_qquickimageprovider_types.QQuickTextureFactory,
  ...
  let tmp = gen_qquickimageprovider_types.QQuickTextureFactory(h: fcQQuickTextureFactory_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQQuickTextureFactory_vdata(tmp.h)[] = addr(vtbl[])
  tmp
...
proc create*(T: type gen_qquickimageprovider_types.QQuickTextureFactory,
  ...
  inst[].h = fcQQuickTextureFactory_new(addr(cQQuickTextureFactory_mvtbl), csize_t(sizeof(pointer)))
  fcQQuickTextureFactory_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc trUtf8*(_: type gen_qquickimageprovider_types.QQuickImageResponse, s: cstring): string =
  let v_ms = fcQQuickImageResponse_trUtf8S(s)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc fcQQuickImageResponse_vtable_callback_errorString(self: pointer): struct_seaqt_string {.cdecl.} =
  let vtbl = cast[ptr QQuickImageResponseVTable](fcQQuickImageResponse_vdata(self)[])
  let self = QQuickImageResponse(h: self)
...
proc fcQQuickImageResponse_method_callback_errorString(self: pointer): struct_seaqt_string {.cdecl.} =
  let inst = cast[VirtualQQuickImageResponse](fcQQuickImageResponse_vdata(self)[])
...
proc create*(T: type gen_qquickimageprovider_types.QQuickImageResponse,
  ...
  let tmp = gen_qquickimageprovider_types.QQuickImageResponse(h: fcQQuickImageResponse_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQQuickImageResponse_vdata(tmp.h)[] = addr(vtbl[])
  tmp
...
proc create*(T: type gen_qquickimageprovider_types.QQuickImageResponse,
  ...
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQQuickImageResponse_new(addr(cQQuickImageResponse_mvtbl), csize_t(sizeof(pointer)))
  fcQQuickImageResponse_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc requestImage*(self: gen_qquickimageprovider_types.QQuickImageProvider, id: openArray[char], size: gen_qsize_types.QSize, requestedSize: gen_qsize_types.QSize): gen_qimage_types.QImage =
  gen_qimage_types.QImage(h: fcQQuickImageProvider_requestImage(self.h, struct_seaqt_string(data: if len(id) > 0: addr id[0] else: nil, len: csize_t(len(id))), size.h, requestedSize.h), owned: true)
...
proc requestPixmap*(self: gen_qquickimageprovider_types.QQuickImageProvider, id: openArray[char], size: gen_qsize_types.QSize, requestedSize: gen_qsize_types.QSize): gen_qpixmap_types.QPixmap =
  gen_qpixmap_types.QPixmap(h: fcQQuickImageProvider_requestPixmap(self.h, struct_seaqt_string(data: if len(id) > 0: addr id[0] else: nil, len: csize_t(len(id))), size.h, requestedSize.h), owned: true)
...
proc operatorAssign*(self: gen_qquickimageprovider_types.QQuickImageProvider, fromVal: gen_qquickimageprovider_types.QQuickImageProvider): void =
  fcQQuickImageProvider_operatorAssign(self.h, fromVal.h)
...
proc QQuickImageProviderrequestImage*(self: gen_qquickimageprovider_types.QQuickImageProvider, id: openArray[char], size: gen_qsize_types.QSize, requestedSize: gen_qsize_types.QSize): gen_qimage_types.QImage =
  gen_qimage_types.QImage(h: fcQQuickImageProvider_virtualbase_requestImage(self.h, struct_seaqt_string(data: if len(id) > 0: addr id[0] else: nil, len: csize_t(len(id))), size.h, requestedSize.h), owned: true)
...
proc QQuickImageProviderrequestPixmap*(self: gen_qquickimageprovider_types.QQuickImageProvider, id: openArray[char], size: gen_qsize_types.QSize, requestedSize: gen_qsize_types.QSize): gen_qpixmap_types.QPixmap =
  gen_qpixmap_types.QPixmap(h: fcQQuickImageProvider_virtualbase_requestPixmap(self.h, struct_seaqt_string(data: if len(id) > 0: addr id[0] else: nil, len: csize_t(len(id))), size.h, requestedSize.h), owned: true)
...
proc QQuickImageProviderrequestTexture*(self: gen_qquickimageprovider_types.QQuickImageProvider, id: openArray[char], size: gen_qsize_types.QSize, requestedSize: gen_qsize_types.QSize): gen_qquickimageprovider_types.QQuickTextureFactory =
  gen_qquickimageprovider_types.QQuickTextureFactory(h: fcQQuickImageProvider_virtualbase_requestTexture(self.h, struct_seaqt_string(data: if len(id) > 0: addr id[0] else: nil, len: csize_t(len(id))), size.h, requestedSize.h), owned: false)
...
proc fcQQuickImageProvider_vtable_callback_requestImage(self: pointer, id: struct_seaqt_string, size: pointer, requestedSize: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QQuickImageProviderVTable](fcQQuickImageProvider_vdata(self)[])
  let self = QQuickImageProvider(h: self)
  let vid_ms = id
...
proc fcQQuickImageProvider_vtable_callback_requestPixmap(self: pointer, id: struct_seaqt_string, size: pointer, requestedSize: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QQuickImageProviderVTable](fcQQuickImageProvider_vdata(self)[])
  let self = QQuickImageProvider(h: self)
  let vid_ms = id
  let vidx_ret = string.fromBytes(vid_ms)
...
proc fcQQuickImageProvider_vtable_callback_requestTexture(self: pointer, id: struct_seaqt_string, size: pointer, requestedSize: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QQuickImageProviderVTable](fcQQuickImageProvider_vdata(self)[])
  let self = QQuickImageProvider(h: self)
  let vid_ms = id
  let vidx_ret = string.fromBytes(vid_ms)
...
proc fcQQuickImageProvider_method_callback_requestImage(self: pointer, id: struct_seaqt_string, size: pointer, requestedSize: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQQuickImageProvider](fcQQuickImageProvider_vdata(self)[])
  let vid_ms = id
  let vidx_ret = string.fromBytes(vid_ms)
  c_free(vid_ms.data)
...
proc fcQQuickImageProvider_method_callback_requestPixmap(self: pointer, id: struct_seaqt_string, size: pointer, requestedSize: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQQuickImageProvider](fcQQuickImageProvider_vdata(self)[])
  let vid_ms = id
  let vidx_ret = string.fromBytes(vid_ms)
  c_free(vid_ms.data)
...
proc fcQQuickImageProvider_method_callback_requestTexture(self: pointer, id: struct_seaqt_string, size: pointer, requestedSize: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQQuickImageProvider](fcQQuickImageProvider_vdata(self)[])
  let vid_ms = id
  let vidx_ret = string.fromBytes(vid_ms)
  c_free(vid_ms.data)
...
proc create*(T: type gen_qquickimageprovider_types.QQuickImageProvider,
  ...
  let tmp = gen_qquickimageprovider_types.QQuickImageProvider(h: fcQQuickImageProvider_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), cint(typeVal)), owned: true)
  fcQQuickImageProvider_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qquickimageprovider_types.QQuickImageProvider,
    fromVal: gen_qquickimageprovider_types.QQuickImageProvider,
    vtbl: ref QQuickImageProviderVTable = nil): gen_qquickimageprovider_types.QQuickImageProvider =
  let vtbl = if vtbl == nil: new QQuickImageProviderVTable else: vtbl
  GC_ref(vtbl)
  vtbl[].vtbl.destructor = proc(self: pointer) {.cdecl.} =
  ...
  if not isNil(vtbl[].requestTexture):
    vtbl[].vtbl.requestTexture = fcQQuickImageProvider_vtable_callback_requestTexture
  let tmp = gen_qquickimageprovider_types.QQuickImageProvider(h: fcQQuickImageProvider_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), fromVal.h), owned: true)
  fcQQuickImageProvider_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qquickimageprovider_types.QQuickImageProvider,
  ...
  if not isNil(vtbl[].requestTexture):
    vtbl[].vtbl.requestTexture = fcQQuickImageProvider_vtable_callback_requestTexture
  let tmp = gen_qquickimageprovider_types.QQuickImageProvider(h: fcQQuickImageProvider_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), cint(typeVal), cint(flags)), owned: true)
  fcQQuickImageProvider_vdata(tmp.h)[] = addr(vtbl[])
  tmp
...
proc create*(T: type gen_qquickimageprovider_types.QQuickImageProvider,
  ...
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQQuickImageProvider_new(addr(cQQuickImageProvider_mvtbl), csize_t(sizeof(pointer)), cint(typeVal))
  fcQQuickImageProvider_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qquickimageprovider_types.QQuickImageProvider,
    ...
    inst: VirtualQQuickImageProvider) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQQuickImageProvider_new2(addr(cQQuickImageProvider_mvtbl), csize_t(sizeof(pointer)), fromVal.h)
  fcQQuickImageProvider_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qquickimageprovider_types.QQuickImageProvider,
    ...
    inst: VirtualQQuickImageProvider) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQQuickImageProvider_new3(addr(cQQuickImageProvider_mvtbl), csize_t(sizeof(pointer)), cint(typeVal), cint(flags))
  fcQQuickImageProvider_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc requestImageResponse*(self: gen_qquickimageprovider_types.QQuickAsyncImageProvider, id: openArray[char], requestedSize: gen_qsize_types.QSize): gen_qquickimageprovider_types.QQuickImageResponse =
  gen_qquickimageprovider_types.QQuickImageResponse(h: fcQQuickAsyncImageProvider_requestImageResponse(self.h, struct_seaqt_string(data: if len(id) > 0: addr id[0] else: nil, len: csize_t(len(id))), requestedSize.h), owned: false)

proc operatorAssign*(self: gen_qquickimageprovider_types.QQuickAsyncImageProvider, fromVal: gen_qquickimageprovider_types.QQuickAsyncImageProvider): void =
  fcQQuickAsyncImageProvider_operatorAssign(self.h, fromVal.h)
...
proc QQuickAsyncImageProviderrequestImage*(self: gen_qquickimageprovider_types.QQuickAsyncImageProvider, id: openArray[char], size: gen_qsize_types.QSize, requestedSize: gen_qsize_types.QSize): gen_qimage_types.QImage =
  gen_qimage_types.QImage(h: fcQQuickAsyncImageProvider_virtualbase_requestImage(self.h, struct_seaqt_string(data: if len(id) > 0: addr id[0] else: nil, len: csize_t(len(id))), size.h, requestedSize.h), owned: true)
...
proc QQuickAsyncImageProviderrequestPixmap*(self: gen_qquickimageprovider_types.QQuickAsyncImageProvider, id: openArray[char], size: gen_qsize_types.QSize, requestedSize: gen_qsize_types.QSize): gen_qpixmap_types.QPixmap =
  gen_qpixmap_types.QPixmap(h: fcQQuickAsyncImageProvider_virtualbase_requestPixmap(self.h, struct_seaqt_string(data: if len(id) > 0: addr id[0] else: nil, len: csize_t(len(id))), size.h, requestedSize.h), owned: true)
...
proc QQuickAsyncImageProviderrequestTexture*(self: gen_qquickimageprovider_types.QQuickAsyncImageProvider, id: openArray[char], size: gen_qsize_types.QSize, requestedSize: gen_qsize_types.QSize): gen_qquickimageprovider_types.QQuickTextureFactory =
  gen_qquickimageprovider_types.QQuickTextureFactory(h: fcQQuickAsyncImageProvider_virtualbase_requestTexture(self.h, struct_seaqt_string(data: if len(id) > 0: addr id[0] else: nil, len: csize_t(len(id))), size.h, requestedSize.h), owned: false)


proc fcQQuickAsyncImageProvider_vtable_callback_requestImageResponse(self: pointer, id: struct_seaqt_string, requestedSize: pointer): pointer {.cdecl.} =
...
proc fcQQuickAsyncImageProvider_vtable_callback_requestImage(self: pointer, id: struct_seaqt_string, size: pointer, requestedSize: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QQuickAsyncImageProviderVTable](fcQQuickAsyncImageProvider_vdata(self)[])
  let self = QQuickAsyncImageProvider(h: self)
  let vid_ms = id
  let vidx_ret = string.fromBytes(vid_ms)
...
proc fcQQuickAsyncImageProvider_vtable_callback_requestPixmap(self: pointer, id: struct_seaqt_string, size: pointer, requestedSize: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QQuickAsyncImageProviderVTable](fcQQuickAsyncImageProvider_vdata(self)[])
  let self = QQuickAsyncImageProvider(h: self)
  let vid_ms = id
  let vidx_ret = string.fromBytes(vid_ms)
...
proc fcQQuickAsyncImageProvider_vtable_callback_requestTexture(self: pointer, id: struct_seaqt_string, size: pointer, requestedSize: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QQuickAsyncImageProviderVTable](fcQQuickAsyncImageProvider_vdata(self)[])
  let self = QQuickAsyncImageProvider(h: self)
  let vid_ms = id
  let vidx_ret = string.fromBytes(vid_ms)
...
proc fcQQuickAsyncImageProvider_method_callback_requestImageResponse(self: pointer, id: struct_seaqt_string, requestedSize: pointer): pointer {.cdecl.} =
...
proc fcQQuickAsyncImageProvider_method_callback_requestImage(self: pointer, id: struct_seaqt_string, size: pointer, requestedSize: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQQuickAsyncImageProvider](fcQQuickAsyncImageProvider_vdata(self)[])
  let vid_ms = id
  let vidx_ret = string.fromBytes(vid_ms)
  c_free(vid_ms.data)
...
proc fcQQuickAsyncImageProvider_method_callback_requestPixmap(self: pointer, id: struct_seaqt_string, size: pointer, requestedSize: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQQuickAsyncImageProvider](fcQQuickAsyncImageProvider_vdata(self)[])
  let vid_ms = id
  let vidx_ret = string.fromBytes(vid_ms)
  c_free(vid_ms.data)
...
proc fcQQuickAsyncImageProvider_method_callback_requestTexture(self: pointer, id: struct_seaqt_string, size: pointer, requestedSize: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQQuickAsyncImageProvider](fcQQuickAsyncImageProvider_vdata(self)[])
  let vid_ms = id
  let vidx_ret = string.fromBytes(vid_ms)
  c_free(vid_ms.data)
...
proc create*(T: type gen_qquickimageprovider_types.QQuickAsyncImageProvider,
  ...
  let tmp = gen_qquickimageprovider_types.QQuickAsyncImageProvider(h: fcQQuickAsyncImageProvider_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQQuickAsyncImageProvider_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qquickimageprovider_types.QQuickAsyncImageProvider,
    fromVal: gen_qquickimageprovider_types.QQuickAsyncImageProvider,
    vtbl: ref QQuickAsyncImageProviderVTable = nil): gen_qquickimageprovider_types.QQuickAsyncImageProvider =
  let vtbl = if vtbl == nil: new QQuickAsyncImageProviderVTable else: vtbl
  GC_ref(vtbl)
  vtbl[].vtbl.destructor = proc(self: pointer) {.cdecl.} =
  ...
  if not isNil(vtbl[].requestTexture):
    vtbl[].vtbl.requestTexture = fcQQuickAsyncImageProvider_vtable_callback_requestTexture
  let tmp = gen_qquickimageprovider_types.QQuickAsyncImageProvider(h: fcQQuickAsyncImageProvider_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), fromVal.h), owned: true)
  fcQQuickAsyncImageProvider_vdata(tmp.h)[] = addr(vtbl[])
  tmp
...
proc create*(T: type gen_qquickimageprovider_types.QQuickAsyncImageProvider,
  ...
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQQuickAsyncImageProvider_new(addr(cQQuickAsyncImageProvider_mvtbl), csize_t(sizeof(pointer)))
  fcQQuickAsyncImageProvider_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qquickimageprovider_types.QQuickAsyncImageProvider,
    ...
    inst: VirtualQQuickAsyncImageProvider) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQQuickAsyncImageProvider_new2(addr(cQQuickAsyncImageProvider_mvtbl), csize_t(sizeof(pointer)), fromVal.h)
  fcQQuickAsyncImageProvider_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
