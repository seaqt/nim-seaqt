...
template MultiView2*(_: type QSGMaterialFlagEnum): untyped = 65536
template MultiView3*(_: type QSGMaterialFlagEnum): untyped = 131072
template MultiView4*(_: type QSGMaterialFlagEnum): untyped = 262144
...
proc fcQSGMaterial_viewCount(self: pointer): cint {.importc: "QSGMaterial_viewCount".}
...
proc viewCount*(self: gen_qsgmaterial_types.QSGMaterial): cint =
  fcQSGMaterial_viewCount(self.h)
