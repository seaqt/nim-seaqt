...
proc create*(T: type gen_qvector3d_types.QVector3D): gen_qvector3d_types.QVector3D =
  let tmp = gen_qvector3d_types.QVector3D(h: fcQVector3D_new(), owned: true)
  tmp
proc create*(T: type gen_qvector3d_types.QVector3D,
    param1: cint): gen_qvector3d_types.QVector3D =
  let tmp = gen_qvector3d_types.QVector3D(h: fcQVector3D_new2(cint(param1)), owned: true)
  tmp
proc create*(T: type gen_qvector3d_types.QVector3D,
    xpos: float32, ypos: float32, zpos: float32): gen_qvector3d_types.QVector3D =
  let tmp = gen_qvector3d_types.QVector3D(h: fcQVector3D_new3(xpos, ypos, zpos), owned: true)
  tmp
proc create*(T: type gen_qvector3d_types.QVector3D,
    point: gen_qpoint_types.QPoint): gen_qvector3d_types.QVector3D =
  let tmp = gen_qvector3d_types.QVector3D(h: fcQVector3D_new4(point.h), owned: true)
  tmp
proc create*(T: type gen_qvector3d_types.QVector3D,
    point: gen_qpoint_types.QPointF): gen_qvector3d_types.QVector3D =
  let tmp = gen_qvector3d_types.QVector3D(h: fcQVector3D_new5(point.h), owned: true)
  tmp
proc create*(T: type gen_qvector3d_types.QVector3D,
    vector: gen_qvector2d_types.QVector2D): gen_qvector3d_types.QVector3D =
  let tmp = gen_qvector3d_types.QVector3D(h: fcQVector3D_new6(vector.h), owned: true)
  tmp
proc create*(T: type gen_qvector3d_types.QVector3D,
    vector: gen_qvector2d_types.QVector2D, zpos: float32): gen_qvector3d_types.QVector3D =
  let tmp = gen_qvector3d_types.QVector3D(h: fcQVector3D_new7(vector.h, zpos), owned: true)
  tmp
proc create*(T: type gen_qvector3d_types.QVector3D,
