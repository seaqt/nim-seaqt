...
proc create*(T: type gen_qvector4d_types.QVector4D): gen_qvector4d_types.QVector4D =
  let tmp = gen_qvector4d_types.QVector4D(h: fcQVector4D_new(), owned: true)
  tmp
proc create*(T: type gen_qvector4d_types.QVector4D,
    param1: cint): gen_qvector4d_types.QVector4D =
  let tmp = gen_qvector4d_types.QVector4D(h: fcQVector4D_new2(cint(param1)), owned: true)
  tmp
proc create*(T: type gen_qvector4d_types.QVector4D,
    xpos: float32, ypos: float32, zpos: float32, wpos: float32): gen_qvector4d_types.QVector4D =
  let tmp = gen_qvector4d_types.QVector4D(h: fcQVector4D_new3(xpos, ypos, zpos, wpos), owned: true)
  tmp
proc create*(T: type gen_qvector4d_types.QVector4D,
    point: gen_qpoint_types.QPoint): gen_qvector4d_types.QVector4D =
  let tmp = gen_qvector4d_types.QVector4D(h: fcQVector4D_new4(point.h), owned: true)
  tmp
proc create*(T: type gen_qvector4d_types.QVector4D,
    point: gen_qpoint_types.QPointF): gen_qvector4d_types.QVector4D =
  let tmp = gen_qvector4d_types.QVector4D(h: fcQVector4D_new5(point.h), owned: true)
  tmp
proc create*(T: type gen_qvector4d_types.QVector4D,
    vector: gen_qvector2d_types.QVector2D): gen_qvector4d_types.QVector4D =
  let tmp = gen_qvector4d_types.QVector4D(h: fcQVector4D_new6(vector.h), owned: true)
  tmp
proc create*(T: type gen_qvector4d_types.QVector4D,
    vector: gen_qvector2d_types.QVector2D, zpos: float32, wpos: float32): gen_qvector4d_types.QVector4D =
  let tmp = gen_qvector4d_types.QVector4D(h: fcQVector4D_new7(vector.h, zpos, wpos), owned: true)
  tmp
proc create*(T: type gen_qvector4d_types.QVector4D,
    vector: gen_qvector3d_types.QVector3D): gen_qvector4d_types.QVector4D =
  let tmp = gen_qvector4d_types.QVector4D(h: fcQVector4D_new8(vector.h), owned: true)
  tmp
proc create*(T: type gen_qvector4d_types.QVector4D,
