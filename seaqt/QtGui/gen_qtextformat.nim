...
template FontFeatures*(_: type QTextFormatPropertyEnum): untyped = 8208
template FontVariableAxes*(_: type QTextFormatPropertyEnum): untyped = 8209
template LastFontProperty*(_: type QTextFormatPropertyEnum): untyped = 8209
...
template ListStart*(_: type QTextFormatPropertyEnum): untyped = 12292
...
template ImageMaxWidth*(_: type QTextFormatPropertyEnum): untyped = 20501
...
proc fcQTextLength_operatorAssign(self: pointer, fromVal: pointer): void {.importc: "QTextLength_operatorAssign".}
proc fcQTextLength_new(): ptr cQTextLength {.importc: "QTextLength_new".}
proc fcQTextLength_new2(typeVal: cint, value: float64): ptr cQTextLength {.importc: "QTextLength_new_type_value".}
proc fcQTextLength_new3(fromVal: pointer): ptr cQTextLength {.importc: "QTextLength_new_from".}
proc fcQTextFormat_operatorAssign(self: pointer, fromVal: pointer): void {.importc: "QTextFormat_operatorAssign".}
...
proc fcQTextFormat_setPropertyPropertyIdValue(self: pointer, propertyId: cint, value: pointer): void {.importc: "QTextFormat_setProperty_propertyId_value".}
...
proc fcQTextFormat_stringProperty(self: pointer, propertyId: cint): struct_seaqt_string {.importc: "QTextFormat_stringProperty".}
...
proc fcQTextFormat_lengthVectorProperty(self: pointer, propertyId: cint): struct_seaqt_array {.importc: "QTextFormat_lengthVectorProperty".}
proc fcQTextFormat_setPropertyPropertyIdLengths(self: pointer, propertyId: cint, lengths: struct_seaqt_array): void {.importc: "QTextFormat_setProperty_propertyId_lengths".}
proc fcQTextFormat_properties(self: pointer): struct_seaqt_map {.importc: "QTextFormat_properties".}
...
proc fcQTextFormat_new2(typeVal: cint): ptr cQTextFormat {.importc: "QTextFormat_new_type".}
proc fcQTextFormat_new3(fromVal: pointer): ptr cQTextFormat {.importc: "QTextFormat_new_from".}
...
proc fcQTextCharFormat_setFontFont(self: pointer, font: pointer): void {.importc: "QTextCharFormat_setFont_font".}
proc fcQTextCharFormat_font(self: pointer): pointer {.importc: "QTextCharFormat_font".}
proc fcQTextCharFormat_setFontFamily(self: pointer, family: struct_seaqt_string): void {.importc: "QTextCharFormat_setFontFamily".}
proc fcQTextCharFormat_fontFamily(self: pointer): struct_seaqt_string {.importc: "QTextCharFormat_fontFamily".}
proc fcQTextCharFormat_setFontFamilies(self: pointer, families: struct_seaqt_array): void {.importc: "QTextCharFormat_setFontFamilies".}
proc fcQTextCharFormat_fontFamilies(self: pointer): pointer {.importc: "QTextCharFormat_fontFamilies".}
proc fcQTextCharFormat_setFontStyleName(self: pointer, styleName: struct_seaqt_string): void {.importc: "QTextCharFormat_setFontStyleName".}
...
proc fcQTextCharFormat_setFontStyleHintHint(self: pointer, hint: cint): void {.importc: "QTextCharFormat_setFontStyleHint_hint".}
...
proc fcQTextCharFormat_setFontFeatures(self: pointer, fontFeatures: struct_seaqt_map): void {.importc: "QTextCharFormat_setFontFeatures".}
proc fcQTextCharFormat_fontFeatures(self: pointer): struct_seaqt_map {.importc: "QTextCharFormat_fontFeatures".}
proc fcQTextCharFormat_setFontVariableAxes(self: pointer, fontVariableAxes: struct_seaqt_map): void {.importc: "QTextCharFormat_setFontVariableAxes".}
proc fcQTextCharFormat_fontVariableAxes(self: pointer): struct_seaqt_map {.importc: "QTextCharFormat_fontVariableAxes".}
...
proc fcQTextCharFormat_setToolTip(self: pointer, tip: struct_seaqt_string): void {.importc: "QTextCharFormat_setToolTip".}
proc fcQTextCharFormat_toolTip(self: pointer): struct_seaqt_string {.importc: "QTextCharFormat_toolTip".}
...
proc fcQTextCharFormat_setAnchorHref(self: pointer, value: struct_seaqt_string): void {.importc: "QTextCharFormat_setAnchorHref".}
proc fcQTextCharFormat_anchorHref(self: pointer): struct_seaqt_string {.importc: "QTextCharFormat_anchorHref".}
proc fcQTextCharFormat_setAnchorNames(self: pointer, names: struct_seaqt_array): void {.importc: "QTextCharFormat_setAnchorNames".}
proc fcQTextCharFormat_anchorNames(self: pointer): struct_seaqt_array {.importc: "QTextCharFormat_anchorNames".}
...
proc fcQTextCharFormat_operatorAssign(self: pointer, fromVal: pointer): void {.importc: "QTextCharFormat_operatorAssign".}
proc fcQTextCharFormat_setFontFontBehavior(self: pointer, font: pointer, behavior: cint): void {.importc: "QTextCharFormat_setFont_font_behavior".}
proc fcQTextCharFormat_setFontStyleHintHintStrategy(self: pointer, hint: cint, strategy: cint): void {.importc: "QTextCharFormat_setFontStyleHint_hint_strategy".}
proc fcQTextCharFormat_new(): ptr cQTextCharFormat {.importc: "QTextCharFormat_new".}
proc fcQTextCharFormat_new2(fromVal: pointer): ptr cQTextCharFormat {.importc: "QTextCharFormat_new_from".}
...
proc fcQTextBlockFormat_lineHeightScriptLineHeightScaling(self: pointer, scriptLineHeight: float64, scaling: float64): float64 {.importc: "QTextBlockFormat_lineHeight_scriptLineHeight_scaling".}
proc fcQTextBlockFormat_lineHeight(self: pointer): float64 {.importc: "QTextBlockFormat_lineHeight".}
...
proc fcQTextBlockFormat_setTabPositions(self: pointer, tabs: struct_seaqt_array): void {.importc: "QTextBlockFormat_setTabPositions".}
proc fcQTextBlockFormat_tabPositions(self: pointer): struct_seaqt_array {.importc: "QTextBlockFormat_tabPositions".}
...
proc fcQTextBlockFormat_operatorAssign(self: pointer, fromVal: pointer): void {.importc: "QTextBlockFormat_operatorAssign".}
proc fcQTextBlockFormat_new(): ptr cQTextBlockFormat {.importc: "QTextBlockFormat_new".}
proc fcQTextBlockFormat_new2(fromVal: pointer): ptr cQTextBlockFormat {.importc: "QTextBlockFormat_new_from".}
...
proc fcQTextListFormat_setNumberPrefix(self: pointer, numberPrefix: struct_seaqt_string): void {.importc: "QTextListFormat_setNumberPrefix".}
proc fcQTextListFormat_numberPrefix(self: pointer): struct_seaqt_string {.importc: "QTextListFormat_numberPrefix".}
proc fcQTextListFormat_setNumberSuffix(self: pointer, numberSuffix: struct_seaqt_string): void {.importc: "QTextListFormat_setNumberSuffix".}
proc fcQTextListFormat_numberSuffix(self: pointer): struct_seaqt_string {.importc: "QTextListFormat_numberSuffix".}
proc fcQTextListFormat_setStart(self: pointer, indent: cint): void {.importc: "QTextListFormat_setStart".}
proc fcQTextListFormat_start(self: pointer): cint {.importc: "QTextListFormat_start".}
proc fcQTextListFormat_operatorAssign(self: pointer, fromVal: pointer): void {.importc: "QTextListFormat_operatorAssign".}
proc fcQTextListFormat_new(): ptr cQTextListFormat {.importc: "QTextListFormat_new".}
proc fcQTextListFormat_new2(fromVal: pointer): ptr cQTextListFormat {.importc: "QTextListFormat_new_from".}
proc fcQTextImageFormat_isValid(self: pointer): bool {.importc: "QTextImageFormat_isValid".}
proc fcQTextImageFormat_setName(self: pointer, name: struct_seaqt_string): void {.importc: "QTextImageFormat_setName".}
proc fcQTextImageFormat_name(self: pointer): struct_seaqt_string {.importc: "QTextImageFormat_name".}
...
proc fcQTextImageFormat_setMaximumWidth(self: pointer, maxWidth: pointer): void {.importc: "QTextImageFormat_setMaximumWidth".}
proc fcQTextImageFormat_maximumWidth(self: pointer): pointer {.importc: "QTextImageFormat_maximumWidth".}
...
proc fcQTextImageFormat_setQualityQuality(self: pointer, quality: cint): void {.importc: "QTextImageFormat_setQuality_quality".}
...
proc fcQTextImageFormat_new2(fromVal: pointer): ptr cQTextImageFormat {.importc: "QTextImageFormat_new_from".}
...
proc fcQTextFrameFormat_setWidthWidth(self: pointer, width: float64): void {.importc: "QTextFrameFormat_setWidth_width".}
proc fcQTextFrameFormat_setWidthLength(self: pointer, length: pointer): void {.importc: "QTextFrameFormat_setWidth_length".}
proc fcQTextFrameFormat_width(self: pointer): pointer {.importc: "QTextFrameFormat_width".}
proc fcQTextFrameFormat_setHeightQreal(self: pointer, height: float64): void {.importc: "QTextFrameFormat_setHeight_qreal".}
proc fcQTextFrameFormat_setHeight_QTextLength(self: pointer, height: pointer): void {.importc: "QTextFrameFormat_setHeight_QTextLength".}
...
proc fcQTextFrameFormat_operatorAssign(self: pointer, fromVal: pointer): void {.importc: "QTextFrameFormat_operatorAssign".}
proc fcQTextFrameFormat_new(): ptr cQTextFrameFormat {.importc: "QTextFrameFormat_new".}
proc fcQTextFrameFormat_new2(fromVal: pointer): ptr cQTextFrameFormat {.importc: "QTextFrameFormat_new_from".}
...
proc fcQTextTableFormat_setColumnWidthConstraints(self: pointer, constraints: struct_seaqt_array): void {.importc: "QTextTableFormat_setColumnWidthConstraints".}
proc fcQTextTableFormat_columnWidthConstraints(self: pointer): struct_seaqt_array {.importc: "QTextTableFormat_columnWidthConstraints".}
...
proc fcQTextTableFormat_new2(fromVal: pointer): ptr cQTextTableFormat {.importc: "QTextTableFormat_new_from".}
...
proc fcQTextTableCellFormat_new2(fromVal: pointer): ptr cQTextTableCellFormat {.importc: "QTextTableCellFormat_new_from".}
...
proc operatorAssign*(self: gen_qtextformat_types.QTextLength, fromVal: gen_qtextformat_types.QTextLength): void =
  fcQTextLength_operatorAssign(self.h, fromVal.h)

proc create*(T: type gen_qtextformat_types.QTextLength): gen_qtextformat_types.QTextLength =
  let tmp = gen_qtextformat_types.QTextLength(h: fcQTextLength_new(), owned: true)
  tmp
proc create*(T: type gen_qtextformat_types.QTextLength,
    typeVal: cint, value: float64): gen_qtextformat_types.QTextLength =
  let tmp = gen_qtextformat_types.QTextLength(h: fcQTextLength_new2(cint(typeVal), value), owned: true)
  tmp
proc create*(T: type gen_qtextformat_types.QTextLength,
    fromVal: gen_qtextformat_types.QTextLength): gen_qtextformat_types.QTextLength =
  let tmp = gen_qtextformat_types.QTextLength(h: fcQTextLength_new3(fromVal.h), owned: true)
  tmp
proc operatorAssign*(self: gen_qtextformat_types.QTextFormat, fromVal: gen_qtextformat_types.QTextFormat): void =
  fcQTextFormat_operatorAssign(self.h, fromVal.h)
...
proc setProperty*(self: gen_qtextformat_types.QTextFormat, propertyId: cint, value: gen_qvariant_types.QVariant): void =
  fcQTextFormat_setPropertyPropertyIdValue(self.h, propertyId, value.h)
...
proc setProperty*(self: gen_qtextformat_types.QTextFormat, propertyId: cint, lengths: openArray[gen_qtextformat_types.QTextLength]): void =
  ...
  fcQTextFormat_setPropertyPropertyIdLengths(self.h, propertyId, struct_seaqt_array(len: csize_t(len(lengths)), data: if len(lengths) == 0: nil else: addr(lengths_CArray[0])))
...
proc create*(T: type gen_qtextformat_types.QTextFormat): gen_qtextformat_types.QTextFormat =
  let tmp = gen_qtextformat_types.QTextFormat(h: fcQTextFormat_new(), owned: true)
  tmp
proc create*(T: type gen_qtextformat_types.QTextFormat,
    typeVal: cint): gen_qtextformat_types.QTextFormat =
  let tmp = gen_qtextformat_types.QTextFormat(h: fcQTextFormat_new2(typeVal), owned: true)
  tmp
proc create*(T: type gen_qtextformat_types.QTextFormat,
    fromVal: gen_qtextformat_types.QTextFormat): gen_qtextformat_types.QTextFormat =
  let tmp = gen_qtextformat_types.QTextFormat(h: fcQTextFormat_new3(fromVal.h), owned: true)
  tmp
...
proc setFont*(self: gen_qtextformat_types.QTextCharFormat, font: gen_qfont_types.QFont): void =
  fcQTextCharFormat_setFontFont(self.h, font.h)
...
proc setFontFamily*(self: gen_qtextformat_types.QTextCharFormat, family: openArray[char]): void =
  fcQTextCharFormat_setFontFamily(self.h, struct_seaqt_string(data: if len(family) > 0: addr family[0] else: nil, len: csize_t(len(family))))
...
proc setFontFamilies*(self: gen_qtextformat_types.QTextCharFormat, families: openArray[string]): void =
  var families_CArray = newSeq[struct_seaqt_string](len(families))
  ...
  fcQTextCharFormat_setFontFamilies(self.h, struct_seaqt_array(len: csize_t(len(families)), data: if len(families) == 0: nil else: addr(families_CArray[0])))
...
proc setFontStyleName*(self: gen_qtextformat_types.QTextCharFormat, styleName: openArray[char]): void =
  fcQTextCharFormat_setFontStyleName(self.h, struct_seaqt_string(data: if len(styleName) > 0: addr styleName[0] else: nil, len: csize_t(len(styleName))))
...
proc setFontStyleHint*(self: gen_qtextformat_types.QTextCharFormat, hint: cint): void =
  fcQTextCharFormat_setFontStyleHintHint(self.h, cint(hint))
...
proc setFontFeatures*(self: gen_qtextformat_types.QTextCharFormat, fontFeatures: Table[gen_qfont_types.QFontTag,cuint]): void =
  var fontFeatures_Keys_CArray = newSeq[pointer](len(fontFeatures))
  var fontFeatures_Values_CArray = newSeq[cuint](len(fontFeatures))
  var fontFeatures_ctr = 0
  for fontFeatures_k in fontFeatures.keys():
    fontFeatures_Keys_CArray[fontFeatures_ctr] = fontFeatures_k.h
    fontFeatures_ctr += 1
  fontFeatures_ctr = 0
  for fontFeatures_v in fontFeatures.values():
    fontFeatures_Values_CArray[fontFeatures_ctr] = fontFeatures_v
    fontFeatures_ctr += 1

  fcQTextCharFormat_setFontFeatures(self.h, struct_seaqt_map(len: csize_t(len(fontFeatures)),keys: if len(fontFeatures) == 0: nil else: addr(fontFeatures_Keys_CArray[0]), values: if len(fontFeatures) == 0: nil else: addr(fontFeatures_Values_CArray[0]),))

proc fontFeatures*(self: gen_qtextformat_types.QTextCharFormat): Table[gen_qfont_types.QFontTag,cuint] =
  var v_mm = fcQTextCharFormat_fontFeatures(self.h)
  var vx_ret: Table[gen_qfont_types.QFontTag, cuint]
  var v_Keys = cast[ptr UncheckedArray[pointer]](v_mm.keys)
  var v_Values = cast[ptr UncheckedArray[cuint]](v_mm.values)
  for i in 0..<v_mm.len:
    var v_entry_Key = gen_qfont_types.QFontTag(h: v_Keys[i], owned: true)

    var v_entry_Value = v_Values[i]
...
proc setFontVariableAxes*(self: gen_qtextformat_types.QTextCharFormat, fontVariableAxes: Table[gen_qfont_types.QFontTag,float32]): void =
  var fontVariableAxes_Keys_CArray = newSeq[pointer](len(fontVariableAxes))
  var fontVariableAxes_Values_CArray = newSeq[float32](len(fontVariableAxes))
  var fontVariableAxes_ctr = 0
  for fontVariableAxes_k in fontVariableAxes.keys():
    fontVariableAxes_Keys_CArray[fontVariableAxes_ctr] = fontVariableAxes_k.h
    fontVariableAxes_ctr += 1
  fontVariableAxes_ctr = 0
  for fontVariableAxes_v in fontVariableAxes.values():
    fontVariableAxes_Values_CArray[fontVariableAxes_ctr] = fontVariableAxes_v
    fontVariableAxes_ctr += 1

  fcQTextCharFormat_setFontVariableAxes(self.h, struct_seaqt_map(len: csize_t(len(fontVariableAxes)),keys: if len(fontVariableAxes) == 0: nil else: addr(fontVariableAxes_Keys_CArray[0]), values: if len(fontVariableAxes) == 0: nil else: addr(fontVariableAxes_Values_CArray[0]),))

proc fontVariableAxes*(self: gen_qtextformat_types.QTextCharFormat): Table[gen_qfont_types.QFontTag,float32] =
  var v_mm = fcQTextCharFormat_fontVariableAxes(self.h)
  var vx_ret: Table[gen_qfont_types.QFontTag, float32]
  var v_Keys = cast[ptr UncheckedArray[pointer]](v_mm.keys)
  var v_Values = cast[ptr UncheckedArray[float32]](v_mm.values)
  for i in 0..<v_mm.len:
    var v_entry_Key = gen_qfont_types.QFontTag(h: v_Keys[i], owned: true)
...
proc setToolTip*(self: gen_qtextformat_types.QTextCharFormat, tip: openArray[char]): void =
  fcQTextCharFormat_setToolTip(self.h, struct_seaqt_string(data: if len(tip) > 0: addr tip[0] else: nil, len: csize_t(len(tip))))
...
proc setAnchorHref*(self: gen_qtextformat_types.QTextCharFormat, value: openArray[char]): void =
  fcQTextCharFormat_setAnchorHref(self.h, struct_seaqt_string(data: if len(value) > 0: addr value[0] else: nil, len: csize_t(len(value))))
...
proc setAnchorNames*(self: gen_qtextformat_types.QTextCharFormat, names: openArray[string]): void =
  var names_CArray = newSeq[struct_seaqt_string](len(names))
  for i in 0..<len(names):
    names_CArray[i] = struct_seaqt_string(data: if len(names[i]) > 0: addr names[i][0] else: nil, len: csize_t(len(names[i])))

  fcQTextCharFormat_setAnchorNames(self.h, struct_seaqt_array(len: csize_t(len(names)), data: if len(names) == 0: nil else: addr(names_CArray[0])))
...
proc operatorAssign*(self: gen_qtextformat_types.QTextCharFormat, fromVal: gen_qtextformat_types.QTextCharFormat): void =
  fcQTextCharFormat_operatorAssign(self.h, fromVal.h)

proc setFont*(self: gen_qtextformat_types.QTextCharFormat, font: gen_qfont_types.QFont, behavior: cint): void =
  fcQTextCharFormat_setFontFontBehavior(self.h, font.h, cint(behavior))

proc setFontStyleHint*(self: gen_qtextformat_types.QTextCharFormat, hint: cint, strategy: cint): void =
  fcQTextCharFormat_setFontStyleHintHintStrategy(self.h, cint(hint), cint(strategy))

proc create*(T: type gen_qtextformat_types.QTextCharFormat): gen_qtextformat_types.QTextCharFormat =
  let tmp = gen_qtextformat_types.QTextCharFormat(h: fcQTextCharFormat_new(), owned: true)
  tmp
proc create*(T: type gen_qtextformat_types.QTextCharFormat,
    fromVal: gen_qtextformat_types.QTextCharFormat): gen_qtextformat_types.QTextCharFormat =
  let tmp = gen_qtextformat_types.QTextCharFormat(h: fcQTextCharFormat_new2(fromVal.h), owned: true)
  tmp
...
proc lineHeight*(self: gen_qtextformat_types.QTextBlockFormat, scriptLineHeight: float64, scaling: float64): float64 =
  fcQTextBlockFormat_lineHeightScriptLineHeightScaling(self.h, scriptLineHeight, scaling)

proc lineHeight*(self: gen_qtextformat_types.QTextBlockFormat): float64 =
  fcQTextBlockFormat_lineHeight(self.h)
...
proc setTabPositions*(self: gen_qtextformat_types.QTextBlockFormat, tabs: openArray[gen_qtextoption_types.QTextOptionTab]): void =
  ...
  fcQTextBlockFormat_setTabPositions(self.h, struct_seaqt_array(len: csize_t(len(tabs)), data: if len(tabs) == 0: nil else: addr(tabs_CArray[0])))
...
proc operatorAssign*(self: gen_qtextformat_types.QTextBlockFormat, fromVal: gen_qtextformat_types.QTextBlockFormat): void =
  fcQTextBlockFormat_operatorAssign(self.h, fromVal.h)

proc create*(T: type gen_qtextformat_types.QTextBlockFormat): gen_qtextformat_types.QTextBlockFormat =
  let tmp = gen_qtextformat_types.QTextBlockFormat(h: fcQTextBlockFormat_new(), owned: true)
  tmp
proc create*(T: type gen_qtextformat_types.QTextBlockFormat,
    fromVal: gen_qtextformat_types.QTextBlockFormat): gen_qtextformat_types.QTextBlockFormat =
  let tmp = gen_qtextformat_types.QTextBlockFormat(h: fcQTextBlockFormat_new2(fromVal.h), owned: true)
  tmp
...
proc setNumberPrefix*(self: gen_qtextformat_types.QTextListFormat, numberPrefix: openArray[char]): void =
  fcQTextListFormat_setNumberPrefix(self.h, struct_seaqt_string(data: if len(numberPrefix) > 0: addr numberPrefix[0] else: nil, len: csize_t(len(numberPrefix))))
...
proc setNumberSuffix*(self: gen_qtextformat_types.QTextListFormat, numberSuffix: openArray[char]): void =
  fcQTextListFormat_setNumberSuffix(self.h, struct_seaqt_string(data: if len(numberSuffix) > 0: addr numberSuffix[0] else: nil, len: csize_t(len(numberSuffix))))
...
proc setStart*(self: gen_qtextformat_types.QTextListFormat, indent: cint): void =
  fcQTextListFormat_setStart(self.h, indent)

proc start*(self: gen_qtextformat_types.QTextListFormat): cint =
  fcQTextListFormat_start(self.h)

proc operatorAssign*(self: gen_qtextformat_types.QTextListFormat, fromVal: gen_qtextformat_types.QTextListFormat): void =
  fcQTextListFormat_operatorAssign(self.h, fromVal.h)

proc create*(T: type gen_qtextformat_types.QTextListFormat): gen_qtextformat_types.QTextListFormat =
  let tmp = gen_qtextformat_types.QTextListFormat(h: fcQTextListFormat_new(), owned: true)
  tmp
proc create*(T: type gen_qtextformat_types.QTextListFormat,
    fromVal: gen_qtextformat_types.QTextListFormat): gen_qtextformat_types.QTextListFormat =
  let tmp = gen_qtextformat_types.QTextListFormat(h: fcQTextListFormat_new2(fromVal.h), owned: true)
  tmp
...
proc setName*(self: gen_qtextformat_types.QTextImageFormat, name: openArray[char]): void =
  fcQTextImageFormat_setName(self.h, struct_seaqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name))))
...
proc setMaximumWidth*(self: gen_qtextformat_types.QTextImageFormat, maxWidth: gen_qtextformat_types.QTextLength): void =
  fcQTextImageFormat_setMaximumWidth(self.h, maxWidth.h)

proc maximumWidth*(self: gen_qtextformat_types.QTextImageFormat): gen_qtextformat_types.QTextLength =
  gen_qtextformat_types.QTextLength(h: fcQTextImageFormat_maximumWidth(self.h), owned: true)
...
proc setQuality*(self: gen_qtextformat_types.QTextImageFormat, quality: cint): void =
  fcQTextImageFormat_setQualityQuality(self.h, quality)
...
proc create*(T: type gen_qtextformat_types.QTextImageFormat): gen_qtextformat_types.QTextImageFormat =
  let tmp = gen_qtextformat_types.QTextImageFormat(h: fcQTextImageFormat_new(), owned: true)
  tmp
proc create*(T: type gen_qtextformat_types.QTextImageFormat,
    fromVal: gen_qtextformat_types.QTextImageFormat): gen_qtextformat_types.QTextImageFormat =
  let tmp = gen_qtextformat_types.QTextImageFormat(h: fcQTextImageFormat_new2(fromVal.h), owned: true)
  tmp
...
proc operatorAssign*(self: gen_qtextformat_types.QTextFrameFormat, fromVal: gen_qtextformat_types.QTextFrameFormat): void =
  fcQTextFrameFormat_operatorAssign(self.h, fromVal.h)

proc create*(T: type gen_qtextformat_types.QTextFrameFormat): gen_qtextformat_types.QTextFrameFormat =
  let tmp = gen_qtextformat_types.QTextFrameFormat(h: fcQTextFrameFormat_new(), owned: true)
  tmp
proc create*(T: type gen_qtextformat_types.QTextFrameFormat,
    fromVal: gen_qtextformat_types.QTextFrameFormat): gen_qtextformat_types.QTextFrameFormat =
  let tmp = gen_qtextformat_types.QTextFrameFormat(h: fcQTextFrameFormat_new2(fromVal.h), owned: true)
  tmp
...
proc setColumnWidthConstraints*(self: gen_qtextformat_types.QTextTableFormat, constraints: openArray[gen_qtextformat_types.QTextLength]): void =
  ...
  fcQTextTableFormat_setColumnWidthConstraints(self.h, struct_seaqt_array(len: csize_t(len(constraints)), data: if len(constraints) == 0: nil else: addr(constraints_CArray[0])))
...
proc create*(T: type gen_qtextformat_types.QTextTableFormat): gen_qtextformat_types.QTextTableFormat =
  let tmp = gen_qtextformat_types.QTextTableFormat(h: fcQTextTableFormat_new(), owned: true)
  tmp
proc create*(T: type gen_qtextformat_types.QTextTableFormat,
    fromVal: gen_qtextformat_types.QTextTableFormat): gen_qtextformat_types.QTextTableFormat =
  let tmp = gen_qtextformat_types.QTextTableFormat(h: fcQTextTableFormat_new2(fromVal.h), owned: true)
  tmp
...
proc create*(T: type gen_qtextformat_types.QTextTableCellFormat): gen_qtextformat_types.QTextTableCellFormat =
  let tmp = gen_qtextformat_types.QTextTableCellFormat(h: fcQTextTableCellFormat_new(), owned: true)
  tmp
proc create*(T: type gen_qtextformat_types.QTextTableCellFormat,
    fromVal: gen_qtextformat_types.QTextTableCellFormat): gen_qtextformat_types.QTextTableCellFormat =
  let tmp = gen_qtextformat_types.QTextTableCellFormat(h: fcQTextTableCellFormat_new2(fromVal.h), owned: true)
  tmp
