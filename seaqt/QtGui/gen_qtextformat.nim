...
proc fcQTextCharFormat_setAnchorName(self: pointer, name: struct_seaqt_string): void {.importc: "QTextCharFormat_setAnchorName".}
proc fcQTextCharFormat_anchorName(self: pointer): struct_seaqt_string {.importc: "QTextCharFormat_anchorName".}
...
proc setAnchorName*(self: gen_qtextformat_types.QTextCharFormat, name: openArray[char]): void =
  fcQTextCharFormat_setAnchorName(self.h, struct_seaqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name))))
