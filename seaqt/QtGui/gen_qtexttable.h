...
const QTextTable_VTable* QTextTable_vtbl(const VirtualQTextTable* self);
void* QTextTable_vdata(const VirtualQTextTable* self);
void QTextTable_setVdata(VirtualQTextTable* self, void* vdata);
