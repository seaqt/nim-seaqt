...
proc create*(T: type gen_qvector2d_types.QVector2D): gen_qvector2d_types.QVector2D =
  let tmp = gen_qvector2d_types.QVector2D(h: fcQVector2D_new(), owned: true)
  tmp
proc create*(T: type gen_qvector2d_types.QVector2D,
    param1: cint): gen_qvector2d_types.QVector2D =
  let tmp = gen_qvector2d_types.QVector2D(h: fcQVector2D_new2(cint(param1)), owned: true)
  tmp
proc create*(T: type gen_qvector2d_types.QVector2D,
    xpos: float32, ypos: float32): gen_qvector2d_types.QVector2D =
  let tmp = gen_qvector2d_types.QVector2D(h: fcQVector2D_new3(xpos, ypos), owned: true)
  tmp
proc create*(T: type gen_qvector2d_types.QVector2D,
    point: gen_qpoint_types.QPoint): gen_qvector2d_types.QVector2D =
  let tmp = gen_qvector2d_types.QVector2D(h: fcQVector2D_new4(point.h), owned: true)
  tmp
proc create*(T: type gen_qvector2d_types.QVector2D,
    point: gen_qpoint_types.QPointF): gen_qvector2d_types.QVector2D =
  let tmp = gen_qvector2d_types.QVector2D(h: fcQVector2D_new5(point.h), owned: true)
  tmp
proc create*(T: type gen_qvector2d_types.QVector2D,
    vector: gen_qvector3d_types.QVector3D): gen_qvector2d_types.QVector2D =
  let tmp = gen_qvector2d_types.QVector2D(h: fcQVector2D_new6(vector.h), owned: true)
  tmp
proc create*(T: type gen_qvector2d_types.QVector2D,
