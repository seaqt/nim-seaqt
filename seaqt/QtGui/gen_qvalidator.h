...
typedef struct QDoubleValidator_VTable{
	...
	void (*fixup)(const VirtualQDoubleValidator* self, struct miqt_string param1);
...
typedef struct QRegExpValidator_VTable{
	...
	int (*validate)(const VirtualQRegExpValidator* self, struct miqt_string input, int* pos);
	void (*fixup)(const VirtualQRegExpValidator* self, struct miqt_string param1);
...
const QRegExpValidator_VTable* QRegExpValidator_vtbl(const VirtualQRegExpValidator* self);
void* QRegExpValidator_vdata(const VirtualQRegExpValidator* self);
void QRegExpValidator_setVdata(VirtualQRegExpValidator* self, void* vdata);
