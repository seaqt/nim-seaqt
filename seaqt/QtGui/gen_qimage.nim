...
proc fcQImage_vtbl(self: pointer): pointer {.importc: "QImage_vtbl".}
proc fcQImage_vdata(self: pointer): pointer {.importc: "QImage_vdata".}
...
proc fcQImage_new(vtbl, vdata: pointer): ptr cQImage {.importc: "QImage_new".}
proc fcQImage_new2(vtbl, vdata: pointer, size: pointer, format: cint): ptr cQImage {.importc: "QImage_new2".}
proc fcQImage_new3(vtbl, vdata: pointer, width: cint, height: cint, format: cint): ptr cQImage {.importc: "QImage_new3".}
proc fcQImage_new4(vtbl, vdata: pointer, data: ptr uint8, width: cint, height: cint, format: cint): ptr cQImage {.importc: "QImage_new4".}
proc fcQImage_new5(vtbl, vdata: pointer, data: ptr uint8, width: cint, height: cint, format: cint): ptr cQImage {.importc: "QImage_new5".}
proc fcQImage_new6(vtbl, vdata: pointer, data: ptr uint8, width: cint, height: cint, bytesPerLine: int64, format: cint): ptr cQImage {.importc: "QImage_new6".}
proc fcQImage_new7(vtbl, vdata: pointer, data: ptr uint8, width: cint, height: cint, bytesPerLine: int64, format: cint): ptr cQImage {.importc: "QImage_new7".}
proc fcQImage_new8(vtbl, vdata: pointer, fileName: struct_miqt_string): ptr cQImage {.importc: "QImage_new8".}
proc fcQImage_new9(vtbl, vdata: pointer, param1: pointer): ptr cQImage {.importc: "QImage_new9".}
proc fcQImage_new10(vtbl, vdata: pointer, fileName: struct_miqt_string, format: cstring): ptr cQImage {.importc: "QImage_new10".}
...
proc convertToFormat*(self: gen_qimage_types.QImage, f: cint, colorTable: openArray[cuint]): gen_qimage_types.QImage =
  ...
  gen_qimage_types.QImage(h: fcQImage_convertToFormat2(self.h, cint(f), struct_miqt_array(len: csize_t(len(colorTable)), data: if len(colorTable) == 0: nil else: addr(colorTable_CArray[0]))), owned: true)
...
proc loadFromData*(self: gen_qimage_types.QImage, data: openArray[byte]): bool =
  fcQImage_loadFromData(self.h, struct_miqt_string(data: cast[cstring](if len(data) == 0: nil else: unsafeAddr data[0]), len: csize_t(len(data))))
...
proc fromData*(_: type gen_qimage_types.QImage, data: openArray[byte]): gen_qimage_types.QImage =
  gen_qimage_types.QImage(h: fcQImage_fromData(struct_miqt_string(data: cast[cstring](if len(data) == 0: nil else: unsafeAddr data[0]), len: csize_t(len(data)))), owned: true)
...
proc fromData2*(_: type gen_qimage_types.QImage, data: openArray[byte]): gen_qimage_types.QImage =
  gen_qimage_types.QImage(h: fcQImage_fromDataWithData(struct_miqt_string(data: cast[cstring](if len(data) == 0: nil else: unsafeAddr data[0]), len: csize_t(len(data)))), owned: true)
...
proc copy*(self: gen_qimage_types.QImage, rect: gen_qrect_types.QRect): gen_qimage_types.QImage =
  gen_qimage_types.QImage(h: fcQImage_copy1(self.h, rect.h), owned: true)
...
proc convertToFormat*(self: gen_qimage_types.QImage, f: cint, colorTable: openArray[cuint], flags: cint): gen_qimage_types.QImage =
  ...
  gen_qimage_types.QImage(h: fcQImage_convertToFormat3(self.h, cint(f), struct_miqt_array(len: csize_t(len(colorTable)), data: if len(colorTable) == 0: nil else: addr(colorTable_CArray[0])), cint(flags)), owned: true)
...
proc createAlphaMask*(self: gen_qimage_types.QImage, flags: cint): gen_qimage_types.QImage =
  gen_qimage_types.QImage(h: fcQImage_createAlphaMask1(self.h, cint(flags)), owned: true)

proc createHeuristicMask*(self: gen_qimage_types.QImage, clipTight: bool): gen_qimage_types.QImage =
  gen_qimage_types.QImage(h: fcQImage_createHeuristicMask1(self.h, clipTight), owned: true)
...
proc scaled*(self: gen_qimage_types.QImage, w: cint, h: cint, aspectMode: cint): gen_qimage_types.QImage =
  gen_qimage_types.QImage(h: fcQImage_scaled3(self.h, w, h, cint(aspectMode)), owned: true)

proc scaled*(self: gen_qimage_types.QImage, w: cint, h: cint, aspectMode: cint, mode: cint): gen_qimage_types.QImage =
  gen_qimage_types.QImage(h: fcQImage_scaled4(self.h, w, h, cint(aspectMode), cint(mode)), owned: true)

proc scaled*(self: gen_qimage_types.QImage, s: gen_qsize_types.QSize, aspectMode: cint): gen_qimage_types.QImage =
  gen_qimage_types.QImage(h: fcQImage_scaled2(self.h, s.h, cint(aspectMode)), owned: true)

proc scaled*(self: gen_qimage_types.QImage, s: gen_qsize_types.QSize, aspectMode: cint, mode: cint): gen_qimage_types.QImage =
  gen_qimage_types.QImage(h: fcQImage_scaled32(self.h, s.h, cint(aspectMode), cint(mode)), owned: true)
...
proc mirrored*(self: gen_qimage_types.QImage, horizontally: bool): gen_qimage_types.QImage =
  gen_qimage_types.QImage(h: fcQImage_mirrored1(self.h, horizontally), owned: true)
...
proc loadFromData*(self: gen_qimage_types.QImage, data: openArray[byte], format: cstring): bool =
  fcQImage_loadFromData22(self.h, struct_miqt_string(data: cast[cstring](if len(data) == 0: nil else: unsafeAddr data[0]), len: csize_t(len(data))), format)
...
proc fromData*(_: type gen_qimage_types.QImage, data: openArray[byte], format: cstring): gen_qimage_types.QImage =
  gen_qimage_types.QImage(h: fcQImage_fromData22(struct_miqt_string(data: cast[cstring](if len(data) == 0: nil else: unsafeAddr data[0]), len: csize_t(len(data))), format), owned: true)
...
proc fromData2*(_: type gen_qimage_types.QImage, data: openArray[byte], format: cstring): gen_qimage_types.QImage =
  gen_qimage_types.QImage(h: fcQImage_fromData23(struct_miqt_string(data: cast[cstring](if len(data) == 0: nil else: unsafeAddr data[0]), len: csize_t(len(data))), format), owned: true)
...
proc cQImage_vtable_callback_devType(self: pointer): cint {.cdecl.} =
...
proc cQImage_vtable_callback_paintEngine(self: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QImageVTable](fcQImage_vdata(self))
  let self = QImage(h: self)
...
proc cQImage_vtable_callback_metric(self: pointer, metric: cint): cint {.cdecl.} =
  let vtbl = cast[ptr QImageVTable](fcQImage_vdata(self))
  let self = QImage(h: self)
...
proc cQImage_vtable_callback_initPainter(self: pointer, painter: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QImageVTable](fcQImage_vdata(self))
  let self = QImage(h: self)
...
proc cQImage_vtable_callback_redirected(self: pointer, offset: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QImageVTable](fcQImage_vdata(self))
  let self = QImage(h: self)
...
proc cQImage_vtable_callback_sharedPainter(self: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QImageVTable](fcQImage_vdata(self))
  let self = QImage(h: self)
...
method devType*(self: VirtualQImage): cint {.base.} =
  QImagedevType(self[])
proc cQImage_method_callback_devType(self: pointer): cint {.cdecl.} =
...
proc cQImage_method_callback_paintEngine(self: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQImage](fcQImage_vdata(self))
...
proc cQImage_method_callback_metric(self: pointer, metric: cint): cint {.cdecl.} =
  let inst = cast[VirtualQImage](fcQImage_vdata(self))
  let slotval1 = cint(metric)
...
proc cQImage_method_callback_initPainter(self: pointer, painter: pointer): void {.cdecl.} =
  let inst = cast[VirtualQImage](fcQImage_vdata(self))
  let slotval1 = gen_qpainter_types.QPainter(h: painter, owned: false)
...
proc cQImage_method_callback_redirected(self: pointer, offset: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQImage](fcQImage_vdata(self))
  let slotval1 = gen_qpoint_types.QPoint(h: offset, owned: false)
...
proc cQImage_method_callback_sharedPainter(self: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQImage](fcQImage_vdata(self))
...
proc create*(T: type gen_qimage_types.QImage,
  ...
  if not isNil(vtbl[].devType):
    vtbl[].vtbl.devType = cQImage_vtable_callback_devType
  if not isNil(vtbl[].paintEngine):
    vtbl[].vtbl.paintEngine = cQImage_vtable_callback_paintEngine
  if not isNil(vtbl[].metric):
    vtbl[].vtbl.metric = cQImage_vtable_callback_metric
  if not isNil(vtbl[].initPainter):
    vtbl[].vtbl.initPainter = cQImage_vtable_callback_initPainter
  if not isNil(vtbl[].redirected):
    vtbl[].vtbl.redirected = cQImage_vtable_callback_redirected
  if not isNil(vtbl[].sharedPainter):
    vtbl[].vtbl.sharedPainter = cQImage_vtable_callback_sharedPainter
  gen_qimage_types.QImage(h: fcQImage_new(addr(vtbl[].vtbl), addr(vtbl[])), owned: true)
...
proc create*(T: type gen_qimage_types.QImage,
  ...
  if not isNil(vtbl[].sharedPainter):
    vtbl[].vtbl.sharedPainter = cQImage_vtable_callback_sharedPainter
  gen_qimage_types.QImage(h: fcQImage_new2(addr(vtbl[].vtbl), addr(vtbl[]), size.h, cint(format)), owned: true)
...
proc create*(T: type gen_qimage_types.QImage,
  ...
  if not isNil(vtbl[].sharedPainter):
    vtbl[].vtbl.sharedPainter = cQImage_vtable_callback_sharedPainter
  gen_qimage_types.QImage(h: fcQImage_new3(addr(vtbl[].vtbl), addr(vtbl[]), width, height, cint(format)), owned: true)
...
proc create*(T: type gen_qimage_types.QImage,
  ...
  if not isNil(vtbl[].sharedPainter):
    vtbl[].vtbl.sharedPainter = cQImage_vtable_callback_sharedPainter
  gen_qimage_types.QImage(h: fcQImage_new4(addr(vtbl[].vtbl), addr(vtbl[]), data, width, height, cint(format)), owned: true)
...
proc create2*(T: type gen_qimage_types.QImage,
  ...
  if not isNil(vtbl[].sharedPainter):
    vtbl[].vtbl.sharedPainter = cQImage_vtable_callback_sharedPainter
  gen_qimage_types.QImage(h: fcQImage_new5(addr(vtbl[].vtbl), addr(vtbl[]), data, width, height, cint(format)), owned: true)
...
proc create*(T: type gen_qimage_types.QImage,
  ...
  if not isNil(vtbl[].sharedPainter):
    vtbl[].vtbl.sharedPainter = cQImage_vtable_callback_sharedPainter
  gen_qimage_types.QImage(h: fcQImage_new6(addr(vtbl[].vtbl), addr(vtbl[]), data, width, height, bytesPerLine, cint(format)), owned: true)
...
proc create2*(T: type gen_qimage_types.QImage,
  ...
  if not isNil(vtbl[].sharedPainter):
    vtbl[].vtbl.sharedPainter = cQImage_vtable_callback_sharedPainter
  gen_qimage_types.QImage(h: fcQImage_new7(addr(vtbl[].vtbl), addr(vtbl[]), data, width, height, bytesPerLine, cint(format)), owned: true)
...
proc create*(T: type gen_qimage_types.QImage,
  ...
  if not isNil(vtbl[].sharedPainter):
    vtbl[].vtbl.sharedPainter = cQImage_vtable_callback_sharedPainter
  gen_qimage_types.QImage(h: fcQImage_new8(addr(vtbl[].vtbl), addr(vtbl[]), struct_miqt_string(data: if len(fileName) > 0: addr fileName[0] else: nil, len: csize_t(len(fileName)))), owned: true)
...
proc create*(T: type gen_qimage_types.QImage,
  ...
  if not isNil(vtbl[].sharedPainter):
    vtbl[].vtbl.sharedPainter = cQImage_vtable_callback_sharedPainter
  gen_qimage_types.QImage(h: fcQImage_new9(addr(vtbl[].vtbl), addr(vtbl[]), param1.h), owned: true)
...
proc create*(T: type gen_qimage_types.QImage,
  ...
  if not isNil(vtbl[].sharedPainter):
    vtbl[].vtbl.sharedPainter = cQImage_vtable_callback_sharedPainter
  gen_qimage_types.QImage(h: fcQImage_new10(addr(vtbl[].vtbl), addr(vtbl[]), struct_miqt_string(data: if len(fileName) > 0: addr fileName[0] else: nil, len: csize_t(len(fileName))), format), owned: true)

const cQImage_mvtbl = cQImageVTable(
  destructor: proc(self: pointer) {.cdecl.} =
    let inst = cast[ptr typeof(VirtualQImage()[])](self.fcQImage_vtbl())
    inst[].h = nil
    inst[].owned = false,
  devType: cQImage_method_callback_devType,
  paintEngine: cQImage_method_callback_paintEngine,
  metric: cQImage_method_callback_metric,
  initPainter: cQImage_method_callback_initPainter,
  redirected: cQImage_method_callback_redirected,
  sharedPainter: cQImage_method_callback_sharedPainter,
)
proc create*(T: type gen_qimage_types.QImage,
    inst: VirtualQImage) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQImage_new(addr(cQImage_mvtbl), addr(inst[]))
  inst[].owned = true
...
proc create*(T: type gen_qimage_types.QImage,
    ...
    inst: VirtualQImage) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQImage_new2(addr(cQImage_mvtbl), addr(inst[]), size.h, cint(format))
  inst[].owned = true
...
proc create*(T: type gen_qimage_types.QImage,
    ...
    inst: VirtualQImage) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQImage_new3(addr(cQImage_mvtbl), addr(inst[]), width, height, cint(format))
  inst[].owned = true
...
proc create*(T: type gen_qimage_types.QImage,
    ...
    inst: VirtualQImage) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQImage_new4(addr(cQImage_mvtbl), addr(inst[]), data, width, height, cint(format))
  inst[].owned = true
...
proc create2*(T: type gen_qimage_types.QImage,
    ...
    inst: VirtualQImage) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQImage_new5(addr(cQImage_mvtbl), addr(inst[]), data, width, height, cint(format))
  inst[].owned = true
...
proc create*(T: type gen_qimage_types.QImage,
    ...
    inst: VirtualQImage) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQImage_new6(addr(cQImage_mvtbl), addr(inst[]), data, width, height, bytesPerLine, cint(format))
  inst[].owned = true
...
proc create2*(T: type gen_qimage_types.QImage,
    ...
    inst: VirtualQImage) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQImage_new7(addr(cQImage_mvtbl), addr(inst[]), data, width, height, bytesPerLine, cint(format))
  inst[].owned = true
...
proc create*(T: type gen_qimage_types.QImage,
    ...
    inst: VirtualQImage) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQImage_new8(addr(cQImage_mvtbl), addr(inst[]), struct_miqt_string(data: if len(fileName) > 0: addr fileName[0] else: nil, len: csize_t(len(fileName))))
  inst[].owned = true
...
proc create*(T: type gen_qimage_types.QImage,
    ...
    inst: VirtualQImage) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQImage_new9(addr(cQImage_mvtbl), addr(inst[]), param1.h)
  inst[].owned = true
...
proc create*(T: type gen_qimage_types.QImage,
    ...
    inst: VirtualQImage) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQImage_new10(addr(cQImage_mvtbl), addr(inst[]), struct_miqt_string(data: if len(fileName) > 0: addr fileName[0] else: nil, len: csize_t(len(fileName))), format)
  inst[].owned = true
