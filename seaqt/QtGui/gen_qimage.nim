...
template Format_CMYK8888*(_: type QImageFormatEnum): untyped = 36
template NImageFormats*(_: type QImageFormatEnum): untyped = 37
...
proc fcQImage_flipped(self: pointer): pointer {.importc: "QImage_flipped".}
proc fcQImage_flip(self: pointer): void {.importc: "QImage_flip".}
...
proc fcQImage_convertedToColorSpaceColorSpace(self: pointer, colorSpace: pointer): pointer {.importc: "QImage_convertedToColorSpace_colorSpace".}
proc fcQImage_convertedToColorSpaceColorSpaceFormat(self: pointer, colorSpace: pointer, format: cint): pointer {.importc: "QImage_convertedToColorSpace_colorSpace_format".}
proc fcQImage_convertToColorSpaceColorSpace(self: pointer, colorSpace: pointer): void {.importc: "QImage_convertToColorSpace_colorSpace".}
proc fcQImage_convertToColorSpaceColorSpaceFormat(self: pointer, colorSpace: pointer, format: cint): void {.importc: "QImage_convertToColorSpace_colorSpace_format".}
proc fcQImage_setColorSpace(self: pointer, colorSpace: pointer): void {.importc: "QImage_setColorSpace".}
proc fcQImage_colorTransformedTransform(self: pointer, transform: pointer): pointer {.importc: "QImage_colorTransformed_transform".}
proc fcQImage_colorTransformedTransformFormat(self: pointer, transform: pointer, format: cint): pointer {.importc: "QImage_colorTransformed_transform_format".}
proc fcQImage_applyColorTransformTransform(self: pointer, transform: pointer): void {.importc: "QImage_applyColorTransform_transform".}
proc fcQImage_applyColorTransformTransformFormat(self: pointer, transform: pointer, format: cint): void {.importc: "QImage_applyColorTransform_transform_format".}
...
proc fcQImage_flippedOrient(self: pointer, orient: cint): pointer {.importc: "QImage_flipped_orient".}
proc fcQImage_flipOrient(self: pointer, orient: cint): void {.importc: "QImage_flip_orient".}
proc fcQImage_invertPixels_QImage_InvertMode(self: pointer, param1: cint): void {.importc: "QImage_invertPixels_QImage_InvertMode".}
proc fcQImage_convertedToColorSpaceColorSpaceFormatFlags(self: pointer, colorSpace: pointer, format: cint, flags: cint): pointer {.importc: "QImage_convertedToColorSpace_colorSpace_format_flags".}
proc fcQImage_convertToColorSpaceColorSpaceFormatFlags(self: pointer, colorSpace: pointer, format: cint, flags: cint): void {.importc: "QImage_convertToColorSpace_colorSpace_format_flags".}
proc fcQImage_colorTransformedTransformFormatFlags(self: pointer, transform: pointer, format: cint, flags: cint): pointer {.importc: "QImage_colorTransformed_transform_format_flags".}
proc fcQImage_applyColorTransformTransformFormatFlags(self: pointer, transform: pointer, format: cint, flags: cint): void {.importc: "QImage_applyColorTransform_transform_format_flags".}
...
proc fcQImage_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QImage_protectedbase_getDecodedMetricF".}
...
proc flipped*(self: gen_qimage_types.QImage): gen_qimage_types.QImage =
  gen_qimage_types.QImage(h: fcQImage_flipped(self.h), owned: true)

proc flip*(self: gen_qimage_types.QImage): void =
  fcQImage_flip(self.h)
...
proc convertedToColorSpace*(self: gen_qimage_types.QImage, colorSpace: gen_qcolorspace_types.QColorSpace): gen_qimage_types.QImage =
  gen_qimage_types.QImage(h: fcQImage_convertedToColorSpaceColorSpace(self.h, colorSpace.h), owned: true)

proc convertedToColorSpace*(self: gen_qimage_types.QImage, colorSpace: gen_qcolorspace_types.QColorSpace, format: cint): gen_qimage_types.QImage =
  gen_qimage_types.QImage(h: fcQImage_convertedToColorSpaceColorSpaceFormat(self.h, colorSpace.h, cint(format)), owned: true)

proc convertToColorSpace*(self: gen_qimage_types.QImage, colorSpace: gen_qcolorspace_types.QColorSpace): void =
  fcQImage_convertToColorSpaceColorSpace(self.h, colorSpace.h)

proc convertToColorSpace*(self: gen_qimage_types.QImage, colorSpace: gen_qcolorspace_types.QColorSpace, format: cint): void =
  fcQImage_convertToColorSpaceColorSpaceFormat(self.h, colorSpace.h, cint(format))
...
proc colorTransformed*(self: gen_qimage_types.QImage, transform: gen_qcolortransform_types.QColorTransform): gen_qimage_types.QImage =
  gen_qimage_types.QImage(h: fcQImage_colorTransformedTransform(self.h, transform.h), owned: true)

proc colorTransformed*(self: gen_qimage_types.QImage, transform: gen_qcolortransform_types.QColorTransform, format: cint): gen_qimage_types.QImage =
  gen_qimage_types.QImage(h: fcQImage_colorTransformedTransformFormat(self.h, transform.h, cint(format)), owned: true)

proc applyColorTransform*(self: gen_qimage_types.QImage, transform: gen_qcolortransform_types.QColorTransform): void =
  fcQImage_applyColorTransformTransform(self.h, transform.h)

proc applyColorTransform*(self: gen_qimage_types.QImage, transform: gen_qcolortransform_types.QColorTransform, format: cint): void =
  fcQImage_applyColorTransformTransformFormat(self.h, transform.h, cint(format))
...
proc flipped*(self: gen_qimage_types.QImage, orient: cint): gen_qimage_types.QImage =
  gen_qimage_types.QImage(h: fcQImage_flippedOrient(self.h, cint(orient)), owned: true)

proc flip*(self: gen_qimage_types.QImage, orient: cint): void =
  fcQImage_flipOrient(self.h, cint(orient))
...
proc convertedToColorSpace*(self: gen_qimage_types.QImage, colorSpace: gen_qcolorspace_types.QColorSpace, format: cint, flags: cint): gen_qimage_types.QImage =
  gen_qimage_types.QImage(h: fcQImage_convertedToColorSpaceColorSpaceFormatFlags(self.h, colorSpace.h, cint(format), cint(flags)), owned: true)

proc convertToColorSpace*(self: gen_qimage_types.QImage, colorSpace: gen_qcolorspace_types.QColorSpace, format: cint, flags: cint): void =
  fcQImage_convertToColorSpaceColorSpaceFormatFlags(self.h, colorSpace.h, cint(format), cint(flags))

proc colorTransformed*(self: gen_qimage_types.QImage, transform: gen_qcolortransform_types.QColorTransform, format: cint, flags: cint): gen_qimage_types.QImage =
  gen_qimage_types.QImage(h: fcQImage_colorTransformedTransformFormatFlags(self.h, transform.h, cint(format), cint(flags)), owned: true)

proc applyColorTransform*(self: gen_qimage_types.QImage, transform: gen_qcolortransform_types.QColorTransform, format: cint, flags: cint): void =
  fcQImage_applyColorTransformTransformFormatFlags(self.h, transform.h, cint(format), cint(flags))
...
proc getDecodedMetricF*(self: gen_qimage_types.QImage, metricA: cint, metricB: cint): float64 =
  fcQImage_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
