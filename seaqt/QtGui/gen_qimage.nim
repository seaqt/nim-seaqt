...
proc fcQImage_new6(vtbl, vdata: pointer, data: ptr uint8, width: cint, height: cint, bytesPerLine: cint, format: cint): ptr cQImage {.importc: "QImage_new6".}
proc fcQImage_new7(vtbl, vdata: pointer, data: ptr uint8, width: cint, height: cint, bytesPerLine: cint, format: cint): ptr cQImage {.importc: "QImage_new7".}
...
proc transformed*(self: gen_qimage_types.QImage, matrix: gen_qtransform_types.QTransform, mode: cint): gen_qimage_types.QImage =
  gen_qimage_types.QImage(h: fcQImage_transformed22(self.h, matrix.h, cint(mode)), owned: true)
...
proc fromData*(_: type gen_qimage_types.QImage, data: openArray[byte], format: cstring): gen_qimage_types.QImage =
  gen_qimage_types.QImage(h: fcQImage_fromData2(struct_miqt_string(data: cast[cstring](if len(data) == 0: nil else: unsafeAddr data[0]), len: csize_t(len(data))), format), owned: true)
