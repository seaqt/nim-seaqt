...
proc create*(T: type gen_qtextcursor_types.QTextCursor): gen_qtextcursor_types.QTextCursor =
  let tmp = gen_qtextcursor_types.QTextCursor(h: fcQTextCursor_new())
  tmp
proc create*(T: type gen_qtextcursor_types.QTextCursor,
  ...
  let tmp = gen_qtextcursor_types.QTextCursor(h: fcQTextCursor_new2(document.h))
  tmp
proc create*(T: type gen_qtextcursor_types.QTextCursor,
    frame: gen_qtextobject_types.QTextFrame): gen_qtextcursor_types.QTextCursor =
  let tmp = gen_qtextcursor_types.QTextCursor(h: fcQTextCursor_new3(frame.h))
  tmp
proc create*(T: type gen_qtextcursor_types.QTextCursor,
    blockVal: gen_qtextobject_types.QTextBlock): gen_qtextcursor_types.QTextCursor =
  let tmp = gen_qtextcursor_types.QTextCursor(h: fcQTextCursor_new4(blockVal.h))
  tmp
proc create*(T: type gen_qtextcursor_types.QTextCursor,
    cursor: gen_qtextcursor_types.QTextCursor): gen_qtextcursor_types.QTextCursor =
  let tmp = gen_qtextcursor_types.QTextCursor(h: fcQTextCursor_new5(cursor.h))
  tmp
