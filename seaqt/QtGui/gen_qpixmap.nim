...
proc fcQPixmap_fillDeviceOfs(self: pointer, device: pointer, ofs: pointer): void {.importc: "QPixmap_fill_device_ofs".}
proc fcQPixmap_fillDeviceXofsYofs(self: pointer, device: pointer, xofs: cint, yofs: cint): void {.importc: "QPixmap_fill_device_xofs_yofs".}
...
proc fcQPixmap_grabWindow_WId(param1: uint): pointer {.importc: "QPixmap_grabWindow_WId".}
proc fcQPixmap_grabWidgetWidgetRect(widget: pointer, rect: pointer): pointer {.importc: "QPixmap_grabWidget_widget_rect".}
proc fcQPixmap_grabWidgetWidget(widget: pointer): pointer {.importc: "QPixmap_grabWidget_widget".}
...
proc fcQPixmap_transformed_QMatrix(self: pointer, param1: pointer): pointer {.importc: "QPixmap_transformed_QMatrix".}
proc fcQPixmap_trueMatrix_QMatrixIntInt(m: pointer, w: cint, h: cint): pointer {.importc: "QPixmap_trueMatrix_QMatrix_int_int".}
proc fcQPixmap_transformed_QTransform(self: pointer, param1: pointer): pointer {.importc: "QPixmap_transformed_QTransform".}
proc fcQPixmap_trueMatrix_QTransformIntInt(m: pointer, w: cint, h: cint): pointer {.importc: "QPixmap_trueMatrix_QTransform_int_int".}
...
proc fcQPixmap_grabWindow_WIdInt(param1: uint, x: cint): pointer {.importc: "QPixmap_grabWindow_WId_int".}
proc fcQPixmap_grabWindow_WIdIntInt(param1: uint, x: cint, y: cint): pointer {.importc: "QPixmap_grabWindow_WId_int_int".}
proc fcQPixmap_grabWindow_WIdIntIntInt(param1: uint, x: cint, y: cint, w: cint): pointer {.importc: "QPixmap_grabWindow_WId_int_int_int".}
proc fcQPixmap_grabWindow_WIdIntIntIntInt(param1: uint, x: cint, y: cint, w: cint, h: cint): pointer {.importc: "QPixmap_grabWindow_WId_int_int_int_int".}
proc fcQPixmap_grabWidgetWidgetX(widget: pointer, x: cint): pointer {.importc: "QPixmap_grabWidget_widget_x".}
proc fcQPixmap_grabWidgetWidgetXY(widget: pointer, x: cint, y: cint): pointer {.importc: "QPixmap_grabWidget_widget_x_y".}
proc fcQPixmap_grabWidgetWidgetXYW(widget: pointer, x: cint, y: cint, w: cint): pointer {.importc: "QPixmap_grabWidget_widget_x_y_w".}
proc fcQPixmap_grabWidgetWidgetXYWH(widget: pointer, x: cint, y: cint, w: cint, h: cint): pointer {.importc: "QPixmap_grabWidget_widget_x_y_w_h".}
...
proc fcQPixmap_transformed_QMatrix_Qt_TransformationMode(self: pointer, param1: pointer, mode: cint): pointer {.importc: "QPixmap_transformed_QMatrix_Qt_TransformationMode".}
...
proc grabWindow*(_: type gen_qpixmap_types.QPixmap, param1: uint): gen_qpixmap_types.QPixmap =
  gen_qpixmap_types.QPixmap(h: fcQPixmap_grabWindow_WId(param1), owned: true)
...
proc grabWidget*(_: type gen_qpixmap_types.QPixmap, widget: gen_qobject_types.QObject, rect: gen_qrect_types.QRect): gen_qpixmap_types.QPixmap =
  gen_qpixmap_types.QPixmap(h: fcQPixmap_grabWidgetWidgetRect(widget.h, rect.h), owned: true)

proc grabWidget*(_: type gen_qpixmap_types.QPixmap, widget: gen_qobject_types.QObject): gen_qpixmap_types.QPixmap =
  gen_qpixmap_types.QPixmap(h: fcQPixmap_grabWidgetWidget(widget.h), owned: true)
...
proc transformed*(self: gen_qpixmap_types.QPixmap, param1: gen_qmatrix_types.QMatrix): gen_qpixmap_types.QPixmap =
  gen_qpixmap_types.QPixmap(h: fcQPixmap_transformed_QMatrix(self.h, param1.h), owned: true)

proc trueMatrix*(_: type gen_qpixmap_types.QPixmap, m: gen_qmatrix_types.QMatrix, w: cint, h: cint): gen_qmatrix_types.QMatrix =
  gen_qmatrix_types.QMatrix(h: fcQPixmap_trueMatrix_QMatrixIntInt(m.h, w, h), owned: true)
...
proc trueMatrix*(_: type gen_qpixmap_types.QPixmap, m: gen_qtransform_types.QTransform, w: cint, h: cint): gen_qtransform_types.QTransform =
  gen_qtransform_types.QTransform(h: fcQPixmap_trueMatrix_QTransformIntInt(m.h, w, h), owned: true)
...
proc grabWidget*(_: type gen_qpixmap_types.QPixmap, widget: gen_qobject_types.QObject, x: cint, y: cint): gen_qpixmap_types.QPixmap =
  gen_qpixmap_types.QPixmap(h: fcQPixmap_grabWidgetWidgetXY(widget.h, x, y), owned: true)
...
proc grabWidget*(_: type gen_qpixmap_types.QPixmap, widget: gen_qobject_types.QObject, x: cint, y: cint, w: cint): gen_qpixmap_types.QPixmap =
  gen_qpixmap_types.QPixmap(h: fcQPixmap_grabWidgetWidgetXYW(widget.h, x, y, w), owned: true)
...
proc grabWidget*(_: type gen_qpixmap_types.QPixmap, widget: gen_qobject_types.QObject, x: cint, y: cint, w: cint, h: cint): gen_qpixmap_types.QPixmap =
  gen_qpixmap_types.QPixmap(h: fcQPixmap_grabWidgetWidgetXYWH(widget.h, x, y, w, h), owned: true)
...
proc transformed*(self: gen_qpixmap_types.QPixmap, param1: gen_qmatrix_types.QMatrix, mode: cint): gen_qpixmap_types.QPixmap =
  gen_qpixmap_types.QPixmap(h: fcQPixmap_transformed_QMatrix_Qt_TransformationMode(self.h, param1.h, cint(mode)), owned: true)
