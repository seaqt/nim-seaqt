...
proc fcQBackingStore_flushRegion(self: pointer, region: pointer): void {.importc: "QBackingStore_flush_region".}
...
proc fcQBackingStore_flushRegionWindow(self: pointer, region: pointer, window: pointer): void {.importc: "QBackingStore_flush_region_window".}
proc fcQBackingStore_flushRegionWindowOffset(self: pointer, region: pointer, window: pointer, offset: pointer): void {.importc: "QBackingStore_flush_region_window_offset".}
...
proc flush*(self: gen_qbackingstore_types.QBackingStore, region: gen_qregion_types.QRegion): void =
  fcQBackingStore_flushRegion(self.h, region.h)
...
proc flush*(self: gen_qbackingstore_types.QBackingStore, region: gen_qregion_types.QRegion, window: gen_qwindow_types.QWindow): void =
  fcQBackingStore_flushRegionWindow(self.h, region.h, window.h)
...
proc flush*(self: gen_qbackingstore_types.QBackingStore, region: gen_qregion_types.QRegion, window: gen_qwindow_types.QWindow, offset: gen_qpoint_types.QPoint): void =
  fcQBackingStore_flushRegionWindowOffset(self.h, region.h, window.h, offset.h)
...
proc create*(T: type gen_qbackingstore_types.QBackingStore,
  ...
  let tmp = gen_qbackingstore_types.QBackingStore(h: fcQBackingStore_new(window.h), owned: true)
  tmp
