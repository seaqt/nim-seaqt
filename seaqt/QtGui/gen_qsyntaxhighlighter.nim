...
proc fcQSyntaxHighlighter_trUtf8(s: cstring): struct_seaqt_string {.importc: "QSyntaxHighlighter_trUtf8".}
...
proc fcQSyntaxHighlighter_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QSyntaxHighlighter_trUtf82".}
proc fcQSyntaxHighlighter_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QSyntaxHighlighter_trUtf83".}
