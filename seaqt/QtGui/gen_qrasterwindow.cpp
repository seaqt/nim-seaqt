...
public:
	...
	friend bool QRasterWindow_virtualbase_nativeEvent(VirtualQRasterWindow* self, struct miqt_string eventType, void* message, long* result);
...
bool QRasterWindow_virtualbase_nativeEvent(VirtualQRasterWindow* self, struct miqt_string eventType, void* message, long* result) {
