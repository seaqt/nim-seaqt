...
proc fcQUndoCommand_new2(vtbl: pointer, vdata: csize_t, text: struct_miqt_string): ptr cQUndoCommand {.importc: "QUndoCommand_new2".}
proc fcQUndoCommand_new3(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQUndoCommand {.importc: "QUndoCommand_new3".}
proc fcQUndoCommand_new4(vtbl: pointer, vdata: csize_t, text: struct_miqt_string, parent: pointer): ptr cQUndoCommand {.importc: "QUndoCommand_new4".}
...
proc create*(T: type gen_qundostack_types.QUndoCommand,
  ...
  if not isNil(vtbl[].mergeWith):
    vtbl[].vtbl.mergeWith = fcQUndoCommand_vtable_callback_mergeWith
  let tmp = gen_qundostack_types.QUndoCommand(h: fcQUndoCommand_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_miqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text)))))
  fcQUndoCommand_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qundostack_types.QUndoCommand,
...
proc create*(T: type gen_qundostack_types.QUndoCommand,
  ...
  if not isNil(vtbl[].mergeWith):
    vtbl[].vtbl.mergeWith = fcQUndoCommand_vtable_callback_mergeWith
  let tmp = gen_qundostack_types.QUndoCommand(h: fcQUndoCommand_new4(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_miqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), parent.h))
  fcQUndoCommand_vdata(tmp.h)[] = addr(vtbl[])
  tmp
...
proc create*(T: type gen_qundostack_types.QUndoCommand,
    ...
    inst: VirtualQUndoCommand) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQUndoCommand_new2(addr(cQUndoCommand_mvtbl), csize_t(sizeof(pointer)), struct_miqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))))
  fcQUndoCommand_vdata(inst[].h)[] = addr inst[]
...
proc create*(T: type gen_qundostack_types.QUndoCommand,
    ...
    inst: VirtualQUndoCommand) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQUndoCommand_new4(addr(cQUndoCommand_mvtbl), csize_t(sizeof(pointer)), struct_miqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), parent.h)
  fcQUndoCommand_vdata(inst[].h)[] = addr inst[]
...
proc createUndoAction*(self: gen_qundostack_types.QUndoStack, parent: gen_qobject_types.QObject, prefix: string): gen_qaction_types.QAction =
  gen_qaction_types.QAction(h: fcQUndoStack_createUndoAction2(self.h, parent.h, struct_miqt_string(data: if len(prefix) > 0: addr prefix[0] else: nil, len: csize_t(len(prefix)))))
...
proc createRedoAction*(self: gen_qundostack_types.QUndoStack, parent: gen_qobject_types.QObject, prefix: string): gen_qaction_types.QAction =
  gen_qaction_types.QAction(h: fcQUndoStack_createRedoAction2(self.h, parent.h, struct_miqt_string(data: if len(prefix) > 0: addr prefix[0] else: nil, len: csize_t(len(prefix)))))
