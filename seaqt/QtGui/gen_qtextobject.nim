...
proc fcQTextFrameLayoutData_operatorAssign(self: pointer, fromVal: pointer): void {.importc: "QTextFrameLayoutData_operatorAssign".}
...
proc operatorAssign*(self: gen_qtextobject_types.QTextFrameLayoutData, fromVal: gen_qtextobject_types.QTextFrameLayoutData): void =
  fcQTextFrameLayoutData_operatorAssign(self.h, fromVal.h)
