...
proc create*(T: type gen_qtextobject_types.QTextFrameiterator,
  ...
  let tmp = gen_qtextobject_types.QTextFrameiterator(h: fcQTextFrameiterator_new2(o.h))
  tmp
...
proc create*(T: type gen_qtextobject_types.QTextBlockiterator,
  ...
  let tmp = gen_qtextobject_types.QTextBlockiterator(h: fcQTextBlockiterator_new2(o.h))
  tmp
