...
proc create*(T: type gen_qpagesize_types.QPageSize): gen_qpagesize_types.QPageSize =
  let tmp = gen_qpagesize_types.QPageSize(h: fcQPageSize_new())
  tmp
proc create*(T: type gen_qpagesize_types.QPageSize,
    pageSizeId: cint): gen_qpagesize_types.QPageSize =
  let tmp = gen_qpagesize_types.QPageSize(h: fcQPageSize_new2(cint(pageSizeId)))
  tmp
proc create*(T: type gen_qpagesize_types.QPageSize,
    pointSize: gen_qsize_types.QSize): gen_qpagesize_types.QPageSize =
  let tmp = gen_qpagesize_types.QPageSize(h: fcQPageSize_new3(pointSize.h))
  tmp
proc create*(T: type gen_qpagesize_types.QPageSize,
    size: gen_qsize_types.QSizeF, units: cint): gen_qpagesize_types.QPageSize =
  let tmp = gen_qpagesize_types.QPageSize(h: fcQPageSize_new4(size.h, cint(units)))
  tmp
proc create*(T: type gen_qpagesize_types.QPageSize,
    other: gen_qpagesize_types.QPageSize): gen_qpagesize_types.QPageSize =
  let tmp = gen_qpagesize_types.QPageSize(h: fcQPageSize_new5(other.h))
  tmp
proc create*(T: type gen_qpagesize_types.QPageSize,
    pointSize: gen_qsize_types.QSize, name: openArray[char]): gen_qpagesize_types.QPageSize =
  let tmp = gen_qpagesize_types.QPageSize(h: fcQPageSize_new6(pointSize.h, struct_seaqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name)))))
  tmp
proc create*(T: type gen_qpagesize_types.QPageSize,
    pointSize: gen_qsize_types.QSize, name: openArray[char], matchPolicy: cint): gen_qpagesize_types.QPageSize =
  let tmp = gen_qpagesize_types.QPageSize(h: fcQPageSize_new7(pointSize.h, struct_seaqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name))), cint(matchPolicy)))
  tmp
proc create*(T: type gen_qpagesize_types.QPageSize,
    size: gen_qsize_types.QSizeF, units: cint, name: openArray[char]): gen_qpagesize_types.QPageSize =
  let tmp = gen_qpagesize_types.QPageSize(h: fcQPageSize_new8(size.h, cint(units), struct_seaqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name)))))
  tmp
proc create*(T: type gen_qpagesize_types.QPageSize,
    size: gen_qsize_types.QSizeF, units: cint, name: openArray[char], matchPolicy: cint): gen_qpagesize_types.QPageSize =
  let tmp = gen_qpagesize_types.QPageSize(h: fcQPageSize_new9(size.h, cint(units), struct_seaqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name))), cint(matchPolicy)))
  tmp
