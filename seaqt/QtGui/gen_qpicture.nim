...
proc fcQPicture_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QPicture_protectedbase_getDecodedMetricF".}
...
proc getDecodedMetricF*(self: gen_qpicture_types.QPicture, metricA: cint, metricB: cint): float64 =
  fcQPicture_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
