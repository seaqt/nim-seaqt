...
proc fcQPicture_pictureFormat(fileName: struct_seaqt_string): cstring {.importc: "QPicture_pictureFormat".}
proc fcQPicture_inputFormats(): struct_seaqt_array {.importc: "QPicture_inputFormats".}
proc fcQPicture_outputFormats(): struct_seaqt_array {.importc: "QPicture_outputFormats".}
...
proc fcQPictureIO_fileName(self: pointer): struct_seaqt_string {.importc: "QPictureIO_fileName".}
proc fcQPictureIO_quality(self: pointer): cint {.importc: "QPictureIO_quality".}
proc fcQPictureIO_description(self: pointer): struct_seaqt_string {.importc: "QPictureIO_description".}
...
proc fcQPictureIO_setFileName(self: pointer, fileName: struct_seaqt_string): void {.importc: "QPictureIO_setFileName".}
proc fcQPictureIO_setQuality(self: pointer, quality: cint): void {.importc: "QPictureIO_setQuality".}
proc fcQPictureIO_setDescription(self: pointer, description: struct_seaqt_string): void {.importc: "QPictureIO_setDescription".}
...
proc pictureFormat*(_: type gen_qpicture_types.QPicture, fileName: openArray[char]): cstring =
  (fcQPicture_pictureFormat(struct_seaqt_string(data: if len(fileName) > 0: addr fileName[0] else: nil, len: csize_t(len(fileName)))))
...
proc setFileName*(self: gen_qpicture_types.QPictureIO, fileName: openArray[char]): void =
  fcQPictureIO_setFileName(self.h, struct_seaqt_string(data: if len(fileName) > 0: addr fileName[0] else: nil, len: csize_t(len(fileName))))
...
proc setDescription*(self: gen_qpicture_types.QPictureIO, description: openArray[char]): void =
  fcQPictureIO_setDescription(self.h, struct_seaqt_string(data: if len(description) > 0: addr description[0] else: nil, len: csize_t(len(description))))
...
proc create*(T: type gen_qpicture_types.QPictureIO): gen_qpicture_types.QPictureIO =
  let tmp = gen_qpicture_types.QPictureIO(h: fcQPictureIO_new(), owned: true)
  tmp
proc create*(T: type gen_qpicture_types.QPictureIO,
  ...
  let tmp = gen_qpicture_types.QPictureIO(h: fcQPictureIO_new2(ioDevice.h, format), owned: true)
  tmp
proc create*(T: type gen_qpicture_types.QPictureIO,
    fileName: openArray[char], format: cstring): gen_qpicture_types.QPictureIO =
  let tmp = gen_qpicture_types.QPictureIO(h: fcQPictureIO_new3(struct_seaqt_string(data: if len(fileName) > 0: addr fileName[0] else: nil, len: csize_t(len(fileName))), format), owned: true)
  tmp
