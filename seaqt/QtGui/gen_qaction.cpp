...
VirtualQAction* QAction_new(const QAction_VTable* vtbl, size_t vdata) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQAction>());
	return _mem_ ? new (_mem_)VirtualQAction(vtbl) : nullptr;
}

VirtualQAction* QAction_new2(const QAction_VTable* vtbl, size_t vdata, struct miqt_string text) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQAction>());
	return _mem_ ? new (_mem_)VirtualQAction(vtbl, text_QString) : nullptr;
}

VirtualQAction* QAction_new3(const QAction_VTable* vtbl, size_t vdata, QIcon* icon, struct miqt_string text) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQAction>());
...
VirtualQAction* QAction_new5(const QAction_VTable* vtbl, size_t vdata, struct miqt_string text, QObject* parent) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQAction>());
	return _mem_ ? new (_mem_)VirtualQAction(vtbl, text_QString, parent) : nullptr;
}

VirtualQAction* QAction_new6(const QAction_VTable* vtbl, size_t vdata, QIcon* icon, struct miqt_string text, QObject* parent) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQAction>());
