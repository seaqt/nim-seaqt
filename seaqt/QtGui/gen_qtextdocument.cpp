...
VirtualQTextDocument* QTextDocument_new(const QTextDocument_VTable* vtbl, size_t vdata) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQTextDocument>());
	return _mem_ ? new (_mem_)VirtualQTextDocument(vtbl) : nullptr;
}

VirtualQTextDocument* QTextDocument_new2(const QTextDocument_VTable* vtbl, size_t vdata, struct miqt_string text) {
...
VirtualQTextDocument* QTextDocument_new4(const QTextDocument_VTable* vtbl, size_t vdata, struct miqt_string text, QObject* parent) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQTextDocument>());
