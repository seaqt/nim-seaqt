...
proc create*(T: type gen_qoffscreensurface_types.QOffscreenSurface,
  ...
  gen_qoffscreensurface_types.QOffscreenSurface(h: fcQOffscreenSurface_new(addr(vtbl[].vtbl), ), owned: true)
...
proc create*(T: type gen_qoffscreensurface_types.QOffscreenSurface,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = miqt_exec_callback_cQOffscreenSurface_disconnectNotify
  gen_qoffscreensurface_types.QOffscreenSurface(h: fcQOffscreenSurface_new2(addr(vtbl[].vtbl), screen.h), owned: true)
...
proc create*(T: type gen_qoffscreensurface_types.QOffscreenSurface,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = miqt_exec_callback_cQOffscreenSurface_disconnectNotify
  gen_qoffscreensurface_types.QOffscreenSurface(h: fcQOffscreenSurface_new3(addr(vtbl[].vtbl), screen.h, parent.h), owned: true)
...
proc create*(T: type gen_qoffscreensurface_types.QOffscreenSurface,
  ...
  vtbl[].h = fcQOffscreenSurface_new(addr(vtbl[].vtbl), )
  vtbl[].owned = true
...
proc create*(T: type gen_qoffscreensurface_types.QOffscreenSurface,
  ...
  vtbl[].vtbl.disconnectNotify = miqt_exec_method_cQOffscreenSurface_disconnectNotify
  if vtbl[].h != nil: delete(move(vtbl[]))
  vtbl[].h = fcQOffscreenSurface_new2(addr(vtbl[].vtbl), screen.h)
  vtbl[].owned = true
...
proc create*(T: type gen_qoffscreensurface_types.QOffscreenSurface,
  ...
  vtbl[].vtbl.disconnectNotify = miqt_exec_method_cQOffscreenSurface_disconnectNotify
  if vtbl[].h != nil: delete(move(vtbl[]))
  vtbl[].h = fcQOffscreenSurface_new3(addr(vtbl[].vtbl), screen.h, parent.h)
  vtbl[].owned = true
