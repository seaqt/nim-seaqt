...
proc fcQOffscreenSurface_new(vtbl, vdata: pointer): ptr cQOffscreenSurface {.importc: "QOffscreenSurface_new".}
proc fcQOffscreenSurface_new2(vtbl, vdata: pointer, screen: pointer): ptr cQOffscreenSurface {.importc: "QOffscreenSurface_new2".}
proc fcQOffscreenSurface_new3(vtbl, vdata: pointer, screen: pointer, parent: pointer): ptr cQOffscreenSurface {.importc: "QOffscreenSurface_new3".}
...
proc create*(T: type gen_qoffscreensurface_types.QOffscreenSurface,
  ...
  inst[].h = fcQOffscreenSurface_new(addr(cQOffscreenSurface_mvtbl), addr(inst[]))
  inst[].owned = true
...
proc create*(T: type gen_qoffscreensurface_types.QOffscreenSurface,
    ...
    inst: VirtualQOffscreenSurface) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQOffscreenSurface_new2(addr(cQOffscreenSurface_mvtbl), addr(inst[]), screen.h)
  inst[].owned = true
...
proc create*(T: type gen_qoffscreensurface_types.QOffscreenSurface,
    ...
    inst: VirtualQOffscreenSurface) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQOffscreenSurface_new3(addr(cQOffscreenSurface_mvtbl), addr(inst[]), screen.h, parent.h)
  inst[].owned = true
