...
VirtualQUndoCommand* QUndoCommand_new(const QUndoCommand_VTable* vtbl, size_t vdata) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQUndoCommand>());
	return _mem_ ? new (_mem_)VirtualQUndoCommand(vtbl) : nullptr;
}

VirtualQUndoCommand* QUndoCommand_new2(const QUndoCommand_VTable* vtbl, size_t vdata, struct miqt_string text) {
...
VirtualQUndoCommand* QUndoCommand_new4(const QUndoCommand_VTable* vtbl, size_t vdata, struct miqt_string text, QUndoCommand* parent) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQUndoCommand>());
...
VirtualQUndoStack* QUndoStack_new(const QUndoStack_VTable* vtbl, size_t vdata) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQUndoStack>());
