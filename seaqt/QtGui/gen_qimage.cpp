...
VirtualQImage* QImage_new(const QImage_VTable* vtbl, size_t vdata) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQImage>());
...
VirtualQImage* QImage_new8(const QImage_VTable* vtbl, size_t vdata, struct miqt_string fileName) {
...
VirtualQImage* QImage_new10(const QImage_VTable* vtbl, size_t vdata, struct miqt_string fileName, const char* format) {
	QString fileName_QString = QString::fromUtf8(fileName.data, fileName.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQImage>());
