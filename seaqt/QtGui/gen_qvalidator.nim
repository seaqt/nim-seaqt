...
type cQValidatorVTable {.pure.} = object
  ...
  validate*: proc(self: pointer, param1: struct_seaqt_string, param2: ptr cint): cint {.cdecl, raises: [], gcsafe.}
  fixup*: proc(self: pointer, param1: struct_seaqt_string): void {.cdecl, raises: [], gcsafe.}
...
proc fcQValidator_virtualbase_fixup(self: pointer, param1: struct_seaqt_string): void {.importc: "QValidator_virtualbase_fixup".}
...
proc fcQIntValidator_virtualbase_validate(self: pointer, param1: struct_seaqt_string, param2: ptr cint): cint {.importc: "QIntValidator_virtualbase_validate".}
proc fcQIntValidator_virtualbase_fixup(self: pointer, input: struct_seaqt_string): void {.importc: "QIntValidator_virtualbase_fixup".}
...
proc fcQDoubleValidator_virtualbase_validate(self: pointer, param1: struct_seaqt_string, param2: ptr cint): cint {.importc: "QDoubleValidator_virtualbase_validate".}
...
proc fcQDoubleValidator_virtualbase_fixup(self: pointer, param1: struct_seaqt_string): void {.importc: "QDoubleValidator_virtualbase_fixup".}
...
proc fcQRegExpValidator_virtualbase_validate(self: pointer, input: struct_seaqt_string, pos: ptr cint): cint {.importc: "QRegExpValidator_virtualbase_validate".}
proc fcQRegExpValidator_virtualbase_fixup(self: pointer, param1: struct_seaqt_string): void {.importc: "QRegExpValidator_virtualbase_fixup".}
...
proc fcQRegularExpressionValidator_virtualbase_validate(self: pointer, input: struct_seaqt_string, pos: ptr cint): cint {.importc: "QRegularExpressionValidator_virtualbase_validate".}
proc fcQRegularExpressionValidator_virtualbase_fixup(self: pointer, param1: struct_seaqt_string): void {.importc: "QRegularExpressionValidator_virtualbase_fixup".}
...
proc validate*(self: gen_qvalidator_types.QValidator, param1: openArray[char], param2: ptr cint): cint =
  cint(fcQValidator_validate(self.h, struct_seaqt_string(data: if len(param1) > 0: addr param1[0] else: nil, len: csize_t(len(param1))), param2))

proc fixup*(self: gen_qvalidator_types.QValidator, param1: openArray[char]): void =
  fcQValidator_fixup(self.h, struct_seaqt_string(data: if len(param1) > 0: addr param1[0] else: nil, len: csize_t(len(param1))))
...
proc QValidatorfixup*(self: gen_qvalidator_types.QValidator, param1: openArray[char]): void =
  fcQValidator_virtualbase_fixup(self.h, struct_seaqt_string(data: if len(param1) > 0: addr param1[0] else: nil, len: csize_t(len(param1))))
...
proc fcQValidator_vtable_callback_validate(self: pointer, param1: struct_seaqt_string, param2: ptr cint): cint {.cdecl.} =
  let vtbl = cast[ptr QValidatorVTable](fcQValidator_vdata(self)[])
  let self = QValidator(h: self)
...
proc fcQValidator_vtable_callback_fixup(self: pointer, param1: struct_seaqt_string): void {.cdecl.} =
  let vtbl = cast[ptr QValidatorVTable](fcQValidator_vdata(self)[])
  let self = QValidator(h: self)
  let vparam1_ms = param1
  let vparam1x_ret = string.fromBytes(vparam1_ms)
...
proc fcQValidator_method_callback_validate(self: pointer, param1: struct_seaqt_string, param2: ptr cint): cint {.cdecl.} =
  let inst = cast[VirtualQValidator](fcQValidator_vdata(self)[])
  let vparam1_ms = param1
  let vparam1x_ret = string.fromBytes(vparam1_ms)
  c_free(vparam1_ms.data)
...
proc fcQValidator_method_callback_fixup(self: pointer, param1: struct_seaqt_string): void {.cdecl.} =
  let inst = cast[VirtualQValidator](fcQValidator_vdata(self)[])
  let vparam1_ms = param1
  let vparam1x_ret = string.fromBytes(vparam1_ms)
  c_free(vparam1_ms.data)
...
proc create*(T: type gen_qvalidator_types.QValidator,
  ...
  let tmp = gen_qvalidator_types.QValidator(h: fcQValidator_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQValidator_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qvalidator_types.QValidator,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQValidator_vtable_callback_disconnectNotify
  let tmp = gen_qvalidator_types.QValidator(h: fcQValidator_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQValidator_vdata(tmp.h)[] = addr(vtbl[])
  tmp
...
proc create*(T: type gen_qvalidator_types.QValidator,
  ...
  inst[].h = fcQValidator_new(addr(cQValidator_mvtbl), csize_t(sizeof(pointer)))
  fcQValidator_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qvalidator_types.QValidator,
    ...
    inst: VirtualQValidator) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQValidator_new2(addr(cQValidator_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQValidator_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc validate*(self: gen_qvalidator_types.QIntValidator, param1: openArray[char], param2: ptr cint): cint =
  cint(fcQIntValidator_validate(self.h, struct_seaqt_string(data: if len(param1) > 0: addr param1[0] else: nil, len: csize_t(len(param1))), param2))

proc fixup*(self: gen_qvalidator_types.QIntValidator, input: openArray[char]): void =
  fcQIntValidator_fixup(self.h, struct_seaqt_string(data: if len(input) > 0: addr input[0] else: nil, len: csize_t(len(input))))
...
proc QIntValidatorvalidate*(self: gen_qvalidator_types.QIntValidator, param1: openArray[char], param2: ptr cint): cint =
  cint(fcQIntValidator_virtualbase_validate(self.h, struct_seaqt_string(data: if len(param1) > 0: addr param1[0] else: nil, len: csize_t(len(param1))), param2))

proc QIntValidatorfixup*(self: gen_qvalidator_types.QIntValidator, input: openArray[char]): void =
  fcQIntValidator_virtualbase_fixup(self.h, struct_seaqt_string(data: if len(input) > 0: addr input[0] else: nil, len: csize_t(len(input))))
...
proc fcQIntValidator_vtable_callback_validate(self: pointer, param1: struct_seaqt_string, param2: ptr cint): cint {.cdecl.} =
  let vtbl = cast[ptr QIntValidatorVTable](fcQIntValidator_vdata(self)[])
  let self = QIntValidator(h: self)
  let vparam1_ms = param1
  let vparam1x_ret = string.fromBytes(vparam1_ms)
...
proc fcQIntValidator_vtable_callback_fixup(self: pointer, input: struct_seaqt_string): void {.cdecl.} =
  let vtbl = cast[ptr QIntValidatorVTable](fcQIntValidator_vdata(self)[])
  let self = QIntValidator(h: self)
  let vinput_ms = input
...
proc fcQIntValidator_method_callback_validate(self: pointer, param1: struct_seaqt_string, param2: ptr cint): cint {.cdecl.} =
  let inst = cast[VirtualQIntValidator](fcQIntValidator_vdata(self)[])
  let vparam1_ms = param1
  let vparam1x_ret = string.fromBytes(vparam1_ms)
  c_free(vparam1_ms.data)
...
proc fcQIntValidator_method_callback_fixup(self: pointer, input: struct_seaqt_string): void {.cdecl.} =
  let inst = cast[VirtualQIntValidator](fcQIntValidator_vdata(self)[])
  let vinput_ms = input
  let vinputx_ret = string.fromBytes(vinput_ms)
  c_free(vinput_ms.data)
...
proc create*(T: type gen_qvalidator_types.QIntValidator,
  ...
  let tmp = gen_qvalidator_types.QIntValidator(h: fcQIntValidator_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQIntValidator_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qvalidator_types.QIntValidator,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQIntValidator_vtable_callback_disconnectNotify
  let tmp = gen_qvalidator_types.QIntValidator(h: fcQIntValidator_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), bottom, top), owned: true)
  fcQIntValidator_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qvalidator_types.QIntValidator,
    parent: gen_qobject_types.QObject,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQIntValidator_vtable_callback_disconnectNotify
  let tmp = gen_qvalidator_types.QIntValidator(h: fcQIntValidator_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQIntValidator_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qvalidator_types.QIntValidator,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQIntValidator_vtable_callback_disconnectNotify
  let tmp = gen_qvalidator_types.QIntValidator(h: fcQIntValidator_new4(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), bottom, top, parent.h), owned: true)
  fcQIntValidator_vdata(tmp.h)[] = addr(vtbl[])
  tmp
...
proc create*(T: type gen_qvalidator_types.QIntValidator,
  ...
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQIntValidator_new(addr(cQIntValidator_mvtbl), csize_t(sizeof(pointer)))
  fcQIntValidator_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qvalidator_types.QIntValidator,
    ...
    inst: VirtualQIntValidator) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQIntValidator_new2(addr(cQIntValidator_mvtbl), csize_t(sizeof(pointer)), bottom, top)
  fcQIntValidator_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qvalidator_types.QIntValidator,
    ...
    inst: VirtualQIntValidator) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQIntValidator_new3(addr(cQIntValidator_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQIntValidator_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qvalidator_types.QIntValidator,
    ...
    inst: VirtualQIntValidator) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQIntValidator_new4(addr(cQIntValidator_mvtbl), csize_t(sizeof(pointer)), bottom, top, parent.h)
  fcQIntValidator_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc validate*(self: gen_qvalidator_types.QDoubleValidator, param1: openArray[char], param2: ptr cint): cint =
  cint(fcQDoubleValidator_validate(self.h, struct_seaqt_string(data: if len(param1) > 0: addr param1[0] else: nil, len: csize_t(len(param1))), param2))
...
proc QDoubleValidatorvalidate*(self: gen_qvalidator_types.QDoubleValidator, param1: openArray[char], param2: ptr cint): cint =
  cint(fcQDoubleValidator_virtualbase_validate(self.h, struct_seaqt_string(data: if len(param1) > 0: addr param1[0] else: nil, len: csize_t(len(param1))), param2))
...
proc QDoubleValidatorfixup*(self: gen_qvalidator_types.QDoubleValidator, param1: openArray[char]): void =
  fcQDoubleValidator_virtualbase_fixup(self.h, struct_seaqt_string(data: if len(param1) > 0: addr param1[0] else: nil, len: csize_t(len(param1))))
...
proc fcQDoubleValidator_vtable_callback_validate(self: pointer, param1: struct_seaqt_string, param2: ptr cint): cint {.cdecl.} =
  let vtbl = cast[ptr QDoubleValidatorVTable](fcQDoubleValidator_vdata(self)[])
  let self = QDoubleValidator(h: self)
  let vparam1_ms = param1
  let vparam1x_ret = string.fromBytes(vparam1_ms)
...
proc fcQDoubleValidator_vtable_callback_fixup(self: pointer, param1: struct_seaqt_string): void {.cdecl.} =
  let vtbl = cast[ptr QDoubleValidatorVTable](fcQDoubleValidator_vdata(self)[])
  let self = QDoubleValidator(h: self)
  let vparam1_ms = param1
  let vparam1x_ret = string.fromBytes(vparam1_ms)
...
proc fcQDoubleValidator_method_callback_validate(self: pointer, param1: struct_seaqt_string, param2: ptr cint): cint {.cdecl.} =
  let inst = cast[VirtualQDoubleValidator](fcQDoubleValidator_vdata(self)[])
  let vparam1_ms = param1
  let vparam1x_ret = string.fromBytes(vparam1_ms)
  c_free(vparam1_ms.data)
...
proc fcQDoubleValidator_method_callback_fixup(self: pointer, param1: struct_seaqt_string): void {.cdecl.} =
  let inst = cast[VirtualQDoubleValidator](fcQDoubleValidator_vdata(self)[])
  let vparam1_ms = param1
  let vparam1x_ret = string.fromBytes(vparam1_ms)
  c_free(vparam1_ms.data)
...
proc create*(T: type gen_qvalidator_types.QDoubleValidator,
  ...
  let tmp = gen_qvalidator_types.QDoubleValidator(h: fcQDoubleValidator_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQDoubleValidator_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qvalidator_types.QDoubleValidator,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQDoubleValidator_vtable_callback_disconnectNotify
  let tmp = gen_qvalidator_types.QDoubleValidator(h: fcQDoubleValidator_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), bottom, top, decimals), owned: true)
  fcQDoubleValidator_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qvalidator_types.QDoubleValidator,
    parent: gen_qobject_types.QObject,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQDoubleValidator_vtable_callback_disconnectNotify
  let tmp = gen_qvalidator_types.QDoubleValidator(h: fcQDoubleValidator_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQDoubleValidator_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qvalidator_types.QDoubleValidator,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQDoubleValidator_vtable_callback_disconnectNotify
  let tmp = gen_qvalidator_types.QDoubleValidator(h: fcQDoubleValidator_new4(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), bottom, top, decimals, parent.h), owned: true)
  fcQDoubleValidator_vdata(tmp.h)[] = addr(vtbl[])
  tmp
...
proc create*(T: type gen_qvalidator_types.QDoubleValidator,
  ...
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQDoubleValidator_new(addr(cQDoubleValidator_mvtbl), csize_t(sizeof(pointer)))
  fcQDoubleValidator_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qvalidator_types.QDoubleValidator,
    ...
    inst: VirtualQDoubleValidator) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQDoubleValidator_new2(addr(cQDoubleValidator_mvtbl), csize_t(sizeof(pointer)), bottom, top, decimals)
  fcQDoubleValidator_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qvalidator_types.QDoubleValidator,
    ...
    inst: VirtualQDoubleValidator) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQDoubleValidator_new3(addr(cQDoubleValidator_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQDoubleValidator_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qvalidator_types.QDoubleValidator,
    ...
    inst: VirtualQDoubleValidator) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQDoubleValidator_new4(addr(cQDoubleValidator_mvtbl), csize_t(sizeof(pointer)), bottom, top, decimals, parent.h)
  fcQDoubleValidator_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc validate*(self: gen_qvalidator_types.QRegExpValidator, input: openArray[char], pos: ptr cint): cint =
  cint(fcQRegExpValidator_validate(self.h, struct_seaqt_string(data: if len(input) > 0: addr input[0] else: nil, len: csize_t(len(input))), pos))
...
proc QRegExpValidatorvalidate*(self: gen_qvalidator_types.QRegExpValidator, input: openArray[char], pos: ptr cint): cint =
  cint(fcQRegExpValidator_virtualbase_validate(self.h, struct_seaqt_string(data: if len(input) > 0: addr input[0] else: nil, len: csize_t(len(input))), pos))

proc QRegExpValidatorfixup*(self: gen_qvalidator_types.QRegExpValidator, param1: openArray[char]): void =
  fcQRegExpValidator_virtualbase_fixup(self.h, struct_seaqt_string(data: if len(param1) > 0: addr param1[0] else: nil, len: csize_t(len(param1))))
...
proc fcQRegExpValidator_vtable_callback_validate(self: pointer, input: struct_seaqt_string, pos: ptr cint): cint {.cdecl.} =
  let vtbl = cast[ptr QRegExpValidatorVTable](fcQRegExpValidator_vdata(self)[])
  let self = QRegExpValidator(h: self)
  let vinput_ms = input
  let vinputx_ret = string.fromBytes(vinput_ms)
...
proc fcQRegExpValidator_vtable_callback_fixup(self: pointer, param1: struct_seaqt_string): void {.cdecl.} =
  let vtbl = cast[ptr QRegExpValidatorVTable](fcQRegExpValidator_vdata(self)[])
  let self = QRegExpValidator(h: self)
  let vparam1_ms = param1
  let vparam1x_ret = string.fromBytes(vparam1_ms)
...
proc fcQRegExpValidator_method_callback_validate(self: pointer, input: struct_seaqt_string, pos: ptr cint): cint {.cdecl.} =
  let inst = cast[VirtualQRegExpValidator](fcQRegExpValidator_vdata(self)[])
  let vinput_ms = input
  let vinputx_ret = string.fromBytes(vinput_ms)
  c_free(vinput_ms.data)
...
proc fcQRegExpValidator_method_callback_fixup(self: pointer, param1: struct_seaqt_string): void {.cdecl.} =
  let inst = cast[VirtualQRegExpValidator](fcQRegExpValidator_vdata(self)[])
  let vparam1_ms = param1
  let vparam1x_ret = string.fromBytes(vparam1_ms)
  c_free(vparam1_ms.data)
...
proc create*(T: type gen_qvalidator_types.QRegExpValidator,
  ...
  let tmp = gen_qvalidator_types.QRegExpValidator(h: fcQRegExpValidator_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQRegExpValidator_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qvalidator_types.QRegExpValidator,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQRegExpValidator_vtable_callback_disconnectNotify
  let tmp = gen_qvalidator_types.QRegExpValidator(h: fcQRegExpValidator_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), rx.h), owned: true)
  fcQRegExpValidator_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qvalidator_types.QRegExpValidator,
    parent: gen_qobject_types.QObject,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQRegExpValidator_vtable_callback_disconnectNotify
  let tmp = gen_qvalidator_types.QRegExpValidator(h: fcQRegExpValidator_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQRegExpValidator_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qvalidator_types.QRegExpValidator,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQRegExpValidator_vtable_callback_disconnectNotify
  let tmp = gen_qvalidator_types.QRegExpValidator(h: fcQRegExpValidator_new4(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), rx.h, parent.h), owned: true)
  fcQRegExpValidator_vdata(tmp.h)[] = addr(vtbl[])
  tmp
const cQRegExpValidator_mvtbl = cQRegExpValidatorVTable(
  destructor: proc(self: pointer) {.cdecl.} =
    let inst = cast[ptr typeof(VirtualQRegExpValidator()[])](self.fcQRegExpValidator_vdata()[])
    inst[].h = nil
    inst[].owned = false,
...
proc create*(T: type gen_qvalidator_types.QRegExpValidator,
  ...
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQRegExpValidator_new(addr(cQRegExpValidator_mvtbl), csize_t(sizeof(pointer)))
  fcQRegExpValidator_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qvalidator_types.QRegExpValidator,
    ...
    inst: VirtualQRegExpValidator) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQRegExpValidator_new2(addr(cQRegExpValidator_mvtbl), csize_t(sizeof(pointer)), rx.h)
  fcQRegExpValidator_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qvalidator_types.QRegExpValidator,
    ...
    inst: VirtualQRegExpValidator) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQRegExpValidator_new3(addr(cQRegExpValidator_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQRegExpValidator_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qvalidator_types.QRegExpValidator,
    ...
    inst: VirtualQRegExpValidator) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQRegExpValidator_new4(addr(cQRegExpValidator_mvtbl), csize_t(sizeof(pointer)), rx.h, parent.h)
  fcQRegExpValidator_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc validate*(self: gen_qvalidator_types.QRegularExpressionValidator, input: openArray[char], pos: ptr cint): cint =
  cint(fcQRegularExpressionValidator_validate(self.h, struct_seaqt_string(data: if len(input) > 0: addr input[0] else: nil, len: csize_t(len(input))), pos))
...
proc QRegularExpressionValidatorvalidate*(self: gen_qvalidator_types.QRegularExpressionValidator, input: openArray[char], pos: ptr cint): cint =
  cint(fcQRegularExpressionValidator_virtualbase_validate(self.h, struct_seaqt_string(data: if len(input) > 0: addr input[0] else: nil, len: csize_t(len(input))), pos))

proc QRegularExpressionValidatorfixup*(self: gen_qvalidator_types.QRegularExpressionValidator, param1: openArray[char]): void =
  fcQRegularExpressionValidator_virtualbase_fixup(self.h, struct_seaqt_string(data: if len(param1) > 0: addr param1[0] else: nil, len: csize_t(len(param1))))
...
proc fcQRegularExpressionValidator_vtable_callback_validate(self: pointer, input: struct_seaqt_string, pos: ptr cint): cint {.cdecl.} =
  let vtbl = cast[ptr QRegularExpressionValidatorVTable](fcQRegularExpressionValidator_vdata(self)[])
  let self = QRegularExpressionValidator(h: self)
  let vinput_ms = input
  let vinputx_ret = string.fromBytes(vinput_ms)
...
proc fcQRegularExpressionValidator_vtable_callback_fixup(self: pointer, param1: struct_seaqt_string): void {.cdecl.} =
  let vtbl = cast[ptr QRegularExpressionValidatorVTable](fcQRegularExpressionValidator_vdata(self)[])
  let self = QRegularExpressionValidator(h: self)
  let vparam1_ms = param1
  let vparam1x_ret = string.fromBytes(vparam1_ms)
...
proc fcQRegularExpressionValidator_method_callback_validate(self: pointer, input: struct_seaqt_string, pos: ptr cint): cint {.cdecl.} =
  let inst = cast[VirtualQRegularExpressionValidator](fcQRegularExpressionValidator_vdata(self)[])
  let vinput_ms = input
  let vinputx_ret = string.fromBytes(vinput_ms)
  c_free(vinput_ms.data)
...
proc fcQRegularExpressionValidator_method_callback_fixup(self: pointer, param1: struct_seaqt_string): void {.cdecl.} =
  let inst = cast[VirtualQRegularExpressionValidator](fcQRegularExpressionValidator_vdata(self)[])
  let vparam1_ms = param1
  let vparam1x_ret = string.fromBytes(vparam1_ms)
  c_free(vparam1_ms.data)
...
proc create*(T: type gen_qvalidator_types.QRegularExpressionValidator,
  ...
  let tmp = gen_qvalidator_types.QRegularExpressionValidator(h: fcQRegularExpressionValidator_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQRegularExpressionValidator_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qvalidator_types.QRegularExpressionValidator,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQRegularExpressionValidator_vtable_callback_disconnectNotify
  let tmp = gen_qvalidator_types.QRegularExpressionValidator(h: fcQRegularExpressionValidator_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), re.h), owned: true)
  fcQRegularExpressionValidator_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qvalidator_types.QRegularExpressionValidator,
    parent: gen_qobject_types.QObject,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQRegularExpressionValidator_vtable_callback_disconnectNotify
  let tmp = gen_qvalidator_types.QRegularExpressionValidator(h: fcQRegularExpressionValidator_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQRegularExpressionValidator_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qvalidator_types.QRegularExpressionValidator,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQRegularExpressionValidator_vtable_callback_disconnectNotify
  let tmp = gen_qvalidator_types.QRegularExpressionValidator(h: fcQRegularExpressionValidator_new4(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), re.h, parent.h), owned: true)
  fcQRegularExpressionValidator_vdata(tmp.h)[] = addr(vtbl[])
  tmp
...
proc create*(T: type gen_qvalidator_types.QRegularExpressionValidator,
  ...
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQRegularExpressionValidator_new(addr(cQRegularExpressionValidator_mvtbl), csize_t(sizeof(pointer)))
  fcQRegularExpressionValidator_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qvalidator_types.QRegularExpressionValidator,
    ...
    inst: VirtualQRegularExpressionValidator) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQRegularExpressionValidator_new2(addr(cQRegularExpressionValidator_mvtbl), csize_t(sizeof(pointer)), re.h)
  fcQRegularExpressionValidator_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qvalidator_types.QRegularExpressionValidator,
    ...
    inst: VirtualQRegularExpressionValidator) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQRegularExpressionValidator_new3(addr(cQRegularExpressionValidator_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQRegularExpressionValidator_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qvalidator_types.QRegularExpressionValidator,
    ...
    inst: VirtualQRegularExpressionValidator) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQRegularExpressionValidator_new4(addr(cQRegularExpressionValidator_mvtbl), csize_t(sizeof(pointer)), re.h, parent.h)
  fcQRegularExpressionValidator_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
