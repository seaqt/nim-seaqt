...
proc fcQIcon_staticMetaObject(): pointer {.importc: "QIcon_staticMetaObject".}
...
proc create*(T: type gen_qicon_types.QIcon,
  ...
  tmp
proc staticMetaObject*(_: type gen_qicon_types.QIcon): gen_qobjectdefs_types.QMetaObject =
  gen_qobjectdefs_types.QMetaObject(h: fcQIcon_staticMetaObject())
