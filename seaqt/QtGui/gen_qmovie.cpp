...
VirtualQMovie* QMovie_new(const QMovie_VTable* vtbl, size_t vdata) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQMovie>());
...
VirtualQMovie* QMovie_new3(const QMovie_VTable* vtbl, size_t vdata, struct miqt_string fileName) {
...
VirtualQMovie* QMovie_new5(const QMovie_VTable* vtbl, size_t vdata, QIODevice* device, struct miqt_string format) {
	QByteArray format_QByteArray(format.data, format.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQMovie>());
	return _mem_ ? new (_mem_)VirtualQMovie(vtbl, device, format_QByteArray) : nullptr;
}

VirtualQMovie* QMovie_new6(const QMovie_VTable* vtbl, size_t vdata, QIODevice* device, struct miqt_string format, QObject* parent) {
	QByteArray format_QByteArray(format.data, format.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQMovie>());
	return _mem_ ? new (_mem_)VirtualQMovie(vtbl, device, format_QByteArray, parent) : nullptr;
}

VirtualQMovie* QMovie_new7(const QMovie_VTable* vtbl, size_t vdata, struct miqt_string fileName, struct miqt_string format) {
	QString fileName_QString = QString::fromUtf8(fileName.data, fileName.len);
	QByteArray format_QByteArray(format.data, format.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQMovie>());
...
VirtualQMovie* QMovie_new8(const QMovie_VTable* vtbl, size_t vdata, struct miqt_string fileName, struct miqt_string format, QObject* parent) {
	QString fileName_QString = QString::fromUtf8(fileName.data, fileName.len);
	QByteArray format_QByteArray(format.data, format.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQMovie>());
