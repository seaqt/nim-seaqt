...
template FrontMatter*(_: type QTextDocumentMetaInformationEnum): untyped = 3
...
template MarkdownDialectGitHub*(_: type QTextDocumentMarkdownFeatureEnum): untyped = 1068812
