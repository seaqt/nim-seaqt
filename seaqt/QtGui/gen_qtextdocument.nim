...
proc fcQTextDocument_trUtf8S(s: cstring): struct_seaqt_string {.importc: "QTextDocument_trUtf8_s".}
...
proc fcQTextDocument_setMetaInformation(self: pointer, info: cint, param2: struct_seaqt_string): void {.importc: "QTextDocument_setMetaInformation".}
proc fcQTextDocument_metaInformation(self: pointer, info: cint): struct_seaqt_string {.importc: "QTextDocument_metaInformation".}
...
proc fcQTextDocument_find_QString(self: pointer, subString: struct_seaqt_string): pointer {.importc: "QTextDocument_find_QString".}
proc fcQTextDocument_find_QString_QTextCursor(self: pointer, subString: struct_seaqt_string, cursor: pointer): pointer {.importc: "QTextDocument_find_QString_QTextCursor".}
proc fcQTextDocument_find_QRegExp(self: pointer, expr: pointer): pointer {.importc: "QTextDocument_find_QRegExp".}
proc fcQTextDocument_find_QRegExp_QTextCursor(self: pointer, expr: pointer, cursor: pointer): pointer {.importc: "QTextDocument_find_QRegExp_QTextCursor".}
proc fcQTextDocument_find_QRegularExpression(self: pointer, expr: pointer): pointer {.importc: "QTextDocument_find_QRegularExpression".}
proc fcQTextDocument_find_QRegularExpression_QTextCursor(self: pointer, expr: pointer, cursor: pointer): pointer {.importc: "QTextDocument_find_QRegularExpression_QTextCursor".}
...
proc fcQTextDocument_allFormats(self: pointer): struct_seaqt_array {.importc: "QTextDocument_allFormats".}
...
proc fcQTextDocument_trUtf8SC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QTextDocument_trUtf8_s_c".}
proc fcQTextDocument_trUtf8SCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QTextDocument_trUtf8_s_c_n".}
proc fcQTextDocument_cloneParent(self: pointer, parent: pointer): pointer {.importc: "QTextDocument_clone_parent".}
proc fcQTextDocument_toHtmlEncoding(self: pointer, encoding: struct_seaqt_string): struct_seaqt_string {.importc: "QTextDocument_toHtml_encoding".}
...
proc fcQTextDocument_find_QStringInt(self: pointer, subString: struct_seaqt_string, fromVal: cint): pointer {.importc: "QTextDocument_find_QString_int".}
proc fcQTextDocument_find_QStringInt_QTextDocument_FindFlags(self: pointer, subString: struct_seaqt_string, fromVal: cint, options: cint): pointer {.importc: "QTextDocument_find_QString_int_QTextDocument_FindFlags".}
proc fcQTextDocument_find_QString_QTextCursor_QTextDocument_FindFlags(self: pointer, subString: struct_seaqt_string, cursor: pointer, options: cint): pointer {.importc: "QTextDocument_find_QString_QTextCursor_QTextDocument_FindFlags".}
proc fcQTextDocument_find_QRegExpInt(self: pointer, expr: pointer, fromVal: cint): pointer {.importc: "QTextDocument_find_QRegExp_int".}
proc fcQTextDocument_find_QRegExpInt_QTextDocument_FindFlags(self: pointer, expr: pointer, fromVal: cint, options: cint): pointer {.importc: "QTextDocument_find_QRegExp_int_QTextDocument_FindFlags".}
proc fcQTextDocument_find_QRegExp_QTextCursor_QTextDocument_FindFlags(self: pointer, expr: pointer, cursor: pointer, options: cint): pointer {.importc: "QTextDocument_find_QRegExp_QTextCursor_QTextDocument_FindFlags".}
proc fcQTextDocument_find_QRegularExpressionInt(self: pointer, expr: pointer, fromVal: cint): pointer {.importc: "QTextDocument_find_QRegularExpression_int".}
proc fcQTextDocument_find_QRegularExpressionInt_QTextDocument_FindFlags(self: pointer, expr: pointer, fromVal: cint, options: cint): pointer {.importc: "QTextDocument_find_QRegularExpression_int_QTextDocument_FindFlags".}
proc fcQTextDocument_find_QRegularExpression_QTextCursor_QTextDocument_FindFlags(self: pointer, expr: pointer, cursor: pointer, options: cint): pointer {.importc: "QTextDocument_find_QRegularExpression_QTextCursor_QTextDocument_FindFlags".}
...
type cQTextDocumentVTable {.pure.} = object
  ...
  createObject*: proc(self: pointer, f: pointer): pointer {.cdecl, raises: [], gcsafe.}
...
proc trUtf8*(_: type gen_qtextdocument_types.QTextDocument, s: cstring): string =
  let v_ms = fcQTextDocument_trUtf8S(s)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc setMetaInformation*(self: gen_qtextdocument_types.QTextDocument, info: cint, param2: openArray[char]): void =
  fcQTextDocument_setMetaInformation(self.h, cint(info), struct_seaqt_string(data: if len(param2) > 0: addr param2[0] else: nil, len: csize_t(len(param2))))
...
proc setHtml*(self: gen_qtextdocument_types.QTextDocument, html: openArray[char]): void =
  fcQTextDocument_setHtml(self.h, struct_seaqt_string(data: if len(html) > 0: addr html[0] else: nil, len: csize_t(len(html))))
...
proc setPlainText*(self: gen_qtextdocument_types.QTextDocument, text: openArray[char]): void =
  fcQTextDocument_setPlainText(self.h, struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))))
...
proc find*(self: gen_qtextdocument_types.QTextDocument, subString: openArray[char]): gen_qtextcursor_types.QTextCursor =
  gen_qtextcursor_types.QTextCursor(h: fcQTextDocument_find_QString(self.h, struct_seaqt_string(data: if len(subString) > 0: addr subString[0] else: nil, len: csize_t(len(subString)))), owned: true)
...
proc find*(self: gen_qtextdocument_types.QTextDocument, subString: openArray[char], cursor: gen_qtextcursor_types.QTextCursor): gen_qtextcursor_types.QTextCursor =
  gen_qtextcursor_types.QTextCursor(h: fcQTextDocument_find_QString_QTextCursor(self.h, struct_seaqt_string(data: if len(subString) > 0: addr subString[0] else: nil, len: csize_t(len(subString))), cursor.h), owned: true)

proc find*(self: gen_qtextdocument_types.QTextDocument, expr: gen_qregexp_types.QRegExp): gen_qtextcursor_types.QTextCursor =
  gen_qtextcursor_types.QTextCursor(h: fcQTextDocument_find_QRegExp(self.h, expr.h), owned: true)
...
proc find*(self: gen_qtextdocument_types.QTextDocument, expr: gen_qregexp_types.QRegExp, cursor: gen_qtextcursor_types.QTextCursor): gen_qtextcursor_types.QTextCursor =
  gen_qtextcursor_types.QTextCursor(h: fcQTextDocument_find_QRegExp_QTextCursor(self.h, expr.h, cursor.h), owned: true)
...
proc find*(self: gen_qtextdocument_types.QTextDocument, expr: gen_qregularexpression_types.QRegularExpression): gen_qtextcursor_types.QTextCursor =
  gen_qtextcursor_types.QTextCursor(h: fcQTextDocument_find_QRegularExpression(self.h, expr.h), owned: true)
...
proc find*(self: gen_qtextdocument_types.QTextDocument, expr: gen_qregularexpression_types.QRegularExpression, cursor: gen_qtextcursor_types.QTextCursor): gen_qtextcursor_types.QTextCursor =
  gen_qtextcursor_types.QTextCursor(h: fcQTextDocument_find_QRegularExpression_QTextCursor(self.h, expr.h, cursor.h), owned: true)
...
proc setDefaultStyleSheet*(self: gen_qtextdocument_types.QTextDocument, sheet: openArray[char]): void =
  fcQTextDocument_setDefaultStyleSheet(self.h, struct_seaqt_string(data: if len(sheet) > 0: addr sheet[0] else: nil, len: csize_t(len(sheet))))
...
proc fcQTextDocument_slot_callback_contentsChange(slot: int, fromVal: cint, charsRemoved: cint, charsAdded: cint) {.cdecl.} =
...
proc fcQTextDocument_slot_callback_contentsChange_release(slot: int) {.cdecl.} =
...
proc onContentsChange*(self: gen_qtextdocument_types.QTextDocument, slot: QTextDocumentcontentsChangeSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQTextDocument_connect_contentsChange(self.h, cast[int](addr tmp[]), fcQTextDocument_slot_callback_contentsChange, fcQTextDocument_slot_callback_contentsChange_release)
...
proc fcQTextDocument_slot_callback_contentsChanged(slot: int) {.cdecl.} =
  let nimfunc = cast[ptr QTextDocumentcontentsChangedSlot](cast[pointer](slot))
  nimfunc[]()

proc fcQTextDocument_slot_callback_contentsChanged_release(slot: int) {.cdecl.} =
...
proc onContentsChanged*(self: gen_qtextdocument_types.QTextDocument, slot: QTextDocumentcontentsChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQTextDocument_connect_contentsChanged(self.h, cast[int](addr tmp[]), fcQTextDocument_slot_callback_contentsChanged, fcQTextDocument_slot_callback_contentsChanged_release)
...
proc fcQTextDocument_slot_callback_undoAvailable(slot: int, param1: bool) {.cdecl.} =
  let nimfunc = cast[ptr QTextDocumentundoAvailableSlot](cast[pointer](slot))
  let slotval1 = param1

  nimfunc[](slotval1)

proc fcQTextDocument_slot_callback_undoAvailable_release(slot: int) {.cdecl.} =
...
proc onUndoAvailable*(self: gen_qtextdocument_types.QTextDocument, slot: QTextDocumentundoAvailableSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQTextDocument_connect_undoAvailable(self.h, cast[int](addr tmp[]), fcQTextDocument_slot_callback_undoAvailable, fcQTextDocument_slot_callback_undoAvailable_release)
...
proc fcQTextDocument_slot_callback_redoAvailable(slot: int, param1: bool) {.cdecl.} =
  let nimfunc = cast[ptr QTextDocumentredoAvailableSlot](cast[pointer](slot))
  let slotval1 = param1

  nimfunc[](slotval1)

proc fcQTextDocument_slot_callback_redoAvailable_release(slot: int) {.cdecl.} =
...
proc onRedoAvailable*(self: gen_qtextdocument_types.QTextDocument, slot: QTextDocumentredoAvailableSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQTextDocument_connect_redoAvailable(self.h, cast[int](addr tmp[]), fcQTextDocument_slot_callback_redoAvailable, fcQTextDocument_slot_callback_redoAvailable_release)
...
proc fcQTextDocument_slot_callback_undoCommandAdded(slot: int) {.cdecl.} =
  let nimfunc = cast[ptr QTextDocumentundoCommandAddedSlot](cast[pointer](slot))
  nimfunc[]()

proc fcQTextDocument_slot_callback_undoCommandAdded_release(slot: int) {.cdecl.} =
...
proc onUndoCommandAdded*(self: gen_qtextdocument_types.QTextDocument, slot: QTextDocumentundoCommandAddedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQTextDocument_connect_undoCommandAdded(self.h, cast[int](addr tmp[]), fcQTextDocument_slot_callback_undoCommandAdded, fcQTextDocument_slot_callback_undoCommandAdded_release)
...
proc fcQTextDocument_slot_callback_modificationChanged(slot: int, m: bool) {.cdecl.} =
  let nimfunc = cast[ptr QTextDocumentmodificationChangedSlot](cast[pointer](slot))
  let slotval1 = m

  nimfunc[](slotval1)

proc fcQTextDocument_slot_callback_modificationChanged_release(slot: int) {.cdecl.} =
...
proc onModificationChanged*(self: gen_qtextdocument_types.QTextDocument, slot: QTextDocumentmodificationChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQTextDocument_connect_modificationChanged(self.h, cast[int](addr tmp[]), fcQTextDocument_slot_callback_modificationChanged, fcQTextDocument_slot_callback_modificationChanged_release)
...
proc fcQTextDocument_slot_callback_cursorPositionChanged(slot: int, cursor: pointer) {.cdecl.} =
...
proc fcQTextDocument_slot_callback_cursorPositionChanged_release(slot: int) {.cdecl.} =
...
proc onCursorPositionChanged*(self: gen_qtextdocument_types.QTextDocument, slot: QTextDocumentcursorPositionChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQTextDocument_connect_cursorPositionChanged(self.h, cast[int](addr tmp[]), fcQTextDocument_slot_callback_cursorPositionChanged, fcQTextDocument_slot_callback_cursorPositionChanged_release)
...
proc fcQTextDocument_slot_callback_blockCountChanged(slot: int, newBlockCount: cint) {.cdecl.} =
  let nimfunc = cast[ptr QTextDocumentblockCountChangedSlot](cast[pointer](slot))
  let slotval1 = newBlockCount

  nimfunc[](slotval1)

proc fcQTextDocument_slot_callback_blockCountChanged_release(slot: int) {.cdecl.} =
...
proc onBlockCountChanged*(self: gen_qtextdocument_types.QTextDocument, slot: QTextDocumentblockCountChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQTextDocument_connect_blockCountChanged(self.h, cast[int](addr tmp[]), fcQTextDocument_slot_callback_blockCountChanged, fcQTextDocument_slot_callback_blockCountChanged_release)
...
proc fcQTextDocument_slot_callback_baseUrlChanged(slot: int, url: pointer) {.cdecl.} =
  let nimfunc = cast[ptr QTextDocumentbaseUrlChangedSlot](cast[pointer](slot))
  let slotval1 = gen_qurl_types.QUrl(h: url, owned: false)

  nimfunc[](slotval1)

proc fcQTextDocument_slot_callback_baseUrlChanged_release(slot: int) {.cdecl.} =
...
proc onBaseUrlChanged*(self: gen_qtextdocument_types.QTextDocument, slot: QTextDocumentbaseUrlChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQTextDocument_connect_baseUrlChanged(self.h, cast[int](addr tmp[]), fcQTextDocument_slot_callback_baseUrlChanged, fcQTextDocument_slot_callback_baseUrlChanged_release)
...
proc fcQTextDocument_slot_callback_documentLayoutChanged(slot: int) {.cdecl.} =
  let nimfunc = cast[ptr QTextDocumentdocumentLayoutChangedSlot](cast[pointer](slot))
  nimfunc[]()

proc fcQTextDocument_slot_callback_documentLayoutChanged_release(slot: int) {.cdecl.} =
...
proc toHtml*(self: gen_qtextdocument_types.QTextDocument, encoding: openArray[byte]): string =
  let v_ms = fcQTextDocument_toHtmlEncoding(self.h, struct_seaqt_string(data: if len(encoding) > 0: addr encoding[0] else: nil, len: csize_t(len(encoding))))
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc find*(self: gen_qtextdocument_types.QTextDocument, subString: openArray[char], fromVal: cint): gen_qtextcursor_types.QTextCursor =
  gen_qtextcursor_types.QTextCursor(h: fcQTextDocument_find_QStringInt(self.h, struct_seaqt_string(data: if len(subString) > 0: addr subString[0] else: nil, len: csize_t(len(subString))), fromVal), owned: true)
...
proc find*(self: gen_qtextdocument_types.QTextDocument, subString: openArray[char], fromVal: cint, options: cint): gen_qtextcursor_types.QTextCursor =
  gen_qtextcursor_types.QTextCursor(h: fcQTextDocument_find_QStringInt_QTextDocument_FindFlags(self.h, struct_seaqt_string(data: if len(subString) > 0: addr subString[0] else: nil, len: csize_t(len(subString))), fromVal, cint(options)), owned: true)
...
proc find*(self: gen_qtextdocument_types.QTextDocument, subString: openArray[char], cursor: gen_qtextcursor_types.QTextCursor, options: cint): gen_qtextcursor_types.QTextCursor =
  gen_qtextcursor_types.QTextCursor(h: fcQTextDocument_find_QString_QTextCursor_QTextDocument_FindFlags(self.h, struct_seaqt_string(data: if len(subString) > 0: addr subString[0] else: nil, len: csize_t(len(subString))), cursor.h, cint(options)), owned: true)
...
proc find*(self: gen_qtextdocument_types.QTextDocument, expr: gen_qregexp_types.QRegExp, fromVal: cint): gen_qtextcursor_types.QTextCursor =
  gen_qtextcursor_types.QTextCursor(h: fcQTextDocument_find_QRegExpInt(self.h, expr.h, fromVal), owned: true)
...
proc find*(self: gen_qtextdocument_types.QTextDocument, expr: gen_qregexp_types.QRegExp, fromVal: cint, options: cint): gen_qtextcursor_types.QTextCursor =
  gen_qtextcursor_types.QTextCursor(h: fcQTextDocument_find_QRegExpInt_QTextDocument_FindFlags(self.h, expr.h, fromVal, cint(options)), owned: true)
...
proc find*(self: gen_qtextdocument_types.QTextDocument, expr: gen_qregexp_types.QRegExp, cursor: gen_qtextcursor_types.QTextCursor, options: cint): gen_qtextcursor_types.QTextCursor =
  gen_qtextcursor_types.QTextCursor(h: fcQTextDocument_find_QRegExp_QTextCursor_QTextDocument_FindFlags(self.h, expr.h, cursor.h, cint(options)), owned: true)
...
proc find*(self: gen_qtextdocument_types.QTextDocument, expr: gen_qregularexpression_types.QRegularExpression, fromVal: cint): gen_qtextcursor_types.QTextCursor =
  gen_qtextcursor_types.QTextCursor(h: fcQTextDocument_find_QRegularExpressionInt(self.h, expr.h, fromVal), owned: true)
...
proc find*(self: gen_qtextdocument_types.QTextDocument, expr: gen_qregularexpression_types.QRegularExpression, fromVal: cint, options: cint): gen_qtextcursor_types.QTextCursor =
  gen_qtextcursor_types.QTextCursor(h: fcQTextDocument_find_QRegularExpressionInt_QTextDocument_FindFlags(self.h, expr.h, fromVal, cint(options)), owned: true)
...
proc find*(self: gen_qtextdocument_types.QTextDocument, expr: gen_qregularexpression_types.QRegularExpression, cursor: gen_qtextcursor_types.QTextCursor, options: cint): gen_qtextcursor_types.QTextCursor =
  gen_qtextcursor_types.QTextCursor(h: fcQTextDocument_find_QRegularExpression_QTextCursor_QTextDocument_FindFlags(self.h, expr.h, cursor.h, cint(options)), owned: true)
...
proc create*(T: type gen_qtextdocument_types.QTextDocument,
  ...
  vtbl[].vtbl.destructor = proc(self: pointer) {.cdecl.} =
    let vtbl = cast[ref QTextDocumentVTable](fcQTextDocument_vdata(self)[])
    GC_unref(vtbl)
  if not isNil(vtbl[].metaObject):
    vtbl[].vtbl.metaObject = fcQTextDocument_vtable_callback_metaObject
  if not isNil(vtbl[].metacast):
    vtbl[].vtbl.metacast = fcQTextDocument_vtable_callback_metacast
  if not isNil(vtbl[].metacall):
    vtbl[].vtbl.metacall = fcQTextDocument_vtable_callback_metacall
  if not isNil(vtbl[].clear):
    vtbl[].vtbl.clear = fcQTextDocument_vtable_callback_clear
  if not isNil(vtbl[].createObject):
    vtbl[].vtbl.createObject = fcQTextDocument_vtable_callback_createObject
  if not isNil(vtbl[].loadResource):
    vtbl[].vtbl.loadResource = fcQTextDocument_vtable_callback_loadResource
  if not isNil(vtbl[].event):
    vtbl[].vtbl.event = fcQTextDocument_vtable_callback_event
  if not isNil(vtbl[].eventFilter):
    vtbl[].vtbl.eventFilter = fcQTextDocument_vtable_callback_eventFilter
  if not isNil(vtbl[].timerEvent):
    vtbl[].vtbl.timerEvent = fcQTextDocument_vtable_callback_timerEvent
  if not isNil(vtbl[].childEvent):
    vtbl[].vtbl.childEvent = fcQTextDocument_vtable_callback_childEvent
  if not isNil(vtbl[].customEvent):
    vtbl[].vtbl.customEvent = fcQTextDocument_vtable_callback_customEvent
  if not isNil(vtbl[].connectNotify):
    vtbl[].vtbl.connectNotify = fcQTextDocument_vtable_callback_connectNotify
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQTextDocument_vtable_callback_disconnectNotify
  let tmp = gen_qtextdocument_types.QTextDocument(h: fcQTextDocument_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
...
proc create*(T: type gen_qtextdocument_types.QTextDocument,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQTextDocument_vtable_callback_disconnectNotify
  let tmp = gen_qtextdocument_types.QTextDocument(h: fcQTextDocument_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text)))), owned: true)
  fcQTextDocument_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qtextdocument_types.QTextDocument,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQTextDocument_vtable_callback_disconnectNotify
  let tmp = gen_qtextdocument_types.QTextDocument(h: fcQTextDocument_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQTextDocument_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qtextdocument_types.QTextDocument,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQTextDocument_vtable_callback_disconnectNotify
  let tmp = gen_qtextdocument_types.QTextDocument(h: fcQTextDocument_new4(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), parent.h), owned: true)
  fcQTextDocument_vdata(tmp.h)[] = addr(vtbl[])
  tmp
const cQTextDocument_mvtbl = cQTextDocumentVTable(
  ...
  metaObject: fcQTextDocument_method_callback_metaObject,
  metacast: fcQTextDocument_method_callback_metacast,
  metacall: fcQTextDocument_method_callback_metacall,
  clear: fcQTextDocument_method_callback_clear,
  createObject: fcQTextDocument_method_callback_createObject,
  loadResource: fcQTextDocument_method_callback_loadResource,
  event: fcQTextDocument_method_callback_event,
  eventFilter: fcQTextDocument_method_callback_eventFilter,
  timerEvent: fcQTextDocument_method_callback_timerEvent,
  childEvent: fcQTextDocument_method_callback_childEvent,
  customEvent: fcQTextDocument_method_callback_customEvent,
  connectNotify: fcQTextDocument_method_callback_connectNotify,
  disconnectNotify: fcQTextDocument_method_callback_disconnectNotify,
)
proc create*(T: type gen_qtextdocument_types.QTextDocument,
...
proc create*(T: type gen_qtextdocument_types.QTextDocument,
    ...
    inst: VirtualQTextDocument) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQTextDocument_new2(addr(cQTextDocument_mvtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))))
  fcQTextDocument_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qtextdocument_types.QTextDocument,
    ...
    inst: VirtualQTextDocument) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQTextDocument_new4(addr(cQTextDocument_mvtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), parent.h)
  fcQTextDocument_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
