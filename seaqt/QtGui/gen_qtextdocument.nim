...
proc fcQTextDocument_trUtf8(s: cstring): struct_seaqt_string {.importc: "QTextDocument_trUtf8".}
...
proc fcQTextDocument_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QTextDocument_trUtf82".}
proc fcQTextDocument_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QTextDocument_trUtf83".}
proc fcQTextDocument_cloneWithParent(self: pointer, parent: pointer): pointer {.importc: "QTextDocument_cloneWithParent".}
proc fcQTextDocument_toHtmlWithEncoding(self: pointer, encoding: struct_seaqt_string): struct_seaqt_string {.importc: "QTextDocument_toHtmlWithEncoding".}
...
proc fcQTextDocument_find6(self: pointer, subString: struct_seaqt_string, fromVal: cint): pointer {.importc: "QTextDocument_find6".}
proc fcQTextDocument_find7(self: pointer, subString: struct_seaqt_string, fromVal: cint, options: cint): pointer {.importc: "QTextDocument_find7".}
proc fcQTextDocument_find8(self: pointer, subString: struct_seaqt_string, cursor: pointer, options: cint): pointer {.importc: "QTextDocument_find8".}
proc fcQTextDocument_find9(self: pointer, expr: pointer, fromVal: cint): pointer {.importc: "QTextDocument_find9".}
proc fcQTextDocument_find10(self: pointer, expr: pointer, fromVal: cint, options: cint): pointer {.importc: "QTextDocument_find10".}
proc fcQTextDocument_find11(self: pointer, expr: pointer, cursor: pointer, options: cint): pointer {.importc: "QTextDocument_find11".}
proc fcQTextDocument_find12(self: pointer, expr: pointer, fromVal: cint): pointer {.importc: "QTextDocument_find12".}
proc fcQTextDocument_find13(self: pointer, expr: pointer, fromVal: cint, options: cint): pointer {.importc: "QTextDocument_find13".}
proc fcQTextDocument_find14(self: pointer, expr: pointer, cursor: pointer, options: cint): pointer {.importc: "QTextDocument_find14".}
...
proc find*(self: gen_qtextdocument_types.QTextDocument, subString: openArray[char]): gen_qtextcursor_types.QTextCursor =
  gen_qtextcursor_types.QTextCursor(h: fcQTextDocument_find(self.h, struct_seaqt_string(data: if len(subString) > 0: addr subString[0] else: nil, len: csize_t(len(subString)))))
...
proc find*(self: gen_qtextdocument_types.QTextDocument, subString: openArray[char], cursor: gen_qtextcursor_types.QTextCursor): gen_qtextcursor_types.QTextCursor =
  gen_qtextcursor_types.QTextCursor(h: fcQTextDocument_find2(self.h, struct_seaqt_string(data: if len(subString) > 0: addr subString[0] else: nil, len: csize_t(len(subString))), cursor.h))
...
proc clone*(self: gen_qtextdocument_types.QTextDocument, parent: gen_qobject_types.QObject): gen_qtextdocument_types.QTextDocument =
  gen_qtextdocument_types.QTextDocument(h: fcQTextDocument_cloneWithParent(self.h, parent.h))

proc toHtml*(self: gen_qtextdocument_types.QTextDocument, encoding: openArray[byte]): string =
  let v_ms = fcQTextDocument_toHtmlWithEncoding(self.h, struct_seaqt_string(data: if len(encoding) > 0: addr encoding[0] else: nil, len: csize_t(len(encoding))))
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc find*(self: gen_qtextdocument_types.QTextDocument, subString: openArray[char], fromVal: cint): gen_qtextcursor_types.QTextCursor =
  gen_qtextcursor_types.QTextCursor(h: fcQTextDocument_find6(self.h, struct_seaqt_string(data: if len(subString) > 0: addr subString[0] else: nil, len: csize_t(len(subString))), fromVal))
...
proc find*(self: gen_qtextdocument_types.QTextDocument, subString: openArray[char], fromVal: cint, options: cint): gen_qtextcursor_types.QTextCursor =
  gen_qtextcursor_types.QTextCursor(h: fcQTextDocument_find7(self.h, struct_seaqt_string(data: if len(subString) > 0: addr subString[0] else: nil, len: csize_t(len(subString))), fromVal, cint(options)))
...
proc find*(self: gen_qtextdocument_types.QTextDocument, subString: openArray[char], cursor: gen_qtextcursor_types.QTextCursor, options: cint): gen_qtextcursor_types.QTextCursor =
  gen_qtextcursor_types.QTextCursor(h: fcQTextDocument_find8(self.h, struct_seaqt_string(data: if len(subString) > 0: addr subString[0] else: nil, len: csize_t(len(subString))), cursor.h, cint(options)))
...
proc find*(self: gen_qtextdocument_types.QTextDocument, expr: gen_qregexp_types.QRegExp, fromVal: cint): gen_qtextcursor_types.QTextCursor =
  gen_qtextcursor_types.QTextCursor(h: fcQTextDocument_find9(self.h, expr.h, fromVal))
...
proc find*(self: gen_qtextdocument_types.QTextDocument, expr: gen_qregexp_types.QRegExp, fromVal: cint, options: cint): gen_qtextcursor_types.QTextCursor =
  gen_qtextcursor_types.QTextCursor(h: fcQTextDocument_find10(self.h, expr.h, fromVal, cint(options)))
...
proc find*(self: gen_qtextdocument_types.QTextDocument, expr: gen_qregexp_types.QRegExp, cursor: gen_qtextcursor_types.QTextCursor, options: cint): gen_qtextcursor_types.QTextCursor =
  gen_qtextcursor_types.QTextCursor(h: fcQTextDocument_find11(self.h, expr.h, cursor.h, cint(options)))
...
proc find*(self: gen_qtextdocument_types.QTextDocument, expr: gen_qregularexpression_types.QRegularExpression, fromVal: cint): gen_qtextcursor_types.QTextCursor =
  gen_qtextcursor_types.QTextCursor(h: fcQTextDocument_find12(self.h, expr.h, fromVal))
...
proc find*(self: gen_qtextdocument_types.QTextDocument, expr: gen_qregularexpression_types.QRegularExpression, fromVal: cint, options: cint): gen_qtextcursor_types.QTextCursor =
  gen_qtextcursor_types.QTextCursor(h: fcQTextDocument_find13(self.h, expr.h, fromVal, cint(options)))
...
proc find*(self: gen_qtextdocument_types.QTextDocument, expr: gen_qregularexpression_types.QRegularExpression, cursor: gen_qtextcursor_types.QTextCursor, options: cint): gen_qtextcursor_types.QTextCursor =
  gen_qtextcursor_types.QTextCursor(h: fcQTextDocument_find14(self.h, expr.h, cursor.h, cint(options)))
...
proc create*(T: type gen_qtextdocument_types.QTextDocument,
  ...
  let tmp = gen_qtextdocument_types.QTextDocument(h: fcQTextDocument_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))))
...
proc create*(T: type gen_qtextdocument_types.QTextDocument,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQTextDocument_vtable_callback_disconnectNotify
  let tmp = gen_qtextdocument_types.QTextDocument(h: fcQTextDocument_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text)))))
  fcQTextDocument_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qtextdocument_types.QTextDocument,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQTextDocument_vtable_callback_disconnectNotify
  let tmp = gen_qtextdocument_types.QTextDocument(h: fcQTextDocument_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h))
  fcQTextDocument_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qtextdocument_types.QTextDocument,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQTextDocument_vtable_callback_disconnectNotify
  let tmp = gen_qtextdocument_types.QTextDocument(h: fcQTextDocument_new4(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), parent.h))
  fcQTextDocument_vdata(tmp.h)[] = addr(vtbl[])
  tmp
