...
proc fcQPointingDevice_new2(vtbl: pointer, vdata: csize_t, name: struct_miqt_string, systemId: clonglong, devType: cint, pType: cint, caps: cint, maxPoints: cint, buttonCount: cint): ptr cQPointingDevice {.importc: "QPointingDevice_new2".}
proc fcQPointingDevice_new3(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQPointingDevice {.importc: "QPointingDevice_new3".}
proc fcQPointingDevice_new4(vtbl: pointer, vdata: csize_t, name: struct_miqt_string, systemId: clonglong, devType: cint, pType: cint, caps: cint, maxPoints: cint, buttonCount: cint, seatName: struct_miqt_string): ptr cQPointingDevice {.importc: "QPointingDevice_new4".}
proc fcQPointingDevice_new5(vtbl: pointer, vdata: csize_t, name: struct_miqt_string, systemId: clonglong, devType: cint, pType: cint, caps: cint, maxPoints: cint, buttonCount: cint, seatName: struct_miqt_string, uniqueId: pointer): ptr cQPointingDevice {.importc: "QPointingDevice_new5".}
proc fcQPointingDevice_new6(vtbl: pointer, vdata: csize_t, name: struct_miqt_string, systemId: clonglong, devType: cint, pType: cint, caps: cint, maxPoints: cint, buttonCount: cint, seatName: struct_miqt_string, uniqueId: pointer, parent: pointer): ptr cQPointingDevice {.importc: "QPointingDevice_new6".}
...
proc create*(T: type gen_qpointingdevice_types.QPointingDeviceUniqueId): gen_qpointingdevice_types.QPointingDeviceUniqueId =
  let tmp = gen_qpointingdevice_types.QPointingDeviceUniqueId(h: fcQPointingDeviceUniqueId_new())
  tmp
proc create*(T: type gen_qpointingdevice_types.QPointingDeviceUniqueId,
  ...
  let tmp = gen_qpointingdevice_types.QPointingDeviceUniqueId(h: fcQPointingDeviceUniqueId_new2(param1.h))
  tmp
...
proc fcQPointingDevice_slot_callback_grabChanged(slot: int, grabber: pointer, transition: cint, event: pointer, point: pointer) {.cdecl.} =
...
proc fcQPointingDevice_slot_callback_grabChanged_release(slot: int) {.cdecl.} =
...
proc primaryPointingDevice*(_: type gen_qpointingdevice_types.QPointingDevice, seatName: string): gen_qpointingdevice_types.QPointingDevice =
  gen_qpointingdevice_types.QPointingDevice(h: fcQPointingDevice_primaryPointingDevice1(struct_miqt_string(data: if len(seatName) > 0: addr seatName[0] else: nil, len: csize_t(len(seatName)))))
...
proc create*(T: type gen_qpointingdevice_types.QPointingDevice,
  ...
  if not isNil(vtbl[].metaObject):
    vtbl[].vtbl.metaObject = fcQPointingDevice_vtable_callback_metaObject
  if not isNil(vtbl[].metacast):
    vtbl[].vtbl.metacast = fcQPointingDevice_vtable_callback_metacast
  if not isNil(vtbl[].metacall):
    vtbl[].vtbl.metacall = fcQPointingDevice_vtable_callback_metacall
  if not isNil(vtbl[].event):
    vtbl[].vtbl.event = fcQPointingDevice_vtable_callback_event
  if not isNil(vtbl[].eventFilter):
    vtbl[].vtbl.eventFilter = fcQPointingDevice_vtable_callback_eventFilter
  if not isNil(vtbl[].timerEvent):
    vtbl[].vtbl.timerEvent = fcQPointingDevice_vtable_callback_timerEvent
  if not isNil(vtbl[].childEvent):
    vtbl[].vtbl.childEvent = fcQPointingDevice_vtable_callback_childEvent
  if not isNil(vtbl[].customEvent):
    vtbl[].vtbl.customEvent = fcQPointingDevice_vtable_callback_customEvent
  if not isNil(vtbl[].connectNotify):
    vtbl[].vtbl.connectNotify = fcQPointingDevice_vtable_callback_connectNotify
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQPointingDevice_vtable_callback_disconnectNotify
  let tmp = gen_qpointingdevice_types.QPointingDevice(h: fcQPointingDevice_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))))
  fcQPointingDevice_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qpointingdevice_types.QPointingDevice,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQPointingDevice_vtable_callback_disconnectNotify
  let tmp = gen_qpointingdevice_types.QPointingDevice(h: fcQPointingDevice_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_miqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name))), systemId, cint(devType), cint(pType), cint(caps), maxPoints, buttonCount))
  fcQPointingDevice_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qpointingdevice_types.QPointingDevice,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQPointingDevice_vtable_callback_disconnectNotify
  let tmp = gen_qpointingdevice_types.QPointingDevice(h: fcQPointingDevice_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h))
  fcQPointingDevice_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qpointingdevice_types.QPointingDevice,
...
const cQPointingDevice_mvtbl = cQPointingDeviceVTable(
  ...
  metaObject: fcQPointingDevice_method_callback_metaObject,
  metacast: fcQPointingDevice_method_callback_metacast,
  metacall: fcQPointingDevice_method_callback_metacall,
  event: fcQPointingDevice_method_callback_event,
  eventFilter: fcQPointingDevice_method_callback_eventFilter,
  timerEvent: fcQPointingDevice_method_callback_timerEvent,
  childEvent: fcQPointingDevice_method_callback_childEvent,
  customEvent: fcQPointingDevice_method_callback_customEvent,
  connectNotify: fcQPointingDevice_method_callback_connectNotify,
  disconnectNotify: fcQPointingDevice_method_callback_disconnectNotify,
)
proc create*(T: type gen_qpointingdevice_types.QPointingDevice,
    inst: VirtualQPointingDevice) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQPointingDevice_new(addr(cQPointingDevice_mvtbl), csize_t(sizeof(pointer)))
  fcQPointingDevice_vdata(inst[].h)[] = addr inst[]

proc create*(T: type gen_qpointingdevice_types.QPointingDevice,
    name: string, systemId: clonglong, devType: cint, pType: cint, caps: cint, maxPoints: cint, buttonCount: cint,
    inst: VirtualQPointingDevice) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQPointingDevice_new2(addr(cQPointingDevice_mvtbl), csize_t(sizeof(pointer)), struct_miqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name))), systemId, cint(devType), cint(pType), cint(caps), maxPoints, buttonCount)
  fcQPointingDevice_vdata(inst[].h)[] = addr inst[]
...
proc create*(T: type gen_qpointingdevice_types.QPointingDevice,
    ...
    inst: VirtualQPointingDevice) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQPointingDevice_new3(addr(cQPointingDevice_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQPointingDevice_vdata(inst[].h)[] = addr inst[]
...
proc create*(T: type gen_qpointingdevice_types.QPointingDevice,
    ...
    inst: VirtualQPointingDevice) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQPointingDevice_new4(addr(cQPointingDevice_mvtbl), csize_t(sizeof(pointer)), struct_miqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name))), systemId, cint(devType), cint(pType), cint(caps), maxPoints, buttonCount, struct_miqt_string(data: if len(seatName) > 0: addr seatName[0] else: nil, len: csize_t(len(seatName))))
  fcQPointingDevice_vdata(inst[].h)[] = addr inst[]
