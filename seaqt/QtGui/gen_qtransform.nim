...
proc inverted*(self: gen_qtransform_types.QTransform, invertible: ptr bool): gen_qtransform_types.QTransform =
  gen_qtransform_types.QTransform(h: fcQTransform_invertedWithInvertible(self.h, invertible))
...
proc create*(T: type gen_qtransform_types.QTransform,
  ...
  let tmp = gen_qtransform_types.QTransform(h: fcQTransform_new(cint(param1)))
  tmp
proc create*(T: type gen_qtransform_types.QTransform): gen_qtransform_types.QTransform =
  let tmp = gen_qtransform_types.QTransform(h: fcQTransform_new2())
  tmp
proc create*(T: type gen_qtransform_types.QTransform,
  ...
  let tmp = gen_qtransform_types.QTransform(h: fcQTransform_new3(h11, h12, h13, h21, h22, h23, h31, h32))
  tmp
proc create*(T: type gen_qtransform_types.QTransform,
    h11: float64, h12: float64, h21: float64, h22: float64, dx: float64, dy: float64): gen_qtransform_types.QTransform =
  let tmp = gen_qtransform_types.QTransform(h: fcQTransform_new4(h11, h12, h21, h22, dx, dy))
  tmp
proc create*(T: type gen_qtransform_types.QTransform,
    mtx: gen_qmatrix_types.QMatrix): gen_qtransform_types.QTransform =
  let tmp = gen_qtransform_types.QTransform(h: fcQTransform_new5(mtx.h))
  tmp
proc create*(T: type gen_qtransform_types.QTransform,
    other: gen_qtransform_types.QTransform): gen_qtransform_types.QTransform =
  let tmp = gen_qtransform_types.QTransform(h: fcQTransform_new6(other.h))
  tmp
proc create*(T: type gen_qtransform_types.QTransform,
  ...
  let tmp = gen_qtransform_types.QTransform(h: fcQTransform_new7(h11, h12, h13, h21, h22, h23, h31, h32, h33))
  tmp
