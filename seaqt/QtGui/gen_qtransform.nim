...
proc create*(T: type gen_qtransform_types.QTransform,
  ...
  let tmp = gen_qtransform_types.QTransform(h: fcQTransform_new3(h11, h12, h13, h21, h22, h23, h31, h32, h33))
  tmp
proc create*(T: type gen_qtransform_types.QTransform,
...
proc create*(T: type gen_qtransform_types.QTransform,
  ...
  let tmp = gen_qtransform_types.QTransform(h: fcQTransform_new5(other.h))
  tmp
