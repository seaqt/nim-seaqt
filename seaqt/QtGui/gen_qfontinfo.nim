...
proc fcQFontInfo_variableAxes(self: pointer): struct_seaqt_array {.importc: "QFontInfo_variableAxes".}
...
proc variableAxes*(self: gen_qfontinfo_types.QFontInfo): seq[gen_qfontvariableaxis_types.QFontVariableAxis] =
  var v_ma = fcQFontInfo_variableAxes(self.h)
  var vx_ret = newSeq[gen_qfontvariableaxis_types.QFontVariableAxis](int(v_ma.len))
  let v_outCast = cast[ptr UncheckedArray[pointer]](v_ma.data)
  for i in 0 ..< v_ma.len:
    vx_ret[i] = gen_qfontvariableaxis_types.QFontVariableAxis(h: v_outCast[i], owned: true)
  c_free(v_ma.data)
  vx_ret
