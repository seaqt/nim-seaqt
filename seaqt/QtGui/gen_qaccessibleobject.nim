...
proc fcQAccessibleObject_setText(self: pointer, t: cint, text: struct_seaqt_string): void {.importc: "QAccessibleObject_setText".}
...
proc fcQAccessibleApplication_text(self: pointer, t: cint): struct_seaqt_string {.importc: "QAccessibleApplication_text".}
...
proc setText*(self: gen_qaccessibleobject_types.QAccessibleObject, t: cint, text: openArray[char]): void =
  fcQAccessibleObject_setText(self.h, cint(t), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))))
...
proc state*(self: gen_qaccessibleobject_types.QAccessibleApplication): gen_qaccessible_base_types.QAccessibleState =
  gen_qaccessible_base_types.QAccessibleState(h: fcQAccessibleApplication_state(self.h), owned: true)

proc create*(T: type gen_qaccessibleobject_types.QAccessibleApplication): gen_qaccessibleobject_types.QAccessibleApplication =
  let tmp = gen_qaccessibleobject_types.QAccessibleApplication(h: fcQAccessibleApplication_new(), owned: true)
  tmp
