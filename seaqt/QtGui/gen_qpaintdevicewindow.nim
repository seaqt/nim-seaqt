...
proc fcQPaintDeviceWindow_trUtf8S(s: cstring): struct_seaqt_string {.importc: "QPaintDeviceWindow_trUtf8_s".}
...
proc fcQPaintDeviceWindow_trUtf8SC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QPaintDeviceWindow_trUtf8_s_c".}
proc fcQPaintDeviceWindow_trUtf8SCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QPaintDeviceWindow_trUtf8_s_c_n".}
...
proc trUtf8*(_: type gen_qpaintdevicewindow_types.QPaintDeviceWindow, s: cstring): string =
  let v_ms = fcQPaintDeviceWindow_trUtf8S(s)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
