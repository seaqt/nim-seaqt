...
proc fcQPaintDeviceWindow_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QPaintDeviceWindow_protectedbase_getDecodedMetricF".}
...
proc getDecodedMetricF*(self: gen_qpaintdevicewindow_types.QPaintDeviceWindow, metricA: cint, metricB: cint): float64 =
  fcQPaintDeviceWindow_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
