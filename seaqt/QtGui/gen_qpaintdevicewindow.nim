...
proc fcQPaintDeviceWindow_trUtf8(s: cstring): struct_seaqt_string {.importc: "QPaintDeviceWindow_trUtf8".}
...
proc fcQPaintDeviceWindow_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QPaintDeviceWindow_trUtf82".}
proc fcQPaintDeviceWindow_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QPaintDeviceWindow_trUtf83".}
