...
proc fcQTextDocumentWriter_setFormat(self: pointer, format: struct_seaqt_string): void {.importc: "QTextDocumentWriter_setFormat".}
proc fcQTextDocumentWriter_format(self: pointer): struct_seaqt_string {.importc: "QTextDocumentWriter_format".}
