...
proc fcQMatrix_invertedWithInvertible(self: pointer, invertible: ptr bool): pointer {.importc: "QMatrix_invertedWithInvertible".}
...
proc inverted*(self: gen_qmatrix_types.QMatrix, invertible: ptr bool): gen_qmatrix_types.QMatrix =
  gen_qmatrix_types.QMatrix(h: fcQMatrix_invertedWithInvertible(self.h, invertible))

proc create*(T: type gen_qmatrix_types.QMatrix,
    param1: cint): gen_qmatrix_types.QMatrix =
  let tmp = gen_qmatrix_types.QMatrix(h: fcQMatrix_new(cint(param1)))
  tmp
proc create*(T: type gen_qmatrix_types.QMatrix): gen_qmatrix_types.QMatrix =
  let tmp = gen_qmatrix_types.QMatrix(h: fcQMatrix_new2())
  tmp
proc create*(T: type gen_qmatrix_types.QMatrix,
    m11: float64, m12: float64, m21: float64, m22: float64, dx: float64, dy: float64): gen_qmatrix_types.QMatrix =
  let tmp = gen_qmatrix_types.QMatrix(h: fcQMatrix_new3(m11, m12, m21, m22, dx, dy))
  tmp
proc create*(T: type gen_qmatrix_types.QMatrix,
    other: gen_qmatrix_types.QMatrix): gen_qmatrix_types.QMatrix =
  let tmp = gen_qmatrix_types.QMatrix(h: fcQMatrix_new4(other.h))
  tmp
