...
class VirtualQIconEngine final : public QIconEngine {
	...
	void* vdata;
public:
	friend const QIconEngine_VTable* QIconEngine_vtbl(const VirtualQIconEngine* self);
	friend void* QIconEngine_vdata(const VirtualQIconEngine* self);
	friend void QIconEngine_setVdata(VirtualQIconEngine* self, void* vdata);

	VirtualQIconEngine(const QIconEngine_VTable* vtbl, void* vdata): QIconEngine(), vtbl(vtbl), vdata(vdata) {}
	VirtualQIconEngine(const QIconEngine_VTable* vtbl, void* vdata, const QIconEngine& other): QIconEngine(other), vtbl(vtbl), vdata(vdata) {}
	...
	friend void QIconEngine_virtualbase_addFile(VirtualQIconEngine* self, struct miqt_string fileName, QSize* size, int mode, int state);
	...
	virtual QString key() const override {
		...
		struct miqt_string callback_return_value = vtbl->key(this);
	...
	friend struct miqt_string QIconEngine_virtualbase_key(const VirtualQIconEngine* self);
	...
	virtual QList<QSize> availableSizes(QIcon::Mode mode, QIcon::State state) const override {
		...
		struct miqt_array /* of QSize* */  callback_return_value = vtbl->availableSizes(this, sigval1, sigval2);
	...
	friend struct miqt_array /* of QSize* */  QIconEngine_virtualbase_availableSizes(const VirtualQIconEngine* self, int mode, int state);
	...
	virtual QString iconName() const override {
		...
		struct miqt_string callback_return_value = vtbl->iconName(this);
		QString callback_return_value_QString = QString::fromUtf8(callback_return_value.data, callback_return_value.len);
		free(callback_return_value.data);
	...
	friend struct miqt_string QIconEngine_virtualbase_iconName(const VirtualQIconEngine* self);
...
const QIconEngine_VTable* QIconEngine_vtbl(const VirtualQIconEngine* self) { return self->vtbl; }
void* QIconEngine_vdata(const VirtualQIconEngine* self) { return self->vdata; }
void QIconEngine_setVdata(VirtualQIconEngine* self, void* vdata) { self->vdata = vdata; }
...
QIconEngine__AvailableSizesArgument* QIconEngine__AvailableSizesArgument_new(QIconEngine__AvailableSizesArgument* param1) {
	return new QIconEngine__AvailableSizesArgument(*param1);
}
...
QIconEngine__ScaledPixmapArgument* QIconEngine__ScaledPixmapArgument_new(QIconEngine__ScaledPixmapArgument* param1) {
	return new QIconEngine__ScaledPixmapArgument(*param1);
}
