...
public:
	...
	friend struct miqt_array /* of QSize* */  QIconEngine_virtualbase_availableSizes(VirtualQIconEngine* self, int mode, int state);
	...
	friend struct miqt_string QIconEngine_virtualbase_iconName(VirtualQIconEngine* self);
...
struct miqt_array /* of QSize* */  QIconEngine_virtualbase_availableSizes(VirtualQIconEngine* self, int mode, int state) {
...
struct miqt_string QIconEngine_virtualbase_iconName(VirtualQIconEngine* self) {
