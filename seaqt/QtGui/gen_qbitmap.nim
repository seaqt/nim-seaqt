...
proc fcQBitmap_transformed_QMatrix(self: pointer, param1: pointer): pointer {.importc: "QBitmap_transformed_QMatrix".}
proc fcQBitmap_transformed_QTransform(self: pointer, matrix: pointer): pointer {.importc: "QBitmap_transformed_QTransform".}
...
proc transformed*(self: gen_qbitmap_types.QBitmap, param1: gen_qmatrix_types.QMatrix): gen_qbitmap_types.QBitmap =
  gen_qbitmap_types.QBitmap(h: fcQBitmap_transformed_QMatrix(self.h, param1.h), owned: true)

proc transformed*(self: gen_qbitmap_types.QBitmap, matrix: gen_qtransform_types.QTransform): gen_qbitmap_types.QBitmap =
  gen_qbitmap_types.QBitmap(h: fcQBitmap_transformed_QTransform(self.h, matrix.h), owned: true)
