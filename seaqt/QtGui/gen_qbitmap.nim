...
proc fcQBitmap_new2(vtbl: pointer, vdata: csize_t, param1: pointer): ptr cQBitmap {.importc: "QBitmap_new2".}
proc fcQBitmap_new3(vtbl: pointer, vdata: csize_t, w: cint, h: cint): ptr cQBitmap {.importc: "QBitmap_new3".}
proc fcQBitmap_new4(vtbl: pointer, vdata: csize_t, param1: pointer): ptr cQBitmap {.importc: "QBitmap_new4".}
proc fcQBitmap_new5(vtbl: pointer, vdata: csize_t, fileName: struct_miqt_string): ptr cQBitmap {.importc: "QBitmap_new5".}
proc fcQBitmap_new6(vtbl: pointer, vdata: csize_t, param1: pointer): ptr cQBitmap {.importc: "QBitmap_new6".}
proc fcQBitmap_new7(vtbl: pointer, vdata: csize_t, fileName: struct_miqt_string, format: cstring): ptr cQBitmap {.importc: "QBitmap_new7".}
...
proc create*(T: type gen_qbitmap_types.QBitmap,
  ...
  if not isNil(vtbl[].sharedPainter):
    vtbl[].vtbl.sharedPainter = fcQBitmap_vtable_callback_sharedPainter
  let tmp = gen_qbitmap_types.QBitmap(h: fcQBitmap_new5(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_miqt_string(data: if len(fileName) > 0: addr fileName[0] else: nil, len: csize_t(len(fileName)))), owned: true)
  fcQBitmap_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qbitmap_types.QBitmap,
  ...
  if not isNil(vtbl[].sharedPainter):
    vtbl[].vtbl.sharedPainter = fcQBitmap_vtable_callback_sharedPainter
  let tmp = gen_qbitmap_types.QBitmap(h: fcQBitmap_new6(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), param1.h), owned: true)
  fcQBitmap_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qbitmap_types.QBitmap,
  ...
  if not isNil(vtbl[].sharedPainter):
    vtbl[].vtbl.sharedPainter = fcQBitmap_vtable_callback_sharedPainter
  let tmp = gen_qbitmap_types.QBitmap(h: fcQBitmap_new7(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_miqt_string(data: if len(fileName) > 0: addr fileName[0] else: nil, len: csize_t(len(fileName))), format), owned: true)
  fcQBitmap_vdata(tmp.h)[] = addr(vtbl[])
  tmp
...
proc create*(T: type gen_qbitmap_types.QBitmap,
    ...
    inst: VirtualQBitmap) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQBitmap_new5(addr(cQBitmap_mvtbl), csize_t(sizeof(pointer)), struct_miqt_string(data: if len(fileName) > 0: addr fileName[0] else: nil, len: csize_t(len(fileName))))
  fcQBitmap_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qbitmap_types.QBitmap,
    ...
    inst: VirtualQBitmap) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQBitmap_new6(addr(cQBitmap_mvtbl), csize_t(sizeof(pointer)), param1.h)
  fcQBitmap_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qbitmap_types.QBitmap,
    ...
    inst: VirtualQBitmap) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQBitmap_new7(addr(cQBitmap_mvtbl), csize_t(sizeof(pointer)), struct_miqt_string(data: if len(fileName) > 0: addr fileName[0] else: nil, len: csize_t(len(fileName))), format)
  fcQBitmap_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
