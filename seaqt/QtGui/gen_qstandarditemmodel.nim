...
proc fcQStandardItem_text(self: pointer): struct_seaqt_string {.importc: "QStandardItem_text".}
proc fcQStandardItem_setText(self: pointer, text: struct_seaqt_string): void {.importc: "QStandardItem_setText".}
...
proc fcQStandardItem_toolTip(self: pointer): struct_seaqt_string {.importc: "QStandardItem_toolTip".}
proc fcQStandardItem_setToolTip(self: pointer, toolTip: struct_seaqt_string): void {.importc: "QStandardItem_setToolTip".}
proc fcQStandardItem_statusTip(self: pointer): struct_seaqt_string {.importc: "QStandardItem_statusTip".}
proc fcQStandardItem_setStatusTip(self: pointer, statusTip: struct_seaqt_string): void {.importc: "QStandardItem_setStatusTip".}
proc fcQStandardItem_whatsThis(self: pointer): struct_seaqt_string {.importc: "QStandardItem_whatsThis".}
proc fcQStandardItem_setWhatsThis(self: pointer, whatsThis: struct_seaqt_string): void {.importc: "QStandardItem_setWhatsThis".}
...
proc fcQStandardItem_accessibleText(self: pointer): struct_seaqt_string {.importc: "QStandardItem_accessibleText".}
proc fcQStandardItem_setAccessibleText(self: pointer, accessibleText: struct_seaqt_string): void {.importc: "QStandardItem_setAccessibleText".}
proc fcQStandardItem_accessibleDescription(self: pointer): struct_seaqt_string {.importc: "QStandardItem_accessibleDescription".}
proc fcQStandardItem_setAccessibleDescription(self: pointer, accessibleDescription: struct_seaqt_string): void {.importc: "QStandardItem_setAccessibleDescription".}
...
proc fcQStandardItemModel_itemData(self: pointer, index: pointer): struct_seaqt_map {.importc: "QStandardItemModel_itemData".}
proc fcQStandardItemModel_setItemData(self: pointer, index: pointer, roles: struct_seaqt_map): bool {.importc: "QStandardItemModel_setItemData".}
...
proc fcQStandardItemModel_setHorizontalHeaderLabels(self: pointer, labels: struct_seaqt_array): void {.importc: "QStandardItemModel_setHorizontalHeaderLabels".}
...
proc fcQStandardItemModel_mimeData(self: pointer, indexes: struct_seaqt_array): pointer {.importc: "QStandardItemModel_mimeData".}
...
proc fcQStandardItemModel_virtualbase_roleNames(self: pointer): struct_seaqt_map {.importc: "QStandardItemModel_virtualbase_roleNames".}
...
proc fcQStandardItemModel_virtualbase_itemData(self: pointer, index: pointer): struct_seaqt_map {.importc: "QStandardItemModel_virtualbase_itemData".}
proc fcQStandardItemModel_virtualbase_setItemData(self: pointer, index: pointer, roles: struct_seaqt_map): bool {.importc: "QStandardItemModel_virtualbase_setItemData".}
...
proc fcQStandardItemModel_virtualbase_mimeTypes(self: pointer): struct_seaqt_array {.importc: "QStandardItemModel_virtualbase_mimeTypes".}
proc fcQStandardItemModel_virtualbase_mimeData(self: pointer, indexes: struct_seaqt_array): pointer {.importc: "QStandardItemModel_virtualbase_mimeData".}
...
proc fcQStandardItemModel_virtualbase_match(self: pointer, start: pointer, role: cint, value: pointer, hits: cint, flags: cint): struct_seaqt_array {.importc: "QStandardItemModel_virtualbase_match".}
...
proc fcQStandardItemModel_protectedbase_changePersistentIndexList(self: pointer, fromVal: struct_seaqt_array, to: struct_seaqt_array): void {.importc: "QStandardItemModel_protectedbase_changePersistentIndexList".}
proc fcQStandardItemModel_protectedbase_persistentIndexList(self: pointer): struct_seaqt_array {.importc: "QStandardItemModel_protectedbase_persistentIndexList".}
...
proc setToolTip*(self: gen_qstandarditemmodel_types.QStandardItem, toolTip: openArray[char]): void =
  fcQStandardItem_setToolTip(self.h, struct_seaqt_string(data: if len(toolTip) > 0: addr toolTip[0] else: nil, len: csize_t(len(toolTip))))
...
proc setStatusTip*(self: gen_qstandarditemmodel_types.QStandardItem, statusTip: openArray[char]): void =
  fcQStandardItem_setStatusTip(self.h, struct_seaqt_string(data: if len(statusTip) > 0: addr statusTip[0] else: nil, len: csize_t(len(statusTip))))
...
proc setAccessibleText*(self: gen_qstandarditemmodel_types.QStandardItem, accessibleText: openArray[char]): void =
  fcQStandardItem_setAccessibleText(self.h, struct_seaqt_string(data: if len(accessibleText) > 0: addr accessibleText[0] else: nil, len: csize_t(len(accessibleText))))
...
proc setAccessibleDescription*(self: gen_qstandarditemmodel_types.QStandardItem, accessibleDescription: openArray[char]): void =
  fcQStandardItem_setAccessibleDescription(self.h, struct_seaqt_string(data: if len(accessibleDescription) > 0: addr accessibleDescription[0] else: nil, len: csize_t(len(accessibleDescription))))
...
proc insertColumn*(self: gen_qstandarditemmodel_types.QStandardItem, column: cint, items: openArray[gen_qstandarditemmodel_types.QStandardItem]): void =
  ...
  fcQStandardItem_insertColumn(self.h, column, struct_seaqt_array(len: csize_t(len(items)), data: if len(items) == 0: nil else: addr(items_CArray[0])))
...
proc appendRows*(self: gen_qstandarditemmodel_types.QStandardItem, items: openArray[gen_qstandarditemmodel_types.QStandardItem]): void =
  ...
  fcQStandardItem_appendRows(self.h, struct_seaqt_array(len: csize_t(len(items)), data: if len(items) == 0: nil else: addr(items_CArray[0])))
...
proc create*(T: type gen_qstandarditemmodel_types.QStandardItem,
  ...
  if not isNil(vtbl[].multiData):
    vtbl[].vtbl.multiData = fcQStandardItem_vtable_callback_multiData
...
proc create*(T: type gen_qstandarditemmodel_types.QStandardItem,
  ...
  inst[].h = fcQStandardItem_new(addr(cQStandardItem_mvtbl), csize_t(sizeof(pointer)))
...
proc create*(T: type gen_qstandarditemmodel_types.QStandardItem,
    ...
    inst: VirtualQStandardItem) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQStandardItem_new2(addr(cQStandardItem_mvtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))))
  fcQStandardItem_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qstandarditemmodel_types.QStandardItem,
    ...
    inst: VirtualQStandardItem) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQStandardItem_new3(addr(cQStandardItem_mvtbl), csize_t(sizeof(pointer)), icon.h, struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))))
  fcQStandardItem_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qstandarditemmodel_types.QStandardItem,
    ...
    inst: VirtualQStandardItem) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQStandardItem_new4(addr(cQStandardItem_mvtbl), csize_t(sizeof(pointer)), rows)
  fcQStandardItem_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qstandarditemmodel_types.QStandardItem,
    ...
    inst: VirtualQStandardItem) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQStandardItem_new5(addr(cQStandardItem_mvtbl), csize_t(sizeof(pointer)), rows, columns)
  fcQStandardItem_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc setItemRoleNames*(self: gen_qstandarditemmodel_types.QStandardItemModel, roleNames: Table[cint,seq[byte]]): void =
  ...
  fcQStandardItemModel_setItemRoleNames(self.h, struct_seaqt_map(len: csize_t(len(roleNames)),keys: if len(roleNames) == 0: nil else: addr(roleNames_Keys_CArray[0]), values: if len(roleNames) == 0: nil else: addr(roleNames_Values_CArray[0]),))
...
proc setItemData*(self: gen_qstandarditemmodel_types.QStandardItemModel, index: gen_qabstractitemmodel_types.QModelIndex, roles: Table[cint,gen_qvariant_types.QVariant]): bool =
  ...
  fcQStandardItemModel_setItemData(self.h, index.h, struct_seaqt_map(len: csize_t(len(roles)),keys: if len(roles) == 0: nil else: addr(roles_Keys_CArray[0]), values: if len(roles) == 0: nil else: addr(roles_Values_CArray[0]),))
...
proc setHorizontalHeaderLabels*(self: gen_qstandarditemmodel_types.QStandardItemModel, labels: openArray[string]): void =
  ...
  fcQStandardItemModel_setHorizontalHeaderLabels(self.h, struct_seaqt_array(len: csize_t(len(labels)), data: if len(labels) == 0: nil else: addr(labels_CArray[0])))
...
proc setVerticalHeaderLabels*(self: gen_qstandarditemmodel_types.QStandardItemModel, labels: openArray[string]): void =
  ...
  fcQStandardItemModel_setVerticalHeaderLabels(self.h, struct_seaqt_array(len: csize_t(len(labels)), data: if len(labels) == 0: nil else: addr(labels_CArray[0])))
...
proc QStandardItemModelsetItemData*(self: gen_qstandarditemmodel_types.QStandardItemModel, index: gen_qabstractitemmodel_types.QModelIndex, roles: Table[cint,gen_qvariant_types.QVariant]): bool =
  ...
  fcQStandardItemModel_virtualbase_setItemData(self.h, index.h, struct_seaqt_map(len: csize_t(len(roles)),keys: if len(roles) == 0: nil else: addr(roles_Keys_CArray[0]), values: if len(roles) == 0: nil else: addr(roles_Values_CArray[0]),))
...
proc fcQStandardItemModel_vtable_callback_roleNames(self: pointer): struct_seaqt_map {.cdecl.} =
  let vtbl = cast[ptr QStandardItemModelVTable](fcQStandardItemModel_vdata(self)[])
  let self = QStandardItemModel(h: self)
...
proc fcQStandardItemModel_vtable_callback_mimeTypes(self: pointer): struct_seaqt_array {.cdecl.} =
  let vtbl = cast[ptr QStandardItemModelVTable](fcQStandardItemModel_vdata(self)[])
  let self = QStandardItemModel(h: self)
...
proc fcQStandardItemModel_vtable_callback_mimeData(self: pointer, indexes: struct_seaqt_array): pointer {.cdecl.} =
  let vtbl = cast[ptr QStandardItemModelVTable](fcQStandardItemModel_vdata(self)[])
  let self = QStandardItemModel(h: self)
...
proc fcQStandardItemModel_vtable_callback_resetInternalData(self: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QStandardItemModelVTable](fcQStandardItemModel_vdata(self)[])
  let self = QStandardItemModel(h: self)
...
proc fcQStandardItemModel_method_callback_roleNames(self: pointer): struct_seaqt_map {.cdecl.} =
  let inst = cast[VirtualQStandardItemModel](fcQStandardItemModel_vdata(self)[])
...
proc fcQStandardItemModel_method_callback_mimeTypes(self: pointer): struct_seaqt_array {.cdecl.} =
  let inst = cast[VirtualQStandardItemModel](fcQStandardItemModel_vdata(self)[])
...
proc fcQStandardItemModel_method_callback_mimeData(self: pointer, indexes: struct_seaqt_array): pointer {.cdecl.} =
  let inst = cast[VirtualQStandardItemModel](fcQStandardItemModel_vdata(self)[])
  var vindexes_ma = indexes
  var vindexesx_ret = newSeq[gen_qabstractitemmodel_types.QModelIndex](int(vindexes_ma.len))
  let vindexes_outCast = cast[ptr UncheckedArray[pointer]](vindexes_ma.data)
...
proc fcQStandardItemModel_method_callback_resetInternalData(self: pointer): void {.cdecl.} =
  let inst = cast[VirtualQStandardItemModel](fcQStandardItemModel_vdata(self)[])
...
proc encodeData*(self: gen_qstandarditemmodel_types.QStandardItemModel, indexes: openArray[gen_qabstractitemmodel_types.QModelIndex], stream: gen_qdatastream_types.QDataStream): void =
  ...
  fcQStandardItemModel_protectedbase_encodeData(self.h, struct_seaqt_array(len: csize_t(len(indexes)), data: if len(indexes) == 0: nil else: addr(indexes_CArray[0])), stream.h)
...
proc changePersistentIndexList*(self: gen_qstandarditemmodel_types.QStandardItemModel, fromVal: openArray[gen_qabstractitemmodel_types.QModelIndex], to: openArray[gen_qabstractitemmodel_types.QModelIndex]): void =
  ...
  fcQStandardItemModel_protectedbase_changePersistentIndexList(self.h, struct_seaqt_array(len: csize_t(len(fromVal)), data: if len(fromVal) == 0: nil else: addr(fromVal_CArray[0])), struct_seaqt_array(len: csize_t(len(to)), data: if len(to) == 0: nil else: addr(to_CArray[0])))
...
proc create*(T: type gen_qstandarditemmodel_types.QStandardItemModel,
  ...
  if not isNil(vtbl[].multiData):
    vtbl[].vtbl.multiData = fcQStandardItemModel_vtable_callback_multiData
  if not isNil(vtbl[].setData):
    vtbl[].vtbl.setData = fcQStandardItemModel_vtable_callback_setData
  if not isNil(vtbl[].clearItemData):
    vtbl[].vtbl.clearItemData = fcQStandardItemModel_vtable_callback_clearItemData
  ...
  if not isNil(vtbl[].resetInternalData):
    vtbl[].vtbl.resetInternalData = fcQStandardItemModel_vtable_callback_resetInternalData
...
const cQStandardItemModel_mvtbl = cQStandardItemModelVTable(
  ...
  multiData: fcQStandardItemModel_method_callback_multiData,
  setData: fcQStandardItemModel_method_callback_setData,
  clearItemData: fcQStandardItemModel_method_callback_clearItemData,
  ...
  resetInternalData: fcQStandardItemModel_method_callback_resetInternalData,
...
proc create*(T: type gen_qstandarditemmodel_types.QStandardItemModel,
  ...
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQStandardItemModel_new(addr(cQStandardItemModel_mvtbl), csize_t(sizeof(pointer)))
  fcQStandardItemModel_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qstandarditemmodel_types.QStandardItemModel,
    ...
    inst: VirtualQStandardItemModel) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQStandardItemModel_new2(addr(cQStandardItemModel_mvtbl), csize_t(sizeof(pointer)), rows, columns)
  fcQStandardItemModel_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qstandarditemmodel_types.QStandardItemModel,
    ...
    inst: VirtualQStandardItemModel) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQStandardItemModel_new3(addr(cQStandardItemModel_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQStandardItemModel_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qstandarditemmodel_types.QStandardItemModel,
    ...
    inst: VirtualQStandardItemModel) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQStandardItemModel_new4(addr(cQStandardItemModel_mvtbl), csize_t(sizeof(pointer)), rows, columns, parent.h)
  fcQStandardItemModel_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
