...
proc fcQStandardItemModel_trUtf8S(s: cstring): struct_seaqt_string {.importc: "QStandardItemModel_trUtf8_s".}
...
proc fcQStandardItemModel_trUtf8SC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QStandardItemModel_trUtf8_s_c".}
proc fcQStandardItemModel_trUtf8SCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QStandardItemModel_trUtf8_s_c_n".}
...
proc trUtf8*(_: type gen_qstandarditemmodel_types.QStandardItemModel, s: cstring): string =
  let v_ms = fcQStandardItemModel_trUtf8S(s)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
