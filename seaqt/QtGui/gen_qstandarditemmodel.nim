...
proc fcQStandardItemModel_trUtf8(s: cstring): struct_seaqt_string {.importc: "QStandardItemModel_trUtf8".}
...
proc fcQStandardItemModel_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QStandardItemModel_trUtf82".}
proc fcQStandardItemModel_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QStandardItemModel_trUtf83".}
