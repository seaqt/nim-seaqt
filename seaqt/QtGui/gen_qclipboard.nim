...
proc fcQClipboard_tr(s: cstring): struct_seaqt_string {.importc: "QClipboard_tr".}
proc fcQClipboard_trUtf8(s: cstring): struct_seaqt_string {.importc: "QClipboard_trUtf8".}
...
proc fcQClipboard_textWithSubtype(self: pointer, subtype: struct_seaqt_string): struct_seaqt_string {.importc: "QClipboard_textWithSubtype".}
proc fcQClipboard_setText(self: pointer, param1: struct_seaqt_string): void {.importc: "QClipboard_setText".}
...
proc fcQClipboard_tr2(s: cstring, c: cstring): struct_seaqt_string {.importc: "QClipboard_tr2".}
proc fcQClipboard_tr3(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QClipboard_tr3".}
proc fcQClipboard_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QClipboard_trUtf82".}
proc fcQClipboard_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QClipboard_trUtf83".}
proc fcQClipboard_clearWithMode(self: pointer, mode: cint): void {.importc: "QClipboard_clearWithMode".}
proc fcQClipboard_textWithMode(self: pointer, mode: cint): struct_seaqt_string {.importc: "QClipboard_textWithMode".}
proc fcQClipboard_text2(self: pointer, subtype: struct_seaqt_string, mode: cint): struct_seaqt_string {.importc: "QClipboard_text2".}
proc fcQClipboard_setText2(self: pointer, param1: struct_seaqt_string, mode: cint): void {.importc: "QClipboard_setText2".}
proc fcQClipboard_mimeDataWithMode(self: pointer, mode: cint): pointer {.importc: "QClipboard_mimeDataWithMode".}
proc fcQClipboard_setMimeData2(self: pointer, data: pointer, mode: cint): void {.importc: "QClipboard_setMimeData2".}
proc fcQClipboard_imageWithMode(self: pointer, mode: cint): pointer {.importc: "QClipboard_imageWithMode".}
proc fcQClipboard_pixmapWithMode(self: pointer, mode: cint): pointer {.importc: "QClipboard_pixmapWithMode".}
...
proc text*(self: gen_qclipboard_types.QClipboard, subtype: openArray[char]): string =
  let v_ms = fcQClipboard_textWithSubtype(self.h, struct_seaqt_string(data: if len(subtype) > 0: addr subtype[0] else: nil, len: csize_t(len(subtype))))
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret

proc setText*(self: gen_qclipboard_types.QClipboard, param1: openArray[char]): void =
  fcQClipboard_setText(self.h, struct_seaqt_string(data: if len(param1) > 0: addr param1[0] else: nil, len: csize_t(len(param1))))
...
proc clear*(self: gen_qclipboard_types.QClipboard, mode: cint): void =
  fcQClipboard_clearWithMode(self.h, cint(mode))

proc text*(self: gen_qclipboard_types.QClipboard, mode: cint): string =
  let v_ms = fcQClipboard_textWithMode(self.h, cint(mode))
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret

proc text*(self: gen_qclipboard_types.QClipboard, subtype: openArray[char], mode: cint): string =
  let v_ms = fcQClipboard_text2(self.h, struct_seaqt_string(data: if len(subtype) > 0: addr subtype[0] else: nil, len: csize_t(len(subtype))), cint(mode))
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret

proc setText*(self: gen_qclipboard_types.QClipboard, param1: openArray[char], mode: cint): void =
  fcQClipboard_setText2(self.h, struct_seaqt_string(data: if len(param1) > 0: addr param1[0] else: nil, len: csize_t(len(param1))), cint(mode))

proc mimeData*(self: gen_qclipboard_types.QClipboard, mode: cint): gen_qmimedata_types.QMimeData =
  gen_qmimedata_types.QMimeData(h: fcQClipboard_mimeDataWithMode(self.h, cint(mode)), owned: false)
...
proc image*(self: gen_qclipboard_types.QClipboard, mode: cint): gen_qimage_types.QImage =
  gen_qimage_types.QImage(h: fcQClipboard_imageWithMode(self.h, cint(mode)), owned: true)

proc pixmap*(self: gen_qclipboard_types.QClipboard, mode: cint): gen_qpixmap_types.QPixmap =
  gen_qpixmap_types.QPixmap(h: fcQClipboard_pixmapWithMode(self.h, cint(mode)), owned: true)
