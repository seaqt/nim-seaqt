...
VirtualQPointingDevice* QPointingDevice_new(const QPointingDevice_VTable* vtbl, size_t vdata) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQPointingDevice>());
	return _mem_ ? new (_mem_)VirtualQPointingDevice(vtbl) : nullptr;
}

VirtualQPointingDevice* QPointingDevice_new2(const QPointingDevice_VTable* vtbl, size_t vdata, struct miqt_string name, long long systemId, int devType, int pType, int caps, int maxPoints, int buttonCount) {
...
VirtualQPointingDevice* QPointingDevice_new4(const QPointingDevice_VTable* vtbl, size_t vdata, struct miqt_string name, long long systemId, int devType, int pType, int caps, int maxPoints, int buttonCount, struct miqt_string seatName) {
	QString name_QString = QString::fromUtf8(name.data, name.len);
...
VirtualQPointingDevice* QPointingDevice_new5(const QPointingDevice_VTable* vtbl, size_t vdata, struct miqt_string name, long long systemId, int devType, int pType, int caps, int maxPoints, int buttonCount, struct miqt_string seatName, QPointingDeviceUniqueId* uniqueId) {
	QString name_QString = QString::fromUtf8(name.data, name.len);
	QString seatName_QString = QString::fromUtf8(seatName.data, seatName.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQPointingDevice>());
...
VirtualQPointingDevice* QPointingDevice_new6(const QPointingDevice_VTable* vtbl, size_t vdata, struct miqt_string name, long long systemId, int devType, int pType, int caps, int maxPoints, int buttonCount, struct miqt_string seatName, QPointingDeviceUniqueId* uniqueId, QObject* parent) {
	QString name_QString = QString::fromUtf8(name.data, name.len);
	QString seatName_QString = QString::fromUtf8(seatName.data, seatName.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQPointingDevice>());
