...
proc index*(self: gen_qfilesystemmodel_types.QFileSystemModel, path: string): gen_qabstractitemmodel_types.QModelIndex =
  gen_qabstractitemmodel_types.QModelIndex(h: fcQFileSystemModel_indexWithPath(self.h, struct_miqt_string(data: path, len: csize_t(len(path)))), owned: true)
...
proc mkdir*(self: gen_qfilesystemmodel_types.QFileSystemModel, parent: gen_qabstractitemmodel_types.QModelIndex, name: string): gen_qabstractitemmodel_types.QModelIndex =
  gen_qabstractitemmodel_types.QModelIndex(h: fcQFileSystemModel_mkdir(self.h, parent.h, struct_miqt_string(data: name, len: csize_t(len(name)))), owned: true)
...
proc index*(self: gen_qfilesystemmodel_types.QFileSystemModel, path: string, column: cint): gen_qabstractitemmodel_types.QModelIndex =
  gen_qabstractitemmodel_types.QModelIndex(h: fcQFileSystemModel_index2(self.h, struct_miqt_string(data: path, len: csize_t(len(path))), column), owned: true)
...
proc miqt_exec_method_cQFileSystemModel_clearItemData(vtbl: pointer, inst: pointer, index: pointer): bool {.cdecl.} =
  let vtbl = cast[VirtualQFileSystemModel](cast[uint](vtbl) - uint(offsetOf(VirtualQFileSystemModel, vtbl)))
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
...
proc miqt_exec_method_cQFileSystemModel_multiData(vtbl: pointer, inst: pointer, index: pointer, roleDataSpan: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQFileSystemModel](cast[uint](vtbl) - uint(offsetOf(VirtualQFileSystemModel, vtbl)))
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
  let slotval2 = gen_qabstractitemmodel_types.QModelRoleDataSpan(h: roleDataSpan, owned: true)
...
proc miqt_exec_method_cQFileSystemModel_resetInternalData(vtbl: pointer, inst: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQFileSystemModel](cast[uint](vtbl) - uint(offsetOf(VirtualQFileSystemModel, vtbl)))
...
proc create*(T: type gen_qfilesystemmodel_types.QFileSystemModel,
  ...
  vtbl[].vtbl.clearItemData = miqt_exec_method_cQFileSystemModel_clearItemData
  ...
  vtbl[].vtbl.multiData = miqt_exec_method_cQFileSystemModel_multiData
  vtbl[].vtbl.submit = miqt_exec_method_cQFileSystemModel_submit
  vtbl[].vtbl.revert = miqt_exec_method_cQFileSystemModel_revert
  vtbl[].vtbl.resetInternalData = miqt_exec_method_cQFileSystemModel_resetInternalData
