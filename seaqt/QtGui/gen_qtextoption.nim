...
proc create*(T: type gen_qtextoption_types.QTextOptionTab,
  ...
  gen_qtextoption_types.QTextOptionTab(h: fcQTextOptionTab_new3(param1.h), owned: true)

proc create*(T: type gen_qtextoption_types.QTextOptionTab,
    pos: float64, tabType: cint, delim: gen_qchar_types.QChar): gen_qtextoption_types.QTextOptionTab =
  gen_qtextoption_types.QTextOptionTab(h: fcQTextOptionTab_new4(pos, cint(tabType), delim.h), owned: true)
