...
template ShowDefaultIgnorables*(_: type QTextOptionFlagEnum): untyped = 32
template DisableEmojiParsing*(_: type QTextOptionFlagEnum): untyped = 64
...
proc fcQTextOption_setTabArray(self: pointer, tabStops: struct_seaqt_array): void {.importc: "QTextOption_setTabArray".}
proc fcQTextOption_tabArray(self: pointer): struct_seaqt_array {.importc: "QTextOption_tabArray".}
proc fcQTextOption_setTabs(self: pointer, tabStops: struct_seaqt_array): void {.importc: "QTextOption_setTabs".}
proc fcQTextOption_tabs(self: pointer): struct_seaqt_array {.importc: "QTextOption_tabs".}
...
proc fcQTextOptionTab_setPosition(self: pointer, position: float64): void {.importc: "QTextOption__Tab_setPosition".}
proc fcQTextOptionTab_typeX(self: pointer): cint {.importc: "QTextOption__Tab_type".}
proc fcQTextOptionTab_setType(self: pointer, typeVal: cint): void {.importc: "QTextOption__Tab_setType".}
...
proc fcQTextOptionTab_new3(pos: float64, tabType: cint, delim: pointer): ptr cQTextOptionTab {.importc: "QTextOption__Tab_new_pos_tabType_delim".}
...
proc setTabArray*(self: gen_qtextoption_types.QTextOption, tabStops: openArray[float64]): void =
  ...
  fcQTextOption_setTabArray(self.h, struct_seaqt_array(len: csize_t(len(tabStops)), data: if len(tabStops) == 0: nil else: addr(tabStops_CArray[0])))
...
proc setTabs*(self: gen_qtextoption_types.QTextOption, tabStops: openArray[gen_qtextoption_types.QTextOptionTab]): void =
  ...
  fcQTextOption_setTabs(self.h, struct_seaqt_array(len: csize_t(len(tabStops)), data: if len(tabStops) == 0: nil else: addr(tabStops_CArray[0])))
...
proc create*(T: type gen_qtextoption_types.QTextOption): gen_qtextoption_types.QTextOption =
  let tmp = gen_qtextoption_types.QTextOption(h: fcQTextOption_new(), owned: true)
  tmp
...
proc position*(self: gen_qtextoption_types.QTextOptionTab): float64 =
  fcQTextOptionTab_position(self.h)

proc setPosition*(self: gen_qtextoption_types.QTextOptionTab, position: float64): void =
  fcQTextOptionTab_setPosition(self.h, position)

proc typeX*(self: gen_qtextoption_types.QTextOptionTab): cint =
  cint(fcQTextOptionTab_typeX(self.h))

proc setType*(self: gen_qtextoption_types.QTextOptionTab, typeVal: cint): void =
  fcQTextOptionTab_setType(self.h, cint(typeVal))

proc delimiter*(self: gen_qtextoption_types.QTextOptionTab): gen_qchar_types.QChar =
  gen_qchar_types.QChar(h: fcQTextOptionTab_delimiter(self.h), owned: true)

proc setDelimiter*(self: gen_qtextoption_types.QTextOptionTab, delimiter: gen_qchar_types.QChar): void =
  fcQTextOptionTab_setDelimiter(self.h, delimiter.h)

proc create*(T: type gen_qtextoption_types.QTextOptionTab): gen_qtextoption_types.QTextOptionTab =
  let tmp = gen_qtextoption_types.QTextOptionTab(h: fcQTextOptionTab_new(), owned: true)
  tmp
...
proc create*(T: type gen_qtextoption_types.QTextOptionTab,
  ...
  let tmp = gen_qtextoption_types.QTextOptionTab(h: fcQTextOptionTab_new3(pos, cint(tabType), delim.h), owned: true)
  tmp
