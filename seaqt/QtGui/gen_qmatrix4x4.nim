...
proc fcQMatrix4x4_projectedRotateAngleXYZDistanceToPlane(self: pointer, angle: float32, x: float32, y: float32, z: float32, distanceToPlane: float32): void {.importc: "QMatrix4x4_projectedRotate_angle_x_y_z_distanceToPlane".}
proc fcQMatrix4x4_projectedRotateAngleXYZ(self: pointer, angle: float32, x: float32, y: float32, z: float32): void {.importc: "QMatrix4x4_projectedRotate_angle_x_y_z".}
...
proc projectedRotate*(self: gen_qmatrix4x4_types.QMatrix4x4, angle: float32, x: float32, y: float32, z: float32, distanceToPlane: float32): void =
  fcQMatrix4x4_projectedRotateAngleXYZDistanceToPlane(self.h, angle, x, y, z, distanceToPlane)

proc projectedRotate*(self: gen_qmatrix4x4_types.QMatrix4x4, angle: float32, x: float32, y: float32, z: float32): void =
  fcQMatrix4x4_projectedRotateAngleXYZ(self.h, angle, x, y, z)
