...
template PdmDevicePixelRatioF_EncodedA*(_: type QPaintDevicePaintDeviceMetricEnum): untyped = 13
template PdmDevicePixelRatioF_EncodedB*(_: type QPaintDevicePaintDeviceMetricEnum): untyped = 14
...
proc fcQPaintDevice_encodeMetricF(metric: cint, value: float64): cint {.importc: "QPaintDevice_encodeMetricF".}
proc fcQPaintDevice_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QPaintDevice_protectedbase_getDecodedMetricF".}
...
proc encodeMetricF*(_: type gen_qpaintdevice_types.QPaintDevice, metric: cint, value: float64): cint =
  fcQPaintDevice_encodeMetricF(cint(metric), value)

proc getDecodedMetricF*(self: gen_qpaintdevice_types.QPaintDevice, metricA: cint, metricB: cint): float64 =
  fcQPaintDevice_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
