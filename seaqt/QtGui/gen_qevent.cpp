...
VirtualQInputEvent* QInputEvent_new(const QInputEvent_VTable* vtbl, size_t vdata, int type, QInputDevice* m_dev) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQInputEvent>());
...
VirtualQPointerEvent* QPointerEvent_new(const QPointerEvent_VTable* vtbl, size_t vdata, int type, QPointingDevice* dev) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQPointerEvent>());
...
VirtualQPointerEvent* QPointerEvent_new3(const QPointerEvent_VTable* vtbl, size_t vdata, int type, QPointingDevice* dev, int modifiers, struct miqt_array /* of QEventPoint* */  points) {
...
VirtualQEnterEvent* QEnterEvent_new(const QEnterEvent_VTable* vtbl, size_t vdata, QPointF* localPos, QPointF* scenePos, QPointF* globalPos) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQEnterEvent>());
...
VirtualQMouseEvent* QMouseEvent_new(const QMouseEvent_VTable* vtbl, size_t vdata, int type, QPointF* localPos, int button, int buttons, int modifiers) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQMouseEvent>());
...
VirtualQHoverEvent* QHoverEvent_new(const QHoverEvent_VTable* vtbl, size_t vdata, int type, QPointF* scenePos, QPointF* globalPos, QPointF* oldPos) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQHoverEvent>());
...
VirtualQWheelEvent* QWheelEvent_new(const QWheelEvent_VTable* vtbl, size_t vdata, QPointF* pos, QPointF* globalPos, QPoint* pixelDelta, QPoint* angleDelta, int buttons, int modifiers, int phase, bool inverted) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQWheelEvent>());
...
VirtualQTabletEvent* QTabletEvent_new(const QTabletEvent_VTable* vtbl, size_t vdata, int t, QPointingDevice* device, QPointF* pos, QPointF* globalPos, double pressure, float xTilt, float yTilt, float tangentialPressure, double rotation, float z, int keyState, int button, int buttons) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQTabletEvent>());
...
VirtualQNativeGestureEvent* QNativeGestureEvent_new(const QNativeGestureEvent_VTable* vtbl, size_t vdata, int type, QPointingDevice* dev, QPointF* localPos, QPointF* scenePos, QPointF* globalPos, double value, unsigned long long sequenceId, unsigned long long intArgument) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQNativeGestureEvent>());
...
VirtualQKeyEvent* QKeyEvent_new(const QKeyEvent_VTable* vtbl, size_t vdata, int type, int key, int modifiers) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQKeyEvent>());
...
VirtualQKeyEvent* QKeyEvent_new3(const QKeyEvent_VTable* vtbl, size_t vdata, int type, int key, int modifiers, struct miqt_string text) {
...
VirtualQKeyEvent* QKeyEvent_new4(const QKeyEvent_VTable* vtbl, size_t vdata, int type, int key, int modifiers, struct miqt_string text, bool autorep) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQKeyEvent>());
...
VirtualQKeyEvent* QKeyEvent_new5(const QKeyEvent_VTable* vtbl, size_t vdata, int type, int key, int modifiers, struct miqt_string text, bool autorep, unsigned short count) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQKeyEvent>());
...
VirtualQKeyEvent* QKeyEvent_new6(const QKeyEvent_VTable* vtbl, size_t vdata, int type, int key, int modifiers, unsigned int nativeScanCode, unsigned int nativeVirtualKey, unsigned int nativeModifiers, struct miqt_string text) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQKeyEvent>());
...
VirtualQKeyEvent* QKeyEvent_new7(const QKeyEvent_VTable* vtbl, size_t vdata, int type, int key, int modifiers, unsigned int nativeScanCode, unsigned int nativeVirtualKey, unsigned int nativeModifiers, struct miqt_string text, bool autorep) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQKeyEvent>());
...
VirtualQKeyEvent* QKeyEvent_new8(const QKeyEvent_VTable* vtbl, size_t vdata, int type, int key, int modifiers, unsigned int nativeScanCode, unsigned int nativeVirtualKey, unsigned int nativeModifiers, struct miqt_string text, bool autorep, unsigned short count) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQKeyEvent>());
...
VirtualQKeyEvent* QKeyEvent_new9(const QKeyEvent_VTable* vtbl, size_t vdata, int type, int key, int modifiers, unsigned int nativeScanCode, unsigned int nativeVirtualKey, unsigned int nativeModifiers, struct miqt_string text, bool autorep, unsigned short count, QInputDevice* device) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQKeyEvent>());
...
VirtualQFocusEvent* QFocusEvent_new(const QFocusEvent_VTable* vtbl, size_t vdata, int type) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQFocusEvent>());
...
VirtualQPaintEvent* QPaintEvent_new(const QPaintEvent_VTable* vtbl, size_t vdata, QRegion* paintRegion) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQPaintEvent>());
...
VirtualQMoveEvent* QMoveEvent_new(const QMoveEvent_VTable* vtbl, size_t vdata, QPoint* pos, QPoint* oldPos) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQMoveEvent>());
...
VirtualQExposeEvent* QExposeEvent_new(const QExposeEvent_VTable* vtbl, size_t vdata, QRegion* m_region) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQExposeEvent>());
...
VirtualQPlatformSurfaceEvent* QPlatformSurfaceEvent_new(const QPlatformSurfaceEvent_VTable* vtbl, size_t vdata, int surfaceEventType) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQPlatformSurfaceEvent>());
...
VirtualQResizeEvent* QResizeEvent_new(const QResizeEvent_VTable* vtbl, size_t vdata, QSize* size, QSize* oldSize) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQResizeEvent>());
...
VirtualQCloseEvent* QCloseEvent_new(const QCloseEvent_VTable* vtbl, size_t vdata) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQCloseEvent>());
...
VirtualQIconDragEvent* QIconDragEvent_new(const QIconDragEvent_VTable* vtbl, size_t vdata) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQIconDragEvent>());
...
VirtualQShowEvent* QShowEvent_new(const QShowEvent_VTable* vtbl, size_t vdata) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQShowEvent>());
...
VirtualQHideEvent* QHideEvent_new(const QHideEvent_VTable* vtbl, size_t vdata) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQHideEvent>());
...
VirtualQContextMenuEvent* QContextMenuEvent_new(const QContextMenuEvent_VTable* vtbl, size_t vdata, int reason, QPoint* pos, QPoint* globalPos) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQContextMenuEvent>());
...
VirtualQInputMethodEvent* QInputMethodEvent_new(const QInputMethodEvent_VTable* vtbl, size_t vdata) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQInputMethodEvent>());
	return _mem_ ? new (_mem_)VirtualQInputMethodEvent(vtbl) : nullptr;
}

VirtualQInputMethodEvent* QInputMethodEvent_new2(const QInputMethodEvent_VTable* vtbl, size_t vdata, struct miqt_string preeditText, struct miqt_array /* of QInputMethodEvent__Attribute* */  attributes) {
...
VirtualQInputMethodQueryEvent* QInputMethodQueryEvent_new(const QInputMethodQueryEvent_VTable* vtbl, size_t vdata, int queries) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQInputMethodQueryEvent>());
...
VirtualQDropEvent* QDropEvent_new(const QDropEvent_VTable* vtbl, size_t vdata, QPointF* pos, int actions, QMimeData* data, int buttons, int modifiers) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQDropEvent>());
...
VirtualQDragMoveEvent* QDragMoveEvent_new(const QDragMoveEvent_VTable* vtbl, size_t vdata, QPoint* pos, int actions, QMimeData* data, int buttons, int modifiers) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQDragMoveEvent>());
...
VirtualQDragEnterEvent* QDragEnterEvent_new(const QDragEnterEvent_VTable* vtbl, size_t vdata, QPoint* pos, int actions, QMimeData* data, int buttons, int modifiers) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQDragEnterEvent>());
...
VirtualQDragLeaveEvent* QDragLeaveEvent_new(const QDragLeaveEvent_VTable* vtbl, size_t vdata) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQDragLeaveEvent>());
...
VirtualQHelpEvent* QHelpEvent_new(const QHelpEvent_VTable* vtbl, size_t vdata, int type, QPoint* pos, QPoint* globalPos) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQHelpEvent>());
...
VirtualQStatusTipEvent* QStatusTipEvent_new(const QStatusTipEvent_VTable* vtbl, size_t vdata, struct miqt_string tip) {
	QString tip_QString = QString::fromUtf8(tip.data, tip.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQStatusTipEvent>());
...
VirtualQWhatsThisClickedEvent* QWhatsThisClickedEvent_new(const QWhatsThisClickedEvent_VTable* vtbl, size_t vdata, struct miqt_string href) {
	QString href_QString = QString::fromUtf8(href.data, href.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQWhatsThisClickedEvent>());
...
VirtualQFileOpenEvent* QFileOpenEvent_new(const QFileOpenEvent_VTable* vtbl, size_t vdata, struct miqt_string file) {
	QString file_QString = QString::fromUtf8(file.data, file.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQFileOpenEvent>());
...
VirtualQToolBarChangeEvent* QToolBarChangeEvent_new(const QToolBarChangeEvent_VTable* vtbl, size_t vdata, bool t) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQToolBarChangeEvent>());
...
VirtualQShortcutEvent* QShortcutEvent_new(const QShortcutEvent_VTable* vtbl, size_t vdata, QKeySequence* key, int id) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQShortcutEvent>());
...
VirtualQWindowStateChangeEvent* QWindowStateChangeEvent_new(const QWindowStateChangeEvent_VTable* vtbl, size_t vdata, int oldState) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQWindowStateChangeEvent>());
...
VirtualQTouchEvent* QTouchEvent_new(const QTouchEvent_VTable* vtbl, size_t vdata, int eventType) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQTouchEvent>());
...
VirtualQTouchEvent* QTouchEvent_new5(const QTouchEvent_VTable* vtbl, size_t vdata, int eventType, QPointingDevice* device, int modifiers, struct miqt_array /* of QEventPoint* */  touchPoints) {
...
VirtualQTouchEvent* QTouchEvent_new6(const QTouchEvent_VTable* vtbl, size_t vdata, int eventType, QPointingDevice* device, int modifiers, uint8_t touchPointStates, struct miqt_array /* of QEventPoint* */  touchPoints) {
	QList<QEventPoint> touchPoints_QList;
	touchPoints_QList.reserve(touchPoints.len);
	QEventPoint** touchPoints_arr = static_cast<QEventPoint**>(touchPoints.data);
	for(size_t i = 0; i < touchPoints.len; ++i) {
...
VirtualQScrollPrepareEvent* QScrollPrepareEvent_new(const QScrollPrepareEvent_VTable* vtbl, size_t vdata, QPointF* startPos) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQScrollPrepareEvent>());
...
VirtualQScrollEvent* QScrollEvent_new(const QScrollEvent_VTable* vtbl, size_t vdata, QPointF* contentPos, QPointF* overshoot, int scrollState) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQScrollEvent>());
...
VirtualQScreenOrientationChangeEvent* QScreenOrientationChangeEvent_new(const QScreenOrientationChangeEvent_VTable* vtbl, size_t vdata, QScreen* screen, int orientation) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQScreenOrientationChangeEvent>());
...
VirtualQApplicationStateChangeEvent* QApplicationStateChangeEvent_new(const QApplicationStateChangeEvent_VTable* vtbl, size_t vdata, int state) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQApplicationStateChangeEvent>());
