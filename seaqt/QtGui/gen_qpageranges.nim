...
proc fcQPageRanges_toRangeList(self: pointer): struct_seaqt_array {.importc: "QPageRanges_toRangeList".}
proc fcQPageRanges_clear(self: pointer): void {.importc: "QPageRanges_clear".}
proc fcQPageRanges_toString(self: pointer): struct_seaqt_string {.importc: "QPageRanges_toString".}
proc fcQPageRanges_fromString(ranges: struct_seaqt_string): pointer {.importc: "QPageRanges_fromString".}
...
proc setFrom*(self: gen_qpageranges_types.QPageRangesRange, fromVal: cint): void =
  fcQPageRangesRange_setFrom(self.h, fromVal)

proc to*(self: gen_qpageranges_types.QPageRangesRange): cint =
  fcQPageRangesRange_to(self.h)

proc setTo*(self: gen_qpageranges_types.QPageRangesRange, to: cint): void =
  fcQPageRangesRange_setTo(self.h, to)
