...
proc fcQTestQTouchEventSequence_operatorAssign(self: pointer, param1: pointer): void {.importc: "QTest__QTouchEventSequence_operatorAssign".}
proc fcQTestQTouchEventSequence_press2(self: pointer, touchId: cint, pt: pointer, window: pointer): pointer {.importc: "QTest__QTouchEventSequence_press2".}
proc fcQTestQTouchEventSequence_move2(self: pointer, touchId: cint, pt: pointer, window: pointer): pointer {.importc: "QTest__QTouchEventSequence_move2".}
proc fcQTestQTouchEventSequence_release2(self: pointer, touchId: cint, pt: pointer, window: pointer): pointer {.importc: "QTest__QTouchEventSequence_release2".}
...
proc operatorAssign*(self: gen_qtestsupport_gui_types.QTestQTouchEventSequence, param1: gen_qtestsupport_gui_types.QTestQTouchEventSequence): void =
  fcQTestQTouchEventSequence_operatorAssign(self.h, param1.h)
...
proc press*(self: gen_qtestsupport_gui_types.QTestQTouchEventSequence, touchId: cint, pt: gen_qpoint_types.QPoint, window: gen_qwindow_types.QWindow): gen_qtestsupport_gui_types.QTestQTouchEventSequence =
  gen_qtestsupport_gui_types.QTestQTouchEventSequence(h: fcQTestQTouchEventSequence_press2(self.h, touchId, pt.h, window.h), owned: false)
...
proc move*(self: gen_qtestsupport_gui_types.QTestQTouchEventSequence, touchId: cint, pt: gen_qpoint_types.QPoint, window: gen_qwindow_types.QWindow): gen_qtestsupport_gui_types.QTestQTouchEventSequence =
  gen_qtestsupport_gui_types.QTestQTouchEventSequence(h: fcQTestQTouchEventSequence_move2(self.h, touchId, pt.h, window.h), owned: false)
...
proc release*(self: gen_qtestsupport_gui_types.QTestQTouchEventSequence, touchId: cint, pt: gen_qpoint_types.QPoint, window: gen_qwindow_types.QWindow): gen_qtestsupport_gui_types.QTestQTouchEventSequence =
  gen_qtestsupport_gui_types.QTestQTouchEventSequence(h: fcQTestQTouchEventSequence_release2(self.h, touchId, pt.h, window.h), owned: false)
