...
proc fcQImageReader_trUtf8(sourceText: cstring): struct_seaqt_string {.importc: "QImageReader_trUtf8".}
...
proc fcQImageReader_trUtf82(sourceText: cstring, disambiguation: cstring): struct_seaqt_string {.importc: "QImageReader_trUtf82".}
proc fcQImageReader_trUtf83(sourceText: cstring, disambiguation: cstring, n: cint): struct_seaqt_string {.importc: "QImageReader_trUtf83".}
