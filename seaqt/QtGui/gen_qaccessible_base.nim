...
template Announcement*(_: type QAccessibleEventEnum): untyped = 32976
template IdentifierChanged*(_: type QAccessibleEventEnum): untyped = 32992
template RoleChanged*(_: type QAccessibleEventEnum): untyped = 32993
...
template Switch*(_: type QAccessibleRoleEnum): untyped = 135
...
template BlockQuote*(_: type QAccessibleRoleEnum): untyped = 1073
...
template Identifier*(_: type QAccessibleTextEnum): untyped = 6
...
template DescriptionFor*(_: type QAccessibleRelationFlagEnum): untyped = 16
template Described*(_: type QAccessibleRelationFlagEnum): untyped = 32
template FlowsFrom*(_: type QAccessibleRelationFlagEnum): untyped = 64
template FlowsTo*(_: type QAccessibleRelationFlagEnum): untyped = 128
...
template SelectionInterface*(_: type QAccessibleInterfaceTypeEnum): untyped = 8
template AttributesInterface*(_: type QAccessibleInterfaceTypeEnum): untyped = 9
...
type QAccessibleAttributeEnum* = distinct cint
template Custom*(_: type QAccessibleAttributeEnum): untyped = 0
template Level*(_: type QAccessibleAttributeEnum): untyped = 1
template Locale*(_: type QAccessibleAttributeEnum): untyped = 2
template Orientation*(_: type QAccessibleAttributeEnum): untyped = 3


type QAccessibleAnnouncementPolitenessEnum* = distinct cint
template Polite*(_: type QAccessibleAnnouncementPolitenessEnum): untyped = 0
template Assertive*(_: type QAccessibleAnnouncementPolitenessEnum): untyped = 1
...
proc fcQAccessibleState_reserved(self: pointer): culonglong {.importc: "QAccessible__State_reserved".}
proc fcQAccessibleState_setQtReserved(self: pointer, qt_reserved: culonglong): void {.importc: "QAccessible__State_setQt_reserved".}
...
proc reserved*(self: gen_qaccessible_base_types.QAccessibleState): culonglong =
  fcQAccessibleState_reserved(self.h)

proc setQtReserved*(self: gen_qaccessible_base_types.QAccessibleState, qt_reserved: culonglong): void =
  fcQAccessibleState_setQtReserved(self.h, qt_reserved)
