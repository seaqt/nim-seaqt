...
proc create*(T: type gen_qeventpoint_types.QEventPoint,
  ...
  let tmp = gen_qeventpoint_types.QEventPoint(h: fcQEventPoint_new4(id), owned: true)
  tmp
proc create*(T: type gen_qeventpoint_types.QEventPoint,
    id: cint, device: gen_qpointingdevice_types.QPointingDevice): gen_qeventpoint_types.QEventPoint =
  let tmp = gen_qeventpoint_types.QEventPoint(h: fcQEventPoint_new5(id, device.h), owned: true)
  tmp
