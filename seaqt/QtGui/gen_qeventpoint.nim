...
proc create*(T: type gen_qeventpoint_types.QEventPoint): gen_qeventpoint_types.QEventPoint =
  let tmp = gen_qeventpoint_types.QEventPoint(h: fcQEventPoint_new())
  tmp
proc create*(T: type gen_qeventpoint_types.QEventPoint,
  ...
  let tmp = gen_qeventpoint_types.QEventPoint(h: fcQEventPoint_new2(pointId, cint(state), scenePosition.h, globalPosition.h))
  tmp
proc create*(T: type gen_qeventpoint_types.QEventPoint,
    other: gen_qeventpoint_types.QEventPoint): gen_qeventpoint_types.QEventPoint =
  let tmp = gen_qeventpoint_types.QEventPoint(h: fcQEventPoint_new3(other.h))
  tmp
proc create*(T: type gen_qeventpoint_types.QEventPoint,
    id: cint): gen_qeventpoint_types.QEventPoint =
  let tmp = gen_qeventpoint_types.QEventPoint(h: fcQEventPoint_new4(id))
  tmp
proc create*(T: type gen_qeventpoint_types.QEventPoint,
    id: cint, device: gen_qpointingdevice_types.QPointingDevice): gen_qeventpoint_types.QEventPoint =
  let tmp = gen_qeventpoint_types.QEventPoint(h: fcQEventPoint_new5(id, device.h))
  tmp
