...
proc create*(T: type gen_qpagelayout_types.QPageLayout): gen_qpagelayout_types.QPageLayout =
  let tmp = gen_qpagelayout_types.QPageLayout(h: fcQPageLayout_new())
  tmp
proc create*(T: type gen_qpagelayout_types.QPageLayout,
  ...
  let tmp = gen_qpagelayout_types.QPageLayout(h: fcQPageLayout_new2(pageSize.h, cint(orientation), margins.h))
  tmp
proc create*(T: type gen_qpagelayout_types.QPageLayout,
    other: gen_qpagelayout_types.QPageLayout): gen_qpagelayout_types.QPageLayout =
  let tmp = gen_qpagelayout_types.QPageLayout(h: fcQPageLayout_new3(other.h))
  tmp
proc create*(T: type gen_qpagelayout_types.QPageLayout,
  ...
  let tmp = gen_qpagelayout_types.QPageLayout(h: fcQPageLayout_new4(pageSize.h, cint(orientation), margins.h, cint(units)))
  tmp
proc create*(T: type gen_qpagelayout_types.QPageLayout,
  ...
  let tmp = gen_qpagelayout_types.QPageLayout(h: fcQPageLayout_new5(pageSize.h, cint(orientation), margins.h, cint(units), minMargins.h))
  tmp
