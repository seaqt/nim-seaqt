...
VirtualQInputDevice* QInputDevice_new(const QInputDevice_VTable* vtbl, size_t vdata) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQInputDevice>());
	return _mem_ ? new (_mem_)VirtualQInputDevice(vtbl) : nullptr;
}

VirtualQInputDevice* QInputDevice_new2(const QInputDevice_VTable* vtbl, size_t vdata, struct miqt_string name, long long systemId, int type) {
...
VirtualQInputDevice* QInputDevice_new4(const QInputDevice_VTable* vtbl, size_t vdata, struct miqt_string name, long long systemId, int type, struct miqt_string seatName) {
	QString name_QString = QString::fromUtf8(name.data, name.len);
...
VirtualQInputDevice* QInputDevice_new5(const QInputDevice_VTable* vtbl, size_t vdata, struct miqt_string name, long long systemId, int type, struct miqt_string seatName, QObject* parent) {
	QString name_QString = QString::fromUtf8(name.data, name.len);
	QString seatName_QString = QString::fromUtf8(seatName.data, seatName.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQInputDevice>());
