...
proc fromIccProfile*(_: type gen_qcolorspace_types.QColorSpace, iccProfile: seq[byte]): gen_qcolorspace_types.QColorSpace =
  gen_qcolorspace_types.QColorSpace(h: fcQColorSpace_fromIccProfile(struct_miqt_string(data: if len(iccProfile) > 0: addr iccProfile[0] else: nil, len: csize_t(len(iccProfile)))))
...
proc create*(T: type gen_qcolorspace_types.QColorSpace,
  ...
  let tmp = gen_qcolorspace_types.QColorSpace(h: fcQColorSpace_new5(cint(primaries), struct_miqt_array(len: csize_t(len(transferFunctionTable)), data: if len(transferFunctionTable) == 0: nil else: addr(transferFunctionTable_CArray[0]))))
  tmp
proc create*(T: type gen_qcolorspace_types.QColorSpace,
...
proc create*(T: type gen_qcolorspace_types.QColorSpace,
  ...
  let tmp = gen_qcolorspace_types.QColorSpace(h: fcQColorSpace_new7(whitePoint.h, redPoint.h, greenPoint.h, bluePoint.h, struct_miqt_array(len: csize_t(len(transferFunctionTable)), data: if len(transferFunctionTable) == 0: nil else: addr(transferFunctionTable_CArray[0]))))
  tmp
proc create*(T: type gen_qcolorspace_types.QColorSpace,
