...
proc create*(T: type gen_qcolorspace_types.QColorSpace,
  ...
  gen_qcolorspace_types.QColorSpace(h: fcQColorSpace_new5(cint(primaries), struct_miqt_array(len: csize_t(len(transferFunctionTable)), data: if len(transferFunctionTable) == 0: nil else: addr(transferFunctionTable_CArray[0]))), owned: true)
...
proc create*(T: type gen_qcolorspace_types.QColorSpace,
  ...
  gen_qcolorspace_types.QColorSpace(h: fcQColorSpace_new6(whitePoint.h, redPoint.h, greenPoint.h, bluePoint.h, cint(transferFunction)), owned: true)
...
proc create*(T: type gen_qcolorspace_types.QColorSpace,
  ...
  gen_qcolorspace_types.QColorSpace(h: fcQColorSpace_new7(whitePoint.h, redPoint.h, greenPoint.h, bluePoint.h, struct_miqt_array(len: csize_t(len(transferFunctionTable)), data: if len(transferFunctionTable) == 0: nil else: addr(transferFunctionTable_CArray[0]))), owned: true)
...
proc create*(T: type gen_qcolorspace_types.QColorSpace,
  ...
  gen_qcolorspace_types.QColorSpace(h: fcQColorSpace_new9(colorSpace.h), owned: true)

proc create*(T: type gen_qcolorspace_types.QColorSpace,
    primaries: cint, transferFunction: cint, gamma: float32): gen_qcolorspace_types.QColorSpace =
  gen_qcolorspace_types.QColorSpace(h: fcQColorSpace_new10(cint(primaries), cint(transferFunction), gamma), owned: true)
...
proc create*(T: type gen_qcolorspace_types.QColorSpace,
  ...
  gen_qcolorspace_types.QColorSpace(h: fcQColorSpace_new11(whitePoint.h, redPoint.h, greenPoint.h, bluePoint.h, cint(transferFunction), gamma), owned: true)
