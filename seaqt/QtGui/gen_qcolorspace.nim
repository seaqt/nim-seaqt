...
proc setDescription*(self: gen_qcolorspace_types.QColorSpace, description: openArray[char]): void =
  fcQColorSpace_setDescription(self.h, struct_miqt_string(data: if len(description) > 0: addr description[0] else: nil, len: csize_t(len(description))))
...
proc withTransferFunction*(self: gen_qcolorspace_types.QColorSpace, transferFunctionTable: openArray[uint16]): gen_qcolorspace_types.QColorSpace =
  ...
  gen_qcolorspace_types.QColorSpace(h: fcQColorSpace_withTransferFunctionWithTransferFunctionTable(self.h, struct_miqt_array(len: csize_t(len(transferFunctionTable)), data: if len(transferFunctionTable) == 0: nil else: addr(transferFunctionTable_CArray[0]))), owned: true)
...
proc withTransferFunctions*(self: gen_qcolorspace_types.QColorSpace, redTransferFunctionTable: openArray[uint16], greenTransferFunctionTable: openArray[uint16], blueTransferFunctionTable: openArray[uint16]): gen_qcolorspace_types.QColorSpace =
  ...
  gen_qcolorspace_types.QColorSpace(h: fcQColorSpace_withTransferFunctions(self.h, struct_miqt_array(len: csize_t(len(redTransferFunctionTable)), data: if len(redTransferFunctionTable) == 0: nil else: addr(redTransferFunctionTable_CArray[0])), struct_miqt_array(len: csize_t(len(greenTransferFunctionTable)), data: if len(greenTransferFunctionTable) == 0: nil else: addr(greenTransferFunctionTable_CArray[0])), struct_miqt_array(len: csize_t(len(blueTransferFunctionTable)), data: if len(blueTransferFunctionTable) == 0: nil else: addr(blueTransferFunctionTable_CArray[0]))), owned: true)
...
proc fromIccProfile*(_: type gen_qcolorspace_types.QColorSpace, iccProfile: openArray[byte]): gen_qcolorspace_types.QColorSpace =
  gen_qcolorspace_types.QColorSpace(h: fcQColorSpace_fromIccProfile(struct_miqt_string(data: if len(iccProfile) > 0: addr iccProfile[0] else: nil, len: csize_t(len(iccProfile)))), owned: true)
...
proc create*(T: type gen_qcolorspace_types.QColorSpace,
  ...
  let tmp = gen_qcolorspace_types.QColorSpace(h: fcQColorSpace_new5(cint(primaries), struct_miqt_array(len: csize_t(len(transferFunctionTable)), data: if len(transferFunctionTable) == 0: nil else: addr(transferFunctionTable_CArray[0]))), owned: true)
  tmp
proc create*(T: type gen_qcolorspace_types.QColorSpace,
  ...
  let tmp = gen_qcolorspace_types.QColorSpace(h: fcQColorSpace_new6(whitePoint.h, redPoint.h, greenPoint.h, bluePoint.h, cint(transferFunction)), owned: true)
  tmp
proc create*(T: type gen_qcolorspace_types.QColorSpace,
  ...
  let tmp = gen_qcolorspace_types.QColorSpace(h: fcQColorSpace_new7(whitePoint.h, redPoint.h, greenPoint.h, bluePoint.h, struct_miqt_array(len: csize_t(len(transferFunctionTable)), data: if len(transferFunctionTable) == 0: nil else: addr(transferFunctionTable_CArray[0]))), owned: true)
  tmp
proc create*(T: type gen_qcolorspace_types.QColorSpace,
  ...
  let tmp = gen_qcolorspace_types.QColorSpace(h: fcQColorSpace_new8(whitePoint.h, redPoint.h, greenPoint.h, bluePoint.h, struct_miqt_array(len: csize_t(len(redTransferFunctionTable)), data: if len(redTransferFunctionTable) == 0: nil else: addr(redTransferFunctionTable_CArray[0])), struct_miqt_array(len: csize_t(len(greenTransferFunctionTable)), data: if len(greenTransferFunctionTable) == 0: nil else: addr(greenTransferFunctionTable_CArray[0])), struct_miqt_array(len: csize_t(len(blueTransferFunctionTable)), data: if len(blueTransferFunctionTable) == 0: nil else: addr(blueTransferFunctionTable_CArray[0]))), owned: true)
  tmp
proc create*(T: type gen_qcolorspace_types.QColorSpace,
...
proc create*(T: type gen_qcolorspace_types.QColorSpace,
  ...
  let tmp = gen_qcolorspace_types.QColorSpace(h: fcQColorSpace_new10(cint(primaries), cint(transferFunction), gamma), owned: true)
  tmp
proc create*(T: type gen_qcolorspace_types.QColorSpace,
  ...
  let tmp = gen_qcolorspace_types.QColorSpace(h: fcQColorSpace_new11(whitePoint.h, redPoint.h, greenPoint.h, bluePoint.h, cint(transferFunction), gamma), owned: true)
  tmp
