...
type cQColorSpacePrimaryPoints*{.exportc: "QColorSpace__PrimaryPoints", incompleteStruct.} = object
...
proc fcQColorSpace_setPrimaryPoints(self: pointer, primaryPoints: pointer): void {.importc: "QColorSpace_setPrimaryPoints".}
proc fcQColorSpace_primaryPoints(self: pointer): pointer {.importc: "QColorSpace_primaryPoints".}
...
proc fcQColorSpace_new9(primaryPoints: pointer, transferFunction: cint): ptr cQColorSpace {.importc: "QColorSpace_new_primaryPoints_transferFunction".}
proc fcQColorSpace_new10(whitePoint: pointer, redPoint: pointer, greenPoint: pointer, bluePoint: pointer, transferFunctionTable: struct_seaqt_array): ptr cQColorSpace {.importc: "QColorSpace_new_whitePoint_redPoint_greenPoint_bluePoint_transferFunctionTable".}
proc fcQColorSpace_new11(whitePoint: pointer, redPoint: pointer, greenPoint: pointer, bluePoint: pointer, redTransferFunctionTable: struct_seaqt_array, greenTransferFunctionTable: struct_seaqt_array, blueTransferFunctionTable: struct_seaqt_array): ptr cQColorSpace {.importc: "QColorSpace_new_whitePoint_redPoint_greenPoint_bluePoint_redTransferFunctionTable_greenTransferFunctionTable_blueTransferFunctionTable".}
proc fcQColorSpace_new12(fromVal: pointer): ptr cQColorSpace {.importc: "QColorSpace_new_from".}
proc fcQColorSpace_new13(whitePoint: pointer, transferFunction: cint, gamma: float32): ptr cQColorSpace {.importc: "QColorSpace_new_whitePoint_transferFunction_gamma".}
proc fcQColorSpace_new14(primaries: cint, transferFunction: cint, gamma: float32): ptr cQColorSpace {.importc: "QColorSpace_new_primaries_transferFunction_gamma".}
proc fcQColorSpace_new15(whitePoint: pointer, redPoint: pointer, greenPoint: pointer, bluePoint: pointer, transferFunction: cint, gamma: float32): ptr cQColorSpace {.importc: "QColorSpace_new_whitePoint_redPoint_greenPoint_bluePoint_transferFunction_gamma".}
proc fcQColorSpace_new16(primaryPoints: pointer, transferFunction: cint, gamma: float32): ptr cQColorSpace {.importc: "QColorSpace_new_primaryPoints_transferFunction_gamma".}
proc fcQColorSpace_staticMetaObject(): pointer {.importc: "QColorSpace_staticMetaObject".}
proc fcQColorSpacePrimaryPoints_fromPrimaries(primaries: cint): pointer {.importc: "QColorSpace__PrimaryPoints_fromPrimaries".}
proc fcQColorSpacePrimaryPoints_isValid(self: pointer): bool {.importc: "QColorSpace__PrimaryPoints_isValid".}
proc fcQColorSpacePrimaryPoints_whitePoint(self: pointer): pointer {.importc: "QColorSpace__PrimaryPoints_whitePoint".}
proc fcQColorSpacePrimaryPoints_setWhitePoint(self: pointer, whitePoint: pointer): void {.importc: "QColorSpace__PrimaryPoints_setWhitePoint".}
proc fcQColorSpacePrimaryPoints_redPoint(self: pointer): pointer {.importc: "QColorSpace__PrimaryPoints_redPoint".}
proc fcQColorSpacePrimaryPoints_setRedPoint(self: pointer, redPoint: pointer): void {.importc: "QColorSpace__PrimaryPoints_setRedPoint".}
proc fcQColorSpacePrimaryPoints_greenPoint(self: pointer): pointer {.importc: "QColorSpace__PrimaryPoints_greenPoint".}
proc fcQColorSpacePrimaryPoints_setGreenPoint(self: pointer, greenPoint: pointer): void {.importc: "QColorSpace__PrimaryPoints_setGreenPoint".}
proc fcQColorSpacePrimaryPoints_bluePoint(self: pointer): pointer {.importc: "QColorSpace__PrimaryPoints_bluePoint".}
proc fcQColorSpacePrimaryPoints_setBluePoint(self: pointer, bluePoint: pointer): void {.importc: "QColorSpace__PrimaryPoints_setBluePoint".}
...
proc setPrimaryPoints*(self: gen_qcolorspace_types.QColorSpace, primaryPoints: gen_qcolorspace_types.QColorSpacePrimaryPoints): void =
  fcQColorSpace_setPrimaryPoints(self.h, primaryPoints.h)

proc primaryPoints*(self: gen_qcolorspace_types.QColorSpace): gen_qcolorspace_types.QColorSpacePrimaryPoints =
  gen_qcolorspace_types.QColorSpacePrimaryPoints(h: fcQColorSpace_primaryPoints(self.h), owned: true)
...
proc create*(T: type gen_qcolorspace_types.QColorSpace,
  ...
  tmp
proc create*(T: type gen_qcolorspace_types.QColorSpace,
    primaryPoints: gen_qcolorspace_types.QColorSpacePrimaryPoints, transferFunction: cint): gen_qcolorspace_types.QColorSpace =
  let tmp = gen_qcolorspace_types.QColorSpace(h: fcQColorSpace_new9(primaryPoints.h, cint(transferFunction)), owned: true)
  tmp
proc create*(T: type gen_qcolorspace_types.QColorSpace,
  ...
  let tmp = gen_qcolorspace_types.QColorSpace(h: fcQColorSpace_new10(whitePoint.h, redPoint.h, greenPoint.h, bluePoint.h, struct_seaqt_array(len: csize_t(len(transferFunctionTable)), data: if len(transferFunctionTable) == 0: nil else: addr(transferFunctionTable_CArray[0]))), owned: true)
  tmp
proc create*(T: type gen_qcolorspace_types.QColorSpace,
...
proc create*(T: type gen_qcolorspace_types.QColorSpace,
  ...
  let tmp = gen_qcolorspace_types.QColorSpace(h: fcQColorSpace_new15(whitePoint.h, redPoint.h, greenPoint.h, bluePoint.h, cint(transferFunction), gamma), owned: true)
  tmp
proc create*(T: type gen_qcolorspace_types.QColorSpace,
    primaryPoints: gen_qcolorspace_types.QColorSpacePrimaryPoints, transferFunction: cint, gamma: float32): gen_qcolorspace_types.QColorSpace =
  let tmp = gen_qcolorspace_types.QColorSpace(h: fcQColorSpace_new16(primaryPoints.h, cint(transferFunction), gamma), owned: true)
  tmp
...
proc fromPrimaries*(_: type gen_qcolorspace_types.QColorSpacePrimaryPoints, primaries: cint): gen_qcolorspace_types.QColorSpacePrimaryPoints =
  gen_qcolorspace_types.QColorSpacePrimaryPoints(h: fcQColorSpacePrimaryPoints_fromPrimaries(cint(primaries)), owned: true)

proc isValid*(self: gen_qcolorspace_types.QColorSpacePrimaryPoints): bool =
  fcQColorSpacePrimaryPoints_isValid(self.h)

proc whitePoint*(self: gen_qcolorspace_types.QColorSpacePrimaryPoints): gen_qpoint_types.QPointF =
  gen_qpoint_types.QPointF(h: fcQColorSpacePrimaryPoints_whitePoint(self.h), owned: true)

proc setWhitePoint*(self: gen_qcolorspace_types.QColorSpacePrimaryPoints, whitePoint: gen_qpoint_types.QPointF): void =
  fcQColorSpacePrimaryPoints_setWhitePoint(self.h, whitePoint.h)

proc redPoint*(self: gen_qcolorspace_types.QColorSpacePrimaryPoints): gen_qpoint_types.QPointF =
  gen_qpoint_types.QPointF(h: fcQColorSpacePrimaryPoints_redPoint(self.h), owned: true)

proc setRedPoint*(self: gen_qcolorspace_types.QColorSpacePrimaryPoints, redPoint: gen_qpoint_types.QPointF): void =
  fcQColorSpacePrimaryPoints_setRedPoint(self.h, redPoint.h)

proc greenPoint*(self: gen_qcolorspace_types.QColorSpacePrimaryPoints): gen_qpoint_types.QPointF =
  gen_qpoint_types.QPointF(h: fcQColorSpacePrimaryPoints_greenPoint(self.h), owned: true)

proc setGreenPoint*(self: gen_qcolorspace_types.QColorSpacePrimaryPoints, greenPoint: gen_qpoint_types.QPointF): void =
  fcQColorSpacePrimaryPoints_setGreenPoint(self.h, greenPoint.h)

proc bluePoint*(self: gen_qcolorspace_types.QColorSpacePrimaryPoints): gen_qpoint_types.QPointF =
  gen_qpoint_types.QPointF(h: fcQColorSpacePrimaryPoints_bluePoint(self.h), owned: true)

proc setBluePoint*(self: gen_qcolorspace_types.QColorSpacePrimaryPoints, bluePoint: gen_qpoint_types.QPointF): void =
  fcQColorSpacePrimaryPoints_setBluePoint(self.h, bluePoint.h)
