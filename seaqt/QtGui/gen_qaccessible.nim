...
type cQAccessibleSelectionInterface*{.exportc: "QAccessibleSelectionInterface", incompleteStruct.} = object
type cQAccessibleAttributesInterface*{.exportc: "QAccessibleAttributesInterface", incompleteStruct.} = object
...
type cQAccessibleAnnouncementEvent*{.exportc: "QAccessibleAnnouncementEvent", incompleteStruct.} = object
...
proc fcQAccessibleInterface_selectionInterface(self: pointer): pointer {.importc: "QAccessibleInterface_selectionInterface".}
proc fcQAccessibleInterface_attributesInterface(self: pointer): pointer {.importc: "QAccessibleInterface_attributesInterface".}
...
proc fcQAccessibleSelectionInterface_selectedItemCount(self: pointer): cint {.importc: "QAccessibleSelectionInterface_selectedItemCount".}
proc fcQAccessibleSelectionInterface_selectedItems(self: pointer): struct_seaqt_array {.importc: "QAccessibleSelectionInterface_selectedItems".}
proc fcQAccessibleSelectionInterface_selectedItem(self: pointer, selectionIndex: cint): pointer {.importc: "QAccessibleSelectionInterface_selectedItem".}
proc fcQAccessibleSelectionInterface_isSelected(self: pointer, childItem: pointer): bool {.importc: "QAccessibleSelectionInterface_isSelected".}
proc fcQAccessibleSelectionInterface_select(self: pointer, childItem: pointer): bool {.importc: "QAccessibleSelectionInterface_select".}
proc fcQAccessibleSelectionInterface_unselect(self: pointer, childItem: pointer): bool {.importc: "QAccessibleSelectionInterface_unselect".}
proc fcQAccessibleSelectionInterface_selectAll(self: pointer): bool {.importc: "QAccessibleSelectionInterface_selectAll".}
proc fcQAccessibleSelectionInterface_clear(self: pointer): bool {.importc: "QAccessibleSelectionInterface_clear".}
proc fcQAccessibleSelectionInterface_operatorAssign(self: pointer, fromVal: pointer): void {.importc: "QAccessibleSelectionInterface_operatorAssign".}
proc fcQAccessibleAttributesInterface_attributeKeys(self: pointer): struct_seaqt_array {.importc: "QAccessibleAttributesInterface_attributeKeys".}
proc fcQAccessibleAttributesInterface_attributeValue(self: pointer, key: cint): pointer {.importc: "QAccessibleAttributesInterface_attributeValue".}
proc fcQAccessibleAttributesInterface_operatorAssign(self: pointer, fromVal: pointer): void {.importc: "QAccessibleAttributesInterface_operatorAssign".}
...
proc fcQAccessibleAnnouncementEvent_message(self: pointer): struct_seaqt_string {.importc: "QAccessibleAnnouncementEvent_message".}
proc fcQAccessibleAnnouncementEvent_politeness(self: pointer): cint {.importc: "QAccessibleAnnouncementEvent_politeness".}
proc fcQAccessibleAnnouncementEvent_setPoliteness(self: pointer, politeness: cint): void {.importc: "QAccessibleAnnouncementEvent_setPoliteness".}
proc fcQAccessibleAnnouncementEvent_vdata(self: pointer): ptr pointer {.importc: "QAccessibleAnnouncementEvent_vdata".}
proc fvdata_cQAccessibleAnnouncementEvent(self: pointer): pointer {.importc: "vdata_QAccessibleAnnouncementEvent".}

type cQAccessibleAnnouncementEventVTable {.pure.} = object
  destructor*: proc(self: pointer) {.cdecl, raises:[], gcsafe.}
  accessibleInterface*: proc(self: pointer): pointer {.cdecl, raises: [], gcsafe.}
proc fcQAccessibleAnnouncementEvent_virtualbase_accessibleInterface(self: pointer): pointer {.importc: "QAccessibleAnnouncementEvent_virtualbase_accessibleInterface".}
proc fcQAccessibleAnnouncementEvent_new(vtbl: pointer, vdata: csize_t, objectVal: pointer, message: struct_seaqt_string): ptr cQAccessibleAnnouncementEvent {.importc: "QAccessibleAnnouncementEvent_new_object_message".}
proc fcQAccessibleAnnouncementEvent_new2(vtbl: pointer, vdata: csize_t, iface: pointer, message: struct_seaqt_string): ptr cQAccessibleAnnouncementEvent {.importc: "QAccessibleAnnouncementEvent_new_iface_message".}
...
proc selectionInterface*(self: gen_qaccessible_types.QAccessibleInterface): gen_qaccessible_types.QAccessibleSelectionInterface =
  gen_qaccessible_types.QAccessibleSelectionInterface(h: fcQAccessibleInterface_selectionInterface(self.h), owned: false)

proc attributesInterface*(self: gen_qaccessible_types.QAccessibleInterface): gen_qaccessible_types.QAccessibleAttributesInterface =
  gen_qaccessible_types.QAccessibleAttributesInterface(h: fcQAccessibleInterface_attributesInterface(self.h), owned: false)
...
proc selectedItemCount*(self: gen_qaccessible_types.QAccessibleSelectionInterface): cint =
  fcQAccessibleSelectionInterface_selectedItemCount(self.h)

proc selectedItems*(self: gen_qaccessible_types.QAccessibleSelectionInterface): seq[gen_qaccessible_types.QAccessibleInterface] =
  var v_ma = fcQAccessibleSelectionInterface_selectedItems(self.h)
  var vx_ret = newSeq[gen_qaccessible_types.QAccessibleInterface](int(v_ma.len))
  let v_outCast = cast[ptr UncheckedArray[pointer]](v_ma.data)
  for i in 0 ..< v_ma.len:
    vx_ret[i] = gen_qaccessible_types.QAccessibleInterface(h: v_outCast[i], owned: false)
...
proc selectedItem*(self: gen_qaccessible_types.QAccessibleSelectionInterface, selectionIndex: cint): gen_qaccessible_types.QAccessibleInterface =
  gen_qaccessible_types.QAccessibleInterface(h: fcQAccessibleSelectionInterface_selectedItem(self.h, selectionIndex), owned: false)

proc isSelected*(self: gen_qaccessible_types.QAccessibleSelectionInterface, childItem: gen_qaccessible_types.QAccessibleInterface): bool =
  fcQAccessibleSelectionInterface_isSelected(self.h, childItem.h)

proc select*(self: gen_qaccessible_types.QAccessibleSelectionInterface, childItem: gen_qaccessible_types.QAccessibleInterface): bool =
  fcQAccessibleSelectionInterface_select(self.h, childItem.h)

proc unselect*(self: gen_qaccessible_types.QAccessibleSelectionInterface, childItem: gen_qaccessible_types.QAccessibleInterface): bool =
  fcQAccessibleSelectionInterface_unselect(self.h, childItem.h)

proc selectAll*(self: gen_qaccessible_types.QAccessibleSelectionInterface): bool =
  fcQAccessibleSelectionInterface_selectAll(self.h)

proc clear*(self: gen_qaccessible_types.QAccessibleSelectionInterface): bool =
  fcQAccessibleSelectionInterface_clear(self.h)

proc operatorAssign*(self: gen_qaccessible_types.QAccessibleSelectionInterface, fromVal: gen_qaccessible_types.QAccessibleSelectionInterface): void =
  fcQAccessibleSelectionInterface_operatorAssign(self.h, fromVal.h)

proc attributeKeys*(self: gen_qaccessible_types.QAccessibleAttributesInterface): seq[cint] =
  var v_ma = fcQAccessibleAttributesInterface_attributeKeys(self.h)
  var vx_ret = newSeq[cint](int(v_ma.len))
  let v_outCast = cast[ptr UncheckedArray[cint]](v_ma.data)
  for i in 0 ..< v_ma.len:
...
proc attributeValue*(self: gen_qaccessible_types.QAccessibleAttributesInterface, key: cint): gen_qvariant_types.QVariant =
  gen_qvariant_types.QVariant(h: fcQAccessibleAttributesInterface_attributeValue(self.h, cint(key)), owned: true)

proc operatorAssign*(self: gen_qaccessible_types.QAccessibleAttributesInterface, fromVal: gen_qaccessible_types.QAccessibleAttributesInterface): void =
  fcQAccessibleAttributesInterface_operatorAssign(self.h, fromVal.h)
...
proc message*(self: gen_qaccessible_types.QAccessibleAnnouncementEvent): string =
  let v_ms = fcQAccessibleAnnouncementEvent_message(self.h)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret

proc politeness*(self: gen_qaccessible_types.QAccessibleAnnouncementEvent): cint =
  cint(fcQAccessibleAnnouncementEvent_politeness(self.h))

proc setPoliteness*(self: gen_qaccessible_types.QAccessibleAnnouncementEvent, politeness: cint): void =
  fcQAccessibleAnnouncementEvent_setPoliteness(self.h, cint(politeness))

type QAccessibleAnnouncementEventaccessibleInterfaceProc* = proc(self: QAccessibleAnnouncementEvent): gen_qaccessible_types.QAccessibleInterface {.raises: [], gcsafe.}

type QAccessibleAnnouncementEventVTable* {.inheritable, pure.} = object
  vtbl: cQAccessibleAnnouncementEventVTable
  accessibleInterface*: QAccessibleAnnouncementEventaccessibleInterfaceProc

proc QAccessibleAnnouncementEventaccessibleInterface*(self: gen_qaccessible_types.QAccessibleAnnouncementEvent): gen_qaccessible_types.QAccessibleInterface =
  gen_qaccessible_types.QAccessibleInterface(h: fcQAccessibleAnnouncementEvent_virtualbase_accessibleInterface(self.h), owned: false)


proc fcQAccessibleAnnouncementEvent_vtable_callback_accessibleInterface(self: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QAccessibleAnnouncementEventVTable](fcQAccessibleAnnouncementEvent_vdata(self)[])
  let self = QAccessibleAnnouncementEvent(h: self)
  var virtualReturn = vtbl[].accessibleInterface(self)
  virtualReturn.owned = false # TODO move?
  let virtualReturn_h = virtualReturn.h
  virtualReturn.h = nil
...
type VirtualQAccessibleAnnouncementEvent* {.inheritable.} = ref object of QAccessibleAnnouncementEvent
  vtbl*: cQAccessibleAnnouncementEventVTable

method accessibleInterface*(self: VirtualQAccessibleAnnouncementEvent): gen_qaccessible_types.QAccessibleInterface {.base.} =
  QAccessibleAnnouncementEventaccessibleInterface(self[])

proc fcQAccessibleAnnouncementEvent_method_callback_accessibleInterface(self: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQAccessibleAnnouncementEvent](fcQAccessibleAnnouncementEvent_vdata(self)[])
  var virtualReturn = inst.accessibleInterface()
  virtualReturn.owned = false # TODO move?
  let virtualReturn_h = virtualReturn.h
  virtualReturn.h = nil
...
proc create*(T: type gen_qaccessible_types.QAccessibleAnnouncementEvent,
    objectVal: gen_qobject_types.QObject, message: openArray[char],
    vtbl: ref QAccessibleAnnouncementEventVTable = nil): gen_qaccessible_types.QAccessibleAnnouncementEvent =
  let vtbl = if vtbl == nil: new QAccessibleAnnouncementEventVTable else: vtbl
  GC_ref(vtbl)
  vtbl[].vtbl.destructor = proc(self: pointer) {.cdecl.} =
    let vtbl = cast[ref QAccessibleAnnouncementEventVTable](fcQAccessibleAnnouncementEvent_vdata(self)[])
    GC_unref(vtbl)
  if not isNil(vtbl[].accessibleInterface):
    vtbl[].vtbl.accessibleInterface = fcQAccessibleAnnouncementEvent_vtable_callback_accessibleInterface
  let tmp = gen_qaccessible_types.QAccessibleAnnouncementEvent(h: fcQAccessibleAnnouncementEvent_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), objectVal.h, struct_seaqt_string(data: if len(message) > 0: addr message[0] else: nil, len: csize_t(len(message)))), owned: true)
  fcQAccessibleAnnouncementEvent_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qaccessible_types.QAccessibleAnnouncementEvent,
    iface: gen_qaccessible_types.QAccessibleInterface, message: openArray[char],
    vtbl: ref QAccessibleAnnouncementEventVTable = nil): gen_qaccessible_types.QAccessibleAnnouncementEvent =
  let vtbl = if vtbl == nil: new QAccessibleAnnouncementEventVTable else: vtbl
  GC_ref(vtbl)
  vtbl[].vtbl.destructor = proc(self: pointer) {.cdecl.} =
  ...
  if not isNil(vtbl[].accessibleInterface):
    vtbl[].vtbl.accessibleInterface = fcQAccessibleAnnouncementEvent_vtable_callback_accessibleInterface
  let tmp = gen_qaccessible_types.QAccessibleAnnouncementEvent(h: fcQAccessibleAnnouncementEvent_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), iface.h, struct_seaqt_string(data: if len(message) > 0: addr message[0] else: nil, len: csize_t(len(message)))), owned: true)
  fcQAccessibleAnnouncementEvent_vdata(tmp.h)[] = addr(vtbl[])
  tmp
const cQAccessibleAnnouncementEvent_mvtbl = cQAccessibleAnnouncementEventVTable(
  destructor: proc(self: pointer) {.cdecl.} =
    let inst = cast[ptr typeof(VirtualQAccessibleAnnouncementEvent()[])](self.fcQAccessibleAnnouncementEvent_vdata()[])
    inst[].h = nil
    inst[].owned = false,

  accessibleInterface: fcQAccessibleAnnouncementEvent_method_callback_accessibleInterface,
)
proc create*(T: type gen_qaccessible_types.QAccessibleAnnouncementEvent,
    objectVal: gen_qobject_types.QObject, message: openArray[char],
    inst: VirtualQAccessibleAnnouncementEvent) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQAccessibleAnnouncementEvent_new(addr(cQAccessibleAnnouncementEvent_mvtbl), csize_t(sizeof(pointer)), objectVal.h, struct_seaqt_string(data: if len(message) > 0: addr message[0] else: nil, len: csize_t(len(message))))
  fcQAccessibleAnnouncementEvent_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qaccessible_types.QAccessibleAnnouncementEvent,
    ...
    inst: VirtualQAccessibleAnnouncementEvent) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQAccessibleAnnouncementEvent_new2(addr(cQAccessibleAnnouncementEvent_mvtbl), csize_t(sizeof(pointer)), iface.h, struct_seaqt_string(data: if len(message) > 0: addr message[0] else: nil, len: csize_t(len(message))))
  fcQAccessibleAnnouncementEvent_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
