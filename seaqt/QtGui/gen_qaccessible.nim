...
proc fcQAccessibleActionInterface_trUtf8SourceText(sourceText: cstring): struct_seaqt_string {.importc: "QAccessibleActionInterface_trUtf8_sourceText".}
...
proc fcQAccessibleActionInterface_trUtf8SourceTextDisambiguation(sourceText: cstring, disambiguation: cstring): struct_seaqt_string {.importc: "QAccessibleActionInterface_trUtf8_sourceText_disambiguation".}
proc fcQAccessibleActionInterface_trUtf8SourceTextDisambiguationN(sourceText: cstring, disambiguation: cstring, n: cint): struct_seaqt_string {.importc: "QAccessibleActionInterface_trUtf8_sourceText_disambiguation_n".}
...
proc fcQAccessibleState_new2(fromVal: pointer): ptr cQAccessibleState {.importc: "QAccessible__State_new_from".}
...
proc trUtf8*(_: type gen_qaccessible_types.QAccessibleActionInterface, sourceText: cstring): string =
  let v_ms = fcQAccessibleActionInterface_trUtf8SourceText(sourceText)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc trUtf8*(_: type gen_qaccessible_types.QAccessibleActionInterface, sourceText: cstring, disambiguation: cstring): string =
  let v_ms = fcQAccessibleActionInterface_trUtf8SourceTextDisambiguation(sourceText, disambiguation)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc trUtf8*(_: type gen_qaccessible_types.QAccessibleActionInterface, sourceText: cstring, disambiguation: cstring, n: cint): string =
  let v_ms = fcQAccessibleActionInterface_trUtf8SourceTextDisambiguationN(sourceText, disambiguation, n)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc create*(T: type gen_qaccessible_types.QAccessibleState,
    fromVal: gen_qaccessible_types.QAccessibleState): gen_qaccessible_types.QAccessibleState =
  let tmp = gen_qaccessible_types.QAccessibleState(h: fcQAccessibleState_new2(fromVal.h), owned: true)
  tmp
...
proc operatorAssign*(self: gen_qaccessible_types.QAccessibleActivationObserver, fromVal: gen_qaccessible_types.QAccessibleActivationObserver): void =
