...
proc create*(T: type gen_qtextlayout_types.QTextLayout,
  ...
  let tmp = gen_qtextlayout_types.QTextLayout(h: fcQTextLayout_new2(struct_miqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text)))))
  tmp
proc create*(T: type gen_qtextlayout_types.QTextLayout,
    text: string, font: gen_qfont_types.QFont): gen_qtextlayout_types.QTextLayout =
  let tmp = gen_qtextlayout_types.QTextLayout(h: fcQTextLayout_new3(struct_miqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), font.h))
  tmp
proc create*(T: type gen_qtextlayout_types.QTextLayout,
...
proc create*(T: type gen_qtextlayout_types.QTextLayout,
  ...
  let tmp = gen_qtextlayout_types.QTextLayout(h: fcQTextLayout_new5(struct_miqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), font.h, paintdevice.h))
  tmp
