...
proc fcQTextLayout_setAdditionalFormats(self: pointer, overrides: struct_seaqt_array): void {.importc: "QTextLayout_setAdditionalFormats".}
proc fcQTextLayout_additionalFormats(self: pointer): struct_seaqt_array {.importc: "QTextLayout_additionalFormats".}
...
proc fcQTextLine_drawPPoint(self: pointer, p: pointer, point: pointer): void {.importc: "QTextLine_draw_p_point".}
...
proc fcQTextLine_drawPPointSelection(self: pointer, p: pointer, point: pointer, selection: pointer): void {.importc: "QTextLine_draw_p_point_selection".}
...
proc setAdditionalFormats*(self: gen_qtextlayout_types.QTextLayout, overrides: openArray[gen_qtextlayout_types.QTextLayoutFormatRange]): void =
  var overrides_CArray = newSeq[pointer](len(overrides))
  for i in 0..<len(overrides):
    overrides_CArray[i] = overrides[i].h

  fcQTextLayout_setAdditionalFormats(self.h, struct_seaqt_array(len: csize_t(len(overrides)), data: if len(overrides) == 0: nil else: addr(overrides_CArray[0])))
...
proc draw*(self: gen_qtextlayout_types.QTextLine, p: gen_qpainter_types.QPainter, point: gen_qpoint_types.QPointF): void =
  fcQTextLine_drawPPoint(self.h, p.h, point.h)
...
proc draw*(self: gen_qtextlayout_types.QTextLine, p: gen_qpainter_types.QPainter, point: gen_qpoint_types.QPointF, selection: gen_qtextlayout_types.QTextLayoutFormatRange): void =
  fcQTextLine_drawPPointSelection(self.h, p.h, point.h, selection.h)
