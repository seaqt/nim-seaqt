...
proc fcQIconEngine_addFile(self: pointer, fileName: struct_seaqt_string, size: pointer, mode: cint, state: cint): void {.importc: "QIconEngine_addFile".}
proc fcQIconEngine_key(self: pointer): struct_seaqt_string {.importc: "QIconEngine_key".}
...
proc fcQIconEngine_availableSizes(self: pointer, mode: cint, state: cint): struct_seaqt_array {.importc: "QIconEngine_availableSizes".}
...
type cQIconEngineVTable {.pure.} = object
  ...
  addFile*: proc(self: pointer, fileName: struct_seaqt_string, size: pointer, mode: cint, state: cint): void {.cdecl, raises: [], gcsafe.}
  key*: proc(self: pointer): struct_seaqt_string {.cdecl, raises: [], gcsafe.}
  ...
  availableSizes*: proc(self: pointer, mode: cint, state: cint): struct_seaqt_array {.cdecl, raises: [], gcsafe.}
  iconName*: proc(self: pointer): struct_seaqt_string {.cdecl, raises: [], gcsafe.}
...
proc fcQIconEngine_virtualbase_addFile(self: pointer, fileName: struct_seaqt_string, size: pointer, mode: cint, state: cint): void {.importc: "QIconEngine_virtualbase_addFile".}
proc fcQIconEngine_virtualbase_key(self: pointer): struct_seaqt_string {.importc: "QIconEngine_virtualbase_key".}
...
proc fcQIconEngine_virtualbase_availableSizes(self: pointer, mode: cint, state: cint): struct_seaqt_array {.importc: "QIconEngine_virtualbase_availableSizes".}
...
proc fcQIconEngine_new2(vtbl: pointer, vdata: csize_t, fromVal: pointer): ptr cQIconEngine {.importc: "QIconEngine_new_from".}
proc fcQIconEngineAvailableSizesArgument_mode(self: pointer): cint {.importc: "QIconEngine__AvailableSizesArgument_mode".}
proc fcQIconEngineAvailableSizesArgument_setMode(self: pointer, mode: cint): void {.importc: "QIconEngine__AvailableSizesArgument_setMode".}
proc fcQIconEngineAvailableSizesArgument_state(self: pointer): cint {.importc: "QIconEngine__AvailableSizesArgument_state".}
proc fcQIconEngineAvailableSizesArgument_setState(self: pointer, state: cint): void {.importc: "QIconEngine__AvailableSizesArgument_setState".}
proc fcQIconEngineAvailableSizesArgument_sizes(self: pointer): struct_seaqt_array {.importc: "QIconEngine__AvailableSizesArgument_sizes".}
proc fcQIconEngineAvailableSizesArgument_setSizes(self: pointer, sizes: struct_seaqt_array): void {.importc: "QIconEngine__AvailableSizesArgument_setSizes".}
proc fcQIconEngineAvailableSizesArgument_operatorAssign(self: pointer, fromVal: pointer): void {.importc: "QIconEngine__AvailableSizesArgument_operatorAssign".}
proc fcQIconEngineAvailableSizesArgument_new(fromVal: pointer): ptr cQIconEngineAvailableSizesArgument {.importc: "QIconEngine__AvailableSizesArgument_new".}
...
proc fcQIconEngineScaledPixmapArgument_mode(self: pointer): cint {.importc: "QIconEngine__ScaledPixmapArgument_mode".}
proc fcQIconEngineScaledPixmapArgument_setMode(self: pointer, mode: cint): void {.importc: "QIconEngine__ScaledPixmapArgument_setMode".}
proc fcQIconEngineScaledPixmapArgument_state(self: pointer): cint {.importc: "QIconEngine__ScaledPixmapArgument_state".}
proc fcQIconEngineScaledPixmapArgument_setState(self: pointer, state: cint): void {.importc: "QIconEngine__ScaledPixmapArgument_setState".}
proc fcQIconEngineScaledPixmapArgument_scale(self: pointer): float64 {.importc: "QIconEngine__ScaledPixmapArgument_scale".}
...
proc addFile*(self: gen_qiconengine_types.QIconEngine, fileName: openArray[char], size: gen_qsize_types.QSize, mode: cint, state: cint): void =
  fcQIconEngine_addFile(self.h, struct_seaqt_string(data: if len(fileName) > 0: addr fileName[0] else: nil, len: csize_t(len(fileName))), size.h, cint(mode), cint(state))
...
proc QIconEngineaddFile*(self: gen_qiconengine_types.QIconEngine, fileName: openArray[char], size: gen_qsize_types.QSize, mode: cint, state: cint): void =
  fcQIconEngine_virtualbase_addFile(self.h, struct_seaqt_string(data: if len(fileName) > 0: addr fileName[0] else: nil, len: csize_t(len(fileName))), size.h, cint(mode), cint(state))
...
proc fcQIconEngine_vtable_callback_paint(self: pointer, painter: pointer, rect: pointer, mode: cint, state: cint): void {.cdecl.} =
...
proc fcQIconEngine_vtable_callback_actualSize(self: pointer, size: pointer, mode: cint, state: cint): pointer {.cdecl.} =
  let vtbl = cast[ptr QIconEngineVTable](fcQIconEngine_vdata(self)[])
  let self = QIconEngine(h: self)
...
proc fcQIconEngine_vtable_callback_pixmap(self: pointer, size: pointer, mode: cint, state: cint): pointer {.cdecl.} =
  let vtbl = cast[ptr QIconEngineVTable](fcQIconEngine_vdata(self)[])
  let self = QIconEngine(h: self)
  let slotval1 = gen_qsize_types.QSize(h: size, owned: false)
  let slotval2 = cint(mode)
...
proc fcQIconEngine_vtable_callback_addPixmap(self: pointer, pixmap: pointer, mode: cint, state: cint): void {.cdecl.} =
  let vtbl = cast[ptr QIconEngineVTable](fcQIconEngine_vdata(self)[])
  let self = QIconEngine(h: self)
...
proc fcQIconEngine_vtable_callback_addFile(self: pointer, fileName: struct_seaqt_string, size: pointer, mode: cint, state: cint): void {.cdecl.} =
  let vtbl = cast[ptr QIconEngineVTable](fcQIconEngine_vdata(self)[])
  let self = QIconEngine(h: self)
...
proc fcQIconEngine_vtable_callback_key(self: pointer): struct_seaqt_string {.cdecl.} =
  let vtbl = cast[ptr QIconEngineVTable](fcQIconEngine_vdata(self)[])
  let self = QIconEngine(h: self)
...
proc fcQIconEngine_vtable_callback_clone(self: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QIconEngineVTable](fcQIconEngine_vdata(self)[])
  let self = QIconEngine(h: self)
...
proc fcQIconEngine_vtable_callback_read(self: pointer, inVal: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QIconEngineVTable](fcQIconEngine_vdata(self)[])
  let self = QIconEngine(h: self)
...
proc fcQIconEngine_vtable_callback_write(self: pointer, outVal: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QIconEngineVTable](fcQIconEngine_vdata(self)[])
  let self = QIconEngine(h: self)
...
proc fcQIconEngine_vtable_callback_availableSizes(self: pointer, mode: cint, state: cint): struct_seaqt_array {.cdecl.} =
  let vtbl = cast[ptr QIconEngineVTable](fcQIconEngine_vdata(self)[])
  let self = QIconEngine(h: self)
...
proc fcQIconEngine_vtable_callback_iconName(self: pointer): struct_seaqt_string {.cdecl.} =
  let vtbl = cast[ptr QIconEngineVTable](fcQIconEngine_vdata(self)[])
  let self = QIconEngine(h: self)
...
proc fcQIconEngine_vtable_callback_virtualHook(self: pointer, id: cint, data: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QIconEngineVTable](fcQIconEngine_vdata(self)[])
  let self = QIconEngine(h: self)
  let slotval1 = id
  let slotval2 = data
...
method paint*(self: VirtualQIconEngine, painter: gen_qpainter_types.QPainter, rect: gen_qrect_types.QRect, mode: cint, state: cint): void {.base.} =
  raiseAssert("missing implementation of QIconEngine.paint")
...
method clone*(self: VirtualQIconEngine): gen_qiconengine_types.QIconEngine {.base.} =
  raiseAssert("missing implementation of QIconEngine.clone")
...
proc fcQIconEngine_method_callback_paint(self: pointer, painter: pointer, rect: pointer, mode: cint, state: cint): void {.cdecl.} =
...
proc fcQIconEngine_method_callback_actualSize(self: pointer, size: pointer, mode: cint, state: cint): pointer {.cdecl.} =
  let inst = cast[VirtualQIconEngine](fcQIconEngine_vdata(self)[])
  let slotval1 = gen_qsize_types.QSize(h: size, owned: false)
  let slotval2 = cint(mode)
  let slotval3 = cint(state)
...
proc fcQIconEngine_method_callback_addFile(self: pointer, fileName: struct_seaqt_string, size: pointer, mode: cint, state: cint): void {.cdecl.} =
  let inst = cast[VirtualQIconEngine](fcQIconEngine_vdata(self)[])
  let vfileName_ms = fileName
  let vfileNamex_ret = string.fromBytes(vfileName_ms)
  c_free(vfileName_ms.data)
...
proc fcQIconEngine_method_callback_key(self: pointer): struct_seaqt_string {.cdecl.} =
  let inst = cast[VirtualQIconEngine](fcQIconEngine_vdata(self)[])
...
proc fcQIconEngine_method_callback_write(self: pointer, outVal: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQIconEngine](fcQIconEngine_vdata(self)[])
  let slotval1 = gen_qdatastream_types.QDataStream(h: outVal, owned: false)
  var virtualReturn = inst.write(slotval1)
  virtualReturn

proc fcQIconEngine_method_callback_availableSizes(self: pointer, mode: cint, state: cint): struct_seaqt_array {.cdecl.} =
  let inst = cast[VirtualQIconEngine](fcQIconEngine_vdata(self)[])
  let slotval1 = cint(mode)
  let slotval2 = cint(state)
...
proc fcQIconEngine_method_callback_iconName(self: pointer): struct_seaqt_string {.cdecl.} =
  let inst = cast[VirtualQIconEngine](fcQIconEngine_vdata(self)[])
...
proc create*(T: type gen_qiconengine_types.QIconEngine,
  ...
  if not isNil(vtbl[].paint):
    vtbl[].vtbl.paint = fcQIconEngine_vtable_callback_paint
  if not isNil(vtbl[].actualSize):
    vtbl[].vtbl.actualSize = fcQIconEngine_vtable_callback_actualSize
  if not isNil(vtbl[].pixmap):
    vtbl[].vtbl.pixmap = fcQIconEngine_vtable_callback_pixmap
  if not isNil(vtbl[].addPixmap):
    vtbl[].vtbl.addPixmap = fcQIconEngine_vtable_callback_addPixmap
  if not isNil(vtbl[].addFile):
    vtbl[].vtbl.addFile = fcQIconEngine_vtable_callback_addFile
  if not isNil(vtbl[].key):
    vtbl[].vtbl.key = fcQIconEngine_vtable_callback_key
  if not isNil(vtbl[].clone):
    vtbl[].vtbl.clone = fcQIconEngine_vtable_callback_clone
  if not isNil(vtbl[].read):
    vtbl[].vtbl.read = fcQIconEngine_vtable_callback_read
  if not isNil(vtbl[].write):
    vtbl[].vtbl.write = fcQIconEngine_vtable_callback_write
  if not isNil(vtbl[].availableSizes):
    vtbl[].vtbl.availableSizes = fcQIconEngine_vtable_callback_availableSizes
  if not isNil(vtbl[].iconName):
    vtbl[].vtbl.iconName = fcQIconEngine_vtable_callback_iconName
  if not isNil(vtbl[].virtualHook):
    vtbl[].vtbl.virtualHook = fcQIconEngine_vtable_callback_virtualHook
  let tmp = gen_qiconengine_types.QIconEngine(h: fcQIconEngine_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQIconEngine_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qiconengine_types.QIconEngine,
    fromVal: gen_qiconengine_types.QIconEngine,
    vtbl: ref QIconEngineVTable = nil): gen_qiconengine_types.QIconEngine =
  let vtbl = if vtbl == nil: new QIconEngineVTable else: vtbl
  GC_ref(vtbl)
  vtbl[].vtbl.destructor = proc(self: pointer) {.cdecl.} =
  ...
  if not isNil(vtbl[].virtualHook):
    vtbl[].vtbl.virtualHook = fcQIconEngine_vtable_callback_virtualHook
  let tmp = gen_qiconengine_types.QIconEngine(h: fcQIconEngine_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), fromVal.h), owned: true)
  fcQIconEngine_vdata(tmp.h)[] = addr(vtbl[])
  tmp
const cQIconEngine_mvtbl = cQIconEngineVTable(
  destructor: proc(self: pointer) {.cdecl.} =
    let inst = cast[ptr typeof(VirtualQIconEngine()[])](self.fcQIconEngine_vdata()[])
    inst[].h = nil
    inst[].owned = false,

  paint: fcQIconEngine_method_callback_paint,
  actualSize: fcQIconEngine_method_callback_actualSize,
  pixmap: fcQIconEngine_method_callback_pixmap,
  addPixmap: fcQIconEngine_method_callback_addPixmap,
  addFile: fcQIconEngine_method_callback_addFile,
  key: fcQIconEngine_method_callback_key,
  clone: fcQIconEngine_method_callback_clone,
  read: fcQIconEngine_method_callback_read,
  write: fcQIconEngine_method_callback_write,
  availableSizes: fcQIconEngine_method_callback_availableSizes,
  iconName: fcQIconEngine_method_callback_iconName,
  virtualHook: fcQIconEngine_method_callback_virtualHook,
)
proc create*(T: type gen_qiconengine_types.QIconEngine,
...
proc create*(T: type gen_qiconengine_types.QIconEngine,
    ...
    inst: VirtualQIconEngine) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQIconEngine_new2(addr(cQIconEngine_mvtbl), csize_t(sizeof(pointer)), fromVal.h)
  fcQIconEngine_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true

proc mode*(self: gen_qiconengine_types.QIconEngineAvailableSizesArgument): cint =
  cint(fcQIconEngineAvailableSizesArgument_mode(self.h))

proc setMode*(self: gen_qiconengine_types.QIconEngineAvailableSizesArgument, mode: cint): void =
  fcQIconEngineAvailableSizesArgument_setMode(self.h, cint(mode))

proc state*(self: gen_qiconengine_types.QIconEngineAvailableSizesArgument): cint =
  cint(fcQIconEngineAvailableSizesArgument_state(self.h))

proc setState*(self: gen_qiconengine_types.QIconEngineAvailableSizesArgument, state: cint): void =
  fcQIconEngineAvailableSizesArgument_setState(self.h, cint(state))

proc sizes*(self: gen_qiconengine_types.QIconEngineAvailableSizesArgument): seq[gen_qsize_types.QSize] =
  var vsizes_ma = fcQIconEngineAvailableSizesArgument_sizes(self.h)
  var vsizesx_ret = newSeq[gen_qsize_types.QSize](int(vsizes_ma.len))
  let vsizes_outCast = cast[ptr UncheckedArray[pointer]](vsizes_ma.data)
  for i in 0 ..< vsizes_ma.len:
    vsizesx_ret[i] = gen_qsize_types.QSize(h: vsizes_outCast[i], owned: true)
  c_free(vsizes_ma.data)
  vsizesx_ret

proc setSizes*(self: gen_qiconengine_types.QIconEngineAvailableSizesArgument, sizes: openArray[gen_qsize_types.QSize]): void =
  var sizes_CArray = newSeq[pointer](len(sizes))
  for i in 0..<len(sizes):
    sizes_CArray[i] = sizes[i].h

  fcQIconEngineAvailableSizesArgument_setSizes(self.h, struct_seaqt_array(len: csize_t(len(sizes)), data: if len(sizes) == 0: nil else: addr(sizes_CArray[0])))

proc operatorAssign*(self: gen_qiconengine_types.QIconEngineAvailableSizesArgument, fromVal: gen_qiconengine_types.QIconEngineAvailableSizesArgument): void =
  fcQIconEngineAvailableSizesArgument_operatorAssign(self.h, fromVal.h)

proc create*(T: type gen_qiconengine_types.QIconEngineAvailableSizesArgument,
    fromVal: gen_qiconengine_types.QIconEngineAvailableSizesArgument): gen_qiconengine_types.QIconEngineAvailableSizesArgument =
  let tmp = gen_qiconengine_types.QIconEngineAvailableSizesArgument(h: fcQIconEngineAvailableSizesArgument_new(fromVal.h), owned: true)
  tmp
proc size*(self: gen_qiconengine_types.QIconEngineScaledPixmapArgument): gen_qsize_types.QSize =
  gen_qsize_types.QSize(h: fcQIconEngineScaledPixmapArgument_size(self.h), owned: true)

proc setSize*(self: gen_qiconengine_types.QIconEngineScaledPixmapArgument, size: gen_qsize_types.QSize): void =
  fcQIconEngineScaledPixmapArgument_setSize(self.h, size.h)

proc mode*(self: gen_qiconengine_types.QIconEngineScaledPixmapArgument): cint =
  cint(fcQIconEngineScaledPixmapArgument_mode(self.h))

proc setMode*(self: gen_qiconengine_types.QIconEngineScaledPixmapArgument, mode: cint): void =
  fcQIconEngineScaledPixmapArgument_setMode(self.h, cint(mode))

proc state*(self: gen_qiconengine_types.QIconEngineScaledPixmapArgument): cint =
  cint(fcQIconEngineScaledPixmapArgument_state(self.h))

proc setState*(self: gen_qiconengine_types.QIconEngineScaledPixmapArgument, state: cint): void =
  fcQIconEngineScaledPixmapArgument_setState(self.h, cint(state))

proc scale*(self: gen_qiconengine_types.QIconEngineScaledPixmapArgument): float64 =
  fcQIconEngineScaledPixmapArgument_scale(self.h)

proc setScale*(self: gen_qiconengine_types.QIconEngineScaledPixmapArgument, scale: float64): void =
  fcQIconEngineScaledPixmapArgument_setScale(self.h, scale)

proc pixmap*(self: gen_qiconengine_types.QIconEngineScaledPixmapArgument): gen_qpixmap_types.QPixmap =
  gen_qpixmap_types.QPixmap(h: fcQIconEngineScaledPixmapArgument_pixmap(self.h), owned: true)
