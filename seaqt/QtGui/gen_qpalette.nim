...
template Accent*(_: type QPaletteColorRoleEnum): untyped = 21
template NColorRoles*(_: type QPaletteColorRoleEnum): untyped = 22
...
proc fcQPalette_accent(self: pointer): pointer {.importc: "QPalette_accent".}
...
proc accent*(self: gen_qpalette_types.QPalette): gen_qbrush_types.QBrush =
  gen_qbrush_types.QBrush(h: fcQPalette_accent(self.h), owned: false)
...
proc resolve*(self: gen_qpalette_types.QPalette, other: gen_qpalette_types.QPalette): gen_qpalette_types.QPalette =
  gen_qpalette_types.QPalette(h: fcQPalette_resolve(self.h, other.h), owned: true)
