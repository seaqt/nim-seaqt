...
proc create*(T: type gen_qpalette_types.QPalette): gen_qpalette_types.QPalette =
  let tmp = gen_qpalette_types.QPalette(h: fcQPalette_new())
  tmp
proc create*(T: type gen_qpalette_types.QPalette,
    button: gen_qcolor_types.QColor): gen_qpalette_types.QPalette =
  let tmp = gen_qpalette_types.QPalette(h: fcQPalette_new2(button.h))
  tmp
proc create*(T: type gen_qpalette_types.QPalette,
    button: cint): gen_qpalette_types.QPalette =
  let tmp = gen_qpalette_types.QPalette(h: fcQPalette_new3(cint(button)))
  tmp
proc create*(T: type gen_qpalette_types.QPalette,
    button: gen_qcolor_types.QColor, window: gen_qcolor_types.QColor): gen_qpalette_types.QPalette =
  let tmp = gen_qpalette_types.QPalette(h: fcQPalette_new4(button.h, window.h))
  tmp
proc create*(T: type gen_qpalette_types.QPalette,
  ...
  let tmp = gen_qpalette_types.QPalette(h: fcQPalette_new5(windowText.h, button.h, light.h, dark.h, mid.h, text.h, bright_text.h, base.h, window.h))
  tmp
proc create*(T: type gen_qpalette_types.QPalette,
  ...
  let tmp = gen_qpalette_types.QPalette(h: fcQPalette_new6(windowText.h, window.h, light.h, dark.h, mid.h, text.h, base.h))
  tmp
proc create*(T: type gen_qpalette_types.QPalette,
    palette: gen_qpalette_types.QPalette): gen_qpalette_types.QPalette =
  let tmp = gen_qpalette_types.QPalette(h: fcQPalette_new7(palette.h))
  tmp
