...
VirtualQPixmap* QPixmap_new(const QPixmap_VTable* vtbl, size_t vdata) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQPixmap>());
...
VirtualQPixmap* QPixmap_new4(const QPixmap_VTable* vtbl, size_t vdata, struct miqt_string fileName) {
...
VirtualQPixmap* QPixmap_new6(const QPixmap_VTable* vtbl, size_t vdata, struct miqt_string fileName, const char* format) {
	QString fileName_QString = QString::fromUtf8(fileName.data, fileName.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQPixmap>());
	return _mem_ ? new (_mem_)VirtualQPixmap(vtbl, fileName_QString, format) : nullptr;
}

VirtualQPixmap* QPixmap_new7(const QPixmap_VTable* vtbl, size_t vdata, struct miqt_string fileName, const char* format, int flags) {
	QString fileName_QString = QString::fromUtf8(fileName.data, fileName.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQPixmap>());
