...
proc fcQFontMetrics_width(self: pointer, param1: struct_seaqt_string): cint {.importc: "QFontMetrics_width".}
proc fcQFontMetrics_width2(self: pointer, param1: struct_seaqt_string, len: cint, flags: cint): cint {.importc: "QFontMetrics_width2".}
...
proc fcQFontMetrics_charWidth(self: pointer, str: struct_seaqt_string, pos: cint): cint {.importc: "QFontMetrics_charWidth".}
...
proc fcQFontMetrics_boundingRect2(self: pointer, r: pointer, flags: cint, text: struct_seaqt_string): pointer {.importc: "QFontMetrics_boundingRect2".}
proc fcQFontMetrics_boundingRect3(self: pointer, x: cint, y: cint, w: cint, h: cint, flags: cint, text: struct_seaqt_string): pointer {.importc: "QFontMetrics_boundingRect3".}
...
proc fcQFontMetrics_width3(self: pointer, param1: struct_seaqt_string, len: cint): cint {.importc: "QFontMetrics_width3".}
proc fcQFontMetrics_horizontalAdvance2(self: pointer, param1: struct_seaqt_string, len: cint): cint {.importc: "QFontMetrics_horizontalAdvance2".}
proc fcQFontMetrics_boundingRect4(self: pointer, r: pointer, flags: cint, text: struct_seaqt_string, tabstops: cint): pointer {.importc: "QFontMetrics_boundingRect4".}
proc fcQFontMetrics_boundingRect5(self: pointer, r: pointer, flags: cint, text: struct_seaqt_string, tabstops: cint, tabarray: ptr cint): pointer {.importc: "QFontMetrics_boundingRect5".}
proc fcQFontMetrics_boundingRect6(self: pointer, x: cint, y: cint, w: cint, h: cint, flags: cint, text: struct_seaqt_string, tabstops: cint): pointer {.importc: "QFontMetrics_boundingRect6".}
proc fcQFontMetrics_boundingRect7(self: pointer, x: cint, y: cint, w: cint, h: cint, flags: cint, text: struct_seaqt_string, tabstops: cint, tabarray: ptr cint): pointer {.importc: "QFontMetrics_boundingRect7".}
...
proc fcQFontMetricsF_width(self: pointer, stringVal: struct_seaqt_string): float64 {.importc: "QFontMetricsF_width".}
...
proc fcQFontMetricsF_boundingRect2(self: pointer, r: pointer, flags: cint, stringVal: struct_seaqt_string): pointer {.importc: "QFontMetricsF_boundingRect2".}
...
proc fcQFontMetricsF_horizontalAdvance2(self: pointer, stringVal: struct_seaqt_string, length: cint): float64 {.importc: "QFontMetricsF_horizontalAdvance2".}
proc fcQFontMetricsF_boundingRect3(self: pointer, r: pointer, flags: cint, stringVal: struct_seaqt_string, tabstops: cint): pointer {.importc: "QFontMetricsF_boundingRect3".}
proc fcQFontMetricsF_boundingRect4(self: pointer, r: pointer, flags: cint, stringVal: struct_seaqt_string, tabstops: cint, tabarray: ptr cint): pointer {.importc: "QFontMetricsF_boundingRect4".}
...
proc width*(self: gen_qfontmetrics_types.QFontMetrics, param1: openArray[char]): cint =
  fcQFontMetrics_width(self.h, struct_seaqt_string(data: if len(param1) > 0: addr param1[0] else: nil, len: csize_t(len(param1))))

proc width*(self: gen_qfontmetrics_types.QFontMetrics, param1: openArray[char], len: cint, flags: cint): cint =
  fcQFontMetrics_width2(self.h, struct_seaqt_string(data: if len(param1) > 0: addr param1[0] else: nil, len: csize_t(len(param1))), len, flags)
...
proc charWidth*(self: gen_qfontmetrics_types.QFontMetrics, str: openArray[char], pos: cint): cint =
  fcQFontMetrics_charWidth(self.h, struct_seaqt_string(data: if len(str) > 0: addr str[0] else: nil, len: csize_t(len(str))), pos)
...
proc boundingRect*(self: gen_qfontmetrics_types.QFontMetrics, r: gen_qrect_types.QRect, flags: cint, text: openArray[char]): gen_qrect_types.QRect =
  gen_qrect_types.QRect(h: fcQFontMetrics_boundingRect2(self.h, r.h, flags, struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text)))), owned: true)
...
proc boundingRect*(self: gen_qfontmetrics_types.QFontMetrics, x: cint, y: cint, w: cint, h: cint, flags: cint, text: openArray[char]): gen_qrect_types.QRect =
  gen_qrect_types.QRect(h: fcQFontMetrics_boundingRect3(self.h, x, y, w, h, flags, struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text)))), owned: true)
...
proc width*(self: gen_qfontmetrics_types.QFontMetrics, param1: openArray[char], len: cint): cint =
  fcQFontMetrics_width3(self.h, struct_seaqt_string(data: if len(param1) > 0: addr param1[0] else: nil, len: csize_t(len(param1))), len)

proc horizontalAdvance*(self: gen_qfontmetrics_types.QFontMetrics, param1: openArray[char], len: cint): cint =
  fcQFontMetrics_horizontalAdvance2(self.h, struct_seaqt_string(data: if len(param1) > 0: addr param1[0] else: nil, len: csize_t(len(param1))), len)
...
proc boundingRect*(self: gen_qfontmetrics_types.QFontMetrics, r: gen_qrect_types.QRect, flags: cint, text: openArray[char], tabstops: cint): gen_qrect_types.QRect =
  gen_qrect_types.QRect(h: fcQFontMetrics_boundingRect4(self.h, r.h, flags, struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), tabstops), owned: true)
...
proc boundingRect*(self: gen_qfontmetrics_types.QFontMetrics, r: gen_qrect_types.QRect, flags: cint, text: openArray[char], tabstops: cint, tabarray: ptr cint): gen_qrect_types.QRect =
  gen_qrect_types.QRect(h: fcQFontMetrics_boundingRect5(self.h, r.h, flags, struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), tabstops, tabarray), owned: true)
...
proc boundingRect*(self: gen_qfontmetrics_types.QFontMetrics, x: cint, y: cint, w: cint, h: cint, flags: cint, text: openArray[char], tabstops: cint): gen_qrect_types.QRect =
  gen_qrect_types.QRect(h: fcQFontMetrics_boundingRect6(self.h, x, y, w, h, flags, struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), tabstops), owned: true)
...
proc boundingRect*(self: gen_qfontmetrics_types.QFontMetrics, x: cint, y: cint, w: cint, h: cint, flags: cint, text: openArray[char], tabstops: cint, tabarray: ptr cint): gen_qrect_types.QRect =
  gen_qrect_types.QRect(h: fcQFontMetrics_boundingRect7(self.h, x, y, w, h, flags, struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), tabstops, tabarray), owned: true)
...
proc width*(self: gen_qfontmetrics_types.QFontMetricsF, stringVal: openArray[char]): float64 =
  fcQFontMetricsF_width(self.h, struct_seaqt_string(data: if len(stringVal) > 0: addr stringVal[0] else: nil, len: csize_t(len(stringVal))))
...
proc boundingRect*(self: gen_qfontmetrics_types.QFontMetricsF, r: gen_qrect_types.QRectF, flags: cint, stringVal: openArray[char]): gen_qrect_types.QRectF =
  gen_qrect_types.QRectF(h: fcQFontMetricsF_boundingRect2(self.h, r.h, flags, struct_seaqt_string(data: if len(stringVal) > 0: addr stringVal[0] else: nil, len: csize_t(len(stringVal)))), owned: true)
...
proc horizontalAdvance*(self: gen_qfontmetrics_types.QFontMetricsF, stringVal: openArray[char], length: cint): float64 =
  fcQFontMetricsF_horizontalAdvance2(self.h, struct_seaqt_string(data: if len(stringVal) > 0: addr stringVal[0] else: nil, len: csize_t(len(stringVal))), length)
...
proc boundingRect*(self: gen_qfontmetrics_types.QFontMetricsF, r: gen_qrect_types.QRectF, flags: cint, stringVal: openArray[char], tabstops: cint): gen_qrect_types.QRectF =
  gen_qrect_types.QRectF(h: fcQFontMetricsF_boundingRect3(self.h, r.h, flags, struct_seaqt_string(data: if len(stringVal) > 0: addr stringVal[0] else: nil, len: csize_t(len(stringVal))), tabstops), owned: true)
...
proc boundingRect*(self: gen_qfontmetrics_types.QFontMetricsF, r: gen_qrect_types.QRectF, flags: cint, stringVal: openArray[char], tabstops: cint, tabarray: ptr cint): gen_qrect_types.QRectF =
  gen_qrect_types.QRectF(h: fcQFontMetricsF_boundingRect4(self.h, r.h, flags, struct_seaqt_string(data: if len(stringVal) > 0: addr stringVal[0] else: nil, len: csize_t(len(stringVal))), tabstops, tabarray), owned: true)
