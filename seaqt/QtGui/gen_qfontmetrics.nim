...
proc fcQFontMetrics_width_QString(self: pointer, param1: struct_seaqt_string): cint {.importc: "QFontMetrics_width_QString".}
proc fcQFontMetrics_width_QStringIntInt(self: pointer, param1: struct_seaqt_string, len: cint, flags: cint): cint {.importc: "QFontMetrics_width_QString_int_int".}
proc fcQFontMetrics_width_QChar(self: pointer, param1: pointer): cint {.importc: "QFontMetrics_width_QChar".}
...
proc fcQFontMetrics_width_QStringInt(self: pointer, param1: struct_seaqt_string, len: cint): cint {.importc: "QFontMetrics_width_QString_int".}
...
proc fcQFontMetricsF_width_QString(self: pointer, stringVal: struct_seaqt_string): float64 {.importc: "QFontMetricsF_width_QString".}
proc fcQFontMetricsF_width_QChar(self: pointer, param1: pointer): float64 {.importc: "QFontMetricsF_width_QChar".}
...
proc width*(self: gen_qfontmetrics_types.QFontMetrics, param1: openArray[char]): cint =
  fcQFontMetrics_width_QString(self.h, struct_seaqt_string(data: if len(param1) > 0: addr param1[0] else: nil, len: csize_t(len(param1))))

proc width*(self: gen_qfontmetrics_types.QFontMetrics, param1: openArray[char], len: cint, flags: cint): cint =
  fcQFontMetrics_width_QStringIntInt(self.h, struct_seaqt_string(data: if len(param1) > 0: addr param1[0] else: nil, len: csize_t(len(param1))), len, flags)

proc width*(self: gen_qfontmetrics_types.QFontMetrics, param1: gen_qchar_types.QChar): cint =
  fcQFontMetrics_width_QChar(self.h, param1.h)
...
proc width*(self: gen_qfontmetrics_types.QFontMetrics, param1: openArray[char], len: cint): cint =
  fcQFontMetrics_width_QStringInt(self.h, struct_seaqt_string(data: if len(param1) > 0: addr param1[0] else: nil, len: csize_t(len(param1))), len)
...
proc width*(self: gen_qfontmetrics_types.QFontMetricsF, stringVal: openArray[char]): float64 =
  fcQFontMetricsF_width_QString(self.h, struct_seaqt_string(data: if len(stringVal) > 0: addr stringVal[0] else: nil, len: csize_t(len(stringVal))))

proc width*(self: gen_qfontmetrics_types.QFontMetricsF, param1: gen_qchar_types.QChar): float64 =
  fcQFontMetricsF_width_QChar(self.h, param1.h)
