...
proc fcQFontMetricsF_width(self: pointer, stringVal: struct_miqt_string): float64 {.importc: "QFontMetricsF_width".}
proc fcQFontMetricsF_widthWithQChar(self: pointer, param1: pointer): float64 {.importc: "QFontMetricsF_widthWithQChar".}
proc fcQFontMetricsF_horizontalAdvance(self: pointer, stringVal: struct_miqt_string): float64 {.importc: "QFontMetricsF_horizontalAdvance".}
...
proc fcQFontMetricsF_boundingRect(self: pointer, stringVal: struct_miqt_string): pointer {.importc: "QFontMetricsF_boundingRect".}
...
proc fcQFontMetricsF_boundingRect2(self: pointer, r: pointer, flags: cint, stringVal: struct_miqt_string): pointer {.importc: "QFontMetricsF_boundingRect2".}
...
proc fcQFontMetricsF_horizontalAdvance2(self: pointer, stringVal: struct_miqt_string, length: cint): float64 {.importc: "QFontMetricsF_horizontalAdvance2".}
proc fcQFontMetricsF_boundingRect4(self: pointer, r: pointer, flags: cint, stringVal: struct_miqt_string, tabstops: cint): pointer {.importc: "QFontMetricsF_boundingRect4".}
proc fcQFontMetricsF_boundingRect5(self: pointer, r: pointer, flags: cint, stringVal: struct_miqt_string, tabstops: cint, tabarray: ptr cint): pointer {.importc: "QFontMetricsF_boundingRect5".}
...
proc width*(self: gen_qfontmetrics_types.QFontMetrics, param1: openArray[char]): cint =
  fcQFontMetrics_width(self.h, struct_miqt_string(data: if len(param1) > 0: addr param1[0] else: nil, len: csize_t(len(param1))))

proc width*(self: gen_qfontmetrics_types.QFontMetrics, param1: openArray[char], len: cint, flags: cint): cint =
  fcQFontMetrics_width2(self.h, struct_miqt_string(data: if len(param1) > 0: addr param1[0] else: nil, len: csize_t(len(param1))), len, flags)
...
proc horizontalAdvance*(self: gen_qfontmetrics_types.QFontMetrics, param1: openArray[char]): cint =
  fcQFontMetrics_horizontalAdvance(self.h, struct_miqt_string(data: if len(param1) > 0: addr param1[0] else: nil, len: csize_t(len(param1))))
...
proc charWidth*(self: gen_qfontmetrics_types.QFontMetrics, str: openArray[char], pos: cint): cint =
  fcQFontMetrics_charWidth(self.h, struct_miqt_string(data: if len(str) > 0: addr str[0] else: nil, len: csize_t(len(str))), pos)
...
proc boundingRect*(self: gen_qfontmetrics_types.QFontMetrics, r: gen_qrect_types.QRect, flags: cint, text: openArray[char]): gen_qrect_types.QRect =
  gen_qrect_types.QRect(h: fcQFontMetrics_boundingRect2(self.h, r.h, flags, struct_miqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text)))), owned: true)
...
proc boundingRect*(self: gen_qfontmetrics_types.QFontMetrics, x: cint, y: cint, w: cint, h: cint, flags: cint, text: openArray[char]): gen_qrect_types.QRect =
  gen_qrect_types.QRect(h: fcQFontMetrics_boundingRect3(self.h, x, y, w, h, flags, struct_miqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text)))), owned: true)
...
proc width*(self: gen_qfontmetrics_types.QFontMetrics, param1: openArray[char], len: cint): cint =
  fcQFontMetrics_width22(self.h, struct_miqt_string(data: if len(param1) > 0: addr param1[0] else: nil, len: csize_t(len(param1))), len)

proc horizontalAdvance*(self: gen_qfontmetrics_types.QFontMetrics, param1: openArray[char], len: cint): cint =
  fcQFontMetrics_horizontalAdvance2(self.h, struct_miqt_string(data: if len(param1) > 0: addr param1[0] else: nil, len: csize_t(len(param1))), len)
...
proc boundingRect*(self: gen_qfontmetrics_types.QFontMetrics, r: gen_qrect_types.QRect, flags: cint, text: openArray[char], tabstops: cint): gen_qrect_types.QRect =
  gen_qrect_types.QRect(h: fcQFontMetrics_boundingRect4(self.h, r.h, flags, struct_miqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), tabstops), owned: true)
...
proc width*(self: gen_qfontmetrics_types.QFontMetricsF, stringVal: openArray[char]): float64 =
  fcQFontMetricsF_width(self.h, struct_miqt_string(data: if len(stringVal) > 0: addr stringVal[0] else: nil, len: csize_t(len(stringVal))))
...
proc horizontalAdvance*(self: gen_qfontmetrics_types.QFontMetricsF, stringVal: openArray[char]): float64 =
  fcQFontMetricsF_horizontalAdvance(self.h, struct_miqt_string(data: if len(stringVal) > 0: addr stringVal[0] else: nil, len: csize_t(len(stringVal))))
...
proc boundingRect*(self: gen_qfontmetrics_types.QFontMetricsF, stringVal: openArray[char]): gen_qrect_types.QRectF =
  gen_qrect_types.QRectF(h: fcQFontMetricsF_boundingRect(self.h, struct_miqt_string(data: if len(stringVal) > 0: addr stringVal[0] else: nil, len: csize_t(len(stringVal)))), owned: true)
...
proc boundingRect*(self: gen_qfontmetrics_types.QFontMetricsF, r: gen_qrect_types.QRectF, flags: cint, stringVal: openArray[char]): gen_qrect_types.QRectF =
  gen_qrect_types.QRectF(h: fcQFontMetricsF_boundingRect2(self.h, r.h, flags, struct_miqt_string(data: if len(stringVal) > 0: addr stringVal[0] else: nil, len: csize_t(len(stringVal)))), owned: true)
...
proc horizontalAdvance*(self: gen_qfontmetrics_types.QFontMetricsF, stringVal: openArray[char], length: cint): float64 =
  fcQFontMetricsF_horizontalAdvance2(self.h, struct_miqt_string(data: if len(stringVal) > 0: addr stringVal[0] else: nil, len: csize_t(len(stringVal))), length)
...
proc boundingRect*(self: gen_qfontmetrics_types.QFontMetricsF, r: gen_qrect_types.QRectF, flags: cint, stringVal: openArray[char], tabstops: cint): gen_qrect_types.QRectF =
  gen_qrect_types.QRectF(h: fcQFontMetricsF_boundingRect4(self.h, r.h, flags, struct_miqt_string(data: if len(stringVal) > 0: addr stringVal[0] else: nil, len: csize_t(len(stringVal))), tabstops), owned: true)
...
proc boundingRect*(self: gen_qfontmetrics_types.QFontMetricsF, r: gen_qrect_types.QRectF, flags: cint, stringVal: openArray[char], tabstops: cint, tabarray: ptr cint): gen_qrect_types.QRectF =
  gen_qrect_types.QRectF(h: fcQFontMetricsF_boundingRect5(self.h, r.h, flags, struct_miqt_string(data: if len(stringVal) > 0: addr stringVal[0] else: nil, len: csize_t(len(stringVal))), tabstops, tabarray), owned: true)
