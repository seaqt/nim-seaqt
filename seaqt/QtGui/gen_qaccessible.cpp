...
VirtualQAccessibleEvent* QAccessibleEvent_new(const QAccessibleEvent_VTable* vtbl, size_t vdata, QObject* obj, int typ) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQAccessibleEvent>());
...
VirtualQAccessibleStateChangeEvent* QAccessibleStateChangeEvent_new(const QAccessibleStateChangeEvent_VTable* vtbl, size_t vdata, QObject* obj, QAccessible__State* state) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQAccessibleStateChangeEvent>());
...
VirtualQAccessibleTextCursorEvent* QAccessibleTextCursorEvent_new(const QAccessibleTextCursorEvent_VTable* vtbl, size_t vdata, QObject* obj, int cursorPos) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQAccessibleTextCursorEvent>());
...
VirtualQAccessibleTextSelectionEvent* QAccessibleTextSelectionEvent_new(const QAccessibleTextSelectionEvent_VTable* vtbl, size_t vdata, QObject* obj, int start, int end) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQAccessibleTextSelectionEvent>());
...
VirtualQAccessibleTextInsertEvent* QAccessibleTextInsertEvent_new(const QAccessibleTextInsertEvent_VTable* vtbl, size_t vdata, QObject* obj, int position, struct miqt_string text) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQAccessibleTextInsertEvent>());
	return _mem_ ? new (_mem_)VirtualQAccessibleTextInsertEvent(vtbl, obj, static_cast<int>(position), text_QString) : nullptr;
}

VirtualQAccessibleTextInsertEvent* QAccessibleTextInsertEvent_new2(const QAccessibleTextInsertEvent_VTable* vtbl, size_t vdata, QAccessibleInterface* iface, int position, struct miqt_string text) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQAccessibleTextInsertEvent>());
...
VirtualQAccessibleTextRemoveEvent* QAccessibleTextRemoveEvent_new(const QAccessibleTextRemoveEvent_VTable* vtbl, size_t vdata, QObject* obj, int position, struct miqt_string text) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQAccessibleTextRemoveEvent>());
	return _mem_ ? new (_mem_)VirtualQAccessibleTextRemoveEvent(vtbl, obj, static_cast<int>(position), text_QString) : nullptr;
}

VirtualQAccessibleTextRemoveEvent* QAccessibleTextRemoveEvent_new2(const QAccessibleTextRemoveEvent_VTable* vtbl, size_t vdata, QAccessibleInterface* iface, int position, struct miqt_string text) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQAccessibleTextRemoveEvent>());
...
VirtualQAccessibleTextUpdateEvent* QAccessibleTextUpdateEvent_new(const QAccessibleTextUpdateEvent_VTable* vtbl, size_t vdata, QObject* obj, int position, struct miqt_string oldText, struct miqt_string text) {
	QString oldText_QString = QString::fromUtf8(oldText.data, oldText.len);
	QString text_QString = QString::fromUtf8(text.data, text.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQAccessibleTextUpdateEvent>());
...
VirtualQAccessibleTextUpdateEvent* QAccessibleTextUpdateEvent_new2(const QAccessibleTextUpdateEvent_VTable* vtbl, size_t vdata, QAccessibleInterface* iface, int position, struct miqt_string oldText, struct miqt_string text) {
	QString oldText_QString = QString::fromUtf8(oldText.data, oldText.len);
	QString text_QString = QString::fromUtf8(text.data, text.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQAccessibleTextUpdateEvent>());
...
VirtualQAccessibleValueChangeEvent* QAccessibleValueChangeEvent_new(const QAccessibleValueChangeEvent_VTable* vtbl, size_t vdata, QObject* obj, QVariant* val) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQAccessibleValueChangeEvent>());
...
VirtualQAccessibleTableModelChangeEvent* QAccessibleTableModelChangeEvent_new(const QAccessibleTableModelChangeEvent_VTable* vtbl, size_t vdata, QObject* obj, int changeType) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQAccessibleTableModelChangeEvent>());
