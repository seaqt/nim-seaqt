...
proc fromString*(_: type gen_qcolor_types.QColor, name: openArray[char]): gen_qcolor_types.QColor =
  gen_qcolor_types.QColor(h: fcQColor_fromString(struct_seaqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name)))))
...
proc create*(T: type gen_qcolor_types.QColor,
  ...
  let tmp = gen_qcolor_types.QColor(h: fcQColor_new9(cint(spec), a1, a2, a3, a4))
  tmp
proc create*(T: type gen_qcolor_types.QColor,
    param1: gen_qcolor_types.QColor): gen_qcolor_types.QColor =
  let tmp = gen_qcolor_types.QColor(h: fcQColor_new10(param1.h))
  tmp
proc create*(T: type gen_qcolor_types.QColor,
