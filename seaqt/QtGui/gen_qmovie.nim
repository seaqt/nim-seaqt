...
proc fcQMovie_new3(vtbl: pointer, vdata: csize_t, fileName: struct_miqt_string): ptr cQMovie {.importc: "QMovie_new3".}
proc fcQMovie_new4(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQMovie {.importc: "QMovie_new4".}
proc fcQMovie_new5(vtbl: pointer, vdata: csize_t, device: pointer, format: struct_miqt_string): ptr cQMovie {.importc: "QMovie_new5".}
proc fcQMovie_new6(vtbl: pointer, vdata: csize_t, device: pointer, format: struct_miqt_string, parent: pointer): ptr cQMovie {.importc: "QMovie_new6".}
proc fcQMovie_new7(vtbl: pointer, vdata: csize_t, fileName: struct_miqt_string, format: struct_miqt_string): ptr cQMovie {.importc: "QMovie_new7".}
proc fcQMovie_new8(vtbl: pointer, vdata: csize_t, fileName: struct_miqt_string, format: struct_miqt_string, parent: pointer): ptr cQMovie {.importc: "QMovie_new8".}
...
proc setFormat*(self: gen_qmovie_types.QMovie, format: openArray[byte]): void =
  fcQMovie_setFormat(self.h, struct_miqt_string(data: if len(format) > 0: addr format[0] else: nil, len: csize_t(len(format))))
...
proc create*(T: type gen_qmovie_types.QMovie,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQMovie_vtable_callback_disconnectNotify
  let tmp = gen_qmovie_types.QMovie(h: fcQMovie_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_miqt_string(data: if len(fileName) > 0: addr fileName[0] else: nil, len: csize_t(len(fileName)))), owned: true)
  fcQMovie_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qmovie_types.QMovie,
...
proc create*(T: type gen_qmovie_types.QMovie,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQMovie_vtable_callback_disconnectNotify
  let tmp = gen_qmovie_types.QMovie(h: fcQMovie_new5(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), device.h, struct_miqt_string(data: if len(format) > 0: addr format[0] else: nil, len: csize_t(len(format)))), owned: true)
  fcQMovie_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qmovie_types.QMovie,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQMovie_vtable_callback_disconnectNotify
  let tmp = gen_qmovie_types.QMovie(h: fcQMovie_new6(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), device.h, struct_miqt_string(data: if len(format) > 0: addr format[0] else: nil, len: csize_t(len(format))), parent.h), owned: true)
  fcQMovie_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qmovie_types.QMovie,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQMovie_vtable_callback_disconnectNotify
  let tmp = gen_qmovie_types.QMovie(h: fcQMovie_new7(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_miqt_string(data: if len(fileName) > 0: addr fileName[0] else: nil, len: csize_t(len(fileName))), struct_miqt_string(data: if len(format) > 0: addr format[0] else: nil, len: csize_t(len(format)))), owned: true)
  fcQMovie_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qmovie_types.QMovie,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQMovie_vtable_callback_disconnectNotify
  let tmp = gen_qmovie_types.QMovie(h: fcQMovie_new8(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_miqt_string(data: if len(fileName) > 0: addr fileName[0] else: nil, len: csize_t(len(fileName))), struct_miqt_string(data: if len(format) > 0: addr format[0] else: nil, len: csize_t(len(format))), parent.h), owned: true)
  fcQMovie_vdata(tmp.h)[] = addr(vtbl[])
  tmp
...
proc create*(T: type gen_qmovie_types.QMovie,
    ...
    inst: VirtualQMovie) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQMovie_new3(addr(cQMovie_mvtbl), csize_t(sizeof(pointer)), struct_miqt_string(data: if len(fileName) > 0: addr fileName[0] else: nil, len: csize_t(len(fileName))))
  fcQMovie_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qmovie_types.QMovie,
    ...
    inst: VirtualQMovie) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQMovie_new5(addr(cQMovie_mvtbl), csize_t(sizeof(pointer)), device.h, struct_miqt_string(data: if len(format) > 0: addr format[0] else: nil, len: csize_t(len(format))))
  fcQMovie_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qmovie_types.QMovie,
    ...
    inst: VirtualQMovie) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQMovie_new6(addr(cQMovie_mvtbl), csize_t(sizeof(pointer)), device.h, struct_miqt_string(data: if len(format) > 0: addr format[0] else: nil, len: csize_t(len(format))), parent.h)
  fcQMovie_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qmovie_types.QMovie,
    ...
    inst: VirtualQMovie) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQMovie_new7(addr(cQMovie_mvtbl), csize_t(sizeof(pointer)), struct_miqt_string(data: if len(fileName) > 0: addr fileName[0] else: nil, len: csize_t(len(fileName))), struct_miqt_string(data: if len(format) > 0: addr format[0] else: nil, len: csize_t(len(format))))
  fcQMovie_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qmovie_types.QMovie,
    ...
    inst: VirtualQMovie) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQMovie_new8(addr(cQMovie_mvtbl), csize_t(sizeof(pointer)), struct_miqt_string(data: if len(fileName) > 0: addr fileName[0] else: nil, len: csize_t(len(fileName))), struct_miqt_string(data: if len(format) > 0: addr format[0] else: nil, len: csize_t(len(format))), parent.h)
  fcQMovie_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
