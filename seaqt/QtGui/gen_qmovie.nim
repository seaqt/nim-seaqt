...
proc create*(T: type gen_qmovie_types.QMovie,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQMovie_vtable_callback_disconnectNotify
  let tmp = gen_qmovie_types.QMovie(h: fcQMovie_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_miqt_string(data: if len(fileName) > 0: addr fileName[0] else: nil, len: csize_t(len(fileName)))))
  fcQMovie_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qmovie_types.QMovie,
...
proc create*(T: type gen_qmovie_types.QMovie,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQMovie_vtable_callback_disconnectNotify
  let tmp = gen_qmovie_types.QMovie(h: fcQMovie_new5(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), device.h, struct_miqt_string(data: if len(format) > 0: addr format[0] else: nil, len: csize_t(len(format)))))
  fcQMovie_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qmovie_types.QMovie,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQMovie_vtable_callback_disconnectNotify
  let tmp = gen_qmovie_types.QMovie(h: fcQMovie_new6(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), device.h, struct_miqt_string(data: if len(format) > 0: addr format[0] else: nil, len: csize_t(len(format))), parent.h))
  fcQMovie_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qmovie_types.QMovie,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQMovie_vtable_callback_disconnectNotify
  let tmp = gen_qmovie_types.QMovie(h: fcQMovie_new7(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_miqt_string(data: if len(fileName) > 0: addr fileName[0] else: nil, len: csize_t(len(fileName))), struct_miqt_string(data: if len(format) > 0: addr format[0] else: nil, len: csize_t(len(format)))))
  fcQMovie_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qmovie_types.QMovie,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQMovie_vtable_callback_disconnectNotify
  let tmp = gen_qmovie_types.QMovie(h: fcQMovie_new8(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_miqt_string(data: if len(fileName) > 0: addr fileName[0] else: nil, len: csize_t(len(fileName))), struct_miqt_string(data: if len(format) > 0: addr format[0] else: nil, len: csize_t(len(format))), parent.h))
  fcQMovie_vdata(tmp.h)[] = addr(vtbl[])
  tmp
