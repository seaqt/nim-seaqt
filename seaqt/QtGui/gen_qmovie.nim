...
proc fcQMovie_trUtf8(s: cstring): struct_seaqt_string {.importc: "QMovie_trUtf8".}
...
proc fcQMovie_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QMovie_trUtf82".}
proc fcQMovie_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QMovie_trUtf83".}
