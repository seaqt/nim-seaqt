...
proc fcQMovie_trUtf8S(s: cstring): struct_seaqt_string {.importc: "QMovie_trUtf8_s".}
...
proc fcQMovie_setFileName(self: pointer, fileName: struct_seaqt_string): void {.importc: "QMovie_setFileName".}
proc fcQMovie_fileName(self: pointer): struct_seaqt_string {.importc: "QMovie_fileName".}
proc fcQMovie_setFormat(self: pointer, format: struct_seaqt_string): void {.importc: "QMovie_setFormat".}
proc fcQMovie_format(self: pointer): struct_seaqt_string {.importc: "QMovie_format".}
...
proc fcQMovie_lastErrorString(self: pointer): struct_seaqt_string {.importc: "QMovie_lastErrorString".}
...
proc fcQMovie_trUtf8SC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QMovie_trUtf8_s_c".}
proc fcQMovie_trUtf8SCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QMovie_trUtf8_s_c_n".}
...
proc setFileName*(self: gen_qmovie_types.QMovie, fileName: openArray[char]): void =
  fcQMovie_setFileName(self.h, struct_seaqt_string(data: if len(fileName) > 0: addr fileName[0] else: nil, len: csize_t(len(fileName))))
...
proc setFormat*(self: gen_qmovie_types.QMovie, format: openArray[byte]): void =
  fcQMovie_setFormat(self.h, struct_seaqt_string(data: if len(format) > 0: addr format[0] else: nil, len: csize_t(len(format))))
...
proc create*(T: type gen_qmovie_types.QMovie,
  ...
  let tmp = gen_qmovie_types.QMovie(h: fcQMovie_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQMovie_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qmovie_types.QMovie,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQMovie_vtable_callback_disconnectNotify
  let tmp = gen_qmovie_types.QMovie(h: fcQMovie_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), device.h), owned: true)
  fcQMovie_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qmovie_types.QMovie,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQMovie_vtable_callback_disconnectNotify
  let tmp = gen_qmovie_types.QMovie(h: fcQMovie_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(fileName) > 0: addr fileName[0] else: nil, len: csize_t(len(fileName)))), owned: true)
  fcQMovie_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qmovie_types.QMovie,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQMovie_vtable_callback_disconnectNotify
  let tmp = gen_qmovie_types.QMovie(h: fcQMovie_new4(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQMovie_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qmovie_types.QMovie,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQMovie_vtable_callback_disconnectNotify
  let tmp = gen_qmovie_types.QMovie(h: fcQMovie_new5(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), device.h, struct_seaqt_string(data: if len(format) > 0: addr format[0] else: nil, len: csize_t(len(format)))), owned: true)
  fcQMovie_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qmovie_types.QMovie,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQMovie_vtable_callback_disconnectNotify
  let tmp = gen_qmovie_types.QMovie(h: fcQMovie_new6(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), device.h, struct_seaqt_string(data: if len(format) > 0: addr format[0] else: nil, len: csize_t(len(format))), parent.h), owned: true)
  fcQMovie_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qmovie_types.QMovie,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQMovie_vtable_callback_disconnectNotify
  let tmp = gen_qmovie_types.QMovie(h: fcQMovie_new7(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(fileName) > 0: addr fileName[0] else: nil, len: csize_t(len(fileName))), struct_seaqt_string(data: if len(format) > 0: addr format[0] else: nil, len: csize_t(len(format)))), owned: true)
  fcQMovie_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qmovie_types.QMovie,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQMovie_vtable_callback_disconnectNotify
  let tmp = gen_qmovie_types.QMovie(h: fcQMovie_new8(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(fileName) > 0: addr fileName[0] else: nil, len: csize_t(len(fileName))), struct_seaqt_string(data: if len(format) > 0: addr format[0] else: nil, len: csize_t(len(format))), parent.h), owned: true)
  fcQMovie_vdata(tmp.h)[] = addr(vtbl[])
  tmp
...
proc create*(T: type gen_qmovie_types.QMovie,
  ...
  inst[].h = fcQMovie_new(addr(cQMovie_mvtbl), csize_t(sizeof(pointer)))
  fcQMovie_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qmovie_types.QMovie,
    ...
    inst: VirtualQMovie) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQMovie_new2(addr(cQMovie_mvtbl), csize_t(sizeof(pointer)), device.h)
  fcQMovie_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qmovie_types.QMovie,
    ...
    inst: VirtualQMovie) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQMovie_new3(addr(cQMovie_mvtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(fileName) > 0: addr fileName[0] else: nil, len: csize_t(len(fileName))))
  fcQMovie_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qmovie_types.QMovie,
    ...
    inst: VirtualQMovie) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQMovie_new4(addr(cQMovie_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQMovie_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qmovie_types.QMovie,
    ...
    inst: VirtualQMovie) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQMovie_new5(addr(cQMovie_mvtbl), csize_t(sizeof(pointer)), device.h, struct_seaqt_string(data: if len(format) > 0: addr format[0] else: nil, len: csize_t(len(format))))
  fcQMovie_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qmovie_types.QMovie,
    ...
    inst: VirtualQMovie) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQMovie_new6(addr(cQMovie_mvtbl), csize_t(sizeof(pointer)), device.h, struct_seaqt_string(data: if len(format) > 0: addr format[0] else: nil, len: csize_t(len(format))), parent.h)
  fcQMovie_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qmovie_types.QMovie,
    ...
    inst: VirtualQMovie) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQMovie_new7(addr(cQMovie_mvtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(fileName) > 0: addr fileName[0] else: nil, len: csize_t(len(fileName))), struct_seaqt_string(data: if len(format) > 0: addr format[0] else: nil, len: csize_t(len(format))))
  fcQMovie_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qmovie_types.QMovie,
    ...
    inst: VirtualQMovie) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQMovie_new8(addr(cQMovie_mvtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(fileName) > 0: addr fileName[0] else: nil, len: csize_t(len(fileName))), struct_seaqt_string(data: if len(format) > 0: addr format[0] else: nil, len: csize_t(len(format))), parent.h)
  fcQMovie_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
