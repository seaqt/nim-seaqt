...
proc fcQBrush_operatorAssign_QBrush(self: pointer, fromVal: pointer): void {.importc: "QBrush_operatorAssign_QBrush".}
proc fcQBrush_swap(self: pointer, other: pointer): void {.importc: "QBrush_swap".}
proc fcQBrush_operatorAssign_Qt_BrushStyle(self: pointer, style: cint): void {.importc: "QBrush_operatorAssign_Qt_BrushStyle".}
proc fcQBrush_operatorAssign_QColor(self: pointer, color: pointer): void {.importc: "QBrush_operatorAssign_QColor".}
proc fcQBrush_operatorAssign_Qt_GlobalColor(self: pointer, color: cint): void {.importc: "QBrush_operatorAssign_Qt_GlobalColor".}
...
proc operatorAssign*(self: gen_qbrush_types.QBrush, fromVal: gen_qbrush_types.QBrush): void =
  fcQBrush_operatorAssign_QBrush(self.h, fromVal.h)

proc swap*(self: gen_qbrush_types.QBrush, other: gen_qbrush_types.QBrush): void =
  fcQBrush_swap(self.h, other.h)

proc operatorAssign*(self: gen_qbrush_types.QBrush, style: cint): void =
  fcQBrush_operatorAssign_Qt_BrushStyle(self.h, cint(style))

proc operatorAssign*(self: gen_qbrush_types.QBrush, color: gen_qcolor_types.QColor): void =
  fcQBrush_operatorAssign_QColor(self.h, color.h)

proc operatorAssign2*(self: gen_qbrush_types.QBrush, color: cint): void =
  fcQBrush_operatorAssign_Qt_GlobalColor(self.h, cint(color))
