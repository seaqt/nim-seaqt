...
proc create*(T: type gen_qbrush_types.QBrush): gen_qbrush_types.QBrush =
  gen_qbrush_types.QBrush(h: fcQBrush_new(), owned: true)

proc create*(T: type gen_qbrush_types.QBrush,
    bs: cint): gen_qbrush_types.QBrush =
  gen_qbrush_types.QBrush(h: fcQBrush_new2(cint(bs)), owned: true)

proc create*(T: type gen_qbrush_types.QBrush,
    color: gen_qcolor_types.QColor): gen_qbrush_types.QBrush =
  gen_qbrush_types.QBrush(h: fcQBrush_new3(color.h), owned: true)

proc create2*(T: type gen_qbrush_types.QBrush,
    color: cint): gen_qbrush_types.QBrush =
  gen_qbrush_types.QBrush(h: fcQBrush_new4(cint(color)), owned: true)

proc create*(T: type gen_qbrush_types.QBrush,
    color: gen_qcolor_types.QColor, pixmap: gen_qpixmap_types.QPixmap): gen_qbrush_types.QBrush =
  gen_qbrush_types.QBrush(h: fcQBrush_new5(color.h, pixmap.h), owned: true)

proc create*(T: type gen_qbrush_types.QBrush,
    color: cint, pixmap: gen_qpixmap_types.QPixmap): gen_qbrush_types.QBrush =
  gen_qbrush_types.QBrush(h: fcQBrush_new6(cint(color), pixmap.h), owned: true)

proc create*(T: type gen_qbrush_types.QBrush,
    pixmap: gen_qpixmap_types.QPixmap): gen_qbrush_types.QBrush =
  gen_qbrush_types.QBrush(h: fcQBrush_new7(pixmap.h), owned: true)

proc create*(T: type gen_qbrush_types.QBrush,
    image: gen_qimage_types.QImage): gen_qbrush_types.QBrush =
  gen_qbrush_types.QBrush(h: fcQBrush_new8(image.h), owned: true)

proc create*(T: type gen_qbrush_types.QBrush,
    brush: gen_qbrush_types.QBrush): gen_qbrush_types.QBrush =
  gen_qbrush_types.QBrush(h: fcQBrush_new9(brush.h), owned: true)

proc create*(T: type gen_qbrush_types.QBrush,
    gradient: gen_qbrush_types.QGradient): gen_qbrush_types.QBrush =
  gen_qbrush_types.QBrush(h: fcQBrush_new10(gradient.h), owned: true)

proc create*(T: type gen_qbrush_types.QBrush,
    color: gen_qcolor_types.QColor, bs: cint): gen_qbrush_types.QBrush =
  gen_qbrush_types.QBrush(h: fcQBrush_new11(color.h, cint(bs)), owned: true)

proc create*(T: type gen_qbrush_types.QBrush,
    color: cint, bs: cint): gen_qbrush_types.QBrush =
  gen_qbrush_types.QBrush(h: fcQBrush_new12(cint(color), cint(bs)), owned: true)
...
proc create*(T: type gen_qbrush_types.QBrushData,
  ...
  gen_qbrush_types.QBrushData(h: fcQBrushData_new(param1.h), owned: true)
...
proc create*(T: type gen_qbrush_types.QGradient): gen_qbrush_types.QGradient =
  gen_qbrush_types.QGradient(h: fcQGradient_new(), owned: true)

proc create*(T: type gen_qbrush_types.QGradient,
    param1: cint): gen_qbrush_types.QGradient =
  gen_qbrush_types.QGradient(h: fcQGradient_new2(cint(param1)), owned: true)

proc create*(T: type gen_qbrush_types.QGradient,
    param1: gen_qbrush_types.QGradient): gen_qbrush_types.QGradient =
  gen_qbrush_types.QGradient(h: fcQGradient_new3(param1.h), owned: true)
...
proc create*(T: type gen_qbrush_types.QLinearGradient): gen_qbrush_types.QLinearGradient =
  gen_qbrush_types.QLinearGradient(h: fcQLinearGradient_new(), owned: true)
...
proc create*(T: type gen_qbrush_types.QLinearGradient,
  ...
  gen_qbrush_types.QLinearGradient(h: fcQLinearGradient_new2(start.h, finalStop.h), owned: true)

proc create*(T: type gen_qbrush_types.QLinearGradient,
    xStart: float64, yStart: float64, xFinalStop: float64, yFinalStop: float64): gen_qbrush_types.QLinearGradient =
  gen_qbrush_types.QLinearGradient(h: fcQLinearGradient_new3(xStart, yStart, xFinalStop, yFinalStop), owned: true)

proc create*(T: type gen_qbrush_types.QLinearGradient,
    param1: gen_qbrush_types.QLinearGradient): gen_qbrush_types.QLinearGradient =
  gen_qbrush_types.QLinearGradient(h: fcQLinearGradient_new4(param1.h), owned: true)
...
proc create*(T: type gen_qbrush_types.QRadialGradient): gen_qbrush_types.QRadialGradient =
  gen_qbrush_types.QRadialGradient(h: fcQRadialGradient_new(), owned: true)
...
proc create*(T: type gen_qbrush_types.QRadialGradient,
  ...
  gen_qbrush_types.QRadialGradient(h: fcQRadialGradient_new2(center.h, radius, focalPoint.h), owned: true)

proc create*(T: type gen_qbrush_types.QRadialGradient,
    cx: float64, cy: float64, radius: float64, fx: float64, fy: float64): gen_qbrush_types.QRadialGradient =
  gen_qbrush_types.QRadialGradient(h: fcQRadialGradient_new3(cx, cy, radius, fx, fy), owned: true)

proc create*(T: type gen_qbrush_types.QRadialGradient,
    center: gen_qpoint_types.QPointF, radius: float64): gen_qbrush_types.QRadialGradient =
  gen_qbrush_types.QRadialGradient(h: fcQRadialGradient_new4(center.h, radius), owned: true)

proc create*(T: type gen_qbrush_types.QRadialGradient,
    cx: float64, cy: float64, radius: float64): gen_qbrush_types.QRadialGradient =
  gen_qbrush_types.QRadialGradient(h: fcQRadialGradient_new5(cx, cy, radius), owned: true)
...
proc create*(T: type gen_qbrush_types.QRadialGradient,
  ...
  gen_qbrush_types.QRadialGradient(h: fcQRadialGradient_new6(center.h, centerRadius, focalPoint.h, focalRadius), owned: true)

proc create*(T: type gen_qbrush_types.QRadialGradient,
    cx: float64, cy: float64, centerRadius: float64, fx: float64, fy: float64, focalRadius: float64): gen_qbrush_types.QRadialGradient =
  gen_qbrush_types.QRadialGradient(h: fcQRadialGradient_new7(cx, cy, centerRadius, fx, fy, focalRadius), owned: true)

proc create*(T: type gen_qbrush_types.QRadialGradient,
    param1: gen_qbrush_types.QRadialGradient): gen_qbrush_types.QRadialGradient =
  gen_qbrush_types.QRadialGradient(h: fcQRadialGradient_new8(param1.h), owned: true)
...
proc create*(T: type gen_qbrush_types.QConicalGradient): gen_qbrush_types.QConicalGradient =
  gen_qbrush_types.QConicalGradient(h: fcQConicalGradient_new(), owned: true)
...
proc create*(T: type gen_qbrush_types.QConicalGradient,
  ...
  gen_qbrush_types.QConicalGradient(h: fcQConicalGradient_new2(center.h, startAngle), owned: true)

proc create*(T: type gen_qbrush_types.QConicalGradient,
    cx: float64, cy: float64, startAngle: float64): gen_qbrush_types.QConicalGradient =
  gen_qbrush_types.QConicalGradient(h: fcQConicalGradient_new3(cx, cy, startAngle), owned: true)

proc create*(T: type gen_qbrush_types.QConicalGradient,
    param1: gen_qbrush_types.QConicalGradient): gen_qbrush_types.QConicalGradient =
  gen_qbrush_types.QConicalGradient(h: fcQConicalGradient_new4(param1.h), owned: true)
...
proc create*(T: type gen_qbrush_types.QGradientQGradientData,
  ...
  gen_qbrush_types.QGradientQGradientData(h: fcQGradientQGradientData_new(param1.h), owned: true)
