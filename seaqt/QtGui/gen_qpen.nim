...
proc fcQPen_operatorAssignFrom(self: pointer, fromVal: pointer): void {.importc: "QPen_operatorAssign_from".}
proc fcQPen_swap(self: pointer, other: pointer): void {.importc: "QPen_swap".}
proc fcQPen_operatorAssignColor(self: pointer, color: pointer): void {.importc: "QPen_operatorAssign_color".}
proc fcQPen_operatorAssignStyle(self: pointer, style: cint): void {.importc: "QPen_operatorAssign_style".}
...
proc fcQPen_dashPattern(self: pointer): struct_seaqt_array {.importc: "QPen_dashPattern".}
proc fcQPen_setDashPattern(self: pointer, pattern: struct_seaqt_array): void {.importc: "QPen_setDashPattern".}
...
proc operatorAssign*(self: gen_qpen_types.QPen, fromVal: gen_qpen_types.QPen): void =
  fcQPen_operatorAssignFrom(self.h, fromVal.h)

proc swap*(self: gen_qpen_types.QPen, other: gen_qpen_types.QPen): void =
  fcQPen_swap(self.h, other.h)

proc operatorAssign*(self: gen_qpen_types.QPen, color: gen_qcolor_types.QColor): void =
  fcQPen_operatorAssignColor(self.h, color.h)

proc operatorAssign*(self: gen_qpen_types.QPen, style: cint): void =
  fcQPen_operatorAssignStyle(self.h, cint(style))
...
proc setDashPattern*(self: gen_qpen_types.QPen, pattern: openArray[float64]): void =
  ...
  fcQPen_setDashPattern(self.h, struct_seaqt_array(len: csize_t(len(pattern)), data: if len(pattern) == 0: nil else: addr(pattern_CArray[0])))
...
proc create*(T: type gen_qpen_types.QPen): gen_qpen_types.QPen =
  let tmp = gen_qpen_types.QPen(h: fcQPen_new(), owned: true)
  tmp
proc create*(T: type gen_qpen_types.QPen,
    param1: cint): gen_qpen_types.QPen =
  let tmp = gen_qpen_types.QPen(h: fcQPen_new2(cint(param1)), owned: true)
  tmp
proc create*(T: type gen_qpen_types.QPen,
    color: gen_qcolor_types.QColor): gen_qpen_types.QPen =
  let tmp = gen_qpen_types.QPen(h: fcQPen_new3(color.h), owned: true)
  tmp
proc create*(T: type gen_qpen_types.QPen,
...
proc create*(T: type gen_qpen_types.QPen,
  ...
  let tmp = gen_qpen_types.QPen(h: fcQPen_new6(brush.h, width, cint(s)), owned: true)
  tmp
proc create*(T: type gen_qpen_types.QPen,
    brush: gen_qbrush_types.QBrush, width: float64, s: cint, c: cint): gen_qpen_types.QPen =
  let tmp = gen_qpen_types.QPen(h: fcQPen_new7(brush.h, width, cint(s), cint(c)), owned: true)
  tmp
proc create*(T: type gen_qpen_types.QPen,
    brush: gen_qbrush_types.QBrush, width: float64, s: cint, c: cint, j: cint): gen_qpen_types.QPen =
  let tmp = gen_qpen_types.QPen(h: fcQPen_new8(brush.h, width, cint(s), cint(c), cint(j)), owned: true)
  tmp
