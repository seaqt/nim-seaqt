...
VirtualQBitmap* QBitmap_new(const QBitmap_VTable* vtbl, size_t vdata) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQBitmap>());
...
VirtualQBitmap* QBitmap_new5(const QBitmap_VTable* vtbl, size_t vdata, struct miqt_string fileName) {
...
VirtualQBitmap* QBitmap_new7(const QBitmap_VTable* vtbl, size_t vdata, struct miqt_string fileName, const char* format) {
	QString fileName_QString = QString::fromUtf8(fileName.data, fileName.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQBitmap>());
