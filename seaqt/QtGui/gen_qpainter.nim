...
proc boundingRect*(self: gen_qpainter_types.QPainter, rect: gen_qrect_types.QRectF, flags: cint, text: string): gen_qrect_types.QRectF =
  gen_qrect_types.QRectF(h: fcQPainter_boundingRect(self.h, rect.h, flags, struct_miqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text)))))
...
proc boundingRect*(self: gen_qpainter_types.QPainter, rect: gen_qrect_types.QRect, flags: cint, text: string): gen_qrect_types.QRect =
  gen_qrect_types.QRect(h: fcQPainter_boundingRect2(self.h, rect.h, flags, struct_miqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text)))))
...
proc boundingRect*(self: gen_qpainter_types.QPainter, x: cint, y: cint, w: cint, h: cint, flags: cint, text: string): gen_qrect_types.QRect =
  gen_qrect_types.QRect(h: fcQPainter_boundingRect3(self.h, x, y, w, h, flags, struct_miqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text)))))

proc boundingRect*(self: gen_qpainter_types.QPainter, rect: gen_qrect_types.QRectF, text: string): gen_qrect_types.QRectF =
  gen_qrect_types.QRectF(h: fcQPainter_boundingRect4(self.h, rect.h, struct_miqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text)))))
...
proc boundingRect*(self: gen_qpainter_types.QPainter, rect: gen_qrect_types.QRectF, text: string, o: gen_qtextoption_types.QTextOption): gen_qrect_types.QRectF =
  gen_qrect_types.QRectF(h: fcQPainter_boundingRect32(self.h, rect.h, struct_miqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), o.h))
