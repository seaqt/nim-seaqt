...
VirtualQPdfWriter* QPdfWriter_new(const QPdfWriter_VTable* vtbl, size_t vdata, struct miqt_string filename) {
	QString filename_QString = QString::fromUtf8(filename.data, filename.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQPdfWriter>());
