...
proc fcQQuaternion_operatorAssign(self: pointer, param1: pointer): void {.importc: "QQuaternion_operatorAssign".}
...
proc operatorAssign*(self: gen_qquaternion_types.QQuaternion, param1: gen_qquaternion_types.QQuaternion): void =
  fcQQuaternion_operatorAssign(self.h, param1.h)
...
proc create*(T: type gen_qquaternion_types.QQuaternion,
  ...
  let tmp = gen_qquaternion_types.QQuaternion(h: fcQQuaternion_new6(param1.h), owned: true)
  tmp
