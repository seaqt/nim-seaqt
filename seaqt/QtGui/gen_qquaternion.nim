...
proc fcQQuaternion_fromEulerAnglesEulerAngles(eulerAngles: pointer): pointer {.importc: "QQuaternion_fromEulerAngles_eulerAngles".}
...
proc fromEulerAngles*(_: type gen_qquaternion_types.QQuaternion, eulerAngles: gen_qvectornd_types.QVector3D): gen_qquaternion_types.QQuaternion =
  gen_qquaternion_types.QQuaternion(h: fcQQuaternion_fromEulerAnglesEulerAngles(eulerAngles.h), owned: true)
