...
proc fcQAction_associatedObjects(self: pointer): struct_seaqt_array {.importc: "QAction_associatedObjects".}
...
proc fcQAction_setText(self: pointer, text: struct_seaqt_string): void {.importc: "QAction_setText".}
proc fcQAction_text(self: pointer): struct_seaqt_string {.importc: "QAction_text".}
proc fcQAction_setIconText(self: pointer, text: struct_seaqt_string): void {.importc: "QAction_setIconText".}
proc fcQAction_iconText(self: pointer): struct_seaqt_string {.importc: "QAction_iconText".}
proc fcQAction_setToolTip(self: pointer, tip: struct_seaqt_string): void {.importc: "QAction_setToolTip".}
proc fcQAction_toolTip(self: pointer): struct_seaqt_string {.importc: "QAction_toolTip".}
proc fcQAction_setStatusTip(self: pointer, statusTip: struct_seaqt_string): void {.importc: "QAction_setStatusTip".}
proc fcQAction_statusTip(self: pointer): struct_seaqt_string {.importc: "QAction_statusTip".}
proc fcQAction_setWhatsThis(self: pointer, what: struct_seaqt_string): void {.importc: "QAction_setWhatsThis".}
proc fcQAction_whatsThis(self: pointer): struct_seaqt_string {.importc: "QAction_whatsThis".}
...
proc fcQAction_showStatusTextWithObject(self: pointer, objectVal: pointer): bool {.importc: "QAction_showStatusTextWithObject".}
...
proc setIconText*(self: gen_qaction_types.QAction, text: openArray[char]): void =
  fcQAction_setIconText(self.h, struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))))
...
proc setToolTip*(self: gen_qaction_types.QAction, tip: openArray[char]): void =
  fcQAction_setToolTip(self.h, struct_seaqt_string(data: if len(tip) > 0: addr tip[0] else: nil, len: csize_t(len(tip))))
...
proc setStatusTip*(self: gen_qaction_types.QAction, statusTip: openArray[char]): void =
  fcQAction_setStatusTip(self.h, struct_seaqt_string(data: if len(statusTip) > 0: addr statusTip[0] else: nil, len: csize_t(len(statusTip))))
...
proc setWhatsThis*(self: gen_qaction_types.QAction, what: openArray[char]): void =
  fcQAction_setWhatsThis(self.h, struct_seaqt_string(data: if len(what) > 0: addr what[0] else: nil, len: csize_t(len(what))))
...
proc showStatusText*(self: gen_qaction_types.QAction, objectVal: gen_qobject_types.QObject): bool =
  fcQAction_showStatusTextWithObject(self.h, objectVal.h)
...
proc create*(T: type gen_qaction_types.QAction,
  ...
  inst[].h = fcQAction_new(addr(cQAction_mvtbl), csize_t(sizeof(pointer)))
  fcQAction_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qaction_types.QAction,
    ...
    inst: VirtualQAction) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQAction_new2(addr(cQAction_mvtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))))
  fcQAction_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qaction_types.QAction,
    ...
    inst: VirtualQAction) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQAction_new3(addr(cQAction_mvtbl), csize_t(sizeof(pointer)), icon.h, struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))))
  fcQAction_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qaction_types.QAction,
    ...
    inst: VirtualQAction) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQAction_new4(addr(cQAction_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQAction_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qaction_types.QAction,
    ...
    inst: VirtualQAction) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQAction_new5(addr(cQAction_mvtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), parent.h)
  fcQAction_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qaction_types.QAction,
    ...
    inst: VirtualQAction) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQAction_new6(addr(cQAction_mvtbl), csize_t(sizeof(pointer)), icon.h, struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), parent.h)
  fcQAction_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
