...
proc fcQAction_showStatusTextObject(self: pointer, objectVal: pointer): bool {.importc: "QAction_showStatusText_object".}
...
proc showStatusText*(self: gen_qaction_types.QAction, objectVal: gen_qobject_types.QObject): bool =
  fcQAction_showStatusTextObject(self.h, objectVal.h)
