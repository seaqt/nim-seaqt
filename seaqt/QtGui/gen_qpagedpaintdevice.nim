...
template PdfVersion_X4*(_: type QPagedPaintDevicePdfVersionEnum): untyped = 3
...
proc fcQPagedPaintDevice_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QPagedPaintDevice_protectedbase_getDecodedMetricF".}
...
proc getDecodedMetricF*(self: gen_qpagedpaintdevice_types.QPagedPaintDevice, metricA: cint, metricB: cint): float64 =
  fcQPagedPaintDevice_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
