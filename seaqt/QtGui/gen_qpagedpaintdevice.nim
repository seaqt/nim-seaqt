...
proc fcQPagedPaintDevice_vdata(self: pointer): ptr pointer {.importc: "QPagedPaintDevice_vdata".}
proc fvdata_cQPagedPaintDevice(self: pointer): pointer {.importc: "vdata_QPagedPaintDevice".}
...
proc fcQPagedPaintDeviceMargins_right(self: pointer): float64 {.importc: "QPagedPaintDevice__Margins_right".}
proc fcQPagedPaintDeviceMargins_setRight(self: pointer, right: float64): void {.importc: "QPagedPaintDevice__Margins_setRight".}
proc fcQPagedPaintDeviceMargins_top(self: pointer): float64 {.importc: "QPagedPaintDevice__Margins_top".}
proc fcQPagedPaintDeviceMargins_setTop(self: pointer, top: float64): void {.importc: "QPagedPaintDevice__Margins_setTop".}
proc fcQPagedPaintDeviceMargins_bottom(self: pointer): float64 {.importc: "QPagedPaintDevice__Margins_bottom".}
proc fcQPagedPaintDeviceMargins_setBottom(self: pointer, bottom: float64): void {.importc: "QPagedPaintDevice__Margins_setBottom".}
...
proc create*(T: type gen_qpagedpaintdevice_types.QPagedPaintDevice,
  ...
  let tmp = gen_qpagedpaintdevice_types.QPagedPaintDevice(h: fcQPagedPaintDevice_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQPagedPaintDevice_vdata(tmp.h)[] = addr(vtbl[])
  tmp
...
proc create*(T: type gen_qpagedpaintdevice_types.QPagedPaintDevice,
  ...
  inst[].h = fcQPagedPaintDevice_new(addr(cQPagedPaintDevice_mvtbl), csize_t(sizeof(pointer)))
  fcQPagedPaintDevice_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true

proc left*(self: gen_qpagedpaintdevice_types.QPagedPaintDeviceMargins): float64 =
  fcQPagedPaintDeviceMargins_left(self.h)

proc setLeft*(self: gen_qpagedpaintdevice_types.QPagedPaintDeviceMargins, left: float64): void =
  fcQPagedPaintDeviceMargins_setLeft(self.h, left)

proc right*(self: gen_qpagedpaintdevice_types.QPagedPaintDeviceMargins): float64 =
  fcQPagedPaintDeviceMargins_right(self.h)

proc setRight*(self: gen_qpagedpaintdevice_types.QPagedPaintDeviceMargins, right: float64): void =
  fcQPagedPaintDeviceMargins_setRight(self.h, right)

proc top*(self: gen_qpagedpaintdevice_types.QPagedPaintDeviceMargins): float64 =
  fcQPagedPaintDeviceMargins_top(self.h)

proc setTop*(self: gen_qpagedpaintdevice_types.QPagedPaintDeviceMargins, top: float64): void =
  fcQPagedPaintDeviceMargins_setTop(self.h, top)

proc bottom*(self: gen_qpagedpaintdevice_types.QPagedPaintDeviceMargins): float64 =
  fcQPagedPaintDeviceMargins_bottom(self.h)

proc setBottom*(self: gen_qpagedpaintdevice_types.QPagedPaintDeviceMargins, bottom: float64): void =
  fcQPagedPaintDeviceMargins_setBottom(self.h, bottom)
