...
proc fcQFont_new3(families: struct_seaqt_array): ptr cQFont {.importc: "QFont_new3".}
...
proc fcQFont_new9(families: struct_seaqt_array, pointSize: cint): ptr cQFont {.importc: "QFont_new9".}
