...
template ContextFontMerging*(_: type QFontStyleStrategyEnum): untyped = 8192
template PreferTypoLineMetrics*(_: type QFontStyleStrategyEnum): untyped = 16384
...
template FeaturesResolved*(_: type QFontResolvePropertiesEnum): untyped = 262144
template VariableAxesResolved*(_: type QFontResolvePropertiesEnum): untyped = 524288
template AllPropertiesResolved*(_: type QFontResolvePropertiesEnum): untyped = 1048575
...
type cQFontTag*{.exportc: "QFont__Tag", incompleteStruct.} = object

proc fcQFont_swap(self: pointer, other: pointer): void {.importc: "QFont_swap".}
proc fcQFont_family(self: pointer): struct_seaqt_string {.importc: "QFont_family".}
proc fcQFont_setFamily(self: pointer, family: struct_seaqt_string): void {.importc: "QFont_setFamily".}
proc fcQFont_families(self: pointer): struct_seaqt_array {.importc: "QFont_families".}
proc fcQFont_setFamilies(self: pointer, families: struct_seaqt_array): void {.importc: "QFont_setFamilies".}
proc fcQFont_styleName(self: pointer): struct_seaqt_string {.importc: "QFont_styleName".}
proc fcQFont_setStyleName(self: pointer, styleName: struct_seaqt_string): void {.importc: "QFont_setStyleName".}
...
proc fcQFont_setStyleHint_QFont_StyleHint(self: pointer, param1: cint): void {.importc: "QFont_setStyleHint_QFont_StyleHint".}
...
proc fcQFont_setFeature(self: pointer, tag: pointer, value: cuint): void {.importc: "QFont_setFeature".}
proc fcQFont_unsetFeature(self: pointer, tag: pointer): void {.importc: "QFont_unsetFeature".}
proc fcQFont_featureValue(self: pointer, tag: pointer): cuint {.importc: "QFont_featureValue".}
proc fcQFont_isFeatureSet(self: pointer, tag: pointer): bool {.importc: "QFont_isFeatureSet".}
proc fcQFont_featureTags(self: pointer): struct_seaqt_array {.importc: "QFont_featureTags".}
proc fcQFont_clearFeatures(self: pointer): void {.importc: "QFont_clearFeatures".}
proc fcQFont_setVariableAxis(self: pointer, tag: pointer, value: float32): void {.importc: "QFont_setVariableAxis".}
proc fcQFont_unsetVariableAxis(self: pointer, tag: pointer): void {.importc: "QFont_unsetVariableAxis".}
proc fcQFont_isVariableAxisSet(self: pointer, tag: pointer): bool {.importc: "QFont_isVariableAxisSet".}
proc fcQFont_variableAxisValue(self: pointer, tag: pointer): float32 {.importc: "QFont_variableAxisValue".}
proc fcQFont_clearVariableAxes(self: pointer): void {.importc: "QFont_clearVariableAxes".}
proc fcQFont_variableAxisTags(self: pointer): struct_seaqt_array {.importc: "QFont_variableAxisTags".}
proc fcQFont_exactMatch(self: pointer): bool {.importc: "QFont_exactMatch".}
proc fcQFont_operatorAssign(self: pointer, fromVal: pointer): void {.importc: "QFont_operatorAssign".}
...
proc fcQFont_key(self: pointer): struct_seaqt_string {.importc: "QFont_key".}
proc fcQFont_toString(self: pointer): struct_seaqt_string {.importc: "QFont_toString".}
proc fcQFont_fromString(self: pointer, param1: struct_seaqt_string): bool {.importc: "QFont_fromString".}
proc fcQFont_substitute(param1: struct_seaqt_string): struct_seaqt_string {.importc: "QFont_substitute".}
proc fcQFont_substitutes(param1: struct_seaqt_string): struct_seaqt_array {.importc: "QFont_substitutes".}
proc fcQFont_substitutions(): struct_seaqt_array {.importc: "QFont_substitutions".}
proc fcQFont_insertSubstitution(param1: struct_seaqt_string, param2: struct_seaqt_string): void {.importc: "QFont_insertSubstitution".}
proc fcQFont_insertSubstitutions(param1: struct_seaqt_string, param2: struct_seaqt_array): void {.importc: "QFont_insertSubstitutions".}
proc fcQFont_removeSubstitutions(param1: struct_seaqt_string): void {.importc: "QFont_removeSubstitutions".}
...
proc fcQFont_defaultFamily(self: pointer): struct_seaqt_string {.importc: "QFont_defaultFamily".}
...
proc fcQFont_setStyleHint_QFont_StyleHint_QFont_StyleStrategy(self: pointer, param1: cint, param2: cint): void {.importc: "QFont_setStyleHint_QFont_StyleHint_QFont_StyleStrategy".}
proc fcQFont_new(): ptr cQFont {.importc: "QFont_new".}
proc fcQFont_new2(family: struct_seaqt_string): ptr cQFont {.importc: "QFont_new_family".}
proc fcQFont_new3(families: struct_seaqt_array): ptr cQFont {.importc: "QFont_new_families".}
proc fcQFont_new4(font: pointer, pd: pointer): ptr cQFont {.importc: "QFont_new_font_pd".}
proc fcQFont_new5(fromVal: pointer): ptr cQFont {.importc: "QFont_new_from".}
proc fcQFont_new6(family: struct_seaqt_string, pointSize: cint): ptr cQFont {.importc: "QFont_new_family_pointSize".}
proc fcQFont_new7(family: struct_seaqt_string, pointSize: cint, weight: cint): ptr cQFont {.importc: "QFont_new_family_pointSize_weight".}
proc fcQFont_new8(family: struct_seaqt_string, pointSize: cint, weight: cint, italic: bool): ptr cQFont {.importc: "QFont_new_family_pointSize_weight_italic".}
proc fcQFont_new9(families: struct_seaqt_array, pointSize: cint): ptr cQFont {.importc: "QFont_new_families_pointSize".}
proc fcQFont_new10(families: struct_seaqt_array, pointSize: cint, weight: cint): ptr cQFont {.importc: "QFont_new_families_pointSize_weight".}
proc fcQFont_new11(families: struct_seaqt_array, pointSize: cint, weight: cint, italic: bool): ptr cQFont {.importc: "QFont_new_families_pointSize_weight_italic".}
proc fcQFont_staticMetaObject(): pointer {.importc: "QFont_staticMetaObject".}
proc fcQFontTag_isValid(self: pointer): bool {.importc: "QFont__Tag_isValid".}
proc fcQFontTag_value(self: pointer): cuint {.importc: "QFont__Tag_value".}
proc fcQFontTag_toString(self: pointer): struct_seaqt_string {.importc: "QFont__Tag_toString".}
proc fcQFontTag_operatorAssign(self: pointer, fromVal: pointer): void {.importc: "QFont__Tag_operatorAssign".}
proc fcQFontTag_new(): ptr cQFontTag {.importc: "QFont__Tag_new".}
proc fcQFontTag_new2(fromVal: pointer): ptr cQFontTag {.importc: "QFont__Tag_new_from".}
...
proc setFamily*(self: gen_qfont_types.QFont, family: openArray[char]): void =
  fcQFont_setFamily(self.h, struct_seaqt_string(data: if len(family) > 0: addr family[0] else: nil, len: csize_t(len(family))))
...
proc setFamilies*(self: gen_qfont_types.QFont, families: openArray[string]): void =
  ...
  fcQFont_setFamilies(self.h, struct_seaqt_array(len: csize_t(len(families)), data: if len(families) == 0: nil else: addr(families_CArray[0])))
...
proc setStyleName*(self: gen_qfont_types.QFont, styleName: openArray[char]): void =
  fcQFont_setStyleName(self.h, struct_seaqt_string(data: if len(styleName) > 0: addr styleName[0] else: nil, len: csize_t(len(styleName))))
...
proc setStyleHint*(self: gen_qfont_types.QFont, param1: cint): void =
  fcQFont_setStyleHint_QFont_StyleHint(self.h, cint(param1))
...
proc setFeature*(self: gen_qfont_types.QFont, tag: gen_qfont_types.QFontTag, value: cuint): void =
  fcQFont_setFeature(self.h, tag.h, value)

proc unsetFeature*(self: gen_qfont_types.QFont, tag: gen_qfont_types.QFontTag): void =
  fcQFont_unsetFeature(self.h, tag.h)

proc featureValue*(self: gen_qfont_types.QFont, tag: gen_qfont_types.QFontTag): cuint =
  fcQFont_featureValue(self.h, tag.h)

proc isFeatureSet*(self: gen_qfont_types.QFont, tag: gen_qfont_types.QFontTag): bool =
  fcQFont_isFeatureSet(self.h, tag.h)

proc featureTags*(self: gen_qfont_types.QFont): seq[gen_qfont_types.QFontTag] =
  var v_ma = fcQFont_featureTags(self.h)
  var vx_ret = newSeq[gen_qfont_types.QFontTag](int(v_ma.len))
  let v_outCast = cast[ptr UncheckedArray[pointer]](v_ma.data)
  for i in 0 ..< v_ma.len:
    vx_ret[i] = gen_qfont_types.QFontTag(h: v_outCast[i], owned: true)
  c_free(v_ma.data)
  vx_ret

proc clearFeatures*(self: gen_qfont_types.QFont): void =
  fcQFont_clearFeatures(self.h)

proc setVariableAxis*(self: gen_qfont_types.QFont, tag: gen_qfont_types.QFontTag, value: float32): void =
  fcQFont_setVariableAxis(self.h, tag.h, value)

proc unsetVariableAxis*(self: gen_qfont_types.QFont, tag: gen_qfont_types.QFontTag): void =
  fcQFont_unsetVariableAxis(self.h, tag.h)

proc isVariableAxisSet*(self: gen_qfont_types.QFont, tag: gen_qfont_types.QFontTag): bool =
  fcQFont_isVariableAxisSet(self.h, tag.h)

proc variableAxisValue*(self: gen_qfont_types.QFont, tag: gen_qfont_types.QFontTag): float32 =
  fcQFont_variableAxisValue(self.h, tag.h)

proc clearVariableAxes*(self: gen_qfont_types.QFont): void =
  fcQFont_clearVariableAxes(self.h)

proc variableAxisTags*(self: gen_qfont_types.QFont): seq[gen_qfont_types.QFontTag] =
  var v_ma = fcQFont_variableAxisTags(self.h)
  var vx_ret = newSeq[gen_qfont_types.QFontTag](int(v_ma.len))
  let v_outCast = cast[ptr UncheckedArray[pointer]](v_ma.data)
  for i in 0 ..< v_ma.len:
    vx_ret[i] = gen_qfont_types.QFontTag(h: v_outCast[i], owned: true)
...
proc operatorAssign*(self: gen_qfont_types.QFont, fromVal: gen_qfont_types.QFont): void =
  fcQFont_operatorAssign(self.h, fromVal.h)
...
proc fromString*(self: gen_qfont_types.QFont, param1: openArray[char]): bool =
  fcQFont_fromString(self.h, struct_seaqt_string(data: if len(param1) > 0: addr param1[0] else: nil, len: csize_t(len(param1))))

proc substitute*(_: type gen_qfont_types.QFont, param1: openArray[char]): string =
  let v_ms = fcQFont_substitute(struct_seaqt_string(data: if len(param1) > 0: addr param1[0] else: nil, len: csize_t(len(param1))))
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret

proc substitutes*(_: type gen_qfont_types.QFont, param1: openArray[char]): seq[string] =
  var v_ma = fcQFont_substitutes(struct_seaqt_string(data: if len(param1) > 0: addr param1[0] else: nil, len: csize_t(len(param1))))
  var vx_ret = newSeq[string](int(v_ma.len))
  let v_outCast = cast[ptr UncheckedArray[struct_seaqt_string]](v_ma.data)
  for i in 0 ..< v_ma.len:
    let vx_lv_ms = v_outCast[i]
...
proc insertSubstitution*(_: type gen_qfont_types.QFont, param1: openArray[char], param2: openArray[char]): void =
  fcQFont_insertSubstitution(struct_seaqt_string(data: if len(param1) > 0: addr param1[0] else: nil, len: csize_t(len(param1))), struct_seaqt_string(data: if len(param2) > 0: addr param2[0] else: nil, len: csize_t(len(param2))))

proc insertSubstitutions*(_: type gen_qfont_types.QFont, param1: openArray[char], param2: openArray[string]): void =
  var param2_CArray = newSeq[struct_seaqt_string](len(param2))
  for i in 0..<len(param2):
    param2_CArray[i] = struct_seaqt_string(data: if len(param2[i]) > 0: addr param2[i][0] else: nil, len: csize_t(len(param2[i])))

  fcQFont_insertSubstitutions(struct_seaqt_string(data: if len(param1) > 0: addr param1[0] else: nil, len: csize_t(len(param1))), struct_seaqt_array(len: csize_t(len(param2)), data: if len(param2) == 0: nil else: addr(param2_CArray[0])))

proc removeSubstitutions*(_: type gen_qfont_types.QFont, param1: openArray[char]): void =
  fcQFont_removeSubstitutions(struct_seaqt_string(data: if len(param1) > 0: addr param1[0] else: nil, len: csize_t(len(param1))))
...
proc setStyleHint*(self: gen_qfont_types.QFont, param1: cint, param2: cint): void =
  fcQFont_setStyleHint_QFont_StyleHint_QFont_StyleStrategy(self.h, cint(param1), cint(param2))
...
proc create*(T: type gen_qfont_types.QFont,
  ...
  tmp
proc create*(T: type gen_qfont_types.QFont,
    fromVal: gen_qfont_types.QFont): gen_qfont_types.QFont =
  let tmp = gen_qfont_types.QFont(h: fcQFont_new5(fromVal.h), owned: true)
  tmp
proc create*(T: type gen_qfont_types.QFont,
...
proc isValid*(self: gen_qfont_types.QFontTag): bool =
  fcQFontTag_isValid(self.h)

proc value*(self: gen_qfont_types.QFontTag): cuint =
  fcQFontTag_value(self.h)

proc toString*(self: gen_qfont_types.QFontTag): seq[byte] =
  var v_bytearray = fcQFontTag_toString(self.h)
  var vx_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](v_bytearray.data), 0, int(v_bytearray.len)-1))
  c_free(v_bytearray.data)
  vx_ret

proc operatorAssign*(self: gen_qfont_types.QFontTag, fromVal: gen_qfont_types.QFontTag): void =
  fcQFontTag_operatorAssign(self.h, fromVal.h)

proc create*(T: type gen_qfont_types.QFontTag): gen_qfont_types.QFontTag =
  let tmp = gen_qfont_types.QFontTag(h: fcQFontTag_new(), owned: true)
  tmp
proc create*(T: type gen_qfont_types.QFontTag,
    fromVal: gen_qfont_types.QFontTag): gen_qfont_types.QFontTag =
  let tmp = gen_qfont_types.QFontTag(h: fcQFontTag_new2(fromVal.h), owned: true)
  tmp
