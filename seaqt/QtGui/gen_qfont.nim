...
proc create*(T: type gen_qfont_types.QFont,
  ...
  let tmp = gen_qfont_types.QFont(h: fcQFont_new2(struct_miqt_string(data: if len(family) > 0: addr family[0] else: nil, len: csize_t(len(family)))))
  tmp
proc create*(T: type gen_qfont_types.QFont,
  ...
  let tmp = gen_qfont_types.QFont(h: fcQFont_new3(struct_miqt_array(len: csize_t(len(families)), data: if len(families) == 0: nil else: addr(families_CArray[0]))))
  tmp
proc create*(T: type gen_qfont_types.QFont,
...
proc create*(T: type gen_qfont_types.QFont,
  ...
  let tmp = gen_qfont_types.QFont(h: fcQFont_new6(struct_miqt_string(data: if len(family) > 0: addr family[0] else: nil, len: csize_t(len(family))), pointSize))
  tmp
proc create*(T: type gen_qfont_types.QFont,
    family: string, pointSize: cint, weight: cint): gen_qfont_types.QFont =
  let tmp = gen_qfont_types.QFont(h: fcQFont_new7(struct_miqt_string(data: if len(family) > 0: addr family[0] else: nil, len: csize_t(len(family))), pointSize, weight))
  tmp
proc create*(T: type gen_qfont_types.QFont,
    family: string, pointSize: cint, weight: cint, italic: bool): gen_qfont_types.QFont =
  let tmp = gen_qfont_types.QFont(h: fcQFont_new8(struct_miqt_string(data: if len(family) > 0: addr family[0] else: nil, len: csize_t(len(family))), pointSize, weight, italic))
  tmp
proc create*(T: type gen_qfont_types.QFont,
  ...
  let tmp = gen_qfont_types.QFont(h: fcQFont_new9(struct_miqt_array(len: csize_t(len(families)), data: if len(families) == 0: nil else: addr(families_CArray[0])), pointSize))
  tmp
proc create*(T: type gen_qfont_types.QFont,
  ...
  let tmp = gen_qfont_types.QFont(h: fcQFont_new10(struct_miqt_array(len: csize_t(len(families)), data: if len(families) == 0: nil else: addr(families_CArray[0])), pointSize, weight))
  tmp
proc create*(T: type gen_qfont_types.QFont,
  ...
  let tmp = gen_qfont_types.QFont(h: fcQFont_new11(struct_miqt_array(len: csize_t(len(families)), data: if len(families) == 0: nil else: addr(families_CArray[0])), pointSize, weight, italic))
  tmp
