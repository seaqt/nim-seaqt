...
proc fcQPdfView_new(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQPdfView {.importc: "QPdfView_new_parent".}
proc fcQPdfView_new2(vtbl: pointer, vdata: csize_t): ptr cQPdfView {.importc: "QPdfView_new".}
...
proc create*(T: type gen_qpdfview_types.QPdfView,
  ...
  inst[].h = fcQPdfView_new(addr(cQPdfView_mvtbl), csize_t(sizeof(pointer)), parent.h)
...
proc create*(T: type gen_qpdfview_types.QPdfView,
    inst: VirtualQPdfView) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQPdfView_new2(addr(cQPdfView_mvtbl), csize_t(sizeof(pointer)))
  fcQPdfView_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
