...
template Custom*(_: type QPdfViewZoomModeEnum): untyped = 0
...
import
  ...
  ../QtPdf/gen_qpdfpagenavigator_types,
  ../QtPdf/gen_qpdfsearchmodel_types,
...
export
  ...
  gen_qpdfpagenavigator_types,
  gen_qpdfsearchmodel_types,
...
proc fcQPdfView_searchModel(self: pointer): pointer {.importc: "QPdfView_searchModel".}
proc fcQPdfView_setSearchModel(self: pointer, searchModel: pointer): void {.importc: "QPdfView_setSearchModel".}
proc fcQPdfView_currentSearchResultIndex(self: pointer): cint {.importc: "QPdfView_currentSearchResultIndex".}
proc fcQPdfView_pageNavigator(self: pointer): pointer {.importc: "QPdfView_pageNavigator".}
...
proc fcQPdfView_setCurrentSearchResultIndex(self: pointer, currentResult: cint): void {.importc: "QPdfView_setCurrentSearchResultIndex".}
...
proc fcQPdfView_searchModelChanged(self: pointer, searchModel: pointer): void {.importc: "QPdfView_searchModelChanged".}
proc fcQPdfView_connect_searchModelChanged(self: pointer, slot: int, callback: proc (slot: int, searchModel: pointer) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QPdfView_connect_searchModelChanged".}
proc fcQPdfView_currentSearchResultIndexChanged(self: pointer, currentResult: cint): void {.importc: "QPdfView_currentSearchResultIndexChanged".}
proc fcQPdfView_connect_currentSearchResultIndexChanged(self: pointer, slot: int, callback: proc (slot: int, currentResult: cint) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QPdfView_connect_currentSearchResultIndexChanged".}
...
proc fcQPdfView_virtualbase_mousePressEvent(self: pointer, event: pointer): void {.importc: "QPdfView_virtualbase_mousePressEvent".}
proc fcQPdfView_virtualbase_mouseMoveEvent(self: pointer, event: pointer): void {.importc: "QPdfView_virtualbase_mouseMoveEvent".}
proc fcQPdfView_virtualbase_mouseReleaseEvent(self: pointer, event: pointer): void {.importc: "QPdfView_virtualbase_mouseReleaseEvent".}
...
proc fcQPdfView_virtualbase_initStyleOption(self: pointer, option: pointer): void {.importc: "QPdfView_virtualbase_initStyleOption".}
...
proc fcQPdfView_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.importc: "QPdfView_virtualbase_nativeEvent".}
...
proc fcQPdfView_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QPdfView_protectedbase_getDecodedMetricF".}
...
proc searchModel*(self: gen_qpdfview_types.QPdfView): gen_qpdfsearchmodel_types.QPdfSearchModel =
  gen_qpdfsearchmodel_types.QPdfSearchModel(h: fcQPdfView_searchModel(self.h), owned: false)

proc setSearchModel*(self: gen_qpdfview_types.QPdfView, searchModel: gen_qpdfsearchmodel_types.QPdfSearchModel): void =
  fcQPdfView_setSearchModel(self.h, searchModel.h)

proc currentSearchResultIndex*(self: gen_qpdfview_types.QPdfView): cint =
  fcQPdfView_currentSearchResultIndex(self.h)

proc pageNavigator*(self: gen_qpdfview_types.QPdfView): gen_qpdfpagenavigator_types.QPdfPageNavigator =
  gen_qpdfpagenavigator_types.QPdfPageNavigator(h: fcQPdfView_pageNavigator(self.h), owned: false)
...
proc setCurrentSearchResultIndex*(self: gen_qpdfview_types.QPdfView, currentResult: cint): void =
  fcQPdfView_setCurrentSearchResultIndex(self.h, currentResult)
...
proc searchModelChanged*(self: gen_qpdfview_types.QPdfView, searchModel: gen_qpdfsearchmodel_types.QPdfSearchModel): void =
  fcQPdfView_searchModelChanged(self.h, searchModel.h)

type QPdfViewsearchModelChangedSlot* = proc(searchModel: gen_qpdfsearchmodel_types.QPdfSearchModel)
proc fcQPdfView_slot_callback_searchModelChanged(slot: int, searchModel: pointer) {.cdecl.} =
  let nimfunc = cast[ptr QPdfViewsearchModelChangedSlot](cast[pointer](slot))
  let slotval1 = gen_qpdfsearchmodel_types.QPdfSearchModel(h: searchModel, owned: false)

  nimfunc[](slotval1)

proc fcQPdfView_slot_callback_searchModelChanged_release(slot: int) {.cdecl.} =
  let nimfunc = cast[ref QPdfViewsearchModelChangedSlot](cast[pointer](slot))
  GC_unref(nimfunc)

proc onSearchModelChanged*(self: gen_qpdfview_types.QPdfView, slot: QPdfViewsearchModelChangedSlot) =
  var tmp = new QPdfViewsearchModelChangedSlot
  tmp[] = slot
  GC_ref(tmp)
  fcQPdfView_connect_searchModelChanged(self.h, cast[int](addr tmp[]), fcQPdfView_slot_callback_searchModelChanged, fcQPdfView_slot_callback_searchModelChanged_release)

proc currentSearchResultIndexChanged*(self: gen_qpdfview_types.QPdfView, currentResult: cint): void =
  fcQPdfView_currentSearchResultIndexChanged(self.h, currentResult)

type QPdfViewcurrentSearchResultIndexChangedSlot* = proc(currentResult: cint)
proc fcQPdfView_slot_callback_currentSearchResultIndexChanged(slot: int, currentResult: cint) {.cdecl.} =
  let nimfunc = cast[ptr QPdfViewcurrentSearchResultIndexChangedSlot](cast[pointer](slot))
  let slotval1 = currentResult

  nimfunc[](slotval1)

proc fcQPdfView_slot_callback_currentSearchResultIndexChanged_release(slot: int) {.cdecl.} =
  let nimfunc = cast[ref QPdfViewcurrentSearchResultIndexChangedSlot](cast[pointer](slot))
  GC_unref(nimfunc)

proc onCurrentSearchResultIndexChanged*(self: gen_qpdfview_types.QPdfView, slot: QPdfViewcurrentSearchResultIndexChangedSlot) =
  var tmp = new QPdfViewcurrentSearchResultIndexChangedSlot
  tmp[] = slot
  GC_ref(tmp)
  fcQPdfView_connect_currentSearchResultIndexChanged(self.h, cast[int](addr tmp[]), fcQPdfView_slot_callback_currentSearchResultIndexChanged, fcQPdfView_slot_callback_currentSearchResultIndexChanged_release)
...
type QPdfViewmousePressEventProc* = proc(self: QPdfView, event: gen_qevent_types.QMouseEvent): void {.raises: [], gcsafe.}
type QPdfViewmouseMoveEventProc* = proc(self: QPdfView, event: gen_qevent_types.QMouseEvent): void {.raises: [], gcsafe.}
type QPdfViewmouseReleaseEventProc* = proc(self: QPdfView, event: gen_qevent_types.QMouseEvent): void {.raises: [], gcsafe.}
...
type QPdfViewinitStyleOptionProc* = proc(self: QPdfView, option: gen_qstyleoption_types.QStyleOptionFrame): void {.raises: [], gcsafe.}
...
type QPdfViewenterEventProc* = proc(self: QPdfView, event: gen_qevent_types.QEnterEvent): void {.raises: [], gcsafe.}
...
type QPdfViewnativeEventProc* = proc(self: QPdfView, eventType: openArray[byte], message: pointer, resultVal: ptr uint): bool {.raises: [], gcsafe.}
...
type QPdfViewVTable* {.inheritable, pure.} = object
  ...
  initStyleOption*: QPdfViewinitStyleOptionProc
...
proc QPdfViewmousePressEvent*(self: gen_qpdfview_types.QPdfView, event: gen_qevent_types.QMouseEvent): void =
  fcQPdfView_virtualbase_mousePressEvent(self.h, event.h)

proc QPdfViewmouseMoveEvent*(self: gen_qpdfview_types.QPdfView, event: gen_qevent_types.QMouseEvent): void =
  fcQPdfView_virtualbase_mouseMoveEvent(self.h, event.h)

proc QPdfViewmouseReleaseEvent*(self: gen_qpdfview_types.QPdfView, event: gen_qevent_types.QMouseEvent): void =
  fcQPdfView_virtualbase_mouseReleaseEvent(self.h, event.h)
...
proc QPdfViewinitStyleOption*(self: gen_qpdfview_types.QPdfView, option: gen_qstyleoption_types.QStyleOptionFrame): void =
  fcQPdfView_virtualbase_initStyleOption(self.h, option.h)
...
proc QPdfViewenterEvent*(self: gen_qpdfview_types.QPdfView, event: gen_qevent_types.QEnterEvent): void =
...
proc QPdfViewnativeEvent*(self: gen_qpdfview_types.QPdfView, eventType: openArray[byte], message: pointer, resultVal: ptr uint): bool =
...
proc fcQPdfView_vtable_callback_mousePressEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QPdfViewVTable](fcQPdfView_vdata(self)[])
  let self = QPdfView(h: self)
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
  vtbl[].mousePressEvent(self, slotval1)

proc fcQPdfView_vtable_callback_mouseMoveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QPdfViewVTable](fcQPdfView_vdata(self)[])
  let self = QPdfView(h: self)
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
  vtbl[].mouseMoveEvent(self, slotval1)

proc fcQPdfView_vtable_callback_mouseReleaseEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QPdfViewVTable](fcQPdfView_vdata(self)[])
  let self = QPdfView(h: self)
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
...
proc fcQPdfView_vtable_callback_initStyleOption(self: pointer, option: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QPdfViewVTable](fcQPdfView_vdata(self)[])
  let self = QPdfView(h: self)
...
proc fcQPdfView_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QPdfViewVTable](fcQPdfView_vdata(self)[])
  let self = QPdfView(h: self)
...
method mousePressEvent*(self: VirtualQPdfView, event: gen_qevent_types.QMouseEvent): void {.base.} =
  QPdfViewmousePressEvent(self[], event)
method mouseMoveEvent*(self: VirtualQPdfView, event: gen_qevent_types.QMouseEvent): void {.base.} =
  QPdfViewmouseMoveEvent(self[], event)
method mouseReleaseEvent*(self: VirtualQPdfView, event: gen_qevent_types.QMouseEvent): void {.base.} =
  QPdfViewmouseReleaseEvent(self[], event)
...
method initStyleOption*(self: VirtualQPdfView, option: gen_qstyleoption_types.QStyleOptionFrame): void {.base.} =
  QPdfViewinitStyleOption(self[], option)
...
method enterEvent*(self: VirtualQPdfView, event: gen_qevent_types.QEnterEvent): void {.base.} =
...
method nativeEvent*(self: VirtualQPdfView, eventType: openArray[byte], message: pointer, resultVal: ptr uint): bool {.base.} =
...
proc fcQPdfView_method_callback_mousePressEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQPdfView](fcQPdfView_vdata(self)[])
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
  inst.mousePressEvent(slotval1)

proc fcQPdfView_method_callback_mouseMoveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQPdfView](fcQPdfView_vdata(self)[])
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
  inst.mouseMoveEvent(slotval1)

proc fcQPdfView_method_callback_mouseReleaseEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQPdfView](fcQPdfView_vdata(self)[])
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
...
proc fcQPdfView_method_callback_initStyleOption(self: pointer, option: pointer): void {.cdecl.} =
  let inst = cast[VirtualQPdfView](fcQPdfView_vdata(self)[])
  let slotval1 = gen_qstyleoption_types.QStyleOptionFrame(h: option, owned: false)
...
proc fcQPdfView_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let inst = cast[VirtualQPdfView](fcQPdfView_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc getDecodedMetricF*(self: gen_qpdfview_types.QPdfView, metricA: cint, metricB: cint): float64 =
  fcQPdfView_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
...
proc create*(T: type gen_qpdfview_types.QPdfView,
  ...
  if not isNil(vtbl[].initStyleOption):
    vtbl[].vtbl.initStyleOption = fcQPdfView_vtable_callback_initStyleOption
  ...
  let tmp = gen_qpdfview_types.QPdfView(h: fcQPdfView_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
...
proc create*(T: type gen_qpdfview_types.QPdfView,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQPdfView_vtable_callback_disconnectNotify
  let tmp = gen_qpdfview_types.QPdfView(h: fcQPdfView_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQPdfView_vdata(tmp.h)[] = addr(vtbl[])
  tmp
const cQPdfView_mvtbl = cQPdfViewVTable(
  ...
  initStyleOption: fcQPdfView_method_callback_initStyleOption,
