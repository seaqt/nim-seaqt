...
type cQNmeaPositionInfoSourceVTable {.pure.} = object
  ...
  parsePosInfoFromNmeaDataDataSizePosInfoHasFix*: proc(self: pointer, data: cstring, size: cint, posInfo: pointer, hasFix: ptr bool): bool {.cdecl, raises: [], gcsafe.}
...
proc fcQNmeaPositionInfoSource_virtualbase_parsePosInfoFromNmeaDataDataSizePosInfoHasFix(self: pointer, data: cstring, size: cint, posInfo: pointer, hasFix: ptr bool): bool {.importc: "QNmeaPositionInfoSource_virtualbase_parsePosInfoFromNmeaData_data_size_posInfo_hasFix".}
...
proc fcQNmeaPositionInfoSource_protectedbase_parsePosInfoFromNmeaData_data_posInfo_hasFix(self: pointer, data: struct_seaqt_string, posInfo: pointer, hasFix: ptr bool): bool {.importc: "QNmeaPositionInfoSource_protectedbase_parsePosInfoFromNmeaData_data_posInfo_hasFix".}
...
proc lastKnownPosition*(self: gen_qnmeapositioninfosource_types.QNmeaPositionInfoSource, fromSatellitePositioningMethodsOnly: bool): gen_qgeopositioninfo_types.QGeoPositionInfo =
  gen_qgeopositioninfo_types.QGeoPositionInfo(h: fcQNmeaPositionInfoSource_lastKnownPosition(self.h, fromSatellitePositioningMethodsOnly), owned: true)
...
type QNmeaPositionInfoSourceparsePosInfoFromNmeaDataDataSizePosInfoHasFixProc* = proc(self: QNmeaPositionInfoSource, data: cstring, size: cint, posInfo: gen_qgeopositioninfo_types.QGeoPositionInfo, hasFix: ptr bool): bool {.raises: [], gcsafe.}
...
type QNmeaPositionInfoSourceVTable* {.inheritable, pure.} = object
  ...
  parsePosInfoFromNmeaDataDataSizePosInfoHasFix*: QNmeaPositionInfoSourceparsePosInfoFromNmeaDataDataSizePosInfoHasFixProc
...
proc QNmeaPositionInfoSourcelastKnownPosition*(self: gen_qnmeapositioninfosource_types.QNmeaPositionInfoSource, fromSatellitePositioningMethodsOnly: bool): gen_qgeopositioninfo_types.QGeoPositionInfo =
  gen_qgeopositioninfo_types.QGeoPositionInfo(h: fcQNmeaPositionInfoSource_virtualbase_lastKnownPosition(self.h, fromSatellitePositioningMethodsOnly), owned: true)
...
proc QNmeaPositionInfoSourceparsePosInfoFromNmeaData*(self: gen_qnmeapositioninfosource_types.QNmeaPositionInfoSource, data: cstring, size: cint, posInfo: gen_qgeopositioninfo_types.QGeoPositionInfo, hasFix: ptr bool): bool =
  fcQNmeaPositionInfoSource_virtualbase_parsePosInfoFromNmeaDataDataSizePosInfoHasFix(self.h, data, size, posInfo.h, hasFix)
...
proc QNmeaPositionInfoSourcebackendProperty*(self: gen_qnmeapositioninfosource_types.QNmeaPositionInfoSource, name: openArray[char]): gen_qvariant_types.QVariant =
  gen_qvariant_types.QVariant(h: fcQNmeaPositionInfoSource_virtualbase_backendProperty(self.h, struct_seaqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name)))), owned: true)
...
proc fcQNmeaPositionInfoSource_vtable_callback_parsePosInfoFromNmeaDataDataSizePosInfoHasFix(self: pointer, data: cstring, size: cint, posInfo: pointer, hasFix: ptr bool): bool {.cdecl.} =
  let vtbl = cast[ptr QNmeaPositionInfoSourceVTable](fcQNmeaPositionInfoSource_vdata(self)[])
  let self = QNmeaPositionInfoSource(h: self)
  let slotval1 = (data)
  let slotval2 = size
  ...
  let slotval4 = hasFix
  var virtualReturn = vtbl[].parsePosInfoFromNmeaDataDataSizePosInfoHasFix(self, slotval1, slotval2, slotval3, slotval4)
  virtualReturn
...
proc fcQNmeaPositionInfoSource_method_callback_parsePosInfoFromNmeaDataDataSizePosInfoHasFix(self: pointer, data: cstring, size: cint, posInfo: pointer, hasFix: ptr bool): bool {.cdecl.} =
  let inst = cast[VirtualQNmeaPositionInfoSource](fcQNmeaPositionInfoSource_vdata(self)[])
  let slotval1 = (data)
  let slotval2 = size
  let slotval3 = gen_qgeopositioninfo_types.QGeoPositionInfo(h: posInfo, owned: false)
...
proc parsePosInfoFromNmeaData*(self: gen_qnmeapositioninfosource_types.QNmeaPositionInfoSource, data: openArray[byte], posInfo: gen_qgeopositioninfo_types.QGeoPositionInfo, hasFix: ptr bool): bool =
  fcQNmeaPositionInfoSource_protectedbase_parsePosInfoFromNmeaData_data_posInfo_hasFix(self.h, struct_seaqt_string(data: if len(data) > 0: addr data[0] else: nil, len: csize_t(len(data))), posInfo.h, hasFix)
...
proc create*(T: type gen_qnmeapositioninfosource_types.QNmeaPositionInfoSource,
  ...
  if not isNil(vtbl[].parsePosInfoFromNmeaDataDataSizePosInfoHasFix):
    vtbl[].vtbl.parsePosInfoFromNmeaDataDataSizePosInfoHasFix = fcQNmeaPositionInfoSource_vtable_callback_parsePosInfoFromNmeaDataDataSizePosInfoHasFix
...
const cQNmeaPositionInfoSource_mvtbl = cQNmeaPositionInfoSourceVTable(
  ...
  parsePosInfoFromNmeaDataDataSizePosInfoHasFix: fcQNmeaPositionInfoSource_method_callback_parsePosInfoFromNmeaDataDataSizePosInfoHasFix,
