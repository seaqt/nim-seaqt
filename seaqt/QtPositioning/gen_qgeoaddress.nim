...
proc fcQGeoAddress_operatorEqual(self: pointer, other: pointer): bool {.importc: "QGeoAddress_operatorEqual".}
proc fcQGeoAddress_operatorNotEqual(self: pointer, other: pointer): bool {.importc: "QGeoAddress_operatorNotEqual".}
...
proc operatorEqual*(self: gen_qgeoaddress_types.QGeoAddress, other: gen_qgeoaddress_types.QGeoAddress): bool =
  fcQGeoAddress_operatorEqual(self.h, other.h)

proc operatorNotEqual*(self: gen_qgeoaddress_types.QGeoAddress, other: gen_qgeoaddress_types.QGeoAddress): bool =
  fcQGeoAddress_operatorNotEqual(self.h, other.h)
