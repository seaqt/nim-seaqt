...
proc fcQGeoLocation_boundingBox(self: pointer): pointer {.importc: "QGeoLocation_boundingBox".}
proc fcQGeoLocation_setBoundingBox(self: pointer, box: pointer): void {.importc: "QGeoLocation_setBoundingBox".}
...
proc operatorNotEqual*(self: gen_qgeolocation_types.QGeoLocation, other: gen_qgeolocation_types.QGeoLocation): bool =
