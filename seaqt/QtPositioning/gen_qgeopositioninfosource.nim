...
template UpdateTimeoutError*(_: type QGeoPositionInfoSourceErrorEnum): untyped = 4
...
proc fcQGeoPositionInfoSource_errorOccurred(self: pointer, param1: cint): void {.importc: "QGeoPositionInfoSource_errorOccurred".}
proc fcQGeoPositionInfoSource_connect_errorOccurred(self: pointer, slot: int, callback: proc (slot: int, param1: cint) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QGeoPositionInfoSource_connect_errorOccurred".}
...
proc fcQGeoPositionInfoSource_virtualbase_setBackendProperty(self: pointer, name: struct_seaqt_string, value: pointer): bool {.importc: "QGeoPositionInfoSource_virtualbase_setBackendProperty".}
proc fcQGeoPositionInfoSource_virtualbase_backendProperty(self: pointer, name: struct_seaqt_string): pointer {.importc: "QGeoPositionInfoSource_virtualbase_backendProperty".}
...
proc errorOccurred*(self: gen_qgeopositioninfosource_types.QGeoPositionInfoSource, param1: cint): void =
  fcQGeoPositionInfoSource_errorOccurred(self.h, cint(param1))

type QGeoPositionInfoSourceerrorOccurredSlot* = proc(param1: cint)
proc fcQGeoPositionInfoSource_slot_callback_errorOccurred(slot: int, param1: cint) {.cdecl.} =
  let nimfunc = cast[ptr QGeoPositionInfoSourceerrorOccurredSlot](cast[pointer](slot))
  let slotval1 = cint(param1)

  nimfunc[](slotval1)

proc fcQGeoPositionInfoSource_slot_callback_errorOccurred_release(slot: int) {.cdecl.} =
  let nimfunc = cast[ref QGeoPositionInfoSourceerrorOccurredSlot](cast[pointer](slot))
  GC_unref(nimfunc)

proc onErrorOccurred*(self: gen_qgeopositioninfosource_types.QGeoPositionInfoSource, slot: QGeoPositionInfoSourceerrorOccurredSlot) =
  var tmp = new QGeoPositionInfoSourceerrorOccurredSlot
  tmp[] = slot
  GC_ref(tmp)
  fcQGeoPositionInfoSource_connect_errorOccurred(self.h, cast[int](addr tmp[]), fcQGeoPositionInfoSource_slot_callback_errorOccurred, fcQGeoPositionInfoSource_slot_callback_errorOccurred_release)
...
type QGeoPositionInfoSourcesetBackendPropertyProc* = proc(self: QGeoPositionInfoSource, name: openArray[char], value: gen_qvariant_types.QVariant): bool {.raises: [], gcsafe.}
type QGeoPositionInfoSourcebackendPropertyProc* = proc(self: QGeoPositionInfoSource, name: openArray[char]): gen_qvariant_types.QVariant {.raises: [], gcsafe.}
...
type QGeoPositionInfoSourceVTable* {.inheritable, pure.} = object
  ...
  setBackendProperty*: QGeoPositionInfoSourcesetBackendPropertyProc
  backendProperty*: QGeoPositionInfoSourcebackendPropertyProc
...
proc QGeoPositionInfoSourcesetBackendProperty*(self: gen_qgeopositioninfosource_types.QGeoPositionInfoSource, name: openArray[char], value: gen_qvariant_types.QVariant): bool =
...
proc fcQGeoPositionInfoSource_vtable_callback_setBackendProperty(self: pointer, name: struct_seaqt_string, value: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QGeoPositionInfoSourceVTable](fcQGeoPositionInfoSource_vdata(self)[])
  let self = QGeoPositionInfoSource(h: self)
  let vname_ms = name
...
proc fcQGeoPositionInfoSource_vtable_callback_backendProperty(self: pointer, name: struct_seaqt_string): pointer {.cdecl.} =
  let vtbl = cast[ptr QGeoPositionInfoSourceVTable](fcQGeoPositionInfoSource_vdata(self)[])
  let self = QGeoPositionInfoSource(h: self)
  let vname_ms = name
  let vnamex_ret = string.fromBytes(vname_ms)
...
method setBackendProperty*(self: VirtualQGeoPositionInfoSource, name: openArray[char], value: gen_qvariant_types.QVariant): bool {.base.} =
  QGeoPositionInfoSourcesetBackendProperty(self[], name, value)
method backendProperty*(self: VirtualQGeoPositionInfoSource, name: openArray[char]): gen_qvariant_types.QVariant {.base.} =
  QGeoPositionInfoSourcebackendProperty(self[], name)
...
proc fcQGeoPositionInfoSource_method_callback_setBackendProperty(self: pointer, name: struct_seaqt_string, value: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQGeoPositionInfoSource](fcQGeoPositionInfoSource_vdata(self)[])
  let vname_ms = name
  let vnamex_ret = string.fromBytes(vname_ms)
  c_free(vname_ms.data)
...
proc fcQGeoPositionInfoSource_method_callback_backendProperty(self: pointer, name: struct_seaqt_string): pointer {.cdecl.} =
  let inst = cast[VirtualQGeoPositionInfoSource](fcQGeoPositionInfoSource_vdata(self)[])
  let vname_ms = name
  let vnamex_ret = string.fromBytes(vname_ms)
  c_free(vname_ms.data)
...
proc create*(T: type gen_qgeopositioninfosource_types.QGeoPositionInfoSource,
  ...
  if not isNil(vtbl[].setBackendProperty):
    vtbl[].vtbl.setBackendProperty = fcQGeoPositionInfoSource_vtable_callback_setBackendProperty
  if not isNil(vtbl[].backendProperty):
    vtbl[].vtbl.backendProperty = fcQGeoPositionInfoSource_vtable_callback_backendProperty
...
const cQGeoPositionInfoSource_mvtbl = cQGeoPositionInfoSourceVTable(
  ...
  setBackendProperty: fcQGeoPositionInfoSource_method_callback_setBackendProperty,
  backendProperty: fcQGeoPositionInfoSource_method_callback_backendProperty,
