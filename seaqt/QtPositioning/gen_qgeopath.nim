...
proc fcQGeoPath_size(self: pointer): cint {.importc: "QGeoPath_size".}
proc fcQGeoPath_addCoordinate(self: pointer, coordinate: pointer): void {.importc: "QGeoPath_addCoordinate".}
proc fcQGeoPath_insertCoordinate(self: pointer, index: cint, coordinate: pointer): void {.importc: "QGeoPath_insertCoordinate".}
...
proc operatorNotEqual*(self: gen_qgeopath_types.QGeoPath, other: gen_qgeopath_types.QGeoPath): bool =
  fcQGeoPath_operatorNotEqual(self.h, other.h)
...
proc size*(self: gen_qgeopath_types.QGeoPath): cint =
...
proc insertCoordinate*(self: gen_qgeopath_types.QGeoPath, index: cint, coordinate: gen_qgeocoordinate_types.QGeoCoordinate): void =
  fcQGeoPath_insertCoordinate(self.h, index, coordinate.h)

proc replaceCoordinate*(self: gen_qgeopath_types.QGeoPath, index: cint, coordinate: gen_qgeocoordinate_types.QGeoCoordinate): void =
