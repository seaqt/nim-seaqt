...
proc fcQGeoPolygon_removeCoordinateWithIndex(self: pointer, index: int64): void {.importc: "QGeoPolygon_removeCoordinateWithIndex".}
proc fcQGeoPolygon_toString(self: pointer): struct_seaqt_string {.importc: "QGeoPolygon_toString".}
proc fcQGeoPolygon_lengthWithIndexFrom(self: pointer, indexFrom: int64): float64 {.importc: "QGeoPolygon_lengthWithIndexFrom".}
proc fcQGeoPolygon_length2(self: pointer, indexFrom: int64, indexTo: int64): float64 {.importc: "QGeoPolygon_length2".}
