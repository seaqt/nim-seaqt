...
type cQNmeaSatelliteInfoSourceVTable {.pure.} = object
  ...
  parseSatellitesInUseFromNmeaDataSizePnrsInUse*: proc(self: pointer, data: cstring, size: cint, pnrsInUse: struct_seaqt_array): cint {.cdecl, raises: [], gcsafe.}
  parseSatelliteInfoFromNmeaDataSizeInfosSystem*: proc(self: pointer, data: cstring, size: cint, infos: struct_seaqt_array, system: ptr cint): cint {.cdecl, raises: [], gcsafe.}
...
proc fcQNmeaSatelliteInfoSource_virtualbase_parseSatellitesInUseFromNmeaDataSizePnrsInUse(self: pointer, data: cstring, size: cint, pnrsInUse: struct_seaqt_array): cint {.importc: "QNmeaSatelliteInfoSource_virtualbase_parseSatellitesInUseFromNmea_data_size_pnrsInUse".}
proc fcQNmeaSatelliteInfoSource_virtualbase_parseSatelliteInfoFromNmeaDataSizeInfosSystem(self: pointer, data: cstring, size: cint, infos: struct_seaqt_array, system: ptr cint): cint {.importc: "QNmeaSatelliteInfoSource_virtualbase_parseSatelliteInfoFromNmea_data_size_infos_system".}
...
proc fcQNmeaSatelliteInfoSource_protectedbase_parseSatellitesInUseFromNmea_data_pnrsInUse(self: pointer, data: struct_seaqt_string, pnrsInUse: struct_seaqt_array): cint {.importc: "QNmeaSatelliteInfoSource_protectedbase_parseSatellitesInUseFromNmea_data_pnrsInUse".}
proc fcQNmeaSatelliteInfoSource_protectedbase_parseSatelliteInfoFromNmea_data_infos_system(self: pointer, data: struct_seaqt_string, infos: struct_seaqt_array, system: ptr cint): cint {.importc: "QNmeaSatelliteInfoSource_protectedbase_parseSatelliteInfoFromNmea_data_infos_system".}
...
type QNmeaSatelliteInfoSourceparseSatellitesInUseFromNmeaDataSizePnrsInUseProc* = proc(self: QNmeaSatelliteInfoSource, data: cstring, size: cint, pnrsInUse: openArray[cint]): cint {.raises: [], gcsafe.}
type QNmeaSatelliteInfoSourceparseSatelliteInfoFromNmeaDataSizeInfosSystemProc* = proc(self: QNmeaSatelliteInfoSource, data: cstring, size: cint, infos: openArray[gen_qgeosatelliteinfo_types.QGeoSatelliteInfo], system: ptr cint): cint {.raises: [], gcsafe.}
...
type QNmeaSatelliteInfoSourceVTable* {.inheritable, pure.} = object
  ...
  parseSatellitesInUseFromNmeaDataSizePnrsInUse*: QNmeaSatelliteInfoSourceparseSatellitesInUseFromNmeaDataSizePnrsInUseProc
  parseSatelliteInfoFromNmeaDataSizeInfosSystem*: QNmeaSatelliteInfoSourceparseSatelliteInfoFromNmeaDataSizeInfosSystemProc
...
proc QNmeaSatelliteInfoSourceparseSatellitesInUseFromNmea*(self: gen_qnmeasatelliteinfosource_types.QNmeaSatelliteInfoSource, data: cstring, size: cint, pnrsInUse: openArray[cint]): cint =
  ...
  cint(fcQNmeaSatelliteInfoSource_virtualbase_parseSatellitesInUseFromNmeaDataSizePnrsInUse(self.h, data, size, struct_seaqt_array(len: csize_t(len(pnrsInUse)), data: if len(pnrsInUse) == 0: nil else: addr(pnrsInUse_CArray[0]))))
...
proc QNmeaSatelliteInfoSourceparseSatelliteInfoFromNmea*(self: gen_qnmeasatelliteinfosource_types.QNmeaSatelliteInfoSource, data: cstring, size: cint, infos: openArray[gen_qgeosatelliteinfo_types.QGeoSatelliteInfo], system: ptr cint): cint =
  ...
  cint(fcQNmeaSatelliteInfoSource_virtualbase_parseSatelliteInfoFromNmeaDataSizeInfosSystem(self.h, data, size, struct_seaqt_array(len: csize_t(len(infos)), data: if len(infos) == 0: nil else: addr(infos_CArray[0])), system))
...
proc fcQNmeaSatelliteInfoSource_vtable_callback_parseSatellitesInUseFromNmeaDataSizePnrsInUse(self: pointer, data: cstring, size: cint, pnrsInUse: struct_seaqt_array): cint {.cdecl.} =
  let vtbl = cast[ptr QNmeaSatelliteInfoSourceVTable](fcQNmeaSatelliteInfoSource_vdata(self)[])
  let self = QNmeaSatelliteInfoSource(h: self)
  let slotval1 = (data)
  let slotval2 = size
  ...
  var virtualReturn = vtbl[].parseSatellitesInUseFromNmeaDataSizePnrsInUse(self, slotval1, slotval2, slotval3)
  cint(virtualReturn)

proc fcQNmeaSatelliteInfoSource_vtable_callback_parseSatelliteInfoFromNmeaDataSizeInfosSystem(self: pointer, data: cstring, size: cint, infos: struct_seaqt_array, system: ptr cint): cint {.cdecl.} =
  let vtbl = cast[ptr QNmeaSatelliteInfoSourceVTable](fcQNmeaSatelliteInfoSource_vdata(self)[])
  let self = QNmeaSatelliteInfoSource(h: self)
  let slotval1 = (data)
  let slotval2 = size
  ...
  let slotval4 = system
  var virtualReturn = vtbl[].parseSatelliteInfoFromNmeaDataSizeInfosSystem(self, slotval1, slotval2, slotval3, slotval4)
  cint(virtualReturn)
...
proc fcQNmeaSatelliteInfoSource_method_callback_parseSatellitesInUseFromNmeaDataSizePnrsInUse(self: pointer, data: cstring, size: cint, pnrsInUse: struct_seaqt_array): cint {.cdecl.} =
  let inst = cast[VirtualQNmeaSatelliteInfoSource](fcQNmeaSatelliteInfoSource_vdata(self)[])
  let slotval1 = (data)
  let slotval2 = size
  var vpnrsInUse_ma = pnrsInUse
...
proc fcQNmeaSatelliteInfoSource_method_callback_parseSatelliteInfoFromNmeaDataSizeInfosSystem(self: pointer, data: cstring, size: cint, infos: struct_seaqt_array, system: ptr cint): cint {.cdecl.} =
  let inst = cast[VirtualQNmeaSatelliteInfoSource](fcQNmeaSatelliteInfoSource_vdata(self)[])
  let slotval1 = (data)
  let slotval2 = size
  var vinfos_ma = infos
...
proc parseSatellitesInUseFromNmea*(self: gen_qnmeasatelliteinfosource_types.QNmeaSatelliteInfoSource, data: openArray[byte], pnrsInUse: openArray[cint]): cint =
  var pnrsInUse_CArray = newSeq[cint](len(pnrsInUse))
  for i in 0..<len(pnrsInUse):
    pnrsInUse_CArray[i] = pnrsInUse[i]

  cint(fcQNmeaSatelliteInfoSource_protectedbase_parseSatellitesInUseFromNmea_data_pnrsInUse(self.h, struct_seaqt_string(data: if len(data) > 0: addr data[0] else: nil, len: csize_t(len(data))), struct_seaqt_array(len: csize_t(len(pnrsInUse)), data: if len(pnrsInUse) == 0: nil else: addr(pnrsInUse_CArray[0]))))

proc parseSatelliteInfoFromNmea*(self: gen_qnmeasatelliteinfosource_types.QNmeaSatelliteInfoSource, data: openArray[byte], infos: openArray[gen_qgeosatelliteinfo_types.QGeoSatelliteInfo], system: ptr cint): cint =
  var infos_CArray = newSeq[pointer](len(infos))
  for i in 0..<len(infos):
    infos_CArray[i] = infos[i].h

  cint(fcQNmeaSatelliteInfoSource_protectedbase_parseSatelliteInfoFromNmea_data_infos_system(self.h, struct_seaqt_string(data: if len(data) > 0: addr data[0] else: nil, len: csize_t(len(data))), struct_seaqt_array(len: csize_t(len(infos)), data: if len(infos) == 0: nil else: addr(infos_CArray[0])), system))
...
proc create*(T: type gen_qnmeasatelliteinfosource_types.QNmeaSatelliteInfoSource,
  ...
  if not isNil(vtbl[].parseSatellitesInUseFromNmeaDataSizePnrsInUse):
    vtbl[].vtbl.parseSatellitesInUseFromNmeaDataSizePnrsInUse = fcQNmeaSatelliteInfoSource_vtable_callback_parseSatellitesInUseFromNmeaDataSizePnrsInUse
  if not isNil(vtbl[].parseSatelliteInfoFromNmeaDataSizeInfosSystem):
    vtbl[].vtbl.parseSatelliteInfoFromNmeaDataSizeInfosSystem = fcQNmeaSatelliteInfoSource_vtable_callback_parseSatelliteInfoFromNmeaDataSizeInfosSystem
...
const cQNmeaSatelliteInfoSource_mvtbl = cQNmeaSatelliteInfoSourceVTable(
  ...
  parseSatellitesInUseFromNmeaDataSizePnrsInUse: fcQNmeaSatelliteInfoSource_method_callback_parseSatellitesInUseFromNmeaDataSizePnrsInUse,
  parseSatelliteInfoFromNmeaDataSizeInfosSystem: fcQNmeaSatelliteInfoSource_method_callback_parseSatelliteInfoFromNmeaDataSizeInfosSystem,
