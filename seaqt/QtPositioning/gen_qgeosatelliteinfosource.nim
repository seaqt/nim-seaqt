...
template UpdateTimeoutError*(_: type QGeoSatelliteInfoSourceErrorEnum): untyped = 3
...
proc fcQGeoSatelliteInfoSource_setBackendProperty(self: pointer, name: struct_seaqt_string, value: pointer): bool {.importc: "QGeoSatelliteInfoSource_setBackendProperty".}
proc fcQGeoSatelliteInfoSource_backendProperty(self: pointer, name: struct_seaqt_string): pointer {.importc: "QGeoSatelliteInfoSource_backendProperty".}
...
proc fcQGeoSatelliteInfoSource_errorOccurred(self: pointer, param1: cint): void {.importc: "QGeoSatelliteInfoSource_errorOccurred".}
proc fcQGeoSatelliteInfoSource_connect_errorOccurred(self: pointer, slot: int, callback: proc (slot: int, param1: cint) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QGeoSatelliteInfoSource_connect_errorOccurred".}
...
proc fcQGeoSatelliteInfoSource_virtualbase_setBackendProperty(self: pointer, name: struct_seaqt_string, value: pointer): bool {.importc: "QGeoSatelliteInfoSource_virtualbase_setBackendProperty".}
proc fcQGeoSatelliteInfoSource_virtualbase_backendProperty(self: pointer, name: struct_seaqt_string): pointer {.importc: "QGeoSatelliteInfoSource_virtualbase_backendProperty".}
...
proc metaObject*(self: gen_qgeosatelliteinfosource_types.QGeoSatelliteInfoSource): gen_qobjectdefs_types.QMetaObject =
  gen_qobjectdefs_types.QMetaObject(h: fcQGeoSatelliteInfoSource_metaObject(self.h), owned: false)
...
proc setBackendProperty*(self: gen_qgeosatelliteinfosource_types.QGeoSatelliteInfoSource, name: openArray[char], value: gen_qvariant_types.QVariant): bool =
  fcQGeoSatelliteInfoSource_setBackendProperty(self.h, struct_seaqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name))), value.h)

proc backendProperty*(self: gen_qgeosatelliteinfosource_types.QGeoSatelliteInfoSource, name: openArray[char]): gen_qvariant_types.QVariant =
  gen_qvariant_types.QVariant(h: fcQGeoSatelliteInfoSource_backendProperty(self.h, struct_seaqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name)))), owned: true)
...
proc fcQGeoSatelliteInfoSource_slot_callback_satellitesInViewUpdated(slot: int, satellites: struct_seaqt_array) {.cdecl.} =
  ...
  for i in 0 ..< vsatellites_ma.len:
    vsatellitesx_ret[i] = gen_qgeosatelliteinfo_types.QGeoSatelliteInfo(h: vsatellites_outCast[i], owned: true)
...
proc errorOccurred*(self: gen_qgeosatelliteinfosource_types.QGeoSatelliteInfoSource, param1: cint): void =
  fcQGeoSatelliteInfoSource_errorOccurred(self.h, cint(param1))

type QGeoSatelliteInfoSourceerrorOccurredSlot* = proc(param1: cint)
proc fcQGeoSatelliteInfoSource_slot_callback_errorOccurred(slot: int, param1: cint) {.cdecl.} =
  let nimfunc = cast[ptr QGeoSatelliteInfoSourceerrorOccurredSlot](cast[pointer](slot))
  let slotval1 = cint(param1)

  nimfunc[](slotval1)

proc fcQGeoSatelliteInfoSource_slot_callback_errorOccurred_release(slot: int) {.cdecl.} =
  let nimfunc = cast[ref QGeoSatelliteInfoSourceerrorOccurredSlot](cast[pointer](slot))
  GC_unref(nimfunc)

proc onErrorOccurred*(self: gen_qgeosatelliteinfosource_types.QGeoSatelliteInfoSource, slot: QGeoSatelliteInfoSourceerrorOccurredSlot) =
  var tmp = new QGeoSatelliteInfoSourceerrorOccurredSlot
  tmp[] = slot
  GC_ref(tmp)
  fcQGeoSatelliteInfoSource_connect_errorOccurred(self.h, cast[int](addr tmp[]), fcQGeoSatelliteInfoSource_slot_callback_errorOccurred, fcQGeoSatelliteInfoSource_slot_callback_errorOccurred_release)
...
type QGeoSatelliteInfoSourcesetBackendPropertyProc* = proc(self: QGeoSatelliteInfoSource, name: openArray[char], value: gen_qvariant_types.QVariant): bool {.raises: [], gcsafe.}
type QGeoSatelliteInfoSourcebackendPropertyProc* = proc(self: QGeoSatelliteInfoSource, name: openArray[char]): gen_qvariant_types.QVariant {.raises: [], gcsafe.}
...
type QGeoSatelliteInfoSourceVTable* {.inheritable, pure.} = object
  ...
  setBackendProperty*: QGeoSatelliteInfoSourcesetBackendPropertyProc
  backendProperty*: QGeoSatelliteInfoSourcebackendPropertyProc
...
proc QGeoSatelliteInfoSourcemetaObject*(self: gen_qgeosatelliteinfosource_types.QGeoSatelliteInfoSource): gen_qobjectdefs_types.QMetaObject =
  gen_qobjectdefs_types.QMetaObject(h: fcQGeoSatelliteInfoSource_virtualbase_metaObject(self.h), owned: false)
...
proc QGeoSatelliteInfoSourcesetBackendProperty*(self: gen_qgeosatelliteinfosource_types.QGeoSatelliteInfoSource, name: openArray[char], value: gen_qvariant_types.QVariant): bool =
  fcQGeoSatelliteInfoSource_virtualbase_setBackendProperty(self.h, struct_seaqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name))), value.h)

proc QGeoSatelliteInfoSourcebackendProperty*(self: gen_qgeosatelliteinfosource_types.QGeoSatelliteInfoSource, name: openArray[char]): gen_qvariant_types.QVariant =
  gen_qvariant_types.QVariant(h: fcQGeoSatelliteInfoSource_virtualbase_backendProperty(self.h, struct_seaqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name)))), owned: true)
...
proc fcQGeoSatelliteInfoSource_vtable_callback_setBackendProperty(self: pointer, name: struct_seaqt_string, value: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QGeoSatelliteInfoSourceVTable](fcQGeoSatelliteInfoSource_vdata(self)[])
  let self = QGeoSatelliteInfoSource(h: self)
  let vname_ms = name
...
proc fcQGeoSatelliteInfoSource_vtable_callback_backendProperty(self: pointer, name: struct_seaqt_string): pointer {.cdecl.} =
  let vtbl = cast[ptr QGeoSatelliteInfoSourceVTable](fcQGeoSatelliteInfoSource_vdata(self)[])
  let self = QGeoSatelliteInfoSource(h: self)
  let vname_ms = name
  let vnamex_ret = string.fromBytes(vname_ms)
...
method setBackendProperty*(self: VirtualQGeoSatelliteInfoSource, name: openArray[char], value: gen_qvariant_types.QVariant): bool {.base.} =
  QGeoSatelliteInfoSourcesetBackendProperty(self[], name, value)
method backendProperty*(self: VirtualQGeoSatelliteInfoSource, name: openArray[char]): gen_qvariant_types.QVariant {.base.} =
  QGeoSatelliteInfoSourcebackendProperty(self[], name)
...
proc fcQGeoSatelliteInfoSource_method_callback_setBackendProperty(self: pointer, name: struct_seaqt_string, value: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQGeoSatelliteInfoSource](fcQGeoSatelliteInfoSource_vdata(self)[])
  let vname_ms = name
  let vnamex_ret = string.fromBytes(vname_ms)
  c_free(vname_ms.data)
...
proc fcQGeoSatelliteInfoSource_method_callback_backendProperty(self: pointer, name: struct_seaqt_string): pointer {.cdecl.} =
  let inst = cast[VirtualQGeoSatelliteInfoSource](fcQGeoSatelliteInfoSource_vdata(self)[])
  let vname_ms = name
  let vnamex_ret = string.fromBytes(vname_ms)
  c_free(vname_ms.data)
...
proc sender*(self: gen_qgeosatelliteinfosource_types.QGeoSatelliteInfoSource): gen_qobject_types.QObject =
  gen_qobject_types.QObject(h: fcQGeoSatelliteInfoSource_protectedbase_sender(self.h), owned: false)
...
proc create*(T: type gen_qgeosatelliteinfosource_types.QGeoSatelliteInfoSource,
  ...
  if not isNil(vtbl[].setBackendProperty):
    vtbl[].vtbl.setBackendProperty = fcQGeoSatelliteInfoSource_vtable_callback_setBackendProperty
  if not isNil(vtbl[].backendProperty):
    vtbl[].vtbl.backendProperty = fcQGeoSatelliteInfoSource_vtable_callback_backendProperty
  ...
  let tmp = gen_qgeosatelliteinfosource_types.QGeoSatelliteInfoSource(h: fcQGeoSatelliteInfoSource_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
...
const cQGeoSatelliteInfoSource_mvtbl = cQGeoSatelliteInfoSourceVTable(
  ...
  setBackendProperty: fcQGeoSatelliteInfoSource_method_callback_setBackendProperty,
  backendProperty: fcQGeoSatelliteInfoSource_method_callback_backendProperty,
