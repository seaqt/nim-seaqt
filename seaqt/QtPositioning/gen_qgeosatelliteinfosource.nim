...
proc backendProperty*(self: gen_qgeosatelliteinfosource_types.QGeoSatelliteInfoSource, name: openArray[char]): gen_qvariant_types.QVariant =
  gen_qvariant_types.QVariant(h: fcQGeoSatelliteInfoSource_backendProperty(self.h, struct_seaqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name)))))
...
proc QGeoSatelliteInfoSourcebackendProperty*(self: gen_qgeosatelliteinfosource_types.QGeoSatelliteInfoSource, name: openArray[char]): gen_qvariant_types.QVariant =
  gen_qvariant_types.QVariant(h: fcQGeoSatelliteInfoSource_virtualbase_backendProperty(self.h, struct_seaqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name)))))
