...
proc fcQPrinterInfo_makeAndModel(self: pointer): struct_seaqt_string {.importc: "QPrinterInfo_makeAndModel".}
...
proc fcQPrinterInfo_supportedPageSizes(self: pointer): struct_seaqt_array {.importc: "QPrinterInfo_supportedPageSizes".}
...
proc fcQPrinterInfo_supportedPaperSizes(self: pointer): struct_seaqt_array {.importc: "QPrinterInfo_supportedPaperSizes".}
proc fcQPrinterInfo_supportedSizesWithNames(self: pointer): struct_seaqt_array {.importc: "QPrinterInfo_supportedSizesWithNames".}
proc fcQPrinterInfo_supportedResolutions(self: pointer): struct_seaqt_array {.importc: "QPrinterInfo_supportedResolutions".}
proc fcQPrinterInfo_defaultDuplexMode(self: pointer): cint {.importc: "QPrinterInfo_defaultDuplexMode".}
proc fcQPrinterInfo_supportedDuplexModes(self: pointer): struct_seaqt_array {.importc: "QPrinterInfo_supportedDuplexModes".}
proc fcQPrinterInfo_defaultColorMode(self: pointer): cint {.importc: "QPrinterInfo_defaultColorMode".}
proc fcQPrinterInfo_supportedColorModes(self: pointer): struct_seaqt_array {.importc: "QPrinterInfo_supportedColorModes".}
proc fcQPrinterInfo_availablePrinterNames(): struct_seaqt_array {.importc: "QPrinterInfo_availablePrinterNames".}
proc fcQPrinterInfo_availablePrinters(): struct_seaqt_array {.importc: "QPrinterInfo_availablePrinters".}
proc fcQPrinterInfo_defaultPrinterName(): struct_seaqt_string {.importc: "QPrinterInfo_defaultPrinterName".}
...
proc printerInfo*(_: type gen_qprinterinfo_types.QPrinterInfo, printerName: openArray[char]): gen_qprinterinfo_types.QPrinterInfo =
  gen_qprinterinfo_types.QPrinterInfo(h: fcQPrinterInfo_printerInfo(struct_seaqt_string(data: if len(printerName) > 0: addr printerName[0] else: nil, len: csize_t(len(printerName)))))

proc create*(T: type gen_qprinterinfo_types.QPrinterInfo): gen_qprinterinfo_types.QPrinterInfo =
  let tmp = gen_qprinterinfo_types.QPrinterInfo(h: fcQPrinterInfo_new())
  tmp
proc create*(T: type gen_qprinterinfo_types.QPrinterInfo,
  ...
  let tmp = gen_qprinterinfo_types.QPrinterInfo(h: fcQPrinterInfo_new2(other.h))
  tmp
proc create*(T: type gen_qprinterinfo_types.QPrinterInfo,
    printer: gen_qprinter_types.QPrinter): gen_qprinterinfo_types.QPrinterInfo =
  let tmp = gen_qprinterinfo_types.QPrinterInfo(h: fcQPrinterInfo_new3(printer.h))
  tmp
