...
proc create*(T: type gen_qprintpreviewdialog_types.QPrintPreviewDialog,
  ...
  let tmp = gen_qprintpreviewdialog_types.QPrintPreviewDialog(h: fcQPrintPreviewDialog_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))))
...
proc create*(T: type gen_qprintpreviewdialog_types.QPrintPreviewDialog,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQPrintPreviewDialog_vtable_callback_disconnectNotify
  let tmp = gen_qprintpreviewdialog_types.QPrintPreviewDialog(h: fcQPrintPreviewDialog_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), printer.h))
  fcQPrintPreviewDialog_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qprintpreviewdialog_types.QPrintPreviewDialog,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQPrintPreviewDialog_vtable_callback_disconnectNotify
  let tmp = gen_qprintpreviewdialog_types.QPrintPreviewDialog(h: fcQPrintPreviewDialog_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h))
  fcQPrintPreviewDialog_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qprintpreviewdialog_types.QPrintPreviewDialog,
