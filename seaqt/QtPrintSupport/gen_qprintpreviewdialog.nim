...
proc fcQPrintPreviewDialog_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.importc: "QPrintPreviewDialog_virtualbase_nativeEvent".}
...
proc fcQPrintPreviewDialog_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QPrintPreviewDialog_protectedbase_getDecodedMetricF".}
...
proc fcQPrintPreviewDialog_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QPrintPreviewDialogVTable](fcQPrintPreviewDialog_vdata(self)[])
  let self = QPrintPreviewDialog(h: self)
...
proc fcQPrintPreviewDialog_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let inst = cast[VirtualQPrintPreviewDialog](fcQPrintPreviewDialog_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc getDecodedMetricF*(self: gen_qprintpreviewdialog_types.QPrintPreviewDialog, metricA: cint, metricB: cint): float64 =
  fcQPrintPreviewDialog_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
