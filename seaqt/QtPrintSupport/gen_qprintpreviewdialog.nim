...
proc fcQPrintPreviewDialog_trUtf8S(s: cstring): struct_seaqt_string {.importc: "QPrintPreviewDialog_trUtf8_s".}
...
proc fcQPrintPreviewDialog_trUtf8SC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QPrintPreviewDialog_trUtf8_s_c".}
proc fcQPrintPreviewDialog_trUtf8SCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QPrintPreviewDialog_trUtf8_s_c_n".}
...
proc fcQPrintPreviewDialog_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.importc: "QPrintPreviewDialog_virtualbase_nativeEvent".}
...
proc trUtf8*(_: type gen_qprintpreviewdialog_types.QPrintPreviewDialog, s: cstring): string =
  let v_ms = fcQPrintPreviewDialog_trUtf8S(s)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc fcQPrintPreviewDialog_slot_callback_paintRequested_release(slot: int) {.cdecl.} =
...
proc QPrintPreviewDialognativeEvent*(self: gen_qprintpreviewdialog_types.QPrintPreviewDialog, eventType: openArray[byte], message: pointer, resultVal: ptr clong): bool =
  fcQPrintPreviewDialog_virtualbase_nativeEvent(self.h, struct_seaqt_string(data: if len(eventType) > 0: addr eventType[0] else: nil, len: csize_t(len(eventType))), message, resultVal)
...
proc fcQPrintPreviewDialog_vtable_callback_metacast(self: pointer, param1: cstring): pointer {.cdecl.} =
  let vtbl = cast[ptr QPrintPreviewDialogVTable](fcQPrintPreviewDialog_vdata(self)[])
  let self = QPrintPreviewDialog(h: self)
  let slotval1 = (param1)
...
proc fcQPrintPreviewDialog_vtable_callback_metacall(self: pointer, param1: cint, param2: cint, param3: pointer): cint {.cdecl.} =
  let vtbl = cast[ptr QPrintPreviewDialogVTable](fcQPrintPreviewDialog_vdata(self)[])
  let self = QPrintPreviewDialog(h: self)
...
proc fcQPrintPreviewDialog_vtable_callback_setVisible(self: pointer, visible: bool): void {.cdecl.} =
  let vtbl = cast[ptr QPrintPreviewDialogVTable](fcQPrintPreviewDialog_vdata(self)[])
  let self = QPrintPreviewDialog(h: self)
  let slotval1 = visible
  vtbl[].setVisible(self, slotval1)

proc fcQPrintPreviewDialog_vtable_callback_done(self: pointer, resultVal: cint): void {.cdecl.} =
  let vtbl = cast[ptr QPrintPreviewDialogVTable](fcQPrintPreviewDialog_vdata(self)[])
  let self = QPrintPreviewDialog(h: self)
...
proc fcQPrintPreviewDialog_vtable_callback_open(self: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QPrintPreviewDialogVTable](fcQPrintPreviewDialog_vdata(self)[])
  let self = QPrintPreviewDialog(h: self)
  vtbl[].open(self)

proc fcQPrintPreviewDialog_vtable_callback_exec(self: pointer): cint {.cdecl.} =
  let vtbl = cast[ptr QPrintPreviewDialogVTable](fcQPrintPreviewDialog_vdata(self)[])
  let self = QPrintPreviewDialog(h: self)
  var virtualReturn = vtbl[].exec(self)
  virtualReturn

proc fcQPrintPreviewDialog_vtable_callback_accept(self: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QPrintPreviewDialogVTable](fcQPrintPreviewDialog_vdata(self)[])
  let self = QPrintPreviewDialog(h: self)
  vtbl[].accept(self)

proc fcQPrintPreviewDialog_vtable_callback_reject(self: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QPrintPreviewDialogVTable](fcQPrintPreviewDialog_vdata(self)[])
  let self = QPrintPreviewDialog(h: self)
  vtbl[].reject(self)
...
proc fcQPrintPreviewDialog_vtable_callback_devType(self: pointer): cint {.cdecl.} =
  let vtbl = cast[ptr QPrintPreviewDialogVTable](fcQPrintPreviewDialog_vdata(self)[])
  let self = QPrintPreviewDialog(h: self)
  var virtualReturn = vtbl[].devType(self)
  virtualReturn

proc fcQPrintPreviewDialog_vtable_callback_heightForWidth(self: pointer, param1: cint): cint {.cdecl.} =
  let vtbl = cast[ptr QPrintPreviewDialogVTable](fcQPrintPreviewDialog_vdata(self)[])
  let self = QPrintPreviewDialog(h: self)
  let slotval1 = param1
...
proc fcQPrintPreviewDialog_vtable_callback_hasHeightForWidth(self: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QPrintPreviewDialogVTable](fcQPrintPreviewDialog_vdata(self)[])
  let self = QPrintPreviewDialog(h: self)
...
proc fcQPrintPreviewDialog_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let vtbl = cast[ptr QPrintPreviewDialogVTable](fcQPrintPreviewDialog_vdata(self)[])
  let self = QPrintPreviewDialog(h: self)
...
proc fcQPrintPreviewDialog_vtable_callback_metric(self: pointer, param1: cint): cint {.cdecl.} =
  let vtbl = cast[ptr QPrintPreviewDialogVTable](fcQPrintPreviewDialog_vdata(self)[])
  let self = QPrintPreviewDialog(h: self)
  let slotval1 = cint(param1)
...
proc fcQPrintPreviewDialog_vtable_callback_focusNextPrevChild(self: pointer, next: bool): bool {.cdecl.} =
  let vtbl = cast[ptr QPrintPreviewDialogVTable](fcQPrintPreviewDialog_vdata(self)[])
  let self = QPrintPreviewDialog(h: self)
  let slotval1 = next
...
proc fcQPrintPreviewDialog_method_callback_metacall(self: pointer, param1: cint, param2: cint, param3: pointer): cint {.cdecl.} =
  let inst = cast[VirtualQPrintPreviewDialog](fcQPrintPreviewDialog_vdata(self)[])
  let slotval1 = cint(param1)
  let slotval2 = param2
  let slotval3 = param3
...
proc fcQPrintPreviewDialog_method_callback_setVisible(self: pointer, visible: bool): void {.cdecl.} =
  let inst = cast[VirtualQPrintPreviewDialog](fcQPrintPreviewDialog_vdata(self)[])
  let slotval1 = visible
  inst.setVisible(slotval1)

proc fcQPrintPreviewDialog_method_callback_done(self: pointer, resultVal: cint): void {.cdecl.} =
  let inst = cast[VirtualQPrintPreviewDialog](fcQPrintPreviewDialog_vdata(self)[])
  let slotval1 = resultVal
  inst.done(slotval1)
...
proc fcQPrintPreviewDialog_method_callback_exec(self: pointer): cint {.cdecl.} =
  let inst = cast[VirtualQPrintPreviewDialog](fcQPrintPreviewDialog_vdata(self)[])
  var virtualReturn = inst.exec()
  virtualReturn

proc fcQPrintPreviewDialog_method_callback_accept(self: pointer): void {.cdecl.} =
  let inst = cast[VirtualQPrintPreviewDialog](fcQPrintPreviewDialog_vdata(self)[])
  inst.accept()

proc fcQPrintPreviewDialog_method_callback_reject(self: pointer): void {.cdecl.} =
  let inst = cast[VirtualQPrintPreviewDialog](fcQPrintPreviewDialog_vdata(self)[])
  inst.reject()
...
proc fcQPrintPreviewDialog_method_callback_devType(self: pointer): cint {.cdecl.} =
  let inst = cast[VirtualQPrintPreviewDialog](fcQPrintPreviewDialog_vdata(self)[])
  var virtualReturn = inst.devType()
  virtualReturn

proc fcQPrintPreviewDialog_method_callback_heightForWidth(self: pointer, param1: cint): cint {.cdecl.} =
  let inst = cast[VirtualQPrintPreviewDialog](fcQPrintPreviewDialog_vdata(self)[])
  let slotval1 = param1
  var virtualReturn = inst.heightForWidth(slotval1)
  virtualReturn

proc fcQPrintPreviewDialog_method_callback_hasHeightForWidth(self: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQPrintPreviewDialog](fcQPrintPreviewDialog_vdata(self)[])
...
proc fcQPrintPreviewDialog_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let inst = cast[VirtualQPrintPreviewDialog](fcQPrintPreviewDialog_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc fcQPrintPreviewDialog_method_callback_metric(self: pointer, param1: cint): cint {.cdecl.} =
  let inst = cast[VirtualQPrintPreviewDialog](fcQPrintPreviewDialog_vdata(self)[])
  let slotval1 = cint(param1)
...
proc fcQPrintPreviewDialog_method_callback_inputMethodQuery(self: pointer, param1: cint): pointer {.cdecl.} =
  let inst = cast[VirtualQPrintPreviewDialog](fcQPrintPreviewDialog_vdata(self)[])
  let slotval1 = cint(param1)
...
proc create*(T: type gen_qprintpreviewdialog_types.QPrintPreviewDialog,
  ...
  if not isNil(vtbl[].metaObject):
    vtbl[].vtbl.metaObject = fcQPrintPreviewDialog_vtable_callback_metaObject
  if not isNil(vtbl[].metacast):
    vtbl[].vtbl.metacast = fcQPrintPreviewDialog_vtable_callback_metacast
  if not isNil(vtbl[].metacall):
    vtbl[].vtbl.metacall = fcQPrintPreviewDialog_vtable_callback_metacall
  if not isNil(vtbl[].setVisible):
    vtbl[].vtbl.setVisible = fcQPrintPreviewDialog_vtable_callback_setVisible
  if not isNil(vtbl[].done):
    vtbl[].vtbl.done = fcQPrintPreviewDialog_vtable_callback_done
  if not isNil(vtbl[].sizeHint):
    vtbl[].vtbl.sizeHint = fcQPrintPreviewDialog_vtable_callback_sizeHint
  if not isNil(vtbl[].minimumSizeHint):
    vtbl[].vtbl.minimumSizeHint = fcQPrintPreviewDialog_vtable_callback_minimumSizeHint
  if not isNil(vtbl[].open):
    vtbl[].vtbl.open = fcQPrintPreviewDialog_vtable_callback_open
  if not isNil(vtbl[].exec):
    vtbl[].vtbl.exec = fcQPrintPreviewDialog_vtable_callback_exec
  if not isNil(vtbl[].accept):
    vtbl[].vtbl.accept = fcQPrintPreviewDialog_vtable_callback_accept
  if not isNil(vtbl[].reject):
    vtbl[].vtbl.reject = fcQPrintPreviewDialog_vtable_callback_reject
  if not isNil(vtbl[].keyPressEvent):
    vtbl[].vtbl.keyPressEvent = fcQPrintPreviewDialog_vtable_callback_keyPressEvent
  if not isNil(vtbl[].closeEvent):
    vtbl[].vtbl.closeEvent = fcQPrintPreviewDialog_vtable_callback_closeEvent
  if not isNil(vtbl[].showEvent):
    vtbl[].vtbl.showEvent = fcQPrintPreviewDialog_vtable_callback_showEvent
  if not isNil(vtbl[].resizeEvent):
    vtbl[].vtbl.resizeEvent = fcQPrintPreviewDialog_vtable_callback_resizeEvent
  if not isNil(vtbl[].contextMenuEvent):
    vtbl[].vtbl.contextMenuEvent = fcQPrintPreviewDialog_vtable_callback_contextMenuEvent
  if not isNil(vtbl[].eventFilter):
    vtbl[].vtbl.eventFilter = fcQPrintPreviewDialog_vtable_callback_eventFilter
  if not isNil(vtbl[].devType):
    vtbl[].vtbl.devType = fcQPrintPreviewDialog_vtable_callback_devType
  if not isNil(vtbl[].heightForWidth):
    vtbl[].vtbl.heightForWidth = fcQPrintPreviewDialog_vtable_callback_heightForWidth
  if not isNil(vtbl[].hasHeightForWidth):
    vtbl[].vtbl.hasHeightForWidth = fcQPrintPreviewDialog_vtable_callback_hasHeightForWidth
  if not isNil(vtbl[].paintEngine):
    vtbl[].vtbl.paintEngine = fcQPrintPreviewDialog_vtable_callback_paintEngine
  if not isNil(vtbl[].event):
    vtbl[].vtbl.event = fcQPrintPreviewDialog_vtable_callback_event
  if not isNil(vtbl[].mousePressEvent):
    vtbl[].vtbl.mousePressEvent = fcQPrintPreviewDialog_vtable_callback_mousePressEvent
  if not isNil(vtbl[].mouseReleaseEvent):
    vtbl[].vtbl.mouseReleaseEvent = fcQPrintPreviewDialog_vtable_callback_mouseReleaseEvent
  if not isNil(vtbl[].mouseDoubleClickEvent):
    vtbl[].vtbl.mouseDoubleClickEvent = fcQPrintPreviewDialog_vtable_callback_mouseDoubleClickEvent
  if not isNil(vtbl[].mouseMoveEvent):
    vtbl[].vtbl.mouseMoveEvent = fcQPrintPreviewDialog_vtable_callback_mouseMoveEvent
  if not isNil(vtbl[].wheelEvent):
    vtbl[].vtbl.wheelEvent = fcQPrintPreviewDialog_vtable_callback_wheelEvent
  if not isNil(vtbl[].keyReleaseEvent):
    vtbl[].vtbl.keyReleaseEvent = fcQPrintPreviewDialog_vtable_callback_keyReleaseEvent
  if not isNil(vtbl[].focusInEvent):
    vtbl[].vtbl.focusInEvent = fcQPrintPreviewDialog_vtable_callback_focusInEvent
  if not isNil(vtbl[].focusOutEvent):
    vtbl[].vtbl.focusOutEvent = fcQPrintPreviewDialog_vtable_callback_focusOutEvent
  if not isNil(vtbl[].enterEvent):
    vtbl[].vtbl.enterEvent = fcQPrintPreviewDialog_vtable_callback_enterEvent
  if not isNil(vtbl[].leaveEvent):
    vtbl[].vtbl.leaveEvent = fcQPrintPreviewDialog_vtable_callback_leaveEvent
  if not isNil(vtbl[].paintEvent):
    vtbl[].vtbl.paintEvent = fcQPrintPreviewDialog_vtable_callback_paintEvent
  if not isNil(vtbl[].moveEvent):
    vtbl[].vtbl.moveEvent = fcQPrintPreviewDialog_vtable_callback_moveEvent
  if not isNil(vtbl[].tabletEvent):
    vtbl[].vtbl.tabletEvent = fcQPrintPreviewDialog_vtable_callback_tabletEvent
  if not isNil(vtbl[].actionEvent):
    vtbl[].vtbl.actionEvent = fcQPrintPreviewDialog_vtable_callback_actionEvent
  if not isNil(vtbl[].dragEnterEvent):
    vtbl[].vtbl.dragEnterEvent = fcQPrintPreviewDialog_vtable_callback_dragEnterEvent
  if not isNil(vtbl[].dragMoveEvent):
    vtbl[].vtbl.dragMoveEvent = fcQPrintPreviewDialog_vtable_callback_dragMoveEvent
  if not isNil(vtbl[].dragLeaveEvent):
    vtbl[].vtbl.dragLeaveEvent = fcQPrintPreviewDialog_vtable_callback_dragLeaveEvent
  if not isNil(vtbl[].dropEvent):
    vtbl[].vtbl.dropEvent = fcQPrintPreviewDialog_vtable_callback_dropEvent
  if not isNil(vtbl[].hideEvent):
    vtbl[].vtbl.hideEvent = fcQPrintPreviewDialog_vtable_callback_hideEvent
  if not isNil(vtbl[].nativeEvent):
    vtbl[].vtbl.nativeEvent = fcQPrintPreviewDialog_vtable_callback_nativeEvent
  if not isNil(vtbl[].changeEvent):
    vtbl[].vtbl.changeEvent = fcQPrintPreviewDialog_vtable_callback_changeEvent
  if not isNil(vtbl[].metric):
    vtbl[].vtbl.metric = fcQPrintPreviewDialog_vtable_callback_metric
  if not isNil(vtbl[].initPainter):
    vtbl[].vtbl.initPainter = fcQPrintPreviewDialog_vtable_callback_initPainter
  if not isNil(vtbl[].redirected):
    vtbl[].vtbl.redirected = fcQPrintPreviewDialog_vtable_callback_redirected
  if not isNil(vtbl[].sharedPainter):
    vtbl[].vtbl.sharedPainter = fcQPrintPreviewDialog_vtable_callback_sharedPainter
  if not isNil(vtbl[].inputMethodEvent):
    vtbl[].vtbl.inputMethodEvent = fcQPrintPreviewDialog_vtable_callback_inputMethodEvent
  if not isNil(vtbl[].inputMethodQuery):
    vtbl[].vtbl.inputMethodQuery = fcQPrintPreviewDialog_vtable_callback_inputMethodQuery
  if not isNil(vtbl[].focusNextPrevChild):
    vtbl[].vtbl.focusNextPrevChild = fcQPrintPreviewDialog_vtable_callback_focusNextPrevChild
  if not isNil(vtbl[].timerEvent):
    vtbl[].vtbl.timerEvent = fcQPrintPreviewDialog_vtable_callback_timerEvent
  if not isNil(vtbl[].childEvent):
    vtbl[].vtbl.childEvent = fcQPrintPreviewDialog_vtable_callback_childEvent
  if not isNil(vtbl[].customEvent):
    vtbl[].vtbl.customEvent = fcQPrintPreviewDialog_vtable_callback_customEvent
  ...
  let tmp = gen_qprintpreviewdialog_types.QPrintPreviewDialog(h: fcQPrintPreviewDialog_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
...
proc create*(T: type gen_qprintpreviewdialog_types.QPrintPreviewDialog,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQPrintPreviewDialog_vtable_callback_disconnectNotify
  let tmp = gen_qprintpreviewdialog_types.QPrintPreviewDialog(h: fcQPrintPreviewDialog_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), printer.h), owned: true)
  fcQPrintPreviewDialog_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qprintpreviewdialog_types.QPrintPreviewDialog,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQPrintPreviewDialog_vtable_callback_disconnectNotify
  let tmp = gen_qprintpreviewdialog_types.QPrintPreviewDialog(h: fcQPrintPreviewDialog_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQPrintPreviewDialog_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qprintpreviewdialog_types.QPrintPreviewDialog,
...
const cQPrintPreviewDialog_mvtbl = cQPrintPreviewDialogVTable(
  ...
  metacall: fcQPrintPreviewDialog_method_callback_metacall,
  setVisible: fcQPrintPreviewDialog_method_callback_setVisible,
  done: fcQPrintPreviewDialog_method_callback_done,
  sizeHint: fcQPrintPreviewDialog_method_callback_sizeHint,
  minimumSizeHint: fcQPrintPreviewDialog_method_callback_minimumSizeHint,
  open: fcQPrintPreviewDialog_method_callback_open,
  exec: fcQPrintPreviewDialog_method_callback_exec,
  accept: fcQPrintPreviewDialog_method_callback_accept,
  reject: fcQPrintPreviewDialog_method_callback_reject,
  keyPressEvent: fcQPrintPreviewDialog_method_callback_keyPressEvent,
  closeEvent: fcQPrintPreviewDialog_method_callback_closeEvent,
  showEvent: fcQPrintPreviewDialog_method_callback_showEvent,
  resizeEvent: fcQPrintPreviewDialog_method_callback_resizeEvent,
  contextMenuEvent: fcQPrintPreviewDialog_method_callback_contextMenuEvent,
  eventFilter: fcQPrintPreviewDialog_method_callback_eventFilter,
  devType: fcQPrintPreviewDialog_method_callback_devType,
  heightForWidth: fcQPrintPreviewDialog_method_callback_heightForWidth,
  hasHeightForWidth: fcQPrintPreviewDialog_method_callback_hasHeightForWidth,
  paintEngine: fcQPrintPreviewDialog_method_callback_paintEngine,
  event: fcQPrintPreviewDialog_method_callback_event,
  mousePressEvent: fcQPrintPreviewDialog_method_callback_mousePressEvent,
  mouseReleaseEvent: fcQPrintPreviewDialog_method_callback_mouseReleaseEvent,
  mouseDoubleClickEvent: fcQPrintPreviewDialog_method_callback_mouseDoubleClickEvent,
  mouseMoveEvent: fcQPrintPreviewDialog_method_callback_mouseMoveEvent,
  wheelEvent: fcQPrintPreviewDialog_method_callback_wheelEvent,
  keyReleaseEvent: fcQPrintPreviewDialog_method_callback_keyReleaseEvent,
  focusInEvent: fcQPrintPreviewDialog_method_callback_focusInEvent,
  focusOutEvent: fcQPrintPreviewDialog_method_callback_focusOutEvent,
  enterEvent: fcQPrintPreviewDialog_method_callback_enterEvent,
  leaveEvent: fcQPrintPreviewDialog_method_callback_leaveEvent,
  paintEvent: fcQPrintPreviewDialog_method_callback_paintEvent,
  moveEvent: fcQPrintPreviewDialog_method_callback_moveEvent,
  tabletEvent: fcQPrintPreviewDialog_method_callback_tabletEvent,
  actionEvent: fcQPrintPreviewDialog_method_callback_actionEvent,
  dragEnterEvent: fcQPrintPreviewDialog_method_callback_dragEnterEvent,
  dragMoveEvent: fcQPrintPreviewDialog_method_callback_dragMoveEvent,
  dragLeaveEvent: fcQPrintPreviewDialog_method_callback_dragLeaveEvent,
  dropEvent: fcQPrintPreviewDialog_method_callback_dropEvent,
  hideEvent: fcQPrintPreviewDialog_method_callback_hideEvent,
  nativeEvent: fcQPrintPreviewDialog_method_callback_nativeEvent,
  changeEvent: fcQPrintPreviewDialog_method_callback_changeEvent,
  metric: fcQPrintPreviewDialog_method_callback_metric,
  initPainter: fcQPrintPreviewDialog_method_callback_initPainter,
  redirected: fcQPrintPreviewDialog_method_callback_redirected,
  sharedPainter: fcQPrintPreviewDialog_method_callback_sharedPainter,
  inputMethodEvent: fcQPrintPreviewDialog_method_callback_inputMethodEvent,
  inputMethodQuery: fcQPrintPreviewDialog_method_callback_inputMethodQuery,
  focusNextPrevChild: fcQPrintPreviewDialog_method_callback_focusNextPrevChild,
  timerEvent: fcQPrintPreviewDialog_method_callback_timerEvent,
  childEvent: fcQPrintPreviewDialog_method_callback_childEvent,
  customEvent: fcQPrintPreviewDialog_method_callback_customEvent,
  connectNotify: fcQPrintPreviewDialog_method_callback_connectNotify,
  disconnectNotify: fcQPrintPreviewDialog_method_callback_disconnectNotify,
)
proc create*(T: type gen_qprintpreviewdialog_types.QPrintPreviewDialog,
    inst: VirtualQPrintPreviewDialog) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQPrintPreviewDialog_new(addr(cQPrintPreviewDialog_mvtbl), csize_t(sizeof(pointer)))
...
proc create*(T: type gen_qprintpreviewdialog_types.QPrintPreviewDialog,
    ...
    inst: VirtualQPrintPreviewDialog) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQPrintPreviewDialog_new2(addr(cQPrintPreviewDialog_mvtbl), csize_t(sizeof(pointer)), printer.h)
  fcQPrintPreviewDialog_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qprintpreviewdialog_types.QPrintPreviewDialog,
    ...
    inst: VirtualQPrintPreviewDialog) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQPrintPreviewDialog_new3(addr(cQPrintPreviewDialog_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQPrintPreviewDialog_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
