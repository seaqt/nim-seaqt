...
proc fcQPrintPreviewDialog_new(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQPrintPreviewDialog {.importc: "QPrintPreviewDialog_new".}
proc fcQPrintPreviewDialog_new2(vtbl: pointer, vdata: csize_t): ptr cQPrintPreviewDialog {.importc: "QPrintPreviewDialog_new2".}
proc fcQPrintPreviewDialog_new3(vtbl: pointer, vdata: csize_t, printer: pointer): ptr cQPrintPreviewDialog {.importc: "QPrintPreviewDialog_new3".}
