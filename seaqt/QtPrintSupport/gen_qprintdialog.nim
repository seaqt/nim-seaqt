...
proc fcQPrintDialog_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.importc: "QPrintDialog_virtualbase_nativeEvent".}
...
proc fcQPrintDialog_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QPrintDialog_protectedbase_getDecodedMetricF".}
...
proc fcQPrintDialog_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QPrintDialogVTable](fcQPrintDialog_vdata(self)[])
  let self = QPrintDialog(h: self)
...
proc fcQPrintDialog_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let inst = cast[VirtualQPrintDialog](fcQPrintDialog_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc getDecodedMetricF*(self: gen_qprintdialog_types.QPrintDialog, metricA: cint, metricB: cint): float64 =
  fcQPrintDialog_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
