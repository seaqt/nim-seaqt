...
proc create*(T: type gen_qprintdialog_types.QPrintDialog,
  ...
  let tmp = gen_qprintdialog_types.QPrintDialog(h: fcQPrintDialog_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), printer.h))
...
proc create*(T: type gen_qprintdialog_types.QPrintDialog,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQPrintDialog_vtable_callback_disconnectNotify
  let tmp = gen_qprintdialog_types.QPrintDialog(h: fcQPrintDialog_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer))))
  fcQPrintDialog_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qprintdialog_types.QPrintDialog,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQPrintDialog_vtable_callback_disconnectNotify
  let tmp = gen_qprintdialog_types.QPrintDialog(h: fcQPrintDialog_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), printer.h, parent.h))
  fcQPrintDialog_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qprintdialog_types.QPrintDialog,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQPrintDialog_vtable_callback_disconnectNotify
  let tmp = gen_qprintdialog_types.QPrintDialog(h: fcQPrintDialog_new4(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h))
  fcQPrintDialog_vdata(tmp.h)[] = addr(vtbl[])
  tmp
