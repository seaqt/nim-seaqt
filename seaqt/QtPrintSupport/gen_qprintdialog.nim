...
proc fcQPrintDialog_trUtf8(s: cstring): struct_seaqt_string {.importc: "QPrintDialog_trUtf8".}
...
proc fcQPrintDialog_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QPrintDialog_trUtf82".}
proc fcQPrintDialog_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QPrintDialog_trUtf83".}
...
proc fcQPrintDialog_new(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQPrintDialog {.importc: "QPrintDialog_new".}
proc fcQPrintDialog_new2(vtbl: pointer, vdata: csize_t, printer: pointer): ptr cQPrintDialog {.importc: "QPrintDialog_new2".}
proc fcQPrintDialog_new3(vtbl: pointer, vdata: csize_t): ptr cQPrintDialog {.importc: "QPrintDialog_new3".}
proc fcQPrintDialog_new4(vtbl: pointer, vdata: csize_t, printer: pointer, parent: pointer): ptr cQPrintDialog {.importc: "QPrintDialog_new4".}
