...
public:
	...
	friend bool QPrintPreviewDialog_virtualbase_nativeEvent(VirtualQPrintPreviewDialog* self, struct miqt_string eventType, void* message, intptr_t* result);
...
VirtualQPrintPreviewDialog* QPrintPreviewDialog_new(const QPrintPreviewDialog_VTable* vtbl, size_t vdata, QWidget* parent) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQPrintPreviewDialog>());
