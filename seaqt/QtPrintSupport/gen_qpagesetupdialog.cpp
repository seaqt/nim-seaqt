...
public:
	...
	friend bool QPageSetupDialog_virtualbase_nativeEvent(VirtualQPageSetupDialog* self, struct miqt_string eventType, void* message, intptr_t* result);
...
VirtualQPageSetupDialog* QPageSetupDialog_new(const QPageSetupDialog_VTable* vtbl, size_t vdata, QWidget* parent) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQPageSetupDialog>());
