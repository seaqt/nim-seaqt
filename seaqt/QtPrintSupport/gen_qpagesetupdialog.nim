...
proc create*(T: type gen_qpagesetupdialog_types.QPageSetupDialog,
  ...
  let tmp = gen_qpagesetupdialog_types.QPageSetupDialog(h: fcQPageSetupDialog_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), printer.h))
...
proc create*(T: type gen_qpagesetupdialog_types.QPageSetupDialog,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQPageSetupDialog_vtable_callback_disconnectNotify
  let tmp = gen_qpagesetupdialog_types.QPageSetupDialog(h: fcQPageSetupDialog_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer))))
  fcQPageSetupDialog_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qpagesetupdialog_types.QPageSetupDialog,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQPageSetupDialog_vtable_callback_disconnectNotify
  let tmp = gen_qpagesetupdialog_types.QPageSetupDialog(h: fcQPageSetupDialog_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), printer.h, parent.h))
  fcQPageSetupDialog_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qpagesetupdialog_types.QPageSetupDialog,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQPageSetupDialog_vtable_callback_disconnectNotify
  let tmp = gen_qpagesetupdialog_types.QPageSetupDialog(h: fcQPageSetupDialog_new4(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h))
  fcQPageSetupDialog_vdata(tmp.h)[] = addr(vtbl[])
  tmp
