...
proc fcQPageSetupDialog_new(vtbl: pointer, vdata: csize_t, printer: pointer): ptr cQPageSetupDialog {.importc: "QPageSetupDialog_new".}
proc fcQPageSetupDialog_new2(vtbl: pointer, vdata: csize_t): ptr cQPageSetupDialog {.importc: "QPageSetupDialog_new2".}
proc fcQPageSetupDialog_new3(vtbl: pointer, vdata: csize_t, printer: pointer, parent: pointer): ptr cQPageSetupDialog {.importc: "QPageSetupDialog_new3".}
proc fcQPageSetupDialog_new4(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQPageSetupDialog {.importc: "QPageSetupDialog_new4".}
