...
proc fcQPageSetupDialog_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.importc: "QPageSetupDialog_virtualbase_nativeEvent".}
...
proc fcQPageSetupDialog_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QPageSetupDialog_protectedbase_getDecodedMetricF".}
proc fcQPageSetupDialog_new(vtbl: pointer, vdata: csize_t, printer: pointer): ptr cQPageSetupDialog {.importc: "QPageSetupDialog_new_printer".}
proc fcQPageSetupDialog_new2(vtbl: pointer, vdata: csize_t): ptr cQPageSetupDialog {.importc: "QPageSetupDialog_new".}
proc fcQPageSetupDialog_new3(vtbl: pointer, vdata: csize_t, printer: pointer, parent: pointer): ptr cQPageSetupDialog {.importc: "QPageSetupDialog_new_printer_parent".}
proc fcQPageSetupDialog_new4(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQPageSetupDialog {.importc: "QPageSetupDialog_new_parent".}
...
proc QPageSetupDialognativeEvent*(self: gen_qpagesetupdialog_types.QPageSetupDialog, eventType: openArray[byte], message: pointer, resultVal: ptr uint): bool =
  fcQPageSetupDialog_virtualbase_nativeEvent(self.h, struct_seaqt_string(data: if len(eventType) > 0: addr eventType[0] else: nil, len: csize_t(len(eventType))), message, resultVal)
...
proc fcQPageSetupDialog_vtable_callback_metacast(self: pointer, param1: cstring): pointer {.cdecl.} =
  let vtbl = cast[ptr QPageSetupDialogVTable](fcQPageSetupDialog_vdata(self)[])
  let self = QPageSetupDialog(h: self)
  let slotval1 = (param1)
...
proc fcQPageSetupDialog_vtable_callback_metacall(self: pointer, param1: cint, param2: cint, param3: pointer): cint {.cdecl.} =
  let vtbl = cast[ptr QPageSetupDialogVTable](fcQPageSetupDialog_vdata(self)[])
  let self = QPageSetupDialog(h: self)
...
proc fcQPageSetupDialog_vtable_callback_exec(self: pointer): cint {.cdecl.} =
  let vtbl = cast[ptr QPageSetupDialogVTable](fcQPageSetupDialog_vdata(self)[])
  let self = QPageSetupDialog(h: self)
  var virtualReturn = vtbl[].exec(self)
  virtualReturn

proc fcQPageSetupDialog_vtable_callback_done(self: pointer, resultVal: cint): void {.cdecl.} =
  let vtbl = cast[ptr QPageSetupDialogVTable](fcQPageSetupDialog_vdata(self)[])
  let self = QPageSetupDialog(h: self)
  let slotval1 = resultVal
  vtbl[].done(self, slotval1)

proc fcQPageSetupDialog_vtable_callback_setVisible(self: pointer, visible: bool): void {.cdecl.} =
  let vtbl = cast[ptr QPageSetupDialogVTable](fcQPageSetupDialog_vdata(self)[])
  let self = QPageSetupDialog(h: self)
...
proc fcQPageSetupDialog_vtable_callback_open(self: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QPageSetupDialogVTable](fcQPageSetupDialog_vdata(self)[])
  let self = QPageSetupDialog(h: self)
  vtbl[].open(self)

proc fcQPageSetupDialog_vtable_callback_accept(self: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QPageSetupDialogVTable](fcQPageSetupDialog_vdata(self)[])
  let self = QPageSetupDialog(h: self)
  vtbl[].accept(self)

proc fcQPageSetupDialog_vtable_callback_reject(self: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QPageSetupDialogVTable](fcQPageSetupDialog_vdata(self)[])
  let self = QPageSetupDialog(h: self)
  vtbl[].reject(self)
...
proc fcQPageSetupDialog_vtable_callback_devType(self: pointer): cint {.cdecl.} =
  let vtbl = cast[ptr QPageSetupDialogVTable](fcQPageSetupDialog_vdata(self)[])
  let self = QPageSetupDialog(h: self)
  var virtualReturn = vtbl[].devType(self)
  virtualReturn

proc fcQPageSetupDialog_vtable_callback_heightForWidth(self: pointer, param1: cint): cint {.cdecl.} =
  let vtbl = cast[ptr QPageSetupDialogVTable](fcQPageSetupDialog_vdata(self)[])
  let self = QPageSetupDialog(h: self)
  let slotval1 = param1
...
proc fcQPageSetupDialog_vtable_callback_hasHeightForWidth(self: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QPageSetupDialogVTable](fcQPageSetupDialog_vdata(self)[])
  let self = QPageSetupDialog(h: self)
...
proc fcQPageSetupDialog_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QPageSetupDialogVTable](fcQPageSetupDialog_vdata(self)[])
  let self = QPageSetupDialog(h: self)
...
proc fcQPageSetupDialog_vtable_callback_metric(self: pointer, param1: cint): cint {.cdecl.} =
  let vtbl = cast[ptr QPageSetupDialogVTable](fcQPageSetupDialog_vdata(self)[])
  let self = QPageSetupDialog(h: self)
  let slotval1 = cint(param1)
...
proc fcQPageSetupDialog_vtable_callback_focusNextPrevChild(self: pointer, next: bool): bool {.cdecl.} =
  let vtbl = cast[ptr QPageSetupDialogVTable](fcQPageSetupDialog_vdata(self)[])
  let self = QPageSetupDialog(h: self)
  let slotval1 = next
...
proc fcQPageSetupDialog_method_callback_metaObject(self: pointer): pointer {.cdecl.} =
...
proc fcQPageSetupDialog_method_callback_metacast(self: pointer, param1: cstring): pointer {.cdecl.} =
  let inst = cast[VirtualQPageSetupDialog](fcQPageSetupDialog_vdata(self)[])
  let slotval1 = (param1)
  var virtualReturn = inst.metacast(slotval1)
  virtualReturn

proc fcQPageSetupDialog_method_callback_metacall(self: pointer, param1: cint, param2: cint, param3: pointer): cint {.cdecl.} =
  let inst = cast[VirtualQPageSetupDialog](fcQPageSetupDialog_vdata(self)[])
  let slotval1 = cint(param1)
  let slotval2 = param2
  let slotval3 = param3
...
proc fcQPageSetupDialog_method_callback_exec(self: pointer): cint {.cdecl.} =
  let inst = cast[VirtualQPageSetupDialog](fcQPageSetupDialog_vdata(self)[])
  var virtualReturn = inst.exec()
  virtualReturn

proc fcQPageSetupDialog_method_callback_done(self: pointer, resultVal: cint): void {.cdecl.} =
  let inst = cast[VirtualQPageSetupDialog](fcQPageSetupDialog_vdata(self)[])
  let slotval1 = resultVal
  inst.done(slotval1)

proc fcQPageSetupDialog_method_callback_setVisible(self: pointer, visible: bool): void {.cdecl.} =
  let inst = cast[VirtualQPageSetupDialog](fcQPageSetupDialog_vdata(self)[])
  let slotval1 = visible
  inst.setVisible(slotval1)

proc fcQPageSetupDialog_method_callback_sizeHint(self: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQPageSetupDialog](fcQPageSetupDialog_vdata(self)[])
...
proc fcQPageSetupDialog_method_callback_minimumSizeHint(self: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQPageSetupDialog](fcQPageSetupDialog_vdata(self)[])
...
proc fcQPageSetupDialog_method_callback_open(self: pointer): void {.cdecl.} =
  let inst = cast[VirtualQPageSetupDialog](fcQPageSetupDialog_vdata(self)[])
  inst.open()

proc fcQPageSetupDialog_method_callback_accept(self: pointer): void {.cdecl.} =
  let inst = cast[VirtualQPageSetupDialog](fcQPageSetupDialog_vdata(self)[])
  inst.accept()

proc fcQPageSetupDialog_method_callback_reject(self: pointer): void {.cdecl.} =
  let inst = cast[VirtualQPageSetupDialog](fcQPageSetupDialog_vdata(self)[])
  inst.reject()
...
proc fcQPageSetupDialog_method_callback_devType(self: pointer): cint {.cdecl.} =
  let inst = cast[VirtualQPageSetupDialog](fcQPageSetupDialog_vdata(self)[])
  var virtualReturn = inst.devType()
  virtualReturn

proc fcQPageSetupDialog_method_callback_heightForWidth(self: pointer, param1: cint): cint {.cdecl.} =
  let inst = cast[VirtualQPageSetupDialog](fcQPageSetupDialog_vdata(self)[])
  let slotval1 = param1
  var virtualReturn = inst.heightForWidth(slotval1)
  virtualReturn

proc fcQPageSetupDialog_method_callback_hasHeightForWidth(self: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQPageSetupDialog](fcQPageSetupDialog_vdata(self)[])
  var virtualReturn = inst.hasHeightForWidth()
  virtualReturn

proc fcQPageSetupDialog_method_callback_paintEngine(self: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQPageSetupDialog](fcQPageSetupDialog_vdata(self)[])
...
proc fcQPageSetupDialog_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let inst = cast[VirtualQPageSetupDialog](fcQPageSetupDialog_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc fcQPageSetupDialog_method_callback_metric(self: pointer, param1: cint): cint {.cdecl.} =
  let inst = cast[VirtualQPageSetupDialog](fcQPageSetupDialog_vdata(self)[])
  let slotval1 = cint(param1)
...
proc fcQPageSetupDialog_method_callback_sharedPainter(self: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQPageSetupDialog](fcQPageSetupDialog_vdata(self)[])
...
proc fcQPageSetupDialog_method_callback_inputMethodQuery(self: pointer, param1: cint): pointer {.cdecl.} =
  let inst = cast[VirtualQPageSetupDialog](fcQPageSetupDialog_vdata(self)[])
  let slotval1 = cint(param1)
...
proc fcQPageSetupDialog_method_callback_focusNextPrevChild(self: pointer, next: bool): bool {.cdecl.} =
  let inst = cast[VirtualQPageSetupDialog](fcQPageSetupDialog_vdata(self)[])
  let slotval1 = next
...
proc getDecodedMetricF*(self: gen_qpagesetupdialog_types.QPageSetupDialog, metricA: cint, metricB: cint): float64 =
  fcQPageSetupDialog_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
...
proc create*(T: type gen_qpagesetupdialog_types.QPageSetupDialog,
  ...
  if not isNil(vtbl[].metaObject):
    vtbl[].vtbl.metaObject = fcQPageSetupDialog_vtable_callback_metaObject
  if not isNil(vtbl[].metacast):
    vtbl[].vtbl.metacast = fcQPageSetupDialog_vtable_callback_metacast
  if not isNil(vtbl[].metacall):
    vtbl[].vtbl.metacall = fcQPageSetupDialog_vtable_callback_metacall
  if not isNil(vtbl[].exec):
    vtbl[].vtbl.exec = fcQPageSetupDialog_vtable_callback_exec
  if not isNil(vtbl[].done):
    vtbl[].vtbl.done = fcQPageSetupDialog_vtable_callback_done
  if not isNil(vtbl[].setVisible):
    vtbl[].vtbl.setVisible = fcQPageSetupDialog_vtable_callback_setVisible
  if not isNil(vtbl[].sizeHint):
    vtbl[].vtbl.sizeHint = fcQPageSetupDialog_vtable_callback_sizeHint
  if not isNil(vtbl[].minimumSizeHint):
    vtbl[].vtbl.minimumSizeHint = fcQPageSetupDialog_vtable_callback_minimumSizeHint
  if not isNil(vtbl[].open):
    vtbl[].vtbl.open = fcQPageSetupDialog_vtable_callback_open
  if not isNil(vtbl[].accept):
    vtbl[].vtbl.accept = fcQPageSetupDialog_vtable_callback_accept
  if not isNil(vtbl[].reject):
    vtbl[].vtbl.reject = fcQPageSetupDialog_vtable_callback_reject
  if not isNil(vtbl[].keyPressEvent):
    vtbl[].vtbl.keyPressEvent = fcQPageSetupDialog_vtable_callback_keyPressEvent
  if not isNil(vtbl[].closeEvent):
    vtbl[].vtbl.closeEvent = fcQPageSetupDialog_vtable_callback_closeEvent
  if not isNil(vtbl[].showEvent):
    vtbl[].vtbl.showEvent = fcQPageSetupDialog_vtable_callback_showEvent
  if not isNil(vtbl[].resizeEvent):
    vtbl[].vtbl.resizeEvent = fcQPageSetupDialog_vtable_callback_resizeEvent
  if not isNil(vtbl[].contextMenuEvent):
    vtbl[].vtbl.contextMenuEvent = fcQPageSetupDialog_vtable_callback_contextMenuEvent
  if not isNil(vtbl[].eventFilter):
    vtbl[].vtbl.eventFilter = fcQPageSetupDialog_vtable_callback_eventFilter
  if not isNil(vtbl[].devType):
    vtbl[].vtbl.devType = fcQPageSetupDialog_vtable_callback_devType
  if not isNil(vtbl[].heightForWidth):
    vtbl[].vtbl.heightForWidth = fcQPageSetupDialog_vtable_callback_heightForWidth
  if not isNil(vtbl[].hasHeightForWidth):
    vtbl[].vtbl.hasHeightForWidth = fcQPageSetupDialog_vtable_callback_hasHeightForWidth
  if not isNil(vtbl[].paintEngine):
    vtbl[].vtbl.paintEngine = fcQPageSetupDialog_vtable_callback_paintEngine
  if not isNil(vtbl[].event):
    vtbl[].vtbl.event = fcQPageSetupDialog_vtable_callback_event
  if not isNil(vtbl[].mousePressEvent):
    vtbl[].vtbl.mousePressEvent = fcQPageSetupDialog_vtable_callback_mousePressEvent
  if not isNil(vtbl[].mouseReleaseEvent):
    vtbl[].vtbl.mouseReleaseEvent = fcQPageSetupDialog_vtable_callback_mouseReleaseEvent
  if not isNil(vtbl[].mouseDoubleClickEvent):
    vtbl[].vtbl.mouseDoubleClickEvent = fcQPageSetupDialog_vtable_callback_mouseDoubleClickEvent
  if not isNil(vtbl[].mouseMoveEvent):
    vtbl[].vtbl.mouseMoveEvent = fcQPageSetupDialog_vtable_callback_mouseMoveEvent
  if not isNil(vtbl[].wheelEvent):
    vtbl[].vtbl.wheelEvent = fcQPageSetupDialog_vtable_callback_wheelEvent
  if not isNil(vtbl[].keyReleaseEvent):
    vtbl[].vtbl.keyReleaseEvent = fcQPageSetupDialog_vtable_callback_keyReleaseEvent
  if not isNil(vtbl[].focusInEvent):
    vtbl[].vtbl.focusInEvent = fcQPageSetupDialog_vtable_callback_focusInEvent
  if not isNil(vtbl[].focusOutEvent):
    vtbl[].vtbl.focusOutEvent = fcQPageSetupDialog_vtable_callback_focusOutEvent
  if not isNil(vtbl[].enterEvent):
    vtbl[].vtbl.enterEvent = fcQPageSetupDialog_vtable_callback_enterEvent
  if not isNil(vtbl[].leaveEvent):
    vtbl[].vtbl.leaveEvent = fcQPageSetupDialog_vtable_callback_leaveEvent
  if not isNil(vtbl[].paintEvent):
    vtbl[].vtbl.paintEvent = fcQPageSetupDialog_vtable_callback_paintEvent
  if not isNil(vtbl[].moveEvent):
    vtbl[].vtbl.moveEvent = fcQPageSetupDialog_vtable_callback_moveEvent
  if not isNil(vtbl[].tabletEvent):
    vtbl[].vtbl.tabletEvent = fcQPageSetupDialog_vtable_callback_tabletEvent
  if not isNil(vtbl[].actionEvent):
    vtbl[].vtbl.actionEvent = fcQPageSetupDialog_vtable_callback_actionEvent
  if not isNil(vtbl[].dragEnterEvent):
    vtbl[].vtbl.dragEnterEvent = fcQPageSetupDialog_vtable_callback_dragEnterEvent
  if not isNil(vtbl[].dragMoveEvent):
    vtbl[].vtbl.dragMoveEvent = fcQPageSetupDialog_vtable_callback_dragMoveEvent
  if not isNil(vtbl[].dragLeaveEvent):
    vtbl[].vtbl.dragLeaveEvent = fcQPageSetupDialog_vtable_callback_dragLeaveEvent
  if not isNil(vtbl[].dropEvent):
    vtbl[].vtbl.dropEvent = fcQPageSetupDialog_vtable_callback_dropEvent
  if not isNil(vtbl[].hideEvent):
    vtbl[].vtbl.hideEvent = fcQPageSetupDialog_vtable_callback_hideEvent
  if not isNil(vtbl[].nativeEvent):
    vtbl[].vtbl.nativeEvent = fcQPageSetupDialog_vtable_callback_nativeEvent
  if not isNil(vtbl[].changeEvent):
    vtbl[].vtbl.changeEvent = fcQPageSetupDialog_vtable_callback_changeEvent
  if not isNil(vtbl[].metric):
    vtbl[].vtbl.metric = fcQPageSetupDialog_vtable_callback_metric
  if not isNil(vtbl[].initPainter):
    vtbl[].vtbl.initPainter = fcQPageSetupDialog_vtable_callback_initPainter
  if not isNil(vtbl[].redirected):
    vtbl[].vtbl.redirected = fcQPageSetupDialog_vtable_callback_redirected
  if not isNil(vtbl[].sharedPainter):
    vtbl[].vtbl.sharedPainter = fcQPageSetupDialog_vtable_callback_sharedPainter
  if not isNil(vtbl[].inputMethodEvent):
    vtbl[].vtbl.inputMethodEvent = fcQPageSetupDialog_vtable_callback_inputMethodEvent
  if not isNil(vtbl[].inputMethodQuery):
    vtbl[].vtbl.inputMethodQuery = fcQPageSetupDialog_vtable_callback_inputMethodQuery
  if not isNil(vtbl[].focusNextPrevChild):
    vtbl[].vtbl.focusNextPrevChild = fcQPageSetupDialog_vtable_callback_focusNextPrevChild
  if not isNil(vtbl[].timerEvent):
    vtbl[].vtbl.timerEvent = fcQPageSetupDialog_vtable_callback_timerEvent
  if not isNil(vtbl[].childEvent):
    vtbl[].vtbl.childEvent = fcQPageSetupDialog_vtable_callback_childEvent
  if not isNil(vtbl[].customEvent):
    vtbl[].vtbl.customEvent = fcQPageSetupDialog_vtable_callback_customEvent
  ...
  let tmp = gen_qpagesetupdialog_types.QPageSetupDialog(h: fcQPageSetupDialog_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), printer.h), owned: true)
...
proc create*(T: type gen_qpagesetupdialog_types.QPageSetupDialog,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQPageSetupDialog_vtable_callback_disconnectNotify
  let tmp = gen_qpagesetupdialog_types.QPageSetupDialog(h: fcQPageSetupDialog_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQPageSetupDialog_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qpagesetupdialog_types.QPageSetupDialog,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQPageSetupDialog_vtable_callback_disconnectNotify
  let tmp = gen_qpagesetupdialog_types.QPageSetupDialog(h: fcQPageSetupDialog_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), printer.h, parent.h), owned: true)
  fcQPageSetupDialog_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qpagesetupdialog_types.QPageSetupDialog,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQPageSetupDialog_vtable_callback_disconnectNotify
  let tmp = gen_qpagesetupdialog_types.QPageSetupDialog(h: fcQPageSetupDialog_new4(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQPageSetupDialog_vdata(tmp.h)[] = addr(vtbl[])
  tmp
const cQPageSetupDialog_mvtbl = cQPageSetupDialogVTable(
  ...
  metacall: fcQPageSetupDialog_method_callback_metacall,
  exec: fcQPageSetupDialog_method_callback_exec,
  done: fcQPageSetupDialog_method_callback_done,
  setVisible: fcQPageSetupDialog_method_callback_setVisible,
  sizeHint: fcQPageSetupDialog_method_callback_sizeHint,
  minimumSizeHint: fcQPageSetupDialog_method_callback_minimumSizeHint,
  open: fcQPageSetupDialog_method_callback_open,
  accept: fcQPageSetupDialog_method_callback_accept,
  reject: fcQPageSetupDialog_method_callback_reject,
  keyPressEvent: fcQPageSetupDialog_method_callback_keyPressEvent,
  closeEvent: fcQPageSetupDialog_method_callback_closeEvent,
  showEvent: fcQPageSetupDialog_method_callback_showEvent,
  resizeEvent: fcQPageSetupDialog_method_callback_resizeEvent,
  contextMenuEvent: fcQPageSetupDialog_method_callback_contextMenuEvent,
  eventFilter: fcQPageSetupDialog_method_callback_eventFilter,
  devType: fcQPageSetupDialog_method_callback_devType,
  heightForWidth: fcQPageSetupDialog_method_callback_heightForWidth,
  hasHeightForWidth: fcQPageSetupDialog_method_callback_hasHeightForWidth,
  paintEngine: fcQPageSetupDialog_method_callback_paintEngine,
  event: fcQPageSetupDialog_method_callback_event,
  mousePressEvent: fcQPageSetupDialog_method_callback_mousePressEvent,
  mouseReleaseEvent: fcQPageSetupDialog_method_callback_mouseReleaseEvent,
  mouseDoubleClickEvent: fcQPageSetupDialog_method_callback_mouseDoubleClickEvent,
  mouseMoveEvent: fcQPageSetupDialog_method_callback_mouseMoveEvent,
  wheelEvent: fcQPageSetupDialog_method_callback_wheelEvent,
  keyReleaseEvent: fcQPageSetupDialog_method_callback_keyReleaseEvent,
  focusInEvent: fcQPageSetupDialog_method_callback_focusInEvent,
  focusOutEvent: fcQPageSetupDialog_method_callback_focusOutEvent,
  enterEvent: fcQPageSetupDialog_method_callback_enterEvent,
  leaveEvent: fcQPageSetupDialog_method_callback_leaveEvent,
  paintEvent: fcQPageSetupDialog_method_callback_paintEvent,
  moveEvent: fcQPageSetupDialog_method_callback_moveEvent,
  tabletEvent: fcQPageSetupDialog_method_callback_tabletEvent,
  actionEvent: fcQPageSetupDialog_method_callback_actionEvent,
  dragEnterEvent: fcQPageSetupDialog_method_callback_dragEnterEvent,
  dragMoveEvent: fcQPageSetupDialog_method_callback_dragMoveEvent,
  dragLeaveEvent: fcQPageSetupDialog_method_callback_dragLeaveEvent,
  dropEvent: fcQPageSetupDialog_method_callback_dropEvent,
  hideEvent: fcQPageSetupDialog_method_callback_hideEvent,
  nativeEvent: fcQPageSetupDialog_method_callback_nativeEvent,
  changeEvent: fcQPageSetupDialog_method_callback_changeEvent,
  metric: fcQPageSetupDialog_method_callback_metric,
  initPainter: fcQPageSetupDialog_method_callback_initPainter,
  redirected: fcQPageSetupDialog_method_callback_redirected,
  sharedPainter: fcQPageSetupDialog_method_callback_sharedPainter,
  inputMethodEvent: fcQPageSetupDialog_method_callback_inputMethodEvent,
  inputMethodQuery: fcQPageSetupDialog_method_callback_inputMethodQuery,
  focusNextPrevChild: fcQPageSetupDialog_method_callback_focusNextPrevChild,
  timerEvent: fcQPageSetupDialog_method_callback_timerEvent,
  childEvent: fcQPageSetupDialog_method_callback_childEvent,
  customEvent: fcQPageSetupDialog_method_callback_customEvent,
  connectNotify: fcQPageSetupDialog_method_callback_connectNotify,
  disconnectNotify: fcQPageSetupDialog_method_callback_disconnectNotify,
)
proc create*(T: type gen_qpagesetupdialog_types.QPageSetupDialog,
    printer: gen_qprinter_types.QPrinter,
    inst: VirtualQPageSetupDialog) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQPageSetupDialog_new(addr(cQPageSetupDialog_mvtbl), csize_t(sizeof(pointer)), printer.h)
...
proc create*(T: type gen_qpagesetupdialog_types.QPageSetupDialog,
    inst: VirtualQPageSetupDialog) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQPageSetupDialog_new2(addr(cQPageSetupDialog_mvtbl), csize_t(sizeof(pointer)))
  fcQPageSetupDialog_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qpagesetupdialog_types.QPageSetupDialog,
    ...
    inst: VirtualQPageSetupDialog) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQPageSetupDialog_new3(addr(cQPageSetupDialog_mvtbl), csize_t(sizeof(pointer)), printer.h, parent.h)
  fcQPageSetupDialog_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qpagesetupdialog_types.QPageSetupDialog,
    ...
    inst: VirtualQPageSetupDialog) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQPageSetupDialog_new4(addr(cQPageSetupDialog_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQPageSetupDialog_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
