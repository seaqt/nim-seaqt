...
proc fcQPrinter_setPrinterName(self: pointer, printerName: struct_seaqt_string): void {.importc: "QPrinter_setPrinterName".}
proc fcQPrinter_printerName(self: pointer): struct_seaqt_string {.importc: "QPrinter_printerName".}
proc fcQPrinter_isValid(self: pointer): bool {.importc: "QPrinter_isValid".}
proc fcQPrinter_setOutputFileName(self: pointer, outputFileName: struct_seaqt_string): void {.importc: "QPrinter_setOutputFileName".}
proc fcQPrinter_outputFileName(self: pointer): struct_seaqt_string {.importc: "QPrinter_outputFileName".}
proc fcQPrinter_setPrintProgram(self: pointer, printProgram: struct_seaqt_string): void {.importc: "QPrinter_setPrintProgram".}
proc fcQPrinter_printProgram(self: pointer): struct_seaqt_string {.importc: "QPrinter_printProgram".}
proc fcQPrinter_setDocName(self: pointer, docName: struct_seaqt_string): void {.importc: "QPrinter_setDocName".}
proc fcQPrinter_docName(self: pointer): struct_seaqt_string {.importc: "QPrinter_docName".}
proc fcQPrinter_setCreator(self: pointer, creator: struct_seaqt_string): void {.importc: "QPrinter_setCreator".}
proc fcQPrinter_creator(self: pointer): struct_seaqt_string {.importc: "QPrinter_creator".}
...
proc fcQPrinter_supportedResolutions(self: pointer): struct_seaqt_array {.importc: "QPrinter_supportedResolutions".}
...
proc fcQPrinter_vdata(self: pointer): ptr pointer {.importc: "QPrinter_vdata".}
proc fvdata_cQPrinter(self: pointer): pointer {.importc: "vdata_QPrinter".}
...
proc fcQPrinter_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QPrinter_protectedbase_getDecodedMetricF".}
...
proc setPrinterName*(self: gen_qprinter_types.QPrinter, printerName: openArray[char]): void =
  fcQPrinter_setPrinterName(self.h, struct_seaqt_string(data: if len(printerName) > 0: addr printerName[0] else: nil, len: csize_t(len(printerName))))
...
proc setOutputFileName*(self: gen_qprinter_types.QPrinter, outputFileName: openArray[char]): void =
  fcQPrinter_setOutputFileName(self.h, struct_seaqt_string(data: if len(outputFileName) > 0: addr outputFileName[0] else: nil, len: csize_t(len(outputFileName))))
...
proc setPrintProgram*(self: gen_qprinter_types.QPrinter, printProgram: openArray[char]): void =
  fcQPrinter_setPrintProgram(self.h, struct_seaqt_string(data: if len(printProgram) > 0: addr printProgram[0] else: nil, len: csize_t(len(printProgram))))
...
proc setDocName*(self: gen_qprinter_types.QPrinter, docName: openArray[char]): void =
  fcQPrinter_setDocName(self.h, struct_seaqt_string(data: if len(docName) > 0: addr docName[0] else: nil, len: csize_t(len(docName))))
...
proc setCreator*(self: gen_qprinter_types.QPrinter, creator: openArray[char]): void =
  fcQPrinter_setCreator(self.h, struct_seaqt_string(data: if len(creator) > 0: addr creator[0] else: nil, len: csize_t(len(creator))))
...
proc setPrinterSelectionOption*(self: gen_qprinter_types.QPrinter, printerSelectionOption: openArray[char]): void =
  fcQPrinter_setPrinterSelectionOption(self.h, struct_seaqt_string(data: if len(printerSelectionOption) > 0: addr printerSelectionOption[0] else: nil, len: csize_t(len(printerSelectionOption))))
...
proc getDecodedMetricF*(self: gen_qprinter_types.QPrinter, metricA: cint, metricB: cint): float64 =
  fcQPrinter_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
