...
proc miqt_exec_method_cQAbstractPrintDialog_metaObject(vtbl: pointer, inst: pointer): pointer {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
...
proc miqt_exec_method_cQAbstractPrintDialog_metacast(vtbl: pointer, inst: pointer, param1: cstring): pointer {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
  let slotval1 = (param1)
...
proc miqt_exec_method_cQAbstractPrintDialog_metacall(vtbl: pointer, inst: pointer, param1: cint, param2: cint, param3: pointer): cint {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
  let slotval1 = cint(param1)
  let slotval2 = param2
  let slotval3 = param3
...
proc miqt_exec_method_cQAbstractPrintDialog_setVisible(vtbl: pointer, inst: pointer, visible: bool): void {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
  let slotval1 = visible
...
proc miqt_exec_method_cQAbstractPrintDialog_sizeHint(vtbl: pointer, inst: pointer): pointer {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
...
proc miqt_exec_method_cQAbstractPrintDialog_minimumSizeHint(vtbl: pointer, inst: pointer): pointer {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
...
proc miqt_exec_method_cQAbstractPrintDialog_open(vtbl: pointer, inst: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
  vtbl.open()

method exec*(self: VirtualQAbstractPrintDialog, ): cint {.base.} =
  QAbstractPrintDialogexec(self[])
proc miqt_exec_method_cQAbstractPrintDialog_exec(vtbl: pointer, inst: pointer): cint {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
...
proc miqt_exec_method_cQAbstractPrintDialog_done(vtbl: pointer, inst: pointer, param1: cint): void {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
  let slotval1 = param1
  vtbl.done(slotval1)
...
proc miqt_exec_method_cQAbstractPrintDialog_accept(vtbl: pointer, inst: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
  vtbl.accept()

method reject*(self: VirtualQAbstractPrintDialog, ): void {.base.} =
  QAbstractPrintDialogreject(self[])
proc miqt_exec_method_cQAbstractPrintDialog_reject(vtbl: pointer, inst: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
  vtbl.reject()
...
proc miqt_exec_method_cQAbstractPrintDialog_keyPressEvent(vtbl: pointer, inst: pointer, param1: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
  let slotval1 = gen_qevent_types.QKeyEvent(h: param1, owned: false)
...
proc miqt_exec_method_cQAbstractPrintDialog_closeEvent(vtbl: pointer, inst: pointer, param1: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
  let slotval1 = gen_qevent_types.QCloseEvent(h: param1, owned: false)
...
proc miqt_exec_method_cQAbstractPrintDialog_showEvent(vtbl: pointer, inst: pointer, param1: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
  let slotval1 = gen_qevent_types.QShowEvent(h: param1, owned: false)
...
proc miqt_exec_method_cQAbstractPrintDialog_resizeEvent(vtbl: pointer, inst: pointer, param1: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
  let slotval1 = gen_qevent_types.QResizeEvent(h: param1, owned: false)
...
proc miqt_exec_method_cQAbstractPrintDialog_contextMenuEvent(vtbl: pointer, inst: pointer, param1: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
  let slotval1 = gen_qevent_types.QContextMenuEvent(h: param1, owned: false)
...
proc miqt_exec_method_cQAbstractPrintDialog_eventFilter(vtbl: pointer, inst: pointer, param1: pointer, param2: pointer): bool {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
  let slotval1 = gen_qobject_types.QObject(h: param1, owned: false)
  let slotval2 = gen_qcoreevent_types.QEvent(h: param2, owned: false)
...
proc miqt_exec_method_cQAbstractPrintDialog_devType(vtbl: pointer, inst: pointer): cint {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
...
proc miqt_exec_method_cQAbstractPrintDialog_heightForWidth(vtbl: pointer, inst: pointer, param1: cint): cint {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
  let slotval1 = param1
...
proc miqt_exec_method_cQAbstractPrintDialog_hasHeightForWidth(vtbl: pointer, inst: pointer): bool {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
...
proc miqt_exec_method_cQAbstractPrintDialog_paintEngine(vtbl: pointer, inst: pointer): pointer {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
...
proc miqt_exec_method_cQAbstractPrintDialog_event(vtbl: pointer, inst: pointer, event: pointer): bool {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
...
proc miqt_exec_method_cQAbstractPrintDialog_mousePressEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
...
proc miqt_exec_method_cQAbstractPrintDialog_mouseReleaseEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
...
proc miqt_exec_method_cQAbstractPrintDialog_mouseDoubleClickEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
...
proc miqt_exec_method_cQAbstractPrintDialog_mouseMoveEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
...
proc miqt_exec_method_cQAbstractPrintDialog_wheelEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
  let slotval1 = gen_qevent_types.QWheelEvent(h: event, owned: false)
...
proc miqt_exec_method_cQAbstractPrintDialog_keyReleaseEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
  let slotval1 = gen_qevent_types.QKeyEvent(h: event, owned: false)
...
proc miqt_exec_method_cQAbstractPrintDialog_focusInEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
  let slotval1 = gen_qevent_types.QFocusEvent(h: event, owned: false)
...
proc miqt_exec_method_cQAbstractPrintDialog_focusOutEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
  let slotval1 = gen_qevent_types.QFocusEvent(h: event, owned: false)
...
proc miqt_exec_method_cQAbstractPrintDialog_enterEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
...
proc miqt_exec_method_cQAbstractPrintDialog_leaveEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
...
proc miqt_exec_method_cQAbstractPrintDialog_paintEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
  let slotval1 = gen_qevent_types.QPaintEvent(h: event, owned: false)
...
proc miqt_exec_method_cQAbstractPrintDialog_moveEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
  let slotval1 = gen_qevent_types.QMoveEvent(h: event, owned: false)
...
proc miqt_exec_method_cQAbstractPrintDialog_tabletEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
  let slotval1 = gen_qevent_types.QTabletEvent(h: event, owned: false)
...
proc miqt_exec_method_cQAbstractPrintDialog_actionEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
  let slotval1 = gen_qevent_types.QActionEvent(h: event, owned: false)
...
proc miqt_exec_method_cQAbstractPrintDialog_dragEnterEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
  let slotval1 = gen_qevent_types.QDragEnterEvent(h: event, owned: false)
...
proc miqt_exec_method_cQAbstractPrintDialog_dragMoveEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
  let slotval1 = gen_qevent_types.QDragMoveEvent(h: event, owned: false)
...
proc miqt_exec_method_cQAbstractPrintDialog_dragLeaveEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
  let slotval1 = gen_qevent_types.QDragLeaveEvent(h: event, owned: false)
...
proc miqt_exec_method_cQAbstractPrintDialog_dropEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
  let slotval1 = gen_qevent_types.QDropEvent(h: event, owned: false)
...
proc miqt_exec_method_cQAbstractPrintDialog_hideEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
  let slotval1 = gen_qevent_types.QHideEvent(h: event, owned: false)
...
proc miqt_exec_method_cQAbstractPrintDialog_nativeEvent(vtbl: pointer, inst: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArrayByte(veventType_bytearray.data, 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc miqt_exec_method_cQAbstractPrintDialog_changeEvent(vtbl: pointer, inst: pointer, param1: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
  let slotval1 = gen_qcoreevent_types.QEvent(h: param1, owned: false)
...
proc miqt_exec_method_cQAbstractPrintDialog_metric(vtbl: pointer, inst: pointer, param1: cint): cint {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
  let slotval1 = cint(param1)
...
proc miqt_exec_method_cQAbstractPrintDialog_initPainter(vtbl: pointer, inst: pointer, painter: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
  let slotval1 = gen_qpainter_types.QPainter(h: painter, owned: false)
...
proc miqt_exec_method_cQAbstractPrintDialog_redirected(vtbl: pointer, inst: pointer, offset: pointer): pointer {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
  let slotval1 = gen_qpoint_types.QPoint(h: offset, owned: false)
...
proc miqt_exec_method_cQAbstractPrintDialog_sharedPainter(vtbl: pointer, inst: pointer): pointer {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
...
proc miqt_exec_method_cQAbstractPrintDialog_inputMethodEvent(vtbl: pointer, inst: pointer, param1: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
  let slotval1 = gen_qevent_types.QInputMethodEvent(h: param1, owned: false)
...
proc miqt_exec_method_cQAbstractPrintDialog_inputMethodQuery(vtbl: pointer, inst: pointer, param1: cint): pointer {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
  let slotval1 = cint(param1)
...
proc miqt_exec_method_cQAbstractPrintDialog_focusNextPrevChild(vtbl: pointer, inst: pointer, next: bool): bool {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
  let slotval1 = next
...
proc miqt_exec_method_cQAbstractPrintDialog_timerEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
  let slotval1 = gen_qcoreevent_types.QTimerEvent(h: event, owned: false)
...
proc miqt_exec_method_cQAbstractPrintDialog_childEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
  let slotval1 = gen_qcoreevent_types.QChildEvent(h: event, owned: false)
...
proc miqt_exec_method_cQAbstractPrintDialog_customEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
...
proc miqt_exec_method_cQAbstractPrintDialog_connectNotify(vtbl: pointer, inst: pointer, signal: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
  let slotval1 = gen_qmetaobject_types.QMetaMethod(h: signal, owned: false)
...
proc miqt_exec_method_cQAbstractPrintDialog_disconnectNotify(vtbl: pointer, inst: pointer, signal: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQAbstractPrintDialog](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
  let slotval1 = gen_qmetaobject_types.QMetaMethod(h: signal, owned: false)
...
proc create*(T: type gen_qabstractprintdialog_types.QAbstractPrintDialog,
  ...
  gen_qabstractprintdialog_types.QAbstractPrintDialog(h: fcQAbstractPrintDialog_new(addr(vtbl[].vtbl), printer.h), owned: true)
...
proc create*(T: type gen_qabstractprintdialog_types.QAbstractPrintDialog,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = miqt_exec_callback_cQAbstractPrintDialog_disconnectNotify
  gen_qabstractprintdialog_types.QAbstractPrintDialog(h: fcQAbstractPrintDialog_new2(addr(vtbl[].vtbl), printer.h, parent.h), owned: true)

proc create*(T: type gen_qabstractprintdialog_types.QAbstractPrintDialog,
    printer: gen_qprinter_types.QPrinter,
    vtbl: VirtualQAbstractPrintDialog) =

  vtbl[].vtbl.destructor = proc(vtbl: ptr cQAbstractPrintDialogVTable, _: ptr cQAbstractPrintDialog) {.cdecl.} =
    let vtbl = cast[ptr typeof(VirtualQAbstractPrintDialog()[])](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractPrintDialog, vtbl)))
    vtbl[].h = nil
    vtbl[].owned = false
  vtbl[].vtbl.metaObject = miqt_exec_method_cQAbstractPrintDialog_metaObject
  vtbl[].vtbl.metacast = miqt_exec_method_cQAbstractPrintDialog_metacast
  vtbl[].vtbl.metacall = miqt_exec_method_cQAbstractPrintDialog_metacall
  vtbl[].vtbl.setVisible = miqt_exec_method_cQAbstractPrintDialog_setVisible
  vtbl[].vtbl.sizeHint = miqt_exec_method_cQAbstractPrintDialog_sizeHint
  vtbl[].vtbl.minimumSizeHint = miqt_exec_method_cQAbstractPrintDialog_minimumSizeHint
  vtbl[].vtbl.open = miqt_exec_method_cQAbstractPrintDialog_open
  vtbl[].vtbl.exec = miqt_exec_method_cQAbstractPrintDialog_exec
  vtbl[].vtbl.done = miqt_exec_method_cQAbstractPrintDialog_done
  vtbl[].vtbl.accept = miqt_exec_method_cQAbstractPrintDialog_accept
  vtbl[].vtbl.reject = miqt_exec_method_cQAbstractPrintDialog_reject
  vtbl[].vtbl.keyPressEvent = miqt_exec_method_cQAbstractPrintDialog_keyPressEvent
  vtbl[].vtbl.closeEvent = miqt_exec_method_cQAbstractPrintDialog_closeEvent
  vtbl[].vtbl.showEvent = miqt_exec_method_cQAbstractPrintDialog_showEvent
  vtbl[].vtbl.resizeEvent = miqt_exec_method_cQAbstractPrintDialog_resizeEvent
  vtbl[].vtbl.contextMenuEvent = miqt_exec_method_cQAbstractPrintDialog_contextMenuEvent
  vtbl[].vtbl.eventFilter = miqt_exec_method_cQAbstractPrintDialog_eventFilter
  vtbl[].vtbl.devType = miqt_exec_method_cQAbstractPrintDialog_devType
  vtbl[].vtbl.heightForWidth = miqt_exec_method_cQAbstractPrintDialog_heightForWidth
  vtbl[].vtbl.hasHeightForWidth = miqt_exec_method_cQAbstractPrintDialog_hasHeightForWidth
  vtbl[].vtbl.paintEngine = miqt_exec_method_cQAbstractPrintDialog_paintEngine
  vtbl[].vtbl.event = miqt_exec_method_cQAbstractPrintDialog_event
  vtbl[].vtbl.mousePressEvent = miqt_exec_method_cQAbstractPrintDialog_mousePressEvent
  vtbl[].vtbl.mouseReleaseEvent = miqt_exec_method_cQAbstractPrintDialog_mouseReleaseEvent
  vtbl[].vtbl.mouseDoubleClickEvent = miqt_exec_method_cQAbstractPrintDialog_mouseDoubleClickEvent
  vtbl[].vtbl.mouseMoveEvent = miqt_exec_method_cQAbstractPrintDialog_mouseMoveEvent
  vtbl[].vtbl.wheelEvent = miqt_exec_method_cQAbstractPrintDialog_wheelEvent
  vtbl[].vtbl.keyReleaseEvent = miqt_exec_method_cQAbstractPrintDialog_keyReleaseEvent
  vtbl[].vtbl.focusInEvent = miqt_exec_method_cQAbstractPrintDialog_focusInEvent
  vtbl[].vtbl.focusOutEvent = miqt_exec_method_cQAbstractPrintDialog_focusOutEvent
  vtbl[].vtbl.enterEvent = miqt_exec_method_cQAbstractPrintDialog_enterEvent
  vtbl[].vtbl.leaveEvent = miqt_exec_method_cQAbstractPrintDialog_leaveEvent
  vtbl[].vtbl.paintEvent = miqt_exec_method_cQAbstractPrintDialog_paintEvent
  vtbl[].vtbl.moveEvent = miqt_exec_method_cQAbstractPrintDialog_moveEvent
  vtbl[].vtbl.tabletEvent = miqt_exec_method_cQAbstractPrintDialog_tabletEvent
  vtbl[].vtbl.actionEvent = miqt_exec_method_cQAbstractPrintDialog_actionEvent
  vtbl[].vtbl.dragEnterEvent = miqt_exec_method_cQAbstractPrintDialog_dragEnterEvent
  vtbl[].vtbl.dragMoveEvent = miqt_exec_method_cQAbstractPrintDialog_dragMoveEvent
  vtbl[].vtbl.dragLeaveEvent = miqt_exec_method_cQAbstractPrintDialog_dragLeaveEvent
  vtbl[].vtbl.dropEvent = miqt_exec_method_cQAbstractPrintDialog_dropEvent
  vtbl[].vtbl.hideEvent = miqt_exec_method_cQAbstractPrintDialog_hideEvent
  vtbl[].vtbl.nativeEvent = miqt_exec_method_cQAbstractPrintDialog_nativeEvent
  vtbl[].vtbl.changeEvent = miqt_exec_method_cQAbstractPrintDialog_changeEvent
  vtbl[].vtbl.metric = miqt_exec_method_cQAbstractPrintDialog_metric
  vtbl[].vtbl.initPainter = miqt_exec_method_cQAbstractPrintDialog_initPainter
  vtbl[].vtbl.redirected = miqt_exec_method_cQAbstractPrintDialog_redirected
  vtbl[].vtbl.sharedPainter = miqt_exec_method_cQAbstractPrintDialog_sharedPainter
  vtbl[].vtbl.inputMethodEvent = miqt_exec_method_cQAbstractPrintDialog_inputMethodEvent
  vtbl[].vtbl.inputMethodQuery = miqt_exec_method_cQAbstractPrintDialog_inputMethodQuery
  vtbl[].vtbl.focusNextPrevChild = miqt_exec_method_cQAbstractPrintDialog_focusNextPrevChild
  vtbl[].vtbl.timerEvent = miqt_exec_method_cQAbstractPrintDialog_timerEvent
  vtbl[].vtbl.childEvent = miqt_exec_method_cQAbstractPrintDialog_childEvent
  vtbl[].vtbl.customEvent = miqt_exec_method_cQAbstractPrintDialog_customEvent
  vtbl[].vtbl.connectNotify = miqt_exec_method_cQAbstractPrintDialog_connectNotify
  vtbl[].vtbl.disconnectNotify = miqt_exec_method_cQAbstractPrintDialog_disconnectNotify
  if vtbl[].h != nil: delete(move(vtbl[]))
  vtbl[].h = fcQAbstractPrintDialog_new(addr(vtbl[].vtbl), printer.h)
  vtbl[].owned = true
...
proc create*(T: type gen_qabstractprintdialog_types.QAbstractPrintDialog,
  ...
  vtbl[].vtbl.disconnectNotify = miqt_exec_method_cQAbstractPrintDialog_disconnectNotify
  if vtbl[].h != nil: delete(move(vtbl[]))
  vtbl[].h = fcQAbstractPrintDialog_new2(addr(vtbl[].vtbl), printer.h, parent.h)
  vtbl[].owned = true
