...
proc fcQAbstractPrintDialog_trUtf8S(s: cstring): struct_seaqt_string {.importc: "QAbstractPrintDialog_trUtf8_s".}
...
proc fcQAbstractPrintDialog_trUtf8SC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QAbstractPrintDialog_trUtf8_s_c".}
proc fcQAbstractPrintDialog_trUtf8SCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QAbstractPrintDialog_trUtf8_s_c_n".}
...
proc fcQAbstractPrintDialog_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.importc: "QAbstractPrintDialog_virtualbase_nativeEvent".}
...
proc trUtf8*(_: type gen_qabstractprintdialog_types.QAbstractPrintDialog, s: cstring): string =
  let v_ms = fcQAbstractPrintDialog_trUtf8S(s)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc setOptionTabs*(self: gen_qabstractprintdialog_types.QAbstractPrintDialog, tabs: openArray[gen_qwidget_types.QWidget]): void =
  ...
  fcQAbstractPrintDialog_setOptionTabs(self.h, struct_seaqt_array(len: csize_t(len(tabs)), data: if len(tabs) == 0: nil else: addr(tabs_CArray[0])))
...
proc QAbstractPrintDialognativeEvent*(self: gen_qabstractprintdialog_types.QAbstractPrintDialog, eventType: openArray[byte], message: pointer, resultVal: ptr clong): bool =
  fcQAbstractPrintDialog_virtualbase_nativeEvent(self.h, struct_seaqt_string(data: if len(eventType) > 0: addr eventType[0] else: nil, len: csize_t(len(eventType))), message, resultVal)
...
proc fcQAbstractPrintDialog_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let vtbl = cast[ptr QAbstractPrintDialogVTable](fcQAbstractPrintDialog_vdata(self)[])
  let self = QAbstractPrintDialog(h: self)
...
proc fcQAbstractPrintDialog_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let inst = cast[VirtualQAbstractPrintDialog](fcQAbstractPrintDialog_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc create*(T: type gen_qabstractprintdialog_types.QAbstractPrintDialog,
  ...
  let tmp = gen_qabstractprintdialog_types.QAbstractPrintDialog(h: fcQAbstractPrintDialog_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), printer.h), owned: true)
  fcQAbstractPrintDialog_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qabstractprintdialog_types.QAbstractPrintDialog,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQAbstractPrintDialog_vtable_callback_disconnectNotify
  let tmp = gen_qabstractprintdialog_types.QAbstractPrintDialog(h: fcQAbstractPrintDialog_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), printer.h, parent.h), owned: true)
  fcQAbstractPrintDialog_vdata(tmp.h)[] = addr(vtbl[])
  tmp
