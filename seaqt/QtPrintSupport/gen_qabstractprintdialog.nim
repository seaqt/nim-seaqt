...
proc fcQAbstractPrintDialog_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.importc: "QAbstractPrintDialog_virtualbase_nativeEvent".}
...
proc fcQAbstractPrintDialog_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QAbstractPrintDialog_protectedbase_getDecodedMetricF".}
...
proc fcQAbstractPrintDialog_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QAbstractPrintDialogVTable](fcQAbstractPrintDialog_vdata(self)[])
  let self = QAbstractPrintDialog(h: self)
...
proc fcQAbstractPrintDialog_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let inst = cast[VirtualQAbstractPrintDialog](fcQAbstractPrintDialog_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc getDecodedMetricF*(self: gen_qabstractprintdialog_types.QAbstractPrintDialog, metricA: cint, metricB: cint): float64 =
  fcQAbstractPrintDialog_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
