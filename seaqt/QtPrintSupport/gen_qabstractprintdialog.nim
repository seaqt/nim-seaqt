...
proc fcQAbstractPrintDialog_trUtf8(s: cstring): struct_seaqt_string {.importc: "QAbstractPrintDialog_trUtf8".}
...
proc fcQAbstractPrintDialog_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QAbstractPrintDialog_trUtf82".}
proc fcQAbstractPrintDialog_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QAbstractPrintDialog_trUtf83".}
