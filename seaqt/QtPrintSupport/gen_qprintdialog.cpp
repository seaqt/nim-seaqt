...
public:
	...
	friend bool QPrintDialog_virtualbase_nativeEvent(VirtualQPrintDialog* self, struct miqt_string eventType, void* message, intptr_t* result);
...
VirtualQPrintDialog* QPrintDialog_new(const QPrintDialog_VTable* vtbl, size_t vdata, QWidget* parent) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQPrintDialog>());
