...
proc fcQPrintPreviewWidget_new(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQPrintPreviewWidget {.importc: "QPrintPreviewWidget_new".}
proc fcQPrintPreviewWidget_new2(vtbl: pointer, vdata: csize_t, printer: pointer): ptr cQPrintPreviewWidget {.importc: "QPrintPreviewWidget_new2".}
proc fcQPrintPreviewWidget_new3(vtbl: pointer, vdata: csize_t): ptr cQPrintPreviewWidget {.importc: "QPrintPreviewWidget_new3".}
proc fcQPrintPreviewWidget_new4(vtbl: pointer, vdata: csize_t, printer: pointer, parent: pointer): ptr cQPrintPreviewWidget {.importc: "QPrintPreviewWidget_new4".}
proc fcQPrintPreviewWidget_new5(vtbl: pointer, vdata: csize_t, printer: pointer, parent: pointer, flags: cint): ptr cQPrintPreviewWidget {.importc: "QPrintPreviewWidget_new5".}
