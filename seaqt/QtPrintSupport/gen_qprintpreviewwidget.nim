...
proc fcQPrintPreviewWidget_trUtf8(s: cstring): struct_seaqt_string {.importc: "QPrintPreviewWidget_trUtf8".}
...
proc fcQPrintPreviewWidget_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QPrintPreviewWidget_trUtf82".}
proc fcQPrintPreviewWidget_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QPrintPreviewWidget_trUtf83".}
