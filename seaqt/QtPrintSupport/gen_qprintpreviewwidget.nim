...
proc fcQPrintPreviewWidget_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QPrintPreviewWidget_protectedbase_getDecodedMetricF".}
...
proc getDecodedMetricF*(self: gen_qprintpreviewwidget_types.QPrintPreviewWidget, metricA: cint, metricB: cint): float64 =
  fcQPrintPreviewWidget_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
...
proc create*(T: type gen_qprintpreviewwidget_types.QPrintPreviewWidget,
  ...
  let tmp = gen_qprintpreviewwidget_types.QPrintPreviewWidget(h: fcQPrintPreviewWidget_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), printer.h), owned: true)
...
proc create*(T: type gen_qprintpreviewwidget_types.QPrintPreviewWidget,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQPrintPreviewWidget_vtable_callback_disconnectNotify
  let tmp = gen_qprintpreviewwidget_types.QPrintPreviewWidget(h: fcQPrintPreviewWidget_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQPrintPreviewWidget_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qprintpreviewwidget_types.QPrintPreviewWidget,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQPrintPreviewWidget_vtable_callback_disconnectNotify
  let tmp = gen_qprintpreviewwidget_types.QPrintPreviewWidget(h: fcQPrintPreviewWidget_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), printer.h, parent.h), owned: true)
  fcQPrintPreviewWidget_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qprintpreviewwidget_types.QPrintPreviewWidget,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQPrintPreviewWidget_vtable_callback_disconnectNotify
  let tmp = gen_qprintpreviewwidget_types.QPrintPreviewWidget(h: fcQPrintPreviewWidget_new4(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), printer.h, parent.h, cint(flags)), owned: true)
  fcQPrintPreviewWidget_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qprintpreviewwidget_types.QPrintPreviewWidget,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQPrintPreviewWidget_vtable_callback_disconnectNotify
  let tmp = gen_qprintpreviewwidget_types.QPrintPreviewWidget(h: fcQPrintPreviewWidget_new5(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQPrintPreviewWidget_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qprintpreviewwidget_types.QPrintPreviewWidget,
...
proc create*(T: type gen_qprintpreviewwidget_types.QPrintPreviewWidget,
  ...
  inst[].h = fcQPrintPreviewWidget_new(addr(cQPrintPreviewWidget_mvtbl), csize_t(sizeof(pointer)), printer.h)
...
proc create*(T: type gen_qprintpreviewwidget_types.QPrintPreviewWidget,
    inst: VirtualQPrintPreviewWidget) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQPrintPreviewWidget_new2(addr(cQPrintPreviewWidget_mvtbl), csize_t(sizeof(pointer)))
  fcQPrintPreviewWidget_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qprintpreviewwidget_types.QPrintPreviewWidget,
    ...
    inst: VirtualQPrintPreviewWidget) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQPrintPreviewWidget_new3(addr(cQPrintPreviewWidget_mvtbl), csize_t(sizeof(pointer)), printer.h, parent.h)
  fcQPrintPreviewWidget_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qprintpreviewwidget_types.QPrintPreviewWidget,
    ...
    inst: VirtualQPrintPreviewWidget) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQPrintPreviewWidget_new4(addr(cQPrintPreviewWidget_mvtbl), csize_t(sizeof(pointer)), printer.h, parent.h, cint(flags))
  fcQPrintPreviewWidget_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qprintpreviewwidget_types.QPrintPreviewWidget,
    ...
    inst: VirtualQPrintPreviewWidget) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQPrintPreviewWidget_new5(addr(cQPrintPreviewWidget_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQPrintPreviewWidget_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
