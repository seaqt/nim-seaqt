...
proc fcQPrintPreviewWidget_trUtf8S(s: cstring): struct_seaqt_string {.importc: "QPrintPreviewWidget_trUtf8_s".}
...
proc fcQPrintPreviewWidget_trUtf8SC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QPrintPreviewWidget_trUtf8_s_c".}
proc fcQPrintPreviewWidget_trUtf8SCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QPrintPreviewWidget_trUtf8_s_c_n".}
...
proc fcQPrintPreviewWidget_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.importc: "QPrintPreviewWidget_virtualbase_nativeEvent".}
...
proc trUtf8*(_: type gen_qprintpreviewwidget_types.QPrintPreviewWidget, s: cstring): string =
  let v_ms = fcQPrintPreviewWidget_trUtf8S(s)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc fcQPrintPreviewWidget_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let vtbl = cast[ptr QPrintPreviewWidgetVTable](fcQPrintPreviewWidget_vdata(self)[])
  let self = QPrintPreviewWidget(h: self)
...
proc fcQPrintPreviewWidget_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let inst = cast[VirtualQPrintPreviewWidget](fcQPrintPreviewWidget_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
