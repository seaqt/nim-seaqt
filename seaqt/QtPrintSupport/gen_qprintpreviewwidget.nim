...
proc fcQPrintPreviewWidget_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.importc: "QPrintPreviewWidget_virtualbase_nativeEvent".}
...
proc fcQPrintPreviewWidget_new(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQPrintPreviewWidget {.importc: "QPrintPreviewWidget_new_parent".}
proc fcQPrintPreviewWidget_new2(vtbl: pointer, vdata: csize_t, printer: pointer): ptr cQPrintPreviewWidget {.importc: "QPrintPreviewWidget_new_printer".}
proc fcQPrintPreviewWidget_new3(vtbl: pointer, vdata: csize_t): ptr cQPrintPreviewWidget {.importc: "QPrintPreviewWidget_new".}
proc fcQPrintPreviewWidget_new4(vtbl: pointer, vdata: csize_t, printer: pointer, parent: pointer): ptr cQPrintPreviewWidget {.importc: "QPrintPreviewWidget_new_printer_parent".}
proc fcQPrintPreviewWidget_new5(vtbl: pointer, vdata: csize_t, printer: pointer, parent: pointer, flags: cint): ptr cQPrintPreviewWidget {.importc: "QPrintPreviewWidget_new_printer_parent_flags".}
...
proc QPrintPreviewWidgetnativeEvent*(self: gen_qprintpreviewwidget_types.QPrintPreviewWidget, eventType: openArray[byte], message: pointer, resultVal: ptr uint): bool =
  fcQPrintPreviewWidget_virtualbase_nativeEvent(self.h, struct_seaqt_string(data: if len(eventType) > 0: addr eventType[0] else: nil, len: csize_t(len(eventType))), message, resultVal)
...
proc fcQPrintPreviewWidget_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QPrintPreviewWidgetVTable](fcQPrintPreviewWidget_vdata(self)[])
  let self = QPrintPreviewWidget(h: self)
...
proc fcQPrintPreviewWidget_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let inst = cast[VirtualQPrintPreviewWidget](fcQPrintPreviewWidget_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc create*(T: type gen_qprintpreviewwidget_types.QPrintPreviewWidget,
  ...
  let tmp = gen_qprintpreviewwidget_types.QPrintPreviewWidget(h: fcQPrintPreviewWidget_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQPrintPreviewWidget_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qprintpreviewwidget_types.QPrintPreviewWidget,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQPrintPreviewWidget_vtable_callback_disconnectNotify
  let tmp = gen_qprintpreviewwidget_types.QPrintPreviewWidget(h: fcQPrintPreviewWidget_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), printer.h), owned: true)
  fcQPrintPreviewWidget_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qprintpreviewwidget_types.QPrintPreviewWidget,
    vtbl: ref QPrintPreviewWidgetVTable = nil): gen_qprintpreviewwidget_types.QPrintPreviewWidget =
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQPrintPreviewWidget_vtable_callback_disconnectNotify
  let tmp = gen_qprintpreviewwidget_types.QPrintPreviewWidget(h: fcQPrintPreviewWidget_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQPrintPreviewWidget_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qprintpreviewwidget_types.QPrintPreviewWidget,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQPrintPreviewWidget_vtable_callback_disconnectNotify
  let tmp = gen_qprintpreviewwidget_types.QPrintPreviewWidget(h: fcQPrintPreviewWidget_new4(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), printer.h, parent.h), owned: true)
  fcQPrintPreviewWidget_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qprintpreviewwidget_types.QPrintPreviewWidget,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQPrintPreviewWidget_vtable_callback_disconnectNotify
  let tmp = gen_qprintpreviewwidget_types.QPrintPreviewWidget(h: fcQPrintPreviewWidget_new5(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), printer.h, parent.h, cint(flags)), owned: true)
  fcQPrintPreviewWidget_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qprintpreviewwidget_types.QPrintPreviewWidget,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQPrintPreviewWidget_vtable_callback_disconnectNotify
  let tmp = gen_qprintpreviewwidget_types.QPrintPreviewWidget(h: fcQPrintPreviewWidget_new6(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h, cint(flags)), owned: true)
  fcQPrintPreviewWidget_vdata(tmp.h)[] = addr(vtbl[])
  tmp
...
proc create*(T: type gen_qprintpreviewwidget_types.QPrintPreviewWidget,
  ...
  inst[].h = fcQPrintPreviewWidget_new(addr(cQPrintPreviewWidget_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQPrintPreviewWidget_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qprintpreviewwidget_types.QPrintPreviewWidget,
    ...
    inst: VirtualQPrintPreviewWidget) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQPrintPreviewWidget_new2(addr(cQPrintPreviewWidget_mvtbl), csize_t(sizeof(pointer)), printer.h)
  fcQPrintPreviewWidget_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qprintpreviewwidget_types.QPrintPreviewWidget,
    inst: VirtualQPrintPreviewWidget) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQPrintPreviewWidget_new3(addr(cQPrintPreviewWidget_mvtbl), csize_t(sizeof(pointer)))
  fcQPrintPreviewWidget_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qprintpreviewwidget_types.QPrintPreviewWidget,
    ...
    inst: VirtualQPrintPreviewWidget) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQPrintPreviewWidget_new4(addr(cQPrintPreviewWidget_mvtbl), csize_t(sizeof(pointer)), printer.h, parent.h)
  fcQPrintPreviewWidget_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qprintpreviewwidget_types.QPrintPreviewWidget,
    ...
    inst: VirtualQPrintPreviewWidget) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQPrintPreviewWidget_new5(addr(cQPrintPreviewWidget_mvtbl), csize_t(sizeof(pointer)), printer.h, parent.h, cint(flags))
  fcQPrintPreviewWidget_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qprintpreviewwidget_types.QPrintPreviewWidget,
    ...
    inst: VirtualQPrintPreviewWidget) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQPrintPreviewWidget_new6(addr(cQPrintPreviewWidget_mvtbl), csize_t(sizeof(pointer)), parent.h, cint(flags))
  fcQPrintPreviewWidget_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
