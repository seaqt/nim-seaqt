...
type QCommandLineParserMessageTypeEnum* = distinct cint
template Information*(_: type QCommandLineParserMessageTypeEnum): untyped = 0
template Error*(_: type QCommandLineParserMessageTypeEnum): untyped = 1
...
proc fcQCommandLineParser_showMessageAndExitTypeMessage(typeVal: cint, message: struct_seaqt_string): void {.importc: "QCommandLineParser_showMessageAndExit_type_message".}
...
proc fcQCommandLineParser_showMessageAndExitTypeMessageExitCode(typeVal: cint, message: struct_seaqt_string, exitCode: cint): void {.importc: "QCommandLineParser_showMessageAndExit_type_message_exitCode".}
...
proc showMessageAndExit*(_: type gen_qcommandlineparser_types.QCommandLineParser, typeVal: cint, message: openArray[char]): void =
  fcQCommandLineParser_showMessageAndExitTypeMessage(cint(typeVal), struct_seaqt_string(data: if len(message) > 0: addr message[0] else: nil, len: csize_t(len(message))))
...
proc showMessageAndExit*(_: type gen_qcommandlineparser_types.QCommandLineParser, typeVal: cint, message: openArray[char], exitCode: cint): void =
  fcQCommandLineParser_showMessageAndExitTypeMessageExitCode(cint(typeVal), struct_seaqt_string(data: if len(message) > 0: addr message[0] else: nil, len: csize_t(len(message))), exitCode)
