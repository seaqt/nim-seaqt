...
proc mimeTypeForName*(self: gen_qmimedatabase_types.QMimeDatabase, nameOrAlias: openArray[char]): gen_qmimetype_types.QMimeType =
  gen_qmimetype_types.QMimeType(h: fcQMimeDatabase_mimeTypeForName(self.h, struct_seaqt_string(data: if len(nameOrAlias) > 0: addr nameOrAlias[0] else: nil, len: csize_t(len(nameOrAlias)))))

proc mimeTypeForFile*(self: gen_qmimedatabase_types.QMimeDatabase, fileName: openArray[char]): gen_qmimetype_types.QMimeType =
  gen_qmimetype_types.QMimeType(h: fcQMimeDatabase_mimeTypeForFile(self.h, struct_seaqt_string(data: if len(fileName) > 0: addr fileName[0] else: nil, len: csize_t(len(fileName)))))
...
proc mimeTypeForData*(self: gen_qmimedatabase_types.QMimeDatabase, data: openArray[byte]): gen_qmimetype_types.QMimeType =
  gen_qmimetype_types.QMimeType(h: fcQMimeDatabase_mimeTypeForData(self.h, struct_seaqt_string(data: if len(data) > 0: addr data[0] else: nil, len: csize_t(len(data)))))
...
proc mimeTypeForFileNameAndData*(self: gen_qmimedatabase_types.QMimeDatabase, fileName: openArray[char], device: gen_qiodevice_types.QIODevice): gen_qmimetype_types.QMimeType =
  gen_qmimetype_types.QMimeType(h: fcQMimeDatabase_mimeTypeForFileNameAndData(self.h, struct_seaqt_string(data: if len(fileName) > 0: addr fileName[0] else: nil, len: csize_t(len(fileName))), device.h))
...
proc mimeTypeForFileNameAndData*(self: gen_qmimedatabase_types.QMimeDatabase, fileName: openArray[char], data: openArray[byte]): gen_qmimetype_types.QMimeType =
  gen_qmimetype_types.QMimeType(h: fcQMimeDatabase_mimeTypeForFileNameAndData2(self.h, struct_seaqt_string(data: if len(fileName) > 0: addr fileName[0] else: nil, len: csize_t(len(fileName))), struct_seaqt_string(data: if len(data) > 0: addr data[0] else: nil, len: csize_t(len(data)))))
...
proc mimeTypeForFile*(self: gen_qmimedatabase_types.QMimeDatabase, fileName: openArray[char], mode: cint): gen_qmimetype_types.QMimeType =
  gen_qmimetype_types.QMimeType(h: fcQMimeDatabase_mimeTypeForFile2(self.h, struct_seaqt_string(data: if len(fileName) > 0: addr fileName[0] else: nil, len: csize_t(len(fileName))), cint(mode)))
...
proc mimeTypeForFile*(self: gen_qmimedatabase_types.QMimeDatabase, fileInfo: gen_qfileinfo_types.QFileInfo, mode: cint): gen_qmimetype_types.QMimeType =
  gen_qmimetype_types.QMimeType(h: fcQMimeDatabase_mimeTypeForFile3(self.h, fileInfo.h, cint(mode)))

proc create*(T: type gen_qmimedatabase_types.QMimeDatabase): gen_qmimedatabase_types.QMimeDatabase =
  let tmp = gen_qmimedatabase_types.QMimeDatabase(h: fcQMimeDatabase_new())
  tmp
