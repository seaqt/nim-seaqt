...
public:
	...
	VirtualQSocketNotifier(const QSocketNotifier_VTable* vtbl, void* vdata, QSocketNotifier::Type param1): QSocketNotifier(param1), vtbl(vtbl), vdata(vdata) {}
	...
	VirtualQSocketNotifier(const QSocketNotifier_VTable* vtbl, void* vdata, QSocketNotifier::Type param1, QObject* parent): QSocketNotifier(param1, parent), vtbl(vtbl), vdata(vdata) {}
...
VirtualQSocketNotifier* QSocketNotifier_new(const QSocketNotifier_VTable* vtbl, void* vdata, int param1) {
	return new VirtualQSocketNotifier(vtbl, vdata, static_cast<QSocketNotifier::Type>(param1));
}

VirtualQSocketNotifier* QSocketNotifier_new2(const QSocketNotifier_VTable* vtbl, void* vdata, intptr_t socket, int param2) {
	return new VirtualQSocketNotifier(vtbl, vdata, (qintptr)(socket), static_cast<QSocketNotifier::Type>(param2));
}

VirtualQSocketNotifier* QSocketNotifier_new3(const QSocketNotifier_VTable* vtbl, void* vdata, int param1, QObject* parent) {
	return new VirtualQSocketNotifier(vtbl, vdata, static_cast<QSocketNotifier::Type>(param1), parent);
}

VirtualQSocketNotifier* QSocketNotifier_new4(const QSocketNotifier_VTable* vtbl, void* vdata, intptr_t socket, int param2, QObject* parent) {
