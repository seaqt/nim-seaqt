...
proc fcQCborError_c(self: pointer): cint {.importc: "QCborError_c".}
proc fcQCborError_setC(self: pointer, c: cint): void {.importc: "QCborError_setC".}
...
proc c*(self: gen_qcborcommon_types.QCborError): cint =
  cint(fcQCborError_c(self.h))

proc setC*(self: gen_qcborcommon_types.QCborError, c: cint): void =
  fcQCborError_setC(self.h, cint(c))
