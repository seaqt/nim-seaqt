...
proc fcQTimeZone_new6(zoneId: struct_seaqt_string, offsetSeconds: cint, name: struct_seaqt_string, abbreviation: struct_seaqt_string, territory: cint): ptr cQTimeZone {.importc: "QTimeZone_new_zoneId_offsetSeconds_name_abbreviation_territory".}
proc fcQTimeZone_new7(zoneId: struct_seaqt_string, offsetSeconds: cint, name: struct_seaqt_string, abbreviation: struct_seaqt_string, territory: cint, comment: struct_seaqt_string): ptr cQTimeZone {.importc: "QTimeZone_new_zoneId_offsetSeconds_name_abbreviation_territory_comment".}
