...
type QTimeZoneInitializationEnum* = distinct cint
template LocalTime*(_: type QTimeZoneInitializationEnum): untyped = 0
template UTC*(_: type QTimeZoneInitializationEnum): untyped = 1
...
proc fcQTimeZone_fromSecondsAheadOfUtc(offset: cint): pointer {.importc: "QTimeZone_fromSecondsAheadOfUtc".}
proc fcQTimeZone_timeSpec(self: pointer): cint {.importc: "QTimeZone_timeSpec".}
proc fcQTimeZone_fixedSecondsAheadOfUtc(self: pointer): cint {.importc: "QTimeZone_fixedSecondsAheadOfUtc".}
proc fcQTimeZone_isUtcOrFixedOffsetSpec(spec: cint): bool {.importc: "QTimeZone_isUtcOrFixedOffset_spec".}
proc fcQTimeZone_isUtcOrFixedOffset(self: pointer): bool {.importc: "QTimeZone_isUtcOrFixedOffset".}
proc fcQTimeZone_asBackendZone(self: pointer): pointer {.importc: "QTimeZone_asBackendZone".}
proc fcQTimeZone_hasAlternativeName(self: pointer, alias: struct_seaqt_string): bool {.importc: "QTimeZone_hasAlternativeName".}
...
proc fcQTimeZone_availableTimeZoneIdsTerritory(territory: cint): struct_seaqt_array {.importc: "QTimeZone_availableTimeZoneIds_territory".}
...
proc fcQTimeZone_windowsIdToDefaultIanaIdWindowsIdTerritory(windowsId: struct_seaqt_string, territory: cint): struct_seaqt_string {.importc: "QTimeZone_windowsIdToDefaultIanaId_windowsId_territory".}
...
proc fcQTimeZone_windowsIdToIanaIdsWindowsIdTerritory(windowsId: struct_seaqt_string, territory: cint): struct_seaqt_array {.importc: "QTimeZone_windowsIdToIanaIds_windowsId_territory".}
...
proc fcQTimeZone_new2(spec: cint): ptr cQTimeZone {.importc: "QTimeZone_new_spec".}
proc fcQTimeZone_new3(offsetSeconds: cint): ptr cQTimeZone {.importc: "QTimeZone_new_offsetSeconds".}
proc fcQTimeZone_new4(ianaId: struct_seaqt_string): ptr cQTimeZone {.importc: "QTimeZone_new_ianaId".}
proc fcQTimeZone_new5(zoneId: struct_seaqt_string, offsetSeconds: cint, name: struct_seaqt_string, abbreviation: struct_seaqt_string): ptr cQTimeZone {.importc: "QTimeZone_new_zoneId_offsetSeconds_name_abbreviation".}
proc fcQTimeZone_new6(fromVal: pointer): ptr cQTimeZone {.importc: "QTimeZone_new_from".}
proc fcQTimeZone_new7(zoneId: struct_seaqt_string, offsetSeconds: cint, name: struct_seaqt_string, abbreviation: struct_seaqt_string, territory: cint): ptr cQTimeZone {.importc: "QTimeZone_new_zoneId_offsetSeconds_name_abbreviation_territory".}
proc fcQTimeZone_new8(zoneId: struct_seaqt_string, offsetSeconds: cint, name: struct_seaqt_string, abbreviation: struct_seaqt_string, territory: cint, comment: struct_seaqt_string): ptr cQTimeZone {.importc: "QTimeZone_new_zoneId_offsetSeconds_name_abbreviation_territory_comment".}
...
proc fcQTimeZoneOffsetData_new(fromVal: pointer): ptr cQTimeZoneOffsetData {.importc: "QTimeZone__OffsetData_new_from".}
proc fcQTimeZoneOffsetData_new2(): ptr cQTimeZoneOffsetData {.importc: "QTimeZone__OffsetData_new".}
...
proc fromSecondsAheadOfUtc*(_: type gen_qtimezone_types.QTimeZone, offset: cint): gen_qtimezone_types.QTimeZone =
  gen_qtimezone_types.QTimeZone(h: fcQTimeZone_fromSecondsAheadOfUtc(offset), owned: true)

proc timeSpec*(self: gen_qtimezone_types.QTimeZone): cint =
  cint(fcQTimeZone_timeSpec(self.h))

proc fixedSecondsAheadOfUtc*(self: gen_qtimezone_types.QTimeZone): cint =
  fcQTimeZone_fixedSecondsAheadOfUtc(self.h)

proc isUtcOrFixedOffset*(_: type gen_qtimezone_types.QTimeZone, spec: cint): bool =
  fcQTimeZone_isUtcOrFixedOffsetSpec(cint(spec))

proc isUtcOrFixedOffset*(self: gen_qtimezone_types.QTimeZone): bool =
  fcQTimeZone_isUtcOrFixedOffset(self.h)

proc asBackendZone*(self: gen_qtimezone_types.QTimeZone): gen_qtimezone_types.QTimeZone =
  gen_qtimezone_types.QTimeZone(h: fcQTimeZone_asBackendZone(self.h), owned: true)

proc hasAlternativeName*(self: gen_qtimezone_types.QTimeZone, alias: openArray[byte]): bool =
  fcQTimeZone_hasAlternativeName(self.h, struct_seaqt_string(data: if len(alias) > 0: addr alias[0] else: nil, len: csize_t(len(alias))))
...
proc availableTimeZoneIds*(_: type gen_qtimezone_types.QTimeZone, territory: cint): seq[seq[byte]] =
  var v_ma = fcQTimeZone_availableTimeZoneIdsTerritory(cint(territory))
  var vx_ret = newSeq[seq[byte]](int(v_ma.len))
  let v_outCast = cast[ptr UncheckedArray[struct_seaqt_string]](v_ma.data)
  for i in 0 ..< v_ma.len:
    var vx_lv_bytearray = v_outCast[i]
...
proc windowsIdToDefaultIanaId*(_: type gen_qtimezone_types.QTimeZone, windowsId: openArray[byte], territory: cint): seq[byte] =
  var v_bytearray = fcQTimeZone_windowsIdToDefaultIanaIdWindowsIdTerritory(struct_seaqt_string(data: if len(windowsId) > 0: addr windowsId[0] else: nil, len: csize_t(len(windowsId))), cint(territory))
  var vx_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](v_bytearray.data), 0, int(v_bytearray.len)-1))
  c_free(v_bytearray.data)
  vx_ret
...
proc windowsIdToIanaIds*(_: type gen_qtimezone_types.QTimeZone, windowsId: openArray[byte], territory: cint): seq[seq[byte]] =
  var v_ma = fcQTimeZone_windowsIdToIanaIdsWindowsIdTerritory(struct_seaqt_string(data: if len(windowsId) > 0: addr windowsId[0] else: nil, len: csize_t(len(windowsId))), cint(territory))
  var vx_ret = newSeq[seq[byte]](int(v_ma.len))
  let v_outCast = cast[ptr UncheckedArray[struct_seaqt_string]](v_ma.data)
  for i in 0 ..< v_ma.len:
    var vx_lv_bytearray = v_outCast[i]
...
proc create*(T: type gen_qtimezone_types.QTimeZone,
    spec: cint): gen_qtimezone_types.QTimeZone =
  let tmp = gen_qtimezone_types.QTimeZone(h: fcQTimeZone_new2(cint(spec)), owned: true)
  tmp
proc create2*(T: type gen_qtimezone_types.QTimeZone,
...
proc create*(T: type gen_qtimezone_types.QTimeZone,
  ...
  let tmp = gen_qtimezone_types.QTimeZone(h: fcQTimeZone_new8(struct_seaqt_string(data: if len(zoneId) > 0: addr zoneId[0] else: nil, len: csize_t(len(zoneId))), offsetSeconds, struct_seaqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name))), struct_seaqt_string(data: if len(abbreviation) > 0: addr abbreviation[0] else: nil, len: csize_t(len(abbreviation))), cint(territory), struct_seaqt_string(data: if len(comment) > 0: addr comment[0] else: nil, len: csize_t(len(comment)))), owned: true)
  tmp
...
proc create*(T: type gen_qtimezone_types.QTimeZoneOffsetData,
  ...
  tmp
proc create*(T: type gen_qtimezone_types.QTimeZoneOffsetData): gen_qtimezone_types.QTimeZoneOffsetData =
  let tmp = gen_qtimezone_types.QTimeZoneOffsetData(h: fcQTimeZoneOffsetData_new2(), owned: true)
  tmp
