...
proc fcQTimeZone_availableTimeZoneIdsWithTerritory(territory: cint): struct_seaqt_array {.importc: "QTimeZone_availableTimeZoneIdsWithTerritory".}
...
proc fcQTimeZone_windowsIdToDefaultIanaId2(windowsId: struct_seaqt_string, territory: cint): struct_seaqt_string {.importc: "QTimeZone_windowsIdToDefaultIanaId2".}
...
proc fcQTimeZone_windowsIdToIanaIds2(windowsId: struct_seaqt_string, territory: cint): struct_seaqt_array {.importc: "QTimeZone_windowsIdToIanaIds2".}
...
proc fcQTimeZone_new6(zoneId: struct_seaqt_string, offsetSeconds: cint, name: struct_seaqt_string, abbreviation: struct_seaqt_string, territory: cint): ptr cQTimeZone {.importc: "QTimeZone_new6".}
proc fcQTimeZone_new7(zoneId: struct_seaqt_string, offsetSeconds: cint, name: struct_seaqt_string, abbreviation: struct_seaqt_string, territory: cint, comment: struct_seaqt_string): ptr cQTimeZone {.importc: "QTimeZone_new7".}
...
proc windowsIdToDefaultIanaId*(_: type gen_qtimezone_types.QTimeZone, windowsId: openArray[byte], territory: cint): seq[byte] =
  var v_bytearray = fcQTimeZone_windowsIdToDefaultIanaId2(struct_seaqt_string(data: if len(windowsId) > 0: addr windowsId[0] else: nil, len: csize_t(len(windowsId))), cint(territory))
  var vx_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](v_bytearray.data), 0, int(v_bytearray.len)-1))
  c_free(v_bytearray.data)
  vx_ret
...
proc windowsIdToIanaIds*(_: type gen_qtimezone_types.QTimeZone, windowsId: openArray[byte], territory: cint): seq[seq[byte]] =
  var v_ma = fcQTimeZone_windowsIdToIanaIds2(struct_seaqt_string(data: if len(windowsId) > 0: addr windowsId[0] else: nil, len: csize_t(len(windowsId))), cint(territory))
  var vx_ret = newSeq[seq[byte]](int(v_ma.len))
  let v_outCast = cast[ptr UncheckedArray[struct_seaqt_string]](v_ma.data)
  for i in 0 ..< v_ma.len:
    var vx_lv_bytearray = v_outCast[i]
...
proc create*(T: type gen_qtimezone_types.QTimeZone): gen_qtimezone_types.QTimeZone =
  let tmp = gen_qtimezone_types.QTimeZone(h: fcQTimeZone_new())
  tmp
proc create*(T: type gen_qtimezone_types.QTimeZone,
    ianaId: openArray[byte]): gen_qtimezone_types.QTimeZone =
  let tmp = gen_qtimezone_types.QTimeZone(h: fcQTimeZone_new2(struct_seaqt_string(data: if len(ianaId) > 0: addr ianaId[0] else: nil, len: csize_t(len(ianaId)))))
  tmp
proc create*(T: type gen_qtimezone_types.QTimeZone,
    offsetSeconds: cint): gen_qtimezone_types.QTimeZone =
  let tmp = gen_qtimezone_types.QTimeZone(h: fcQTimeZone_new3(offsetSeconds))
  tmp
proc create*(T: type gen_qtimezone_types.QTimeZone,
...
proc create*(T: type gen_qtimezone_types.QTimeZone,
  ...
  let tmp = gen_qtimezone_types.QTimeZone(h: fcQTimeZone_new5(other.h))
  tmp
proc create*(T: type gen_qtimezone_types.QTimeZone,
...
proc atUtc*(self: gen_qtimezone_types.QTimeZoneOffsetData): gen_qdatetime_types.QDateTime =
  gen_qdatetime_types.QDateTime(h: fcQTimeZoneOffsetData_atUtc(self.h))
...
proc create*(T: type gen_qtimezone_types.QTimeZoneOffsetData,
  ...
  let tmp = gen_qtimezone_types.QTimeZoneOffsetData(h: fcQTimeZoneOffsetData_new(param1.h))
  tmp
