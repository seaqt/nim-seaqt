...
proc fcQMetaMethodReturnArgument_new(): ptr cQMetaMethodReturnArgument {.importc: "QMetaMethodReturnArgument_new".}
proc fcQMetaMethodReturnArgument_new2(fromVal: pointer): ptr cQMetaMethodReturnArgument {.importc: "QMetaMethodReturnArgument_new_from".}
...
proc create*(T: type gen_qobjectdefs_types.QMetaMethodReturnArgument): gen_qobjectdefs_types.QMetaMethodReturnArgument =
  let tmp = gen_qobjectdefs_types.QMetaMethodReturnArgument(h: fcQMetaMethodReturnArgument_new(), owned: true)
  tmp
proc create*(T: type gen_qobjectdefs_types.QMetaMethodReturnArgument,
    fromVal: gen_qobjectdefs_types.QMetaMethodReturnArgument): gen_qobjectdefs_types.QMetaMethodReturnArgument =
  let tmp = gen_qobjectdefs_types.QMetaMethodReturnArgument(h: fcQMetaMethodReturnArgument_new2(fromVal.h), owned: true)
  tmp
