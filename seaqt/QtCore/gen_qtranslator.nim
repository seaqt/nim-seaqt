...
proc fcQTranslator_trUtf8(s: cstring): struct_seaqt_string {.importc: "QTranslator_trUtf8".}
...
proc fcQTranslator_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QTranslator_trUtf82".}
proc fcQTranslator_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QTranslator_trUtf83".}
