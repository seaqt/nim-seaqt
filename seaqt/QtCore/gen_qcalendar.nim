...
proc fcQCalendar_matchCenturyToWeekday(self: pointer, parts: pointer, dow: cint): pointer {.importc: "QCalendar_matchCenturyToWeekday".}
...
proc fcQCalendar_new2(system: cint): ptr cQCalendar {.importc: "QCalendar_new_system".}
proc fcQCalendar_new3(name: struct_seaqt_string): ptr cQCalendar {.importc: "QCalendar_new_name".}
proc fcQCalendar_new4(id: pointer): ptr cQCalendar {.importc: "QCalendar_new_id".}
...
proc matchCenturyToWeekday*(self: gen_qcalendar_types.QCalendar, parts: gen_qcalendar_types.QCalendarYearMonthDay, dow: cint): gen_qdatetime_types.QDate =
  gen_qdatetime_types.QDate(h: fcQCalendar_matchCenturyToWeekday(self.h, parts.h, dow), owned: true)
...
proc create*(T: type gen_qcalendar_types.QCalendar,
  ...
  let tmp = gen_qcalendar_types.QCalendar(h: fcQCalendar_new3(struct_seaqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name)))), owned: true)
  tmp
proc create*(T: type gen_qcalendar_types.QCalendar,
    id: gen_qcalendar_types.QCalendarSystemId): gen_qcalendar_types.QCalendar =
  let tmp = gen_qcalendar_types.QCalendar(h: fcQCalendar_new4(id.h), owned: true)
  tmp
...
proc create*(T: type gen_qcalendar_types.QCalendarSystemId): gen_qcalendar_types.QCalendarSystemId =
  let tmp = gen_qcalendar_types.QCalendarSystemId(h: fcQCalendarSystemId_new(), owned: true)
  tmp
