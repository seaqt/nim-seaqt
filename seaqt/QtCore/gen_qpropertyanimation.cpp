...
VirtualQPropertyAnimation* QPropertyAnimation_new(const QPropertyAnimation_VTable* vtbl, size_t vdata) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQPropertyAnimation>());
	return _mem_ ? new (_mem_)VirtualQPropertyAnimation(vtbl) : nullptr;
}

VirtualQPropertyAnimation* QPropertyAnimation_new2(const QPropertyAnimation_VTable* vtbl, size_t vdata, QObject* target, struct miqt_string propertyName) {
...
VirtualQPropertyAnimation* QPropertyAnimation_new4(const QPropertyAnimation_VTable* vtbl, size_t vdata, QObject* target, struct miqt_string propertyName, QObject* parent) {
	QByteArray propertyName_QByteArray(propertyName.data, propertyName.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQPropertyAnimation>());
