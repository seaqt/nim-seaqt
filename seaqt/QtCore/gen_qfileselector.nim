...
proc fcQFileSelector_trUtf8(s: cstring): struct_seaqt_string {.importc: "QFileSelector_trUtf8".}
...
proc fcQFileSelector_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QFileSelector_trUtf82".}
proc fcQFileSelector_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QFileSelector_trUtf83".}
