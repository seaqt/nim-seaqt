...
proc fcQStringView_isUpper(self: pointer): bool {.importc: "QStringView_isUpper".}
proc fcQStringView_isLower(self: pointer): bool {.importc: "QStringView_isLower".}
...
proc fcQStringView_maxSize(self: pointer): int64 {.importc: "QStringView_max_size".}
...
proc fcQStringView_maxSize(): int64 {.importc: "QStringView_maxSize".}
...
proc isUpper*(self: gen_qstringview_types.QStringView): bool =
  fcQStringView_isUpper(self.h)

proc isLower*(self: gen_qstringview_types.QStringView): bool =
  fcQStringView_isLower(self.h)
...
proc maxSize*(self: gen_qstringview_types.QStringView): int64 =
  fcQStringView_maxSize(self.h)
...
proc maxSize2*(_: type gen_qstringview_types.QStringView): int64 =
  fcQStringView_maxSize()
