...
proc fcQStringView_lastIndexOf6(self: pointer, c: pointer, cs: cint): int64 {.importc: "QStringView_lastIndexOf6".}
proc fcQStringView_lastIndexOf7(self: pointer, c: pointer, fromVal: int64, cs: cint): int64 {.importc: "QStringView_lastIndexOf7".}
proc fcQStringView_indexOf8(self: pointer, re: pointer, fromVal: int64): int64 {.importc: "QStringView_indexOf8".}
proc fcQStringView_indexOf9(self: pointer, re: pointer, fromVal: int64, rmatch: pointer): int64 {.importc: "QStringView_indexOf9".}
proc fcQStringView_lastIndexOf12(self: pointer, re: pointer, fromVal: int64, rmatch: pointer): int64 {.importc: "QStringView_lastIndexOf12".}
proc fcQStringView_contains5(self: pointer, re: pointer, rmatch: pointer): bool {.importc: "QStringView_contains5".}
...
proc first*(self: gen_qstringview_types.QStringView): gen_qchar_types.QChar =
  gen_qchar_types.QChar(h: fcQStringView_first2(self.h), owned: true)

proc last*(self: gen_qstringview_types.QStringView): gen_qchar_types.QChar =
  gen_qchar_types.QChar(h: fcQStringView_last2(self.h), owned: true)
...
proc indexOf*(self: gen_qstringview_types.QStringView, re: gen_qregularexpression_types.QRegularExpression, fromVal: int64): int64 =
  fcQStringView_indexOf8(self.h, re.h, fromVal)
...
proc indexOf*(self: gen_qstringview_types.QStringView, re: gen_qregularexpression_types.QRegularExpression, fromVal: int64, rmatch: gen_qregularexpression_types.QRegularExpressionMatch): int64 =
  fcQStringView_indexOf9(self.h, re.h, fromVal, rmatch.h)
...
proc lastIndexOf*(self: gen_qstringview_types.QStringView, re: gen_qregularexpression_types.QRegularExpression, fromVal: int64, rmatch: gen_qregularexpression_types.QRegularExpressionMatch): int64 =
  fcQStringView_lastIndexOf12(self.h, re.h, fromVal, rmatch.h)
...
proc contains*(self: gen_qstringview_types.QStringView, re: gen_qregularexpression_types.QRegularExpression, rmatch: gen_qregularexpression_types.QRegularExpressionMatch): bool =
  fcQStringView_contains5(self.h, re.h, rmatch.h)
