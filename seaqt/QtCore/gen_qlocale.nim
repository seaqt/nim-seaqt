...
proc fcQLocale_toStringDouble(self: pointer, i: float64): struct_seaqt_string {.importc: "QLocale_toString_double".}
proc fcQLocale_toStringFloat(self: pointer, i: float32): struct_seaqt_string {.importc: "QLocale_toString_float".}
proc fcQLocale_toString_QDate_QString(self: pointer, date: pointer, formatStr: struct_seaqt_string): struct_seaqt_string {.importc: "QLocale_toString_QDate_QString".}
proc fcQLocale_toString_QTime_QString(self: pointer, time: pointer, formatStr: struct_seaqt_string): struct_seaqt_string {.importc: "QLocale_toString_QTime_QString".}
...
proc fcQLocale_toTime_QString_QLocale_FormatType_QCalendar(self: pointer, stringVal: struct_seaqt_string, format: cint, cal: pointer): pointer {.importc: "QLocale_toTime_QString_QLocale_FormatType_QCalendar".}
proc fcQLocale_toTime_QString_QString_QCalendar(self: pointer, stringVal: struct_seaqt_string, format: struct_seaqt_string, cal: pointer): pointer {.importc: "QLocale_toTime_QString_QString_QCalendar".}
...
proc fcQLocale_toCurrencyStringShort(self: pointer, param1: cshort): struct_seaqt_string {.importc: "QLocale_toCurrencyString_short".}
proc fcQLocale_toCurrencyStringUshort(self: pointer, param1: cushort): struct_seaqt_string {.importc: "QLocale_toCurrencyString_ushort".}
proc fcQLocale_toCurrencyStringInt(self: pointer, param1: cint): struct_seaqt_string {.importc: "QLocale_toCurrencyString_int".}
proc fcQLocale_toCurrencyStringUint(self: pointer, param1: cuint): struct_seaqt_string {.importc: "QLocale_toCurrencyString_uint".}
...
proc fcQLocale_formattedDataSizeQint64(self: pointer, bytes: clonglong): struct_seaqt_string {.importc: "QLocale_formattedDataSize_qint64".}
proc fcQLocale_formattedDataSizeConstQint64(self: pointer, bytes: clonglong): struct_seaqt_string {.importc: "QLocale_formattedDataSize_const_qint64".}
...
proc fcQLocale_toStringDoubleChar(self: pointer, i: float64, f: cchar): struct_seaqt_string {.importc: "QLocale_toString_double_char".}
proc fcQLocale_toStringDoubleCharInt(self: pointer, i: float64, f: cchar, prec: cint): struct_seaqt_string {.importc: "QLocale_toString_double_char_int".}
proc fcQLocale_toStringFloatChar(self: pointer, i: float32, f: cchar): struct_seaqt_string {.importc: "QLocale_toString_float_char".}
proc fcQLocale_toStringFloatCharInt(self: pointer, i: float32, f: cchar, prec: cint): struct_seaqt_string {.importc: "QLocale_toString_float_char_int".}
...
proc fcQLocale_toCurrencyStringShort_QString(self: pointer, param1: cshort, symbol: struct_seaqt_string): struct_seaqt_string {.importc: "QLocale_toCurrencyString_short_QString".}
proc fcQLocale_toCurrencyStringUshort_QString(self: pointer, param1: cushort, symbol: struct_seaqt_string): struct_seaqt_string {.importc: "QLocale_toCurrencyString_ushort_QString".}
proc fcQLocale_toCurrencyStringInt_QString(self: pointer, param1: cint, symbol: struct_seaqt_string): struct_seaqt_string {.importc: "QLocale_toCurrencyString_int_QString".}
proc fcQLocale_toCurrencyStringUint_QString(self: pointer, param1: cuint, symbol: struct_seaqt_string): struct_seaqt_string {.importc: "QLocale_toCurrencyString_uint_QString".}
...
proc fcQLocale_formattedDataSizeQint64Int(self: pointer, bytes: clonglong, precision: cint): struct_seaqt_string {.importc: "QLocale_formattedDataSize_qint64_int".}
proc fcQLocale_formattedDataSizeQint64Int_QLocale_DataSizeFormats(self: pointer, bytes: clonglong, precision: cint, format: cint): struct_seaqt_string {.importc: "QLocale_formattedDataSize_qint64_int_QLocale_DataSizeFormats".}
proc fcQLocale_formattedDataSizeConstQint64Int(self: pointer, bytes: clonglong, precision: cint): struct_seaqt_string {.importc: "QLocale_formattedDataSize_const_qint64_int".}
proc fcQLocale_formattedDataSizeConstQint64Int_QLocale_DataSizeFormats(self: pointer, bytes: clonglong, precision: cint, format: cint): struct_seaqt_string {.importc: "QLocale_formattedDataSize_const_qint64_int_QLocale_DataSizeFormats".}
...
proc fcQLocale_new2(name: struct_seaqt_string): ptr cQLocale {.importc: "QLocale_new_name".}
proc fcQLocale_new3(language: cint): ptr cQLocale {.importc: "QLocale_new_language".}
proc fcQLocale_new4(language: cint, script: cint, country: cint): ptr cQLocale {.importc: "QLocale_new_language_script_country".}
proc fcQLocale_new5(fromVal: pointer): ptr cQLocale {.importc: "QLocale_new_from".}
proc fcQLocale_new6(language: cint, country: cint): ptr cQLocale {.importc: "QLocale_new_language_country".}
...
proc toString*(self: gen_qlocale_types.QLocale, i: float64): string =
  let v_ms = fcQLocale_toStringDouble(self.h, i)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret

proc toString*(self: gen_qlocale_types.QLocale, i: float32): string =
  let v_ms = fcQLocale_toStringFloat(self.h, i)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret

proc toString*(self: gen_qlocale_types.QLocale, date: gen_qdatetime_types.QDate, formatStr: openArray[char]): string =
  let v_ms = fcQLocale_toString_QDate_QString(self.h, date.h, struct_seaqt_string(data: if len(formatStr) > 0: addr formatStr[0] else: nil, len: csize_t(len(formatStr))))
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret

proc toString*(self: gen_qlocale_types.QLocale, time: gen_qdatetime_types.QTime, formatStr: openArray[char]): string =
  let v_ms = fcQLocale_toString_QTime_QString(self.h, time.h, struct_seaqt_string(data: if len(formatStr) > 0: addr formatStr[0] else: nil, len: csize_t(len(formatStr))))
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc toTime*(self: gen_qlocale_types.QLocale, stringVal: openArray[char], format: cint, cal: gen_qcalendar_types.QCalendar): gen_qdatetime_types.QTime =
  gen_qdatetime_types.QTime(h: fcQLocale_toTime_QString_QLocale_FormatType_QCalendar(self.h, struct_seaqt_string(data: if len(stringVal) > 0: addr stringVal[0] else: nil, len: csize_t(len(stringVal))), cint(format), cal.h), owned: true)
...
proc toTime*(self: gen_qlocale_types.QLocale, stringVal: openArray[char], format: openArray[char], cal: gen_qcalendar_types.QCalendar): gen_qdatetime_types.QTime =
  gen_qdatetime_types.QTime(h: fcQLocale_toTime_QString_QString_QCalendar(self.h, struct_seaqt_string(data: if len(stringVal) > 0: addr stringVal[0] else: nil, len: csize_t(len(stringVal))), struct_seaqt_string(data: if len(format) > 0: addr format[0] else: nil, len: csize_t(len(format))), cal.h), owned: true)
...
proc formattedDataSize*(self: gen_qlocale_types.QLocale, bytes: clonglong): string =
  let v_ms = fcQLocale_formattedDataSizeQint64(self.h, bytes)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret

proc formattedDataSize2*(self: gen_qlocale_types.QLocale, bytes: clonglong): string =
  let v_ms = fcQLocale_formattedDataSizeConstQint64(self.h, bytes)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc toCurrencyString*(self: gen_qlocale_types.QLocale, param1: cshort, symbol: openArray[char]): string =
  let v_ms = fcQLocale_toCurrencyStringShort_QString(self.h, param1, struct_seaqt_string(data: if len(symbol) > 0: addr symbol[0] else: nil, len: csize_t(len(symbol))))
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret

proc toCurrencyString*(self: gen_qlocale_types.QLocale, param1: cushort, symbol: openArray[char]): string =
  let v_ms = fcQLocale_toCurrencyStringUshort_QString(self.h, param1, struct_seaqt_string(data: if len(symbol) > 0: addr symbol[0] else: nil, len: csize_t(len(symbol))))
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret

proc toCurrencyString*(self: gen_qlocale_types.QLocale, param1: cint, symbol: openArray[char]): string =
  let v_ms = fcQLocale_toCurrencyStringInt_QString(self.h, param1, struct_seaqt_string(data: if len(symbol) > 0: addr symbol[0] else: nil, len: csize_t(len(symbol))))
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret

proc toCurrencyString*(self: gen_qlocale_types.QLocale, param1: cuint, symbol: openArray[char]): string =
  let v_ms = fcQLocale_toCurrencyStringUint_QString(self.h, param1, struct_seaqt_string(data: if len(symbol) > 0: addr symbol[0] else: nil, len: csize_t(len(symbol))))
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc formattedDataSize*(self: gen_qlocale_types.QLocale, bytes: clonglong, precision: cint): string =
  let v_ms = fcQLocale_formattedDataSizeQint64Int(self.h, bytes, precision)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret

proc formattedDataSize*(self: gen_qlocale_types.QLocale, bytes: clonglong, precision: cint, format: cint): string =
  let v_ms = fcQLocale_formattedDataSizeQint64Int_QLocale_DataSizeFormats(self.h, bytes, precision, cint(format))
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret

proc formattedDataSize2*(self: gen_qlocale_types.QLocale, bytes: clonglong, precision: cint): string =
  let v_ms = fcQLocale_formattedDataSizeConstQint64Int(self.h, bytes, precision)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret

proc formattedDataSize2*(self: gen_qlocale_types.QLocale, bytes: clonglong, precision: cint, format: cint): string =
  let v_ms = fcQLocale_formattedDataSizeConstQint64Int_QLocale_DataSizeFormats(self.h, bytes, precision, cint(format))
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
