...
proc toDate*(self: gen_qlocale_types.QLocale, stringVal: openArray[char]): gen_qdatetime_types.QDate =
  gen_qdatetime_types.QDate(h: fcQLocale_toDate(self.h, struct_seaqt_string(data: if len(stringVal) > 0: addr stringVal[0] else: nil, len: csize_t(len(stringVal)))))

proc toTime*(self: gen_qlocale_types.QLocale, stringVal: openArray[char]): gen_qdatetime_types.QTime =
  gen_qdatetime_types.QTime(h: fcQLocale_toTime(self.h, struct_seaqt_string(data: if len(stringVal) > 0: addr stringVal[0] else: nil, len: csize_t(len(stringVal)))))

proc toDateTime*(self: gen_qlocale_types.QLocale, stringVal: openArray[char]): gen_qdatetime_types.QDateTime =
  gen_qdatetime_types.QDateTime(h: fcQLocale_toDateTime(self.h, struct_seaqt_string(data: if len(stringVal) > 0: addr stringVal[0] else: nil, len: csize_t(len(stringVal)))))

proc toDate*(self: gen_qlocale_types.QLocale, stringVal: openArray[char], format: openArray[char]): gen_qdatetime_types.QDate =
  gen_qdatetime_types.QDate(h: fcQLocale_toDate2(self.h, struct_seaqt_string(data: if len(stringVal) > 0: addr stringVal[0] else: nil, len: csize_t(len(stringVal))), struct_seaqt_string(data: if len(format) > 0: addr format[0] else: nil, len: csize_t(len(format)))))

proc toTime*(self: gen_qlocale_types.QLocale, stringVal: openArray[char], format: openArray[char]): gen_qdatetime_types.QTime =
  gen_qdatetime_types.QTime(h: fcQLocale_toTime2(self.h, struct_seaqt_string(data: if len(stringVal) > 0: addr stringVal[0] else: nil, len: csize_t(len(stringVal))), struct_seaqt_string(data: if len(format) > 0: addr format[0] else: nil, len: csize_t(len(format)))))
...
proc toDateTime*(self: gen_qlocale_types.QLocale, stringVal: openArray[char], format: openArray[char]): gen_qdatetime_types.QDateTime =
  gen_qdatetime_types.QDateTime(h: fcQLocale_toDateTime2(self.h, struct_seaqt_string(data: if len(stringVal) > 0: addr stringVal[0] else: nil, len: csize_t(len(stringVal))), struct_seaqt_string(data: if len(format) > 0: addr format[0] else: nil, len: csize_t(len(format)))))
...
proc toDate*(self: gen_qlocale_types.QLocale, stringVal: openArray[char], format: cint, cal: gen_qcalendar_types.QCalendar): gen_qdatetime_types.QDate =
  gen_qdatetime_types.QDate(h: fcQLocale_toDate3(self.h, struct_seaqt_string(data: if len(stringVal) > 0: addr stringVal[0] else: nil, len: csize_t(len(stringVal))), cint(format), cal.h))
...
proc toDateTime*(self: gen_qlocale_types.QLocale, stringVal: openArray[char], format: cint, cal: gen_qcalendar_types.QCalendar): gen_qdatetime_types.QDateTime =
  gen_qdatetime_types.QDateTime(h: fcQLocale_toDateTime3(self.h, struct_seaqt_string(data: if len(stringVal) > 0: addr stringVal[0] else: nil, len: csize_t(len(stringVal))), cint(format), cal.h))
...
proc toDate*(self: gen_qlocale_types.QLocale, stringVal: openArray[char], format: openArray[char], cal: gen_qcalendar_types.QCalendar): gen_qdatetime_types.QDate =
  gen_qdatetime_types.QDate(h: fcQLocale_toDate4(self.h, struct_seaqt_string(data: if len(stringVal) > 0: addr stringVal[0] else: nil, len: csize_t(len(stringVal))), struct_seaqt_string(data: if len(format) > 0: addr format[0] else: nil, len: csize_t(len(format))), cal.h))
...
proc toDateTime*(self: gen_qlocale_types.QLocale, stringVal: openArray[char], format: openArray[char], cal: gen_qcalendar_types.QCalendar): gen_qdatetime_types.QDateTime =
  gen_qdatetime_types.QDateTime(h: fcQLocale_toDateTime4(self.h, struct_seaqt_string(data: if len(stringVal) > 0: addr stringVal[0] else: nil, len: csize_t(len(stringVal))), struct_seaqt_string(data: if len(format) > 0: addr format[0] else: nil, len: csize_t(len(format))), cal.h))
...
proc toTime*(self: gen_qlocale_types.QLocale, stringVal: openArray[char], format: cint, cal: gen_qcalendar_types.QCalendar): gen_qdatetime_types.QTime =
  gen_qdatetime_types.QTime(h: fcQLocale_toTime3(self.h, struct_seaqt_string(data: if len(stringVal) > 0: addr stringVal[0] else: nil, len: csize_t(len(stringVal))), cint(format), cal.h))
...
proc toTime*(self: gen_qlocale_types.QLocale, stringVal: openArray[char], format: openArray[char], cal: gen_qcalendar_types.QCalendar): gen_qdatetime_types.QTime =
  gen_qdatetime_types.QTime(h: fcQLocale_toTime4(self.h, struct_seaqt_string(data: if len(stringVal) > 0: addr stringVal[0] else: nil, len: csize_t(len(stringVal))), struct_seaqt_string(data: if len(format) > 0: addr format[0] else: nil, len: csize_t(len(format))), cal.h))
...
proc toDate*(self: gen_qlocale_types.QLocale, stringVal: openArray[char], param2: cint): gen_qdatetime_types.QDate =
  gen_qdatetime_types.QDate(h: fcQLocale_toDate5(self.h, struct_seaqt_string(data: if len(stringVal) > 0: addr stringVal[0] else: nil, len: csize_t(len(stringVal))), cint(param2)))

proc toTime*(self: gen_qlocale_types.QLocale, stringVal: openArray[char], param2: cint): gen_qdatetime_types.QTime =
  gen_qdatetime_types.QTime(h: fcQLocale_toTime5(self.h, struct_seaqt_string(data: if len(stringVal) > 0: addr stringVal[0] else: nil, len: csize_t(len(stringVal))), cint(param2)))

proc toDateTime*(self: gen_qlocale_types.QLocale, stringVal: openArray[char], format: cint): gen_qdatetime_types.QDateTime =
  gen_qdatetime_types.QDateTime(h: fcQLocale_toDateTime5(self.h, struct_seaqt_string(data: if len(stringVal) > 0: addr stringVal[0] else: nil, len: csize_t(len(stringVal))), cint(format)))
...
proc create*(T: type gen_qlocale_types.QLocale): gen_qlocale_types.QLocale =
  let tmp = gen_qlocale_types.QLocale(h: fcQLocale_new())
  tmp
proc create*(T: type gen_qlocale_types.QLocale,
    name: openArray[char]): gen_qlocale_types.QLocale =
  let tmp = gen_qlocale_types.QLocale(h: fcQLocale_new2(struct_seaqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name)))))
  tmp
proc create*(T: type gen_qlocale_types.QLocale,
    language: cint): gen_qlocale_types.QLocale =
  let tmp = gen_qlocale_types.QLocale(h: fcQLocale_new3(cint(language)))
  tmp
proc create*(T: type gen_qlocale_types.QLocale,
    language: cint, script: cint, country: cint): gen_qlocale_types.QLocale =
  let tmp = gen_qlocale_types.QLocale(h: fcQLocale_new4(cint(language), cint(script), cint(country)))
  tmp
proc create*(T: type gen_qlocale_types.QLocale,
    other: gen_qlocale_types.QLocale): gen_qlocale_types.QLocale =
  let tmp = gen_qlocale_types.QLocale(h: fcQLocale_new5(other.h))
  tmp
proc create*(T: type gen_qlocale_types.QLocale,
    language: cint, country: cint): gen_qlocale_types.QLocale =
  let tmp = gen_qlocale_types.QLocale(h: fcQLocale_new6(cint(language), cint(country)))
  tmp
