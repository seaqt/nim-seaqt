...
proc fcQLatin1String_toUtf8(self: pointer): struct_seaqt_string {.importc: "QLatin1String_toUtf8".}
...
proc toUtf8*(self: gen_qlatin1stringview_types.QLatin1String): seq[byte] =
  var v_bytearray = fcQLatin1String_toUtf8(self.h)
