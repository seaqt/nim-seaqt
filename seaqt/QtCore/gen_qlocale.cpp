...
struct miqt_string QLocale_toCurrencyString23(const QLocale* self, short i, struct miqt_string symbol) {
	QString symbol_QString = QString::fromUtf8(symbol.data, symbol.len);
...
struct miqt_string QLocale_toCurrencyString24(const QLocale* self, unsigned short i, struct miqt_string symbol) {
	QString symbol_QString = QString::fromUtf8(symbol.data, symbol.len);
