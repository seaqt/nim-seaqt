...
proc fcQFutureWatcherBase_trUtf8S(s: cstring): struct_seaqt_string {.importc: "QFutureWatcherBase_trUtf8_s".}
...
proc fcQFutureWatcherBase_progressText(self: pointer): struct_seaqt_string {.importc: "QFutureWatcherBase_progressText".}
...
proc fcQFutureWatcherBase_progressTextChanged(self: pointer, progressText: struct_seaqt_string): void {.importc: "QFutureWatcherBase_progressTextChanged".}
proc fcQFutureWatcherBase_connect_progressTextChanged(self: pointer, slot: int, callback: proc (slot: int, progressText: struct_seaqt_string) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QFutureWatcherBase_connect_progressTextChanged".}
...
proc fcQFutureWatcherBase_trUtf8SC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QFutureWatcherBase_trUtf8_s_c".}
proc fcQFutureWatcherBase_trUtf8SCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QFutureWatcherBase_trUtf8_s_c_n".}
...
proc trUtf8*(_: type gen_qfuturewatcher_types.QFutureWatcherBase, s: cstring): string =
  let v_ms = fcQFutureWatcherBase_trUtf8S(s)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc progressTextChanged*(self: gen_qfuturewatcher_types.QFutureWatcherBase, progressText: openArray[char]): void =
  fcQFutureWatcherBase_progressTextChanged(self.h, struct_seaqt_string(data: if len(progressText) > 0: addr progressText[0] else: nil, len: csize_t(len(progressText))))

type QFutureWatcherBaseprogressTextChangedSlot* = proc(progressText: openArray[char])
proc fcQFutureWatcherBase_slot_callback_progressTextChanged(slot: int, progressText: struct_seaqt_string) {.cdecl.} =
