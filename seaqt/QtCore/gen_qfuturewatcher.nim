...
proc fcQFutureWatcherBase_trUtf8(s: cstring): struct_seaqt_string {.importc: "QFutureWatcherBase_trUtf8".}
...
proc fcQFutureWatcherBase_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QFutureWatcherBase_trUtf82".}
proc fcQFutureWatcherBase_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QFutureWatcherBase_trUtf83".}
