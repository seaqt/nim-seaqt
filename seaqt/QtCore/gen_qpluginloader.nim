...
proc fcQPluginLoader_trUtf8(s: cstring): struct_seaqt_string {.importc: "QPluginLoader_trUtf8".}
...
proc fcQPluginLoader_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QPluginLoader_trUtf82".}
proc fcQPluginLoader_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QPluginLoader_trUtf83".}
