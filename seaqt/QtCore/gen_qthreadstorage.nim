...
proc id*(self: gen_qthreadstorage_types.QThreadStorageData): cint =
  fcQThreadStorageData_id(self.h)

proc setId*(self: gen_qthreadstorage_types.QThreadStorageData, id: cint): void =
