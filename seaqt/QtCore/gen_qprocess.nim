...
proc start*(self: gen_qprocess_types.QProcess, program: openArray[char], arguments: openArray[string]): void =
  ...
  fcQProcess_start(self.h, struct_miqt_string(data: if len(program) > 0: addr program[0] else: nil, len: csize_t(len(program))), struct_miqt_array(len: csize_t(len(arguments)), data: if len(arguments) == 0: nil else: addr(arguments_CArray[0])))

proc start*(self: gen_qprocess_types.QProcess, command: openArray[char]): void =
  fcQProcess_startWithCommand(self.h, struct_miqt_string(data: if len(command) > 0: addr command[0] else: nil, len: csize_t(len(command))))
...
proc execute*(_: type gen_qprocess_types.QProcess, program: openArray[char], arguments: openArray[string]): cint =
  ...
  fcQProcess_execute(struct_miqt_string(data: if len(program) > 0: addr program[0] else: nil, len: csize_t(len(program))), struct_miqt_array(len: csize_t(len(arguments)), data: if len(arguments) == 0: nil else: addr(arguments_CArray[0])))

proc execute*(_: type gen_qprocess_types.QProcess, command: openArray[char]): cint =
  fcQProcess_executeWithCommand(struct_miqt_string(data: if len(command) > 0: addr command[0] else: nil, len: csize_t(len(command))))
...
proc startDetached*(_: type gen_qprocess_types.QProcess, program: openArray[char], arguments: openArray[string]): bool =
  ...
  fcQProcess_startDetached3(struct_miqt_string(data: if len(program) > 0: addr program[0] else: nil, len: csize_t(len(program))), struct_miqt_array(len: csize_t(len(arguments)), data: if len(arguments) == 0: nil else: addr(arguments_CArray[0])))

proc startDetached*(_: type gen_qprocess_types.QProcess, command: openArray[char]): bool =
  fcQProcess_startDetachedWithCommand(struct_miqt_string(data: if len(command) > 0: addr command[0] else: nil, len: csize_t(len(command))))
...
proc start*(self: gen_qprocess_types.QProcess, command: openArray[char], mode: cint): void =
  fcQProcess_start22(self.h, struct_miqt_string(data: if len(command) > 0: addr command[0] else: nil, len: csize_t(len(command))), cint(mode))
