...
type QProcessUnixProcessFlagEnum* = distinct cuint
template ResetSignalHandlers*(_: type QProcessUnixProcessFlagEnum): untyped = 1
template IgnoreSigPipe*(_: type QProcessUnixProcessFlagEnum): untyped = 2
template CloseFileDescriptors*(_: type QProcessUnixProcessFlagEnum): untyped = 16
template UseVFork*(_: type QProcessUnixProcessFlagEnum): untyped = 32
template CreateNewSession*(_: type QProcessUnixProcessFlagEnum): untyped = 64
template DisconnectControllingTerminal*(_: type QProcessUnixProcessFlagEnum): untyped = 128
template ResetIds*(_: type QProcessUnixProcessFlagEnum): untyped = 256
template DisableCoreDumps*(_: type QProcessUnixProcessFlagEnum): untyped = 512
...
proc fcQProcess_failChildProcessModifierDescription(self: pointer, description: cstring): void {.importc: "QProcess_failChildProcessModifier_description".}
proc fcQProcess_setUnixProcessParameters_QProcess_UnixProcessFlags(self: pointer, flagsOnly: cint): void {.importc: "QProcess_setUnixProcessParameters_QProcess_UnixProcessFlags".}
...
proc fcQProcess_failChildProcessModifierDescriptionError(self: pointer, description: cstring, error: cint): void {.importc: "QProcess_failChildProcessModifier_description_error".}
...
proc failChildProcessModifier*(self: gen_qprocess_types.QProcess, description: cstring): void =
  fcQProcess_failChildProcessModifierDescription(self.h, description)

proc setUnixProcessParameters*(self: gen_qprocess_types.QProcess, flagsOnly: cint): void =
  fcQProcess_setUnixProcessParameters_QProcess_UnixProcessFlags(self.h, cint(flagsOnly))
...
proc failChildProcessModifier*(self: gen_qprocess_types.QProcess, description: cstring, error: cint): void =
  fcQProcess_failChildProcessModifierDescriptionError(self.h, description, error)
