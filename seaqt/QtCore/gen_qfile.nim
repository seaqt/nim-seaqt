...
proc cQFile_vtable_callback_metaObject(self: pointer): pointer {.cdecl.} =
...
proc cQFile_vtable_callback_metacast(self: pointer, param1: cstring): pointer {.cdecl.} =
  let vtbl = cast[ptr QFileVTable](fcQFile_vdata(self))
  let self = QFile(h: self)
  let slotval1 = (param1)
...
proc cQFile_vtable_callback_metacall(self: pointer, param1: cint, param2: cint, param3: pointer): cint {.cdecl.} =
  let vtbl = cast[ptr QFileVTable](fcQFile_vdata(self))
  let self = QFile(h: self)
...
proc cQFile_vtable_callback_fileName(self: pointer): struct_miqt_string {.cdecl.} =
  let vtbl = cast[ptr QFileVTable](fcQFile_vdata(self))
  let self = QFile(h: self)
...
proc cQFile_vtable_callback_open(self: pointer, flags: cint): bool {.cdecl.} =
  let vtbl = cast[ptr QFileVTable](fcQFile_vdata(self))
  let self = QFile(h: self)
...
proc cQFile_vtable_callback_size(self: pointer): clonglong {.cdecl.} =
  let vtbl = cast[ptr QFileVTable](fcQFile_vdata(self))
  let self = QFile(h: self)
...
proc cQFile_vtable_callback_resize(self: pointer, sz: clonglong): bool {.cdecl.} =
  let vtbl = cast[ptr QFileVTable](fcQFile_vdata(self))
  let self = QFile(h: self)
  let slotval1 = sz
...
proc cQFile_vtable_callback_permissions(self: pointer): cint {.cdecl.} =
  let vtbl = cast[ptr QFileVTable](fcQFile_vdata(self))
  let self = QFile(h: self)
...
proc cQFile_vtable_callback_setPermissions(self: pointer, permissionSpec: cint): bool {.cdecl.} =
  let vtbl = cast[ptr QFileVTable](fcQFile_vdata(self))
  let self = QFile(h: self)
...
proc cQFile_vtable_callback_close(self: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QFileVTable](fcQFile_vdata(self))
  let self = QFile(h: self)
  vtbl[].close(self)
...
proc cQFile_vtable_callback_isSequential(self: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QFileVTable](fcQFile_vdata(self))
  let self = QFile(h: self)
...
proc cQFile_vtable_callback_pos(self: pointer): clonglong {.cdecl.} =
  let vtbl = cast[ptr QFileVTable](fcQFile_vdata(self))
  let self = QFile(h: self)
...
proc cQFile_vtable_callback_seek(self: pointer, offset: clonglong): bool {.cdecl.} =
  let vtbl = cast[ptr QFileVTable](fcQFile_vdata(self))
  let self = QFile(h: self)
  let slotval1 = offset
...
proc cQFile_vtable_callback_atEnd(self: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QFileVTable](fcQFile_vdata(self))
  let self = QFile(h: self)
...
proc cQFile_vtable_callback_readData(self: pointer, data: cstring, maxlen: clonglong): clonglong {.cdecl.} =
  let vtbl = cast[ptr QFileVTable](fcQFile_vdata(self))
  let self = QFile(h: self)
  let slotval1 = (data)
  let slotval2 = maxlen
...
proc cQFile_vtable_callback_writeData(self: pointer, data: cstring, len: clonglong): clonglong {.cdecl.} =
  let vtbl = cast[ptr QFileVTable](fcQFile_vdata(self))
  let self = QFile(h: self)
  let slotval1 = (data)
  let slotval2 = len
...
proc cQFile_vtable_callback_readLineData(self: pointer, data: cstring, maxlen: clonglong): clonglong {.cdecl.} =
  let vtbl = cast[ptr QFileVTable](fcQFile_vdata(self))
  let self = QFile(h: self)
  let slotval1 = (data)
  let slotval2 = maxlen
...
proc cQFile_vtable_callback_reset(self: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QFileVTable](fcQFile_vdata(self))
  let self = QFile(h: self)
...
proc cQFile_vtable_callback_bytesAvailable(self: pointer): clonglong {.cdecl.} =
  let vtbl = cast[ptr QFileVTable](fcQFile_vdata(self))
  let self = QFile(h: self)
...
proc cQFile_vtable_callback_bytesToWrite(self: pointer): clonglong {.cdecl.} =
  let vtbl = cast[ptr QFileVTable](fcQFile_vdata(self))
  let self = QFile(h: self)
...
proc cQFile_vtable_callback_canReadLine(self: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QFileVTable](fcQFile_vdata(self))
  let self = QFile(h: self)
...
proc cQFile_vtable_callback_waitForReadyRead(self: pointer, msecs: cint): bool {.cdecl.} =
  let vtbl = cast[ptr QFileVTable](fcQFile_vdata(self))
  let self = QFile(h: self)
  let slotval1 = msecs
...
proc cQFile_vtable_callback_waitForBytesWritten(self: pointer, msecs: cint): bool {.cdecl.} =
  let vtbl = cast[ptr QFileVTable](fcQFile_vdata(self))
  let self = QFile(h: self)
  let slotval1 = msecs
...
proc cQFile_vtable_callback_skipData(self: pointer, maxSize: clonglong): clonglong {.cdecl.} =
  let vtbl = cast[ptr QFileVTable](fcQFile_vdata(self))
  let self = QFile(h: self)
...
proc cQFile_vtable_callback_event(self: pointer, event: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QFileVTable](fcQFile_vdata(self))
  let self = QFile(h: self)
...
proc cQFile_vtable_callback_eventFilter(self: pointer, watched: pointer, event: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QFileVTable](fcQFile_vdata(self))
  let self = QFile(h: self)
...
proc cQFile_vtable_callback_timerEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QFileVTable](fcQFile_vdata(self))
  let self = QFile(h: self)
...
proc cQFile_vtable_callback_childEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QFileVTable](fcQFile_vdata(self))
  let self = QFile(h: self)
...
proc cQFile_vtable_callback_customEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QFileVTable](fcQFile_vdata(self))
  let self = QFile(h: self)
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
...
proc cQFile_vtable_callback_connectNotify(self: pointer, signal: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QFileVTable](fcQFile_vdata(self))
  let self = QFile(h: self)
...
proc cQFile_vtable_callback_disconnectNotify(self: pointer, signal: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QFileVTable](fcQFile_vdata(self))
  let self = QFile(h: self)
  let slotval1 = gen_qmetaobject_types.QMetaMethod(h: signal, owned: false)
...
proc cQFile_method_callback_metaObject(self: pointer): pointer {.cdecl.} =
...
proc cQFile_method_callback_metacast(self: pointer, param1: cstring): pointer {.cdecl.} =
  let inst = cast[VirtualQFile](fcQFile_vdata(self))
  let slotval1 = (param1)
...
proc cQFile_method_callback_metacall(self: pointer, param1: cint, param2: cint, param3: pointer): cint {.cdecl.} =
  let inst = cast[VirtualQFile](fcQFile_vdata(self))
  let slotval1 = cint(param1)
  let slotval2 = param2
  let slotval3 = param3
...
method fileName*(self: VirtualQFile): string {.base.} =
  QFilefileName(self[])
proc cQFile_method_callback_fileName(self: pointer): struct_miqt_string {.cdecl.} =
  let inst = cast[VirtualQFile](fcQFile_vdata(self))
...
proc cQFile_method_callback_open(self: pointer, flags: cint): bool {.cdecl.} =
  let inst = cast[VirtualQFile](fcQFile_vdata(self))
  let slotval1 = cint(flags)
...
method size*(self: VirtualQFile): clonglong {.base.} =
  QFilesize(self[])
proc cQFile_method_callback_size(self: pointer): clonglong {.cdecl.} =
  let inst = cast[VirtualQFile](fcQFile_vdata(self))
...
method resize*(self: VirtualQFile, sz: clonglong): bool {.base.} =
  QFileresize(self[], sz)
proc cQFile_method_callback_resize(self: pointer, sz: clonglong): bool {.cdecl.} =
  let inst = cast[VirtualQFile](fcQFile_vdata(self))
  let slotval1 = sz
...
proc cQFile_method_callback_permissions(self: pointer): cint {.cdecl.} =
  let inst = cast[VirtualQFile](fcQFile_vdata(self))
...
proc cQFile_method_callback_setPermissions(self: pointer, permissionSpec: cint): bool {.cdecl.} =
  let inst = cast[VirtualQFile](fcQFile_vdata(self))
  let slotval1 = cint(permissionSpec)
...
method close*(self: VirtualQFile): void {.base.} =
  QFileclose(self[])
proc cQFile_method_callback_close(self: pointer): void {.cdecl.} =
  let inst = cast[VirtualQFile](fcQFile_vdata(self))
  inst.close()

method isSequential*(self: VirtualQFile): bool {.base.} =
  QFileisSequential(self[])
proc cQFile_method_callback_isSequential(self: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQFile](fcQFile_vdata(self))
...
method pos*(self: VirtualQFile): clonglong {.base.} =
  QFilepos(self[])
proc cQFile_method_callback_pos(self: pointer): clonglong {.cdecl.} =
  let inst = cast[VirtualQFile](fcQFile_vdata(self))
...
proc cQFile_method_callback_seek(self: pointer, offset: clonglong): bool {.cdecl.} =
  let inst = cast[VirtualQFile](fcQFile_vdata(self))
  let slotval1 = offset
...
method atEnd*(self: VirtualQFile): bool {.base.} =
  QFileatEnd(self[])
proc cQFile_method_callback_atEnd(self: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQFile](fcQFile_vdata(self))
...
proc cQFile_method_callback_readData(self: pointer, data: cstring, maxlen: clonglong): clonglong {.cdecl.} =
  let inst = cast[VirtualQFile](fcQFile_vdata(self))
  let slotval1 = (data)
  let slotval2 = maxlen
...
proc cQFile_method_callback_writeData(self: pointer, data: cstring, len: clonglong): clonglong {.cdecl.} =
  let inst = cast[VirtualQFile](fcQFile_vdata(self))
  let slotval1 = (data)
  let slotval2 = len
...
proc cQFile_method_callback_readLineData(self: pointer, data: cstring, maxlen: clonglong): clonglong {.cdecl.} =
  let inst = cast[VirtualQFile](fcQFile_vdata(self))
  let slotval1 = (data)
  let slotval2 = maxlen
...
method reset*(self: VirtualQFile): bool {.base.} =
  QFilereset(self[])
proc cQFile_method_callback_reset(self: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQFile](fcQFile_vdata(self))
...
proc cQFile_method_callback_bytesAvailable(self: pointer): clonglong {.cdecl.} =
  let inst = cast[VirtualQFile](fcQFile_vdata(self))
...
proc cQFile_method_callback_bytesToWrite(self: pointer): clonglong {.cdecl.} =
  let inst = cast[VirtualQFile](fcQFile_vdata(self))
...
proc cQFile_method_callback_canReadLine(self: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQFile](fcQFile_vdata(self))
...
proc cQFile_method_callback_waitForReadyRead(self: pointer, msecs: cint): bool {.cdecl.} =
  let inst = cast[VirtualQFile](fcQFile_vdata(self))
  let slotval1 = msecs
...
proc cQFile_method_callback_waitForBytesWritten(self: pointer, msecs: cint): bool {.cdecl.} =
  let inst = cast[VirtualQFile](fcQFile_vdata(self))
  let slotval1 = msecs
...
proc cQFile_method_callback_skipData(self: pointer, maxSize: clonglong): clonglong {.cdecl.} =
  let inst = cast[VirtualQFile](fcQFile_vdata(self))
  let slotval1 = maxSize
...
proc cQFile_method_callback_event(self: pointer, event: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQFile](fcQFile_vdata(self))
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
...
proc cQFile_method_callback_eventFilter(self: pointer, watched: pointer, event: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQFile](fcQFile_vdata(self))
  let slotval1 = gen_qobject_types.QObject(h: watched, owned: false)
  let slotval2 = gen_qcoreevent_types.QEvent(h: event, owned: false)
...
proc cQFile_method_callback_timerEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQFile](fcQFile_vdata(self))
  let slotval1 = gen_qcoreevent_types.QTimerEvent(h: event, owned: false)
...
proc cQFile_method_callback_childEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQFile](fcQFile_vdata(self))
  let slotval1 = gen_qcoreevent_types.QChildEvent(h: event, owned: false)
...
proc cQFile_method_callback_customEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQFile](fcQFile_vdata(self))
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
...
proc cQFile_method_callback_connectNotify(self: pointer, signal: pointer): void {.cdecl.} =
  let inst = cast[VirtualQFile](fcQFile_vdata(self))
  let slotval1 = gen_qmetaobject_types.QMetaMethod(h: signal, owned: false)
...
proc cQFile_method_callback_disconnectNotify(self: pointer, signal: pointer): void {.cdecl.} =
  let inst = cast[VirtualQFile](fcQFile_vdata(self))
  let slotval1 = gen_qmetaobject_types.QMetaMethod(h: signal, owned: false)
...
proc create*(T: type gen_qfile_types.QFile,
  ...
  if not isNil(vtbl[].metaObject):
    vtbl[].vtbl.metaObject = cQFile_vtable_callback_metaObject
  if not isNil(vtbl[].metacast):
    vtbl[].vtbl.metacast = cQFile_vtable_callback_metacast
  if not isNil(vtbl[].metacall):
    vtbl[].vtbl.metacall = cQFile_vtable_callback_metacall
  if not isNil(vtbl[].fileName):
    vtbl[].vtbl.fileName = cQFile_vtable_callback_fileName
  if not isNil(vtbl[].open):
    vtbl[].vtbl.open = cQFile_vtable_callback_open
  if not isNil(vtbl[].size):
    vtbl[].vtbl.size = cQFile_vtable_callback_size
  if not isNil(vtbl[].resize):
    vtbl[].vtbl.resize = cQFile_vtable_callback_resize
  if not isNil(vtbl[].permissions):
    vtbl[].vtbl.permissions = cQFile_vtable_callback_permissions
  if not isNil(vtbl[].setPermissions):
    vtbl[].vtbl.setPermissions = cQFile_vtable_callback_setPermissions
  if not isNil(vtbl[].close):
    vtbl[].vtbl.close = cQFile_vtable_callback_close
  if not isNil(vtbl[].isSequential):
    vtbl[].vtbl.isSequential = cQFile_vtable_callback_isSequential
  if not isNil(vtbl[].pos):
    vtbl[].vtbl.pos = cQFile_vtable_callback_pos
  if not isNil(vtbl[].seek):
    vtbl[].vtbl.seek = cQFile_vtable_callback_seek
  if not isNil(vtbl[].atEnd):
    vtbl[].vtbl.atEnd = cQFile_vtable_callback_atEnd
  if not isNil(vtbl[].readData):
    vtbl[].vtbl.readData = cQFile_vtable_callback_readData
  if not isNil(vtbl[].writeData):
    vtbl[].vtbl.writeData = cQFile_vtable_callback_writeData
  if not isNil(vtbl[].readLineData):
    vtbl[].vtbl.readLineData = cQFile_vtable_callback_readLineData
  if not isNil(vtbl[].reset):
    vtbl[].vtbl.reset = cQFile_vtable_callback_reset
  if not isNil(vtbl[].bytesAvailable):
    vtbl[].vtbl.bytesAvailable = cQFile_vtable_callback_bytesAvailable
  if not isNil(vtbl[].bytesToWrite):
    vtbl[].vtbl.bytesToWrite = cQFile_vtable_callback_bytesToWrite
  if not isNil(vtbl[].canReadLine):
    vtbl[].vtbl.canReadLine = cQFile_vtable_callback_canReadLine
  if not isNil(vtbl[].waitForReadyRead):
    vtbl[].vtbl.waitForReadyRead = cQFile_vtable_callback_waitForReadyRead
  if not isNil(vtbl[].waitForBytesWritten):
    vtbl[].vtbl.waitForBytesWritten = cQFile_vtable_callback_waitForBytesWritten
  if not isNil(vtbl[].skipData):
    vtbl[].vtbl.skipData = cQFile_vtable_callback_skipData
  if not isNil(vtbl[].event):
    vtbl[].vtbl.event = cQFile_vtable_callback_event
  if not isNil(vtbl[].eventFilter):
    vtbl[].vtbl.eventFilter = cQFile_vtable_callback_eventFilter
  if not isNil(vtbl[].timerEvent):
    vtbl[].vtbl.timerEvent = cQFile_vtable_callback_timerEvent
  if not isNil(vtbl[].childEvent):
    vtbl[].vtbl.childEvent = cQFile_vtable_callback_childEvent
  if not isNil(vtbl[].customEvent):
    vtbl[].vtbl.customEvent = cQFile_vtable_callback_customEvent
  if not isNil(vtbl[].connectNotify):
    vtbl[].vtbl.connectNotify = cQFile_vtable_callback_connectNotify
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = cQFile_vtable_callback_disconnectNotify
...
proc create*(T: type gen_qfile_types.QFile,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = cQFile_vtable_callback_disconnectNotify
  gen_qfile_types.QFile(h: fcQFile_new2(addr(vtbl[].vtbl), addr(vtbl[]), struct_miqt_string(data: name, len: csize_t(len(name)))), owned: true)
...
proc create*(T: type gen_qfile_types.QFile,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = cQFile_vtable_callback_disconnectNotify
  gen_qfile_types.QFile(h: fcQFile_new4(addr(vtbl[].vtbl), addr(vtbl[]), struct_miqt_string(data: name, len: csize_t(len(name))), parent.h), owned: true)
...
const cQFile_mvtbl = cQFileVTable(
  destructor: proc(self: pointer) {.cdecl.} =
    ...
    inst[].h = nil
    inst[].owned = false,
  metaObject: cQFile_method_callback_metaObject,
  metacast: cQFile_method_callback_metacast,
  metacall: cQFile_method_callback_metacall,
  fileName: cQFile_method_callback_fileName,
  open: cQFile_method_callback_open,
  size: cQFile_method_callback_size,
  resize: cQFile_method_callback_resize,
  permissions: cQFile_method_callback_permissions,
  setPermissions: cQFile_method_callback_setPermissions,
  close: cQFile_method_callback_close,
  isSequential: cQFile_method_callback_isSequential,
  pos: cQFile_method_callback_pos,
  seek: cQFile_method_callback_seek,
  atEnd: cQFile_method_callback_atEnd,
  readData: cQFile_method_callback_readData,
  writeData: cQFile_method_callback_writeData,
  readLineData: cQFile_method_callback_readLineData,
  reset: cQFile_method_callback_reset,
  bytesAvailable: cQFile_method_callback_bytesAvailable,
  bytesToWrite: cQFile_method_callback_bytesToWrite,
  canReadLine: cQFile_method_callback_canReadLine,
  waitForReadyRead: cQFile_method_callback_waitForReadyRead,
  waitForBytesWritten: cQFile_method_callback_waitForBytesWritten,
  skipData: cQFile_method_callback_skipData,
  event: cQFile_method_callback_event,
  eventFilter: cQFile_method_callback_eventFilter,
  timerEvent: cQFile_method_callback_timerEvent,
  childEvent: cQFile_method_callback_childEvent,
  customEvent: cQFile_method_callback_customEvent,
  connectNotify: cQFile_method_callback_connectNotify,
  disconnectNotify: cQFile_method_callback_disconnectNotify,
)
proc create*(T: type gen_qfile_types.QFile,
    inst: VirtualQFile) =
...
proc create*(T: type gen_qfile_types.QFile,
    ...
    inst: VirtualQFile) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQFile_new2(addr(cQFile_mvtbl), addr(inst[]), struct_miqt_string(data: name, len: csize_t(len(name))))
  inst[].owned = true
...
proc create*(T: type gen_qfile_types.QFile,
    ...
    inst: VirtualQFile) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQFile_new4(addr(cQFile_mvtbl), addr(inst[]), struct_miqt_string(data: name, len: csize_t(len(name))), parent.h)
  inst[].owned = true
