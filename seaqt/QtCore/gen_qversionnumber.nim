...
proc fcQVersionNumber_fromString_QString(stringVal: struct_seaqt_string): pointer {.importc: "QVersionNumber_fromString_QString".}
proc fcQVersionNumber_operatorAssign(self: pointer, fromVal: pointer): void {.importc: "QVersionNumber_operatorAssign".}
proc fcQVersionNumber_fromString_QStringInt(stringVal: struct_seaqt_string, suffixIndex: ptr cint): pointer {.importc: "QVersionNumber_fromString_QString_int".}
...
proc fromString*(_: type gen_qversionnumber_types.QVersionNumber, stringVal: openArray[char]): gen_qversionnumber_types.QVersionNumber =
  gen_qversionnumber_types.QVersionNumber(h: fcQVersionNumber_fromString_QString(struct_seaqt_string(data: if len(stringVal) > 0: addr stringVal[0] else: nil, len: csize_t(len(stringVal)))), owned: true)
...
proc fromString*(_: type gen_qversionnumber_types.QVersionNumber, stringVal: openArray[char], suffixIndex: ptr cint): gen_qversionnumber_types.QVersionNumber =
  gen_qversionnumber_types.QVersionNumber(h: fcQVersionNumber_fromString_QStringInt(struct_seaqt_string(data: if len(stringVal) > 0: addr stringVal[0] else: nil, len: csize_t(len(stringVal))), suffixIndex), owned: true)
