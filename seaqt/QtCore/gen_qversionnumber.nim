...
proc fcQVersionNumber_new2(maj: cint): ptr cQVersionNumber {.importc: "QVersionNumber_new_int".}
proc fcQVersionNumber_new3(maj: cint, min: cint): ptr cQVersionNumber {.importc: "QVersionNumber_new_int_int".}
proc fcQVersionNumber_new4(maj: cint, min: cint, mic: cint): ptr cQVersionNumber {.importc: "QVersionNumber_new_int_int_int".}
proc fcQVersionNumber_new5(fromVal: pointer): ptr cQVersionNumber {.importc: "QVersionNumber_new_QVersionNumber".}
...
proc create*(T: type gen_qversionnumber_types.QVersionNumber,
  ...
  let tmp = gen_qversionnumber_types.QVersionNumber(h: fcQVersionNumber_new2(maj), owned: true)
  tmp
proc create*(T: type gen_qversionnumber_types.QVersionNumber,
    maj: cint, min: cint): gen_qversionnumber_types.QVersionNumber =
  let tmp = gen_qversionnumber_types.QVersionNumber(h: fcQVersionNumber_new3(maj, min), owned: true)
  tmp
proc create*(T: type gen_qversionnumber_types.QVersionNumber,
    maj: cint, min: cint, mic: cint): gen_qversionnumber_types.QVersionNumber =
  let tmp = gen_qversionnumber_types.QVersionNumber(h: fcQVersionNumber_new4(maj, min, mic), owned: true)
  tmp
proc create*(T: type gen_qversionnumber_types.QVersionNumber,
    fromVal: gen_qversionnumber_types.QVersionNumber): gen_qversionnumber_types.QVersionNumber =
  let tmp = gen_qversionnumber_types.QVersionNumber(h: fcQVersionNumber_new5(fromVal.h), owned: true)
  tmp
