...
proc fcQMimeType_name(self: pointer): struct_seaqt_string {.importc: "QMimeType_name".}
proc fcQMimeType_comment(self: pointer): struct_seaqt_string {.importc: "QMimeType_comment".}
proc fcQMimeType_genericIconName(self: pointer): struct_seaqt_string {.importc: "QMimeType_genericIconName".}
proc fcQMimeType_iconName(self: pointer): struct_seaqt_string {.importc: "QMimeType_iconName".}
proc fcQMimeType_globPatterns(self: pointer): struct_seaqt_array {.importc: "QMimeType_globPatterns".}
proc fcQMimeType_parentMimeTypes(self: pointer): struct_seaqt_array {.importc: "QMimeType_parentMimeTypes".}
proc fcQMimeType_allAncestors(self: pointer): struct_seaqt_array {.importc: "QMimeType_allAncestors".}
proc fcQMimeType_aliases(self: pointer): struct_seaqt_array {.importc: "QMimeType_aliases".}
proc fcQMimeType_suffixes(self: pointer): struct_seaqt_array {.importc: "QMimeType_suffixes".}
proc fcQMimeType_preferredSuffix(self: pointer): struct_seaqt_string {.importc: "QMimeType_preferredSuffix".}
...
proc inherits*(self: gen_qmimetype_types.QMimeType, mimeTypeName: openArray[char]): bool =
  fcQMimeType_inherits(self.h, struct_seaqt_string(data: if len(mimeTypeName) > 0: addr mimeTypeName[0] else: nil, len: csize_t(len(mimeTypeName))))
