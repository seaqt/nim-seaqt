...
public:
	...
	friend QVariant* QMimeData_virtualbase_retrieveData(const VirtualQMimeData* self, struct miqt_string mimetype, QMetaType* preferredType);
...
VirtualQMimeData* QMimeData_new(const QMimeData_VTable* vtbl, size_t vdata) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQMimeData>());
