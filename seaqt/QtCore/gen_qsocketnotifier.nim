...
proc create*(T: type gen_qsocketnotifier_types.QSocketNotifier,
  ...
  gen_qsocketnotifier_types.QSocketNotifier(h: fcQSocketNotifier_new(addr(vtbl[].vtbl), cint(param1)), owned: true)
...
proc create*(T: type gen_qsocketnotifier_types.QSocketNotifier,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = miqt_exec_callback_cQSocketNotifier_disconnectNotify
  gen_qsocketnotifier_types.QSocketNotifier(h: fcQSocketNotifier_new2(addr(vtbl[].vtbl), socket, cint(param2)), owned: true)
...
proc create*(T: type gen_qsocketnotifier_types.QSocketNotifier,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = miqt_exec_callback_cQSocketNotifier_disconnectNotify
  gen_qsocketnotifier_types.QSocketNotifier(h: fcQSocketNotifier_new3(addr(vtbl[].vtbl), cint(param1), parent.h), owned: true)
...
proc create*(T: type gen_qsocketnotifier_types.QSocketNotifier,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = miqt_exec_callback_cQSocketNotifier_disconnectNotify
  gen_qsocketnotifier_types.QSocketNotifier(h: fcQSocketNotifier_new4(addr(vtbl[].vtbl), socket, cint(param2), parent.h), owned: true)
...
proc create*(T: type gen_qsocketnotifier_types.QSocketNotifier,
  ...
  vtbl[].h = fcQSocketNotifier_new(addr(vtbl[].vtbl), cint(param1))
  vtbl[].owned = true
...
proc create*(T: type gen_qsocketnotifier_types.QSocketNotifier,
  ...
  vtbl[].vtbl.disconnectNotify = miqt_exec_method_cQSocketNotifier_disconnectNotify
  if vtbl[].h != nil: delete(move(vtbl[]))
  vtbl[].h = fcQSocketNotifier_new2(addr(vtbl[].vtbl), socket, cint(param2))
  vtbl[].owned = true
...
proc create*(T: type gen_qsocketnotifier_types.QSocketNotifier,
  ...
  vtbl[].vtbl.disconnectNotify = miqt_exec_method_cQSocketNotifier_disconnectNotify
  if vtbl[].h != nil: delete(move(vtbl[]))
  vtbl[].h = fcQSocketNotifier_new3(addr(vtbl[].vtbl), cint(param1), parent.h)
  vtbl[].owned = true
...
proc create*(T: type gen_qsocketnotifier_types.QSocketNotifier,
  ...
  vtbl[].vtbl.disconnectNotify = miqt_exec_method_cQSocketNotifier_disconnectNotify
  if vtbl[].h != nil: delete(move(vtbl[]))
  vtbl[].h = fcQSocketNotifier_new4(addr(vtbl[].vtbl), socket, cint(param2), parent.h)
  vtbl[].owned = true
