...
VirtualQPluginLoader* QPluginLoader_new(const QPluginLoader_VTable* vtbl, size_t vdata) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQPluginLoader>());
	return _mem_ ? new (_mem_)VirtualQPluginLoader(vtbl) : nullptr;
}

VirtualQPluginLoader* QPluginLoader_new2(const QPluginLoader_VTable* vtbl, size_t vdata, struct miqt_string fileName) {
...
VirtualQPluginLoader* QPluginLoader_new4(const QPluginLoader_VTable* vtbl, size_t vdata, struct miqt_string fileName, QObject* parent) {
	QString fileName_QString = QString::fromUtf8(fileName.data, fileName.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQPluginLoader>());
