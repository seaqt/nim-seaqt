...
proc fcQBitArray_countOn(self: pointer, on: bool): cint {.importc: "QBitArray_count_on".}
...
proc fcQBitArray_setBitI(self: pointer, i: cint): void {.importc: "QBitArray_setBit_i".}
proc fcQBitArray_setBitIVal(self: pointer, i: cint, val: bool): void {.importc: "QBitArray_setBit_i_val".}
...
proc fcQBitArray_operatorSubscriptInt(self: pointer, i: cint): pointer {.importc: "QBitArray_operatorSubscript_int".}
proc fcQBitArray_operatorSubscriptConstInt(self: pointer, i: cint): bool {.importc: "QBitArray_operatorSubscript_const_int".}
proc fcQBitArray_operatorSubscriptUint(self: pointer, i: cuint): pointer {.importc: "QBitArray_operatorSubscript_uint".}
proc fcQBitArray_operatorSubscriptConstUint(self: pointer, i: cuint): bool {.importc: "QBitArray_operatorSubscript_const_uint".}
...
proc fcQBitArray_fillVal(self: pointer, val: bool): bool {.importc: "QBitArray_fill_val".}
proc fcQBitArray_fillValFirstLast(self: pointer, val: bool, first: cint, last: cint): void {.importc: "QBitArray_fill_val_first_last".}
...
proc fcQBitArray_fillValSize(self: pointer, val: bool, size: cint): bool {.importc: "QBitArray_fill_val_size".}
proc fcQBitArray_new(): ptr cQBitArray {.importc: "QBitArray_new".}
proc fcQBitArray_new2(size: cint): ptr cQBitArray {.importc: "QBitArray_new_size".}
proc fcQBitArray_new3(fromVal: pointer): ptr cQBitArray {.importc: "QBitArray_new_from".}
proc fcQBitArray_new4(size: cint, val: bool): ptr cQBitArray {.importc: "QBitArray_new_size_val".}
...
proc operatorSubscript*(self: gen_qbitarray_types.QBitArray, i: cint): gen_qbitarray_types.QBitRef =
  gen_qbitarray_types.QBitRef(h: fcQBitArray_operatorSubscriptInt(self.h, i), owned: true)

proc operatorSubscript2*(self: gen_qbitarray_types.QBitArray, i: cint): bool =
  fcQBitArray_operatorSubscriptConstInt(self.h, i)

proc operatorSubscript*(self: gen_qbitarray_types.QBitArray, i: cuint): gen_qbitarray_types.QBitRef =
  gen_qbitarray_types.QBitRef(h: fcQBitArray_operatorSubscriptUint(self.h, i), owned: true)

proc operatorSubscript2*(self: gen_qbitarray_types.QBitArray, i: cuint): bool =
  fcQBitArray_operatorSubscriptConstUint(self.h, i)
...
proc fill*(self: gen_qbitarray_types.QBitArray, val: bool): bool =
  fcQBitArray_fillVal(self.h, val)
...
proc fill*(self: gen_qbitarray_types.QBitArray, val: bool, size: cint): bool =
  fcQBitArray_fillValSize(self.h, val, size)
