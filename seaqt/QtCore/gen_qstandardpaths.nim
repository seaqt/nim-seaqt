...
template StateLocation*(_: type QStandardPathsStandardLocationEnum): untyped = 21
template GenericStateLocation*(_: type QStandardPathsStandardLocationEnum): untyped = 22
