...
proc fcQSequentialAnimationGroup_trUtf8(s: cstring): struct_seaqt_string {.importc: "QSequentialAnimationGroup_trUtf8".}
...
proc fcQSequentialAnimationGroup_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QSequentialAnimationGroup_trUtf82".}
proc fcQSequentialAnimationGroup_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QSequentialAnimationGroup_trUtf83".}
