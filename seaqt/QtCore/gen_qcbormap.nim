...
proc fcQCborMapIterator_operatorMinusGreaterConst(self: pointer): pointer {.importc: "QCborMap__Iterator_operatorMinusGreater_const".}
proc fcQCborMapIterator_key(self: pointer): pointer {.importc: "QCborMap__Iterator_key".}
proc fcQCborMapIterator_keyRef(self: pointer): pointer {.importc: "QCborMap__Iterator_keyRef".}
...
proc fcQCborMapConstIterator_keyRef(self: pointer): pointer {.importc: "QCborMap__ConstIterator_keyRef".}
...
proc operatorMinusGreater2*(self: gen_qcbormap_types.QCborMapIterator): gen_qcborvalue_types.QCborValueConstRef =
  gen_qcborvalue_types.QCborValueConstRef(h: fcQCborMapIterator_operatorMinusGreaterConst(self.h), owned: false)
...
proc keyRef*(self: gen_qcbormap_types.QCborMapIterator): gen_qcborvalue_types.QCborValueConstRef =
  gen_qcborvalue_types.QCborValueConstRef(h: fcQCborMapIterator_keyRef(self.h), owned: true)
...
proc keyRef*(self: gen_qcbormap_types.QCborMapConstIterator): gen_qcborvalue_types.QCborValueConstRef =
  gen_qcborvalue_types.QCborValueConstRef(h: fcQCborMapConstIterator_keyRef(self.h), owned: true)
