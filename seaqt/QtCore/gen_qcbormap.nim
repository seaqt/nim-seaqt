...
proc value*(self: gen_qcbormap_types.QCborMap, key: openArray[char]): gen_qcborvalue_types.QCborValue =
  gen_qcborvalue_types.QCborValue(h: fcQCborMap_value2(self.h, struct_seaqt_string(data: if len(key) > 0: addr key[0] else: nil, len: csize_t(len(key)))))
...
proc operatorSubscript*(self: gen_qcbormap_types.QCborMap, key: openArray[char]): gen_qcborvalue_types.QCborValue =
  gen_qcborvalue_types.QCborValue(h: fcQCborMap_operatorSubscript2(self.h, struct_seaqt_string(data: if len(key) > 0: addr key[0] else: nil, len: csize_t(len(key)))))
...
proc operatorSubscript2*(self: gen_qcbormap_types.QCborMap, key: openArray[char]): gen_qcborvalue_types.QCborValueRef =
  gen_qcborvalue_types.QCborValueRef(h: fcQCborMap_operatorSubscript6(self.h, struct_seaqt_string(data: if len(key) > 0: addr key[0] else: nil, len: csize_t(len(key)))))
...
proc take*(self: gen_qcbormap_types.QCborMap, key: openArray[char]): gen_qcborvalue_types.QCborValue =
  gen_qcborvalue_types.QCborValue(h: fcQCborMap_take2(self.h, struct_seaqt_string(data: if len(key) > 0: addr key[0] else: nil, len: csize_t(len(key)))))
...
proc find*(self: gen_qcbormap_types.QCborMap, key: openArray[char]): gen_qcbormap_types.QCborMapIterator =
  gen_qcbormap_types.QCborMapIterator(h: fcQCborMap_find2(self.h, struct_seaqt_string(data: if len(key) > 0: addr key[0] else: nil, len: csize_t(len(key)))))
...
proc constFind*(self: gen_qcbormap_types.QCborMap, key: openArray[char]): gen_qcbormap_types.QCborMapConstIterator =
  gen_qcbormap_types.QCborMapConstIterator(h: fcQCborMap_constFind2(self.h, struct_seaqt_string(data: if len(key) > 0: addr key[0] else: nil, len: csize_t(len(key)))))
...
proc find2*(self: gen_qcbormap_types.QCborMap, key: openArray[char]): gen_qcbormap_types.QCborMapConstIterator =
  gen_qcbormap_types.QCborMapConstIterator(h: fcQCborMap_find6(self.h, struct_seaqt_string(data: if len(key) > 0: addr key[0] else: nil, len: csize_t(len(key)))))
...
proc insert*(self: gen_qcbormap_types.QCborMap, key: openArray[char], value_x: gen_qcborvalue_types.QCborValue): gen_qcbormap_types.QCborMapIterator =
  gen_qcbormap_types.QCborMapIterator(h: fcQCborMap_insert3(self.h, struct_seaqt_string(data: if len(key) > 0: addr key[0] else: nil, len: csize_t(len(key))), value_x.h))
...
proc insert*(self: gen_qcbormap_types.QCborMap, v: tuple[first: gen_qcborvalue_types.QCborValue, second: gen_qcborvalue_types.QCborValue]): gen_qcbormap_types.QCborMapIterator =
  ...
  gen_qcbormap_types.QCborMapIterator(h: fcQCborMap_insertWithQCborMapvalueType(self.h, struct_seaqt_map(len: 1,keys: addr(v_CArray_First),values: addr(v_CArray_Second),)))
...
proc fromVariantMap*(_: type gen_qcbormap_types.QCborMap, map: Table[string,gen_qvariant_types.QVariant]): gen_qcbormap_types.QCborMap =
  ...
  gen_qcbormap_types.QCborMap(h: fcQCborMap_fromVariantMap(struct_seaqt_map(len: csize_t(len(map)),keys: if len(map) == 0: nil else: addr(map_Keys_CArray[0]), values: if len(map) == 0: nil else: addr(map_Values_CArray[0]),)))
...
proc fromVariantHash*(_: type gen_qcbormap_types.QCborMap, hash: Table[string,gen_qvariant_types.QVariant]): gen_qcbormap_types.QCborMap =
  ...
  gen_qcbormap_types.QCborMap(h: fcQCborMap_fromVariantHash(struct_seaqt_map(len: csize_t(len(hash)),keys: if len(hash) == 0: nil else: addr(hash_Keys_CArray[0]), values: if len(hash) == 0: nil else: addr(hash_Values_CArray[0]),)))
...
proc create*(T: type gen_qcbormap_types.QCborMap): gen_qcbormap_types.QCborMap =
  let tmp = gen_qcbormap_types.QCborMap(h: fcQCborMap_new())
  tmp
proc create*(T: type gen_qcbormap_types.QCborMap,
    other: gen_qcbormap_types.QCborMap): gen_qcbormap_types.QCborMap =
  let tmp = gen_qcbormap_types.QCborMap(h: fcQCborMap_new2(other.h))
  tmp
...
proc create*(T: type gen_qcbormap_types.QCborMapIterator): gen_qcbormap_types.QCborMapIterator =
  let tmp = gen_qcbormap_types.QCborMapIterator(h: fcQCborMapIterator_new())
  tmp
proc create*(T: type gen_qcbormap_types.QCborMapIterator,
  ...
  let tmp = gen_qcbormap_types.QCborMapIterator(h: fcQCborMapIterator_new2(param1.h))
  tmp
...
proc create*(T: type gen_qcbormap_types.QCborMapConstIterator): gen_qcbormap_types.QCborMapConstIterator =
  let tmp = gen_qcbormap_types.QCborMapConstIterator(h: fcQCborMapConstIterator_new())
  tmp
proc create*(T: type gen_qcbormap_types.QCborMapConstIterator,
  ...
  let tmp = gen_qcbormap_types.QCborMapConstIterator(h: fcQCborMapConstIterator_new2(param1.h))
  tmp
