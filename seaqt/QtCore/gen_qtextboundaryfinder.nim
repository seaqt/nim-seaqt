...
proc fcQTextBoundaryFinder_new4(typeVal: cint, chars: pointer, length: cint): ptr cQTextBoundaryFinder {.importc: "QTextBoundaryFinder_new_type_chars_length".}
proc fcQTextBoundaryFinder_new5(typeVal: cint, chars: pointer, length: cint, buffer: ptr uint8): ptr cQTextBoundaryFinder {.importc: "QTextBoundaryFinder_new_type_chars_length_buffer".}
proc fcQTextBoundaryFinder_new6(typeVal: cint, chars: pointer, length: cint, buffer: ptr uint8, bufferSize: cint): ptr cQTextBoundaryFinder {.importc: "QTextBoundaryFinder_new_type_chars_length_buffer_bufferSize".}
