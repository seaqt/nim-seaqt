...
proc fcQTextBoundaryFinder_swap(self: pointer, other: pointer): void {.importc: "QTextBoundaryFinder_swap".}
...
proc swap*(self: gen_qtextboundaryfinder_types.QTextBoundaryFinder, other: gen_qtextboundaryfinder_types.QTextBoundaryFinder): void =
  fcQTextBoundaryFinder_swap(self.h, other.h)
