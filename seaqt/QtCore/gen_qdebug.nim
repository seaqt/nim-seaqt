...
proc operatorShiftLeft*(self: gen_qdebug_types.QDebug, t: string): gen_qdebug_types.QDebug =
  gen_qdebug_types.QDebug(h: fcQDebug_operatorShiftLeftWithQString(self.h, struct_miqt_string(data: if len(t) > 0: addr t[0] else: nil, len: csize_t(len(t)))))

proc operatorShiftLeft*(self: gen_qdebug_types.QDebug, t: seq[byte]): gen_qdebug_types.QDebug =
  gen_qdebug_types.QDebug(h: fcQDebug_operatorShiftLeftWithQByteArray(self.h, struct_miqt_string(data: if len(t) > 0: addr t[0] else: nil, len: csize_t(len(t)))))
