...
proc operatorShiftLeft*(self: gen_qdebug_types.QDebug, t: openArray[char]): gen_qdebug_types.QDebug =
  gen_qdebug_types.QDebug(h: fcQDebug_operatorShiftLeftWithQString(self.h, struct_seaqt_string(data: if len(t) > 0: addr t[0] else: nil, len: csize_t(len(t)))), owned: false)

proc operatorShiftLeft*(self: gen_qdebug_types.QDebug, t: openArray[byte]): gen_qdebug_types.QDebug =
  gen_qdebug_types.QDebug(h: fcQDebug_operatorShiftLeftWithQByteArray(self.h, struct_seaqt_string(data: if len(t) > 0: addr t[0] else: nil, len: csize_t(len(t)))), owned: false)

proc operatorShiftLeft2*(self: gen_qdebug_types.QDebug, t: openArray[byte]): gen_qdebug_types.QDebug =
  gen_qdebug_types.QDebug(h: fcQDebug_operatorShiftLeftWithQByteArrayView(self.h, struct_seaqt_string(data: if len(t) > 0: addr t[0] else: nil, len: csize_t(len(t)))), owned: false)
...
proc maybeQuote*(self: gen_qdebug_types.QDebug, c: cchar): gen_qdebug_types.QDebug =
  gen_qdebug_types.QDebug(h: fcQDebug_maybeQuoteWithChar(self.h, c), owned: false)
...
proc create*(T: type gen_qdebug_types.QDebug,
  ...
  let tmp = gen_qdebug_types.QDebug(h: fcQDebug_new2(o.h), owned: true)
  tmp
...
proc maybeQuote*(self: gen_qdebug_types.QNoDebug, param1: cchar): gen_qdebug_types.QNoDebug =
  gen_qdebug_types.QNoDebug(h: fcQNoDebug_maybeQuoteWithChar(self.h, param1), owned: false)
