...
proc fcQDebug_operatorShiftLeftWithQString(self: pointer, t: struct_seaqt_string): pointer {.importc: "QDebug_operatorShiftLeftWithQString".}
proc fcQDebug_operatorShiftLeftWithQByteArray(self: pointer, t: struct_seaqt_string): pointer {.importc: "QDebug_operatorShiftLeftWithQByteArray".}
proc fcQDebug_operatorShiftLeftWithQByteArrayView(self: pointer, t: struct_seaqt_string): pointer {.importc: "QDebug_operatorShiftLeftWithQByteArrayView".}
proc fcQDebug_operatorShiftLeftWithVoid(self: pointer, t: pointer): pointer {.importc: "QDebug_operatorShiftLeftWithVoid".}
proc fcQDebug_maybeQuoteWithChar(self: pointer, c: cchar): pointer {.importc: "QDebug_maybeQuoteWithChar".}
...
proc fcQNoDebug_maybeQuoteWithChar(self: pointer, param1: cchar): pointer {.importc: "QNoDebug_maybeQuoteWithChar".}
...
proc operatorShiftLeft*(self: gen_qdebug_types.QDebug, t: openArray[char]): gen_qdebug_types.QDebug =
  gen_qdebug_types.QDebug(h: fcQDebug_operatorShiftLeftWithQString(self.h, struct_seaqt_string(data: if len(t) > 0: addr t[0] else: nil, len: csize_t(len(t)))))

proc operatorShiftLeft*(self: gen_qdebug_types.QDebug, t: openArray[byte]): gen_qdebug_types.QDebug =
  gen_qdebug_types.QDebug(h: fcQDebug_operatorShiftLeftWithQByteArray(self.h, struct_seaqt_string(data: if len(t) > 0: addr t[0] else: nil, len: csize_t(len(t)))))

proc operatorShiftLeft2*(self: gen_qdebug_types.QDebug, t: openArray[byte]): gen_qdebug_types.QDebug =
  gen_qdebug_types.QDebug(h: fcQDebug_operatorShiftLeftWithQByteArrayView(self.h, struct_seaqt_string(data: if len(t) > 0: addr t[0] else: nil, len: csize_t(len(t)))))
...
proc maybeQuote*(self: gen_qdebug_types.QDebug, c: cchar): gen_qdebug_types.QDebug =
  gen_qdebug_types.QDebug(h: fcQDebug_maybeQuoteWithChar(self.h, c))

proc create*(T: type gen_qdebug_types.QDebug,
    device: gen_qiodevice_types.QIODevice): gen_qdebug_types.QDebug =
  let tmp = gen_qdebug_types.QDebug(h: fcQDebug_new(device.h))
  tmp
proc create*(T: type gen_qdebug_types.QDebug,
    o: gen_qdebug_types.QDebug): gen_qdebug_types.QDebug =
  let tmp = gen_qdebug_types.QDebug(h: fcQDebug_new2(o.h))
  tmp
...
proc create*(T: type gen_qdebug_types.QDebugStateSaver,
  ...
  let tmp = gen_qdebug_types.QDebugStateSaver(h: fcQDebugStateSaver_new(dbg.h))
  tmp
...
proc maybeQuote*(self: gen_qdebug_types.QNoDebug, param1: cchar): gen_qdebug_types.QNoDebug =
  gen_qdebug_types.QNoDebug(h: fcQNoDebug_maybeQuoteWithChar(self.h, param1))
