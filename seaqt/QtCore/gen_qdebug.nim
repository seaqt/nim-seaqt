...
proc fcQDebug_quoteStrings(self: pointer): bool {.importc: "QDebug_quoteStrings".}
proc fcQDebug_setQuoteStrings(self: pointer, b: bool): void {.importc: "QDebug_setQuoteStrings".}
...
proc quoteStrings*(self: gen_qdebug_types.QDebug): bool =
  fcQDebug_quoteStrings(self.h)

proc setQuoteStrings*(self: gen_qdebug_types.QDebug, b: bool): void =
  fcQDebug_setQuoteStrings(self.h, b)
