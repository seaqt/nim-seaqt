...
proc fromStringList*(_: type gen_qcborarray_types.QCborArray, list: openArray[string]): gen_qcborarray_types.QCborArray =
  ...
  gen_qcborarray_types.QCborArray(h: fcQCborArray_fromStringList(struct_seaqt_array(len: csize_t(len(list)), data: if len(list) == 0: nil else: addr(list_CArray[0]))))
...
proc fromVariantList*(_: type gen_qcborarray_types.QCborArray, list: openArray[gen_qvariant_types.QVariant]): gen_qcborarray_types.QCborArray =
  ...
  gen_qcborarray_types.QCborArray(h: fcQCborArray_fromVariantList(struct_seaqt_array(len: csize_t(len(list)), data: if len(list) == 0: nil else: addr(list_CArray[0]))))
...
proc create*(T: type gen_qcborarray_types.QCborArray): gen_qcborarray_types.QCborArray =
  let tmp = gen_qcborarray_types.QCborArray(h: fcQCborArray_new())
  tmp
proc create*(T: type gen_qcborarray_types.QCborArray,
    other: gen_qcborarray_types.QCborArray): gen_qcborarray_types.QCborArray =
  let tmp = gen_qcborarray_types.QCborArray(h: fcQCborArray_new2(other.h))
  tmp
...
proc create*(T: type gen_qcborarray_types.QCborArrayIterator): gen_qcborarray_types.QCborArrayIterator =
  let tmp = gen_qcborarray_types.QCborArrayIterator(h: fcQCborArrayIterator_new())
  tmp
proc create*(T: type gen_qcborarray_types.QCborArrayIterator,
  ...
  let tmp = gen_qcborarray_types.QCborArrayIterator(h: fcQCborArrayIterator_new2(param1.h))
  tmp
...
proc create*(T: type gen_qcborarray_types.QCborArrayConstIterator): gen_qcborarray_types.QCborArrayConstIterator =
  let tmp = gen_qcborarray_types.QCborArrayConstIterator(h: fcQCborArrayConstIterator_new())
  tmp
proc create*(T: type gen_qcborarray_types.QCborArrayConstIterator,
  ...
  let tmp = gen_qcborarray_types.QCborArrayConstIterator(h: fcQCborArrayConstIterator_new2(param1.h))
  tmp
