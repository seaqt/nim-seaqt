...
VirtualQEvent* QEvent_new(const QEvent_VTable* vtbl, size_t vdata, int type) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQEvent>());
...
VirtualQTimerEvent* QTimerEvent_new(const QTimerEvent_VTable* vtbl, size_t vdata, int timerId) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQTimerEvent>());
...
VirtualQChildEvent* QChildEvent_new(const QChildEvent_VTable* vtbl, size_t vdata, int type, QObject* child) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQChildEvent>());
...
VirtualQDynamicPropertyChangeEvent* QDynamicPropertyChangeEvent_new(const QDynamicPropertyChangeEvent_VTable* vtbl, size_t vdata, struct miqt_string name) {
	QByteArray name_QByteArray(name.data, name.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQDynamicPropertyChangeEvent>());
