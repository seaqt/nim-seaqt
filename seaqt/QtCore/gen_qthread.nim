...
type QThreadQualityOfServiceEnum* = distinct cint
template Auto*(_: type QThreadQualityOfServiceEnum): untyped = 0
template High*(_: type QThreadQualityOfServiceEnum): untyped = 1
template Eco*(_: type QThreadQualityOfServiceEnum): untyped = 2
...
proc fcQThread_isMainThread(): bool {.importc: "QThread_isMainThread".}
...
proc fcQThread_isCurrentThread(self: pointer): bool {.importc: "QThread_isCurrentThread".}
proc fcQThread_setServiceLevel(self: pointer, serviceLevel: cint): void {.importc: "QThread_setServiceLevel".}
proc fcQThread_serviceLevel(self: pointer): cint {.importc: "QThread_serviceLevel".}
...
proc fcQThread_sleepUnsignedlong(param1: culong): void {.importc: "QThread_sleep_unsignedlong".}
...
proc isMainThread*(_: type gen_qthread_types.QThread): bool =
  fcQThread_isMainThread()
...
proc isCurrentThread*(self: gen_qthread_types.QThread): bool =
  fcQThread_isCurrentThread(self.h)

proc setServiceLevel*(self: gen_qthread_types.QThread, serviceLevel: cint): void =
  fcQThread_setServiceLevel(self.h, cint(serviceLevel))

proc serviceLevel*(self: gen_qthread_types.QThread): cint =
  cint(fcQThread_serviceLevel(self.h))
...
proc sleep*(_: type gen_qthread_types.QThread, param1: culong): void =
  fcQThread_sleepUnsignedlong(param1)
