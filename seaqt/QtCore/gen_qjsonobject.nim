...
proc create*(T: type gen_qjsonobject_types.QJsonObjectiterator,
  ...
  gen_qjsonobject_types.QJsonObjectiterator(h: fcQJsonObjectiterator_new3(param1.h), owned: true)
...
proc create*(T: type gen_qjsonobject_types.QJsonObjectconst_iterator,
  ...
  gen_qjsonobject_types.QJsonObjectconst_iterator(h: fcQJsonObjectconst_iterator_new4(param1.h), owned: true)
