...
proc fcQJsonObject_value(self: pointer, key: struct_seaqt_string): pointer {.importc: "QJsonObject_value".}
proc fcQJsonObject_operatorSubscript(self: pointer, key: struct_seaqt_string): pointer {.importc: "QJsonObject_operatorSubscript".}
proc fcQJsonObject_operatorSubscriptWithKey(self: pointer, key: struct_seaqt_string): pointer {.importc: "QJsonObject_operatorSubscriptWithKey".}
proc fcQJsonObject_remove(self: pointer, key: struct_seaqt_string): void {.importc: "QJsonObject_remove".}
proc fcQJsonObject_take(self: pointer, key: struct_seaqt_string): pointer {.importc: "QJsonObject_take".}
proc fcQJsonObject_contains(self: pointer, key: struct_seaqt_string): bool {.importc: "QJsonObject_contains".}
...
proc fcQJsonObject_find(self: pointer, key: struct_seaqt_string): pointer {.importc: "QJsonObject_find".}
proc fcQJsonObject_findWithKey(self: pointer, key: struct_seaqt_string): pointer {.importc: "QJsonObject_findWithKey".}
proc fcQJsonObject_constFind(self: pointer, key: struct_seaqt_string): pointer {.importc: "QJsonObject_constFind".}
proc fcQJsonObject_insert(self: pointer, key: struct_seaqt_string, value: pointer): pointer {.importc: "QJsonObject_insert".}
...
proc fromVariantMap*(_: type gen_qjsonobject_types.QJsonObject, map: Table[string,gen_qvariant_types.QVariant]): gen_qjsonobject_types.QJsonObject =
  ...
  gen_qjsonobject_types.QJsonObject(h: fcQJsonObject_fromVariantMap(struct_seaqt_map(len: csize_t(len(map)),keys: if len(map) == 0: nil else: addr(map_Keys_CArray[0]), values: if len(map) == 0: nil else: addr(map_Values_CArray[0]),)))
...
proc fromVariantHash*(_: type gen_qjsonobject_types.QJsonObject, map: Table[string,gen_qvariant_types.QVariant]): gen_qjsonobject_types.QJsonObject =
  ...
  gen_qjsonobject_types.QJsonObject(h: fcQJsonObject_fromVariantHash(struct_seaqt_map(len: csize_t(len(map)),keys: if len(map) == 0: nil else: addr(map_Keys_CArray[0]), values: if len(map) == 0: nil else: addr(map_Values_CArray[0]),)))
...
proc value*(self: gen_qjsonobject_types.QJsonObject, key: openArray[char]): gen_qjsonvalue_types.QJsonValue =
  gen_qjsonvalue_types.QJsonValue(h: fcQJsonObject_value(self.h, struct_seaqt_string(data: if len(key) > 0: addr key[0] else: nil, len: csize_t(len(key)))))

proc operatorSubscript*(self: gen_qjsonobject_types.QJsonObject, key: openArray[char]): gen_qjsonvalue_types.QJsonValue =
  gen_qjsonvalue_types.QJsonValue(h: fcQJsonObject_operatorSubscript(self.h, struct_seaqt_string(data: if len(key) > 0: addr key[0] else: nil, len: csize_t(len(key)))))

proc operatorSubscript2*(self: gen_qjsonobject_types.QJsonObject, key: openArray[char]): gen_qjsonvalue_types.QJsonValueRef =
  gen_qjsonvalue_types.QJsonValueRef(h: fcQJsonObject_operatorSubscriptWithKey(self.h, struct_seaqt_string(data: if len(key) > 0: addr key[0] else: nil, len: csize_t(len(key)))))

proc remove*(self: gen_qjsonobject_types.QJsonObject, key: openArray[char]): void =
  fcQJsonObject_remove(self.h, struct_seaqt_string(data: if len(key) > 0: addr key[0] else: nil, len: csize_t(len(key))))

proc take*(self: gen_qjsonobject_types.QJsonObject, key: openArray[char]): gen_qjsonvalue_types.QJsonValue =
  gen_qjsonvalue_types.QJsonValue(h: fcQJsonObject_take(self.h, struct_seaqt_string(data: if len(key) > 0: addr key[0] else: nil, len: csize_t(len(key)))))

proc contains*(self: gen_qjsonobject_types.QJsonObject, key: openArray[char]): bool =
  fcQJsonObject_contains(self.h, struct_seaqt_string(data: if len(key) > 0: addr key[0] else: nil, len: csize_t(len(key))))
...
proc find*(self: gen_qjsonobject_types.QJsonObject, key: openArray[char]): gen_qjsonobject_types.QJsonObjectiterator =
  gen_qjsonobject_types.QJsonObjectiterator(h: fcQJsonObject_find(self.h, struct_seaqt_string(data: if len(key) > 0: addr key[0] else: nil, len: csize_t(len(key)))))

proc find2*(self: gen_qjsonobject_types.QJsonObject, key: openArray[char]): gen_qjsonobject_types.QJsonObjectconst_iterator =
  gen_qjsonobject_types.QJsonObjectconst_iterator(h: fcQJsonObject_findWithKey(self.h, struct_seaqt_string(data: if len(key) > 0: addr key[0] else: nil, len: csize_t(len(key)))))

proc constFind*(self: gen_qjsonobject_types.QJsonObject, key: openArray[char]): gen_qjsonobject_types.QJsonObjectconst_iterator =
  gen_qjsonobject_types.QJsonObjectconst_iterator(h: fcQJsonObject_constFind(self.h, struct_seaqt_string(data: if len(key) > 0: addr key[0] else: nil, len: csize_t(len(key)))))
...
proc insert*(self: gen_qjsonobject_types.QJsonObject, key: openArray[char], value: gen_qjsonvalue_types.QJsonValue): gen_qjsonobject_types.QJsonObjectiterator =
  gen_qjsonobject_types.QJsonObjectiterator(h: fcQJsonObject_insert(self.h, struct_seaqt_string(data: if len(key) > 0: addr key[0] else: nil, len: csize_t(len(key))), value.h))
...
proc create*(T: type gen_qjsonobject_types.QJsonObject): gen_qjsonobject_types.QJsonObject =
  let tmp = gen_qjsonobject_types.QJsonObject(h: fcQJsonObject_new())
  tmp
proc create*(T: type gen_qjsonobject_types.QJsonObject,
  ...
  let tmp = gen_qjsonobject_types.QJsonObject(h: fcQJsonObject_new2(other.h))
  tmp
...
proc create*(T: type gen_qjsonobject_types.QJsonObjectiterator): gen_qjsonobject_types.QJsonObjectiterator =
  let tmp = gen_qjsonobject_types.QJsonObjectiterator(h: fcQJsonObjectiterator_new())
  tmp
proc create*(T: type gen_qjsonobject_types.QJsonObjectiterator,
  ...
  let tmp = gen_qjsonobject_types.QJsonObjectiterator(h: fcQJsonObjectiterator_new2(obj.h, index))
  tmp
proc create*(T: type gen_qjsonobject_types.QJsonObjectiterator,
    param1: gen_qjsonobject_types.QJsonObjectiterator): gen_qjsonobject_types.QJsonObjectiterator =
  let tmp = gen_qjsonobject_types.QJsonObjectiterator(h: fcQJsonObjectiterator_new3(param1.h))
  tmp
...
proc create*(T: type gen_qjsonobject_types.QJsonObjectconst_iterator): gen_qjsonobject_types.QJsonObjectconst_iterator =
  let tmp = gen_qjsonobject_types.QJsonObjectconst_iterator(h: fcQJsonObjectconst_iterator_new())
  tmp
proc create*(T: type gen_qjsonobject_types.QJsonObjectconst_iterator,
  ...
  let tmp = gen_qjsonobject_types.QJsonObjectconst_iterator(h: fcQJsonObjectconst_iterator_new2(obj.h, index))
  tmp
proc create*(T: type gen_qjsonobject_types.QJsonObjectconst_iterator,
    other: gen_qjsonobject_types.QJsonObjectiterator): gen_qjsonobject_types.QJsonObjectconst_iterator =
  let tmp = gen_qjsonobject_types.QJsonObjectconst_iterator(h: fcQJsonObjectconst_iterator_new3(other.h))
  tmp
proc create*(T: type gen_qjsonobject_types.QJsonObjectconst_iterator,
    param1: gen_qjsonobject_types.QJsonObjectconst_iterator): gen_qjsonobject_types.QJsonObjectconst_iterator =
  let tmp = gen_qjsonobject_types.QJsonObjectconst_iterator(h: fcQJsonObjectconst_iterator_new4(param1.h))
  tmp
