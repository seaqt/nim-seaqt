...
proc fcQJsonObjectiterator_keyView(self: pointer): struct_seaqt_string {.importc: "QJsonObject__iterator_keyView".}
...
proc fcQJsonObjectconst_iterator_keyView(self: pointer): struct_seaqt_string {.importc: "QJsonObject__const_iterator_keyView".}
...
proc keyView*(self: gen_qjsonobject_types.QJsonObjectiterator): string =
  let v_ms = fcQJsonObjectiterator_keyView(self.h)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc keyView*(self: gen_qjsonobject_types.QJsonObjectconst_iterator): string =
  let v_ms = fcQJsonObjectconst_iterator_keyView(self.h)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
