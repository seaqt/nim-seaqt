...
proc create*(T: type gen_qjsonobject_types.QJsonObjectiterator,
  ...
  let tmp = gen_qjsonobject_types.QJsonObjectiterator(h: fcQJsonObjectiterator_new3(other.h))
  tmp
...
proc create*(T: type gen_qjsonobject_types.QJsonObjectconst_iterator,
  ...
  let tmp = gen_qjsonobject_types.QJsonObjectconst_iterator(h: fcQJsonObjectconst_iterator_new4(other.h))
  tmp
