...
proc value*(self: gen_qjsonobject_types.QJsonObject, key: openArray[char]): gen_qjsonvalue_types.QJsonValue =
  gen_qjsonvalue_types.QJsonValue(h: fcQJsonObject_value(self.h, struct_seaqt_string(data: if len(key) > 0: addr key[0] else: nil, len: csize_t(len(key)))), owned: true)

proc operatorSubscript*(self: gen_qjsonobject_types.QJsonObject, key: openArray[char]): gen_qjsonvalue_types.QJsonValue =
  gen_qjsonvalue_types.QJsonValue(h: fcQJsonObject_operatorSubscript(self.h, struct_seaqt_string(data: if len(key) > 0: addr key[0] else: nil, len: csize_t(len(key)))), owned: true)

proc operatorSubscript2*(self: gen_qjsonobject_types.QJsonObject, key: openArray[char]): gen_qjsonvalue_types.QJsonValueRef =
  gen_qjsonvalue_types.QJsonValueRef(h: fcQJsonObject_operatorSubscriptWithKey(self.h, struct_seaqt_string(data: if len(key) > 0: addr key[0] else: nil, len: csize_t(len(key)))), owned: true)
...
proc take*(self: gen_qjsonobject_types.QJsonObject, key: openArray[char]): gen_qjsonvalue_types.QJsonValue =
  gen_qjsonvalue_types.QJsonValue(h: fcQJsonObject_take(self.h, struct_seaqt_string(data: if len(key) > 0: addr key[0] else: nil, len: csize_t(len(key)))), owned: true)
...
proc find*(self: gen_qjsonobject_types.QJsonObject, key: openArray[char]): gen_qjsonobject_types.QJsonObjectiterator =
  gen_qjsonobject_types.QJsonObjectiterator(h: fcQJsonObject_find(self.h, struct_seaqt_string(data: if len(key) > 0: addr key[0] else: nil, len: csize_t(len(key)))), owned: true)

proc find2*(self: gen_qjsonobject_types.QJsonObject, key: openArray[char]): gen_qjsonobject_types.QJsonObjectconst_iterator =
  gen_qjsonobject_types.QJsonObjectconst_iterator(h: fcQJsonObject_findWithKey(self.h, struct_seaqt_string(data: if len(key) > 0: addr key[0] else: nil, len: csize_t(len(key)))), owned: true)

proc constFind*(self: gen_qjsonobject_types.QJsonObject, key: openArray[char]): gen_qjsonobject_types.QJsonObjectconst_iterator =
  gen_qjsonobject_types.QJsonObjectconst_iterator(h: fcQJsonObject_constFind(self.h, struct_seaqt_string(data: if len(key) > 0: addr key[0] else: nil, len: csize_t(len(key)))), owned: true)
...
proc insert*(self: gen_qjsonobject_types.QJsonObject, key: openArray[char], value: gen_qjsonvalue_types.QJsonValue): gen_qjsonobject_types.QJsonObjectiterator =
  gen_qjsonobject_types.QJsonObjectiterator(h: fcQJsonObject_insert(self.h, struct_seaqt_string(data: if len(key) > 0: addr key[0] else: nil, len: csize_t(len(key))), value.h), owned: true)
...
proc create*(T: type gen_qjsonobject_types.QJsonObject,
  ...
  let tmp = gen_qjsonobject_types.QJsonObject(h: fcQJsonObject_new2(other.h), owned: true)
  tmp
...
proc operatorMinusGreater*(self: gen_qjsonobject_types.QJsonObjectiterator): gen_qjsonvalue_types.QJsonValueRefPtr =
  gen_qjsonvalue_types.QJsonValueRefPtr(h: fcQJsonObjectiterator_operatorMinusGreater(self.h), owned: true)
...
proc create*(T: type gen_qjsonobject_types.QJsonObjectiterator,
  ...
  let tmp = gen_qjsonobject_types.QJsonObjectiterator(h: fcQJsonObjectiterator_new3(param1.h), owned: true)
  tmp
...
proc value*(self: gen_qjsonobject_types.QJsonObjectconst_iterator): gen_qjsonvalue_types.QJsonValue =
  gen_qjsonvalue_types.QJsonValue(h: fcQJsonObjectconst_iterator_value(self.h), owned: true)

proc operatorMultiply*(self: gen_qjsonobject_types.QJsonObjectconst_iterator): gen_qjsonvalue_types.QJsonValue =
  gen_qjsonvalue_types.QJsonValue(h: fcQJsonObjectconst_iterator_operatorMultiply(self.h), owned: true)

proc operatorMinusGreater*(self: gen_qjsonobject_types.QJsonObjectconst_iterator): gen_qjsonvalue_types.QJsonValuePtr =
  gen_qjsonvalue_types.QJsonValuePtr(h: fcQJsonObjectconst_iterator_operatorMinusGreater(self.h), owned: true)

proc operatorSubscript*(self: gen_qjsonobject_types.QJsonObjectconst_iterator, j: cint): gen_qjsonvalue_types.QJsonValue =
  gen_qjsonvalue_types.QJsonValue(h: fcQJsonObjectconst_iterator_operatorSubscript(self.h, j), owned: true)
...
proc create*(T: type gen_qjsonobject_types.QJsonObjectconst_iterator,
  ...
  let tmp = gen_qjsonobject_types.QJsonObjectconst_iterator(h: fcQJsonObjectconst_iterator_new4(param1.h), owned: true)
  tmp
