...
proc fcQJsonObjectiterator_operatorMinusInt(self: pointer, j: cint): pointer {.importc: "QJsonObject__iterator_operatorMinus_int".}
...
proc fcQJsonObjectiterator_operatorMinus_QJsonObjectIterator(self: pointer, j: pointer): cint {.importc: "QJsonObject__iterator_operatorMinus_QJsonObject_iterator".}
...
proc fcQJsonObjectiterator_new2(obj: pointer, index: cint): ptr cQJsonObjectiterator {.importc: "QJsonObject__iterator_new_obj_index".}
...
proc fcQJsonObjectconst_iterator_operatorMinusInt(self: pointer, j: cint): pointer {.importc: "QJsonObject__const_iterator_operatorMinus_int".}
...
proc fcQJsonObjectconst_iterator_operatorMinus_QJsonObjectConstIterator(self: pointer, j: pointer): cint {.importc: "QJsonObject__const_iterator_operatorMinus_QJsonObject_const_iterator".}
...
proc fcQJsonObjectconst_iterator_new2(obj: pointer, index: cint): ptr cQJsonObjectconst_iterator {.importc: "QJsonObject__const_iterator_new_obj_index".}
...
proc operatorMinus*(self: gen_qjsonobject_types.QJsonObjectiterator, j: cint): gen_qjsonobject_types.QJsonObjectiterator =
  gen_qjsonobject_types.QJsonObjectiterator(h: fcQJsonObjectiterator_operatorMinusInt(self.h, j), owned: true)
...
proc operatorMinus*(self: gen_qjsonobject_types.QJsonObjectconst_iterator, j: cint): gen_qjsonobject_types.QJsonObjectconst_iterator =
  gen_qjsonobject_types.QJsonObjectconst_iterator(h: fcQJsonObjectconst_iterator_operatorMinusInt(self.h, j), owned: true)
