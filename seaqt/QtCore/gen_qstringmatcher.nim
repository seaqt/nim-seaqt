...
proc fcQStringMatcher_indexIn(self: pointer, str: struct_seaqt_string): int64 {.importc: "QStringMatcher_indexIn".}
...
proc fcQStringMatcher_indexIn3(self: pointer, str: struct_seaqt_string, fromVal: int64): int64 {.importc: "QStringMatcher_indexIn3".}
proc fcQStringMatcher_indexIn4(self: pointer, str: pointer, length: int64, fromVal: int64): int64 {.importc: "QStringMatcher_indexIn4".}
