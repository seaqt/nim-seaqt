...
proc fcQByteArrayMatcher_indexInWithData(self: pointer, data: struct_seaqt_string): int64 {.importc: "QByteArrayMatcher_indexInWithData".}
proc fcQByteArrayMatcher_pattern(self: pointer): struct_seaqt_string {.importc: "QByteArrayMatcher_pattern".}
proc fcQByteArrayMatcher_indexIn2(self: pointer, str: cstring, len: int64, fromVal: int64): int64 {.importc: "QByteArrayMatcher_indexIn2".}
proc fcQByteArrayMatcher_indexIn3(self: pointer, data: struct_seaqt_string, fromVal: int64): int64 {.importc: "QByteArrayMatcher_indexIn3".}
...
proc fcQByteArrayMatcher_new3(pattern: struct_seaqt_string): ptr cQByteArrayMatcher {.importc: "QByteArrayMatcher_new3".}
...
proc indexIn*(self: gen_qbytearraymatcher_types.QByteArrayMatcher, data: openArray[byte]): int64 =
  fcQByteArrayMatcher_indexInWithData(self.h, struct_seaqt_string(data: if len(data) > 0: addr data[0] else: nil, len: csize_t(len(data))))
...
proc indexIn*(self: gen_qbytearraymatcher_types.QByteArrayMatcher, str: cstring, len: int64, fromVal: int64): int64 =
  fcQByteArrayMatcher_indexIn2(self.h, str, len, fromVal)

proc indexIn*(self: gen_qbytearraymatcher_types.QByteArrayMatcher, data: openArray[byte], fromVal: int64): int64 =
  fcQByteArrayMatcher_indexIn3(self.h, struct_seaqt_string(data: if len(data) > 0: addr data[0] else: nil, len: csize_t(len(data))), fromVal)

proc create*(T: type gen_qbytearraymatcher_types.QByteArrayMatcher): gen_qbytearraymatcher_types.QByteArrayMatcher =
  let tmp = gen_qbytearraymatcher_types.QByteArrayMatcher(h: fcQByteArrayMatcher_new())
  tmp
proc create*(T: type gen_qbytearraymatcher_types.QByteArrayMatcher,
  ...
  let tmp = gen_qbytearraymatcher_types.QByteArrayMatcher(h: fcQByteArrayMatcher_new2(struct_seaqt_string(data: if len(pattern) > 0: addr pattern[0] else: nil, len: csize_t(len(pattern)))))
  tmp
proc create2*(T: type gen_qbytearraymatcher_types.QByteArrayMatcher,
    pattern: openArray[byte]): gen_qbytearraymatcher_types.QByteArrayMatcher =
  let tmp = gen_qbytearraymatcher_types.QByteArrayMatcher(h: fcQByteArrayMatcher_new3(struct_seaqt_string(data: if len(pattern) > 0: addr pattern[0] else: nil, len: csize_t(len(pattern)))))
  tmp
proc create*(T: type gen_qbytearraymatcher_types.QByteArrayMatcher,
    pattern: cstring): gen_qbytearraymatcher_types.QByteArrayMatcher =
  let tmp = gen_qbytearraymatcher_types.QByteArrayMatcher(h: fcQByteArrayMatcher_new4(pattern))
  tmp
proc create*(T: type gen_qbytearraymatcher_types.QByteArrayMatcher,
    other: gen_qbytearraymatcher_types.QByteArrayMatcher): gen_qbytearraymatcher_types.QByteArrayMatcher =
  let tmp = gen_qbytearraymatcher_types.QByteArrayMatcher(h: fcQByteArrayMatcher_new5(other.h))
  tmp
proc create*(T: type gen_qbytearraymatcher_types.QByteArrayMatcher,
    pattern: cstring, length: int64): gen_qbytearraymatcher_types.QByteArrayMatcher =
  let tmp = gen_qbytearraymatcher_types.QByteArrayMatcher(h: fcQByteArrayMatcher_new6(pattern, length))
  tmp
