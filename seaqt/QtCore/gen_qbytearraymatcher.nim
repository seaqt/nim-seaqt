...
proc setPattern*(self: gen_qbytearraymatcher_types.QByteArrayMatcher, pattern: openArray[byte]): void =
  fcQByteArrayMatcher_setPattern(self.h, struct_miqt_string(data: if len(pattern) > 0: addr pattern[0] else: nil, len: csize_t(len(pattern))))
...
proc indexIn*(self: gen_qbytearraymatcher_types.QByteArrayMatcher, data: openArray[byte]): int64 =
  fcQByteArrayMatcher_indexInWithData(self.h, struct_miqt_string(data: if len(data) > 0: addr data[0] else: nil, len: csize_t(len(data))))
...
proc indexIn*(self: gen_qbytearraymatcher_types.QByteArrayMatcher, data: openArray[byte], fromVal: int64): int64 =
  fcQByteArrayMatcher_indexIn2(self.h, struct_miqt_string(data: if len(data) > 0: addr data[0] else: nil, len: csize_t(len(data))), fromVal)
...
proc create*(T: type gen_qbytearraymatcher_types.QByteArrayMatcher,
  ...
  let tmp = gen_qbytearraymatcher_types.QByteArrayMatcher(h: fcQByteArrayMatcher_new2(struct_miqt_string(data: if len(pattern) > 0: addr pattern[0] else: nil, len: csize_t(len(pattern)))), owned: true)
  tmp
proc create2*(T: type gen_qbytearraymatcher_types.QByteArrayMatcher,
    pattern: openArray[byte]): gen_qbytearraymatcher_types.QByteArrayMatcher =
  let tmp = gen_qbytearraymatcher_types.QByteArrayMatcher(h: fcQByteArrayMatcher_new3(struct_miqt_string(data: if len(pattern) > 0: addr pattern[0] else: nil, len: csize_t(len(pattern)))), owned: true)
  tmp
proc create*(T: type gen_qbytearraymatcher_types.QByteArrayMatcher,
