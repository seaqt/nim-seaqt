...
proc miqt_exec_method_cQAbstractProxyModel_clearItemData(vtbl: pointer, inst: pointer, index: pointer): bool {.cdecl.} =
  let vtbl = cast[VirtualQAbstractProxyModel](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractProxyModel, vtbl)))
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
...
proc miqt_exec_method_cQAbstractProxyModel_multiData(vtbl: pointer, inst: pointer, index: pointer, roleDataSpan: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQAbstractProxyModel](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractProxyModel, vtbl)))
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
  let slotval2 = gen_qabstractitemmodel_types.QModelRoleDataSpan(h: roleDataSpan, owned: true)
...
proc miqt_exec_method_cQAbstractProxyModel_resetInternalData(vtbl: pointer, inst: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQAbstractProxyModel](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractProxyModel, vtbl)))
...
proc create*(T: type gen_qabstractproxymodel_types.QAbstractProxyModel,
  ...
  vtbl[].vtbl.clearItemData = miqt_exec_method_cQAbstractProxyModel_clearItemData
  ...
  vtbl[].vtbl.multiData = miqt_exec_method_cQAbstractProxyModel_multiData
  vtbl[].vtbl.resetInternalData = miqt_exec_method_cQAbstractProxyModel_resetInternalData
