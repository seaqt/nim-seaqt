...
proc fcQAbstractProxyModel_trUtf8S(s: cstring): struct_seaqt_string {.importc: "QAbstractProxyModel_trUtf8_s".}
...
proc fcQAbstractProxyModel_itemData(self: pointer, index: pointer): struct_seaqt_map {.importc: "QAbstractProxyModel_itemData".}
...
proc fcQAbstractProxyModel_setItemData(self: pointer, index: pointer, roles: struct_seaqt_map): bool {.importc: "QAbstractProxyModel_setItemData".}
...
proc fcQAbstractProxyModel_mimeData(self: pointer, indexes: struct_seaqt_array): pointer {.importc: "QAbstractProxyModel_mimeData".}
...
proc fcQAbstractProxyModel_mimeTypes(self: pointer): struct_seaqt_array {.importc: "QAbstractProxyModel_mimeTypes".}
...
proc fcQAbstractProxyModel_trUtf8SC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QAbstractProxyModel_trUtf8_s_c".}
proc fcQAbstractProxyModel_trUtf8SCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QAbstractProxyModel_trUtf8_s_c_n".}
...
proc fcQAbstractProxyModel_virtualbase_itemData(self: pointer, index: pointer): struct_seaqt_map {.importc: "QAbstractProxyModel_virtualbase_itemData".}
...
proc fcQAbstractProxyModel_virtualbase_setItemData(self: pointer, index: pointer, roles: struct_seaqt_map): bool {.importc: "QAbstractProxyModel_virtualbase_setItemData".}
...
proc fcQAbstractProxyModel_virtualbase_mimeData(self: pointer, indexes: struct_seaqt_array): pointer {.importc: "QAbstractProxyModel_virtualbase_mimeData".}
...
proc fcQAbstractProxyModel_virtualbase_mimeTypes(self: pointer): struct_seaqt_array {.importc: "QAbstractProxyModel_virtualbase_mimeTypes".}
...
proc fcQAbstractProxyModel_virtualbase_match(self: pointer, start: pointer, role: cint, value: pointer, hits: cint, flags: cint): struct_seaqt_array {.importc: "QAbstractProxyModel_virtualbase_match".}
proc fcQAbstractProxyModel_virtualbase_roleNames(self: pointer): struct_seaqt_map {.importc: "QAbstractProxyModel_virtualbase_roleNames".}
...
proc fcQAbstractProxyModel_protectedbase_changePersistentIndexList(self: pointer, fromVal: struct_seaqt_array, to: struct_seaqt_array): void {.importc: "QAbstractProxyModel_protectedbase_changePersistentIndexList".}
proc fcQAbstractProxyModel_protectedbase_persistentIndexList(self: pointer): struct_seaqt_array {.importc: "QAbstractProxyModel_protectedbase_persistentIndexList".}
...
proc trUtf8*(_: type gen_qabstractproxymodel_types.QAbstractProxyModel, s: cstring): string =
  let v_ms = fcQAbstractProxyModel_trUtf8S(s)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc setItemData*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, index: gen_qabstractitemmodel_types.QModelIndex, roles: Table[cint,gen_qvariant_types.QVariant]): bool =
  ...
  fcQAbstractProxyModel_setItemData(self.h, index.h, struct_seaqt_map(len: csize_t(len(roles)),keys: if len(roles) == 0: nil else: addr(roles_Keys_CArray[0]), values: if len(roles) == 0: nil else: addr(roles_Values_CArray[0]),))
...
proc mimeData*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, indexes: openArray[gen_qabstractitemmodel_types.QModelIndex]): gen_qmimedata_types.QMimeData =
  ...
  gen_qmimedata_types.QMimeData(h: fcQAbstractProxyModel_mimeData(self.h, struct_seaqt_array(len: csize_t(len(indexes)), data: if len(indexes) == 0: nil else: addr(indexes_CArray[0]))), owned: false)
...
proc QAbstractProxyModelsetItemData*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, index: gen_qabstractitemmodel_types.QModelIndex, roles: Table[cint,gen_qvariant_types.QVariant]): bool =
  ...
  fcQAbstractProxyModel_virtualbase_setItemData(self.h, index.h, struct_seaqt_map(len: csize_t(len(roles)),keys: if len(roles) == 0: nil else: addr(roles_Keys_CArray[0]), values: if len(roles) == 0: nil else: addr(roles_Values_CArray[0]),))
...
proc QAbstractProxyModelmimeData*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, indexes: openArray[gen_qabstractitemmodel_types.QModelIndex]): gen_qmimedata_types.QMimeData =
  ...
  gen_qmimedata_types.QMimeData(h: fcQAbstractProxyModel_virtualbase_mimeData(self.h, struct_seaqt_array(len: csize_t(len(indexes)), data: if len(indexes) == 0: nil else: addr(indexes_CArray[0]))), owned: false)
...
proc fcQAbstractProxyModel_vtable_callback_itemData(self: pointer, index: pointer): struct_seaqt_map {.cdecl.} =
  let vtbl = cast[ptr QAbstractProxyModelVTable](fcQAbstractProxyModel_vdata(self)[])
  let self = QAbstractProxyModel(h: self)
...
proc fcQAbstractProxyModel_vtable_callback_setItemData(self: pointer, index: pointer, roles: struct_seaqt_map): bool {.cdecl.} =
  let vtbl = cast[ptr QAbstractProxyModelVTable](fcQAbstractProxyModel_vdata(self)[])
  let self = QAbstractProxyModel(h: self)
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
  var vroles_mm = roles
...
proc fcQAbstractProxyModel_vtable_callback_mimeData(self: pointer, indexes: struct_seaqt_array): pointer {.cdecl.} =
  let vtbl = cast[ptr QAbstractProxyModelVTable](fcQAbstractProxyModel_vdata(self)[])
  let self = QAbstractProxyModel(h: self)
...
proc fcQAbstractProxyModel_vtable_callback_mimeTypes(self: pointer): struct_seaqt_array {.cdecl.} =
  let vtbl = cast[ptr QAbstractProxyModelVTable](fcQAbstractProxyModel_vdata(self)[])
  let self = QAbstractProxyModel(h: self)
...
proc fcQAbstractProxyModel_vtable_callback_match(self: pointer, start: pointer, role: cint, value: pointer, hits: cint, flags: cint): struct_seaqt_array {.cdecl.} =
  let vtbl = cast[ptr QAbstractProxyModelVTable](fcQAbstractProxyModel_vdata(self)[])
  let self = QAbstractProxyModel(h: self)
...
proc fcQAbstractProxyModel_vtable_callback_roleNames(self: pointer): struct_seaqt_map {.cdecl.} =
  let vtbl = cast[ptr QAbstractProxyModelVTable](fcQAbstractProxyModel_vdata(self)[])
  let self = QAbstractProxyModel(h: self)
...
proc fcQAbstractProxyModel_method_callback_itemData(self: pointer, index: pointer): struct_seaqt_map {.cdecl.} =
  let inst = cast[VirtualQAbstractProxyModel](fcQAbstractProxyModel_vdata(self)[])
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
...
proc fcQAbstractProxyModel_method_callback_setItemData(self: pointer, index: pointer, roles: struct_seaqt_map): bool {.cdecl.} =
  let inst = cast[VirtualQAbstractProxyModel](fcQAbstractProxyModel_vdata(self)[])
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
  var vroles_mm = roles
  var vrolesx_ret: Table[cint, gen_qvariant_types.QVariant]
...
proc fcQAbstractProxyModel_method_callback_mimeData(self: pointer, indexes: struct_seaqt_array): pointer {.cdecl.} =
  let inst = cast[VirtualQAbstractProxyModel](fcQAbstractProxyModel_vdata(self)[])
  var vindexes_ma = indexes
  var vindexesx_ret = newSeq[gen_qabstractitemmodel_types.QModelIndex](int(vindexes_ma.len))
  let vindexes_outCast = cast[ptr UncheckedArray[pointer]](vindexes_ma.data)
...
proc fcQAbstractProxyModel_method_callback_mimeTypes(self: pointer): struct_seaqt_array {.cdecl.} =
  let inst = cast[VirtualQAbstractProxyModel](fcQAbstractProxyModel_vdata(self)[])
...
proc fcQAbstractProxyModel_method_callback_match(self: pointer, start: pointer, role: cint, value: pointer, hits: cint, flags: cint): struct_seaqt_array {.cdecl.} =
  let inst = cast[VirtualQAbstractProxyModel](fcQAbstractProxyModel_vdata(self)[])
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: start, owned: false)
  let slotval2 = role
  let slotval3 = gen_qvariant_types.QVariant(h: value, owned: false)
...
proc fcQAbstractProxyModel_method_callback_roleNames(self: pointer): struct_seaqt_map {.cdecl.} =
  let inst = cast[VirtualQAbstractProxyModel](fcQAbstractProxyModel_vdata(self)[])
...
proc encodeData*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, indexes: openArray[gen_qabstractitemmodel_types.QModelIndex], stream: gen_qdatastream_types.QDataStream): void =
  ...
  fcQAbstractProxyModel_protectedbase_encodeData(self.h, struct_seaqt_array(len: csize_t(len(indexes)), data: if len(indexes) == 0: nil else: addr(indexes_CArray[0])), stream.h)
...
proc changePersistentIndexList*(self: gen_qabstractproxymodel_types.QAbstractProxyModel, fromVal: openArray[gen_qabstractitemmodel_types.QModelIndex], to: openArray[gen_qabstractitemmodel_types.QModelIndex]): void =
  ...
  fcQAbstractProxyModel_protectedbase_changePersistentIndexList(self.h, struct_seaqt_array(len: csize_t(len(fromVal)), data: if len(fromVal) == 0: nil else: addr(fromVal_CArray[0])), struct_seaqt_array(len: csize_t(len(to)), data: if len(to) == 0: nil else: addr(to_CArray[0])))
...
proc create*(T: type gen_qabstractproxymodel_types.QAbstractProxyModel,
  ...
  let tmp = gen_qabstractproxymodel_types.QAbstractProxyModel(h: fcQAbstractProxyModel_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
...
proc create*(T: type gen_qabstractproxymodel_types.QAbstractProxyModel,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQAbstractProxyModel_vtable_callback_disconnectNotify
  let tmp = gen_qabstractproxymodel_types.QAbstractProxyModel(h: fcQAbstractProxyModel_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQAbstractProxyModel_vdata(tmp.h)[] = addr(vtbl[])
  tmp
