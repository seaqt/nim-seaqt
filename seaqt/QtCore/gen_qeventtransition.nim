...
proc fcQEventTransition_trUtf8S(s: cstring): struct_seaqt_string {.importc: "QEventTransition_trUtf8_s".}
...
proc fcQEventTransition_trUtf8SC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QEventTransition_trUtf8_s_c".}
proc fcQEventTransition_trUtf8SCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QEventTransition_trUtf8_s_c_n".}
...
proc trUtf8*(_: type gen_qeventtransition_types.QEventTransition, s: cstring): string =
  let v_ms = fcQEventTransition_trUtf8S(s)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc create*(T: type gen_qeventtransition_types.QEventTransition,
  ...
  inst[].h = fcQEventTransition_new(addr(cQEventTransition_mvtbl), csize_t(sizeof(pointer)))
  fcQEventTransition_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qeventtransition_types.QEventTransition,
    ...
    inst: VirtualQEventTransition) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQEventTransition_new2(addr(cQEventTransition_mvtbl), csize_t(sizeof(pointer)), objectVal.h, cint(typeVal))
  fcQEventTransition_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qeventtransition_types.QEventTransition,
    ...
    inst: VirtualQEventTransition) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQEventTransition_new3(addr(cQEventTransition_mvtbl), csize_t(sizeof(pointer)), sourceState.h)
  fcQEventTransition_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qeventtransition_types.QEventTransition,
    ...
    inst: VirtualQEventTransition) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQEventTransition_new4(addr(cQEventTransition_mvtbl), csize_t(sizeof(pointer)), objectVal.h, cint(typeVal), sourceState.h)
  fcQEventTransition_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
