...
proc fcQEventTransition_trUtf8(s: cstring): struct_seaqt_string {.importc: "QEventTransition_trUtf8".}
...
proc fcQEventTransition_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QEventTransition_trUtf82".}
proc fcQEventTransition_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QEventTransition_trUtf83".}
