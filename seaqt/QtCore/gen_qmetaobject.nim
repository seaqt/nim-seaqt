...
proc fcQMetaMethod_nameView(self: pointer): struct_seaqt_string {.importc: "QMetaMethod_nameView".}
...
proc fcQMetaMethod_parameterTypeName(self: pointer, index: cint): struct_seaqt_string {.importc: "QMetaMethod_parameterTypeName".}
...
proc fcQMetaEnum_metaType(self: pointer): pointer {.importc: "QMetaEnum_metaType".}
...
proc fcQMetaEnum_is64Bit(self: pointer): bool {.importc: "QMetaEnum_is64Bit".}
...
proc fcQMetaEnum_valueToKey(self: pointer, value: culonglong): cstring {.importc: "QMetaEnum_valueToKey".}
proc fcQMetaEnum_valueToKeys(self: pointer, value: culonglong): struct_seaqt_string {.importc: "QMetaEnum_valueToKeys".}
...
proc fcQMetaProperty_isVirtual(self: pointer): bool {.importc: "QMetaProperty_isVirtual".}
proc fcQMetaProperty_isOverride(self: pointer): bool {.importc: "QMetaProperty_isOverride".}
...
proc fcQMetaClassInfo_new2(fromVal: pointer): ptr cQMetaClassInfo {.importc: "QMetaClassInfo_new_from".}
...
proc nameView*(self: gen_qmetaobject_types.QMetaMethod): seq[byte] =
  var v_bytearray = fcQMetaMethod_nameView(self.h)
  var vx_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](v_bytearray.data), 0, int(v_bytearray.len)-1))
  c_free(v_bytearray.data)
  vx_ret
...
proc metaType*(self: gen_qmetaobject_types.QMetaEnum): gen_qmetatype_types.QMetaType =
  gen_qmetatype_types.QMetaType(h: fcQMetaEnum_metaType(self.h), owned: true)
...
proc is64Bit*(self: gen_qmetaobject_types.QMetaEnum): bool =
  fcQMetaEnum_is64Bit(self.h)
...
proc valueToKey*(self: gen_qmetaobject_types.QMetaEnum, value: culonglong): cstring =
  (fcQMetaEnum_valueToKey(self.h, value))

proc valueToKeys*(self: gen_qmetaobject_types.QMetaEnum, value: culonglong): seq[byte] =
...
proc isVirtual*(self: gen_qmetaobject_types.QMetaProperty): bool =
  fcQMetaProperty_isVirtual(self.h)

proc isOverride*(self: gen_qmetaobject_types.QMetaProperty): bool =
  fcQMetaProperty_isOverride(self.h)
...
proc create*(T: type gen_qmetaobject_types.QMetaClassInfo): gen_qmetaobject_types.QMetaClassInfo =
  ...
  tmp
proc create*(T: type gen_qmetaobject_types.QMetaClassInfo,
    fromVal: gen_qmetaobject_types.QMetaClassInfo): gen_qmetaobject_types.QMetaClassInfo =
  let tmp = gen_qmetaobject_types.QMetaClassInfo(h: fcQMetaClassInfo_new2(fromVal.h), owned: true)
  tmp
