...
proc fcQObjectData_postedEvents(self: pointer): cint {.importc: "QObjectData_postedEvents".}
proc fcQObjectData_setPostedEvents(self: pointer, postedEvents: cint): void {.importc: "QObjectData_setPostedEvents".}
...
proc fcQObject_trUtf8S(s: cstring): struct_seaqt_string {.importc: "QObject_trUtf8_s".}
...
proc fcQObject_dumpObjectTreeConst(self: pointer): void {.importc: "QObject_dumpObjectTree_const".}
proc fcQObject_dumpObjectInfoConst(self: pointer): void {.importc: "QObject_dumpObjectInfo_const".}
...
proc fcQObject_trUtf8SC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QObject_trUtf8_s_c".}
proc fcQObject_trUtf8SCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QObject_trUtf8_s_c_n".}
...
proc postedEvents*(self: gen_qobject_types.QObjectData): cint =
  fcQObjectData_postedEvents(self.h)

proc setPostedEvents*(self: gen_qobject_types.QObjectData, postedEvents: cint): void =
  fcQObjectData_setPostedEvents(self.h, postedEvents)
...
proc dumpObjectTree2*(self: gen_qobject_types.QObject): void =
  fcQObject_dumpObjectTreeConst(self.h)

proc dumpObjectInfo2*(self: gen_qobject_types.QObject): void =
  fcQObject_dumpObjectInfoConst(self.h)
