...
proc fcQObjectData_qPtr(self: pointer): pointer {.importc: "QObjectData_qPtr".}
proc fcQObjectData_setQPtr(self: pointer, q_ptr: pointer): void {.importc: "QObjectData_setQPtr".}
