...
proc fcQObject_trUtf8(s: cstring): struct_seaqt_string {.importc: "QObject_trUtf8".}
...
proc fcQObject_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QObject_trUtf82".}
proc fcQObject_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QObject_trUtf83".}
