...
proc fcQObjectData_qPtr(self: pointer): pointer {.importc: "QObjectData_q_ptr".}
proc fcQObjectData_setQPtr(self: pointer, q_ptr: pointer): void {.importc: "QObjectData_setQ_ptr".}
proc fcQObjectData_parent(self: pointer): pointer {.importc: "QObjectData_parent".}
proc fcQObjectData_setParent(self: pointer, parent: pointer): void {.importc: "QObjectData_setParent".}
proc fcQObjectData_children(self: pointer): struct_seaqt_array {.importc: "QObjectData_children".}
proc fcQObjectData_setChildren(self: pointer, children: struct_seaqt_array): void {.importc: "QObjectData_setChildren".}
proc fcQObjectData_isWidget(self: pointer): cuint {.importc: "QObjectData_isWidget".}
proc fcQObjectData_setIsWidget(self: pointer, isWidget: cuint): void {.importc: "QObjectData_setIsWidget".}
proc fcQObjectData_blockSig(self: pointer): cuint {.importc: "QObjectData_blockSig".}
proc fcQObjectData_setBlockSig(self: pointer, blockSig: cuint): void {.importc: "QObjectData_setBlockSig".}
proc fcQObjectData_wasDeleted(self: pointer): cuint {.importc: "QObjectData_wasDeleted".}
proc fcQObjectData_setWasDeleted(self: pointer, wasDeleted: cuint): void {.importc: "QObjectData_setWasDeleted".}
proc fcQObjectData_isDeletingChildren(self: pointer): cuint {.importc: "QObjectData_isDeletingChildren".}
proc fcQObjectData_setIsDeletingChildren(self: pointer, isDeletingChildren: cuint): void {.importc: "QObjectData_setIsDeletingChildren".}
proc fcQObjectData_sendChildEvents(self: pointer): cuint {.importc: "QObjectData_sendChildEvents".}
proc fcQObjectData_setSendChildEvents(self: pointer, sendChildEvents: cuint): void {.importc: "QObjectData_setSendChildEvents".}
proc fcQObjectData_receiveChildEvents(self: pointer): cuint {.importc: "QObjectData_receiveChildEvents".}
proc fcQObjectData_setReceiveChildEvents(self: pointer, receiveChildEvents: cuint): void {.importc: "QObjectData_setReceiveChildEvents".}
proc fcQObjectData_isWindow(self: pointer): cuint {.importc: "QObjectData_isWindow".}
proc fcQObjectData_setIsWindow(self: pointer, isWindow: cuint): void {.importc: "QObjectData_setIsWindow".}
proc fcQObjectData_deleteLaterCalled(self: pointer): cuint {.importc: "QObjectData_deleteLaterCalled".}
proc fcQObjectData_setDeleteLaterCalled(self: pointer, deleteLaterCalled: cuint): void {.importc: "QObjectData_setDeleteLaterCalled".}
proc fcQObjectData_isQuickItem(self: pointer): cuint {.importc: "QObjectData_isQuickItem".}
proc fcQObjectData_setIsQuickItem(self: pointer, isQuickItem: cuint): void {.importc: "QObjectData_setIsQuickItem".}
proc fcQObjectData_willBeWidget(self: pointer): cuint {.importc: "QObjectData_willBeWidget".}
proc fcQObjectData_setWillBeWidget(self: pointer, willBeWidget: cuint): void {.importc: "QObjectData_setWillBeWidget".}
proc fcQObjectData_wasWidget(self: pointer): cuint {.importc: "QObjectData_wasWidget".}
proc fcQObjectData_setWasWidget(self: pointer, wasWidget: cuint): void {.importc: "QObjectData_setWasWidget".}
proc fcQObjectData_unused(self: pointer): cuint {.importc: "QObjectData_unused".}
proc fcQObjectData_setUnused(self: pointer, unused: cuint): void {.importc: "QObjectData_setUnused".}
proc fcQObjectData_bindingStorage(self: pointer): pointer {.importc: "QObjectData_bindingStorage".}
proc fcQObjectData_setBindingStorage(self: pointer, bindingStorage: pointer): void {.importc: "QObjectData_setBindingStorage".}
...
proc fcQObject_setObjectName(self: pointer, name: struct_seaqt_string): void {.importc: "QObject_setObjectName".}
...
proc qPtr*(self: gen_qobject_types.QObjectData): gen_qobject_types.QObject =
  gen_qobject_types.QObject(h: fcQObjectData_qPtr(self.h), owned: false)

proc setQPtr*(self: gen_qobject_types.QObjectData, q_ptr: gen_qobject_types.QObject): void =
  fcQObjectData_setQPtr(self.h, q_ptr.h)

proc parent*(self: gen_qobject_types.QObjectData): gen_qobject_types.QObject =
  gen_qobject_types.QObject(h: fcQObjectData_parent(self.h), owned: false)

proc setParent*(self: gen_qobject_types.QObjectData, parent: gen_qobject_types.QObject): void =
  fcQObjectData_setParent(self.h, parent.h)

proc children*(self: gen_qobject_types.QObjectData): seq[gen_qobject_types.QObject] =
  var vchildren_ma = fcQObjectData_children(self.h)
  var vchildrenx_ret = newSeq[gen_qobject_types.QObject](int(vchildren_ma.len))
  let vchildren_outCast = cast[ptr UncheckedArray[pointer]](vchildren_ma.data)
  for i in 0 ..< vchildren_ma.len:
    vchildrenx_ret[i] = gen_qobject_types.QObject(h: vchildren_outCast[i], owned: false)
  c_free(vchildren_ma.data)
  vchildrenx_ret

proc setChildren*(self: gen_qobject_types.QObjectData, children: openArray[gen_qobject_types.QObject]): void =
  var children_CArray = newSeq[pointer](len(children))
  for i in 0..<len(children):
    children_CArray[i] = children[i].h

  fcQObjectData_setChildren(self.h, struct_seaqt_array(len: csize_t(len(children)), data: if len(children) == 0: nil else: addr(children_CArray[0])))

proc isWidget*(self: gen_qobject_types.QObjectData): cuint =
  fcQObjectData_isWidget(self.h)

proc setIsWidget*(self: gen_qobject_types.QObjectData, isWidget: cuint): void =
  fcQObjectData_setIsWidget(self.h, isWidget)

proc blockSig*(self: gen_qobject_types.QObjectData): cuint =
  fcQObjectData_blockSig(self.h)

proc setBlockSig*(self: gen_qobject_types.QObjectData, blockSig: cuint): void =
  fcQObjectData_setBlockSig(self.h, blockSig)

proc wasDeleted*(self: gen_qobject_types.QObjectData): cuint =
  fcQObjectData_wasDeleted(self.h)

proc setWasDeleted*(self: gen_qobject_types.QObjectData, wasDeleted: cuint): void =
  fcQObjectData_setWasDeleted(self.h, wasDeleted)

proc isDeletingChildren*(self: gen_qobject_types.QObjectData): cuint =
  fcQObjectData_isDeletingChildren(self.h)

proc setIsDeletingChildren*(self: gen_qobject_types.QObjectData, isDeletingChildren: cuint): void =
  fcQObjectData_setIsDeletingChildren(self.h, isDeletingChildren)

proc sendChildEvents*(self: gen_qobject_types.QObjectData): cuint =
  fcQObjectData_sendChildEvents(self.h)

proc setSendChildEvents*(self: gen_qobject_types.QObjectData, sendChildEvents: cuint): void =
  fcQObjectData_setSendChildEvents(self.h, sendChildEvents)

proc receiveChildEvents*(self: gen_qobject_types.QObjectData): cuint =
  fcQObjectData_receiveChildEvents(self.h)

proc setReceiveChildEvents*(self: gen_qobject_types.QObjectData, receiveChildEvents: cuint): void =
  fcQObjectData_setReceiveChildEvents(self.h, receiveChildEvents)

proc isWindow*(self: gen_qobject_types.QObjectData): cuint =
  fcQObjectData_isWindow(self.h)

proc setIsWindow*(self: gen_qobject_types.QObjectData, isWindow: cuint): void =
  fcQObjectData_setIsWindow(self.h, isWindow)

proc deleteLaterCalled*(self: gen_qobject_types.QObjectData): cuint =
  fcQObjectData_deleteLaterCalled(self.h)

proc setDeleteLaterCalled*(self: gen_qobject_types.QObjectData, deleteLaterCalled: cuint): void =
  fcQObjectData_setDeleteLaterCalled(self.h, deleteLaterCalled)

proc isQuickItem*(self: gen_qobject_types.QObjectData): cuint =
  fcQObjectData_isQuickItem(self.h)

proc setIsQuickItem*(self: gen_qobject_types.QObjectData, isQuickItem: cuint): void =
  fcQObjectData_setIsQuickItem(self.h, isQuickItem)

proc willBeWidget*(self: gen_qobject_types.QObjectData): cuint =
  fcQObjectData_willBeWidget(self.h)

proc setWillBeWidget*(self: gen_qobject_types.QObjectData, willBeWidget: cuint): void =
  fcQObjectData_setWillBeWidget(self.h, willBeWidget)

proc wasWidget*(self: gen_qobject_types.QObjectData): cuint =
  fcQObjectData_wasWidget(self.h)

proc setWasWidget*(self: gen_qobject_types.QObjectData, wasWidget: cuint): void =
  fcQObjectData_setWasWidget(self.h, wasWidget)

proc unused*(self: gen_qobject_types.QObjectData): cuint =
  fcQObjectData_unused(self.h)

proc setUnused*(self: gen_qobject_types.QObjectData, unused: cuint): void =
  fcQObjectData_setUnused(self.h, unused)

proc bindingStorage*(self: gen_qobject_types.QObjectData): gen_qbindingstorage_types.QBindingStorage =
  gen_qbindingstorage_types.QBindingStorage(h: fcQObjectData_bindingStorage(self.h), owned: true)

proc setBindingStorage*(self: gen_qobject_types.QObjectData, bindingStorage: gen_qbindingstorage_types.QBindingStorage): void =
  fcQObjectData_setBindingStorage(self.h, bindingStorage.h)
...
proc setObjectName*(self: gen_qobject_types.QObject, name: openArray[char]): void =
  fcQObject_setObjectName(self.h, struct_seaqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name))))
