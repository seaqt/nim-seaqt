...
proc qPtr*(self: gen_qobject_types.QObjectData): gen_qobject_types.QObject =
  gen_qobject_types.QObject(h: fcQObjectData_qPtr(self.h))
...
proc parent*(self: gen_qobject_types.QObjectData): gen_qobject_types.QObject =
  gen_qobject_types.QObject(h: fcQObjectData_parent(self.h))
...
proc children*(self: gen_qobject_types.QObjectData): seq[gen_qobject_types.QObject] =
  ...
  for i in 0 ..< vchildren_ma.len:
    vchildrenx_ret[i] = gen_qobject_types.QObject(h: vchildren_outCast[i])
...
proc bindingStorage*(self: gen_qobject_types.QObjectData): gen_qbindingstorage_types.QBindingStorage =
  gen_qbindingstorage_types.QBindingStorage(h: fcQObjectData_bindingStorage(self.h))
