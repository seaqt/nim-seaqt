...
proc fcQObject_isQmlExposed(self: pointer): bool {.importc: "QObject_isQmlExposed".}
...
proc fcQObject_moveToThread_QThread(self: pointer, thread: pointer): bool {.importc: "QObject_moveToThread_QThread".}
proc fcQObject_startTimerInterval(self: pointer, interval: cint): cint {.importc: "QObject_startTimer_interval".}
proc fcQObject_killTimerInt(self: pointer, id: cint): void {.importc: "QObject_killTimer_int".}
proc fcQObject_killTimer_Qt_TimerId(self: pointer, id: cint): void {.importc: "QObject_killTimer_Qt_TimerId".}
...
proc fcQSignalBlocker_dismiss(self: pointer): void {.importc: "QSignalBlocker_dismiss".}
...
proc isQmlExposed*(self: gen_qobject_types.QObject): bool =
  fcQObject_isQmlExposed(self.h)
...
proc moveToThread*(self: gen_qobject_types.QObject, thread: gen_qthread_types.QThread): bool =
  fcQObject_moveToThread_QThread(self.h, thread.h)
...
proc killTimer*(self: gen_qobject_types.QObject, id: cint): void =
  fcQObject_killTimerInt(self.h, id)

proc killTimer2*(self: gen_qobject_types.QObject, id: cint): void =
  fcQObject_killTimer_Qt_TimerId(self.h, cint(id))
...
proc dismiss*(self: gen_qobject_types.QSignalBlocker): void =
  fcQSignalBlocker_dismiss(self.h)
