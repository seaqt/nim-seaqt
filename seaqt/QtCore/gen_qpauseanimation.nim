...
proc fcQPauseAnimation_trUtf8(s: cstring): struct_seaqt_string {.importc: "QPauseAnimation_trUtf8".}
...
proc fcQPauseAnimation_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QPauseAnimation_trUtf82".}
proc fcQPauseAnimation_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QPauseAnimation_trUtf83".}
