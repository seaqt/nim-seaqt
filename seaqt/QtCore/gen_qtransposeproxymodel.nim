...
proc fcQTransposeProxyModel_trUtf8(s: cstring): struct_seaqt_string {.importc: "QTransposeProxyModel_trUtf8".}
...
proc fcQTransposeProxyModel_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QTransposeProxyModel_trUtf82".}
proc fcQTransposeProxyModel_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QTransposeProxyModel_trUtf83".}
