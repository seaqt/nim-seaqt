...
proc fcQTransposeProxyModel_trUtf8S(s: cstring): struct_seaqt_string {.importc: "QTransposeProxyModel_trUtf8_s".}
...
proc fcQTransposeProxyModel_trUtf8SC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QTransposeProxyModel_trUtf8_s_c".}
proc fcQTransposeProxyModel_trUtf8SCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QTransposeProxyModel_trUtf8_s_c_n".}
...
proc trUtf8*(_: type gen_qtransposeproxymodel_types.QTransposeProxyModel, s: cstring): string =
  let v_ms = fcQTransposeProxyModel_trUtf8S(s)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
