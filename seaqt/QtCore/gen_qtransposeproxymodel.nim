...
proc fcQTransposeProxyModel_setItemData(self: pointer, index: pointer, roles: struct_seaqt_map): bool {.importc: "QTransposeProxyModel_setItemData".}
proc fcQTransposeProxyModel_span(self: pointer, index: pointer): pointer {.importc: "QTransposeProxyModel_span".}
proc fcQTransposeProxyModel_itemData(self: pointer, index: pointer): struct_seaqt_map {.importc: "QTransposeProxyModel_itemData".}
...
proc fcQTransposeProxyModel_virtualbase_setItemData(self: pointer, index: pointer, roles: struct_seaqt_map): bool {.importc: "QTransposeProxyModel_virtualbase_setItemData".}
...
proc fcQTransposeProxyModel_virtualbase_itemData(self: pointer, index: pointer): struct_seaqt_map {.importc: "QTransposeProxyModel_virtualbase_itemData".}
...
proc fcQTransposeProxyModel_virtualbase_mimeData(self: pointer, indexes: struct_seaqt_array): pointer {.importc: "QTransposeProxyModel_virtualbase_mimeData".}
...
proc fcQTransposeProxyModel_virtualbase_mimeTypes(self: pointer): struct_seaqt_array {.importc: "QTransposeProxyModel_virtualbase_mimeTypes".}
...
proc fcQTransposeProxyModel_virtualbase_roleNames(self: pointer): struct_seaqt_map {.importc: "QTransposeProxyModel_virtualbase_roleNames".}
proc fcQTransposeProxyModel_virtualbase_match(self: pointer, start: pointer, role: cint, value: pointer, hits: cint, flags: cint): struct_seaqt_array {.importc: "QTransposeProxyModel_virtualbase_match".}
...
proc fcQTransposeProxyModel_protectedbase_changePersistentIndexList(self: pointer, fromVal: struct_seaqt_array, to: struct_seaqt_array): void {.importc: "QTransposeProxyModel_protectedbase_changePersistentIndexList".}
proc fcQTransposeProxyModel_protectedbase_persistentIndexList(self: pointer): struct_seaqt_array {.importc: "QTransposeProxyModel_protectedbase_persistentIndexList".}
...
proc setItemData*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, index: gen_qabstractitemmodel_types.QModelIndex, roles: Table[cint,gen_qvariant_types.QVariant]): bool =
  ...
  fcQTransposeProxyModel_setItemData(self.h, index.h, struct_seaqt_map(len: csize_t(len(roles)),keys: if len(roles) == 0: nil else: addr(roles_Keys_CArray[0]), values: if len(roles) == 0: nil else: addr(roles_Values_CArray[0]),))
...
proc QTransposeProxyModelsetItemData*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, index: gen_qabstractitemmodel_types.QModelIndex, roles: Table[cint,gen_qvariant_types.QVariant]): bool =
  ...
  fcQTransposeProxyModel_virtualbase_setItemData(self.h, index.h, struct_seaqt_map(len: csize_t(len(roles)),keys: if len(roles) == 0: nil else: addr(roles_Keys_CArray[0]), values: if len(roles) == 0: nil else: addr(roles_Values_CArray[0]),))
...
proc QTransposeProxyModelmimeData*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, indexes: openArray[gen_qabstractitemmodel_types.QModelIndex]): gen_qmimedata_types.QMimeData =
  ...
  gen_qmimedata_types.QMimeData(h: fcQTransposeProxyModel_virtualbase_mimeData(self.h, struct_seaqt_array(len: csize_t(len(indexes)), data: if len(indexes) == 0: nil else: addr(indexes_CArray[0]))), owned: false)
...
proc fcQTransposeProxyModel_vtable_callback_setItemData(self: pointer, index: pointer, roles: struct_seaqt_map): bool {.cdecl.} =
  let vtbl = cast[ptr QTransposeProxyModelVTable](fcQTransposeProxyModel_vdata(self)[])
  let self = QTransposeProxyModel(h: self)
...
proc fcQTransposeProxyModel_vtable_callback_itemData(self: pointer, index: pointer): struct_seaqt_map {.cdecl.} =
  let vtbl = cast[ptr QTransposeProxyModelVTable](fcQTransposeProxyModel_vdata(self)[])
  let self = QTransposeProxyModel(h: self)
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
...
proc fcQTransposeProxyModel_vtable_callback_clearItemData(self: pointer, index: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QTransposeProxyModelVTable](fcQTransposeProxyModel_vdata(self)[])
  let self = QTransposeProxyModel(h: self)
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
...
proc fcQTransposeProxyModel_vtable_callback_mimeData(self: pointer, indexes: struct_seaqt_array): pointer {.cdecl.} =
  let vtbl = cast[ptr QTransposeProxyModelVTable](fcQTransposeProxyModel_vdata(self)[])
  let self = QTransposeProxyModel(h: self)
...
proc fcQTransposeProxyModel_vtable_callback_mimeTypes(self: pointer): struct_seaqt_array {.cdecl.} =
  let vtbl = cast[ptr QTransposeProxyModelVTable](fcQTransposeProxyModel_vdata(self)[])
  let self = QTransposeProxyModel(h: self)
...
proc fcQTransposeProxyModel_vtable_callback_roleNames(self: pointer): struct_seaqt_map {.cdecl.} =
  let vtbl = cast[ptr QTransposeProxyModelVTable](fcQTransposeProxyModel_vdata(self)[])
  let self = QTransposeProxyModel(h: self)
...
proc fcQTransposeProxyModel_vtable_callback_match(self: pointer, start: pointer, role: cint, value: pointer, hits: cint, flags: cint): struct_seaqt_array {.cdecl.} =
  let vtbl = cast[ptr QTransposeProxyModelVTable](fcQTransposeProxyModel_vdata(self)[])
  let self = QTransposeProxyModel(h: self)
...
proc fcQTransposeProxyModel_vtable_callback_multiData(self: pointer, index: pointer, roleDataSpan: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTransposeProxyModelVTable](fcQTransposeProxyModel_vdata(self)[])
  let self = QTransposeProxyModel(h: self)
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
...
proc fcQTransposeProxyModel_vtable_callback_resetInternalData(self: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTransposeProxyModelVTable](fcQTransposeProxyModel_vdata(self)[])
  let self = QTransposeProxyModel(h: self)
...
proc fcQTransposeProxyModel_method_callback_setItemData(self: pointer, index: pointer, roles: struct_seaqt_map): bool {.cdecl.} =
  let inst = cast[VirtualQTransposeProxyModel](fcQTransposeProxyModel_vdata(self)[])
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
  var vroles_mm = roles
  var vrolesx_ret: Table[cint, gen_qvariant_types.QVariant]
...
proc fcQTransposeProxyModel_method_callback_itemData(self: pointer, index: pointer): struct_seaqt_map {.cdecl.} =
  let inst = cast[VirtualQTransposeProxyModel](fcQTransposeProxyModel_vdata(self)[])
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
...
proc fcQTransposeProxyModel_method_callback_clearItemData(self: pointer, index: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQTransposeProxyModel](fcQTransposeProxyModel_vdata(self)[])
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
...
proc fcQTransposeProxyModel_method_callback_mimeData(self: pointer, indexes: struct_seaqt_array): pointer {.cdecl.} =
  let inst = cast[VirtualQTransposeProxyModel](fcQTransposeProxyModel_vdata(self)[])
  var vindexes_ma = indexes
  var vindexesx_ret = newSeq[gen_qabstractitemmodel_types.QModelIndex](int(vindexes_ma.len))
  let vindexes_outCast = cast[ptr UncheckedArray[pointer]](vindexes_ma.data)
...
proc fcQTransposeProxyModel_method_callback_mimeTypes(self: pointer): struct_seaqt_array {.cdecl.} =
  let inst = cast[VirtualQTransposeProxyModel](fcQTransposeProxyModel_vdata(self)[])
...
proc fcQTransposeProxyModel_method_callback_roleNames(self: pointer): struct_seaqt_map {.cdecl.} =
  let inst = cast[VirtualQTransposeProxyModel](fcQTransposeProxyModel_vdata(self)[])
...
proc fcQTransposeProxyModel_method_callback_match(self: pointer, start: pointer, role: cint, value: pointer, hits: cint, flags: cint): struct_seaqt_array {.cdecl.} =
  let inst = cast[VirtualQTransposeProxyModel](fcQTransposeProxyModel_vdata(self)[])
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: start, owned: false)
  let slotval2 = role
  let slotval3 = gen_qvariant_types.QVariant(h: value, owned: false)
...
proc fcQTransposeProxyModel_method_callback_multiData(self: pointer, index: pointer, roleDataSpan: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTransposeProxyModel](fcQTransposeProxyModel_vdata(self)[])
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
  let slotval2 = gen_qabstractitemmodel_types.QModelRoleDataSpan(h: roleDataSpan, owned: true)
  inst.multiData(slotval1, slotval2)

proc fcQTransposeProxyModel_method_callback_resetInternalData(self: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTransposeProxyModel](fcQTransposeProxyModel_vdata(self)[])
...
proc encodeData*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, indexes: openArray[gen_qabstractitemmodel_types.QModelIndex], stream: gen_qdatastream_types.QDataStream): void =
  ...
  fcQTransposeProxyModel_protectedbase_encodeData(self.h, struct_seaqt_array(len: csize_t(len(indexes)), data: if len(indexes) == 0: nil else: addr(indexes_CArray[0])), stream.h)
...
proc changePersistentIndexList*(self: gen_qtransposeproxymodel_types.QTransposeProxyModel, fromVal: openArray[gen_qabstractitemmodel_types.QModelIndex], to: openArray[gen_qabstractitemmodel_types.QModelIndex]): void =
  ...
  fcQTransposeProxyModel_protectedbase_changePersistentIndexList(self.h, struct_seaqt_array(len: csize_t(len(fromVal)), data: if len(fromVal) == 0: nil else: addr(fromVal_CArray[0])), struct_seaqt_array(len: csize_t(len(to)), data: if len(to) == 0: nil else: addr(to_CArray[0])))
...
proc create*(T: type gen_qtransposeproxymodel_types.QTransposeProxyModel,
  ...
  if not isNil(vtbl[].clearItemData):
    vtbl[].vtbl.clearItemData = fcQTransposeProxyModel_vtable_callback_clearItemData
  ...
  if not isNil(vtbl[].multiData):
    vtbl[].vtbl.multiData = fcQTransposeProxyModel_vtable_callback_multiData
  if not isNil(vtbl[].resetInternalData):
    vtbl[].vtbl.resetInternalData = fcQTransposeProxyModel_vtable_callback_resetInternalData
  ...
  let tmp = gen_qtransposeproxymodel_types.QTransposeProxyModel(h: fcQTransposeProxyModel_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQTransposeProxyModel_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qtransposeproxymodel_types.QTransposeProxyModel,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQTransposeProxyModel_vtable_callback_disconnectNotify
  let tmp = gen_qtransposeproxymodel_types.QTransposeProxyModel(h: fcQTransposeProxyModel_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQTransposeProxyModel_vdata(tmp.h)[] = addr(vtbl[])
  tmp
const cQTransposeProxyModel_mvtbl = cQTransposeProxyModelVTable(
  ...
  clearItemData: fcQTransposeProxyModel_method_callback_clearItemData,
  ...
  multiData: fcQTransposeProxyModel_method_callback_multiData,
  resetInternalData: fcQTransposeProxyModel_method_callback_resetInternalData,
...
proc create*(T: type gen_qtransposeproxymodel_types.QTransposeProxyModel,
  ...
  inst[].h = fcQTransposeProxyModel_new(addr(cQTransposeProxyModel_mvtbl), csize_t(sizeof(pointer)))
  fcQTransposeProxyModel_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qtransposeproxymodel_types.QTransposeProxyModel,
    ...
    inst: VirtualQTransposeProxyModel) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQTransposeProxyModel_new2(addr(cQTransposeProxyModel_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQTransposeProxyModel_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
