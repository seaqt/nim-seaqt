...
proc miqt_exec_method_cQAbstractNativeEventFilter_nativeEventFilter(vtbl: pointer, inst: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
