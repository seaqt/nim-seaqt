...
proc fcQLibraryInfo_licensee(): struct_seaqt_string {.importc: "QLibraryInfo_licensee".}
proc fcQLibraryInfo_licensedProducts(): struct_seaqt_string {.importc: "QLibraryInfo_licensedProducts".}
...
proc fcQLibraryInfo_location(param1: cint): struct_seaqt_string {.importc: "QLibraryInfo_location".}
