...
proc create*(T: type gen_qxmlstream_types.QXmlStreamStringRef,
  ...
  gen_qxmlstream_types.QXmlStreamStringRef(h: fcQXmlStreamStringRef_new2(struct_miqt_string(data: if len(aString) > 0: addr aString[0] else: nil, len: csize_t(len(aString)))), owned: true)
...
proc create*(T: type gen_qxmlstream_types.QXmlStreamAttribute,
  ...
  gen_qxmlstream_types.QXmlStreamAttribute(h: fcQXmlStreamAttribute_new2(struct_miqt_string(data: if len(qualifiedName) > 0: addr qualifiedName[0] else: nil, len: csize_t(len(qualifiedName))), struct_miqt_string(data: if len(value) > 0: addr value[0] else: nil, len: csize_t(len(value)))), owned: true)

proc create*(T: type gen_qxmlstream_types.QXmlStreamAttribute,
    namespaceUri: openArray[char], name: openArray[char], value: openArray[char]): gen_qxmlstream_types.QXmlStreamAttribute =
  gen_qxmlstream_types.QXmlStreamAttribute(h: fcQXmlStreamAttribute_new3(struct_miqt_string(data: if len(namespaceUri) > 0: addr namespaceUri[0] else: nil, len: csize_t(len(namespaceUri))), struct_miqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name))), struct_miqt_string(data: if len(value) > 0: addr value[0] else: nil, len: csize_t(len(value)))), owned: true)
...
proc create*(T: type gen_qxmlstream_types.QXmlStreamNamespaceDeclaration,
  ...
  gen_qxmlstream_types.QXmlStreamNamespaceDeclaration(h: fcQXmlStreamNamespaceDeclaration_new2(struct_miqt_string(data: if len(prefix) > 0: addr prefix[0] else: nil, len: csize_t(len(prefix))), struct_miqt_string(data: if len(namespaceUri) > 0: addr namespaceUri[0] else: nil, len: csize_t(len(namespaceUri)))), owned: true)
...
proc create*(T: type gen_qxmlstream_types.QXmlStreamReader,
  ...
  gen_qxmlstream_types.QXmlStreamReader(h: fcQXmlStreamReader_new4(struct_miqt_string(data: if len(data) > 0: addr data[0] else: nil, len: csize_t(len(data)))), owned: true)
