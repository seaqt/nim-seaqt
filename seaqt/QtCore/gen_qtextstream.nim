...
proc operatorShiftRight*(self: gen_qtextstream_types.QTextStream, s: string): gen_qtextstream_types.QTextStream =
  gen_qtextstream_types.QTextStream(h: fcQTextStream_operatorShiftRightWithQString(self.h, struct_miqt_string(data: if len(s) > 0: addr s[0] else: nil, len: csize_t(len(s)))))

proc operatorShiftRight*(self: gen_qtextstream_types.QTextStream, array: seq[byte]): gen_qtextstream_types.QTextStream =
  gen_qtextstream_types.QTextStream(h: fcQTextStream_operatorShiftRightWithArray(self.h, struct_miqt_string(data: if len(array) > 0: addr array[0] else: nil, len: csize_t(len(array)))))
...
proc operatorShiftLeft*(self: gen_qtextstream_types.QTextStream, s: string): gen_qtextstream_types.QTextStream =
  gen_qtextstream_types.QTextStream(h: fcQTextStream_operatorShiftLeftWithQString(self.h, struct_miqt_string(data: if len(s) > 0: addr s[0] else: nil, len: csize_t(len(s)))))

proc operatorShiftLeft*(self: gen_qtextstream_types.QTextStream, array: seq[byte]): gen_qtextstream_types.QTextStream =
  gen_qtextstream_types.QTextStream(h: fcQTextStream_operatorShiftLeftWithArray(self.h, struct_miqt_string(data: if len(array) > 0: addr array[0] else: nil, len: csize_t(len(array)))))
...
proc create*(T: type gen_qtextstream_types.QTextStream,
  ...
  let tmp = gen_qtextstream_types.QTextStream(h: fcQTextStream_new3(struct_miqt_string(data: if len(array) > 0: addr array[0] else: nil, len: csize_t(len(array)))))
  tmp
proc create*(T: type gen_qtextstream_types.QTextStream,
    array: seq[byte], openMode: cint): gen_qtextstream_types.QTextStream =
  let tmp = gen_qtextstream_types.QTextStream(h: fcQTextStream_new4(struct_miqt_string(data: if len(array) > 0: addr array[0] else: nil, len: csize_t(len(array))), cint(openMode)))
  tmp
