...
proc fcQOperatingSystemVersionBase_name(osversion: pointer): struct_seaqt_string {.importc: "QOperatingSystemVersionBase_name".}
...
proc fcQOperatingSystemVersionBase_name2(self: pointer): struct_seaqt_string {.importc: "QOperatingSystemVersionBase_name2".}
...
proc create*(T: type gen_qoperatingsystemversion_types.QOperatingSystemVersionBase,
  ...
  let tmp = gen_qoperatingsystemversion_types.QOperatingSystemVersionBase(h: fcQOperatingSystemVersionBase_new(cint(osType), vmajor))
  tmp
proc create*(T: type gen_qoperatingsystemversion_types.QOperatingSystemVersionBase,
  ...
  let tmp = gen_qoperatingsystemversion_types.QOperatingSystemVersionBase(h: fcQOperatingSystemVersionBase_new2(param1.h))
  tmp
proc create*(T: type gen_qoperatingsystemversion_types.QOperatingSystemVersionBase,
    osType: cint, vmajor: cint, vminor: cint): gen_qoperatingsystemversion_types.QOperatingSystemVersionBase =
  let tmp = gen_qoperatingsystemversion_types.QOperatingSystemVersionBase(h: fcQOperatingSystemVersionBase_new3(cint(osType), vmajor, vminor))
  tmp
proc create*(T: type gen_qoperatingsystemversion_types.QOperatingSystemVersionBase,
    osType: cint, vmajor: cint, vminor: cint, vmicro: cint): gen_qoperatingsystemversion_types.QOperatingSystemVersionBase =
  let tmp = gen_qoperatingsystemversion_types.QOperatingSystemVersionBase(h: fcQOperatingSystemVersionBase_new4(cint(osType), vmajor, vminor, vmicro))
  tmp
...
proc create*(T: type gen_qoperatingsystemversion_types.QOperatingSystemVersion,
  ...
  let tmp = gen_qoperatingsystemversion_types.QOperatingSystemVersion(h: fcQOperatingSystemVersion_new(osversion.h))
  tmp
proc create*(T: type gen_qoperatingsystemversion_types.QOperatingSystemVersion,
    osType: cint, vmajor: cint): gen_qoperatingsystemversion_types.QOperatingSystemVersion =
  let tmp = gen_qoperatingsystemversion_types.QOperatingSystemVersion(h: fcQOperatingSystemVersion_new2(cint(osType), vmajor))
  tmp
proc create*(T: type gen_qoperatingsystemversion_types.QOperatingSystemVersion,
  ...
  let tmp = gen_qoperatingsystemversion_types.QOperatingSystemVersion(h: fcQOperatingSystemVersion_new3(param1.h))
  tmp
proc create*(T: type gen_qoperatingsystemversion_types.QOperatingSystemVersion,
    osType: cint, vmajor: cint, vminor: cint): gen_qoperatingsystemversion_types.QOperatingSystemVersion =
  let tmp = gen_qoperatingsystemversion_types.QOperatingSystemVersion(h: fcQOperatingSystemVersion_new4(cint(osType), vmajor, vminor))
  tmp
proc create*(T: type gen_qoperatingsystemversion_types.QOperatingSystemVersion,
    osType: cint, vmajor: cint, vminor: cint, vmicro: cint): gen_qoperatingsystemversion_types.QOperatingSystemVersion =
  let tmp = gen_qoperatingsystemversion_types.QOperatingSystemVersion(h: fcQOperatingSystemVersion_new5(cint(osType), vmajor, vminor, vmicro))
  tmp
