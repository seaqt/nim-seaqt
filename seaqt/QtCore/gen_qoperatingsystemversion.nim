...
template VisionOS*(_: type QOperatingSystemVersionBaseOSTypeEnum): untyped = 7
...
template VisionOS*(_: type QOperatingSystemVersionOSTypeEnum): untyped = 7
...
type cQOperatingSystemVersionUnexported*{.exportc: "QOperatingSystemVersionUnexported", incompleteStruct.} = object
...
proc fcQOperatingSystemVersionUnexported_new(other: pointer): ptr cQOperatingSystemVersionUnexported {.importc: "QOperatingSystemVersionUnexported_new_QOperatingSystemVersionBase".}
proc fcQOperatingSystemVersionUnexported_new2(): ptr cQOperatingSystemVersionUnexported {.importc: "QOperatingSystemVersionUnexported_new".}
proc fcQOperatingSystemVersionUnexported_new3(fromVal: pointer): ptr cQOperatingSystemVersionUnexported {.importc: "QOperatingSystemVersionUnexported_new_QOperatingSystemVersionUnexported".}
proc fcQOperatingSystemVersionUnexported_new4(param1: cint, param2: cint, param3: cint, param4: cint): ptr cQOperatingSystemVersionUnexported {.importc: "QOperatingSystemVersionUnexported_new_QOperatingSystemVersionBase_OSType_int_int_int".}
...
proc create*(T: type gen_qoperatingsystemversion_types.QOperatingSystemVersionBase,
  ...
  tmp
proc create*(T: type gen_qoperatingsystemversion_types.QOperatingSystemVersionUnexported,
    other: gen_qoperatingsystemversion_types.QOperatingSystemVersionBase): gen_qoperatingsystemversion_types.QOperatingSystemVersionUnexported =
  let tmp = gen_qoperatingsystemversion_types.QOperatingSystemVersionUnexported(h: fcQOperatingSystemVersionUnexported_new(other.h), owned: true)
  tmp
proc create*(T: type gen_qoperatingsystemversion_types.QOperatingSystemVersionUnexported): gen_qoperatingsystemversion_types.QOperatingSystemVersionUnexported =
  let tmp = gen_qoperatingsystemversion_types.QOperatingSystemVersionUnexported(h: fcQOperatingSystemVersionUnexported_new2(), owned: true)
  tmp
proc create*(T: type gen_qoperatingsystemversion_types.QOperatingSystemVersionUnexported,
    fromVal: gen_qoperatingsystemversion_types.QOperatingSystemVersionUnexported): gen_qoperatingsystemversion_types.QOperatingSystemVersionUnexported =
  let tmp = gen_qoperatingsystemversion_types.QOperatingSystemVersionUnexported(h: fcQOperatingSystemVersionUnexported_new3(fromVal.h), owned: true)
  tmp
proc create*(T: type gen_qoperatingsystemversion_types.QOperatingSystemVersionUnexported,
    param1: cint, param2: cint, param3: cint, param4: cint): gen_qoperatingsystemversion_types.QOperatingSystemVersionUnexported =
  let tmp = gen_qoperatingsystemversion_types.QOperatingSystemVersionUnexported(h: fcQOperatingSystemVersionUnexported_new4(cint(param1), param2, param3, param4), owned: true)
  tmp
