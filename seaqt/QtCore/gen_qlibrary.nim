...
proc fcQLibrary_trUtf8(s: cstring): struct_seaqt_string {.importc: "QLibrary_trUtf8".}
...
proc fcQLibrary_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QLibrary_trUtf82".}
proc fcQLibrary_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QLibrary_trUtf83".}
