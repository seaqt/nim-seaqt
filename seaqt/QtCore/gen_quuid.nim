...
proc createUuidV3*(_: type gen_quuid_types.QUuid, ns: gen_quuid_types.QUuid, baseData: seq[byte]): gen_quuid_types.QUuid =
  gen_quuid_types.QUuid(h: fcQUuid_createUuidV3(ns.h, struct_miqt_string(data: if len(baseData) > 0: addr baseData[0] else: nil, len: csize_t(len(baseData)))))

proc createUuidV5*(_: type gen_quuid_types.QUuid, ns: gen_quuid_types.QUuid, baseData: seq[byte]): gen_quuid_types.QUuid =
  gen_quuid_types.QUuid(h: fcQUuid_createUuidV5(ns.h, struct_miqt_string(data: if len(baseData) > 0: addr baseData[0] else: nil, len: csize_t(len(baseData)))))

proc createUuidV3*(_: type gen_quuid_types.QUuid, ns: gen_quuid_types.QUuid, baseData: string): gen_quuid_types.QUuid =
  gen_quuid_types.QUuid(h: fcQUuid_createUuidV32(ns.h, struct_miqt_string(data: if len(baseData) > 0: addr baseData[0] else: nil, len: csize_t(len(baseData)))))

proc createUuidV5*(_: type gen_quuid_types.QUuid, ns: gen_quuid_types.QUuid, baseData: string): gen_quuid_types.QUuid =
  gen_quuid_types.QUuid(h: fcQUuid_createUuidV52(ns.h, struct_miqt_string(data: if len(baseData) > 0: addr baseData[0] else: nil, len: csize_t(len(baseData)))))
...
proc create*(T: type gen_quuid_types.QUuid,
  ...
  let tmp = gen_quuid_types.QUuid(h: fcQUuid_new3(string.h))
  tmp
proc create*(T: type gen_quuid_types.QUuid,
