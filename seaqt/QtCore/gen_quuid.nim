...
proc create*(T: type gen_quuid_types.QUuid,
  ...
  let tmp = gen_quuid_types.QUuid(h: fcQUuid_new3(struct_seaqt_string(data: if len(param1) > 0: addr param1[0] else: nil, len: csize_t(len(param1)))))
  tmp
proc create*(T: type gen_quuid_types.QUuid,
    param1: cstring): gen_quuid_types.QUuid =
  let tmp = gen_quuid_types.QUuid(h: fcQUuid_new4(param1))
  tmp
proc create*(T: type gen_quuid_types.QUuid,
    param1: openArray[byte]): gen_quuid_types.QUuid =
  let tmp = gen_quuid_types.QUuid(h: fcQUuid_new5(struct_seaqt_string(data: if len(param1) > 0: addr param1[0] else: nil, len: csize_t(len(param1)))))
  tmp
proc create*(T: type gen_quuid_types.QUuid,
    param1: gen_quuid_types.QUuid): gen_quuid_types.QUuid =
  let tmp = gen_quuid_types.QUuid(h: fcQUuid_new6(param1.h))
  tmp
