...
proc fcQDate_operatorAssign(self: pointer, fromVal: pointer): void {.importc: "QDate_operatorAssign".}
...
proc operatorAssign*(self: gen_qdatetime_types.QDate, fromVal: gen_qdatetime_types.QDate): void =
  fcQDate_operatorAssign(self.h, fromVal.h)
