...
proc fcQMetaType_isRegisteredInt(typeVal: cint): bool {.importc: "QMetaType_isRegistered_int".}
...
proc fcQMetaType_underlyingType(self: pointer): pointer {.importc: "QMetaType_underlyingType".}
...
proc isRegistered*(_: type gen_qmetatype_types.QMetaType, typeVal: cint): bool =
  fcQMetaType_isRegisteredInt(typeVal)
...
proc underlyingType*(self: gen_qmetatype_types.QMetaType): gen_qmetatype_types.QMetaType =
  gen_qmetatype_types.QMetaType(h: fcQMetaType_underlyingType(self.h), owned: true)
