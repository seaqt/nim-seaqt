...
VirtualQLibrary* QLibrary_new(const QLibrary_VTable* vtbl, size_t vdata) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQLibrary>());
	return _mem_ ? new (_mem_)VirtualQLibrary(vtbl) : nullptr;
}

VirtualQLibrary* QLibrary_new2(const QLibrary_VTable* vtbl, size_t vdata, struct miqt_string fileName) {
	QString fileName_QString = QString::fromUtf8(fileName.data, fileName.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQLibrary>());
	return _mem_ ? new (_mem_)VirtualQLibrary(vtbl, fileName_QString) : nullptr;
}

VirtualQLibrary* QLibrary_new3(const QLibrary_VTable* vtbl, size_t vdata, struct miqt_string fileName, int verNum) {
	QString fileName_QString = QString::fromUtf8(fileName.data, fileName.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQLibrary>());
	return _mem_ ? new (_mem_)VirtualQLibrary(vtbl, fileName_QString, static_cast<int>(verNum)) : nullptr;
}

VirtualQLibrary* QLibrary_new4(const QLibrary_VTable* vtbl, size_t vdata, struct miqt_string fileName, struct miqt_string version) {
	QString fileName_QString = QString::fromUtf8(fileName.data, fileName.len);
...
VirtualQLibrary* QLibrary_new6(const QLibrary_VTable* vtbl, size_t vdata, struct miqt_string fileName, QObject* parent) {
	QString fileName_QString = QString::fromUtf8(fileName.data, fileName.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQLibrary>());
	return _mem_ ? new (_mem_)VirtualQLibrary(vtbl, fileName_QString, parent) : nullptr;
}

VirtualQLibrary* QLibrary_new7(const QLibrary_VTable* vtbl, size_t vdata, struct miqt_string fileName, int verNum, QObject* parent) {
	QString fileName_QString = QString::fromUtf8(fileName.data, fileName.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQLibrary>());
	return _mem_ ? new (_mem_)VirtualQLibrary(vtbl, fileName_QString, static_cast<int>(verNum), parent) : nullptr;
}

VirtualQLibrary* QLibrary_new8(const QLibrary_VTable* vtbl, size_t vdata, struct miqt_string fileName, struct miqt_string version, QObject* parent) {
	QString fileName_QString = QString::fromUtf8(fileName.data, fileName.len);
	QString version_QString = QString::fromUtf8(version.data, version.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQLibrary>());
