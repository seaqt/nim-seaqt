...
proc create*(T: type gen_qanystringview_types.QAnyStringView): gen_qanystringview_types.QAnyStringView =
  let tmp = gen_qanystringview_types.QAnyStringView(h: fcQAnyStringView_new(), owned: true)
  tmp
proc create*(T: type gen_qanystringview_types.QAnyStringView,
    str: seq[byte]): gen_qanystringview_types.QAnyStringView =
  let tmp = gen_qanystringview_types.QAnyStringView(h: fcQAnyStringView_new2(struct_miqt_string(data: if len(str) > 0: addr str[0] else: nil, len: csize_t(len(str)))), owned: true)
  tmp
proc create*(T: type gen_qanystringview_types.QAnyStringView,
    str: string): gen_qanystringview_types.QAnyStringView =
  let tmp = gen_qanystringview_types.QAnyStringView(h: fcQAnyStringView_new3(struct_miqt_string(data: if len(str) > 0: addr str[0] else: nil, len: csize_t(len(str)))), owned: true)
  tmp
proc create*(T: type gen_qanystringview_types.QAnyStringView,
    c: gen_qchar_types.QChar): gen_qanystringview_types.QAnyStringView =
  let tmp = gen_qanystringview_types.QAnyStringView(h: fcQAnyStringView_new4(c.h), owned: true)
  tmp
proc create*(T: type gen_qanystringview_types.QAnyStringView,
    param1: gen_qanystringview_types.QAnyStringView): gen_qanystringview_types.QAnyStringView =
  let tmp = gen_qanystringview_types.QAnyStringView(h: fcQAnyStringView_new5(param1.h), owned: true)
  tmp
