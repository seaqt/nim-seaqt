...
proc fcQReadWriteLock_tryLockForReadInt(self: pointer, timeout: cint): bool {.importc: "QReadWriteLock_tryLockForRead_int".}
...
proc fcQReadWriteLock_tryLockForWriteInt(self: pointer, timeout: cint): bool {.importc: "QReadWriteLock_tryLockForWrite_int".}
...
proc fcQReadWriteLock_tryLockForRead_QDeadlineTimer(self: pointer, timeout: pointer): bool {.importc: "QReadWriteLock_tryLockForRead_QDeadlineTimer".}
proc fcQReadWriteLock_tryLockForWrite_QDeadlineTimer(self: pointer, timeout: pointer): bool {.importc: "QReadWriteLock_tryLockForWrite_QDeadlineTimer".}
...
proc tryLockForRead*(self: gen_qreadwritelock_types.QReadWriteLock, timeout: cint): bool =
  fcQReadWriteLock_tryLockForReadInt(self.h, timeout)
...
proc tryLockForWrite*(self: gen_qreadwritelock_types.QReadWriteLock, timeout: cint): bool =
  fcQReadWriteLock_tryLockForWriteInt(self.h, timeout)
...
proc tryLockForRead*(self: gen_qreadwritelock_types.QReadWriteLock, timeout: gen_qdeadlinetimer_types.QDeadlineTimer): bool =
  fcQReadWriteLock_tryLockForRead_QDeadlineTimer(self.h, timeout.h)

proc tryLockForWrite*(self: gen_qreadwritelock_types.QReadWriteLock, timeout: gen_qdeadlinetimer_types.QDeadlineTimer): bool =
  fcQReadWriteLock_tryLockForWrite_QDeadlineTimer(self.h, timeout.h)
