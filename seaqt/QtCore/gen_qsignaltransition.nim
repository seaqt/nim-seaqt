...
proc fcQSignalTransition_trUtf8(s: cstring): struct_seaqt_string {.importc: "QSignalTransition_trUtf8".}
...
proc fcQSignalTransition_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QSignalTransition_trUtf82".}
proc fcQSignalTransition_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QSignalTransition_trUtf83".}
