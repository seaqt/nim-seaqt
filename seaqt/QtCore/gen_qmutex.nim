...
proc create*(T: type gen_qmutex_types.QMutex,
  ...
  let tmp = gen_qmutex_types.QMutex(h: fcQMutex_new2(cint(mode)), owned: true)
  tmp
...
proc create*(T: type gen_qmutex_types.QMutexLocker,
  ...
  let tmp = gen_qmutex_types.QMutexLocker(h: fcQMutexLocker_new(m.h), owned: true)
  tmp
proc create*(T: type gen_qmutex_types.QMutexLocker,
    m: gen_qmutex_types.QRecursiveMutex): gen_qmutex_types.QMutexLocker =
  let tmp = gen_qmutex_types.QMutexLocker(h: fcQMutexLocker_new2(m.h), owned: true)
  tmp
