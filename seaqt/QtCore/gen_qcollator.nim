...
proc fcQCollator_compare_QCharInt_QCharInt(self: pointer, s1: pointer, len1: cint, s2: pointer, len2: cint): cint {.importc: "QCollator_compare_QChar_int_QChar_int".}
...
proc compare*(self: gen_qcollator_types.QCollator, s1: gen_qchar_types.QChar, len1: cint, s2: gen_qchar_types.QChar, len2: cint): cint =
  fcQCollator_compare_QCharInt_QCharInt(self.h, s1.h, len1, s2.h, len2)
