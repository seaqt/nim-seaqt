...
proc fcQFileInfo_setFile_QFileDevice(self: pointer, file: pointer): void {.importc: "QFileInfo_setFile_QFileDevice".}
...
proc fcQFileInfo_canonicalFilePath(self: pointer): struct_seaqt_string {.importc: "QFileInfo_canonicalFilePath".}
proc fcQFileInfo_fileName(self: pointer): struct_seaqt_string {.importc: "QFileInfo_fileName".}
proc fcQFileInfo_baseName(self: pointer): struct_seaqt_string {.importc: "QFileInfo_baseName".}
proc fcQFileInfo_completeBaseName(self: pointer): struct_seaqt_string {.importc: "QFileInfo_completeBaseName".}
proc fcQFileInfo_suffix(self: pointer): struct_seaqt_string {.importc: "QFileInfo_suffix".}
proc fcQFileInfo_bundleName(self: pointer): struct_seaqt_string {.importc: "QFileInfo_bundleName".}
proc fcQFileInfo_completeSuffix(self: pointer): struct_seaqt_string {.importc: "QFileInfo_completeSuffix".}
proc fcQFileInfo_path(self: pointer): struct_seaqt_string {.importc: "QFileInfo_path".}
proc fcQFileInfo_absolutePath(self: pointer): struct_seaqt_string {.importc: "QFileInfo_absolutePath".}
proc fcQFileInfo_canonicalPath(self: pointer): struct_seaqt_string {.importc: "QFileInfo_canonicalPath".}
...
proc fcQFileInfo_isOther(self: pointer): bool {.importc: "QFileInfo_isOther".}
...
proc fcQFileInfo_symLinkTarget(self: pointer): struct_seaqt_string {.importc: "QFileInfo_symLinkTarget".}
proc fcQFileInfo_readSymLink(self: pointer): struct_seaqt_string {.importc: "QFileInfo_readSymLink".}
proc fcQFileInfo_junctionTarget(self: pointer): struct_seaqt_string {.importc: "QFileInfo_junctionTarget".}
proc fcQFileInfo_owner(self: pointer): struct_seaqt_string {.importc: "QFileInfo_owner".}
proc fcQFileInfo_ownerId(self: pointer): cuint {.importc: "QFileInfo_ownerId".}
proc fcQFileInfo_group(self: pointer): struct_seaqt_string {.importc: "QFileInfo_group".}
...
proc fcQFileInfo_fileTimeTime(self: pointer, time: cint): pointer {.importc: "QFileInfo_fileTime_time".}
proc fcQFileInfo_birthTimeTz(self: pointer, tz: pointer): pointer {.importc: "QFileInfo_birthTime_tz".}
proc fcQFileInfo_metadataChangeTimeTz(self: pointer, tz: pointer): pointer {.importc: "QFileInfo_metadataChangeTime_tz".}
proc fcQFileInfo_lastModifiedTz(self: pointer, tz: pointer): pointer {.importc: "QFileInfo_lastModified_tz".}
proc fcQFileInfo_lastReadTz(self: pointer, tz: pointer): pointer {.importc: "QFileInfo_lastRead_tz".}
proc fcQFileInfo_fileTimeTimeTz(self: pointer, time: cint, tz: pointer): pointer {.importc: "QFileInfo_fileTime_time_tz".}
...
proc fcQFileInfo_new3(file: pointer): ptr cQFileInfo {.importc: "QFileInfo_new_QFileDevice".}
...
proc setFile*(self: gen_qfileinfo_types.QFileInfo, file: gen_qfiledevice_types.QFileDevice): void =
  fcQFileInfo_setFile_QFileDevice(self.h, file.h)
...
proc isOther*(self: gen_qfileinfo_types.QFileInfo): bool =
  fcQFileInfo_isOther(self.h)
...
proc readSymLink*(self: gen_qfileinfo_types.QFileInfo): string =
  let v_ms = fcQFileInfo_readSymLink(self.h)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc fileTime*(self: gen_qfileinfo_types.QFileInfo, time: cint): gen_qdatetime_types.QDateTime =
  gen_qdatetime_types.QDateTime(h: fcQFileInfo_fileTimeTime(self.h, cint(time)), owned: true)

proc birthTime*(self: gen_qfileinfo_types.QFileInfo, tz: gen_qtimezone_types.QTimeZone): gen_qdatetime_types.QDateTime =
  gen_qdatetime_types.QDateTime(h: fcQFileInfo_birthTimeTz(self.h, tz.h), owned: true)

proc metadataChangeTime*(self: gen_qfileinfo_types.QFileInfo, tz: gen_qtimezone_types.QTimeZone): gen_qdatetime_types.QDateTime =
  gen_qdatetime_types.QDateTime(h: fcQFileInfo_metadataChangeTimeTz(self.h, tz.h), owned: true)

proc lastModified*(self: gen_qfileinfo_types.QFileInfo, tz: gen_qtimezone_types.QTimeZone): gen_qdatetime_types.QDateTime =
  gen_qdatetime_types.QDateTime(h: fcQFileInfo_lastModifiedTz(self.h, tz.h), owned: true)

proc lastRead*(self: gen_qfileinfo_types.QFileInfo, tz: gen_qtimezone_types.QTimeZone): gen_qdatetime_types.QDateTime =
  gen_qdatetime_types.QDateTime(h: fcQFileInfo_lastReadTz(self.h, tz.h), owned: true)

proc fileTime*(self: gen_qfileinfo_types.QFileInfo, time: cint, tz: gen_qtimezone_types.QTimeZone): gen_qdatetime_types.QDateTime =
  gen_qdatetime_types.QDateTime(h: fcQFileInfo_fileTimeTimeTz(self.h, cint(time), tz.h), owned: true)
...
proc create*(T: type gen_qfileinfo_types.QFileInfo,
  ...
  let tmp = gen_qfileinfo_types.QFileInfo(h: fcQFileInfo_new2(struct_seaqt_string(data: if len(file) > 0: addr file[0] else: nil, len: csize_t(len(file)))), owned: true)
  tmp
proc create*(T: type gen_qfileinfo_types.QFileInfo,
