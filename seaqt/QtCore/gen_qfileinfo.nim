...
proc create*(T: type gen_qfileinfo_types.QFileInfo,
  ...
  let tmp = gen_qfileinfo_types.QFileInfo(h: fcQFileInfo_new2(struct_miqt_string(data: if len(file) > 0: addr file[0] else: nil, len: csize_t(len(file)))))
  tmp
proc create*(T: type gen_qfileinfo_types.QFileInfo,
...
proc create*(T: type gen_qfileinfo_types.QFileInfo,
  ...
  let tmp = gen_qfileinfo_types.QFileInfo(h: fcQFileInfo_new4(dir.h, struct_miqt_string(data: if len(file) > 0: addr file[0] else: nil, len: csize_t(len(file)))))
  tmp
proc create*(T: type gen_qfileinfo_types.QFileInfo,
