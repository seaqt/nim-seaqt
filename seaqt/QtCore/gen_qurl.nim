...
proc fromEncoded*(_: type gen_qurl_types.QUrl, url: seq[byte]): gen_qurl_types.QUrl =
  gen_qurl_types.QUrl(h: fcQUrl_fromEncoded(struct_miqt_string(data: if len(url) > 0: addr url[0] else: nil, len: csize_t(len(url)))))

proc fromUserInput*(_: type gen_qurl_types.QUrl, userInput: string): gen_qurl_types.QUrl =
  gen_qurl_types.QUrl(h: fcQUrl_fromUserInput(struct_miqt_string(data: if len(userInput) > 0: addr userInput[0] else: nil, len: csize_t(len(userInput)))))
...
proc fromLocalFile*(_: type gen_qurl_types.QUrl, localfile: string): gen_qurl_types.QUrl =
  gen_qurl_types.QUrl(h: fcQUrl_fromLocalFile(struct_miqt_string(data: if len(localfile) > 0: addr localfile[0] else: nil, len: csize_t(len(localfile)))))
...
proc fromEncoded*(_: type gen_qurl_types.QUrl, url: seq[byte], mode: cint): gen_qurl_types.QUrl =
  gen_qurl_types.QUrl(h: fcQUrl_fromEncoded2(struct_miqt_string(data: if len(url) > 0: addr url[0] else: nil, len: csize_t(len(url))), cint(mode)))

proc fromUserInput*(_: type gen_qurl_types.QUrl, userInput: string, workingDirectory: string): gen_qurl_types.QUrl =
  gen_qurl_types.QUrl(h: fcQUrl_fromUserInput2(struct_miqt_string(data: if len(userInput) > 0: addr userInput[0] else: nil, len: csize_t(len(userInput))), struct_miqt_string(data: if len(workingDirectory) > 0: addr workingDirectory[0] else: nil, len: csize_t(len(workingDirectory)))))

proc fromUserInput*(_: type gen_qurl_types.QUrl, userInput: string, workingDirectory: string, options: cint): gen_qurl_types.QUrl =
  gen_qurl_types.QUrl(h: fcQUrl_fromUserInput3(struct_miqt_string(data: if len(userInput) > 0: addr userInput[0] else: nil, len: csize_t(len(userInput))), struct_miqt_string(data: if len(workingDirectory) > 0: addr workingDirectory[0] else: nil, len: csize_t(len(workingDirectory))), cint(options)))
...
proc create*(T: type gen_qurl_types.QUrl,
  ...
  let tmp = gen_qurl_types.QUrl(h: fcQUrl_new3(struct_miqt_string(data: if len(url) > 0: addr url[0] else: nil, len: csize_t(len(url)))))
  tmp
proc create*(T: type gen_qurl_types.QUrl,
    url: string, mode: cint): gen_qurl_types.QUrl =
  let tmp = gen_qurl_types.QUrl(h: fcQUrl_new4(struct_miqt_string(data: if len(url) > 0: addr url[0] else: nil, len: csize_t(len(url))), cint(mode)))
  tmp
