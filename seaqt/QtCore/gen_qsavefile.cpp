...
VirtualQSaveFile* QSaveFile_new(const QSaveFile_VTable* vtbl, size_t vdata, struct miqt_string name) {
	QString name_QString = QString::fromUtf8(name.data, name.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQSaveFile>());
...
VirtualQSaveFile* QSaveFile_new3(const QSaveFile_VTable* vtbl, size_t vdata, struct miqt_string name, QObject* parent) {
	QString name_QString = QString::fromUtf8(name.data, name.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQSaveFile>());
