...
proc fcQCoreApplication_trUtf8(s: cstring): struct_seaqt_string {.importc: "QCoreApplication_trUtf8".}
...
proc fcQCoreApplication_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QCoreApplication_trUtf82".}
proc fcQCoreApplication_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QCoreApplication_trUtf83".}
