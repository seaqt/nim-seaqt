...
proc match*(self: gen_qregularexpression_types.QRegularExpression, subject: openArray[char]): gen_qregularexpression_types.QRegularExpressionMatch =
  gen_qregularexpression_types.QRegularExpressionMatch(h: fcQRegularExpression_match(self.h, struct_seaqt_string(data: if len(subject) > 0: addr subject[0] else: nil, len: csize_t(len(subject)))))
...
proc globalMatch*(self: gen_qregularexpression_types.QRegularExpression, subject: openArray[char]): gen_qregularexpression_types.QRegularExpressionMatchIterator =
  gen_qregularexpression_types.QRegularExpressionMatchIterator(h: fcQRegularExpression_globalMatch(self.h, struct_seaqt_string(data: if len(subject) > 0: addr subject[0] else: nil, len: csize_t(len(subject)))))
...
proc match*(self: gen_qregularexpression_types.QRegularExpression, subject: openArray[char], offset: cint): gen_qregularexpression_types.QRegularExpressionMatch =
  gen_qregularexpression_types.QRegularExpressionMatch(h: fcQRegularExpression_match2(self.h, struct_seaqt_string(data: if len(subject) > 0: addr subject[0] else: nil, len: csize_t(len(subject))), offset))
...
proc match*(self: gen_qregularexpression_types.QRegularExpression, subject: openArray[char], offset: cint, matchType: cint): gen_qregularexpression_types.QRegularExpressionMatch =
  gen_qregularexpression_types.QRegularExpressionMatch(h: fcQRegularExpression_match3(self.h, struct_seaqt_string(data: if len(subject) > 0: addr subject[0] else: nil, len: csize_t(len(subject))), offset, cint(matchType)))
...
proc match*(self: gen_qregularexpression_types.QRegularExpression, subject: openArray[char], offset: cint, matchType: cint, matchOptions: cint): gen_qregularexpression_types.QRegularExpressionMatch =
  gen_qregularexpression_types.QRegularExpressionMatch(h: fcQRegularExpression_match4(self.h, struct_seaqt_string(data: if len(subject) > 0: addr subject[0] else: nil, len: csize_t(len(subject))), offset, cint(matchType), cint(matchOptions)))
...
proc globalMatch*(self: gen_qregularexpression_types.QRegularExpression, subject: openArray[char], offset: cint): gen_qregularexpression_types.QRegularExpressionMatchIterator =
  gen_qregularexpression_types.QRegularExpressionMatchIterator(h: fcQRegularExpression_globalMatch2(self.h, struct_seaqt_string(data: if len(subject) > 0: addr subject[0] else: nil, len: csize_t(len(subject))), offset))
...
proc globalMatch*(self: gen_qregularexpression_types.QRegularExpression, subject: openArray[char], offset: cint, matchType: cint): gen_qregularexpression_types.QRegularExpressionMatchIterator =
  gen_qregularexpression_types.QRegularExpressionMatchIterator(h: fcQRegularExpression_globalMatch3(self.h, struct_seaqt_string(data: if len(subject) > 0: addr subject[0] else: nil, len: csize_t(len(subject))), offset, cint(matchType)))
...
proc globalMatch*(self: gen_qregularexpression_types.QRegularExpression, subject: openArray[char], offset: cint, matchType: cint, matchOptions: cint): gen_qregularexpression_types.QRegularExpressionMatchIterator =
  gen_qregularexpression_types.QRegularExpressionMatchIterator(h: fcQRegularExpression_globalMatch4(self.h, struct_seaqt_string(data: if len(subject) > 0: addr subject[0] else: nil, len: csize_t(len(subject))), offset, cint(matchType), cint(matchOptions)))

proc create*(T: type gen_qregularexpression_types.QRegularExpression): gen_qregularexpression_types.QRegularExpression =
  let tmp = gen_qregularexpression_types.QRegularExpression(h: fcQRegularExpression_new())
  tmp
proc create*(T: type gen_qregularexpression_types.QRegularExpression,
  ...
  let tmp = gen_qregularexpression_types.QRegularExpression(h: fcQRegularExpression_new2(struct_seaqt_string(data: if len(pattern) > 0: addr pattern[0] else: nil, len: csize_t(len(pattern)))))
  tmp
proc create*(T: type gen_qregularexpression_types.QRegularExpression,
    re: gen_qregularexpression_types.QRegularExpression): gen_qregularexpression_types.QRegularExpression =
  let tmp = gen_qregularexpression_types.QRegularExpression(h: fcQRegularExpression_new3(re.h))
  tmp
proc create*(T: type gen_qregularexpression_types.QRegularExpression,
    pattern: openArray[char], options: cint): gen_qregularexpression_types.QRegularExpression =
  let tmp = gen_qregularexpression_types.QRegularExpression(h: fcQRegularExpression_new4(struct_seaqt_string(data: if len(pattern) > 0: addr pattern[0] else: nil, len: csize_t(len(pattern))), cint(options)))
  tmp
...
proc create*(T: type gen_qregularexpression_types.QRegularExpressionMatch): gen_qregularexpression_types.QRegularExpressionMatch =
  let tmp = gen_qregularexpression_types.QRegularExpressionMatch(h: fcQRegularExpressionMatch_new())
  tmp
proc create*(T: type gen_qregularexpression_types.QRegularExpressionMatch,
  ...
  let tmp = gen_qregularexpression_types.QRegularExpressionMatch(h: fcQRegularExpressionMatch_new2(match.h))
  tmp
...
proc create*(T: type gen_qregularexpression_types.QRegularExpressionMatchIterator): gen_qregularexpression_types.QRegularExpressionMatchIterator =
  let tmp = gen_qregularexpression_types.QRegularExpressionMatchIterator(h: fcQRegularExpressionMatchIterator_new())
  tmp
proc create*(T: type gen_qregularexpression_types.QRegularExpressionMatchIterator,
  ...
  let tmp = gen_qregularexpression_types.QRegularExpressionMatchIterator(h: fcQRegularExpressionMatchIterator_new2(iteratorVal.h))
  tmp
