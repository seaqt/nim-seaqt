...
proc fcQThreadPool_setServiceLevel(self: pointer, serviceLevel: cint): void {.importc: "QThreadPool_setServiceLevel".}
proc fcQThreadPool_serviceLevel(self: pointer): cint {.importc: "QThreadPool_serviceLevel".}
...
proc fcQThreadPool_waitForDoneDeadline(self: pointer, deadline: pointer): bool {.importc: "QThreadPool_waitForDone_deadline".}
...
proc setServiceLevel*(self: gen_qthreadpool_types.QThreadPool, serviceLevel: cint): void =
  fcQThreadPool_setServiceLevel(self.h, cint(serviceLevel))

proc serviceLevel*(self: gen_qthreadpool_types.QThreadPool): cint =
  cint(fcQThreadPool_serviceLevel(self.h))
...
proc waitForDone*(self: gen_qthreadpool_types.QThreadPool, deadline: gen_qdeadlinetimer_types.QDeadlineTimer): bool =
  fcQThreadPool_waitForDoneDeadline(self.h, deadline.h)
