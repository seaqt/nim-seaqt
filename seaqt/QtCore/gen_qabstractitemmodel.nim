...
proc fcQModelRoleData_dataConst(self: pointer): pointer {.importc: "QModelRoleData_data_const".}
proc fcQModelRoleData_clearData(self: pointer): void {.importc: "QModelRoleData_clearData".}
proc fcQModelRoleData_operatorAssign(self: pointer, fromVal: pointer): void {.importc: "QModelRoleData_operatorAssign".}
proc fcQModelRoleData_new(role: cint): ptr cQModelRoleData {.importc: "QModelRoleData_new_role".}
proc fcQModelRoleData_new2(fromVal: pointer): ptr cQModelRoleData {.importc: "QModelRoleData_new_from".}
...
proc fcQModelRoleDataSpan_new2(modelRoleData: pointer): ptr cQModelRoleDataSpan {.importc: "QModelRoleDataSpan_new_modelRoleData".}
proc fcQModelRoleDataSpan_new3(modelRoleData: pointer, len: int64): ptr cQModelRoleDataSpan {.importc: "QModelRoleDataSpan_new_modelRoleData_len".}
proc fcQModelRoleDataSpan_new4(fromVal: pointer): ptr cQModelRoleDataSpan {.importc: "QModelRoleDataSpan_new_from".}
...
proc fcQAbstractItemModel_itemData(self: pointer, index: pointer): struct_seaqt_map {.importc: "QAbstractItemModel_itemData".}
proc fcQAbstractItemModel_setItemData(self: pointer, index: pointer, roles: struct_seaqt_map): bool {.importc: "QAbstractItemModel_setItemData".}
proc fcQAbstractItemModel_clearItemData(self: pointer, index: pointer): bool {.importc: "QAbstractItemModel_clearItemData".}
proc fcQAbstractItemModel_mimeTypes(self: pointer): struct_seaqt_array {.importc: "QAbstractItemModel_mimeTypes".}
proc fcQAbstractItemModel_mimeData(self: pointer, indexes: struct_seaqt_array): pointer {.importc: "QAbstractItemModel_mimeData".}
...
proc fcQAbstractItemModel_virtualbase_itemData(self: pointer, index: pointer): struct_seaqt_map {.importc: "QAbstractItemModel_virtualbase_itemData".}
proc fcQAbstractItemModel_virtualbase_setItemData(self: pointer, index: pointer, roles: struct_seaqt_map): bool {.importc: "QAbstractItemModel_virtualbase_setItemData".}
...
proc fcQAbstractItemModel_virtualbase_mimeTypes(self: pointer): struct_seaqt_array {.importc: "QAbstractItemModel_virtualbase_mimeTypes".}
proc fcQAbstractItemModel_virtualbase_mimeData(self: pointer, indexes: struct_seaqt_array): pointer {.importc: "QAbstractItemModel_virtualbase_mimeData".}
...
proc fcQAbstractItemModel_virtualbase_match(self: pointer, start: pointer, role: cint, value: pointer, hits: cint, flags: cint): struct_seaqt_array {.importc: "QAbstractItemModel_virtualbase_match".}
...
proc fcQAbstractItemModel_virtualbase_roleNames(self: pointer): struct_seaqt_map {.importc: "QAbstractItemModel_virtualbase_roleNames".}
...
proc fcQAbstractTableModel_virtualbase_itemData(self: pointer, index: pointer): struct_seaqt_map {.importc: "QAbstractTableModel_virtualbase_itemData".}
proc fcQAbstractTableModel_virtualbase_setItemData(self: pointer, index: pointer, roles: struct_seaqt_map): bool {.importc: "QAbstractTableModel_virtualbase_setItemData".}
...
proc fcQAbstractTableModel_virtualbase_mimeTypes(self: pointer): struct_seaqt_array {.importc: "QAbstractTableModel_virtualbase_mimeTypes".}
proc fcQAbstractTableModel_virtualbase_mimeData(self: pointer, indexes: struct_seaqt_array): pointer {.importc: "QAbstractTableModel_virtualbase_mimeData".}
...
proc fcQAbstractTableModel_virtualbase_match(self: pointer, start: pointer, role: cint, value: pointer, hits: cint, flags: cint): struct_seaqt_array {.importc: "QAbstractTableModel_virtualbase_match".}
...
proc fcQAbstractTableModel_virtualbase_roleNames(self: pointer): struct_seaqt_map {.importc: "QAbstractTableModel_virtualbase_roleNames".}
...
proc fcQAbstractTableModel_protectedbase_changePersistentIndexList(self: pointer, fromVal: struct_seaqt_array, to: struct_seaqt_array): void {.importc: "QAbstractTableModel_protectedbase_changePersistentIndexList".}
proc fcQAbstractTableModel_protectedbase_persistentIndexList(self: pointer): struct_seaqt_array {.importc: "QAbstractTableModel_protectedbase_persistentIndexList".}
...
proc fcQAbstractListModel_virtualbase_itemData(self: pointer, index: pointer): struct_seaqt_map {.importc: "QAbstractListModel_virtualbase_itemData".}
proc fcQAbstractListModel_virtualbase_setItemData(self: pointer, index: pointer, roles: struct_seaqt_map): bool {.importc: "QAbstractListModel_virtualbase_setItemData".}
...
proc fcQAbstractListModel_virtualbase_mimeTypes(self: pointer): struct_seaqt_array {.importc: "QAbstractListModel_virtualbase_mimeTypes".}
proc fcQAbstractListModel_virtualbase_mimeData(self: pointer, indexes: struct_seaqt_array): pointer {.importc: "QAbstractListModel_virtualbase_mimeData".}
...
proc fcQAbstractListModel_virtualbase_match(self: pointer, start: pointer, role: cint, value: pointer, hits: cint, flags: cint): struct_seaqt_array {.importc: "QAbstractListModel_virtualbase_match".}
...
proc fcQAbstractListModel_virtualbase_roleNames(self: pointer): struct_seaqt_map {.importc: "QAbstractListModel_virtualbase_roleNames".}
...
proc fcQAbstractListModel_protectedbase_changePersistentIndexList(self: pointer, fromVal: struct_seaqt_array, to: struct_seaqt_array): void {.importc: "QAbstractListModel_protectedbase_changePersistentIndexList".}
proc fcQAbstractListModel_protectedbase_persistentIndexList(self: pointer): struct_seaqt_array {.importc: "QAbstractListModel_protectedbase_persistentIndexList".}
...
proc data2*(self: gen_qabstractitemmodel_types.QModelRoleData): gen_qvariant_types.QVariant =
  gen_qvariant_types.QVariant(h: fcQModelRoleData_dataConst(self.h), owned: false)

proc clearData*(self: gen_qabstractitemmodel_types.QModelRoleData): void =
  fcQModelRoleData_clearData(self.h)

proc operatorAssign*(self: gen_qabstractitemmodel_types.QModelRoleData, fromVal: gen_qabstractitemmodel_types.QModelRoleData): void =
  fcQModelRoleData_operatorAssign(self.h, fromVal.h)

proc create*(T: type gen_qabstractitemmodel_types.QModelRoleData,
    role: cint): gen_qabstractitemmodel_types.QModelRoleData =
  let tmp = gen_qabstractitemmodel_types.QModelRoleData(h: fcQModelRoleData_new(role), owned: true)
  tmp
proc create*(T: type gen_qabstractitemmodel_types.QModelRoleData,
    fromVal: gen_qabstractitemmodel_types.QModelRoleData): gen_qabstractitemmodel_types.QModelRoleData =
  let tmp = gen_qabstractitemmodel_types.QModelRoleData(h: fcQModelRoleData_new2(fromVal.h), owned: true)
  tmp
...
proc create*(T: type gen_qabstractitemmodel_types.QModelRoleDataSpan): gen_qabstractitemmodel_types.QModelRoleDataSpan =
  let tmp = gen_qabstractitemmodel_types.QModelRoleDataSpan(h: fcQModelRoleDataSpan_new(), owned: true)
  tmp
proc create*(T: type gen_qabstractitemmodel_types.QModelRoleDataSpan,
  ...
  let tmp = gen_qabstractitemmodel_types.QModelRoleDataSpan(h: fcQModelRoleDataSpan_new2(modelRoleData.h), owned: true)
  tmp
proc create*(T: type gen_qabstractitemmodel_types.QModelRoleDataSpan,
    modelRoleData: gen_qabstractitemmodel_types.QModelRoleData, len: int64): gen_qabstractitemmodel_types.QModelRoleDataSpan =
  let tmp = gen_qabstractitemmodel_types.QModelRoleDataSpan(h: fcQModelRoleDataSpan_new3(modelRoleData.h, len), owned: true)
  tmp
proc create*(T: type gen_qabstractitemmodel_types.QModelRoleDataSpan,
    fromVal: gen_qabstractitemmodel_types.QModelRoleDataSpan): gen_qabstractitemmodel_types.QModelRoleDataSpan =
  let tmp = gen_qabstractitemmodel_types.QModelRoleDataSpan(h: fcQModelRoleDataSpan_new4(fromVal.h), owned: true)
  tmp
...
proc setItemData*(self: gen_qabstractitemmodel_types.QAbstractItemModel, index: gen_qabstractitemmodel_types.QModelIndex, roles: Table[cint,gen_qvariant_types.QVariant]): bool =
  ...
  fcQAbstractItemModel_setItemData(self.h, index.h, struct_seaqt_map(len: csize_t(len(roles)),keys: if len(roles) == 0: nil else: addr(roles_Keys_CArray[0]), values: if len(roles) == 0: nil else: addr(roles_Values_CArray[0]),))
...
proc mimeData*(self: gen_qabstractitemmodel_types.QAbstractItemModel, indexes: openArray[gen_qabstractitemmodel_types.QModelIndex]): gen_qmimedata_types.QMimeData =
  ...
  gen_qmimedata_types.QMimeData(h: fcQAbstractItemModel_mimeData(self.h, struct_seaqt_array(len: csize_t(len(indexes)), data: if len(indexes) == 0: nil else: addr(indexes_CArray[0]))), owned: false)
...
proc QAbstractItemModelsetItemData*(self: gen_qabstractitemmodel_types.QAbstractItemModel, index: gen_qabstractitemmodel_types.QModelIndex, roles: Table[cint,gen_qvariant_types.QVariant]): bool =
  ...
  fcQAbstractItemModel_virtualbase_setItemData(self.h, index.h, struct_seaqt_map(len: csize_t(len(roles)),keys: if len(roles) == 0: nil else: addr(roles_Keys_CArray[0]), values: if len(roles) == 0: nil else: addr(roles_Values_CArray[0]),))
...
proc QAbstractItemModelmimeData*(self: gen_qabstractitemmodel_types.QAbstractItemModel, indexes: openArray[gen_qabstractitemmodel_types.QModelIndex]): gen_qmimedata_types.QMimeData =
  ...
  gen_qmimedata_types.QMimeData(h: fcQAbstractItemModel_virtualbase_mimeData(self.h, struct_seaqt_array(len: csize_t(len(indexes)), data: if len(indexes) == 0: nil else: addr(indexes_CArray[0]))), owned: false)
...
proc fcQAbstractItemModel_vtable_callback_itemData(self: pointer, index: pointer): struct_seaqt_map {.cdecl.} =
  let vtbl = cast[ptr QAbstractItemModelVTable](fcQAbstractItemModel_vdata(self)[])
  let self = QAbstractItemModel(h: self)
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
...
proc fcQAbstractItemModel_vtable_callback_setItemData(self: pointer, index: pointer, roles: struct_seaqt_map): bool {.cdecl.} =
  let vtbl = cast[ptr QAbstractItemModelVTable](fcQAbstractItemModel_vdata(self)[])
  let self = QAbstractItemModel(h: self)
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
  var vroles_mm = roles
...
proc fcQAbstractItemModel_vtable_callback_mimeTypes(self: pointer): struct_seaqt_array {.cdecl.} =
  let vtbl = cast[ptr QAbstractItemModelVTable](fcQAbstractItemModel_vdata(self)[])
  let self = QAbstractItemModel(h: self)
...
proc fcQAbstractItemModel_vtable_callback_mimeData(self: pointer, indexes: struct_seaqt_array): pointer {.cdecl.} =
  let vtbl = cast[ptr QAbstractItemModelVTable](fcQAbstractItemModel_vdata(self)[])
  let self = QAbstractItemModel(h: self)
...
proc fcQAbstractItemModel_vtable_callback_match(self: pointer, start: pointer, role: cint, value: pointer, hits: cint, flags: cint): struct_seaqt_array {.cdecl.} =
  let vtbl = cast[ptr QAbstractItemModelVTable](fcQAbstractItemModel_vdata(self)[])
  let self = QAbstractItemModel(h: self)
...
proc fcQAbstractItemModel_vtable_callback_roleNames(self: pointer): struct_seaqt_map {.cdecl.} =
  let vtbl = cast[ptr QAbstractItemModelVTable](fcQAbstractItemModel_vdata(self)[])
  let self = QAbstractItemModel(h: self)
...
proc fcQAbstractItemModel_method_callback_itemData(self: pointer, index: pointer): struct_seaqt_map {.cdecl.} =
  let inst = cast[VirtualQAbstractItemModel](fcQAbstractItemModel_vdata(self)[])
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
...
proc fcQAbstractItemModel_method_callback_setItemData(self: pointer, index: pointer, roles: struct_seaqt_map): bool {.cdecl.} =
  let inst = cast[VirtualQAbstractItemModel](fcQAbstractItemModel_vdata(self)[])
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
  var vroles_mm = roles
  var vrolesx_ret: Table[cint, gen_qvariant_types.QVariant]
...
proc fcQAbstractItemModel_method_callback_mimeTypes(self: pointer): struct_seaqt_array {.cdecl.} =
  let inst = cast[VirtualQAbstractItemModel](fcQAbstractItemModel_vdata(self)[])
...
proc fcQAbstractItemModel_method_callback_mimeData(self: pointer, indexes: struct_seaqt_array): pointer {.cdecl.} =
  let inst = cast[VirtualQAbstractItemModel](fcQAbstractItemModel_vdata(self)[])
  var vindexes_ma = indexes
  var vindexesx_ret = newSeq[gen_qabstractitemmodel_types.QModelIndex](int(vindexes_ma.len))
  let vindexes_outCast = cast[ptr UncheckedArray[pointer]](vindexes_ma.data)
...
proc fcQAbstractItemModel_method_callback_match(self: pointer, start: pointer, role: cint, value: pointer, hits: cint, flags: cint): struct_seaqt_array {.cdecl.} =
  let inst = cast[VirtualQAbstractItemModel](fcQAbstractItemModel_vdata(self)[])
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: start, owned: false)
  let slotval2 = role
  let slotval3 = gen_qvariant_types.QVariant(h: value, owned: false)
...
proc fcQAbstractItemModel_method_callback_roleNames(self: pointer): struct_seaqt_map {.cdecl.} =
  let inst = cast[VirtualQAbstractItemModel](fcQAbstractItemModel_vdata(self)[])
...
proc encodeData*(self: gen_qabstractitemmodel_types.QAbstractItemModel, indexes: openArray[gen_qabstractitemmodel_types.QModelIndex], stream: gen_qdatastream_types.QDataStream): void =
  ...
  fcQAbstractItemModel_protectedbase_encodeData(self.h, struct_seaqt_array(len: csize_t(len(indexes)), data: if len(indexes) == 0: nil else: addr(indexes_CArray[0])), stream.h)
...
proc changePersistentIndexList*(self: gen_qabstractitemmodel_types.QAbstractItemModel, fromVal: openArray[gen_qabstractitemmodel_types.QModelIndex], to: openArray[gen_qabstractitemmodel_types.QModelIndex]): void =
  ...
  fcQAbstractItemModel_protectedbase_changePersistentIndexList(self.h, struct_seaqt_array(len: csize_t(len(fromVal)), data: if len(fromVal) == 0: nil else: addr(fromVal_CArray[0])), struct_seaqt_array(len: csize_t(len(to)), data: if len(to) == 0: nil else: addr(to_CArray[0])))
...
proc create*(T: type gen_qabstractitemmodel_types.QAbstractItemModel,
  ...
  let tmp = gen_qabstractitemmodel_types.QAbstractItemModel(h: fcQAbstractItemModel_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQAbstractItemModel_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qabstractitemmodel_types.QAbstractItemModel,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQAbstractItemModel_vtable_callback_disconnectNotify
  let tmp = gen_qabstractitemmodel_types.QAbstractItemModel(h: fcQAbstractItemModel_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQAbstractItemModel_vdata(tmp.h)[] = addr(vtbl[])
  tmp
...
proc create*(T: type gen_qabstractitemmodel_types.QAbstractItemModel,
  ...
  inst[].h = fcQAbstractItemModel_new(addr(cQAbstractItemModel_mvtbl), csize_t(sizeof(pointer)))
  fcQAbstractItemModel_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qabstractitemmodel_types.QAbstractItemModel,
    ...
    inst: VirtualQAbstractItemModel) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQAbstractItemModel_new2(addr(cQAbstractItemModel_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQAbstractItemModel_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc QAbstractTableModelsetItemData*(self: gen_qabstractitemmodel_types.QAbstractTableModel, index: gen_qabstractitemmodel_types.QModelIndex, roles: Table[cint,gen_qvariant_types.QVariant]): bool =
  ...
  fcQAbstractTableModel_virtualbase_setItemData(self.h, index.h, struct_seaqt_map(len: csize_t(len(roles)),keys: if len(roles) == 0: nil else: addr(roles_Keys_CArray[0]), values: if len(roles) == 0: nil else: addr(roles_Values_CArray[0]),))
...
proc QAbstractTableModelmimeData*(self: gen_qabstractitemmodel_types.QAbstractTableModel, indexes: openArray[gen_qabstractitemmodel_types.QModelIndex]): gen_qmimedata_types.QMimeData =
  ...
  gen_qmimedata_types.QMimeData(h: fcQAbstractTableModel_virtualbase_mimeData(self.h, struct_seaqt_array(len: csize_t(len(indexes)), data: if len(indexes) == 0: nil else: addr(indexes_CArray[0]))), owned: false)
...
proc fcQAbstractTableModel_vtable_callback_itemData(self: pointer, index: pointer): struct_seaqt_map {.cdecl.} =
  let vtbl = cast[ptr QAbstractTableModelVTable](fcQAbstractTableModel_vdata(self)[])
  let self = QAbstractTableModel(h: self)
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
  var virtualReturn = vtbl[].itemData(self, slotval1)
...
proc fcQAbstractTableModel_vtable_callback_setItemData(self: pointer, index: pointer, roles: struct_seaqt_map): bool {.cdecl.} =
  let vtbl = cast[ptr QAbstractTableModelVTable](fcQAbstractTableModel_vdata(self)[])
  let self = QAbstractTableModel(h: self)
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
  var vroles_mm = roles
...
proc fcQAbstractTableModel_vtable_callback_mimeTypes(self: pointer): struct_seaqt_array {.cdecl.} =
  let vtbl = cast[ptr QAbstractTableModelVTable](fcQAbstractTableModel_vdata(self)[])
  let self = QAbstractTableModel(h: self)
  var virtualReturn = vtbl[].mimeTypes(self)
  var virtualReturn_CArray = cast[ptr UncheckedArray[struct_seaqt_string]](if len(virtualReturn) > 0: c_malloc(c_sizet(sizeof(struct_seaqt_string) * len(virtualReturn))) else: nil)
...
proc fcQAbstractTableModel_vtable_callback_mimeData(self: pointer, indexes: struct_seaqt_array): pointer {.cdecl.} =
  let vtbl = cast[ptr QAbstractTableModelVTable](fcQAbstractTableModel_vdata(self)[])
  let self = QAbstractTableModel(h: self)
  var vindexes_ma = indexes
  var vindexesx_ret = newSeq[gen_qabstractitemmodel_types.QModelIndex](int(vindexes_ma.len))
...
proc fcQAbstractTableModel_vtable_callback_match(self: pointer, start: pointer, role: cint, value: pointer, hits: cint, flags: cint): struct_seaqt_array {.cdecl.} =
  let vtbl = cast[ptr QAbstractTableModelVTable](fcQAbstractTableModel_vdata(self)[])
  let self = QAbstractTableModel(h: self)
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: start, owned: false)
  let slotval2 = role
...
proc fcQAbstractTableModel_vtable_callback_roleNames(self: pointer): struct_seaqt_map {.cdecl.} =
  let vtbl = cast[ptr QAbstractTableModelVTable](fcQAbstractTableModel_vdata(self)[])
  let self = QAbstractTableModel(h: self)
  var virtualReturn = vtbl[].roleNames(self)
  var virtualReturn_Keys_CArray = cast[ptr UncheckedArray[cint]](if len(virtualReturn) > 0: c_malloc(csize_t(sizeof(cint) * len(virtualReturn))) else: nil)
...
proc fcQAbstractTableModel_method_callback_itemData(self: pointer, index: pointer): struct_seaqt_map {.cdecl.} =
  let inst = cast[VirtualQAbstractTableModel](fcQAbstractTableModel_vdata(self)[])
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
  var virtualReturn = inst.itemData(slotval1)
  var virtualReturn_Keys_CArray = cast[ptr UncheckedArray[cint]](if len(virtualReturn) > 0: c_malloc(csize_t(sizeof(cint) * len(virtualReturn))) else: nil)
...
proc fcQAbstractTableModel_method_callback_setItemData(self: pointer, index: pointer, roles: struct_seaqt_map): bool {.cdecl.} =
  let inst = cast[VirtualQAbstractTableModel](fcQAbstractTableModel_vdata(self)[])
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
  var vroles_mm = roles
  var vrolesx_ret: Table[cint, gen_qvariant_types.QVariant]
...
proc fcQAbstractTableModel_method_callback_mimeTypes(self: pointer): struct_seaqt_array {.cdecl.} =
  let inst = cast[VirtualQAbstractTableModel](fcQAbstractTableModel_vdata(self)[])
  var virtualReturn = inst.mimeTypes()
  var virtualReturn_CArray = cast[ptr UncheckedArray[struct_seaqt_string]](if len(virtualReturn) > 0: c_malloc(c_sizet(sizeof(struct_seaqt_string) * len(virtualReturn))) else: nil)
  for i in 0..<len(virtualReturn):
...
proc fcQAbstractTableModel_method_callback_mimeData(self: pointer, indexes: struct_seaqt_array): pointer {.cdecl.} =
  let inst = cast[VirtualQAbstractTableModel](fcQAbstractTableModel_vdata(self)[])
  var vindexes_ma = indexes
  var vindexesx_ret = newSeq[gen_qabstractitemmodel_types.QModelIndex](int(vindexes_ma.len))
  let vindexes_outCast = cast[ptr UncheckedArray[pointer]](vindexes_ma.data)
...
proc fcQAbstractTableModel_method_callback_match(self: pointer, start: pointer, role: cint, value: pointer, hits: cint, flags: cint): struct_seaqt_array {.cdecl.} =
  let inst = cast[VirtualQAbstractTableModel](fcQAbstractTableModel_vdata(self)[])
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: start, owned: false)
  let slotval2 = role
  let slotval3 = gen_qvariant_types.QVariant(h: value, owned: false)
...
proc fcQAbstractTableModel_method_callback_roleNames(self: pointer): struct_seaqt_map {.cdecl.} =
  let inst = cast[VirtualQAbstractTableModel](fcQAbstractTableModel_vdata(self)[])
  var virtualReturn = inst.roleNames()
  var virtualReturn_Keys_CArray = cast[ptr UncheckedArray[cint]](if len(virtualReturn) > 0: c_malloc(csize_t(sizeof(cint) * len(virtualReturn))) else: nil)
  var virtualReturn_Values_CArray = cast[ptr UncheckedArray[struct_seaqt_string]](if len(virtualReturn) > 0: c_malloc(csize_t(sizeof(struct_seaqt_string) * len(virtualReturn))) else: nil)
...
proc encodeData*(self: gen_qabstractitemmodel_types.QAbstractTableModel, indexes: openArray[gen_qabstractitemmodel_types.QModelIndex], stream: gen_qdatastream_types.QDataStream): void =
  ...
  fcQAbstractTableModel_protectedbase_encodeData(self.h, struct_seaqt_array(len: csize_t(len(indexes)), data: if len(indexes) == 0: nil else: addr(indexes_CArray[0])), stream.h)
...
proc changePersistentIndexList*(self: gen_qabstractitemmodel_types.QAbstractTableModel, fromVal: openArray[gen_qabstractitemmodel_types.QModelIndex], to: openArray[gen_qabstractitemmodel_types.QModelIndex]): void =
  ...
  fcQAbstractTableModel_protectedbase_changePersistentIndexList(self.h, struct_seaqt_array(len: csize_t(len(fromVal)), data: if len(fromVal) == 0: nil else: addr(fromVal_CArray[0])), struct_seaqt_array(len: csize_t(len(to)), data: if len(to) == 0: nil else: addr(to_CArray[0])))
...
proc create*(T: type gen_qabstractitemmodel_types.QAbstractTableModel,
  ...
  let tmp = gen_qabstractitemmodel_types.QAbstractTableModel(h: fcQAbstractTableModel_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQAbstractTableModel_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qabstractitemmodel_types.QAbstractTableModel,
    parent: gen_qobject_types.QObject,
    vtbl: ref QAbstractTableModelVTable = nil): gen_qabstractitemmodel_types.QAbstractTableModel =
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQAbstractTableModel_vtable_callback_disconnectNotify
  let tmp = gen_qabstractitemmodel_types.QAbstractTableModel(h: fcQAbstractTableModel_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQAbstractTableModel_vdata(tmp.h)[] = addr(vtbl[])
  tmp
...
proc create*(T: type gen_qabstractitemmodel_types.QAbstractTableModel,
  ...
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQAbstractTableModel_new(addr(cQAbstractTableModel_mvtbl), csize_t(sizeof(pointer)))
  fcQAbstractTableModel_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qabstractitemmodel_types.QAbstractTableModel,
    ...
    inst: VirtualQAbstractTableModel) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQAbstractTableModel_new2(addr(cQAbstractTableModel_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQAbstractTableModel_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc QAbstractListModelsetItemData*(self: gen_qabstractitemmodel_types.QAbstractListModel, index: gen_qabstractitemmodel_types.QModelIndex, roles: Table[cint,gen_qvariant_types.QVariant]): bool =
  ...
  fcQAbstractListModel_virtualbase_setItemData(self.h, index.h, struct_seaqt_map(len: csize_t(len(roles)),keys: if len(roles) == 0: nil else: addr(roles_Keys_CArray[0]), values: if len(roles) == 0: nil else: addr(roles_Values_CArray[0]),))
...
proc QAbstractListModelmimeData*(self: gen_qabstractitemmodel_types.QAbstractListModel, indexes: openArray[gen_qabstractitemmodel_types.QModelIndex]): gen_qmimedata_types.QMimeData =
  ...
  gen_qmimedata_types.QMimeData(h: fcQAbstractListModel_virtualbase_mimeData(self.h, struct_seaqt_array(len: csize_t(len(indexes)), data: if len(indexes) == 0: nil else: addr(indexes_CArray[0]))), owned: false)
...
proc fcQAbstractListModel_vtable_callback_itemData(self: pointer, index: pointer): struct_seaqt_map {.cdecl.} =
  let vtbl = cast[ptr QAbstractListModelVTable](fcQAbstractListModel_vdata(self)[])
  let self = QAbstractListModel(h: self)
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
  var virtualReturn = vtbl[].itemData(self, slotval1)
...
proc fcQAbstractListModel_vtable_callback_setItemData(self: pointer, index: pointer, roles: struct_seaqt_map): bool {.cdecl.} =
  let vtbl = cast[ptr QAbstractListModelVTable](fcQAbstractListModel_vdata(self)[])
  let self = QAbstractListModel(h: self)
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
  var vroles_mm = roles
...
proc fcQAbstractListModel_vtable_callback_mimeTypes(self: pointer): struct_seaqt_array {.cdecl.} =
  let vtbl = cast[ptr QAbstractListModelVTable](fcQAbstractListModel_vdata(self)[])
  let self = QAbstractListModel(h: self)
  var virtualReturn = vtbl[].mimeTypes(self)
  var virtualReturn_CArray = cast[ptr UncheckedArray[struct_seaqt_string]](if len(virtualReturn) > 0: c_malloc(c_sizet(sizeof(struct_seaqt_string) * len(virtualReturn))) else: nil)
...
proc fcQAbstractListModel_vtable_callback_mimeData(self: pointer, indexes: struct_seaqt_array): pointer {.cdecl.} =
  let vtbl = cast[ptr QAbstractListModelVTable](fcQAbstractListModel_vdata(self)[])
  let self = QAbstractListModel(h: self)
  var vindexes_ma = indexes
  var vindexesx_ret = newSeq[gen_qabstractitemmodel_types.QModelIndex](int(vindexes_ma.len))
...
proc fcQAbstractListModel_vtable_callback_match(self: pointer, start: pointer, role: cint, value: pointer, hits: cint, flags: cint): struct_seaqt_array {.cdecl.} =
  let vtbl = cast[ptr QAbstractListModelVTable](fcQAbstractListModel_vdata(self)[])
  let self = QAbstractListModel(h: self)
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: start, owned: false)
  let slotval2 = role
...
proc fcQAbstractListModel_vtable_callback_roleNames(self: pointer): struct_seaqt_map {.cdecl.} =
  let vtbl = cast[ptr QAbstractListModelVTable](fcQAbstractListModel_vdata(self)[])
  let self = QAbstractListModel(h: self)
  var virtualReturn = vtbl[].roleNames(self)
  var virtualReturn_Keys_CArray = cast[ptr UncheckedArray[cint]](if len(virtualReturn) > 0: c_malloc(csize_t(sizeof(cint) * len(virtualReturn))) else: nil)
...
proc fcQAbstractListModel_method_callback_itemData(self: pointer, index: pointer): struct_seaqt_map {.cdecl.} =
  let inst = cast[VirtualQAbstractListModel](fcQAbstractListModel_vdata(self)[])
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
  var virtualReturn = inst.itemData(slotval1)
  var virtualReturn_Keys_CArray = cast[ptr UncheckedArray[cint]](if len(virtualReturn) > 0: c_malloc(csize_t(sizeof(cint) * len(virtualReturn))) else: nil)
...
proc fcQAbstractListModel_method_callback_setItemData(self: pointer, index: pointer, roles: struct_seaqt_map): bool {.cdecl.} =
  let inst = cast[VirtualQAbstractListModel](fcQAbstractListModel_vdata(self)[])
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
  var vroles_mm = roles
  var vrolesx_ret: Table[cint, gen_qvariant_types.QVariant]
...
proc fcQAbstractListModel_method_callback_mimeTypes(self: pointer): struct_seaqt_array {.cdecl.} =
  let inst = cast[VirtualQAbstractListModel](fcQAbstractListModel_vdata(self)[])
  var virtualReturn = inst.mimeTypes()
  var virtualReturn_CArray = cast[ptr UncheckedArray[struct_seaqt_string]](if len(virtualReturn) > 0: c_malloc(c_sizet(sizeof(struct_seaqt_string) * len(virtualReturn))) else: nil)
  for i in 0..<len(virtualReturn):
...
proc fcQAbstractListModel_method_callback_mimeData(self: pointer, indexes: struct_seaqt_array): pointer {.cdecl.} =
  let inst = cast[VirtualQAbstractListModel](fcQAbstractListModel_vdata(self)[])
  var vindexes_ma = indexes
  var vindexesx_ret = newSeq[gen_qabstractitemmodel_types.QModelIndex](int(vindexes_ma.len))
  let vindexes_outCast = cast[ptr UncheckedArray[pointer]](vindexes_ma.data)
...
proc fcQAbstractListModel_method_callback_match(self: pointer, start: pointer, role: cint, value: pointer, hits: cint, flags: cint): struct_seaqt_array {.cdecl.} =
  let inst = cast[VirtualQAbstractListModel](fcQAbstractListModel_vdata(self)[])
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: start, owned: false)
  let slotval2 = role
  let slotval3 = gen_qvariant_types.QVariant(h: value, owned: false)
...
proc fcQAbstractListModel_method_callback_roleNames(self: pointer): struct_seaqt_map {.cdecl.} =
  let inst = cast[VirtualQAbstractListModel](fcQAbstractListModel_vdata(self)[])
  var virtualReturn = inst.roleNames()
  var virtualReturn_Keys_CArray = cast[ptr UncheckedArray[cint]](if len(virtualReturn) > 0: c_malloc(csize_t(sizeof(cint) * len(virtualReturn))) else: nil)
  var virtualReturn_Values_CArray = cast[ptr UncheckedArray[struct_seaqt_string]](if len(virtualReturn) > 0: c_malloc(csize_t(sizeof(struct_seaqt_string) * len(virtualReturn))) else: nil)
...
proc encodeData*(self: gen_qabstractitemmodel_types.QAbstractListModel, indexes: openArray[gen_qabstractitemmodel_types.QModelIndex], stream: gen_qdatastream_types.QDataStream): void =
  ...
  fcQAbstractListModel_protectedbase_encodeData(self.h, struct_seaqt_array(len: csize_t(len(indexes)), data: if len(indexes) == 0: nil else: addr(indexes_CArray[0])), stream.h)
...
proc changePersistentIndexList*(self: gen_qabstractitemmodel_types.QAbstractListModel, fromVal: openArray[gen_qabstractitemmodel_types.QModelIndex], to: openArray[gen_qabstractitemmodel_types.QModelIndex]): void =
  ...
  fcQAbstractListModel_protectedbase_changePersistentIndexList(self.h, struct_seaqt_array(len: csize_t(len(fromVal)), data: if len(fromVal) == 0: nil else: addr(fromVal_CArray[0])), struct_seaqt_array(len: csize_t(len(to)), data: if len(to) == 0: nil else: addr(to_CArray[0])))
...
proc create*(T: type gen_qabstractitemmodel_types.QAbstractListModel,
  ...
  let tmp = gen_qabstractitemmodel_types.QAbstractListModel(h: fcQAbstractListModel_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQAbstractListModel_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qabstractitemmodel_types.QAbstractListModel,
    parent: gen_qobject_types.QObject,
    vtbl: ref QAbstractListModelVTable = nil): gen_qabstractitemmodel_types.QAbstractListModel =
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQAbstractListModel_vtable_callback_disconnectNotify
  let tmp = gen_qabstractitemmodel_types.QAbstractListModel(h: fcQAbstractListModel_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQAbstractListModel_vdata(tmp.h)[] = addr(vtbl[])
  tmp
...
proc create*(T: type gen_qabstractitemmodel_types.QAbstractListModel,
  ...
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQAbstractListModel_new(addr(cQAbstractListModel_mvtbl), csize_t(sizeof(pointer)))
  fcQAbstractListModel_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qabstractitemmodel_types.QAbstractListModel,
    ...
    inst: VirtualQAbstractListModel) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQAbstractListModel_new2(addr(cQAbstractListModel_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQAbstractListModel_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
