...
proc fcQAbstractItemModel_connect_rowsMoved(self: pointer, slot: int, callback: proc (slot: int, parent: pointer, start: cint, endVal: cint, destination: pointer, row: cint) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QAbstractItemModel_connect_rowsMoved".}
...
proc fcQAbstractItemModel_connect_columnsMoved(self: pointer, slot: int, callback: proc (slot: int, parent: pointer, start: cint, endVal: cint, destination: pointer, column: cint) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QAbstractItemModel_connect_columnsMoved".}
...
type QAbstractItemModelrowsMovedSlot* = proc(parent: gen_qabstractitemmodel_types.QModelIndex, start: cint, endVal: cint, destination: gen_qabstractitemmodel_types.QModelIndex, row: cint)
proc fcQAbstractItemModel_slot_callback_rowsMoved(slot: int, parent: pointer, start: cint, endVal: cint, destination: pointer, row: cint) {.cdecl.} =
  ...
  let slotval4 = gen_qabstractitemmodel_types.QModelIndex(h: destination, owned: false)
...
type QAbstractItemModelcolumnsMovedSlot* = proc(parent: gen_qabstractitemmodel_types.QModelIndex, start: cint, endVal: cint, destination: gen_qabstractitemmodel_types.QModelIndex, column: cint)
proc fcQAbstractItemModel_slot_callback_columnsMoved(slot: int, parent: pointer, start: cint, endVal: cint, destination: pointer, column: cint) {.cdecl.} =
