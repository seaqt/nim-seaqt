...
proc fcQArrayData_flags(self: pointer): cint {.importc: "QArrayData_flags".}
proc fcQArrayData_setFlags(self: pointer, flags: cint): void {.importc: "QArrayData_setFlags".}
proc fcQArrayData_alloc(self: pointer): int64 {.importc: "QArrayData_alloc".}
proc fcQArrayData_setAlloc(self: pointer, alloc: int64): void {.importc: "QArrayData_setAlloc".}
...
proc fcQArrayData_reallocateUnaligned(data: pointer, dataPointer: pointer, objectSize: int64, newCapacity: int64, option: cint): struct_seaqt_map {.importc: "QArrayData_reallocateUnaligned".}
...
proc flags*(self: gen_qarraydata_types.QArrayData): cint =
  cint(fcQArrayData_flags(self.h))

proc setFlags*(self: gen_qarraydata_types.QArrayData, flags: cint): void =
  fcQArrayData_setFlags(self.h, cint(flags))

proc alloc*(self: gen_qarraydata_types.QArrayData): int64 =
  fcQArrayData_alloc(self.h)

proc setAlloc*(self: gen_qarraydata_types.QArrayData, alloc: int64): void =
