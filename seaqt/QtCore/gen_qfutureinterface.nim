...
type QFutureInterfaceBaseContinuationTypeEnum* = distinct uint8
template Unknown*(_: type QFutureInterfaceBaseContinuationTypeEnum): untyped = 0
template Then*(_: type QFutureInterfaceBaseContinuationTypeEnum): untyped = 1
template OnFailed*(_: type QFutureInterfaceBaseContinuationTypeEnum): untyped = 2
template OnCanceled*(_: type QFutureInterfaceBaseContinuationTypeEnum): untyped = 3
...
proc fcQFutureInterfaceBase_setProgressValueAndText(self: pointer, progressValue: cint, progressText: struct_seaqt_string): void {.importc: "QFutureInterfaceBase_setProgressValueAndText".}
proc fcQFutureInterfaceBase_progressText(self: pointer): struct_seaqt_string {.importc: "QFutureInterfaceBase_progressText".}
...
proc fcQFutureInterfaceBase_cancelChain(self: pointer): void {.importc: "QFutureInterfaceBase_cancelChain".}
proc fcQFutureInterfaceBase_setAddResultsIfCanceledEnabled(self: pointer, enable: bool): void {.importc: "QFutureInterfaceBase_setAddResultsIfCanceledEnabled".}
proc fcQFutureInterfaceBase_isAddResultsIfCanceledEnabled(self: pointer): bool {.importc: "QFutureInterfaceBase_isAddResultsIfCanceledEnabled".}
...
proc fcQFutureInterfaceBase_protectedbase_cancelChain_mode(self: pointer, mode: cint): void {.importc: "QFutureInterfaceBase_protectedbase_cancelChain_mode".}
...
proc setProgressValueAndText*(self: gen_qfutureinterface_types.QFutureInterfaceBase, progressValue: cint, progressText: openArray[char]): void =
  fcQFutureInterfaceBase_setProgressValueAndText(self.h, progressValue, struct_seaqt_string(data: if len(progressText) > 0: addr progressText[0] else: nil, len: csize_t(len(progressText))))
...
proc cancelChain*(self: gen_qfutureinterface_types.QFutureInterfaceBase): void =
  fcQFutureInterfaceBase_cancelChain(self.h)

proc setAddResultsIfCanceledEnabled*(self: gen_qfutureinterface_types.QFutureInterfaceBase, enable: bool): void =
  fcQFutureInterfaceBase_setAddResultsIfCanceledEnabled(self.h, enable)

proc isAddResultsIfCanceledEnabled*(self: gen_qfutureinterface_types.QFutureInterfaceBase): bool =
  fcQFutureInterfaceBase_isAddResultsIfCanceledEnabled(self.h)
...
proc cancelChain*(self: gen_qfutureinterface_types.QFutureInterfaceBase, mode: cint): void =
  fcQFutureInterfaceBase_protectedbase_cancelChain_mode(self.h, cint(mode))
