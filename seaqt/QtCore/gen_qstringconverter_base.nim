...
type QStringConverterFinalizeResultErrorEnum* = distinct uint8
template NoError*(_: type QStringConverterFinalizeResultErrorEnum): untyped = 0
template InvalidCharacters*(_: type QStringConverterFinalizeResultErrorEnum): untyped = 1
template NotEnoughSpace*(_: type QStringConverterFinalizeResultErrorEnum): untyped = 2
...
proc fcQStringConverter_availableCodecs(): struct_seaqt_array {.importc: "QStringConverter_availableCodecs".}
...
proc availableCodecs*(_: type gen_qstringconverter_base_types.QStringConverter): seq[string] =
  var v_ma = fcQStringConverter_availableCodecs()
