...
proc fcQStringConverterBaseState_flags(self: pointer): cint {.importc: "QStringConverterBase__State_flags".}
proc fcQStringConverterBaseState_setFlags(self: pointer, flags: cint): void {.importc: "QStringConverterBase__State_setFlags".}
proc fcQStringConverterBaseState_internalState(self: pointer): cint {.importc: "QStringConverterBase__State_internalState".}
proc fcQStringConverterBaseState_setInternalState(self: pointer, internalState: cint): void {.importc: "QStringConverterBase__State_setInternalState".}
proc fcQStringConverterBaseState_remainingChars(self: pointer): int64 {.importc: "QStringConverterBase__State_remainingChars".}
proc fcQStringConverterBaseState_setRemainingChars(self: pointer, remainingChars: int64): void {.importc: "QStringConverterBase__State_setRemainingChars".}
...
proc flags*(self: gen_qstringconverter_base_types.QStringConverterBaseState): cint =
  cint(fcQStringConverterBaseState_flags(self.h))

proc setFlags*(self: gen_qstringconverter_base_types.QStringConverterBaseState, flags: cint): void =
  fcQStringConverterBaseState_setFlags(self.h, cint(flags))

proc internalState*(self: gen_qstringconverter_base_types.QStringConverterBaseState): cint =
  fcQStringConverterBaseState_internalState(self.h)

proc setInternalState*(self: gen_qstringconverter_base_types.QStringConverterBaseState, internalState: cint): void =
  fcQStringConverterBaseState_setInternalState(self.h, internalState)

proc remainingChars*(self: gen_qstringconverter_base_types.QStringConverterBaseState): int64 =
  fcQStringConverterBaseState_remainingChars(self.h)

proc setRemainingChars*(self: gen_qstringconverter_base_types.QStringConverterBaseState, remainingChars: int64): void =
  fcQStringConverterBaseState_setRemainingChars(self.h, remainingChars)

proc invalidChars*(self: gen_qstringconverter_base_types.QStringConverterBaseState): int64 =
  fcQStringConverterBaseState_invalidChars(self.h)

proc setInvalidChars*(self: gen_qstringconverter_base_types.QStringConverterBaseState, invalidChars: int64): void =
