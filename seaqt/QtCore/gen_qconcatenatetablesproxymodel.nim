...
proc fcQConcatenateTablesProxyModel_itemData(self: pointer, proxyIndex: pointer): struct_seaqt_map {.importc: "QConcatenateTablesProxyModel_itemData".}
proc fcQConcatenateTablesProxyModel_setItemData(self: pointer, index: pointer, roles: struct_seaqt_map): bool {.importc: "QConcatenateTablesProxyModel_setItemData".}
...
proc fcQConcatenateTablesProxyModel_mimeTypes(self: pointer): struct_seaqt_array {.importc: "QConcatenateTablesProxyModel_mimeTypes".}
proc fcQConcatenateTablesProxyModel_mimeData(self: pointer, indexes: struct_seaqt_array): pointer {.importc: "QConcatenateTablesProxyModel_mimeData".}
...
proc fcQConcatenateTablesProxyModel_roleNames(self: pointer): struct_seaqt_map {.importc: "QConcatenateTablesProxyModel_roleNames".}
...
type cQConcatenateTablesProxyModelVTable {.pure.} = object
  ...
  itemData*: proc(self: pointer, proxyIndex: pointer): struct_seaqt_map {.cdecl, raises: [], gcsafe.}
...
proc fcQConcatenateTablesProxyModel_virtualbase_itemData(self: pointer, proxyIndex: pointer): struct_seaqt_map {.importc: "QConcatenateTablesProxyModel_virtualbase_itemData".}
proc fcQConcatenateTablesProxyModel_virtualbase_setItemData(self: pointer, index: pointer, roles: struct_seaqt_map): bool {.importc: "QConcatenateTablesProxyModel_virtualbase_setItemData".}
...
proc fcQConcatenateTablesProxyModel_virtualbase_mimeTypes(self: pointer): struct_seaqt_array {.importc: "QConcatenateTablesProxyModel_virtualbase_mimeTypes".}
proc fcQConcatenateTablesProxyModel_virtualbase_mimeData(self: pointer, indexes: struct_seaqt_array): pointer {.importc: "QConcatenateTablesProxyModel_virtualbase_mimeData".}
...
proc fcQConcatenateTablesProxyModel_virtualbase_roleNames(self: pointer): struct_seaqt_map {.importc: "QConcatenateTablesProxyModel_virtualbase_roleNames".}
...
proc fcQConcatenateTablesProxyModel_virtualbase_match(self: pointer, start: pointer, role: cint, value: pointer, hits: cint, flags: cint): struct_seaqt_array {.importc: "QConcatenateTablesProxyModel_virtualbase_match".}
...
proc fcQConcatenateTablesProxyModel_protectedbase_changePersistentIndexList(self: pointer, fromVal: struct_seaqt_array, to: struct_seaqt_array): void {.importc: "QConcatenateTablesProxyModel_protectedbase_changePersistentIndexList".}
proc fcQConcatenateTablesProxyModel_protectedbase_persistentIndexList(self: pointer): struct_seaqt_array {.importc: "QConcatenateTablesProxyModel_protectedbase_persistentIndexList".}
...
proc setItemData*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, index: gen_qabstractitemmodel_types.QModelIndex, roles: Table[cint,gen_qvariant_types.QVariant]): bool =
  ...
  fcQConcatenateTablesProxyModel_setItemData(self.h, index.h, struct_seaqt_map(len: csize_t(len(roles)),keys: if len(roles) == 0: nil else: addr(roles_Keys_CArray[0]), values: if len(roles) == 0: nil else: addr(roles_Values_CArray[0]),))
...
proc mimeData*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, indexes: openArray[gen_qabstractitemmodel_types.QModelIndex]): gen_qmimedata_types.QMimeData =
  ...
  gen_qmimedata_types.QMimeData(h: fcQConcatenateTablesProxyModel_mimeData(self.h, struct_seaqt_array(len: csize_t(len(indexes)), data: if len(indexes) == 0: nil else: addr(indexes_CArray[0]))), owned: false)
...
proc roleNames*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel): Table[cint,seq[byte]] =
  var v_mm = fcQConcatenateTablesProxyModel_roleNames(self.h)
...
proc QConcatenateTablesProxyModelsetItemData*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, index: gen_qabstractitemmodel_types.QModelIndex, roles: Table[cint,gen_qvariant_types.QVariant]): bool =
  ...
  fcQConcatenateTablesProxyModel_virtualbase_setItemData(self.h, index.h, struct_seaqt_map(len: csize_t(len(roles)),keys: if len(roles) == 0: nil else: addr(roles_Keys_CArray[0]), values: if len(roles) == 0: nil else: addr(roles_Values_CArray[0]),))
...
proc QConcatenateTablesProxyModelmimeData*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, indexes: openArray[gen_qabstractitemmodel_types.QModelIndex]): gen_qmimedata_types.QMimeData =
  ...
  gen_qmimedata_types.QMimeData(h: fcQConcatenateTablesProxyModel_virtualbase_mimeData(self.h, struct_seaqt_array(len: csize_t(len(indexes)), data: if len(indexes) == 0: nil else: addr(indexes_CArray[0]))), owned: false)
...
proc fcQConcatenateTablesProxyModel_vtable_callback_itemData(self: pointer, proxyIndex: pointer): struct_seaqt_map {.cdecl.} =
  let vtbl = cast[ptr QConcatenateTablesProxyModelVTable](fcQConcatenateTablesProxyModel_vdata(self)[])
  let self = QConcatenateTablesProxyModel(h: self)
...
proc fcQConcatenateTablesProxyModel_vtable_callback_setItemData(self: pointer, index: pointer, roles: struct_seaqt_map): bool {.cdecl.} =
  let vtbl = cast[ptr QConcatenateTablesProxyModelVTable](fcQConcatenateTablesProxyModel_vdata(self)[])
  let self = QConcatenateTablesProxyModel(h: self)
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
  var vroles_mm = roles
...
proc fcQConcatenateTablesProxyModel_vtable_callback_mimeTypes(self: pointer): struct_seaqt_array {.cdecl.} =
  let vtbl = cast[ptr QConcatenateTablesProxyModelVTable](fcQConcatenateTablesProxyModel_vdata(self)[])
  let self = QConcatenateTablesProxyModel(h: self)
...
proc fcQConcatenateTablesProxyModel_vtable_callback_mimeData(self: pointer, indexes: struct_seaqt_array): pointer {.cdecl.} =
  let vtbl = cast[ptr QConcatenateTablesProxyModelVTable](fcQConcatenateTablesProxyModel_vdata(self)[])
  let self = QConcatenateTablesProxyModel(h: self)
...
proc fcQConcatenateTablesProxyModel_vtable_callback_roleNames(self: pointer): struct_seaqt_map {.cdecl.} =
  let vtbl = cast[ptr QConcatenateTablesProxyModelVTable](fcQConcatenateTablesProxyModel_vdata(self)[])
  let self = QConcatenateTablesProxyModel(h: self)
...
proc fcQConcatenateTablesProxyModel_vtable_callback_match(self: pointer, start: pointer, role: cint, value: pointer, hits: cint, flags: cint): struct_seaqt_array {.cdecl.} =
  let vtbl = cast[ptr QConcatenateTablesProxyModelVTable](fcQConcatenateTablesProxyModel_vdata(self)[])
  let self = QConcatenateTablesProxyModel(h: self)
...
proc fcQConcatenateTablesProxyModel_method_callback_itemData(self: pointer, proxyIndex: pointer): struct_seaqt_map {.cdecl.} =
  let inst = cast[VirtualQConcatenateTablesProxyModel](fcQConcatenateTablesProxyModel_vdata(self)[])
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: proxyIndex, owned: false)
...
proc fcQConcatenateTablesProxyModel_method_callback_setItemData(self: pointer, index: pointer, roles: struct_seaqt_map): bool {.cdecl.} =
  let inst = cast[VirtualQConcatenateTablesProxyModel](fcQConcatenateTablesProxyModel_vdata(self)[])
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
  var vroles_mm = roles
  var vrolesx_ret: Table[cint, gen_qvariant_types.QVariant]
...
proc fcQConcatenateTablesProxyModel_method_callback_mimeTypes(self: pointer): struct_seaqt_array {.cdecl.} =
  let inst = cast[VirtualQConcatenateTablesProxyModel](fcQConcatenateTablesProxyModel_vdata(self)[])
...
proc fcQConcatenateTablesProxyModel_method_callback_mimeData(self: pointer, indexes: struct_seaqt_array): pointer {.cdecl.} =
  let inst = cast[VirtualQConcatenateTablesProxyModel](fcQConcatenateTablesProxyModel_vdata(self)[])
  var vindexes_ma = indexes
  var vindexesx_ret = newSeq[gen_qabstractitemmodel_types.QModelIndex](int(vindexes_ma.len))
  let vindexes_outCast = cast[ptr UncheckedArray[pointer]](vindexes_ma.data)
...
proc fcQConcatenateTablesProxyModel_method_callback_roleNames(self: pointer): struct_seaqt_map {.cdecl.} =
  let inst = cast[VirtualQConcatenateTablesProxyModel](fcQConcatenateTablesProxyModel_vdata(self)[])
...
proc fcQConcatenateTablesProxyModel_method_callback_match(self: pointer, start: pointer, role: cint, value: pointer, hits: cint, flags: cint): struct_seaqt_array {.cdecl.} =
  let inst = cast[VirtualQConcatenateTablesProxyModel](fcQConcatenateTablesProxyModel_vdata(self)[])
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: start, owned: false)
  let slotval2 = role
  let slotval3 = gen_qvariant_types.QVariant(h: value, owned: false)
...
proc encodeData*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, indexes: openArray[gen_qabstractitemmodel_types.QModelIndex], stream: gen_qdatastream_types.QDataStream): void =
  ...
  fcQConcatenateTablesProxyModel_protectedbase_encodeData(self.h, struct_seaqt_array(len: csize_t(len(indexes)), data: if len(indexes) == 0: nil else: addr(indexes_CArray[0])), stream.h)
...
proc changePersistentIndexList*(self: gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel, fromVal: openArray[gen_qabstractitemmodel_types.QModelIndex], to: openArray[gen_qabstractitemmodel_types.QModelIndex]): void =
  ...
  fcQConcatenateTablesProxyModel_protectedbase_changePersistentIndexList(self.h, struct_seaqt_array(len: csize_t(len(fromVal)), data: if len(fromVal) == 0: nil else: addr(fromVal_CArray[0])), struct_seaqt_array(len: csize_t(len(to)), data: if len(to) == 0: nil else: addr(to_CArray[0])))
...
proc create*(T: type gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel,
  ...
  let tmp = gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel(h: fcQConcatenateTablesProxyModel_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQConcatenateTablesProxyModel_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQConcatenateTablesProxyModel_vtable_callback_disconnectNotify
  let tmp = gen_qconcatenatetablesproxymodel_types.QConcatenateTablesProxyModel(h: fcQConcatenateTablesProxyModel_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQConcatenateTablesProxyModel_vdata(tmp.h)[] = addr(vtbl[])
  tmp
