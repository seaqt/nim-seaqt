...
proc fcQFileDevice_trUtf8(s: cstring): struct_seaqt_string {.importc: "QFileDevice_trUtf8".}
...
proc fcQFileDevice_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QFileDevice_trUtf82".}
proc fcQFileDevice_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QFileDevice_trUtf83".}
