...
proc create*(T: type gen_qflags_types.QFlag,
  ...
  let tmp = gen_qflags_types.QFlag(h: fcQFlag_new(value), owned: true)
  tmp
proc create*(T: type gen_qflags_types.QFlag,
    value: cuint): gen_qflags_types.QFlag =
  let tmp = gen_qflags_types.QFlag(h: fcQFlag_new2(value), owned: true)
  tmp
proc create*(T: type gen_qflags_types.QFlag,
    value: cshort): gen_qflags_types.QFlag =
  let tmp = gen_qflags_types.QFlag(h: fcQFlag_new3(value), owned: true)
  tmp
proc create*(T: type gen_qflags_types.QFlag,
    value: cushort): gen_qflags_types.QFlag =
  let tmp = gen_qflags_types.QFlag(h: fcQFlag_new4(value), owned: true)
  tmp
...
proc create*(T: type gen_qflags_types.QIncompatibleFlag,
  ...
  let tmp = gen_qflags_types.QIncompatibleFlag(h: fcQIncompatibleFlag_new(i), owned: true)
  tmp
proc create*(T: type gen_qflags_types.QIncompatibleFlag,
    param1: gen_qflags_types.QIncompatibleFlag): gen_qflags_types.QIncompatibleFlag =
  let tmp = gen_qflags_types.QIncompatibleFlag(h: fcQIncompatibleFlag_new2(param1.h), owned: true)
  tmp
