...
proc fcQAbstractEventDispatcher_trUtf8S(s: cstring): struct_seaqt_string {.importc: "QAbstractEventDispatcher_trUtf8_s".}
...
proc fcQAbstractEventDispatcher_registerTimerIntervalTimerTypeObject(self: pointer, interval: cint, timerType: cint, objectVal: pointer): cint {.importc: "QAbstractEventDispatcher_registerTimer_interval_timerType_object".}
proc fcQAbstractEventDispatcher_registerTimerTimerIdIntervalTimerTypeObject(self: pointer, timerId: cint, interval: cint, timerType: cint, objectVal: pointer): void {.importc: "QAbstractEventDispatcher_registerTimer_timerId_interval_timerType_object".}
...
proc fcQAbstractEventDispatcher_filterNativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.importc: "QAbstractEventDispatcher_filterNativeEvent".}
...
proc fcQAbstractEventDispatcher_trUtf8SC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QAbstractEventDispatcher_trUtf8_s_c".}
proc fcQAbstractEventDispatcher_trUtf8SCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QAbstractEventDispatcher_trUtf8_s_c_n".}
...
proc trUtf8*(_: type gen_qabstracteventdispatcher_types.QAbstractEventDispatcher, s: cstring): string =
  let v_ms = fcQAbstractEventDispatcher_trUtf8S(s)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc filterNativeEvent*(self: gen_qabstracteventdispatcher_types.QAbstractEventDispatcher, eventType: openArray[byte], message: pointer, resultVal: ptr clong): bool =
