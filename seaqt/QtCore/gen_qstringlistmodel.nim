...
proc cQStringListModel_vtable_callback_clearItemData(self: pointer, index: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QStringListModelVTable](fcQStringListModel_vdata(self))
  let self = QStringListModel(h: self)
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
...
proc cQStringListModel_vtable_callback_multiData(self: pointer, index: pointer, roleDataSpan: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QStringListModelVTable](fcQStringListModel_vdata(self))
  let self = QStringListModel(h: self)
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
...
proc cQStringListModel_vtable_callback_resetInternalData(self: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QStringListModelVTable](fcQStringListModel_vdata(self))
  let self = QStringListModel(h: self)
...
proc cQStringListModel_method_callback_clearItemData(self: pointer, index: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQStringListModel](fcQStringListModel_vdata(self))
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
...
proc cQStringListModel_method_callback_multiData(self: pointer, index: pointer, roleDataSpan: pointer): void {.cdecl.} =
  let inst = cast[VirtualQStringListModel](fcQStringListModel_vdata(self))
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
  let slotval2 = gen_qabstractitemmodel_types.QModelRoleDataSpan(h: roleDataSpan, owned: true)
...
proc cQStringListModel_method_callback_resetInternalData(self: pointer): void {.cdecl.} =
  let inst = cast[VirtualQStringListModel](fcQStringListModel_vdata(self))
...
proc create*(T: type gen_qstringlistmodel_types.QStringListModel,
  ...
  if not isNil(vtbl[].clearItemData):
    vtbl[].vtbl.clearItemData = cQStringListModel_vtable_callback_clearItemData
  ...
  if not isNil(vtbl[].multiData):
    vtbl[].vtbl.multiData = cQStringListModel_vtable_callback_multiData
  ...
  if not isNil(vtbl[].resetInternalData):
    vtbl[].vtbl.resetInternalData = cQStringListModel_vtable_callback_resetInternalData
...
const cQStringListModel_mvtbl = cQStringListModelVTable(
  ...
  clearItemData: cQStringListModel_method_callback_clearItemData,
  ...
  multiData: cQStringListModel_method_callback_multiData,
  submit: cQStringListModel_method_callback_submit,
  revert: cQStringListModel_method_callback_revert,
  resetInternalData: cQStringListModel_method_callback_resetInternalData,
