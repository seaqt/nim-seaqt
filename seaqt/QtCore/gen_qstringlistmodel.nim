...
proc fcQStringListModel_trUtf8(s: cstring): struct_seaqt_string {.importc: "QStringListModel_trUtf8".}
...
proc fcQStringListModel_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QStringListModel_trUtf82".}
proc fcQStringListModel_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QStringListModel_trUtf83".}
