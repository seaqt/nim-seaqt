...
proc QStringListModelmimeData*(self: gen_qstringlistmodel_types.QStringListModel, indexes: openArray[gen_qabstractitemmodel_types.QModelIndex]): gen_qmimedata_types.QMimeData =
  ...
  gen_qmimedata_types.QMimeData(h: fcQStringListModel_virtualbase_mimeData(self.h, struct_seaqt_array(len: csize_t(len(indexes)), data: if len(indexes) == 0: nil else: addr(indexes_CArray[0]))))
...
proc create*(T: type gen_qstringlistmodel_types.QStringListModel,
  ...
  let tmp = gen_qstringlistmodel_types.QStringListModel(h: fcQStringListModel_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))))
...
proc create*(T: type gen_qstringlistmodel_types.QStringListModel,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQStringListModel_vtable_callback_disconnectNotify
  let tmp = gen_qstringlistmodel_types.QStringListModel(h: fcQStringListModel_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_seaqt_array(len: csize_t(len(strings)), data: if len(strings) == 0: nil else: addr(strings_CArray[0]))))
  fcQStringListModel_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qstringlistmodel_types.QStringListModel,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQStringListModel_vtable_callback_disconnectNotify
  let tmp = gen_qstringlistmodel_types.QStringListModel(h: fcQStringListModel_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h))
  fcQStringListModel_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qstringlistmodel_types.QStringListModel,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQStringListModel_vtable_callback_disconnectNotify
  let tmp = gen_qstringlistmodel_types.QStringListModel(h: fcQStringListModel_new4(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_seaqt_array(len: csize_t(len(strings)), data: if len(strings) == 0: nil else: addr(strings_CArray[0])), parent.h))
  fcQStringListModel_vdata(tmp.h)[] = addr(vtbl[])
  tmp
