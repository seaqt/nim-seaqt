...
proc miqt_exec_method_cQStringListModel_clearItemData(vtbl: pointer, inst: pointer, index: pointer): bool {.cdecl.} =
  let vtbl = cast[VirtualQStringListModel](cast[uint](vtbl) - uint(offsetOf(VirtualQStringListModel, vtbl)))
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
...
proc miqt_exec_method_cQStringListModel_multiData(vtbl: pointer, inst: pointer, index: pointer, roleDataSpan: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQStringListModel](cast[uint](vtbl) - uint(offsetOf(VirtualQStringListModel, vtbl)))
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
  let slotval2 = gen_qabstractitemmodel_types.QModelRoleDataSpan(h: roleDataSpan, owned: true)
...
proc miqt_exec_method_cQStringListModel_resetInternalData(vtbl: pointer, inst: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQStringListModel](cast[uint](vtbl) - uint(offsetOf(VirtualQStringListModel, vtbl)))
...
proc create*(T: type gen_qstringlistmodel_types.QStringListModel,
  ...
  vtbl[].vtbl.clearItemData = miqt_exec_method_cQStringListModel_clearItemData
  ...
  vtbl[].vtbl.multiData = miqt_exec_method_cQStringListModel_multiData
  vtbl[].vtbl.submit = miqt_exec_method_cQStringListModel_submit
  vtbl[].vtbl.revert = miqt_exec_method_cQStringListModel_revert
  vtbl[].vtbl.resetInternalData = miqt_exec_method_cQStringListModel_resetInternalData
