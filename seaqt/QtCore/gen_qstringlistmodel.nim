...
proc fcQStringListModel_new2(vtbl: pointer, vdata: csize_t, strings: struct_miqt_array): ptr cQStringListModel {.importc: "QStringListModel_new2".}
...
proc fcQStringListModel_new4(vtbl: pointer, vdata: csize_t, strings: struct_miqt_array, parent: pointer): ptr cQStringListModel {.importc: "QStringListModel_new4".}
...
proc create*(T: type gen_qstringlistmodel_types.QStringListModel,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQStringListModel_vtable_callback_disconnectNotify
  let tmp = gen_qstringlistmodel_types.QStringListModel(h: fcQStringListModel_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_miqt_array(len: csize_t(len(strings)), data: if len(strings) == 0: nil else: addr(strings_CArray[0]))), owned: true)
  fcQStringListModel_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qstringlistmodel_types.QStringListModel,
...
proc create*(T: type gen_qstringlistmodel_types.QStringListModel,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQStringListModel_vtable_callback_disconnectNotify
  let tmp = gen_qstringlistmodel_types.QStringListModel(h: fcQStringListModel_new4(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_miqt_array(len: csize_t(len(strings)), data: if len(strings) == 0: nil else: addr(strings_CArray[0])), parent.h), owned: true)
  fcQStringListModel_vdata(tmp.h)[] = addr(vtbl[])
  tmp
