...
proc fcQStringListModel_trUtf8S(s: cstring): struct_seaqt_string {.importc: "QStringListModel_trUtf8_s".}
...
proc fcQStringListModel_itemData(self: pointer, index: pointer): struct_seaqt_map {.importc: "QStringListModel_itemData".}
proc fcQStringListModel_setItemData(self: pointer, index: pointer, roles: struct_seaqt_map): bool {.importc: "QStringListModel_setItemData".}
...
proc fcQStringListModel_trUtf8SC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QStringListModel_trUtf8_s_c".}
proc fcQStringListModel_trUtf8SCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QStringListModel_trUtf8_s_c_n".}
...
proc fcQStringListModel_virtualbase_itemData(self: pointer, index: pointer): struct_seaqt_map {.importc: "QStringListModel_virtualbase_itemData".}
proc fcQStringListModel_virtualbase_setItemData(self: pointer, index: pointer, roles: struct_seaqt_map): bool {.importc: "QStringListModel_virtualbase_setItemData".}
...
proc fcQStringListModel_virtualbase_mimeTypes(self: pointer): struct_seaqt_array {.importc: "QStringListModel_virtualbase_mimeTypes".}
proc fcQStringListModel_virtualbase_mimeData(self: pointer, indexes: struct_seaqt_array): pointer {.importc: "QStringListModel_virtualbase_mimeData".}
...
proc fcQStringListModel_virtualbase_match(self: pointer, start: pointer, role: cint, value: pointer, hits: cint, flags: cint): struct_seaqt_array {.importc: "QStringListModel_virtualbase_match".}
proc fcQStringListModel_virtualbase_span(self: pointer, index: pointer): pointer {.importc: "QStringListModel_virtualbase_span".}
proc fcQStringListModel_virtualbase_roleNames(self: pointer): struct_seaqt_map {.importc: "QStringListModel_virtualbase_roleNames".}
...
proc fcQStringListModel_protectedbase_changePersistentIndexList(self: pointer, fromVal: struct_seaqt_array, to: struct_seaqt_array): void {.importc: "QStringListModel_protectedbase_changePersistentIndexList".}
proc fcQStringListModel_protectedbase_persistentIndexList(self: pointer): struct_seaqt_array {.importc: "QStringListModel_protectedbase_persistentIndexList".}
...
proc trUtf8*(_: type gen_qstringlistmodel_types.QStringListModel, s: cstring): string =
  let v_ms = fcQStringListModel_trUtf8S(s)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc setItemData*(self: gen_qstringlistmodel_types.QStringListModel, index: gen_qabstractitemmodel_types.QModelIndex, roles: Table[cint,gen_qvariant_types.QVariant]): bool =
  ...
  fcQStringListModel_setItemData(self.h, index.h, struct_seaqt_map(len: csize_t(len(roles)),keys: if len(roles) == 0: nil else: addr(roles_Keys_CArray[0]), values: if len(roles) == 0: nil else: addr(roles_Values_CArray[0]),))
...
proc setStringList*(self: gen_qstringlistmodel_types.QStringListModel, strings: openArray[string]): void =
  ...
  fcQStringListModel_setStringList(self.h, struct_seaqt_array(len: csize_t(len(strings)), data: if len(strings) == 0: nil else: addr(strings_CArray[0])))
...
proc QStringListModelsetItemData*(self: gen_qstringlistmodel_types.QStringListModel, index: gen_qabstractitemmodel_types.QModelIndex, roles: Table[cint,gen_qvariant_types.QVariant]): bool =
  ...
  fcQStringListModel_virtualbase_setItemData(self.h, index.h, struct_seaqt_map(len: csize_t(len(roles)),keys: if len(roles) == 0: nil else: addr(roles_Keys_CArray[0]), values: if len(roles) == 0: nil else: addr(roles_Values_CArray[0]),))
...
proc QStringListModelmimeData*(self: gen_qstringlistmodel_types.QStringListModel, indexes: openArray[gen_qabstractitemmodel_types.QModelIndex]): gen_qmimedata_types.QMimeData =
  ...
  gen_qmimedata_types.QMimeData(h: fcQStringListModel_virtualbase_mimeData(self.h, struct_seaqt_array(len: csize_t(len(indexes)), data: if len(indexes) == 0: nil else: addr(indexes_CArray[0]))), owned: false)
...
proc fcQStringListModel_vtable_callback_itemData(self: pointer, index: pointer): struct_seaqt_map {.cdecl.} =
  let vtbl = cast[ptr QStringListModelVTable](fcQStringListModel_vdata(self)[])
  let self = QStringListModel(h: self)
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
...
proc fcQStringListModel_vtable_callback_setItemData(self: pointer, index: pointer, roles: struct_seaqt_map): bool {.cdecl.} =
  let vtbl = cast[ptr QStringListModelVTable](fcQStringListModel_vdata(self)[])
  let self = QStringListModel(h: self)
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
  var vroles_mm = roles
...
proc fcQStringListModel_vtable_callback_mimeTypes(self: pointer): struct_seaqt_array {.cdecl.} =
  let vtbl = cast[ptr QStringListModelVTable](fcQStringListModel_vdata(self)[])
  let self = QStringListModel(h: self)
...
proc fcQStringListModel_vtable_callback_mimeData(self: pointer, indexes: struct_seaqt_array): pointer {.cdecl.} =
  let vtbl = cast[ptr QStringListModelVTable](fcQStringListModel_vdata(self)[])
  let self = QStringListModel(h: self)
...
proc fcQStringListModel_vtable_callback_match(self: pointer, start: pointer, role: cint, value: pointer, hits: cint, flags: cint): struct_seaqt_array {.cdecl.} =
  let vtbl = cast[ptr QStringListModelVTable](fcQStringListModel_vdata(self)[])
  let self = QStringListModel(h: self)
...
proc fcQStringListModel_vtable_callback_roleNames(self: pointer): struct_seaqt_map {.cdecl.} =
  let vtbl = cast[ptr QStringListModelVTable](fcQStringListModel_vdata(self)[])
  let self = QStringListModel(h: self)
...
proc fcQStringListModel_method_callback_itemData(self: pointer, index: pointer): struct_seaqt_map {.cdecl.} =
  let inst = cast[VirtualQStringListModel](fcQStringListModel_vdata(self)[])
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
...
proc fcQStringListModel_method_callback_setItemData(self: pointer, index: pointer, roles: struct_seaqt_map): bool {.cdecl.} =
  let inst = cast[VirtualQStringListModel](fcQStringListModel_vdata(self)[])
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
  var vroles_mm = roles
  var vrolesx_ret: Table[cint, gen_qvariant_types.QVariant]
...
proc fcQStringListModel_method_callback_mimeTypes(self: pointer): struct_seaqt_array {.cdecl.} =
  let inst = cast[VirtualQStringListModel](fcQStringListModel_vdata(self)[])
...
proc fcQStringListModel_method_callback_mimeData(self: pointer, indexes: struct_seaqt_array): pointer {.cdecl.} =
  let inst = cast[VirtualQStringListModel](fcQStringListModel_vdata(self)[])
  var vindexes_ma = indexes
  var vindexesx_ret = newSeq[gen_qabstractitemmodel_types.QModelIndex](int(vindexes_ma.len))
  let vindexes_outCast = cast[ptr UncheckedArray[pointer]](vindexes_ma.data)
...
proc fcQStringListModel_method_callback_match(self: pointer, start: pointer, role: cint, value: pointer, hits: cint, flags: cint): struct_seaqt_array {.cdecl.} =
  let inst = cast[VirtualQStringListModel](fcQStringListModel_vdata(self)[])
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: start, owned: false)
  let slotval2 = role
  let slotval3 = gen_qvariant_types.QVariant(h: value, owned: false)
...
proc fcQStringListModel_method_callback_roleNames(self: pointer): struct_seaqt_map {.cdecl.} =
  let inst = cast[VirtualQStringListModel](fcQStringListModel_vdata(self)[])
...
proc encodeData*(self: gen_qstringlistmodel_types.QStringListModel, indexes: openArray[gen_qabstractitemmodel_types.QModelIndex], stream: gen_qdatastream_types.QDataStream): void =
  ...
  fcQStringListModel_protectedbase_encodeData(self.h, struct_seaqt_array(len: csize_t(len(indexes)), data: if len(indexes) == 0: nil else: addr(indexes_CArray[0])), stream.h)
...
proc changePersistentIndexList*(self: gen_qstringlistmodel_types.QStringListModel, fromVal: openArray[gen_qabstractitemmodel_types.QModelIndex], to: openArray[gen_qabstractitemmodel_types.QModelIndex]): void =
  ...
  fcQStringListModel_protectedbase_changePersistentIndexList(self.h, struct_seaqt_array(len: csize_t(len(fromVal)), data: if len(fromVal) == 0: nil else: addr(fromVal_CArray[0])), struct_seaqt_array(len: csize_t(len(to)), data: if len(to) == 0: nil else: addr(to_CArray[0])))
...
proc create*(T: type gen_qstringlistmodel_types.QStringListModel,
  ...
  let tmp = gen_qstringlistmodel_types.QStringListModel(h: fcQStringListModel_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
...
proc create*(T: type gen_qstringlistmodel_types.QStringListModel,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQStringListModel_vtable_callback_disconnectNotify
  let tmp = gen_qstringlistmodel_types.QStringListModel(h: fcQStringListModel_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_seaqt_array(len: csize_t(len(strings)), data: if len(strings) == 0: nil else: addr(strings_CArray[0]))), owned: true)
  fcQStringListModel_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qstringlistmodel_types.QStringListModel,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQStringListModel_vtable_callback_disconnectNotify
  let tmp = gen_qstringlistmodel_types.QStringListModel(h: fcQStringListModel_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQStringListModel_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qstringlistmodel_types.QStringListModel,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQStringListModel_vtable_callback_disconnectNotify
  let tmp = gen_qstringlistmodel_types.QStringListModel(h: fcQStringListModel_new4(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_seaqt_array(len: csize_t(len(strings)), data: if len(strings) == 0: nil else: addr(strings_CArray[0])), parent.h), owned: true)
  fcQStringListModel_vdata(tmp.h)[] = addr(vtbl[])
  tmp
...
proc create*(T: type gen_qstringlistmodel_types.QStringListModel,
  ...
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQStringListModel_new2(addr(cQStringListModel_mvtbl), csize_t(sizeof(pointer)), struct_seaqt_array(len: csize_t(len(strings)), data: if len(strings) == 0: nil else: addr(strings_CArray[0])))
  fcQStringListModel_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qstringlistmodel_types.QStringListModel,
  ...
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQStringListModel_new4(addr(cQStringListModel_mvtbl), csize_t(sizeof(pointer)), struct_seaqt_array(len: csize_t(len(strings)), data: if len(strings) == 0: nil else: addr(strings_CArray[0])), parent.h)
  fcQStringListModel_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
