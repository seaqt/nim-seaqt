...
proc fcQCborValue_toStringView(self: pointer): struct_seaqt_string {.importc: "QCborValue_toStringView".}
...
proc fcQCborValue_toStringViewDefaultValue(self: pointer, defaultValue: struct_seaqt_string): struct_seaqt_string {.importc: "QCborValue_toStringView_defaultValue".}
...
proc fcQCborValueConstRef_toStringView(self: pointer): struct_seaqt_string {.importc: "QCborValueConstRef_toStringView".}
...
proc fcQCborValueConstRef_toStringViewDefaultValue(self: pointer, defaultValue: struct_seaqt_string): struct_seaqt_string {.importc: "QCborValueConstRef_toStringView_defaultValue".}
...
proc toStringView*(self: gen_qcborvalue_types.QCborValue): string =
  let v_ms = fcQCborValue_toStringView(self.h)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc toStringView*(self: gen_qcborvalue_types.QCborValue, defaultValue: openArray[char]): string =
  let v_ms = fcQCborValue_toStringViewDefaultValue(self.h, struct_seaqt_string(data: if len(defaultValue) > 0: addr defaultValue[0] else: nil, len: csize_t(len(defaultValue))))
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc toStringView*(self: gen_qcborvalue_types.QCborValueConstRef): string =
  let v_ms = fcQCborValueConstRef_toStringView(self.h)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc toStringView*(self: gen_qcborvalue_types.QCborValueConstRef, defaultValue: openArray[char]): string =
  let v_ms = fcQCborValueConstRef_toStringViewDefaultValue(self.h, struct_seaqt_string(data: if len(defaultValue) > 0: addr defaultValue[0] else: nil, len: csize_t(len(defaultValue))))
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
