...
{.compile("gen_qsavefile.cpp", QtCoreCFlags).}
...
proc fcQSaveFile_virtualbase_fileName(self: pointer): struct_seaqt_string {.importc: "QSaveFile_virtualbase_fileName".}
...
proc fcQSaveFile_protectedbase_setErrorString(self: pointer, errorString: struct_seaqt_string): void {.importc: "QSaveFile_protectedbase_setErrorString".}
...
proc fcQSaveFile_new(vtbl: pointer, vdata: csize_t): ptr cQSaveFile {.importc: "QSaveFile_new".}
proc fcQSaveFile_new2(vtbl: pointer, vdata: csize_t, name: struct_seaqt_string): ptr cQSaveFile {.importc: "QSaveFile_new_name".}
proc fcQSaveFile_new3(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQSaveFile {.importc: "QSaveFile_new_parent".}
proc fcQSaveFile_new4(vtbl: pointer, vdata: csize_t, name: struct_seaqt_string, parent: pointer): ptr cQSaveFile {.importc: "QSaveFile_new_name_parent".}
...
proc setFileName*(self: gen_qsavefile_types.QSaveFile, name: openArray[char]): void =
  fcQSaveFile_setFileName(self.h, struct_seaqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name))))
...
proc fcQSaveFile_vtable_callback_metacast(self: pointer, param1: cstring): pointer {.cdecl.} =
  let vtbl = cast[ptr QSaveFileVTable](fcQSaveFile_vdata(self)[])
  let self = QSaveFile(h: self)
  let slotval1 = (param1)
...
proc fcQSaveFile_vtable_callback_metacall(self: pointer, param1: cint, param2: cint, param3: pointer): cint {.cdecl.} =
  let vtbl = cast[ptr QSaveFileVTable](fcQSaveFile_vdata(self)[])
  let self = QSaveFile(h: self)
...
proc fcQSaveFile_vtable_callback_fileName(self: pointer): struct_seaqt_string {.cdecl.} =
  let vtbl = cast[ptr QSaveFileVTable](fcQSaveFile_vdata(self)[])
  let self = QSaveFile(h: self)
...
proc fcQSaveFile_vtable_callback_open(self: pointer, flags: cint): bool {.cdecl.} =
  let vtbl = cast[ptr QSaveFileVTable](fcQSaveFile_vdata(self)[])
  let self = QSaveFile(h: self)
...
proc fcQSaveFile_vtable_callback_writeData(self: pointer, data: cstring, len: clonglong): clonglong {.cdecl.} =
  let vtbl = cast[ptr QSaveFileVTable](fcQSaveFile_vdata(self)[])
  let self = QSaveFile(h: self)
  let slotval1 = (data)
  let slotval2 = len
...
proc fcQSaveFile_vtable_callback_isSequential(self: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QSaveFileVTable](fcQSaveFile_vdata(self)[])
  let self = QSaveFile(h: self)
  var virtualReturn = vtbl[].isSequential(self)
  virtualReturn

proc fcQSaveFile_vtable_callback_pos(self: pointer): clonglong {.cdecl.} =
  let vtbl = cast[ptr QSaveFileVTable](fcQSaveFile_vdata(self)[])
  let self = QSaveFile(h: self)
  var virtualReturn = vtbl[].pos(self)
  virtualReturn

proc fcQSaveFile_vtable_callback_seek(self: pointer, offset: clonglong): bool {.cdecl.} =
  let vtbl = cast[ptr QSaveFileVTable](fcQSaveFile_vdata(self)[])
  let self = QSaveFile(h: self)
  let slotval1 = offset
...
proc fcQSaveFile_vtable_callback_atEnd(self: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QSaveFileVTable](fcQSaveFile_vdata(self)[])
  let self = QSaveFile(h: self)
  var virtualReturn = vtbl[].atEnd(self)
  virtualReturn

proc fcQSaveFile_vtable_callback_size(self: pointer): clonglong {.cdecl.} =
  let vtbl = cast[ptr QSaveFileVTable](fcQSaveFile_vdata(self)[])
  let self = QSaveFile(h: self)
  var virtualReturn = vtbl[].size(self)
  virtualReturn

proc fcQSaveFile_vtable_callback_resize(self: pointer, sz: clonglong): bool {.cdecl.} =
  let vtbl = cast[ptr QSaveFileVTable](fcQSaveFile_vdata(self)[])
  let self = QSaveFile(h: self)
  let slotval1 = sz
...
proc fcQSaveFile_vtable_callback_permissions(self: pointer): cint {.cdecl.} =
  let vtbl = cast[ptr QSaveFileVTable](fcQSaveFile_vdata(self)[])
  let self = QSaveFile(h: self)
  var virtualReturn = vtbl[].permissions(self)
  cint(virtualReturn)

proc fcQSaveFile_vtable_callback_setPermissions(self: pointer, permissionSpec: cint): bool {.cdecl.} =
  let vtbl = cast[ptr QSaveFileVTable](fcQSaveFile_vdata(self)[])
  let self = QSaveFile(h: self)
...
proc fcQSaveFile_vtable_callback_readData(self: pointer, data: cstring, maxlen: clonglong): clonglong {.cdecl.} =
  let vtbl = cast[ptr QSaveFileVTable](fcQSaveFile_vdata(self)[])
  let self = QSaveFile(h: self)
  let slotval1 = (data)
  let slotval2 = maxlen
...
proc fcQSaveFile_vtable_callback_readLineData(self: pointer, data: cstring, maxlen: clonglong): clonglong {.cdecl.} =
  let vtbl = cast[ptr QSaveFileVTable](fcQSaveFile_vdata(self)[])
  let self = QSaveFile(h: self)
  let slotval1 = (data)
  let slotval2 = maxlen
...
proc fcQSaveFile_vtable_callback_reset(self: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QSaveFileVTable](fcQSaveFile_vdata(self)[])
  let self = QSaveFile(h: self)
  var virtualReturn = vtbl[].reset(self)
  virtualReturn

proc fcQSaveFile_vtable_callback_bytesAvailable(self: pointer): clonglong {.cdecl.} =
  let vtbl = cast[ptr QSaveFileVTable](fcQSaveFile_vdata(self)[])
  let self = QSaveFile(h: self)
  var virtualReturn = vtbl[].bytesAvailable(self)
  virtualReturn

proc fcQSaveFile_vtable_callback_bytesToWrite(self: pointer): clonglong {.cdecl.} =
  let vtbl = cast[ptr QSaveFileVTable](fcQSaveFile_vdata(self)[])
  let self = QSaveFile(h: self)
  var virtualReturn = vtbl[].bytesToWrite(self)
  virtualReturn

proc fcQSaveFile_vtable_callback_canReadLine(self: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QSaveFileVTable](fcQSaveFile_vdata(self)[])
  let self = QSaveFile(h: self)
  var virtualReturn = vtbl[].canReadLine(self)
  virtualReturn

proc fcQSaveFile_vtable_callback_waitForReadyRead(self: pointer, msecs: cint): bool {.cdecl.} =
  let vtbl = cast[ptr QSaveFileVTable](fcQSaveFile_vdata(self)[])
  let self = QSaveFile(h: self)
  let slotval1 = msecs
...
proc fcQSaveFile_vtable_callback_waitForBytesWritten(self: pointer, msecs: cint): bool {.cdecl.} =
  let vtbl = cast[ptr QSaveFileVTable](fcQSaveFile_vdata(self)[])
  let self = QSaveFile(h: self)
  let slotval1 = msecs
...
proc fcQSaveFile_vtable_callback_skipData(self: pointer, maxSize: clonglong): clonglong {.cdecl.} =
  let vtbl = cast[ptr QSaveFileVTable](fcQSaveFile_vdata(self)[])
  let self = QSaveFile(h: self)
...
method skipData*(self: VirtualQSaveFile, maxSize: clonglong): clonglong {.base.} =
  QSaveFileskipData(self[], maxSize)
...
proc fcQSaveFile_method_callback_metacall(self: pointer, param1: cint, param2: cint, param3: pointer): cint {.cdecl.} =
  let inst = cast[VirtualQSaveFile](fcQSaveFile_vdata(self)[])
  let slotval1 = cint(param1)
  let slotval2 = param2
  let slotval3 = param3
...
proc fcQSaveFile_method_callback_fileName(self: pointer): struct_seaqt_string {.cdecl.} =
  let inst = cast[VirtualQSaveFile](fcQSaveFile_vdata(self)[])
...
proc fcQSaveFile_method_callback_writeData(self: pointer, data: cstring, len: clonglong): clonglong {.cdecl.} =
  let inst = cast[VirtualQSaveFile](fcQSaveFile_vdata(self)[])
  let slotval1 = (data)
  let slotval2 = len
...
proc fcQSaveFile_method_callback_isSequential(self: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQSaveFile](fcQSaveFile_vdata(self)[])
  var virtualReturn = inst.isSequential()
  virtualReturn

proc fcQSaveFile_method_callback_pos(self: pointer): clonglong {.cdecl.} =
  let inst = cast[VirtualQSaveFile](fcQSaveFile_vdata(self)[])
  var virtualReturn = inst.pos()
  virtualReturn

proc fcQSaveFile_method_callback_seek(self: pointer, offset: clonglong): bool {.cdecl.} =
  let inst = cast[VirtualQSaveFile](fcQSaveFile_vdata(self)[])
  let slotval1 = offset
  var virtualReturn = inst.seek(slotval1)
  virtualReturn

proc fcQSaveFile_method_callback_atEnd(self: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQSaveFile](fcQSaveFile_vdata(self)[])
  var virtualReturn = inst.atEnd()
  virtualReturn

proc fcQSaveFile_method_callback_size(self: pointer): clonglong {.cdecl.} =
  let inst = cast[VirtualQSaveFile](fcQSaveFile_vdata(self)[])
  var virtualReturn = inst.size()
  virtualReturn

proc fcQSaveFile_method_callback_resize(self: pointer, sz: clonglong): bool {.cdecl.} =
  let inst = cast[VirtualQSaveFile](fcQSaveFile_vdata(self)[])
  let slotval1 = sz
  var virtualReturn = inst.resize(slotval1)
  virtualReturn

proc fcQSaveFile_method_callback_permissions(self: pointer): cint {.cdecl.} =
  let inst = cast[VirtualQSaveFile](fcQSaveFile_vdata(self)[])
  var virtualReturn = inst.permissions()
  cint(virtualReturn)

proc fcQSaveFile_method_callback_setPermissions(self: pointer, permissionSpec: cint): bool {.cdecl.} =
  let inst = cast[VirtualQSaveFile](fcQSaveFile_vdata(self)[])
  let slotval1 = cint(permissionSpec)
  var virtualReturn = inst.setPermissions(slotval1)
  virtualReturn

proc fcQSaveFile_method_callback_readData(self: pointer, data: cstring, maxlen: clonglong): clonglong {.cdecl.} =
  let inst = cast[VirtualQSaveFile](fcQSaveFile_vdata(self)[])
  let slotval1 = (data)
  let slotval2 = maxlen
...
proc fcQSaveFile_method_callback_readLineData(self: pointer, data: cstring, maxlen: clonglong): clonglong {.cdecl.} =
  let inst = cast[VirtualQSaveFile](fcQSaveFile_vdata(self)[])
  let slotval1 = (data)
  let slotval2 = maxlen
...
proc fcQSaveFile_method_callback_reset(self: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQSaveFile](fcQSaveFile_vdata(self)[])
  var virtualReturn = inst.reset()
  virtualReturn

proc fcQSaveFile_method_callback_bytesAvailable(self: pointer): clonglong {.cdecl.} =
  let inst = cast[VirtualQSaveFile](fcQSaveFile_vdata(self)[])
  var virtualReturn = inst.bytesAvailable()
  virtualReturn

proc fcQSaveFile_method_callback_bytesToWrite(self: pointer): clonglong {.cdecl.} =
  let inst = cast[VirtualQSaveFile](fcQSaveFile_vdata(self)[])
  var virtualReturn = inst.bytesToWrite()
  virtualReturn

proc fcQSaveFile_method_callback_canReadLine(self: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQSaveFile](fcQSaveFile_vdata(self)[])
  var virtualReturn = inst.canReadLine()
  virtualReturn

proc fcQSaveFile_method_callback_waitForReadyRead(self: pointer, msecs: cint): bool {.cdecl.} =
  let inst = cast[VirtualQSaveFile](fcQSaveFile_vdata(self)[])
  let slotval1 = msecs
  var virtualReturn = inst.waitForReadyRead(slotval1)
  virtualReturn

proc fcQSaveFile_method_callback_waitForBytesWritten(self: pointer, msecs: cint): bool {.cdecl.} =
  let inst = cast[VirtualQSaveFile](fcQSaveFile_vdata(self)[])
  let slotval1 = msecs
  var virtualReturn = inst.waitForBytesWritten(slotval1)
  virtualReturn

proc fcQSaveFile_method_callback_skipData(self: pointer, maxSize: clonglong): clonglong {.cdecl.} =
  let inst = cast[VirtualQSaveFile](fcQSaveFile_vdata(self)[])
  let slotval1 = maxSize
...
proc setErrorString*(self: gen_qsavefile_types.QSaveFile, errorString: openArray[char]): void =
  fcQSaveFile_protectedbase_setErrorString(self.h, struct_seaqt_string(data: if len(errorString) > 0: addr errorString[0] else: nil, len: csize_t(len(errorString))))
...
proc create*(T: type gen_qsavefile_types.QSaveFile,
  ...
  if not isNil(vtbl[].metaObject):
    vtbl[].vtbl.metaObject = fcQSaveFile_vtable_callback_metaObject
  if not isNil(vtbl[].metacast):
    vtbl[].vtbl.metacast = fcQSaveFile_vtable_callback_metacast
  if not isNil(vtbl[].metacall):
    vtbl[].vtbl.metacall = fcQSaveFile_vtable_callback_metacall
  if not isNil(vtbl[].fileName):
    vtbl[].vtbl.fileName = fcQSaveFile_vtable_callback_fileName
  if not isNil(vtbl[].open):
    vtbl[].vtbl.open = fcQSaveFile_vtable_callback_open
  if not isNil(vtbl[].writeData):
    vtbl[].vtbl.writeData = fcQSaveFile_vtable_callback_writeData
  if not isNil(vtbl[].isSequential):
    vtbl[].vtbl.isSequential = fcQSaveFile_vtable_callback_isSequential
  if not isNil(vtbl[].pos):
    vtbl[].vtbl.pos = fcQSaveFile_vtable_callback_pos
  if not isNil(vtbl[].seek):
    vtbl[].vtbl.seek = fcQSaveFile_vtable_callback_seek
  if not isNil(vtbl[].atEnd):
    vtbl[].vtbl.atEnd = fcQSaveFile_vtable_callback_atEnd
  if not isNil(vtbl[].size):
    vtbl[].vtbl.size = fcQSaveFile_vtable_callback_size
  if not isNil(vtbl[].resize):
    vtbl[].vtbl.resize = fcQSaveFile_vtable_callback_resize
  if not isNil(vtbl[].permissions):
    vtbl[].vtbl.permissions = fcQSaveFile_vtable_callback_permissions
  if not isNil(vtbl[].setPermissions):
    vtbl[].vtbl.setPermissions = fcQSaveFile_vtable_callback_setPermissions
  if not isNil(vtbl[].readData):
    vtbl[].vtbl.readData = fcQSaveFile_vtable_callback_readData
  if not isNil(vtbl[].readLineData):
    vtbl[].vtbl.readLineData = fcQSaveFile_vtable_callback_readLineData
  if not isNil(vtbl[].reset):
    vtbl[].vtbl.reset = fcQSaveFile_vtable_callback_reset
  if not isNil(vtbl[].bytesAvailable):
    vtbl[].vtbl.bytesAvailable = fcQSaveFile_vtable_callback_bytesAvailable
  if not isNil(vtbl[].bytesToWrite):
    vtbl[].vtbl.bytesToWrite = fcQSaveFile_vtable_callback_bytesToWrite
  if not isNil(vtbl[].canReadLine):
    vtbl[].vtbl.canReadLine = fcQSaveFile_vtable_callback_canReadLine
  if not isNil(vtbl[].waitForReadyRead):
    vtbl[].vtbl.waitForReadyRead = fcQSaveFile_vtable_callback_waitForReadyRead
  if not isNil(vtbl[].waitForBytesWritten):
    vtbl[].vtbl.waitForBytesWritten = fcQSaveFile_vtable_callback_waitForBytesWritten
  if not isNil(vtbl[].skipData):
    vtbl[].vtbl.skipData = fcQSaveFile_vtable_callback_skipData
  if not isNil(vtbl[].event):
    vtbl[].vtbl.event = fcQSaveFile_vtable_callback_event
  if not isNil(vtbl[].eventFilter):
    vtbl[].vtbl.eventFilter = fcQSaveFile_vtable_callback_eventFilter
  if not isNil(vtbl[].timerEvent):
    vtbl[].vtbl.timerEvent = fcQSaveFile_vtable_callback_timerEvent
  if not isNil(vtbl[].childEvent):
    vtbl[].vtbl.childEvent = fcQSaveFile_vtable_callback_childEvent
  if not isNil(vtbl[].customEvent):
    vtbl[].vtbl.customEvent = fcQSaveFile_vtable_callback_customEvent
  ...
  let tmp = gen_qsavefile_types.QSaveFile(h: fcQSaveFile_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
...
proc create*(T: type gen_qsavefile_types.QSaveFile,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQSaveFile_vtable_callback_disconnectNotify
  let tmp = gen_qsavefile_types.QSaveFile(h: fcQSaveFile_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name)))), owned: true)
  fcQSaveFile_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qsavefile_types.QSaveFile,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQSaveFile_vtable_callback_disconnectNotify
  let tmp = gen_qsavefile_types.QSaveFile(h: fcQSaveFile_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQSaveFile_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qsavefile_types.QSaveFile,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQSaveFile_vtable_callback_disconnectNotify
  let tmp = gen_qsavefile_types.QSaveFile(h: fcQSaveFile_new4(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name))), parent.h), owned: true)
  fcQSaveFile_vdata(tmp.h)[] = addr(vtbl[])
  tmp
const cQSaveFile_mvtbl = cQSaveFileVTable(
  ...
  metacall: fcQSaveFile_method_callback_metacall,
  fileName: fcQSaveFile_method_callback_fileName,
  open: fcQSaveFile_method_callback_open,
  writeData: fcQSaveFile_method_callback_writeData,
  isSequential: fcQSaveFile_method_callback_isSequential,
  pos: fcQSaveFile_method_callback_pos,
  seek: fcQSaveFile_method_callback_seek,
  atEnd: fcQSaveFile_method_callback_atEnd,
  size: fcQSaveFile_method_callback_size,
  resize: fcQSaveFile_method_callback_resize,
  permissions: fcQSaveFile_method_callback_permissions,
  setPermissions: fcQSaveFile_method_callback_setPermissions,
  readData: fcQSaveFile_method_callback_readData,
  readLineData: fcQSaveFile_method_callback_readLineData,
  reset: fcQSaveFile_method_callback_reset,
  bytesAvailable: fcQSaveFile_method_callback_bytesAvailable,
  bytesToWrite: fcQSaveFile_method_callback_bytesToWrite,
  canReadLine: fcQSaveFile_method_callback_canReadLine,
  waitForReadyRead: fcQSaveFile_method_callback_waitForReadyRead,
  waitForBytesWritten: fcQSaveFile_method_callback_waitForBytesWritten,
  skipData: fcQSaveFile_method_callback_skipData,
  event: fcQSaveFile_method_callback_event,
  eventFilter: fcQSaveFile_method_callback_eventFilter,
  timerEvent: fcQSaveFile_method_callback_timerEvent,
  childEvent: fcQSaveFile_method_callback_childEvent,
  customEvent: fcQSaveFile_method_callback_customEvent,
  connectNotify: fcQSaveFile_method_callback_connectNotify,
  disconnectNotify: fcQSaveFile_method_callback_disconnectNotify,
)
proc create*(T: type gen_qsavefile_types.QSaveFile,
    inst: VirtualQSaveFile) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQSaveFile_new(addr(cQSaveFile_mvtbl), csize_t(sizeof(pointer)))
...
proc create*(T: type gen_qsavefile_types.QSaveFile,
    ...
    inst: VirtualQSaveFile) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQSaveFile_new2(addr(cQSaveFile_mvtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name))))
  fcQSaveFile_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qsavefile_types.QSaveFile,
    ...
    inst: VirtualQSaveFile) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQSaveFile_new3(addr(cQSaveFile_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQSaveFile_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qsavefile_types.QSaveFile,
    ...
    inst: VirtualQSaveFile) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQSaveFile_new4(addr(cQSaveFile_mvtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name))), parent.h)
  fcQSaveFile_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
