...
proc fcQSaveFile_trUtf8(s: cstring): struct_seaqt_string {.importc: "QSaveFile_trUtf8".}
...
proc fcQSaveFile_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QSaveFile_trUtf82".}
proc fcQSaveFile_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QSaveFile_trUtf83".}
