...
proc create*(T: type gen_qjsonarray_types.QJsonArrayiterator,
  ...
  gen_qjsonarray_types.QJsonArrayiterator(h: fcQJsonArrayiterator_new3(other.h), owned: true)
...
proc create*(T: type gen_qjsonarray_types.QJsonArrayconst_iterator,
  ...
  gen_qjsonarray_types.QJsonArrayconst_iterator(h: fcQJsonArrayconst_iterator_new4(other.h), owned: true)
