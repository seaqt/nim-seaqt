...
proc fromStringList*(_: type gen_qjsonarray_types.QJsonArray, list: openArray[string]): gen_qjsonarray_types.QJsonArray =
  ...
  gen_qjsonarray_types.QJsonArray(h: fcQJsonArray_fromStringList(struct_seaqt_array(len: csize_t(len(list)), data: if len(list) == 0: nil else: addr(list_CArray[0]))))
...
proc fromVariantList*(_: type gen_qjsonarray_types.QJsonArray, list: openArray[gen_qvariant_types.QVariant]): gen_qjsonarray_types.QJsonArray =
  ...
  gen_qjsonarray_types.QJsonArray(h: fcQJsonArray_fromVariantList(struct_seaqt_array(len: csize_t(len(list)), data: if len(list) == 0: nil else: addr(list_CArray[0]))))
...
proc create*(T: type gen_qjsonarray_types.QJsonArray): gen_qjsonarray_types.QJsonArray =
  let tmp = gen_qjsonarray_types.QJsonArray(h: fcQJsonArray_new())
  tmp
proc create*(T: type gen_qjsonarray_types.QJsonArray,
    other: gen_qjsonarray_types.QJsonArray): gen_qjsonarray_types.QJsonArray =
  let tmp = gen_qjsonarray_types.QJsonArray(h: fcQJsonArray_new2(other.h))
  tmp
...
proc a*(self: gen_qjsonarray_types.QJsonArrayiterator): gen_qjsonarray_types.QJsonArray =
  gen_qjsonarray_types.QJsonArray(h: fcQJsonArrayiterator_a(self.h))
...
proc create*(T: type gen_qjsonarray_types.QJsonArrayiterator): gen_qjsonarray_types.QJsonArrayiterator =
  let tmp = gen_qjsonarray_types.QJsonArrayiterator(h: fcQJsonArrayiterator_new())
  tmp
proc create*(T: type gen_qjsonarray_types.QJsonArrayiterator,
  ...
  let tmp = gen_qjsonarray_types.QJsonArrayiterator(h: fcQJsonArrayiterator_new2(array.h, index))
  tmp
proc create*(T: type gen_qjsonarray_types.QJsonArrayiterator,
    param1: gen_qjsonarray_types.QJsonArrayiterator): gen_qjsonarray_types.QJsonArrayiterator =
  let tmp = gen_qjsonarray_types.QJsonArrayiterator(h: fcQJsonArrayiterator_new3(param1.h))
  tmp
...
proc a*(self: gen_qjsonarray_types.QJsonArrayconst_iterator): gen_qjsonarray_types.QJsonArray =
  gen_qjsonarray_types.QJsonArray(h: fcQJsonArrayconst_iterator_a(self.h))
...
proc create*(T: type gen_qjsonarray_types.QJsonArrayconst_iterator): gen_qjsonarray_types.QJsonArrayconst_iterator =
  let tmp = gen_qjsonarray_types.QJsonArrayconst_iterator(h: fcQJsonArrayconst_iterator_new())
  tmp
proc create*(T: type gen_qjsonarray_types.QJsonArrayconst_iterator,
  ...
  let tmp = gen_qjsonarray_types.QJsonArrayconst_iterator(h: fcQJsonArrayconst_iterator_new2(array.h, index))
  tmp
proc create*(T: type gen_qjsonarray_types.QJsonArrayconst_iterator,
    o: gen_qjsonarray_types.QJsonArrayconst_iterator): gen_qjsonarray_types.QJsonArrayconst_iterator =
  let tmp = gen_qjsonarray_types.QJsonArrayconst_iterator(h: fcQJsonArrayconst_iterator_new3(o.h))
  tmp
proc create*(T: type gen_qjsonarray_types.QJsonArrayconst_iterator,
    o: gen_qjsonarray_types.QJsonArrayiterator): gen_qjsonarray_types.QJsonArrayconst_iterator =
  let tmp = gen_qjsonarray_types.QJsonArrayconst_iterator(h: fcQJsonArrayconst_iterator_new4(o.h))
  tmp
