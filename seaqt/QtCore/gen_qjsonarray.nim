...
proc fcQJsonArray_insertIValue(self: pointer, i: cint, value: pointer): void {.importc: "QJsonArray_insert_i_value".}
...
proc fcQJsonArray_operatorSubscriptInt(self: pointer, i: cint): pointer {.importc: "QJsonArray_operatorSubscript_int".}
proc fcQJsonArray_operatorSubscriptConstInt(self: pointer, i: cint): pointer {.importc: "QJsonArray_operatorSubscript_const_int".}
...
proc fcQJsonArrayiterator_a(self: pointer): pointer {.importc: "QJsonArray__iterator_a".}
proc fcQJsonArrayiterator_setA(self: pointer, a: pointer): void {.importc: "QJsonArray__iterator_setA".}
proc fcQJsonArrayiterator_i(self: pointer): cint {.importc: "QJsonArray__iterator_i".}
proc fcQJsonArrayiterator_setI(self: pointer, i: cint): void {.importc: "QJsonArray__iterator_setI".}
...
proc fcQJsonArrayiterator_operatorMinusInt(self: pointer, j: cint): pointer {.importc: "QJsonArray__iterator_operatorMinus_int".}
proc fcQJsonArrayiterator_operatorMinus_QJsonArrayIterator(self: pointer, j: pointer): cint {.importc: "QJsonArray__iterator_operatorMinus_QJsonArray_iterator".}
proc fcQJsonArrayiterator_new(): ptr cQJsonArrayiterator {.importc: "QJsonArray__iterator_new".}
proc fcQJsonArrayiterator_new2(array: pointer, index: cint): ptr cQJsonArrayiterator {.importc: "QJsonArray__iterator_new_array_index".}
proc fcQJsonArrayiterator_new3(fromVal: pointer): ptr cQJsonArrayiterator {.importc: "QJsonArray__iterator_new_from".}
proc fcQJsonArrayconst_iterator_a(self: pointer): pointer {.importc: "QJsonArray__const_iterator_a".}
proc fcQJsonArrayconst_iterator_setA(self: pointer, a: pointer): void {.importc: "QJsonArray__const_iterator_setA".}
proc fcQJsonArrayconst_iterator_i(self: pointer): cint {.importc: "QJsonArray__const_iterator_i".}
proc fcQJsonArrayconst_iterator_setI(self: pointer, i: cint): void {.importc: "QJsonArray__const_iterator_setI".}
...
proc fcQJsonArrayconst_iterator_operatorMinusInt(self: pointer, j: cint): pointer {.importc: "QJsonArray__const_iterator_operatorMinus_int".}
proc fcQJsonArrayconst_iterator_operatorMinus_QJsonArrayConstIterator(self: pointer, j: pointer): cint {.importc: "QJsonArray__const_iterator_operatorMinus_QJsonArray_const_iterator".}
proc fcQJsonArrayconst_iterator_new(): ptr cQJsonArrayconst_iterator {.importc: "QJsonArray__const_iterator_new".}
proc fcQJsonArrayconst_iterator_new2(array: pointer, index: cint): ptr cQJsonArrayconst_iterator {.importc: "QJsonArray__const_iterator_new_array_index".}
proc fcQJsonArrayconst_iterator_new3(fromVal: pointer): ptr cQJsonArrayconst_iterator {.importc: "QJsonArray__const_iterator_new_from".}
proc fcQJsonArrayconst_iterator_new4(o: pointer): ptr cQJsonArrayconst_iterator {.importc: "QJsonArray__const_iterator_new_o".}
...
proc operatorSubscript*(self: gen_qjsonarray_types.QJsonArray, i: cint): gen_qjsonvalue_types.QJsonValueRef =
  gen_qjsonvalue_types.QJsonValueRef(h: fcQJsonArray_operatorSubscriptInt(self.h, i), owned: true)

proc operatorSubscript2*(self: gen_qjsonarray_types.QJsonArray, i: cint): gen_qjsonvalue_types.QJsonValue =
  gen_qjsonvalue_types.QJsonValue(h: fcQJsonArray_operatorSubscriptConstInt(self.h, i), owned: true)
...
proc create*(T: type gen_qjsonarray_types.QJsonArray,
  ...
  tmp
proc a*(self: gen_qjsonarray_types.QJsonArrayiterator): gen_qjsonarray_types.QJsonArray =
  gen_qjsonarray_types.QJsonArray(h: fcQJsonArrayiterator_a(self.h), owned: false)

proc setA*(self: gen_qjsonarray_types.QJsonArrayiterator, a: gen_qjsonarray_types.QJsonArray): void =
  fcQJsonArrayiterator_setA(self.h, a.h)

proc i*(self: gen_qjsonarray_types.QJsonArrayiterator): cint =
  fcQJsonArrayiterator_i(self.h)

proc setI*(self: gen_qjsonarray_types.QJsonArrayiterator, i: cint): void =
  fcQJsonArrayiterator_setI(self.h, i)
...
proc operatorMinus*(self: gen_qjsonarray_types.QJsonArrayiterator, j: cint): gen_qjsonarray_types.QJsonArrayiterator =
  gen_qjsonarray_types.QJsonArrayiterator(h: fcQJsonArrayiterator_operatorMinusInt(self.h, j), owned: true)
...
proc create*(T: type gen_qjsonarray_types.QJsonArrayiterator,
  ...
  tmp
proc a*(self: gen_qjsonarray_types.QJsonArrayconst_iterator): gen_qjsonarray_types.QJsonArray =
  gen_qjsonarray_types.QJsonArray(h: fcQJsonArrayconst_iterator_a(self.h), owned: false)

proc setA*(self: gen_qjsonarray_types.QJsonArrayconst_iterator, a: gen_qjsonarray_types.QJsonArray): void =
  fcQJsonArrayconst_iterator_setA(self.h, a.h)

proc i*(self: gen_qjsonarray_types.QJsonArrayconst_iterator): cint =
  fcQJsonArrayconst_iterator_i(self.h)

proc setI*(self: gen_qjsonarray_types.QJsonArrayconst_iterator, i: cint): void =
  fcQJsonArrayconst_iterator_setI(self.h, i)
...
proc operatorMinus*(self: gen_qjsonarray_types.QJsonArrayconst_iterator, j: cint): gen_qjsonarray_types.QJsonArrayconst_iterator =
  gen_qjsonarray_types.QJsonArrayconst_iterator(h: fcQJsonArrayconst_iterator_operatorMinusInt(self.h, j), owned: true)
...
proc create*(T: type gen_qjsonarray_types.QJsonArrayconst_iterator,
  ...
  let tmp = gen_qjsonarray_types.QJsonArrayconst_iterator(h: fcQJsonArrayconst_iterator_new3(fromVal.h), owned: true)
  tmp
proc create*(T: type gen_qjsonarray_types.QJsonArrayconst_iterator,
    o: gen_qjsonarray_types.QJsonArrayiterator): gen_qjsonarray_types.QJsonArrayconst_iterator =
  let tmp = gen_qjsonarray_types.QJsonArrayconst_iterator(h: fcQJsonArrayconst_iterator_new4(o.h), owned: true)
  tmp
