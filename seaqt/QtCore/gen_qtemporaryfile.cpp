...
VirtualQTemporaryFile* QTemporaryFile_new(const QTemporaryFile_VTable* vtbl, size_t vdata) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQTemporaryFile>());
	return _mem_ ? new (_mem_)VirtualQTemporaryFile(vtbl) : nullptr;
}

VirtualQTemporaryFile* QTemporaryFile_new2(const QTemporaryFile_VTable* vtbl, size_t vdata, struct miqt_string templateName) {
...
VirtualQTemporaryFile* QTemporaryFile_new4(const QTemporaryFile_VTable* vtbl, size_t vdata, struct miqt_string templateName, QObject* parent) {
	QString templateName_QString = QString::fromUtf8(templateName.data, templateName.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQTemporaryFile>());
