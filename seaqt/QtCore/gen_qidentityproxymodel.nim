...
{.compile("gen_qidentityproxymodel.cpp", QtCoreCFlags).}
...
proc fcQIdentityProxyModel_match(self: pointer, start: pointer, role: cint, value: pointer, hits: cint, flags: cint): struct_seaqt_array {.importc: "QIdentityProxyModel_match".}
...
proc fcQIdentityProxyModel_handleSourceLayoutChanges(self: pointer): bool {.importc: "QIdentityProxyModel_handleSourceLayoutChanges".}
proc fcQIdentityProxyModel_handleSourceDataChanges(self: pointer): bool {.importc: "QIdentityProxyModel_handleSourceDataChanges".}
...
proc fcQIdentityProxyModel_virtualbase_match(self: pointer, start: pointer, role: cint, value: pointer, hits: cint, flags: cint): struct_seaqt_array {.importc: "QIdentityProxyModel_virtualbase_match".}
...
proc fcQIdentityProxyModel_virtualbase_itemData(self: pointer, index: pointer): struct_seaqt_map {.importc: "QIdentityProxyModel_virtualbase_itemData".}
...
proc fcQIdentityProxyModel_virtualbase_setItemData(self: pointer, index: pointer, roles: struct_seaqt_map): bool {.importc: "QIdentityProxyModel_virtualbase_setItemData".}
...
proc fcQIdentityProxyModel_virtualbase_mimeData(self: pointer, indexes: struct_seaqt_array): pointer {.importc: "QIdentityProxyModel_virtualbase_mimeData".}
...
proc fcQIdentityProxyModel_virtualbase_mimeTypes(self: pointer): struct_seaqt_array {.importc: "QIdentityProxyModel_virtualbase_mimeTypes".}
...
proc fcQIdentityProxyModel_virtualbase_roleNames(self: pointer): struct_seaqt_map {.importc: "QIdentityProxyModel_virtualbase_roleNames".}
...
proc fcQIdentityProxyModel_protectedbase_setHandleSourceLayoutChanges(self: pointer, handleSourceLayoutChanges: bool): void {.importc: "QIdentityProxyModel_protectedbase_setHandleSourceLayoutChanges".}
proc fcQIdentityProxyModel_protectedbase_setHandleSourceDataChanges(self: pointer, handleSourceDataChanges: bool): void {.importc: "QIdentityProxyModel_protectedbase_setHandleSourceDataChanges".}
...
proc fcQIdentityProxyModel_protectedbase_changePersistentIndexList(self: pointer, fromVal: struct_seaqt_array, to: struct_seaqt_array): void {.importc: "QIdentityProxyModel_protectedbase_changePersistentIndexList".}
proc fcQIdentityProxyModel_protectedbase_persistentIndexList(self: pointer): struct_seaqt_array {.importc: "QIdentityProxyModel_protectedbase_persistentIndexList".}
...
proc handleSourceLayoutChanges*(self: gen_qidentityproxymodel_types.QIdentityProxyModel): bool =
  fcQIdentityProxyModel_handleSourceLayoutChanges(self.h)

proc handleSourceDataChanges*(self: gen_qidentityproxymodel_types.QIdentityProxyModel): bool =
  fcQIdentityProxyModel_handleSourceDataChanges(self.h)
...
proc QIdentityProxyModelsetItemData*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, index: gen_qabstractitemmodel_types.QModelIndex, roles: Table[cint,gen_qvariant_types.QVariant]): bool =
  ...
  fcQIdentityProxyModel_virtualbase_setItemData(self.h, index.h, struct_seaqt_map(len: csize_t(len(roles)),keys: if len(roles) == 0: nil else: addr(roles_Keys_CArray[0]), values: if len(roles) == 0: nil else: addr(roles_Values_CArray[0]),))
...
proc QIdentityProxyModelmimeData*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, indexes: openArray[gen_qabstractitemmodel_types.QModelIndex]): gen_qmimedata_types.QMimeData =
  ...
  gen_qmimedata_types.QMimeData(h: fcQIdentityProxyModel_virtualbase_mimeData(self.h, struct_seaqt_array(len: csize_t(len(indexes)), data: if len(indexes) == 0: nil else: addr(indexes_CArray[0]))), owned: false)
...
proc fcQIdentityProxyModel_vtable_callback_match(self: pointer, start: pointer, role: cint, value: pointer, hits: cint, flags: cint): struct_seaqt_array {.cdecl.} =
  let vtbl = cast[ptr QIdentityProxyModelVTable](fcQIdentityProxyModel_vdata(self)[])
  let self = QIdentityProxyModel(h: self)
...
proc fcQIdentityProxyModel_vtable_callback_itemData(self: pointer, index: pointer): struct_seaqt_map {.cdecl.} =
  let vtbl = cast[ptr QIdentityProxyModelVTable](fcQIdentityProxyModel_vdata(self)[])
  let self = QIdentityProxyModel(h: self)
...
proc fcQIdentityProxyModel_vtable_callback_setItemData(self: pointer, index: pointer, roles: struct_seaqt_map): bool {.cdecl.} =
  let vtbl = cast[ptr QIdentityProxyModelVTable](fcQIdentityProxyModel_vdata(self)[])
  let self = QIdentityProxyModel(h: self)
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
  var vroles_mm = roles
...
proc fcQIdentityProxyModel_vtable_callback_mimeData(self: pointer, indexes: struct_seaqt_array): pointer {.cdecl.} =
  let vtbl = cast[ptr QIdentityProxyModelVTable](fcQIdentityProxyModel_vdata(self)[])
  let self = QIdentityProxyModel(h: self)
...
proc fcQIdentityProxyModel_vtable_callback_mimeTypes(self: pointer): struct_seaqt_array {.cdecl.} =
  let vtbl = cast[ptr QIdentityProxyModelVTable](fcQIdentityProxyModel_vdata(self)[])
  let self = QIdentityProxyModel(h: self)
...
proc fcQIdentityProxyModel_vtable_callback_roleNames(self: pointer): struct_seaqt_map {.cdecl.} =
  let vtbl = cast[ptr QIdentityProxyModelVTable](fcQIdentityProxyModel_vdata(self)[])
  let self = QIdentityProxyModel(h: self)
...
proc fcQIdentityProxyModel_method_callback_match(self: pointer, start: pointer, role: cint, value: pointer, hits: cint, flags: cint): struct_seaqt_array {.cdecl.} =
  let inst = cast[VirtualQIdentityProxyModel](fcQIdentityProxyModel_vdata(self)[])
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: start, owned: false)
  let slotval2 = role
  let slotval3 = gen_qvariant_types.QVariant(h: value, owned: false)
...
proc fcQIdentityProxyModel_method_callback_itemData(self: pointer, index: pointer): struct_seaqt_map {.cdecl.} =
  let inst = cast[VirtualQIdentityProxyModel](fcQIdentityProxyModel_vdata(self)[])
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
...
proc fcQIdentityProxyModel_method_callback_setItemData(self: pointer, index: pointer, roles: struct_seaqt_map): bool {.cdecl.} =
  let inst = cast[VirtualQIdentityProxyModel](fcQIdentityProxyModel_vdata(self)[])
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
  var vroles_mm = roles
  var vrolesx_ret: Table[cint, gen_qvariant_types.QVariant]
...
proc fcQIdentityProxyModel_method_callback_mimeData(self: pointer, indexes: struct_seaqt_array): pointer {.cdecl.} =
  let inst = cast[VirtualQIdentityProxyModel](fcQIdentityProxyModel_vdata(self)[])
  var vindexes_ma = indexes
  var vindexesx_ret = newSeq[gen_qabstractitemmodel_types.QModelIndex](int(vindexes_ma.len))
  let vindexes_outCast = cast[ptr UncheckedArray[pointer]](vindexes_ma.data)
...
proc fcQIdentityProxyModel_method_callback_mimeTypes(self: pointer): struct_seaqt_array {.cdecl.} =
  let inst = cast[VirtualQIdentityProxyModel](fcQIdentityProxyModel_vdata(self)[])
...
proc fcQIdentityProxyModel_method_callback_roleNames(self: pointer): struct_seaqt_map {.cdecl.} =
  let inst = cast[VirtualQIdentityProxyModel](fcQIdentityProxyModel_vdata(self)[])
...
proc setHandleSourceLayoutChanges*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, handleSourceLayoutChanges: bool): void =
  fcQIdentityProxyModel_protectedbase_setHandleSourceLayoutChanges(self.h, handleSourceLayoutChanges)

proc setHandleSourceDataChanges*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, handleSourceDataChanges: bool): void =
  fcQIdentityProxyModel_protectedbase_setHandleSourceDataChanges(self.h, handleSourceDataChanges)
...
proc encodeData*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, indexes: openArray[gen_qabstractitemmodel_types.QModelIndex], stream: gen_qdatastream_types.QDataStream): void =
  ...
  fcQIdentityProxyModel_protectedbase_encodeData(self.h, struct_seaqt_array(len: csize_t(len(indexes)), data: if len(indexes) == 0: nil else: addr(indexes_CArray[0])), stream.h)
...
proc changePersistentIndexList*(self: gen_qidentityproxymodel_types.QIdentityProxyModel, fromVal: openArray[gen_qabstractitemmodel_types.QModelIndex], to: openArray[gen_qabstractitemmodel_types.QModelIndex]): void =
  ...
  fcQIdentityProxyModel_protectedbase_changePersistentIndexList(self.h, struct_seaqt_array(len: csize_t(len(fromVal)), data: if len(fromVal) == 0: nil else: addr(fromVal_CArray[0])), struct_seaqt_array(len: csize_t(len(to)), data: if len(to) == 0: nil else: addr(to_CArray[0])))
...
proc create*(T: type gen_qidentityproxymodel_types.QIdentityProxyModel,
  ...
  let tmp = gen_qidentityproxymodel_types.QIdentityProxyModel(h: fcQIdentityProxyModel_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
...
proc create*(T: type gen_qidentityproxymodel_types.QIdentityProxyModel,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQIdentityProxyModel_vtable_callback_disconnectNotify
  let tmp = gen_qidentityproxymodel_types.QIdentityProxyModel(h: fcQIdentityProxyModel_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQIdentityProxyModel_vdata(tmp.h)[] = addr(vtbl[])
  tmp
