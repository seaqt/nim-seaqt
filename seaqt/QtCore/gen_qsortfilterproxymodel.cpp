...
class VirtualQSortFilterProxyModel final : public QSortFilterProxyModel {
	...
	void* vdata;
public:
	friend const QSortFilterProxyModel_VTable* QSortFilterProxyModel_vtbl(const VirtualQSortFilterProxyModel* self);
	friend void* QSortFilterProxyModel_vdata(const VirtualQSortFilterProxyModel* self);
	friend void QSortFilterProxyModel_setVdata(VirtualQSortFilterProxyModel* self, void* vdata);

	VirtualQSortFilterProxyModel(const QSortFilterProxyModel_VTable* vtbl, void* vdata): QSortFilterProxyModel(), vtbl(vtbl), vdata(vdata) {}
	VirtualQSortFilterProxyModel(const QSortFilterProxyModel_VTable* vtbl, void* vdata, QObject* parent): QSortFilterProxyModel(parent), vtbl(vtbl), vdata(vdata) {}
	...
	friend QMimeData* QSortFilterProxyModel_virtualbase_mimeData(const VirtualQSortFilterProxyModel* self, struct miqt_array /* of QModelIndex* */  indexes);
	...
	friend struct miqt_array /* of QModelIndex* */  QSortFilterProxyModel_virtualbase_match(const VirtualQSortFilterProxyModel* self, QModelIndex* start, int role, QVariant* value, int hits, int flags);
	...
	friend struct miqt_array /* of struct miqt_string */  QSortFilterProxyModel_virtualbase_mimeTypes(const VirtualQSortFilterProxyModel* self);
	...
	friend struct miqt_map /* of int to QVariant* */  QSortFilterProxyModel_virtualbase_itemData(const VirtualQSortFilterProxyModel* self, QModelIndex* index);
	...
	friend bool QSortFilterProxyModel_virtualbase_setItemData(VirtualQSortFilterProxyModel* self, QModelIndex* index, struct miqt_map /* of int to QVariant* */  roles);
	...
	friend struct miqt_map /* of int to struct miqt_string */  QSortFilterProxyModel_virtualbase_roleNames(const VirtualQSortFilterProxyModel* self);
	...
	friend void QSortFilterProxyModel_protectedbase_encodeData(const VirtualQSortFilterProxyModel* self, struct miqt_array /* of QModelIndex* */  indexes, QDataStream* stream);
	...
	friend void QSortFilterProxyModel_protectedbase_changePersistentIndexList(VirtualQSortFilterProxyModel* self, struct miqt_array /* of QModelIndex* */  from, struct miqt_array /* of QModelIndex* */  to);
	friend struct miqt_array /* of QModelIndex* */  QSortFilterProxyModel_protectedbase_persistentIndexList(const VirtualQSortFilterProxyModel* self);
...
VirtualQSortFilterProxyModel* QSortFilterProxyModel_new(const QSortFilterProxyModel_VTable* vtbl, void* vdata) {
	return new VirtualQSortFilterProxyModel(vtbl, vdata);
}
...
VirtualQSortFilterProxyModel* QSortFilterProxyModel_new2(const QSortFilterProxyModel_VTable* vtbl, void* vdata, QObject* parent) {
	return new VirtualQSortFilterProxyModel(vtbl, vdata, parent);
}
...
void QSortFilterProxyModel_connect_autoAcceptChildRowsChanged(VirtualQSortFilterProxyModel* self, intptr_t slot, void (*callback)(intptr_t, bool), void (*release)(intptr_t)) {
	struct local_caller : seaqt::caller {
		constexpr local_caller(intptr_t slot, void (*callback)(intptr_t, bool), void (*release)(intptr_t)) : callback(callback), caller{slot, release} {}
		void (*callback)(intptr_t, bool);
...
const QSortFilterProxyModel_VTable* QSortFilterProxyModel_vtbl(const VirtualQSortFilterProxyModel* self) { return self->vtbl; }
void* QSortFilterProxyModel_vdata(const VirtualQSortFilterProxyModel* self) { return self->vdata; }
void QSortFilterProxyModel_setVdata(VirtualQSortFilterProxyModel* self, void* vdata) { self->vdata = vdata; }
