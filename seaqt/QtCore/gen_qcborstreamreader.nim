...
proc fcQCborStreamReader_readAndAppendToString(self: pointer, dst: struct_seaqt_string): bool {.importc: "QCborStreamReader_readAndAppendToString".}
proc fcQCborStreamReader_readAndAppendToUtf8String(self: pointer, dst: struct_seaqt_string): bool {.importc: "QCborStreamReader_readAndAppendToUtf8String".}
proc fcQCborStreamReader_readAndAppendToByteArray(self: pointer, dst: struct_seaqt_string): bool {.importc: "QCborStreamReader_readAndAppendToByteArray".}
...
proc fcQCborStreamReader_readAllString(self: pointer): struct_seaqt_string {.importc: "QCborStreamReader_readAllString".}
proc fcQCborStreamReader_readAllUtf8String(self: pointer): struct_seaqt_string {.importc: "QCborStreamReader_readAllUtf8String".}
proc fcQCborStreamReader_readAllByteArray(self: pointer): struct_seaqt_string {.importc: "QCborStreamReader_readAllByteArray".}
...
proc readAndAppendToString*(self: gen_qcborstreamreader_types.QCborStreamReader, dst: openArray[char]): bool =
  fcQCborStreamReader_readAndAppendToString(self.h, struct_seaqt_string(data: if len(dst) > 0: addr dst[0] else: nil, len: csize_t(len(dst))))

proc readAndAppendToUtf8String*(self: gen_qcborstreamreader_types.QCborStreamReader, dst: openArray[byte]): bool =
  fcQCborStreamReader_readAndAppendToUtf8String(self.h, struct_seaqt_string(data: if len(dst) > 0: addr dst[0] else: nil, len: csize_t(len(dst))))

proc readAndAppendToByteArray*(self: gen_qcborstreamreader_types.QCborStreamReader, dst: openArray[byte]): bool =
  fcQCborStreamReader_readAndAppendToByteArray(self.h, struct_seaqt_string(data: if len(dst) > 0: addr dst[0] else: nil, len: csize_t(len(dst))))
...
proc readAllString*(self: gen_qcborstreamreader_types.QCborStreamReader): string =
  let v_ms = fcQCborStreamReader_readAllString(self.h)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret

proc readAllUtf8String*(self: gen_qcborstreamreader_types.QCborStreamReader): seq[byte] =
  var v_bytearray = fcQCborStreamReader_readAllUtf8String(self.h)
  var vx_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](v_bytearray.data), 0, int(v_bytearray.len)-1))
  c_free(v_bytearray.data)
  vx_ret

proc readAllByteArray*(self: gen_qcborstreamreader_types.QCborStreamReader): seq[byte] =
  var v_bytearray = fcQCborStreamReader_readAllByteArray(self.h)
  var vx_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](v_bytearray.data), 0, int(v_bytearray.len)-1))
  c_free(v_bytearray.data)
  vx_ret
...
proc create*(T: type gen_qcborstreamreader_types.QCborStreamReader,
  ...
  let tmp = gen_qcborstreamreader_types.QCborStreamReader(h: fcQCborStreamReader_new2(data, len), owned: true)
  tmp
proc create*(T: type gen_qcborstreamreader_types.QCborStreamReader,
...
proc create*(T: type gen_qcborstreamreader_types.QCborStreamReader,
  ...
  let tmp = gen_qcborstreamreader_types.QCborStreamReader(h: fcQCborStreamReader_new4(struct_seaqt_string(data: if len(data) > 0: addr data[0] else: nil, len: csize_t(len(data)))), owned: true)
  tmp
proc create*(T: type gen_qcborstreamreader_types.QCborStreamReader,
    device: gen_qiodevice_types.QIODevice): gen_qcborstreamreader_types.QCborStreamReader =
  let tmp = gen_qcborstreamreader_types.QCborStreamReader(h: fcQCborStreamReader_new5(device.h), owned: true)
  tmp
