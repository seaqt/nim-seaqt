...
proc create*(T: type gen_qcborstreamreader_types.QCborStreamReader,
  ...
  let tmp = gen_qcborstreamreader_types.QCborStreamReader(h: fcQCborStreamReader_new4(struct_miqt_string(data: if len(data) > 0: addr data[0] else: nil, len: csize_t(len(data)))))
  tmp
proc create*(T: type gen_qcborstreamreader_types.QCborStreamReader,
