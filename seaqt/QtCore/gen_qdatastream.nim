...
template Qt_6_5*(_: type QDataStreamVersionEnum): untyped = 20
template Qt_6_6*(_: type QDataStreamVersionEnum): untyped = 21
template Qt_6_7*(_: type QDataStreamVersionEnum): untyped = 22
template Qt_6_8*(_: type QDataStreamVersionEnum): untyped = 22
template Qt_6_9*(_: type QDataStreamVersionEnum): untyped = 22
template Qt_6_10*(_: type QDataStreamVersionEnum): untyped = 23
template Qt_6_11*(_: type QDataStreamVersionEnum): untyped = 24
template Qt_DefaultCompiledVersion*(_: type QDataStreamVersionEnum): untyped = 24
...
template SizeLimitExceeded*(_: type QDataStreamStatusEnum): untyped = 4
...
proc fcQDataStream_ToBool(self: pointer): bool {.importc: "QDataStream_ToBool".}
proc fcQDataStream_readBytesCharUint(self: pointer, param1: cstring, len: ptr cuint): pointer {.importc: "QDataStream_readBytes_char_uint".}
proc fcQDataStream_readBytesCharQint64(self: pointer, param1: cstring, len: ptr clonglong): pointer {.importc: "QDataStream_readBytes_char_qint64".}
proc fcQDataStream_readRawData(self: pointer, param1: cstring, len: clonglong): clonglong {.importc: "QDataStream_readRawData".}
proc fcQDataStream_writeBytes(self: pointer, param1: cstring, len: clonglong): void {.importc: "QDataStream_writeBytes".}
proc fcQDataStream_writeRawData(self: pointer, param1: cstring, len: clonglong): clonglong {.importc: "QDataStream_writeRawData".}
proc fcQDataStream_skipRawData(self: pointer, len: clonglong): clonglong {.importc: "QDataStream_skipRawData".}
...
proc fcQDataStream_staticMetaObject(): pointer {.importc: "QDataStream_staticMetaObject".}
...
proc ToBool*(self: gen_qdatastream_types.QDataStream): bool =
  fcQDataStream_ToBool(self.h)

proc readBytes*(self: gen_qdatastream_types.QDataStream, param1: cstring, len: ptr cuint): gen_qdatastream_types.QDataStream =
  gen_qdatastream_types.QDataStream(h: fcQDataStream_readBytesCharUint(self.h, param1, len), owned: false)

proc readBytes*(self: gen_qdatastream_types.QDataStream, param1: cstring, len: ptr clonglong): gen_qdatastream_types.QDataStream =
  gen_qdatastream_types.QDataStream(h: fcQDataStream_readBytesCharQint64(self.h, param1, len), owned: false)

proc readRawData*(self: gen_qdatastream_types.QDataStream, param1: cstring, len: clonglong): clonglong =
  fcQDataStream_readRawData(self.h, param1, len)

proc writeBytes*(self: gen_qdatastream_types.QDataStream, param1: cstring, len: clonglong): void =
  fcQDataStream_writeBytes(self.h, param1, len)

proc writeRawData*(self: gen_qdatastream_types.QDataStream, param1: cstring, len: clonglong): clonglong =
  fcQDataStream_writeRawData(self.h, param1, len)

proc skipRawData*(self: gen_qdatastream_types.QDataStream, len: clonglong): clonglong =
...
proc create*(T: type gen_qdatastream_types.QDataStream,
  ...
  tmp
proc staticMetaObject*(_: type gen_qdatastream_types.QDataStream): gen_qobjectdefs_types.QMetaObject =
  gen_qobjectdefs_types.QMetaObject(h: fcQDataStream_staticMetaObject())
