...
type ColorSchemeEnum* = distinct cint
template Unknown*(_: type ColorSchemeEnum): untyped = 0
template Light*(_: type ColorSchemeEnum): untyped = 1
template Dark*(_: type ColorSchemeEnum): untyped = 2


type ContrastPreferenceEnum* = distinct cint
template NoPreference*(_: type ContrastPreferenceEnum): untyped = 0
template HighContrast*(_: type ContrastPreferenceEnum): untyped = 1
...
template ExpandedClientAreaHint*(_: type WindowTypeEnum): untyped = 4194304
template NoTitleBarBackgroundHint*(_: type WindowTypeEnum): untyped = 8388608
...
template AA_QtQuickUseDefaultSizePolicy*(_: type ApplicationAttributeEnum): untyped = 1
...
template AA_DontUseNativeMenuWindows*(_: type ApplicationAttributeEnum): untyped = 10
...
template Key_micro*(_: type KeyEnum): untyped = 181
...
template Key_Keyboard*(_: type KeyEnum): untyped = 16777503
...
type ContextMenuTriggerEnum* = distinct cint
template Press*(_: type ContextMenuTriggerEnum): untyped = 0
template Release*(_: type ContextMenuTriggerEnum): untyped = 1
...
template RangeModelDataRole*(_: type ItemDataRoleEnum): untyped = 40
template RangeModelAdapterRole*(_: type ItemDataRoleEnum): untyped = 41
template UserRole*(_: type ItemDataRoleEnum): untyped = 256
template StandardItemFlagsRole*(_: type ItemDataRoleEnum): untyped = 255
template FileInfoRole*(_: type ItemDataRoleEnum): untyped = 252
template RemoteObjectsCacheRole*(_: type ItemDataRoleEnum): untyped = 255
...
type TimerIdEnum* = distinct cint
template Invalid*(_: type TimerIdEnum): untyped = 0
...
type PermissionStatusEnum* = distinct cint
template Undetermined*(_: type PermissionStatusEnum): untyped = 0
template Granted*(_: type PermissionStatusEnum): untyped = 1
template Denied*(_: type PermissionStatusEnum): untyped = 2
...
type QInternalCallModeEnum* = distinct cint
template Testing*(_: type QInternalCallModeEnum): untyped = 0
template Live*(_: type QInternalCallModeEnum): untyped = 1


type QInternalSaveStateRuleEnum* = distinct cint
template KeepSavedState*(_: type QInternalSaveStateRuleEnum): untyped = 0
template ClearSavedState*(_: type QInternalSaveStateRuleEnum): untyped = 1
