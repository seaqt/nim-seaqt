...
template ExcludeOther*(_: type QDirListingIteratorFlagEnum): untyped = 16
...
template IncludeBrokenSymlinks*(_: type QDirListingIteratorFlagEnum): untyped = 4096
template NoNameFiltersForDirs*(_: type QDirListingIteratorFlagEnum): untyped = 262144
...
proc fcQDirListing_staticMetaObject(): pointer {.importc: "QDirListing_staticMetaObject".}
...
proc create*(T: type gen_qdirlisting_types.QDirListing,
  ...
  tmp
proc staticMetaObject*(_: type gen_qdirlisting_types.QDirListing): gen_qobjectdefs_types.QMetaObject =
  gen_qobjectdefs_types.QMetaObject(h: fcQDirListing_staticMetaObject())
