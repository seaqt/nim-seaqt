...
proc fcQRandomGenerator_seedWithQuint32(self: pointer, s: cuint): void {.importc: "QRandomGenerator_seedWithQuint32".}
...
proc seed*(self: gen_qrandom_types.QRandomGenerator, s: cuint): void =
  fcQRandomGenerator_seedWithQuint32(self.h, s)
...
proc create*(T: type gen_qrandom_types.QRandomGenerator,
  ...
  let tmp = gen_qrandom_types.QRandomGenerator(h: fcQRandomGenerator_new4(other.h), owned: true)
  tmp
proc create*(T: type gen_qrandom_types.QRandomGenerator,
...
proc create*(T: type gen_qrandom_types.QRandomGenerator64,
  ...
  let tmp = gen_qrandom_types.QRandomGenerator64(h: fcQRandomGenerator64_new5(param1.h), owned: true)
  tmp
proc create*(T: type gen_qrandom_types.QRandomGenerator64,
