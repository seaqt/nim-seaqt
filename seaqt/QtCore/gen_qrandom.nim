...
proc create*(T: type gen_qrandom_types.QRandomGenerator): gen_qrandom_types.QRandomGenerator =
  let tmp = gen_qrandom_types.QRandomGenerator(h: fcQRandomGenerator_new())
  tmp
proc create*(T: type gen_qrandom_types.QRandomGenerator,
    seedBuffer: ptr cuint, len: int64): gen_qrandom_types.QRandomGenerator =
  let tmp = gen_qrandom_types.QRandomGenerator(h: fcQRandomGenerator_new2(seedBuffer, len))
  tmp
proc create*(T: type gen_qrandom_types.QRandomGenerator,
    begin: ptr cuint, endVal: ptr cuint): gen_qrandom_types.QRandomGenerator =
  let tmp = gen_qrandom_types.QRandomGenerator(h: fcQRandomGenerator_new3(begin, endVal))
  tmp
proc create*(T: type gen_qrandom_types.QRandomGenerator,
    other: gen_qrandom_types.QRandomGenerator): gen_qrandom_types.QRandomGenerator =
  let tmp = gen_qrandom_types.QRandomGenerator(h: fcQRandomGenerator_new4(other.h))
  tmp
proc create*(T: type gen_qrandom_types.QRandomGenerator,
    seedValue: cuint): gen_qrandom_types.QRandomGenerator =
  let tmp = gen_qrandom_types.QRandomGenerator(h: fcQRandomGenerator_new5(seedValue))
  tmp
...
proc create*(T: type gen_qrandom_types.QRandomGenerator64): gen_qrandom_types.QRandomGenerator64 =
  let tmp = gen_qrandom_types.QRandomGenerator64(h: fcQRandomGenerator64_new())
  tmp
proc create*(T: type gen_qrandom_types.QRandomGenerator64,
  ...
  let tmp = gen_qrandom_types.QRandomGenerator64(h: fcQRandomGenerator64_new2(seedBuffer, len))
  tmp
proc create*(T: type gen_qrandom_types.QRandomGenerator64,
    begin: ptr cuint, endVal: ptr cuint): gen_qrandom_types.QRandomGenerator64 =
  let tmp = gen_qrandom_types.QRandomGenerator64(h: fcQRandomGenerator64_new3(begin, endVal))
  tmp
proc create*(T: type gen_qrandom_types.QRandomGenerator64,
    other: gen_qrandom_types.QRandomGenerator): gen_qrandom_types.QRandomGenerator64 =
  let tmp = gen_qrandom_types.QRandomGenerator64(h: fcQRandomGenerator64_new4(other.h))
  tmp
proc create*(T: type gen_qrandom_types.QRandomGenerator64,
    param1: gen_qrandom_types.QRandomGenerator64): gen_qrandom_types.QRandomGenerator64 =
  let tmp = gen_qrandom_types.QRandomGenerator64(h: fcQRandomGenerator64_new5(param1.h))
  tmp
proc create*(T: type gen_qrandom_types.QRandomGenerator64,
    seedValue: cuint): gen_qrandom_types.QRandomGenerator64 =
  let tmp = gen_qrandom_types.QRandomGenerator64(h: fcQRandomGenerator64_new6(seedValue))
  tmp
