...
proc create*(T: type gen_qdeadlinetimer_types.QDeadlineTimer,
  ...
  let tmp = gen_qdeadlinetimer_types.QDeadlineTimer(h: fcQDeadlineTimer_new2(cint(param1)), owned: true)
  tmp
proc create*(T: type gen_qdeadlinetimer_types.QDeadlineTimer,
...
proc create2*(T: type gen_qdeadlinetimer_types.QDeadlineTimer,
  ...
  let tmp = gen_qdeadlinetimer_types.QDeadlineTimer(h: fcQDeadlineTimer_new5(cint(type_x)), owned: true)
  tmp
proc create*(T: type gen_qdeadlinetimer_types.QDeadlineTimer,
