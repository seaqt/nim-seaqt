...
proc create*(T: type gen_qvariant_types.QVariant,
  ...
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new12(struct_miqt_string(data: if len(bytearray) > 0: addr bytearray[0] else: nil, len: csize_t(len(bytearray)))))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
...
proc create*(T: type gen_qvariant_types.QVariant,
  ...
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new14(struct_miqt_string(data: if len(string) > 0: addr string[0] else: nil, len: csize_t(len(string)))))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
  ...
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new15(struct_miqt_array(len: csize_t(len(stringlist)), data: if len(stringlist) == 0: nil else: addr(stringlist_CArray[0]))))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
...
proc create*(T: type gen_qvariant_types.QVariant,
  ...
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new20(struct_miqt_array(len: csize_t(len(list)), data: if len(list) == 0: nil else: addr(list_CArray[0]))))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
  ...
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new21(struct_miqt_map(len: csize_t(len(map)),keys: if len(map) == 0: nil else: addr(map_Keys_CArray[0]), values: if len(map) == 0: nil else: addr(map_Values_CArray[0]),)))
  tmp
proc create2*(T: type gen_qvariant_types.QVariant,
  ...
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new22(struct_miqt_map(len: csize_t(len(hash)),keys: if len(hash) == 0: nil else: addr(hash_Keys_CArray[0]), values: if len(hash) == 0: nil else: addr(hash_Values_CArray[0]),)))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
...
proc create*(T: type gen_qvariant_types.QVariantConstPointer,
  ...
  let tmp = gen_qvariant_types.QVariantConstPointer(h: fcQVariantConstPointer_new(variant.h))
  tmp
proc create*(T: type gen_qvariant_types.QVariantConstPointer,
    param1: gen_qvariant_types.QVariantConstPointer): gen_qvariant_types.QVariantConstPointer =
  let tmp = gen_qvariant_types.QVariantConstPointer(h: fcQVariantConstPointer_new2(param1.h))
  tmp
