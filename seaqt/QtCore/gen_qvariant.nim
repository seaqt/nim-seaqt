...
proc fcQVariant_new23(map: struct_seaqt_map): ptr cQVariant {.importc: "QVariant_new_QMapOfQString_QVariant".}
proc fcQVariant_new24(hash: struct_seaqt_map): ptr cQVariant {.importc: "QVariant_new_QHashOfQString_QVariant".}
proc fcQVariant_new25(size: pointer): ptr cQVariant {.importc: "QVariant_new_QSize".}
proc fcQVariant_new26(size: pointer): ptr cQVariant {.importc: "QVariant_new_QSizeF".}
proc fcQVariant_new27(pt: pointer): ptr cQVariant {.importc: "QVariant_new_QPoint".}
proc fcQVariant_new28(pt: pointer): ptr cQVariant {.importc: "QVariant_new_QPointF".}
proc fcQVariant_new29(line: pointer): ptr cQVariant {.importc: "QVariant_new_QLine".}
proc fcQVariant_new30(line: pointer): ptr cQVariant {.importc: "QVariant_new_QLineF".}
proc fcQVariant_new31(rect: pointer): ptr cQVariant {.importc: "QVariant_new_QRect".}
proc fcQVariant_new32(rect: pointer): ptr cQVariant {.importc: "QVariant_new_QRectF".}
proc fcQVariant_new33(locale: pointer): ptr cQVariant {.importc: "QVariant_new_QLocale".}
proc fcQVariant_new34(regExp: pointer): ptr cQVariant {.importc: "QVariant_new_QRegExp".}
proc fcQVariant_new35(re: pointer): ptr cQVariant {.importc: "QVariant_new_QRegularExpression".}
proc fcQVariant_new36(easing: pointer): ptr cQVariant {.importc: "QVariant_new_QEasingCurve".}
proc fcQVariant_new37(uuid: pointer): ptr cQVariant {.importc: "QVariant_new_QUuid".}
proc fcQVariant_new38(url: pointer): ptr cQVariant {.importc: "QVariant_new_QUrl".}
proc fcQVariant_new39(jsonValue: pointer): ptr cQVariant {.importc: "QVariant_new_QJsonValue".}
proc fcQVariant_new40(jsonObject: pointer): ptr cQVariant {.importc: "QVariant_new_QJsonObject".}
proc fcQVariant_new41(jsonArray: pointer): ptr cQVariant {.importc: "QVariant_new_QJsonArray".}
proc fcQVariant_new42(jsonDocument: pointer): ptr cQVariant {.importc: "QVariant_new_QJsonDocument".}
proc fcQVariant_new43(modelIndex: pointer): ptr cQVariant {.importc: "QVariant_new_QModelIndex".}
proc fcQVariant_new44(modelIndex: pointer): ptr cQVariant {.importc: "QVariant_new_QPersistentModelIndex".}
proc fcQVariant_new45(list: struct_seaqt_array): ptr cQVariant {.importc: "QVariant_new_QListOfQVariant".}
...
proc create*(T: type gen_qvariant_types.QVariant,
  ...
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new23(struct_seaqt_map(len: csize_t(len(map)),keys: if len(map) == 0: nil else: addr(map_Keys_CArray[0]), values: if len(map) == 0: nil else: addr(map_Values_CArray[0]),)), owned: true)
  tmp
proc create2*(T: type gen_qvariant_types.QVariant,
  ...
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new24(struct_seaqt_map(len: csize_t(len(hash)),keys: if len(hash) == 0: nil else: addr(hash_Keys_CArray[0]), values: if len(hash) == 0: nil else: addr(hash_Values_CArray[0]),)), owned: true)
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    size: gen_qsize_types.QSize): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new25(size.h), owned: true)
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
...
proc create*(T: type gen_qvariant_types.QVariant,
  ...
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new27(pt.h), owned: true)
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
...
proc create*(T: type gen_qvariant_types.QVariant,
  ...
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new29(line.h), owned: true)
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
...
proc create*(T: type gen_qvariant_types.QVariant,
  ...
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new31(rect.h), owned: true)
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
...
proc create*(T: type gen_qvariant_types.QVariant,
  ...
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new33(locale.h), owned: true)
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    regExp: gen_qregexp_types.QRegExp): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new34(regExp.h), owned: true)
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    re: gen_qregularexpression_types.QRegularExpression): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new35(re.h), owned: true)
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    easing: gen_qeasingcurve_types.QEasingCurve): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new36(easing.h), owned: true)
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    uuid: gen_quuid_types.QUuid): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new37(uuid.h), owned: true)
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    url: gen_qurl_types.QUrl): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new38(url.h), owned: true)
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    jsonValue: gen_qjsonvalue_types.QJsonValue): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new39(jsonValue.h), owned: true)
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    jsonObject: gen_qjsonobject_types.QJsonObject): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new40(jsonObject.h), owned: true)
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    jsonArray: gen_qjsonarray_types.QJsonArray): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new41(jsonArray.h), owned: true)
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    jsonDocument: gen_qjsondocument_types.QJsonDocument): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new42(jsonDocument.h), owned: true)
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    modelIndex: gen_qabstractitemmodel_types.QModelIndex): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new43(modelIndex.h), owned: true)
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
...
proc create*(T: type gen_qvariant_types.QVariant,
  ...
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new45(struct_seaqt_array(len: csize_t(len(list)), data: if len(list) == 0: nil else: addr(list_CArray[0]))), owned: true)
  tmp
