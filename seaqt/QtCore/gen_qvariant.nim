...
proc fcQVariant_new21(map: struct_seaqt_map): ptr cQVariant {.importc: "QVariant_new_QMapOfQString_QVariant".}
proc fcQVariant_new22(hash: struct_seaqt_map): ptr cQVariant {.importc: "QVariant_new_QHashOfQString_QVariant".}
proc fcQVariant_new23(size: pointer): ptr cQVariant {.importc: "QVariant_new_QSize".}
proc fcQVariant_new24(size: pointer): ptr cQVariant {.importc: "QVariant_new_QSizeF".}
proc fcQVariant_new25(pt: pointer): ptr cQVariant {.importc: "QVariant_new_QPoint".}
proc fcQVariant_new26(pt: pointer): ptr cQVariant {.importc: "QVariant_new_QPointF".}
proc fcQVariant_new27(line: pointer): ptr cQVariant {.importc: "QVariant_new_QLine".}
proc fcQVariant_new28(line: pointer): ptr cQVariant {.importc: "QVariant_new_QLineF".}
proc fcQVariant_new29(rect: pointer): ptr cQVariant {.importc: "QVariant_new_QRect".}
proc fcQVariant_new30(rect: pointer): ptr cQVariant {.importc: "QVariant_new_QRectF".}
proc fcQVariant_new31(locale: pointer): ptr cQVariant {.importc: "QVariant_new_QLocale".}
proc fcQVariant_new32(re: pointer): ptr cQVariant {.importc: "QVariant_new_QRegularExpression".}
proc fcQVariant_new33(easing: pointer): ptr cQVariant {.importc: "QVariant_new_QEasingCurve".}
proc fcQVariant_new34(uuid: pointer): ptr cQVariant {.importc: "QVariant_new_QUuid".}
proc fcQVariant_new35(url: pointer): ptr cQVariant {.importc: "QVariant_new_QUrl".}
proc fcQVariant_new36(jsonValue: pointer): ptr cQVariant {.importc: "QVariant_new_QJsonValue".}
proc fcQVariant_new37(jsonObject: pointer): ptr cQVariant {.importc: "QVariant_new_QJsonObject".}
proc fcQVariant_new38(jsonArray: pointer): ptr cQVariant {.importc: "QVariant_new_QJsonArray".}
proc fcQVariant_new39(jsonDocument: pointer): ptr cQVariant {.importc: "QVariant_new_QJsonDocument".}
proc fcQVariant_new40(modelIndex: pointer): ptr cQVariant {.importc: "QVariant_new_QModelIndex".}
proc fcQVariant_new41(modelIndex: pointer): ptr cQVariant {.importc: "QVariant_new_QPersistentModelIndex".}
