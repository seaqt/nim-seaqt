...
template LastCoreType*(_: type QVariantTypeEnum): untyped = 63
...
proc fcQVariant_fromMetaTypeType(typeVal: pointer): pointer {.importc: "QVariant_fromMetaType_type".}
...
proc fcQVariant_fromMetaTypeTypeCopy(typeVal: pointer, copy: pointer): pointer {.importc: "QVariant_fromMetaType_type_copy".}
...
proc fcQVariant_new11(qchar: pointer): ptr cQVariant {.importc: "QVariant_new_QChar".}
proc fcQVariant_new12(date: pointer): ptr cQVariant {.importc: "QVariant_new_QDate".}
proc fcQVariant_new13(time: pointer): ptr cQVariant {.importc: "QVariant_new_QTime".}
proc fcQVariant_new14(bitarray: pointer): ptr cQVariant {.importc: "QVariant_new_QBitArray".}
proc fcQVariant_new15(bytearray: struct_seaqt_string): ptr cQVariant {.importc: "QVariant_new_QByteArray".}
proc fcQVariant_new16(datetime: pointer): ptr cQVariant {.importc: "QVariant_new_QDateTime".}
proc fcQVariant_new17(hash: struct_seaqt_map): ptr cQVariant {.importc: "QVariant_new_QHashOfQString_QVariant".}
proc fcQVariant_new18(jsonArray: pointer): ptr cQVariant {.importc: "QVariant_new_QJsonArray".}
proc fcQVariant_new19(jsonObject: pointer): ptr cQVariant {.importc: "QVariant_new_QJsonObject".}
proc fcQVariant_new20(list: struct_seaqt_array): ptr cQVariant {.importc: "QVariant_new_QListOfQVariant".}
proc fcQVariant_new21(locale: pointer): ptr cQVariant {.importc: "QVariant_new_QLocale".}
proc fcQVariant_new22(map: struct_seaqt_map): ptr cQVariant {.importc: "QVariant_new_QMapOfQString_QVariant".}
proc fcQVariant_new23(re: pointer): ptr cQVariant {.importc: "QVariant_new_QRegularExpression".}
proc fcQVariant_new24(stringVal: struct_seaqt_string): ptr cQVariant {.importc: "QVariant_new_QString".}
proc fcQVariant_new25(stringlist: struct_seaqt_array): ptr cQVariant {.importc: "QVariant_new_QStringList".}
proc fcQVariant_new26(url: pointer): ptr cQVariant {.importc: "QVariant_new_QUrl".}
proc fcQVariant_new27(jsonValue: pointer): ptr cQVariant {.importc: "QVariant_new_QJsonValue".}
proc fcQVariant_new28(modelIndex: pointer): ptr cQVariant {.importc: "QVariant_new_QModelIndex".}
proc fcQVariant_new29(uuid: pointer): ptr cQVariant {.importc: "QVariant_new_QUuid".}
proc fcQVariant_new30(size: pointer): ptr cQVariant {.importc: "QVariant_new_QSize".}
proc fcQVariant_new31(size: pointer): ptr cQVariant {.importc: "QVariant_new_QSizeF".}
proc fcQVariant_new32(pt: pointer): ptr cQVariant {.importc: "QVariant_new_QPoint".}
proc fcQVariant_new33(pt: pointer): ptr cQVariant {.importc: "QVariant_new_QPointF".}
proc fcQVariant_new34(line: pointer): ptr cQVariant {.importc: "QVariant_new_QLine".}
proc fcQVariant_new35(line: pointer): ptr cQVariant {.importc: "QVariant_new_QLineF".}
proc fcQVariant_new36(rect: pointer): ptr cQVariant {.importc: "QVariant_new_QRect".}
proc fcQVariant_new37(rect: pointer): ptr cQVariant {.importc: "QVariant_new_QRectF".}
proc fcQVariant_new38(easing: pointer): ptr cQVariant {.importc: "QVariant_new_QEasingCurve".}
proc fcQVariant_new39(jsonDocument: pointer): ptr cQVariant {.importc: "QVariant_new_QJsonDocument".}
proc fcQVariant_new40(modelIndex: pointer): ptr cQVariant {.importc: "QVariant_new_QPersistentModelIndex".}
proc fcQVariant_new41(str: cstring): ptr cQVariant {.importc: "QVariant_new_char".}
proc fcQVariant_new42(typeVal: cint): ptr cQVariant {.importc: "QVariant_new_QVariant_Type".}
proc fcQVariant_new43(typeVal: pointer, copy: pointer): ptr cQVariant {.importc: "QVariant_new_QMetaType_void".}
...
proc fromMetaType*(_: type gen_qvariant_types.QVariant, typeVal: gen_qmetatype_types.QMetaType): gen_qvariant_types.QVariant =
  gen_qvariant_types.QVariant(h: fcQVariant_fromMetaTypeType(typeVal.h), owned: true)
...
proc fromMetaType*(_: type gen_qvariant_types.QVariant, typeVal: gen_qmetatype_types.QMetaType, copy: pointer): gen_qvariant_types.QVariant =
  gen_qvariant_types.QVariant(h: fcQVariant_fromMetaTypeTypeCopy(typeVal.h, copy), owned: true)
...
proc create*(T: type gen_qvariant_types.QVariant,
  ...
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new11(qchar.h), owned: true)
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    date: gen_qdatetime_types.QDate): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new12(date.h), owned: true)
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    time: gen_qdatetime_types.QTime): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new13(time.h), owned: true)
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    bitarray: gen_qbitarray_types.QBitArray): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new14(bitarray.h), owned: true)
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
...
proc create*(T: type gen_qvariant_types.QVariant,
  ...
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new16(datetime.h), owned: true)
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
  ...
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new17(struct_seaqt_map(len: csize_t(len(hash)),keys: if len(hash) == 0: nil else: addr(hash_Keys_CArray[0]), values: if len(hash) == 0: nil else: addr(hash_Values_CArray[0]),)), owned: true)
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    jsonArray: gen_qjsonarray_types.QJsonArray): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new18(jsonArray.h), owned: true)
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    jsonObject: gen_qjsonobject_types.QJsonObject): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new19(jsonObject.h), owned: true)
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
...
proc create*(T: type gen_qvariant_types.QVariant,
  ...
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new21(locale.h), owned: true)
  tmp
proc create2*(T: type gen_qvariant_types.QVariant,
  ...
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new22(struct_seaqt_map(len: csize_t(len(map)),keys: if len(map) == 0: nil else: addr(map_Keys_CArray[0]), values: if len(map) == 0: nil else: addr(map_Values_CArray[0]),)), owned: true)
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    re: gen_qregularexpression_types.QRegularExpression): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new23(re.h), owned: true)
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    stringVal: openArray[char]): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new24(struct_seaqt_string(data: if len(stringVal) > 0: addr stringVal[0] else: nil, len: csize_t(len(stringVal)))), owned: true)
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
  ...
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new25(struct_seaqt_array(len: csize_t(len(stringlist)), data: if len(stringlist) == 0: nil else: addr(stringlist_CArray[0]))), owned: true)
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    url: gen_qurl_types.QUrl): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new26(url.h), owned: true)
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    jsonValue: gen_qjsonvalue_types.QJsonValue): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new27(jsonValue.h), owned: true)
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    modelIndex: gen_qabstractitemmodel_types.QModelIndex): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new28(modelIndex.h), owned: true)
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    uuid: gen_quuid_types.QUuid): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new29(uuid.h), owned: true)
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    size: gen_qsize_types.QSize): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new30(size.h), owned: true)
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    size: gen_qsize_types.QSizeF): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new31(size.h), owned: true)
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    pt: gen_qpoint_types.QPoint): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new32(pt.h), owned: true)
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    pt: gen_qpoint_types.QPointF): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new33(pt.h), owned: true)
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    line: gen_qline_types.QLine): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new34(line.h), owned: true)
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    line: gen_qline_types.QLineF): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new35(line.h), owned: true)
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    rect: gen_qrect_types.QRect): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new36(rect.h), owned: true)
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    rect: gen_qrect_types.QRectF): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new37(rect.h), owned: true)
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    easing: gen_qeasingcurve_types.QEasingCurve): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new38(easing.h), owned: true)
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
...
proc create*(T: type gen_qvariant_types.QVariant,
  ...
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new41(str), owned: true)
  tmp
proc create2*(T: type gen_qvariant_types.QVariant,
