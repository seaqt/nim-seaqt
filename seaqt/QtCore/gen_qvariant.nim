...
proc create*(T: type gen_qvariant_types.QVariant,
  ...
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new2(cint(typeVal)))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    typeId: cint, copy: pointer): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new3(typeId, copy))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    typeId: cint, copy: pointer, flags: cuint): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new4(typeId, copy, flags))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    other: gen_qvariant_types.QVariant): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new5(other.h))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    s: gen_qdatastream_types.QDataStream): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new6(s.h))
  tmp
proc create2*(T: type gen_qvariant_types.QVariant,
    i: cint): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new7(i))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    ui: cuint): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new8(ui))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    ll: clonglong): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new9(ll))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    ull: culonglong): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new10(ull))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    b: bool): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new11(b))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    d: float64): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new12(d))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    f: float32): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new13(f))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    str: cstring): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new14(str))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    bytearray: openArray[byte]): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new15(struct_seaqt_string(data: if len(bytearray) > 0: addr bytearray[0] else: nil, len: csize_t(len(bytearray)))))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    bitarray: gen_qbitarray_types.QBitArray): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new16(bitarray.h))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    stringVal: openArray[char]): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new17(struct_seaqt_string(data: if len(stringVal) > 0: addr stringVal[0] else: nil, len: csize_t(len(stringVal)))))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
  ...
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new18(struct_seaqt_array(len: csize_t(len(stringlist)), data: if len(stringlist) == 0: nil else: addr(stringlist_CArray[0]))))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    qchar: gen_qchar_types.QChar): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new19(qchar.h))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    date: gen_qdatetime_types.QDate): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new20(date.h))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    time: gen_qdatetime_types.QTime): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new21(time.h))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    datetime: gen_qdatetime_types.QDateTime): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new22(datetime.h))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
  ...
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new23(struct_seaqt_array(len: csize_t(len(list)), data: if len(list) == 0: nil else: addr(list_CArray[0]))))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
  ...
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new24(struct_seaqt_map(len: csize_t(len(map)),keys: if len(map) == 0: nil else: addr(map_Keys_CArray[0]), values: if len(map) == 0: nil else: addr(map_Values_CArray[0]),)))
  tmp
proc create2*(T: type gen_qvariant_types.QVariant,
  ...
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new25(struct_seaqt_map(len: csize_t(len(hash)),keys: if len(hash) == 0: nil else: addr(hash_Keys_CArray[0]), values: if len(hash) == 0: nil else: addr(hash_Values_CArray[0]),)))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    size: gen_qsize_types.QSize): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new26(size.h))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    size: gen_qsize_types.QSizeF): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new27(size.h))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    pt: gen_qpoint_types.QPoint): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new28(pt.h))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    pt: gen_qpoint_types.QPointF): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new29(pt.h))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    line: gen_qline_types.QLine): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new30(line.h))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    line: gen_qline_types.QLineF): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new31(line.h))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    rect: gen_qrect_types.QRect): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new32(rect.h))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    rect: gen_qrect_types.QRectF): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new33(rect.h))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    locale: gen_qlocale_types.QLocale): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new34(locale.h))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    regExp: gen_qregexp_types.QRegExp): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new35(regExp.h))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    re: gen_qregularexpression_types.QRegularExpression): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new36(re.h))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    easing: gen_qeasingcurve_types.QEasingCurve): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new37(easing.h))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    uuid: gen_quuid_types.QUuid): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new38(uuid.h))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    url: gen_qurl_types.QUrl): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new39(url.h))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    jsonValue: gen_qjsonvalue_types.QJsonValue): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new40(jsonValue.h))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    jsonObject: gen_qjsonobject_types.QJsonObject): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new41(jsonObject.h))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    jsonArray: gen_qjsonarray_types.QJsonArray): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new42(jsonArray.h))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    jsonDocument: gen_qjsondocument_types.QJsonDocument): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new43(jsonDocument.h))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    modelIndex: gen_qabstractitemmodel_types.QModelIndex): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new44(modelIndex.h))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    modelIndex: gen_qabstractitemmodel_types.QPersistentModelIndex): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new45(modelIndex.h))
  tmp
...
proc create*(T: type gen_qvariant_types.QVariantComparisonHelper,
  ...
  let tmp = gen_qvariant_types.QVariantComparisonHelper(h: fcQVariantComparisonHelper_new(varVal.h))
  tmp
proc create*(T: type gen_qvariant_types.QVariantComparisonHelper,
    param1: gen_qvariant_types.QVariantComparisonHelper): gen_qvariant_types.QVariantComparisonHelper =
  let tmp = gen_qvariant_types.QVariantComparisonHelper(h: fcQVariantComparisonHelper_new2(param1.h))
  tmp
...
proc create*(T: type gen_qvariant_types.QSequentialIterableconst_iterator,
  ...
  let tmp = gen_qvariant_types.QSequentialIterableconst_iterator(h: fcQSequentialIterableconst_iterator_new(other.h))
  tmp
...
proc create*(T: type gen_qvariant_types.QAssociativeIterableconst_iterator,
  ...
  let tmp = gen_qvariant_types.QAssociativeIterableconst_iterator(h: fcQAssociativeIterableconst_iterator_new(other.h))
  tmp
