...
proc create*(T: type gen_qvariant_types.QVariant,
  ...
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new20(struct_seaqt_map(len: csize_t(len(map)),keys: if len(map) == 0: nil else: addr(map_Keys_CArray[0]), values: if len(map) == 0: nil else: addr(map_Values_CArray[0]),)))
  tmp
proc create2*(T: type gen_qvariant_types.QVariant,
  ...
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new21(struct_seaqt_map(len: csize_t(len(hash)),keys: if len(hash) == 0: nil else: addr(hash_Keys_CArray[0]), values: if len(hash) == 0: nil else: addr(hash_Values_CArray[0]),)))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    size: gen_qsize_types.QSize): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new22(size.h))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
...
proc create*(T: type gen_qvariant_types.QVariant,
  ...
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new24(pt.h))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
...
proc create*(T: type gen_qvariant_types.QVariant,
  ...
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new26(line.h))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
...
proc create*(T: type gen_qvariant_types.QVariant,
  ...
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new28(rect.h))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
...
proc create*(T: type gen_qvariant_types.QVariant,
  ...
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new30(locale.h))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    re: gen_qregularexpression_types.QRegularExpression): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new31(re.h))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    easing: gen_qeasingcurve_types.QEasingCurve): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new32(easing.h))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    uuid: gen_quuid_types.QUuid): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new33(uuid.h))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    url: gen_qurl_types.QUrl): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new34(url.h))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    jsonValue: gen_qjsonvalue_types.QJsonValue): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new35(jsonValue.h))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    jsonObject: gen_qjsonobject_types.QJsonObject): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new36(jsonObject.h))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    jsonArray: gen_qjsonarray_types.QJsonArray): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new37(jsonArray.h))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    jsonDocument: gen_qjsondocument_types.QJsonDocument): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new38(jsonDocument.h))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    modelIndex: gen_qabstractitemmodel_types.QModelIndex): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new39(modelIndex.h))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
...
proc create2*(T: type gen_qvariant_types.QVariant,
  ...
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new41(cint(typeVal)))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
    typeVal: gen_qmetatype_types.QMetaType, copy: pointer): gen_qvariant_types.QVariant =
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new42(typeVal.h, copy))
  tmp
proc create*(T: type gen_qvariant_types.QVariant,
  ...
  let tmp = gen_qvariant_types.QVariant(h: fcQVariant_new43(struct_seaqt_array(len: csize_t(len(list)), data: if len(list) == 0: nil else: addr(list_CArray[0]))))
  tmp
