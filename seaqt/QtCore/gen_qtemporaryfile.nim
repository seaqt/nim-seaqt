...
proc miqt_exec_method_cQTemporaryFile_skipData(vtbl: pointer, inst: pointer, maxSize: clonglong): clonglong {.cdecl.} =
  let vtbl = cast[VirtualQTemporaryFile](cast[uint](vtbl) - uint(offsetOf(VirtualQTemporaryFile, vtbl)))
  let slotval1 = maxSize
...
proc create*(T: type gen_qtemporaryfile_types.QTemporaryFile,
  ...
  vtbl[].vtbl.skipData = miqt_exec_method_cQTemporaryFile_skipData
