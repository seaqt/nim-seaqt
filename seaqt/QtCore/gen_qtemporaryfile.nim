...
proc createLocalFile*(_: type gen_qtemporaryfile_types.QTemporaryFile, fileName: openArray[char]): gen_qtemporaryfile_types.QTemporaryFile =
  gen_qtemporaryfile_types.QTemporaryFile(h: fcQTemporaryFile_createLocalFile(struct_seaqt_string(data: if len(fileName) > 0: addr fileName[0] else: nil, len: csize_t(len(fileName)))))
...
proc createNativeFile*(_: type gen_qtemporaryfile_types.QTemporaryFile, fileName: openArray[char]): gen_qtemporaryfile_types.QTemporaryFile =
  gen_qtemporaryfile_types.QTemporaryFile(h: fcQTemporaryFile_createNativeFile(struct_seaqt_string(data: if len(fileName) > 0: addr fileName[0] else: nil, len: csize_t(len(fileName)))))
...
proc create*(T: type gen_qtemporaryfile_types.QTemporaryFile,
  ...
  let tmp = gen_qtemporaryfile_types.QTemporaryFile(h: fcQTemporaryFile_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))))
...
proc create*(T: type gen_qtemporaryfile_types.QTemporaryFile,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQTemporaryFile_vtable_callback_disconnectNotify
  let tmp = gen_qtemporaryfile_types.QTemporaryFile(h: fcQTemporaryFile_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(templateName) > 0: addr templateName[0] else: nil, len: csize_t(len(templateName)))))
  fcQTemporaryFile_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qtemporaryfile_types.QTemporaryFile,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQTemporaryFile_vtable_callback_disconnectNotify
  let tmp = gen_qtemporaryfile_types.QTemporaryFile(h: fcQTemporaryFile_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h))
  fcQTemporaryFile_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qtemporaryfile_types.QTemporaryFile,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQTemporaryFile_vtable_callback_disconnectNotify
  let tmp = gen_qtemporaryfile_types.QTemporaryFile(h: fcQTemporaryFile_new4(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(templateName) > 0: addr templateName[0] else: nil, len: csize_t(len(templateName))), parent.h))
  fcQTemporaryFile_vdata(tmp.h)[] = addr(vtbl[])
  tmp
