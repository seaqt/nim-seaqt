...
{.compile("gen_qmimedata.cpp", QtCoreCFlags).}
...
proc fcQMimeData_text(self: pointer): struct_seaqt_string {.importc: "QMimeData_text".}
proc fcQMimeData_setText(self: pointer, text: struct_seaqt_string): void {.importc: "QMimeData_setText".}
proc fcQMimeData_hasText(self: pointer): bool {.importc: "QMimeData_hasText".}
proc fcQMimeData_html(self: pointer): struct_seaqt_string {.importc: "QMimeData_html".}
proc fcQMimeData_setHtml(self: pointer, html: struct_seaqt_string): void {.importc: "QMimeData_setHtml".}
...
proc fcQMimeData_data(self: pointer, mimetype: struct_seaqt_string): struct_seaqt_string {.importc: "QMimeData_data".}
proc fcQMimeData_setData(self: pointer, mimetype: struct_seaqt_string, data: struct_seaqt_string): void {.importc: "QMimeData_setData".}
proc fcQMimeData_removeFormat(self: pointer, mimetype: struct_seaqt_string): void {.importc: "QMimeData_removeFormat".}
...
type cQMimeDataVTable {.pure.} = object
  ...
  hasFormat*: proc(self: pointer, mimetype: struct_seaqt_string): bool {.cdecl, raises: [], gcsafe.}
  formats*: proc(self: pointer): struct_seaqt_array {.cdecl, raises: [], gcsafe.}
  retrieveData*: proc(self: pointer, mimetype: struct_seaqt_string, preferredType: cint): pointer {.cdecl, raises: [], gcsafe.}
...
proc fcQMimeData_virtualbase_hasFormat(self: pointer, mimetype: struct_seaqt_string): bool {.importc: "QMimeData_virtualbase_hasFormat".}
proc fcQMimeData_virtualbase_formats(self: pointer): struct_seaqt_array {.importc: "QMimeData_virtualbase_formats".}
proc fcQMimeData_virtualbase_retrieveData(self: pointer, mimetype: struct_seaqt_string, preferredType: cint): pointer {.importc: "QMimeData_virtualbase_retrieveData".}
...
proc setUrls*(self: gen_qmimedata_types.QMimeData, urls: openArray[gen_qurl_types.QUrl]): void =
  ...
  fcQMimeData_setUrls(self.h, struct_seaqt_array(len: csize_t(len(urls)), data: if len(urls) == 0: nil else: addr(urls_CArray[0])))
...
proc setText*(self: gen_qmimedata_types.QMimeData, text: openArray[char]): void =
  fcQMimeData_setText(self.h, struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))))
...
proc setHtml*(self: gen_qmimedata_types.QMimeData, html: openArray[char]): void =
  fcQMimeData_setHtml(self.h, struct_seaqt_string(data: if len(html) > 0: addr html[0] else: nil, len: csize_t(len(html))))
...
proc data*(self: gen_qmimedata_types.QMimeData, mimetype: openArray[char]): seq[byte] =
  var v_bytearray = fcQMimeData_data(self.h, struct_seaqt_string(data: if len(mimetype) > 0: addr mimetype[0] else: nil, len: csize_t(len(mimetype))))
  var vx_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](v_bytearray.data), 0, int(v_bytearray.len)-1))
  c_free(v_bytearray.data)
  vx_ret

proc setData*(self: gen_qmimedata_types.QMimeData, mimetype: openArray[char], data: openArray[byte]): void =
  fcQMimeData_setData(self.h, struct_seaqt_string(data: if len(mimetype) > 0: addr mimetype[0] else: nil, len: csize_t(len(mimetype))), struct_seaqt_string(data: if len(data) > 0: addr data[0] else: nil, len: csize_t(len(data))))

proc removeFormat*(self: gen_qmimedata_types.QMimeData, mimetype: openArray[char]): void =
  fcQMimeData_removeFormat(self.h, struct_seaqt_string(data: if len(mimetype) > 0: addr mimetype[0] else: nil, len: csize_t(len(mimetype))))

proc hasFormat*(self: gen_qmimedata_types.QMimeData, mimetype: openArray[char]): bool =
  fcQMimeData_hasFormat(self.h, struct_seaqt_string(data: if len(mimetype) > 0: addr mimetype[0] else: nil, len: csize_t(len(mimetype))))
...
type QMimeDataretrieveDataProc* = proc(self: QMimeData, mimetype: openArray[char], preferredType: cint): gen_qvariant_types.QVariant {.raises: [], gcsafe.}
...
proc QMimeDatahasFormat*(self: gen_qmimedata_types.QMimeData, mimetype: openArray[char]): bool =
  fcQMimeData_virtualbase_hasFormat(self.h, struct_seaqt_string(data: if len(mimetype) > 0: addr mimetype[0] else: nil, len: csize_t(len(mimetype))))
...
proc QMimeDataretrieveData*(self: gen_qmimedata_types.QMimeData, mimetype: openArray[char], preferredType: cint): gen_qvariant_types.QVariant =
  gen_qvariant_types.QVariant(h: fcQMimeData_virtualbase_retrieveData(self.h, struct_seaqt_string(data: if len(mimetype) > 0: addr mimetype[0] else: nil, len: csize_t(len(mimetype))), cint(preferredType)), owned: true)
...
proc fcQMimeData_vtable_callback_metaObject(self: pointer): pointer {.cdecl.} =
...
proc fcQMimeData_vtable_callback_metacall(self: pointer, param1: cint, param2: cint, param3: pointer): cint {.cdecl.} =
  let vtbl = cast[ptr QMimeDataVTable](fcQMimeData_vdata(self)[])
  let self = QMimeData(h: self)
...
proc fcQMimeData_vtable_callback_hasFormat(self: pointer, mimetype: struct_seaqt_string): bool {.cdecl.} =
  let vtbl = cast[ptr QMimeDataVTable](fcQMimeData_vdata(self)[])
  let self = QMimeData(h: self)
...
proc fcQMimeData_vtable_callback_formats(self: pointer): struct_seaqt_array {.cdecl.} =
  let vtbl = cast[ptr QMimeDataVTable](fcQMimeData_vdata(self)[])
  let self = QMimeData(h: self)
...
proc fcQMimeData_vtable_callback_retrieveData(self: pointer, mimetype: struct_seaqt_string, preferredType: cint): pointer {.cdecl.} =
  let vtbl = cast[ptr QMimeDataVTable](fcQMimeData_vdata(self)[])
  let self = QMimeData(h: self)
  let vmimetype_ms = mimetype
  let vmimetypex_ret = string.fromBytes(vmimetype_ms)
...
method retrieveData*(self: VirtualQMimeData, mimetype: openArray[char], preferredType: cint): gen_qvariant_types.QVariant {.base.} =
...
proc fcQMimeData_method_callback_metacall(self: pointer, param1: cint, param2: cint, param3: pointer): cint {.cdecl.} =
  let inst = cast[VirtualQMimeData](fcQMimeData_vdata(self)[])
  let slotval1 = cint(param1)
  let slotval2 = param2
  let slotval3 = param3
...
proc fcQMimeData_method_callback_hasFormat(self: pointer, mimetype: struct_seaqt_string): bool {.cdecl.} =
  let inst = cast[VirtualQMimeData](fcQMimeData_vdata(self)[])
  let vmimetype_ms = mimetype
  let vmimetypex_ret = string.fromBytes(vmimetype_ms)
  c_free(vmimetype_ms.data)
...
proc fcQMimeData_method_callback_formats(self: pointer): struct_seaqt_array {.cdecl.} =
  let inst = cast[VirtualQMimeData](fcQMimeData_vdata(self)[])
...
proc fcQMimeData_method_callback_retrieveData(self: pointer, mimetype: struct_seaqt_string, preferredType: cint): pointer {.cdecl.} =
  let inst = cast[VirtualQMimeData](fcQMimeData_vdata(self)[])
  let vmimetype_ms = mimetype
  let vmimetypex_ret = string.fromBytes(vmimetype_ms)
  c_free(vmimetype_ms.data)
...
proc create*(T: type gen_qmimedata_types.QMimeData,
  ...
  if not isNil(vtbl[].metaObject):
    vtbl[].vtbl.metaObject = fcQMimeData_vtable_callback_metaObject
  if not isNil(vtbl[].metacast):
    vtbl[].vtbl.metacast = fcQMimeData_vtable_callback_metacast
  if not isNil(vtbl[].metacall):
    vtbl[].vtbl.metacall = fcQMimeData_vtable_callback_metacall
  if not isNil(vtbl[].hasFormat):
    vtbl[].vtbl.hasFormat = fcQMimeData_vtable_callback_hasFormat
  if not isNil(vtbl[].formats):
    vtbl[].vtbl.formats = fcQMimeData_vtable_callback_formats
  if not isNil(vtbl[].retrieveData):
    vtbl[].vtbl.retrieveData = fcQMimeData_vtable_callback_retrieveData
  if not isNil(vtbl[].event):
    vtbl[].vtbl.event = fcQMimeData_vtable_callback_event
  if not isNil(vtbl[].eventFilter):
    vtbl[].vtbl.eventFilter = fcQMimeData_vtable_callback_eventFilter
  if not isNil(vtbl[].timerEvent):
    vtbl[].vtbl.timerEvent = fcQMimeData_vtable_callback_timerEvent
  if not isNil(vtbl[].childEvent):
    vtbl[].vtbl.childEvent = fcQMimeData_vtable_callback_childEvent
  if not isNil(vtbl[].customEvent):
    vtbl[].vtbl.customEvent = fcQMimeData_vtable_callback_customEvent
...
const cQMimeData_mvtbl = cQMimeDataVTable(
  ...
  metacall: fcQMimeData_method_callback_metacall,
  hasFormat: fcQMimeData_method_callback_hasFormat,
  formats: fcQMimeData_method_callback_formats,
  retrieveData: fcQMimeData_method_callback_retrieveData,
  event: fcQMimeData_method_callback_event,
  eventFilter: fcQMimeData_method_callback_eventFilter,
  timerEvent: fcQMimeData_method_callback_timerEvent,
  childEvent: fcQMimeData_method_callback_childEvent,
  customEvent: fcQMimeData_method_callback_customEvent,
  connectNotify: fcQMimeData_method_callback_connectNotify,
  disconnectNotify: fcQMimeData_method_callback_disconnectNotify,
)
proc create*(T: type gen_qmimedata_types.QMimeData,
    inst: VirtualQMimeData) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQMimeData_new(addr(cQMimeData_mvtbl), csize_t(sizeof(pointer)))
  fcQMimeData_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
