...
proc fcQSettings_value(self: pointer, key: struct_seaqt_string, defaultValue: pointer): pointer {.importc: "QSettings_value".}
proc fcQSettings_valueWithKey(self: pointer, key: struct_seaqt_string): pointer {.importc: "QSettings_valueWithKey".}
