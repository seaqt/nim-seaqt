...
proc fcQRect_operatorAssign(self: pointer, param1: pointer): void {.importc: "QRect_operatorAssign".}
proc fcQRect_contains4(self: pointer, r: pointer, proper: bool): bool {.importc: "QRect_contains4".}
proc fcQRect_contains5(self: pointer, p: pointer, proper: bool): bool {.importc: "QRect_contains5".}
...
proc fcQRectF_operatorAssign(self: pointer, param1: pointer): void {.importc: "QRectF_operatorAssign".}
...
proc operatorAssign*(self: gen_qrect_types.QRect, param1: gen_qrect_types.QRect): void =
  fcQRect_operatorAssign(self.h, param1.h)

proc contains*(self: gen_qrect_types.QRect, r: gen_qrect_types.QRect, proper: bool): bool =
  fcQRect_contains4(self.h, r.h, proper)

proc contains*(self: gen_qrect_types.QRect, p: gen_qpoint_types.QPoint, proper: bool): bool =
  fcQRect_contains5(self.h, p.h, proper)

proc create*(T: type gen_qrect_types.QRect): gen_qrect_types.QRect =
  let tmp = gen_qrect_types.QRect(h: fcQRect_new())
  tmp
proc create*(T: type gen_qrect_types.QRect,
  ...
  let tmp = gen_qrect_types.QRect(h: fcQRect_new2(topleft.h, bottomright.h))
  tmp
proc create*(T: type gen_qrect_types.QRect,
    topleft: gen_qpoint_types.QPoint, size: gen_qsize_types.QSize): gen_qrect_types.QRect =
  let tmp = gen_qrect_types.QRect(h: fcQRect_new3(topleft.h, size.h))
  tmp
proc create*(T: type gen_qrect_types.QRect,
    left: cint, top: cint, width: cint, height: cint): gen_qrect_types.QRect =
  let tmp = gen_qrect_types.QRect(h: fcQRect_new4(left, top, width, height))
  tmp
proc create*(T: type gen_qrect_types.QRect,
    param1: gen_qrect_types.QRect): gen_qrect_types.QRect =
  let tmp = gen_qrect_types.QRect(h: fcQRect_new5(param1.h))
  tmp
...
proc operatorAssign*(self: gen_qrect_types.QRectF, param1: gen_qrect_types.QRectF): void =
  fcQRectF_operatorAssign(self.h, param1.h)

proc create*(T: type gen_qrect_types.QRectF): gen_qrect_types.QRectF =
  let tmp = gen_qrect_types.QRectF(h: fcQRectF_new())
  tmp
proc create*(T: type gen_qrect_types.QRectF,
  ...
  let tmp = gen_qrect_types.QRectF(h: fcQRectF_new2(topleft.h, size.h))
  tmp
proc create*(T: type gen_qrect_types.QRectF,
    topleft: gen_qpoint_types.QPointF, bottomRight: gen_qpoint_types.QPointF): gen_qrect_types.QRectF =
  let tmp = gen_qrect_types.QRectF(h: fcQRectF_new3(topleft.h, bottomRight.h))
  tmp
proc create*(T: type gen_qrect_types.QRectF,
    left: float64, top: float64, width: float64, height: float64): gen_qrect_types.QRectF =
  let tmp = gen_qrect_types.QRectF(h: fcQRectF_new4(left, top, width, height))
  tmp
proc create*(T: type gen_qrect_types.QRectF,
    rect: gen_qrect_types.QRect): gen_qrect_types.QRectF =
  let tmp = gen_qrect_types.QRectF(h: fcQRectF_new5(rect.h))
  tmp
proc create*(T: type gen_qrect_types.QRectF,
    param1: gen_qrect_types.QRectF): gen_qrect_types.QRectF =
  let tmp = gen_qrect_types.QRectF(h: fcQRectF_new6(param1.h))
  tmp
