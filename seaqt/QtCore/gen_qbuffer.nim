...
proc fcQBuffer_trUtf8S(s: cstring): struct_seaqt_string {.importc: "QBuffer_trUtf8_s".}
...
proc fcQBuffer_trUtf8SC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QBuffer_trUtf8_s_c".}
proc fcQBuffer_trUtf8SCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QBuffer_trUtf8_s_c_n".}
...
proc fcQBuffer_protectedbase_setErrorString(self: pointer, errorString: struct_seaqt_string): void {.importc: "QBuffer_protectedbase_setErrorString".}
...
proc setErrorString*(self: gen_qbuffer_types.QBuffer, errorString: openArray[char]): void =
  fcQBuffer_protectedbase_setErrorString(self.h, struct_seaqt_string(data: if len(errorString) > 0: addr errorString[0] else: nil, len: csize_t(len(errorString))))
