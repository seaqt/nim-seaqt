...
proc fcQBuffer_setDataDataLen(self: pointer, data: cstring, len: int64): void {.importc: "QBuffer_setData_data_len".}
...
proc setData*(self: gen_qbuffer_types.QBuffer, data: cstring, len: int64): void =
