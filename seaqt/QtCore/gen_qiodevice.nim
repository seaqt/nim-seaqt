...
proc fcQIODevice_trUtf8(s: cstring): struct_seaqt_string {.importc: "QIODevice_trUtf8".}
...
proc fcQIODevice_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QIODevice_trUtf82".}
proc fcQIODevice_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QIODevice_trUtf83".}
