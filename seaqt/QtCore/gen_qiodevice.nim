...
proc miqt_exec_method_cQIODevice_skipData(vtbl: pointer, inst: pointer, maxSize: clonglong): clonglong {.cdecl.} =
  let vtbl = cast[VirtualQIODevice](cast[uint](vtbl) - uint(offsetOf(VirtualQIODevice, vtbl)))
  let slotval1 = maxSize
...
proc create*(T: type gen_qiodevice_types.QIODevice,
  ...
  vtbl[].vtbl.skipData = miqt_exec_method_cQIODevice_skipData
