...
template Script_Kawi*(_: type QCharScriptEnum): untyped = 162
template Script_NagMundari*(_: type QCharScriptEnum): untyped = 163
template Script_Garay*(_: type QCharScriptEnum): untyped = 164
template Script_GurungKhema*(_: type QCharScriptEnum): untyped = 165
template Script_KiratRai*(_: type QCharScriptEnum): untyped = 166
template Script_OlOnal*(_: type QCharScriptEnum): untyped = 167
template Script_Sunuwar*(_: type QCharScriptEnum): untyped = 168
template Script_Todhri*(_: type QCharScriptEnum): untyped = 169
template Script_TuluTigalari*(_: type QCharScriptEnum): untyped = 170
template Script_Sidetic*(_: type QCharScriptEnum): untyped = 171
template Script_TaiYo*(_: type QCharScriptEnum): untyped = 172
template Script_TolongSiki*(_: type QCharScriptEnum): untyped = 173
template Script_BeriaErfe*(_: type QCharScriptEnum): untyped = 174
template ScriptCount*(_: type QCharScriptEnum): untyped = 175
...
template Unicode_15_0*(_: type QCharUnicodeVersionEnum): untyped = 25
template Unicode_15_1*(_: type QCharUnicodeVersionEnum): untyped = 26
template Unicode_16_0*(_: type QCharUnicodeVersionEnum): untyped = 27
template Unicode_17_0*(_: type QCharUnicodeVersionEnum): untyped = 28
...
proc fcQChar_new2(c: uint8, r: uint8): ptr cQChar {.importc: "QChar_new_c_r".}
proc fcQChar_new3(fromVal: pointer): ptr cQChar {.importc: "QChar_new_from".}
...
proc create*(T: type gen_qchar_types.QChar,
  ...
  let tmp = gen_qchar_types.QChar(h: fcQChar_new2(c, r), owned: true)
  tmp
proc create*(T: type gen_qchar_types.QChar,
    fromVal: gen_qchar_types.QChar): gen_qchar_types.QChar =
  let tmp = gen_qchar_types.QChar(h: fcQChar_new3(fromVal.h), owned: true)
  tmp
