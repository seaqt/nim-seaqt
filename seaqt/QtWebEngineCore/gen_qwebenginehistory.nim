...
proc fcQWebEngineHistoryModel_trS(s: cstring): struct_seaqt_string {.importc: "QWebEngineHistoryModel_tr_s".}
...
proc fcQWebEngineHistoryModel_roleNames(self: pointer): struct_seaqt_map {.importc: "QWebEngineHistoryModel_roleNames".}
proc fcQWebEngineHistoryModel_reset(self: pointer): void {.importc: "QWebEngineHistoryModel_reset".}
proc fcQWebEngineHistoryModel_trSC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QWebEngineHistoryModel_tr_s_c".}
proc fcQWebEngineHistoryModel_trSCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QWebEngineHistoryModel_tr_s_c_n".}
proc fcQWebEngineHistoryModel_protectedbase_createIndex_row_column(self: pointer, row: cint, column: cint): pointer {.importc: "QWebEngineHistoryModel_protectedbase_createIndex_row_column".}
proc fcQWebEngineHistoryModel_protectedbase_encodeData(self: pointer, indexes: struct_seaqt_array, stream: pointer): void {.importc: "QWebEngineHistoryModel_protectedbase_encodeData".}
...
proc fcQWebEngineHistoryModel_protectedbase_changePersistentIndexList(self: pointer, fromVal: struct_seaqt_array, to: struct_seaqt_array): void {.importc: "QWebEngineHistoryModel_protectedbase_changePersistentIndexList".}
proc fcQWebEngineHistoryModel_protectedbase_persistentIndexList(self: pointer): struct_seaqt_array {.importc: "QWebEngineHistoryModel_protectedbase_persistentIndexList".}
...
proc fcQWebEngineHistory_trS(s: cstring): struct_seaqt_string {.importc: "QWebEngineHistory_tr_s".}
...
proc fcQWebEngineHistory_trSC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QWebEngineHistory_tr_s_c".}
proc fcQWebEngineHistory_trSCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QWebEngineHistory_tr_s_c_n".}
...
proc metaObject*(self: gen_qwebenginehistory_types.QWebEngineHistoryModel): gen_qobjectdefs_types.QMetaObject =
  gen_qobjectdefs_types.QMetaObject(h: fcQWebEngineHistoryModel_metaObject(self.h), owned: false)
...
proc tr*(_: type gen_qwebenginehistory_types.QWebEngineHistoryModel, s: cstring): string =
  let v_ms = fcQWebEngineHistoryModel_trS(s)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc data*(self: gen_qwebenginehistory_types.QWebEngineHistoryModel, index: gen_qabstractitemmodel_types.QModelIndex, role: cint): gen_qvariant_types.QVariant =
  gen_qvariant_types.QVariant(h: fcQWebEngineHistoryModel_data(self.h, index.h, role), owned: true)
...
proc createIndex*(self: gen_qwebenginehistory_types.QWebEngineHistoryModel, row: cint, column: cint): gen_qabstractitemmodel_types.QModelIndex =
  gen_qabstractitemmodel_types.QModelIndex(h: fcQWebEngineHistoryModel_protectedbase_createIndex_row_column(self.h, row, column), owned: true)

proc encodeData*(self: gen_qwebenginehistory_types.QWebEngineHistoryModel, indexes: openArray[gen_qabstractitemmodel_types.QModelIndex], stream: gen_qdatastream_types.QDataStream): void =
  var indexes_CArray = newSeq[pointer](len(indexes))
  for i in 0..<len(indexes):
    indexes_CArray[i] = indexes[i].h

  fcQWebEngineHistoryModel_protectedbase_encodeData(self.h, struct_seaqt_array(len: csize_t(len(indexes)), data: if len(indexes) == 0: nil else: addr(indexes_CArray[0])), stream.h)
...
proc changePersistentIndexList*(self: gen_qwebenginehistory_types.QWebEngineHistoryModel, fromVal: openArray[gen_qabstractitemmodel_types.QModelIndex], to: openArray[gen_qabstractitemmodel_types.QModelIndex]): void =
  ...
  fcQWebEngineHistoryModel_protectedbase_changePersistentIndexList(self.h, struct_seaqt_array(len: csize_t(len(fromVal)), data: if len(fromVal) == 0: nil else: addr(fromVal_CArray[0])), struct_seaqt_array(len: csize_t(len(to)), data: if len(to) == 0: nil else: addr(to_CArray[0])))
...
proc sender*(self: gen_qwebenginehistory_types.QWebEngineHistoryModel): gen_qobject_types.QObject =
  gen_qobject_types.QObject(h: fcQWebEngineHistoryModel_protectedbase_sender(self.h), owned: false)
...
proc metaObject*(self: gen_qwebenginehistory_types.QWebEngineHistory): gen_qobjectdefs_types.QMetaObject =
  gen_qobjectdefs_types.QMetaObject(h: fcQWebEngineHistory_metaObject(self.h), owned: false)
...
proc tr*(_: type gen_qwebenginehistory_types.QWebEngineHistory, s: cstring): string =
  let v_ms = fcQWebEngineHistory_trS(s)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc itemsModel*(self: gen_qwebenginehistory_types.QWebEngineHistory): gen_qwebenginehistory_types.QWebEngineHistoryModel =
  gen_qwebenginehistory_types.QWebEngineHistoryModel(h: fcQWebEngineHistory_itemsModel(self.h), owned: false)
...
proc backItemsModel*(self: gen_qwebenginehistory_types.QWebEngineHistory): gen_qwebenginehistory_types.QWebEngineHistoryModel =
  gen_qwebenginehistory_types.QWebEngineHistoryModel(h: fcQWebEngineHistory_backItemsModel(self.h), owned: false)
...
proc forwardItemsModel*(self: gen_qwebenginehistory_types.QWebEngineHistory): gen_qwebenginehistory_types.QWebEngineHistoryModel =
  gen_qwebenginehistory_types.QWebEngineHistoryModel(h: fcQWebEngineHistory_forwardItemsModel(self.h), owned: false)

proc tr*(_: type gen_qwebenginehistory_types.QWebEngineHistory, s: cstring, c: cstring): string =
  let v_ms = fcQWebEngineHistory_trSC(s, c)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret

proc tr*(_: type gen_qwebenginehistory_types.QWebEngineHistory, s: cstring, c: cstring, n: cint): string =
  let v_ms = fcQWebEngineHistory_trSCN(s, c, n)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret

proc sender*(self: gen_qwebenginehistory_types.QWebEngineHistory): gen_qobject_types.QObject =
  gen_qobject_types.QObject(h: fcQWebEngineHistory_protectedbase_sender(self.h), owned: false)
