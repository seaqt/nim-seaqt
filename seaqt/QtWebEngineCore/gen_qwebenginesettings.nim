...
template ReadingFromCanvasEnabled*(_: type QWebEngineSettingsWebAttributeEnum): untyped = 32
template ForceDarkMode*(_: type QWebEngineSettingsWebAttributeEnum): untyped = 33
template PrintHeaderAndFooter*(_: type QWebEngineSettingsWebAttributeEnum): untyped = 34
template PreferCSSMarginsForPrinting*(_: type QWebEngineSettingsWebAttributeEnum): untyped = 35
template TouchEventsApiEnabled*(_: type QWebEngineSettingsWebAttributeEnum): untyped = 36
template BackForwardCacheEnabled*(_: type QWebEngineSettingsWebAttributeEnum): untyped = 37
template TrimAccessibilityIdentifiers*(_: type QWebEngineSettingsWebAttributeEnum): untyped = 38
...
type QWebEngineSettingsImageAnimationPolicyEnum* = distinct uint8
template Inherited*(_: type QWebEngineSettingsImageAnimationPolicyEnum): untyped = 0
template Allow*(_: type QWebEngineSettingsImageAnimationPolicyEnum): untyped = 1
template AnimateOnce*(_: type QWebEngineSettingsImageAnimationPolicyEnum): untyped = 2
template Disallow*(_: type QWebEngineSettingsImageAnimationPolicyEnum): untyped = 3
...
proc fcQWebEngineSettings_setFontFamily(self: pointer, which: cint, family: struct_seaqt_string): void {.importc: "QWebEngineSettings_setFontFamily".}
proc fcQWebEngineSettings_fontFamily(self: pointer, which: cint): struct_seaqt_string {.importc: "QWebEngineSettings_fontFamily".}
...
proc fcQWebEngineSettings_setDefaultTextEncoding(self: pointer, encoding: struct_seaqt_string): void {.importc: "QWebEngineSettings_setDefaultTextEncoding".}
proc fcQWebEngineSettings_defaultTextEncoding(self: pointer): struct_seaqt_string {.importc: "QWebEngineSettings_defaultTextEncoding".}
...
proc fcQWebEngineSettings_setImageAnimationPolicy(self: pointer, policy: cint): void {.importc: "QWebEngineSettings_setImageAnimationPolicy".}
proc fcQWebEngineSettings_imageAnimationPolicy(self: pointer): cint {.importc: "QWebEngineSettings_imageAnimationPolicy".}
proc fcQWebEngineSettings_resetImageAnimationPolicy(self: pointer): void {.importc: "QWebEngineSettings_resetImageAnimationPolicy".}
...
proc setDefaultTextEncoding*(self: gen_qwebenginesettings_types.QWebEngineSettings, encoding: openArray[char]): void =
  fcQWebEngineSettings_setDefaultTextEncoding(self.h, struct_seaqt_string(data: if len(encoding) > 0: addr encoding[0] else: nil, len: csize_t(len(encoding))))
...
proc setImageAnimationPolicy*(self: gen_qwebenginesettings_types.QWebEngineSettings, policy: cint): void =
  fcQWebEngineSettings_setImageAnimationPolicy(self.h, cint(policy))

proc imageAnimationPolicy*(self: gen_qwebenginesettings_types.QWebEngineSettings): cint =
  cint(fcQWebEngineSettings_imageAnimationPolicy(self.h))

proc resetImageAnimationPolicy*(self: gen_qwebenginesettings_types.QWebEngineSettings): void =
  fcQWebEngineSettings_resetImageAnimationPolicy(self.h)
