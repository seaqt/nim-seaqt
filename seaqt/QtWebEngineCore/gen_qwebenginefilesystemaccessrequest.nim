...
proc fcQWebEngineFileSystemAccessRequest_operatorAssign(self: pointer, fromVal: pointer): void {.importc: "QWebEngineFileSystemAccessRequest_operatorAssign".}
...
proc fcQWebEngineFileSystemAccessRequest_new(): ptr cQWebEngineFileSystemAccessRequest {.importc: "QWebEngineFileSystemAccessRequest_new".}
proc fcQWebEngineFileSystemAccessRequest_new2(fromVal: pointer): ptr cQWebEngineFileSystemAccessRequest {.importc: "QWebEngineFileSystemAccessRequest_new_from".}
...
proc operatorAssign*(self: gen_qwebenginefilesystemaccessrequest_types.QWebEngineFileSystemAccessRequest, fromVal: gen_qwebenginefilesystemaccessrequest_types.QWebEngineFileSystemAccessRequest): void =
  fcQWebEngineFileSystemAccessRequest_operatorAssign(self.h, fromVal.h)
...
proc create*(T: type gen_qwebenginefilesystemaccessrequest_types.QWebEngineFileSystemAccessRequest): gen_qwebenginefilesystemaccessrequest_types.QWebEngineFileSystemAccessRequest =
  let tmp = gen_qwebenginefilesystemaccessrequest_types.QWebEngineFileSystemAccessRequest(h: fcQWebEngineFileSystemAccessRequest_new(), owned: true)
  tmp
proc create*(T: type gen_qwebenginefilesystemaccessrequest_types.QWebEngineFileSystemAccessRequest,
    fromVal: gen_qwebenginefilesystemaccessrequest_types.QWebEngineFileSystemAccessRequest): gen_qwebenginefilesystemaccessrequest_types.QWebEngineFileSystemAccessRequest =
  let tmp = gen_qwebenginefilesystemaccessrequest_types.QWebEngineFileSystemAccessRequest(h: fcQWebEngineFileSystemAccessRequest_new2(fromVal.h), owned: true)
  tmp
