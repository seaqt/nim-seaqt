...
proc fcQWebEngineUrlRequestInterceptor_trUtf8S(s: cstring): struct_seaqt_string {.importc: "QWebEngineUrlRequestInterceptor_trUtf8_s".}
...
proc fcQWebEngineUrlRequestInterceptor_trUtf8SC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QWebEngineUrlRequestInterceptor_trUtf8_s_c".}
proc fcQWebEngineUrlRequestInterceptor_trUtf8SCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QWebEngineUrlRequestInterceptor_trUtf8_s_c_n".}
...
proc trUtf8*(_: type gen_qwebengineurlrequestinterceptor_types.QWebEngineUrlRequestInterceptor, s: cstring): string =
  let v_ms = fcQWebEngineUrlRequestInterceptor_trUtf8S(s)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc trUtf8*(_: type gen_qwebengineurlrequestinterceptor_types.QWebEngineUrlRequestInterceptor, s: cstring, c: cstring): string =
  let v_ms = fcQWebEngineUrlRequestInterceptor_trUtf8SC(s, c)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc trUtf8*(_: type gen_qwebengineurlrequestinterceptor_types.QWebEngineUrlRequestInterceptor, s: cstring, c: cstring, n: cint): string =
  let v_ms = fcQWebEngineUrlRequestInterceptor_trUtf8SCN(s, c, n)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc create*(T: type gen_qwebengineurlrequestinterceptor_types.QWebEngineUrlRequestInterceptor,
  ...
  let tmp = gen_qwebengineurlrequestinterceptor_types.QWebEngineUrlRequestInterceptor(h: fcQWebEngineUrlRequestInterceptor_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQWebEngineUrlRequestInterceptor_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qwebengineurlrequestinterceptor_types.QWebEngineUrlRequestInterceptor,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQWebEngineUrlRequestInterceptor_vtable_callback_disconnectNotify
  let tmp = gen_qwebengineurlrequestinterceptor_types.QWebEngineUrlRequestInterceptor(h: fcQWebEngineUrlRequestInterceptor_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), p.h), owned: true)
  fcQWebEngineUrlRequestInterceptor_vdata(tmp.h)[] = addr(vtbl[])
  tmp
