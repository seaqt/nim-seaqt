...
proc fcQWebEngineUrlRequestInterceptor_trUtf8(s: cstring): struct_seaqt_string {.importc: "QWebEngineUrlRequestInterceptor_trUtf8".}
...
proc fcQWebEngineUrlRequestInterceptor_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QWebEngineUrlRequestInterceptor_trUtf82".}
proc fcQWebEngineUrlRequestInterceptor_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QWebEngineUrlRequestInterceptor_trUtf83".}
