...
{.compile("gen_qwebenginecontextmenurequest.cpp", QtWebEngineCoreCFlags).}
...
proc fcQWebEngineContextMenuRequest_misspelledWord(self: pointer): struct_seaqt_string {.importc: "QWebEngineContextMenuRequest_misspelledWord".}
proc fcQWebEngineContextMenuRequest_spellCheckerSuggestions(self: pointer): struct_seaqt_array {.importc: "QWebEngineContextMenuRequest_spellCheckerSuggestions".}
