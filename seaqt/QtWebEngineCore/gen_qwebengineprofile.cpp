...
VirtualQWebEngineProfile* QWebEngineProfile_new(const QWebEngineProfile_VTable* vtbl, size_t vdata) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQWebEngineProfile>());
	return _mem_ ? new (_mem_)VirtualQWebEngineProfile(vtbl) : nullptr;
}

VirtualQWebEngineProfile* QWebEngineProfile_new2(const QWebEngineProfile_VTable* vtbl, size_t vdata, struct miqt_string name) {
...
VirtualQWebEngineProfile* QWebEngineProfile_new4(const QWebEngineProfile_VTable* vtbl, size_t vdata, struct miqt_string name, QObject* parent) {
	QString name_QString = QString::fromUtf8(name.data, name.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQWebEngineProfile>());
