...
template Ok*(_: type QWebEngineCertificateErrorTypeEnum): untyped = 0
...
proc fcQWebEngineCertificateError_description(self: pointer): struct_seaqt_string {.importc: "QWebEngineCertificateError_description".}
proc fcQWebEngineCertificateError_isMainFrame(self: pointer): bool {.importc: "QWebEngineCertificateError_isMainFrame".}
...
proc fcQWebEngineCertificateError_new(): ptr cQWebEngineCertificateError {.importc: "QWebEngineCertificateError_new".}
...
proc isMainFrame*(self: gen_qwebenginecertificateerror_types.QWebEngineCertificateError): bool =
  fcQWebEngineCertificateError_isMainFrame(self.h)
...
proc create*(T: type gen_qwebenginecertificateerror_types.QWebEngineCertificateError): gen_qwebenginecertificateerror_types.QWebEngineCertificateError =
  let tmp = gen_qwebenginecertificateerror_types.QWebEngineCertificateError(h: fcQWebEngineCertificateError_new(), owned: true)
  tmp
