...
{.compile("gen_qwebenginenotification.cpp", QtWebEngineCoreCFlags).}
...
proc fcQWebEngineNotification_title(self: pointer): struct_seaqt_string {.importc: "QWebEngineNotification_title".}
proc fcQWebEngineNotification_message(self: pointer): struct_seaqt_string {.importc: "QWebEngineNotification_message".}
proc fcQWebEngineNotification_tag(self: pointer): struct_seaqt_string {.importc: "QWebEngineNotification_tag".}
proc fcQWebEngineNotification_language(self: pointer): struct_seaqt_string {.importc: "QWebEngineNotification_language".}
