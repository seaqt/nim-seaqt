...
{.compile("gen_qwebenginedownloadrequest.cpp", QtWebEngineCoreCFlags).}
...
proc fcQWebEngineDownloadRequest_mimeType(self: pointer): struct_seaqt_string {.importc: "QWebEngineDownloadRequest_mimeType".}
...
proc fcQWebEngineDownloadRequest_interruptReasonString(self: pointer): struct_seaqt_string {.importc: "QWebEngineDownloadRequest_interruptReasonString".}
...
proc fcQWebEngineDownloadRequest_suggestedFileName(self: pointer): struct_seaqt_string {.importc: "QWebEngineDownloadRequest_suggestedFileName".}
proc fcQWebEngineDownloadRequest_downloadDirectory(self: pointer): struct_seaqt_string {.importc: "QWebEngineDownloadRequest_downloadDirectory".}
proc fcQWebEngineDownloadRequest_setDownloadDirectory(self: pointer, directory: struct_seaqt_string): void {.importc: "QWebEngineDownloadRequest_setDownloadDirectory".}
proc fcQWebEngineDownloadRequest_downloadFileName(self: pointer): struct_seaqt_string {.importc: "QWebEngineDownloadRequest_downloadFileName".}
proc fcQWebEngineDownloadRequest_setDownloadFileName(self: pointer, fileName: struct_seaqt_string): void {.importc: "QWebEngineDownloadRequest_setDownloadFileName".}
...
proc setDownloadDirectory*(self: gen_qwebenginedownloadrequest_types.QWebEngineDownloadRequest, directory: openArray[char]): void =
  fcQWebEngineDownloadRequest_setDownloadDirectory(self.h, struct_seaqt_string(data: if len(directory) > 0: addr directory[0] else: nil, len: csize_t(len(directory))))
...
proc setDownloadFileName*(self: gen_qwebenginedownloadrequest_types.QWebEngineDownloadRequest, fileName: openArray[char]): void =
  fcQWebEngineDownloadRequest_setDownloadFileName(self.h, struct_seaqt_string(data: if len(fileName) > 0: addr fileName[0] else: nil, len: csize_t(len(fileName))))
