...
{.compile("gen_qwebenginenavigationrequest.cpp", QtWebEngineCoreCFlags).}
...
proc fcQWebEngineNavigationRequest_hasFormData(self: pointer): bool {.importc: "QWebEngineNavigationRequest_hasFormData".}
...
proc hasFormData*(self: gen_qwebenginenavigationrequest_types.QWebEngineNavigationRequest): bool =
  fcQWebEngineNavigationRequest_hasFormData(self.h)
