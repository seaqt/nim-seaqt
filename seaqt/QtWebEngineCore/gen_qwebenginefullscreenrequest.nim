...
proc fcQWebEngineFullScreenRequest_operatorAssign(self: pointer, fromVal: pointer): void {.importc: "QWebEngineFullScreenRequest_operatorAssign".}
...
proc fcQWebEngineFullScreenRequest_new(): ptr cQWebEngineFullScreenRequest {.importc: "QWebEngineFullScreenRequest_new".}
proc fcQWebEngineFullScreenRequest_new2(fromVal: pointer): ptr cQWebEngineFullScreenRequest {.importc: "QWebEngineFullScreenRequest_new_from".}
proc fcQWebEngineFullScreenRequest_staticMetaObject(): pointer {.importc: "QWebEngineFullScreenRequest_staticMetaObject".}

proc operatorAssign*(self: gen_qwebenginefullscreenrequest_types.QWebEngineFullScreenRequest, fromVal: gen_qwebenginefullscreenrequest_types.QWebEngineFullScreenRequest): void =
  fcQWebEngineFullScreenRequest_operatorAssign(self.h, fromVal.h)
...
proc create*(T: type gen_qwebenginefullscreenrequest_types.QWebEngineFullScreenRequest): gen_qwebenginefullscreenrequest_types.QWebEngineFullScreenRequest =
  let tmp = gen_qwebenginefullscreenrequest_types.QWebEngineFullScreenRequest(h: fcQWebEngineFullScreenRequest_new(), owned: true)
  tmp
proc create*(T: type gen_qwebenginefullscreenrequest_types.QWebEngineFullScreenRequest,
  ...
  let tmp = gen_qwebenginefullscreenrequest_types.QWebEngineFullScreenRequest(h: fcQWebEngineFullScreenRequest_new2(fromVal.h), owned: true)
  tmp
