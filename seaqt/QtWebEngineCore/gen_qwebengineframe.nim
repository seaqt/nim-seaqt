...
proc fcQWebEngineFrame_new(fromVal: pointer): ptr cQWebEngineFrame {.importc: "QWebEngineFrame_new".}
...
proc create*(T: type gen_qwebengineframe_types.QWebEngineFrame,
  ...
  let tmp = gen_qwebengineframe_types.QWebEngineFrame(h: fcQWebEngineFrame_new(fromVal.h), owned: true)
  tmp
