...
proc fcQWebEngineDesktopMediaRequest_new(fromVal: pointer): ptr cQWebEngineDesktopMediaRequest {.importc: "QWebEngineDesktopMediaRequest_new".}
...
proc create*(T: type gen_qwebenginedesktopmediarequest_types.QWebEngineDesktopMediaRequest,
  ...
  let tmp = gen_qwebenginedesktopmediarequest_types.QWebEngineDesktopMediaRequest(h: fcQWebEngineDesktopMediaRequest_new(fromVal.h), owned: true)
  tmp
