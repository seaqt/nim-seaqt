...
proc fcQWebEnginePage_runJavaScriptWithScriptSource(self: pointer, scriptSource: struct_seaqt_string): void {.importc: "QWebEnginePage_runJavaScriptWithScriptSource".}
...
proc fcQWebEnginePage_printToPdf3(self: pointer, filePath: struct_seaqt_string, layout: pointer, ranges: pointer): void {.importc: "QWebEnginePage_printToPdf3".}
...
proc runJavaScript*(self: gen_qwebenginepage_types.QWebEnginePage, scriptSource: openArray[char]): void =
  fcQWebEnginePage_runJavaScriptWithScriptSource(self.h, struct_seaqt_string(data: if len(scriptSource) > 0: addr scriptSource[0] else: nil, len: csize_t(len(scriptSource))))
...
proc printToPdf*(self: gen_qwebenginepage_types.QWebEnginePage, filePath: openArray[char], layout: gen_qpagelayout_types.QPageLayout, ranges: gen_qpageranges_types.QPageRanges): void =
  fcQWebEnginePage_printToPdf3(self.h, struct_seaqt_string(data: if len(filePath) > 0: addr filePath[0] else: nil, len: csize_t(len(filePath))), layout.h, ranges.h)
