...
template ChangeTextDirectionLTR*(_: type QWebEnginePageWebActionEnum): untyped = 45
template ChangeTextDirectionRTL*(_: type QWebEnginePageWebActionEnum): untyped = 46
template WebActionCount*(_: type QWebEnginePageWebActionEnum): untyped = 47
...
import
  ...
  ./gen_qwebenginedesktopmediarequest_types,
  ...
  ./gen_qwebenginepermission_types,
  ...
  ./gen_qwebenginewebauthuxrequest_types
export
...
proc fcQWebEnginePage_trS(s: cstring): struct_seaqt_string {.importc: "QWebEnginePage_tr_s".}
...
proc fcQWebEnginePage_selectedText(self: pointer): struct_seaqt_string {.importc: "QWebEnginePage_selectedText".}
...
proc fcQWebEnginePage_setHtmlHtml(self: pointer, html: struct_seaqt_string): void {.importc: "QWebEnginePage_setHtml_html".}
proc fcQWebEnginePage_setContentData(self: pointer, data: struct_seaqt_string): void {.importc: "QWebEnginePage_setContent_data".}
proc fcQWebEnginePage_title(self: pointer): struct_seaqt_string {.importc: "QWebEnginePage_title".}
...
proc fcQWebEnginePage_runJavaScriptScriptSource(self: pointer, scriptSource: struct_seaqt_string): void {.importc: "QWebEnginePage_runJavaScript_scriptSource".}
...
proc fcQWebEnginePage_setWebChannel_QWebChannel(self: pointer, param1: pointer): void {.importc: "QWebEnginePage_setWebChannel_QWebChannel".}
...
proc fcQWebEnginePage_saveFilePath(self: pointer, filePath: struct_seaqt_string): void {.importc: "QWebEnginePage_save_filePath".}
...
proc fcQWebEnginePage_printToPdfFilePath(self: pointer, filePath: struct_seaqt_string): void {.importc: "QWebEnginePage_printToPdf_filePath".}
...
proc fcQWebEnginePage_devToolsId(self: pointer): struct_seaqt_string {.importc: "QWebEnginePage_devToolsId".}
...
proc fcQWebEnginePage_mainFrame(self: pointer): pointer {.importc: "QWebEnginePage_mainFrame".}
...
proc fcQWebEnginePage_linkHovered(self: pointer, url: struct_seaqt_string): void {.importc: "QWebEnginePage_linkHovered".}
proc fcQWebEnginePage_connect_linkHovered(self: pointer, slot: int, callback: proc (slot: int, url: struct_seaqt_string) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QWebEnginePage_connect_linkHovered".}
...
proc fcQWebEnginePage_permissionRequested(self: pointer, permissionRequest: pointer): void {.importc: "QWebEnginePage_permissionRequested".}
proc fcQWebEnginePage_connect_permissionRequested(self: pointer, slot: int, callback: proc (slot: int, permissionRequest: pointer) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QWebEnginePage_connect_permissionRequested".}
...
proc fcQWebEnginePage_proxyAuthenticationRequired(self: pointer, requestUrl: pointer, authenticator: pointer, proxyHost: struct_seaqt_string): void {.importc: "QWebEnginePage_proxyAuthenticationRequired".}
proc fcQWebEnginePage_connect_proxyAuthenticationRequired(self: pointer, slot: int, callback: proc (slot: int, requestUrl: pointer, authenticator: pointer, proxyHost: struct_seaqt_string) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QWebEnginePage_connect_proxyAuthenticationRequired".}
...
proc fcQWebEnginePage_desktopMediaRequested(self: pointer, request: pointer): void {.importc: "QWebEnginePage_desktopMediaRequested".}
proc fcQWebEnginePage_connect_desktopMediaRequested(self: pointer, slot: int, callback: proc (slot: int, request: pointer) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QWebEnginePage_connect_desktopMediaRequested".}
...
proc fcQWebEnginePage_titleChanged(self: pointer, title: struct_seaqt_string): void {.importc: "QWebEnginePage_titleChanged".}
proc fcQWebEnginePage_connect_titleChanged(self: pointer, slot: int, callback: proc (slot: int, title: struct_seaqt_string) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QWebEnginePage_connect_titleChanged".}
...
proc fcQWebEnginePage_zoomFactorChanged(self: pointer, factor: float64): void {.importc: "QWebEnginePage_zoomFactorChanged".}
proc fcQWebEnginePage_connect_zoomFactorChanged(self: pointer, slot: int, callback: proc (slot: int, factor: float64) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QWebEnginePage_connect_zoomFactorChanged".}
...
proc fcQWebEnginePage_pdfPrintingFinished(self: pointer, filePath: struct_seaqt_string, success: bool): void {.importc: "QWebEnginePage_pdfPrintingFinished".}
proc fcQWebEnginePage_connect_pdfPrintingFinished(self: pointer, slot: int, callback: proc (slot: int, filePath: struct_seaqt_string, success: bool) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QWebEnginePage_connect_pdfPrintingFinished".}
...
proc fcQWebEnginePage_printRequestedByFrame(self: pointer, frame: pointer): void {.importc: "QWebEnginePage_printRequestedByFrame".}
proc fcQWebEnginePage_connect_printRequestedByFrame(self: pointer, slot: int, callback: proc (slot: int, frame: pointer) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QWebEnginePage_connect_printRequestedByFrame".}
...
proc fcQWebEnginePage_QAboutToDelete(self: pointer): void {.importc: "QWebEnginePage__q_aboutToDelete".}
proc fcQWebEnginePage_connect_QAboutToDelete(self: pointer, slot: int, callback: proc (slot: int) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QWebEnginePage_connect__q_aboutToDelete".}
proc fcQWebEnginePage_webAuthUxRequested(self: pointer, request: pointer): void {.importc: "QWebEnginePage_webAuthUxRequested".}
proc fcQWebEnginePage_connect_webAuthUxRequested(self: pointer, slot: int, callback: proc (slot: int, request: pointer) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QWebEnginePage_connect_webAuthUxRequested".}
proc fcQWebEnginePage_trSC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QWebEnginePage_tr_s_c".}
proc fcQWebEnginePage_trSCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QWebEnginePage_tr_s_c_n".}
proc fcQWebEnginePage_findTextSubStringOptions(self: pointer, subString: struct_seaqt_string, options: cint): void {.importc: "QWebEnginePage_findText_subString_options".}
proc fcQWebEnginePage_downloadUrlFilename(self: pointer, url: pointer, filename: struct_seaqt_string): void {.importc: "QWebEnginePage_download_url_filename".}
proc fcQWebEnginePage_setHtmlHtmlBaseUrl(self: pointer, html: struct_seaqt_string, baseUrl: pointer): void {.importc: "QWebEnginePage_setHtml_html_baseUrl".}
proc fcQWebEnginePage_setContentDataMimeType(self: pointer, data: struct_seaqt_string, mimeType: struct_seaqt_string): void {.importc: "QWebEnginePage_setContent_data_mimeType".}
proc fcQWebEnginePage_setContentDataMimeTypeBaseUrl(self: pointer, data: struct_seaqt_string, mimeType: struct_seaqt_string, baseUrl: pointer): void {.importc: "QWebEnginePage_setContent_data_mimeType_baseUrl".}
proc fcQWebEnginePage_runJavaScriptScriptSourceWorldId(self: pointer, scriptSource: struct_seaqt_string, worldId: cuint): void {.importc: "QWebEnginePage_runJavaScript_scriptSource_worldId".}
proc fcQWebEnginePage_setWebChannel_QWebChannelQuint32(self: pointer, param1: pointer, worldId: cuint): void {.importc: "QWebEnginePage_setWebChannel_QWebChannel_quint32".}
proc fcQWebEnginePage_saveFilePathFormat(self: pointer, filePath: struct_seaqt_string, format: cint): void {.importc: "QWebEnginePage_save_filePath_format".}
proc fcQWebEnginePage_printToPdfFilePathLayout(self: pointer, filePath: struct_seaqt_string, layout: pointer): void {.importc: "QWebEnginePage_printToPdf_filePath_layout".}
proc fcQWebEnginePage_printToPdfFilePathLayoutRanges(self: pointer, filePath: struct_seaqt_string, layout: pointer, ranges: pointer): void {.importc: "QWebEnginePage_printToPdf_filePath_layout_ranges".}
...
type cQWebEnginePageVTable {.pure.} = object
  ...
  chooseFiles*: proc(self: pointer, mode: cint, oldFiles: struct_seaqt_array, acceptedMimeTypes: struct_seaqt_array): struct_seaqt_array {.cdecl, raises: [], gcsafe.}
  javaScriptAlert*: proc(self: pointer, securityOrigin: pointer, msg: struct_seaqt_string): void {.cdecl, raises: [], gcsafe.}
  javaScriptConfirm*: proc(self: pointer, securityOrigin: pointer, msg: struct_seaqt_string): bool {.cdecl, raises: [], gcsafe.}
  javaScriptConsoleMessage*: proc(self: pointer, level: cint, message: struct_seaqt_string, lineNumber: cint, sourceID: struct_seaqt_string): void {.cdecl, raises: [], gcsafe.}
...
proc fcQWebEnginePage_virtualbase_chooseFiles(self: pointer, mode: cint, oldFiles: struct_seaqt_array, acceptedMimeTypes: struct_seaqt_array): struct_seaqt_array {.importc: "QWebEnginePage_virtualbase_chooseFiles".}
proc fcQWebEnginePage_virtualbase_javaScriptAlert(self: pointer, securityOrigin: pointer, msg: struct_seaqt_string): void {.importc: "QWebEnginePage_virtualbase_javaScriptAlert".}
proc fcQWebEnginePage_virtualbase_javaScriptConfirm(self: pointer, securityOrigin: pointer, msg: struct_seaqt_string): bool {.importc: "QWebEnginePage_virtualbase_javaScriptConfirm".}
proc fcQWebEnginePage_virtualbase_javaScriptConsoleMessage(self: pointer, level: cint, message: struct_seaqt_string, lineNumber: cint, sourceID: struct_seaqt_string): void {.importc: "QWebEnginePage_virtualbase_javaScriptConsoleMessage".}
...
proc fcQWebEnginePage_new(vtbl: pointer, vdata: csize_t): ptr cQWebEnginePage {.importc: "QWebEnginePage_new".}
proc fcQWebEnginePage_new2(vtbl: pointer, vdata: csize_t, profile: pointer): ptr cQWebEnginePage {.importc: "QWebEnginePage_new_profile".}
proc fcQWebEnginePage_new3(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQWebEnginePage {.importc: "QWebEnginePage_new_parent".}
proc fcQWebEnginePage_new4(vtbl: pointer, vdata: csize_t, profile: pointer, parent: pointer): ptr cQWebEnginePage {.importc: "QWebEnginePage_new_profile_parent".}
...
proc tr*(_: type gen_qwebenginepage_types.QWebEnginePage, s: cstring): string =
  let v_ms = fcQWebEnginePage_trS(s)
...
proc replaceMisspelledWord*(self: gen_qwebenginepage_types.QWebEnginePage, replacement: openArray[char]): void =
  fcQWebEnginePage_replaceMisspelledWord(self.h, struct_seaqt_string(data: if len(replacement) > 0: addr replacement[0] else: nil, len: csize_t(len(replacement))))
...
proc load*(self: gen_qwebenginepage_types.QWebEnginePage, request: gen_qwebenginehttprequest_types.QWebEngineHttpRequest): void =
  fcQWebEnginePage_loadRequest(self.h, request.h)

proc download*(self: gen_qwebenginepage_types.QWebEnginePage, url: gen_qurl_types.QUrl): void =
  fcQWebEnginePage_downloadUrl(self.h, url.h)

proc setHtml*(self: gen_qwebenginepage_types.QWebEnginePage, html: openArray[char]): void =
  fcQWebEnginePage_setHtmlHtml(self.h, struct_seaqt_string(data: if len(html) > 0: addr html[0] else: nil, len: csize_t(len(html))))

proc setContent*(self: gen_qwebenginepage_types.QWebEnginePage, data: openArray[byte]): void =
  fcQWebEnginePage_setContentData(self.h, struct_seaqt_string(data: if len(data) > 0: addr data[0] else: nil, len: csize_t(len(data))))
...
proc runJavaScript*(self: gen_qwebenginepage_types.QWebEnginePage, scriptSource: openArray[char]): void =
  fcQWebEnginePage_runJavaScriptScriptSource(self.h, struct_seaqt_string(data: if len(scriptSource) > 0: addr scriptSource[0] else: nil, len: csize_t(len(scriptSource))))
...
proc setWebChannel*(self: gen_qwebenginepage_types.QWebEnginePage, param1: gen_qwebchannel_types.QWebChannel): void =
  fcQWebEnginePage_setWebChannel_QWebChannel(self.h, param1.h)
...
proc save*(self: gen_qwebenginepage_types.QWebEnginePage, filePath: openArray[char]): void =
  fcQWebEnginePage_saveFilePath(self.h, struct_seaqt_string(data: if len(filePath) > 0: addr filePath[0] else: nil, len: csize_t(len(filePath))))
...
proc printToPdf*(self: gen_qwebenginepage_types.QWebEnginePage, filePath: openArray[char]): void =
  fcQWebEnginePage_printToPdfFilePath(self.h, struct_seaqt_string(data: if len(filePath) > 0: addr filePath[0] else: nil, len: csize_t(len(filePath))))
...
proc devToolsId*(self: gen_qwebenginepage_types.QWebEnginePage): string =
  let v_ms = fcQWebEnginePage_devToolsId(self.h)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc mainFrame*(self: gen_qwebenginepage_types.QWebEnginePage): gen_qwebengineframe_types.QWebEngineFrame =
  gen_qwebengineframe_types.QWebEngineFrame(h: fcQWebEnginePage_mainFrame(self.h), owned: true)
...
proc linkHovered*(self: gen_qwebenginepage_types.QWebEnginePage, url: openArray[char]): void =
  fcQWebEnginePage_linkHovered(self.h, struct_seaqt_string(data: if len(url) > 0: addr url[0] else: nil, len: csize_t(len(url))))

type QWebEnginePagelinkHoveredSlot* = proc(url: openArray[char])
proc fcQWebEnginePage_slot_callback_linkHovered(slot: int, url: struct_seaqt_string) {.cdecl.} =
...
proc permissionRequested*(self: gen_qwebenginepage_types.QWebEnginePage, permissionRequest: gen_qwebenginepermission_types.QWebEnginePermission): void =
  fcQWebEnginePage_permissionRequested(self.h, permissionRequest.h)

type QWebEnginePagepermissionRequestedSlot* = proc(permissionRequest: gen_qwebenginepermission_types.QWebEnginePermission)
proc fcQWebEnginePage_slot_callback_permissionRequested(slot: int, permissionRequest: pointer) {.cdecl.} =
  let nimfunc = cast[ptr QWebEnginePagepermissionRequestedSlot](cast[pointer](slot))
  let slotval1 = gen_qwebenginepermission_types.QWebEnginePermission(h: permissionRequest, owned: true)

  nimfunc[](slotval1)

proc fcQWebEnginePage_slot_callback_permissionRequested_release(slot: int) {.cdecl.} =
  let nimfunc = cast[ref QWebEnginePagepermissionRequestedSlot](cast[pointer](slot))
  GC_unref(nimfunc)

proc onPermissionRequested*(self: gen_qwebenginepage_types.QWebEnginePage, slot: QWebEnginePagepermissionRequestedSlot) =
  var tmp = new QWebEnginePagepermissionRequestedSlot
  tmp[] = slot
  GC_ref(tmp)
  fcQWebEnginePage_connect_permissionRequested(self.h, cast[int](addr tmp[]), fcQWebEnginePage_slot_callback_permissionRequested, fcQWebEnginePage_slot_callback_permissionRequested_release)
...
proc proxyAuthenticationRequired*(self: gen_qwebenginepage_types.QWebEnginePage, requestUrl: gen_qurl_types.QUrl, authenticator: gen_qauthenticator_types.QAuthenticator, proxyHost: openArray[char]): void =
  fcQWebEnginePage_proxyAuthenticationRequired(self.h, requestUrl.h, authenticator.h, struct_seaqt_string(data: if len(proxyHost) > 0: addr proxyHost[0] else: nil, len: csize_t(len(proxyHost))))
...
proc fcQWebEnginePage_slot_callback_proxyAuthenticationRequired(slot: int, requestUrl: pointer, authenticator: pointer, proxyHost: struct_seaqt_string) {.cdecl.} =
...
proc desktopMediaRequested*(self: gen_qwebenginepage_types.QWebEnginePage, request: gen_qwebenginedesktopmediarequest_types.QWebEngineDesktopMediaRequest): void =
  fcQWebEnginePage_desktopMediaRequested(self.h, request.h)

type QWebEnginePagedesktopMediaRequestedSlot* = proc(request: gen_qwebenginedesktopmediarequest_types.QWebEngineDesktopMediaRequest)
proc fcQWebEnginePage_slot_callback_desktopMediaRequested(slot: int, request: pointer) {.cdecl.} =
  let nimfunc = cast[ptr QWebEnginePagedesktopMediaRequestedSlot](cast[pointer](slot))
  let slotval1 = gen_qwebenginedesktopmediarequest_types.QWebEngineDesktopMediaRequest(h: request, owned: false)

  nimfunc[](slotval1)

proc fcQWebEnginePage_slot_callback_desktopMediaRequested_release(slot: int) {.cdecl.} =
  let nimfunc = cast[ref QWebEnginePagedesktopMediaRequestedSlot](cast[pointer](slot))
  GC_unref(nimfunc)

proc onDesktopMediaRequested*(self: gen_qwebenginepage_types.QWebEnginePage, slot: QWebEnginePagedesktopMediaRequestedSlot) =
  var tmp = new QWebEnginePagedesktopMediaRequestedSlot
  tmp[] = slot
  GC_ref(tmp)
  fcQWebEnginePage_connect_desktopMediaRequested(self.h, cast[int](addr tmp[]), fcQWebEnginePage_slot_callback_desktopMediaRequested, fcQWebEnginePage_slot_callback_desktopMediaRequested_release)
...
proc titleChanged*(self: gen_qwebenginepage_types.QWebEnginePage, title: openArray[char]): void =
  fcQWebEnginePage_titleChanged(self.h, struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))))

type QWebEnginePagetitleChangedSlot* = proc(title: openArray[char])
proc fcQWebEnginePage_slot_callback_titleChanged(slot: int, title: struct_seaqt_string) {.cdecl.} =
...
proc zoomFactorChanged*(self: gen_qwebenginepage_types.QWebEnginePage, factor: float64): void =
  fcQWebEnginePage_zoomFactorChanged(self.h, factor)

type QWebEnginePagezoomFactorChangedSlot* = proc(factor: float64)
proc fcQWebEnginePage_slot_callback_zoomFactorChanged(slot: int, factor: float64) {.cdecl.} =
  let nimfunc = cast[ptr QWebEnginePagezoomFactorChangedSlot](cast[pointer](slot))
  let slotval1 = factor

  nimfunc[](slotval1)

proc fcQWebEnginePage_slot_callback_zoomFactorChanged_release(slot: int) {.cdecl.} =
  let nimfunc = cast[ref QWebEnginePagezoomFactorChangedSlot](cast[pointer](slot))
  GC_unref(nimfunc)

proc onZoomFactorChanged*(self: gen_qwebenginepage_types.QWebEnginePage, slot: QWebEnginePagezoomFactorChangedSlot) =
  var tmp = new QWebEnginePagezoomFactorChangedSlot
  tmp[] = slot
  GC_ref(tmp)
  fcQWebEnginePage_connect_zoomFactorChanged(self.h, cast[int](addr tmp[]), fcQWebEnginePage_slot_callback_zoomFactorChanged, fcQWebEnginePage_slot_callback_zoomFactorChanged_release)
...
proc pdfPrintingFinished*(self: gen_qwebenginepage_types.QWebEnginePage, filePath: openArray[char], success: bool): void =
  fcQWebEnginePage_pdfPrintingFinished(self.h, struct_seaqt_string(data: if len(filePath) > 0: addr filePath[0] else: nil, len: csize_t(len(filePath))), success)

type QWebEnginePagepdfPrintingFinishedSlot* = proc(filePath: openArray[char], success: bool)
proc fcQWebEnginePage_slot_callback_pdfPrintingFinished(slot: int, filePath: struct_seaqt_string, success: bool) {.cdecl.} =
...
proc printRequestedByFrame*(self: gen_qwebenginepage_types.QWebEnginePage, frame: gen_qwebengineframe_types.QWebEngineFrame): void =
  fcQWebEnginePage_printRequestedByFrame(self.h, frame.h)

type QWebEnginePageprintRequestedByFrameSlot* = proc(frame: gen_qwebengineframe_types.QWebEngineFrame)
proc fcQWebEnginePage_slot_callback_printRequestedByFrame(slot: int, frame: pointer) {.cdecl.} =
  let nimfunc = cast[ptr QWebEnginePageprintRequestedByFrameSlot](cast[pointer](slot))
  let slotval1 = gen_qwebengineframe_types.QWebEngineFrame(h: frame, owned: true)

  nimfunc[](slotval1)

proc fcQWebEnginePage_slot_callback_printRequestedByFrame_release(slot: int) {.cdecl.} =
  let nimfunc = cast[ref QWebEnginePageprintRequestedByFrameSlot](cast[pointer](slot))
  GC_unref(nimfunc)

proc onPrintRequestedByFrame*(self: gen_qwebenginepage_types.QWebEnginePage, slot: QWebEnginePageprintRequestedByFrameSlot) =
  var tmp = new QWebEnginePageprintRequestedByFrameSlot
  tmp[] = slot
  GC_ref(tmp)
  fcQWebEnginePage_connect_printRequestedByFrame(self.h, cast[int](addr tmp[]), fcQWebEnginePage_slot_callback_printRequestedByFrame, fcQWebEnginePage_slot_callback_printRequestedByFrame_release)
...
proc webAuthUxRequested*(self: gen_qwebenginepage_types.QWebEnginePage, request: gen_qwebenginewebauthuxrequest_types.QWebEngineWebAuthUxRequest): void =
  fcQWebEnginePage_webAuthUxRequested(self.h, request.h)

type QWebEnginePagewebAuthUxRequestedSlot* = proc(request: gen_qwebenginewebauthuxrequest_types.QWebEngineWebAuthUxRequest)
proc fcQWebEnginePage_slot_callback_webAuthUxRequested(slot: int, request: pointer) {.cdecl.} =
  let nimfunc = cast[ptr QWebEnginePagewebAuthUxRequestedSlot](cast[pointer](slot))
  let slotval1 = gen_qwebenginewebauthuxrequest_types.QWebEngineWebAuthUxRequest(h: request, owned: false)

  nimfunc[](slotval1)

proc fcQWebEnginePage_slot_callback_webAuthUxRequested_release(slot: int) {.cdecl.} =
  let nimfunc = cast[ref QWebEnginePagewebAuthUxRequestedSlot](cast[pointer](slot))
  GC_unref(nimfunc)

proc onWebAuthUxRequested*(self: gen_qwebenginepage_types.QWebEnginePage, slot: QWebEnginePagewebAuthUxRequestedSlot) =
  var tmp = new QWebEnginePagewebAuthUxRequestedSlot
  tmp[] = slot
  GC_ref(tmp)
  fcQWebEnginePage_connect_webAuthUxRequested(self.h, cast[int](addr tmp[]), fcQWebEnginePage_slot_callback_webAuthUxRequested, fcQWebEnginePage_slot_callback_webAuthUxRequested_release)

proc tr*(_: type gen_qwebenginepage_types.QWebEnginePage, s: cstring, c: cstring): string =
  let v_ms = fcQWebEnginePage_trSC(s, c)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret

proc tr*(_: type gen_qwebenginepage_types.QWebEnginePage, s: cstring, c: cstring, n: cint): string =
  let v_ms = fcQWebEnginePage_trSCN(s, c, n)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret

proc findText*(self: gen_qwebenginepage_types.QWebEnginePage, subString: openArray[char], options: cint): void =
  fcQWebEnginePage_findTextSubStringOptions(self.h, struct_seaqt_string(data: if len(subString) > 0: addr subString[0] else: nil, len: csize_t(len(subString))), cint(options))

proc download*(self: gen_qwebenginepage_types.QWebEnginePage, url: gen_qurl_types.QUrl, filename: openArray[char]): void =
  fcQWebEnginePage_downloadUrlFilename(self.h, url.h, struct_seaqt_string(data: if len(filename) > 0: addr filename[0] else: nil, len: csize_t(len(filename))))

proc setHtml*(self: gen_qwebenginepage_types.QWebEnginePage, html: openArray[char], baseUrl: gen_qurl_types.QUrl): void =
  fcQWebEnginePage_setHtmlHtmlBaseUrl(self.h, struct_seaqt_string(data: if len(html) > 0: addr html[0] else: nil, len: csize_t(len(html))), baseUrl.h)

proc setContent*(self: gen_qwebenginepage_types.QWebEnginePage, data: openArray[byte], mimeType: openArray[char]): void =
  fcQWebEnginePage_setContentDataMimeType(self.h, struct_seaqt_string(data: if len(data) > 0: addr data[0] else: nil, len: csize_t(len(data))), struct_seaqt_string(data: if len(mimeType) > 0: addr mimeType[0] else: nil, len: csize_t(len(mimeType))))
...
proc setContent*(self: gen_qwebenginepage_types.QWebEnginePage, data: openArray[byte], mimeType: openArray[char], baseUrl: gen_qurl_types.QUrl): void =
  fcQWebEnginePage_setContentDataMimeTypeBaseUrl(self.h, struct_seaqt_string(data: if len(data) > 0: addr data[0] else: nil, len: csize_t(len(data))), struct_seaqt_string(data: if len(mimeType) > 0: addr mimeType[0] else: nil, len: csize_t(len(mimeType))), baseUrl.h)

proc runJavaScript*(self: gen_qwebenginepage_types.QWebEnginePage, scriptSource: openArray[char], worldId: cuint): void =
  fcQWebEnginePage_runJavaScriptScriptSourceWorldId(self.h, struct_seaqt_string(data: if len(scriptSource) > 0: addr scriptSource[0] else: nil, len: csize_t(len(scriptSource))), worldId)
...
proc setWebChannel*(self: gen_qwebenginepage_types.QWebEnginePage, param1: gen_qwebchannel_types.QWebChannel, worldId: cuint): void =
  fcQWebEnginePage_setWebChannel_QWebChannelQuint32(self.h, param1.h, worldId)

proc save*(self: gen_qwebenginepage_types.QWebEnginePage, filePath: openArray[char], format: cint): void =
  fcQWebEnginePage_saveFilePathFormat(self.h, struct_seaqt_string(data: if len(filePath) > 0: addr filePath[0] else: nil, len: csize_t(len(filePath))), cint(format))
...
proc printToPdf*(self: gen_qwebenginepage_types.QWebEnginePage, filePath: openArray[char], layout: gen_qpagelayout_types.QPageLayout): void =
  fcQWebEnginePage_printToPdfFilePathLayout(self.h, struct_seaqt_string(data: if len(filePath) > 0: addr filePath[0] else: nil, len: csize_t(len(filePath))), layout.h)
...
proc printToPdf*(self: gen_qwebenginepage_types.QWebEnginePage, filePath: openArray[char], layout: gen_qpagelayout_types.QPageLayout, ranges: gen_qpageranges_types.QPageRanges): void =
  fcQWebEnginePage_printToPdfFilePathLayoutRanges(self.h, struct_seaqt_string(data: if len(filePath) > 0: addr filePath[0] else: nil, len: csize_t(len(filePath))), layout.h, ranges.h)
...
proc QWebEnginePagechooseFiles*(self: gen_qwebenginepage_types.QWebEnginePage, mode: cint, oldFiles: openArray[string], acceptedMimeTypes: openArray[string]): seq[string] =
  var oldFiles_CArray = newSeq[struct_seaqt_string](len(oldFiles))
  for i in 0..<len(oldFiles):
    oldFiles_CArray[i] = struct_seaqt_string(data: if len(oldFiles[i]) > 0: addr oldFiles[i][0] else: nil, len: csize_t(len(oldFiles[i])))

  var acceptedMimeTypes_CArray = newSeq[struct_seaqt_string](len(acceptedMimeTypes))
  for i in 0..<len(acceptedMimeTypes):
    acceptedMimeTypes_CArray[i] = struct_seaqt_string(data: if len(acceptedMimeTypes[i]) > 0: addr acceptedMimeTypes[i][0] else: nil, len: csize_t(len(acceptedMimeTypes[i])))

  var v_ma = fcQWebEnginePage_virtualbase_chooseFiles(self.h, cint(mode), struct_seaqt_array(len: csize_t(len(oldFiles)), data: if len(oldFiles) == 0: nil else: addr(oldFiles_CArray[0])), struct_seaqt_array(len: csize_t(len(acceptedMimeTypes)), data: if len(acceptedMimeTypes) == 0: nil else: addr(acceptedMimeTypes_CArray[0])))
...
proc QWebEnginePagejavaScriptAlert*(self: gen_qwebenginepage_types.QWebEnginePage, securityOrigin: gen_qurl_types.QUrl, msg: openArray[char]): void =
  fcQWebEnginePage_virtualbase_javaScriptAlert(self.h, securityOrigin.h, struct_seaqt_string(data: if len(msg) > 0: addr msg[0] else: nil, len: csize_t(len(msg))))
...
proc QWebEnginePagejavaScriptConfirm*(self: gen_qwebenginepage_types.QWebEnginePage, securityOrigin: gen_qurl_types.QUrl, msg: openArray[char]): bool =
  fcQWebEnginePage_virtualbase_javaScriptConfirm(self.h, securityOrigin.h, struct_seaqt_string(data: if len(msg) > 0: addr msg[0] else: nil, len: csize_t(len(msg))))
...
proc QWebEnginePagejavaScriptConsoleMessage*(self: gen_qwebenginepage_types.QWebEnginePage, level: cint, message: openArray[char], lineNumber: cint, sourceID: openArray[char]): void =
  fcQWebEnginePage_virtualbase_javaScriptConsoleMessage(self.h, cint(level), struct_seaqt_string(data: if len(message) > 0: addr message[0] else: nil, len: csize_t(len(message))), lineNumber, struct_seaqt_string(data: if len(sourceID) > 0: addr sourceID[0] else: nil, len: csize_t(len(sourceID))))
...
proc fcQWebEnginePage_vtable_callback_chooseFiles(self: pointer, mode: cint, oldFiles: struct_seaqt_array, acceptedMimeTypes: struct_seaqt_array): struct_seaqt_array {.cdecl.} =
  let vtbl = cast[ptr QWebEnginePageVTable](fcQWebEnginePage_vdata(self)[])
  let self = QWebEnginePage(h: self)
  let slotval1 = cint(mode)
  var voldFiles_ma = oldFiles
  var voldFilesx_ret = newSeq[string](int(voldFiles_ma.len))
  let voldFiles_outCast = cast[ptr UncheckedArray[struct_seaqt_string]](voldFiles_ma.data)
  ...
  let vacceptedMimeTypes_outCast = cast[ptr UncheckedArray[struct_seaqt_string]](vacceptedMimeTypes_ma.data)
...
proc fcQWebEnginePage_vtable_callback_javaScriptAlert(self: pointer, securityOrigin: pointer, msg: struct_seaqt_string): void {.cdecl.} =
  let vtbl = cast[ptr QWebEnginePageVTable](fcQWebEnginePage_vdata(self)[])
  let self = QWebEnginePage(h: self)
  let slotval1 = gen_qurl_types.QUrl(h: securityOrigin, owned: false)
  let vmsg_ms = msg
...
proc fcQWebEnginePage_vtable_callback_javaScriptConfirm(self: pointer, securityOrigin: pointer, msg: struct_seaqt_string): bool {.cdecl.} =
  let vtbl = cast[ptr QWebEnginePageVTable](fcQWebEnginePage_vdata(self)[])
  let self = QWebEnginePage(h: self)
  let slotval1 = gen_qurl_types.QUrl(h: securityOrigin, owned: false)
  let vmsg_ms = msg
...
proc fcQWebEnginePage_vtable_callback_javaScriptConsoleMessage(self: pointer, level: cint, message: struct_seaqt_string, lineNumber: cint, sourceID: struct_seaqt_string): void {.cdecl.} =
  let vtbl = cast[ptr QWebEnginePageVTable](fcQWebEnginePage_vdata(self)[])
  let self = QWebEnginePage(h: self)
...
proc fcQWebEnginePage_method_callback_chooseFiles(self: pointer, mode: cint, oldFiles: struct_seaqt_array, acceptedMimeTypes: struct_seaqt_array): struct_seaqt_array {.cdecl.} =
  let inst = cast[VirtualQWebEnginePage](fcQWebEnginePage_vdata(self)[])
  let slotval1 = cint(mode)
  var voldFiles_ma = oldFiles
  var voldFilesx_ret = newSeq[string](int(voldFiles_ma.len))
...
proc fcQWebEnginePage_method_callback_javaScriptAlert(self: pointer, securityOrigin: pointer, msg: struct_seaqt_string): void {.cdecl.} =
  let inst = cast[VirtualQWebEnginePage](fcQWebEnginePage_vdata(self)[])
  let slotval1 = gen_qurl_types.QUrl(h: securityOrigin, owned: false)
  let vmsg_ms = msg
  let vmsgx_ret = string.fromBytes(vmsg_ms)
...
proc fcQWebEnginePage_method_callback_javaScriptConfirm(self: pointer, securityOrigin: pointer, msg: struct_seaqt_string): bool {.cdecl.} =
  let inst = cast[VirtualQWebEnginePage](fcQWebEnginePage_vdata(self)[])
  let slotval1 = gen_qurl_types.QUrl(h: securityOrigin, owned: false)
  let vmsg_ms = msg
  let vmsgx_ret = string.fromBytes(vmsg_ms)
...
proc fcQWebEnginePage_method_callback_javaScriptConsoleMessage(self: pointer, level: cint, message: struct_seaqt_string, lineNumber: cint, sourceID: struct_seaqt_string): void {.cdecl.} =
  let inst = cast[VirtualQWebEnginePage](fcQWebEnginePage_vdata(self)[])
  let slotval1 = cint(level)
  let vmessage_ms = message
  let vmessagex_ret = string.fromBytes(vmessage_ms)
...
proc create*(T: type gen_qwebenginepage_types.QWebEnginePage,
  ...
  let tmp = gen_qwebenginepage_types.QWebEnginePage(h: fcQWebEnginePage_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQWebEnginePage_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qwebenginepage_types.QWebEnginePage,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQWebEnginePage_vtable_callback_disconnectNotify
  let tmp = gen_qwebenginepage_types.QWebEnginePage(h: fcQWebEnginePage_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), profile.h), owned: true)
  fcQWebEnginePage_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qwebenginepage_types.QWebEnginePage,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQWebEnginePage_vtable_callback_disconnectNotify
  let tmp = gen_qwebenginepage_types.QWebEnginePage(h: fcQWebEnginePage_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQWebEnginePage_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qwebenginepage_types.QWebEnginePage,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQWebEnginePage_vtable_callback_disconnectNotify
  let tmp = gen_qwebenginepage_types.QWebEnginePage(h: fcQWebEnginePage_new4(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), profile.h, parent.h), owned: true)
  fcQWebEnginePage_vdata(tmp.h)[] = addr(vtbl[])
  tmp
