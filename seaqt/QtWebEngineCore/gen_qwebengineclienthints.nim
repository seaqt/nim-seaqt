...
type QWebEngineClientHintsQmlIsUncreatableEnum* = distinct cint
template yes*(_: type QWebEngineClientHintsQmlIsUncreatableEnum): untyped = 1
...
proc fcQWebEngineClientHints_qmlMarkerUncreatable(self: pointer): void {.importc: "QWebEngineClientHints_qmlMarker_uncreatable".}
...
proc qmlMarkerUncreatable*(self: gen_qwebengineclienthints_types.QWebEngineClientHints): void =
  fcQWebEngineClientHints_qmlMarkerUncreatable(self.h)
