...
proc fcQWebEngineLoadingInfo_isDownload(self: pointer): bool {.importc: "QWebEngineLoadingInfo_isDownload".}
proc fcQWebEngineLoadingInfo_new(): ptr cQWebEngineLoadingInfo {.importc: "QWebEngineLoadingInfo_new".}
proc fcQWebEngineLoadingInfo_new2(fromVal: pointer): ptr cQWebEngineLoadingInfo {.importc: "QWebEngineLoadingInfo_new_from".}
...
proc isDownload*(self: gen_qwebengineloadinginfo_types.QWebEngineLoadingInfo): bool =
  fcQWebEngineLoadingInfo_isDownload(self.h)

proc create*(T: type gen_qwebengineloadinginfo_types.QWebEngineLoadingInfo): gen_qwebengineloadinginfo_types.QWebEngineLoadingInfo =
  let tmp = gen_qwebengineloadinginfo_types.QWebEngineLoadingInfo(h: fcQWebEngineLoadingInfo_new(), owned: true)
  tmp
proc create*(T: type gen_qwebengineloadinginfo_types.QWebEngineLoadingInfo,
  ...
  let tmp = gen_qwebengineloadinginfo_types.QWebEngineLoadingInfo(h: fcQWebEngineLoadingInfo_new2(fromVal.h), owned: true)
  tmp
