...
{.compile("gen_qwebengineprofile.cpp", QtWebEngineCoreCFlags).}
...
template OnlyPersistentCookies*(_: type QWebEngineProfilePersistentCookiesPolicyEnum): untyped = 3


type QWebEngineProfilePersistentPermissionsPolicyEnum* = distinct uint8
template AskEveryTime*(_: type QWebEngineProfilePersistentPermissionsPolicyEnum): untyped = 0
template StoreInMemory*(_: type QWebEngineProfilePersistentPermissionsPolicyEnum): untyped = 1
template StoreOnDisk*(_: type QWebEngineProfilePersistentPermissionsPolicyEnum): untyped = 2
...
proc fcQWebEngineProfile_setPersistentStoragePath(self: pointer, path: struct_seaqt_string): void {.importc: "QWebEngineProfile_setPersistentStoragePath".}
proc fcQWebEngineProfile_cachePath(self: pointer): struct_seaqt_string {.importc: "QWebEngineProfile_cachePath".}
proc fcQWebEngineProfile_setCachePath(self: pointer, path: struct_seaqt_string): void {.importc: "QWebEngineProfile_setCachePath".}
proc fcQWebEngineProfile_httpUserAgent(self: pointer): struct_seaqt_string {.importc: "QWebEngineProfile_httpUserAgent".}
proc fcQWebEngineProfile_setHttpUserAgent(self: pointer, userAgent: struct_seaqt_string): void {.importc: "QWebEngineProfile_setHttpUserAgent".}
...
proc fcQWebEngineProfile_setHttpAcceptLanguage(self: pointer, httpAcceptLanguage: struct_seaqt_string): void {.importc: "QWebEngineProfile_setHttpAcceptLanguage".}
proc fcQWebEngineProfile_httpAcceptLanguage(self: pointer): struct_seaqt_string {.importc: "QWebEngineProfile_httpAcceptLanguage".}
...
proc fcQWebEngineProfile_persistentPermissionsPolicy(self: pointer): cint {.importc: "QWebEngineProfile_persistentPermissionsPolicy".}
proc fcQWebEngineProfile_setPersistentPermissionsPolicy(self: pointer, persistentPermissionsPolicy: cint): void {.importc: "QWebEngineProfile_setPersistentPermissionsPolicy".}
...
proc fcQWebEngineProfile_clearVisitedLinks(self: pointer, urls: struct_seaqt_array): void {.importc: "QWebEngineProfile_clearVisitedLinks".}
...
proc fcQWebEngineProfile_clientHints(self: pointer): pointer {.importc: "QWebEngineProfile_clientHints".}
proc fcQWebEngineProfile_urlSchemeHandler(self: pointer, param1: struct_seaqt_string): pointer {.importc: "QWebEngineProfile_urlSchemeHandler".}
proc fcQWebEngineProfile_installUrlSchemeHandler(self: pointer, scheme: struct_seaqt_string, param2: pointer): void {.importc: "QWebEngineProfile_installUrlSchemeHandler".}
proc fcQWebEngineProfile_removeUrlScheme(self: pointer, scheme: struct_seaqt_string): void {.importc: "QWebEngineProfile_removeUrlScheme".}
...
proc fcQWebEngineProfile_setSpellCheckLanguages(self: pointer, languages: struct_seaqt_array): void {.importc: "QWebEngineProfile_setSpellCheckLanguages".}
proc fcQWebEngineProfile_spellCheckLanguages(self: pointer): struct_seaqt_array {.importc: "QWebEngineProfile_spellCheckLanguages".}
...
proc fcQWebEngineProfile_downloadPath(self: pointer): struct_seaqt_string {.importc: "QWebEngineProfile_downloadPath".}
proc fcQWebEngineProfile_setDownloadPath(self: pointer, path: struct_seaqt_string): void {.importc: "QWebEngineProfile_setDownloadPath".}
proc fcQWebEngineProfile_isPushServiceEnabled(self: pointer): bool {.importc: "QWebEngineProfile_isPushServiceEnabled".}
proc fcQWebEngineProfile_setPushServiceEnabled(self: pointer, enabled: bool): void {.importc: "QWebEngineProfile_setPushServiceEnabled".}
proc fcQWebEngineProfile_clientCertificateStore(self: pointer): pointer {.importc: "QWebEngineProfile_clientCertificateStore".}
proc fcQWebEngineProfile_additionalTrustedCertificates(self: pointer): struct_seaqt_array {.importc: "QWebEngineProfile_additionalTrustedCertificates".}
proc fcQWebEngineProfile_queryPermission(self: pointer, securityOrigin: pointer, permissionType: cint): pointer {.importc: "QWebEngineProfile_queryPermission".}
proc fcQWebEngineProfile_listAllPermissions(self: pointer): struct_seaqt_array {.importc: "QWebEngineProfile_listAllPermissions".}
proc fcQWebEngineProfile_listPermissionsForOrigin(self: pointer, securityOrigin: pointer): struct_seaqt_array {.importc: "QWebEngineProfile_listPermissionsForOrigin".}
proc fcQWebEngineProfile_listPermissionsForPermissionType(self: pointer, permissionType: cint): struct_seaqt_array {.importc: "QWebEngineProfile_listPermissionsForPermissionType".}
proc fcQWebEngineProfile_extensionManager(self: pointer): pointer {.importc: "QWebEngineProfile_extensionManager".}
...
proc fcQWebEngineProfile_clearHttpCacheCompleted(self: pointer): void {.importc: "QWebEngineProfile_clearHttpCacheCompleted".}
proc fcQWebEngineProfile_connect_clearHttpCacheCompleted(self: pointer, slot: int, callback: proc (slot: int) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QWebEngineProfile_connect_clearHttpCacheCompleted".}
...
proc setPersistentStoragePath*(self: gen_qwebengineprofile_types.QWebEngineProfile, path: openArray[char]): void =
  fcQWebEngineProfile_setPersistentStoragePath(self.h, struct_seaqt_string(data: if len(path) > 0: addr path[0] else: nil, len: csize_t(len(path))))
...
proc setCachePath*(self: gen_qwebengineprofile_types.QWebEngineProfile, path: openArray[char]): void =
  fcQWebEngineProfile_setCachePath(self.h, struct_seaqt_string(data: if len(path) > 0: addr path[0] else: nil, len: csize_t(len(path))))
...
proc setHttpUserAgent*(self: gen_qwebengineprofile_types.QWebEngineProfile, userAgent: openArray[char]): void =
  fcQWebEngineProfile_setHttpUserAgent(self.h, struct_seaqt_string(data: if len(userAgent) > 0: addr userAgent[0] else: nil, len: csize_t(len(userAgent))))
...
proc setHttpAcceptLanguage*(self: gen_qwebengineprofile_types.QWebEngineProfile, httpAcceptLanguage: openArray[char]): void =
  fcQWebEngineProfile_setHttpAcceptLanguage(self.h, struct_seaqt_string(data: if len(httpAcceptLanguage) > 0: addr httpAcceptLanguage[0] else: nil, len: csize_t(len(httpAcceptLanguage))))
...
proc persistentPermissionsPolicy*(self: gen_qwebengineprofile_types.QWebEngineProfile): cint =
  cint(fcQWebEngineProfile_persistentPermissionsPolicy(self.h))

proc setPersistentPermissionsPolicy*(self: gen_qwebengineprofile_types.QWebEngineProfile, persistentPermissionsPolicy: cint): void =
  fcQWebEngineProfile_setPersistentPermissionsPolicy(self.h, cint(persistentPermissionsPolicy))
...
proc clearVisitedLinks*(self: gen_qwebengineprofile_types.QWebEngineProfile, urls: openArray[gen_qurl_types.QUrl]): void =
  ...
  fcQWebEngineProfile_clearVisitedLinks(self.h, struct_seaqt_array(len: csize_t(len(urls)), data: if len(urls) == 0: nil else: addr(urls_CArray[0])))
...
proc clientHints*(self: gen_qwebengineprofile_types.QWebEngineProfile): gen_qwebengineclienthints_types.QWebEngineClientHints =
  gen_qwebengineclienthints_types.QWebEngineClientHints(h: fcQWebEngineProfile_clientHints(self.h), owned: false)
...
proc urlSchemeHandler*(self: gen_qwebengineprofile_types.QWebEngineProfile, param1: openArray[byte]): gen_qwebengineurlschemehandler_types.QWebEngineUrlSchemeHandler =
  gen_qwebengineurlschemehandler_types.QWebEngineUrlSchemeHandler(h: fcQWebEngineProfile_urlSchemeHandler(self.h, struct_seaqt_string(data: if len(param1) > 0: addr param1[0] else: nil, len: csize_t(len(param1)))), owned: false)
...
proc installUrlSchemeHandler*(self: gen_qwebengineprofile_types.QWebEngineProfile, scheme: openArray[byte], param2: gen_qwebengineurlschemehandler_types.QWebEngineUrlSchemeHandler): void =
  fcQWebEngineProfile_installUrlSchemeHandler(self.h, struct_seaqt_string(data: if len(scheme) > 0: addr scheme[0] else: nil, len: csize_t(len(scheme))), param2.h)

proc removeUrlScheme*(self: gen_qwebengineprofile_types.QWebEngineProfile, scheme: openArray[byte]): void =
  fcQWebEngineProfile_removeUrlScheme(self.h, struct_seaqt_string(data: if len(scheme) > 0: addr scheme[0] else: nil, len: csize_t(len(scheme))))
...
proc setSpellCheckLanguages*(self: gen_qwebengineprofile_types.QWebEngineProfile, languages: openArray[string]): void =
  ...
  fcQWebEngineProfile_setSpellCheckLanguages(self.h, struct_seaqt_array(len: csize_t(len(languages)), data: if len(languages) == 0: nil else: addr(languages_CArray[0])))
...
proc setDownloadPath*(self: gen_qwebengineprofile_types.QWebEngineProfile, path: openArray[char]): void =
  fcQWebEngineProfile_setDownloadPath(self.h, struct_seaqt_string(data: if len(path) > 0: addr path[0] else: nil, len: csize_t(len(path))))

proc isPushServiceEnabled*(self: gen_qwebengineprofile_types.QWebEngineProfile): bool =
  fcQWebEngineProfile_isPushServiceEnabled(self.h)

proc setPushServiceEnabled*(self: gen_qwebengineprofile_types.QWebEngineProfile, enabled: bool): void =
  fcQWebEngineProfile_setPushServiceEnabled(self.h, enabled)
...
proc additionalTrustedCertificates*(self: gen_qwebengineprofile_types.QWebEngineProfile): seq[gen_qsslcertificate_types.QSslCertificate] =
  var v_ma = fcQWebEngineProfile_additionalTrustedCertificates(self.h)
...
proc queryPermission*(self: gen_qwebengineprofile_types.QWebEngineProfile, securityOrigin: gen_qurl_types.QUrl, permissionType: cint): gen_qwebenginepermission_types.QWebEnginePermission =
  gen_qwebenginepermission_types.QWebEnginePermission(h: fcQWebEngineProfile_queryPermission(self.h, securityOrigin.h, cint(permissionType)), owned: true)

proc listAllPermissions*(self: gen_qwebengineprofile_types.QWebEngineProfile): seq[gen_qwebenginepermission_types.QWebEnginePermission] =
  var v_ma = fcQWebEngineProfile_listAllPermissions(self.h)
...
proc listPermissionsForOrigin*(self: gen_qwebengineprofile_types.QWebEngineProfile, securityOrigin: gen_qurl_types.QUrl): seq[gen_qwebenginepermission_types.QWebEnginePermission] =
  var v_ma = fcQWebEngineProfile_listPermissionsForOrigin(self.h, securityOrigin.h)
  var vx_ret = newSeq[gen_qwebenginepermission_types.QWebEnginePermission](int(v_ma.len))
  let v_outCast = cast[ptr UncheckedArray[pointer]](v_ma.data)
  for i in 0 ..< v_ma.len:
    vx_ret[i] = gen_qwebenginepermission_types.QWebEnginePermission(h: v_outCast[i], owned: true)
...
proc listPermissionsForPermissionType*(self: gen_qwebengineprofile_types.QWebEngineProfile, permissionType: cint): seq[gen_qwebenginepermission_types.QWebEnginePermission] =
  var v_ma = fcQWebEngineProfile_listPermissionsForPermissionType(self.h, cint(permissionType))
  var vx_ret = newSeq[gen_qwebenginepermission_types.QWebEnginePermission](int(v_ma.len))
  let v_outCast = cast[ptr UncheckedArray[pointer]](v_ma.data)
  for i in 0 ..< v_ma.len:
    vx_ret[i] = gen_qwebenginepermission_types.QWebEnginePermission(h: v_outCast[i], owned: true)
...
proc extensionManager*(self: gen_qwebengineprofile_types.QWebEngineProfile): gen_qwebengineextensionmanager_types.QWebEngineExtensionManager =
  gen_qwebengineextensionmanager_types.QWebEngineExtensionManager(h: fcQWebEngineProfile_extensionManager(self.h), owned: false)
...
proc fcQWebEngineProfile_slot_callback_downloadRequested(slot: int, download: pointer) {.cdecl.} =
...
proc fcQWebEngineProfile_slot_callback_downloadRequested_release(slot: int) {.cdecl.} =
...
proc clearHttpCacheCompleted*(self: gen_qwebengineprofile_types.QWebEngineProfile): void =
  fcQWebEngineProfile_clearHttpCacheCompleted(self.h)

type QWebEngineProfileclearHttpCacheCompletedSlot* = proc()
proc fcQWebEngineProfile_slot_callback_clearHttpCacheCompleted(slot: int) {.cdecl.} =
  let nimfunc = cast[ptr QWebEngineProfileclearHttpCacheCompletedSlot](cast[pointer](slot))
  nimfunc[]()

proc fcQWebEngineProfile_slot_callback_clearHttpCacheCompleted_release(slot: int) {.cdecl.} =
  let nimfunc = cast[ref QWebEngineProfileclearHttpCacheCompletedSlot](cast[pointer](slot))
  GC_unref(nimfunc)

proc onClearHttpCacheCompleted*(self: gen_qwebengineprofile_types.QWebEngineProfile, slot: QWebEngineProfileclearHttpCacheCompletedSlot) =
  var tmp = new QWebEngineProfileclearHttpCacheCompletedSlot
  tmp[] = slot
  GC_ref(tmp)
  fcQWebEngineProfile_connect_clearHttpCacheCompleted(self.h, cast[int](addr tmp[]), fcQWebEngineProfile_slot_callback_clearHttpCacheCompleted, fcQWebEngineProfile_slot_callback_clearHttpCacheCompleted_release)
...
proc create*(T: type gen_qwebengineprofile_types.QWebEngineProfile,
  ...
  if not isNil(vtbl[].metaObject):
    vtbl[].vtbl.metaObject = fcQWebEngineProfile_vtable_callback_metaObject
  if not isNil(vtbl[].metacast):
    vtbl[].vtbl.metacast = fcQWebEngineProfile_vtable_callback_metacast
  if not isNil(vtbl[].metacall):
    vtbl[].vtbl.metacall = fcQWebEngineProfile_vtable_callback_metacall
  if not isNil(vtbl[].event):
    vtbl[].vtbl.event = fcQWebEngineProfile_vtable_callback_event
  if not isNil(vtbl[].eventFilter):
    vtbl[].vtbl.eventFilter = fcQWebEngineProfile_vtable_callback_eventFilter
  if not isNil(vtbl[].timerEvent):
    vtbl[].vtbl.timerEvent = fcQWebEngineProfile_vtable_callback_timerEvent
  if not isNil(vtbl[].childEvent):
    vtbl[].vtbl.childEvent = fcQWebEngineProfile_vtable_callback_childEvent
  if not isNil(vtbl[].customEvent):
    vtbl[].vtbl.customEvent = fcQWebEngineProfile_vtable_callback_customEvent
  if not isNil(vtbl[].connectNotify):
    vtbl[].vtbl.connectNotify = fcQWebEngineProfile_vtable_callback_connectNotify
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQWebEngineProfile_vtable_callback_disconnectNotify
  let tmp = gen_qwebengineprofile_types.QWebEngineProfile(h: fcQWebEngineProfile_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
...
proc create*(T: type gen_qwebengineprofile_types.QWebEngineProfile,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQWebEngineProfile_vtable_callback_disconnectNotify
  let tmp = gen_qwebengineprofile_types.QWebEngineProfile(h: fcQWebEngineProfile_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name)))), owned: true)
  fcQWebEngineProfile_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qwebengineprofile_types.QWebEngineProfile,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQWebEngineProfile_vtable_callback_disconnectNotify
  let tmp = gen_qwebengineprofile_types.QWebEngineProfile(h: fcQWebEngineProfile_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQWebEngineProfile_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qwebengineprofile_types.QWebEngineProfile,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQWebEngineProfile_vtable_callback_disconnectNotify
  let tmp = gen_qwebengineprofile_types.QWebEngineProfile(h: fcQWebEngineProfile_new4(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name))), parent.h), owned: true)
  fcQWebEngineProfile_vdata(tmp.h)[] = addr(vtbl[])
  tmp
const cQWebEngineProfile_mvtbl = cQWebEngineProfileVTable(
  destructor: proc(self: pointer) {.cdecl.} =
    let inst = cast[ptr typeof(VirtualQWebEngineProfile()[])](self.fcQWebEngineProfile_vdata()[])
    inst[].h = nil
    inst[].owned = false,

  metaObject: fcQWebEngineProfile_method_callback_metaObject,
  metacast: fcQWebEngineProfile_method_callback_metacast,
  metacall: fcQWebEngineProfile_method_callback_metacall,
  event: fcQWebEngineProfile_method_callback_event,
  eventFilter: fcQWebEngineProfile_method_callback_eventFilter,
  timerEvent: fcQWebEngineProfile_method_callback_timerEvent,
  childEvent: fcQWebEngineProfile_method_callback_childEvent,
  customEvent: fcQWebEngineProfile_method_callback_customEvent,
  connectNotify: fcQWebEngineProfile_method_callback_connectNotify,
  disconnectNotify: fcQWebEngineProfile_method_callback_disconnectNotify,
)
proc create*(T: type gen_qwebengineprofile_types.QWebEngineProfile,
...
proc create*(T: type gen_qwebengineprofile_types.QWebEngineProfile,
    ...
    inst: VirtualQWebEngineProfile) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQWebEngineProfile_new2(addr(cQWebEngineProfile_mvtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name))))
  fcQWebEngineProfile_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qwebengineprofile_types.QWebEngineProfile,
    ...
    inst: VirtualQWebEngineProfile) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQWebEngineProfile_new4(addr(cQWebEngineProfile_mvtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name))), parent.h)
  fcQWebEngineProfile_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
