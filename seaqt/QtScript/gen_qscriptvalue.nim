...
proc property*(self: gen_qscriptvalue_types.QScriptValue, name: string): gen_qscriptvalue_types.QScriptValue =
  gen_qscriptvalue_types.QScriptValue(h: fcQScriptValue_property(self.h, struct_miqt_string(data: name, len: csize_t(len(name)))), owned: true)
...
proc property*(self: gen_qscriptvalue_types.QScriptValue, name: string, mode: ptr cint): gen_qscriptvalue_types.QScriptValue =
  gen_qscriptvalue_types.QScriptValue(h: fcQScriptValue_property2(self.h, struct_miqt_string(data: name, len: csize_t(len(name))), mode), owned: true)
...
proc property*(self: gen_qscriptvalue_types.QScriptValue, arrayIndex: cuint, mode: ptr cint): gen_qscriptvalue_types.QScriptValue =
  gen_qscriptvalue_types.QScriptValue(h: fcQScriptValue_property22(self.h, arrayIndex, mode), owned: true)
...
proc property*(self: gen_qscriptvalue_types.QScriptValue, name: gen_qscriptstring_types.QScriptString, mode: ptr cint): gen_qscriptvalue_types.QScriptValue =
  gen_qscriptvalue_types.QScriptValue(h: fcQScriptValue_property23(self.h, name.h, mode), owned: true)
...
proc call*(self: gen_qscriptvalue_types.QScriptValue, thisObject: gen_qscriptvalue_types.QScriptValue): gen_qscriptvalue_types.QScriptValue =
  gen_qscriptvalue_types.QScriptValue(h: fcQScriptValue_call1(self.h, thisObject.h), owned: true)
...
proc call*(self: gen_qscriptvalue_types.QScriptValue, thisObject: gen_qscriptvalue_types.QScriptValue, args: seq[gen_qscriptvalue_types.QScriptValue]): gen_qscriptvalue_types.QScriptValue =
  ...
  gen_qscriptvalue_types.QScriptValue(h: fcQScriptValue_call22(self.h, thisObject.h, struct_miqt_array(len: csize_t(len(args)), data: if len(args) == 0: nil else: addr(args_CArray[0]))), owned: true)
...
proc construct*(self: gen_qscriptvalue_types.QScriptValue, args: seq[gen_qscriptvalue_types.QScriptValue]): gen_qscriptvalue_types.QScriptValue =
  ...
  gen_qscriptvalue_types.QScriptValue(h: fcQScriptValue_construct1(self.h, struct_miqt_array(len: csize_t(len(args)), data: if len(args) == 0: nil else: addr(args_CArray[0]))), owned: true)

proc create*(T: type gen_qscriptvalue_types.QScriptValue): gen_qscriptvalue_types.QScriptValue =
  gen_qscriptvalue_types.QScriptValue(h: fcQScriptValue_new(), owned: true)
...
proc create*(T: type gen_qscriptvalue_types.QScriptValue,
  ...
  gen_qscriptvalue_types.QScriptValue(h: fcQScriptValue_new2(other.h), owned: true)

proc create*(T: type gen_qscriptvalue_types.QScriptValue,
    engine: gen_qscriptengine_types.QScriptEngine, val: cint): gen_qscriptvalue_types.QScriptValue =
  gen_qscriptvalue_types.QScriptValue(h: fcQScriptValue_new3(engine.h, cint(val)), owned: true)

proc create*(T: type gen_qscriptvalue_types.QScriptValue,
    engine: gen_qscriptengine_types.QScriptEngine, val: bool): gen_qscriptvalue_types.QScriptValue =
  gen_qscriptvalue_types.QScriptValue(h: fcQScriptValue_new4(engine.h, val), owned: true)

proc create2*(T: type gen_qscriptvalue_types.QScriptValue,
    engine: gen_qscriptengine_types.QScriptEngine, val: cint): gen_qscriptvalue_types.QScriptValue =
  gen_qscriptvalue_types.QScriptValue(h: fcQScriptValue_new5(engine.h, val), owned: true)

proc create*(T: type gen_qscriptvalue_types.QScriptValue,
    engine: gen_qscriptengine_types.QScriptEngine, val: cuint): gen_qscriptvalue_types.QScriptValue =
  gen_qscriptvalue_types.QScriptValue(h: fcQScriptValue_new6(engine.h, val), owned: true)

proc create*(T: type gen_qscriptvalue_types.QScriptValue,
    engine: gen_qscriptengine_types.QScriptEngine, val: float64): gen_qscriptvalue_types.QScriptValue =
  gen_qscriptvalue_types.QScriptValue(h: fcQScriptValue_new7(engine.h, val), owned: true)

proc create*(T: type gen_qscriptvalue_types.QScriptValue,
    engine: gen_qscriptengine_types.QScriptEngine, val: string): gen_qscriptvalue_types.QScriptValue =
  gen_qscriptvalue_types.QScriptValue(h: fcQScriptValue_new8(engine.h, struct_miqt_string(data: val, len: csize_t(len(val)))), owned: true)

proc create*(T: type gen_qscriptvalue_types.QScriptValue,
    engine: gen_qscriptengine_types.QScriptEngine, val: cstring): gen_qscriptvalue_types.QScriptValue =
  gen_qscriptvalue_types.QScriptValue(h: fcQScriptValue_new9(engine.h, val), owned: true)

proc create*(T: type gen_qscriptvalue_types.QScriptValue,
    value: cint): gen_qscriptvalue_types.QScriptValue =
  gen_qscriptvalue_types.QScriptValue(h: fcQScriptValue_new10(cint(value)), owned: true)

proc create*(T: type gen_qscriptvalue_types.QScriptValue,
    value: bool): gen_qscriptvalue_types.QScriptValue =
  gen_qscriptvalue_types.QScriptValue(h: fcQScriptValue_new11(value), owned: true)

proc create2*(T: type gen_qscriptvalue_types.QScriptValue,
    value: cint): gen_qscriptvalue_types.QScriptValue =
  gen_qscriptvalue_types.QScriptValue(h: fcQScriptValue_new12(value), owned: true)

proc create*(T: type gen_qscriptvalue_types.QScriptValue,
    value: cuint): gen_qscriptvalue_types.QScriptValue =
  gen_qscriptvalue_types.QScriptValue(h: fcQScriptValue_new13(value), owned: true)

proc create*(T: type gen_qscriptvalue_types.QScriptValue,
    value: float64): gen_qscriptvalue_types.QScriptValue =
  gen_qscriptvalue_types.QScriptValue(h: fcQScriptValue_new14(value), owned: true)

proc create*(T: type gen_qscriptvalue_types.QScriptValue,
    value: string): gen_qscriptvalue_types.QScriptValue =
  gen_qscriptvalue_types.QScriptValue(h: fcQScriptValue_new15(struct_miqt_string(data: value, len: csize_t(len(value)))), owned: true)

proc create*(T: type gen_qscriptvalue_types.QScriptValue,
    value: cstring): gen_qscriptvalue_types.QScriptValue =
  gen_qscriptvalue_types.QScriptValue(h: fcQScriptValue_new16(value), owned: true)
