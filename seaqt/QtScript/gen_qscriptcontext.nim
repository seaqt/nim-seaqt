...
proc throwError*(self: gen_qscriptcontext_types.QScriptContext, error: cint, text: string): gen_qscriptvalue_types.QScriptValue =
  gen_qscriptvalue_types.QScriptValue(h: fcQScriptContext_throwError(self.h, cint(error), struct_miqt_string(data: text, len: csize_t(len(text)))), owned: true)

proc throwError*(self: gen_qscriptcontext_types.QScriptContext, text: string): gen_qscriptvalue_types.QScriptValue =
  gen_qscriptvalue_types.QScriptValue(h: fcQScriptContext_throwErrorWithText(self.h, struct_miqt_string(data: text, len: csize_t(len(text)))), owned: true)
