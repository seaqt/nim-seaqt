...
proc engine*(self: gen_qscriptclass_types.QScriptClass, ): gen_qscriptengine_types.QScriptEngine =
  gen_qscriptengine_types.QScriptEngine(h: fcQScriptClass_engine(self.h), owned: false)
...
proc property*(self: gen_qscriptclass_types.QScriptClass, objectVal: gen_qscriptvalue_types.QScriptValue, name: gen_qscriptstring_types.QScriptString, id: cuint): gen_qscriptvalue_types.QScriptValue =
  gen_qscriptvalue_types.QScriptValue(h: fcQScriptClass_property(self.h, objectVal.h, name.h, id), owned: true)
...
proc newIterator*(self: gen_qscriptclass_types.QScriptClass, objectVal: gen_qscriptvalue_types.QScriptValue): gen_qscriptclasspropertyiterator_types.QScriptClassPropertyIterator =
  gen_qscriptclasspropertyiterator_types.QScriptClassPropertyIterator(h: fcQScriptClass_newIterator(self.h, objectVal.h), owned: false)

proc prototype*(self: gen_qscriptclass_types.QScriptClass, ): gen_qscriptvalue_types.QScriptValue =
  gen_qscriptvalue_types.QScriptValue(h: fcQScriptClass_prototype(self.h), owned: true)
...
proc extension*(self: gen_qscriptclass_types.QScriptClass, extension: cint, argument: gen_qvariant_types.QVariant): gen_qvariant_types.QVariant =
  gen_qvariant_types.QVariant(h: fcQScriptClass_extension(self.h, cint(extension), argument.h), owned: true)
...
type QScriptClassVTable* {.inheritable, pure.} = object
...
proc miqt_exec_callback_cQScriptClass_queryProperty(vtbl: pointer, self: pointer, objectVal: pointer, name: pointer, flags: cint, id: ptr cuint): cint {.cdecl.} =
  ...
  let slotval1 = gen_qscriptvalue_types.QScriptValue(h: objectVal, owned: false)
  let slotval2 = gen_qscriptstring_types.QScriptString(h: name, owned: false)
...
proc QScriptClassproperty*(self: gen_qscriptclass_types.QScriptClass, objectVal: gen_qscriptvalue_types.QScriptValue, name: gen_qscriptstring_types.QScriptString, id: cuint): gen_qscriptvalue_types.QScriptValue =
  gen_qscriptvalue_types.QScriptValue(h: fcQScriptClass_virtualbase_property(self.h, objectVal.h, name.h, id), owned: true)
...
proc miqt_exec_callback_cQScriptClass_setProperty(vtbl: pointer, self: pointer, objectVal: pointer, name: pointer, id: cuint, value: pointer): void {.cdecl.} =
  ...
  let slotval2 = gen_qscriptstring_types.QScriptString(h: name, owned: false)
  let slotval3 = id
  let slotval4 = gen_qscriptvalue_types.QScriptValue(h: value, owned: false)
...
proc QScriptClassnewIterator*(self: gen_qscriptclass_types.QScriptClass, objectVal: gen_qscriptvalue_types.QScriptValue): gen_qscriptclasspropertyiterator_types.QScriptClassPropertyIterator =
  gen_qscriptclasspropertyiterator_types.QScriptClassPropertyIterator(h: fcQScriptClass_virtualbase_newIterator(self.h, objectVal.h), owned: false)
...
proc QScriptClassprototype*(self: gen_qscriptclass_types.QScriptClass, ): gen_qscriptvalue_types.QScriptValue =
  gen_qscriptvalue_types.QScriptValue(h: fcQScriptClass_virtualbase_prototype(self.h), owned: true)
...
proc QScriptClassextension*(self: gen_qscriptclass_types.QScriptClass, extension: cint, argument: gen_qvariant_types.QVariant): gen_qvariant_types.QVariant =
  gen_qvariant_types.QVariant(h: fcQScriptClass_virtualbase_extension(self.h, cint(extension), argument.h), owned: true)
...
proc miqt_exec_method_cQScriptClass_queryProperty(vtbl: pointer, inst: pointer, objectVal: pointer, name: pointer, flags: cint, id: ptr cuint): cint {.cdecl.} =
  let vtbl = cast[VirtualQScriptClass](cast[uint](vtbl) - uint(offsetOf(VirtualQScriptClass, vtbl)))
  let slotval1 = gen_qscriptvalue_types.QScriptValue(h: objectVal, owned: false)
  let slotval2 = gen_qscriptstring_types.QScriptString(h: name, owned: false)
  let slotval3 = cint(flags)
  let slotval4 = id
  var virtualReturn = vtbl.queryProperty(slotval1, slotval2, slotval3, slotval4)
  cint(virtualReturn)
...
proc miqt_exec_method_cQScriptClass_property(vtbl: pointer, inst: pointer, objectVal: pointer, name: pointer, id: cuint): pointer {.cdecl.} =
  let vtbl = cast[VirtualQScriptClass](cast[uint](vtbl) - uint(offsetOf(VirtualQScriptClass, vtbl)))
  let slotval1 = gen_qscriptvalue_types.QScriptValue(h: objectVal, owned: false)
  let slotval2 = gen_qscriptstring_types.QScriptString(h: name, owned: false)
  let slotval3 = id
  var virtualReturn = vtbl.property(slotval1, slotval2, slotval3)
  virtualReturn.owned = false # TODO move?
  let virtualReturn_h = virtualReturn.h
  virtualReturn.h = nil
  virtualReturn_h
...
proc miqt_exec_method_cQScriptClass_setProperty(vtbl: pointer, inst: pointer, objectVal: pointer, name: pointer, id: cuint, value: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQScriptClass](cast[uint](vtbl) - uint(offsetOf(VirtualQScriptClass, vtbl)))
  let slotval1 = gen_qscriptvalue_types.QScriptValue(h: objectVal, owned: false)
  let slotval2 = gen_qscriptstring_types.QScriptString(h: name, owned: false)
  let slotval3 = id
  let slotval4 = gen_qscriptvalue_types.QScriptValue(h: value, owned: false)
  vtbl.setProperty(slotval1, slotval2, slotval3, slotval4)
...
proc miqt_exec_method_cQScriptClass_propertyFlags(vtbl: pointer, inst: pointer, objectVal: pointer, name: pointer, id: cuint): cint {.cdecl.} =
  let vtbl = cast[VirtualQScriptClass](cast[uint](vtbl) - uint(offsetOf(VirtualQScriptClass, vtbl)))
  let slotval1 = gen_qscriptvalue_types.QScriptValue(h: objectVal, owned: false)
  let slotval2 = gen_qscriptstring_types.QScriptString(h: name, owned: false)
  let slotval3 = id
  var virtualReturn = vtbl.propertyFlags(slotval1, slotval2, slotval3)
  cint(virtualReturn)
...
proc miqt_exec_method_cQScriptClass_newIterator(vtbl: pointer, inst: pointer, objectVal: pointer): pointer {.cdecl.} =
  let vtbl = cast[VirtualQScriptClass](cast[uint](vtbl) - uint(offsetOf(VirtualQScriptClass, vtbl)))
  let slotval1 = gen_qscriptvalue_types.QScriptValue(h: objectVal, owned: false)
  var virtualReturn = vtbl.newIterator(slotval1)
  virtualReturn.owned = false # TODO move?
  let virtualReturn_h = virtualReturn.h
  virtualReturn.h = nil
  virtualReturn_h
...
proc miqt_exec_method_cQScriptClass_prototype(vtbl: pointer, inst: pointer): pointer {.cdecl.} =
  let vtbl = cast[VirtualQScriptClass](cast[uint](vtbl) - uint(offsetOf(VirtualQScriptClass, vtbl)))
  var virtualReturn = vtbl.prototype()
  virtualReturn.owned = false # TODO move?
  let virtualReturn_h = virtualReturn.h
  virtualReturn.h = nil
  virtualReturn_h
...
proc miqt_exec_method_cQScriptClass_name(vtbl: pointer, inst: pointer): struct_miqt_string {.cdecl.} =
  let vtbl = cast[VirtualQScriptClass](cast[uint](vtbl) - uint(offsetOf(VirtualQScriptClass, vtbl)))
...
proc miqt_exec_method_cQScriptClass_supportsExtension(vtbl: pointer, inst: pointer, extension: cint): bool {.cdecl.} =
  let vtbl = cast[VirtualQScriptClass](cast[uint](vtbl) - uint(offsetOf(VirtualQScriptClass, vtbl)))
  let slotval1 = cint(extension)
...
proc miqt_exec_method_cQScriptClass_extension(vtbl: pointer, inst: pointer, extension: cint, argument: pointer): pointer {.cdecl.} =
  let vtbl = cast[VirtualQScriptClass](cast[uint](vtbl) - uint(offsetOf(VirtualQScriptClass, vtbl)))
  let slotval1 = cint(extension)
  let slotval2 = gen_qvariant_types.QVariant(h: argument, owned: false)
...
proc create*(T: type gen_qscriptclass_types.QScriptClass,
  ...
  gen_qscriptclass_types.QScriptClass(h: fcQScriptClass_new(addr(vtbl[].vtbl), engine.h), owned: true)

proc create*(T: type gen_qscriptclass_types.QScriptClass,
    engine: gen_qscriptengine_types.QScriptEngine,
    vtbl: VirtualQScriptClass) =

  vtbl[].vtbl.destructor = proc(vtbl: ptr cQScriptClassVTable, _: ptr cQScriptClass) {.cdecl.} =
    let vtbl = cast[ptr typeof(VirtualQScriptClass()[])](cast[uint](vtbl) - uint(offsetOf(VirtualQScriptClass, vtbl)))
    vtbl[].h = nil
    vtbl[].owned = false
  vtbl[].vtbl.queryProperty = miqt_exec_method_cQScriptClass_queryProperty
  vtbl[].vtbl.property = miqt_exec_method_cQScriptClass_property
  vtbl[].vtbl.setProperty = miqt_exec_method_cQScriptClass_setProperty
  vtbl[].vtbl.propertyFlags = miqt_exec_method_cQScriptClass_propertyFlags
  vtbl[].vtbl.newIterator = miqt_exec_method_cQScriptClass_newIterator
  vtbl[].vtbl.prototype = miqt_exec_method_cQScriptClass_prototype
  vtbl[].vtbl.name = miqt_exec_method_cQScriptClass_name
  vtbl[].vtbl.supportsExtension = miqt_exec_method_cQScriptClass_supportsExtension
  vtbl[].vtbl.extension = miqt_exec_method_cQScriptClass_extension
  if vtbl[].h != nil: delete(move(vtbl[]))
  vtbl[].h = fcQScriptClass_new(addr(vtbl[].vtbl), engine.h)
  vtbl[].owned = true
