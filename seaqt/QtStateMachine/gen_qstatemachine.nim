...
{.compile("gen_qstatemachine.cpp", QtStateMachineCFlags).}
...
import
  ../QtCore/gen_qabstractanimation_types,
...
proc fcQStateMachine_trS(s: cstring): struct_seaqt_string {.importc: "QStateMachine_tr_s".}
...
proc fcQStateMachine_errorString(self: pointer): struct_seaqt_string {.importc: "QStateMachine_errorString".}
...
proc fcQStateMachine_defaultAnimations(self: pointer): struct_seaqt_array {.importc: "QStateMachine_defaultAnimations".}
...
proc fcQStateMachine_postEventEvent(self: pointer, event: pointer): void {.importc: "QStateMachine_postEvent_event".}
proc fcQStateMachine_postDelayedEvent_QEventInt(self: pointer, event: pointer, delay: cint): cint {.importc: "QStateMachine_postDelayedEvent_QEvent_int".}
...
proc fcQStateMachine_trSC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QStateMachine_tr_s_c".}
proc fcQStateMachine_trSCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QStateMachine_tr_s_c_n".}
...
proc fcQStateMachine_new(vtbl: pointer, vdata: csize_t): ptr cQStateMachine {.importc: "QStateMachine_new".}
proc fcQStateMachine_new2(vtbl: pointer, vdata: csize_t, childMode: cint): ptr cQStateMachine {.importc: "QStateMachine_new_childMode".}
proc fcQStateMachine_new3(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQStateMachine {.importc: "QStateMachine_new_parent".}
proc fcQStateMachine_new4(vtbl: pointer, vdata: csize_t, childMode: cint, parent: pointer): ptr cQStateMachine {.importc: "QStateMachine_new_childMode_parent".}
...
proc fcQStateMachineSignalEvent_arguments(self: pointer): struct_seaqt_array {.importc: "QStateMachine__SignalEvent_arguments".}
proc fcQStateMachineSignalEvent_operatorAssign(self: pointer, fromVal: pointer): void {.importc: "QStateMachine__SignalEvent_operatorAssign".}
proc fcQStateMachineSignalEvent_vdata(self: pointer): ptr pointer {.importc: "QStateMachine__SignalEvent_vdata".}
proc fvdata_cQStateMachineSignalEvent(self: pointer): pointer {.importc: "vdata_QStateMachine__SignalEvent".}

type cQStateMachineSignalEventVTable {.pure.} = object
  destructor*: proc(self: pointer) {.cdecl, raises:[], gcsafe.}
  setAccepted*: proc(self: pointer, accepted: bool): void {.cdecl, raises: [], gcsafe.}
  clone*: proc(self: pointer): pointer {.cdecl, raises: [], gcsafe.}
proc fcQStateMachineSignalEvent_virtualbase_setAccepted(self: pointer, accepted: bool): void {.importc: "QStateMachine__SignalEvent_virtualbase_setAccepted".}
proc fcQStateMachineSignalEvent_virtualbase_clone(self: pointer): pointer {.importc: "QStateMachine__SignalEvent_virtualbase_clone".}
proc fcQStateMachineSignalEvent_new(vtbl: pointer, vdata: csize_t, sender: pointer, signalIndex: cint, arguments: struct_seaqt_array): ptr cQStateMachineSignalEvent {.importc: "QStateMachine__SignalEvent_new_sender_signalIndex_arguments".}
proc fcQStateMachineSignalEvent_new2(vtbl: pointer, vdata: csize_t, fromVal: pointer): ptr cQStateMachineSignalEvent {.importc: "QStateMachine__SignalEvent_new_from".}
...
proc fcQStateMachineWrappedEvent_operatorAssign(self: pointer, fromVal: pointer): void {.importc: "QStateMachine__WrappedEvent_operatorAssign".}
proc fcQStateMachineWrappedEvent_vdata(self: pointer): ptr pointer {.importc: "QStateMachine__WrappedEvent_vdata".}
proc fvdata_cQStateMachineWrappedEvent(self: pointer): pointer {.importc: "vdata_QStateMachine__WrappedEvent".}

type cQStateMachineWrappedEventVTable {.pure.} = object
  destructor*: proc(self: pointer) {.cdecl, raises:[], gcsafe.}
  setAccepted*: proc(self: pointer, accepted: bool): void {.cdecl, raises: [], gcsafe.}
  clone*: proc(self: pointer): pointer {.cdecl, raises: [], gcsafe.}
proc fcQStateMachineWrappedEvent_virtualbase_setAccepted(self: pointer, accepted: bool): void {.importc: "QStateMachine__WrappedEvent_virtualbase_setAccepted".}
proc fcQStateMachineWrappedEvent_virtualbase_clone(self: pointer): pointer {.importc: "QStateMachine__WrappedEvent_virtualbase_clone".}
proc fcQStateMachineWrappedEvent_new(vtbl: pointer, vdata: csize_t, objectVal: pointer, event: pointer): ptr cQStateMachineWrappedEvent {.importc: "QStateMachine__WrappedEvent_new_object_event".}
proc fcQStateMachineWrappedEvent_new2(vtbl: pointer, vdata: csize_t, fromVal: pointer): ptr cQStateMachineWrappedEvent {.importc: "QStateMachine__WrappedEvent_new_from".}
...
proc tr*(_: type gen_qstatemachine_types.QStateMachine, s: cstring): string =
  let v_ms = fcQStateMachine_trS(s)
...
proc create*(T: type gen_qstatemachine_types.QStateMachine,
  ...
  let tmp = gen_qstatemachine_types.QStateMachine(h: fcQStateMachine_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQStateMachine_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qstatemachine_types.QStateMachine,
    childMode: cint,
    vtbl: ref QStateMachineVTable = nil): gen_qstatemachine_types.QStateMachine =
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQStateMachine_vtable_callback_disconnectNotify
  let tmp = gen_qstatemachine_types.QStateMachine(h: fcQStateMachine_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), cint(childMode)), owned: true)
  fcQStateMachine_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qstatemachine_types.QStateMachine,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQStateMachine_vtable_callback_disconnectNotify
  let tmp = gen_qstatemachine_types.QStateMachine(h: fcQStateMachine_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQStateMachine_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qstatemachine_types.QStateMachine,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQStateMachine_vtable_callback_disconnectNotify
  let tmp = gen_qstatemachine_types.QStateMachine(h: fcQStateMachine_new4(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), cint(childMode), parent.h), owned: true)
  fcQStateMachine_vdata(tmp.h)[] = addr(vtbl[])
  tmp
...
proc create*(T: type gen_qstatemachine_types.QStateMachine,
  ...
  inst[].h = fcQStateMachine_new(addr(cQStateMachine_mvtbl), csize_t(sizeof(pointer)))
  fcQStateMachine_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qstatemachine_types.QStateMachine,
    ...
    inst: VirtualQStateMachine) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQStateMachine_new2(addr(cQStateMachine_mvtbl), csize_t(sizeof(pointer)), cint(childMode))
  fcQStateMachine_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qstatemachine_types.QStateMachine,
    ...
    inst: VirtualQStateMachine) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQStateMachine_new3(addr(cQStateMachine_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQStateMachine_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qstatemachine_types.QStateMachine,
    ...
    inst: VirtualQStateMachine) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQStateMachine_new4(addr(cQStateMachine_mvtbl), csize_t(sizeof(pointer)), cint(childMode), parent.h)
  fcQStateMachine_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc operatorAssign*(self: gen_qstatemachine_types.QStateMachineSignalEvent, fromVal: gen_qstatemachine_types.QStateMachineSignalEvent): void =
  fcQStateMachineSignalEvent_operatorAssign(self.h, fromVal.h)

type QStateMachineSignalEventsetAcceptedProc* = proc(self: QStateMachineSignalEvent, accepted: bool): void {.raises: [], gcsafe.}
type QStateMachineSignalEventcloneProc* = proc(self: QStateMachineSignalEvent): gen_qcoreevent_types.QEvent {.raises: [], gcsafe.}

type QStateMachineSignalEventVTable* {.inheritable, pure.} = object
  vtbl: cQStateMachineSignalEventVTable
  setAccepted*: QStateMachineSignalEventsetAcceptedProc
  clone*: QStateMachineSignalEventcloneProc

proc QStateMachineSignalEventsetAccepted*(self: gen_qstatemachine_types.QStateMachineSignalEvent, accepted: bool): void =
  fcQStateMachineSignalEvent_virtualbase_setAccepted(self.h, accepted)

proc QStateMachineSignalEventclone*(self: gen_qstatemachine_types.QStateMachineSignalEvent): gen_qcoreevent_types.QEvent =
  gen_qcoreevent_types.QEvent(h: fcQStateMachineSignalEvent_virtualbase_clone(self.h), owned: false)


proc fcQStateMachineSignalEvent_vtable_callback_setAccepted(self: pointer, accepted: bool): void {.cdecl.} =
  let vtbl = cast[ptr QStateMachineSignalEventVTable](fcQStateMachineSignalEvent_vdata(self)[])
  let self = QStateMachineSignalEvent(h: self)
  let slotval1 = accepted
  vtbl[].setAccepted(self, slotval1)

proc fcQStateMachineSignalEvent_vtable_callback_clone(self: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QStateMachineSignalEventVTable](fcQStateMachineSignalEvent_vdata(self)[])
  let self = QStateMachineSignalEvent(h: self)
...
type VirtualQStateMachineSignalEvent* {.inheritable.} = ref object of QStateMachineSignalEvent
  vtbl*: cQStateMachineSignalEventVTable

method setAccepted*(self: VirtualQStateMachineSignalEvent, accepted: bool): void {.base.} =
  QStateMachineSignalEventsetAccepted(self[], accepted)
method clone*(self: VirtualQStateMachineSignalEvent): gen_qcoreevent_types.QEvent {.base.} =
  QStateMachineSignalEventclone(self[])

proc fcQStateMachineSignalEvent_method_callback_setAccepted(self: pointer, accepted: bool): void {.cdecl.} =
  let inst = cast[VirtualQStateMachineSignalEvent](fcQStateMachineSignalEvent_vdata(self)[])
  let slotval1 = accepted
  inst.setAccepted(slotval1)

proc fcQStateMachineSignalEvent_method_callback_clone(self: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQStateMachineSignalEvent](fcQStateMachineSignalEvent_vdata(self)[])
...
proc create*(T: type gen_qstatemachine_types.QStateMachineSignalEvent,
    sender: gen_qobject_types.QObject, signalIndex: cint, arguments: openArray[gen_qvariant_types.QVariant],
    vtbl: ref QStateMachineSignalEventVTable = nil): gen_qstatemachine_types.QStateMachineSignalEvent =
  var arguments_CArray = newSeq[pointer](len(arguments))
  for i in 0..<len(arguments):
    arguments_CArray[i] = arguments[i].h

  let vtbl = if vtbl == nil: new QStateMachineSignalEventVTable else: vtbl
  GC_ref(vtbl)
  vtbl[].vtbl.destructor = proc(self: pointer) {.cdecl.} =
    let vtbl = cast[ref QStateMachineSignalEventVTable](fcQStateMachineSignalEvent_vdata(self)[])
    GC_unref(vtbl)
  if not isNil(vtbl[].setAccepted):
    vtbl[].vtbl.setAccepted = fcQStateMachineSignalEvent_vtable_callback_setAccepted
  if not isNil(vtbl[].clone):
    vtbl[].vtbl.clone = fcQStateMachineSignalEvent_vtable_callback_clone
  let tmp = gen_qstatemachine_types.QStateMachineSignalEvent(h: fcQStateMachineSignalEvent_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), sender.h, signalIndex, struct_seaqt_array(len: csize_t(len(arguments)), data: if len(arguments) == 0: nil else: addr(arguments_CArray[0]))), owned: true)
  fcQStateMachineSignalEvent_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qstatemachine_types.QStateMachineSignalEvent,
    fromVal: gen_qstatemachine_types.QStateMachineSignalEvent,
    vtbl: ref QStateMachineSignalEventVTable = nil): gen_qstatemachine_types.QStateMachineSignalEvent =
  let vtbl = if vtbl == nil: new QStateMachineSignalEventVTable else: vtbl
  GC_ref(vtbl)
  vtbl[].vtbl.destructor = proc(self: pointer) {.cdecl.} =
  ...
  if not isNil(vtbl[].clone):
    vtbl[].vtbl.clone = fcQStateMachineSignalEvent_vtable_callback_clone
  let tmp = gen_qstatemachine_types.QStateMachineSignalEvent(h: fcQStateMachineSignalEvent_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), fromVal.h), owned: true)
  fcQStateMachineSignalEvent_vdata(tmp.h)[] = addr(vtbl[])
  tmp
const cQStateMachineSignalEvent_mvtbl = cQStateMachineSignalEventVTable(
  destructor: proc(self: pointer) {.cdecl.} =
    let inst = cast[ptr typeof(VirtualQStateMachineSignalEvent()[])](self.fcQStateMachineSignalEvent_vdata()[])
    inst[].h = nil
    inst[].owned = false,

  setAccepted: fcQStateMachineSignalEvent_method_callback_setAccepted,
  clone: fcQStateMachineSignalEvent_method_callback_clone,
)
proc create*(T: type gen_qstatemachine_types.QStateMachineSignalEvent,
    sender: gen_qobject_types.QObject, signalIndex: cint, arguments: openArray[gen_qvariant_types.QVariant],
    inst: VirtualQStateMachineSignalEvent) =
  var arguments_CArray = newSeq[pointer](len(arguments))
  for i in 0..<len(arguments):
    arguments_CArray[i] = arguments[i].h

  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQStateMachineSignalEvent_new(addr(cQStateMachineSignalEvent_mvtbl), csize_t(sizeof(pointer)), sender.h, signalIndex, struct_seaqt_array(len: csize_t(len(arguments)), data: if len(arguments) == 0: nil else: addr(arguments_CArray[0])))
  fcQStateMachineSignalEvent_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qstatemachine_types.QStateMachineSignalEvent,
    ...
    inst: VirtualQStateMachineSignalEvent) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQStateMachineSignalEvent_new2(addr(cQStateMachineSignalEvent_mvtbl), csize_t(sizeof(pointer)), fromVal.h)
  fcQStateMachineSignalEvent_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc operatorAssign*(self: gen_qstatemachine_types.QStateMachineWrappedEvent, fromVal: gen_qstatemachine_types.QStateMachineWrappedEvent): void =
  fcQStateMachineWrappedEvent_operatorAssign(self.h, fromVal.h)

type QStateMachineWrappedEventsetAcceptedProc* = proc(self: QStateMachineWrappedEvent, accepted: bool): void {.raises: [], gcsafe.}
type QStateMachineWrappedEventcloneProc* = proc(self: QStateMachineWrappedEvent): gen_qcoreevent_types.QEvent {.raises: [], gcsafe.}

type QStateMachineWrappedEventVTable* {.inheritable, pure.} = object
  vtbl: cQStateMachineWrappedEventVTable
  setAccepted*: QStateMachineWrappedEventsetAcceptedProc
  clone*: QStateMachineWrappedEventcloneProc

proc QStateMachineWrappedEventsetAccepted*(self: gen_qstatemachine_types.QStateMachineWrappedEvent, accepted: bool): void =
  fcQStateMachineWrappedEvent_virtualbase_setAccepted(self.h, accepted)

proc QStateMachineWrappedEventclone*(self: gen_qstatemachine_types.QStateMachineWrappedEvent): gen_qcoreevent_types.QEvent =
  gen_qcoreevent_types.QEvent(h: fcQStateMachineWrappedEvent_virtualbase_clone(self.h), owned: false)


proc fcQStateMachineWrappedEvent_vtable_callback_setAccepted(self: pointer, accepted: bool): void {.cdecl.} =
  let vtbl = cast[ptr QStateMachineWrappedEventVTable](fcQStateMachineWrappedEvent_vdata(self)[])
  let self = QStateMachineWrappedEvent(h: self)
  let slotval1 = accepted
  vtbl[].setAccepted(self, slotval1)

proc fcQStateMachineWrappedEvent_vtable_callback_clone(self: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QStateMachineWrappedEventVTable](fcQStateMachineWrappedEvent_vdata(self)[])
  let self = QStateMachineWrappedEvent(h: self)
  var virtualReturn = vtbl[].clone(self)
  virtualReturn.owned = false # TODO move?
...
type VirtualQStateMachineWrappedEvent* {.inheritable.} = ref object of QStateMachineWrappedEvent
  vtbl*: cQStateMachineWrappedEventVTable

method setAccepted*(self: VirtualQStateMachineWrappedEvent, accepted: bool): void {.base.} =
  QStateMachineWrappedEventsetAccepted(self[], accepted)
method clone*(self: VirtualQStateMachineWrappedEvent): gen_qcoreevent_types.QEvent {.base.} =
  QStateMachineWrappedEventclone(self[])

proc fcQStateMachineWrappedEvent_method_callback_setAccepted(self: pointer, accepted: bool): void {.cdecl.} =
  let inst = cast[VirtualQStateMachineWrappedEvent](fcQStateMachineWrappedEvent_vdata(self)[])
  let slotval1 = accepted
  inst.setAccepted(slotval1)

proc fcQStateMachineWrappedEvent_method_callback_clone(self: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQStateMachineWrappedEvent](fcQStateMachineWrappedEvent_vdata(self)[])
  var virtualReturn = inst.clone()
  virtualReturn.owned = false # TODO move?
  let virtualReturn_h = virtualReturn.h
...
proc create*(T: type gen_qstatemachine_types.QStateMachineWrappedEvent,
    objectVal: gen_qobject_types.QObject, event: gen_qcoreevent_types.QEvent,
    vtbl: ref QStateMachineWrappedEventVTable = nil): gen_qstatemachine_types.QStateMachineWrappedEvent =
  let vtbl = if vtbl == nil: new QStateMachineWrappedEventVTable else: vtbl
  GC_ref(vtbl)
  vtbl[].vtbl.destructor = proc(self: pointer) {.cdecl.} =
    let vtbl = cast[ref QStateMachineWrappedEventVTable](fcQStateMachineWrappedEvent_vdata(self)[])
    GC_unref(vtbl)
  if not isNil(vtbl[].setAccepted):
    vtbl[].vtbl.setAccepted = fcQStateMachineWrappedEvent_vtable_callback_setAccepted
  if not isNil(vtbl[].clone):
    vtbl[].vtbl.clone = fcQStateMachineWrappedEvent_vtable_callback_clone
  let tmp = gen_qstatemachine_types.QStateMachineWrappedEvent(h: fcQStateMachineWrappedEvent_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), objectVal.h, event.h), owned: true)
  fcQStateMachineWrappedEvent_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qstatemachine_types.QStateMachineWrappedEvent,
    fromVal: gen_qstatemachine_types.QStateMachineWrappedEvent,
    vtbl: ref QStateMachineWrappedEventVTable = nil): gen_qstatemachine_types.QStateMachineWrappedEvent =
  let vtbl = if vtbl == nil: new QStateMachineWrappedEventVTable else: vtbl
  GC_ref(vtbl)
  vtbl[].vtbl.destructor = proc(self: pointer) {.cdecl.} =
  ...
  if not isNil(vtbl[].clone):
    vtbl[].vtbl.clone = fcQStateMachineWrappedEvent_vtable_callback_clone
  let tmp = gen_qstatemachine_types.QStateMachineWrappedEvent(h: fcQStateMachineWrappedEvent_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), fromVal.h), owned: true)
  fcQStateMachineWrappedEvent_vdata(tmp.h)[] = addr(vtbl[])
  tmp
const cQStateMachineWrappedEvent_mvtbl = cQStateMachineWrappedEventVTable(
  destructor: proc(self: pointer) {.cdecl.} =
    let inst = cast[ptr typeof(VirtualQStateMachineWrappedEvent()[])](self.fcQStateMachineWrappedEvent_vdata()[])
    inst[].h = nil
    inst[].owned = false,

  setAccepted: fcQStateMachineWrappedEvent_method_callback_setAccepted,
  clone: fcQStateMachineWrappedEvent_method_callback_clone,
)
proc create*(T: type gen_qstatemachine_types.QStateMachineWrappedEvent,
    objectVal: gen_qobject_types.QObject, event: gen_qcoreevent_types.QEvent,
    inst: VirtualQStateMachineWrappedEvent) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQStateMachineWrappedEvent_new(addr(cQStateMachineWrappedEvent_mvtbl), csize_t(sizeof(pointer)), objectVal.h, event.h)
  fcQStateMachineWrappedEvent_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qstatemachine_types.QStateMachineWrappedEvent,
    ...
    inst: VirtualQStateMachineWrappedEvent) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQStateMachineWrappedEvent_new2(addr(cQStateMachineWrappedEvent_mvtbl), csize_t(sizeof(pointer)), fromVal.h)
  fcQStateMachineWrappedEvent_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
