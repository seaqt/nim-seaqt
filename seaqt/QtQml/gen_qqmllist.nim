...
proc create*(T: type gen_qqmllist_types.QQmlListReference,
  ...
  let tmp = gen_qqmllist_types.QQmlListReference(h: fcQQmlListReference_new2(param1.h, property))
  tmp
proc create*(T: type gen_qqmllist_types.QQmlListReference,
    param1: gen_qqmllist_types.QQmlListReference): gen_qqmllist_types.QQmlListReference =
  let tmp = gen_qqmllist_types.QQmlListReference(h: fcQQmlListReference_new3(param1.h))
  tmp
proc create*(T: type gen_qqmllist_types.QQmlListReference,
  ...
  let tmp = gen_qqmllist_types.QQmlListReference(h: fcQQmlListReference_new4(param1.h, property, param3.h))
  tmp
