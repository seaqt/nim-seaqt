...
proc create*(T: type gen_qqmllist_types.QQmlListReference,
  ...
  let tmp = gen_qqmllist_types.QQmlListReference(h: fcQQmlListReference_new2(variant.h), owned: true)
  tmp
proc create*(T: type gen_qqmllist_types.QQmlListReference,
    o: gen_qobject_types.QObject, property: cstring): gen_qqmllist_types.QQmlListReference =
  let tmp = gen_qqmllist_types.QQmlListReference(h: fcQQmlListReference_new3(o.h, property), owned: true)
  tmp
...
proc create*(T: type gen_qqmllist_types.QQmlListReference,
  ...
  let tmp = gen_qqmllist_types.QQmlListReference(h: fcQQmlListReference_new7(variant.h, engine.h), owned: true)
  tmp
proc create*(T: type gen_qqmllist_types.QQmlListReference,
    o: gen_qobject_types.QObject, property: cstring, engine: gen_qqmlengine_types.QQmlEngine): gen_qqmllist_types.QQmlListReference =
  let tmp = gen_qqmllist_types.QQmlListReference(h: fcQQmlListReference_new8(o.h, property, engine.h), owned: true)
  tmp
