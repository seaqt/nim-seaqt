...
proc property*(self: gen_qjsvalue_types.QJSValue, name: string): gen_qjsvalue_types.QJSValue =
  gen_qjsvalue_types.QJSValue(h: fcQJSValue_property(self.h, struct_miqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name)))))
...
proc create*(T: type gen_qjsvalue_types.QJSValue,
  ...
  let tmp = gen_qjsvalue_types.QJSValue(h: fcQJSValue_new7(struct_miqt_string(data: if len(value) > 0: addr value[0] else: nil, len: csize_t(len(value)))))
  tmp
proc create*(T: type gen_qjsvalue_types.QJSValue,
