...
public:
	...
	friend QObject* QQmlComponent_protectedbase_createObject1(VirtualQQmlComponent* self, QObject* parent);
	friend QObject* QQmlComponent_protectedbase_createObject22(VirtualQQmlComponent* self, QObject* parent, struct miqt_map /* of struct miqt_string to QVariant* */  properties);
...
VirtualQQmlComponent* QQmlComponent_new(const QQmlComponent_VTable* vtbl, size_t vdata) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQQmlComponent>());
...
VirtualQQmlComponent* QQmlComponent_new3(const QQmlComponent_VTable* vtbl, size_t vdata, QQmlEngine* param1, struct miqt_string fileName) {
	QString fileName_QString = QString::fromUtf8(fileName.data, fileName.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQQmlComponent>());
	return _mem_ ? new (_mem_)VirtualQQmlComponent(vtbl, param1, fileName_QString) : nullptr;
}

VirtualQQmlComponent* QQmlComponent_new4(const QQmlComponent_VTable* vtbl, size_t vdata, QQmlEngine* param1, struct miqt_string fileName, int mode) {
	QString fileName_QString = QString::fromUtf8(fileName.data, fileName.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQQmlComponent>());
...
VirtualQQmlComponent* QQmlComponent_new9(const QQmlComponent_VTable* vtbl, size_t vdata, QQmlEngine* param1, struct miqt_string fileName, QObject* parent) {
	QString fileName_QString = QString::fromUtf8(fileName.data, fileName.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQQmlComponent>());
	return _mem_ ? new (_mem_)VirtualQQmlComponent(vtbl, param1, fileName_QString, parent) : nullptr;
}

VirtualQQmlComponent* QQmlComponent_new10(const QQmlComponent_VTable* vtbl, size_t vdata, QQmlEngine* param1, struct miqt_string fileName, int mode, QObject* parent) {
	QString fileName_QString = QString::fromUtf8(fileName.data, fileName.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQQmlComponent>());
...
QObject* QQmlComponent_protectedbase_createObject1(VirtualQQmlComponent* self, QObject* parent) {
	return self->createObject(parent);
}

QObject* QQmlComponent_protectedbase_createObject22(VirtualQQmlComponent* self, QObject* parent, struct miqt_map /* of struct miqt_string to QVariant* */  properties) {
		QVariantMap properties_QMap;
		struct miqt_string* properties_karr = static_cast<struct miqt_string*>(properties.keys);
		QVariant** properties_varr = static_cast<QVariant**>(properties.values);
		for(size_t i = 0; i < properties.len; ++i) {
