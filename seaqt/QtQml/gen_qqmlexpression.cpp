...
VirtualQQmlExpression* QQmlExpression_new(const QQmlExpression_VTable* vtbl, size_t vdata) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQQmlExpression>());
	return _mem_ ? new (_mem_)VirtualQQmlExpression(vtbl) : nullptr;
}

VirtualQQmlExpression* QQmlExpression_new2(const QQmlExpression_VTable* vtbl, size_t vdata, QQmlContext* param1, QObject* param2, struct miqt_string param3) {
...
VirtualQQmlExpression* QQmlExpression_new4(const QQmlExpression_VTable* vtbl, size_t vdata, QQmlContext* param1, QObject* param2, struct miqt_string param3, QObject* param4) {
	QString param3_QString = QString::fromUtf8(param3.data, param3.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQQmlExpression>());
