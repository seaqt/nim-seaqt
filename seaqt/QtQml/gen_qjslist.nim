...
proc fcQJSListForInIterator_new(): ptr cQJSListForInIterator {.importc: "QJSListForInIterator_new".}
proc fcQJSListForInIterator_new2(fromVal: pointer): ptr cQJSListForInIterator {.importc: "QJSListForInIterator_new_from".}
proc fcQJSListForOfIterator_init(self: pointer): void {.importc: "QJSListForOfIterator_init".}
proc fcQJSListForOfIterator_new(): ptr cQJSListForOfIterator {.importc: "QJSListForOfIterator_new".}
proc fcQJSListForOfIterator_new2(fromVal: pointer): ptr cQJSListForOfIterator {.importc: "QJSListForOfIterator_new_from".}
...
proc create*(T: type gen_qjslist_types.QJSListForInIterator): gen_qjslist_types.QJSListForInIterator =
  let tmp = gen_qjslist_types.QJSListForInIterator(h: fcQJSListForInIterator_new(), owned: true)
  tmp
proc create*(T: type gen_qjslist_types.QJSListForInIterator,
    fromVal: gen_qjslist_types.QJSListForInIterator): gen_qjslist_types.QJSListForInIterator =
  let tmp = gen_qjslist_types.QJSListForInIterator(h: fcQJSListForInIterator_new2(fromVal.h), owned: true)
  tmp
proc init*(self: gen_qjslist_types.QJSListForOfIterator): void =
  fcQJSListForOfIterator_init(self.h)

proc create*(T: type gen_qjslist_types.QJSListForOfIterator): gen_qjslist_types.QJSListForOfIterator =
  let tmp = gen_qjslist_types.QJSListForOfIterator(h: fcQJSListForOfIterator_new(), owned: true)
  tmp
proc create*(T: type gen_qjslist_types.QJSListForOfIterator,
    fromVal: gen_qjslist_types.QJSListForOfIterator): gen_qjslist_types.QJSListForOfIterator =
  let tmp = gen_qjslist_types.QJSListForOfIterator(h: fcQJSListForOfIterator_new2(fromVal.h), owned: true)
  tmp
