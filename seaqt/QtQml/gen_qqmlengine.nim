...
proc fcQQmlImageProviderBase_operatorAssign(self: pointer, fromVal: pointer): void {.importc: "QQmlImageProviderBase_operatorAssign".}
...
proc fcQQmlEngine_trUtf8S(s: cstring): struct_seaqt_string {.importc: "QQmlEngine_trUtf8_s".}
...
proc fcQQmlEngine_addNamedBundle(self: pointer, name: struct_seaqt_string, fileName: struct_seaqt_string): bool {.importc: "QQmlEngine_addNamedBundle".}
...
proc fcQQmlEngine_trUtf8SC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QQmlEngine_trUtf8_s_c".}
proc fcQQmlEngine_trUtf8SCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QQmlEngine_trUtf8_s_c_n".}
...
proc operatorAssign*(self: gen_qqmlengine_types.QQmlImageProviderBase, fromVal: gen_qqmlengine_types.QQmlImageProviderBase): void =
  fcQQmlImageProviderBase_operatorAssign(self.h, fromVal.h)
...
proc trUtf8*(_: type gen_qqmlengine_types.QQmlEngine, s: cstring): string =
  let v_ms = fcQQmlEngine_trUtf8S(s)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc addNamedBundle*(self: gen_qqmlengine_types.QQmlEngine, name: openArray[char], fileName: openArray[char]): bool =
  fcQQmlEngine_addNamedBundle(self.h, struct_seaqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name))), struct_seaqt_string(data: if len(fileName) > 0: addr fileName[0] else: nil, len: csize_t(len(fileName))))
