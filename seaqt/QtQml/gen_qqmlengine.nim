...
proc fcQQmlEngine_importPathList(self: pointer): struct_seaqt_array {.importc: "QQmlEngine_importPathList".}
proc fcQQmlEngine_setImportPathList(self: pointer, paths: struct_seaqt_array): void {.importc: "QQmlEngine_setImportPathList".}
proc fcQQmlEngine_addImportPath(self: pointer, dir: struct_seaqt_string): void {.importc: "QQmlEngine_addImportPath".}
proc fcQQmlEngine_pluginPathList(self: pointer): struct_seaqt_array {.importc: "QQmlEngine_pluginPathList".}
proc fcQQmlEngine_setPluginPathList(self: pointer, paths: struct_seaqt_array): void {.importc: "QQmlEngine_setPluginPathList".}
proc fcQQmlEngine_addPluginPath(self: pointer, dir: struct_seaqt_string): void {.importc: "QQmlEngine_addPluginPath".}
proc fcQQmlEngine_addNamedBundle(self: pointer, param1: struct_seaqt_string, param2: struct_seaqt_string): bool {.importc: "QQmlEngine_addNamedBundle".}
proc fcQQmlEngine_importPlugin(self: pointer, filePath: struct_seaqt_string, uri: struct_seaqt_string, errors: struct_seaqt_array): bool {.importc: "QQmlEngine_importPlugin".}
...
proc fcQQmlEngine_urlInterceptors(self: pointer): struct_seaqt_array {.importc: "QQmlEngine_urlInterceptors".}
proc fcQQmlEngine_interceptUrl(self: pointer, url: pointer, typeVal: cint): pointer {.importc: "QQmlEngine_interceptUrl".}
proc fcQQmlEngine_addImageProvider(self: pointer, id: struct_seaqt_string, param2: pointer): void {.importc: "QQmlEngine_addImageProvider".}
proc fcQQmlEngine_imageProvider(self: pointer, id: struct_seaqt_string): pointer {.importc: "QQmlEngine_imageProvider".}
proc fcQQmlEngine_removeImageProvider(self: pointer, id: struct_seaqt_string): void {.importc: "QQmlEngine_removeImageProvider".}
...
proc fcQQmlEngine_setOfflineStoragePath(self: pointer, dir: struct_seaqt_string): void {.importc: "QQmlEngine_setOfflineStoragePath".}
proc fcQQmlEngine_offlineStoragePath(self: pointer): struct_seaqt_string {.importc: "QQmlEngine_offlineStoragePath".}
proc fcQQmlEngine_offlineStorageDatabaseFilePath(self: pointer, databaseName: struct_seaqt_string): struct_seaqt_string {.importc: "QQmlEngine_offlineStorageDatabaseFilePath".}
...
proc fcQQmlEngine_markCurrentFunctionAsTranslationBinding(self: pointer): void {.importc: "QQmlEngine_markCurrentFunctionAsTranslationBinding".}
...
proc fcQQmlEngine_offlineStoragePathChanged(self: pointer): void {.importc: "QQmlEngine_offlineStoragePathChanged".}
proc fcQQmlEngine_connect_offlineStoragePathChanged(self: pointer, slot: int, callback: proc (slot: int) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QQmlEngine_connect_offlineStoragePathChanged".}
...
proc metaObject*(self: gen_qqmlengine_types.QQmlImageProviderBase): gen_qobjectdefs_types.QMetaObject =
  gen_qobjectdefs_types.QMetaObject(h: fcQQmlImageProviderBase_metaObject(self.h), owned: false)
...
proc sender*(self: gen_qqmlengine_types.QQmlImageProviderBase): gen_qobject_types.QObject =
  gen_qobject_types.QObject(h: fcQQmlImageProviderBase_protectedbase_sender(self.h), owned: false)
...
proc setImportPathList*(self: gen_qqmlengine_types.QQmlEngine, paths: openArray[string]): void =
  ...
  fcQQmlEngine_setImportPathList(self.h, struct_seaqt_array(len: csize_t(len(paths)), data: if len(paths) == 0: nil else: addr(paths_CArray[0])))

proc addImportPath*(self: gen_qqmlengine_types.QQmlEngine, dir: openArray[char]): void =
  fcQQmlEngine_addImportPath(self.h, struct_seaqt_string(data: if len(dir) > 0: addr dir[0] else: nil, len: csize_t(len(dir))))
...
proc setPluginPathList*(self: gen_qqmlengine_types.QQmlEngine, paths: openArray[string]): void =
  ...
  fcQQmlEngine_setPluginPathList(self.h, struct_seaqt_array(len: csize_t(len(paths)), data: if len(paths) == 0: nil else: addr(paths_CArray[0])))

proc addPluginPath*(self: gen_qqmlengine_types.QQmlEngine, dir: openArray[char]): void =
  fcQQmlEngine_addPluginPath(self.h, struct_seaqt_string(data: if len(dir) > 0: addr dir[0] else: nil, len: csize_t(len(dir))))

proc addNamedBundle*(self: gen_qqmlengine_types.QQmlEngine, param1: openArray[char], param2: openArray[char]): bool =
  fcQQmlEngine_addNamedBundle(self.h, struct_seaqt_string(data: if len(param1) > 0: addr param1[0] else: nil, len: csize_t(len(param1))), struct_seaqt_string(data: if len(param2) > 0: addr param2[0] else: nil, len: csize_t(len(param2))))
...
proc importPlugin*(self: gen_qqmlengine_types.QQmlEngine, filePath: openArray[char], uri: openArray[char], errors: openArray[gen_qqmlerror_types.QQmlError]): bool =
  ...
  fcQQmlEngine_importPlugin(self.h, struct_seaqt_string(data: if len(filePath) > 0: addr filePath[0] else: nil, len: csize_t(len(filePath))), struct_seaqt_string(data: if len(uri) > 0: addr uri[0] else: nil, len: csize_t(len(uri))), struct_seaqt_array(len: csize_t(len(errors)), data: if len(errors) == 0: nil else: addr(errors_CArray[0])))
...
proc urlInterceptors*(self: gen_qqmlengine_types.QQmlEngine): seq[gen_qqmlabstracturlinterceptor_types.QQmlAbstractUrlInterceptor] =
  ...
  for i in 0 ..< v_ma.len:
    vx_ret[i] = gen_qqmlabstracturlinterceptor_types.QQmlAbstractUrlInterceptor(h: v_outCast[i], owned: false)
  c_free(v_ma.data)
  vx_ret
...
proc addImageProvider*(self: gen_qqmlengine_types.QQmlEngine, id: openArray[char], param2: gen_qqmlengine_types.QQmlImageProviderBase): void =
  fcQQmlEngine_addImageProvider(self.h, struct_seaqt_string(data: if len(id) > 0: addr id[0] else: nil, len: csize_t(len(id))), param2.h)

proc imageProvider*(self: gen_qqmlengine_types.QQmlEngine, id: openArray[char]): gen_qqmlengine_types.QQmlImageProviderBase =
  gen_qqmlengine_types.QQmlImageProviderBase(h: fcQQmlEngine_imageProvider(self.h, struct_seaqt_string(data: if len(id) > 0: addr id[0] else: nil, len: csize_t(len(id)))), owned: false)

proc removeImageProvider*(self: gen_qqmlengine_types.QQmlEngine, id: openArray[char]): void =
  fcQQmlEngine_removeImageProvider(self.h, struct_seaqt_string(data: if len(id) > 0: addr id[0] else: nil, len: csize_t(len(id))))
...
proc setOfflineStoragePath*(self: gen_qqmlengine_types.QQmlEngine, dir: openArray[char]): void =
  fcQQmlEngine_setOfflineStoragePath(self.h, struct_seaqt_string(data: if len(dir) > 0: addr dir[0] else: nil, len: csize_t(len(dir))))
...
proc offlineStorageDatabaseFilePath*(self: gen_qqmlengine_types.QQmlEngine, databaseName: openArray[char]): string =
  let v_ms = fcQQmlEngine_offlineStorageDatabaseFilePath(self.h, struct_seaqt_string(data: if len(databaseName) > 0: addr databaseName[0] else: nil, len: csize_t(len(databaseName))))
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc markCurrentFunctionAsTranslationBinding*(self: gen_qqmlengine_types.QQmlEngine): void =
  fcQQmlEngine_markCurrentFunctionAsTranslationBinding(self.h)
...
proc offlineStoragePathChanged*(self: gen_qqmlengine_types.QQmlEngine): void =
  fcQQmlEngine_offlineStoragePathChanged(self.h)

type QQmlEngineofflineStoragePathChangedSlot* = proc()
proc fcQQmlEngine_slot_callback_offlineStoragePathChanged(slot: int) {.cdecl.} =
  let nimfunc = cast[ptr QQmlEngineofflineStoragePathChangedSlot](cast[pointer](slot))
  nimfunc[]()

proc fcQQmlEngine_slot_callback_offlineStoragePathChanged_release(slot: int) {.cdecl.} =
  let nimfunc = cast[ref QQmlEngineofflineStoragePathChangedSlot](cast[pointer](slot))
  GC_unref(nimfunc)

proc onOfflineStoragePathChanged*(self: gen_qqmlengine_types.QQmlEngine, slot: QQmlEngineofflineStoragePathChangedSlot) =
  var tmp = new QQmlEngineofflineStoragePathChangedSlot
  tmp[] = slot
  GC_ref(tmp)
  fcQQmlEngine_connect_offlineStoragePathChanged(self.h, cast[int](addr tmp[]), fcQQmlEngine_slot_callback_offlineStoragePathChanged, fcQQmlEngine_slot_callback_offlineStoragePathChanged_release)
...
proc fcQQmlEngine_slot_callback_quit(slot: int) {.cdecl.} =
  let nimfunc = cast[ptr QQmlEnginequitSlot](cast[pointer](slot))
  nimfunc[]()

proc fcQQmlEngine_slot_callback_quit_release(slot: int) {.cdecl.} =
...
proc onQuit*(self: gen_qqmlengine_types.QQmlEngine, slot: QQmlEnginequitSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQQmlEngine_connect_quit(self.h, cast[int](addr tmp[]), fcQQmlEngine_slot_callback_quit, fcQQmlEngine_slot_callback_quit_release)
...
proc fcQQmlEngine_slot_callback_exit(slot: int, retCode: cint) {.cdecl.} =
  let nimfunc = cast[ptr QQmlEngineexitSlot](cast[pointer](slot))
  let slotval1 = retCode

  nimfunc[](slotval1)

proc fcQQmlEngine_slot_callback_exit_release(slot: int) {.cdecl.} =
...
proc warnings*(self: gen_qqmlengine_types.QQmlEngine, warnings: openArray[gen_qqmlerror_types.QQmlError]): void =
  ...
  fcQQmlEngine_warnings(self.h, struct_seaqt_array(len: csize_t(len(warnings)), data: if len(warnings) == 0: nil else: addr(warnings_CArray[0])))

type QQmlEnginewarningsSlot* = proc(warnings: openArray[gen_qqmlerror_types.QQmlError])
proc fcQQmlEngine_slot_callback_warnings(slot: int, warnings: struct_seaqt_array) {.cdecl.} =
...
proc fcQQmlEngine_slot_callback_warnings_release(slot: int) {.cdecl.} =
...
proc fcQQmlEngine_vtable_callback_metaObject(self: pointer): pointer {.cdecl.} =
...
proc fcQQmlEngine_vtable_callback_metacast(self: pointer, param1: cstring): pointer {.cdecl.} =
  let vtbl = cast[ptr QQmlEngineVTable](fcQQmlEngine_vdata(self)[])
  let self = QQmlEngine(h: self)
  let slotval1 = (param1)
...
proc fcQQmlEngine_vtable_callback_metacall(self: pointer, param1: cint, param2: cint, param3: pointer): cint {.cdecl.} =
  let vtbl = cast[ptr QQmlEngineVTable](fcQQmlEngine_vdata(self)[])
  let self = QQmlEngine(h: self)
...
proc fcQQmlEngine_vtable_callback_event(self: pointer, param1: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QQmlEngineVTable](fcQQmlEngine_vdata(self)[])
  let self = QQmlEngine(h: self)
...
proc fcQQmlEngine_vtable_callback_eventFilter(self: pointer, watched: pointer, event: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QQmlEngineVTable](fcQQmlEngine_vdata(self)[])
  let self = QQmlEngine(h: self)
...
proc fcQQmlEngine_vtable_callback_timerEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QQmlEngineVTable](fcQQmlEngine_vdata(self)[])
  let self = QQmlEngine(h: self)
  let slotval1 = gen_qcoreevent_types.QTimerEvent(h: event, owned: false)
  vtbl[].timerEvent(self, slotval1)

proc fcQQmlEngine_vtable_callback_childEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QQmlEngineVTable](fcQQmlEngine_vdata(self)[])
  let self = QQmlEngine(h: self)
  let slotval1 = gen_qcoreevent_types.QChildEvent(h: event, owned: false)
  vtbl[].childEvent(self, slotval1)

proc fcQQmlEngine_vtable_callback_customEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QQmlEngineVTable](fcQQmlEngine_vdata(self)[])
  let self = QQmlEngine(h: self)
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
  vtbl[].customEvent(self, slotval1)

proc fcQQmlEngine_vtable_callback_connectNotify(self: pointer, signal: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QQmlEngineVTable](fcQQmlEngine_vdata(self)[])
  let self = QQmlEngine(h: self)
  let slotval1 = gen_qmetaobject_types.QMetaMethod(h: signal, owned: false)
  vtbl[].connectNotify(self, slotval1)

proc fcQQmlEngine_vtable_callback_disconnectNotify(self: pointer, signal: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QQmlEngineVTable](fcQQmlEngine_vdata(self)[])
  let self = QQmlEngine(h: self)
  let slotval1 = gen_qmetaobject_types.QMetaMethod(h: signal, owned: false)
...
proc fcQQmlEngine_method_callback_metaObject(self: pointer): pointer {.cdecl.} =
...
proc fcQQmlEngine_method_callback_metacast(self: pointer, param1: cstring): pointer {.cdecl.} =
  let inst = cast[VirtualQQmlEngine](fcQQmlEngine_vdata(self)[])
  let slotval1 = (param1)
  var virtualReturn = inst.metacast(slotval1)
  virtualReturn

proc fcQQmlEngine_method_callback_metacall(self: pointer, param1: cint, param2: cint, param3: pointer): cint {.cdecl.} =
  let inst = cast[VirtualQQmlEngine](fcQQmlEngine_vdata(self)[])
  let slotval1 = cint(param1)
  let slotval2 = param2
  let slotval3 = param3
...
proc fcQQmlEngine_method_callback_event(self: pointer, param1: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQQmlEngine](fcQQmlEngine_vdata(self)[])
  let slotval1 = gen_qcoreevent_types.QEvent(h: param1, owned: false)
  var virtualReturn = inst.event(slotval1)
  virtualReturn

proc fcQQmlEngine_method_callback_eventFilter(self: pointer, watched: pointer, event: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQQmlEngine](fcQQmlEngine_vdata(self)[])
  let slotval1 = gen_qobject_types.QObject(h: watched, owned: false)
  let slotval2 = gen_qcoreevent_types.QEvent(h: event, owned: false)
...
proc fcQQmlEngine_method_callback_timerEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQQmlEngine](fcQQmlEngine_vdata(self)[])
  let slotval1 = gen_qcoreevent_types.QTimerEvent(h: event, owned: false)
  inst.timerEvent(slotval1)

proc fcQQmlEngine_method_callback_childEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQQmlEngine](fcQQmlEngine_vdata(self)[])
  let slotval1 = gen_qcoreevent_types.QChildEvent(h: event, owned: false)
  inst.childEvent(slotval1)

proc fcQQmlEngine_method_callback_customEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQQmlEngine](fcQQmlEngine_vdata(self)[])
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
  inst.customEvent(slotval1)

proc fcQQmlEngine_method_callback_connectNotify(self: pointer, signal: pointer): void {.cdecl.} =
  let inst = cast[VirtualQQmlEngine](fcQQmlEngine_vdata(self)[])
  let slotval1 = gen_qmetaobject_types.QMetaMethod(h: signal, owned: false)
  inst.connectNotify(slotval1)

proc fcQQmlEngine_method_callback_disconnectNotify(self: pointer, signal: pointer): void {.cdecl.} =
  let inst = cast[VirtualQQmlEngine](fcQQmlEngine_vdata(self)[])
  let slotval1 = gen_qmetaobject_types.QMetaMethod(h: signal, owned: false)
...
proc create*(T: type gen_qqmlengine_types.QQmlEngine,
  ...
  if not isNil(vtbl[].metaObject):
    vtbl[].vtbl.metaObject = fcQQmlEngine_vtable_callback_metaObject
  if not isNil(vtbl[].metacast):
    vtbl[].vtbl.metacast = fcQQmlEngine_vtable_callback_metacast
  if not isNil(vtbl[].metacall):
    vtbl[].vtbl.metacall = fcQQmlEngine_vtable_callback_metacall
  if not isNil(vtbl[].event):
    vtbl[].vtbl.event = fcQQmlEngine_vtable_callback_event
  if not isNil(vtbl[].eventFilter):
    vtbl[].vtbl.eventFilter = fcQQmlEngine_vtable_callback_eventFilter
  if not isNil(vtbl[].timerEvent):
    vtbl[].vtbl.timerEvent = fcQQmlEngine_vtable_callback_timerEvent
  if not isNil(vtbl[].childEvent):
    vtbl[].vtbl.childEvent = fcQQmlEngine_vtable_callback_childEvent
  if not isNil(vtbl[].customEvent):
    vtbl[].vtbl.customEvent = fcQQmlEngine_vtable_callback_customEvent
  if not isNil(vtbl[].connectNotify):
    vtbl[].vtbl.connectNotify = fcQQmlEngine_vtable_callback_connectNotify
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQQmlEngine_vtable_callback_disconnectNotify
  let tmp = gen_qqmlengine_types.QQmlEngine(h: fcQQmlEngine_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQQmlEngine_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qqmlengine_types.QQmlEngine,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQQmlEngine_vtable_callback_disconnectNotify
  let tmp = gen_qqmlengine_types.QQmlEngine(h: fcQQmlEngine_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), p.h), owned: true)
  fcQQmlEngine_vdata(tmp.h)[] = addr(vtbl[])
  tmp
const cQQmlEngine_mvtbl = cQQmlEngineVTable(
  ...
  metaObject: fcQQmlEngine_method_callback_metaObject,
  metacast: fcQQmlEngine_method_callback_metacast,
  metacall: fcQQmlEngine_method_callback_metacall,
  event: fcQQmlEngine_method_callback_event,
  eventFilter: fcQQmlEngine_method_callback_eventFilter,
  timerEvent: fcQQmlEngine_method_callback_timerEvent,
  childEvent: fcQQmlEngine_method_callback_childEvent,
  customEvent: fcQQmlEngine_method_callback_customEvent,
  connectNotify: fcQQmlEngine_method_callback_connectNotify,
  disconnectNotify: fcQQmlEngine_method_callback_disconnectNotify,
)
proc create*(T: type gen_qqmlengine_types.QQmlEngine,
