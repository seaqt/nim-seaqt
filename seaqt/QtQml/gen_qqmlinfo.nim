...
proc operatorShiftLeft*(self: gen_qqmlinfo_types.QQmlInfo, t: string): gen_qqmlinfo_types.QQmlInfo =
  gen_qqmlinfo_types.QQmlInfo(h: fcQQmlInfo_operatorShiftLeftWithQString(self.h, struct_miqt_string(data: if len(t) > 0: addr t[0] else: nil, len: csize_t(len(t)))))

proc operatorShiftLeft*(self: gen_qqmlinfo_types.QQmlInfo, t: seq[byte]): gen_qqmlinfo_types.QQmlInfo =
  gen_qqmlinfo_types.QQmlInfo(h: fcQQmlInfo_operatorShiftLeftWithQByteArray(self.h, struct_miqt_string(data: if len(t) > 0: addr t[0] else: nil, len: csize_t(len(t)))))
