...
proc fcQQmlScriptString_operatorAssign(self: pointer, fromVal: pointer): void {.importc: "QQmlScriptString_operatorAssign".}
...
proc fcQQmlScriptString_stringLiteral(self: pointer): struct_seaqt_string {.importc: "QQmlScriptString_stringLiteral".}
...
proc fcQQmlScriptString_new2(fromVal: pointer): ptr cQQmlScriptString {.importc: "QQmlScriptString_new_from".}
proc fcQQmlScriptString_staticMetaObject(): pointer {.importc: "QQmlScriptString_staticMetaObject".}

proc operatorAssign*(self: gen_qqmlscriptstring_types.QQmlScriptString, fromVal: gen_qqmlscriptstring_types.QQmlScriptString): void =
  fcQQmlScriptString_operatorAssign(self.h, fromVal.h)
...
proc create*(T: type gen_qqmlscriptstring_types.QQmlScriptString,
    fromVal: gen_qqmlscriptstring_types.QQmlScriptString): gen_qqmlscriptstring_types.QQmlScriptString =
  let tmp = gen_qqmlscriptstring_types.QQmlScriptString(h: fcQQmlScriptString_new2(fromVal.h), owned: true)
  tmp
