...
proc property*(self: gen_qjsmanagedvalue_types.QJSManagedValue, name: openArray[char]): gen_qjsvalue_types.QJSValue =
  gen_qjsvalue_types.QJSValue(h: fcQJSManagedValue_property(self.h, struct_seaqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name)))))
...
proc call*(self: gen_qjsmanagedvalue_types.QJSManagedValue, arguments: openArray[gen_qjsvalue_types.QJSValue]): gen_qjsvalue_types.QJSValue =
  ...
  gen_qjsvalue_types.QJSValue(h: fcQJSManagedValue_callWithArguments(self.h, struct_seaqt_array(len: csize_t(len(arguments)), data: if len(arguments) == 0: nil else: addr(arguments_CArray[0]))))
...
proc callWithInstance*(self: gen_qjsmanagedvalue_types.QJSManagedValue, instance: gen_qjsvalue_types.QJSValue, arguments: openArray[gen_qjsvalue_types.QJSValue]): gen_qjsvalue_types.QJSValue =
  ...
  gen_qjsvalue_types.QJSValue(h: fcQJSManagedValue_callWithInstance2(self.h, instance.h, struct_seaqt_array(len: csize_t(len(arguments)), data: if len(arguments) == 0: nil else: addr(arguments_CArray[0]))))
...
proc callAsConstructor*(self: gen_qjsmanagedvalue_types.QJSManagedValue, arguments: openArray[gen_qjsvalue_types.QJSValue]): gen_qjsvalue_types.QJSValue =
  ...
  gen_qjsvalue_types.QJSValue(h: fcQJSManagedValue_callAsConstructorWithArguments(self.h, struct_seaqt_array(len: csize_t(len(arguments)), data: if len(arguments) == 0: nil else: addr(arguments_CArray[0]))))
...
proc jsMetaInstantiate*(self: gen_qjsmanagedvalue_types.QJSManagedValue, values: openArray[gen_qjsvalue_types.QJSValue]): gen_qjsmanagedvalue_types.QJSManagedValue =
  ...
  gen_qjsmanagedvalue_types.QJSManagedValue(h: fcQJSManagedValue_jsMetaInstantiateWithValues(self.h, struct_seaqt_array(len: csize_t(len(values)), data: if len(values) == 0: nil else: addr(values_CArray[0]))))

proc create*(T: type gen_qjsmanagedvalue_types.QJSManagedValue): gen_qjsmanagedvalue_types.QJSManagedValue =
  let tmp = gen_qjsmanagedvalue_types.QJSManagedValue(h: fcQJSManagedValue_new())
  tmp
proc create*(T: type gen_qjsmanagedvalue_types.QJSManagedValue,
  ...
  let tmp = gen_qjsmanagedvalue_types.QJSManagedValue(h: fcQJSManagedValue_new2(value.h, engine.h))
  tmp
proc create*(T: type gen_qjsmanagedvalue_types.QJSManagedValue,
  ...
  let tmp = gen_qjsmanagedvalue_types.QJSManagedValue(h: fcQJSManagedValue_new3(value.h, engine.h))
  tmp
proc create*(T: type gen_qjsmanagedvalue_types.QJSManagedValue,
    variant: gen_qvariant_types.QVariant, engine: gen_qjsengine_types.QJSEngine): gen_qjsmanagedvalue_types.QJSManagedValue =
  let tmp = gen_qjsmanagedvalue_types.QJSManagedValue(h: fcQJSManagedValue_new4(variant.h, engine.h))
  tmp
proc create*(T: type gen_qjsmanagedvalue_types.QJSManagedValue,
    stringVal: openArray[char], engine: gen_qjsengine_types.QJSEngine): gen_qjsmanagedvalue_types.QJSManagedValue =
  let tmp = gen_qjsmanagedvalue_types.QJSManagedValue(h: fcQJSManagedValue_new5(struct_seaqt_string(data: if len(stringVal) > 0: addr stringVal[0] else: nil, len: csize_t(len(stringVal))), engine.h))
  tmp
