...
proc fcQQmlComponent_new3(vtbl: pointer, vdata: csize_t, param1: pointer, fileName: struct_miqt_string): ptr cQQmlComponent {.importc: "QQmlComponent_new3".}
proc fcQQmlComponent_new4(vtbl: pointer, vdata: csize_t, param1: pointer, fileName: struct_miqt_string, mode: cint): ptr cQQmlComponent {.importc: "QQmlComponent_new4".}
...
proc fcQQmlComponent_new9(vtbl: pointer, vdata: csize_t, param1: pointer, fileName: struct_miqt_string, parent: pointer): ptr cQQmlComponent {.importc: "QQmlComponent_new9".}
proc fcQQmlComponent_new10(vtbl: pointer, vdata: csize_t, param1: pointer, fileName: struct_miqt_string, mode: cint, parent: pointer): ptr cQQmlComponent {.importc: "QQmlComponent_new10".}
...
proc setData*(self: gen_qqmlcomponent_types.QQmlComponent, param1: seq[byte], baseUrl: gen_qurl_types.QUrl): void =
  fcQQmlComponent_setData(self.h, struct_miqt_string(data: if len(param1) > 0: addr param1[0] else: nil, len: csize_t(len(param1))), baseUrl.h)
...
proc fcQQmlComponent_vtable_callback_create(self: pointer, context: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QQmlComponentVTable](fcQQmlComponent_vdata(self)[])
  let self = QQmlComponent(h: self)
...
proc fcQQmlComponent_method_callback_create(self: pointer, context: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQQmlComponent](fcQQmlComponent_vdata(self)[])
  let slotval1 = gen_qqmlcontext_types.QQmlContext(h: context, owned: false)
...
proc create*(T: type gen_qqmlcomponent_types.QQmlComponent,
  ...
  if not isNil(vtbl[].create):
    vtbl[].vtbl.create = fcQQmlComponent_vtable_callback_create
...
proc create*(T: type gen_qqmlcomponent_types.QQmlComponent,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQQmlComponent_vtable_callback_disconnectNotify
  let tmp = gen_qqmlcomponent_types.QQmlComponent(h: fcQQmlComponent_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), param1.h, struct_miqt_string(data: if len(fileName) > 0: addr fileName[0] else: nil, len: csize_t(len(fileName)))), owned: true)
  fcQQmlComponent_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qqmlcomponent_types.QQmlComponent,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQQmlComponent_vtable_callback_disconnectNotify
  let tmp = gen_qqmlcomponent_types.QQmlComponent(h: fcQQmlComponent_new4(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), param1.h, struct_miqt_string(data: if len(fileName) > 0: addr fileName[0] else: nil, len: csize_t(len(fileName))), cint(mode)), owned: true)
  fcQQmlComponent_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qqmlcomponent_types.QQmlComponent,
...
proc create*(T: type gen_qqmlcomponent_types.QQmlComponent,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQQmlComponent_vtable_callback_disconnectNotify
  let tmp = gen_qqmlcomponent_types.QQmlComponent(h: fcQQmlComponent_new9(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), param1.h, struct_miqt_string(data: if len(fileName) > 0: addr fileName[0] else: nil, len: csize_t(len(fileName))), parent.h), owned: true)
  fcQQmlComponent_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qqmlcomponent_types.QQmlComponent,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQQmlComponent_vtable_callback_disconnectNotify
  let tmp = gen_qqmlcomponent_types.QQmlComponent(h: fcQQmlComponent_new10(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), param1.h, struct_miqt_string(data: if len(fileName) > 0: addr fileName[0] else: nil, len: csize_t(len(fileName))), cint(mode), parent.h), owned: true)
  fcQQmlComponent_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qqmlcomponent_types.QQmlComponent,
...
const cQQmlComponent_mvtbl = cQQmlComponentVTable(
  ...
  create: fcQQmlComponent_method_callback_create,
...
proc create*(T: type gen_qqmlcomponent_types.QQmlComponent,
    ...
    inst: VirtualQQmlComponent) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQQmlComponent_new3(addr(cQQmlComponent_mvtbl), csize_t(sizeof(pointer)), param1.h, struct_miqt_string(data: if len(fileName) > 0: addr fileName[0] else: nil, len: csize_t(len(fileName))))
  fcQQmlComponent_vdata(inst[].h)[] = addr inst[]
...
proc create*(T: type gen_qqmlcomponent_types.QQmlComponent,
    ...
    inst: VirtualQQmlComponent) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQQmlComponent_new4(addr(cQQmlComponent_mvtbl), csize_t(sizeof(pointer)), param1.h, struct_miqt_string(data: if len(fileName) > 0: addr fileName[0] else: nil, len: csize_t(len(fileName))), cint(mode))
  fcQQmlComponent_vdata(inst[].h)[] = addr inst[]
...
proc create*(T: type gen_qqmlcomponent_types.QQmlComponent,
    ...
    inst: VirtualQQmlComponent) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQQmlComponent_new9(addr(cQQmlComponent_mvtbl), csize_t(sizeof(pointer)), param1.h, struct_miqt_string(data: if len(fileName) > 0: addr fileName[0] else: nil, len: csize_t(len(fileName))), parent.h)
  fcQQmlComponent_vdata(inst[].h)[] = addr inst[]
...
proc create*(T: type gen_qqmlcomponent_types.QQmlComponent,
    ...
    inst: VirtualQQmlComponent) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQQmlComponent_new10(addr(cQQmlComponent_mvtbl), csize_t(sizeof(pointer)), param1.h, struct_miqt_string(data: if len(fileName) > 0: addr fileName[0] else: nil, len: csize_t(len(fileName))), cint(mode), parent.h)
  fcQQmlComponent_vdata(inst[].h)[] = addr inst[]
