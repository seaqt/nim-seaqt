...
void QQmlApplicationEngine_connect_objectCreationFailed(VirtualQQmlApplicationEngine* self, intptr_t slot, void (*callback)(intptr_t, QUrl*), void (*release)(intptr_t));
