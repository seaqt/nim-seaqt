...
proc fcQQmlContext_trUtf8(s: cstring): struct_seaqt_string {.importc: "QQmlContext_trUtf8".}
...
proc fcQQmlContext_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QQmlContext_trUtf82".}
proc fcQQmlContext_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QQmlContext_trUtf83".}
