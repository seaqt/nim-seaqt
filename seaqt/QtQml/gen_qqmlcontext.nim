...
proc fcQQmlContext_childContexts(self: pointer): struct_seaqt_array {.importc: "QQmlContext_childContexts".}
...
proc fcQQmlContext_findObjectRecursively(self: pointer, id: struct_seaqt_string): pointer {.importc: "QQmlContext_findObjectRecursively".}
proc fcQQmlContext_findObjectsRecursively(self: pointer, id: struct_seaqt_string): struct_seaqt_array {.importc: "QQmlContext_findObjectsRecursively".}
...
proc childContexts*(self: gen_qqmlcontext_types.QQmlContext): seq[gen_qqmlcontext_types.QQmlContext] =
  var v_ma = fcQQmlContext_childContexts(self.h)
  var vx_ret = newSeq[gen_qqmlcontext_types.QQmlContext](int(v_ma.len))
  let v_outCast = cast[ptr UncheckedArray[pointer]](v_ma.data)
  for i in 0 ..< v_ma.len:
    vx_ret[i] = gen_qqmlcontext_types.QQmlContext(h: v_outCast[i], owned: false)
  c_free(v_ma.data)
  vx_ret
...
proc setContextProperties*(self: gen_qqmlcontext_types.QQmlContext, properties: openArray[gen_qqmlcontext_types.QQmlContextPropertyPair]): void =
  ...
  fcQQmlContext_setContextProperties(self.h, struct_seaqt_array(len: csize_t(len(properties)), data: if len(properties) == 0: nil else: addr(properties_CArray[0])))
...
proc objectForName*(self: gen_qqmlcontext_types.QQmlContext, param1: openArray[char]): gen_qobject_types.QObject =
  gen_qobject_types.QObject(h: fcQQmlContext_objectForName(self.h, struct_seaqt_string(data: if len(param1) > 0: addr param1[0] else: nil, len: csize_t(len(param1)))), owned: false)

proc findObjectRecursively*(self: gen_qqmlcontext_types.QQmlContext, id: openArray[char]): gen_qobject_types.QObject =
  gen_qobject_types.QObject(h: fcQQmlContext_findObjectRecursively(self.h, struct_seaqt_string(data: if len(id) > 0: addr id[0] else: nil, len: csize_t(len(id)))), owned: false)

proc findObjectsRecursively*(self: gen_qqmlcontext_types.QQmlContext, id: openArray[char]): seq[gen_qobject_types.QObject] =
  var v_ma = fcQQmlContext_findObjectsRecursively(self.h, struct_seaqt_string(data: if len(id) > 0: addr id[0] else: nil, len: csize_t(len(id))))
...
proc create*(T: type gen_qqmlcontext_types.QQmlContext,
  ...
  let tmp = gen_qqmlcontext_types.QQmlContext(h: fcQQmlContext_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQQmlContext_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qqmlcontext_types.QQmlContext,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQQmlContext_vtable_callback_disconnectNotify
  let tmp = gen_qqmlcontext_types.QQmlContext(h: fcQQmlContext_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQQmlContext_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qqmlcontext_types.QQmlContext,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQQmlContext_vtable_callback_disconnectNotify
  let tmp = gen_qqmlcontext_types.QQmlContext(h: fcQQmlContext_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h, objParent.h), owned: true)
  fcQQmlContext_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qqmlcontext_types.QQmlContext,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQQmlContext_vtable_callback_disconnectNotify
  let tmp = gen_qqmlcontext_types.QQmlContext(h: fcQQmlContext_new4(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h, objParent.h), owned: true)
  fcQQmlContext_vdata(tmp.h)[] = addr(vtbl[])
  tmp
...
proc name*(self: gen_qqmlcontext_types.QQmlContextPropertyPair): string =
  let vname_ms = fcQQmlContextPropertyPair_name(self.h)
  let vnamex_ret = string.fromBytes(vname_ms)
  c_free(vname_ms.data)
  vnamex_ret

proc setName*(self: gen_qqmlcontext_types.QQmlContextPropertyPair, name: openArray[char]): void =
  fcQQmlContextPropertyPair_setName(self.h, struct_seaqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name))))

proc value*(self: gen_qqmlcontext_types.QQmlContextPropertyPair): gen_qvariant_types.QVariant =
  gen_qvariant_types.QVariant(h: fcQQmlContextPropertyPair_value(self.h), owned: true)
