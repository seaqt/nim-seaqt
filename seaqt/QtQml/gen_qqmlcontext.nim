...
proc contextProperty*(self: gen_qqmlcontext_types.QQmlContext, param1: string): gen_qvariant_types.QVariant =
  gen_qvariant_types.QVariant(h: fcQQmlContext_contextProperty(self.h, struct_miqt_string(data: if len(param1) > 0: addr param1[0] else: nil, len: csize_t(len(param1)))))
...
proc objectForName*(self: gen_qqmlcontext_types.QQmlContext, param1: string): gen_qobject_types.QObject =
  gen_qobject_types.QObject(h: fcQQmlContext_objectForName(self.h, struct_miqt_string(data: if len(param1) > 0: addr param1[0] else: nil, len: csize_t(len(param1)))))
...
proc importedScript*(self: gen_qqmlcontext_types.QQmlContext, name: string): gen_qjsvalue_types.QJSValue =
  gen_qjsvalue_types.QJSValue(h: fcQQmlContext_importedScript(self.h, struct_miqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name)))))
