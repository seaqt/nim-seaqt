...
type QPdfBookmarkModelStructureModeEnum* = distinct cint
template TreeMode*(_: type QPdfBookmarkModelStructureModeEnum): untyped = 0
template ListMode*(_: type QPdfBookmarkModelStructureModeEnum): untyped = 1


type QPdfBookmarkModelRoleEnum* = distinct cint
template TitleRole*(_: type QPdfBookmarkModelRoleEnum): untyped = 0
template LevelRole*(_: type QPdfBookmarkModelRoleEnum): untyped = 256
template PageNumberRole*(_: type QPdfBookmarkModelRoleEnum): untyped = 257
...
proc fcQPdfBookmarkModel_setStructureMode(self: pointer, mode: cint): void {.importc: "QPdfBookmarkModel_setStructureMode".}
...
proc structureMode*(self: gen_qpdfbookmarkmodel_types.QPdfBookmarkModel): cint =
  cint(fcQPdfBookmarkModel_structureMode(self.h))

proc setStructureMode*(self: gen_qpdfbookmarkmodel_types.QPdfBookmarkModel, mode: cint): void =
  fcQPdfBookmarkModel_setStructureMode(self.h, cint(mode))
...
proc structureModeChanged*(self: gen_qpdfbookmarkmodel_types.QPdfBookmarkModel, structureMode: cint): void =
  fcQPdfBookmarkModel_structureModeChanged(self.h, cint(structureMode))

type QPdfBookmarkModelstructureModeChangedSlot* = proc(structureMode: cint)
proc fcQPdfBookmarkModel_slot_callback_structureModeChanged(slot: int, structureMode: cint) {.cdecl.} =
  let nimfunc = cast[ptr QPdfBookmarkModelstructureModeChangedSlot](cast[pointer](slot))
  let slotval1 = cint(structureMode)

  nimfunc[](slotval1)

proc fcQPdfBookmarkModel_slot_callback_structureModeChanged_release(slot: int) {.cdecl.} =
  let nimfunc = cast[ref QPdfBookmarkModelstructureModeChangedSlot](cast[pointer](slot))
  GC_unref(nimfunc)

proc onStructureModeChanged*(self: gen_qpdfbookmarkmodel_types.QPdfBookmarkModel, slot: QPdfBookmarkModelstructureModeChangedSlot) =
  var tmp = new QPdfBookmarkModelstructureModeChangedSlot
  tmp[] = slot
  GC_ref(tmp)
...
proc resetInternalData*(self: gen_qpdfbookmarkmodel_types.QPdfBookmarkModel): void =
