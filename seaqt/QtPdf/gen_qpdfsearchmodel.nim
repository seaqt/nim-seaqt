...
proc fcQPdfSearchModel_trUtf8S(s: cstring): struct_seaqt_string {.importc: "QPdfSearchModel_trUtf8_s".}
...
proc fcQPdfSearchModel_trUtf8SC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QPdfSearchModel_trUtf8_s_c".}
proc fcQPdfSearchModel_trUtf8SCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QPdfSearchModel_trUtf8_s_c_n".}
...
proc trUtf8*(_: type gen_qpdfsearchmodel_types.QPdfSearchModel, s: cstring): string =
  let v_ms = fcQPdfSearchModel_trUtf8S(s)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc resultsOnPage*(self: gen_qpdfsearchmodel_types.QPdfSearchModel, page: cint): seq[gen_qpdfsearchresult_types.QPdfSearchResult] =
  ...
  for i in 0 ..< v_ma.len:
    vx_ret[i] = gen_qpdfsearchresult_types.QPdfSearchResult(h: v_outCast[i], owned: true)
  c_free(v_ma.data)
  vx_ret

proc resultAtIndex*(self: gen_qpdfsearchmodel_types.QPdfSearchModel, index: cint): gen_qpdfsearchresult_types.QPdfSearchResult =
  gen_qpdfsearchresult_types.QPdfSearchResult(h: fcQPdfSearchModel_resultAtIndex(self.h, index), owned: true)
