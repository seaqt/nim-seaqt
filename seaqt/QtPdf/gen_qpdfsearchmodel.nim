...
template _Count*(_: type QPdfSearchModelRoleEnum): untyped = 261
...
proc fcQPdfSearchModel_trUtf8(s: cstring): struct_seaqt_string {.importc: "QPdfSearchModel_trUtf8".}
...
proc fcQPdfSearchModel_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QPdfSearchModel_trUtf82".}
proc fcQPdfSearchModel_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QPdfSearchModel_trUtf83".}
...
proc fcQPdfSearchModel_protectedbase_resetInternalData(self: pointer): void {.importc: "QPdfSearchModel_protectedbase_resetInternalData".}
...
proc fcQPdfSearchModel_delete(self: pointer) {.importc: "QPdfSearchModel_delete".}

proc metaObject*(self: gen_qpdfsearchmodel_types.QPdfSearchModel): gen_qobjectdefs_types.QMetaObject =
  gen_qobjectdefs_types.QMetaObject(h: fcQPdfSearchModel_metaObject(self.h))
...
proc trUtf8*(_: type gen_qpdfsearchmodel_types.QPdfSearchModel, s: cstring): string =
  let v_ms = fcQPdfSearchModel_trUtf8(s)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret

proc resultsOnPage*(self: gen_qpdfsearchmodel_types.QPdfSearchModel, page: cint): seq[gen_qpdfsearchresult_types.QPdfSearchResult] =
  var v_ma = fcQPdfSearchModel_resultsOnPage(self.h, page)
  var vx_ret = newSeq[gen_qpdfsearchresult_types.QPdfSearchResult](int(v_ma.len))
  let v_outCast = cast[ptr UncheckedArray[pointer]](v_ma.data)
  for i in 0 ..< v_ma.len:
    vx_ret[i] = gen_qpdfsearchresult_types.QPdfSearchResult(h: v_outCast[i])
  c_free(v_ma.data)
  vx_ret

proc resultAtIndex*(self: gen_qpdfsearchmodel_types.QPdfSearchModel, index: cint): gen_qpdfsearchresult_types.QPdfSearchResult =
  gen_qpdfsearchresult_types.QPdfSearchResult(h: fcQPdfSearchModel_resultAtIndex(self.h, index))

proc document*(self: gen_qpdfsearchmodel_types.QPdfSearchModel): gen_qpdfdocument_types.QPdfDocument =
  gen_qpdfdocument_types.QPdfDocument(h: fcQPdfSearchModel_document(self.h))
...
proc data*(self: gen_qpdfsearchmodel_types.QPdfSearchModel, index: gen_qabstractitemmodel_types.QModelIndex, role: cint): gen_qvariant_types.QVariant =
  gen_qvariant_types.QVariant(h: fcQPdfSearchModel_data(self.h, index.h, role))
...
proc trUtf8*(_: type gen_qpdfsearchmodel_types.QPdfSearchModel, s: cstring, c: cstring): string =
  let v_ms = fcQPdfSearchModel_trUtf82(s, c)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret

proc trUtf8*(_: type gen_qpdfsearchmodel_types.QPdfSearchModel, s: cstring, c: cstring, n: cint): string =
  let v_ms = fcQPdfSearchModel_trUtf83(s, c, n)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
type QPdfSearchModelVTable* = object
...
proc QPdfSearchModelmetaObject*(self: gen_qpdfsearchmodel_types.QPdfSearchModel): gen_qobjectdefs_types.QMetaObject =
  gen_qobjectdefs_types.QMetaObject(h: fcQPdfSearchModel_virtualbase_metaObject(self.h))
...
proc QPdfSearchModeldata*(self: gen_qpdfsearchmodel_types.QPdfSearchModel, index: gen_qabstractitemmodel_types.QModelIndex, role: cint): gen_qvariant_types.QVariant =
  gen_qvariant_types.QVariant(h: fcQPdfSearchModel_virtualbase_data(self.h, index.h, role))
...
proc QPdfSearchModelindex*(self: gen_qpdfsearchmodel_types.QPdfSearchModel, row: cint, column: cint, parent: gen_qabstractitemmodel_types.QModelIndex): gen_qabstractitemmodel_types.QModelIndex =
  gen_qabstractitemmodel_types.QModelIndex(h: fcQPdfSearchModel_virtualbase_index(self.h, row, column, parent.h))
...
proc QPdfSearchModelsibling*(self: gen_qpdfsearchmodel_types.QPdfSearchModel, row: cint, column: cint, idx: gen_qabstractitemmodel_types.QModelIndex): gen_qabstractitemmodel_types.QModelIndex =
  gen_qabstractitemmodel_types.QModelIndex(h: fcQPdfSearchModel_virtualbase_sibling(self.h, row, column, idx.h))
...
proc QPdfSearchModelheaderData*(self: gen_qpdfsearchmodel_types.QPdfSearchModel, section: cint, orientation: cint, role: cint): gen_qvariant_types.QVariant =
  gen_qvariant_types.QVariant(h: fcQPdfSearchModel_virtualbase_headerData(self.h, section, cint(orientation), role))
...
proc QPdfSearchModelmimeData*(self: gen_qpdfsearchmodel_types.QPdfSearchModel, indexes: openArray[gen_qabstractitemmodel_types.QModelIndex]): gen_qmimedata_types.QMimeData =
  ...
  gen_qmimedata_types.QMimeData(h: fcQPdfSearchModel_virtualbase_mimeData(self.h, struct_seaqt_array(len: csize_t(len(indexes)), data: if len(indexes) == 0: nil else: addr(indexes_CArray[0]))))
...
proc QPdfSearchModelbuddy*(self: gen_qpdfsearchmodel_types.QPdfSearchModel, index: gen_qabstractitemmodel_types.QModelIndex): gen_qabstractitemmodel_types.QModelIndex =
  gen_qabstractitemmodel_types.QModelIndex(h: fcQPdfSearchModel_virtualbase_buddy(self.h, index.h))
...
proc QPdfSearchModelspan*(self: gen_qpdfsearchmodel_types.QPdfSearchModel, index: gen_qabstractitemmodel_types.QModelIndex): gen_qsize_types.QSize =
  gen_qsize_types.QSize(h: fcQPdfSearchModel_virtualbase_span(self.h, index.h))
...
proc resetInternalData*(self: gen_qpdfsearchmodel_types.QPdfSearchModel): void =
  fcQPdfSearchModel_protectedbase_resetInternalData(self.h)
...
proc createIndex*(self: gen_qpdfsearchmodel_types.QPdfSearchModel, row: cint, column: cint): gen_qabstractitemmodel_types.QModelIndex =
  gen_qabstractitemmodel_types.QModelIndex(h: fcQPdfSearchModel_protectedbase_createIndex(self.h, row, column))
...
proc sender*(self: gen_qpdfsearchmodel_types.QPdfSearchModel): gen_qobject_types.QObject =
  gen_qobject_types.QObject(h: fcQPdfSearchModel_protectedbase_sender(self.h))
...
proc create*(T: type gen_qpdfsearchmodel_types.QPdfSearchModel,
  ...
  let tmp = gen_qpdfsearchmodel_types.QPdfSearchModel(h: fcQPdfSearchModel_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))))
...
proc create*(T: type gen_qpdfsearchmodel_types.QPdfSearchModel,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQPdfSearchModel_vtable_callback_disconnectNotify
  let tmp = gen_qpdfsearchmodel_types.QPdfSearchModel(h: fcQPdfSearchModel_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h))
  fcQPdfSearchModel_vdata(tmp.h)[] = addr(vtbl[])
  tmp
...
proc delete*(self: gen_qpdfsearchmodel_types.QPdfSearchModel) =
  fcQPdfSearchModel_delete(self.h)
