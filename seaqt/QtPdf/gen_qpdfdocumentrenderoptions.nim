...
type QPdfDocumentRenderOptionsRotationEnum* = distinct cint
template None*(_: type QPdfDocumentRenderOptionsRotationEnum): untyped = 0
template Clockwise90*(_: type QPdfDocumentRenderOptionsRotationEnum): untyped = 1
template Clockwise180*(_: type QPdfDocumentRenderOptionsRotationEnum): untyped = 2
template Clockwise270*(_: type QPdfDocumentRenderOptionsRotationEnum): untyped = 3


type QPdfDocumentRenderOptionsRenderFlagEnum* = distinct cint
template None*(_: type QPdfDocumentRenderOptionsRenderFlagEnum): untyped = 0
template Annotations*(_: type QPdfDocumentRenderOptionsRenderFlagEnum): untyped = 1
template OptimizedForLcd*(_: type QPdfDocumentRenderOptionsRenderFlagEnum): untyped = 2
template Grayscale*(_: type QPdfDocumentRenderOptionsRenderFlagEnum): untyped = 4
template ForceHalftone*(_: type QPdfDocumentRenderOptionsRenderFlagEnum): untyped = 8
template TextAliased*(_: type QPdfDocumentRenderOptionsRenderFlagEnum): untyped = 16
template ImageAliased*(_: type QPdfDocumentRenderOptionsRenderFlagEnum): untyped = 32
template PathAliased*(_: type QPdfDocumentRenderOptionsRenderFlagEnum): untyped = 64
