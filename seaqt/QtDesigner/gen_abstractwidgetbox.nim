...
proc fcQDesignerWidgetBoxInterface_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QDesignerWidgetBoxInterface_protectedbase_getDecodedMetricF".}
...
proc getDecodedMetricF*(self: gen_abstractwidgetbox_types.QDesignerWidgetBoxInterface, metricA: cint, metricB: cint): float64 =
  fcQDesignerWidgetBoxInterface_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
