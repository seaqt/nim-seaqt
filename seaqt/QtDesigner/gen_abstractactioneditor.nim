...
proc fcQDesignerActionEditorInterface_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QDesignerActionEditorInterface_protectedbase_getDecodedMetricF".}
...
proc getDecodedMetricF*(self: gen_abstractactioneditor_types.QDesignerActionEditorInterface, metricA: cint, metricB: cint): float64 =
  fcQDesignerActionEditorInterface_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
