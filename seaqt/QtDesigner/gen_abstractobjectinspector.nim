...
proc fcQDesignerObjectInspectorInterface_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QDesignerObjectInspectorInterface_protectedbase_getDecodedMetricF".}
...
proc metaObject*(self: gen_abstractobjectinspector_types.QDesignerObjectInspectorInterface): gen_qobjectdefs_types.QMetaObject =
  gen_qobjectdefs_types.QMetaObject(h: fcQDesignerObjectInspectorInterface_metaObject(self.h), owned: false)
...
type QDesignerObjectInspectorInterfaceVTable* {.inheritable, pure.} = object
...
proc QDesignerObjectInspectorInterfacemetaObject*(self: gen_abstractobjectinspector_types.QDesignerObjectInspectorInterface): gen_qobjectdefs_types.QMetaObject =
  gen_qobjectdefs_types.QMetaObject(h: fcQDesignerObjectInspectorInterface_virtualbase_metaObject(self.h), owned: false)
...
proc QDesignerObjectInspectorInterfacesizeHint*(self: gen_abstractobjectinspector_types.QDesignerObjectInspectorInterface): gen_qsize_types.QSize =
  gen_qsize_types.QSize(h: fcQDesignerObjectInspectorInterface_virtualbase_sizeHint(self.h), owned: true)
...
proc QDesignerObjectInspectorInterfaceminimumSizeHint*(self: gen_abstractobjectinspector_types.QDesignerObjectInspectorInterface): gen_qsize_types.QSize =
  gen_qsize_types.QSize(h: fcQDesignerObjectInspectorInterface_virtualbase_minimumSizeHint(self.h), owned: true)
...
proc QDesignerObjectInspectorInterfacepaintEngine*(self: gen_abstractobjectinspector_types.QDesignerObjectInspectorInterface): gen_qpaintengine_types.QPaintEngine =
  gen_qpaintengine_types.QPaintEngine(h: fcQDesignerObjectInspectorInterface_virtualbase_paintEngine(self.h), owned: false)
...
proc QDesignerObjectInspectorInterfaceredirected*(self: gen_abstractobjectinspector_types.QDesignerObjectInspectorInterface, offset: gen_qpoint_types.QPoint): gen_qpaintdevice_types.QPaintDevice =
  gen_qpaintdevice_types.QPaintDevice(h: fcQDesignerObjectInspectorInterface_virtualbase_redirected(self.h, offset.h), owned: false)
...
proc QDesignerObjectInspectorInterfacesharedPainter*(self: gen_abstractobjectinspector_types.QDesignerObjectInspectorInterface): gen_qpainter_types.QPainter =
  gen_qpainter_types.QPainter(h: fcQDesignerObjectInspectorInterface_virtualbase_sharedPainter(self.h), owned: false)
...
proc QDesignerObjectInspectorInterfaceinputMethodQuery*(self: gen_abstractobjectinspector_types.QDesignerObjectInspectorInterface, param1: cint): gen_qvariant_types.QVariant =
  gen_qvariant_types.QVariant(h: fcQDesignerObjectInspectorInterface_virtualbase_inputMethodQuery(self.h, cint(param1)), owned: true)
...
proc sender*(self: gen_abstractobjectinspector_types.QDesignerObjectInspectorInterface): gen_qobject_types.QObject =
  gen_qobject_types.QObject(h: fcQDesignerObjectInspectorInterface_protectedbase_sender(self.h), owned: false)
...
proc getDecodedMetricF*(self: gen_abstractobjectinspector_types.QDesignerObjectInspectorInterface, metricA: cint, metricB: cint): float64 =
  fcQDesignerObjectInspectorInterface_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
...
proc create*(T: type gen_abstractobjectinspector_types.QDesignerObjectInspectorInterface,
  ...
  let tmp = gen_abstractobjectinspector_types.QDesignerObjectInspectorInterface(h: fcQDesignerObjectInspectorInterface_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
...
proc create*(T: type gen_abstractobjectinspector_types.QDesignerObjectInspectorInterface,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQDesignerObjectInspectorInterface_vtable_callback_disconnectNotify
  let tmp = gen_abstractobjectinspector_types.QDesignerObjectInspectorInterface(h: fcQDesignerObjectInspectorInterface_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h, cint(flags)), owned: true)
  fcQDesignerObjectInspectorInterface_vdata(tmp.h)[] = addr(vtbl[])
  tmp
