...
proc fcQDesignerFormWindowInterface_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QDesignerFormWindowInterface_protectedbase_getDecodedMetricF".}
...
proc getDecodedMetricF*(self: gen_abstractformwindow_types.QDesignerFormWindowInterface, metricA: cint, metricB: cint): float64 =
  fcQDesignerFormWindowInterface_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
