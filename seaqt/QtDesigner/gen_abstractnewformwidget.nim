...
proc fcQDesignerNewFormWidgetInterface_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QDesignerNewFormWidgetInterface_protectedbase_getDecodedMetricF".}
...
proc getDecodedMetricF*(self: gen_abstractnewformwidget_types.QDesignerNewFormWidgetInterface, metricA: cint, metricB: cint): float64 =
  fcQDesignerNewFormWidgetInterface_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
