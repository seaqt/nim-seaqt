...
import
  ...
  ../QtCore/gen_qversionnumber_types,
...
proc fcQDesignerIntegrationInterface_qtVersion(self: pointer): pointer {.importc: "QDesignerIntegrationInterface_qtVersion".}
proc fcQDesignerIntegrationInterface_setQtVersion(self: pointer, qtVersion: pointer): void {.importc: "QDesignerIntegrationInterface_setQtVersion".}
...
proc qtVersion*(self: gen_abstractintegration_types.QDesignerIntegrationInterface): gen_qversionnumber_types.QVersionNumber =
  gen_qversionnumber_types.QVersionNumber(h: fcQDesignerIntegrationInterface_qtVersion(self.h), owned: true)

proc setQtVersion*(self: gen_abstractintegration_types.QDesignerIntegrationInterface, qtVersion: gen_qversionnumber_types.QVersionNumber): void =
  fcQDesignerIntegrationInterface_setQtVersion(self.h, qtVersion.h)
