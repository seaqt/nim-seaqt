...
VirtualQDnsLookup* QDnsLookup_new(const QDnsLookup_VTable* vtbl, size_t vdata) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQDnsLookup>());
	return _mem_ ? new (_mem_)VirtualQDnsLookup(vtbl) : nullptr;
}

VirtualQDnsLookup* QDnsLookup_new2(const QDnsLookup_VTable* vtbl, size_t vdata, int type, struct miqt_string name) {
	QString name_QString = QString::fromUtf8(name.data, name.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQDnsLookup>());
	return _mem_ ? new (_mem_)VirtualQDnsLookup(vtbl, static_cast<QDnsLookup::Type>(type), name_QString) : nullptr;
}

VirtualQDnsLookup* QDnsLookup_new3(const QDnsLookup_VTable* vtbl, size_t vdata, int type, struct miqt_string name, QHostAddress* nameserver) {
	QString name_QString = QString::fromUtf8(name.data, name.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQDnsLookup>());
...
VirtualQDnsLookup* QDnsLookup_new5(const QDnsLookup_VTable* vtbl, size_t vdata, int type, struct miqt_string name, QObject* parent) {
	QString name_QString = QString::fromUtf8(name.data, name.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQDnsLookup>());
	return _mem_ ? new (_mem_)VirtualQDnsLookup(vtbl, static_cast<QDnsLookup::Type>(type), name_QString, parent) : nullptr;
}

VirtualQDnsLookup* QDnsLookup_new6(const QDnsLookup_VTable* vtbl, size_t vdata, int type, struct miqt_string name, QHostAddress* nameserver, QObject* parent) {
	QString name_QString = QString::fromUtf8(name.data, name.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQDnsLookup>());
