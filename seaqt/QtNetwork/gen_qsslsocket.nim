...
proc fcQSslSocket_availableBackends(): struct_seaqt_array {.importc: "QSslSocket_availableBackends".}
...
proc fcQSslSocket_sslErrors(self: pointer, errors: struct_seaqt_array): void {.importc: "QSslSocket_sslErrors".}
proc fcQSslSocket_connect_sslErrors(self: pointer, slot: int, callback: proc (slot: int, errors: struct_seaqt_array) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QSslSocket_connect_sslErrors".}
...
proc fcQSslSocket_alertSent(self: pointer, level: cint, typeVal: cint, description: struct_seaqt_string): void {.importc: "QSslSocket_alertSent".}
proc fcQSslSocket_connect_alertSent(self: pointer, slot: int, callback: proc (slot: int, level: cint, typeVal: cint, description: struct_seaqt_string) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QSslSocket_connect_alertSent".}
proc fcQSslSocket_alertReceived(self: pointer, level: cint, typeVal: cint, description: struct_seaqt_string): void {.importc: "QSslSocket_alertReceived".}
...
proc setActiveBackend*(_: type gen_qsslsocket_types.QSslSocket, backendName: openArray[char]): bool =
  fcQSslSocket_setActiveBackend(struct_seaqt_string(data: if len(backendName) > 0: addr backendName[0] else: nil, len: csize_t(len(backendName))))
...
proc sslErrors*(self: gen_qsslsocket_types.QSslSocket, errors: openArray[gen_qsslerror_types.QSslError]): void =
  ...
  fcQSslSocket_sslErrors(self.h, struct_seaqt_array(len: csize_t(len(errors)), data: if len(errors) == 0: nil else: addr(errors_CArray[0])))

type QSslSocketsslErrorsSlot* = proc(errors: openArray[gen_qsslerror_types.QSslError])
proc fcQSslSocket_slot_callback_sslErrors(slot: int, errors: struct_seaqt_array) {.cdecl.} =
...
proc fcQSslSocket_slot_callback_sslErrors_release(slot: int) {.cdecl.} =
...
proc onSslErrors*(self: gen_qsslsocket_types.QSslSocket, slot: QSslSocketsslErrorsSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQSslSocket_connect_sslErrors(self.h, cast[int](addr tmp[]), fcQSslSocket_slot_callback_sslErrors, fcQSslSocket_slot_callback_sslErrors_release)
...
proc alertSent*(self: gen_qsslsocket_types.QSslSocket, level: cint, typeVal: cint, description: openArray[char]): void =
  fcQSslSocket_alertSent(self.h, cint(level), cint(typeVal), struct_seaqt_string(data: if len(description) > 0: addr description[0] else: nil, len: csize_t(len(description))))

type QSslSocketalertSentSlot* = proc(level: cint, typeVal: cint, description: openArray[char])
proc fcQSslSocket_slot_callback_alertSent(slot: int, level: cint, typeVal: cint, description: struct_seaqt_string) {.cdecl.} =
...
proc fcQSslSocket_slot_callback_alertSent_release(slot: int) {.cdecl.} =
...
proc onAlertSent*(self: gen_qsslsocket_types.QSslSocket, slot: QSslSocketalertSentSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQSslSocket_connect_alertSent(self.h, cast[int](addr tmp[]), fcQSslSocket_slot_callback_alertSent, fcQSslSocket_slot_callback_alertSent_release)

proc alertReceived*(self: gen_qsslsocket_types.QSslSocket, level: cint, typeVal: cint, description: openArray[char]): void =
  fcQSslSocket_alertReceived(self.h, cint(level), cint(typeVal), struct_seaqt_string(data: if len(description) > 0: addr description[0] else: nil, len: csize_t(len(description))))

type QSslSocketalertReceivedSlot* = proc(level: cint, typeVal: cint, description: openArray[char])
proc fcQSslSocket_slot_callback_alertReceived(slot: int, level: cint, typeVal: cint, description: struct_seaqt_string) {.cdecl.} =
...
proc fcQSslSocket_slot_callback_alertReceived_release(slot: int) {.cdecl.} =
...
proc onAlertReceived*(self: gen_qsslsocket_types.QSslSocket, slot: QSslSocketalertReceivedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQSslSocket_connect_alertReceived(self.h, cast[int](addr tmp[]), fcQSslSocket_slot_callback_alertReceived, fcQSslSocket_slot_callback_alertReceived_release)
...
proc fcQSslSocket_slot_callback_handshakeInterruptedOnError(slot: int, error: pointer) {.cdecl.} =
  let nimfunc = cast[ptr QSslSockethandshakeInterruptedOnErrorSlot](cast[pointer](slot))
  let slotval1 = gen_qsslerror_types.QSslError(h: error, owned: false)

  nimfunc[](slotval1)

proc fcQSslSocket_slot_callback_handshakeInterruptedOnError_release(slot: int) {.cdecl.} =
...
proc fcQSslSocket_vtable_callback_skipData(self: pointer, maxSize: clonglong): clonglong {.cdecl.} =
  let vtbl = cast[ptr QSslSocketVTable](fcQSslSocket_vdata(self)[])
  let self = QSslSocket(h: self)
...
proc fcQSslSocket_method_callback_skipData(self: pointer, maxSize: clonglong): clonglong {.cdecl.} =
  let inst = cast[VirtualQSslSocket](fcQSslSocket_vdata(self)[])
  let slotval1 = maxSize
