...
proc fcQNetworkConfiguration_bearerTypeName(self: pointer): struct_seaqt_string {.importc: "QNetworkConfiguration_bearerTypeName".}
proc fcQNetworkConfiguration_identifier(self: pointer): struct_seaqt_string {.importc: "QNetworkConfiguration_identifier".}
proc fcQNetworkConfiguration_isRoamingAvailable(self: pointer): bool {.importc: "QNetworkConfiguration_isRoamingAvailable".}
proc fcQNetworkConfiguration_children(self: pointer): struct_seaqt_array {.importc: "QNetworkConfiguration_children".}
proc fcQNetworkConfiguration_name(self: pointer): struct_seaqt_string {.importc: "QNetworkConfiguration_name".}
...
proc create*(T: type gen_qnetworkconfiguration_types.QNetworkConfiguration): gen_qnetworkconfiguration_types.QNetworkConfiguration =
  let tmp = gen_qnetworkconfiguration_types.QNetworkConfiguration(h: fcQNetworkConfiguration_new())
  tmp
proc create*(T: type gen_qnetworkconfiguration_types.QNetworkConfiguration,
  ...
  let tmp = gen_qnetworkconfiguration_types.QNetworkConfiguration(h: fcQNetworkConfiguration_new2(other.h))
  tmp
