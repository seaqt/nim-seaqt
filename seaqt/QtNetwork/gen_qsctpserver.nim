...
{.compile("gen_qsctpserver.cpp", QtNetworkCFlags).}
...
proc fcQSctpServer_vtable_callback_metaObject(self: pointer): pointer {.cdecl.} =
...
proc fcQSctpServer_vtable_callback_metacast(self: pointer, param1: cstring): pointer {.cdecl.} =
  let vtbl = cast[ptr QSctpServerVTable](fcQSctpServer_vdata(self)[])
  let self = QSctpServer(h: self)
  let slotval1 = (param1)
...
proc fcQSctpServer_vtable_callback_metacall(self: pointer, param1: cint, param2: cint, param3: pointer): cint {.cdecl.} =
  let vtbl = cast[ptr QSctpServerVTable](fcQSctpServer_vdata(self)[])
  let self = QSctpServer(h: self)
...
proc fcQSctpServer_vtable_callback_incomingConnection(self: pointer, handle: uint): void {.cdecl.} =
  let vtbl = cast[ptr QSctpServerVTable](fcQSctpServer_vdata(self)[])
  let self = QSctpServer(h: self)
  let slotval1 = handle
  vtbl[].incomingConnection(self, slotval1)

proc fcQSctpServer_vtable_callback_hasPendingConnections(self: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QSctpServerVTable](fcQSctpServer_vdata(self)[])
  let self = QSctpServer(h: self)
  var virtualReturn = vtbl[].hasPendingConnections(self)
  virtualReturn

proc fcQSctpServer_vtable_callback_nextPendingConnection(self: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QSctpServerVTable](fcQSctpServer_vdata(self)[])
  let self = QSctpServer(h: self)
...
proc fcQSctpServer_vtable_callback_event(self: pointer, event: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QSctpServerVTable](fcQSctpServer_vdata(self)[])
  let self = QSctpServer(h: self)
...
proc fcQSctpServer_vtable_callback_eventFilter(self: pointer, watched: pointer, event: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QSctpServerVTable](fcQSctpServer_vdata(self)[])
  let self = QSctpServer(h: self)
...
proc fcQSctpServer_vtable_callback_timerEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QSctpServerVTable](fcQSctpServer_vdata(self)[])
  let self = QSctpServer(h: self)
  let slotval1 = gen_qcoreevent_types.QTimerEvent(h: event, owned: false)
  vtbl[].timerEvent(self, slotval1)

proc fcQSctpServer_vtable_callback_childEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QSctpServerVTable](fcQSctpServer_vdata(self)[])
  let self = QSctpServer(h: self)
  let slotval1 = gen_qcoreevent_types.QChildEvent(h: event, owned: false)
  vtbl[].childEvent(self, slotval1)

proc fcQSctpServer_vtable_callback_customEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QSctpServerVTable](fcQSctpServer_vdata(self)[])
  let self = QSctpServer(h: self)
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
  vtbl[].customEvent(self, slotval1)

proc fcQSctpServer_vtable_callback_connectNotify(self: pointer, signal: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QSctpServerVTable](fcQSctpServer_vdata(self)[])
  let self = QSctpServer(h: self)
  let slotval1 = gen_qmetaobject_types.QMetaMethod(h: signal, owned: false)
  vtbl[].connectNotify(self, slotval1)

proc fcQSctpServer_vtable_callback_disconnectNotify(self: pointer, signal: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QSctpServerVTable](fcQSctpServer_vdata(self)[])
  let self = QSctpServer(h: self)
  let slotval1 = gen_qmetaobject_types.QMetaMethod(h: signal, owned: false)
...
proc fcQSctpServer_method_callback_metacall(self: pointer, param1: cint, param2: cint, param3: pointer): cint {.cdecl.} =
  let inst = cast[VirtualQSctpServer](fcQSctpServer_vdata(self)[])
  let slotval1 = cint(param1)
  let slotval2 = param2
  let slotval3 = param3
...
proc fcQSctpServer_method_callback_incomingConnection(self: pointer, handle: uint): void {.cdecl.} =
  let inst = cast[VirtualQSctpServer](fcQSctpServer_vdata(self)[])
  let slotval1 = handle
  inst.incomingConnection(slotval1)

proc fcQSctpServer_method_callback_hasPendingConnections(self: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQSctpServer](fcQSctpServer_vdata(self)[])
...
proc fcQSctpServer_method_callback_eventFilter(self: pointer, watched: pointer, event: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQSctpServer](fcQSctpServer_vdata(self)[])
  let slotval1 = gen_qobject_types.QObject(h: watched, owned: false)
  let slotval2 = gen_qcoreevent_types.QEvent(h: event, owned: false)
...
proc fcQSctpServer_method_callback_timerEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQSctpServer](fcQSctpServer_vdata(self)[])
  let slotval1 = gen_qcoreevent_types.QTimerEvent(h: event, owned: false)
  inst.timerEvent(slotval1)

proc fcQSctpServer_method_callback_childEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQSctpServer](fcQSctpServer_vdata(self)[])
  let slotval1 = gen_qcoreevent_types.QChildEvent(h: event, owned: false)
  inst.childEvent(slotval1)

proc fcQSctpServer_method_callback_customEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQSctpServer](fcQSctpServer_vdata(self)[])
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
  inst.customEvent(slotval1)

proc fcQSctpServer_method_callback_connectNotify(self: pointer, signal: pointer): void {.cdecl.} =
  let inst = cast[VirtualQSctpServer](fcQSctpServer_vdata(self)[])
  let slotval1 = gen_qmetaobject_types.QMetaMethod(h: signal, owned: false)
  inst.connectNotify(slotval1)

proc fcQSctpServer_method_callback_disconnectNotify(self: pointer, signal: pointer): void {.cdecl.} =
  let inst = cast[VirtualQSctpServer](fcQSctpServer_vdata(self)[])
  let slotval1 = gen_qmetaobject_types.QMetaMethod(h: signal, owned: false)
...
proc create*(T: type gen_qsctpserver_types.QSctpServer,
  ...
  if not isNil(vtbl[].metaObject):
    vtbl[].vtbl.metaObject = fcQSctpServer_vtable_callback_metaObject
  if not isNil(vtbl[].metacast):
    vtbl[].vtbl.metacast = fcQSctpServer_vtable_callback_metacast
  if not isNil(vtbl[].metacall):
    vtbl[].vtbl.metacall = fcQSctpServer_vtable_callback_metacall
  if not isNil(vtbl[].incomingConnection):
    vtbl[].vtbl.incomingConnection = fcQSctpServer_vtable_callback_incomingConnection
  if not isNil(vtbl[].hasPendingConnections):
    vtbl[].vtbl.hasPendingConnections = fcQSctpServer_vtable_callback_hasPendingConnections
  if not isNil(vtbl[].nextPendingConnection):
    vtbl[].vtbl.nextPendingConnection = fcQSctpServer_vtable_callback_nextPendingConnection
  if not isNil(vtbl[].event):
    vtbl[].vtbl.event = fcQSctpServer_vtable_callback_event
  if not isNil(vtbl[].eventFilter):
    vtbl[].vtbl.eventFilter = fcQSctpServer_vtable_callback_eventFilter
  if not isNil(vtbl[].timerEvent):
    vtbl[].vtbl.timerEvent = fcQSctpServer_vtable_callback_timerEvent
  if not isNil(vtbl[].childEvent):
    vtbl[].vtbl.childEvent = fcQSctpServer_vtable_callback_childEvent
  if not isNil(vtbl[].customEvent):
    vtbl[].vtbl.customEvent = fcQSctpServer_vtable_callback_customEvent
  if not isNil(vtbl[].connectNotify):
    vtbl[].vtbl.connectNotify = fcQSctpServer_vtable_callback_connectNotify
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQSctpServer_vtable_callback_disconnectNotify
  let tmp = gen_qsctpserver_types.QSctpServer(h: fcQSctpServer_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQSctpServer_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qsctpserver_types.QSctpServer,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQSctpServer_vtable_callback_disconnectNotify
  let tmp = gen_qsctpserver_types.QSctpServer(h: fcQSctpServer_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQSctpServer_vdata(tmp.h)[] = addr(vtbl[])
  tmp
const cQSctpServer_mvtbl = cQSctpServerVTable(
  ...
  metaObject: fcQSctpServer_method_callback_metaObject,
  metacast: fcQSctpServer_method_callback_metacast,
  metacall: fcQSctpServer_method_callback_metacall,
  incomingConnection: fcQSctpServer_method_callback_incomingConnection,
  hasPendingConnections: fcQSctpServer_method_callback_hasPendingConnections,
  nextPendingConnection: fcQSctpServer_method_callback_nextPendingConnection,
  event: fcQSctpServer_method_callback_event,
  eventFilter: fcQSctpServer_method_callback_eventFilter,
  timerEvent: fcQSctpServer_method_callback_timerEvent,
  childEvent: fcQSctpServer_method_callback_childEvent,
  customEvent: fcQSctpServer_method_callback_customEvent,
  connectNotify: fcQSctpServer_method_callback_connectNotify,
  disconnectNotify: fcQSctpServer_method_callback_disconnectNotify,
)
proc create*(T: type gen_qsctpserver_types.QSctpServer,
