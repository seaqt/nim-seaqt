...
proc fcQHttp2Configuration_setMaxConcurrentStreams(self: pointer, value: cuint): void {.importc: "QHttp2Configuration_setMaxConcurrentStreams".}
proc fcQHttp2Configuration_maxConcurrentStreams(self: pointer): cuint {.importc: "QHttp2Configuration_maxConcurrentStreams".}
...
proc setMaxConcurrentStreams*(self: gen_qhttp2configuration_types.QHttp2Configuration, value: cuint): void =
  fcQHttp2Configuration_setMaxConcurrentStreams(self.h, value)

proc maxConcurrentStreams*(self: gen_qhttp2configuration_types.QHttp2Configuration): cuint =
  fcQHttp2Configuration_maxConcurrentStreams(self.h)
