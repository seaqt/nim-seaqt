...
VirtualQDtlsClientVerifier* QDtlsClientVerifier_new(const QDtlsClientVerifier_VTable* vtbl, size_t vdata) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQDtlsClientVerifier>());
...
VirtualQDtls* QDtls_new(const QDtls_VTable* vtbl, size_t vdata, int mode) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQDtls>());
...
bool QDtls_setPeer3(QDtls* self, QHostAddress* address, unsigned short port, struct miqt_string verificationName) {
