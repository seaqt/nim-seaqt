...
proc fcQLocalServer_protectedbase_addPendingConnection(self: pointer, socket: pointer): void {.importc: "QLocalServer_protectedbase_addPendingConnection".}
...
proc addPendingConnection*(self: gen_qlocalserver_types.QLocalServer, socket: gen_qlocalsocket_types.QLocalSocket): void =
  fcQLocalServer_protectedbase_addPendingConnection(self.h, socket.h)
