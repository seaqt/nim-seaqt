...
proc fcQLocalServer_trUtf8(s: cstring): struct_seaqt_string {.importc: "QLocalServer_trUtf8".}
...
proc fcQLocalServer_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QLocalServer_trUtf82".}
proc fcQLocalServer_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QLocalServer_trUtf83".}
