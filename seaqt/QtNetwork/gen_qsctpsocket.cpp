...
public:
	...
	friend void QSctpSocket_virtualbase_connectToHost(VirtualQSctpSocket* self, struct miqt_string hostName, unsigned short port, int mode, int protocol);
...
VirtualQSctpSocket* QSctpSocket_new(const QSctpSocket_VTable* vtbl, size_t vdata) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQSctpSocket>());
...
void QSctpSocket_virtualbase_connectToHost(VirtualQSctpSocket* self, struct miqt_string hostName, unsigned short port, int mode, int protocol) {
