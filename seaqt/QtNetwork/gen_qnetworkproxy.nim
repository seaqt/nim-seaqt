...
proc fcQNetworkProxyQuery_new5(fromVal: pointer): ptr cQNetworkProxyQuery {.importc: "QNetworkProxyQuery_new_from".}
proc fcQNetworkProxyQuery_new6(requestUrl: pointer, queryType: cint): ptr cQNetworkProxyQuery {.importc: "QNetworkProxyQuery_new_requestUrl_queryType".}
proc fcQNetworkProxyQuery_new7(hostname: struct_seaqt_string, port: cint, protocolTag: struct_seaqt_string): ptr cQNetworkProxyQuery {.importc: "QNetworkProxyQuery_new_hostname_port_protocolTag".}
proc fcQNetworkProxyQuery_new8(hostname: struct_seaqt_string, port: cint, protocolTag: struct_seaqt_string, queryType: cint): ptr cQNetworkProxyQuery {.importc: "QNetworkProxyQuery_new_hostname_port_protocolTag_queryType".}
proc fcQNetworkProxyQuery_new9(bindPort: cushort, protocolTag: struct_seaqt_string): ptr cQNetworkProxyQuery {.importc: "QNetworkProxyQuery_new_bindPort_protocolTag".}
proc fcQNetworkProxyQuery_new10(bindPort: cushort, protocolTag: struct_seaqt_string, queryType: cint): ptr cQNetworkProxyQuery {.importc: "QNetworkProxyQuery_new_bindPort_protocolTag_queryType".}
...
proc fcQNetworkProxy_headers(self: pointer): pointer {.importc: "QNetworkProxy_headers".}
proc fcQNetworkProxy_setHeaders(self: pointer, newHeaders: pointer): void {.importc: "QNetworkProxy_setHeaders".}
...
proc fcQNetworkProxy_staticMetaObject(): pointer {.importc: "QNetworkProxy_staticMetaObject".}
...
proc create*(T: type gen_qnetworkproxy_types.QNetworkProxyQuery,
  ...
  let tmp = gen_qnetworkproxy_types.QNetworkProxyQuery(h: fcQNetworkProxyQuery_new5(fromVal.h), owned: true)
  tmp
proc create*(T: type gen_qnetworkproxy_types.QNetworkProxyQuery,
    requestUrl: gen_qurl_types.QUrl, queryType: cint): gen_qnetworkproxy_types.QNetworkProxyQuery =
  let tmp = gen_qnetworkproxy_types.QNetworkProxyQuery(h: fcQNetworkProxyQuery_new6(requestUrl.h, cint(queryType)), owned: true)
  tmp
proc create*(T: type gen_qnetworkproxy_types.QNetworkProxyQuery,
    hostname: openArray[char], port: cint, protocolTag: openArray[char]): gen_qnetworkproxy_types.QNetworkProxyQuery =
  let tmp = gen_qnetworkproxy_types.QNetworkProxyQuery(h: fcQNetworkProxyQuery_new7(struct_seaqt_string(data: if len(hostname) > 0: addr hostname[0] else: nil, len: csize_t(len(hostname))), port, struct_seaqt_string(data: if len(protocolTag) > 0: addr protocolTag[0] else: nil, len: csize_t(len(protocolTag)))), owned: true)
  tmp
proc create*(T: type gen_qnetworkproxy_types.QNetworkProxyQuery,
    hostname: openArray[char], port: cint, protocolTag: openArray[char], queryType: cint): gen_qnetworkproxy_types.QNetworkProxyQuery =
  let tmp = gen_qnetworkproxy_types.QNetworkProxyQuery(h: fcQNetworkProxyQuery_new8(struct_seaqt_string(data: if len(hostname) > 0: addr hostname[0] else: nil, len: csize_t(len(hostname))), port, struct_seaqt_string(data: if len(protocolTag) > 0: addr protocolTag[0] else: nil, len: csize_t(len(protocolTag))), cint(queryType)), owned: true)
  tmp
proc create*(T: type gen_qnetworkproxy_types.QNetworkProxyQuery,
    bindPort: cushort, protocolTag: openArray[char]): gen_qnetworkproxy_types.QNetworkProxyQuery =
  let tmp = gen_qnetworkproxy_types.QNetworkProxyQuery(h: fcQNetworkProxyQuery_new9(bindPort, struct_seaqt_string(data: if len(protocolTag) > 0: addr protocolTag[0] else: nil, len: csize_t(len(protocolTag)))), owned: true)
  tmp
proc create*(T: type gen_qnetworkproxy_types.QNetworkProxyQuery,
    bindPort: cushort, protocolTag: openArray[char], queryType: cint): gen_qnetworkproxy_types.QNetworkProxyQuery =
  let tmp = gen_qnetworkproxy_types.QNetworkProxyQuery(h: fcQNetworkProxyQuery_new10(bindPort, struct_seaqt_string(data: if len(protocolTag) > 0: addr protocolTag[0] else: nil, len: csize_t(len(protocolTag))), cint(queryType)), owned: true)
  tmp
...
proc headers*(self: gen_qnetworkproxy_types.QNetworkProxy): gen_qhttpheaders_types.QHttpHeaders =
  gen_qhttpheaders_types.QHttpHeaders(h: fcQNetworkProxy_headers(self.h), owned: true)

proc setHeaders*(self: gen_qnetworkproxy_types.QNetworkProxy, newHeaders: gen_qhttpheaders_types.QHttpHeaders): void =
  fcQNetworkProxy_setHeaders(self.h, newHeaders.h)
...
proc create*(T: type gen_qnetworkproxy_types.QNetworkProxy,
  ...
  tmp
proc staticMetaObject*(_: type gen_qnetworkproxy_types.QNetworkProxy): gen_qobjectdefs_types.QMetaObject =
  gen_qobjectdefs_types.QMetaObject(h: fcQNetworkProxy_staticMetaObject())
