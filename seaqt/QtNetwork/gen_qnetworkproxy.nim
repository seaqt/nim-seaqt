...
proc create*(T: type gen_qnetworkproxy_types.QNetworkProxyQuery,
  ...
  let tmp = gen_qnetworkproxy_types.QNetworkProxyQuery(h: fcQNetworkProxyQuery_new3(struct_miqt_string(data: if len(hostname) > 0: addr hostname[0] else: nil, len: csize_t(len(hostname))), port))
  tmp
proc create*(T: type gen_qnetworkproxy_types.QNetworkProxyQuery,
...
proc create*(T: type gen_qnetworkproxy_types.QNetworkProxyQuery,
  ...
  let tmp = gen_qnetworkproxy_types.QNetworkProxyQuery(h: fcQNetworkProxyQuery_new7(struct_miqt_string(data: if len(hostname) > 0: addr hostname[0] else: nil, len: csize_t(len(hostname))), port, struct_miqt_string(data: if len(protocolTag) > 0: addr protocolTag[0] else: nil, len: csize_t(len(protocolTag)))))
  tmp
proc create*(T: type gen_qnetworkproxy_types.QNetworkProxyQuery,
    hostname: string, port: cint, protocolTag: string, queryType: cint): gen_qnetworkproxy_types.QNetworkProxyQuery =
  let tmp = gen_qnetworkproxy_types.QNetworkProxyQuery(h: fcQNetworkProxyQuery_new8(struct_miqt_string(data: if len(hostname) > 0: addr hostname[0] else: nil, len: csize_t(len(hostname))), port, struct_miqt_string(data: if len(protocolTag) > 0: addr protocolTag[0] else: nil, len: csize_t(len(protocolTag))), cint(queryType)))
  tmp
proc create*(T: type gen_qnetworkproxy_types.QNetworkProxyQuery,
    bindPort: cushort, protocolTag: string): gen_qnetworkproxy_types.QNetworkProxyQuery =
  let tmp = gen_qnetworkproxy_types.QNetworkProxyQuery(h: fcQNetworkProxyQuery_new9(bindPort, struct_miqt_string(data: if len(protocolTag) > 0: addr protocolTag[0] else: nil, len: csize_t(len(protocolTag)))))
  tmp
proc create*(T: type gen_qnetworkproxy_types.QNetworkProxyQuery,
    bindPort: cushort, protocolTag: string, queryType: cint): gen_qnetworkproxy_types.QNetworkProxyQuery =
  let tmp = gen_qnetworkproxy_types.QNetworkProxyQuery(h: fcQNetworkProxyQuery_new10(bindPort, struct_miqt_string(data: if len(protocolTag) > 0: addr protocolTag[0] else: nil, len: csize_t(len(protocolTag))), cint(queryType)))
  tmp
...
proc create*(T: type gen_qnetworkproxy_types.QNetworkProxy,
  ...
  let tmp = gen_qnetworkproxy_types.QNetworkProxy(h: fcQNetworkProxy_new4(cint(typeVal), struct_miqt_string(data: if len(hostName) > 0: addr hostName[0] else: nil, len: csize_t(len(hostName)))))
  tmp
proc create*(T: type gen_qnetworkproxy_types.QNetworkProxy,
    typeVal: cint, hostName: string, port: cushort): gen_qnetworkproxy_types.QNetworkProxy =
  let tmp = gen_qnetworkproxy_types.QNetworkProxy(h: fcQNetworkProxy_new5(cint(typeVal), struct_miqt_string(data: if len(hostName) > 0: addr hostName[0] else: nil, len: csize_t(len(hostName))), port))
  tmp
proc create*(T: type gen_qnetworkproxy_types.QNetworkProxy,
    typeVal: cint, hostName: string, port: cushort, user: string): gen_qnetworkproxy_types.QNetworkProxy =
  let tmp = gen_qnetworkproxy_types.QNetworkProxy(h: fcQNetworkProxy_new6(cint(typeVal), struct_miqt_string(data: if len(hostName) > 0: addr hostName[0] else: nil, len: csize_t(len(hostName))), port, struct_miqt_string(data: if len(user) > 0: addr user[0] else: nil, len: csize_t(len(user)))))
  tmp
proc create*(T: type gen_qnetworkproxy_types.QNetworkProxy,
