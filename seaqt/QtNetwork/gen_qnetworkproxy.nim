...
proc fcQNetworkProxyQuery_new3(hostname: struct_seaqt_string, port: cint): ptr cQNetworkProxyQuery {.importc: "QNetworkProxyQuery_new3".}
...
proc fcQNetworkProxyQuery_new6(networkConfiguration: pointer, hostname: struct_seaqt_string, port: cint): ptr cQNetworkProxyQuery {.importc: "QNetworkProxyQuery_new6".}
...
proc fcQNetworkProxyQuery_new10(hostname: struct_seaqt_string, port: cint, protocolTag: struct_seaqt_string): ptr cQNetworkProxyQuery {.importc: "QNetworkProxyQuery_new10".}
proc fcQNetworkProxyQuery_new11(hostname: struct_seaqt_string, port: cint, protocolTag: struct_seaqt_string, queryType: cint): ptr cQNetworkProxyQuery {.importc: "QNetworkProxyQuery_new11".}
proc fcQNetworkProxyQuery_new12(bindPort: cushort, protocolTag: struct_seaqt_string): ptr cQNetworkProxyQuery {.importc: "QNetworkProxyQuery_new12".}
proc fcQNetworkProxyQuery_new13(bindPort: cushort, protocolTag: struct_seaqt_string, queryType: cint): ptr cQNetworkProxyQuery {.importc: "QNetworkProxyQuery_new13".}
...
proc fcQNetworkProxyQuery_new15(networkConfiguration: pointer, hostname: struct_seaqt_string, port: cint, protocolTag: struct_seaqt_string): ptr cQNetworkProxyQuery {.importc: "QNetworkProxyQuery_new15".}
proc fcQNetworkProxyQuery_new16(networkConfiguration: pointer, hostname: struct_seaqt_string, port: cint, protocolTag: struct_seaqt_string, queryType: cint): ptr cQNetworkProxyQuery {.importc: "QNetworkProxyQuery_new16".}
proc fcQNetworkProxyQuery_new17(networkConfiguration: pointer, bindPort: cushort, protocolTag: struct_seaqt_string): ptr cQNetworkProxyQuery {.importc: "QNetworkProxyQuery_new17".}
proc fcQNetworkProxyQuery_new18(networkConfiguration: pointer, bindPort: cushort, protocolTag: struct_seaqt_string, queryType: cint): ptr cQNetworkProxyQuery {.importc: "QNetworkProxyQuery_new18".}
...
proc fcQNetworkProxy_new4(typeVal: cint, hostName: struct_seaqt_string): ptr cQNetworkProxy {.importc: "QNetworkProxy_new4".}
proc fcQNetworkProxy_new5(typeVal: cint, hostName: struct_seaqt_string, port: cushort): ptr cQNetworkProxy {.importc: "QNetworkProxy_new5".}
proc fcQNetworkProxy_new6(typeVal: cint, hostName: struct_seaqt_string, port: cushort, user: struct_seaqt_string): ptr cQNetworkProxy {.importc: "QNetworkProxy_new6".}
proc fcQNetworkProxy_new7(typeVal: cint, hostName: struct_seaqt_string, port: cushort, user: struct_seaqt_string, password: struct_seaqt_string): ptr cQNetworkProxy {.importc: "QNetworkProxy_new7".}
...
proc fcQNetworkProxyFactory_systemProxyForQueryWithQuery(query: pointer): struct_seaqt_array {.importc: "QNetworkProxyFactory_systemProxyForQueryWithQuery".}
...
proc create*(T: type gen_qnetworkproxy_types.QNetworkProxyQuery,
  ...
  let tmp = gen_qnetworkproxy_types.QNetworkProxyQuery(h: fcQNetworkProxyQuery_new8(other.h), owned: true)
  tmp
proc create*(T: type gen_qnetworkproxy_types.QNetworkProxyQuery,
...
proc create*(T: type gen_qnetworkproxy_types.QNetworkProxy,
  ...
  let tmp = gen_qnetworkproxy_types.QNetworkProxy(h: fcQNetworkProxy_new3(other.h), owned: true)
  tmp
proc create*(T: type gen_qnetworkproxy_types.QNetworkProxy,
...
proc systemProxyForQuery*(_: type gen_qnetworkproxy_types.QNetworkProxyFactory, query: gen_qnetworkproxy_types.QNetworkProxyQuery): seq[gen_qnetworkproxy_types.QNetworkProxy] =
  var v_ma = fcQNetworkProxyFactory_systemProxyForQueryWithQuery(query.h)
  var vx_ret = newSeq[gen_qnetworkproxy_types.QNetworkProxy](int(v_ma.len))
  let v_outCast = cast[ptr UncheckedArray[pointer]](v_ma.data)
  for i in 0 ..< v_ma.len:
    vx_ret[i] = gen_qnetworkproxy_types.QNetworkProxy(h: v_outCast[i], owned: true)
