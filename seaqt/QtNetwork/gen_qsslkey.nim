...
proc create*(T: type gen_qsslkey_types.QSslKey,
  ...
  let tmp = gen_qsslkey_types.QSslKey(h: fcQSslKey_new2(struct_seaqt_string(data: if len(encoded) > 0: addr encoded[0] else: nil, len: csize_t(len(encoded))), cint(algorithm)))
  tmp
proc create*(T: type gen_qsslkey_types.QSslKey,
...
proc create*(T: type gen_qsslkey_types.QSslKey,
  ...
  let tmp = gen_qsslkey_types.QSslKey(h: fcQSslKey_new6(struct_seaqt_string(data: if len(encoded) > 0: addr encoded[0] else: nil, len: csize_t(len(encoded))), cint(algorithm), cint(format)))
  tmp
proc create*(T: type gen_qsslkey_types.QSslKey,
    encoded: openArray[byte], algorithm: cint, format: cint, typeVal: cint): gen_qsslkey_types.QSslKey =
  let tmp = gen_qsslkey_types.QSslKey(h: fcQSslKey_new7(struct_seaqt_string(data: if len(encoded) > 0: addr encoded[0] else: nil, len: csize_t(len(encoded))), cint(algorithm), cint(format), cint(typeVal)))
  tmp
proc create*(T: type gen_qsslkey_types.QSslKey,
    encoded: openArray[byte], algorithm: cint, format: cint, typeVal: cint, passPhrase: openArray[byte]): gen_qsslkey_types.QSslKey =
  let tmp = gen_qsslkey_types.QSslKey(h: fcQSslKey_new8(struct_seaqt_string(data: if len(encoded) > 0: addr encoded[0] else: nil, len: csize_t(len(encoded))), cint(algorithm), cint(format), cint(typeVal), struct_seaqt_string(data: if len(passPhrase) > 0: addr passPhrase[0] else: nil, len: csize_t(len(passPhrase)))))
  tmp
proc create*(T: type gen_qsslkey_types.QSslKey,
...
proc create*(T: type gen_qsslkey_types.QSslKey,
  ...
  let tmp = gen_qsslkey_types.QSslKey(h: fcQSslKey_new11(device.h, cint(algorithm), cint(format), cint(typeVal), struct_seaqt_string(data: if len(passPhrase) > 0: addr passPhrase[0] else: nil, len: csize_t(len(passPhrase)))))
  tmp
proc create*(T: type gen_qsslkey_types.QSslKey,
