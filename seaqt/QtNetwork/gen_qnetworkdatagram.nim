...
proc setData*(self: gen_qnetworkdatagram_types.QNetworkDatagram, data: openArray[byte]): void =
  fcQNetworkDatagram_setData(self.h, struct_seaqt_string(data: if len(data) > 0: addr data[0] else: nil, len: csize_t(len(data))))
...
proc makeReply*(self: gen_qnetworkdatagram_types.QNetworkDatagram, payload: openArray[byte]): gen_qnetworkdatagram_types.QNetworkDatagram =
  gen_qnetworkdatagram_types.QNetworkDatagram(h: fcQNetworkDatagram_makeReply(self.h, struct_seaqt_string(data: if len(payload) > 0: addr payload[0] else: nil, len: csize_t(len(payload)))))
...
proc create*(T: type gen_qnetworkdatagram_types.QNetworkDatagram): gen_qnetworkdatagram_types.QNetworkDatagram =
  let tmp = gen_qnetworkdatagram_types.QNetworkDatagram(h: fcQNetworkDatagram_new())
  tmp
proc create*(T: type gen_qnetworkdatagram_types.QNetworkDatagram,
  ...
  let tmp = gen_qnetworkdatagram_types.QNetworkDatagram(h: fcQNetworkDatagram_new2(struct_seaqt_string(data: if len(data) > 0: addr data[0] else: nil, len: csize_t(len(data)))))
  tmp
proc create*(T: type gen_qnetworkdatagram_types.QNetworkDatagram,
    other: gen_qnetworkdatagram_types.QNetworkDatagram): gen_qnetworkdatagram_types.QNetworkDatagram =
  let tmp = gen_qnetworkdatagram_types.QNetworkDatagram(h: fcQNetworkDatagram_new3(other.h))
  tmp
proc create*(T: type gen_qnetworkdatagram_types.QNetworkDatagram,
    data: openArray[byte], destinationAddress: gen_qhostaddress_types.QHostAddress): gen_qnetworkdatagram_types.QNetworkDatagram =
  let tmp = gen_qnetworkdatagram_types.QNetworkDatagram(h: fcQNetworkDatagram_new4(struct_seaqt_string(data: if len(data) > 0: addr data[0] else: nil, len: csize_t(len(data))), destinationAddress.h))
  tmp
proc create*(T: type gen_qnetworkdatagram_types.QNetworkDatagram,
  ...
  let tmp = gen_qnetworkdatagram_types.QNetworkDatagram(h: fcQNetworkDatagram_new5(struct_seaqt_string(data: if len(data) > 0: addr data[0] else: nil, len: csize_t(len(data))), destinationAddress.h, port))
  tmp
