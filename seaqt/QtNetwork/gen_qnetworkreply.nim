...
proc hasRawHeader*(self: gen_qnetworkreply_types.QNetworkReply, headerName: openArray[byte]): bool =
  fcQNetworkReply_hasRawHeader(self.h, struct_miqt_string(data: if len(headerName) > 0: addr headerName[0] else: nil, len: csize_t(len(headerName))))
...
proc rawHeader*(self: gen_qnetworkreply_types.QNetworkReply, headerName: openArray[byte]): seq[byte] =
  var v_bytearray = fcQNetworkReply_rawHeader(self.h, struct_miqt_string(data: if len(headerName) > 0: addr headerName[0] else: nil, len: csize_t(len(headerName))))
...
proc fcQNetworkReply_slot_callback_sslErrors(slot: int, errors: struct_miqt_array) {.cdecl.} =
...
proc setRawHeader*(self: gen_qnetworkreply_types.QNetworkReply, headerName: openArray[byte], value: openArray[byte]): void =
  fcQNetworkReply_protectedbase_setRawHeader(self.h, struct_miqt_string(data: if len(headerName) > 0: addr headerName[0] else: nil, len: csize_t(len(headerName))), struct_miqt_string(data: if len(value) > 0: addr value[0] else: nil, len: csize_t(len(value))))
