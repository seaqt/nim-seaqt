...
const QTcpServer_VTable* QTcpServer_vtbl(const VirtualQTcpServer* self);
void* QTcpServer_vdata(const VirtualQTcpServer* self);
void QTcpServer_setVdata(VirtualQTcpServer* self, void* vdata);
