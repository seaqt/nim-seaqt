...
proc fcQAuthenticator_setUser(self: pointer, user: struct_seaqt_string): void {.importc: "QAuthenticator_setUser".}
proc fcQAuthenticator_password(self: pointer): struct_seaqt_string {.importc: "QAuthenticator_password".}
proc fcQAuthenticator_setPassword(self: pointer, password: struct_seaqt_string): void {.importc: "QAuthenticator_setPassword".}
proc fcQAuthenticator_realm(self: pointer): struct_seaqt_string {.importc: "QAuthenticator_realm".}
proc fcQAuthenticator_setRealm(self: pointer, realm: struct_seaqt_string): void {.importc: "QAuthenticator_setRealm".}
proc fcQAuthenticator_option(self: pointer, opt: struct_seaqt_string): pointer {.importc: "QAuthenticator_option".}
proc fcQAuthenticator_options(self: pointer): struct_seaqt_map {.importc: "QAuthenticator_options".}
proc fcQAuthenticator_setOption(self: pointer, opt: struct_seaqt_string, value: pointer): void {.importc: "QAuthenticator_setOption".}
...
proc fcQAuthenticator_clear(self: pointer): void {.importc: "QAuthenticator_clear".}
...
proc fcQAuthenticator_staticMetaObject(): pointer {.importc: "QAuthenticator_staticMetaObject".}
...
proc setUser*(self: gen_qauthenticator_types.QAuthenticator, user: openArray[char]): void =
  fcQAuthenticator_setUser(self.h, struct_seaqt_string(data: if len(user) > 0: addr user[0] else: nil, len: csize_t(len(user))))
...
proc setPassword*(self: gen_qauthenticator_types.QAuthenticator, password: openArray[char]): void =
  fcQAuthenticator_setPassword(self.h, struct_seaqt_string(data: if len(password) > 0: addr password[0] else: nil, len: csize_t(len(password))))
...
proc setOption*(self: gen_qauthenticator_types.QAuthenticator, opt: openArray[char], value: gen_qvariant_types.QVariant): void =
  fcQAuthenticator_setOption(self.h, struct_seaqt_string(data: if len(opt) > 0: addr opt[0] else: nil, len: csize_t(len(opt))), value.h)
...
proc clear*(self: gen_qauthenticator_types.QAuthenticator): void =
  fcQAuthenticator_clear(self.h)
...
proc create*(T: type gen_qauthenticator_types.QAuthenticator,
  ...
  tmp
proc staticMetaObject*(_: type gen_qauthenticator_types.QAuthenticator): gen_qobjectdefs_types.QMetaObject =
  gen_qobjectdefs_types.QMetaObject(h: fcQAuthenticator_staticMetaObject())
