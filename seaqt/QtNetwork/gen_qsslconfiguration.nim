...
proc fcQSslConfiguration_localCertificateChain(self: pointer): struct_seaqt_array {.importc: "QSslConfiguration_localCertificateChain".}
proc fcQSslConfiguration_setLocalCertificateChain(self: pointer, localChain: struct_seaqt_array): void {.importc: "QSslConfiguration_setLocalCertificateChain".}
...
proc fcQSslConfiguration_peerCertificateChain(self: pointer): struct_seaqt_array {.importc: "QSslConfiguration_peerCertificateChain".}
...
proc fcQSslConfiguration_ciphers(self: pointer): struct_seaqt_array {.importc: "QSslConfiguration_ciphers".}
proc fcQSslConfiguration_setCiphers(self: pointer, ciphers: struct_seaqt_array): void {.importc: "QSslConfiguration_setCiphers".}
proc fcQSslConfiguration_setCiphersWithCiphers(self: pointer, ciphers: struct_seaqt_string): void {.importc: "QSslConfiguration_setCiphersWithCiphers".}
...
proc fcQSslConfiguration_sessionTicket(self: pointer): struct_seaqt_string {.importc: "QSslConfiguration_sessionTicket".}
proc fcQSslConfiguration_setSessionTicket(self: pointer, sessionTicket: struct_seaqt_string): void {.importc: "QSslConfiguration_setSessionTicket".}
...
proc fcQSslConfiguration_ellipticCurves(self: pointer): struct_seaqt_array {.importc: "QSslConfiguration_ellipticCurves".}
proc fcQSslConfiguration_setEllipticCurves(self: pointer, curves: struct_seaqt_array): void {.importc: "QSslConfiguration_setEllipticCurves".}
proc fcQSslConfiguration_supportedEllipticCurves(): struct_seaqt_array {.importc: "QSslConfiguration_supportedEllipticCurves".}
proc fcQSslConfiguration_preSharedKeyIdentityHint(self: pointer): struct_seaqt_string {.importc: "QSslConfiguration_preSharedKeyIdentityHint".}
proc fcQSslConfiguration_setPreSharedKeyIdentityHint(self: pointer, hint: struct_seaqt_string): void {.importc: "QSslConfiguration_setPreSharedKeyIdentityHint".}
...
proc fcQSslConfiguration_setBackendConfigurationOption(self: pointer, name: struct_seaqt_string, value: pointer): void {.importc: "QSslConfiguration_setBackendConfigurationOption".}
...
proc fcQSslConfiguration_setAllowedNextProtocols(self: pointer, protocols: struct_seaqt_array): void {.importc: "QSslConfiguration_setAllowedNextProtocols".}
...
proc setLocalCertificateChain*(self: gen_qsslconfiguration_types.QSslConfiguration, localChain: openArray[gen_qsslcertificate_types.QSslCertificate]): void =
  var localChain_CArray = newSeq[pointer](len(localChain))
  for i in 0..<len(localChain):
    localChain_CArray[i] = localChain[i].h

  fcQSslConfiguration_setLocalCertificateChain(self.h, struct_seaqt_array(len: csize_t(len(localChain)), data: if len(localChain) == 0: nil else: addr(localChain_CArray[0])))
...
proc setCiphers*(self: gen_qsslconfiguration_types.QSslConfiguration, ciphers: openArray[gen_qsslcipher_types.QSslCipher]): void =
  var ciphers_CArray = newSeq[pointer](len(ciphers))
  for i in 0..<len(ciphers):
    ciphers_CArray[i] = ciphers[i].h

  fcQSslConfiguration_setCiphers(self.h, struct_seaqt_array(len: csize_t(len(ciphers)), data: if len(ciphers) == 0: nil else: addr(ciphers_CArray[0])))

proc setCiphers*(self: gen_qsslconfiguration_types.QSslConfiguration, ciphers: openArray[char]): void =
  fcQSslConfiguration_setCiphersWithCiphers(self.h, struct_seaqt_string(data: if len(ciphers) > 0: addr ciphers[0] else: nil, len: csize_t(len(ciphers))))
...
proc setCaCertificates*(self: gen_qsslconfiguration_types.QSslConfiguration, certificates: openArray[gen_qsslcertificate_types.QSslCertificate]): void =
...
proc addCaCertificates*(self: gen_qsslconfiguration_types.QSslConfiguration, certificates: openArray[gen_qsslcertificate_types.QSslCertificate]): void =
  var certificates_CArray = newSeq[pointer](len(certificates))
  for i in 0..<len(certificates):
    certificates_CArray[i] = certificates[i].h
...
proc setSessionTicket*(self: gen_qsslconfiguration_types.QSslConfiguration, sessionTicket: openArray[byte]): void =
  fcQSslConfiguration_setSessionTicket(self.h, struct_seaqt_string(data: if len(sessionTicket) > 0: addr sessionTicket[0] else: nil, len: csize_t(len(sessionTicket))))
...
proc setEllipticCurves*(self: gen_qsslconfiguration_types.QSslConfiguration, curves: openArray[gen_qsslellipticcurve_types.QSslEllipticCurve]): void =
  var curves_CArray = newSeq[pointer](len(curves))
  for i in 0..<len(curves):
    curves_CArray[i] = curves[i].h

  fcQSslConfiguration_setEllipticCurves(self.h, struct_seaqt_array(len: csize_t(len(curves)), data: if len(curves) == 0: nil else: addr(curves_CArray[0])))
...
proc setPreSharedKeyIdentityHint*(self: gen_qsslconfiguration_types.QSslConfiguration, hint: openArray[byte]): void =
  fcQSslConfiguration_setPreSharedKeyIdentityHint(self.h, struct_seaqt_string(data: if len(hint) > 0: addr hint[0] else: nil, len: csize_t(len(hint))))
...
proc setBackendConfigurationOption*(self: gen_qsslconfiguration_types.QSslConfiguration, name: openArray[byte], value: gen_qvariant_types.QVariant): void =
  fcQSslConfiguration_setBackendConfigurationOption(self.h, struct_seaqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name))), value.h)
...
proc setAllowedNextProtocols*(self: gen_qsslconfiguration_types.QSslConfiguration, protocols: openArray[seq[byte]]): void =
  ...
  fcQSslConfiguration_setAllowedNextProtocols(self.h, struct_seaqt_array(len: csize_t(len(protocols)), data: if len(protocols) == 0: nil else: addr(protocols_CArray[0])))
...
proc create*(T: type gen_qsslconfiguration_types.QSslConfiguration): gen_qsslconfiguration_types.QSslConfiguration =
  let tmp = gen_qsslconfiguration_types.QSslConfiguration(h: fcQSslConfiguration_new())
  tmp
proc create*(T: type gen_qsslconfiguration_types.QSslConfiguration,
  ...
  let tmp = gen_qsslconfiguration_types.QSslConfiguration(h: fcQSslConfiguration_new2(other.h))
  tmp
