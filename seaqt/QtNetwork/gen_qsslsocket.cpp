...
public:
	...
	friend void QSslSocket_virtualbase_connectToHost(VirtualQSslSocket* self, struct miqt_string hostName, unsigned short port, int openMode, int protocol);
...
VirtualQSslSocket* QSslSocket_new(const QSslSocket_VTable* vtbl, size_t vdata) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQSslSocket>());
...
void QSslSocket_connectToHostEncrypted42(QSslSocket* self, struct miqt_string hostName, unsigned short port, struct miqt_string sslPeerName, int mode) {
	QString hostName_QString = QString::fromUtf8(hostName.data, hostName.len);
	QString sslPeerName_QString = QString::fromUtf8(sslPeerName.data, sslPeerName.len);
...
void QSslSocket_connectToHostEncrypted5(QSslSocket* self, struct miqt_string hostName, unsigned short port, struct miqt_string sslPeerName, int mode, int protocol) {
	QString hostName_QString = QString::fromUtf8(hostName.data, hostName.len);
	QString sslPeerName_QString = QString::fromUtf8(sslPeerName.data, sslPeerName.len);
...
void QSslSocket_virtualbase_connectToHost(VirtualQSslSocket* self, struct miqt_string hostName, unsigned short port, int openMode, int protocol) {
	QString hostName_QString = QString::fromUtf8(hostName.data, hostName.len);
