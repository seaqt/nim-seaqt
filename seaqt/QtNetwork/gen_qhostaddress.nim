...
proc fcQHostAddress_operatorAssignWithAddress(self: pointer, address: struct_seaqt_string): void {.importc: "QHostAddress_operatorAssignWithAddress".}
...
proc fcQHostAddress_setAddress4(self: pointer, address: struct_seaqt_string): bool {.importc: "QHostAddress_setAddress4".}
...
proc fcQHostAddress_isInSubnetWithSubnet(self: pointer, subnet: struct_seaqt_map): bool {.importc: "QHostAddress_isInSubnetWithSubnet".}
...
proc fcQHostAddress_new6(address: struct_seaqt_string): ptr cQHostAddress {.importc: "QHostAddress_new6".}
...
proc operatorAssign*(self: gen_qhostaddress_types.QHostAddress, address: openArray[char]): void =
  fcQHostAddress_operatorAssignWithAddress(self.h, struct_seaqt_string(data: if len(address) > 0: addr address[0] else: nil, len: csize_t(len(address))))
...
proc setAddress*(self: gen_qhostaddress_types.QHostAddress, address: openArray[char]): bool =
  fcQHostAddress_setAddress4(self.h, struct_seaqt_string(data: if len(address) > 0: addr address[0] else: nil, len: csize_t(len(address))))
...
proc isInSubnet*(self: gen_qhostaddress_types.QHostAddress, subnet: tuple[first: gen_qhostaddress_types.QHostAddress, second: cint]): bool =
  ...
  fcQHostAddress_isInSubnetWithSubnet(self.h, struct_seaqt_map(len: 1,keys: addr(subnet_CArray_First),values: addr(subnet_CArray_Second),))
...
proc create*(T: type gen_qhostaddress_types.QHostAddress): gen_qhostaddress_types.QHostAddress =
  let tmp = gen_qhostaddress_types.QHostAddress(h: fcQHostAddress_new())
  tmp
proc create*(T: type gen_qhostaddress_types.QHostAddress,
    ip4Addr: cuint): gen_qhostaddress_types.QHostAddress =
  let tmp = gen_qhostaddress_types.QHostAddress(h: fcQHostAddress_new2(ip4Addr))
  tmp
proc create*(T: type gen_qhostaddress_types.QHostAddress,
    ip6Addr: ptr uint8): gen_qhostaddress_types.QHostAddress =
  let tmp = gen_qhostaddress_types.QHostAddress(h: fcQHostAddress_new3(ip6Addr))
  tmp
proc create2*(T: type gen_qhostaddress_types.QHostAddress,
    ip6Addr: ptr uint8): gen_qhostaddress_types.QHostAddress =
  let tmp = gen_qhostaddress_types.QHostAddress(h: fcQHostAddress_new4(ip6Addr))
  tmp
proc create*(T: type gen_qhostaddress_types.QHostAddress,
    ip6Addr: gen_qhostaddress_types.QIPv6Address): gen_qhostaddress_types.QHostAddress =
  let tmp = gen_qhostaddress_types.QHostAddress(h: fcQHostAddress_new5(ip6Addr.h))
  tmp
proc create*(T: type gen_qhostaddress_types.QHostAddress,
    address: openArray[char]): gen_qhostaddress_types.QHostAddress =
  let tmp = gen_qhostaddress_types.QHostAddress(h: fcQHostAddress_new6(struct_seaqt_string(data: if len(address) > 0: addr address[0] else: nil, len: csize_t(len(address)))))
  tmp
proc create*(T: type gen_qhostaddress_types.QHostAddress,
    copy: gen_qhostaddress_types.QHostAddress): gen_qhostaddress_types.QHostAddress =
  let tmp = gen_qhostaddress_types.QHostAddress(h: fcQHostAddress_new7(copy.h))
  tmp
proc create*(T: type gen_qhostaddress_types.QHostAddress,
    address: cint): gen_qhostaddress_types.QHostAddress =
  let tmp = gen_qhostaddress_types.QHostAddress(h: fcQHostAddress_new8(cint(address)))
  tmp
