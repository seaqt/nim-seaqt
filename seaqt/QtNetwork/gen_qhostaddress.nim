...
proc fcQHostAddress_setAddress3(self: pointer, address: struct_seaqt_string): bool {.importc: "QHostAddress_setAddress3".}
...
proc fcQHostAddress_new5(address: struct_seaqt_string): ptr cQHostAddress {.importc: "QHostAddress_new5".}
...
proc setAddress*(self: gen_qhostaddress_types.QHostAddress, address: openArray[char]): bool =
  fcQHostAddress_setAddress3(self.h, struct_seaqt_string(data: if len(address) > 0: addr address[0] else: nil, len: csize_t(len(address))))
...
proc create*(T: type gen_qhostaddress_types.QHostAddress,
  ...
  let tmp = gen_qhostaddress_types.QHostAddress(h: fcQHostAddress_new4(ip6Addr.h))
  tmp
proc create*(T: type gen_qhostaddress_types.QHostAddress,
    address: openArray[char]): gen_qhostaddress_types.QHostAddress =
  let tmp = gen_qhostaddress_types.QHostAddress(h: fcQHostAddress_new5(struct_seaqt_string(data: if len(address) > 0: addr address[0] else: nil, len: csize_t(len(address)))))
  tmp
proc create*(T: type gen_qhostaddress_types.QHostAddress,
    copy: gen_qhostaddress_types.QHostAddress): gen_qhostaddress_types.QHostAddress =
  let tmp = gen_qhostaddress_types.QHostAddress(h: fcQHostAddress_new6(copy.h))
  tmp
proc create*(T: type gen_qhostaddress_types.QHostAddress,
    address: cint): gen_qhostaddress_types.QHostAddress =
  let tmp = gen_qhostaddress_types.QHostAddress(h: fcQHostAddress_new7(cint(address)))
  tmp
