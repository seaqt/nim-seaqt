...
proc fcQHostAddress_operatorAssign_QHostAddress(self: pointer, fromVal: pointer): void {.importc: "QHostAddress_operatorAssign_QHostAddress".}
proc fcQHostAddress_operatorAssign_QString(self: pointer, address: struct_seaqt_string): void {.importc: "QHostAddress_operatorAssign_QString".}
proc fcQHostAddress_operatorAssign_QHostAddress_SpecialAddress(self: pointer, address: cint): void {.importc: "QHostAddress_operatorAssign_QHostAddress_SpecialAddress".}
...
proc fcQHostAddress_setAddressPquint8(self: pointer, ip6Addr: ptr uint8): void {.importc: "QHostAddress_setAddress_pquint8".}
proc fcQHostAddress_setAddressPcquint8(self: pointer, ip6Addr: ptr uint8): void {.importc: "QHostAddress_setAddress_pcquint8".}
proc fcQHostAddress_setAddressCQ_IPV6ADDR(self: pointer, ip6Addr: pointer): void {.importc: "QHostAddress_setAddress_cQ_IPV6ADDR".}
proc fcQHostAddress_setAddressCQString(self: pointer, address: struct_seaqt_string): bool {.importc: "QHostAddress_setAddress_cQString".}
...
proc fcQHostAddress_new3(ip6Addr: ptr uint8): ptr cQHostAddress {.importc: "QHostAddress_new_pquint8".}
proc fcQHostAddress_new4(ip6Addr: ptr uint8): ptr cQHostAddress {.importc: "QHostAddress_new_pcquint8".}
proc fcQHostAddress_new5(ip6Addr: pointer): ptr cQHostAddress {.importc: "QHostAddress_new_cQ_IPV6ADDR".}
proc fcQHostAddress_new6(address: struct_seaqt_string): ptr cQHostAddress {.importc: "QHostAddress_new_cQString".}
proc fcQHostAddress_new7(fromVal: pointer): ptr cQHostAddress {.importc: "QHostAddress_new_cQHostAddress".}
proc fcQHostAddress_new8(address: cint): ptr cQHostAddress {.importc: "QHostAddress_new_QHostAddress_SpecialAddress".}
...
proc operatorAssign*(self: gen_qhostaddress_types.QHostAddress, fromVal: gen_qhostaddress_types.QHostAddress): void =
  fcQHostAddress_operatorAssign_QHostAddress(self.h, fromVal.h)

proc operatorAssign*(self: gen_qhostaddress_types.QHostAddress, address: openArray[char]): void =
  fcQHostAddress_operatorAssign_QString(self.h, struct_seaqt_string(data: if len(address) > 0: addr address[0] else: nil, len: csize_t(len(address))))

proc operatorAssign*(self: gen_qhostaddress_types.QHostAddress, address: cint): void =
  fcQHostAddress_operatorAssign_QHostAddress_SpecialAddress(self.h, cint(address))
...
proc setAddress*(self: gen_qhostaddress_types.QHostAddress, ip6Addr: ptr uint8): void =
  fcQHostAddress_setAddressPquint8(self.h, ip6Addr)

proc setAddress2*(self: gen_qhostaddress_types.QHostAddress, ip6Addr: ptr uint8): void =
  fcQHostAddress_setAddressPcquint8(self.h, ip6Addr)

proc setAddress*(self: gen_qhostaddress_types.QHostAddress, ip6Addr: gen_qhostaddress_types.QIPv6Address): void =
  fcQHostAddress_setAddressCQ_IPV6ADDR(self.h, ip6Addr.h)

proc setAddress*(self: gen_qhostaddress_types.QHostAddress, address: openArray[char]): bool =
  fcQHostAddress_setAddressCQString(self.h, struct_seaqt_string(data: if len(address) > 0: addr address[0] else: nil, len: csize_t(len(address))))
...
proc create2*(T: type gen_qhostaddress_types.QHostAddress,
    ip6Addr: ptr uint8): gen_qhostaddress_types.QHostAddress =
  let tmp = gen_qhostaddress_types.QHostAddress(h: fcQHostAddress_new4(ip6Addr), owned: true)
  tmp
proc create*(T: type gen_qhostaddress_types.QHostAddress,
    ip6Addr: gen_qhostaddress_types.QIPv6Address): gen_qhostaddress_types.QHostAddress =
  let tmp = gen_qhostaddress_types.QHostAddress(h: fcQHostAddress_new5(ip6Addr.h), owned: true)
  tmp
proc create*(T: type gen_qhostaddress_types.QHostAddress,
    address: openArray[char]): gen_qhostaddress_types.QHostAddress =
  let tmp = gen_qhostaddress_types.QHostAddress(h: fcQHostAddress_new6(struct_seaqt_string(data: if len(address) > 0: addr address[0] else: nil, len: csize_t(len(address)))), owned: true)
  tmp
proc create*(T: type gen_qhostaddress_types.QHostAddress,
    fromVal: gen_qhostaddress_types.QHostAddress): gen_qhostaddress_types.QHostAddress =
  let tmp = gen_qhostaddress_types.QHostAddress(h: fcQHostAddress_new7(fromVal.h), owned: true)
  tmp
proc create*(T: type gen_qhostaddress_types.QHostAddress,
    address: cint): gen_qhostaddress_types.QHostAddress =
  let tmp = gen_qhostaddress_types.QHostAddress(h: fcQHostAddress_new8(cint(address)), owned: true)
  tmp
