...
public:
	...
	virtual QStringList supportedSchemes() const override {
		...
		struct miqt_array /* of struct miqt_string */  callback_return_value = vtbl->supportedSchemes(this);
	...
	friend struct miqt_array /* of struct miqt_string */  QNetworkAccessManager_virtualbase_supportedSchemes(const VirtualQNetworkAccessManager* self);
