...
proc fcQHttpHeaders_setDateTimeValue_QAnyStringView_QDateTime(self: pointer, name: struct_seaqt_string, dateTime: pointer): void {.importc: "QHttpHeaders_setDateTimeValue_QAnyStringView_QDateTime".}
proc fcQHttpHeaders_setDateTimeValue_QHttpHeaders_WellKnownHeader_QDateTime(self: pointer, name: cint, dateTime: pointer): void {.importc: "QHttpHeaders_setDateTimeValue_QHttpHeaders_WellKnownHeader_QDateTime".}
...
proc setDateTimeValue*(self: gen_qhttpheaders_types.QHttpHeaders, name: openArray[char], dateTime: gen_qdatetime_types.QDateTime): void =
  fcQHttpHeaders_setDateTimeValue_QAnyStringView_QDateTime(self.h, struct_seaqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name))), dateTime.h)

proc setDateTimeValue*(self: gen_qhttpheaders_types.QHttpHeaders, name: cint, dateTime: gen_qdatetime_types.QDateTime): void =
  fcQHttpHeaders_setDateTimeValue_QHttpHeaders_WellKnownHeader_QDateTime(self.h, cint(name), dateTime.h)
