...
public:
	...
	friend void QAbstractSocket_virtualbase_connectToHost(VirtualQAbstractSocket* self, struct miqt_string hostName, unsigned short port, int mode, int protocol);
...
VirtualQAbstractSocket* QAbstractSocket_new(const QAbstractSocket_VTable* vtbl, size_t vdata, int socketType, QObject* parent) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQAbstractSocket>());
...
bool QAbstractSocket_bind1(QAbstractSocket* self, unsigned short port) {
	return self->bind(static_cast<quint16>(port));
}

bool QAbstractSocket_bind22(QAbstractSocket* self, unsigned short port, int mode) {
...
void QAbstractSocket_virtualbase_connectToHost(VirtualQAbstractSocket* self, struct miqt_string hostName, unsigned short port, int mode, int protocol) {
	QString hostName_QString = QString::fromUtf8(hostName.data, hostName.len);
