...
template KeepAliveIdleOption*(_: type QAbstractSocketSocketOptionEnum): untyped = 8
template KeepAliveIntervalOption*(_: type QAbstractSocketSocketOptionEnum): untyped = 9
template KeepAliveCountOption*(_: type QAbstractSocketSocketOptionEnum): untyped = 10
...
proc fcQAbstractSocket_connectToHostAddressPort(self: pointer, address: pointer, port: cushort): void {.importc: "QAbstractSocket_connectToHost_address_port".}
...
proc fcQAbstractSocket_peerName(self: pointer): struct_seaqt_string {.importc: "QAbstractSocket_peerName".}
...
proc fcQAbstractSocket_protocolTag(self: pointer): struct_seaqt_string {.importc: "QAbstractSocket_protocolTag".}
proc fcQAbstractSocket_setProtocolTag(self: pointer, tag: struct_seaqt_string): void {.importc: "QAbstractSocket_setProtocolTag".}
...
proc fcQAbstractSocket_virtualbase_bindAddressPortMode(self: pointer, address: pointer, port: cushort, mode: cint): bool {.importc: "QAbstractSocket_virtualbase_bind_address_port_mode".}
...
proc fcQAbstractSocket_protectedbase_setPeerName(self: pointer, name: struct_seaqt_string): void {.importc: "QAbstractSocket_protectedbase_setPeerName".}
...
proc fcQAbstractSocket_protectedbase_setErrorString(self: pointer, errorString: struct_seaqt_string): void {.importc: "QAbstractSocket_protectedbase_setErrorString".}
...
proc connectToHost*(self: gen_qabstractsocket_types.QAbstractSocket, address: gen_qhostaddress_types.QHostAddress, port: cushort): void =
  fcQAbstractSocket_connectToHostAddressPort(self.h, address.h, port)
...
proc setProtocolTag*(self: gen_qabstractsocket_types.QAbstractSocket, tag: openArray[char]): void =
  fcQAbstractSocket_setProtocolTag(self.h, struct_seaqt_string(data: if len(tag) > 0: addr tag[0] else: nil, len: csize_t(len(tag))))
...
type QAbstractSocketbindAddressPortModeProc* = proc(self: QAbstractSocket, address: gen_qhostaddress_types.QHostAddress, port: cushort, mode: cint): bool {.raises: [], gcsafe.}
...
type QAbstractSocketVTable* {.inheritable, pure.} = object
  ...
  bindAddressPortMode*: QAbstractSocketbindAddressPortModeProc
...
proc QAbstractSocketbindX*(self: gen_qabstractsocket_types.QAbstractSocket, address: gen_qhostaddress_types.QHostAddress, port: cushort, mode: cint): bool =
  fcQAbstractSocket_virtualbase_bindAddressPortMode(self.h, address.h, port, cint(mode))
...
proc fcQAbstractSocket_vtable_callback_bindAddressPortMode(self: pointer, address: pointer, port: cushort, mode: cint): bool {.cdecl.} =
  let vtbl = cast[ptr QAbstractSocketVTable](fcQAbstractSocket_vdata(self)[])
  let self = QAbstractSocket(h: self)
...
proc fcQAbstractSocket_method_callback_bindAddressPortMode(self: pointer, address: pointer, port: cushort, mode: cint): bool {.cdecl.} =
  let inst = cast[VirtualQAbstractSocket](fcQAbstractSocket_vdata(self)[])
  let slotval1 = gen_qhostaddress_types.QHostAddress(h: address, owned: false)
  let slotval2 = port
  let slotval3 = cint(mode)
...
proc setPeerName*(self: gen_qabstractsocket_types.QAbstractSocket, name: openArray[char]): void =
  fcQAbstractSocket_protectedbase_setPeerName(self.h, struct_seaqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name))))
...
proc setErrorString*(self: gen_qabstractsocket_types.QAbstractSocket, errorString: openArray[char]): void =
  fcQAbstractSocket_protectedbase_setErrorString(self.h, struct_seaqt_string(data: if len(errorString) > 0: addr errorString[0] else: nil, len: csize_t(len(errorString))))
...
proc create*(T: type gen_qabstractsocket_types.QAbstractSocket,
  ...
  if not isNil(vtbl[].bindAddressPortMode):
    vtbl[].vtbl.bindAddressPortMode = fcQAbstractSocket_vtable_callback_bindAddressPortMode
...
const cQAbstractSocket_mvtbl = cQAbstractSocketVTable(
  ...
  bindAddressPortMode: fcQAbstractSocket_method_callback_bindAddressPortMode,
