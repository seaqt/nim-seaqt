...
proc cQAbstractSocket_vtable_callback_bindX(self: pointer, address: pointer, port: cushort, mode: cint): bool {.cdecl.} =
  let vtbl = cast[ptr QAbstractSocketVTable](fcQAbstractSocket_vdata(self))
  let self = QAbstractSocket(h: self)
...
proc cQAbstractSocket_vtable_callback_skipData(self: pointer, maxSize: clonglong): clonglong {.cdecl.} =
  let vtbl = cast[ptr QAbstractSocketVTable](fcQAbstractSocket_vdata(self))
  let self = QAbstractSocket(h: self)
...
proc cQAbstractSocket_method_callback_bindX(self: pointer, address: pointer, port: cushort, mode: cint): bool {.cdecl.} =
  let inst = cast[VirtualQAbstractSocket](fcQAbstractSocket_vdata(self))
  let slotval1 = gen_qhostaddress_types.QHostAddress(h: address, owned: false)
  let slotval2 = port
  let slotval3 = cint(mode)
...
proc cQAbstractSocket_method_callback_skipData(self: pointer, maxSize: clonglong): clonglong {.cdecl.} =
  let inst = cast[VirtualQAbstractSocket](fcQAbstractSocket_vdata(self))
  let slotval1 = maxSize
...
proc create*(T: type gen_qabstractsocket_types.QAbstractSocket,
  ...
  if not isNil(vtbl[].bindX):
    vtbl[].vtbl.bindX = cQAbstractSocket_vtable_callback_bindX
  ...
  if not isNil(vtbl[].skipData):
    vtbl[].vtbl.skipData = cQAbstractSocket_vtable_callback_skipData
...
const cQAbstractSocket_mvtbl = cQAbstractSocketVTable(
  ...
  bindX: cQAbstractSocket_method_callback_bindX,
  ...
  skipData: cQAbstractSocket_method_callback_skipData,
