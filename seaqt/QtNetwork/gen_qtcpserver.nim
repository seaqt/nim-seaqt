...
proc fcQTcpServer_trUtf8(s: cstring): struct_seaqt_string {.importc: "QTcpServer_trUtf8".}
...
proc fcQTcpServer_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QTcpServer_trUtf82".}
proc fcQTcpServer_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QTcpServer_trUtf83".}
