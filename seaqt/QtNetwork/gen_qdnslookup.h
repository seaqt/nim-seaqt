...
const QDnsLookup_VTable* QDnsLookup_vtbl(const VirtualQDnsLookup* self);
void* QDnsLookup_vdata(const VirtualQDnsLookup* self);
void QDnsLookup_setVdata(VirtualQDnsLookup* self, void* vdata);
