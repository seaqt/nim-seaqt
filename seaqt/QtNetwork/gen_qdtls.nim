...
proc fcQDtlsClientVerifier_trUtf8(s: cstring): struct_seaqt_string {.importc: "QDtlsClientVerifier_trUtf8".}
...
proc fcQDtlsClientVerifier_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QDtlsClientVerifier_trUtf82".}
proc fcQDtlsClientVerifier_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QDtlsClientVerifier_trUtf83".}
...
proc fcQDtls_trUtf8(s: cstring): struct_seaqt_string {.importc: "QDtls_trUtf8".}
...
proc fcQDtls_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QDtls_trUtf82".}
proc fcQDtls_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QDtls_trUtf83".}
...
proc create*(T: type gen_qdtls_types.QDtlsClientVerifierGeneratorParameters,
  ...
  let tmp = gen_qdtls_types.QDtlsClientVerifierGeneratorParameters(h: fcQDtlsClientVerifierGeneratorParameters_new2(cint(a), struct_seaqt_string(data: if len(s) > 0: addr s[0] else: nil, len: csize_t(len(s)))))
  tmp
proc create*(T: type gen_qdtls_types.QDtlsClientVerifierGeneratorParameters,
