...
proc fcQSslServer_sslErrors(self: pointer, socket: pointer, errors: struct_seaqt_array): void {.importc: "QSslServer_sslErrors".}
proc fcQSslServer_connect_sslErrors(self: pointer, slot: int, callback: proc (slot: int, socket: pointer, errors: struct_seaqt_array) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QSslServer_connect_sslErrors".}
...
proc fcQSslServer_alertSent(self: pointer, socket: pointer, level: cint, typeVal: cint, description: struct_seaqt_string): void {.importc: "QSslServer_alertSent".}
proc fcQSslServer_connect_alertSent(self: pointer, slot: int, callback: proc (slot: int, socket: pointer, level: cint, typeVal: cint, description: struct_seaqt_string) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QSslServer_connect_alertSent".}
proc fcQSslServer_alertReceived(self: pointer, socket: pointer, level: cint, typeVal: cint, description: struct_seaqt_string): void {.importc: "QSslServer_alertReceived".}
proc fcQSslServer_connect_alertReceived(self: pointer, slot: int, callback: proc (slot: int, socket: pointer, level: cint, typeVal: cint, description: struct_seaqt_string) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QSslServer_connect_alertReceived".}
...
proc sslErrors*(self: gen_qsslserver_types.QSslServer, socket: gen_qsslsocket_types.QSslSocket, errors: openArray[gen_qsslerror_types.QSslError]): void =
  ...
  fcQSslServer_sslErrors(self.h, socket.h, struct_seaqt_array(len: csize_t(len(errors)), data: if len(errors) == 0: nil else: addr(errors_CArray[0])))
...
proc alertSent*(self: gen_qsslserver_types.QSslServer, socket: gen_qsslsocket_types.QSslSocket, level: cint, typeVal: cint, description: openArray[char]): void =
  fcQSslServer_alertSent(self.h, socket.h, cint(level), cint(typeVal), struct_seaqt_string(data: if len(description) > 0: addr description[0] else: nil, len: csize_t(len(description))))
...
proc alertReceived*(self: gen_qsslserver_types.QSslServer, socket: gen_qsslsocket_types.QSslSocket, level: cint, typeVal: cint, description: openArray[char]): void =
  fcQSslServer_alertReceived(self.h, socket.h, cint(level), cint(typeVal), struct_seaqt_string(data: if len(description) > 0: addr description[0] else: nil, len: csize_t(len(description))))
