...
proc create*(T: type gen_qwebinspector_types.QWebInspector,
  ...
  let tmp = gen_qwebinspector_types.QWebInspector(h: fcQWebInspector_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))))
...
proc create*(T: type gen_qwebinspector_types.QWebInspector,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQWebInspector_vtable_callback_disconnectNotify
  let tmp = gen_qwebinspector_types.QWebInspector(h: fcQWebInspector_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h))
  fcQWebInspector_vdata(tmp.h)[] = addr(vtbl[])
  tmp
