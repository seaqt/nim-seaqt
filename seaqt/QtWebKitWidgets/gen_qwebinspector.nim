...
proc fcQWebInspector_new(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQWebInspector {.importc: "QWebInspector_new_parent".}
proc fcQWebInspector_new2(vtbl: pointer, vdata: csize_t): ptr cQWebInspector {.importc: "QWebInspector_new".}
...
proc create*(T: type gen_qwebinspector_types.QWebInspector,
  ...
  inst[].h = fcQWebInspector_new(addr(cQWebInspector_mvtbl), csize_t(sizeof(pointer)), parent.h)
...
proc create*(T: type gen_qwebinspector_types.QWebInspector,
    inst: VirtualQWebInspector) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQWebInspector_new2(addr(cQWebInspector_mvtbl), csize_t(sizeof(pointer)))
  fcQWebInspector_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
