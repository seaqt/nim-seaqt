...
proc fcQGraphicsWebView_title(self: pointer): struct_seaqt_string {.importc: "QGraphicsWebView_title".}
...
proc fcQGraphicsWebView_titleChanged(self: pointer, param1: struct_seaqt_string): void {.importc: "QGraphicsWebView_titleChanged".}
proc fcQGraphicsWebView_connect_titleChanged(self: pointer, slot: int, callback: proc (slot: int, param1: struct_seaqt_string) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QGraphicsWebView_connect_titleChanged".}
...
proc fcQGraphicsWebView_statusBarMessage(self: pointer, message: struct_seaqt_string): void {.importc: "QGraphicsWebView_statusBarMessage".}
...
proc fcQGraphicsWebView_virtualbase_propertyChange(self: pointer, propertyName: struct_seaqt_string, value: pointer): pointer {.importc: "QGraphicsWebView_virtualbase_propertyChange".}
...
proc titleChanged*(self: gen_qgraphicswebview_types.QGraphicsWebView, param1: openArray[char]): void =
  fcQGraphicsWebView_titleChanged(self.h, struct_seaqt_string(data: if len(param1) > 0: addr param1[0] else: nil, len: csize_t(len(param1))))

type QGraphicsWebViewtitleChangedSlot* = proc(param1: openArray[char])
proc fcQGraphicsWebView_slot_callback_titleChanged(slot: int, param1: struct_seaqt_string) {.cdecl.} =
...
proc statusBarMessage*(self: gen_qgraphicswebview_types.QGraphicsWebView, message: openArray[char]): void =
  fcQGraphicsWebView_statusBarMessage(self.h, struct_seaqt_string(data: if len(message) > 0: addr message[0] else: nil, len: csize_t(len(message))))

type QGraphicsWebViewstatusBarMessageSlot* = proc(message: openArray[char])
proc fcQGraphicsWebView_slot_callback_statusBarMessage(slot: int, message: struct_seaqt_string) {.cdecl.} =
...
proc QGraphicsWebViewpropertyChange*(self: gen_qgraphicswebview_types.QGraphicsWebView, propertyName: openArray[char], value: gen_qvariant_types.QVariant): gen_qvariant_types.QVariant =
  gen_qvariant_types.QVariant(h: fcQGraphicsWebView_virtualbase_propertyChange(self.h, struct_seaqt_string(data: if len(propertyName) > 0: addr propertyName[0] else: nil, len: csize_t(len(propertyName))), value.h), owned: true)
...
proc fcQGraphicsWebView_vtable_callback_propertyChange(self: pointer, propertyName: struct_seaqt_string, value: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QGraphicsWebViewVTable](fcQGraphicsWebView_vdata(self)[])
  let self = QGraphicsWebView(h: self)
...
proc fcQGraphicsWebView_method_callback_propertyChange(self: pointer, propertyName: struct_seaqt_string, value: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQGraphicsWebView](fcQGraphicsWebView_vdata(self)[])
  let vpropertyName_ms = propertyName
  let vpropertyNamex_ret = string.fromBytes(vpropertyName_ms)
  c_free(vpropertyName_ms.data)
...
proc create*(T: type gen_qgraphicswebview_types.QGraphicsWebView,
  ...
  let tmp = gen_qgraphicswebview_types.QGraphicsWebView(h: fcQGraphicsWebView_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQGraphicsWebView_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qgraphicswebview_types.QGraphicsWebView,
  ...
  if not isNil(vtbl[].extension):
    vtbl[].vtbl.extension = fcQGraphicsWebView_vtable_callback_extension
  let tmp = gen_qgraphicswebview_types.QGraphicsWebView(h: fcQGraphicsWebView_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQGraphicsWebView_vdata(tmp.h)[] = addr(vtbl[])
  tmp
...
proc create*(T: type gen_qgraphicswebview_types.QGraphicsWebView,
  ...
  inst[].h = fcQGraphicsWebView_new(addr(cQGraphicsWebView_mvtbl), csize_t(sizeof(pointer)))
  fcQGraphicsWebView_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qgraphicswebview_types.QGraphicsWebView,
    ...
    inst: VirtualQGraphicsWebView) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQGraphicsWebView_new2(addr(cQGraphicsWebView_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQGraphicsWebView_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
