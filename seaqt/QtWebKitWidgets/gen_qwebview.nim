...
proc fcQWebView_new(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQWebView {.importc: "QWebView_new".}
proc fcQWebView_new2(vtbl: pointer, vdata: csize_t): ptr cQWebView {.importc: "QWebView_new2".}
