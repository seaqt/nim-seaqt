...
proc fcQWebHitTestResult_title(self: pointer): struct_seaqt_string {.importc: "QWebHitTestResult_title".}
proc fcQWebHitTestResult_linkText(self: pointer): struct_seaqt_string {.importc: "QWebHitTestResult_linkText".}
...
proc fcQWebHitTestResult_linkTitleString(self: pointer): struct_seaqt_string {.importc: "QWebHitTestResult_linkTitleString".}
...
proc fcQWebHitTestResult_alternateText(self: pointer): struct_seaqt_string {.importc: "QWebHitTestResult_alternateText".}
...
proc fcQWebFrame_frameName(self: pointer): struct_seaqt_string {.importc: "QWebFrame_frameName".}
proc fcQWebFrame_parentFrame(self: pointer): pointer {.importc: "QWebFrame_parentFrame".}
proc fcQWebFrame_childFrames(self: pointer): struct_seaqt_array {.importc: "QWebFrame_childFrames".}
...
proc fcQWebFrame_findAllElements(self: pointer, selectorQuery: struct_seaqt_string): pointer {.importc: "QWebFrame_findAllElements".}
proc fcQWebFrame_findFirstElement(self: pointer, selectorQuery: struct_seaqt_string): pointer {.importc: "QWebFrame_findFirstElement".}
...
proc fcQWebFrame_evaluateJavaScript(self: pointer, scriptSource: struct_seaqt_string): pointer {.importc: "QWebFrame_evaluateJavaScript".}
...
proc fcQWebFrame_titleChanged(self: pointer, title: struct_seaqt_string): void {.importc: "QWebFrame_titleChanged".}
proc fcQWebFrame_connect_titleChanged(self: pointer, slot: int, callback: proc (slot: int, title: struct_seaqt_string) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QWebFrame_connect_titleChanged".}
...
proc titleChanged*(self: gen_qwebframe_types.QWebFrame, title: openArray[char]): void =
  fcQWebFrame_titleChanged(self.h, struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))))

type QWebFrametitleChangedSlot* = proc(title: openArray[char])
proc fcQWebFrame_slot_callback_titleChanged(slot: int, title: struct_seaqt_string) {.cdecl.} =
