...
VirtualQSvgRenderer* QSvgRenderer_new(const QSvgRenderer_VTable* vtbl, size_t vdata) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQSvgRenderer>());
	return _mem_ ? new (_mem_)VirtualQSvgRenderer(vtbl) : nullptr;
}

VirtualQSvgRenderer* QSvgRenderer_new2(const QSvgRenderer_VTable* vtbl, size_t vdata, struct miqt_string filename) {
	QString filename_QString = QString::fromUtf8(filename.data, filename.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQSvgRenderer>());
	return _mem_ ? new (_mem_)VirtualQSvgRenderer(vtbl, filename_QString) : nullptr;
}

VirtualQSvgRenderer* QSvgRenderer_new3(const QSvgRenderer_VTable* vtbl, size_t vdata, struct miqt_string contents) {
...
VirtualQSvgRenderer* QSvgRenderer_new6(const QSvgRenderer_VTable* vtbl, size_t vdata, struct miqt_string filename, QObject* parent) {
	QString filename_QString = QString::fromUtf8(filename.data, filename.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQSvgRenderer>());
	return _mem_ ? new (_mem_)VirtualQSvgRenderer(vtbl, filename_QString, parent) : nullptr;
}

VirtualQSvgRenderer* QSvgRenderer_new7(const QSvgRenderer_VTable* vtbl, size_t vdata, struct miqt_string contents, QObject* parent) {
	QByteArray contents_QByteArray(contents.data, contents.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQSvgRenderer>());
