...
template OnlyPersistentCookies*(_: type QQuickWebEngineProfilePersistentCookiesPolicyEnum): untyped = 3


type QQuickWebEngineProfilePersistentPermissionsPolicyEnum* = distinct uint8
template AskEveryTime*(_: type QQuickWebEngineProfilePersistentPermissionsPolicyEnum): untyped = 0
template StoreInMemory*(_: type QQuickWebEngineProfilePersistentPermissionsPolicyEnum): untyped = 1
template StoreOnDisk*(_: type QQuickWebEngineProfilePersistentPermissionsPolicyEnum): untyped = 2
...
import
  ...
  ../QtWebEngineCore/gen_qwebengineclienthints_types,
  ../QtWebEngineCore/gen_qwebenginecookiestore_types,
  ../QtWebEngineCore/gen_qwebengineextensionmanager_types,
  ../QtWebEngineCore/gen_qwebenginenotification_types,
  ../QtWebEngineCore/gen_qwebenginepermission_types,
...
export
  ...
  gen_qwebengineclienthints_types,
  gen_qwebenginecookiestore_types,
  gen_qwebengineextensionmanager_types,
...
proc fcQQuickWebEngineProfile_persistentStoragePath(self: pointer): struct_seaqt_string {.importc: "QQuickWebEngineProfile_persistentStoragePath".}
proc fcQQuickWebEngineProfile_setPersistentStoragePath(self: pointer, path: struct_seaqt_string): void {.importc: "QQuickWebEngineProfile_setPersistentStoragePath".}
proc fcQQuickWebEngineProfile_cachePath(self: pointer): struct_seaqt_string {.importc: "QQuickWebEngineProfile_cachePath".}
proc fcQQuickWebEngineProfile_setCachePath(self: pointer, path: struct_seaqt_string): void {.importc: "QQuickWebEngineProfile_setCachePath".}
proc fcQQuickWebEngineProfile_httpUserAgent(self: pointer): struct_seaqt_string {.importc: "QQuickWebEngineProfile_httpUserAgent".}
proc fcQQuickWebEngineProfile_setHttpUserAgent(self: pointer, userAgent: struct_seaqt_string): void {.importc: "QQuickWebEngineProfile_setHttpUserAgent".}
...
proc fcQQuickWebEngineProfile_persistentPermissionsPolicy(self: pointer): cint {.importc: "QQuickWebEngineProfile_persistentPermissionsPolicy".}
proc fcQQuickWebEngineProfile_setPersistentPermissionsPolicy(self: pointer, persistentPermissionsPolicy: cint): void {.importc: "QQuickWebEngineProfile_setPersistentPermissionsPolicy".}
...
proc fcQQuickWebEngineProfile_httpAcceptLanguage(self: pointer): struct_seaqt_string {.importc: "QQuickWebEngineProfile_httpAcceptLanguage".}
proc fcQQuickWebEngineProfile_setHttpAcceptLanguage(self: pointer, httpAcceptLanguage: struct_seaqt_string): void {.importc: "QQuickWebEngineProfile_setHttpAcceptLanguage".}
...
proc fcQQuickWebEngineProfile_urlSchemeHandler(self: pointer, param1: struct_seaqt_string): pointer {.importc: "QQuickWebEngineProfile_urlSchemeHandler".}
proc fcQQuickWebEngineProfile_installUrlSchemeHandler(self: pointer, scheme: struct_seaqt_string, param2: pointer): void {.importc: "QQuickWebEngineProfile_installUrlSchemeHandler".}
proc fcQQuickWebEngineProfile_removeUrlScheme(self: pointer, scheme: struct_seaqt_string): void {.importc: "QQuickWebEngineProfile_removeUrlScheme".}
...
proc fcQQuickWebEngineProfile_setSpellCheckLanguages(self: pointer, languages: struct_seaqt_array): void {.importc: "QQuickWebEngineProfile_setSpellCheckLanguages".}
proc fcQQuickWebEngineProfile_spellCheckLanguages(self: pointer): struct_seaqt_array {.importc: "QQuickWebEngineProfile_spellCheckLanguages".}
...
proc fcQQuickWebEngineProfile_downloadPath(self: pointer): struct_seaqt_string {.importc: "QQuickWebEngineProfile_downloadPath".}
proc fcQQuickWebEngineProfile_setDownloadPath(self: pointer, path: struct_seaqt_string): void {.importc: "QQuickWebEngineProfile_setDownloadPath".}
proc fcQQuickWebEngineProfile_isPushServiceEnabled(self: pointer): bool {.importc: "QQuickWebEngineProfile_isPushServiceEnabled".}
proc fcQQuickWebEngineProfile_setPushServiceEnabled(self: pointer, enable: bool): void {.importc: "QQuickWebEngineProfile_setPushServiceEnabled".}
...
proc fcQQuickWebEngineProfile_clientHints(self: pointer): pointer {.importc: "QQuickWebEngineProfile_clientHints".}
proc fcQQuickWebEngineProfile_extensionManager(self: pointer): pointer {.importc: "QQuickWebEngineProfile_extensionManager".}
proc fcQQuickWebEngineProfile_queryPermission(self: pointer, securityOrigin: pointer, permissionType: cint): pointer {.importc: "QQuickWebEngineProfile_queryPermission".}
proc fcQQuickWebEngineProfile_listAllPermissions(self: pointer): struct_seaqt_array {.importc: "QQuickWebEngineProfile_listAllPermissions".}
proc fcQQuickWebEngineProfile_listPermissionsForOrigin(self: pointer, securityOrigin: pointer): struct_seaqt_array {.importc: "QQuickWebEngineProfile_listPermissionsForOrigin".}
proc fcQQuickWebEngineProfile_listPermissionsForPermissionType(self: pointer, permissionType: cint): struct_seaqt_array {.importc: "QQuickWebEngineProfile_listPermissionsForPermissionType".}
...
proc fcQQuickWebEngineProfile_pushServiceEnabledChanged(self: pointer): void {.importc: "QQuickWebEngineProfile_pushServiceEnabledChanged".}
proc fcQQuickWebEngineProfile_connect_pushServiceEnabledChanged(self: pointer, slot: int, callback: proc (slot: int) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QQuickWebEngineProfile_connect_pushServiceEnabledChanged".}
proc fcQQuickWebEngineProfile_clearHttpCacheCompleted(self: pointer): void {.importc: "QQuickWebEngineProfile_clearHttpCacheCompleted".}
proc fcQQuickWebEngineProfile_connect_clearHttpCacheCompleted(self: pointer, slot: int, callback: proc (slot: int) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QQuickWebEngineProfile_connect_clearHttpCacheCompleted".}
proc fcQQuickWebEngineProfile_persistentPermissionsPolicyChanged(self: pointer): void {.importc: "QQuickWebEngineProfile_persistentPermissionsPolicyChanged".}
proc fcQQuickWebEngineProfile_connect_persistentPermissionsPolicyChanged(self: pointer, slot: int, callback: proc (slot: int) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QQuickWebEngineProfile_connect_persistentPermissionsPolicyChanged".}
...
proc fcQQuickWebEngineProfile_new2(vtbl: pointer, vdata: csize_t, storageName: struct_seaqt_string): ptr cQQuickWebEngineProfile {.importc: "QQuickWebEngineProfile_new_storageName".}
proc fcQQuickWebEngineProfile_new3(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQQuickWebEngineProfile {.importc: "QQuickWebEngineProfile_new_parent".}
proc fcQQuickWebEngineProfile_new4(vtbl: pointer, vdata: csize_t, storageName: struct_seaqt_string, parent: pointer): ptr cQQuickWebEngineProfile {.importc: "QQuickWebEngineProfile_new_storageName_parent".}
...
proc setStorageName*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, name: openArray[char]): void =
  fcQQuickWebEngineProfile_setStorageName(self.h, struct_seaqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name))))
...
proc setPersistentStoragePath*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, path: openArray[char]): void =
  fcQQuickWebEngineProfile_setPersistentStoragePath(self.h, struct_seaqt_string(data: if len(path) > 0: addr path[0] else: nil, len: csize_t(len(path))))
...
proc setCachePath*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, path: openArray[char]): void =
  fcQQuickWebEngineProfile_setCachePath(self.h, struct_seaqt_string(data: if len(path) > 0: addr path[0] else: nil, len: csize_t(len(path))))
...
proc setHttpUserAgent*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, userAgent: openArray[char]): void =
  fcQQuickWebEngineProfile_setHttpUserAgent(self.h, struct_seaqt_string(data: if len(userAgent) > 0: addr userAgent[0] else: nil, len: csize_t(len(userAgent))))
...
proc persistentPermissionsPolicy*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile): cint =
  cint(fcQQuickWebEngineProfile_persistentPermissionsPolicy(self.h))

proc setPersistentPermissionsPolicy*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, persistentPermissionsPolicy: cint): void =
  fcQQuickWebEngineProfile_setPersistentPermissionsPolicy(self.h, cint(persistentPermissionsPolicy))
...
proc setHttpAcceptLanguage*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, httpAcceptLanguage: openArray[char]): void =
  fcQQuickWebEngineProfile_setHttpAcceptLanguage(self.h, struct_seaqt_string(data: if len(httpAcceptLanguage) > 0: addr httpAcceptLanguage[0] else: nil, len: csize_t(len(httpAcceptLanguage))))
...
proc urlSchemeHandler*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, param1: openArray[byte]): gen_qwebengineurlschemehandler_types.QWebEngineUrlSchemeHandler =
  gen_qwebengineurlschemehandler_types.QWebEngineUrlSchemeHandler(h: fcQQuickWebEngineProfile_urlSchemeHandler(self.h, struct_seaqt_string(data: if len(param1) > 0: addr param1[0] else: nil, len: csize_t(len(param1)))), owned: false)
...
proc installUrlSchemeHandler*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, scheme: openArray[byte], param2: gen_qwebengineurlschemehandler_types.QWebEngineUrlSchemeHandler): void =
  fcQQuickWebEngineProfile_installUrlSchemeHandler(self.h, struct_seaqt_string(data: if len(scheme) > 0: addr scheme[0] else: nil, len: csize_t(len(scheme))), param2.h)

proc removeUrlScheme*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, scheme: openArray[byte]): void =
  fcQQuickWebEngineProfile_removeUrlScheme(self.h, struct_seaqt_string(data: if len(scheme) > 0: addr scheme[0] else: nil, len: csize_t(len(scheme))))
...
proc setSpellCheckLanguages*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, languages: openArray[string]): void =
  var languages_CArray = newSeq[struct_seaqt_string](len(languages))
  for i in 0..<len(languages):
    languages_CArray[i] = struct_seaqt_string(data: if len(languages[i]) > 0: addr languages[i][0] else: nil, len: csize_t(len(languages[i])))

  fcQQuickWebEngineProfile_setSpellCheckLanguages(self.h, struct_seaqt_array(len: csize_t(len(languages)), data: if len(languages) == 0: nil else: addr(languages_CArray[0])))
...
proc setDownloadPath*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, path: openArray[char]): void =
  fcQQuickWebEngineProfile_setDownloadPath(self.h, struct_seaqt_string(data: if len(path) > 0: addr path[0] else: nil, len: csize_t(len(path))))

proc isPushServiceEnabled*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile): bool =
  fcQQuickWebEngineProfile_isPushServiceEnabled(self.h)

proc setPushServiceEnabled*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, enable: bool): void =
  fcQQuickWebEngineProfile_setPushServiceEnabled(self.h, enable)
...
proc clientHints*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile): gen_qwebengineclienthints_types.QWebEngineClientHints =
  gen_qwebengineclienthints_types.QWebEngineClientHints(h: fcQQuickWebEngineProfile_clientHints(self.h), owned: false)

proc extensionManager*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile): gen_qwebengineextensionmanager_types.QWebEngineExtensionManager =
  gen_qwebengineextensionmanager_types.QWebEngineExtensionManager(h: fcQQuickWebEngineProfile_extensionManager(self.h), owned: false)

proc queryPermission*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, securityOrigin: gen_qurl_types.QUrl, permissionType: cint): gen_qwebenginepermission_types.QWebEnginePermission =
  gen_qwebenginepermission_types.QWebEnginePermission(h: fcQQuickWebEngineProfile_queryPermission(self.h, securityOrigin.h, cint(permissionType)), owned: true)

proc listAllPermissions*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile): seq[gen_qwebenginepermission_types.QWebEnginePermission] =
  var v_ma = fcQQuickWebEngineProfile_listAllPermissions(self.h)
  var vx_ret = newSeq[gen_qwebenginepermission_types.QWebEnginePermission](int(v_ma.len))
  let v_outCast = cast[ptr UncheckedArray[pointer]](v_ma.data)
  for i in 0 ..< v_ma.len:
    vx_ret[i] = gen_qwebenginepermission_types.QWebEnginePermission(h: v_outCast[i], owned: true)
  c_free(v_ma.data)
  vx_ret

proc listPermissionsForOrigin*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, securityOrigin: gen_qurl_types.QUrl): seq[gen_qwebenginepermission_types.QWebEnginePermission] =
  var v_ma = fcQQuickWebEngineProfile_listPermissionsForOrigin(self.h, securityOrigin.h)
  var vx_ret = newSeq[gen_qwebenginepermission_types.QWebEnginePermission](int(v_ma.len))
  let v_outCast = cast[ptr UncheckedArray[pointer]](v_ma.data)
  for i in 0 ..< v_ma.len:
    vx_ret[i] = gen_qwebenginepermission_types.QWebEnginePermission(h: v_outCast[i], owned: true)
...
proc listPermissionsForPermissionType*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, permissionType: cint): seq[gen_qwebenginepermission_types.QWebEnginePermission] =
  var v_ma = fcQQuickWebEngineProfile_listPermissionsForPermissionType(self.h, cint(permissionType))
  var vx_ret = newSeq[gen_qwebenginepermission_types.QWebEnginePermission](int(v_ma.len))
  let v_outCast = cast[ptr UncheckedArray[pointer]](v_ma.data)
  for i in 0 ..< v_ma.len:
    vx_ret[i] = gen_qwebenginepermission_types.QWebEnginePermission(h: v_outCast[i], owned: true)
...
proc fcQQuickWebEngineProfile_slot_callback_storageNameChanged(slot: int) {.cdecl.} =
  let nimfunc = cast[ptr QQuickWebEngineProfilestorageNameChangedSlot](cast[pointer](slot))
  nimfunc[]()

proc fcQQuickWebEngineProfile_slot_callback_storageNameChanged_release(slot: int) {.cdecl.} =
...
proc onStorageNameChanged*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, slot: QQuickWebEngineProfilestorageNameChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQQuickWebEngineProfile_connect_storageNameChanged(self.h, cast[int](addr tmp[]), fcQQuickWebEngineProfile_slot_callback_storageNameChanged, fcQQuickWebEngineProfile_slot_callback_storageNameChanged_release)
...
proc fcQQuickWebEngineProfile_slot_callback_offTheRecordChanged(slot: int) {.cdecl.} =
  let nimfunc = cast[ptr QQuickWebEngineProfileoffTheRecordChangedSlot](cast[pointer](slot))
  nimfunc[]()

proc fcQQuickWebEngineProfile_slot_callback_offTheRecordChanged_release(slot: int) {.cdecl.} =
...
proc onOffTheRecordChanged*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, slot: QQuickWebEngineProfileoffTheRecordChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQQuickWebEngineProfile_connect_offTheRecordChanged(self.h, cast[int](addr tmp[]), fcQQuickWebEngineProfile_slot_callback_offTheRecordChanged, fcQQuickWebEngineProfile_slot_callback_offTheRecordChanged_release)
...
proc fcQQuickWebEngineProfile_slot_callback_persistentStoragePathChanged(slot: int) {.cdecl.} =
  let nimfunc = cast[ptr QQuickWebEngineProfilepersistentStoragePathChangedSlot](cast[pointer](slot))
  nimfunc[]()

proc fcQQuickWebEngineProfile_slot_callback_persistentStoragePathChanged_release(slot: int) {.cdecl.} =
...
proc onPersistentStoragePathChanged*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, slot: QQuickWebEngineProfilepersistentStoragePathChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQQuickWebEngineProfile_connect_persistentStoragePathChanged(self.h, cast[int](addr tmp[]), fcQQuickWebEngineProfile_slot_callback_persistentStoragePathChanged, fcQQuickWebEngineProfile_slot_callback_persistentStoragePathChanged_release)
...
proc fcQQuickWebEngineProfile_slot_callback_cachePathChanged(slot: int) {.cdecl.} =
  let nimfunc = cast[ptr QQuickWebEngineProfilecachePathChangedSlot](cast[pointer](slot))
  nimfunc[]()

proc fcQQuickWebEngineProfile_slot_callback_cachePathChanged_release(slot: int) {.cdecl.} =
...
proc onCachePathChanged*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, slot: QQuickWebEngineProfilecachePathChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQQuickWebEngineProfile_connect_cachePathChanged(self.h, cast[int](addr tmp[]), fcQQuickWebEngineProfile_slot_callback_cachePathChanged, fcQQuickWebEngineProfile_slot_callback_cachePathChanged_release)
...
proc fcQQuickWebEngineProfile_slot_callback_httpUserAgentChanged(slot: int) {.cdecl.} =
  let nimfunc = cast[ptr QQuickWebEngineProfilehttpUserAgentChangedSlot](cast[pointer](slot))
  nimfunc[]()

proc fcQQuickWebEngineProfile_slot_callback_httpUserAgentChanged_release(slot: int) {.cdecl.} =
...
proc onHttpUserAgentChanged*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, slot: QQuickWebEngineProfilehttpUserAgentChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQQuickWebEngineProfile_connect_httpUserAgentChanged(self.h, cast[int](addr tmp[]), fcQQuickWebEngineProfile_slot_callback_httpUserAgentChanged, fcQQuickWebEngineProfile_slot_callback_httpUserAgentChanged_release)
...
proc fcQQuickWebEngineProfile_slot_callback_httpCacheTypeChanged(slot: int) {.cdecl.} =
  let nimfunc = cast[ptr QQuickWebEngineProfilehttpCacheTypeChangedSlot](cast[pointer](slot))
  nimfunc[]()

proc fcQQuickWebEngineProfile_slot_callback_httpCacheTypeChanged_release(slot: int) {.cdecl.} =
...
proc onHttpCacheTypeChanged*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, slot: QQuickWebEngineProfilehttpCacheTypeChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQQuickWebEngineProfile_connect_httpCacheTypeChanged(self.h, cast[int](addr tmp[]), fcQQuickWebEngineProfile_slot_callback_httpCacheTypeChanged, fcQQuickWebEngineProfile_slot_callback_httpCacheTypeChanged_release)
...
proc fcQQuickWebEngineProfile_slot_callback_persistentCookiesPolicyChanged(slot: int) {.cdecl.} =
  let nimfunc = cast[ptr QQuickWebEngineProfilepersistentCookiesPolicyChangedSlot](cast[pointer](slot))
  nimfunc[]()

proc fcQQuickWebEngineProfile_slot_callback_persistentCookiesPolicyChanged_release(slot: int) {.cdecl.} =
...
proc onPersistentCookiesPolicyChanged*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, slot: QQuickWebEngineProfilepersistentCookiesPolicyChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQQuickWebEngineProfile_connect_persistentCookiesPolicyChanged(self.h, cast[int](addr tmp[]), fcQQuickWebEngineProfile_slot_callback_persistentCookiesPolicyChanged, fcQQuickWebEngineProfile_slot_callback_persistentCookiesPolicyChanged_release)
...
proc fcQQuickWebEngineProfile_slot_callback_httpCacheMaximumSizeChanged(slot: int) {.cdecl.} =
  let nimfunc = cast[ptr QQuickWebEngineProfilehttpCacheMaximumSizeChangedSlot](cast[pointer](slot))
  nimfunc[]()

proc fcQQuickWebEngineProfile_slot_callback_httpCacheMaximumSizeChanged_release(slot: int) {.cdecl.} =
...
proc onHttpCacheMaximumSizeChanged*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, slot: QQuickWebEngineProfilehttpCacheMaximumSizeChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQQuickWebEngineProfile_connect_httpCacheMaximumSizeChanged(self.h, cast[int](addr tmp[]), fcQQuickWebEngineProfile_slot_callback_httpCacheMaximumSizeChanged, fcQQuickWebEngineProfile_slot_callback_httpCacheMaximumSizeChanged_release)
...
proc fcQQuickWebEngineProfile_slot_callback_httpAcceptLanguageChanged(slot: int) {.cdecl.} =
  let nimfunc = cast[ptr QQuickWebEngineProfilehttpAcceptLanguageChangedSlot](cast[pointer](slot))
  nimfunc[]()

proc fcQQuickWebEngineProfile_slot_callback_httpAcceptLanguageChanged_release(slot: int) {.cdecl.} =
...
proc onHttpAcceptLanguageChanged*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, slot: QQuickWebEngineProfilehttpAcceptLanguageChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQQuickWebEngineProfile_connect_httpAcceptLanguageChanged(self.h, cast[int](addr tmp[]), fcQQuickWebEngineProfile_slot_callback_httpAcceptLanguageChanged, fcQQuickWebEngineProfile_slot_callback_httpAcceptLanguageChanged_release)
...
proc fcQQuickWebEngineProfile_slot_callback_spellCheckLanguagesChanged(slot: int) {.cdecl.} =
  let nimfunc = cast[ptr QQuickWebEngineProfilespellCheckLanguagesChangedSlot](cast[pointer](slot))
  nimfunc[]()

proc fcQQuickWebEngineProfile_slot_callback_spellCheckLanguagesChanged_release(slot: int) {.cdecl.} =
...
proc onSpellCheckLanguagesChanged*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, slot: QQuickWebEngineProfilespellCheckLanguagesChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQQuickWebEngineProfile_connect_spellCheckLanguagesChanged(self.h, cast[int](addr tmp[]), fcQQuickWebEngineProfile_slot_callback_spellCheckLanguagesChanged, fcQQuickWebEngineProfile_slot_callback_spellCheckLanguagesChanged_release)
...
proc fcQQuickWebEngineProfile_slot_callback_spellCheckEnabledChanged(slot: int) {.cdecl.} =
  let nimfunc = cast[ptr QQuickWebEngineProfilespellCheckEnabledChangedSlot](cast[pointer](slot))
  nimfunc[]()

proc fcQQuickWebEngineProfile_slot_callback_spellCheckEnabledChanged_release(slot: int) {.cdecl.} =
...
proc onSpellCheckEnabledChanged*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, slot: QQuickWebEngineProfilespellCheckEnabledChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQQuickWebEngineProfile_connect_spellCheckEnabledChanged(self.h, cast[int](addr tmp[]), fcQQuickWebEngineProfile_slot_callback_spellCheckEnabledChanged, fcQQuickWebEngineProfile_slot_callback_spellCheckEnabledChanged_release)
...
proc fcQQuickWebEngineProfile_slot_callback_downloadPathChanged(slot: int) {.cdecl.} =
  let nimfunc = cast[ptr QQuickWebEngineProfiledownloadPathChangedSlot](cast[pointer](slot))
  nimfunc[]()

proc fcQQuickWebEngineProfile_slot_callback_downloadPathChanged_release(slot: int) {.cdecl.} =
...
proc onDownloadPathChanged*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, slot: QQuickWebEngineProfiledownloadPathChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQQuickWebEngineProfile_connect_downloadPathChanged(self.h, cast[int](addr tmp[]), fcQQuickWebEngineProfile_slot_callback_downloadPathChanged, fcQQuickWebEngineProfile_slot_callback_downloadPathChanged_release)

proc pushServiceEnabledChanged*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile): void =
  fcQQuickWebEngineProfile_pushServiceEnabledChanged(self.h)

type QQuickWebEngineProfilepushServiceEnabledChangedSlot* = proc()
proc fcQQuickWebEngineProfile_slot_callback_pushServiceEnabledChanged(slot: int) {.cdecl.} =
  let nimfunc = cast[ptr QQuickWebEngineProfilepushServiceEnabledChangedSlot](cast[pointer](slot))
  nimfunc[]()

proc fcQQuickWebEngineProfile_slot_callback_pushServiceEnabledChanged_release(slot: int) {.cdecl.} =
  let nimfunc = cast[ref QQuickWebEngineProfilepushServiceEnabledChangedSlot](cast[pointer](slot))
  GC_unref(nimfunc)

proc onPushServiceEnabledChanged*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, slot: QQuickWebEngineProfilepushServiceEnabledChangedSlot) =
  var tmp = new QQuickWebEngineProfilepushServiceEnabledChangedSlot
  tmp[] = slot
  GC_ref(tmp)
  fcQQuickWebEngineProfile_connect_pushServiceEnabledChanged(self.h, cast[int](addr tmp[]), fcQQuickWebEngineProfile_slot_callback_pushServiceEnabledChanged, fcQQuickWebEngineProfile_slot_callback_pushServiceEnabledChanged_release)

proc clearHttpCacheCompleted*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile): void =
  fcQQuickWebEngineProfile_clearHttpCacheCompleted(self.h)

type QQuickWebEngineProfileclearHttpCacheCompletedSlot* = proc()
proc fcQQuickWebEngineProfile_slot_callback_clearHttpCacheCompleted(slot: int) {.cdecl.} =
  let nimfunc = cast[ptr QQuickWebEngineProfileclearHttpCacheCompletedSlot](cast[pointer](slot))
  nimfunc[]()

proc fcQQuickWebEngineProfile_slot_callback_clearHttpCacheCompleted_release(slot: int) {.cdecl.} =
  let nimfunc = cast[ref QQuickWebEngineProfileclearHttpCacheCompletedSlot](cast[pointer](slot))
  GC_unref(nimfunc)

proc onClearHttpCacheCompleted*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, slot: QQuickWebEngineProfileclearHttpCacheCompletedSlot) =
  var tmp = new QQuickWebEngineProfileclearHttpCacheCompletedSlot
  tmp[] = slot
  GC_ref(tmp)
  fcQQuickWebEngineProfile_connect_clearHttpCacheCompleted(self.h, cast[int](addr tmp[]), fcQQuickWebEngineProfile_slot_callback_clearHttpCacheCompleted, fcQQuickWebEngineProfile_slot_callback_clearHttpCacheCompleted_release)

proc persistentPermissionsPolicyChanged*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile): void =
  fcQQuickWebEngineProfile_persistentPermissionsPolicyChanged(self.h)

type QQuickWebEngineProfilepersistentPermissionsPolicyChangedSlot* = proc()
proc fcQQuickWebEngineProfile_slot_callback_persistentPermissionsPolicyChanged(slot: int) {.cdecl.} =
  let nimfunc = cast[ptr QQuickWebEngineProfilepersistentPermissionsPolicyChangedSlot](cast[pointer](slot))
  nimfunc[]()

proc fcQQuickWebEngineProfile_slot_callback_persistentPermissionsPolicyChanged_release(slot: int) {.cdecl.} =
  let nimfunc = cast[ref QQuickWebEngineProfilepersistentPermissionsPolicyChangedSlot](cast[pointer](slot))
  GC_unref(nimfunc)

proc onPersistentPermissionsPolicyChanged*(self: gen_qquickwebengineprofile_types.QQuickWebEngineProfile, slot: QQuickWebEngineProfilepersistentPermissionsPolicyChangedSlot) =
  var tmp = new QQuickWebEngineProfilepersistentPermissionsPolicyChangedSlot
  tmp[] = slot
  GC_ref(tmp)
  fcQQuickWebEngineProfile_connect_persistentPermissionsPolicyChanged(self.h, cast[int](addr tmp[]), fcQQuickWebEngineProfile_slot_callback_persistentPermissionsPolicyChanged, fcQQuickWebEngineProfile_slot_callback_persistentPermissionsPolicyChanged_release)
...
proc fcQQuickWebEngineProfile_slot_callback_presentNotification(slot: int, notification: pointer) {.cdecl.} =
...
proc fcQQuickWebEngineProfile_slot_callback_presentNotification_release(slot: int) {.cdecl.} =
...
proc create*(T: type gen_qquickwebengineprofile_types.QQuickWebEngineProfile,
  ...
  if not isNil(vtbl[].metaObject):
    vtbl[].vtbl.metaObject = fcQQuickWebEngineProfile_vtable_callback_metaObject
  if not isNil(vtbl[].metacast):
    vtbl[].vtbl.metacast = fcQQuickWebEngineProfile_vtable_callback_metacast
  if not isNil(vtbl[].metacall):
    vtbl[].vtbl.metacall = fcQQuickWebEngineProfile_vtable_callback_metacall
  if not isNil(vtbl[].event):
    vtbl[].vtbl.event = fcQQuickWebEngineProfile_vtable_callback_event
  if not isNil(vtbl[].eventFilter):
    vtbl[].vtbl.eventFilter = fcQQuickWebEngineProfile_vtable_callback_eventFilter
  if not isNil(vtbl[].timerEvent):
    vtbl[].vtbl.timerEvent = fcQQuickWebEngineProfile_vtable_callback_timerEvent
  if not isNil(vtbl[].childEvent):
    vtbl[].vtbl.childEvent = fcQQuickWebEngineProfile_vtable_callback_childEvent
  if not isNil(vtbl[].customEvent):
    vtbl[].vtbl.customEvent = fcQQuickWebEngineProfile_vtable_callback_customEvent
  if not isNil(vtbl[].connectNotify):
    vtbl[].vtbl.connectNotify = fcQQuickWebEngineProfile_vtable_callback_connectNotify
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQQuickWebEngineProfile_vtable_callback_disconnectNotify
  let tmp = gen_qquickwebengineprofile_types.QQuickWebEngineProfile(h: fcQQuickWebEngineProfile_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQQuickWebEngineProfile_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qquickwebengineprofile_types.QQuickWebEngineProfile,
    storageName: openArray[char],
    vtbl: ref QQuickWebEngineProfileVTable = nil): gen_qquickwebengineprofile_types.QQuickWebEngineProfile =
  let vtbl = if vtbl == nil: new QQuickWebEngineProfileVTable else: vtbl
  GC_ref(vtbl)
  vtbl[].vtbl.destructor = proc(self: pointer) {.cdecl.} =
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQQuickWebEngineProfile_vtable_callback_disconnectNotify
  let tmp = gen_qquickwebengineprofile_types.QQuickWebEngineProfile(h: fcQQuickWebEngineProfile_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(storageName) > 0: addr storageName[0] else: nil, len: csize_t(len(storageName)))), owned: true)
  fcQQuickWebEngineProfile_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qquickwebengineprofile_types.QQuickWebEngineProfile,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQQuickWebEngineProfile_vtable_callback_disconnectNotify
  let tmp = gen_qquickwebengineprofile_types.QQuickWebEngineProfile(h: fcQQuickWebEngineProfile_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQQuickWebEngineProfile_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qquickwebengineprofile_types.QQuickWebEngineProfile,
    storageName: openArray[char], parent: gen_qobject_types.QObject,
    vtbl: ref QQuickWebEngineProfileVTable = nil): gen_qquickwebengineprofile_types.QQuickWebEngineProfile =
  let vtbl = if vtbl == nil: new QQuickWebEngineProfileVTable else: vtbl
  GC_ref(vtbl)
  vtbl[].vtbl.destructor = proc(self: pointer) {.cdecl.} =
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQQuickWebEngineProfile_vtable_callback_disconnectNotify
  let tmp = gen_qquickwebengineprofile_types.QQuickWebEngineProfile(h: fcQQuickWebEngineProfile_new4(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(storageName) > 0: addr storageName[0] else: nil, len: csize_t(len(storageName))), parent.h), owned: true)
  fcQQuickWebEngineProfile_vdata(tmp.h)[] = addr(vtbl[])
  tmp
const cQQuickWebEngineProfile_mvtbl = cQQuickWebEngineProfileVTable(
  ...
  metaObject: fcQQuickWebEngineProfile_method_callback_metaObject,
  metacast: fcQQuickWebEngineProfile_method_callback_metacast,
  metacall: fcQQuickWebEngineProfile_method_callback_metacall,
  event: fcQQuickWebEngineProfile_method_callback_event,
  eventFilter: fcQQuickWebEngineProfile_method_callback_eventFilter,
  timerEvent: fcQQuickWebEngineProfile_method_callback_timerEvent,
  childEvent: fcQQuickWebEngineProfile_method_callback_childEvent,
  customEvent: fcQQuickWebEngineProfile_method_callback_customEvent,
  connectNotify: fcQQuickWebEngineProfile_method_callback_connectNotify,
  disconnectNotify: fcQQuickWebEngineProfile_method_callback_disconnectNotify,
)
proc create*(T: type gen_qquickwebengineprofile_types.QQuickWebEngineProfile,
    inst: VirtualQQuickWebEngineProfile) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQQuickWebEngineProfile_new(addr(cQQuickWebEngineProfile_mvtbl), csize_t(sizeof(pointer)))
  fcQQuickWebEngineProfile_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qquickwebengineprofile_types.QQuickWebEngineProfile,
    ...
    inst: VirtualQQuickWebEngineProfile) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQQuickWebEngineProfile_new2(addr(cQQuickWebEngineProfile_mvtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(storageName) > 0: addr storageName[0] else: nil, len: csize_t(len(storageName))))
  fcQQuickWebEngineProfile_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qquickwebengineprofile_types.QQuickWebEngineProfile,
    ...
    inst: VirtualQQuickWebEngineProfile) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQQuickWebEngineProfile_new3(addr(cQQuickWebEngineProfile_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQQuickWebEngineProfile_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qquickwebengineprofile_types.QQuickWebEngineProfile,
    ...
    inst: VirtualQQuickWebEngineProfile) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQQuickWebEngineProfile_new4(addr(cQQuickWebEngineProfile_mvtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(storageName) > 0: addr storageName[0] else: nil, len: csize_t(len(storageName))), parent.h)
  fcQQuickWebEngineProfile_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
