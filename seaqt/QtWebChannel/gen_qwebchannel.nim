...
proc fcQWebChannel_trUtf8(s: cstring): struct_seaqt_string {.importc: "QWebChannel_trUtf8".}
...
proc fcQWebChannel_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QWebChannel_trUtf82".}
proc fcQWebChannel_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QWebChannel_trUtf83".}
