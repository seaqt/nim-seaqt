...
proc fcQSqlQuery_setPositionalBindingEnabled(self: pointer, enable: bool): void {.importc: "QSqlQuery_setPositionalBindingEnabled".}
proc fcQSqlQuery_isPositionalBindingEnabled(self: pointer): bool {.importc: "QSqlQuery_isPositionalBindingEnabled".}
...
proc fcQSqlQuery_boundValueNames(self: pointer): struct_seaqt_array {.importc: "QSqlQuery_boundValueNames".}
proc fcQSqlQuery_boundValueName(self: pointer, pos: cint): struct_seaqt_string {.importc: "QSqlQuery_boundValueName".}
...
proc fcQSqlQuery_staticMetaObject(): pointer {.importc: "QSqlQuery_staticMetaObject".}
...
proc setPositionalBindingEnabled*(self: gen_qsqlquery_types.QSqlQuery, enable: bool): void =
  fcQSqlQuery_setPositionalBindingEnabled(self.h, enable)

proc isPositionalBindingEnabled*(self: gen_qsqlquery_types.QSqlQuery): bool =
  fcQSqlQuery_isPositionalBindingEnabled(self.h)
...
proc boundValueNames*(self: gen_qsqlquery_types.QSqlQuery): seq[string] =
  var v_ma = fcQSqlQuery_boundValueNames(self.h)
...
proc boundValueName*(self: gen_qsqlquery_types.QSqlQuery, pos: cint): string =
  let v_ms = fcQSqlQuery_boundValueName(self.h, pos)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc create*(T: type gen_qsqlquery_types.QSqlQuery,
  ...
  tmp
proc staticMetaObject*(_: type gen_qsqlquery_types.QSqlQuery): gen_qobjectdefs_types.QMetaObject =
  gen_qobjectdefs_types.QMetaObject(h: fcQSqlQuery_staticMetaObject())
