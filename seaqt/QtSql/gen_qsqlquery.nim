...
proc fcQSqlQuery_operatorAssign(self: pointer, fromVal: pointer): void {.importc: "QSqlQuery_operatorAssign".}
...
proc fcQSqlQuery_new4(fromVal: pointer): ptr cQSqlQuery {.importc: "QSqlQuery_new_from".}
...
proc operatorAssign*(self: gen_qsqlquery_types.QSqlQuery, fromVal: gen_qsqlquery_types.QSqlQuery): void =
  fcQSqlQuery_operatorAssign(self.h, fromVal.h)
...
proc create*(T: type gen_qsqlquery_types.QSqlQuery,
  ...
  tmp
proc create*(T: type gen_qsqlquery_types.QSqlQuery,
    fromVal: gen_qsqlquery_types.QSqlQuery): gen_qsqlquery_types.QSqlQuery =
  let tmp = gen_qsqlquery_types.QSqlQuery(h: fcQSqlQuery_new4(fromVal.h), owned: true)
  tmp
proc create*(T: type gen_qsqlquery_types.QSqlQuery,
