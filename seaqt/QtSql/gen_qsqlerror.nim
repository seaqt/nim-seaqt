...
proc fcQSqlError_new(driverText: struct_seaqt_string, databaseText: struct_seaqt_string, typeVal: cint, number: cint): ptr cQSqlError {.importc: "QSqlError_new_driverText_databaseText_type_number".}
proc fcQSqlError_new2(): ptr cQSqlError {.importc: "QSqlError_new".}
proc fcQSqlError_new3(fromVal: pointer): ptr cQSqlError {.importc: "QSqlError_new_from".}
proc fcQSqlError_new4(driverText: struct_seaqt_string): ptr cQSqlError {.importc: "QSqlError_new_driverText".}
proc fcQSqlError_new5(driverText: struct_seaqt_string, databaseText: struct_seaqt_string): ptr cQSqlError {.importc: "QSqlError_new_driverText_databaseText".}
proc fcQSqlError_new6(driverText: struct_seaqt_string, databaseText: struct_seaqt_string, typeVal: cint): ptr cQSqlError {.importc: "QSqlError_new_driverText_databaseText_type".}
proc fcQSqlError_new7(driverText: struct_seaqt_string, databaseText: struct_seaqt_string, typeVal: cint, errorCode: struct_seaqt_string): ptr cQSqlError {.importc: "QSqlError_new_driverText_databaseText_type_errorCode".}
...
proc create*(T: type gen_qsqlerror_types.QSqlError,
  ...
  let tmp = gen_qsqlerror_types.QSqlError(h: fcQSqlError_new3(fromVal.h), owned: true)
  tmp
proc create*(T: type gen_qsqlerror_types.QSqlError,
