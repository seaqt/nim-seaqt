...
proc fcQSqlRecord_swap(self: pointer, other: pointer): void {.importc: "QSqlRecord_swap".}
...
proc swap*(self: gen_qsqlrecord_types.QSqlRecord, other: gen_qsqlrecord_types.QSqlRecord): void =
  fcQSqlRecord_swap(self.h, other.h)
