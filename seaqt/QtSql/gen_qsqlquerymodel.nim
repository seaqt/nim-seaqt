...
proc fcQSqlQueryModel_refresh(self: pointer): void {.importc: "QSqlQueryModel_refresh".}
...
proc refresh*(self: gen_qsqlquerymodel_types.QSqlQueryModel): void =
  fcQSqlQueryModel_refresh(self.h)

proc query*(self: gen_qsqlquerymodel_types.QSqlQueryModel): gen_qsqlquery_types.QSqlQuery =
  gen_qsqlquery_types.QSqlQuery(h: fcQSqlQueryModel_query(self.h), owned: false)
