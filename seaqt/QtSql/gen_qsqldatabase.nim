...
type cQSqlDatabaseDefaultConnectionName*{.exportc: "QSqlDatabaseDefaultConnectionName", incompleteStruct.} = object
...
proc fcQSqlDatabaseDefaultConnectionName_defaultConnectionName(): struct_seaqt_string {.importc: "QSqlDatabaseDefaultConnectionName_defaultConnectionName".}
...
proc defaultConnectionName*(_: type gen_qsqldatabase_types.QSqlDatabaseDefaultConnectionName): string =
  let v_ms = fcQSqlDatabaseDefaultConnectionName_defaultConnectionName()
