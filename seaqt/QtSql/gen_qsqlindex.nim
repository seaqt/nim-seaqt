...
proc fcQSqlIndex_swap(self: pointer, other: pointer): void {.importc: "QSqlIndex_swap".}
...
proc fcQSqlIndex_staticMetaObject(): pointer {.importc: "QSqlIndex_staticMetaObject".}
...
proc swap*(self: gen_qsqlindex_types.QSqlIndex, other: gen_qsqlindex_types.QSqlIndex): void =
  fcQSqlIndex_swap(self.h, other.h)
...
proc create*(T: type gen_qsqlindex_types.QSqlIndex,
  ...
  tmp
proc staticMetaObject*(_: type gen_qsqlindex_types.QSqlIndex): gen_qobjectdefs_types.QMetaObject =
  gen_qobjectdefs_types.QMetaObject(h: fcQSqlIndex_staticMetaObject())
