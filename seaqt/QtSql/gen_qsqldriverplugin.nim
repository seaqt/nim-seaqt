...
proc fcQSqlDriverPlugin_trUtf8S(s: cstring): struct_seaqt_string {.importc: "QSqlDriverPlugin_trUtf8_s".}
...
proc fcQSqlDriverPlugin_trUtf8SC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QSqlDriverPlugin_trUtf8_s_c".}
proc fcQSqlDriverPlugin_trUtf8SCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QSqlDriverPlugin_trUtf8_s_c_n".}
...
proc trUtf8*(_: type gen_qsqldriverplugin_types.QSqlDriverPlugin, s: cstring): string =
  let v_ms = fcQSqlDriverPlugin_trUtf8S(s)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc trUtf8*(_: type gen_qsqldriverplugin_types.QSqlDriverPlugin, s: cstring, c: cstring): string =
  let v_ms = fcQSqlDriverPlugin_trUtf8SC(s, c)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret

proc trUtf8*(_: type gen_qsqldriverplugin_types.QSqlDriverPlugin, s: cstring, c: cstring, n: cint): string =
  let v_ms = fcQSqlDriverPlugin_trUtf8SCN(s, c, n)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
