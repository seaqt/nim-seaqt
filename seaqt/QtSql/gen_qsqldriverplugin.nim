...
proc fcQSqlDriverPlugin_trUtf8(s: cstring): struct_seaqt_string {.importc: "QSqlDriverPlugin_trUtf8".}
...
proc fcQSqlDriverPlugin_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QSqlDriverPlugin_trUtf82".}
proc fcQSqlDriverPlugin_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QSqlDriverPlugin_trUtf83".}
...
proc trUtf8*(_: type gen_qsqldriverplugin_types.QSqlDriverPlugin, s: cstring): string =
  let v_ms = fcQSqlDriverPlugin_trUtf8(s)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
