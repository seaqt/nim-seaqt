...
proc create*(T: type gen_qvideowidget_types.QVideoWidget,
  ...
  let tmp = gen_qvideowidget_types.QVideoWidget(h: fcQVideoWidget_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))))
...
proc create*(T: type gen_qvideowidget_types.QVideoWidget,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQVideoWidget_vtable_callback_disconnectNotify
  let tmp = gen_qvideowidget_types.QVideoWidget(h: fcQVideoWidget_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h))
  fcQVideoWidget_vdata(tmp.h)[] = addr(vtbl[])
  tmp
