...
proc fcQVideoWidget_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.importc: "QVideoWidget_virtualbase_nativeEvent".}
...
proc mediaObject*(self: gen_qvideowidget_types.QVideoWidget): gen_qmediaobject_types.QMediaObject =
  gen_qmediaobject_types.QMediaObject(h: fcQVideoWidget_mediaObject(self.h), owned: false)

proc videoSurface*(self: gen_qvideowidget_types.QVideoWidget): gen_qabstractvideosurface_types.QAbstractVideoSurface =
  gen_qabstractvideosurface_types.QAbstractVideoSurface(h: fcQVideoWidget_videoSurface(self.h), owned: false)
...
proc fcQVideoWidget_slot_callback_fullScreenChanged(slot: int, fullScreen: bool) {.cdecl.} =
  let nimfunc = cast[ptr QVideoWidgetfullScreenChangedSlot](cast[pointer](slot))
  let slotval1 = fullScreen

  nimfunc[](slotval1)

proc fcQVideoWidget_slot_callback_fullScreenChanged_release(slot: int) {.cdecl.} =
...
proc onFullScreenChanged*(self: gen_qvideowidget_types.QVideoWidget, slot: QVideoWidgetfullScreenChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQVideoWidget_connect_fullScreenChanged(self.h, cast[int](addr tmp[]), fcQVideoWidget_slot_callback_fullScreenChanged, fcQVideoWidget_slot_callback_fullScreenChanged_release)
...
proc fcQVideoWidget_slot_callback_brightnessChanged(slot: int, brightness: cint) {.cdecl.} =
  let nimfunc = cast[ptr QVideoWidgetbrightnessChangedSlot](cast[pointer](slot))
  let slotval1 = brightness

  nimfunc[](slotval1)

proc fcQVideoWidget_slot_callback_brightnessChanged_release(slot: int) {.cdecl.} =
...
proc onBrightnessChanged*(self: gen_qvideowidget_types.QVideoWidget, slot: QVideoWidgetbrightnessChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQVideoWidget_connect_brightnessChanged(self.h, cast[int](addr tmp[]), fcQVideoWidget_slot_callback_brightnessChanged, fcQVideoWidget_slot_callback_brightnessChanged_release)
...
proc fcQVideoWidget_slot_callback_contrastChanged(slot: int, contrast: cint) {.cdecl.} =
  let nimfunc = cast[ptr QVideoWidgetcontrastChangedSlot](cast[pointer](slot))
  let slotval1 = contrast

  nimfunc[](slotval1)

proc fcQVideoWidget_slot_callback_contrastChanged_release(slot: int) {.cdecl.} =
...
proc onContrastChanged*(self: gen_qvideowidget_types.QVideoWidget, slot: QVideoWidgetcontrastChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQVideoWidget_connect_contrastChanged(self.h, cast[int](addr tmp[]), fcQVideoWidget_slot_callback_contrastChanged, fcQVideoWidget_slot_callback_contrastChanged_release)
...
proc fcQVideoWidget_slot_callback_hueChanged(slot: int, hue: cint) {.cdecl.} =
  let nimfunc = cast[ptr QVideoWidgethueChangedSlot](cast[pointer](slot))
  let slotval1 = hue

  nimfunc[](slotval1)

proc fcQVideoWidget_slot_callback_hueChanged_release(slot: int) {.cdecl.} =
...
proc onHueChanged*(self: gen_qvideowidget_types.QVideoWidget, slot: QVideoWidgethueChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQVideoWidget_connect_hueChanged(self.h, cast[int](addr tmp[]), fcQVideoWidget_slot_callback_hueChanged, fcQVideoWidget_slot_callback_hueChanged_release)
...
proc fcQVideoWidget_slot_callback_saturationChanged(slot: int, saturation: cint) {.cdecl.} =
  let nimfunc = cast[ptr QVideoWidgetsaturationChangedSlot](cast[pointer](slot))
  let slotval1 = saturation

  nimfunc[](slotval1)

proc fcQVideoWidget_slot_callback_saturationChanged_release(slot: int) {.cdecl.} =
...
type QVideoWidgetnativeEventProc* = proc(self: QVideoWidget, eventType: openArray[byte], message: pointer, resultVal: ptr clong): bool {.raises: [], gcsafe.}
...
proc QVideoWidgetmediaObject*(self: gen_qvideowidget_types.QVideoWidget): gen_qmediaobject_types.QMediaObject =
  gen_qmediaobject_types.QMediaObject(h: fcQVideoWidget_virtualbase_mediaObject(self.h), owned: false)
...
proc QVideoWidgetnativeEvent*(self: gen_qvideowidget_types.QVideoWidget, eventType: openArray[byte], message: pointer, resultVal: ptr clong): bool =
  fcQVideoWidget_virtualbase_nativeEvent(self.h, struct_seaqt_string(data: if len(eventType) > 0: addr eventType[0] else: nil, len: csize_t(len(eventType))), message, resultVal)
...
proc fcQVideoWidget_vtable_callback_metaObject(self: pointer): pointer {.cdecl.} =
...
proc fcQVideoWidget_vtable_callback_metacast(self: pointer, param1: cstring): pointer {.cdecl.} =
  let vtbl = cast[ptr QVideoWidgetVTable](fcQVideoWidget_vdata(self)[])
  let self = QVideoWidget(h: self)
  let slotval1 = (param1)
...
proc fcQVideoWidget_vtable_callback_metacall(self: pointer, param1: cint, param2: cint, param3: pointer): cint {.cdecl.} =
  let vtbl = cast[ptr QVideoWidgetVTable](fcQVideoWidget_vdata(self)[])
  let self = QVideoWidget(h: self)
...
proc fcQVideoWidget_vtable_callback_mediaObject(self: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QVideoWidgetVTable](fcQVideoWidget_vdata(self)[])
  let self = QVideoWidget(h: self)
...
proc fcQVideoWidget_vtable_callback_sizeHint(self: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QVideoWidgetVTable](fcQVideoWidget_vdata(self)[])
  let self = QVideoWidget(h: self)
...
proc fcQVideoWidget_vtable_callback_event(self: pointer, event: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QVideoWidgetVTable](fcQVideoWidget_vdata(self)[])
  let self = QVideoWidget(h: self)
...
proc fcQVideoWidget_vtable_callback_showEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QVideoWidgetVTable](fcQVideoWidget_vdata(self)[])
  let self = QVideoWidget(h: self)
  let slotval1 = gen_qevent_types.QShowEvent(h: event, owned: false)
  vtbl[].showEvent(self, slotval1)

proc fcQVideoWidget_vtable_callback_hideEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QVideoWidgetVTable](fcQVideoWidget_vdata(self)[])
  let self = QVideoWidget(h: self)
  let slotval1 = gen_qevent_types.QHideEvent(h: event, owned: false)
  vtbl[].hideEvent(self, slotval1)

proc fcQVideoWidget_vtable_callback_resizeEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QVideoWidgetVTable](fcQVideoWidget_vdata(self)[])
  let self = QVideoWidget(h: self)
  let slotval1 = gen_qevent_types.QResizeEvent(h: event, owned: false)
  vtbl[].resizeEvent(self, slotval1)

proc fcQVideoWidget_vtable_callback_moveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QVideoWidgetVTable](fcQVideoWidget_vdata(self)[])
  let self = QVideoWidget(h: self)
  let slotval1 = gen_qevent_types.QMoveEvent(h: event, owned: false)
  vtbl[].moveEvent(self, slotval1)

proc fcQVideoWidget_vtable_callback_paintEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QVideoWidgetVTable](fcQVideoWidget_vdata(self)[])
  let self = QVideoWidget(h: self)
  let slotval1 = gen_qevent_types.QPaintEvent(h: event, owned: false)
  vtbl[].paintEvent(self, slotval1)

proc fcQVideoWidget_vtable_callback_setMediaObject(self: pointer, objectVal: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QVideoWidgetVTable](fcQVideoWidget_vdata(self)[])
  let self = QVideoWidget(h: self)
...
proc fcQVideoWidget_vtable_callback_devType(self: pointer): cint {.cdecl.} =
  let vtbl = cast[ptr QVideoWidgetVTable](fcQVideoWidget_vdata(self)[])
  let self = QVideoWidget(h: self)
  var virtualReturn = vtbl[].devType(self)
  virtualReturn

proc fcQVideoWidget_vtable_callback_setVisible(self: pointer, visible: bool): void {.cdecl.} =
  let vtbl = cast[ptr QVideoWidgetVTable](fcQVideoWidget_vdata(self)[])
  let self = QVideoWidget(h: self)
  let slotval1 = visible
  vtbl[].setVisible(self, slotval1)

proc fcQVideoWidget_vtable_callback_minimumSizeHint(self: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QVideoWidgetVTable](fcQVideoWidget_vdata(self)[])
  let self = QVideoWidget(h: self)
...
proc fcQVideoWidget_vtable_callback_heightForWidth(self: pointer, param1: cint): cint {.cdecl.} =
  let vtbl = cast[ptr QVideoWidgetVTable](fcQVideoWidget_vdata(self)[])
  let self = QVideoWidget(h: self)
  let slotval1 = param1
...
proc fcQVideoWidget_vtable_callback_hasHeightForWidth(self: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QVideoWidgetVTable](fcQVideoWidget_vdata(self)[])
  let self = QVideoWidget(h: self)
  var virtualReturn = vtbl[].hasHeightForWidth(self)
  virtualReturn

proc fcQVideoWidget_vtable_callback_paintEngine(self: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QVideoWidgetVTable](fcQVideoWidget_vdata(self)[])
  let self = QVideoWidget(h: self)
...
proc fcQVideoWidget_vtable_callback_mousePressEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QVideoWidgetVTable](fcQVideoWidget_vdata(self)[])
  let self = QVideoWidget(h: self)
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
  vtbl[].mousePressEvent(self, slotval1)

proc fcQVideoWidget_vtable_callback_mouseReleaseEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QVideoWidgetVTable](fcQVideoWidget_vdata(self)[])
  let self = QVideoWidget(h: self)
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
  vtbl[].mouseReleaseEvent(self, slotval1)

proc fcQVideoWidget_vtable_callback_mouseDoubleClickEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QVideoWidgetVTable](fcQVideoWidget_vdata(self)[])
  let self = QVideoWidget(h: self)
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
  vtbl[].mouseDoubleClickEvent(self, slotval1)

proc fcQVideoWidget_vtable_callback_mouseMoveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QVideoWidgetVTable](fcQVideoWidget_vdata(self)[])
  let self = QVideoWidget(h: self)
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
  vtbl[].mouseMoveEvent(self, slotval1)

proc fcQVideoWidget_vtable_callback_wheelEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QVideoWidgetVTable](fcQVideoWidget_vdata(self)[])
  let self = QVideoWidget(h: self)
  let slotval1 = gen_qevent_types.QWheelEvent(h: event, owned: false)
  vtbl[].wheelEvent(self, slotval1)

proc fcQVideoWidget_vtable_callback_keyPressEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QVideoWidgetVTable](fcQVideoWidget_vdata(self)[])
  let self = QVideoWidget(h: self)
  let slotval1 = gen_qevent_types.QKeyEvent(h: event, owned: false)
  vtbl[].keyPressEvent(self, slotval1)

proc fcQVideoWidget_vtable_callback_keyReleaseEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QVideoWidgetVTable](fcQVideoWidget_vdata(self)[])
  let self = QVideoWidget(h: self)
  let slotval1 = gen_qevent_types.QKeyEvent(h: event, owned: false)
  vtbl[].keyReleaseEvent(self, slotval1)

proc fcQVideoWidget_vtable_callback_focusInEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QVideoWidgetVTable](fcQVideoWidget_vdata(self)[])
  let self = QVideoWidget(h: self)
  let slotval1 = gen_qevent_types.QFocusEvent(h: event, owned: false)
  vtbl[].focusInEvent(self, slotval1)

proc fcQVideoWidget_vtable_callback_focusOutEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QVideoWidgetVTable](fcQVideoWidget_vdata(self)[])
  let self = QVideoWidget(h: self)
  let slotval1 = gen_qevent_types.QFocusEvent(h: event, owned: false)
  vtbl[].focusOutEvent(self, slotval1)

proc fcQVideoWidget_vtable_callback_enterEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QVideoWidgetVTable](fcQVideoWidget_vdata(self)[])
  let self = QVideoWidget(h: self)
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
  vtbl[].enterEvent(self, slotval1)

proc fcQVideoWidget_vtable_callback_leaveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QVideoWidgetVTable](fcQVideoWidget_vdata(self)[])
  let self = QVideoWidget(h: self)
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
  vtbl[].leaveEvent(self, slotval1)

proc fcQVideoWidget_vtable_callback_closeEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QVideoWidgetVTable](fcQVideoWidget_vdata(self)[])
  let self = QVideoWidget(h: self)
  let slotval1 = gen_qevent_types.QCloseEvent(h: event, owned: false)
  vtbl[].closeEvent(self, slotval1)

proc fcQVideoWidget_vtable_callback_contextMenuEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QVideoWidgetVTable](fcQVideoWidget_vdata(self)[])
  let self = QVideoWidget(h: self)
  let slotval1 = gen_qevent_types.QContextMenuEvent(h: event, owned: false)
  vtbl[].contextMenuEvent(self, slotval1)

proc fcQVideoWidget_vtable_callback_tabletEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QVideoWidgetVTable](fcQVideoWidget_vdata(self)[])
  let self = QVideoWidget(h: self)
  let slotval1 = gen_qevent_types.QTabletEvent(h: event, owned: false)
  vtbl[].tabletEvent(self, slotval1)

proc fcQVideoWidget_vtable_callback_actionEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QVideoWidgetVTable](fcQVideoWidget_vdata(self)[])
  let self = QVideoWidget(h: self)
  let slotval1 = gen_qevent_types.QActionEvent(h: event, owned: false)
  vtbl[].actionEvent(self, slotval1)

proc fcQVideoWidget_vtable_callback_dragEnterEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QVideoWidgetVTable](fcQVideoWidget_vdata(self)[])
  let self = QVideoWidget(h: self)
  let slotval1 = gen_qevent_types.QDragEnterEvent(h: event, owned: false)
  vtbl[].dragEnterEvent(self, slotval1)

proc fcQVideoWidget_vtable_callback_dragMoveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QVideoWidgetVTable](fcQVideoWidget_vdata(self)[])
  let self = QVideoWidget(h: self)
  let slotval1 = gen_qevent_types.QDragMoveEvent(h: event, owned: false)
  vtbl[].dragMoveEvent(self, slotval1)

proc fcQVideoWidget_vtable_callback_dragLeaveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QVideoWidgetVTable](fcQVideoWidget_vdata(self)[])
  let self = QVideoWidget(h: self)
  let slotval1 = gen_qevent_types.QDragLeaveEvent(h: event, owned: false)
  vtbl[].dragLeaveEvent(self, slotval1)

proc fcQVideoWidget_vtable_callback_dropEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QVideoWidgetVTable](fcQVideoWidget_vdata(self)[])
  let self = QVideoWidget(h: self)
  let slotval1 = gen_qevent_types.QDropEvent(h: event, owned: false)
  vtbl[].dropEvent(self, slotval1)

proc fcQVideoWidget_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let vtbl = cast[ptr QVideoWidgetVTable](fcQVideoWidget_vdata(self)[])
  let self = QVideoWidget(h: self)
...
proc fcQVideoWidget_vtable_callback_changeEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QVideoWidgetVTable](fcQVideoWidget_vdata(self)[])
  let self = QVideoWidget(h: self)
  let slotval1 = gen_qcoreevent_types.QEvent(h: param1, owned: false)
  vtbl[].changeEvent(self, slotval1)

proc fcQVideoWidget_vtable_callback_metric(self: pointer, param1: cint): cint {.cdecl.} =
  let vtbl = cast[ptr QVideoWidgetVTable](fcQVideoWidget_vdata(self)[])
  let self = QVideoWidget(h: self)
  let slotval1 = cint(param1)
...
proc fcQVideoWidget_vtable_callback_initPainter(self: pointer, painter: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QVideoWidgetVTable](fcQVideoWidget_vdata(self)[])
  let self = QVideoWidget(h: self)
  let slotval1 = gen_qpainter_types.QPainter(h: painter, owned: false)
  vtbl[].initPainter(self, slotval1)

proc fcQVideoWidget_vtable_callback_redirected(self: pointer, offset: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QVideoWidgetVTable](fcQVideoWidget_vdata(self)[])
  let self = QVideoWidget(h: self)
...
proc fcQVideoWidget_vtable_callback_sharedPainter(self: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QVideoWidgetVTable](fcQVideoWidget_vdata(self)[])
  let self = QVideoWidget(h: self)
...
proc fcQVideoWidget_vtable_callback_inputMethodEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QVideoWidgetVTable](fcQVideoWidget_vdata(self)[])
  let self = QVideoWidget(h: self)
  let slotval1 = gen_qevent_types.QInputMethodEvent(h: param1, owned: false)
  vtbl[].inputMethodEvent(self, slotval1)

proc fcQVideoWidget_vtable_callback_inputMethodQuery(self: pointer, param1: cint): pointer {.cdecl.} =
  let vtbl = cast[ptr QVideoWidgetVTable](fcQVideoWidget_vdata(self)[])
  let self = QVideoWidget(h: self)
  let slotval1 = cint(param1)
...
proc fcQVideoWidget_vtable_callback_focusNextPrevChild(self: pointer, next: bool): bool {.cdecl.} =
  let vtbl = cast[ptr QVideoWidgetVTable](fcQVideoWidget_vdata(self)[])
  let self = QVideoWidget(h: self)
  let slotval1 = next
...
proc fcQVideoWidget_vtable_callback_eventFilter(self: pointer, watched: pointer, event: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QVideoWidgetVTable](fcQVideoWidget_vdata(self)[])
  let self = QVideoWidget(h: self)
...
proc fcQVideoWidget_vtable_callback_timerEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QVideoWidgetVTable](fcQVideoWidget_vdata(self)[])
  let self = QVideoWidget(h: self)
  let slotval1 = gen_qcoreevent_types.QTimerEvent(h: event, owned: false)
  vtbl[].timerEvent(self, slotval1)

proc fcQVideoWidget_vtable_callback_childEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QVideoWidgetVTable](fcQVideoWidget_vdata(self)[])
  let self = QVideoWidget(h: self)
  let slotval1 = gen_qcoreevent_types.QChildEvent(h: event, owned: false)
  vtbl[].childEvent(self, slotval1)

proc fcQVideoWidget_vtable_callback_customEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QVideoWidgetVTable](fcQVideoWidget_vdata(self)[])
  let self = QVideoWidget(h: self)
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
  vtbl[].customEvent(self, slotval1)

proc fcQVideoWidget_vtable_callback_connectNotify(self: pointer, signal: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QVideoWidgetVTable](fcQVideoWidget_vdata(self)[])
  let self = QVideoWidget(h: self)
  let slotval1 = gen_qmetaobject_types.QMetaMethod(h: signal, owned: false)
  vtbl[].connectNotify(self, slotval1)

proc fcQVideoWidget_vtable_callback_disconnectNotify(self: pointer, signal: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QVideoWidgetVTable](fcQVideoWidget_vdata(self)[])
  let self = QVideoWidget(h: self)
  let slotval1 = gen_qmetaobject_types.QMetaMethod(h: signal, owned: false)
...
method mediaObject*(self: VirtualQVideoWidget): gen_qmediaobject_types.QMediaObject {.base.} =
  QVideoWidgetmediaObject(self[])
...
method setMediaObject*(self: VirtualQVideoWidget, objectVal: gen_qmediaobject_types.QMediaObject): bool {.base.} =
  QVideoWidgetsetMediaObject(self[], objectVal)
...
method enterEvent*(self: VirtualQVideoWidget, event: gen_qcoreevent_types.QEvent): void {.base.} =
...
method nativeEvent*(self: VirtualQVideoWidget, eventType: openArray[byte], message: pointer, resultVal: ptr clong): bool {.base.} =
...
proc fcQVideoWidget_method_callback_metaObject(self: pointer): pointer {.cdecl.} =
...
proc fcQVideoWidget_method_callback_metacast(self: pointer, param1: cstring): pointer {.cdecl.} =
  let inst = cast[VirtualQVideoWidget](fcQVideoWidget_vdata(self)[])
  let slotval1 = (param1)
  var virtualReturn = inst.metacast(slotval1)
  virtualReturn

proc fcQVideoWidget_method_callback_metacall(self: pointer, param1: cint, param2: cint, param3: pointer): cint {.cdecl.} =
  let inst = cast[VirtualQVideoWidget](fcQVideoWidget_vdata(self)[])
  let slotval1 = cint(param1)
  let slotval2 = param2
  let slotval3 = param3
...
proc fcQVideoWidget_method_callback_mediaObject(self: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQVideoWidget](fcQVideoWidget_vdata(self)[])
...
proc fcQVideoWidget_method_callback_sizeHint(self: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQVideoWidget](fcQVideoWidget_vdata(self)[])
...
proc fcQVideoWidget_method_callback_event(self: pointer, event: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQVideoWidget](fcQVideoWidget_vdata(self)[])
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
  var virtualReturn = inst.event(slotval1)
  virtualReturn

proc fcQVideoWidget_method_callback_showEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQVideoWidget](fcQVideoWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QShowEvent(h: event, owned: false)
  inst.showEvent(slotval1)

proc fcQVideoWidget_method_callback_hideEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQVideoWidget](fcQVideoWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QHideEvent(h: event, owned: false)
  inst.hideEvent(slotval1)

proc fcQVideoWidget_method_callback_resizeEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQVideoWidget](fcQVideoWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QResizeEvent(h: event, owned: false)
  inst.resizeEvent(slotval1)

proc fcQVideoWidget_method_callback_moveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQVideoWidget](fcQVideoWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QMoveEvent(h: event, owned: false)
  inst.moveEvent(slotval1)

proc fcQVideoWidget_method_callback_paintEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQVideoWidget](fcQVideoWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QPaintEvent(h: event, owned: false)
  inst.paintEvent(slotval1)

proc fcQVideoWidget_method_callback_setMediaObject(self: pointer, objectVal: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQVideoWidget](fcQVideoWidget_vdata(self)[])
  let slotval1 = gen_qmediaobject_types.QMediaObject(h: objectVal, owned: false)
  var virtualReturn = inst.setMediaObject(slotval1)
  virtualReturn

proc fcQVideoWidget_method_callback_devType(self: pointer): cint {.cdecl.} =
  let inst = cast[VirtualQVideoWidget](fcQVideoWidget_vdata(self)[])
  var virtualReturn = inst.devType()
  virtualReturn

proc fcQVideoWidget_method_callback_setVisible(self: pointer, visible: bool): void {.cdecl.} =
  let inst = cast[VirtualQVideoWidget](fcQVideoWidget_vdata(self)[])
  let slotval1 = visible
  inst.setVisible(slotval1)

proc fcQVideoWidget_method_callback_minimumSizeHint(self: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQVideoWidget](fcQVideoWidget_vdata(self)[])
...
proc fcQVideoWidget_method_callback_heightForWidth(self: pointer, param1: cint): cint {.cdecl.} =
  let inst = cast[VirtualQVideoWidget](fcQVideoWidget_vdata(self)[])
  let slotval1 = param1
  var virtualReturn = inst.heightForWidth(slotval1)
  virtualReturn

proc fcQVideoWidget_method_callback_hasHeightForWidth(self: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQVideoWidget](fcQVideoWidget_vdata(self)[])
  var virtualReturn = inst.hasHeightForWidth()
  virtualReturn

proc fcQVideoWidget_method_callback_paintEngine(self: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQVideoWidget](fcQVideoWidget_vdata(self)[])
...
proc fcQVideoWidget_method_callback_mousePressEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQVideoWidget](fcQVideoWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
  inst.mousePressEvent(slotval1)

proc fcQVideoWidget_method_callback_mouseReleaseEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQVideoWidget](fcQVideoWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
  inst.mouseReleaseEvent(slotval1)

proc fcQVideoWidget_method_callback_mouseDoubleClickEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQVideoWidget](fcQVideoWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
  inst.mouseDoubleClickEvent(slotval1)

proc fcQVideoWidget_method_callback_mouseMoveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQVideoWidget](fcQVideoWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
  inst.mouseMoveEvent(slotval1)

proc fcQVideoWidget_method_callback_wheelEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQVideoWidget](fcQVideoWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QWheelEvent(h: event, owned: false)
  inst.wheelEvent(slotval1)

proc fcQVideoWidget_method_callback_keyPressEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQVideoWidget](fcQVideoWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QKeyEvent(h: event, owned: false)
  inst.keyPressEvent(slotval1)

proc fcQVideoWidget_method_callback_keyReleaseEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQVideoWidget](fcQVideoWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QKeyEvent(h: event, owned: false)
  inst.keyReleaseEvent(slotval1)

proc fcQVideoWidget_method_callback_focusInEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQVideoWidget](fcQVideoWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QFocusEvent(h: event, owned: false)
  inst.focusInEvent(slotval1)

proc fcQVideoWidget_method_callback_focusOutEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQVideoWidget](fcQVideoWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QFocusEvent(h: event, owned: false)
  inst.focusOutEvent(slotval1)

proc fcQVideoWidget_method_callback_enterEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQVideoWidget](fcQVideoWidget_vdata(self)[])
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
  inst.enterEvent(slotval1)

proc fcQVideoWidget_method_callback_leaveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQVideoWidget](fcQVideoWidget_vdata(self)[])
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
  inst.leaveEvent(slotval1)

proc fcQVideoWidget_method_callback_closeEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQVideoWidget](fcQVideoWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QCloseEvent(h: event, owned: false)
  inst.closeEvent(slotval1)

proc fcQVideoWidget_method_callback_contextMenuEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQVideoWidget](fcQVideoWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QContextMenuEvent(h: event, owned: false)
  inst.contextMenuEvent(slotval1)

proc fcQVideoWidget_method_callback_tabletEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQVideoWidget](fcQVideoWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QTabletEvent(h: event, owned: false)
  inst.tabletEvent(slotval1)

proc fcQVideoWidget_method_callback_actionEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQVideoWidget](fcQVideoWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QActionEvent(h: event, owned: false)
  inst.actionEvent(slotval1)

proc fcQVideoWidget_method_callback_dragEnterEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQVideoWidget](fcQVideoWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QDragEnterEvent(h: event, owned: false)
  inst.dragEnterEvent(slotval1)

proc fcQVideoWidget_method_callback_dragMoveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQVideoWidget](fcQVideoWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QDragMoveEvent(h: event, owned: false)
  inst.dragMoveEvent(slotval1)

proc fcQVideoWidget_method_callback_dragLeaveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQVideoWidget](fcQVideoWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QDragLeaveEvent(h: event, owned: false)
  inst.dragLeaveEvent(slotval1)

proc fcQVideoWidget_method_callback_dropEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQVideoWidget](fcQVideoWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QDropEvent(h: event, owned: false)
  inst.dropEvent(slotval1)

proc fcQVideoWidget_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let inst = cast[VirtualQVideoWidget](fcQVideoWidget_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc fcQVideoWidget_method_callback_changeEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let inst = cast[VirtualQVideoWidget](fcQVideoWidget_vdata(self)[])
  let slotval1 = gen_qcoreevent_types.QEvent(h: param1, owned: false)
  inst.changeEvent(slotval1)

proc fcQVideoWidget_method_callback_metric(self: pointer, param1: cint): cint {.cdecl.} =
  let inst = cast[VirtualQVideoWidget](fcQVideoWidget_vdata(self)[])
  let slotval1 = cint(param1)
  var virtualReturn = inst.metric(slotval1)
  virtualReturn

proc fcQVideoWidget_method_callback_initPainter(self: pointer, painter: pointer): void {.cdecl.} =
  let inst = cast[VirtualQVideoWidget](fcQVideoWidget_vdata(self)[])
  let slotval1 = gen_qpainter_types.QPainter(h: painter, owned: false)
  inst.initPainter(slotval1)

proc fcQVideoWidget_method_callback_redirected(self: pointer, offset: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQVideoWidget](fcQVideoWidget_vdata(self)[])
  let slotval1 = gen_qpoint_types.QPoint(h: offset, owned: false)
...
proc fcQVideoWidget_method_callback_sharedPainter(self: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQVideoWidget](fcQVideoWidget_vdata(self)[])
...
proc fcQVideoWidget_method_callback_inputMethodEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let inst = cast[VirtualQVideoWidget](fcQVideoWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QInputMethodEvent(h: param1, owned: false)
  inst.inputMethodEvent(slotval1)

proc fcQVideoWidget_method_callback_inputMethodQuery(self: pointer, param1: cint): pointer {.cdecl.} =
  let inst = cast[VirtualQVideoWidget](fcQVideoWidget_vdata(self)[])
  let slotval1 = cint(param1)
...
proc fcQVideoWidget_method_callback_focusNextPrevChild(self: pointer, next: bool): bool {.cdecl.} =
  let inst = cast[VirtualQVideoWidget](fcQVideoWidget_vdata(self)[])
  let slotval1 = next
  var virtualReturn = inst.focusNextPrevChild(slotval1)
  virtualReturn

proc fcQVideoWidget_method_callback_eventFilter(self: pointer, watched: pointer, event: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQVideoWidget](fcQVideoWidget_vdata(self)[])
  let slotval1 = gen_qobject_types.QObject(h: watched, owned: false)
  let slotval2 = gen_qcoreevent_types.QEvent(h: event, owned: false)
...
proc fcQVideoWidget_method_callback_timerEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQVideoWidget](fcQVideoWidget_vdata(self)[])
  let slotval1 = gen_qcoreevent_types.QTimerEvent(h: event, owned: false)
  inst.timerEvent(slotval1)

proc fcQVideoWidget_method_callback_childEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQVideoWidget](fcQVideoWidget_vdata(self)[])
  let slotval1 = gen_qcoreevent_types.QChildEvent(h: event, owned: false)
  inst.childEvent(slotval1)

proc fcQVideoWidget_method_callback_customEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQVideoWidget](fcQVideoWidget_vdata(self)[])
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
  inst.customEvent(slotval1)

proc fcQVideoWidget_method_callback_connectNotify(self: pointer, signal: pointer): void {.cdecl.} =
  let inst = cast[VirtualQVideoWidget](fcQVideoWidget_vdata(self)[])
  let slotval1 = gen_qmetaobject_types.QMetaMethod(h: signal, owned: false)
  inst.connectNotify(slotval1)

proc fcQVideoWidget_method_callback_disconnectNotify(self: pointer, signal: pointer): void {.cdecl.} =
  let inst = cast[VirtualQVideoWidget](fcQVideoWidget_vdata(self)[])
  let slotval1 = gen_qmetaobject_types.QMetaMethod(h: signal, owned: false)
...
proc create*(T: type gen_qvideowidget_types.QVideoWidget,
  ...
  if not isNil(vtbl[].metaObject):
    vtbl[].vtbl.metaObject = fcQVideoWidget_vtable_callback_metaObject
  if not isNil(vtbl[].metacast):
    vtbl[].vtbl.metacast = fcQVideoWidget_vtable_callback_metacast
  if not isNil(vtbl[].metacall):
    vtbl[].vtbl.metacall = fcQVideoWidget_vtable_callback_metacall
  if not isNil(vtbl[].mediaObject):
    vtbl[].vtbl.mediaObject = fcQVideoWidget_vtable_callback_mediaObject
  if not isNil(vtbl[].sizeHint):
    vtbl[].vtbl.sizeHint = fcQVideoWidget_vtable_callback_sizeHint
  if not isNil(vtbl[].event):
    vtbl[].vtbl.event = fcQVideoWidget_vtable_callback_event
  if not isNil(vtbl[].showEvent):
    vtbl[].vtbl.showEvent = fcQVideoWidget_vtable_callback_showEvent
  if not isNil(vtbl[].hideEvent):
    vtbl[].vtbl.hideEvent = fcQVideoWidget_vtable_callback_hideEvent
  if not isNil(vtbl[].resizeEvent):
    vtbl[].vtbl.resizeEvent = fcQVideoWidget_vtable_callback_resizeEvent
  if not isNil(vtbl[].moveEvent):
    vtbl[].vtbl.moveEvent = fcQVideoWidget_vtable_callback_moveEvent
  if not isNil(vtbl[].paintEvent):
    vtbl[].vtbl.paintEvent = fcQVideoWidget_vtable_callback_paintEvent
  if not isNil(vtbl[].setMediaObject):
    vtbl[].vtbl.setMediaObject = fcQVideoWidget_vtable_callback_setMediaObject
  if not isNil(vtbl[].devType):
    vtbl[].vtbl.devType = fcQVideoWidget_vtable_callback_devType
  if not isNil(vtbl[].setVisible):
    vtbl[].vtbl.setVisible = fcQVideoWidget_vtable_callback_setVisible
  if not isNil(vtbl[].minimumSizeHint):
    vtbl[].vtbl.minimumSizeHint = fcQVideoWidget_vtable_callback_minimumSizeHint
  if not isNil(vtbl[].heightForWidth):
    vtbl[].vtbl.heightForWidth = fcQVideoWidget_vtable_callback_heightForWidth
  if not isNil(vtbl[].hasHeightForWidth):
    vtbl[].vtbl.hasHeightForWidth = fcQVideoWidget_vtable_callback_hasHeightForWidth
  if not isNil(vtbl[].paintEngine):
    vtbl[].vtbl.paintEngine = fcQVideoWidget_vtable_callback_paintEngine
  if not isNil(vtbl[].mousePressEvent):
    vtbl[].vtbl.mousePressEvent = fcQVideoWidget_vtable_callback_mousePressEvent
  if not isNil(vtbl[].mouseReleaseEvent):
    vtbl[].vtbl.mouseReleaseEvent = fcQVideoWidget_vtable_callback_mouseReleaseEvent
  if not isNil(vtbl[].mouseDoubleClickEvent):
    vtbl[].vtbl.mouseDoubleClickEvent = fcQVideoWidget_vtable_callback_mouseDoubleClickEvent
  if not isNil(vtbl[].mouseMoveEvent):
    vtbl[].vtbl.mouseMoveEvent = fcQVideoWidget_vtable_callback_mouseMoveEvent
  if not isNil(vtbl[].wheelEvent):
    vtbl[].vtbl.wheelEvent = fcQVideoWidget_vtable_callback_wheelEvent
  if not isNil(vtbl[].keyPressEvent):
    vtbl[].vtbl.keyPressEvent = fcQVideoWidget_vtable_callback_keyPressEvent
  if not isNil(vtbl[].keyReleaseEvent):
    vtbl[].vtbl.keyReleaseEvent = fcQVideoWidget_vtable_callback_keyReleaseEvent
  if not isNil(vtbl[].focusInEvent):
    vtbl[].vtbl.focusInEvent = fcQVideoWidget_vtable_callback_focusInEvent
  if not isNil(vtbl[].focusOutEvent):
    vtbl[].vtbl.focusOutEvent = fcQVideoWidget_vtable_callback_focusOutEvent
  if not isNil(vtbl[].enterEvent):
    vtbl[].vtbl.enterEvent = fcQVideoWidget_vtable_callback_enterEvent
  if not isNil(vtbl[].leaveEvent):
    vtbl[].vtbl.leaveEvent = fcQVideoWidget_vtable_callback_leaveEvent
  if not isNil(vtbl[].closeEvent):
    vtbl[].vtbl.closeEvent = fcQVideoWidget_vtable_callback_closeEvent
  if not isNil(vtbl[].contextMenuEvent):
    vtbl[].vtbl.contextMenuEvent = fcQVideoWidget_vtable_callback_contextMenuEvent
  if not isNil(vtbl[].tabletEvent):
    vtbl[].vtbl.tabletEvent = fcQVideoWidget_vtable_callback_tabletEvent
  if not isNil(vtbl[].actionEvent):
    vtbl[].vtbl.actionEvent = fcQVideoWidget_vtable_callback_actionEvent
  if not isNil(vtbl[].dragEnterEvent):
    vtbl[].vtbl.dragEnterEvent = fcQVideoWidget_vtable_callback_dragEnterEvent
  if not isNil(vtbl[].dragMoveEvent):
    vtbl[].vtbl.dragMoveEvent = fcQVideoWidget_vtable_callback_dragMoveEvent
  if not isNil(vtbl[].dragLeaveEvent):
    vtbl[].vtbl.dragLeaveEvent = fcQVideoWidget_vtable_callback_dragLeaveEvent
  if not isNil(vtbl[].dropEvent):
    vtbl[].vtbl.dropEvent = fcQVideoWidget_vtable_callback_dropEvent
  if not isNil(vtbl[].nativeEvent):
    vtbl[].vtbl.nativeEvent = fcQVideoWidget_vtable_callback_nativeEvent
  if not isNil(vtbl[].changeEvent):
    vtbl[].vtbl.changeEvent = fcQVideoWidget_vtable_callback_changeEvent
  if not isNil(vtbl[].metric):
    vtbl[].vtbl.metric = fcQVideoWidget_vtable_callback_metric
  if not isNil(vtbl[].initPainter):
    vtbl[].vtbl.initPainter = fcQVideoWidget_vtable_callback_initPainter
  if not isNil(vtbl[].redirected):
    vtbl[].vtbl.redirected = fcQVideoWidget_vtable_callback_redirected
  if not isNil(vtbl[].sharedPainter):
    vtbl[].vtbl.sharedPainter = fcQVideoWidget_vtable_callback_sharedPainter
  if not isNil(vtbl[].inputMethodEvent):
    vtbl[].vtbl.inputMethodEvent = fcQVideoWidget_vtable_callback_inputMethodEvent
  if not isNil(vtbl[].inputMethodQuery):
    vtbl[].vtbl.inputMethodQuery = fcQVideoWidget_vtable_callback_inputMethodQuery
  if not isNil(vtbl[].focusNextPrevChild):
    vtbl[].vtbl.focusNextPrevChild = fcQVideoWidget_vtable_callback_focusNextPrevChild
  if not isNil(vtbl[].eventFilter):
    vtbl[].vtbl.eventFilter = fcQVideoWidget_vtable_callback_eventFilter
  if not isNil(vtbl[].timerEvent):
    vtbl[].vtbl.timerEvent = fcQVideoWidget_vtable_callback_timerEvent
  if not isNil(vtbl[].childEvent):
    vtbl[].vtbl.childEvent = fcQVideoWidget_vtable_callback_childEvent
  if not isNil(vtbl[].customEvent):
    vtbl[].vtbl.customEvent = fcQVideoWidget_vtable_callback_customEvent
  if not isNil(vtbl[].connectNotify):
    vtbl[].vtbl.connectNotify = fcQVideoWidget_vtable_callback_connectNotify
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQVideoWidget_vtable_callback_disconnectNotify
  let tmp = gen_qvideowidget_types.QVideoWidget(h: fcQVideoWidget_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQVideoWidget_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qvideowidget_types.QVideoWidget,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQVideoWidget_vtable_callback_disconnectNotify
  let tmp = gen_qvideowidget_types.QVideoWidget(h: fcQVideoWidget_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQVideoWidget_vdata(tmp.h)[] = addr(vtbl[])
  tmp
const cQVideoWidget_mvtbl = cQVideoWidgetVTable(
  ...
  metaObject: fcQVideoWidget_method_callback_metaObject,
  metacast: fcQVideoWidget_method_callback_metacast,
  metacall: fcQVideoWidget_method_callback_metacall,
  mediaObject: fcQVideoWidget_method_callback_mediaObject,
  sizeHint: fcQVideoWidget_method_callback_sizeHint,
  event: fcQVideoWidget_method_callback_event,
  showEvent: fcQVideoWidget_method_callback_showEvent,
  hideEvent: fcQVideoWidget_method_callback_hideEvent,
  resizeEvent: fcQVideoWidget_method_callback_resizeEvent,
  moveEvent: fcQVideoWidget_method_callback_moveEvent,
  paintEvent: fcQVideoWidget_method_callback_paintEvent,
  setMediaObject: fcQVideoWidget_method_callback_setMediaObject,
  devType: fcQVideoWidget_method_callback_devType,
  setVisible: fcQVideoWidget_method_callback_setVisible,
  minimumSizeHint: fcQVideoWidget_method_callback_minimumSizeHint,
  heightForWidth: fcQVideoWidget_method_callback_heightForWidth,
  hasHeightForWidth: fcQVideoWidget_method_callback_hasHeightForWidth,
  paintEngine: fcQVideoWidget_method_callback_paintEngine,
  mousePressEvent: fcQVideoWidget_method_callback_mousePressEvent,
  mouseReleaseEvent: fcQVideoWidget_method_callback_mouseReleaseEvent,
  mouseDoubleClickEvent: fcQVideoWidget_method_callback_mouseDoubleClickEvent,
  mouseMoveEvent: fcQVideoWidget_method_callback_mouseMoveEvent,
  wheelEvent: fcQVideoWidget_method_callback_wheelEvent,
  keyPressEvent: fcQVideoWidget_method_callback_keyPressEvent,
  keyReleaseEvent: fcQVideoWidget_method_callback_keyReleaseEvent,
  focusInEvent: fcQVideoWidget_method_callback_focusInEvent,
  focusOutEvent: fcQVideoWidget_method_callback_focusOutEvent,
  enterEvent: fcQVideoWidget_method_callback_enterEvent,
  leaveEvent: fcQVideoWidget_method_callback_leaveEvent,
  closeEvent: fcQVideoWidget_method_callback_closeEvent,
  contextMenuEvent: fcQVideoWidget_method_callback_contextMenuEvent,
  tabletEvent: fcQVideoWidget_method_callback_tabletEvent,
  actionEvent: fcQVideoWidget_method_callback_actionEvent,
  dragEnterEvent: fcQVideoWidget_method_callback_dragEnterEvent,
  dragMoveEvent: fcQVideoWidget_method_callback_dragMoveEvent,
  dragLeaveEvent: fcQVideoWidget_method_callback_dragLeaveEvent,
  dropEvent: fcQVideoWidget_method_callback_dropEvent,
  nativeEvent: fcQVideoWidget_method_callback_nativeEvent,
  changeEvent: fcQVideoWidget_method_callback_changeEvent,
  metric: fcQVideoWidget_method_callback_metric,
  initPainter: fcQVideoWidget_method_callback_initPainter,
  redirected: fcQVideoWidget_method_callback_redirected,
  sharedPainter: fcQVideoWidget_method_callback_sharedPainter,
  inputMethodEvent: fcQVideoWidget_method_callback_inputMethodEvent,
  inputMethodQuery: fcQVideoWidget_method_callback_inputMethodQuery,
  focusNextPrevChild: fcQVideoWidget_method_callback_focusNextPrevChild,
  eventFilter: fcQVideoWidget_method_callback_eventFilter,
  timerEvent: fcQVideoWidget_method_callback_timerEvent,
  childEvent: fcQVideoWidget_method_callback_childEvent,
  customEvent: fcQVideoWidget_method_callback_customEvent,
  connectNotify: fcQVideoWidget_method_callback_connectNotify,
  disconnectNotify: fcQVideoWidget_method_callback_disconnectNotify,
)
proc create*(T: type gen_qvideowidget_types.QVideoWidget,
    inst: VirtualQVideoWidget) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQVideoWidget_new(addr(cQVideoWidget_mvtbl), csize_t(sizeof(pointer)))
...
proc create*(T: type gen_qvideowidget_types.QVideoWidget,
    ...
    inst: VirtualQVideoWidget) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQVideoWidget_new2(addr(cQVideoWidget_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQVideoWidget_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
