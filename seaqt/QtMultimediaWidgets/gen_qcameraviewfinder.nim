...
proc create*(T: type gen_qcameraviewfinder_types.QCameraViewfinder,
  ...
  let tmp = gen_qcameraviewfinder_types.QCameraViewfinder(h: fcQCameraViewfinder_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h))
...
proc create*(T: type gen_qcameraviewfinder_types.QCameraViewfinder,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQCameraViewfinder_vtable_callback_disconnectNotify
  let tmp = gen_qcameraviewfinder_types.QCameraViewfinder(h: fcQCameraViewfinder_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer))))
  fcQCameraViewfinder_vdata(tmp.h)[] = addr(vtbl[])
  tmp
