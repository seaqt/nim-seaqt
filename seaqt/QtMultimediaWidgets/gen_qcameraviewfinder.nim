...
proc create*(T: type gen_qcameraviewfinder_types.QCameraViewfinder,
  ...
  let tmp = gen_qcameraviewfinder_types.QCameraViewfinder(h: fcQCameraViewfinder_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
...
proc create*(T: type gen_qcameraviewfinder_types.QCameraViewfinder,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQCameraViewfinder_vtable_callback_disconnectNotify
  let tmp = gen_qcameraviewfinder_types.QCameraViewfinder(h: fcQCameraViewfinder_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQCameraViewfinder_vdata(tmp.h)[] = addr(vtbl[])
  tmp
...
proc create*(T: type gen_qcameraviewfinder_types.QCameraViewfinder,
  ...
  inst[].h = fcQCameraViewfinder_new(addr(cQCameraViewfinder_mvtbl), csize_t(sizeof(pointer)))
...
proc create*(T: type gen_qcameraviewfinder_types.QCameraViewfinder,
    ...
    inst: VirtualQCameraViewfinder) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQCameraViewfinder_new2(addr(cQCameraViewfinder_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQCameraViewfinder_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
