...
proc fcQCameraViewfinder_new(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQCameraViewfinder {.importc: "QCameraViewfinder_new".}
proc fcQCameraViewfinder_new2(vtbl: pointer, vdata: csize_t): ptr cQCameraViewfinder {.importc: "QCameraViewfinder_new2".}
