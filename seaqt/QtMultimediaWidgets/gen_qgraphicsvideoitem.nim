...
proc fcQGraphicsVideoItem_trUtf8S(s: cstring): struct_seaqt_string {.importc: "QGraphicsVideoItem_trUtf8_s".}
...
proc fcQGraphicsVideoItem_trUtf8SC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QGraphicsVideoItem_trUtf8_s_c".}
proc fcQGraphicsVideoItem_trUtf8SCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QGraphicsVideoItem_trUtf8_s_c_n".}
...
proc trUtf8*(_: type gen_qgraphicsvideoitem_types.QGraphicsVideoItem, s: cstring): string =
  let v_ms = fcQGraphicsVideoItem_trUtf8S(s)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc create*(T: type gen_qgraphicsvideoitem_types.QGraphicsVideoItem,
  ...
  let tmp = gen_qgraphicsvideoitem_types.QGraphicsVideoItem(h: fcQGraphicsVideoItem_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQGraphicsVideoItem_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qgraphicsvideoitem_types.QGraphicsVideoItem,
  ...
  if not isNil(vtbl[].extension):
    vtbl[].vtbl.extension = fcQGraphicsVideoItem_vtable_callback_extension
  let tmp = gen_qgraphicsvideoitem_types.QGraphicsVideoItem(h: fcQGraphicsVideoItem_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQGraphicsVideoItem_vdata(tmp.h)[] = addr(vtbl[])
  tmp
