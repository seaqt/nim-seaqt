...
proc fcQSvgWidget_new(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQSvgWidget {.importc: "QSvgWidget_new".}
proc fcQSvgWidget_new2(vtbl: pointer, vdata: csize_t): ptr cQSvgWidget {.importc: "QSvgWidget_new2".}
proc fcQSvgWidget_new3(vtbl: pointer, vdata: csize_t, file: struct_seaqt_string): ptr cQSvgWidget {.importc: "QSvgWidget_new3".}
