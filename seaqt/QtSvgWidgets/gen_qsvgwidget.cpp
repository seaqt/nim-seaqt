...
public:
	...
	friend bool QSvgWidget_virtualbase_nativeEvent(VirtualQSvgWidget* self, struct miqt_string eventType, void* message, intptr_t* result);
...
VirtualQSvgWidget* QSvgWidget_new(const QSvgWidget_VTable* vtbl, size_t vdata, QWidget* parent) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQSvgWidget>());
...
VirtualQSvgWidget* QSvgWidget_new3(const QSvgWidget_VTable* vtbl, size_t vdata, struct miqt_string file) {
	QString file_QString = QString::fromUtf8(file.data, file.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQSvgWidget>());
	return _mem_ ? new (_mem_)VirtualQSvgWidget(vtbl, file_QString) : nullptr;
}

VirtualQSvgWidget* QSvgWidget_new4(const QSvgWidget_VTable* vtbl, size_t vdata, struct miqt_string file, QWidget* parent) {
	QString file_QString = QString::fromUtf8(file.data, file.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQSvgWidget>());
