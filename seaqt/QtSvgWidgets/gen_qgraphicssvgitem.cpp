...
VirtualQGraphicsSvgItem* QGraphicsSvgItem_new(const QGraphicsSvgItem_VTable* vtbl, size_t vdata) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQGraphicsSvgItem>());
	return _mem_ ? new (_mem_)VirtualQGraphicsSvgItem(vtbl) : nullptr;
}

VirtualQGraphicsSvgItem* QGraphicsSvgItem_new2(const QGraphicsSvgItem_VTable* vtbl, size_t vdata, struct miqt_string fileName) {
...
VirtualQGraphicsSvgItem* QGraphicsSvgItem_new4(const QGraphicsSvgItem_VTable* vtbl, size_t vdata, struct miqt_string fileName, QGraphicsItem* parentItem) {
	QString fileName_QString = QString::fromUtf8(fileName.data, fileName.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQGraphicsSvgItem>());
