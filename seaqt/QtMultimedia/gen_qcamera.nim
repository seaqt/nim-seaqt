...
proc fcQCamera_new2(vtbl, vdata: pointer, cameraDevice: pointer): ptr cQCamera {.importc: "QCamera_new2".}
proc fcQCamera_new3(vtbl, vdata: pointer, position: cint): ptr cQCamera {.importc: "QCamera_new3".}
proc fcQCamera_new4(vtbl, vdata: pointer, parent: pointer): ptr cQCamera {.importc: "QCamera_new4".}
proc fcQCamera_new5(vtbl, vdata: pointer, cameraDevice: pointer, parent: pointer): ptr cQCamera {.importc: "QCamera_new5".}
proc fcQCamera_new6(vtbl, vdata: pointer, position: cint, parent: pointer): ptr cQCamera {.importc: "QCamera_new6".}
...
proc create*(T: type gen_qcamera_types.QCamera,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQCamera_vtable_callback_disconnectNotify
  gen_qcamera_types.QCamera(h: fcQCamera_new2(addr(vtbl[].vtbl), addr(vtbl[]), cameraDevice.h), owned: true)
...
proc create*(T: type gen_qcamera_types.QCamera,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQCamera_vtable_callback_disconnectNotify
  gen_qcamera_types.QCamera(h: fcQCamera_new3(addr(vtbl[].vtbl), addr(vtbl[]), cint(position)), owned: true)
...
proc create*(T: type gen_qcamera_types.QCamera,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQCamera_vtable_callback_disconnectNotify
  gen_qcamera_types.QCamera(h: fcQCamera_new4(addr(vtbl[].vtbl), addr(vtbl[]), parent.h), owned: true)
...
proc create*(T: type gen_qcamera_types.QCamera,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQCamera_vtable_callback_disconnectNotify
  gen_qcamera_types.QCamera(h: fcQCamera_new5(addr(vtbl[].vtbl), addr(vtbl[]), cameraDevice.h, parent.h), owned: true)
...
proc create*(T: type gen_qcamera_types.QCamera,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQCamera_vtable_callback_disconnectNotify
  gen_qcamera_types.QCamera(h: fcQCamera_new6(addr(vtbl[].vtbl), addr(vtbl[]), cint(position), parent.h), owned: true)
...
proc create*(T: type gen_qcamera_types.QCamera,
    ...
    inst: VirtualQCamera) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQCamera_new2(addr(cQCamera_mvtbl), addr(inst[]), cameraDevice.h)
  inst[].owned = true
...
proc create*(T: type gen_qcamera_types.QCamera,
    ...
    inst: VirtualQCamera) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQCamera_new3(addr(cQCamera_mvtbl), addr(inst[]), cint(position))
  inst[].owned = true
...
proc create*(T: type gen_qcamera_types.QCamera,
    ...
    inst: VirtualQCamera) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQCamera_new4(addr(cQCamera_mvtbl), addr(inst[]), parent.h)
  inst[].owned = true
...
proc create*(T: type gen_qcamera_types.QCamera,
    ...
    inst: VirtualQCamera) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQCamera_new5(addr(cQCamera_mvtbl), addr(inst[]), cameraDevice.h, parent.h)
  inst[].owned = true
...
proc create*(T: type gen_qcamera_types.QCamera,
    ...
    inst: VirtualQCamera) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQCamera_new6(addr(cQCamera_mvtbl), addr(inst[]), cint(position), parent.h)
  inst[].owned = true
