...
proc cQMediaPlayer_slot_callback_mediaChanged(slot: int, media: pointer) {.cdecl.} =
...
proc cQMediaPlayer_slot_callback_mediaChanged_release(slot: int) {.cdecl.} =
...
proc onmediaChanged*(self: gen_qmediaplayer_types.QMediaPlayer, slot: QMediaPlayermediaChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQMediaPlayer_connect_mediaChanged(self.h, cast[int](addr tmp[]), cQMediaPlayer_slot_callback_mediaChanged, cQMediaPlayer_slot_callback_mediaChanged_release)
...
proc cQMediaPlayer_slot_callback_currentMediaChanged(slot: int, media: pointer) {.cdecl.} =
  let nimfunc = cast[ptr QMediaPlayercurrentMediaChangedSlot](cast[pointer](slot))
  let slotval1 = gen_qmediacontent_types.QMediaContent(h: media, owned: false)

  nimfunc[](slotval1)

proc cQMediaPlayer_slot_callback_currentMediaChanged_release(slot: int) {.cdecl.} =
...
proc oncurrentMediaChanged*(self: gen_qmediaplayer_types.QMediaPlayer, slot: QMediaPlayercurrentMediaChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQMediaPlayer_connect_currentMediaChanged(self.h, cast[int](addr tmp[]), cQMediaPlayer_slot_callback_currentMediaChanged, cQMediaPlayer_slot_callback_currentMediaChanged_release)
...
proc cQMediaPlayer_slot_callback_stateChanged(slot: int, newState: cint) {.cdecl.} =
  let nimfunc = cast[ptr QMediaPlayerstateChangedSlot](cast[pointer](slot))
  let slotval1 = cint(newState)

  nimfunc[](slotval1)

proc cQMediaPlayer_slot_callback_stateChanged_release(slot: int) {.cdecl.} =
...
proc onstateChanged*(self: gen_qmediaplayer_types.QMediaPlayer, slot: QMediaPlayerstateChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQMediaPlayer_connect_stateChanged(self.h, cast[int](addr tmp[]), cQMediaPlayer_slot_callback_stateChanged, cQMediaPlayer_slot_callback_stateChanged_release)
...
proc cQMediaPlayer_slot_callback_volumeChanged(slot: int, volume: cint) {.cdecl.} =
  let nimfunc = cast[ptr QMediaPlayervolumeChangedSlot](cast[pointer](slot))
  let slotval1 = volume

  nimfunc[](slotval1)

proc cQMediaPlayer_slot_callback_volumeChanged_release(slot: int) {.cdecl.} =
...
proc onvolumeChanged*(self: gen_qmediaplayer_types.QMediaPlayer, slot: QMediaPlayervolumeChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQMediaPlayer_connect_volumeChanged(self.h, cast[int](addr tmp[]), cQMediaPlayer_slot_callback_volumeChanged, cQMediaPlayer_slot_callback_volumeChanged_release)
...
proc cQMediaPlayer_slot_callback_mutedChanged(slot: int, muted: bool) {.cdecl.} =
  let nimfunc = cast[ptr QMediaPlayermutedChangedSlot](cast[pointer](slot))
  let slotval1 = muted

  nimfunc[](slotval1)

proc cQMediaPlayer_slot_callback_mutedChanged_release(slot: int) {.cdecl.} =
...
proc onmutedChanged*(self: gen_qmediaplayer_types.QMediaPlayer, slot: QMediaPlayermutedChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQMediaPlayer_connect_mutedChanged(self.h, cast[int](addr tmp[]), cQMediaPlayer_slot_callback_mutedChanged, cQMediaPlayer_slot_callback_mutedChanged_release)
...
proc cQMediaPlayer_slot_callback_audioAvailableChanged(slot: int, available: bool) {.cdecl.} =
  let nimfunc = cast[ptr QMediaPlayeraudioAvailableChangedSlot](cast[pointer](slot))
  let slotval1 = available

  nimfunc[](slotval1)

proc cQMediaPlayer_slot_callback_audioAvailableChanged_release(slot: int) {.cdecl.} =
...
proc onaudioAvailableChanged*(self: gen_qmediaplayer_types.QMediaPlayer, slot: QMediaPlayeraudioAvailableChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQMediaPlayer_connect_audioAvailableChanged(self.h, cast[int](addr tmp[]), cQMediaPlayer_slot_callback_audioAvailableChanged, cQMediaPlayer_slot_callback_audioAvailableChanged_release)
...
proc cQMediaPlayer_slot_callback_videoAvailableChanged(slot: int, videoAvailable: bool) {.cdecl.} =
  let nimfunc = cast[ptr QMediaPlayervideoAvailableChangedSlot](cast[pointer](slot))
  let slotval1 = videoAvailable

  nimfunc[](slotval1)

proc cQMediaPlayer_slot_callback_videoAvailableChanged_release(slot: int) {.cdecl.} =
...
proc onvideoAvailableChanged*(self: gen_qmediaplayer_types.QMediaPlayer, slot: QMediaPlayervideoAvailableChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQMediaPlayer_connect_videoAvailableChanged(self.h, cast[int](addr tmp[]), cQMediaPlayer_slot_callback_videoAvailableChanged, cQMediaPlayer_slot_callback_videoAvailableChanged_release)
...
proc cQMediaPlayer_slot_callback_bufferStatusChanged(slot: int, percentFilled: cint) {.cdecl.} =
  let nimfunc = cast[ptr QMediaPlayerbufferStatusChangedSlot](cast[pointer](slot))
  let slotval1 = percentFilled

  nimfunc[](slotval1)

proc cQMediaPlayer_slot_callback_bufferStatusChanged_release(slot: int) {.cdecl.} =
...
proc onbufferStatusChanged*(self: gen_qmediaplayer_types.QMediaPlayer, slot: QMediaPlayerbufferStatusChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQMediaPlayer_connect_bufferStatusChanged(self.h, cast[int](addr tmp[]), cQMediaPlayer_slot_callback_bufferStatusChanged, cQMediaPlayer_slot_callback_bufferStatusChanged_release)
...
proc cQMediaPlayer_slot_callback_audioRoleChanged(slot: int, role: cint) {.cdecl.} =
  let nimfunc = cast[ptr QMediaPlayeraudioRoleChangedSlot](cast[pointer](slot))
  let slotval1 = cint(role)

  nimfunc[](slotval1)

proc cQMediaPlayer_slot_callback_audioRoleChanged_release(slot: int) {.cdecl.} =
...
proc cQMediaPlayer_slot_callback_customAudioRoleChanged_release(slot: int) {.cdecl.} =
...
proc oncustomAudioRoleChanged*(self: gen_qmediaplayer_types.QMediaPlayer, slot: QMediaPlayercustomAudioRoleChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQMediaPlayer_connect_customAudioRoleChanged(self.h, cast[int](addr tmp[]), cQMediaPlayer_slot_callback_customAudioRoleChanged, cQMediaPlayer_slot_callback_customAudioRoleChanged_release)
...
proc cQMediaPlayer_slot_callback_errorWithError(slot: int, error: cint) {.cdecl.} =
  let nimfunc = cast[ptr QMediaPlayererrorWithErrorSlot](cast[pointer](slot))
  let slotval1 = cint(error)

  nimfunc[](slotval1)

proc cQMediaPlayer_slot_callback_errorWithError_release(slot: int) {.cdecl.} =
...
proc onerror*(self: gen_qmediaplayer_types.QMediaPlayer, slot: QMediaPlayererrorWithErrorSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQMediaPlayer_connect_errorWithError(self.h, cast[int](addr tmp[]), cQMediaPlayer_slot_callback_errorWithError, cQMediaPlayer_slot_callback_errorWithError_release)
...
proc cQMediaPlayer_slot_callback_networkConfigurationChanged(slot: int, configuration: pointer) {.cdecl.} =
...
proc cQMediaPlayer_slot_callback_networkConfigurationChanged_release(slot: int) {.cdecl.} =
...
proc onnetworkConfigurationChanged*(self: gen_qmediaplayer_types.QMediaPlayer, slot: QMediaPlayernetworkConfigurationChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQMediaPlayer_connect_networkConfigurationChanged(self.h, cast[int](addr tmp[]), cQMediaPlayer_slot_callback_networkConfigurationChanged, cQMediaPlayer_slot_callback_networkConfigurationChanged_release)
...
proc cQMediaPlayer_vtable_callback_availability(self: pointer): cint {.cdecl.} =
  let vtbl = cast[ptr QMediaPlayerVTable](fcQMediaPlayer_vdata(self))
  let self = QMediaPlayer(h: self)
...
proc cQMediaPlayer_vtable_callback_bindX(self: pointer, param1: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QMediaPlayerVTable](fcQMediaPlayer_vdata(self))
  let self = QMediaPlayer(h: self)
...
proc cQMediaPlayer_vtable_callback_unbind(self: pointer, param1: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QMediaPlayerVTable](fcQMediaPlayer_vdata(self))
  let self = QMediaPlayer(h: self)
  let slotval1 = gen_qobject_types.QObject(h: param1, owned: false)
...
proc cQMediaPlayer_vtable_callback_isAvailable(self: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QMediaPlayerVTable](fcQMediaPlayer_vdata(self))
  let self = QMediaPlayer(h: self)
...
proc cQMediaPlayer_vtable_callback_service(self: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QMediaPlayerVTable](fcQMediaPlayer_vdata(self))
  let self = QMediaPlayer(h: self)
...
proc cQMediaPlayer_method_callback_availability(self: pointer): cint {.cdecl.} =
  let inst = cast[VirtualQMediaPlayer](fcQMediaPlayer_vdata(self))
...
proc cQMediaPlayer_method_callback_bindX(self: pointer, param1: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQMediaPlayer](fcQMediaPlayer_vdata(self))
  let slotval1 = gen_qobject_types.QObject(h: param1, owned: false)
...
proc cQMediaPlayer_method_callback_unbind(self: pointer, param1: pointer): void {.cdecl.} =
  let inst = cast[VirtualQMediaPlayer](fcQMediaPlayer_vdata(self))
  let slotval1 = gen_qobject_types.QObject(h: param1, owned: false)
...
proc cQMediaPlayer_method_callback_isAvailable(self: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQMediaPlayer](fcQMediaPlayer_vdata(self))
...
proc cQMediaPlayer_method_callback_service(self: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQMediaPlayer](fcQMediaPlayer_vdata(self))
...
proc create*(T: type gen_qmediaplayer_types.QMediaPlayer,
  ...
  if not isNil(vtbl[].availability):
    vtbl[].vtbl.availability = cQMediaPlayer_vtable_callback_availability
  if not isNil(vtbl[].bindX):
    vtbl[].vtbl.bindX = cQMediaPlayer_vtable_callback_bindX
  if not isNil(vtbl[].unbind):
    vtbl[].vtbl.unbind = cQMediaPlayer_vtable_callback_unbind
  if not isNil(vtbl[].isAvailable):
    vtbl[].vtbl.isAvailable = cQMediaPlayer_vtable_callback_isAvailable
  if not isNil(vtbl[].service):
    vtbl[].vtbl.service = cQMediaPlayer_vtable_callback_service
...
const cQMediaPlayer_mvtbl = cQMediaPlayerVTable(
  ...
  availability: cQMediaPlayer_method_callback_availability,
  bindX: cQMediaPlayer_method_callback_bindX,
  unbind: cQMediaPlayer_method_callback_unbind,
  isAvailable: cQMediaPlayer_method_callback_isAvailable,
  service: cQMediaPlayer_method_callback_service,
