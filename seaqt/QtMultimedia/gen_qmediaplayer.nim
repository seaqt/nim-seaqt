...
type QMediaPlayerPitchCompensationAvailabilityEnum* = distinct cint
template AlwaysOn*(_: type QMediaPlayerPitchCompensationAvailabilityEnum): untyped = 0
template Available*(_: type QMediaPlayerPitchCompensationAvailabilityEnum): untyped = 1
template Unavailable*(_: type QMediaPlayerPitchCompensationAvailabilityEnum): untyped = 2
...
proc fcQMediaPlayer_setAudioBufferOutput(self: pointer, output: pointer): void {.importc: "QMediaPlayer_setAudioBufferOutput".}
proc fcQMediaPlayer_audioBufferOutput(self: pointer): pointer {.importc: "QMediaPlayer_audioBufferOutput".}
...
proc fcQMediaPlayer_isPlaying(self: pointer): bool {.importc: "QMediaPlayer_isPlaying".}
...
proc fcQMediaPlayer_errorString(self: pointer): struct_seaqt_string {.importc: "QMediaPlayer_errorString".}
...
proc fcQMediaPlayer_pitchCompensationAvailability(self: pointer): cint {.importc: "QMediaPlayer_pitchCompensationAvailability".}
proc fcQMediaPlayer_pitchCompensation(self: pointer): bool {.importc: "QMediaPlayer_pitchCompensation".}
proc fcQMediaPlayer_playbackOptions(self: pointer): pointer {.importc: "QMediaPlayer_playbackOptions".}
...
proc fcQMediaPlayer_setPitchCompensation(self: pointer, pitchCompensation: bool): void {.importc: "QMediaPlayer_setPitchCompensation".}
proc fcQMediaPlayer_setPlaybackOptions(self: pointer, options: pointer): void {.importc: "QMediaPlayer_setPlaybackOptions".}
proc fcQMediaPlayer_resetPlaybackOptions(self: pointer): void {.importc: "QMediaPlayer_resetPlaybackOptions".}
...
proc fcQMediaPlayer_playingChanged(self: pointer, playing: bool): void {.importc: "QMediaPlayer_playingChanged".}
proc fcQMediaPlayer_connect_playingChanged(self: pointer, slot: int, callback: proc (slot: int, playing: bool) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QMediaPlayer_connect_playingChanged".}
...
proc fcQMediaPlayer_audioBufferOutputChanged(self: pointer): void {.importc: "QMediaPlayer_audioBufferOutputChanged".}
proc fcQMediaPlayer_connect_audioBufferOutputChanged(self: pointer, slot: int, callback: proc (slot: int) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QMediaPlayer_connect_audioBufferOutputChanged".}
...
proc fcQMediaPlayer_pitchCompensationChanged(self: pointer, param1: bool): void {.importc: "QMediaPlayer_pitchCompensationChanged".}
proc fcQMediaPlayer_connect_pitchCompensationChanged(self: pointer, slot: int, callback: proc (slot: int, param1: bool) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QMediaPlayer_connect_pitchCompensationChanged".}
proc fcQMediaPlayer_playbackOptionsChanged(self: pointer): void {.importc: "QMediaPlayer_playbackOptionsChanged".}
proc fcQMediaPlayer_connect_playbackOptionsChanged(self: pointer, slot: int, callback: proc (slot: int) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QMediaPlayer_connect_playbackOptionsChanged".}
...
proc setAudioBufferOutput*(self: gen_qmediaplayer_types.QMediaPlayer, output: gen_qaudiobufferoutput_types.QAudioBufferOutput): void =
  fcQMediaPlayer_setAudioBufferOutput(self.h, output.h)

proc audioBufferOutput*(self: gen_qmediaplayer_types.QMediaPlayer): gen_qaudiobufferoutput_types.QAudioBufferOutput =
  gen_qaudiobufferoutput_types.QAudioBufferOutput(h: fcQMediaPlayer_audioBufferOutput(self.h), owned: false)
...
proc isPlaying*(self: gen_qmediaplayer_types.QMediaPlayer): bool =
  fcQMediaPlayer_isPlaying(self.h)
...
proc pitchCompensationAvailability*(self: gen_qmediaplayer_types.QMediaPlayer): cint =
  cint(fcQMediaPlayer_pitchCompensationAvailability(self.h))

proc pitchCompensation*(self: gen_qmediaplayer_types.QMediaPlayer): bool =
  fcQMediaPlayer_pitchCompensation(self.h)

proc playbackOptions*(self: gen_qmediaplayer_types.QMediaPlayer): gen_qplaybackoptions_types.QPlaybackOptions =
  gen_qplaybackoptions_types.QPlaybackOptions(h: fcQMediaPlayer_playbackOptions(self.h), owned: true)
...
proc setPitchCompensation*(self: gen_qmediaplayer_types.QMediaPlayer, pitchCompensation: bool): void =
  fcQMediaPlayer_setPitchCompensation(self.h, pitchCompensation)

proc setPlaybackOptions*(self: gen_qmediaplayer_types.QMediaPlayer, options: gen_qplaybackoptions_types.QPlaybackOptions): void =
  fcQMediaPlayer_setPlaybackOptions(self.h, options.h)

proc resetPlaybackOptions*(self: gen_qmediaplayer_types.QMediaPlayer): void =
  fcQMediaPlayer_resetPlaybackOptions(self.h)
...
proc fcQMediaPlayer_slot_callback_sourceChanged(slot: int, media: pointer) {.cdecl.} =
  let nimfunc = cast[ptr QMediaPlayersourceChangedSlot](cast[pointer](slot))
  let slotval1 = gen_qurl_types.QUrl(h: media, owned: false)

  nimfunc[](slotval1)

proc fcQMediaPlayer_slot_callback_sourceChanged_release(slot: int) {.cdecl.} =
...
proc onSourceChanged*(self: gen_qmediaplayer_types.QMediaPlayer, slot: QMediaPlayersourceChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQMediaPlayer_connect_sourceChanged(self.h, cast[int](addr tmp[]), fcQMediaPlayer_slot_callback_sourceChanged, fcQMediaPlayer_slot_callback_sourceChanged_release)
...
proc fcQMediaPlayer_slot_callback_playbackStateChanged(slot: int, newState: cint) {.cdecl.} =
  let nimfunc = cast[ptr QMediaPlayerplaybackStateChangedSlot](cast[pointer](slot))
  let slotval1 = cint(newState)

  nimfunc[](slotval1)

proc fcQMediaPlayer_slot_callback_playbackStateChanged_release(slot: int) {.cdecl.} =
...
proc onPlaybackStateChanged*(self: gen_qmediaplayer_types.QMediaPlayer, slot: QMediaPlayerplaybackStateChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQMediaPlayer_connect_playbackStateChanged(self.h, cast[int](addr tmp[]), fcQMediaPlayer_slot_callback_playbackStateChanged, fcQMediaPlayer_slot_callback_playbackStateChanged_release)
...
proc fcQMediaPlayer_slot_callback_hasAudioChanged(slot: int, available: bool) {.cdecl.} =
  let nimfunc = cast[ptr QMediaPlayerhasAudioChangedSlot](cast[pointer](slot))
  let slotval1 = available

  nimfunc[](slotval1)

proc fcQMediaPlayer_slot_callback_hasAudioChanged_release(slot: int) {.cdecl.} =
...
proc onHasAudioChanged*(self: gen_qmediaplayer_types.QMediaPlayer, slot: QMediaPlayerhasAudioChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQMediaPlayer_connect_hasAudioChanged(self.h, cast[int](addr tmp[]), fcQMediaPlayer_slot_callback_hasAudioChanged, fcQMediaPlayer_slot_callback_hasAudioChanged_release)
...
proc fcQMediaPlayer_slot_callback_hasVideoChanged(slot: int, videoAvailable: bool) {.cdecl.} =
  let nimfunc = cast[ptr QMediaPlayerhasVideoChangedSlot](cast[pointer](slot))
  let slotval1 = videoAvailable

  nimfunc[](slotval1)

proc fcQMediaPlayer_slot_callback_hasVideoChanged_release(slot: int) {.cdecl.} =
...
proc onHasVideoChanged*(self: gen_qmediaplayer_types.QMediaPlayer, slot: QMediaPlayerhasVideoChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQMediaPlayer_connect_hasVideoChanged(self.h, cast[int](addr tmp[]), fcQMediaPlayer_slot_callback_hasVideoChanged, fcQMediaPlayer_slot_callback_hasVideoChanged_release)
...
proc fcQMediaPlayer_slot_callback_bufferProgressChanged(slot: int, progress: float32) {.cdecl.} =
  let nimfunc = cast[ptr QMediaPlayerbufferProgressChangedSlot](cast[pointer](slot))
  let slotval1 = progress

  nimfunc[](slotval1)

proc fcQMediaPlayer_slot_callback_bufferProgressChanged_release(slot: int) {.cdecl.} =
...
proc onBufferProgressChanged*(self: gen_qmediaplayer_types.QMediaPlayer, slot: QMediaPlayerbufferProgressChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQMediaPlayer_connect_bufferProgressChanged(self.h, cast[int](addr tmp[]), fcQMediaPlayer_slot_callback_bufferProgressChanged, fcQMediaPlayer_slot_callback_bufferProgressChanged_release)
...
proc playingChanged*(self: gen_qmediaplayer_types.QMediaPlayer, playing: bool): void =
  fcQMediaPlayer_playingChanged(self.h, playing)

type QMediaPlayerplayingChangedSlot* = proc(playing: bool)
proc fcQMediaPlayer_slot_callback_playingChanged(slot: int, playing: bool) {.cdecl.} =
  let nimfunc = cast[ptr QMediaPlayerplayingChangedSlot](cast[pointer](slot))
  let slotval1 = playing

  nimfunc[](slotval1)

proc fcQMediaPlayer_slot_callback_playingChanged_release(slot: int) {.cdecl.} =
  let nimfunc = cast[ref QMediaPlayerplayingChangedSlot](cast[pointer](slot))
  GC_unref(nimfunc)

proc onPlayingChanged*(self: gen_qmediaplayer_types.QMediaPlayer, slot: QMediaPlayerplayingChangedSlot) =
  var tmp = new QMediaPlayerplayingChangedSlot
  tmp[] = slot
  GC_ref(tmp)
  fcQMediaPlayer_connect_playingChanged(self.h, cast[int](addr tmp[]), fcQMediaPlayer_slot_callback_playingChanged, fcQMediaPlayer_slot_callback_playingChanged_release)
...
proc fcQMediaPlayer_slot_callback_loopsChanged(slot: int) {.cdecl.} =
  let nimfunc = cast[ptr QMediaPlayerloopsChangedSlot](cast[pointer](slot))
  nimfunc[]()

proc fcQMediaPlayer_slot_callback_loopsChanged_release(slot: int) {.cdecl.} =
...
proc onLoopsChanged*(self: gen_qmediaplayer_types.QMediaPlayer, slot: QMediaPlayerloopsChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQMediaPlayer_connect_loopsChanged(self.h, cast[int](addr tmp[]), fcQMediaPlayer_slot_callback_loopsChanged, fcQMediaPlayer_slot_callback_loopsChanged_release)
...
proc fcQMediaPlayer_slot_callback_metaDataChanged(slot: int) {.cdecl.} =
  let nimfunc = cast[ptr QMediaPlayermetaDataChangedSlot](cast[pointer](slot))
  nimfunc[]()

proc fcQMediaPlayer_slot_callback_metaDataChanged_release(slot: int) {.cdecl.} =
...
proc onMetaDataChanged*(self: gen_qmediaplayer_types.QMediaPlayer, slot: QMediaPlayermetaDataChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQMediaPlayer_connect_metaDataChanged(self.h, cast[int](addr tmp[]), fcQMediaPlayer_slot_callback_metaDataChanged, fcQMediaPlayer_slot_callback_metaDataChanged_release)
...
proc fcQMediaPlayer_slot_callback_videoOutputChanged(slot: int) {.cdecl.} =
  let nimfunc = cast[ptr QMediaPlayervideoOutputChangedSlot](cast[pointer](slot))
  nimfunc[]()

proc fcQMediaPlayer_slot_callback_videoOutputChanged_release(slot: int) {.cdecl.} =
...
proc onVideoOutputChanged*(self: gen_qmediaplayer_types.QMediaPlayer, slot: QMediaPlayervideoOutputChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQMediaPlayer_connect_videoOutputChanged(self.h, cast[int](addr tmp[]), fcQMediaPlayer_slot_callback_videoOutputChanged, fcQMediaPlayer_slot_callback_videoOutputChanged_release)
...
proc fcQMediaPlayer_slot_callback_audioOutputChanged(slot: int) {.cdecl.} =
  let nimfunc = cast[ptr QMediaPlayeraudioOutputChangedSlot](cast[pointer](slot))
  nimfunc[]()

proc fcQMediaPlayer_slot_callback_audioOutputChanged_release(slot: int) {.cdecl.} =
...
proc onAudioOutputChanged*(self: gen_qmediaplayer_types.QMediaPlayer, slot: QMediaPlayeraudioOutputChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQMediaPlayer_connect_audioOutputChanged(self.h, cast[int](addr tmp[]), fcQMediaPlayer_slot_callback_audioOutputChanged, fcQMediaPlayer_slot_callback_audioOutputChanged_release)

proc audioBufferOutputChanged*(self: gen_qmediaplayer_types.QMediaPlayer): void =
  fcQMediaPlayer_audioBufferOutputChanged(self.h)

type QMediaPlayeraudioBufferOutputChangedSlot* = proc()
proc fcQMediaPlayer_slot_callback_audioBufferOutputChanged(slot: int) {.cdecl.} =
  let nimfunc = cast[ptr QMediaPlayeraudioBufferOutputChangedSlot](cast[pointer](slot))
  nimfunc[]()

proc fcQMediaPlayer_slot_callback_audioBufferOutputChanged_release(slot: int) {.cdecl.} =
  let nimfunc = cast[ref QMediaPlayeraudioBufferOutputChangedSlot](cast[pointer](slot))
  GC_unref(nimfunc)

proc onAudioBufferOutputChanged*(self: gen_qmediaplayer_types.QMediaPlayer, slot: QMediaPlayeraudioBufferOutputChangedSlot) =
  var tmp = new QMediaPlayeraudioBufferOutputChangedSlot
  tmp[] = slot
  GC_ref(tmp)
  fcQMediaPlayer_connect_audioBufferOutputChanged(self.h, cast[int](addr tmp[]), fcQMediaPlayer_slot_callback_audioBufferOutputChanged, fcQMediaPlayer_slot_callback_audioBufferOutputChanged_release)
...
proc fcQMediaPlayer_slot_callback_tracksChanged(slot: int) {.cdecl.} =
  let nimfunc = cast[ptr QMediaPlayertracksChangedSlot](cast[pointer](slot))
  nimfunc[]()

proc fcQMediaPlayer_slot_callback_tracksChanged_release(slot: int) {.cdecl.} =
...
proc onTracksChanged*(self: gen_qmediaplayer_types.QMediaPlayer, slot: QMediaPlayertracksChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQMediaPlayer_connect_tracksChanged(self.h, cast[int](addr tmp[]), fcQMediaPlayer_slot_callback_tracksChanged, fcQMediaPlayer_slot_callback_tracksChanged_release)
...
proc fcQMediaPlayer_slot_callback_activeTracksChanged(slot: int) {.cdecl.} =
  let nimfunc = cast[ptr QMediaPlayeractiveTracksChangedSlot](cast[pointer](slot))
  nimfunc[]()

proc fcQMediaPlayer_slot_callback_activeTracksChanged_release(slot: int) {.cdecl.} =
...
proc onActiveTracksChanged*(self: gen_qmediaplayer_types.QMediaPlayer, slot: QMediaPlayeractiveTracksChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQMediaPlayer_connect_activeTracksChanged(self.h, cast[int](addr tmp[]), fcQMediaPlayer_slot_callback_activeTracksChanged, fcQMediaPlayer_slot_callback_activeTracksChanged_release)
...
proc fcQMediaPlayer_slot_callback_errorChanged(slot: int) {.cdecl.} =
  let nimfunc = cast[ptr QMediaPlayererrorChangedSlot](cast[pointer](slot))
  nimfunc[]()

proc fcQMediaPlayer_slot_callback_errorChanged_release(slot: int) {.cdecl.} =
...
proc errorOccurred*(self: gen_qmediaplayer_types.QMediaPlayer, error: cint, errorString: openArray[char]): void =
  fcQMediaPlayer_errorOccurred(self.h, cint(error), struct_seaqt_string(data: if len(errorString) > 0: addr errorString[0] else: nil, len: csize_t(len(errorString))))

type QMediaPlayererrorOccurredSlot* = proc(error: cint, errorString: openArray[char])
proc fcQMediaPlayer_slot_callback_errorOccurred(slot: int, error: cint, errorString: struct_seaqt_string) {.cdecl.} =
...
proc fcQMediaPlayer_slot_callback_errorOccurred_release(slot: int) {.cdecl.} =
...
proc pitchCompensationChanged*(self: gen_qmediaplayer_types.QMediaPlayer, param1: bool): void =
  fcQMediaPlayer_pitchCompensationChanged(self.h, param1)

type QMediaPlayerpitchCompensationChangedSlot* = proc(param1: bool)
proc fcQMediaPlayer_slot_callback_pitchCompensationChanged(slot: int, param1: bool) {.cdecl.} =
  let nimfunc = cast[ptr QMediaPlayerpitchCompensationChangedSlot](cast[pointer](slot))
  let slotval1 = param1

  nimfunc[](slotval1)

proc fcQMediaPlayer_slot_callback_pitchCompensationChanged_release(slot: int) {.cdecl.} =
  let nimfunc = cast[ref QMediaPlayerpitchCompensationChangedSlot](cast[pointer](slot))
  GC_unref(nimfunc)

proc onPitchCompensationChanged*(self: gen_qmediaplayer_types.QMediaPlayer, slot: QMediaPlayerpitchCompensationChangedSlot) =
  var tmp = new QMediaPlayerpitchCompensationChangedSlot
  tmp[] = slot
  GC_ref(tmp)
  fcQMediaPlayer_connect_pitchCompensationChanged(self.h, cast[int](addr tmp[]), fcQMediaPlayer_slot_callback_pitchCompensationChanged, fcQMediaPlayer_slot_callback_pitchCompensationChanged_release)

proc playbackOptionsChanged*(self: gen_qmediaplayer_types.QMediaPlayer): void =
  fcQMediaPlayer_playbackOptionsChanged(self.h)

type QMediaPlayerplaybackOptionsChangedSlot* = proc()
proc fcQMediaPlayer_slot_callback_playbackOptionsChanged(slot: int) {.cdecl.} =
  let nimfunc = cast[ptr QMediaPlayerplaybackOptionsChangedSlot](cast[pointer](slot))
  nimfunc[]()

proc fcQMediaPlayer_slot_callback_playbackOptionsChanged_release(slot: int) {.cdecl.} =
  let nimfunc = cast[ref QMediaPlayerplaybackOptionsChangedSlot](cast[pointer](slot))
  GC_unref(nimfunc)

proc onPlaybackOptionsChanged*(self: gen_qmediaplayer_types.QMediaPlayer, slot: QMediaPlayerplaybackOptionsChangedSlot) =
  var tmp = new QMediaPlayerplaybackOptionsChangedSlot
  tmp[] = slot
  GC_ref(tmp)
  fcQMediaPlayer_connect_playbackOptionsChanged(self.h, cast[int](addr tmp[]), fcQMediaPlayer_slot_callback_playbackOptionsChanged, fcQMediaPlayer_slot_callback_playbackOptionsChanged_release)
...
proc create*(T: type gen_qmediaplayer_types.QMediaPlayer,
  ...
  let tmp = gen_qmediaplayer_types.QMediaPlayer(h: fcQMediaPlayer_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQMediaPlayer_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qmediaplayer_types.QMediaPlayer,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQMediaPlayer_vtable_callback_disconnectNotify
  let tmp = gen_qmediaplayer_types.QMediaPlayer(h: fcQMediaPlayer_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQMediaPlayer_vdata(tmp.h)[] = addr(vtbl[])
  tmp
