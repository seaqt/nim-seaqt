...
proc fcQMediaCaptureSession_audioBufferInput(self: pointer): pointer {.importc: "QMediaCaptureSession_audioBufferInput".}
proc fcQMediaCaptureSession_setAudioBufferInput(self: pointer, input: pointer): void {.importc: "QMediaCaptureSession_setAudioBufferInput".}
...
proc fcQMediaCaptureSession_screenCapture(self: pointer): pointer {.importc: "QMediaCaptureSession_screenCapture".}
proc fcQMediaCaptureSession_setScreenCapture(self: pointer, screenCapture: pointer): void {.importc: "QMediaCaptureSession_setScreenCapture".}
proc fcQMediaCaptureSession_windowCapture(self: pointer): pointer {.importc: "QMediaCaptureSession_windowCapture".}
proc fcQMediaCaptureSession_setWindowCapture(self: pointer, windowCapture: pointer): void {.importc: "QMediaCaptureSession_setWindowCapture".}
proc fcQMediaCaptureSession_videoFrameInput(self: pointer): pointer {.importc: "QMediaCaptureSession_videoFrameInput".}
proc fcQMediaCaptureSession_setVideoFrameInput(self: pointer, input: pointer): void {.importc: "QMediaCaptureSession_setVideoFrameInput".}
...
proc fcQMediaCaptureSession_audioBufferInputChanged(self: pointer): void {.importc: "QMediaCaptureSession_audioBufferInputChanged".}
proc fcQMediaCaptureSession_connect_audioBufferInputChanged(self: pointer, slot: int, callback: proc (slot: int) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QMediaCaptureSession_connect_audioBufferInputChanged".}
...
proc fcQMediaCaptureSession_screenCaptureChanged(self: pointer): void {.importc: "QMediaCaptureSession_screenCaptureChanged".}
proc fcQMediaCaptureSession_connect_screenCaptureChanged(self: pointer, slot: int, callback: proc (slot: int) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QMediaCaptureSession_connect_screenCaptureChanged".}
proc fcQMediaCaptureSession_windowCaptureChanged(self: pointer): void {.importc: "QMediaCaptureSession_windowCaptureChanged".}
proc fcQMediaCaptureSession_connect_windowCaptureChanged(self: pointer, slot: int, callback: proc (slot: int) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QMediaCaptureSession_connect_windowCaptureChanged".}
proc fcQMediaCaptureSession_videoFrameInputChanged(self: pointer): void {.importc: "QMediaCaptureSession_videoFrameInputChanged".}
proc fcQMediaCaptureSession_connect_videoFrameInputChanged(self: pointer, slot: int, callback: proc (slot: int) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QMediaCaptureSession_connect_videoFrameInputChanged".}
...
proc audioBufferInput*(self: gen_qmediacapturesession_types.QMediaCaptureSession): gen_qaudiobufferinput_types.QAudioBufferInput =
  gen_qaudiobufferinput_types.QAudioBufferInput(h: fcQMediaCaptureSession_audioBufferInput(self.h), owned: false)

proc setAudioBufferInput*(self: gen_qmediacapturesession_types.QMediaCaptureSession, input: gen_qaudiobufferinput_types.QAudioBufferInput): void =
  fcQMediaCaptureSession_setAudioBufferInput(self.h, input.h)
...
proc screenCapture*(self: gen_qmediacapturesession_types.QMediaCaptureSession): gen_qscreencapture_types.QScreenCapture =
  gen_qscreencapture_types.QScreenCapture(h: fcQMediaCaptureSession_screenCapture(self.h), owned: false)

proc setScreenCapture*(self: gen_qmediacapturesession_types.QMediaCaptureSession, screenCapture: gen_qscreencapture_types.QScreenCapture): void =
  fcQMediaCaptureSession_setScreenCapture(self.h, screenCapture.h)

proc windowCapture*(self: gen_qmediacapturesession_types.QMediaCaptureSession): gen_qwindowcapture_types.QWindowCapture =
  gen_qwindowcapture_types.QWindowCapture(h: fcQMediaCaptureSession_windowCapture(self.h), owned: false)

proc setWindowCapture*(self: gen_qmediacapturesession_types.QMediaCaptureSession, windowCapture: gen_qwindowcapture_types.QWindowCapture): void =
  fcQMediaCaptureSession_setWindowCapture(self.h, windowCapture.h)

proc videoFrameInput*(self: gen_qmediacapturesession_types.QMediaCaptureSession): gen_qvideoframeinput_types.QVideoFrameInput =
  gen_qvideoframeinput_types.QVideoFrameInput(h: fcQMediaCaptureSession_videoFrameInput(self.h), owned: false)

proc setVideoFrameInput*(self: gen_qmediacapturesession_types.QMediaCaptureSession, input: gen_qvideoframeinput_types.QVideoFrameInput): void =
  fcQMediaCaptureSession_setVideoFrameInput(self.h, input.h)
...
proc audioBufferInputChanged*(self: gen_qmediacapturesession_types.QMediaCaptureSession): void =
  fcQMediaCaptureSession_audioBufferInputChanged(self.h)

type QMediaCaptureSessionaudioBufferInputChangedSlot* = proc()
proc fcQMediaCaptureSession_slot_callback_audioBufferInputChanged(slot: int) {.cdecl.} =
  let nimfunc = cast[ptr QMediaCaptureSessionaudioBufferInputChangedSlot](cast[pointer](slot))
  nimfunc[]()

proc fcQMediaCaptureSession_slot_callback_audioBufferInputChanged_release(slot: int) {.cdecl.} =
  let nimfunc = cast[ref QMediaCaptureSessionaudioBufferInputChangedSlot](cast[pointer](slot))
  GC_unref(nimfunc)

proc onAudioBufferInputChanged*(self: gen_qmediacapturesession_types.QMediaCaptureSession, slot: QMediaCaptureSessionaudioBufferInputChangedSlot) =
  var tmp = new QMediaCaptureSessionaudioBufferInputChangedSlot
  tmp[] = slot
  GC_ref(tmp)
  fcQMediaCaptureSession_connect_audioBufferInputChanged(self.h, cast[int](addr tmp[]), fcQMediaCaptureSession_slot_callback_audioBufferInputChanged, fcQMediaCaptureSession_slot_callback_audioBufferInputChanged_release)
...
proc screenCaptureChanged*(self: gen_qmediacapturesession_types.QMediaCaptureSession): void =
  fcQMediaCaptureSession_screenCaptureChanged(self.h)

type QMediaCaptureSessionscreenCaptureChangedSlot* = proc()
proc fcQMediaCaptureSession_slot_callback_screenCaptureChanged(slot: int) {.cdecl.} =
  let nimfunc = cast[ptr QMediaCaptureSessionscreenCaptureChangedSlot](cast[pointer](slot))
  nimfunc[]()

proc fcQMediaCaptureSession_slot_callback_screenCaptureChanged_release(slot: int) {.cdecl.} =
  let nimfunc = cast[ref QMediaCaptureSessionscreenCaptureChangedSlot](cast[pointer](slot))
  GC_unref(nimfunc)

proc onScreenCaptureChanged*(self: gen_qmediacapturesession_types.QMediaCaptureSession, slot: QMediaCaptureSessionscreenCaptureChangedSlot) =
  var tmp = new QMediaCaptureSessionscreenCaptureChangedSlot
  tmp[] = slot
  GC_ref(tmp)
  fcQMediaCaptureSession_connect_screenCaptureChanged(self.h, cast[int](addr tmp[]), fcQMediaCaptureSession_slot_callback_screenCaptureChanged, fcQMediaCaptureSession_slot_callback_screenCaptureChanged_release)

proc windowCaptureChanged*(self: gen_qmediacapturesession_types.QMediaCaptureSession): void =
  fcQMediaCaptureSession_windowCaptureChanged(self.h)

type QMediaCaptureSessionwindowCaptureChangedSlot* = proc()
proc fcQMediaCaptureSession_slot_callback_windowCaptureChanged(slot: int) {.cdecl.} =
  let nimfunc = cast[ptr QMediaCaptureSessionwindowCaptureChangedSlot](cast[pointer](slot))
  nimfunc[]()

proc fcQMediaCaptureSession_slot_callback_windowCaptureChanged_release(slot: int) {.cdecl.} =
  let nimfunc = cast[ref QMediaCaptureSessionwindowCaptureChangedSlot](cast[pointer](slot))
  GC_unref(nimfunc)

proc onWindowCaptureChanged*(self: gen_qmediacapturesession_types.QMediaCaptureSession, slot: QMediaCaptureSessionwindowCaptureChangedSlot) =
  var tmp = new QMediaCaptureSessionwindowCaptureChangedSlot
  tmp[] = slot
  GC_ref(tmp)
  fcQMediaCaptureSession_connect_windowCaptureChanged(self.h, cast[int](addr tmp[]), fcQMediaCaptureSession_slot_callback_windowCaptureChanged, fcQMediaCaptureSession_slot_callback_windowCaptureChanged_release)

proc videoFrameInputChanged*(self: gen_qmediacapturesession_types.QMediaCaptureSession): void =
  fcQMediaCaptureSession_videoFrameInputChanged(self.h)

type QMediaCaptureSessionvideoFrameInputChangedSlot* = proc()
proc fcQMediaCaptureSession_slot_callback_videoFrameInputChanged(slot: int) {.cdecl.} =
  let nimfunc = cast[ptr QMediaCaptureSessionvideoFrameInputChangedSlot](cast[pointer](slot))
  nimfunc[]()

proc fcQMediaCaptureSession_slot_callback_videoFrameInputChanged_release(slot: int) {.cdecl.} =
  let nimfunc = cast[ref QMediaCaptureSessionvideoFrameInputChangedSlot](cast[pointer](slot))
  GC_unref(nimfunc)

proc onVideoFrameInputChanged*(self: gen_qmediacapturesession_types.QMediaCaptureSession, slot: QMediaCaptureSessionvideoFrameInputChangedSlot) =
  var tmp = new QMediaCaptureSessionvideoFrameInputChangedSlot
  tmp[] = slot
  GC_ref(tmp)
  fcQMediaCaptureSession_connect_videoFrameInputChanged(self.h, cast[int](addr tmp[]), fcQMediaCaptureSession_slot_callback_videoFrameInputChanged, fcQMediaCaptureSession_slot_callback_videoFrameInputChanged_release)
...
proc create*(T: type gen_qmediacapturesession_types.QMediaCaptureSession,
  ...
  let tmp = gen_qmediacapturesession_types.QMediaCaptureSession(h: fcQMediaCaptureSession_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQMediaCaptureSession_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qmediacapturesession_types.QMediaCaptureSession,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQMediaCaptureSession_vtable_callback_disconnectNotify
  let tmp = gen_qmediacapturesession_types.QMediaCaptureSession(h: fcQMediaCaptureSession_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQMediaCaptureSession_vdata(tmp.h)[] = addr(vtbl[])
  tmp
