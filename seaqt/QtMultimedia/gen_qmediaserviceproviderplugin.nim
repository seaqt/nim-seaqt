...
proc fcQMediaServiceProviderHint_operatorAssign(self: pointer, fromVal: pointer): void {.importc: "QMediaServiceProviderHint_operatorAssign".}
...
proc fcQMediaServiceProviderHint_mimeType(self: pointer): struct_seaqt_string {.importc: "QMediaServiceProviderHint_mimeType".}
proc fcQMediaServiceProviderHint_codecs(self: pointer): struct_seaqt_array {.importc: "QMediaServiceProviderHint_codecs".}
proc fcQMediaServiceProviderHint_device(self: pointer): struct_seaqt_string {.importc: "QMediaServiceProviderHint_device".}
...
proc fcQMediaServiceProviderHint_new2(mimeType: struct_seaqt_string, codecs: struct_seaqt_array): ptr cQMediaServiceProviderHint {.importc: "QMediaServiceProviderHint_new_mimeType_codecs".}
proc fcQMediaServiceProviderHint_new3(device: struct_seaqt_string): ptr cQMediaServiceProviderHint {.importc: "QMediaServiceProviderHint_new_device".}
proc fcQMediaServiceProviderHint_new4(position: cint): ptr cQMediaServiceProviderHint {.importc: "QMediaServiceProviderHint_new_position".}
proc fcQMediaServiceProviderHint_new5(features: cint): ptr cQMediaServiceProviderHint {.importc: "QMediaServiceProviderHint_new_features".}
proc fcQMediaServiceProviderHint_new6(fromVal: pointer): ptr cQMediaServiceProviderHint {.importc: "QMediaServiceProviderHint_new_from".}
proc fcQMediaServiceProviderFactoryInterface_createX(self: pointer, key: struct_seaqt_string): pointer {.importc: "QMediaServiceProviderFactoryInterface_create".}
...
proc fcQMediaServiceProviderFactoryInterface_operatorAssign(self: pointer, fromVal: pointer): void {.importc: "QMediaServiceProviderFactoryInterface_operatorAssign".}
proc fcQMediaServiceSupportedFormatsInterface_hasSupport(self: pointer, mimeType: struct_seaqt_string, codecs: struct_seaqt_array): cint {.importc: "QMediaServiceSupportedFormatsInterface_hasSupport".}
proc fcQMediaServiceSupportedFormatsInterface_supportedMimeTypes(self: pointer): struct_seaqt_array {.importc: "QMediaServiceSupportedFormatsInterface_supportedMimeTypes".}
proc fcQMediaServiceSupportedFormatsInterface_operatorAssign(self: pointer, fromVal: pointer): void {.importc: "QMediaServiceSupportedFormatsInterface_operatorAssign".}
proc fcQMediaServiceSupportedDevicesInterface_devices(self: pointer, service: struct_seaqt_string): struct_seaqt_array {.importc: "QMediaServiceSupportedDevicesInterface_devices".}
proc fcQMediaServiceSupportedDevicesInterface_deviceDescription(self: pointer, service: struct_seaqt_string, device: struct_seaqt_string): struct_seaqt_string {.importc: "QMediaServiceSupportedDevicesInterface_deviceDescription".}
proc fcQMediaServiceSupportedDevicesInterface_operatorAssign(self: pointer, fromVal: pointer): void {.importc: "QMediaServiceSupportedDevicesInterface_operatorAssign".}
proc fcQMediaServiceDefaultDeviceInterface_defaultDevice(self: pointer, service: struct_seaqt_string): struct_seaqt_string {.importc: "QMediaServiceDefaultDeviceInterface_defaultDevice".}
proc fcQMediaServiceDefaultDeviceInterface_operatorAssign(self: pointer, fromVal: pointer): void {.importc: "QMediaServiceDefaultDeviceInterface_operatorAssign".}
proc fcQMediaServiceCameraInfoInterface_cameraPosition(self: pointer, device: struct_seaqt_string): cint {.importc: "QMediaServiceCameraInfoInterface_cameraPosition".}
proc fcQMediaServiceCameraInfoInterface_cameraOrientation(self: pointer, device: struct_seaqt_string): cint {.importc: "QMediaServiceCameraInfoInterface_cameraOrientation".}
proc fcQMediaServiceCameraInfoInterface_operatorAssign(self: pointer, fromVal: pointer): void {.importc: "QMediaServiceCameraInfoInterface_operatorAssign".}
proc fcQMediaServiceFeaturesInterface_supportedFeatures(self: pointer, service: struct_seaqt_string): cint {.importc: "QMediaServiceFeaturesInterface_supportedFeatures".}
proc fcQMediaServiceFeaturesInterface_operatorAssign(self: pointer, fromVal: pointer): void {.importc: "QMediaServiceFeaturesInterface_operatorAssign".}
...
proc fcQMediaServiceProviderPlugin_trS(s: cstring): struct_seaqt_string {.importc: "QMediaServiceProviderPlugin_tr_s".}
proc fcQMediaServiceProviderPlugin_trUtf8S(s: cstring): struct_seaqt_string {.importc: "QMediaServiceProviderPlugin_trUtf8_s".}
proc fcQMediaServiceProviderPlugin_createX(self: pointer, key: struct_seaqt_string): pointer {.importc: "QMediaServiceProviderPlugin_create".}
proc fcQMediaServiceProviderPlugin_release(self: pointer, service: pointer): void {.importc: "QMediaServiceProviderPlugin_release".}
proc fcQMediaServiceProviderPlugin_trSC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QMediaServiceProviderPlugin_tr_s_c".}
proc fcQMediaServiceProviderPlugin_trSCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QMediaServiceProviderPlugin_tr_s_c_n".}
proc fcQMediaServiceProviderPlugin_trUtf8SC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QMediaServiceProviderPlugin_trUtf8_s_c".}
proc fcQMediaServiceProviderPlugin_trUtf8SCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QMediaServiceProviderPlugin_trUtf8_s_c_n".}
...
proc operatorAssign*(self: gen_qmediaserviceproviderplugin_types.QMediaServiceProviderHint, fromVal: gen_qmediaserviceproviderplugin_types.QMediaServiceProviderHint): void =
  fcQMediaServiceProviderHint_operatorAssign(self.h, fromVal.h)
...
proc create*(T: type gen_qmediaserviceproviderplugin_types.QMediaServiceProviderHint): gen_qmediaserviceproviderplugin_types.QMediaServiceProviderHint =
  let tmp = gen_qmediaserviceproviderplugin_types.QMediaServiceProviderHint(h: fcQMediaServiceProviderHint_new(), owned: true)
  tmp
proc create*(T: type gen_qmediaserviceproviderplugin_types.QMediaServiceProviderHint,
  ...
  let tmp = gen_qmediaserviceproviderplugin_types.QMediaServiceProviderHint(h: fcQMediaServiceProviderHint_new2(struct_seaqt_string(data: if len(mimeType) > 0: addr mimeType[0] else: nil, len: csize_t(len(mimeType))), struct_seaqt_array(len: csize_t(len(codecs)), data: if len(codecs) == 0: nil else: addr(codecs_CArray[0]))), owned: true)
  tmp
proc create*(T: type gen_qmediaserviceproviderplugin_types.QMediaServiceProviderHint,
    device: openArray[byte]): gen_qmediaserviceproviderplugin_types.QMediaServiceProviderHint =
  let tmp = gen_qmediaserviceproviderplugin_types.QMediaServiceProviderHint(h: fcQMediaServiceProviderHint_new3(struct_seaqt_string(data: if len(device) > 0: addr device[0] else: nil, len: csize_t(len(device)))), owned: true)
  tmp
proc create*(T: type gen_qmediaserviceproviderplugin_types.QMediaServiceProviderHint,
    position: cint): gen_qmediaserviceproviderplugin_types.QMediaServiceProviderHint =
  let tmp = gen_qmediaserviceproviderplugin_types.QMediaServiceProviderHint(h: fcQMediaServiceProviderHint_new4(cint(position)), owned: true)
  tmp
proc create2*(T: type gen_qmediaserviceproviderplugin_types.QMediaServiceProviderHint,
  ...
  let tmp = gen_qmediaserviceproviderplugin_types.QMediaServiceProviderHint(h: fcQMediaServiceProviderHint_new5(cint(features)), owned: true)
  tmp
proc create*(T: type gen_qmediaserviceproviderplugin_types.QMediaServiceProviderHint,
    fromVal: gen_qmediaserviceproviderplugin_types.QMediaServiceProviderHint): gen_qmediaserviceproviderplugin_types.QMediaServiceProviderHint =
  let tmp = gen_qmediaserviceproviderplugin_types.QMediaServiceProviderHint(h: fcQMediaServiceProviderHint_new6(fromVal.h), owned: true)
  tmp
proc createX*(self: gen_qmediaserviceproviderplugin_types.QMediaServiceProviderFactoryInterface, key: openArray[char]): gen_qmediaservice_types.QMediaService =
  gen_qmediaservice_types.QMediaService(h: fcQMediaServiceProviderFactoryInterface_createX(self.h, struct_seaqt_string(data: if len(key) > 0: addr key[0] else: nil, len: csize_t(len(key)))), owned: false)
...
proc operatorAssign*(self: gen_qmediaserviceproviderplugin_types.QMediaServiceProviderFactoryInterface, fromVal: gen_qmediaserviceproviderplugin_types.QMediaServiceProviderFactoryInterface): void =
  fcQMediaServiceProviderFactoryInterface_operatorAssign(self.h, fromVal.h)
...
proc hasSupport*(self: gen_qmediaserviceproviderplugin_types.QMediaServiceSupportedFormatsInterface, mimeType: openArray[char], codecs: openArray[string]): cint =
  ...
  cint(fcQMediaServiceSupportedFormatsInterface_hasSupport(self.h, struct_seaqt_string(data: if len(mimeType) > 0: addr mimeType[0] else: nil, len: csize_t(len(mimeType))), struct_seaqt_array(len: csize_t(len(codecs)), data: if len(codecs) == 0: nil else: addr(codecs_CArray[0]))))
...
proc operatorAssign*(self: gen_qmediaserviceproviderplugin_types.QMediaServiceSupportedFormatsInterface, fromVal: gen_qmediaserviceproviderplugin_types.QMediaServiceSupportedFormatsInterface): void =
  fcQMediaServiceSupportedFormatsInterface_operatorAssign(self.h, fromVal.h)
...
proc devices*(self: gen_qmediaserviceproviderplugin_types.QMediaServiceSupportedDevicesInterface, service: openArray[byte]): seq[seq[byte]] =
  var v_ma = fcQMediaServiceSupportedDevicesInterface_devices(self.h, struct_seaqt_string(data: if len(service) > 0: addr service[0] else: nil, len: csize_t(len(service))))
...
proc deviceDescription*(self: gen_qmediaserviceproviderplugin_types.QMediaServiceSupportedDevicesInterface, service: openArray[byte], device: openArray[byte]): string =
  let v_ms = fcQMediaServiceSupportedDevicesInterface_deviceDescription(self.h, struct_seaqt_string(data: if len(service) > 0: addr service[0] else: nil, len: csize_t(len(service))), struct_seaqt_string(data: if len(device) > 0: addr device[0] else: nil, len: csize_t(len(device))))
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret

proc operatorAssign*(self: gen_qmediaserviceproviderplugin_types.QMediaServiceSupportedDevicesInterface, fromVal: gen_qmediaserviceproviderplugin_types.QMediaServiceSupportedDevicesInterface): void =
  fcQMediaServiceSupportedDevicesInterface_operatorAssign(self.h, fromVal.h)
...
proc defaultDevice*(self: gen_qmediaserviceproviderplugin_types.QMediaServiceDefaultDeviceInterface, service: openArray[byte]): seq[byte] =
  var v_bytearray = fcQMediaServiceDefaultDeviceInterface_defaultDevice(self.h, struct_seaqt_string(data: if len(service) > 0: addr service[0] else: nil, len: csize_t(len(service))))
  var vx_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](v_bytearray.data), 0, int(v_bytearray.len)-1))
  c_free(v_bytearray.data)
  vx_ret

proc operatorAssign*(self: gen_qmediaserviceproviderplugin_types.QMediaServiceDefaultDeviceInterface, fromVal: gen_qmediaserviceproviderplugin_types.QMediaServiceDefaultDeviceInterface): void =
  fcQMediaServiceDefaultDeviceInterface_operatorAssign(self.h, fromVal.h)
...
proc cameraPosition*(self: gen_qmediaserviceproviderplugin_types.QMediaServiceCameraInfoInterface, device: openArray[byte]): cint =
  cint(fcQMediaServiceCameraInfoInterface_cameraPosition(self.h, struct_seaqt_string(data: if len(device) > 0: addr device[0] else: nil, len: csize_t(len(device)))))
...
proc cameraOrientation*(self: gen_qmediaserviceproviderplugin_types.QMediaServiceCameraInfoInterface, device: openArray[byte]): cint =
  fcQMediaServiceCameraInfoInterface_cameraOrientation(self.h, struct_seaqt_string(data: if len(device) > 0: addr device[0] else: nil, len: csize_t(len(device))))

proc operatorAssign*(self: gen_qmediaserviceproviderplugin_types.QMediaServiceCameraInfoInterface, fromVal: gen_qmediaserviceproviderplugin_types.QMediaServiceCameraInfoInterface): void =
  fcQMediaServiceCameraInfoInterface_operatorAssign(self.h, fromVal.h)
...
proc supportedFeatures*(self: gen_qmediaserviceproviderplugin_types.QMediaServiceFeaturesInterface, service: openArray[byte]): cint =
  cint(fcQMediaServiceFeaturesInterface_supportedFeatures(self.h, struct_seaqt_string(data: if len(service) > 0: addr service[0] else: nil, len: csize_t(len(service)))))

proc operatorAssign*(self: gen_qmediaserviceproviderplugin_types.QMediaServiceFeaturesInterface, fromVal: gen_qmediaserviceproviderplugin_types.QMediaServiceFeaturesInterface): void =
  fcQMediaServiceFeaturesInterface_operatorAssign(self.h, fromVal.h)
...
proc createX*(self: gen_qmediaserviceproviderplugin_types.QMediaServiceProviderPlugin, key: openArray[char]): gen_qmediaservice_types.QMediaService =
  gen_qmediaservice_types.QMediaService(h: fcQMediaServiceProviderPlugin_createX(self.h, struct_seaqt_string(data: if len(key) > 0: addr key[0] else: nil, len: csize_t(len(key)))), owned: false)
