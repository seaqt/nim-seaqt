...
proc fcQMediaServiceProviderHint_new2(mimeType: struct_seaqt_string, codecs: struct_seaqt_array): ptr cQMediaServiceProviderHint {.importc: "QMediaServiceProviderHint_new2".}
proc fcQMediaServiceProviderHint_new3(device: struct_seaqt_string): ptr cQMediaServiceProviderHint {.importc: "QMediaServiceProviderHint_new3".}
...
proc fcQMediaServiceProviderPlugin_tr(s: cstring): struct_seaqt_string {.importc: "QMediaServiceProviderPlugin_tr".}
proc fcQMediaServiceProviderPlugin_trUtf8(s: cstring): struct_seaqt_string {.importc: "QMediaServiceProviderPlugin_trUtf8".}
...
proc fcQMediaServiceProviderPlugin_tr2(s: cstring, c: cstring): struct_seaqt_string {.importc: "QMediaServiceProviderPlugin_tr2".}
proc fcQMediaServiceProviderPlugin_tr3(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QMediaServiceProviderPlugin_tr3".}
proc fcQMediaServiceProviderPlugin_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QMediaServiceProviderPlugin_trUtf82".}
proc fcQMediaServiceProviderPlugin_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QMediaServiceProviderPlugin_trUtf83".}
...
proc create*(T: type gen_qmediaserviceproviderplugin_types.QMediaServiceProviderHint,
  ...
  let tmp = gen_qmediaserviceproviderplugin_types.QMediaServiceProviderHint(h: fcQMediaServiceProviderHint_new6(other.h), owned: true)
  tmp
