...
const QRadioTuner_VTable* QRadioTuner_vtbl(const VirtualQRadioTuner* self);
void* QRadioTuner_vdata(const VirtualQRadioTuner* self);
void QRadioTuner_setVdata(VirtualQRadioTuner* self, void* vdata);
