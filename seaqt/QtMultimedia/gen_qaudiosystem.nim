...
proc fcQAbstractAudioDeviceInfo_supportedCodecs(self: pointer): struct_seaqt_array {.importc: "QAbstractAudioDeviceInfo_supportedCodecs".}
proc fcQAbstractAudioDeviceInfo_supportedSampleRates(self: pointer): struct_seaqt_array {.importc: "QAbstractAudioDeviceInfo_supportedSampleRates".}
proc fcQAbstractAudioDeviceInfo_supportedChannelCounts(self: pointer): struct_seaqt_array {.importc: "QAbstractAudioDeviceInfo_supportedChannelCounts".}
...
proc fcQAbstractAudioOutput_category(self: pointer): struct_seaqt_string {.importc: "QAbstractAudioOutput_category".}
proc fcQAbstractAudioOutput_setCategory(self: pointer, category: struct_seaqt_string): void {.importc: "QAbstractAudioOutput_setCategory".}
...
proc setCategory*(self: gen_qaudiosystem_types.QAbstractAudioOutput, category: openArray[char]): void =
  fcQAbstractAudioOutput_setCategory(self.h, struct_seaqt_string(data: if len(category) > 0: addr category[0] else: nil, len: csize_t(len(category))))
