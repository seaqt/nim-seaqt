...
{.compile("gen_qradiodatacontrol.cpp", QtMultimediaCFlags).}
...
proc fcQRadioDataControl_trS(s: cstring): struct_seaqt_string {.importc: "QRadioDataControl_tr_s".}
proc fcQRadioDataControl_trUtf8S(s: cstring): struct_seaqt_string {.importc: "QRadioDataControl_trUtf8_s".}
proc fcQRadioDataControl_stationId(self: pointer): struct_seaqt_string {.importc: "QRadioDataControl_stationId".}
proc fcQRadioDataControl_programType(self: pointer): cint {.importc: "QRadioDataControl_programType".}
proc fcQRadioDataControl_programTypeName(self: pointer): struct_seaqt_string {.importc: "QRadioDataControl_programTypeName".}
proc fcQRadioDataControl_stationName(self: pointer): struct_seaqt_string {.importc: "QRadioDataControl_stationName".}
proc fcQRadioDataControl_radioText(self: pointer): struct_seaqt_string {.importc: "QRadioDataControl_radioText".}
...
proc fcQRadioDataControl_errorString(self: pointer): struct_seaqt_string {.importc: "QRadioDataControl_errorString".}
proc fcQRadioDataControl_stationIdChanged(self: pointer, stationId: struct_seaqt_string): void {.importc: "QRadioDataControl_stationIdChanged".}
proc fcQRadioDataControl_connect_stationIdChanged(self: pointer, slot: int, callback: proc (slot: int, stationId: struct_seaqt_string) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QRadioDataControl_connect_stationIdChanged".}
...
proc fcQRadioDataControl_programTypeNameChanged(self: pointer, programTypeName: struct_seaqt_string): void {.importc: "QRadioDataControl_programTypeNameChanged".}
proc fcQRadioDataControl_connect_programTypeNameChanged(self: pointer, slot: int, callback: proc (slot: int, programTypeName: struct_seaqt_string) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QRadioDataControl_connect_programTypeNameChanged".}
proc fcQRadioDataControl_stationNameChanged(self: pointer, stationName: struct_seaqt_string): void {.importc: "QRadioDataControl_stationNameChanged".}
proc fcQRadioDataControl_connect_stationNameChanged(self: pointer, slot: int, callback: proc (slot: int, stationName: struct_seaqt_string) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QRadioDataControl_connect_stationNameChanged".}
proc fcQRadioDataControl_radioTextChanged(self: pointer, radioText: struct_seaqt_string): void {.importc: "QRadioDataControl_radioTextChanged".}
proc fcQRadioDataControl_connect_radioTextChanged(self: pointer, slot: int, callback: proc (slot: int, radioText: struct_seaqt_string) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QRadioDataControl_connect_radioTextChanged".}
...
proc fcQRadioDataControl_errorErr(self: pointer, err: cint): void {.importc: "QRadioDataControl_error_err".}
proc fcQRadioDataControl_connect_errorErr(self: pointer, slot: int, callback: proc (slot: int, err: cint) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QRadioDataControl_connect_error_err".}
proc fcQRadioDataControl_trSC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QRadioDataControl_tr_s_c".}
proc fcQRadioDataControl_trSCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QRadioDataControl_tr_s_c_n".}
proc fcQRadioDataControl_trUtf8SC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QRadioDataControl_trUtf8_s_c".}
proc fcQRadioDataControl_trUtf8SCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QRadioDataControl_trUtf8_s_c_n".}
...
proc stationIdChanged*(self: gen_qradiodatacontrol_types.QRadioDataControl, stationId: openArray[char]): void =
  fcQRadioDataControl_stationIdChanged(self.h, struct_seaqt_string(data: if len(stationId) > 0: addr stationId[0] else: nil, len: csize_t(len(stationId))))

type QRadioDataControlstationIdChangedSlot* = proc(stationId: openArray[char])
proc fcQRadioDataControl_slot_callback_stationIdChanged(slot: int, stationId: struct_seaqt_string) {.cdecl.} =
...
proc fcQRadioDataControl_slot_callback_stationIdChanged_release(slot: int) {.cdecl.} =
...
proc onStationIdChanged*(self: gen_qradiodatacontrol_types.QRadioDataControl, slot: QRadioDataControlstationIdChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQRadioDataControl_connect_stationIdChanged(self.h, cast[int](addr tmp[]), fcQRadioDataControl_slot_callback_stationIdChanged, fcQRadioDataControl_slot_callback_stationIdChanged_release)
...
proc fcQRadioDataControl_slot_callback_programTypeChanged(slot: int, programType: cint) {.cdecl.} =
  let nimfunc = cast[ptr QRadioDataControlprogramTypeChangedSlot](cast[pointer](slot))
  let slotval1 = cint(programType)

  nimfunc[](slotval1)

proc fcQRadioDataControl_slot_callback_programTypeChanged_release(slot: int) {.cdecl.} =
...
proc onProgramTypeChanged*(self: gen_qradiodatacontrol_types.QRadioDataControl, slot: QRadioDataControlprogramTypeChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQRadioDataControl_connect_programTypeChanged(self.h, cast[int](addr tmp[]), fcQRadioDataControl_slot_callback_programTypeChanged, fcQRadioDataControl_slot_callback_programTypeChanged_release)

proc programTypeNameChanged*(self: gen_qradiodatacontrol_types.QRadioDataControl, programTypeName: openArray[char]): void =
  fcQRadioDataControl_programTypeNameChanged(self.h, struct_seaqt_string(data: if len(programTypeName) > 0: addr programTypeName[0] else: nil, len: csize_t(len(programTypeName))))

type QRadioDataControlprogramTypeNameChangedSlot* = proc(programTypeName: openArray[char])
proc fcQRadioDataControl_slot_callback_programTypeNameChanged(slot: int, programTypeName: struct_seaqt_string) {.cdecl.} =
...
proc fcQRadioDataControl_slot_callback_programTypeNameChanged_release(slot: int) {.cdecl.} =
...
proc onProgramTypeNameChanged*(self: gen_qradiodatacontrol_types.QRadioDataControl, slot: QRadioDataControlprogramTypeNameChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQRadioDataControl_connect_programTypeNameChanged(self.h, cast[int](addr tmp[]), fcQRadioDataControl_slot_callback_programTypeNameChanged, fcQRadioDataControl_slot_callback_programTypeNameChanged_release)

proc stationNameChanged*(self: gen_qradiodatacontrol_types.QRadioDataControl, stationName: openArray[char]): void =
  fcQRadioDataControl_stationNameChanged(self.h, struct_seaqt_string(data: if len(stationName) > 0: addr stationName[0] else: nil, len: csize_t(len(stationName))))

type QRadioDataControlstationNameChangedSlot* = proc(stationName: openArray[char])
proc fcQRadioDataControl_slot_callback_stationNameChanged(slot: int, stationName: struct_seaqt_string) {.cdecl.} =
...
proc fcQRadioDataControl_slot_callback_stationNameChanged_release(slot: int) {.cdecl.} =
...
proc onStationNameChanged*(self: gen_qradiodatacontrol_types.QRadioDataControl, slot: QRadioDataControlstationNameChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQRadioDataControl_connect_stationNameChanged(self.h, cast[int](addr tmp[]), fcQRadioDataControl_slot_callback_stationNameChanged, fcQRadioDataControl_slot_callback_stationNameChanged_release)

proc radioTextChanged*(self: gen_qradiodatacontrol_types.QRadioDataControl, radioText: openArray[char]): void =
  fcQRadioDataControl_radioTextChanged(self.h, struct_seaqt_string(data: if len(radioText) > 0: addr radioText[0] else: nil, len: csize_t(len(radioText))))

type QRadioDataControlradioTextChangedSlot* = proc(radioText: openArray[char])
proc fcQRadioDataControl_slot_callback_radioTextChanged(slot: int, radioText: struct_seaqt_string) {.cdecl.} =
...
proc fcQRadioDataControl_slot_callback_radioTextChanged_release(slot: int) {.cdecl.} =
...
proc onRadioTextChanged*(self: gen_qradiodatacontrol_types.QRadioDataControl, slot: QRadioDataControlradioTextChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQRadioDataControl_connect_radioTextChanged(self.h, cast[int](addr tmp[]), fcQRadioDataControl_slot_callback_radioTextChanged, fcQRadioDataControl_slot_callback_radioTextChanged_release)
...
proc fcQRadioDataControl_slot_callback_alternativeFrequenciesEnabledChanged(slot: int, enabled: bool) {.cdecl.} =
  let nimfunc = cast[ptr QRadioDataControlalternativeFrequenciesEnabledChangedSlot](cast[pointer](slot))
  let slotval1 = enabled

  nimfunc[](slotval1)

proc fcQRadioDataControl_slot_callback_alternativeFrequenciesEnabledChanged_release(slot: int) {.cdecl.} =
...
proc onAlternativeFrequenciesEnabledChanged*(self: gen_qradiodatacontrol_types.QRadioDataControl, slot: QRadioDataControlalternativeFrequenciesEnabledChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQRadioDataControl_connect_alternativeFrequenciesEnabledChanged(self.h, cast[int](addr tmp[]), fcQRadioDataControl_slot_callback_alternativeFrequenciesEnabledChanged, fcQRadioDataControl_slot_callback_alternativeFrequenciesEnabledChanged_release)

proc error*(self: gen_qradiodatacontrol_types.QRadioDataControl, err: cint): void =
  fcQRadioDataControl_errorErr(self.h, cint(err))

type QRadioDataControlerrorErrSlot* = proc(err: cint)
proc fcQRadioDataControl_slot_callback_errorErr(slot: int, err: cint) {.cdecl.} =
  let nimfunc = cast[ptr QRadioDataControlerrorErrSlot](cast[pointer](slot))
  let slotval1 = cint(err)

  nimfunc[](slotval1)

proc fcQRadioDataControl_slot_callback_errorErr_release(slot: int) {.cdecl.} =
  let nimfunc = cast[ref QRadioDataControlerrorErrSlot](cast[pointer](slot))
  GC_unref(nimfunc)

proc onError*(self: gen_qradiodatacontrol_types.QRadioDataControl, slot: QRadioDataControlerrorErrSlot) =
  var tmp = new QRadioDataControlerrorErrSlot
  tmp[] = slot
  GC_ref(tmp)
  fcQRadioDataControl_connect_errorErr(self.h, cast[int](addr tmp[]), fcQRadioDataControl_slot_callback_errorErr, fcQRadioDataControl_slot_callback_errorErr_release)

proc tr*(_: type gen_qradiodatacontrol_types.QRadioDataControl, s: cstring, c: cstring): string =
  let v_ms = fcQRadioDataControl_trSC(s, c)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret

proc tr*(_: type gen_qradiodatacontrol_types.QRadioDataControl, s: cstring, c: cstring, n: cint): string =
  let v_ms = fcQRadioDataControl_trSCN(s, c, n)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret

proc trUtf8*(_: type gen_qradiodatacontrol_types.QRadioDataControl, s: cstring, c: cstring): string =
  let v_ms = fcQRadioDataControl_trUtf8SC(s, c)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret

proc trUtf8*(_: type gen_qradiodatacontrol_types.QRadioDataControl, s: cstring, c: cstring, n: cint): string =
  let v_ms = fcQRadioDataControl_trUtf8SCN(s, c, n)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
