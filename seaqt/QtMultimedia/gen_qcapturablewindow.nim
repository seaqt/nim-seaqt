...
proc fcQCapturableWindow_new2(window: pointer): ptr cQCapturableWindow {.importc: "QCapturableWindow_new_window".}
proc fcQCapturableWindow_new3(fromVal: pointer): ptr cQCapturableWindow {.importc: "QCapturableWindow_new_from".}
...
proc create*(T: type gen_qcapturablewindow_types.QCapturableWindow,
    window: gen_qwindow_types.QWindow): gen_qcapturablewindow_types.QCapturableWindow =
  let tmp = gen_qcapturablewindow_types.QCapturableWindow(h: fcQCapturableWindow_new2(window.h), owned: true)
  tmp
proc create*(T: type gen_qcapturablewindow_types.QCapturableWindow,
    fromVal: gen_qcapturablewindow_types.QCapturableWindow): gen_qcapturablewindow_types.QCapturableWindow =
  let tmp = gen_qcapturablewindow_types.QCapturableWindow(h: fcQCapturableWindow_new3(fromVal.h), owned: true)
  tmp
