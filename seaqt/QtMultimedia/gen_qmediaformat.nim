...
proc fcQMediaFormat_operatorAssign(self: pointer, fromVal: pointer): void {.importc: "QMediaFormat_operatorAssign".}
...
proc fcQMediaFormat_supportedFileFormats(self: pointer, m: cint): struct_seaqt_array {.importc: "QMediaFormat_supportedFileFormats".}
proc fcQMediaFormat_supportedVideoCodecs(self: pointer, m: cint): struct_seaqt_array {.importc: "QMediaFormat_supportedVideoCodecs".}
proc fcQMediaFormat_supportedAudioCodecs(self: pointer, m: cint): struct_seaqt_array {.importc: "QMediaFormat_supportedAudioCodecs".}
proc fcQMediaFormat_fileFormatName(fileFormat: cint): struct_seaqt_string {.importc: "QMediaFormat_fileFormatName".}
proc fcQMediaFormat_audioCodecName(codec: cint): struct_seaqt_string {.importc: "QMediaFormat_audioCodecName".}
proc fcQMediaFormat_videoCodecName(codec: cint): struct_seaqt_string {.importc: "QMediaFormat_videoCodecName".}
proc fcQMediaFormat_fileFormatDescription(fileFormat: cint): struct_seaqt_string {.importc: "QMediaFormat_fileFormatDescription".}
proc fcQMediaFormat_audioCodecDescription(codec: cint): struct_seaqt_string {.importc: "QMediaFormat_audioCodecDescription".}
proc fcQMediaFormat_videoCodecDescription(codec: cint): struct_seaqt_string {.importc: "QMediaFormat_videoCodecDescription".}
...
proc fcQMediaFormat_new2(fromVal: pointer): ptr cQMediaFormat {.importc: "QMediaFormat_new_from".}
proc fcQMediaFormat_new3(format: cint): ptr cQMediaFormat {.importc: "QMediaFormat_new_format".}
proc fcQMediaFormat_staticMetaObject(): pointer {.importc: "QMediaFormat_staticMetaObject".}

proc operatorAssign*(self: gen_qmediaformat_types.QMediaFormat, fromVal: gen_qmediaformat_types.QMediaFormat): void =
  fcQMediaFormat_operatorAssign(self.h, fromVal.h)
...
proc create*(T: type gen_qmediaformat_types.QMediaFormat,
    fromVal: gen_qmediaformat_types.QMediaFormat): gen_qmediaformat_types.QMediaFormat =
  let tmp = gen_qmediaformat_types.QMediaFormat(h: fcQMediaFormat_new2(fromVal.h), owned: true)
  tmp
proc create*(T: type gen_qmediaformat_types.QMediaFormat,
