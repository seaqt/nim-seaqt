...
proc create*(T: type gen_qmediaresource_types.QMediaResource,
  ...
  let tmp = gen_qmediaresource_types.QMediaResource(h: fcQMediaResource_new2(url.h), owned: true)
  tmp
proc create*(T: type gen_qmediaresource_types.QMediaResource,
...
proc create*(T: type gen_qmediaresource_types.QMediaResource,
  ...
  let tmp = gen_qmediaresource_types.QMediaResource(h: fcQMediaResource_new5(url.h, struct_seaqt_string(data: if len(mimeType) > 0: addr mimeType[0] else: nil, len: csize_t(len(mimeType)))), owned: true)
  tmp
proc create*(T: type gen_qmediaresource_types.QMediaResource,
    request: gen_qnetworkrequest_types.QNetworkRequest, mimeType: openArray[char]): gen_qmediaresource_types.QMediaResource =
  let tmp = gen_qmediaresource_types.QMediaResource(h: fcQMediaResource_new6(request.h, struct_seaqt_string(data: if len(mimeType) > 0: addr mimeType[0] else: nil, len: csize_t(len(mimeType)))), owned: true)
  tmp
