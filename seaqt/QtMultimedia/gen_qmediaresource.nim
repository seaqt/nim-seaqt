...
proc fcQMediaResource_mimeType(self: pointer): struct_seaqt_string {.importc: "QMediaResource_mimeType".}
proc fcQMediaResource_language(self: pointer): struct_seaqt_string {.importc: "QMediaResource_language".}
proc fcQMediaResource_setLanguage(self: pointer, language: struct_seaqt_string): void {.importc: "QMediaResource_setLanguage".}
proc fcQMediaResource_audioCodec(self: pointer): struct_seaqt_string {.importc: "QMediaResource_audioCodec".}
proc fcQMediaResource_setAudioCodec(self: pointer, codec: struct_seaqt_string): void {.importc: "QMediaResource_setAudioCodec".}
proc fcQMediaResource_videoCodec(self: pointer): struct_seaqt_string {.importc: "QMediaResource_videoCodec".}
proc fcQMediaResource_setVideoCodec(self: pointer, codec: struct_seaqt_string): void {.importc: "QMediaResource_setVideoCodec".}
...
proc setLanguage*(self: gen_qmediaresource_types.QMediaResource, language: openArray[char]): void =
  fcQMediaResource_setLanguage(self.h, struct_seaqt_string(data: if len(language) > 0: addr language[0] else: nil, len: csize_t(len(language))))
...
proc setAudioCodec*(self: gen_qmediaresource_types.QMediaResource, codec: openArray[char]): void =
  fcQMediaResource_setAudioCodec(self.h, struct_seaqt_string(data: if len(codec) > 0: addr codec[0] else: nil, len: csize_t(len(codec))))
...
proc setVideoCodec*(self: gen_qmediaresource_types.QMediaResource, codec: openArray[char]): void =
  fcQMediaResource_setVideoCodec(self.h, struct_seaqt_string(data: if len(codec) > 0: addr codec[0] else: nil, len: csize_t(len(codec))))
...
proc create*(T: type gen_qmediaresource_types.QMediaResource): gen_qmediaresource_types.QMediaResource =
  let tmp = gen_qmediaresource_types.QMediaResource(h: fcQMediaResource_new())
  tmp
proc create*(T: type gen_qmediaresource_types.QMediaResource,
  ...
  let tmp = gen_qmediaresource_types.QMediaResource(h: fcQMediaResource_new2(url.h))
  tmp
proc create*(T: type gen_qmediaresource_types.QMediaResource,
    request: gen_qnetworkrequest_types.QNetworkRequest): gen_qmediaresource_types.QMediaResource =
  let tmp = gen_qmediaresource_types.QMediaResource(h: fcQMediaResource_new3(request.h))
  tmp
proc create*(T: type gen_qmediaresource_types.QMediaResource,
    other: gen_qmediaresource_types.QMediaResource): gen_qmediaresource_types.QMediaResource =
  let tmp = gen_qmediaresource_types.QMediaResource(h: fcQMediaResource_new4(other.h))
  tmp
proc create*(T: type gen_qmediaresource_types.QMediaResource,
    url: gen_qurl_types.QUrl, mimeType: openArray[char]): gen_qmediaresource_types.QMediaResource =
  let tmp = gen_qmediaresource_types.QMediaResource(h: fcQMediaResource_new5(url.h, struct_seaqt_string(data: if len(mimeType) > 0: addr mimeType[0] else: nil, len: csize_t(len(mimeType)))))
  tmp
proc create*(T: type gen_qmediaresource_types.QMediaResource,
    request: gen_qnetworkrequest_types.QNetworkRequest, mimeType: openArray[char]): gen_qmediaresource_types.QMediaResource =
  let tmp = gen_qmediaresource_types.QMediaResource(h: fcQMediaResource_new6(request.h, struct_seaqt_string(data: if len(mimeType) > 0: addr mimeType[0] else: nil, len: csize_t(len(mimeType)))))
  tmp
