...
proc fcQAudioDeviceInfo_deviceName(self: pointer): struct_seaqt_string {.importc: "QAudioDeviceInfo_deviceName".}
...
proc fcQAudioDeviceInfo_supportedCodecs(self: pointer): struct_seaqt_array {.importc: "QAudioDeviceInfo_supportedCodecs".}
proc fcQAudioDeviceInfo_supportedSampleRates(self: pointer): struct_seaqt_array {.importc: "QAudioDeviceInfo_supportedSampleRates".}
proc fcQAudioDeviceInfo_supportedChannelCounts(self: pointer): struct_seaqt_array {.importc: "QAudioDeviceInfo_supportedChannelCounts".}
proc fcQAudioDeviceInfo_supportedSampleSizes(self: pointer): struct_seaqt_array {.importc: "QAudioDeviceInfo_supportedSampleSizes".}
proc fcQAudioDeviceInfo_supportedByteOrders(self: pointer): struct_seaqt_array {.importc: "QAudioDeviceInfo_supportedByteOrders".}
proc fcQAudioDeviceInfo_supportedSampleTypes(self: pointer): struct_seaqt_array {.importc: "QAudioDeviceInfo_supportedSampleTypes".}
proc fcQAudioDeviceInfo_realm(self: pointer): struct_seaqt_string {.importc: "QAudioDeviceInfo_realm".}
...
proc create*(T: type gen_qaudiodeviceinfo_types.QAudioDeviceInfo): gen_qaudiodeviceinfo_types.QAudioDeviceInfo =
  let tmp = gen_qaudiodeviceinfo_types.QAudioDeviceInfo(h: fcQAudioDeviceInfo_new())
  tmp
proc create*(T: type gen_qaudiodeviceinfo_types.QAudioDeviceInfo,
  ...
  let tmp = gen_qaudiodeviceinfo_types.QAudioDeviceInfo(h: fcQAudioDeviceInfo_new2(other.h))
  tmp
