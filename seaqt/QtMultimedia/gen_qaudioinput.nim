...
proc fcQAudioInput_new2(vtbl: pointer, vdata: csize_t, deviceInfo: pointer): ptr cQAudioInput {.importc: "QAudioInput_new_deviceInfo".}
proc fcQAudioInput_new3(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQAudioInput {.importc: "QAudioInput_new_parent".}
proc fcQAudioInput_new4(vtbl: pointer, vdata: csize_t, deviceInfo: pointer, parent: pointer): ptr cQAudioInput {.importc: "QAudioInput_new_deviceInfo_parent".}
...
proc fcQAudioInput_slot_callback_deviceChanged(slot: int) {.cdecl.} =
  let nimfunc = cast[ptr QAudioInputdeviceChangedSlot](cast[pointer](slot))
  nimfunc[]()

proc fcQAudioInput_slot_callback_deviceChanged_release(slot: int) {.cdecl.} =
...
proc onDeviceChanged*(self: gen_qaudioinput_types.QAudioInput, slot: QAudioInputdeviceChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQAudioInput_connect_deviceChanged(self.h, cast[int](addr tmp[]), fcQAudioInput_slot_callback_deviceChanged, fcQAudioInput_slot_callback_deviceChanged_release)
...
proc fcQAudioInput_slot_callback_volumeChanged(slot: int, volume: float32) {.cdecl.} =
  let nimfunc = cast[ptr QAudioInputvolumeChangedSlot](cast[pointer](slot))
  let slotval1 = volume

  nimfunc[](slotval1)

proc fcQAudioInput_slot_callback_volumeChanged_release(slot: int) {.cdecl.} =
...
proc onVolumeChanged*(self: gen_qaudioinput_types.QAudioInput, slot: QAudioInputvolumeChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQAudioInput_connect_volumeChanged(self.h, cast[int](addr tmp[]), fcQAudioInput_slot_callback_volumeChanged, fcQAudioInput_slot_callback_volumeChanged_release)
...
proc fcQAudioInput_slot_callback_mutedChanged(slot: int, muted: bool) {.cdecl.} =
  let nimfunc = cast[ptr QAudioInputmutedChangedSlot](cast[pointer](slot))
  let slotval1 = muted

  nimfunc[](slotval1)

proc fcQAudioInput_slot_callback_mutedChanged_release(slot: int) {.cdecl.} =
...
proc onMutedChanged*(self: gen_qaudioinput_types.QAudioInput, slot: QAudioInputmutedChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQAudioInput_connect_mutedChanged(self.h, cast[int](addr tmp[]), fcQAudioInput_slot_callback_mutedChanged, fcQAudioInput_slot_callback_mutedChanged_release)
...
proc create*(T: type gen_qaudioinput_types.QAudioInput,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQAudioInput_vtable_callback_disconnectNotify
  let tmp = gen_qaudioinput_types.QAudioInput(h: fcQAudioInput_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), deviceInfo.h), owned: true)
  fcQAudioInput_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qaudioinput_types.QAudioInput,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQAudioInput_vtable_callback_disconnectNotify
  let tmp = gen_qaudioinput_types.QAudioInput(h: fcQAudioInput_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQAudioInput_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qaudioinput_types.QAudioInput,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQAudioInput_vtable_callback_disconnectNotify
  let tmp = gen_qaudioinput_types.QAudioInput(h: fcQAudioInput_new4(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), deviceInfo.h, parent.h), owned: true)
  fcQAudioInput_vdata(tmp.h)[] = addr(vtbl[])
  tmp
...
proc create*(T: type gen_qaudioinput_types.QAudioInput,
    ...
    inst: VirtualQAudioInput) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQAudioInput_new2(addr(cQAudioInput_mvtbl), csize_t(sizeof(pointer)), deviceInfo.h)
  fcQAudioInput_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qaudioinput_types.QAudioInput,
    ...
    inst: VirtualQAudioInput) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQAudioInput_new3(addr(cQAudioInput_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQAudioInput_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qaudioinput_types.QAudioInput,
    ...
    inst: VirtualQAudioInput) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQAudioInput_new4(addr(cQAudioInput_mvtbl), csize_t(sizeof(pointer)), deviceInfo.h, parent.h)
  fcQAudioInput_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
