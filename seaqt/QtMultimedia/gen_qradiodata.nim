...
proc fcQRadioData_programTypeName(self: pointer): struct_seaqt_string {.importc: "QRadioData_programTypeName".}
proc fcQRadioData_stationName(self: pointer): struct_seaqt_string {.importc: "QRadioData_stationName".}
proc fcQRadioData_radioText(self: pointer): struct_seaqt_string {.importc: "QRadioData_radioText".}
...
proc fcQRadioData_errorString(self: pointer): struct_seaqt_string {.importc: "QRadioData_errorString".}
...
proc fcQRadioData_stationIdChanged(self: pointer, stationId: struct_seaqt_string): void {.importc: "QRadioData_stationIdChanged".}
proc fcQRadioData_connect_stationIdChanged(self: pointer, slot: int, callback: proc (slot: int, stationId: struct_seaqt_string) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QRadioData_connect_stationIdChanged".}
...
proc fcQRadioData_programTypeNameChanged(self: pointer, programTypeName: struct_seaqt_string): void {.importc: "QRadioData_programTypeNameChanged".}
proc fcQRadioData_connect_programTypeNameChanged(self: pointer, slot: int, callback: proc (slot: int, programTypeName: struct_seaqt_string) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QRadioData_connect_programTypeNameChanged".}
proc fcQRadioData_stationNameChanged(self: pointer, stationName: struct_seaqt_string): void {.importc: "QRadioData_stationNameChanged".}
proc fcQRadioData_connect_stationNameChanged(self: pointer, slot: int, callback: proc (slot: int, stationName: struct_seaqt_string) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QRadioData_connect_stationNameChanged".}
proc fcQRadioData_radioTextChanged(self: pointer, radioText: struct_seaqt_string): void {.importc: "QRadioData_radioTextChanged".}
...
proc stationIdChanged*(self: gen_qradiodata_types.QRadioData, stationId: openArray[char]): void =
  fcQRadioData_stationIdChanged(self.h, struct_seaqt_string(data: if len(stationId) > 0: addr stationId[0] else: nil, len: csize_t(len(stationId))))

type QRadioDatastationIdChangedSlot* = proc(stationId: openArray[char])
proc fcQRadioData_slot_callback_stationIdChanged(slot: int, stationId: struct_seaqt_string) {.cdecl.} =
...
proc programTypeNameChanged*(self: gen_qradiodata_types.QRadioData, programTypeName: openArray[char]): void =
  fcQRadioData_programTypeNameChanged(self.h, struct_seaqt_string(data: if len(programTypeName) > 0: addr programTypeName[0] else: nil, len: csize_t(len(programTypeName))))

type QRadioDataprogramTypeNameChangedSlot* = proc(programTypeName: openArray[char])
proc fcQRadioData_slot_callback_programTypeNameChanged(slot: int, programTypeName: struct_seaqt_string) {.cdecl.} =
...
proc stationNameChanged*(self: gen_qradiodata_types.QRadioData, stationName: openArray[char]): void =
  fcQRadioData_stationNameChanged(self.h, struct_seaqt_string(data: if len(stationName) > 0: addr stationName[0] else: nil, len: csize_t(len(stationName))))

type QRadioDatastationNameChangedSlot* = proc(stationName: openArray[char])
proc fcQRadioData_slot_callback_stationNameChanged(slot: int, stationName: struct_seaqt_string) {.cdecl.} =
...
proc radioTextChanged*(self: gen_qradiodata_types.QRadioData, radioText: openArray[char]): void =
  fcQRadioData_radioTextChanged(self.h, struct_seaqt_string(data: if len(radioText) > 0: addr radioText[0] else: nil, len: csize_t(len(radioText))))

type QRadioDataradioTextChangedSlot* = proc(radioText: openArray[char])
proc fcQRadioData_slot_callback_radioTextChanged(slot: int, radioText: struct_seaqt_string) {.cdecl.} =
...
proc create*(T: type gen_qradiodata_types.QRadioData,
  ...
  let tmp = gen_qradiodata_types.QRadioData(h: fcQRadioData_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), mediaObject.h), owned: true)
  fcQRadioData_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qradiodata_types.QRadioData,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQRadioData_vtable_callback_disconnectNotify
  let tmp = gen_qradiodata_types.QRadioData(h: fcQRadioData_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), mediaObject.h, parent.h), owned: true)
  fcQRadioData_vdata(tmp.h)[] = addr(vtbl[])
  tmp
...
proc create*(T: type gen_qradiodata_types.QRadioData,
  ...
  inst[].h = fcQRadioData_new(addr(cQRadioData_mvtbl), csize_t(sizeof(pointer)), mediaObject.h)
  fcQRadioData_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qradiodata_types.QRadioData,
    ...
    inst: VirtualQRadioData) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQRadioData_new2(addr(cQRadioData_mvtbl), csize_t(sizeof(pointer)), mediaObject.h, parent.h)
  fcQRadioData_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
