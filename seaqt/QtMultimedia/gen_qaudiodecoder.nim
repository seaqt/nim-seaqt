...
proc fcQAudioDecoder_errorString(self: pointer): struct_seaqt_string {.importc: "QAudioDecoder_errorString".}
...
proc fcQAudioDecoder_protectedbase_addPropertyWatch(self: pointer, name: struct_seaqt_string): void {.importc: "QAudioDecoder_protectedbase_addPropertyWatch".}
proc fcQAudioDecoder_protectedbase_removePropertyWatch(self: pointer, name: struct_seaqt_string): void {.importc: "QAudioDecoder_protectedbase_removePropertyWatch".}
...
proc addPropertyWatch*(self: gen_qaudiodecoder_types.QAudioDecoder, name: openArray[byte]): void =
  fcQAudioDecoder_protectedbase_addPropertyWatch(self.h, struct_seaqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name))))
