...
proc cQAudioSource_slot_callback_stateChanged(slot: int, state: cint) {.cdecl.} =
  let nimfunc = cast[ptr QAudioSourcestateChangedSlot](cast[pointer](slot))
  let slotval1 = cint(state)

  nimfunc[](slotval1)

proc cQAudioSource_slot_callback_stateChanged_release(slot: int) {.cdecl.} =
...
proc onstateChanged*(self: gen_qaudiosource_types.QAudioSource, slot: QAudioSourcestateChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQAudioSource_connect_stateChanged(self.h, cast[int](addr tmp[]), cQAudioSource_slot_callback_stateChanged, cQAudioSource_slot_callback_stateChanged_release)
...
proc cQAudioSource_vtable_callback_metaObject(self: pointer): pointer {.cdecl.} =
...
proc cQAudioSource_vtable_callback_metacast(self: pointer, param1: cstring): pointer {.cdecl.} =
  let vtbl = cast[ptr QAudioSourceVTable](fcQAudioSource_vdata(self))
  let self = QAudioSource(h: self)
  let slotval1 = (param1)
...
proc cQAudioSource_vtable_callback_metacall(self: pointer, param1: cint, param2: cint, param3: pointer): cint {.cdecl.} =
  let vtbl = cast[ptr QAudioSourceVTable](fcQAudioSource_vdata(self))
  let self = QAudioSource(h: self)
...
proc cQAudioSource_vtable_callback_event(self: pointer, event: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QAudioSourceVTable](fcQAudioSource_vdata(self))
  let self = QAudioSource(h: self)
...
proc cQAudioSource_vtable_callback_eventFilter(self: pointer, watched: pointer, event: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QAudioSourceVTable](fcQAudioSource_vdata(self))
  let self = QAudioSource(h: self)
...
proc cQAudioSource_vtable_callback_timerEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QAudioSourceVTable](fcQAudioSource_vdata(self))
  let self = QAudioSource(h: self)
...
proc cQAudioSource_vtable_callback_childEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QAudioSourceVTable](fcQAudioSource_vdata(self))
  let self = QAudioSource(h: self)
...
proc cQAudioSource_vtable_callback_customEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QAudioSourceVTable](fcQAudioSource_vdata(self))
  let self = QAudioSource(h: self)
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
...
proc cQAudioSource_vtable_callback_connectNotify(self: pointer, signal: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QAudioSourceVTable](fcQAudioSource_vdata(self))
  let self = QAudioSource(h: self)
...
proc cQAudioSource_vtable_callback_disconnectNotify(self: pointer, signal: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QAudioSourceVTable](fcQAudioSource_vdata(self))
  let self = QAudioSource(h: self)
  let slotval1 = gen_qmetaobject_types.QMetaMethod(h: signal, owned: false)
...
proc cQAudioSource_method_callback_metaObject(self: pointer): pointer {.cdecl.} =
...
proc cQAudioSource_method_callback_metacast(self: pointer, param1: cstring): pointer {.cdecl.} =
  let inst = cast[VirtualQAudioSource](fcQAudioSource_vdata(self))
  let slotval1 = (param1)
...
proc cQAudioSource_method_callback_metacall(self: pointer, param1: cint, param2: cint, param3: pointer): cint {.cdecl.} =
  let inst = cast[VirtualQAudioSource](fcQAudioSource_vdata(self))
  let slotval1 = cint(param1)
  let slotval2 = param2
  let slotval3 = param3
...
proc cQAudioSource_method_callback_event(self: pointer, event: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQAudioSource](fcQAudioSource_vdata(self))
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
...
proc cQAudioSource_method_callback_eventFilter(self: pointer, watched: pointer, event: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQAudioSource](fcQAudioSource_vdata(self))
  let slotval1 = gen_qobject_types.QObject(h: watched, owned: false)
  let slotval2 = gen_qcoreevent_types.QEvent(h: event, owned: false)
...
proc cQAudioSource_method_callback_timerEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQAudioSource](fcQAudioSource_vdata(self))
  let slotval1 = gen_qcoreevent_types.QTimerEvent(h: event, owned: false)
...
proc cQAudioSource_method_callback_childEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQAudioSource](fcQAudioSource_vdata(self))
  let slotval1 = gen_qcoreevent_types.QChildEvent(h: event, owned: false)
...
proc cQAudioSource_method_callback_customEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQAudioSource](fcQAudioSource_vdata(self))
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
...
proc cQAudioSource_method_callback_connectNotify(self: pointer, signal: pointer): void {.cdecl.} =
  let inst = cast[VirtualQAudioSource](fcQAudioSource_vdata(self))
  let slotval1 = gen_qmetaobject_types.QMetaMethod(h: signal, owned: false)
...
proc cQAudioSource_method_callback_disconnectNotify(self: pointer, signal: pointer): void {.cdecl.} =
  let inst = cast[VirtualQAudioSource](fcQAudioSource_vdata(self))
  let slotval1 = gen_qmetaobject_types.QMetaMethod(h: signal, owned: false)
...
proc create*(T: type gen_qaudiosource_types.QAudioSource,
  ...
  if not isNil(vtbl[].metaObject):
    vtbl[].vtbl.metaObject = cQAudioSource_vtable_callback_metaObject
  if not isNil(vtbl[].metacast):
    vtbl[].vtbl.metacast = cQAudioSource_vtable_callback_metacast
  if not isNil(vtbl[].metacall):
    vtbl[].vtbl.metacall = cQAudioSource_vtable_callback_metacall
  if not isNil(vtbl[].event):
    vtbl[].vtbl.event = cQAudioSource_vtable_callback_event
  if not isNil(vtbl[].eventFilter):
    vtbl[].vtbl.eventFilter = cQAudioSource_vtable_callback_eventFilter
  if not isNil(vtbl[].timerEvent):
    vtbl[].vtbl.timerEvent = cQAudioSource_vtable_callback_timerEvent
  if not isNil(vtbl[].childEvent):
    vtbl[].vtbl.childEvent = cQAudioSource_vtable_callback_childEvent
  if not isNil(vtbl[].customEvent):
    vtbl[].vtbl.customEvent = cQAudioSource_vtable_callback_customEvent
  if not isNil(vtbl[].connectNotify):
    vtbl[].vtbl.connectNotify = cQAudioSource_vtable_callback_connectNotify
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = cQAudioSource_vtable_callback_disconnectNotify
...
const cQAudioSource_mvtbl = cQAudioSourceVTable(
  destructor: proc(self: pointer) {.cdecl.} =
    ...
    inst[].h = nil
    inst[].owned = false,
  metaObject: cQAudioSource_method_callback_metaObject,
  metacast: cQAudioSource_method_callback_metacast,
  metacall: cQAudioSource_method_callback_metacall,
  event: cQAudioSource_method_callback_event,
  eventFilter: cQAudioSource_method_callback_eventFilter,
  timerEvent: cQAudioSource_method_callback_timerEvent,
  childEvent: cQAudioSource_method_callback_childEvent,
  customEvent: cQAudioSource_method_callback_customEvent,
  connectNotify: cQAudioSource_method_callback_connectNotify,
  disconnectNotify: cQAudioSource_method_callback_disconnectNotify,
)
proc create*(T: type gen_qaudiosource_types.QAudioSource,
