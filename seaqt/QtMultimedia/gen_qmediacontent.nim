...
proc create*(T: type gen_qmediacontent_types.QMediaContent): gen_qmediacontent_types.QMediaContent =
  let tmp = gen_qmediacontent_types.QMediaContent(h: fcQMediaContent_new())
  tmp
proc create*(T: type gen_qmediacontent_types.QMediaContent,
  ...
  let tmp = gen_qmediacontent_types.QMediaContent(h: fcQMediaContent_new2(contentUrl.h))
  tmp
proc create*(T: type gen_qmediacontent_types.QMediaContent,
    contentRequest: gen_qnetworkrequest_types.QNetworkRequest): gen_qmediacontent_types.QMediaContent =
  let tmp = gen_qmediacontent_types.QMediaContent(h: fcQMediaContent_new3(contentRequest.h))
  tmp
proc create*(T: type gen_qmediacontent_types.QMediaContent,
    contentResource: gen_qmediaresource_types.QMediaResource): gen_qmediacontent_types.QMediaContent =
  let tmp = gen_qmediacontent_types.QMediaContent(h: fcQMediaContent_new4(contentResource.h))
  tmp
proc create*(T: type gen_qmediacontent_types.QMediaContent,
    resources: openArray[gen_qmediaresource_types.QMediaResource]): gen_qmediacontent_types.QMediaContent =
  var resources_CArray = newSeq[pointer](len(resources))
  for i in 0..<len(resources):
    resources_CArray[i] = resources[i].h

  let tmp = gen_qmediacontent_types.QMediaContent(h: fcQMediaContent_new5(struct_seaqt_array(len: csize_t(len(resources)), data: if len(resources) == 0: nil else: addr(resources_CArray[0]))))
  tmp
proc create*(T: type gen_qmediacontent_types.QMediaContent,
    other: gen_qmediacontent_types.QMediaContent): gen_qmediacontent_types.QMediaContent =
  let tmp = gen_qmediacontent_types.QMediaContent(h: fcQMediaContent_new6(other.h))
  tmp
proc create*(T: type gen_qmediacontent_types.QMediaContent,
    playlist: gen_qmediaplaylist_types.QMediaPlaylist): gen_qmediacontent_types.QMediaContent =
  let tmp = gen_qmediacontent_types.QMediaContent(h: fcQMediaContent_new7(playlist.h))
  tmp
proc create*(T: type gen_qmediacontent_types.QMediaContent,
    playlist: gen_qmediaplaylist_types.QMediaPlaylist, contentUrl: gen_qurl_types.QUrl): gen_qmediacontent_types.QMediaContent =
  let tmp = gen_qmediacontent_types.QMediaContent(h: fcQMediaContent_new8(playlist.h, contentUrl.h))
  tmp
proc create*(T: type gen_qmediacontent_types.QMediaContent,
  ...
  let tmp = gen_qmediacontent_types.QMediaContent(h: fcQMediaContent_new9(playlist.h, contentUrl.h, takeOwnership))
  tmp
