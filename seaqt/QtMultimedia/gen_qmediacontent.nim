...
proc create*(T: type gen_qmediacontent_types.QMediaContent): gen_qmediacontent_types.QMediaContent =
  let tmp = gen_qmediacontent_types.QMediaContent(h: fcQMediaContent_new(), owned: true)
  tmp
proc create*(T: type gen_qmediacontent_types.QMediaContent,
  ...
  let tmp = gen_qmediacontent_types.QMediaContent(h: fcQMediaContent_new2(contentUrl.h), owned: true)
  tmp
proc create*(T: type gen_qmediacontent_types.QMediaContent,
    contentRequest: gen_qnetworkrequest_types.QNetworkRequest): gen_qmediacontent_types.QMediaContent =
  let tmp = gen_qmediacontent_types.QMediaContent(h: fcQMediaContent_new3(contentRequest.h), owned: true)
  tmp
proc create*(T: type gen_qmediacontent_types.QMediaContent,
    contentResource: gen_qmediaresource_types.QMediaResource): gen_qmediacontent_types.QMediaContent =
  let tmp = gen_qmediacontent_types.QMediaContent(h: fcQMediaContent_new4(contentResource.h), owned: true)
  tmp
proc create*(T: type gen_qmediacontent_types.QMediaContent,
...
proc create*(T: type gen_qmediacontent_types.QMediaContent,
  ...
  let tmp = gen_qmediacontent_types.QMediaContent(h: fcQMediaContent_new7(playlist.h), owned: true)
  tmp
proc create*(T: type gen_qmediacontent_types.QMediaContent,
    playlist: gen_qmediaplaylist_types.QMediaPlaylist, contentUrl: gen_qurl_types.QUrl): gen_qmediacontent_types.QMediaContent =
  let tmp = gen_qmediacontent_types.QMediaContent(h: fcQMediaContent_new8(playlist.h, contentUrl.h), owned: true)
  tmp
proc create*(T: type gen_qmediacontent_types.QMediaContent,
  ...
  let tmp = gen_qmediacontent_types.QMediaContent(h: fcQMediaContent_new9(playlist.h, contentUrl.h, takeOwnership), owned: true)
  tmp
