...
proc fcQCameraInfo_operatorAssign(self: pointer, fromVal: pointer): void {.importc: "QCameraInfo_operatorAssign".}
...
proc fcQCameraInfo_deviceName(self: pointer): struct_seaqt_string {.importc: "QCameraInfo_deviceName".}
proc fcQCameraInfo_description(self: pointer): struct_seaqt_string {.importc: "QCameraInfo_description".}
...
proc fcQCameraInfo_availableCameras(): struct_seaqt_array {.importc: "QCameraInfo_availableCameras".}
proc fcQCameraInfo_availableCamerasPosition(position: cint): struct_seaqt_array {.importc: "QCameraInfo_availableCameras_position".}
proc fcQCameraInfo_new(): ptr cQCameraInfo {.importc: "QCameraInfo_new".}
proc fcQCameraInfo_new2(camera: pointer): ptr cQCameraInfo {.importc: "QCameraInfo_new_camera".}
proc fcQCameraInfo_new3(fromVal: pointer): ptr cQCameraInfo {.importc: "QCameraInfo_new_from".}
proc fcQCameraInfo_new4(name: struct_seaqt_string): ptr cQCameraInfo {.importc: "QCameraInfo_new_name".}

proc operatorAssign*(self: gen_qcamerainfo_types.QCameraInfo, fromVal: gen_qcamerainfo_types.QCameraInfo): void =
  fcQCameraInfo_operatorAssign(self.h, fromVal.h)
...
proc availableCameras*(_: type gen_qcamerainfo_types.QCameraInfo, position: cint): seq[gen_qcamerainfo_types.QCameraInfo] =
  var v_ma = fcQCameraInfo_availableCamerasPosition(cint(position))
  var vx_ret = newSeq[gen_qcamerainfo_types.QCameraInfo](int(v_ma.len))
  let v_outCast = cast[ptr UncheckedArray[pointer]](v_ma.data)
  for i in 0 ..< v_ma.len:
    vx_ret[i] = gen_qcamerainfo_types.QCameraInfo(h: v_outCast[i], owned: true)
...
proc create*(T: type gen_qcamerainfo_types.QCameraInfo,
  ...
  tmp
proc create*(T: type gen_qcamerainfo_types.QCameraInfo,
    fromVal: gen_qcamerainfo_types.QCameraInfo): gen_qcamerainfo_types.QCameraInfo =
  let tmp = gen_qcamerainfo_types.QCameraInfo(h: fcQCameraInfo_new3(fromVal.h), owned: true)
  tmp
proc create*(T: type gen_qcamerainfo_types.QCameraInfo,
