...
proc fcQVideoFrame_setRotationAngle(self: pointer, angle: cint): void {.importc: "QVideoFrame_setRotationAngle".}
proc fcQVideoFrame_rotationAngle(self: pointer): cint {.importc: "QVideoFrame_rotationAngle".}
proc fcQVideoFrame_setRotation(self: pointer, angle: cint): void {.importc: "QVideoFrame_setRotation".}
proc fcQVideoFrame_rotation(self: pointer): cint {.importc: "QVideoFrame_rotation".}
...
proc fcQVideoFrame_setStreamFrameRate(self: pointer, rate: float64): void {.importc: "QVideoFrame_setStreamFrameRate".}
proc fcQVideoFrame_streamFrameRate(self: pointer): float64 {.importc: "QVideoFrame_streamFrameRate".}
proc fcQVideoFrame_toImage(self: pointer): pointer {.importc: "QVideoFrame_toImage".}
proc fcQVideoFrame_subtitleText(self: pointer): struct_seaqt_string {.importc: "QVideoFrame_subtitleText".}
...
proc fcQVideoFrame_staticMetaObject(): pointer {.importc: "QVideoFrame_staticMetaObject".}
...
proc setRotationAngle*(self: gen_qvideoframe_types.QVideoFrame, angle: cint): void =
  fcQVideoFrame_setRotationAngle(self.h, cint(angle))

proc rotationAngle*(self: gen_qvideoframe_types.QVideoFrame): cint =
  cint(fcQVideoFrame_rotationAngle(self.h))

proc setRotation*(self: gen_qvideoframe_types.QVideoFrame, angle: cint): void =
  fcQVideoFrame_setRotation(self.h, cint(angle))

proc rotation*(self: gen_qvideoframe_types.QVideoFrame): cint =
  cint(fcQVideoFrame_rotation(self.h))
...
proc setStreamFrameRate*(self: gen_qvideoframe_types.QVideoFrame, rate: float64): void =
  fcQVideoFrame_setStreamFrameRate(self.h, rate)

proc streamFrameRate*(self: gen_qvideoframe_types.QVideoFrame): float64 =
  fcQVideoFrame_streamFrameRate(self.h)
...
proc setSubtitleText*(self: gen_qvideoframe_types.QVideoFrame, text: openArray[char]): void =
  fcQVideoFrame_setSubtitleText(self.h, struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))))
...
proc create*(T: type gen_qvideoframe_types.QVideoFrame,
  ...
  tmp
proc staticMetaObject*(_: type gen_qvideoframe_types.QVideoFrame): gen_qobjectdefs_types.QMetaObject =
  gen_qobjectdefs_types.QMetaObject(h: fcQVideoFrame_staticMetaObject())
...
proc aspectRatioMode*(self: gen_qvideoframe_types.QVideoFramePaintOptions): cint =
  cint(fcQVideoFramePaintOptions_aspectRatioMode(self.h))

proc setAspectRatioMode*(self: gen_qvideoframe_types.QVideoFramePaintOptions, aspectRatioMode: cint): void =
  fcQVideoFramePaintOptions_setAspectRatioMode(self.h, cint(aspectRatioMode))

proc paintFlags*(self: gen_qvideoframe_types.QVideoFramePaintOptions): cint =
  cint(fcQVideoFramePaintOptions_paintFlags(self.h))
