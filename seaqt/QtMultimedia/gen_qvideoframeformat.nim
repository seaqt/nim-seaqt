...
proc fcQVideoFrameFormat_streamFrameRate(self: pointer): float64 {.importc: "QVideoFrameFormat_streamFrameRate".}
proc fcQVideoFrameFormat_setStreamFrameRate(self: pointer, rate: float64): void {.importc: "QVideoFrameFormat_setStreamFrameRate".}
...
proc fcQVideoFrameFormat_rotation(self: pointer): cint {.importc: "QVideoFrameFormat_rotation".}
proc fcQVideoFrameFormat_setRotation(self: pointer, rotation: cint): void {.importc: "QVideoFrameFormat_setRotation".}
proc fcQVideoFrameFormat_vertexShaderFileName(self: pointer): struct_seaqt_string {.importc: "QVideoFrameFormat_vertexShaderFileName".}
proc fcQVideoFrameFormat_fragmentShaderFileName(self: pointer): struct_seaqt_string {.importc: "QVideoFrameFormat_fragmentShaderFileName".}
...
proc fcQVideoFrameFormat_staticMetaObject(): pointer {.importc: "QVideoFrameFormat_staticMetaObject".}
...
proc streamFrameRate*(self: gen_qvideoframeformat_types.QVideoFrameFormat): float64 =
  fcQVideoFrameFormat_streamFrameRate(self.h)

proc setStreamFrameRate*(self: gen_qvideoframeformat_types.QVideoFrameFormat, rate: float64): void =
  fcQVideoFrameFormat_setStreamFrameRate(self.h, rate)
...
proc rotation*(self: gen_qvideoframeformat_types.QVideoFrameFormat): cint =
  cint(fcQVideoFrameFormat_rotation(self.h))

proc setRotation*(self: gen_qvideoframeformat_types.QVideoFrameFormat, rotation: cint): void =
  fcQVideoFrameFormat_setRotation(self.h, cint(rotation))
...
proc create*(T: type gen_qvideoframeformat_types.QVideoFrameFormat): gen_qvideoframeformat_types.QVideoFrameFormat =
  let tmp = gen_qvideoframeformat_types.QVideoFrameFormat(h: fcQVideoFrameFormat_new(), owned: true)
  tmp
...
proc create*(T: type gen_qvideoframeformat_types.QVideoFrameFormat,
  ...
  tmp
proc staticMetaObject*(_: type gen_qvideoframeformat_types.QVideoFrameFormat): gen_qobjectdefs_types.QMetaObject =
  gen_qobjectdefs_types.QMetaObject(h: fcQVideoFrameFormat_staticMetaObject())
