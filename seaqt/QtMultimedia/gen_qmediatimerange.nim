...
proc fcQMediaTimeRangeInterval_operatorAssign(self: pointer, param1: pointer): void {.importc: "QMediaTimeRange__Interval_operatorAssign".}
...
proc create*(T: type gen_qmediatimerange_types.QMediaTimeRange): gen_qmediatimerange_types.QMediaTimeRange =
  let tmp = gen_qmediatimerange_types.QMediaTimeRange(h: fcQMediaTimeRange_new())
  tmp
proc create*(T: type gen_qmediatimerange_types.QMediaTimeRange,
  ...
  let tmp = gen_qmediatimerange_types.QMediaTimeRange(h: fcQMediaTimeRange_new2(start, endVal))
  tmp
proc create*(T: type gen_qmediatimerange_types.QMediaTimeRange,
    param1: gen_qmediatimerange_types.QMediaTimeRangeInterval): gen_qmediatimerange_types.QMediaTimeRange =
  let tmp = gen_qmediatimerange_types.QMediaTimeRange(h: fcQMediaTimeRange_new3(param1.h))
  tmp
proc create*(T: type gen_qmediatimerange_types.QMediaTimeRange,
    range: gen_qmediatimerange_types.QMediaTimeRange): gen_qmediatimerange_types.QMediaTimeRange =
  let tmp = gen_qmediatimerange_types.QMediaTimeRange(h: fcQMediaTimeRange_new4(range.h))
  tmp
...
proc operatorAssign*(self: gen_qmediatimerange_types.QMediaTimeRangeInterval, param1: gen_qmediatimerange_types.QMediaTimeRangeInterval): void =
  fcQMediaTimeRangeInterval_operatorAssign(self.h, param1.h)

proc create*(T: type gen_qmediatimerange_types.QMediaTimeRangeInterval): gen_qmediatimerange_types.QMediaTimeRangeInterval =
  let tmp = gen_qmediatimerange_types.QMediaTimeRangeInterval(h: fcQMediaTimeRangeInterval_new())
  tmp
proc create*(T: type gen_qmediatimerange_types.QMediaTimeRangeInterval,
  ...
  let tmp = gen_qmediatimerange_types.QMediaTimeRangeInterval(h: fcQMediaTimeRangeInterval_new2(start, endVal))
  tmp
proc create*(T: type gen_qmediatimerange_types.QMediaTimeRangeInterval,
    param1: gen_qmediatimerange_types.QMediaTimeRangeInterval): gen_qmediatimerange_types.QMediaTimeRangeInterval =
  let tmp = gen_qmediatimerange_types.QMediaTimeRangeInterval(h: fcQMediaTimeRangeInterval_new3(param1.h))
  tmp
