...
proc cQCameraExposureControl_slot_callback_requestedValueChanged(slot: int, parameter: cint) {.cdecl.} =
  let nimfunc = cast[ptr QCameraExposureControlrequestedValueChangedSlot](cast[pointer](slot))
  let slotval1 = parameter

  nimfunc[](slotval1)

proc cQCameraExposureControl_slot_callback_requestedValueChanged_release(slot: int) {.cdecl.} =
...
proc onrequestedValueChanged*(self: gen_qcameraexposurecontrol_types.QCameraExposureControl, slot: QCameraExposureControlrequestedValueChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQCameraExposureControl_connect_requestedValueChanged(self.h, cast[int](addr tmp[]), cQCameraExposureControl_slot_callback_requestedValueChanged, cQCameraExposureControl_slot_callback_requestedValueChanged_release)
...
proc cQCameraExposureControl_slot_callback_actualValueChanged(slot: int, parameter: cint) {.cdecl.} =
  let nimfunc = cast[ptr QCameraExposureControlactualValueChangedSlot](cast[pointer](slot))
  let slotval1 = parameter

  nimfunc[](slotval1)

proc cQCameraExposureControl_slot_callback_actualValueChanged_release(slot: int) {.cdecl.} =
...
proc onactualValueChanged*(self: gen_qcameraexposurecontrol_types.QCameraExposureControl, slot: QCameraExposureControlactualValueChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQCameraExposureControl_connect_actualValueChanged(self.h, cast[int](addr tmp[]), cQCameraExposureControl_slot_callback_actualValueChanged, cQCameraExposureControl_slot_callback_actualValueChanged_release)
...
proc cQCameraExposureControl_slot_callback_parameterRangeChanged(slot: int, parameter: cint) {.cdecl.} =
  let nimfunc = cast[ptr QCameraExposureControlparameterRangeChangedSlot](cast[pointer](slot))
  let slotval1 = parameter

  nimfunc[](slotval1)

proc cQCameraExposureControl_slot_callback_parameterRangeChanged_release(slot: int) {.cdecl.} =
...
proc onparameterRangeChanged*(self: gen_qcameraexposurecontrol_types.QCameraExposureControl, slot: QCameraExposureControlparameterRangeChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQCameraExposureControl_connect_parameterRangeChanged(self.h, cast[int](addr tmp[]), cQCameraExposureControl_slot_callback_parameterRangeChanged, cQCameraExposureControl_slot_callback_parameterRangeChanged_release)
