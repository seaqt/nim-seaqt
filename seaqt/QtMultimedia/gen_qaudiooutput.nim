...
proc fcQAudioOutput_new2(vtbl: pointer, vdata: csize_t, device: pointer): ptr cQAudioOutput {.importc: "QAudioOutput_new_device".}
proc fcQAudioOutput_new3(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQAudioOutput {.importc: "QAudioOutput_new_parent".}
proc fcQAudioOutput_new4(vtbl: pointer, vdata: csize_t, device: pointer, parent: pointer): ptr cQAudioOutput {.importc: "QAudioOutput_new_device_parent".}
...
proc fcQAudioOutput_slot_callback_deviceChanged(slot: int) {.cdecl.} =
  let nimfunc = cast[ptr QAudioOutputdeviceChangedSlot](cast[pointer](slot))
  nimfunc[]()

proc fcQAudioOutput_slot_callback_deviceChanged_release(slot: int) {.cdecl.} =
...
proc onDeviceChanged*(self: gen_qaudiooutput_types.QAudioOutput, slot: QAudioOutputdeviceChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQAudioOutput_connect_deviceChanged(self.h, cast[int](addr tmp[]), fcQAudioOutput_slot_callback_deviceChanged, fcQAudioOutput_slot_callback_deviceChanged_release)
...
proc fcQAudioOutput_slot_callback_volumeChanged(slot: int, volume: float32) {.cdecl.} =
  let nimfunc = cast[ptr QAudioOutputvolumeChangedSlot](cast[pointer](slot))
  let slotval1 = volume

  nimfunc[](slotval1)

proc fcQAudioOutput_slot_callback_volumeChanged_release(slot: int) {.cdecl.} =
...
proc onVolumeChanged*(self: gen_qaudiooutput_types.QAudioOutput, slot: QAudioOutputvolumeChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQAudioOutput_connect_volumeChanged(self.h, cast[int](addr tmp[]), fcQAudioOutput_slot_callback_volumeChanged, fcQAudioOutput_slot_callback_volumeChanged_release)
...
proc fcQAudioOutput_slot_callback_mutedChanged(slot: int, muted: bool) {.cdecl.} =
  let nimfunc = cast[ptr QAudioOutputmutedChangedSlot](cast[pointer](slot))
  let slotval1 = muted

  nimfunc[](slotval1)

proc fcQAudioOutput_slot_callback_mutedChanged_release(slot: int) {.cdecl.} =
...
proc onMutedChanged*(self: gen_qaudiooutput_types.QAudioOutput, slot: QAudioOutputmutedChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQAudioOutput_connect_mutedChanged(self.h, cast[int](addr tmp[]), fcQAudioOutput_slot_callback_mutedChanged, fcQAudioOutput_slot_callback_mutedChanged_release)
...
proc create*(T: type gen_qaudiooutput_types.QAudioOutput,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQAudioOutput_vtable_callback_disconnectNotify
  let tmp = gen_qaudiooutput_types.QAudioOutput(h: fcQAudioOutput_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), device.h), owned: true)
  fcQAudioOutput_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qaudiooutput_types.QAudioOutput,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQAudioOutput_vtable_callback_disconnectNotify
  let tmp = gen_qaudiooutput_types.QAudioOutput(h: fcQAudioOutput_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQAudioOutput_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qaudiooutput_types.QAudioOutput,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQAudioOutput_vtable_callback_disconnectNotify
  let tmp = gen_qaudiooutput_types.QAudioOutput(h: fcQAudioOutput_new4(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), device.h, parent.h), owned: true)
  fcQAudioOutput_vdata(tmp.h)[] = addr(vtbl[])
  tmp
...
proc create*(T: type gen_qaudiooutput_types.QAudioOutput,
    ...
    inst: VirtualQAudioOutput) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQAudioOutput_new2(addr(cQAudioOutput_mvtbl), csize_t(sizeof(pointer)), device.h)
  fcQAudioOutput_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qaudiooutput_types.QAudioOutput,
    ...
    inst: VirtualQAudioOutput) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQAudioOutput_new3(addr(cQAudioOutput_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQAudioOutput_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qaudiooutput_types.QAudioOutput,
    ...
    inst: VirtualQAudioOutput) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQAudioOutput_new4(addr(cQAudioOutput_mvtbl), csize_t(sizeof(pointer)), device.h, parent.h)
  fcQAudioOutput_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
