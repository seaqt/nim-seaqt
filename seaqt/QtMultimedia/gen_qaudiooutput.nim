...
proc fcQAudioOutput_trS(s: cstring): struct_seaqt_string {.importc: "QAudioOutput_tr_s".}
proc fcQAudioOutput_trUtf8S(s: cstring): struct_seaqt_string {.importc: "QAudioOutput_trUtf8_s".}
proc fcQAudioOutput_format(self: pointer): pointer {.importc: "QAudioOutput_format".}
proc fcQAudioOutput_startDevice(self: pointer, device: pointer): void {.importc: "QAudioOutput_start_device".}
proc fcQAudioOutput_start(self: pointer): pointer {.importc: "QAudioOutput_start".}
...
proc fcQAudioOutput_category(self: pointer): struct_seaqt_string {.importc: "QAudioOutput_category".}
proc fcQAudioOutput_setCategory(self: pointer, category: struct_seaqt_string): void {.importc: "QAudioOutput_setCategory".}
...
proc fcQAudioOutput_trSC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QAudioOutput_tr_s_c".}
proc fcQAudioOutput_trSCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QAudioOutput_tr_s_c_n".}
proc fcQAudioOutput_trUtf8SC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QAudioOutput_trUtf8_s_c".}
proc fcQAudioOutput_trUtf8SCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QAudioOutput_trUtf8_s_c_n".}
proc fcQAudioOutput_vdata(self: pointer): ptr pointer {.importc: "QAudioOutput_vdata".}
proc fvdata_cQAudioOutput(self: pointer): pointer {.importc: "vdata_QAudioOutput".}
...
proc fcQAudioOutput_new(vtbl: pointer, vdata: csize_t): ptr cQAudioOutput {.importc: "QAudioOutput_new".}
proc fcQAudioOutput_new2(vtbl: pointer, vdata: csize_t, audioDeviceInfo: pointer): ptr cQAudioOutput {.importc: "QAudioOutput_new_audioDeviceInfo".}
proc fcQAudioOutput_new3(vtbl: pointer, vdata: csize_t, format: pointer): ptr cQAudioOutput {.importc: "QAudioOutput_new_format".}
proc fcQAudioOutput_new4(vtbl: pointer, vdata: csize_t, format: pointer, parent: pointer): ptr cQAudioOutput {.importc: "QAudioOutput_new_format_parent".}
proc fcQAudioOutput_new5(vtbl: pointer, vdata: csize_t, audioDeviceInfo: pointer, format: pointer): ptr cQAudioOutput {.importc: "QAudioOutput_new_audioDeviceInfo_format".}
proc fcQAudioOutput_new6(vtbl: pointer, vdata: csize_t, audioDeviceInfo: pointer, format: pointer, parent: pointer): ptr cQAudioOutput {.importc: "QAudioOutput_new_audioDeviceInfo_format_parent".}
...
proc start*(self: gen_qaudiooutput_types.QAudioOutput, device: gen_qiodevice_types.QIODevice): void =
  fcQAudioOutput_startDevice(self.h, device.h)

proc start*(self: gen_qaudiooutput_types.QAudioOutput): gen_qiodevice_types.QIODevice =
  gen_qiodevice_types.QIODevice(h: fcQAudioOutput_start(self.h), owned: false)
...
proc setCategory*(self: gen_qaudiooutput_types.QAudioOutput, category: openArray[char]): void =
  fcQAudioOutput_setCategory(self.h, struct_seaqt_string(data: if len(category) > 0: addr category[0] else: nil, len: csize_t(len(category))))
...
proc create*(T: type gen_qaudiooutput_types.QAudioOutput,
  ...
  let tmp = gen_qaudiooutput_types.QAudioOutput(h: fcQAudioOutput_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQAudioOutput_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qaudiooutput_types.QAudioOutput,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQAudioOutput_vtable_callback_disconnectNotify
  let tmp = gen_qaudiooutput_types.QAudioOutput(h: fcQAudioOutput_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), audioDeviceInfo.h), owned: true)
  fcQAudioOutput_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qaudiooutput_types.QAudioOutput,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQAudioOutput_vtable_callback_disconnectNotify
  let tmp = gen_qaudiooutput_types.QAudioOutput(h: fcQAudioOutput_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), format.h), owned: true)
  fcQAudioOutput_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qaudiooutput_types.QAudioOutput,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQAudioOutput_vtable_callback_disconnectNotify
  let tmp = gen_qaudiooutput_types.QAudioOutput(h: fcQAudioOutput_new4(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), format.h, parent.h), owned: true)
  fcQAudioOutput_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qaudiooutput_types.QAudioOutput,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQAudioOutput_vtable_callback_disconnectNotify
  let tmp = gen_qaudiooutput_types.QAudioOutput(h: fcQAudioOutput_new5(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), audioDeviceInfo.h, format.h), owned: true)
  fcQAudioOutput_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qaudiooutput_types.QAudioOutput,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQAudioOutput_vtable_callback_disconnectNotify
  let tmp = gen_qaudiooutput_types.QAudioOutput(h: fcQAudioOutput_new6(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), audioDeviceInfo.h, format.h, parent.h), owned: true)
  fcQAudioOutput_vdata(tmp.h)[] = addr(vtbl[])
  tmp
const cQAudioOutput_mvtbl = cQAudioOutputVTable(
  destructor: proc(self: pointer) {.cdecl.} =
    let inst = cast[ptr typeof(VirtualQAudioOutput()[])](self.fcQAudioOutput_vdata()[])
    inst[].h = nil
    inst[].owned = false,
...
proc create*(T: type gen_qaudiooutput_types.QAudioOutput,
  ...
  inst[].h = fcQAudioOutput_new(addr(cQAudioOutput_mvtbl), csize_t(sizeof(pointer)))
  fcQAudioOutput_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qaudiooutput_types.QAudioOutput,
    ...
    inst: VirtualQAudioOutput) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQAudioOutput_new2(addr(cQAudioOutput_mvtbl), csize_t(sizeof(pointer)), audioDeviceInfo.h)
  fcQAudioOutput_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qaudiooutput_types.QAudioOutput,
    ...
    inst: VirtualQAudioOutput) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQAudioOutput_new3(addr(cQAudioOutput_mvtbl), csize_t(sizeof(pointer)), format.h)
  fcQAudioOutput_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qaudiooutput_types.QAudioOutput,
    ...
    inst: VirtualQAudioOutput) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQAudioOutput_new4(addr(cQAudioOutput_mvtbl), csize_t(sizeof(pointer)), format.h, parent.h)
  fcQAudioOutput_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qaudiooutput_types.QAudioOutput,
    ...
    inst: VirtualQAudioOutput) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQAudioOutput_new5(addr(cQAudioOutput_mvtbl), csize_t(sizeof(pointer)), audioDeviceInfo.h, format.h)
  fcQAudioOutput_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qaudiooutput_types.QAudioOutput,
    ...
    inst: VirtualQAudioOutput) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQAudioOutput_new6(addr(cQAudioOutput_mvtbl), csize_t(sizeof(pointer)), audioDeviceInfo.h, format.h, parent.h)
  fcQAudioOutput_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
