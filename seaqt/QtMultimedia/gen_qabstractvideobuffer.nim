...
proc fcQAbstractPlanarVideoBuffer_vtable_callback_map(self: pointer, mode: cint, numBytes: ptr cint, bytesPerLine: ptr cint): ptr uint8 {.cdecl.} =
...
proc fcQAbstractPlanarVideoBuffer_vtable_callback_release(self: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QAbstractPlanarVideoBufferVTable](fcQAbstractPlanarVideoBuffer_vdata(self))
  let self = QAbstractPlanarVideoBuffer(h: self)
  vtbl[].release(self)

proc fcQAbstractPlanarVideoBuffer_vtable_callback_mapMode(self: pointer): cint {.cdecl.} =
  let vtbl = cast[ptr QAbstractPlanarVideoBufferVTable](fcQAbstractPlanarVideoBuffer_vdata(self))
  let self = QAbstractPlanarVideoBuffer(h: self)
  var virtualReturn = vtbl[].mapMode(self)
  cint(virtualReturn)

proc fcQAbstractPlanarVideoBuffer_vtable_callback_unmap(self: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QAbstractPlanarVideoBufferVTable](fcQAbstractPlanarVideoBuffer_vdata(self))
  let self = QAbstractPlanarVideoBuffer(h: self)
  vtbl[].unmap(self)

proc fcQAbstractPlanarVideoBuffer_vtable_callback_handle(self: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QAbstractPlanarVideoBufferVTable](fcQAbstractPlanarVideoBuffer_vdata(self))
  let self = QAbstractPlanarVideoBuffer(h: self)
  var virtualReturn = vtbl[].handle(self)
  virtualReturn.owned = false # TODO move?
...
method mapMode*(self: VirtualQAbstractPlanarVideoBuffer): cint {.base.} =
  raiseAssert("missing implementation of QAbstractPlanarVideoBuffer.mapMode")
method unmap*(self: VirtualQAbstractPlanarVideoBuffer): void {.base.} =
  raiseAssert("missing implementation of QAbstractPlanarVideoBuffer.unmap")
...
proc fcQAbstractPlanarVideoBuffer_method_callback_map(self: pointer, mode: cint, numBytes: ptr cint, bytesPerLine: ptr cint): ptr uint8 {.cdecl.} =
...
proc fcQAbstractPlanarVideoBuffer_method_callback_release(self: pointer): void {.cdecl.} =
  let inst = cast[VirtualQAbstractPlanarVideoBuffer](fcQAbstractPlanarVideoBuffer_vdata(self))
  inst.release()

proc fcQAbstractPlanarVideoBuffer_method_callback_mapMode(self: pointer): cint {.cdecl.} =
  let inst = cast[VirtualQAbstractPlanarVideoBuffer](fcQAbstractPlanarVideoBuffer_vdata(self))
  var virtualReturn = inst.mapMode()
  cint(virtualReturn)

proc fcQAbstractPlanarVideoBuffer_method_callback_unmap(self: pointer): void {.cdecl.} =
  let inst = cast[VirtualQAbstractPlanarVideoBuffer](fcQAbstractPlanarVideoBuffer_vdata(self))
  inst.unmap()

proc fcQAbstractPlanarVideoBuffer_method_callback_handle(self: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQAbstractPlanarVideoBuffer](fcQAbstractPlanarVideoBuffer_vdata(self))
  var virtualReturn = inst.handle()
  virtualReturn.owned = false # TODO move?
  let virtualReturn_h = virtualReturn.h
...
proc create*(T: type gen_qabstractvideobuffer_types.QAbstractPlanarVideoBuffer,
  ...
  vtbl[].vtbl.destructor = proc(self: pointer) {.cdecl.} =
    ...
    GC_unref(vtbl)
  if not isNil(vtbl[].map):
    vtbl[].vtbl.map = fcQAbstractPlanarVideoBuffer_vtable_callback_map
  if not isNil(vtbl[].release):
    vtbl[].vtbl.release = fcQAbstractPlanarVideoBuffer_vtable_callback_release
  if not isNil(vtbl[].mapMode):
    vtbl[].vtbl.mapMode = fcQAbstractPlanarVideoBuffer_vtable_callback_mapMode
  if not isNil(vtbl[].unmap):
    vtbl[].vtbl.unmap = fcQAbstractPlanarVideoBuffer_vtable_callback_unmap
  if not isNil(vtbl[].handle):
    vtbl[].vtbl.handle = fcQAbstractPlanarVideoBuffer_vtable_callback_handle
...
const cQAbstractPlanarVideoBuffer_mvtbl = cQAbstractPlanarVideoBufferVTable(
  ...
  map: fcQAbstractPlanarVideoBuffer_method_callback_map,
  release: fcQAbstractPlanarVideoBuffer_method_callback_release,
  mapMode: fcQAbstractPlanarVideoBuffer_method_callback_mapMode,
  unmap: fcQAbstractPlanarVideoBuffer_method_callback_unmap,
  handle: fcQAbstractPlanarVideoBuffer_method_callback_handle,
)
proc create*(T: type gen_qabstractvideobuffer_types.QAbstractPlanarVideoBuffer,
    typeVal: cint,
