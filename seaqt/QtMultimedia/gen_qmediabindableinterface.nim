...
proc fcQMediaBindableInterface_operatorAssign(self: pointer, fromVal: pointer): void {.importc: "QMediaBindableInterface_operatorAssign".}
...
proc operatorAssign*(self: gen_qmediabindableinterface_types.QMediaBindableInterface, fromVal: gen_qmediabindableinterface_types.QMediaBindableInterface): void =
  fcQMediaBindableInterface_operatorAssign(self.h, fromVal.h)
