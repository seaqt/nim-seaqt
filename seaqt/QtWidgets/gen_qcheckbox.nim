...
type QCheckBoxnativeEventProc* = proc(self: QCheckBox, eventType: openArray[byte], message: pointer, resultVal: ptr clong): bool {.raises: [], gcsafe.}
...
proc QCheckBoxnativeEvent*(self: gen_qcheckbox_types.QCheckBox, eventType: openArray[byte], message: pointer, resultVal: ptr clong): bool =
...
method nativeEvent*(self: VirtualQCheckBox, eventType: openArray[byte], message: pointer, resultVal: ptr clong): bool {.base.} =
