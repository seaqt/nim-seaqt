...
proc fcQCheckBox_new2(vtbl: pointer, vdata: csize_t, text: struct_seaqt_string): ptr cQCheckBox {.importc: "QCheckBox_new2".}
proc fcQCheckBox_new3(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQCheckBox {.importc: "QCheckBox_new3".}
