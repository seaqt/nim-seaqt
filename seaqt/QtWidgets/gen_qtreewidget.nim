...
proc fcQTreeWidget_trUtf8(s: cstring): struct_seaqt_string {.importc: "QTreeWidget_trUtf8".}
...
proc fcQTreeWidget_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QTreeWidget_trUtf82".}
proc fcQTreeWidget_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QTreeWidget_trUtf83".}
...
proc fcQTreeWidget_protectedbase_indexFromItem3(self: pointer, item: pointer, column: cint): pointer {.importc: "QTreeWidget_protectedbase_indexFromItem3".}
...
proc indexFromItem*(self: gen_qtreewidget_types.QTreeWidget, item: gen_qtreewidget_types.QTreeWidgetItem, column: cint): gen_qabstractitemmodel_types.QModelIndex =
  gen_qabstractitemmodel_types.QModelIndex(h: fcQTreeWidget_protectedbase_indexFromItem3(self.h, item.h, column), owned: true)
