...
proc fcQTreeWidget_new(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQTreeWidget {.importc: "QTreeWidget_new".}
proc fcQTreeWidget_new2(vtbl: pointer, vdata: csize_t): ptr cQTreeWidget {.importc: "QTreeWidget_new2".}
