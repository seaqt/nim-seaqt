...
proc fcQTreeWidget_trUtf8S(s: cstring): struct_seaqt_string {.importc: "QTreeWidget_trUtf8_s".}
...
proc fcQTreeWidget_trUtf8SC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QTreeWidget_trUtf8_s_c".}
proc fcQTreeWidget_trUtf8SCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QTreeWidget_trUtf8_s_c_n".}
...
proc fcQTreeWidget_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.importc: "QTreeWidget_virtualbase_nativeEvent".}
...
proc fcQTreeWidget_protectedbase_items(self: pointer, data: pointer): struct_seaqt_array {.importc: "QTreeWidget_protectedbase_items".}
proc fcQTreeWidget_protectedbase_indexFromItem_const_pcQTreeWidgetItem(self: pointer, item: pointer): pointer {.importc: "QTreeWidget_protectedbase_indexFromItem_const_pcQTreeWidgetItem".}
proc fcQTreeWidget_protectedbase_indexFromItem_const_pQTreeWidgetItem(self: pointer, item: pointer): pointer {.importc: "QTreeWidget_protectedbase_indexFromItem_const_pQTreeWidgetItem".}
...
proc fcQTreeWidget_protectedbase_indexFromItem_const_pcQTreeWidgetItem_int(self: pointer, item: pointer, column: cint): pointer {.importc: "QTreeWidget_protectedbase_indexFromItem_const_pcQTreeWidgetItem_int".}
proc fcQTreeWidget_protectedbase_indexFromItem_const_pQTreeWidgetItem_int(self: pointer, item: pointer, column: cint): pointer {.importc: "QTreeWidget_protectedbase_indexFromItem_const_pQTreeWidgetItem_int".}
...
proc fcQTreeWidget_new(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQTreeWidget {.importc: "QTreeWidget_new_parent".}
proc fcQTreeWidget_new2(vtbl: pointer, vdata: csize_t): ptr cQTreeWidget {.importc: "QTreeWidget_new".}
...
proc trUtf8*(_: type gen_qtreewidget_types.QTreeWidget, s: cstring): string =
  let v_ms = fcQTreeWidget_trUtf8S(s)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc fcQTreeWidget_vtable_callback_viewOptions(self: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QTreeWidgetVTable](fcQTreeWidget_vdata(self)[])
  let self = QTreeWidget(h: self)
...
proc fcQTreeWidget_vtable_callback_changeEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTreeWidgetVTable](fcQTreeWidget_vdata(self)[])
  let self = QTreeWidget(h: self)
...
proc fcQTreeWidget_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let vtbl = cast[ptr QTreeWidgetVTable](fcQTreeWidget_vdata(self)[])
  let self = QTreeWidget(h: self)
...
proc fcQTreeWidget_method_callback_viewOptions(self: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQTreeWidget](fcQTreeWidget_vdata(self)[])
...
proc fcQTreeWidget_method_callback_changeEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTreeWidget](fcQTreeWidget_vdata(self)[])
  let slotval1 = gen_qcoreevent_types.QEvent(h: param1, owned: false)
...
proc fcQTreeWidget_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let inst = cast[VirtualQTreeWidget](fcQTreeWidget_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc indexFromItem*(self: gen_qtreewidget_types.QTreeWidget, item: gen_qtreewidget_types.QTreeWidgetItem): gen_qabstractitemmodel_types.QModelIndex =
  gen_qabstractitemmodel_types.QModelIndex(h: fcQTreeWidget_protectedbase_indexFromItem_const_pcQTreeWidgetItem(self.h, item.h), owned: true)

proc indexFromItem*(self: gen_qtreewidget_types.QTreeWidget, item: gen_qtreewidget_types.QTreeWidgetItem): gen_qabstractitemmodel_types.QModelIndex =
  gen_qabstractitemmodel_types.QModelIndex(h: fcQTreeWidget_protectedbase_indexFromItem_const_pQTreeWidgetItem(self.h, item.h), owned: true)
...
proc indexFromItem*(self: gen_qtreewidget_types.QTreeWidget, item: gen_qtreewidget_types.QTreeWidgetItem, column: cint): gen_qabstractitemmodel_types.QModelIndex =
  gen_qabstractitemmodel_types.QModelIndex(h: fcQTreeWidget_protectedbase_indexFromItem_const_pcQTreeWidgetItem_int(self.h, item.h, column), owned: true)

proc indexFromItem*(self: gen_qtreewidget_types.QTreeWidget, item: gen_qtreewidget_types.QTreeWidgetItem, column: cint): gen_qabstractitemmodel_types.QModelIndex =
  gen_qabstractitemmodel_types.QModelIndex(h: fcQTreeWidget_protectedbase_indexFromItem_const_pQTreeWidgetItem_int(self.h, item.h, column), owned: true)
...
proc create*(T: type gen_qtreewidget_types.QTreeWidget,
  ...
  if not isNil(vtbl[].viewOptions):
    vtbl[].vtbl.viewOptions = fcQTreeWidget_vtable_callback_viewOptions
  ...
  let tmp = gen_qtreewidget_types.QTreeWidget(h: fcQTreeWidget_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
...
proc create*(T: type gen_qtreewidget_types.QTreeWidget,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQTreeWidget_vtable_callback_disconnectNotify
  let tmp = gen_qtreewidget_types.QTreeWidget(h: fcQTreeWidget_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQTreeWidget_vdata(tmp.h)[] = addr(vtbl[])
  tmp
const cQTreeWidget_mvtbl = cQTreeWidgetVTable(
  ...
  viewOptions: fcQTreeWidget_method_callback_viewOptions,
...
proc create*(T: type gen_qtreewidget_types.QTreeWidget,
  ...
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQTreeWidget_new(addr(cQTreeWidget_mvtbl), csize_t(sizeof(pointer)), parent.h)
...
proc create*(T: type gen_qtreewidget_types.QTreeWidget,
    inst: VirtualQTreeWidget) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQTreeWidget_new2(addr(cQTreeWidget_mvtbl), csize_t(sizeof(pointer)))
  fcQTreeWidget_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
