...
proc fcQTreeWidgetItem_new2(vtbl: pointer, vdata: csize_t, strings: struct_miqt_array): ptr cQTreeWidgetItem {.importc: "QTreeWidgetItem_new2".}
...
proc fcQTreeWidgetItem_new4(vtbl: pointer, vdata: csize_t, treeview: pointer, strings: struct_miqt_array): ptr cQTreeWidgetItem {.importc: "QTreeWidgetItem_new4".}
...
proc fcQTreeWidgetItem_new7(vtbl: pointer, vdata: csize_t, parent: pointer, strings: struct_miqt_array): ptr cQTreeWidgetItem {.importc: "QTreeWidgetItem_new7".}
...
proc fcQTreeWidgetItem_new11(vtbl: pointer, vdata: csize_t, strings: struct_miqt_array, typeVal: cint): ptr cQTreeWidgetItem {.importc: "QTreeWidgetItem_new11".}
...
proc fcQTreeWidgetItem_new13(vtbl: pointer, vdata: csize_t, treeview: pointer, strings: struct_miqt_array, typeVal: cint): ptr cQTreeWidgetItem {.importc: "QTreeWidgetItem_new13".}
...
proc fcQTreeWidgetItem_new16(vtbl: pointer, vdata: csize_t, parent: pointer, strings: struct_miqt_array, typeVal: cint): ptr cQTreeWidgetItem {.importc: "QTreeWidgetItem_new16".}
...
proc create*(T: type gen_qtreewidget_types.QTreeWidgetItem,
  ...
  if not isNil(vtbl[].write):
    vtbl[].vtbl.write = fcQTreeWidgetItem_vtable_callback_write
  let tmp = gen_qtreewidget_types.QTreeWidgetItem(h: fcQTreeWidgetItem_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_miqt_array(len: csize_t(len(strings)), data: if len(strings) == 0: nil else: addr(strings_CArray[0]))), owned: true)
  fcQTreeWidgetItem_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qtreewidget_types.QTreeWidgetItem,
...
proc create*(T: type gen_qtreewidget_types.QTreeWidgetItem,
  ...
  if not isNil(vtbl[].write):
    vtbl[].vtbl.write = fcQTreeWidgetItem_vtable_callback_write
  let tmp = gen_qtreewidget_types.QTreeWidgetItem(h: fcQTreeWidgetItem_new4(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), treeview.h, struct_miqt_array(len: csize_t(len(strings)), data: if len(strings) == 0: nil else: addr(strings_CArray[0]))), owned: true)
  fcQTreeWidgetItem_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qtreewidget_types.QTreeWidgetItem,
...
proc create*(T: type gen_qtreewidget_types.QTreeWidgetItem,
  ...
  if not isNil(vtbl[].write):
    vtbl[].vtbl.write = fcQTreeWidgetItem_vtable_callback_write
  let tmp = gen_qtreewidget_types.QTreeWidgetItem(h: fcQTreeWidgetItem_new7(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h, struct_miqt_array(len: csize_t(len(strings)), data: if len(strings) == 0: nil else: addr(strings_CArray[0]))), owned: true)
  fcQTreeWidgetItem_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qtreewidget_types.QTreeWidgetItem,
...
proc create*(T: type gen_qtreewidget_types.QTreeWidgetItem,
  ...
  if not isNil(vtbl[].write):
    vtbl[].vtbl.write = fcQTreeWidgetItem_vtable_callback_write
  let tmp = gen_qtreewidget_types.QTreeWidgetItem(h: fcQTreeWidgetItem_new11(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_miqt_array(len: csize_t(len(strings)), data: if len(strings) == 0: nil else: addr(strings_CArray[0])), typeVal), owned: true)
  fcQTreeWidgetItem_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qtreewidget_types.QTreeWidgetItem,
...
proc create*(T: type gen_qtreewidget_types.QTreeWidgetItem,
  ...
  if not isNil(vtbl[].write):
    vtbl[].vtbl.write = fcQTreeWidgetItem_vtable_callback_write
  let tmp = gen_qtreewidget_types.QTreeWidgetItem(h: fcQTreeWidgetItem_new13(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), treeview.h, struct_miqt_array(len: csize_t(len(strings)), data: if len(strings) == 0: nil else: addr(strings_CArray[0])), typeVal), owned: true)
  fcQTreeWidgetItem_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qtreewidget_types.QTreeWidgetItem,
...
proc create*(T: type gen_qtreewidget_types.QTreeWidgetItem,
  ...
  if not isNil(vtbl[].write):
    vtbl[].vtbl.write = fcQTreeWidgetItem_vtable_callback_write
  let tmp = gen_qtreewidget_types.QTreeWidgetItem(h: fcQTreeWidgetItem_new16(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h, struct_miqt_array(len: csize_t(len(strings)), data: if len(strings) == 0: nil else: addr(strings_CArray[0])), typeVal), owned: true)
  fcQTreeWidgetItem_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qtreewidget_types.QTreeWidgetItem,
...
proc create*(T: type gen_qtreewidget_types.QTreeWidgetItem,
  ...
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQTreeWidgetItem_new2(addr(cQTreeWidgetItem_mvtbl), csize_t(sizeof(pointer)), struct_miqt_array(len: csize_t(len(strings)), data: if len(strings) == 0: nil else: addr(strings_CArray[0])))
  fcQTreeWidgetItem_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qtreewidget_types.QTreeWidgetItem,
  ...
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQTreeWidgetItem_new4(addr(cQTreeWidgetItem_mvtbl), csize_t(sizeof(pointer)), treeview.h, struct_miqt_array(len: csize_t(len(strings)), data: if len(strings) == 0: nil else: addr(strings_CArray[0])))
  fcQTreeWidgetItem_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qtreewidget_types.QTreeWidgetItem,
  ...
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQTreeWidgetItem_new7(addr(cQTreeWidgetItem_mvtbl), csize_t(sizeof(pointer)), parent.h, struct_miqt_array(len: csize_t(len(strings)), data: if len(strings) == 0: nil else: addr(strings_CArray[0])))
  fcQTreeWidgetItem_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qtreewidget_types.QTreeWidgetItem,
  ...
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQTreeWidgetItem_new11(addr(cQTreeWidgetItem_mvtbl), csize_t(sizeof(pointer)), struct_miqt_array(len: csize_t(len(strings)), data: if len(strings) == 0: nil else: addr(strings_CArray[0])), typeVal)
  fcQTreeWidgetItem_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qtreewidget_types.QTreeWidgetItem,
  ...
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQTreeWidgetItem_new13(addr(cQTreeWidgetItem_mvtbl), csize_t(sizeof(pointer)), treeview.h, struct_miqt_array(len: csize_t(len(strings)), data: if len(strings) == 0: nil else: addr(strings_CArray[0])), typeVal)
  fcQTreeWidgetItem_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qtreewidget_types.QTreeWidgetItem,
  ...
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQTreeWidgetItem_new16(addr(cQTreeWidgetItem_mvtbl), csize_t(sizeof(pointer)), parent.h, struct_miqt_array(len: csize_t(len(strings)), data: if len(strings) == 0: nil else: addr(strings_CArray[0])), typeVal)
  fcQTreeWidgetItem_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc QTreeWidgetnativeEvent*(self: gen_qtreewidget_types.QTreeWidget, eventType: openArray[byte], message: pointer, resultVal: ptr uint): bool =
  fcQTreeWidget_virtualbase_nativeEvent(self.h, struct_miqt_string(data: if len(eventType) > 0: addr eventType[0] else: nil, len: csize_t(len(eventType))), message, resultVal)
...
proc fcQTreeWidget_vtable_callback_mimeTypes(self: pointer): struct_miqt_array {.cdecl.} =
  let vtbl = cast[ptr QTreeWidgetVTable](fcQTreeWidget_vdata(self)[])
  let self = QTreeWidget(h: self)
...
proc fcQTreeWidget_vtable_callback_mimeData(self: pointer, items: struct_miqt_array): pointer {.cdecl.} =
  let vtbl = cast[ptr QTreeWidgetVTable](fcQTreeWidget_vdata(self)[])
  let self = QTreeWidget(h: self)
  var vitems_ma = items
...
proc fcQTreeWidget_vtable_callback_keyboardSearch(self: pointer, search: struct_miqt_string): void {.cdecl.} =
  let vtbl = cast[ptr QTreeWidgetVTable](fcQTreeWidget_vdata(self)[])
  let self = QTreeWidget(h: self)
...
proc fcQTreeWidget_vtable_callback_dataChanged(self: pointer, topLeft: pointer, bottomRight: pointer, roles: struct_miqt_array): void {.cdecl.} =
  let vtbl = cast[ptr QTreeWidgetVTable](fcQTreeWidget_vdata(self)[])
  let self = QTreeWidget(h: self)
...
proc fcQTreeWidget_vtable_callback_selectedIndexes(self: pointer): struct_miqt_array {.cdecl.} =
  let vtbl = cast[ptr QTreeWidgetVTable](fcQTreeWidget_vdata(self)[])
  let self = QTreeWidget(h: self)
...
proc fcQTreeWidget_vtable_callback_nativeEvent(self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QTreeWidgetVTable](fcQTreeWidget_vdata(self)[])
  let self = QTreeWidget(h: self)
...
proc fcQTreeWidget_method_callback_mimeTypes(self: pointer): struct_miqt_array {.cdecl.} =
  let inst = cast[VirtualQTreeWidget](fcQTreeWidget_vdata(self)[])
...
proc fcQTreeWidget_method_callback_mimeData(self: pointer, items: struct_miqt_array): pointer {.cdecl.} =
  let inst = cast[VirtualQTreeWidget](fcQTreeWidget_vdata(self)[])
  var vitems_ma = items
  var vitemsx_ret = newSeq[gen_qtreewidget_types.QTreeWidgetItem](int(vitems_ma.len))
  let vitems_outCast = cast[ptr UncheckedArray[pointer]](vitems_ma.data)
...
proc fcQTreeWidget_method_callback_keyboardSearch(self: pointer, search: struct_miqt_string): void {.cdecl.} =
  let inst = cast[VirtualQTreeWidget](fcQTreeWidget_vdata(self)[])
  let vsearch_ms = search
  let vsearchx_ret = string.fromBytes(vsearch_ms)
  c_free(vsearch_ms.data)
...
proc fcQTreeWidget_method_callback_dataChanged(self: pointer, topLeft: pointer, bottomRight: pointer, roles: struct_miqt_array): void {.cdecl.} =
  let inst = cast[VirtualQTreeWidget](fcQTreeWidget_vdata(self)[])
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: topLeft, owned: false)
  let slotval2 = gen_qabstractitemmodel_types.QModelIndex(h: bottomRight, owned: false)
  var vroles_ma = roles
...
proc fcQTreeWidget_method_callback_selectedIndexes(self: pointer): struct_miqt_array {.cdecl.} =
  let inst = cast[VirtualQTreeWidget](fcQTreeWidget_vdata(self)[])
...
proc fcQTreeWidget_method_callback_nativeEvent(self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let inst = cast[VirtualQTreeWidget](fcQTreeWidget_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
