...
proc fcQFontDialog_trUtf8S(s: cstring): struct_seaqt_string {.importc: "QFontDialog_trUtf8_s".}
...
proc fcQFontDialog_trUtf8SC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QFontDialog_trUtf8_s_c".}
proc fcQFontDialog_trUtf8SCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QFontDialog_trUtf8_s_c_n".}
...
proc fcQFontDialog_new(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQFontDialog {.importc: "QFontDialog_new_parent".}
proc fcQFontDialog_new2(vtbl: pointer, vdata: csize_t): ptr cQFontDialog {.importc: "QFontDialog_new".}
proc fcQFontDialog_new3(vtbl: pointer, vdata: csize_t, initial: pointer): ptr cQFontDialog {.importc: "QFontDialog_new_initial".}
...
proc trUtf8*(_: type gen_qfontdialog_types.QFontDialog, s: cstring): string =
  let v_ms = fcQFontDialog_trUtf8S(s)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc create*(T: type gen_qfontdialog_types.QFontDialog,
  ...
  let tmp = gen_qfontdialog_types.QFontDialog(h: fcQFontDialog_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
...
proc create*(T: type gen_qfontdialog_types.QFontDialog,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQFontDialog_vtable_callback_disconnectNotify
  let tmp = gen_qfontdialog_types.QFontDialog(h: fcQFontDialog_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQFontDialog_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qfontdialog_types.QFontDialog,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQFontDialog_vtable_callback_disconnectNotify
  let tmp = gen_qfontdialog_types.QFontDialog(h: fcQFontDialog_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), initial.h), owned: true)
  fcQFontDialog_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qfontdialog_types.QFontDialog,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQFontDialog_vtable_callback_disconnectNotify
  let tmp = gen_qfontdialog_types.QFontDialog(h: fcQFontDialog_new4(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), initial.h, parent.h), owned: true)
  fcQFontDialog_vdata(tmp.h)[] = addr(vtbl[])
  tmp
