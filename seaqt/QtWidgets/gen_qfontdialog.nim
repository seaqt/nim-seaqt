...
proc fcQFontDialog_trUtf8(s: cstring): struct_seaqt_string {.importc: "QFontDialog_trUtf8".}
...
proc fcQFontDialog_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QFontDialog_trUtf82".}
proc fcQFontDialog_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QFontDialog_trUtf83".}
...
proc fcQFontDialog_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.importc: "QFontDialog_virtualbase_nativeEvent".}
...
proc fcQFontDialog_new(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQFontDialog {.importc: "QFontDialog_new".}
proc fcQFontDialog_new2(vtbl: pointer, vdata: csize_t): ptr cQFontDialog {.importc: "QFontDialog_new2".}
proc fcQFontDialog_new3(vtbl: pointer, vdata: csize_t, initial: pointer): ptr cQFontDialog {.importc: "QFontDialog_new3".}
...
proc getFont*(_: type gen_qfontdialog_types.QFontDialog, ok: ptr bool, parent: gen_qwidget_types.QWidget): gen_qfont_types.QFont =
  gen_qfont_types.QFont(h: fcQFontDialog_getFont3(ok, parent.h))
...
proc getFont*(_: type gen_qfontdialog_types.QFontDialog, ok: ptr bool, initial: gen_qfont_types.QFont, parent: gen_qwidget_types.QWidget): gen_qfont_types.QFont =
  gen_qfont_types.QFont(h: fcQFontDialog_getFont4(ok, initial.h, parent.h))
...
proc getFont*(_: type gen_qfontdialog_types.QFontDialog, ok: ptr bool, initial: gen_qfont_types.QFont, parent: gen_qwidget_types.QWidget, title: openArray[char]): gen_qfont_types.QFont =
  gen_qfont_types.QFont(h: fcQFontDialog_getFont5(ok, initial.h, parent.h, struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title)))))
...
proc getFont*(_: type gen_qfontdialog_types.QFontDialog, ok: ptr bool, initial: gen_qfont_types.QFont, parent: gen_qwidget_types.QWidget, title: openArray[char], options: cint): gen_qfont_types.QFont =
  gen_qfont_types.QFont(h: fcQFontDialog_getFont6(ok, initial.h, parent.h, struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), cint(options)))
...
proc QFontDialognativeEvent*(self: gen_qfontdialog_types.QFontDialog, eventType: openArray[byte], message: pointer, resultVal: ptr clong): bool =
  fcQFontDialog_virtualbase_nativeEvent(self.h, struct_seaqt_string(data: if len(eventType) > 0: addr eventType[0] else: nil, len: csize_t(len(eventType))), message, resultVal)
...
proc fcQFontDialog_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let vtbl = cast[ptr QFontDialogVTable](fcQFontDialog_vdata(self)[])
  let self = QFontDialog(h: self)
...
proc fcQFontDialog_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let inst = cast[VirtualQFontDialog](fcQFontDialog_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc create*(T: type gen_qfontdialog_types.QFontDialog,
  ...
  let tmp = gen_qfontdialog_types.QFontDialog(h: fcQFontDialog_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h))
  fcQFontDialog_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qfontdialog_types.QFontDialog,
    vtbl: ref QFontDialogVTable = nil): gen_qfontdialog_types.QFontDialog =
  let vtbl = if vtbl == nil: new QFontDialogVTable else: vtbl
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQFontDialog_vtable_callback_disconnectNotify
  let tmp = gen_qfontdialog_types.QFontDialog(h: fcQFontDialog_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer))))
  fcQFontDialog_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qfontdialog_types.QFontDialog,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQFontDialog_vtable_callback_disconnectNotify
  let tmp = gen_qfontdialog_types.QFontDialog(h: fcQFontDialog_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), initial.h))
  fcQFontDialog_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qfontdialog_types.QFontDialog,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQFontDialog_vtable_callback_disconnectNotify
  let tmp = gen_qfontdialog_types.QFontDialog(h: fcQFontDialog_new4(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), initial.h, parent.h))
  fcQFontDialog_vdata(tmp.h)[] = addr(vtbl[])
  tmp
