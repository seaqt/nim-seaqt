...
proc fcQFontDialog_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QFontDialog_protectedbase_getDecodedMetricF".}
...
proc getDecodedMetricF*(self: gen_qfontdialog_types.QFontDialog, metricA: cint, metricB: cint): float64 =
  fcQFontDialog_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
