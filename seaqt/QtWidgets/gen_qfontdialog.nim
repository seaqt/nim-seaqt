...
proc create*(T: type gen_qfontdialog_types.QFontDialog,
  ...
  let tmp = gen_qfontdialog_types.QFontDialog(h: fcQFontDialog_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
...
proc create*(T: type gen_qfontdialog_types.QFontDialog,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQFontDialog_vtable_callback_disconnectNotify
  let tmp = gen_qfontdialog_types.QFontDialog(h: fcQFontDialog_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), initial.h), owned: true)
  fcQFontDialog_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qfontdialog_types.QFontDialog,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQFontDialog_vtable_callback_disconnectNotify
  let tmp = gen_qfontdialog_types.QFontDialog(h: fcQFontDialog_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQFontDialog_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qfontdialog_types.QFontDialog,
