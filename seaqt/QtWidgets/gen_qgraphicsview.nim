...
proc fcQGraphicsView_new(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQGraphicsView {.importc: "QGraphicsView_new_parent".}
proc fcQGraphicsView_new2(vtbl: pointer, vdata: csize_t): ptr cQGraphicsView {.importc: "QGraphicsView_new".}
proc fcQGraphicsView_new3(vtbl: pointer, vdata: csize_t, scene: pointer): ptr cQGraphicsView {.importc: "QGraphicsView_new_scene".}
...
proc create*(T: type gen_qgraphicsview_types.QGraphicsView,
  ...
  let tmp = gen_qgraphicsview_types.QGraphicsView(h: fcQGraphicsView_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
...
proc create*(T: type gen_qgraphicsview_types.QGraphicsView,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQGraphicsView_vtable_callback_disconnectNotify
  let tmp = gen_qgraphicsview_types.QGraphicsView(h: fcQGraphicsView_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQGraphicsView_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qgraphicsview_types.QGraphicsView,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQGraphicsView_vtable_callback_disconnectNotify
  let tmp = gen_qgraphicsview_types.QGraphicsView(h: fcQGraphicsView_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), scene.h), owned: true)
  fcQGraphicsView_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qgraphicsview_types.QGraphicsView,
