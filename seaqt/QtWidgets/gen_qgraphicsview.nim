...
proc fcQGraphicsView_new(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQGraphicsView {.importc: "QGraphicsView_new".}
proc fcQGraphicsView_new2(vtbl: pointer, vdata: csize_t): ptr cQGraphicsView {.importc: "QGraphicsView_new2".}
proc fcQGraphicsView_new3(vtbl: pointer, vdata: csize_t, scene: pointer): ptr cQGraphicsView {.importc: "QGraphicsView_new3".}
