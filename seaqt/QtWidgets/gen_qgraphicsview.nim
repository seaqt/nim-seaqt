...
proc create*(T: type gen_qgraphicsview_types.QGraphicsView,
  ...
  let tmp = gen_qgraphicsview_types.QGraphicsView(h: fcQGraphicsView_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h))
...
proc create*(T: type gen_qgraphicsview_types.QGraphicsView,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQGraphicsView_vtable_callback_disconnectNotify
  let tmp = gen_qgraphicsview_types.QGraphicsView(h: fcQGraphicsView_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer))))
  fcQGraphicsView_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qgraphicsview_types.QGraphicsView,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQGraphicsView_vtable_callback_disconnectNotify
  let tmp = gen_qgraphicsview_types.QGraphicsView(h: fcQGraphicsView_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), scene.h))
  fcQGraphicsView_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qgraphicsview_types.QGraphicsView,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQGraphicsView_vtable_callback_disconnectNotify
  let tmp = gen_qgraphicsview_types.QGraphicsView(h: fcQGraphicsView_new4(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), scene.h, parent.h))
  fcQGraphicsView_vdata(tmp.h)[] = addr(vtbl[])
  tmp
