...
public:
	...
	friend bool QDockWidget_virtualbase_nativeEvent(VirtualQDockWidget* self, struct miqt_string eventType, void* message, intptr_t* result);
...
VirtualQDockWidget* QDockWidget_new(const QDockWidget_VTable* vtbl, size_t vdata, QWidget* parent) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQDockWidget>());
	return _mem_ ? new (_mem_)VirtualQDockWidget(vtbl, parent) : nullptr;
}

VirtualQDockWidget* QDockWidget_new2(const QDockWidget_VTable* vtbl, size_t vdata, struct miqt_string title) {
...
VirtualQDockWidget* QDockWidget_new4(const QDockWidget_VTable* vtbl, size_t vdata, struct miqt_string title, QWidget* parent) {
	QString title_QString = QString::fromUtf8(title.data, title.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQDockWidget>());
	return _mem_ ? new (_mem_)VirtualQDockWidget(vtbl, title_QString, parent) : nullptr;
}

VirtualQDockWidget* QDockWidget_new5(const QDockWidget_VTable* vtbl, size_t vdata, struct miqt_string title, QWidget* parent, int flags) {
	QString title_QString = QString::fromUtf8(title.data, title.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQDockWidget>());
