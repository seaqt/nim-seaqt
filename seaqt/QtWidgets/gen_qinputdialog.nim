...
proc create*(T: type gen_qinputdialog_types.QInputDialog,
  ...
  let tmp = gen_qinputdialog_types.QInputDialog(h: fcQInputDialog_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
...
proc create*(T: type gen_qinputdialog_types.QInputDialog,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQInputDialog_vtable_callback_disconnectNotify
  let tmp = gen_qinputdialog_types.QInputDialog(h: fcQInputDialog_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQInputDialog_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qinputdialog_types.QInputDialog,
