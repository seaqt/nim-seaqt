...
proc fcQInputDialog_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QInputDialog_protectedbase_getDecodedMetricF".}
...
proc getDecodedMetricF*(self: gen_qinputdialog_types.QInputDialog, metricA: cint, metricB: cint): float64 =
  fcQInputDialog_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
