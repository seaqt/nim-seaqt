...
{.compile("gen_qinputdialog.cpp", QtWidgetsCFlags).}
...
proc fcQInputDialog_setTextValue(self: pointer, text: struct_seaqt_string): void {.importc: "QInputDialog_setTextValue".}
proc fcQInputDialog_textValue(self: pointer): struct_seaqt_string {.importc: "QInputDialog_textValue".}
...
proc fcQInputDialog_setComboBoxItems(self: pointer, items: struct_seaqt_array): void {.importc: "QInputDialog_setComboBoxItems".}
proc fcQInputDialog_comboBoxItems(self: pointer): struct_seaqt_array {.importc: "QInputDialog_comboBoxItems".}
...
proc fcQInputDialog_setOkButtonText(self: pointer, text: struct_seaqt_string): void {.importc: "QInputDialog_setOkButtonText".}
proc fcQInputDialog_okButtonText(self: pointer): struct_seaqt_string {.importc: "QInputDialog_okButtonText".}
proc fcQInputDialog_setCancelButtonText(self: pointer, text: struct_seaqt_string): void {.importc: "QInputDialog_setCancelButtonText".}
proc fcQInputDialog_cancelButtonText(self: pointer): struct_seaqt_string {.importc: "QInputDialog_cancelButtonText".}
...
proc fcQInputDialog_connect_textValueChanged(self: pointer, slot: int, callback: proc (slot: int, text: struct_seaqt_string) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QInputDialog_connect_textValueChanged".}
proc fcQInputDialog_textValueSelected(self: pointer, text: struct_seaqt_string): void {.importc: "QInputDialog_textValueSelected".}
proc fcQInputDialog_connect_textValueSelected(self: pointer, slot: int, callback: proc (slot: int, text: struct_seaqt_string) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QInputDialog_connect_textValueSelected".}
...
proc fcQInputDialog_getDouble2(parent: pointer, title: struct_seaqt_string, label: struct_seaqt_string, value: float64): float64 {.importc: "QInputDialog_getDouble2".}
proc fcQInputDialog_getDouble3(parent: pointer, title: struct_seaqt_string, label: struct_seaqt_string, value: float64, minValue: float64): float64 {.importc: "QInputDialog_getDouble3".}
proc fcQInputDialog_getDouble4(parent: pointer, title: struct_seaqt_string, label: struct_seaqt_string, value: float64, minValue: float64, maxValue: float64): float64 {.importc: "QInputDialog_getDouble4".}
proc fcQInputDialog_getDouble5(parent: pointer, title: struct_seaqt_string, label: struct_seaqt_string, value: float64, minValue: float64, maxValue: float64, decimals: cint): float64 {.importc: "QInputDialog_getDouble5".}
proc fcQInputDialog_getDouble6(parent: pointer, title: struct_seaqt_string, label: struct_seaqt_string, value: float64, minValue: float64, maxValue: float64, decimals: cint, ok: ptr bool): float64 {.importc: "QInputDialog_getDouble6".}
proc fcQInputDialog_getDouble7(parent: pointer, title: struct_seaqt_string, label: struct_seaqt_string, value: float64, minValue: float64, maxValue: float64, decimals: cint, ok: ptr bool, flags: cint): float64 {.importc: "QInputDialog_getDouble7".}
proc fcQInputDialog_getDouble8(parent: pointer, title: struct_seaqt_string, label: struct_seaqt_string, value: float64, minValue: float64, maxValue: float64, decimals: cint, ok: ptr bool, flags: cint, step: float64): float64 {.importc: "QInputDialog_getDouble8".}
...
proc fcQInputDialog_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.importc: "QInputDialog_virtualbase_nativeEvent".}
...
proc fcQInputDialog_new(vtbl: pointer, vdata: csize_t): ptr cQInputDialog {.importc: "QInputDialog_new".}
proc fcQInputDialog_new2(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQInputDialog {.importc: "QInputDialog_new2".}
...
proc setLabelText*(self: gen_qinputdialog_types.QInputDialog, text: openArray[char]): void =
  fcQInputDialog_setLabelText(self.h, struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))))
...
proc setTextValue*(self: gen_qinputdialog_types.QInputDialog, text: openArray[char]): void =
  fcQInputDialog_setTextValue(self.h, struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))))
...
proc setComboBoxItems*(self: gen_qinputdialog_types.QInputDialog, items: openArray[string]): void =
  var items_CArray = newSeq[struct_seaqt_string](len(items))
  for i in 0..<len(items):
    items_CArray[i] = struct_seaqt_string(data: if len(items[i]) > 0: addr items[i][0] else: nil, len: csize_t(len(items[i])))

  fcQInputDialog_setComboBoxItems(self.h, struct_seaqt_array(len: csize_t(len(items)), data: if len(items) == 0: nil else: addr(items_CArray[0])))
...
proc setOkButtonText*(self: gen_qinputdialog_types.QInputDialog, text: openArray[char]): void =
  fcQInputDialog_setOkButtonText(self.h, struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))))
...
proc setCancelButtonText*(self: gen_qinputdialog_types.QInputDialog, text: openArray[char]): void =
  fcQInputDialog_setCancelButtonText(self.h, struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))))
...
proc textValueChanged*(self: gen_qinputdialog_types.QInputDialog, text: openArray[char]): void =
  fcQInputDialog_textValueChanged(self.h, struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))))

type QInputDialogtextValueChangedSlot* = proc(text: openArray[char])
proc fcQInputDialog_slot_callback_textValueChanged(slot: int, text: struct_seaqt_string) {.cdecl.} =
...
proc fcQInputDialog_slot_callback_textValueChanged_release(slot: int) {.cdecl.} =
...
proc textValueSelected*(self: gen_qinputdialog_types.QInputDialog, text: openArray[char]): void =
  fcQInputDialog_textValueSelected(self.h, struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))))

type QInputDialogtextValueSelectedSlot* = proc(text: openArray[char])
proc fcQInputDialog_slot_callback_textValueSelected(slot: int, text: struct_seaqt_string) {.cdecl.} =
...
proc fcQInputDialog_slot_callback_textValueSelected_release(slot: int) {.cdecl.} =
...
proc onTextValueSelected*(self: gen_qinputdialog_types.QInputDialog, slot: QInputDialogtextValueSelectedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQInputDialog_connect_textValueSelected(self.h, cast[int](addr tmp[]), fcQInputDialog_slot_callback_textValueSelected, fcQInputDialog_slot_callback_textValueSelected_release)
...
proc fcQInputDialog_slot_callback_intValueChanged(slot: int, value: cint) {.cdecl.} =
  let nimfunc = cast[ptr QInputDialogintValueChangedSlot](cast[pointer](slot))
  let slotval1 = value

  nimfunc[](slotval1)

proc fcQInputDialog_slot_callback_intValueChanged_release(slot: int) {.cdecl.} =
...
proc onIntValueChanged*(self: gen_qinputdialog_types.QInputDialog, slot: QInputDialogintValueChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQInputDialog_connect_intValueChanged(self.h, cast[int](addr tmp[]), fcQInputDialog_slot_callback_intValueChanged, fcQInputDialog_slot_callback_intValueChanged_release)
...
proc fcQInputDialog_slot_callback_intValueSelected(slot: int, value: cint) {.cdecl.} =
  let nimfunc = cast[ptr QInputDialogintValueSelectedSlot](cast[pointer](slot))
  let slotval1 = value

  nimfunc[](slotval1)

proc fcQInputDialog_slot_callback_intValueSelected_release(slot: int) {.cdecl.} =
...
proc onIntValueSelected*(self: gen_qinputdialog_types.QInputDialog, slot: QInputDialogintValueSelectedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQInputDialog_connect_intValueSelected(self.h, cast[int](addr tmp[]), fcQInputDialog_slot_callback_intValueSelected, fcQInputDialog_slot_callback_intValueSelected_release)
...
proc fcQInputDialog_slot_callback_doubleValueChanged(slot: int, value: float64) {.cdecl.} =
  let nimfunc = cast[ptr QInputDialogdoubleValueChangedSlot](cast[pointer](slot))
  let slotval1 = value

  nimfunc[](slotval1)

proc fcQInputDialog_slot_callback_doubleValueChanged_release(slot: int) {.cdecl.} =
...
proc onDoubleValueChanged*(self: gen_qinputdialog_types.QInputDialog, slot: QInputDialogdoubleValueChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQInputDialog_connect_doubleValueChanged(self.h, cast[int](addr tmp[]), fcQInputDialog_slot_callback_doubleValueChanged, fcQInputDialog_slot_callback_doubleValueChanged_release)
...
proc fcQInputDialog_slot_callback_doubleValueSelected(slot: int, value: float64) {.cdecl.} =
  let nimfunc = cast[ptr QInputDialogdoubleValueSelectedSlot](cast[pointer](slot))
  let slotval1 = value

  nimfunc[](slotval1)

proc fcQInputDialog_slot_callback_doubleValueSelected_release(slot: int) {.cdecl.} =
...
proc onDoubleValueSelected*(self: gen_qinputdialog_types.QInputDialog, slot: QInputDialogdoubleValueSelectedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQInputDialog_connect_doubleValueSelected(self.h, cast[int](addr tmp[]), fcQInputDialog_slot_callback_doubleValueSelected, fcQInputDialog_slot_callback_doubleValueSelected_release)
...
proc getDouble*(_: type gen_qinputdialog_types.QInputDialog, parent: gen_qwidget_types.QWidget, title: openArray[char], label: openArray[char], value: float64): float64 =
  fcQInputDialog_getDouble2(parent.h, struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), struct_seaqt_string(data: if len(label) > 0: addr label[0] else: nil, len: csize_t(len(label))), value)
...
proc getDouble*(_: type gen_qinputdialog_types.QInputDialog, parent: gen_qwidget_types.QWidget, title: openArray[char], label: openArray[char], value: float64, minValue: float64): float64 =
  fcQInputDialog_getDouble3(parent.h, struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), struct_seaqt_string(data: if len(label) > 0: addr label[0] else: nil, len: csize_t(len(label))), value, minValue)
...
proc getDouble*(_: type gen_qinputdialog_types.QInputDialog, parent: gen_qwidget_types.QWidget, title: openArray[char], label: openArray[char], value: float64, minValue: float64, maxValue: float64): float64 =
  fcQInputDialog_getDouble4(parent.h, struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), struct_seaqt_string(data: if len(label) > 0: addr label[0] else: nil, len: csize_t(len(label))), value, minValue, maxValue)
...
proc getDouble*(_: type gen_qinputdialog_types.QInputDialog, parent: gen_qwidget_types.QWidget, title: openArray[char], label: openArray[char], value: float64, minValue: float64, maxValue: float64, decimals: cint): float64 =
  fcQInputDialog_getDouble5(parent.h, struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), struct_seaqt_string(data: if len(label) > 0: addr label[0] else: nil, len: csize_t(len(label))), value, minValue, maxValue, decimals)
...
proc getDouble*(_: type gen_qinputdialog_types.QInputDialog, parent: gen_qwidget_types.QWidget, title: openArray[char], label: openArray[char], value: float64, minValue: float64, maxValue: float64, decimals: cint, ok: ptr bool): float64 =
  fcQInputDialog_getDouble6(parent.h, struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), struct_seaqt_string(data: if len(label) > 0: addr label[0] else: nil, len: csize_t(len(label))), value, minValue, maxValue, decimals, ok)
...
proc getDouble*(_: type gen_qinputdialog_types.QInputDialog, parent: gen_qwidget_types.QWidget, title: openArray[char], label: openArray[char], value: float64, minValue: float64, maxValue: float64, decimals: cint, ok: ptr bool, flags: cint): float64 =
  fcQInputDialog_getDouble7(parent.h, struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), struct_seaqt_string(data: if len(label) > 0: addr label[0] else: nil, len: csize_t(len(label))), value, minValue, maxValue, decimals, ok, cint(flags))
...
proc getDouble*(_: type gen_qinputdialog_types.QInputDialog, parent: gen_qwidget_types.QWidget, title: openArray[char], label: openArray[char], value: float64, minValue: float64, maxValue: float64, decimals: cint, ok: ptr bool, flags: cint, step: float64): float64 =
  fcQInputDialog_getDouble8(parent.h, struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), struct_seaqt_string(data: if len(label) > 0: addr label[0] else: nil, len: csize_t(len(label))), value, minValue, maxValue, decimals, ok, cint(flags), step)
...
proc QInputDialognativeEvent*(self: gen_qinputdialog_types.QInputDialog, eventType: openArray[byte], message: pointer, resultVal: ptr uint): bool =
  fcQInputDialog_virtualbase_nativeEvent(self.h, struct_seaqt_string(data: if len(eventType) > 0: addr eventType[0] else: nil, len: csize_t(len(eventType))), message, resultVal)
...
proc fcQInputDialog_vtable_callback_metaObject(self: pointer): pointer {.cdecl.} =
...
proc fcQInputDialog_vtable_callback_metacast(self: pointer, param1: cstring): pointer {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
  let slotval1 = (param1)
...
proc fcQInputDialog_vtable_callback_metacall(self: pointer, param1: cint, param2: cint, param3: pointer): cint {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
...
proc fcQInputDialog_vtable_callback_minimumSizeHint(self: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
...
proc fcQInputDialog_vtable_callback_sizeHint(self: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
...
proc fcQInputDialog_vtable_callback_setVisible(self: pointer, visible: bool): void {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
  let slotval1 = visible
  vtbl[].setVisible(self, slotval1)

proc fcQInputDialog_vtable_callback_done(self: pointer, resultVal: cint): void {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
  let slotval1 = resultVal
  vtbl[].done(self, slotval1)

proc fcQInputDialog_vtable_callback_open(self: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
  vtbl[].open(self)

proc fcQInputDialog_vtable_callback_exec(self: pointer): cint {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
  var virtualReturn = vtbl[].exec(self)
  virtualReturn

proc fcQInputDialog_vtable_callback_accept(self: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
  vtbl[].accept(self)

proc fcQInputDialog_vtable_callback_reject(self: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
  vtbl[].reject(self)

proc fcQInputDialog_vtable_callback_keyPressEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
  let slotval1 = gen_qevent_types.QKeyEvent(h: param1, owned: false)
  vtbl[].keyPressEvent(self, slotval1)

proc fcQInputDialog_vtable_callback_closeEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
  let slotval1 = gen_qevent_types.QCloseEvent(h: param1, owned: false)
  vtbl[].closeEvent(self, slotval1)

proc fcQInputDialog_vtable_callback_showEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
  let slotval1 = gen_qevent_types.QShowEvent(h: param1, owned: false)
  vtbl[].showEvent(self, slotval1)

proc fcQInputDialog_vtable_callback_resizeEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
  let slotval1 = gen_qevent_types.QResizeEvent(h: param1, owned: false)
  vtbl[].resizeEvent(self, slotval1)

proc fcQInputDialog_vtable_callback_contextMenuEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
  let slotval1 = gen_qevent_types.QContextMenuEvent(h: param1, owned: false)
  vtbl[].contextMenuEvent(self, slotval1)

proc fcQInputDialog_vtable_callback_eventFilter(self: pointer, param1: pointer, param2: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
...
proc fcQInputDialog_vtable_callback_devType(self: pointer): cint {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
  var virtualReturn = vtbl[].devType(self)
  virtualReturn

proc fcQInputDialog_vtable_callback_heightForWidth(self: pointer, param1: cint): cint {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
  let slotval1 = param1
...
proc fcQInputDialog_vtable_callback_hasHeightForWidth(self: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
  var virtualReturn = vtbl[].hasHeightForWidth(self)
  virtualReturn

proc fcQInputDialog_vtable_callback_paintEngine(self: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
...
proc fcQInputDialog_vtable_callback_event(self: pointer, event: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
...
proc fcQInputDialog_vtable_callback_mousePressEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
  vtbl[].mousePressEvent(self, slotval1)

proc fcQInputDialog_vtable_callback_mouseReleaseEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
  vtbl[].mouseReleaseEvent(self, slotval1)

proc fcQInputDialog_vtable_callback_mouseDoubleClickEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
  vtbl[].mouseDoubleClickEvent(self, slotval1)

proc fcQInputDialog_vtable_callback_mouseMoveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
  vtbl[].mouseMoveEvent(self, slotval1)

proc fcQInputDialog_vtable_callback_wheelEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
  let slotval1 = gen_qevent_types.QWheelEvent(h: event, owned: false)
  vtbl[].wheelEvent(self, slotval1)

proc fcQInputDialog_vtable_callback_keyReleaseEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
  let slotval1 = gen_qevent_types.QKeyEvent(h: event, owned: false)
  vtbl[].keyReleaseEvent(self, slotval1)

proc fcQInputDialog_vtable_callback_focusInEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
  let slotval1 = gen_qevent_types.QFocusEvent(h: event, owned: false)
  vtbl[].focusInEvent(self, slotval1)

proc fcQInputDialog_vtable_callback_focusOutEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
  let slotval1 = gen_qevent_types.QFocusEvent(h: event, owned: false)
  vtbl[].focusOutEvent(self, slotval1)

proc fcQInputDialog_vtable_callback_enterEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
  let slotval1 = gen_qevent_types.QEnterEvent(h: event, owned: false)
  vtbl[].enterEvent(self, slotval1)

proc fcQInputDialog_vtable_callback_leaveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
  vtbl[].leaveEvent(self, slotval1)

proc fcQInputDialog_vtable_callback_paintEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
  let slotval1 = gen_qevent_types.QPaintEvent(h: event, owned: false)
  vtbl[].paintEvent(self, slotval1)

proc fcQInputDialog_vtable_callback_moveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
  let slotval1 = gen_qevent_types.QMoveEvent(h: event, owned: false)
  vtbl[].moveEvent(self, slotval1)

proc fcQInputDialog_vtable_callback_tabletEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
  let slotval1 = gen_qevent_types.QTabletEvent(h: event, owned: false)
  vtbl[].tabletEvent(self, slotval1)

proc fcQInputDialog_vtable_callback_actionEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
  let slotval1 = gen_qevent_types.QActionEvent(h: event, owned: false)
  vtbl[].actionEvent(self, slotval1)

proc fcQInputDialog_vtable_callback_dragEnterEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
  let slotval1 = gen_qevent_types.QDragEnterEvent(h: event, owned: false)
  vtbl[].dragEnterEvent(self, slotval1)

proc fcQInputDialog_vtable_callback_dragMoveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
  let slotval1 = gen_qevent_types.QDragMoveEvent(h: event, owned: false)
  vtbl[].dragMoveEvent(self, slotval1)

proc fcQInputDialog_vtable_callback_dragLeaveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
  let slotval1 = gen_qevent_types.QDragLeaveEvent(h: event, owned: false)
  vtbl[].dragLeaveEvent(self, slotval1)

proc fcQInputDialog_vtable_callback_dropEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
  let slotval1 = gen_qevent_types.QDropEvent(h: event, owned: false)
  vtbl[].dropEvent(self, slotval1)

proc fcQInputDialog_vtable_callback_hideEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
  let slotval1 = gen_qevent_types.QHideEvent(h: event, owned: false)
  vtbl[].hideEvent(self, slotval1)

proc fcQInputDialog_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
...
proc fcQInputDialog_vtable_callback_changeEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
  let slotval1 = gen_qcoreevent_types.QEvent(h: param1, owned: false)
  vtbl[].changeEvent(self, slotval1)

proc fcQInputDialog_vtable_callback_metric(self: pointer, param1: cint): cint {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
  let slotval1 = cint(param1)
...
proc fcQInputDialog_vtable_callback_initPainter(self: pointer, painter: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
  let slotval1 = gen_qpainter_types.QPainter(h: painter, owned: false)
  vtbl[].initPainter(self, slotval1)

proc fcQInputDialog_vtable_callback_redirected(self: pointer, offset: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
...
proc fcQInputDialog_vtable_callback_sharedPainter(self: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
...
proc fcQInputDialog_vtable_callback_inputMethodEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
  let slotval1 = gen_qevent_types.QInputMethodEvent(h: param1, owned: false)
  vtbl[].inputMethodEvent(self, slotval1)

proc fcQInputDialog_vtable_callback_inputMethodQuery(self: pointer, param1: cint): pointer {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
  let slotval1 = cint(param1)
...
proc fcQInputDialog_vtable_callback_focusNextPrevChild(self: pointer, next: bool): bool {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
  let slotval1 = next
...
proc fcQInputDialog_vtable_callback_timerEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
  let slotval1 = gen_qcoreevent_types.QTimerEvent(h: event, owned: false)
  vtbl[].timerEvent(self, slotval1)

proc fcQInputDialog_vtable_callback_childEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
  let slotval1 = gen_qcoreevent_types.QChildEvent(h: event, owned: false)
  vtbl[].childEvent(self, slotval1)

proc fcQInputDialog_vtable_callback_customEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
  vtbl[].customEvent(self, slotval1)

proc fcQInputDialog_vtable_callback_connectNotify(self: pointer, signal: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
  let slotval1 = gen_qmetaobject_types.QMetaMethod(h: signal, owned: false)
  vtbl[].connectNotify(self, slotval1)

proc fcQInputDialog_vtable_callback_disconnectNotify(self: pointer, signal: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
  let slotval1 = gen_qmetaobject_types.QMetaMethod(h: signal, owned: false)
...
proc fcQInputDialog_method_callback_metaObject(self: pointer): pointer {.cdecl.} =
...
proc fcQInputDialog_method_callback_metacast(self: pointer, param1: cstring): pointer {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
  let slotval1 = (param1)
  var virtualReturn = inst.metacast(slotval1)
  virtualReturn

proc fcQInputDialog_method_callback_metacall(self: pointer, param1: cint, param2: cint, param3: pointer): cint {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
  let slotval1 = cint(param1)
  let slotval2 = param2
  let slotval3 = param3
...
proc fcQInputDialog_method_callback_minimumSizeHint(self: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
...
proc fcQInputDialog_method_callback_sizeHint(self: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
...
proc fcQInputDialog_method_callback_setVisible(self: pointer, visible: bool): void {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
  let slotval1 = visible
  inst.setVisible(slotval1)

proc fcQInputDialog_method_callback_done(self: pointer, resultVal: cint): void {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
  let slotval1 = resultVal
  inst.done(slotval1)

proc fcQInputDialog_method_callback_open(self: pointer): void {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
  inst.open()

proc fcQInputDialog_method_callback_exec(self: pointer): cint {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
  var virtualReturn = inst.exec()
  virtualReturn

proc fcQInputDialog_method_callback_accept(self: pointer): void {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
  inst.accept()

proc fcQInputDialog_method_callback_reject(self: pointer): void {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
  inst.reject()

proc fcQInputDialog_method_callback_keyPressEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
  let slotval1 = gen_qevent_types.QKeyEvent(h: param1, owned: false)
  inst.keyPressEvent(slotval1)

proc fcQInputDialog_method_callback_closeEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
  let slotval1 = gen_qevent_types.QCloseEvent(h: param1, owned: false)
  inst.closeEvent(slotval1)

proc fcQInputDialog_method_callback_showEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
  let slotval1 = gen_qevent_types.QShowEvent(h: param1, owned: false)
  inst.showEvent(slotval1)

proc fcQInputDialog_method_callback_resizeEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
  let slotval1 = gen_qevent_types.QResizeEvent(h: param1, owned: false)
  inst.resizeEvent(slotval1)

proc fcQInputDialog_method_callback_contextMenuEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
  let slotval1 = gen_qevent_types.QContextMenuEvent(h: param1, owned: false)
  inst.contextMenuEvent(slotval1)

proc fcQInputDialog_method_callback_eventFilter(self: pointer, param1: pointer, param2: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
  let slotval1 = gen_qobject_types.QObject(h: param1, owned: false)
  let slotval2 = gen_qcoreevent_types.QEvent(h: param2, owned: false)
...
proc fcQInputDialog_method_callback_devType(self: pointer): cint {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
  var virtualReturn = inst.devType()
  virtualReturn

proc fcQInputDialog_method_callback_heightForWidth(self: pointer, param1: cint): cint {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
  let slotval1 = param1
  var virtualReturn = inst.heightForWidth(slotval1)
  virtualReturn

proc fcQInputDialog_method_callback_hasHeightForWidth(self: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
  var virtualReturn = inst.hasHeightForWidth()
  virtualReturn

proc fcQInputDialog_method_callback_paintEngine(self: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
...
proc fcQInputDialog_method_callback_event(self: pointer, event: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
  var virtualReturn = inst.event(slotval1)
  virtualReturn

proc fcQInputDialog_method_callback_mousePressEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
  inst.mousePressEvent(slotval1)

proc fcQInputDialog_method_callback_mouseReleaseEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
  inst.mouseReleaseEvent(slotval1)

proc fcQInputDialog_method_callback_mouseDoubleClickEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
  inst.mouseDoubleClickEvent(slotval1)

proc fcQInputDialog_method_callback_mouseMoveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
  inst.mouseMoveEvent(slotval1)

proc fcQInputDialog_method_callback_wheelEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
  let slotval1 = gen_qevent_types.QWheelEvent(h: event, owned: false)
  inst.wheelEvent(slotval1)

proc fcQInputDialog_method_callback_keyReleaseEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
  let slotval1 = gen_qevent_types.QKeyEvent(h: event, owned: false)
  inst.keyReleaseEvent(slotval1)

proc fcQInputDialog_method_callback_focusInEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
  let slotval1 = gen_qevent_types.QFocusEvent(h: event, owned: false)
  inst.focusInEvent(slotval1)

proc fcQInputDialog_method_callback_focusOutEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
  let slotval1 = gen_qevent_types.QFocusEvent(h: event, owned: false)
  inst.focusOutEvent(slotval1)

proc fcQInputDialog_method_callback_enterEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
  let slotval1 = gen_qevent_types.QEnterEvent(h: event, owned: false)
  inst.enterEvent(slotval1)

proc fcQInputDialog_method_callback_leaveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
  inst.leaveEvent(slotval1)

proc fcQInputDialog_method_callback_paintEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
  let slotval1 = gen_qevent_types.QPaintEvent(h: event, owned: false)
  inst.paintEvent(slotval1)

proc fcQInputDialog_method_callback_moveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
  let slotval1 = gen_qevent_types.QMoveEvent(h: event, owned: false)
  inst.moveEvent(slotval1)

proc fcQInputDialog_method_callback_tabletEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
  let slotval1 = gen_qevent_types.QTabletEvent(h: event, owned: false)
  inst.tabletEvent(slotval1)

proc fcQInputDialog_method_callback_actionEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
  let slotval1 = gen_qevent_types.QActionEvent(h: event, owned: false)
  inst.actionEvent(slotval1)

proc fcQInputDialog_method_callback_dragEnterEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
  let slotval1 = gen_qevent_types.QDragEnterEvent(h: event, owned: false)
  inst.dragEnterEvent(slotval1)

proc fcQInputDialog_method_callback_dragMoveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
  let slotval1 = gen_qevent_types.QDragMoveEvent(h: event, owned: false)
  inst.dragMoveEvent(slotval1)

proc fcQInputDialog_method_callback_dragLeaveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
  let slotval1 = gen_qevent_types.QDragLeaveEvent(h: event, owned: false)
  inst.dragLeaveEvent(slotval1)

proc fcQInputDialog_method_callback_dropEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
  let slotval1 = gen_qevent_types.QDropEvent(h: event, owned: false)
  inst.dropEvent(slotval1)

proc fcQInputDialog_method_callback_hideEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
  let slotval1 = gen_qevent_types.QHideEvent(h: event, owned: false)
  inst.hideEvent(slotval1)

proc fcQInputDialog_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc fcQInputDialog_method_callback_changeEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
  let slotval1 = gen_qcoreevent_types.QEvent(h: param1, owned: false)
  inst.changeEvent(slotval1)

proc fcQInputDialog_method_callback_metric(self: pointer, param1: cint): cint {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
  let slotval1 = cint(param1)
  var virtualReturn = inst.metric(slotval1)
  virtualReturn

proc fcQInputDialog_method_callback_initPainter(self: pointer, painter: pointer): void {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
  let slotval1 = gen_qpainter_types.QPainter(h: painter, owned: false)
  inst.initPainter(slotval1)

proc fcQInputDialog_method_callback_redirected(self: pointer, offset: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
  let slotval1 = gen_qpoint_types.QPoint(h: offset, owned: false)
...
proc fcQInputDialog_method_callback_sharedPainter(self: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
...
proc fcQInputDialog_method_callback_inputMethodEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
  let slotval1 = gen_qevent_types.QInputMethodEvent(h: param1, owned: false)
  inst.inputMethodEvent(slotval1)

proc fcQInputDialog_method_callback_inputMethodQuery(self: pointer, param1: cint): pointer {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
  let slotval1 = cint(param1)
...
proc fcQInputDialog_method_callback_focusNextPrevChild(self: pointer, next: bool): bool {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
  let slotval1 = next
  var virtualReturn = inst.focusNextPrevChild(slotval1)
  virtualReturn

proc fcQInputDialog_method_callback_timerEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
  let slotval1 = gen_qcoreevent_types.QTimerEvent(h: event, owned: false)
  inst.timerEvent(slotval1)

proc fcQInputDialog_method_callback_childEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
  let slotval1 = gen_qcoreevent_types.QChildEvent(h: event, owned: false)
  inst.childEvent(slotval1)

proc fcQInputDialog_method_callback_customEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
  inst.customEvent(slotval1)

proc fcQInputDialog_method_callback_connectNotify(self: pointer, signal: pointer): void {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
  let slotval1 = gen_qmetaobject_types.QMetaMethod(h: signal, owned: false)
  inst.connectNotify(slotval1)

proc fcQInputDialog_method_callback_disconnectNotify(self: pointer, signal: pointer): void {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
  let slotval1 = gen_qmetaobject_types.QMetaMethod(h: signal, owned: false)
...
proc createX*(self: gen_qinputdialog_types.QInputDialog): void =
...
proc create*(T: type gen_qinputdialog_types.QInputDialog,
  ...
  if not isNil(vtbl[].metaObject):
    vtbl[].vtbl.metaObject = fcQInputDialog_vtable_callback_metaObject
  if not isNil(vtbl[].metacast):
    vtbl[].vtbl.metacast = fcQInputDialog_vtable_callback_metacast
  if not isNil(vtbl[].metacall):
    vtbl[].vtbl.metacall = fcQInputDialog_vtable_callback_metacall
  if not isNil(vtbl[].minimumSizeHint):
    vtbl[].vtbl.minimumSizeHint = fcQInputDialog_vtable_callback_minimumSizeHint
  if not isNil(vtbl[].sizeHint):
    vtbl[].vtbl.sizeHint = fcQInputDialog_vtable_callback_sizeHint
  if not isNil(vtbl[].setVisible):
    vtbl[].vtbl.setVisible = fcQInputDialog_vtable_callback_setVisible
  if not isNil(vtbl[].done):
    vtbl[].vtbl.done = fcQInputDialog_vtable_callback_done
  if not isNil(vtbl[].open):
    vtbl[].vtbl.open = fcQInputDialog_vtable_callback_open
  if not isNil(vtbl[].exec):
    vtbl[].vtbl.exec = fcQInputDialog_vtable_callback_exec
  if not isNil(vtbl[].accept):
    vtbl[].vtbl.accept = fcQInputDialog_vtable_callback_accept
  if not isNil(vtbl[].reject):
    vtbl[].vtbl.reject = fcQInputDialog_vtable_callback_reject
  if not isNil(vtbl[].keyPressEvent):
    vtbl[].vtbl.keyPressEvent = fcQInputDialog_vtable_callback_keyPressEvent
  if not isNil(vtbl[].closeEvent):
    vtbl[].vtbl.closeEvent = fcQInputDialog_vtable_callback_closeEvent
  if not isNil(vtbl[].showEvent):
    vtbl[].vtbl.showEvent = fcQInputDialog_vtable_callback_showEvent
  if not isNil(vtbl[].resizeEvent):
    vtbl[].vtbl.resizeEvent = fcQInputDialog_vtable_callback_resizeEvent
  if not isNil(vtbl[].contextMenuEvent):
    vtbl[].vtbl.contextMenuEvent = fcQInputDialog_vtable_callback_contextMenuEvent
  if not isNil(vtbl[].eventFilter):
    vtbl[].vtbl.eventFilter = fcQInputDialog_vtable_callback_eventFilter
  if not isNil(vtbl[].devType):
    vtbl[].vtbl.devType = fcQInputDialog_vtable_callback_devType
  if not isNil(vtbl[].heightForWidth):
    vtbl[].vtbl.heightForWidth = fcQInputDialog_vtable_callback_heightForWidth
  if not isNil(vtbl[].hasHeightForWidth):
    vtbl[].vtbl.hasHeightForWidth = fcQInputDialog_vtable_callback_hasHeightForWidth
  if not isNil(vtbl[].paintEngine):
    vtbl[].vtbl.paintEngine = fcQInputDialog_vtable_callback_paintEngine
  if not isNil(vtbl[].event):
    vtbl[].vtbl.event = fcQInputDialog_vtable_callback_event
  if not isNil(vtbl[].mousePressEvent):
    vtbl[].vtbl.mousePressEvent = fcQInputDialog_vtable_callback_mousePressEvent
  if not isNil(vtbl[].mouseReleaseEvent):
    vtbl[].vtbl.mouseReleaseEvent = fcQInputDialog_vtable_callback_mouseReleaseEvent
  if not isNil(vtbl[].mouseDoubleClickEvent):
    vtbl[].vtbl.mouseDoubleClickEvent = fcQInputDialog_vtable_callback_mouseDoubleClickEvent
  if not isNil(vtbl[].mouseMoveEvent):
    vtbl[].vtbl.mouseMoveEvent = fcQInputDialog_vtable_callback_mouseMoveEvent
  if not isNil(vtbl[].wheelEvent):
    vtbl[].vtbl.wheelEvent = fcQInputDialog_vtable_callback_wheelEvent
  if not isNil(vtbl[].keyReleaseEvent):
    vtbl[].vtbl.keyReleaseEvent = fcQInputDialog_vtable_callback_keyReleaseEvent
  if not isNil(vtbl[].focusInEvent):
    vtbl[].vtbl.focusInEvent = fcQInputDialog_vtable_callback_focusInEvent
  if not isNil(vtbl[].focusOutEvent):
    vtbl[].vtbl.focusOutEvent = fcQInputDialog_vtable_callback_focusOutEvent
  if not isNil(vtbl[].enterEvent):
    vtbl[].vtbl.enterEvent = fcQInputDialog_vtable_callback_enterEvent
  if not isNil(vtbl[].leaveEvent):
    vtbl[].vtbl.leaveEvent = fcQInputDialog_vtable_callback_leaveEvent
  if not isNil(vtbl[].paintEvent):
    vtbl[].vtbl.paintEvent = fcQInputDialog_vtable_callback_paintEvent
  if not isNil(vtbl[].moveEvent):
    vtbl[].vtbl.moveEvent = fcQInputDialog_vtable_callback_moveEvent
  if not isNil(vtbl[].tabletEvent):
    vtbl[].vtbl.tabletEvent = fcQInputDialog_vtable_callback_tabletEvent
  if not isNil(vtbl[].actionEvent):
    vtbl[].vtbl.actionEvent = fcQInputDialog_vtable_callback_actionEvent
  if not isNil(vtbl[].dragEnterEvent):
    vtbl[].vtbl.dragEnterEvent = fcQInputDialog_vtable_callback_dragEnterEvent
  if not isNil(vtbl[].dragMoveEvent):
    vtbl[].vtbl.dragMoveEvent = fcQInputDialog_vtable_callback_dragMoveEvent
  if not isNil(vtbl[].dragLeaveEvent):
    vtbl[].vtbl.dragLeaveEvent = fcQInputDialog_vtable_callback_dragLeaveEvent
  if not isNil(vtbl[].dropEvent):
    vtbl[].vtbl.dropEvent = fcQInputDialog_vtable_callback_dropEvent
  if not isNil(vtbl[].hideEvent):
    vtbl[].vtbl.hideEvent = fcQInputDialog_vtable_callback_hideEvent
  if not isNil(vtbl[].nativeEvent):
    vtbl[].vtbl.nativeEvent = fcQInputDialog_vtable_callback_nativeEvent
  if not isNil(vtbl[].changeEvent):
    vtbl[].vtbl.changeEvent = fcQInputDialog_vtable_callback_changeEvent
  if not isNil(vtbl[].metric):
    vtbl[].vtbl.metric = fcQInputDialog_vtable_callback_metric
  if not isNil(vtbl[].initPainter):
    vtbl[].vtbl.initPainter = fcQInputDialog_vtable_callback_initPainter
  if not isNil(vtbl[].redirected):
    vtbl[].vtbl.redirected = fcQInputDialog_vtable_callback_redirected
  if not isNil(vtbl[].sharedPainter):
    vtbl[].vtbl.sharedPainter = fcQInputDialog_vtable_callback_sharedPainter
  if not isNil(vtbl[].inputMethodEvent):
    vtbl[].vtbl.inputMethodEvent = fcQInputDialog_vtable_callback_inputMethodEvent
  if not isNil(vtbl[].inputMethodQuery):
    vtbl[].vtbl.inputMethodQuery = fcQInputDialog_vtable_callback_inputMethodQuery
  if not isNil(vtbl[].focusNextPrevChild):
    vtbl[].vtbl.focusNextPrevChild = fcQInputDialog_vtable_callback_focusNextPrevChild
  if not isNil(vtbl[].timerEvent):
    vtbl[].vtbl.timerEvent = fcQInputDialog_vtable_callback_timerEvent
  if not isNil(vtbl[].childEvent):
    vtbl[].vtbl.childEvent = fcQInputDialog_vtable_callback_childEvent
  if not isNil(vtbl[].customEvent):
    vtbl[].vtbl.customEvent = fcQInputDialog_vtable_callback_customEvent
  if not isNil(vtbl[].connectNotify):
    vtbl[].vtbl.connectNotify = fcQInputDialog_vtable_callback_connectNotify
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQInputDialog_vtable_callback_disconnectNotify
  let tmp = gen_qinputdialog_types.QInputDialog(h: fcQInputDialog_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQInputDialog_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qinputdialog_types.QInputDialog,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQInputDialog_vtable_callback_disconnectNotify
  let tmp = gen_qinputdialog_types.QInputDialog(h: fcQInputDialog_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQInputDialog_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qinputdialog_types.QInputDialog,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQInputDialog_vtable_callback_disconnectNotify
  let tmp = gen_qinputdialog_types.QInputDialog(h: fcQInputDialog_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h, cint(flags)), owned: true)
  fcQInputDialog_vdata(tmp.h)[] = addr(vtbl[])
  tmp
const cQInputDialog_mvtbl = cQInputDialogVTable(
  ...
  metaObject: fcQInputDialog_method_callback_metaObject,
  metacast: fcQInputDialog_method_callback_metacast,
  metacall: fcQInputDialog_method_callback_metacall,
  minimumSizeHint: fcQInputDialog_method_callback_minimumSizeHint,
  sizeHint: fcQInputDialog_method_callback_sizeHint,
  setVisible: fcQInputDialog_method_callback_setVisible,
  done: fcQInputDialog_method_callback_done,
  open: fcQInputDialog_method_callback_open,
  exec: fcQInputDialog_method_callback_exec,
  accept: fcQInputDialog_method_callback_accept,
  reject: fcQInputDialog_method_callback_reject,
  keyPressEvent: fcQInputDialog_method_callback_keyPressEvent,
  closeEvent: fcQInputDialog_method_callback_closeEvent,
  showEvent: fcQInputDialog_method_callback_showEvent,
  resizeEvent: fcQInputDialog_method_callback_resizeEvent,
  contextMenuEvent: fcQInputDialog_method_callback_contextMenuEvent,
  eventFilter: fcQInputDialog_method_callback_eventFilter,
  devType: fcQInputDialog_method_callback_devType,
  heightForWidth: fcQInputDialog_method_callback_heightForWidth,
  hasHeightForWidth: fcQInputDialog_method_callback_hasHeightForWidth,
  paintEngine: fcQInputDialog_method_callback_paintEngine,
  event: fcQInputDialog_method_callback_event,
  mousePressEvent: fcQInputDialog_method_callback_mousePressEvent,
  mouseReleaseEvent: fcQInputDialog_method_callback_mouseReleaseEvent,
  mouseDoubleClickEvent: fcQInputDialog_method_callback_mouseDoubleClickEvent,
  mouseMoveEvent: fcQInputDialog_method_callback_mouseMoveEvent,
  wheelEvent: fcQInputDialog_method_callback_wheelEvent,
  keyReleaseEvent: fcQInputDialog_method_callback_keyReleaseEvent,
  focusInEvent: fcQInputDialog_method_callback_focusInEvent,
  focusOutEvent: fcQInputDialog_method_callback_focusOutEvent,
  enterEvent: fcQInputDialog_method_callback_enterEvent,
  leaveEvent: fcQInputDialog_method_callback_leaveEvent,
  paintEvent: fcQInputDialog_method_callback_paintEvent,
  moveEvent: fcQInputDialog_method_callback_moveEvent,
  tabletEvent: fcQInputDialog_method_callback_tabletEvent,
  actionEvent: fcQInputDialog_method_callback_actionEvent,
  dragEnterEvent: fcQInputDialog_method_callback_dragEnterEvent,
  dragMoveEvent: fcQInputDialog_method_callback_dragMoveEvent,
  dragLeaveEvent: fcQInputDialog_method_callback_dragLeaveEvent,
  dropEvent: fcQInputDialog_method_callback_dropEvent,
  hideEvent: fcQInputDialog_method_callback_hideEvent,
  nativeEvent: fcQInputDialog_method_callback_nativeEvent,
  changeEvent: fcQInputDialog_method_callback_changeEvent,
  metric: fcQInputDialog_method_callback_metric,
  initPainter: fcQInputDialog_method_callback_initPainter,
  redirected: fcQInputDialog_method_callback_redirected,
  sharedPainter: fcQInputDialog_method_callback_sharedPainter,
  inputMethodEvent: fcQInputDialog_method_callback_inputMethodEvent,
  inputMethodQuery: fcQInputDialog_method_callback_inputMethodQuery,
  focusNextPrevChild: fcQInputDialog_method_callback_focusNextPrevChild,
  timerEvent: fcQInputDialog_method_callback_timerEvent,
  childEvent: fcQInputDialog_method_callback_childEvent,
  customEvent: fcQInputDialog_method_callback_customEvent,
  connectNotify: fcQInputDialog_method_callback_connectNotify,
  disconnectNotify: fcQInputDialog_method_callback_disconnectNotify,
)
proc create*(T: type gen_qinputdialog_types.QInputDialog,
    inst: VirtualQInputDialog) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQInputDialog_new(addr(cQInputDialog_mvtbl), csize_t(sizeof(pointer)))
...
proc create*(T: type gen_qinputdialog_types.QInputDialog,
    ...
    inst: VirtualQInputDialog) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQInputDialog_new2(addr(cQInputDialog_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQInputDialog_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
