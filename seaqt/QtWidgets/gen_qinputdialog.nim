...
proc fcQInputDialog_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.importc: "QInputDialog_virtualbase_nativeEvent".}
...
proc fcQInputDialog_new2(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQInputDialog {.importc: "QInputDialog_new_parent".}
...
type QInputDialognativeEventProc* = proc(self: QInputDialog, eventType: openArray[byte], message: pointer, resultVal: ptr clong): bool {.raises: [], gcsafe.}
...
proc QInputDialognativeEvent*(self: gen_qinputdialog_types.QInputDialog, eventType: openArray[byte], message: pointer, resultVal: ptr clong): bool =
...
proc fcQInputDialog_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let vtbl = cast[ptr QInputDialogVTable](fcQInputDialog_vdata(self)[])
  let self = QInputDialog(h: self)
...
method enterEvent*(self: VirtualQInputDialog, event: gen_qcoreevent_types.QEvent): void {.base.} =
...
method nativeEvent*(self: VirtualQInputDialog, eventType: openArray[byte], message: pointer, resultVal: ptr clong): bool {.base.} =
...
proc fcQInputDialog_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let inst = cast[VirtualQInputDialog](fcQInputDialog_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
