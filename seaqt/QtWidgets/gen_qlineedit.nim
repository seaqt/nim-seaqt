...
proc fcQLineEdit_setPlaceholderText(self: pointer, placeholderText: struct_seaqt_string): void {.importc: "QLineEdit_setPlaceholderText".}
...
proc fcQLineEdit_selectedText(self: pointer): struct_seaqt_string {.importc: "QLineEdit_selectedText".}
...
proc fcQLineEdit_insert(self: pointer, param1: struct_seaqt_string): void {.importc: "QLineEdit_insert".}
proc fcQLineEdit_createStandardContextMenu(self: pointer): pointer {.importc: "QLineEdit_createStandardContextMenu".}
proc fcQLineEdit_textChanged(self: pointer, param1: struct_seaqt_string): void {.importc: "QLineEdit_textChanged".}
proc fcQLineEdit_connect_textChanged(self: pointer, slot: int, callback: proc (slot: int, param1: struct_seaqt_string) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QLineEdit_connect_textChanged".}
proc fcQLineEdit_textEdited(self: pointer, param1: struct_seaqt_string): void {.importc: "QLineEdit_textEdited".}
proc fcQLineEdit_connect_textEdited(self: pointer, slot: int, callback: proc (slot: int, param1: struct_seaqt_string) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QLineEdit_connect_textEdited".}
...
proc fcQLineEdit_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.importc: "QLineEdit_virtualbase_nativeEvent".}
...
proc fcQLineEdit_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QLineEdit_protectedbase_getDecodedMetricF".}
proc fcQLineEdit_new(vtbl: pointer, vdata: csize_t): ptr cQLineEdit {.importc: "QLineEdit_new".}
proc fcQLineEdit_new2(vtbl: pointer, vdata: csize_t, param1: struct_seaqt_string): ptr cQLineEdit {.importc: "QLineEdit_new_QString".}
proc fcQLineEdit_new3(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQLineEdit {.importc: "QLineEdit_new_QWidget".}
...
proc setPlaceholderText*(self: gen_qlineedit_types.QLineEdit, placeholderText: openArray[char]): void =
  fcQLineEdit_setPlaceholderText(self.h, struct_seaqt_string(data: if len(placeholderText) > 0: addr placeholderText[0] else: nil, len: csize_t(len(placeholderText))))
...
proc setInputMask*(self: gen_qlineedit_types.QLineEdit, inputMask: openArray[char]): void =
  fcQLineEdit_setInputMask(self.h, struct_seaqt_string(data: if len(inputMask) > 0: addr inputMask[0] else: nil, len: csize_t(len(inputMask))))
...
proc insert*(self: gen_qlineedit_types.QLineEdit, param1: openArray[char]): void =
  fcQLineEdit_insert(self.h, struct_seaqt_string(data: if len(param1) > 0: addr param1[0] else: nil, len: csize_t(len(param1))))
...
proc textChanged*(self: gen_qlineedit_types.QLineEdit, param1: openArray[char]): void =
  fcQLineEdit_textChanged(self.h, struct_seaqt_string(data: if len(param1) > 0: addr param1[0] else: nil, len: csize_t(len(param1))))

type QLineEdittextChangedSlot* = proc(param1: openArray[char])
proc fcQLineEdit_slot_callback_textChanged(slot: int, param1: struct_seaqt_string) {.cdecl.} =
...
proc textEdited*(self: gen_qlineedit_types.QLineEdit, param1: openArray[char]): void =
  fcQLineEdit_textEdited(self.h, struct_seaqt_string(data: if len(param1) > 0: addr param1[0] else: nil, len: csize_t(len(param1))))

type QLineEdittextEditedSlot* = proc(param1: openArray[char])
proc fcQLineEdit_slot_callback_textEdited(slot: int, param1: struct_seaqt_string) {.cdecl.} =
...
proc QLineEditnativeEvent*(self: gen_qlineedit_types.QLineEdit, eventType: openArray[byte], message: pointer, resultVal: ptr uint): bool =
  fcQLineEdit_virtualbase_nativeEvent(self.h, struct_seaqt_string(data: if len(eventType) > 0: addr eventType[0] else: nil, len: csize_t(len(eventType))), message, resultVal)
...
proc fcQLineEdit_vtable_callback_keyReleaseEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QLineEditVTable](fcQLineEdit_vdata(self)[])
  let self = QLineEdit(h: self)
  let slotval1 = gen_qevent_types.QKeyEvent(h: param1, owned: false)
...
proc fcQLineEdit_vtable_callback_initStyleOption(self: pointer, option: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QLineEditVTable](fcQLineEdit_vdata(self)[])
  let self = QLineEdit(h: self)
...
proc fcQLineEdit_vtable_callback_timerEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QLineEditVTable](fcQLineEdit_vdata(self)[])
  let self = QLineEdit(h: self)
...
proc fcQLineEdit_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QLineEditVTable](fcQLineEdit_vdata(self)[])
  let self = QLineEdit(h: self)
...
proc fcQLineEdit_method_callback_keyReleaseEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let inst = cast[VirtualQLineEdit](fcQLineEdit_vdata(self)[])
  let slotval1 = gen_qevent_types.QKeyEvent(h: param1, owned: false)
...
proc fcQLineEdit_method_callback_initStyleOption(self: pointer, option: pointer): void {.cdecl.} =
  let inst = cast[VirtualQLineEdit](fcQLineEdit_vdata(self)[])
  let slotval1 = gen_qstyleoption_types.QStyleOptionFrame(h: option, owned: false)
...
proc fcQLineEdit_method_callback_timerEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let inst = cast[VirtualQLineEdit](fcQLineEdit_vdata(self)[])
  let slotval1 = gen_qcoreevent_types.QTimerEvent(h: param1, owned: false)
...
proc fcQLineEdit_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let inst = cast[VirtualQLineEdit](fcQLineEdit_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc getDecodedMetricF*(self: gen_qlineedit_types.QLineEdit, metricA: cint, metricB: cint): float64 =
  fcQLineEdit_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
...
proc create*(T: type gen_qlineedit_types.QLineEdit,
  ...
  let tmp = gen_qlineedit_types.QLineEdit(h: fcQLineEdit_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
...
proc create*(T: type gen_qlineedit_types.QLineEdit,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQLineEdit_vtable_callback_disconnectNotify
  let tmp = gen_qlineedit_types.QLineEdit(h: fcQLineEdit_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(param1) > 0: addr param1[0] else: nil, len: csize_t(len(param1)))), owned: true)
  fcQLineEdit_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qlineedit_types.QLineEdit,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQLineEdit_vtable_callback_disconnectNotify
  let tmp = gen_qlineedit_types.QLineEdit(h: fcQLineEdit_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQLineEdit_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qlineedit_types.QLineEdit,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQLineEdit_vtable_callback_disconnectNotify
  let tmp = gen_qlineedit_types.QLineEdit(h: fcQLineEdit_new4(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(param1) > 0: addr param1[0] else: nil, len: csize_t(len(param1))), parent.h), owned: true)
  fcQLineEdit_vdata(tmp.h)[] = addr(vtbl[])
  tmp
...
proc create*(T: type gen_qlineedit_types.QLineEdit,
  ...
  inst[].h = fcQLineEdit_new(addr(cQLineEdit_mvtbl), csize_t(sizeof(pointer)))
...
proc create*(T: type gen_qlineedit_types.QLineEdit,
    ...
    inst: VirtualQLineEdit) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQLineEdit_new2(addr(cQLineEdit_mvtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(param1) > 0: addr param1[0] else: nil, len: csize_t(len(param1))))
  fcQLineEdit_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qlineedit_types.QLineEdit,
    ...
    inst: VirtualQLineEdit) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQLineEdit_new3(addr(cQLineEdit_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQLineEdit_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qlineedit_types.QLineEdit,
    ...
    inst: VirtualQLineEdit) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQLineEdit_new4(addr(cQLineEdit_mvtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(param1) > 0: addr param1[0] else: nil, len: csize_t(len(param1))), parent.h)
  fcQLineEdit_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
