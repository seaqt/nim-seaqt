...
typedef struct QTableView_VTable{
	...
	struct miqt_array /* of QModelIndex* */  (*selectedIndexes)(const VirtualQTableView* self);
	...
	void (*keyboardSearch)(VirtualQTableView* self, struct miqt_string search);
	...
	void (*dataChanged)(VirtualQTableView* self, QModelIndex* topLeft, QModelIndex* bottomRight, struct miqt_array /* of int */  roles);
	...
	bool (*nativeEvent)(VirtualQTableView* self, struct miqt_string eventType, void* message, intptr_t* result);
...
const QTableView_VTable* QTableView_vtbl(const VirtualQTableView* self);
void* QTableView_vdata(const VirtualQTableView* self);
void QTableView_setVdata(VirtualQTableView* self, void* vdata);
