...
VirtualQTableWidgetItem* QTableWidgetItem_new(const QTableWidgetItem_VTable* vtbl, size_t vdata) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQTableWidgetItem>());
	return _mem_ ? new (_mem_)VirtualQTableWidgetItem(vtbl) : nullptr;
}

VirtualQTableWidgetItem* QTableWidgetItem_new2(const QTableWidgetItem_VTable* vtbl, size_t vdata, struct miqt_string text) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQTableWidgetItem>());
	return _mem_ ? new (_mem_)VirtualQTableWidgetItem(vtbl, text_QString) : nullptr;
}

VirtualQTableWidgetItem* QTableWidgetItem_new3(const QTableWidgetItem_VTable* vtbl, size_t vdata, QIcon* icon, struct miqt_string text) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQTableWidgetItem>());
...
VirtualQTableWidgetItem* QTableWidgetItem_new6(const QTableWidgetItem_VTable* vtbl, size_t vdata, struct miqt_string text, int type) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQTableWidgetItem>());
	return _mem_ ? new (_mem_)VirtualQTableWidgetItem(vtbl, text_QString, static_cast<int>(type)) : nullptr;
}

VirtualQTableWidgetItem* QTableWidgetItem_new7(const QTableWidgetItem_VTable* vtbl, size_t vdata, QIcon* icon, struct miqt_string text, int type) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQTableWidgetItem>());
...
public:
	...
	friend bool QTableWidget_virtualbase_nativeEvent(VirtualQTableWidget* self, struct miqt_string eventType, void* message, intptr_t* result);
...
VirtualQTableWidget* QTableWidget_new(const QTableWidget_VTable* vtbl, size_t vdata, QWidget* parent) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQTableWidget>());
