...
public:
	...
	friend bool QAbstractSpinBox_virtualbase_nativeEvent(VirtualQAbstractSpinBox* self, struct miqt_string eventType, void* message, intptr_t* result);
...
VirtualQAbstractSpinBox* QAbstractSpinBox_new(const QAbstractSpinBox_VTable* vtbl, size_t vdata, QWidget* parent) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQAbstractSpinBox>());
