...
public:
	...
	friend bool QAbstractSlider_virtualbase_nativeEvent(VirtualQAbstractSlider* self, struct miqt_string eventType, void* message, intptr_t* result);
...
VirtualQAbstractSlider* QAbstractSlider_new(const QAbstractSlider_VTable* vtbl, size_t vdata, QWidget* parent) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQAbstractSlider>());
