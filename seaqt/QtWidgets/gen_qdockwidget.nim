...
proc fcQDockWidget_new(vtbl: pointer, vdata: csize_t, title: struct_seaqt_string): ptr cQDockWidget {.importc: "QDockWidget_new".}
proc fcQDockWidget_new2(vtbl: pointer, vdata: csize_t): ptr cQDockWidget {.importc: "QDockWidget_new2".}
proc fcQDockWidget_new3(vtbl: pointer, vdata: csize_t, title: struct_seaqt_string, parent: pointer): ptr cQDockWidget {.importc: "QDockWidget_new3".}
proc fcQDockWidget_new4(vtbl: pointer, vdata: csize_t, title: struct_seaqt_string, parent: pointer, flags: cint): ptr cQDockWidget {.importc: "QDockWidget_new4".}
proc fcQDockWidget_new5(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQDockWidget {.importc: "QDockWidget_new5".}
