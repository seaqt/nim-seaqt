...
proc create*(T: type gen_qdockwidget_types.QDockWidget,
  ...
  let tmp = gen_qdockwidget_types.QDockWidget(h: fcQDockWidget_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
...
proc create*(T: type gen_qdockwidget_types.QDockWidget,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQDockWidget_vtable_callback_disconnectNotify
  let tmp = gen_qdockwidget_types.QDockWidget(h: fcQDockWidget_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title)))), owned: true)
  fcQDockWidget_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qdockwidget_types.QDockWidget,
    vtbl: ref QDockWidgetVTable = nil): gen_qdockwidget_types.QDockWidget =
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQDockWidget_vtable_callback_disconnectNotify
  let tmp = gen_qdockwidget_types.QDockWidget(h: fcQDockWidget_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQDockWidget_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qdockwidget_types.QDockWidget,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQDockWidget_vtable_callback_disconnectNotify
  let tmp = gen_qdockwidget_types.QDockWidget(h: fcQDockWidget_new4(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), parent.h), owned: true)
  fcQDockWidget_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qdockwidget_types.QDockWidget,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQDockWidget_vtable_callback_disconnectNotify
  let tmp = gen_qdockwidget_types.QDockWidget(h: fcQDockWidget_new5(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), parent.h, cint(flags)), owned: true)
  fcQDockWidget_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qdockwidget_types.QDockWidget,
...
proc create*(T: type gen_qdockwidget_types.QDockWidget,
    ...
    inst: VirtualQDockWidget) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQDockWidget_new2(addr(cQDockWidget_mvtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))))
  fcQDockWidget_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qdockwidget_types.QDockWidget,
    ...
    inst: VirtualQDockWidget) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQDockWidget_new4(addr(cQDockWidget_mvtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), parent.h)
  fcQDockWidget_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qdockwidget_types.QDockWidget,
    ...
    inst: VirtualQDockWidget) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQDockWidget_new5(addr(cQDockWidget_mvtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), parent.h, cint(flags))
  fcQDockWidget_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
