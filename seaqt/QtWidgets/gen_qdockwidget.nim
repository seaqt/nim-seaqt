...
proc fcQDockWidget_setDockLocation(self: pointer, area: cint): void {.importc: "QDockWidget_setDockLocation".}
proc fcQDockWidget_dockLocation(self: pointer): cint {.importc: "QDockWidget_dockLocation".}
...
proc fcQDockWidget_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.importc: "QDockWidget_virtualbase_nativeEvent".}
...
proc fcQDockWidget_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QDockWidget_protectedbase_getDecodedMetricF".}
proc fcQDockWidget_new(vtbl: pointer, vdata: csize_t, title: struct_seaqt_string): ptr cQDockWidget {.importc: "QDockWidget_new_title".}
proc fcQDockWidget_new2(vtbl: pointer, vdata: csize_t): ptr cQDockWidget {.importc: "QDockWidget_new".}
proc fcQDockWidget_new3(vtbl: pointer, vdata: csize_t, title: struct_seaqt_string, parent: pointer): ptr cQDockWidget {.importc: "QDockWidget_new_title_parent".}
proc fcQDockWidget_new4(vtbl: pointer, vdata: csize_t, title: struct_seaqt_string, parent: pointer, flags: cint): ptr cQDockWidget {.importc: "QDockWidget_new_title_parent_flags".}
proc fcQDockWidget_new5(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQDockWidget {.importc: "QDockWidget_new_parent".}
...
proc setDockLocation*(self: gen_qdockwidget_types.QDockWidget, area: cint): void =
  fcQDockWidget_setDockLocation(self.h, cint(area))

proc dockLocation*(self: gen_qdockwidget_types.QDockWidget): cint =
  cint(fcQDockWidget_dockLocation(self.h))
...
proc QDockWidgetnativeEvent*(self: gen_qdockwidget_types.QDockWidget, eventType: openArray[byte], message: pointer, resultVal: ptr uint): bool =
  fcQDockWidget_virtualbase_nativeEvent(self.h, struct_seaqt_string(data: if len(eventType) > 0: addr eventType[0] else: nil, len: csize_t(len(eventType))), message, resultVal)
...
proc fcQDockWidget_vtable_callback_initStyleOption(self: pointer, option: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QDockWidgetVTable](fcQDockWidget_vdata(self)[])
  let self = QDockWidget(h: self)
...
proc fcQDockWidget_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QDockWidgetVTable](fcQDockWidget_vdata(self)[])
  let self = QDockWidget(h: self)
...
proc fcQDockWidget_method_callback_initStyleOption(self: pointer, option: pointer): void {.cdecl.} =
  let inst = cast[VirtualQDockWidget](fcQDockWidget_vdata(self)[])
  let slotval1 = gen_qstyleoption_types.QStyleOptionDockWidget(h: option, owned: false)
...
proc fcQDockWidget_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let inst = cast[VirtualQDockWidget](fcQDockWidget_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc getDecodedMetricF*(self: gen_qdockwidget_types.QDockWidget, metricA: cint, metricB: cint): float64 =
  fcQDockWidget_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
...
proc create*(T: type gen_qdockwidget_types.QDockWidget,
  ...
  if not isNil(vtbl[].initStyleOption):
    vtbl[].vtbl.initStyleOption = fcQDockWidget_vtable_callback_initStyleOption
  ...
  let tmp = gen_qdockwidget_types.QDockWidget(h: fcQDockWidget_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title)))), owned: true)
...
proc create*(T: type gen_qdockwidget_types.QDockWidget,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQDockWidget_vtable_callback_disconnectNotify
  let tmp = gen_qdockwidget_types.QDockWidget(h: fcQDockWidget_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQDockWidget_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qdockwidget_types.QDockWidget,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQDockWidget_vtable_callback_disconnectNotify
  let tmp = gen_qdockwidget_types.QDockWidget(h: fcQDockWidget_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), parent.h), owned: true)
  fcQDockWidget_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qdockwidget_types.QDockWidget,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQDockWidget_vtable_callback_disconnectNotify
  let tmp = gen_qdockwidget_types.QDockWidget(h: fcQDockWidget_new4(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), parent.h, cint(flags)), owned: true)
  fcQDockWidget_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qdockwidget_types.QDockWidget,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQDockWidget_vtable_callback_disconnectNotify
  let tmp = gen_qdockwidget_types.QDockWidget(h: fcQDockWidget_new5(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQDockWidget_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qdockwidget_types.QDockWidget,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQDockWidget_vtable_callback_disconnectNotify
  let tmp = gen_qdockwidget_types.QDockWidget(h: fcQDockWidget_new6(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h, cint(flags)), owned: true)
  fcQDockWidget_vdata(tmp.h)[] = addr(vtbl[])
  tmp
const cQDockWidget_mvtbl = cQDockWidgetVTable(
  ...
  initStyleOption: fcQDockWidget_method_callback_initStyleOption,
...
proc create*(T: type gen_qdockwidget_types.QDockWidget,
  ...
  inst[].h = fcQDockWidget_new(addr(cQDockWidget_mvtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))))
...
proc create*(T: type gen_qdockwidget_types.QDockWidget,
    inst: VirtualQDockWidget) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQDockWidget_new2(addr(cQDockWidget_mvtbl), csize_t(sizeof(pointer)))
  fcQDockWidget_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qdockwidget_types.QDockWidget,
    ...
    inst: VirtualQDockWidget) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQDockWidget_new3(addr(cQDockWidget_mvtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), parent.h)
  fcQDockWidget_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qdockwidget_types.QDockWidget,
    ...
    inst: VirtualQDockWidget) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQDockWidget_new4(addr(cQDockWidget_mvtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), parent.h, cint(flags))
  fcQDockWidget_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qdockwidget_types.QDockWidget,
    ...
    inst: VirtualQDockWidget) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQDockWidget_new5(addr(cQDockWidget_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQDockWidget_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
