...
proc cQTableView_vtable_callback_initViewItemOption(self: pointer, option: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTableViewVTable](fcQTableView_vdata(self))
  let self = QTableView(h: self)
...
proc cQTableView_vtable_callback_itemDelegateForIndex(self: pointer, index: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QTableViewVTable](fcQTableView_vdata(self))
  let self = QTableView(h: self)
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
...
proc cQTableView_vtable_callback_initStyleOption(self: pointer, option: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTableViewVTable](fcQTableView_vdata(self))
  let self = QTableView(h: self)
...
proc cQTableView_vtable_callback_nativeEvent(self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QTableViewVTable](fcQTableView_vdata(self))
  let self = QTableView(h: self)
...
proc cQTableView_method_callback_initViewItemOption(self: pointer, option: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTableView](fcQTableView_vdata(self))
  let slotval1 = gen_qstyleoption_types.QStyleOptionViewItem(h: option, owned: false)
...
proc cQTableView_method_callback_itemDelegateForIndex(self: pointer, index: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQTableView](fcQTableView_vdata(self))
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
...
proc cQTableView_method_callback_initStyleOption(self: pointer, option: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTableView](fcQTableView_vdata(self))
  let slotval1 = gen_qstyleoption_types.QStyleOptionFrame(h: option, owned: false)
...
method nativeEvent*(self: VirtualQTableView, eventType: seq[byte], message: pointer, resultVal: ptr uint): bool {.base.} =
  QTableViewnativeEvent(self[], eventType, message, resultVal)
proc cQTableView_method_callback_nativeEvent(self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let inst = cast[VirtualQTableView](fcQTableView_vdata(self))
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArrayByte(veventType_bytearray.data, 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc create*(T: type gen_qtableview_types.QTableView,
  ...
  if not isNil(vtbl[].initViewItemOption):
    vtbl[].vtbl.initViewItemOption = cQTableView_vtable_callback_initViewItemOption
  ...
  if not isNil(vtbl[].itemDelegateForIndex):
    vtbl[].vtbl.itemDelegateForIndex = cQTableView_vtable_callback_itemDelegateForIndex
  ...
  if not isNil(vtbl[].initStyleOption):
    vtbl[].vtbl.initStyleOption = cQTableView_vtable_callback_initStyleOption
...
const cQTableView_mvtbl = cQTableViewVTable(
  ...
  initViewItemOption: cQTableView_method_callback_initViewItemOption,
  ...
  itemDelegateForIndex: cQTableView_method_callback_itemDelegateForIndex,
  ...
  initStyleOption: cQTableView_method_callback_initStyleOption,
