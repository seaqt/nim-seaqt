...
proc fcQTableView_trUtf8S(s: cstring): struct_seaqt_string {.importc: "QTableView_trUtf8_s".}
...
proc fcQTableView_sortByColumnColumn(self: pointer, column: cint): void {.importc: "QTableView_sortByColumn_column".}
proc fcQTableView_sortByColumnColumnOrder(self: pointer, column: cint, order: cint): void {.importc: "QTableView_sortByColumn_column_order".}
...
proc fcQTableView_trUtf8SC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QTableView_trUtf8_s_c".}
proc fcQTableView_trUtf8SCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QTableView_trUtf8_s_c_n".}
...
proc fcQTableView_virtualbase_selectedIndexes(self: pointer): struct_seaqt_array {.importc: "QTableView_virtualbase_selectedIndexes".}
...
proc fcQTableView_virtualbase_keyboardSearch(self: pointer, search: struct_seaqt_string): void {.importc: "QTableView_virtualbase_keyboardSearch".}
...
proc fcQTableView_virtualbase_dataChanged(self: pointer, topLeft: pointer, bottomRight: pointer, roles: struct_seaqt_array): void {.importc: "QTableView_virtualbase_dataChanged".}
...
proc fcQTableView_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.importc: "QTableView_virtualbase_nativeEvent".}
...
proc fcQTableView_new(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQTableView {.importc: "QTableView_new_parent".}
proc fcQTableView_new2(vtbl: pointer, vdata: csize_t): ptr cQTableView {.importc: "QTableView_new".}
...
proc trUtf8*(_: type gen_qtableview_types.QTableView, s: cstring): string =
  let v_ms = fcQTableView_trUtf8S(s)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc sortByColumn*(self: gen_qtableview_types.QTableView, column: cint): void =
  fcQTableView_sortByColumnColumn(self.h, column)

proc sortByColumn*(self: gen_qtableview_types.QTableView, column: cint, order: cint): void =
  fcQTableView_sortByColumnColumnOrder(self.h, column, cint(order))
...
proc QTableViewkeyboardSearch*(self: gen_qtableview_types.QTableView, search: openArray[char]): void =
  fcQTableView_virtualbase_keyboardSearch(self.h, struct_seaqt_string(data: if len(search) > 0: addr search[0] else: nil, len: csize_t(len(search))))
...
proc QTableViewdataChanged*(self: gen_qtableview_types.QTableView, topLeft: gen_qabstractitemmodel_types.QModelIndex, bottomRight: gen_qabstractitemmodel_types.QModelIndex, roles: openArray[cint]): void =
  ...
  fcQTableView_virtualbase_dataChanged(self.h, topLeft.h, bottomRight.h, struct_seaqt_array(len: csize_t(len(roles)), data: if len(roles) == 0: nil else: addr(roles_CArray[0])))
...
proc QTableViewnativeEvent*(self: gen_qtableview_types.QTableView, eventType: openArray[byte], message: pointer, resultVal: ptr clong): bool =
  fcQTableView_virtualbase_nativeEvent(self.h, struct_seaqt_string(data: if len(eventType) > 0: addr eventType[0] else: nil, len: csize_t(len(eventType))), message, resultVal)
...
proc fcQTableView_vtable_callback_viewOptions(self: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QTableViewVTable](fcQTableView_vdata(self)[])
  let self = QTableView(h: self)
...
proc fcQTableView_vtable_callback_selectedIndexes(self: pointer): struct_seaqt_array {.cdecl.} =
  let vtbl = cast[ptr QTableViewVTable](fcQTableView_vdata(self)[])
  let self = QTableView(h: self)
...
proc fcQTableView_vtable_callback_keyboardSearch(self: pointer, search: struct_seaqt_string): void {.cdecl.} =
  let vtbl = cast[ptr QTableViewVTable](fcQTableView_vdata(self)[])
  let self = QTableView(h: self)
...
proc fcQTableView_vtable_callback_dataChanged(self: pointer, topLeft: pointer, bottomRight: pointer, roles: struct_seaqt_array): void {.cdecl.} =
  let vtbl = cast[ptr QTableViewVTable](fcQTableView_vdata(self)[])
  let self = QTableView(h: self)
...
proc fcQTableView_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let vtbl = cast[ptr QTableViewVTable](fcQTableView_vdata(self)[])
  let self = QTableView(h: self)
...
proc fcQTableView_method_callback_viewOptions(self: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQTableView](fcQTableView_vdata(self)[])
...
proc fcQTableView_method_callback_selectedIndexes(self: pointer): struct_seaqt_array {.cdecl.} =
  let inst = cast[VirtualQTableView](fcQTableView_vdata(self)[])
...
proc fcQTableView_method_callback_keyboardSearch(self: pointer, search: struct_seaqt_string): void {.cdecl.} =
  let inst = cast[VirtualQTableView](fcQTableView_vdata(self)[])
  let vsearch_ms = search
  let vsearchx_ret = string.fromBytes(vsearch_ms)
  c_free(vsearch_ms.data)
...
proc fcQTableView_method_callback_dataChanged(self: pointer, topLeft: pointer, bottomRight: pointer, roles: struct_seaqt_array): void {.cdecl.} =
  let inst = cast[VirtualQTableView](fcQTableView_vdata(self)[])
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: topLeft, owned: false)
  let slotval2 = gen_qabstractitemmodel_types.QModelIndex(h: bottomRight, owned: false)
  var vroles_ma = roles
...
proc fcQTableView_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let inst = cast[VirtualQTableView](fcQTableView_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc create*(T: type gen_qtableview_types.QTableView,
  ...
  if not isNil(vtbl[].viewOptions):
    vtbl[].vtbl.viewOptions = fcQTableView_vtable_callback_viewOptions
  ...
  let tmp = gen_qtableview_types.QTableView(h: fcQTableView_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQTableView_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qtableview_types.QTableView,
    vtbl: ref QTableViewVTable = nil): gen_qtableview_types.QTableView =
  let vtbl = if vtbl == nil: new QTableViewVTable else: vtbl
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQTableView_vtable_callback_disconnectNotify
  let tmp = gen_qtableview_types.QTableView(h: fcQTableView_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQTableView_vdata(tmp.h)[] = addr(vtbl[])
  tmp
const cQTableView_mvtbl = cQTableViewVTable(
  ...
  viewOptions: fcQTableView_method_callback_viewOptions,
...
proc create*(T: type gen_qtableview_types.QTableView,
  ...
  inst[].h = fcQTableView_new(addr(cQTableView_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQTableView_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true

proc create*(T: type gen_qtableview_types.QTableView,
    inst: VirtualQTableView) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQTableView_new2(addr(cQTableView_mvtbl), csize_t(sizeof(pointer)))
  fcQTableView_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
