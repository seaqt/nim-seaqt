...
proc fcQTableView_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.importc: "QTableView_virtualbase_nativeEvent".}
...
proc fcQTableView_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QTableView_protectedbase_getDecodedMetricF".}
...
proc fcQTableView_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QTableViewVTable](fcQTableView_vdata(self)[])
  let self = QTableView(h: self)
...
proc fcQTableView_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let inst = cast[VirtualQTableView](fcQTableView_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc getDecodedMetricF*(self: gen_qtableview_types.QTableView, metricA: cint, metricB: cint): float64 =
  fcQTableView_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
