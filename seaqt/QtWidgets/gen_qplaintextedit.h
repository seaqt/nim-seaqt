...
typedef struct QPlainTextEdit_VTable{
	...
	bool (*nativeEvent)(VirtualQPlainTextEdit* self, struct miqt_string eventType, void* message, long* result);
...
const QPlainTextEdit_VTable* QPlainTextEdit_vtbl(const VirtualQPlainTextEdit* self);
void* QPlainTextEdit_vdata(const VirtualQPlainTextEdit* self);
void QPlainTextEdit_setVdata(VirtualQPlainTextEdit* self, void* vdata);
...
const QPlainTextDocumentLayout_VTable* QPlainTextDocumentLayout_vtbl(const VirtualQPlainTextDocumentLayout* self);
void* QPlainTextDocumentLayout_vdata(const VirtualQPlainTextDocumentLayout* self);
void QPlainTextDocumentLayout_setVdata(VirtualQPlainTextDocumentLayout* self, void* vdata);
