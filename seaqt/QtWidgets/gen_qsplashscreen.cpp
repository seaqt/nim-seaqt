...
public:
	...
	friend bool QSplashScreen_virtualbase_nativeEvent(VirtualQSplashScreen* self, struct miqt_string eventType, void* message, intptr_t* result);
...
VirtualQSplashScreen* QSplashScreen_new(const QSplashScreen_VTable* vtbl, size_t vdata) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQSplashScreen>());
