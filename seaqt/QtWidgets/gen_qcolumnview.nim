...
proc fcQColumnView_setPreviewColumnVisible(self: pointer, visible: bool): void {.importc: "QColumnView_setPreviewColumnVisible".}
proc fcQColumnView_isPreviewColumnVisible(self: pointer): bool {.importc: "QColumnView_isPreviewColumnVisible".}
...
proc fcQColumnView_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.importc: "QColumnView_virtualbase_nativeEvent".}
...
proc fcQColumnView_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QColumnView_protectedbase_getDecodedMetricF".}
...
proc setPreviewColumnVisible*(self: gen_qcolumnview_types.QColumnView, visible: bool): void =
  fcQColumnView_setPreviewColumnVisible(self.h, visible)

proc isPreviewColumnVisible*(self: gen_qcolumnview_types.QColumnView): bool =
  fcQColumnView_isPreviewColumnVisible(self.h)
...
proc fcQColumnView_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QColumnViewVTable](fcQColumnView_vdata(self)[])
  let self = QColumnView(h: self)
...
proc fcQColumnView_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let inst = cast[VirtualQColumnView](fcQColumnView_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc getDecodedMetricF*(self: gen_qcolumnview_types.QColumnView, metricA: cint, metricB: cint): float64 =
  fcQColumnView_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
