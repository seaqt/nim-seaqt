...
proc create*(T: type gen_qmdiarea_types.QMdiArea,
  ...
  let tmp = gen_qmdiarea_types.QMdiArea(h: fcQMdiArea_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))))
...
proc create*(T: type gen_qmdiarea_types.QMdiArea,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQMdiArea_vtable_callback_disconnectNotify
  let tmp = gen_qmdiarea_types.QMdiArea(h: fcQMdiArea_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h))
  fcQMdiArea_vdata(tmp.h)[] = addr(vtbl[])
  tmp
