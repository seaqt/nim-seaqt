...
proc fcQGraphicsItemAnimation_posList(self: pointer): struct_seaqt_array {.importc: "QGraphicsItemAnimation_posList".}
...
proc fcQGraphicsItemAnimation_rotationList(self: pointer): struct_seaqt_array {.importc: "QGraphicsItemAnimation_rotationList".}
...
proc fcQGraphicsItemAnimation_translationList(self: pointer): struct_seaqt_array {.importc: "QGraphicsItemAnimation_translationList".}
...
proc fcQGraphicsItemAnimation_scaleList(self: pointer): struct_seaqt_array {.importc: "QGraphicsItemAnimation_scaleList".}
...
proc fcQGraphicsItemAnimation_shearList(self: pointer): struct_seaqt_array {.importc: "QGraphicsItemAnimation_shearList".}
...
proc create*(T: type gen_qgraphicsitemanimation_types.QGraphicsItemAnimation,
  ...
  let tmp = gen_qgraphicsitemanimation_types.QGraphicsItemAnimation(h: fcQGraphicsItemAnimation_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQGraphicsItemAnimation_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qgraphicsitemanimation_types.QGraphicsItemAnimation,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQGraphicsItemAnimation_vtable_callback_disconnectNotify
  let tmp = gen_qgraphicsitemanimation_types.QGraphicsItemAnimation(h: fcQGraphicsItemAnimation_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQGraphicsItemAnimation_vdata(tmp.h)[] = addr(vtbl[])
  tmp
