...
VirtualQListWidgetItem* QListWidgetItem_new(const QListWidgetItem_VTable* vtbl, size_t vdata) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQListWidgetItem>());
	return _mem_ ? new (_mem_)VirtualQListWidgetItem(vtbl) : nullptr;
}

VirtualQListWidgetItem* QListWidgetItem_new2(const QListWidgetItem_VTable* vtbl, size_t vdata, struct miqt_string text) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQListWidgetItem>());
	return _mem_ ? new (_mem_)VirtualQListWidgetItem(vtbl, text_QString) : nullptr;
}

VirtualQListWidgetItem* QListWidgetItem_new3(const QListWidgetItem_VTable* vtbl, size_t vdata, QIcon* icon, struct miqt_string text) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQListWidgetItem>());
...
VirtualQListWidgetItem* QListWidgetItem_new7(const QListWidgetItem_VTable* vtbl, size_t vdata, struct miqt_string text, QListWidget* listview) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQListWidgetItem>());
	return _mem_ ? new (_mem_)VirtualQListWidgetItem(vtbl, text_QString, listview) : nullptr;
}

VirtualQListWidgetItem* QListWidgetItem_new8(const QListWidgetItem_VTable* vtbl, size_t vdata, struct miqt_string text, QListWidget* listview, int type) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQListWidgetItem>());
	return _mem_ ? new (_mem_)VirtualQListWidgetItem(vtbl, text_QString, listview, static_cast<int>(type)) : nullptr;
}

VirtualQListWidgetItem* QListWidgetItem_new9(const QListWidgetItem_VTable* vtbl, size_t vdata, QIcon* icon, struct miqt_string text, QListWidget* listview) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQListWidgetItem>());
	return _mem_ ? new (_mem_)VirtualQListWidgetItem(vtbl, *icon, text_QString, listview) : nullptr;
}

VirtualQListWidgetItem* QListWidgetItem_new10(const QListWidgetItem_VTable* vtbl, size_t vdata, QIcon* icon, struct miqt_string text, QListWidget* listview, int type) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQListWidgetItem>());
...
VirtualQListWidget* QListWidget_new(const QListWidget_VTable* vtbl, size_t vdata, QWidget* parent) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQListWidget>());
