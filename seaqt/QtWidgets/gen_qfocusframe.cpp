...
public:
	...
	friend bool QFocusFrame_virtualbase_nativeEvent(VirtualQFocusFrame* self, struct miqt_string eventType, void* message, intptr_t* result);
...
VirtualQFocusFrame* QFocusFrame_new(const QFocusFrame_VTable* vtbl, size_t vdata, QWidget* parent) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQFocusFrame>());
...
bool QFocusFrame_virtualbase_nativeEvent(VirtualQFocusFrame* self, struct miqt_string eventType, void* message, intptr_t* result) {
