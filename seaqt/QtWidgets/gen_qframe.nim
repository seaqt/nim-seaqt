...
proc miqt_exec_method_cQFrame_metaObject(vtbl: pointer, inst: pointer): pointer {.cdecl.} =
  let vtbl = cast[VirtualQFrame](cast[uint](vtbl) - uint(offsetOf(VirtualQFrame, vtbl)))
...
proc miqt_exec_method_cQFrame_metacast(vtbl: pointer, inst: pointer, param1: cstring): pointer {.cdecl.} =
  let vtbl = cast[VirtualQFrame](cast[uint](vtbl) - uint(offsetOf(VirtualQFrame, vtbl)))
  let slotval1 = (param1)
...
proc miqt_exec_method_cQFrame_metacall(vtbl: pointer, inst: pointer, param1: cint, param2: cint, param3: pointer): cint {.cdecl.} =
  let vtbl = cast[VirtualQFrame](cast[uint](vtbl) - uint(offsetOf(VirtualQFrame, vtbl)))
  let slotval1 = cint(param1)
  let slotval2 = param2
  let slotval3 = param3
...
method sizeHint*(self: VirtualQFrame, ): gen_qsize_types.QSize {.base.} =
  QFramesizeHint(self[])
proc miqt_exec_method_cQFrame_sizeHint(vtbl: pointer, inst: pointer): pointer {.cdecl.} =
  let vtbl = cast[VirtualQFrame](cast[uint](vtbl) - uint(offsetOf(VirtualQFrame, vtbl)))
...
method event*(self: VirtualQFrame, e: gen_qcoreevent_types.QEvent): bool {.base.} =
  QFrameevent(self[], e)
proc miqt_exec_method_cQFrame_event(vtbl: pointer, inst: pointer, e: pointer): bool {.cdecl.} =
  let vtbl = cast[VirtualQFrame](cast[uint](vtbl) - uint(offsetOf(VirtualQFrame, vtbl)))
  let slotval1 = gen_qcoreevent_types.QEvent(h: e, owned: false)
...
proc miqt_exec_method_cQFrame_paintEvent(vtbl: pointer, inst: pointer, param1: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQFrame](cast[uint](vtbl) - uint(offsetOf(VirtualQFrame, vtbl)))
  let slotval1 = gen_qevent_types.QPaintEvent(h: param1, owned: false)
...
proc miqt_exec_method_cQFrame_changeEvent(vtbl: pointer, inst: pointer, param1: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQFrame](cast[uint](vtbl) - uint(offsetOf(VirtualQFrame, vtbl)))
  let slotval1 = gen_qcoreevent_types.QEvent(h: param1, owned: false)
...
method devType*(self: VirtualQFrame, ): cint {.base.} =
  QFramedevType(self[])
proc miqt_exec_method_cQFrame_devType(vtbl: pointer, inst: pointer): cint {.cdecl.} =
  let vtbl = cast[VirtualQFrame](cast[uint](vtbl) - uint(offsetOf(VirtualQFrame, vtbl)))
...
proc miqt_exec_method_cQFrame_setVisible(vtbl: pointer, inst: pointer, visible: bool): void {.cdecl.} =
  let vtbl = cast[VirtualQFrame](cast[uint](vtbl) - uint(offsetOf(VirtualQFrame, vtbl)))
  let slotval1 = visible
...
proc miqt_exec_method_cQFrame_minimumSizeHint(vtbl: pointer, inst: pointer): pointer {.cdecl.} =
  let vtbl = cast[VirtualQFrame](cast[uint](vtbl) - uint(offsetOf(VirtualQFrame, vtbl)))
...
proc miqt_exec_method_cQFrame_heightForWidth(vtbl: pointer, inst: pointer, param1: cint): cint {.cdecl.} =
  let vtbl = cast[VirtualQFrame](cast[uint](vtbl) - uint(offsetOf(VirtualQFrame, vtbl)))
  let slotval1 = param1
...
proc miqt_exec_method_cQFrame_hasHeightForWidth(vtbl: pointer, inst: pointer): bool {.cdecl.} =
  let vtbl = cast[VirtualQFrame](cast[uint](vtbl) - uint(offsetOf(VirtualQFrame, vtbl)))
...
proc miqt_exec_method_cQFrame_paintEngine(vtbl: pointer, inst: pointer): pointer {.cdecl.} =
  let vtbl = cast[VirtualQFrame](cast[uint](vtbl) - uint(offsetOf(VirtualQFrame, vtbl)))
...
proc miqt_exec_method_cQFrame_mousePressEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQFrame](cast[uint](vtbl) - uint(offsetOf(VirtualQFrame, vtbl)))
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
...
proc miqt_exec_method_cQFrame_mouseReleaseEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQFrame](cast[uint](vtbl) - uint(offsetOf(VirtualQFrame, vtbl)))
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
...
proc miqt_exec_method_cQFrame_mouseDoubleClickEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQFrame](cast[uint](vtbl) - uint(offsetOf(VirtualQFrame, vtbl)))
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
...
proc miqt_exec_method_cQFrame_mouseMoveEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQFrame](cast[uint](vtbl) - uint(offsetOf(VirtualQFrame, vtbl)))
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
...
proc miqt_exec_method_cQFrame_wheelEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQFrame](cast[uint](vtbl) - uint(offsetOf(VirtualQFrame, vtbl)))
  let slotval1 = gen_qevent_types.QWheelEvent(h: event, owned: false)
...
proc miqt_exec_method_cQFrame_keyPressEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQFrame](cast[uint](vtbl) - uint(offsetOf(VirtualQFrame, vtbl)))
  let slotval1 = gen_qevent_types.QKeyEvent(h: event, owned: false)
...
proc miqt_exec_method_cQFrame_keyReleaseEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQFrame](cast[uint](vtbl) - uint(offsetOf(VirtualQFrame, vtbl)))
  let slotval1 = gen_qevent_types.QKeyEvent(h: event, owned: false)
...
proc miqt_exec_method_cQFrame_focusInEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQFrame](cast[uint](vtbl) - uint(offsetOf(VirtualQFrame, vtbl)))
  let slotval1 = gen_qevent_types.QFocusEvent(h: event, owned: false)
...
proc miqt_exec_method_cQFrame_focusOutEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQFrame](cast[uint](vtbl) - uint(offsetOf(VirtualQFrame, vtbl)))
  let slotval1 = gen_qevent_types.QFocusEvent(h: event, owned: false)
...
proc miqt_exec_method_cQFrame_enterEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQFrame](cast[uint](vtbl) - uint(offsetOf(VirtualQFrame, vtbl)))
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
...
proc miqt_exec_method_cQFrame_leaveEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQFrame](cast[uint](vtbl) - uint(offsetOf(VirtualQFrame, vtbl)))
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
...
proc miqt_exec_method_cQFrame_moveEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQFrame](cast[uint](vtbl) - uint(offsetOf(VirtualQFrame, vtbl)))
  let slotval1 = gen_qevent_types.QMoveEvent(h: event, owned: false)
...
proc miqt_exec_method_cQFrame_resizeEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQFrame](cast[uint](vtbl) - uint(offsetOf(VirtualQFrame, vtbl)))
  let slotval1 = gen_qevent_types.QResizeEvent(h: event, owned: false)
...
proc miqt_exec_method_cQFrame_closeEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQFrame](cast[uint](vtbl) - uint(offsetOf(VirtualQFrame, vtbl)))
  let slotval1 = gen_qevent_types.QCloseEvent(h: event, owned: false)
...
proc miqt_exec_method_cQFrame_contextMenuEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQFrame](cast[uint](vtbl) - uint(offsetOf(VirtualQFrame, vtbl)))
  let slotval1 = gen_qevent_types.QContextMenuEvent(h: event, owned: false)
...
proc miqt_exec_method_cQFrame_tabletEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQFrame](cast[uint](vtbl) - uint(offsetOf(VirtualQFrame, vtbl)))
  let slotval1 = gen_qevent_types.QTabletEvent(h: event, owned: false)
...
proc miqt_exec_method_cQFrame_actionEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQFrame](cast[uint](vtbl) - uint(offsetOf(VirtualQFrame, vtbl)))
  let slotval1 = gen_qevent_types.QActionEvent(h: event, owned: false)
...
proc miqt_exec_method_cQFrame_dragEnterEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQFrame](cast[uint](vtbl) - uint(offsetOf(VirtualQFrame, vtbl)))
  let slotval1 = gen_qevent_types.QDragEnterEvent(h: event, owned: false)
...
proc miqt_exec_method_cQFrame_dragMoveEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQFrame](cast[uint](vtbl) - uint(offsetOf(VirtualQFrame, vtbl)))
  let slotval1 = gen_qevent_types.QDragMoveEvent(h: event, owned: false)
...
proc miqt_exec_method_cQFrame_dragLeaveEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQFrame](cast[uint](vtbl) - uint(offsetOf(VirtualQFrame, vtbl)))
  let slotval1 = gen_qevent_types.QDragLeaveEvent(h: event, owned: false)
...
proc miqt_exec_method_cQFrame_dropEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQFrame](cast[uint](vtbl) - uint(offsetOf(VirtualQFrame, vtbl)))
  let slotval1 = gen_qevent_types.QDropEvent(h: event, owned: false)
...
proc miqt_exec_method_cQFrame_showEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQFrame](cast[uint](vtbl) - uint(offsetOf(VirtualQFrame, vtbl)))
  let slotval1 = gen_qevent_types.QShowEvent(h: event, owned: false)
...
proc miqt_exec_method_cQFrame_hideEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQFrame](cast[uint](vtbl) - uint(offsetOf(VirtualQFrame, vtbl)))
  let slotval1 = gen_qevent_types.QHideEvent(h: event, owned: false)
  vtbl.hideEvent(slotval1)

method nativeEvent*(self: VirtualQFrame, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool {.base.} =
  QFramenativeEvent(self[], eventType, message, resultVal)
proc miqt_exec_method_cQFrame_nativeEvent(vtbl: pointer, inst: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let vtbl = cast[VirtualQFrame](cast[uint](vtbl) - uint(offsetOf(VirtualQFrame, vtbl)))
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArrayByte(veventType_bytearray.data, 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc miqt_exec_method_cQFrame_metric(vtbl: pointer, inst: pointer, param1: cint): cint {.cdecl.} =
  let vtbl = cast[VirtualQFrame](cast[uint](vtbl) - uint(offsetOf(VirtualQFrame, vtbl)))
  let slotval1 = cint(param1)
...
proc miqt_exec_method_cQFrame_initPainter(vtbl: pointer, inst: pointer, painter: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQFrame](cast[uint](vtbl) - uint(offsetOf(VirtualQFrame, vtbl)))
  let slotval1 = gen_qpainter_types.QPainter(h: painter, owned: false)
...
proc miqt_exec_method_cQFrame_redirected(vtbl: pointer, inst: pointer, offset: pointer): pointer {.cdecl.} =
  let vtbl = cast[VirtualQFrame](cast[uint](vtbl) - uint(offsetOf(VirtualQFrame, vtbl)))
  let slotval1 = gen_qpoint_types.QPoint(h: offset, owned: false)
...
proc miqt_exec_method_cQFrame_sharedPainter(vtbl: pointer, inst: pointer): pointer {.cdecl.} =
  let vtbl = cast[VirtualQFrame](cast[uint](vtbl) - uint(offsetOf(VirtualQFrame, vtbl)))
...
proc miqt_exec_method_cQFrame_inputMethodEvent(vtbl: pointer, inst: pointer, param1: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQFrame](cast[uint](vtbl) - uint(offsetOf(VirtualQFrame, vtbl)))
  let slotval1 = gen_qevent_types.QInputMethodEvent(h: param1, owned: false)
...
proc miqt_exec_method_cQFrame_inputMethodQuery(vtbl: pointer, inst: pointer, param1: cint): pointer {.cdecl.} =
  let vtbl = cast[VirtualQFrame](cast[uint](vtbl) - uint(offsetOf(VirtualQFrame, vtbl)))
  let slotval1 = cint(param1)
...
proc miqt_exec_method_cQFrame_focusNextPrevChild(vtbl: pointer, inst: pointer, next: bool): bool {.cdecl.} =
  let vtbl = cast[VirtualQFrame](cast[uint](vtbl) - uint(offsetOf(VirtualQFrame, vtbl)))
  let slotval1 = next
...
proc miqt_exec_method_cQFrame_eventFilter(vtbl: pointer, inst: pointer, watched: pointer, event: pointer): bool {.cdecl.} =
  let vtbl = cast[VirtualQFrame](cast[uint](vtbl) - uint(offsetOf(VirtualQFrame, vtbl)))
  let slotval1 = gen_qobject_types.QObject(h: watched, owned: false)
  let slotval2 = gen_qcoreevent_types.QEvent(h: event, owned: false)
...
proc miqt_exec_method_cQFrame_timerEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQFrame](cast[uint](vtbl) - uint(offsetOf(VirtualQFrame, vtbl)))
  let slotval1 = gen_qcoreevent_types.QTimerEvent(h: event, owned: false)
...
proc miqt_exec_method_cQFrame_childEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQFrame](cast[uint](vtbl) - uint(offsetOf(VirtualQFrame, vtbl)))
  let slotval1 = gen_qcoreevent_types.QChildEvent(h: event, owned: false)
...
proc miqt_exec_method_cQFrame_customEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQFrame](cast[uint](vtbl) - uint(offsetOf(VirtualQFrame, vtbl)))
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
...
proc miqt_exec_method_cQFrame_connectNotify(vtbl: pointer, inst: pointer, signal: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQFrame](cast[uint](vtbl) - uint(offsetOf(VirtualQFrame, vtbl)))
  let slotval1 = gen_qmetaobject_types.QMetaMethod(h: signal, owned: false)
...
proc miqt_exec_method_cQFrame_disconnectNotify(vtbl: pointer, inst: pointer, signal: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQFrame](cast[uint](vtbl) - uint(offsetOf(VirtualQFrame, vtbl)))
  let slotval1 = gen_qmetaobject_types.QMetaMethod(h: signal, owned: false)
...
proc create*(T: type gen_qframe_types.QFrame,
  ...
  gen_qframe_types.QFrame(h: fcQFrame_new(addr(vtbl[].vtbl), parent.h), owned: true)
...
proc create*(T: type gen_qframe_types.QFrame,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = miqt_exec_callback_cQFrame_disconnectNotify
  gen_qframe_types.QFrame(h: fcQFrame_new2(addr(vtbl[].vtbl), ), owned: true)
...
proc create*(T: type gen_qframe_types.QFrame,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = miqt_exec_callback_cQFrame_disconnectNotify
  gen_qframe_types.QFrame(h: fcQFrame_new3(addr(vtbl[].vtbl), parent.h, cint(f)), owned: true)
...
proc create*(T: type gen_qframe_types.QFrame,
  ...
  vtbl[].vtbl.destructor = proc(vtbl: ptr cQFrameVTable, _: ptr cQFrame) {.cdecl.} =
    let vtbl = cast[ptr typeof(VirtualQFrame()[])](cast[uint](vtbl) - uint(offsetOf(VirtualQFrame, vtbl)))
    vtbl[].h = nil
    vtbl[].owned = false
  vtbl[].vtbl.metaObject = miqt_exec_method_cQFrame_metaObject
  vtbl[].vtbl.metacast = miqt_exec_method_cQFrame_metacast
  vtbl[].vtbl.metacall = miqt_exec_method_cQFrame_metacall
  vtbl[].vtbl.sizeHint = miqt_exec_method_cQFrame_sizeHint
  vtbl[].vtbl.event = miqt_exec_method_cQFrame_event
  vtbl[].vtbl.paintEvent = miqt_exec_method_cQFrame_paintEvent
  vtbl[].vtbl.changeEvent = miqt_exec_method_cQFrame_changeEvent
  vtbl[].vtbl.devType = miqt_exec_method_cQFrame_devType
  vtbl[].vtbl.setVisible = miqt_exec_method_cQFrame_setVisible
  vtbl[].vtbl.minimumSizeHint = miqt_exec_method_cQFrame_minimumSizeHint
  vtbl[].vtbl.heightForWidth = miqt_exec_method_cQFrame_heightForWidth
  vtbl[].vtbl.hasHeightForWidth = miqt_exec_method_cQFrame_hasHeightForWidth
  vtbl[].vtbl.paintEngine = miqt_exec_method_cQFrame_paintEngine
  vtbl[].vtbl.mousePressEvent = miqt_exec_method_cQFrame_mousePressEvent
  vtbl[].vtbl.mouseReleaseEvent = miqt_exec_method_cQFrame_mouseReleaseEvent
  vtbl[].vtbl.mouseDoubleClickEvent = miqt_exec_method_cQFrame_mouseDoubleClickEvent
  vtbl[].vtbl.mouseMoveEvent = miqt_exec_method_cQFrame_mouseMoveEvent
  vtbl[].vtbl.wheelEvent = miqt_exec_method_cQFrame_wheelEvent
  vtbl[].vtbl.keyPressEvent = miqt_exec_method_cQFrame_keyPressEvent
  vtbl[].vtbl.keyReleaseEvent = miqt_exec_method_cQFrame_keyReleaseEvent
  vtbl[].vtbl.focusInEvent = miqt_exec_method_cQFrame_focusInEvent
  vtbl[].vtbl.focusOutEvent = miqt_exec_method_cQFrame_focusOutEvent
  vtbl[].vtbl.enterEvent = miqt_exec_method_cQFrame_enterEvent
  vtbl[].vtbl.leaveEvent = miqt_exec_method_cQFrame_leaveEvent
  vtbl[].vtbl.moveEvent = miqt_exec_method_cQFrame_moveEvent
  vtbl[].vtbl.resizeEvent = miqt_exec_method_cQFrame_resizeEvent
  vtbl[].vtbl.closeEvent = miqt_exec_method_cQFrame_closeEvent
  vtbl[].vtbl.contextMenuEvent = miqt_exec_method_cQFrame_contextMenuEvent
  vtbl[].vtbl.tabletEvent = miqt_exec_method_cQFrame_tabletEvent
  vtbl[].vtbl.actionEvent = miqt_exec_method_cQFrame_actionEvent
  vtbl[].vtbl.dragEnterEvent = miqt_exec_method_cQFrame_dragEnterEvent
  vtbl[].vtbl.dragMoveEvent = miqt_exec_method_cQFrame_dragMoveEvent
  vtbl[].vtbl.dragLeaveEvent = miqt_exec_method_cQFrame_dragLeaveEvent
  vtbl[].vtbl.dropEvent = miqt_exec_method_cQFrame_dropEvent
  vtbl[].vtbl.showEvent = miqt_exec_method_cQFrame_showEvent
  vtbl[].vtbl.hideEvent = miqt_exec_method_cQFrame_hideEvent
  vtbl[].vtbl.nativeEvent = miqt_exec_method_cQFrame_nativeEvent
  vtbl[].vtbl.metric = miqt_exec_method_cQFrame_metric
  vtbl[].vtbl.initPainter = miqt_exec_method_cQFrame_initPainter
  vtbl[].vtbl.redirected = miqt_exec_method_cQFrame_redirected
  vtbl[].vtbl.sharedPainter = miqt_exec_method_cQFrame_sharedPainter
  vtbl[].vtbl.inputMethodEvent = miqt_exec_method_cQFrame_inputMethodEvent
  vtbl[].vtbl.inputMethodQuery = miqt_exec_method_cQFrame_inputMethodQuery
  vtbl[].vtbl.focusNextPrevChild = miqt_exec_method_cQFrame_focusNextPrevChild
  vtbl[].vtbl.eventFilter = miqt_exec_method_cQFrame_eventFilter
  vtbl[].vtbl.timerEvent = miqt_exec_method_cQFrame_timerEvent
  vtbl[].vtbl.childEvent = miqt_exec_method_cQFrame_childEvent
  vtbl[].vtbl.customEvent = miqt_exec_method_cQFrame_customEvent
  vtbl[].vtbl.connectNotify = miqt_exec_method_cQFrame_connectNotify
  vtbl[].vtbl.disconnectNotify = miqt_exec_method_cQFrame_disconnectNotify
  if vtbl[].h != nil: delete(move(vtbl[]))
  vtbl[].h = fcQFrame_new(addr(vtbl[].vtbl), parent.h)
  vtbl[].owned = true
...
proc create*(T: type gen_qframe_types.QFrame,
  ...
  vtbl[].vtbl.disconnectNotify = miqt_exec_method_cQFrame_disconnectNotify
  if vtbl[].h != nil: delete(move(vtbl[]))
  vtbl[].h = fcQFrame_new2(addr(vtbl[].vtbl), )
  vtbl[].owned = true
...
proc create*(T: type gen_qframe_types.QFrame,
  ...
  vtbl[].vtbl.disconnectNotify = miqt_exec_method_cQFrame_disconnectNotify
  if vtbl[].h != nil: delete(move(vtbl[]))
  vtbl[].h = fcQFrame_new3(addr(vtbl[].vtbl), parent.h, cint(f))
  vtbl[].owned = true
