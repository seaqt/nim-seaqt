...
typedef struct QGraphicsView_VTable{
	...
	bool (*nativeEvent)(VirtualQGraphicsView* self, struct miqt_string eventType, void* message, intptr_t* result);
...
const QGraphicsView_VTable* QGraphicsView_vtbl(const VirtualQGraphicsView* self);
void* QGraphicsView_vdata(const VirtualQGraphicsView* self);
void QGraphicsView_setVdata(VirtualQGraphicsView* self, void* vdata);
