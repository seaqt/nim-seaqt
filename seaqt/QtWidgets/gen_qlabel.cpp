...
VirtualQLabel* QLabel_new(const QLabel_VTable* vtbl, size_t vdata, QWidget* parent) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQLabel>());
...
VirtualQLabel* QLabel_new3(const QLabel_VTable* vtbl, size_t vdata, struct miqt_string text) {
...
VirtualQLabel* QLabel_new5(const QLabel_VTable* vtbl, size_t vdata, struct miqt_string text, QWidget* parent) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQLabel>());
	return _mem_ ? new (_mem_)VirtualQLabel(vtbl, text_QString, parent) : nullptr;
}

VirtualQLabel* QLabel_new6(const QLabel_VTable* vtbl, size_t vdata, struct miqt_string text, QWidget* parent, int f) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQLabel>());
