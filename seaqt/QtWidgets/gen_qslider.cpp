...
public:
	...
	friend bool QSlider_virtualbase_nativeEvent(VirtualQSlider* self, struct miqt_string eventType, void* message, intptr_t* result);
...
VirtualQSlider* QSlider_new(const QSlider_VTable* vtbl, size_t vdata, QWidget* parent) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQSlider>());
