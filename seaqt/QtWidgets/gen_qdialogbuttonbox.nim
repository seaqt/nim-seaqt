...
proc fcQDialogButtonBox_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.importc: "QDialogButtonBox_virtualbase_nativeEvent".}
...
proc fcQDialogButtonBox_new2(vtbl: pointer, vdata: csize_t, orientation: cint): ptr cQDialogButtonBox {.importc: "QDialogButtonBox_new2".}
proc fcQDialogButtonBox_new3(vtbl: pointer, vdata: csize_t, buttons: cint): ptr cQDialogButtonBox {.importc: "QDialogButtonBox_new3".}
proc fcQDialogButtonBox_new4(vtbl: pointer, vdata: csize_t, buttons: cint, orientation: cint): ptr cQDialogButtonBox {.importc: "QDialogButtonBox_new4".}
proc fcQDialogButtonBox_new5(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQDialogButtonBox {.importc: "QDialogButtonBox_new5".}
...
proc addButton*(self: gen_qdialogbuttonbox_types.QDialogButtonBox, text: openArray[char], role: cint): gen_qpushbutton_types.QPushButton =
  gen_qpushbutton_types.QPushButton(h: fcQDialogButtonBox_addButton2(self.h, struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), cint(role)))
...
proc fcQDialogButtonBox_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let vtbl = cast[ptr QDialogButtonBoxVTable](fcQDialogButtonBox_vdata(self)[])
  let self = QDialogButtonBox(h: self)
...
proc fcQDialogButtonBox_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let inst = cast[VirtualQDialogButtonBox](fcQDialogButtonBox_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc create*(T: type gen_qdialogbuttonbox_types.QDialogButtonBox,
  ...
  let tmp = gen_qdialogbuttonbox_types.QDialogButtonBox(h: fcQDialogButtonBox_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))))
...
proc create*(T: type gen_qdialogbuttonbox_types.QDialogButtonBox,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQDialogButtonBox_vtable_callback_disconnectNotify
  let tmp = gen_qdialogbuttonbox_types.QDialogButtonBox(h: fcQDialogButtonBox_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), cint(orientation)))
  fcQDialogButtonBox_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create2*(T: type gen_qdialogbuttonbox_types.QDialogButtonBox,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQDialogButtonBox_vtable_callback_disconnectNotify
  let tmp = gen_qdialogbuttonbox_types.QDialogButtonBox(h: fcQDialogButtonBox_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), cint(buttons)))
  fcQDialogButtonBox_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qdialogbuttonbox_types.QDialogButtonBox,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQDialogButtonBox_vtable_callback_disconnectNotify
  let tmp = gen_qdialogbuttonbox_types.QDialogButtonBox(h: fcQDialogButtonBox_new4(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), cint(buttons), cint(orientation)))
  fcQDialogButtonBox_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qdialogbuttonbox_types.QDialogButtonBox,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQDialogButtonBox_vtable_callback_disconnectNotify
  let tmp = gen_qdialogbuttonbox_types.QDialogButtonBox(h: fcQDialogButtonBox_new5(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h))
  fcQDialogButtonBox_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qdialogbuttonbox_types.QDialogButtonBox,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQDialogButtonBox_vtable_callback_disconnectNotify
  let tmp = gen_qdialogbuttonbox_types.QDialogButtonBox(h: fcQDialogButtonBox_new6(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), cint(orientation), parent.h))
  fcQDialogButtonBox_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create2*(T: type gen_qdialogbuttonbox_types.QDialogButtonBox,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQDialogButtonBox_vtable_callback_disconnectNotify
  let tmp = gen_qdialogbuttonbox_types.QDialogButtonBox(h: fcQDialogButtonBox_new7(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), cint(buttons), parent.h))
  fcQDialogButtonBox_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qdialogbuttonbox_types.QDialogButtonBox,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQDialogButtonBox_vtable_callback_disconnectNotify
  let tmp = gen_qdialogbuttonbox_types.QDialogButtonBox(h: fcQDialogButtonBox_new8(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), cint(buttons), cint(orientation), parent.h))
  fcQDialogButtonBox_vdata(tmp.h)[] = addr(vtbl[])
  tmp
