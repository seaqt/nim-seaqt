...
proc fcQScrollArea_trUtf8(s: cstring): struct_seaqt_string {.importc: "QScrollArea_trUtf8".}
...
proc fcQScrollArea_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QScrollArea_trUtf82".}
proc fcQScrollArea_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QScrollArea_trUtf83".}
...
proc fcQScrollArea_new2(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQScrollArea {.importc: "QScrollArea_new2".}
