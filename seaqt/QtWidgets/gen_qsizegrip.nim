...
proc fcQSizeGrip_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QSizeGrip_protectedbase_getDecodedMetricF".}
...
proc getDecodedMetricF*(self: gen_qsizegrip_types.QSizeGrip, metricA: cint, metricB: cint): float64 =
  fcQSizeGrip_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
