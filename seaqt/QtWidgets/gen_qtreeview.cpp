...
public:
	...
	friend bool QTreeView_virtualbase_nativeEvent(VirtualQTreeView* self, struct miqt_string eventType, void* message, long* result);
...
bool QTreeView_virtualbase_nativeEvent(VirtualQTreeView* self, struct miqt_string eventType, void* message, long* result) {
