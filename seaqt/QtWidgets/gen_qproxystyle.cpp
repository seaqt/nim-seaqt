...
VirtualQProxyStyle* QProxyStyle_new(const QProxyStyle_VTable* vtbl, size_t vdata) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQProxyStyle>());
	return _mem_ ? new (_mem_)VirtualQProxyStyle(vtbl) : nullptr;
}

VirtualQProxyStyle* QProxyStyle_new2(const QProxyStyle_VTable* vtbl, size_t vdata, struct miqt_string key) {
