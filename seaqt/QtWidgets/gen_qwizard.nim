...
template StretchBanner*(_: type QWizardWizardOptionEnum): untyped = 131072
...
proc fcQWizard_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.importc: "QWizard_virtualbase_nativeEvent".}
...
proc fcQWizard_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QWizard_protectedbase_getDecodedMetricF".}
...
proc fcQWizardPage_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.importc: "QWizardPage_virtualbase_nativeEvent".}
...
proc fcQWizardPage_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QWizardPage_protectedbase_getDecodedMetricF".}
...
proc fcQWizard_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QWizardVTable](fcQWizard_vdata(self)[])
  let self = QWizard(h: self)
...
proc fcQWizard_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let inst = cast[VirtualQWizard](fcQWizard_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc getDecodedMetricF*(self: gen_qwizard_types.QWizard, metricA: cint, metricB: cint): float64 =
  fcQWizard_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
...
proc fcQWizardPage_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QWizardPageVTable](fcQWizardPage_vdata(self)[])
  let self = QWizardPage(h: self)
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
...
proc fcQWizardPage_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let inst = cast[VirtualQWizardPage](fcQWizardPage_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc getDecodedMetricF*(self: gen_qwizard_types.QWizardPage, metricA: cint, metricB: cint): float64 =
  fcQWizardPage_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
