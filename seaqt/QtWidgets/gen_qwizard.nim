...
proc create*(T: type gen_qwizard_types.QWizard,
  ...
  let tmp = gen_qwizard_types.QWizard(h: fcQWizard_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))))
...
proc create*(T: type gen_qwizard_types.QWizard,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQWizard_vtable_callback_disconnectNotify
  let tmp = gen_qwizard_types.QWizard(h: fcQWizard_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h))
  fcQWizard_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qwizard_types.QWizard,
...
proc create*(T: type gen_qwizard_types.QWizardPage,
  ...
  let tmp = gen_qwizard_types.QWizardPage(h: fcQWizardPage_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))))
...
proc create*(T: type gen_qwizard_types.QWizardPage,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQWizardPage_vtable_callback_disconnectNotify
  let tmp = gen_qwizard_types.QWizardPage(h: fcQWizardPage_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h))
  fcQWizardPage_vdata(tmp.h)[] = addr(vtbl[])
  tmp
