...
proc fcQMainWindow_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.importc: "QMainWindow_virtualbase_nativeEvent".}
...
proc fcQMainWindow_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QMainWindow_protectedbase_getDecodedMetricF".}
...
proc fcQMainWindow_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QMainWindowVTable](fcQMainWindow_vdata(self)[])
  let self = QMainWindow(h: self)
...
method enterEvent*(self: VirtualQMainWindow, event: gen_qevent_types.QEnterEvent): void {.base.} =
...
proc fcQMainWindow_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let inst = cast[VirtualQMainWindow](fcQMainWindow_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc getDecodedMetricF*(self: gen_qmainwindow_types.QMainWindow, metricA: cint, metricB: cint): float64 =
  fcQMainWindow_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
