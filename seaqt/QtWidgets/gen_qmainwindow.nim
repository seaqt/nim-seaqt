...
proc create*(T: type gen_qmainwindow_types.QMainWindow,
  ...
  let tmp = gen_qmainwindow_types.QMainWindow(h: fcQMainWindow_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))))
...
proc create*(T: type gen_qmainwindow_types.QMainWindow,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQMainWindow_vtable_callback_disconnectNotify
  let tmp = gen_qmainwindow_types.QMainWindow(h: fcQMainWindow_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h))
  fcQMainWindow_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qmainwindow_types.QMainWindow,
...
proc create*(T: type gen_qmainwindow_types.QMainWindow,
  ...
  inst[].h = fcQMainWindow_new(addr(cQMainWindow_mvtbl), csize_t(sizeof(pointer)))
...
proc create*(T: type gen_qmainwindow_types.QMainWindow,
    ...
    inst: VirtualQMainWindow) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQMainWindow_new2(addr(cQMainWindow_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQMainWindow_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
