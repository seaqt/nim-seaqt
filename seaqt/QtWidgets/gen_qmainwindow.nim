...
proc fcQMainWindow_trUtf8(s: cstring): struct_seaqt_string {.importc: "QMainWindow_trUtf8".}
...
proc fcQMainWindow_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QMainWindow_trUtf82".}
proc fcQMainWindow_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QMainWindow_trUtf83".}
...
proc fcQMainWindow_new(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQMainWindow {.importc: "QMainWindow_new".}
proc fcQMainWindow_new2(vtbl: pointer, vdata: csize_t): ptr cQMainWindow {.importc: "QMainWindow_new2".}
...
proc addToolBar*(self: gen_qmainwindow_types.QMainWindow, title: openArray[char]): gen_qtoolbar_types.QToolBar =
  gen_qtoolbar_types.QToolBar(h: fcQMainWindow_addToolBarWithTitle(self.h, struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title)))))
...
proc create*(T: type gen_qmainwindow_types.QMainWindow,
  ...
  let tmp = gen_qmainwindow_types.QMainWindow(h: fcQMainWindow_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h))
...
proc create*(T: type gen_qmainwindow_types.QMainWindow,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQMainWindow_vtable_callback_disconnectNotify
  let tmp = gen_qmainwindow_types.QMainWindow(h: fcQMainWindow_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer))))
  fcQMainWindow_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qmainwindow_types.QMainWindow,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQMainWindow_vtable_callback_disconnectNotify
  let tmp = gen_qmainwindow_types.QMainWindow(h: fcQMainWindow_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h, cint(flags)))
  fcQMainWindow_vdata(tmp.h)[] = addr(vtbl[])
  tmp
