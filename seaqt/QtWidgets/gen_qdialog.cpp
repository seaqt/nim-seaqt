...
public:
	...
	friend bool QDialog_virtualbase_nativeEvent(VirtualQDialog* self, struct miqt_string eventType, void* message, intptr_t* result);
...
VirtualQDialog* QDialog_new(const QDialog_VTable* vtbl, size_t vdata, QWidget* parent) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQDialog>());
...
bool QDialog_virtualbase_nativeEvent(VirtualQDialog* self, struct miqt_string eventType, void* message, intptr_t* result) {
