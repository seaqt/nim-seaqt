...
const QActionGroup_VTable* QActionGroup_vtbl(const VirtualQActionGroup* self);
void* QActionGroup_vdata(const VirtualQActionGroup* self);
void QActionGroup_setVdata(VirtualQActionGroup* self, void* vdata);
