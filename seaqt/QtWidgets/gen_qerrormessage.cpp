...
public:
	...
	friend bool QErrorMessage_virtualbase_nativeEvent(VirtualQErrorMessage* self, struct miqt_string eventType, void* message, intptr_t* result);
...
VirtualQErrorMessage* QErrorMessage_new(const QErrorMessage_VTable* vtbl, size_t vdata, QWidget* parent) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQErrorMessage>());
...
bool QErrorMessage_virtualbase_nativeEvent(VirtualQErrorMessage* self, struct miqt_string eventType, void* message, intptr_t* result) {
