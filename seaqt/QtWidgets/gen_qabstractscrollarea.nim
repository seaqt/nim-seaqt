...
proc cQAbstractScrollArea_vtable_callback_initStyleOption(self: pointer, option: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QAbstractScrollAreaVTable](fcQAbstractScrollArea_vdata(self))
  let self = QAbstractScrollArea(h: self)
...
proc cQAbstractScrollArea_vtable_callback_nativeEvent(self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QAbstractScrollAreaVTable](fcQAbstractScrollArea_vdata(self))
  let self = QAbstractScrollArea(h: self)
...
proc cQAbstractScrollArea_method_callback_initStyleOption(self: pointer, option: pointer): void {.cdecl.} =
  let inst = cast[VirtualQAbstractScrollArea](fcQAbstractScrollArea_vdata(self))
  let slotval1 = gen_qstyleoption_types.QStyleOptionFrame(h: option, owned: false)
...
proc cQAbstractScrollArea_method_callback_nativeEvent(self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let inst = cast[VirtualQAbstractScrollArea](fcQAbstractScrollArea_vdata(self))
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc create*(T: type gen_qabstractscrollarea_types.QAbstractScrollArea,
  ...
  if not isNil(vtbl[].initStyleOption):
    vtbl[].vtbl.initStyleOption = cQAbstractScrollArea_vtable_callback_initStyleOption
...
const cQAbstractScrollArea_mvtbl = cQAbstractScrollAreaVTable(
  ...
  initStyleOption: cQAbstractScrollArea_method_callback_initStyleOption,
