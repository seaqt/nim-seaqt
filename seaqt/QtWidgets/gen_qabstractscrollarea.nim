...
proc fcQAbstractScrollArea_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.importc: "QAbstractScrollArea_virtualbase_nativeEvent".}
...
proc fcQAbstractScrollArea_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QAbstractScrollArea_protectedbase_getDecodedMetricF".}
...
proc fcQAbstractScrollArea_vtable_callback_initStyleOption(self: pointer, option: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QAbstractScrollAreaVTable](fcQAbstractScrollArea_vdata(self)[])
  let self = QAbstractScrollArea(h: self)
...
proc fcQAbstractScrollArea_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QAbstractScrollAreaVTable](fcQAbstractScrollArea_vdata(self)[])
  let self = QAbstractScrollArea(h: self)
...
method initStyleOption*(self: VirtualQAbstractScrollArea, option: gen_qstyleoption_types.QStyleOptionFrame): void {.base.} =
  QAbstractScrollAreainitStyleOption(self[], option)
...
method enterEvent*(self: VirtualQAbstractScrollArea, event: gen_qevent_types.QEnterEvent): void {.base.} =
...
proc fcQAbstractScrollArea_method_callback_initStyleOption(self: pointer, option: pointer): void {.cdecl.} =
  let inst = cast[VirtualQAbstractScrollArea](fcQAbstractScrollArea_vdata(self)[])
  let slotval1 = gen_qstyleoption_types.QStyleOptionFrame(h: option, owned: false)
...
proc fcQAbstractScrollArea_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let inst = cast[VirtualQAbstractScrollArea](fcQAbstractScrollArea_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc getDecodedMetricF*(self: gen_qabstractscrollarea_types.QAbstractScrollArea, metricA: cint, metricB: cint): float64 =
  fcQAbstractScrollArea_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
...
proc create*(T: type gen_qabstractscrollarea_types.QAbstractScrollArea,
  ...
  if not isNil(vtbl[].initStyleOption):
    vtbl[].vtbl.initStyleOption = fcQAbstractScrollArea_vtable_callback_initStyleOption
  ...
  let tmp = gen_qabstractscrollarea_types.QAbstractScrollArea(h: fcQAbstractScrollArea_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
...
proc create*(T: type gen_qabstractscrollarea_types.QAbstractScrollArea,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQAbstractScrollArea_vtable_callback_disconnectNotify
  let tmp = gen_qabstractscrollarea_types.QAbstractScrollArea(h: fcQAbstractScrollArea_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQAbstractScrollArea_vdata(tmp.h)[] = addr(vtbl[])
  tmp
const cQAbstractScrollArea_mvtbl = cQAbstractScrollAreaVTable(
  ...
  initStyleOption: fcQAbstractScrollArea_method_callback_initStyleOption,
...
proc create*(T: type gen_qabstractscrollarea_types.QAbstractScrollArea,
  ...
  inst[].h = fcQAbstractScrollArea_new(addr(cQAbstractScrollArea_mvtbl), csize_t(sizeof(pointer)))
...
proc create*(T: type gen_qabstractscrollarea_types.QAbstractScrollArea,
    ...
    inst: VirtualQAbstractScrollArea) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQAbstractScrollArea_new2(addr(cQAbstractScrollArea_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQAbstractScrollArea_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
