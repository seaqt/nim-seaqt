...
proc create*(T: type gen_qprogressbar_types.QProgressBar,
  ...
  let tmp = gen_qprogressbar_types.QProgressBar(h: fcQProgressBar_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h))
...
proc create*(T: type gen_qprogressbar_types.QProgressBar,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQProgressBar_vtable_callback_disconnectNotify
  let tmp = gen_qprogressbar_types.QProgressBar(h: fcQProgressBar_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer))))
  fcQProgressBar_vdata(tmp.h)[] = addr(vtbl[])
  tmp
