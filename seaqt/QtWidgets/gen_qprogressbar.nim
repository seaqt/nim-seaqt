...
proc fcQProgressBar_text(self: pointer): struct_seaqt_string {.importc: "QProgressBar_text".}
...
proc fcQProgressBar_setFormat(self: pointer, format: struct_seaqt_string): void {.importc: "QProgressBar_setFormat".}
proc fcQProgressBar_resetFormat(self: pointer): void {.importc: "QProgressBar_resetFormat".}
proc fcQProgressBar_format(self: pointer): struct_seaqt_string {.importc: "QProgressBar_format".}
...
type cQProgressBarVTable {.pure.} = object
  ...
  text*: proc(self: pointer): struct_seaqt_string {.cdecl, raises: [], gcsafe.}
...
proc fcQProgressBar_virtualbase_text(self: pointer): struct_seaqt_string {.importc: "QProgressBar_virtualbase_text".}
...
proc fcQProgressBar_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.importc: "QProgressBar_virtualbase_nativeEvent".}
...
proc fcQProgressBar_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QProgressBar_protectedbase_getDecodedMetricF".}
...
proc setFormat*(self: gen_qprogressbar_types.QProgressBar, format: openArray[char]): void =
  fcQProgressBar_setFormat(self.h, struct_seaqt_string(data: if len(format) > 0: addr format[0] else: nil, len: csize_t(len(format))))
...
proc QProgressBarnativeEvent*(self: gen_qprogressbar_types.QProgressBar, eventType: openArray[byte], message: pointer, resultVal: ptr uint): bool =
  fcQProgressBar_virtualbase_nativeEvent(self.h, struct_seaqt_string(data: if len(eventType) > 0: addr eventType[0] else: nil, len: csize_t(len(eventType))), message, resultVal)
...
proc fcQProgressBar_vtable_callback_text(self: pointer): struct_seaqt_string {.cdecl.} =
  let vtbl = cast[ptr QProgressBarVTable](fcQProgressBar_vdata(self)[])
  let self = QProgressBar(h: self)
...
proc fcQProgressBar_vtable_callback_initStyleOption(self: pointer, option: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QProgressBarVTable](fcQProgressBar_vdata(self)[])
  let self = QProgressBar(h: self)
  let slotval1 = gen_qstyleoption_types.QStyleOptionProgressBar(h: option, owned: false)
...
proc fcQProgressBar_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QProgressBarVTable](fcQProgressBar_vdata(self)[])
  let self = QProgressBar(h: self)
...
method initStyleOption*(self: VirtualQProgressBar, option: gen_qstyleoption_types.QStyleOptionProgressBar): void {.base.} =
  QProgressBarinitStyleOption(self[], option)
...
method enterEvent*(self: VirtualQProgressBar, event: gen_qevent_types.QEnterEvent): void {.base.} =
...
proc fcQProgressBar_method_callback_text(self: pointer): struct_seaqt_string {.cdecl.} =
  let inst = cast[VirtualQProgressBar](fcQProgressBar_vdata(self)[])
...
proc fcQProgressBar_method_callback_initStyleOption(self: pointer, option: pointer): void {.cdecl.} =
  let inst = cast[VirtualQProgressBar](fcQProgressBar_vdata(self)[])
  let slotval1 = gen_qstyleoption_types.QStyleOptionProgressBar(h: option, owned: false)
...
proc fcQProgressBar_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let inst = cast[VirtualQProgressBar](fcQProgressBar_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc getDecodedMetricF*(self: gen_qprogressbar_types.QProgressBar, metricA: cint, metricB: cint): float64 =
  fcQProgressBar_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
...
proc create*(T: type gen_qprogressbar_types.QProgressBar,
  ...
  if not isNil(vtbl[].initStyleOption):
    vtbl[].vtbl.initStyleOption = fcQProgressBar_vtable_callback_initStyleOption
  ...
  let tmp = gen_qprogressbar_types.QProgressBar(h: fcQProgressBar_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQProgressBar_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qprogressbar_types.QProgressBar,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQProgressBar_vtable_callback_disconnectNotify
  let tmp = gen_qprogressbar_types.QProgressBar(h: fcQProgressBar_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQProgressBar_vdata(tmp.h)[] = addr(vtbl[])
  tmp
const cQProgressBar_mvtbl = cQProgressBarVTable(
  ...
  initStyleOption: fcQProgressBar_method_callback_initStyleOption,
...
proc create*(T: type gen_qprogressbar_types.QProgressBar,
  ...
  inst[].h = fcQProgressBar_new(addr(cQProgressBar_mvtbl), csize_t(sizeof(pointer)))
...
proc create*(T: type gen_qprogressbar_types.QProgressBar,
    ...
    inst: VirtualQProgressBar) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQProgressBar_new2(addr(cQProgressBar_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQProgressBar_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
