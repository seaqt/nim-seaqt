...
proc fcQProgressBar_new(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQProgressBar {.importc: "QProgressBar_new".}
proc fcQProgressBar_new2(vtbl: pointer, vdata: csize_t): ptr cQProgressBar {.importc: "QProgressBar_new2".}
