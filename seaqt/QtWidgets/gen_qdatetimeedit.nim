...
proc miqt_exec_method_cQDateTimeEdit_initStyleOption(vtbl: pointer, inst: pointer, option: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQDateTimeEdit](cast[uint](vtbl) - uint(offsetOf(VirtualQDateTimeEdit, vtbl)))
  let slotval1 = gen_qstyleoption_types.QStyleOptionSpinBox(h: option, owned: false)
...
proc miqt_exec_method_cQDateTimeEdit_nativeEvent(vtbl: pointer, inst: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[VirtualQDateTimeEdit](cast[uint](vtbl) - uint(offsetOf(VirtualQDateTimeEdit, vtbl)))
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArrayByte(veventType_bytearray.data, 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc create*(T: type gen_qdatetimeedit_types.QDateTimeEdit,
  ...
  vtbl[].vtbl.initStyleOption = miqt_exec_method_cQDateTimeEdit_initStyleOption
...
proc miqt_exec_method_cQTimeEdit_initStyleOption(vtbl: pointer, inst: pointer, option: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQTimeEdit](cast[uint](vtbl) - uint(offsetOf(VirtualQTimeEdit, vtbl)))
  let slotval1 = gen_qstyleoption_types.QStyleOptionSpinBox(h: option, owned: false)
  vtbl.initStyleOption(slotval1)
...
proc miqt_exec_method_cQTimeEdit_nativeEvent(vtbl: pointer, inst: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[VirtualQTimeEdit](cast[uint](vtbl) - uint(offsetOf(VirtualQTimeEdit, vtbl)))
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArrayByte(veventType_bytearray.data, 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc create*(T: type gen_qdatetimeedit_types.QTimeEdit,
  ...
  vtbl[].vtbl.initStyleOption = miqt_exec_method_cQTimeEdit_initStyleOption
...
proc miqt_exec_method_cQDateEdit_initStyleOption(vtbl: pointer, inst: pointer, option: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQDateEdit](cast[uint](vtbl) - uint(offsetOf(VirtualQDateEdit, vtbl)))
  let slotval1 = gen_qstyleoption_types.QStyleOptionSpinBox(h: option, owned: false)
  vtbl.initStyleOption(slotval1)
...
proc miqt_exec_method_cQDateEdit_nativeEvent(vtbl: pointer, inst: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[VirtualQDateEdit](cast[uint](vtbl) - uint(offsetOf(VirtualQDateEdit, vtbl)))
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArrayByte(veventType_bytearray.data, 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc create*(T: type gen_qdatetimeedit_types.QDateEdit,
  ...
  vtbl[].vtbl.initStyleOption = miqt_exec_method_cQDateEdit_initStyleOption
