...
proc fcQDateTimeEdit_new(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQDateTimeEdit {.importc: "QDateTimeEdit_new".}
proc fcQDateTimeEdit_new2(vtbl: pointer, vdata: csize_t): ptr cQDateTimeEdit {.importc: "QDateTimeEdit_new2".}
proc fcQDateTimeEdit_new3(vtbl: pointer, vdata: csize_t, dt: pointer): ptr cQDateTimeEdit {.importc: "QDateTimeEdit_new3".}
proc fcQDateTimeEdit_new4(vtbl: pointer, vdata: csize_t, d: pointer): ptr cQDateTimeEdit {.importc: "QDateTimeEdit_new4".}
proc fcQDateTimeEdit_new5(vtbl: pointer, vdata: csize_t, t: pointer): ptr cQDateTimeEdit {.importc: "QDateTimeEdit_new5".}
...
proc fcQTimeEdit_new(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQTimeEdit {.importc: "QTimeEdit_new".}
proc fcQTimeEdit_new2(vtbl: pointer, vdata: csize_t): ptr cQTimeEdit {.importc: "QTimeEdit_new2".}
...
proc fcQDateEdit_new(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQDateEdit {.importc: "QDateEdit_new".}
proc fcQDateEdit_new2(vtbl: pointer, vdata: csize_t): ptr cQDateEdit {.importc: "QDateEdit_new2".}
