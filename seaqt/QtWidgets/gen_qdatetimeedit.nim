...
proc fcQDateTimeEdit_sectionText(self: pointer, section: cint): struct_seaqt_string {.importc: "QDateTimeEdit_sectionText".}
proc fcQDateTimeEdit_displayFormat(self: pointer): struct_seaqt_string {.importc: "QDateTimeEdit_displayFormat".}
proc fcQDateTimeEdit_setDisplayFormat(self: pointer, format: struct_seaqt_string): void {.importc: "QDateTimeEdit_setDisplayFormat".}
...
proc fcQDateTimeEdit_timeZone(self: pointer): pointer {.importc: "QDateTimeEdit_timeZone".}
proc fcQDateTimeEdit_setTimeZone(self: pointer, zone: pointer): void {.importc: "QDateTimeEdit_setTimeZone".}
...
type cQDateTimeEditVTable {.pure.} = object
  ...
  dateTimeFromText*: proc(self: pointer, text: struct_seaqt_string): pointer {.cdecl, raises: [], gcsafe.}
  textFromDateTime*: proc(self: pointer, dt: pointer): struct_seaqt_string {.cdecl, raises: [], gcsafe.}
...
proc fcQDateTimeEdit_virtualbase_validate(self: pointer, input: struct_seaqt_string, pos: ptr cint): cint {.importc: "QDateTimeEdit_virtualbase_validate".}
proc fcQDateTimeEdit_virtualbase_fixup(self: pointer, input: struct_seaqt_string): void {.importc: "QDateTimeEdit_virtualbase_fixup".}
proc fcQDateTimeEdit_virtualbase_dateTimeFromText(self: pointer, text: struct_seaqt_string): pointer {.importc: "QDateTimeEdit_virtualbase_dateTimeFromText".}
proc fcQDateTimeEdit_virtualbase_textFromDateTime(self: pointer, dt: pointer): struct_seaqt_string {.importc: "QDateTimeEdit_virtualbase_textFromDateTime".}
...
proc fcQDateTimeEdit_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.importc: "QDateTimeEdit_virtualbase_nativeEvent".}
...
proc fcQDateTimeEdit_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QDateTimeEdit_protectedbase_getDecodedMetricF".}
...
proc fcQTimeEdit_virtualbase_validate(self: pointer, input: struct_seaqt_string, pos: ptr cint): cint {.importc: "QTimeEdit_virtualbase_validate".}
proc fcQTimeEdit_virtualbase_fixup(self: pointer, input: struct_seaqt_string): void {.importc: "QTimeEdit_virtualbase_fixup".}
proc fcQTimeEdit_virtualbase_dateTimeFromText(self: pointer, text: struct_seaqt_string): pointer {.importc: "QTimeEdit_virtualbase_dateTimeFromText".}
proc fcQTimeEdit_virtualbase_textFromDateTime(self: pointer, dt: pointer): struct_seaqt_string {.importc: "QTimeEdit_virtualbase_textFromDateTime".}
...
proc fcQTimeEdit_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.importc: "QTimeEdit_virtualbase_nativeEvent".}
...
proc fcQTimeEdit_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QTimeEdit_protectedbase_getDecodedMetricF".}
...
proc fcQDateEdit_virtualbase_validate(self: pointer, input: struct_seaqt_string, pos: ptr cint): cint {.importc: "QDateEdit_virtualbase_validate".}
proc fcQDateEdit_virtualbase_fixup(self: pointer, input: struct_seaqt_string): void {.importc: "QDateEdit_virtualbase_fixup".}
proc fcQDateEdit_virtualbase_dateTimeFromText(self: pointer, text: struct_seaqt_string): pointer {.importc: "QDateEdit_virtualbase_dateTimeFromText".}
proc fcQDateEdit_virtualbase_textFromDateTime(self: pointer, dt: pointer): struct_seaqt_string {.importc: "QDateEdit_virtualbase_textFromDateTime".}
...
proc fcQDateEdit_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.importc: "QDateEdit_virtualbase_nativeEvent".}
...
proc fcQDateEdit_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QDateEdit_protectedbase_getDecodedMetricF".}
...
proc setDisplayFormat*(self: gen_qdatetimeedit_types.QDateTimeEdit, format: openArray[char]): void =
  fcQDateTimeEdit_setDisplayFormat(self.h, struct_seaqt_string(data: if len(format) > 0: addr format[0] else: nil, len: csize_t(len(format))))
...
proc timeZone*(self: gen_qdatetimeedit_types.QDateTimeEdit): gen_qtimezone_types.QTimeZone =
  gen_qtimezone_types.QTimeZone(h: fcQDateTimeEdit_timeZone(self.h), owned: true)

proc setTimeZone*(self: gen_qdatetimeedit_types.QDateTimeEdit, zone: gen_qtimezone_types.QTimeZone): void =
  fcQDateTimeEdit_setTimeZone(self.h, zone.h)
...
proc QDateTimeEditvalidate*(self: gen_qdatetimeedit_types.QDateTimeEdit, input: openArray[char], pos: ptr cint): cint =
  cint(fcQDateTimeEdit_virtualbase_validate(self.h, struct_seaqt_string(data: if len(input) > 0: addr input[0] else: nil, len: csize_t(len(input))), pos))

proc QDateTimeEditfixup*(self: gen_qdatetimeedit_types.QDateTimeEdit, input: openArray[char]): void =
  fcQDateTimeEdit_virtualbase_fixup(self.h, struct_seaqt_string(data: if len(input) > 0: addr input[0] else: nil, len: csize_t(len(input))))
...
proc QDateTimeEditdateTimeFromText*(self: gen_qdatetimeedit_types.QDateTimeEdit, text: openArray[char]): gen_qdatetime_types.QDateTime =
  gen_qdatetime_types.QDateTime(h: fcQDateTimeEdit_virtualbase_dateTimeFromText(self.h, struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text)))), owned: true)
...
proc QDateTimeEditnativeEvent*(self: gen_qdatetimeedit_types.QDateTimeEdit, eventType: openArray[byte], message: pointer, resultVal: ptr uint): bool =
  fcQDateTimeEdit_virtualbase_nativeEvent(self.h, struct_seaqt_string(data: if len(eventType) > 0: addr eventType[0] else: nil, len: csize_t(len(eventType))), message, resultVal)
...
proc fcQDateTimeEdit_vtable_callback_validate(self: pointer, input: struct_seaqt_string, pos: ptr cint): cint {.cdecl.} =
  let vtbl = cast[ptr QDateTimeEditVTable](fcQDateTimeEdit_vdata(self)[])
  let self = QDateTimeEdit(h: self)
  let vinput_ms = input
...
proc fcQDateTimeEdit_vtable_callback_fixup(self: pointer, input: struct_seaqt_string): void {.cdecl.} =
  let vtbl = cast[ptr QDateTimeEditVTable](fcQDateTimeEdit_vdata(self)[])
  let self = QDateTimeEdit(h: self)
  let vinput_ms = input
  let vinputx_ret = string.fromBytes(vinput_ms)
...
proc fcQDateTimeEdit_vtable_callback_dateTimeFromText(self: pointer, text: struct_seaqt_string): pointer {.cdecl.} =
  let vtbl = cast[ptr QDateTimeEditVTable](fcQDateTimeEdit_vdata(self)[])
  let self = QDateTimeEdit(h: self)
  let vtext_ms = text
...
proc fcQDateTimeEdit_vtable_callback_textFromDateTime(self: pointer, dt: pointer): struct_seaqt_string {.cdecl.} =
  let vtbl = cast[ptr QDateTimeEditVTable](fcQDateTimeEdit_vdata(self)[])
  let self = QDateTimeEdit(h: self)
...
proc fcQDateTimeEdit_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QDateTimeEditVTable](fcQDateTimeEdit_vdata(self)[])
  let self = QDateTimeEdit(h: self)
...
proc fcQDateTimeEdit_method_callback_validate(self: pointer, input: struct_seaqt_string, pos: ptr cint): cint {.cdecl.} =
  let inst = cast[VirtualQDateTimeEdit](fcQDateTimeEdit_vdata(self)[])
  let vinput_ms = input
  let vinputx_ret = string.fromBytes(vinput_ms)
  c_free(vinput_ms.data)
...
proc fcQDateTimeEdit_method_callback_fixup(self: pointer, input: struct_seaqt_string): void {.cdecl.} =
  let inst = cast[VirtualQDateTimeEdit](fcQDateTimeEdit_vdata(self)[])
  let vinput_ms = input
  let vinputx_ret = string.fromBytes(vinput_ms)
  c_free(vinput_ms.data)
...
proc fcQDateTimeEdit_method_callback_dateTimeFromText(self: pointer, text: struct_seaqt_string): pointer {.cdecl.} =
  let inst = cast[VirtualQDateTimeEdit](fcQDateTimeEdit_vdata(self)[])
  let vtext_ms = text
  let vtextx_ret = string.fromBytes(vtext_ms)
  c_free(vtext_ms.data)
...
proc fcQDateTimeEdit_method_callback_textFromDateTime(self: pointer, dt: pointer): struct_seaqt_string {.cdecl.} =
  let inst = cast[VirtualQDateTimeEdit](fcQDateTimeEdit_vdata(self)[])
  let slotval1 = gen_qdatetime_types.QDateTime(h: dt, owned: false)
...
proc fcQDateTimeEdit_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let inst = cast[VirtualQDateTimeEdit](fcQDateTimeEdit_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc getDecodedMetricF*(self: gen_qdatetimeedit_types.QDateTimeEdit, metricA: cint, metricB: cint): float64 =
  fcQDateTimeEdit_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
...
proc create*(T: type gen_qdatetimeedit_types.QDateTimeEdit,
  ...
  let tmp = gen_qdatetimeedit_types.QDateTimeEdit(h: fcQDateTimeEdit_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
...
proc create*(T: type gen_qdatetimeedit_types.QDateTimeEdit,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQDateTimeEdit_vtable_callback_disconnectNotify
  let tmp = gen_qdatetimeedit_types.QDateTimeEdit(h: fcQDateTimeEdit_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), dt.h), owned: true)
  fcQDateTimeEdit_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qdatetimeedit_types.QDateTimeEdit,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQDateTimeEdit_vtable_callback_disconnectNotify
  let tmp = gen_qdatetimeedit_types.QDateTimeEdit(h: fcQDateTimeEdit_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), d.h), owned: true)
  fcQDateTimeEdit_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qdatetimeedit_types.QDateTimeEdit,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQDateTimeEdit_vtable_callback_disconnectNotify
  let tmp = gen_qdatetimeedit_types.QDateTimeEdit(h: fcQDateTimeEdit_new4(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), t.h), owned: true)
  fcQDateTimeEdit_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qdatetimeedit_types.QDateTimeEdit,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQDateTimeEdit_vtable_callback_disconnectNotify
  let tmp = gen_qdatetimeedit_types.QDateTimeEdit(h: fcQDateTimeEdit_new5(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQDateTimeEdit_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qdatetimeedit_types.QDateTimeEdit,
...
proc create*(T: type gen_qdatetimeedit_types.QDateTimeEdit,
  ...
  inst[].h = fcQDateTimeEdit_new(addr(cQDateTimeEdit_mvtbl), csize_t(sizeof(pointer)))
  fcQDateTimeEdit_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qdatetimeedit_types.QDateTimeEdit,
    ...
    inst: VirtualQDateTimeEdit) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQDateTimeEdit_new2(addr(cQDateTimeEdit_mvtbl), csize_t(sizeof(pointer)), dt.h)
  fcQDateTimeEdit_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qdatetimeedit_types.QDateTimeEdit,
    ...
    inst: VirtualQDateTimeEdit) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQDateTimeEdit_new3(addr(cQDateTimeEdit_mvtbl), csize_t(sizeof(pointer)), d.h)
  fcQDateTimeEdit_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qdatetimeedit_types.QDateTimeEdit,
    ...
    inst: VirtualQDateTimeEdit) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQDateTimeEdit_new4(addr(cQDateTimeEdit_mvtbl), csize_t(sizeof(pointer)), t.h)
  fcQDateTimeEdit_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qdatetimeedit_types.QDateTimeEdit,
    ...
    inst: VirtualQDateTimeEdit) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQDateTimeEdit_new5(addr(cQDateTimeEdit_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQDateTimeEdit_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qdatetimeedit_types.QDateTimeEdit,
    ...
    inst: VirtualQDateTimeEdit) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQDateTimeEdit_new6(addr(cQDateTimeEdit_mvtbl), csize_t(sizeof(pointer)), dt.h, parent.h)
  fcQDateTimeEdit_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qdatetimeedit_types.QDateTimeEdit,
    ...
    inst: VirtualQDateTimeEdit) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQDateTimeEdit_new7(addr(cQDateTimeEdit_mvtbl), csize_t(sizeof(pointer)), d.h, parent.h)
  fcQDateTimeEdit_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qdatetimeedit_types.QDateTimeEdit,
    ...
    inst: VirtualQDateTimeEdit) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQDateTimeEdit_new8(addr(cQDateTimeEdit_mvtbl), csize_t(sizeof(pointer)), t.h, parent.h)
  fcQDateTimeEdit_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc QTimeEditvalidate*(self: gen_qdatetimeedit_types.QTimeEdit, input: openArray[char], pos: ptr cint): cint =
  cint(fcQTimeEdit_virtualbase_validate(self.h, struct_seaqt_string(data: if len(input) > 0: addr input[0] else: nil, len: csize_t(len(input))), pos))

proc QTimeEditfixup*(self: gen_qdatetimeedit_types.QTimeEdit, input: openArray[char]): void =
  fcQTimeEdit_virtualbase_fixup(self.h, struct_seaqt_string(data: if len(input) > 0: addr input[0] else: nil, len: csize_t(len(input))))

proc QTimeEditdateTimeFromText*(self: gen_qdatetimeedit_types.QTimeEdit, text: openArray[char]): gen_qdatetime_types.QDateTime =
  gen_qdatetime_types.QDateTime(h: fcQTimeEdit_virtualbase_dateTimeFromText(self.h, struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text)))), owned: true)
...
proc QTimeEditnativeEvent*(self: gen_qdatetimeedit_types.QTimeEdit, eventType: openArray[byte], message: pointer, resultVal: ptr uint): bool =
  fcQTimeEdit_virtualbase_nativeEvent(self.h, struct_seaqt_string(data: if len(eventType) > 0: addr eventType[0] else: nil, len: csize_t(len(eventType))), message, resultVal)
...
proc fcQTimeEdit_vtable_callback_validate(self: pointer, input: struct_seaqt_string, pos: ptr cint): cint {.cdecl.} =
  let vtbl = cast[ptr QTimeEditVTable](fcQTimeEdit_vdata(self)[])
  let self = QTimeEdit(h: self)
  let vinput_ms = input
  let vinputx_ret = string.fromBytes(vinput_ms)
...
proc fcQTimeEdit_vtable_callback_fixup(self: pointer, input: struct_seaqt_string): void {.cdecl.} =
  let vtbl = cast[ptr QTimeEditVTable](fcQTimeEdit_vdata(self)[])
  let self = QTimeEdit(h: self)
  let vinput_ms = input
  let vinputx_ret = string.fromBytes(vinput_ms)
...
proc fcQTimeEdit_vtable_callback_dateTimeFromText(self: pointer, text: struct_seaqt_string): pointer {.cdecl.} =
  let vtbl = cast[ptr QTimeEditVTable](fcQTimeEdit_vdata(self)[])
  let self = QTimeEdit(h: self)
  let vtext_ms = text
  let vtextx_ret = string.fromBytes(vtext_ms)
...
proc fcQTimeEdit_vtable_callback_textFromDateTime(self: pointer, dt: pointer): struct_seaqt_string {.cdecl.} =
  let vtbl = cast[ptr QTimeEditVTable](fcQTimeEdit_vdata(self)[])
  let self = QTimeEdit(h: self)
  let slotval1 = gen_qdatetime_types.QDateTime(h: dt, owned: false)
  var virtualReturn = vtbl[].textFromDateTime(self, slotval1)
...
proc fcQTimeEdit_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QTimeEditVTable](fcQTimeEdit_vdata(self)[])
  let self = QTimeEdit(h: self)
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
...
proc fcQTimeEdit_method_callback_validate(self: pointer, input: struct_seaqt_string, pos: ptr cint): cint {.cdecl.} =
  let inst = cast[VirtualQTimeEdit](fcQTimeEdit_vdata(self)[])
  let vinput_ms = input
  let vinputx_ret = string.fromBytes(vinput_ms)
  c_free(vinput_ms.data)
...
proc fcQTimeEdit_method_callback_fixup(self: pointer, input: struct_seaqt_string): void {.cdecl.} =
  let inst = cast[VirtualQTimeEdit](fcQTimeEdit_vdata(self)[])
  let vinput_ms = input
  let vinputx_ret = string.fromBytes(vinput_ms)
  c_free(vinput_ms.data)
...
proc fcQTimeEdit_method_callback_dateTimeFromText(self: pointer, text: struct_seaqt_string): pointer {.cdecl.} =
  let inst = cast[VirtualQTimeEdit](fcQTimeEdit_vdata(self)[])
  let vtext_ms = text
  let vtextx_ret = string.fromBytes(vtext_ms)
  c_free(vtext_ms.data)
...
proc fcQTimeEdit_method_callback_textFromDateTime(self: pointer, dt: pointer): struct_seaqt_string {.cdecl.} =
  let inst = cast[VirtualQTimeEdit](fcQTimeEdit_vdata(self)[])
  let slotval1 = gen_qdatetime_types.QDateTime(h: dt, owned: false)
  var virtualReturn = inst.textFromDateTime(slotval1)
  var virtualReturn_copy = if len(virtualReturn) > 0: c_malloc(csize_t(len(virtualReturn))) else: nil
...
proc fcQTimeEdit_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let inst = cast[VirtualQTimeEdit](fcQTimeEdit_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc getDecodedMetricF*(self: gen_qdatetimeedit_types.QTimeEdit, metricA: cint, metricB: cint): float64 =
  fcQTimeEdit_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
...
proc create*(T: type gen_qdatetimeedit_types.QTimeEdit,
  ...
  let tmp = gen_qdatetimeedit_types.QTimeEdit(h: fcQTimeEdit_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
...
proc create*(T: type gen_qdatetimeedit_types.QTimeEdit,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQTimeEdit_vtable_callback_disconnectNotify
  let tmp = gen_qdatetimeedit_types.QTimeEdit(h: fcQTimeEdit_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), time.h), owned: true)
  fcQTimeEdit_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qdatetimeedit_types.QTimeEdit,
    parent: gen_qwidget_types.QWidget,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQTimeEdit_vtable_callback_disconnectNotify
  let tmp = gen_qdatetimeedit_types.QTimeEdit(h: fcQTimeEdit_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQTimeEdit_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qdatetimeedit_types.QTimeEdit,
...
proc create*(T: type gen_qdatetimeedit_types.QTimeEdit,
  ...
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQTimeEdit_new(addr(cQTimeEdit_mvtbl), csize_t(sizeof(pointer)))
  fcQTimeEdit_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qdatetimeedit_types.QTimeEdit,
    ...
    inst: VirtualQTimeEdit) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQTimeEdit_new2(addr(cQTimeEdit_mvtbl), csize_t(sizeof(pointer)), time.h)
  fcQTimeEdit_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qdatetimeedit_types.QTimeEdit,
    ...
    inst: VirtualQTimeEdit) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQTimeEdit_new3(addr(cQTimeEdit_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQTimeEdit_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qdatetimeedit_types.QTimeEdit,
    ...
    inst: VirtualQTimeEdit) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQTimeEdit_new4(addr(cQTimeEdit_mvtbl), csize_t(sizeof(pointer)), time.h, parent.h)
  fcQTimeEdit_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc QDateEditvalidate*(self: gen_qdatetimeedit_types.QDateEdit, input: openArray[char], pos: ptr cint): cint =
  cint(fcQDateEdit_virtualbase_validate(self.h, struct_seaqt_string(data: if len(input) > 0: addr input[0] else: nil, len: csize_t(len(input))), pos))

proc QDateEditfixup*(self: gen_qdatetimeedit_types.QDateEdit, input: openArray[char]): void =
  fcQDateEdit_virtualbase_fixup(self.h, struct_seaqt_string(data: if len(input) > 0: addr input[0] else: nil, len: csize_t(len(input))))

proc QDateEditdateTimeFromText*(self: gen_qdatetimeedit_types.QDateEdit, text: openArray[char]): gen_qdatetime_types.QDateTime =
  gen_qdatetime_types.QDateTime(h: fcQDateEdit_virtualbase_dateTimeFromText(self.h, struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text)))), owned: true)
...
proc QDateEditnativeEvent*(self: gen_qdatetimeedit_types.QDateEdit, eventType: openArray[byte], message: pointer, resultVal: ptr uint): bool =
  fcQDateEdit_virtualbase_nativeEvent(self.h, struct_seaqt_string(data: if len(eventType) > 0: addr eventType[0] else: nil, len: csize_t(len(eventType))), message, resultVal)
...
proc fcQDateEdit_vtable_callback_validate(self: pointer, input: struct_seaqt_string, pos: ptr cint): cint {.cdecl.} =
  let vtbl = cast[ptr QDateEditVTable](fcQDateEdit_vdata(self)[])
  let self = QDateEdit(h: self)
  let vinput_ms = input
  let vinputx_ret = string.fromBytes(vinput_ms)
...
proc fcQDateEdit_vtable_callback_fixup(self: pointer, input: struct_seaqt_string): void {.cdecl.} =
  let vtbl = cast[ptr QDateEditVTable](fcQDateEdit_vdata(self)[])
  let self = QDateEdit(h: self)
  let vinput_ms = input
  let vinputx_ret = string.fromBytes(vinput_ms)
...
proc fcQDateEdit_vtable_callback_dateTimeFromText(self: pointer, text: struct_seaqt_string): pointer {.cdecl.} =
  let vtbl = cast[ptr QDateEditVTable](fcQDateEdit_vdata(self)[])
  let self = QDateEdit(h: self)
  let vtext_ms = text
  let vtextx_ret = string.fromBytes(vtext_ms)
...
proc fcQDateEdit_vtable_callback_textFromDateTime(self: pointer, dt: pointer): struct_seaqt_string {.cdecl.} =
  let vtbl = cast[ptr QDateEditVTable](fcQDateEdit_vdata(self)[])
  let self = QDateEdit(h: self)
  let slotval1 = gen_qdatetime_types.QDateTime(h: dt, owned: false)
  var virtualReturn = vtbl[].textFromDateTime(self, slotval1)
...
proc fcQDateEdit_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QDateEditVTable](fcQDateEdit_vdata(self)[])
  let self = QDateEdit(h: self)
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
...
proc fcQDateEdit_method_callback_validate(self: pointer, input: struct_seaqt_string, pos: ptr cint): cint {.cdecl.} =
  let inst = cast[VirtualQDateEdit](fcQDateEdit_vdata(self)[])
  let vinput_ms = input
  let vinputx_ret = string.fromBytes(vinput_ms)
  c_free(vinput_ms.data)
...
proc fcQDateEdit_method_callback_fixup(self: pointer, input: struct_seaqt_string): void {.cdecl.} =
  let inst = cast[VirtualQDateEdit](fcQDateEdit_vdata(self)[])
  let vinput_ms = input
  let vinputx_ret = string.fromBytes(vinput_ms)
  c_free(vinput_ms.data)
...
proc fcQDateEdit_method_callback_dateTimeFromText(self: pointer, text: struct_seaqt_string): pointer {.cdecl.} =
  let inst = cast[VirtualQDateEdit](fcQDateEdit_vdata(self)[])
  let vtext_ms = text
  let vtextx_ret = string.fromBytes(vtext_ms)
  c_free(vtext_ms.data)
...
proc fcQDateEdit_method_callback_textFromDateTime(self: pointer, dt: pointer): struct_seaqt_string {.cdecl.} =
  let inst = cast[VirtualQDateEdit](fcQDateEdit_vdata(self)[])
  let slotval1 = gen_qdatetime_types.QDateTime(h: dt, owned: false)
  var virtualReturn = inst.textFromDateTime(slotval1)
  var virtualReturn_copy = if len(virtualReturn) > 0: c_malloc(csize_t(len(virtualReturn))) else: nil
...
proc fcQDateEdit_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let inst = cast[VirtualQDateEdit](fcQDateEdit_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc getDecodedMetricF*(self: gen_qdatetimeedit_types.QDateEdit, metricA: cint, metricB: cint): float64 =
  fcQDateEdit_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
...
proc create*(T: type gen_qdatetimeedit_types.QDateEdit,
  ...
  let tmp = gen_qdatetimeedit_types.QDateEdit(h: fcQDateEdit_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
...
proc create*(T: type gen_qdatetimeedit_types.QDateEdit,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQDateEdit_vtable_callback_disconnectNotify
  let tmp = gen_qdatetimeedit_types.QDateEdit(h: fcQDateEdit_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), date.h), owned: true)
  fcQDateEdit_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qdatetimeedit_types.QDateEdit,
    parent: gen_qwidget_types.QWidget,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQDateEdit_vtable_callback_disconnectNotify
  let tmp = gen_qdatetimeedit_types.QDateEdit(h: fcQDateEdit_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQDateEdit_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qdatetimeedit_types.QDateEdit,
...
proc create*(T: type gen_qdatetimeedit_types.QDateEdit,
  ...
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQDateEdit_new(addr(cQDateEdit_mvtbl), csize_t(sizeof(pointer)))
  fcQDateEdit_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qdatetimeedit_types.QDateEdit,
    ...
    inst: VirtualQDateEdit) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQDateEdit_new2(addr(cQDateEdit_mvtbl), csize_t(sizeof(pointer)), date.h)
  fcQDateEdit_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qdatetimeedit_types.QDateEdit,
    ...
    inst: VirtualQDateEdit) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQDateEdit_new3(addr(cQDateEdit_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQDateEdit_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qdatetimeedit_types.QDateEdit,
    ...
    inst: VirtualQDateEdit) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQDateEdit_new4(addr(cQDateEdit_mvtbl), csize_t(sizeof(pointer)), date.h, parent.h)
  fcQDateEdit_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
