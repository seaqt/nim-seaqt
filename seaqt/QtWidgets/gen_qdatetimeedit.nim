...
proc fcQDateTimeEdit_new(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQDateTimeEdit {.importc: "QDateTimeEdit_new_parent".}
proc fcQDateTimeEdit_new2(vtbl: pointer, vdata: csize_t): ptr cQDateTimeEdit {.importc: "QDateTimeEdit_new".}
proc fcQDateTimeEdit_new3(vtbl: pointer, vdata: csize_t, dt: pointer): ptr cQDateTimeEdit {.importc: "QDateTimeEdit_new_dt".}
proc fcQDateTimeEdit_new4(vtbl: pointer, vdata: csize_t, d: pointer): ptr cQDateTimeEdit {.importc: "QDateTimeEdit_new_d".}
proc fcQDateTimeEdit_new5(vtbl: pointer, vdata: csize_t, t: pointer): ptr cQDateTimeEdit {.importc: "QDateTimeEdit_new_t".}
...
proc fcQTimeEdit_new(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQTimeEdit {.importc: "QTimeEdit_new_parent".}
proc fcQTimeEdit_new2(vtbl: pointer, vdata: csize_t): ptr cQTimeEdit {.importc: "QTimeEdit_new".}
proc fcQTimeEdit_new3(vtbl: pointer, vdata: csize_t, time: pointer): ptr cQTimeEdit {.importc: "QTimeEdit_new_time".}
...
proc fcQDateEdit_new(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQDateEdit {.importc: "QDateEdit_new_parent".}
proc fcQDateEdit_new2(vtbl: pointer, vdata: csize_t): ptr cQDateEdit {.importc: "QDateEdit_new".}
proc fcQDateEdit_new3(vtbl: pointer, vdata: csize_t, date: pointer): ptr cQDateEdit {.importc: "QDateEdit_new_date".}
...
proc create*(T: type gen_qdatetimeedit_types.QDateTimeEdit,
  ...
  inst[].h = fcQDateTimeEdit_new(addr(cQDateTimeEdit_mvtbl), csize_t(sizeof(pointer)), parent.h)
...
proc create*(T: type gen_qdatetimeedit_types.QDateTimeEdit,
    inst: VirtualQDateTimeEdit) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQDateTimeEdit_new2(addr(cQDateTimeEdit_mvtbl), csize_t(sizeof(pointer)))
  fcQDateTimeEdit_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qdatetimeedit_types.QDateTimeEdit,
    ...
    inst: VirtualQDateTimeEdit) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQDateTimeEdit_new3(addr(cQDateTimeEdit_mvtbl), csize_t(sizeof(pointer)), dt.h)
  fcQDateTimeEdit_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qdatetimeedit_types.QDateTimeEdit,
    ...
    inst: VirtualQDateTimeEdit) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQDateTimeEdit_new4(addr(cQDateTimeEdit_mvtbl), csize_t(sizeof(pointer)), d.h)
  fcQDateTimeEdit_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qdatetimeedit_types.QDateTimeEdit,
    ...
    inst: VirtualQDateTimeEdit) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQDateTimeEdit_new5(addr(cQDateTimeEdit_mvtbl), csize_t(sizeof(pointer)), t.h)
  fcQDateTimeEdit_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qdatetimeedit_types.QTimeEdit,
  ...
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQTimeEdit_new(addr(cQTimeEdit_mvtbl), csize_t(sizeof(pointer)), parent.h)
...
proc create*(T: type gen_qdatetimeedit_types.QTimeEdit,
    inst: VirtualQTimeEdit) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQTimeEdit_new2(addr(cQTimeEdit_mvtbl), csize_t(sizeof(pointer)))
  fcQTimeEdit_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qdatetimeedit_types.QTimeEdit,
    ...
    inst: VirtualQTimeEdit) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQTimeEdit_new3(addr(cQTimeEdit_mvtbl), csize_t(sizeof(pointer)), time.h)
  fcQTimeEdit_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qdatetimeedit_types.QDateEdit,
  ...
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQDateEdit_new(addr(cQDateEdit_mvtbl), csize_t(sizeof(pointer)), parent.h)
...
proc create*(T: type gen_qdatetimeedit_types.QDateEdit,
    inst: VirtualQDateEdit) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQDateEdit_new2(addr(cQDateEdit_mvtbl), csize_t(sizeof(pointer)))
  fcQDateEdit_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qdatetimeedit_types.QDateEdit,
    ...
    inst: VirtualQDateEdit) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQDateEdit_new3(addr(cQDateEdit_mvtbl), csize_t(sizeof(pointer)), date.h)
  fcQDateEdit_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
