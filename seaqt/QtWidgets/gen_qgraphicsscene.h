...
const QGraphicsScene_VTable* QGraphicsScene_vtbl(const VirtualQGraphicsScene* self);
void* QGraphicsScene_vdata(const VirtualQGraphicsScene* self);
void QGraphicsScene_setVdata(VirtualQGraphicsScene* self, void* vdata);
