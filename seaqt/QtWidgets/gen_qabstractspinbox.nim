...
proc cQAbstractSpinBox_vtable_callback_initStyleOption(self: pointer, option: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QAbstractSpinBoxVTable](fcQAbstractSpinBox_vdata(self))
  let self = QAbstractSpinBox(h: self)
...
proc cQAbstractSpinBox_vtable_callback_nativeEvent(self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QAbstractSpinBoxVTable](fcQAbstractSpinBox_vdata(self))
  let self = QAbstractSpinBox(h: self)
...
proc cQAbstractSpinBox_method_callback_initStyleOption(self: pointer, option: pointer): void {.cdecl.} =
  let inst = cast[VirtualQAbstractSpinBox](fcQAbstractSpinBox_vdata(self))
  let slotval1 = gen_qstyleoption_types.QStyleOptionSpinBox(h: option, owned: false)
...
proc cQAbstractSpinBox_method_callback_nativeEvent(self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let inst = cast[VirtualQAbstractSpinBox](fcQAbstractSpinBox_vdata(self))
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc create*(T: type gen_qabstractspinbox_types.QAbstractSpinBox,
  ...
  if not isNil(vtbl[].initStyleOption):
    vtbl[].vtbl.initStyleOption = cQAbstractSpinBox_vtable_callback_initStyleOption
...
const cQAbstractSpinBox_mvtbl = cQAbstractSpinBoxVTable(
  ...
  initStyleOption: cQAbstractSpinBox_method_callback_initStyleOption,
