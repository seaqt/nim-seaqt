...
proc create*(T: type gen_qabstractspinbox_types.QAbstractSpinBox,
  ...
  let tmp = gen_qabstractspinbox_types.QAbstractSpinBox(h: fcQAbstractSpinBox_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))))
...
proc create*(T: type gen_qabstractspinbox_types.QAbstractSpinBox,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQAbstractSpinBox_vtable_callback_disconnectNotify
  let tmp = gen_qabstractspinbox_types.QAbstractSpinBox(h: fcQAbstractSpinBox_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h))
  fcQAbstractSpinBox_vdata(tmp.h)[] = addr(vtbl[])
  tmp
