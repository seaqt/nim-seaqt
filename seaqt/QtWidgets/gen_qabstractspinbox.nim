...
proc fcQAbstractSpinBox_new(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQAbstractSpinBox {.importc: "QAbstractSpinBox_new_parent".}
proc fcQAbstractSpinBox_new2(vtbl: pointer, vdata: csize_t): ptr cQAbstractSpinBox {.importc: "QAbstractSpinBox_new".}
...
proc create*(T: type gen_qabstractspinbox_types.QAbstractSpinBox,
  ...
  let tmp = gen_qabstractspinbox_types.QAbstractSpinBox(h: fcQAbstractSpinBox_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
...
proc create*(T: type gen_qabstractspinbox_types.QAbstractSpinBox,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQAbstractSpinBox_vtable_callback_disconnectNotify
  let tmp = gen_qabstractspinbox_types.QAbstractSpinBox(h: fcQAbstractSpinBox_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQAbstractSpinBox_vdata(tmp.h)[] = addr(vtbl[])
  tmp
...
proc create*(T: type gen_qabstractspinbox_types.QAbstractSpinBox,
  ...
  inst[].h = fcQAbstractSpinBox_new(addr(cQAbstractSpinBox_mvtbl), csize_t(sizeof(pointer)), parent.h)
...
proc create*(T: type gen_qabstractspinbox_types.QAbstractSpinBox,
    inst: VirtualQAbstractSpinBox) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQAbstractSpinBox_new2(addr(cQAbstractSpinBox_mvtbl), csize_t(sizeof(pointer)))
  fcQAbstractSpinBox_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
