...
proc fcQGroupBox_new(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQGroupBox {.importc: "QGroupBox_new".}
proc fcQGroupBox_new2(vtbl: pointer, vdata: csize_t): ptr cQGroupBox {.importc: "QGroupBox_new2".}
proc fcQGroupBox_new3(vtbl: pointer, vdata: csize_t, title: struct_seaqt_string): ptr cQGroupBox {.importc: "QGroupBox_new3".}
