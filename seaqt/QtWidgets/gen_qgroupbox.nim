...
proc fcQGroupBox_trUtf8(s: cstring): struct_seaqt_string {.importc: "QGroupBox_trUtf8".}
...
proc fcQGroupBox_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QGroupBox_trUtf82".}
proc fcQGroupBox_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QGroupBox_trUtf83".}
