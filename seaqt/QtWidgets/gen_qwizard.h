...
typedef struct QWizard_VTable{
	...
	bool (*nativeEvent)(VirtualQWizard* self, struct miqt_string eventType, void* message, long* result);
...
typedef struct QWizardPage_VTable{
	...
	bool (*nativeEvent)(VirtualQWizardPage* self, struct miqt_string eventType, void* message, long* result);
