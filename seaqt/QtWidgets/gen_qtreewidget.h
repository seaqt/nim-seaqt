...
const QTreeWidgetItem_VTable* QTreeWidgetItem_vtbl(const VirtualQTreeWidgetItem* self);
void* QTreeWidgetItem_vdata(const VirtualQTreeWidgetItem* self);
void QTreeWidgetItem_setVdata(VirtualQTreeWidgetItem* self, void* vdata);
...
const QTreeWidget_VTable* QTreeWidget_vtbl(const VirtualQTreeWidget* self);
void* QTreeWidget_vdata(const VirtualQTreeWidget* self);
void QTreeWidget_setVdata(VirtualQTreeWidget* self, void* vdata);
