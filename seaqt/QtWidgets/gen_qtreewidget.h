...
typedef struct QTreeWidget_VTable{
	...
	struct miqt_array /* of struct miqt_string */  (*mimeTypes)(const VirtualQTreeWidget* self);
	QMimeData* (*mimeData)(const VirtualQTreeWidget* self, struct miqt_array /* of QTreeWidgetItem* */  items);
	...
	void (*keyboardSearch)(VirtualQTreeWidget* self, struct miqt_string search);
	...
	void (*dataChanged)(VirtualQTreeWidget* self, QModelIndex* topLeft, QModelIndex* bottomRight, struct miqt_array /* of int */  roles);
	...
	struct miqt_array /* of QModelIndex* */  (*selectedIndexes)(const VirtualQTreeWidget* self);
	...
	bool (*nativeEvent)(VirtualQTreeWidget* self, struct miqt_string eventType, void* message, intptr_t* result);
