...
proc miqt_exec_method_cQSplashScreen_nativeEvent(vtbl: pointer, inst: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let vtbl = cast[VirtualQSplashScreen](cast[uint](vtbl) - uint(offsetOf(VirtualQSplashScreen, vtbl)))
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArrayByte(veventType_bytearray.data, 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc create*(T: type gen_qsplashscreen_types.QSplashScreen,
  ...
  gen_qsplashscreen_types.QSplashScreen(h: fcQSplashScreen_new(addr(vtbl[].vtbl), parent.h), owned: true)
...
proc create*(T: type gen_qsplashscreen_types.QSplashScreen,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = miqt_exec_callback_cQSplashScreen_disconnectNotify
  gen_qsplashscreen_types.QSplashScreen(h: fcQSplashScreen_new2(addr(vtbl[].vtbl), ), owned: true)
...
proc create*(T: type gen_qsplashscreen_types.QSplashScreen,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = miqt_exec_callback_cQSplashScreen_disconnectNotify
  gen_qsplashscreen_types.QSplashScreen(h: fcQSplashScreen_new3(addr(vtbl[].vtbl), screen.h), owned: true)
...
proc create*(T: type gen_qsplashscreen_types.QSplashScreen,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = miqt_exec_callback_cQSplashScreen_disconnectNotify
  gen_qsplashscreen_types.QSplashScreen(h: fcQSplashScreen_new4(addr(vtbl[].vtbl), pixmap.h), owned: true)
...
proc create*(T: type gen_qsplashscreen_types.QSplashScreen,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = miqt_exec_callback_cQSplashScreen_disconnectNotify
  gen_qsplashscreen_types.QSplashScreen(h: fcQSplashScreen_new5(addr(vtbl[].vtbl), pixmap.h, cint(f)), owned: true)
...
proc create*(T: type gen_qsplashscreen_types.QSplashScreen,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = miqt_exec_callback_cQSplashScreen_disconnectNotify
  gen_qsplashscreen_types.QSplashScreen(h: fcQSplashScreen_new6(addr(vtbl[].vtbl), screen.h, pixmap.h), owned: true)
...
proc create*(T: type gen_qsplashscreen_types.QSplashScreen,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = miqt_exec_callback_cQSplashScreen_disconnectNotify
  gen_qsplashscreen_types.QSplashScreen(h: fcQSplashScreen_new7(addr(vtbl[].vtbl), screen.h, pixmap.h, cint(f)), owned: true)
...
proc create*(T: type gen_qsplashscreen_types.QSplashScreen,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = miqt_exec_callback_cQSplashScreen_disconnectNotify
  gen_qsplashscreen_types.QSplashScreen(h: fcQSplashScreen_new8(addr(vtbl[].vtbl), parent.h, pixmap.h), owned: true)
...
proc create*(T: type gen_qsplashscreen_types.QSplashScreen,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = miqt_exec_callback_cQSplashScreen_disconnectNotify
  gen_qsplashscreen_types.QSplashScreen(h: fcQSplashScreen_new9(addr(vtbl[].vtbl), parent.h, pixmap.h, cint(f)), owned: true)
...
proc create*(T: type gen_qsplashscreen_types.QSplashScreen,
  ...
  vtbl[].h = fcQSplashScreen_new(addr(vtbl[].vtbl), parent.h)
  vtbl[].owned = true
...
proc create*(T: type gen_qsplashscreen_types.QSplashScreen,
  ...
  vtbl[].vtbl.disconnectNotify = miqt_exec_method_cQSplashScreen_disconnectNotify
  if vtbl[].h != nil: delete(move(vtbl[]))
  vtbl[].h = fcQSplashScreen_new2(addr(vtbl[].vtbl), )
  vtbl[].owned = true
...
proc create*(T: type gen_qsplashscreen_types.QSplashScreen,
  ...
  vtbl[].vtbl.disconnectNotify = miqt_exec_method_cQSplashScreen_disconnectNotify
  if vtbl[].h != nil: delete(move(vtbl[]))
  vtbl[].h = fcQSplashScreen_new3(addr(vtbl[].vtbl), screen.h)
  vtbl[].owned = true
...
proc create*(T: type gen_qsplashscreen_types.QSplashScreen,
  ...
  vtbl[].vtbl.disconnectNotify = miqt_exec_method_cQSplashScreen_disconnectNotify
  if vtbl[].h != nil: delete(move(vtbl[]))
  vtbl[].h = fcQSplashScreen_new4(addr(vtbl[].vtbl), pixmap.h)
  vtbl[].owned = true
...
proc create*(T: type gen_qsplashscreen_types.QSplashScreen,
  ...
  vtbl[].vtbl.disconnectNotify = miqt_exec_method_cQSplashScreen_disconnectNotify
  if vtbl[].h != nil: delete(move(vtbl[]))
  vtbl[].h = fcQSplashScreen_new5(addr(vtbl[].vtbl), pixmap.h, cint(f))
  vtbl[].owned = true
...
proc create*(T: type gen_qsplashscreen_types.QSplashScreen,
  ...
  vtbl[].vtbl.disconnectNotify = miqt_exec_method_cQSplashScreen_disconnectNotify
  if vtbl[].h != nil: delete(move(vtbl[]))
  vtbl[].h = fcQSplashScreen_new6(addr(vtbl[].vtbl), screen.h, pixmap.h)
  vtbl[].owned = true
...
proc create*(T: type gen_qsplashscreen_types.QSplashScreen,
  ...
  vtbl[].vtbl.disconnectNotify = miqt_exec_method_cQSplashScreen_disconnectNotify
  if vtbl[].h != nil: delete(move(vtbl[]))
  vtbl[].h = fcQSplashScreen_new7(addr(vtbl[].vtbl), screen.h, pixmap.h, cint(f))
  vtbl[].owned = true
...
proc create*(T: type gen_qsplashscreen_types.QSplashScreen,
  ...
  vtbl[].vtbl.disconnectNotify = miqt_exec_method_cQSplashScreen_disconnectNotify
  if vtbl[].h != nil: delete(move(vtbl[]))
  vtbl[].h = fcQSplashScreen_new8(addr(vtbl[].vtbl), parent.h, pixmap.h)
  vtbl[].owned = true
...
proc create*(T: type gen_qsplashscreen_types.QSplashScreen,
  ...
  vtbl[].vtbl.disconnectNotify = miqt_exec_method_cQSplashScreen_disconnectNotify
  if vtbl[].h != nil: delete(move(vtbl[]))
  vtbl[].h = fcQSplashScreen_new9(addr(vtbl[].vtbl), parent.h, pixmap.h, cint(f))
  vtbl[].owned = true
