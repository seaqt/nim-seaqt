...
proc fcQSplashScreen_new3(vtbl: pointer, vdata: csize_t, pixmap: pointer): ptr cQSplashScreen {.importc: "QSplashScreen_new3".}
proc fcQSplashScreen_new4(vtbl: pointer, vdata: csize_t, pixmap: pointer, f: cint): ptr cQSplashScreen {.importc: "QSplashScreen_new4".}
