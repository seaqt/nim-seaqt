...
proc fcQSplashScreen_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.importc: "QSplashScreen_virtualbase_nativeEvent".}
...
proc fcQSplashScreen_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QSplashScreen_protectedbase_getDecodedMetricF".}
...
proc fcQSplashScreen_new3(vtbl: pointer, vdata: csize_t, pixmap: pointer): ptr cQSplashScreen {.importc: "QSplashScreen_new_pixmap".}
proc fcQSplashScreen_new4(vtbl: pointer, vdata: csize_t, pixmap: pointer, f: cint): ptr cQSplashScreen {.importc: "QSplashScreen_new_pixmap_f".}
proc fcQSplashScreen_new5(vtbl: pointer, vdata: csize_t, screen: pointer, pixmap: pointer): ptr cQSplashScreen {.importc: "QSplashScreen_new_screen_pixmap".}
proc fcQSplashScreen_new6(vtbl: pointer, vdata: csize_t, screen: pointer, pixmap: pointer, f: cint): ptr cQSplashScreen {.importc: "QSplashScreen_new_screen_pixmap_f".}
...
proc fcQSplashScreen_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QSplashScreenVTable](fcQSplashScreen_vdata(self)[])
  let self = QSplashScreen(h: self)
...
proc fcQSplashScreen_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let inst = cast[VirtualQSplashScreen](fcQSplashScreen_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc getDecodedMetricF*(self: gen_qsplashscreen_types.QSplashScreen, metricA: cint, metricB: cint): float64 =
  fcQSplashScreen_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
