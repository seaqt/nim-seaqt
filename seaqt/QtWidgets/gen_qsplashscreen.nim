...
proc fcQSplashScreen_new(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQSplashScreen {.importc: "QSplashScreen_new".}
proc fcQSplashScreen_new2(vtbl: pointer, vdata: csize_t): ptr cQSplashScreen {.importc: "QSplashScreen_new2".}
proc fcQSplashScreen_new3(vtbl: pointer, vdata: csize_t, screen: pointer): ptr cQSplashScreen {.importc: "QSplashScreen_new3".}
