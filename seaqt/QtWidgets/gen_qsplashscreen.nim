...
proc fcQSplashScreen_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.importc: "QSplashScreen_virtualbase_nativeEvent".}
...
proc fcQSplashScreen_new(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQSplashScreen {.importc: "QSplashScreen_new_parent".}
proc fcQSplashScreen_new2(vtbl: pointer, vdata: csize_t): ptr cQSplashScreen {.importc: "QSplashScreen_new".}
proc fcQSplashScreen_new3(vtbl: pointer, vdata: csize_t, screen: pointer): ptr cQSplashScreen {.importc: "QSplashScreen_new_screen".}
...
proc messageChanged*(self: gen_qsplashscreen_types.QSplashScreen, message: openArray[char]): void =
  fcQSplashScreen_messageChanged(self.h, struct_seaqt_string(data: if len(message) > 0: addr message[0] else: nil, len: csize_t(len(message))))

type QSplashScreenmessageChangedSlot* = proc(message: openArray[char])
proc fcQSplashScreen_slot_callback_messageChanged(slot: int, message: struct_seaqt_string) {.cdecl.} =
...
proc QSplashScreennativeEvent*(self: gen_qsplashscreen_types.QSplashScreen, eventType: openArray[byte], message: pointer, resultVal: ptr clong): bool =
  fcQSplashScreen_virtualbase_nativeEvent(self.h, struct_seaqt_string(data: if len(eventType) > 0: addr eventType[0] else: nil, len: csize_t(len(eventType))), message, resultVal)
...
proc fcQSplashScreen_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let vtbl = cast[ptr QSplashScreenVTable](fcQSplashScreen_vdata(self)[])
  let self = QSplashScreen(h: self)
...
proc fcQSplashScreen_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let inst = cast[VirtualQSplashScreen](fcQSplashScreen_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc create*(T: type gen_qsplashscreen_types.QSplashScreen,
  ...
  let tmp = gen_qsplashscreen_types.QSplashScreen(h: fcQSplashScreen_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
...
proc create*(T: type gen_qsplashscreen_types.QSplashScreen,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQSplashScreen_vtable_callback_disconnectNotify
  let tmp = gen_qsplashscreen_types.QSplashScreen(h: fcQSplashScreen_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQSplashScreen_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qsplashscreen_types.QSplashScreen,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQSplashScreen_vtable_callback_disconnectNotify
  let tmp = gen_qsplashscreen_types.QSplashScreen(h: fcQSplashScreen_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), screen.h), owned: true)
  fcQSplashScreen_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qsplashscreen_types.QSplashScreen,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQSplashScreen_vtable_callback_disconnectNotify
  let tmp = gen_qsplashscreen_types.QSplashScreen(h: fcQSplashScreen_new4(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), pixmap.h), owned: true)
  fcQSplashScreen_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qsplashscreen_types.QSplashScreen,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQSplashScreen_vtable_callback_disconnectNotify
  let tmp = gen_qsplashscreen_types.QSplashScreen(h: fcQSplashScreen_new5(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), pixmap.h, cint(f)), owned: true)
  fcQSplashScreen_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qsplashscreen_types.QSplashScreen,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQSplashScreen_vtable_callback_disconnectNotify
  let tmp = gen_qsplashscreen_types.QSplashScreen(h: fcQSplashScreen_new6(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), screen.h, pixmap.h), owned: true)
  fcQSplashScreen_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qsplashscreen_types.QSplashScreen,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQSplashScreen_vtable_callback_disconnectNotify
  let tmp = gen_qsplashscreen_types.QSplashScreen(h: fcQSplashScreen_new7(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), screen.h, pixmap.h, cint(f)), owned: true)
  fcQSplashScreen_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qsplashscreen_types.QSplashScreen,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQSplashScreen_vtable_callback_disconnectNotify
  let tmp = gen_qsplashscreen_types.QSplashScreen(h: fcQSplashScreen_new8(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h, pixmap.h), owned: true)
  fcQSplashScreen_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qsplashscreen_types.QSplashScreen,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQSplashScreen_vtable_callback_disconnectNotify
  let tmp = gen_qsplashscreen_types.QSplashScreen(h: fcQSplashScreen_new9(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h, pixmap.h, cint(f)), owned: true)
  fcQSplashScreen_vdata(tmp.h)[] = addr(vtbl[])
  tmp
...
proc create*(T: type gen_qsplashscreen_types.QSplashScreen,
  ...
  inst[].h = fcQSplashScreen_new(addr(cQSplashScreen_mvtbl), csize_t(sizeof(pointer)), parent.h)
...
proc create*(T: type gen_qsplashscreen_types.QSplashScreen,
    inst: VirtualQSplashScreen) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQSplashScreen_new2(addr(cQSplashScreen_mvtbl), csize_t(sizeof(pointer)))
  fcQSplashScreen_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qsplashscreen_types.QSplashScreen,
    ...
    inst: VirtualQSplashScreen) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQSplashScreen_new3(addr(cQSplashScreen_mvtbl), csize_t(sizeof(pointer)), screen.h)
  fcQSplashScreen_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qsplashscreen_types.QSplashScreen,
    ...
    inst: VirtualQSplashScreen) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQSplashScreen_new4(addr(cQSplashScreen_mvtbl), csize_t(sizeof(pointer)), pixmap.h)
  fcQSplashScreen_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qsplashscreen_types.QSplashScreen,
    ...
    inst: VirtualQSplashScreen) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQSplashScreen_new5(addr(cQSplashScreen_mvtbl), csize_t(sizeof(pointer)), pixmap.h, cint(f))
  fcQSplashScreen_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qsplashscreen_types.QSplashScreen,
    ...
    inst: VirtualQSplashScreen) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQSplashScreen_new6(addr(cQSplashScreen_mvtbl), csize_t(sizeof(pointer)), screen.h, pixmap.h)
  fcQSplashScreen_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qsplashscreen_types.QSplashScreen,
    ...
    inst: VirtualQSplashScreen) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQSplashScreen_new7(addr(cQSplashScreen_mvtbl), csize_t(sizeof(pointer)), screen.h, pixmap.h, cint(f))
  fcQSplashScreen_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qsplashscreen_types.QSplashScreen,
    ...
    inst: VirtualQSplashScreen) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQSplashScreen_new8(addr(cQSplashScreen_mvtbl), csize_t(sizeof(pointer)), parent.h, pixmap.h)
  fcQSplashScreen_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qsplashscreen_types.QSplashScreen,
    ...
    inst: VirtualQSplashScreen) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQSplashScreen_new9(addr(cQSplashScreen_mvtbl), csize_t(sizeof(pointer)), parent.h, pixmap.h, cint(f))
  fcQSplashScreen_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
