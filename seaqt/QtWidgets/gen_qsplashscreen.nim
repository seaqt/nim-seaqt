...
proc create*(T: type gen_qsplashscreen_types.QSplashScreen,
  ...
  let tmp = gen_qsplashscreen_types.QSplashScreen(h: fcQSplashScreen_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h))
...
proc create*(T: type gen_qsplashscreen_types.QSplashScreen,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQSplashScreen_vtable_callback_disconnectNotify
  let tmp = gen_qsplashscreen_types.QSplashScreen(h: fcQSplashScreen_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer))))
  fcQSplashScreen_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qsplashscreen_types.QSplashScreen,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQSplashScreen_vtable_callback_disconnectNotify
  let tmp = gen_qsplashscreen_types.QSplashScreen(h: fcQSplashScreen_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), screen.h))
  fcQSplashScreen_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qsplashscreen_types.QSplashScreen,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQSplashScreen_vtable_callback_disconnectNotify
  let tmp = gen_qsplashscreen_types.QSplashScreen(h: fcQSplashScreen_new4(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), pixmap.h))
  fcQSplashScreen_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qsplashscreen_types.QSplashScreen,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQSplashScreen_vtable_callback_disconnectNotify
  let tmp = gen_qsplashscreen_types.QSplashScreen(h: fcQSplashScreen_new5(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), pixmap.h, cint(f)))
  fcQSplashScreen_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qsplashscreen_types.QSplashScreen,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQSplashScreen_vtable_callback_disconnectNotify
  let tmp = gen_qsplashscreen_types.QSplashScreen(h: fcQSplashScreen_new6(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), screen.h, pixmap.h))
  fcQSplashScreen_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qsplashscreen_types.QSplashScreen,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQSplashScreen_vtable_callback_disconnectNotify
  let tmp = gen_qsplashscreen_types.QSplashScreen(h: fcQSplashScreen_new7(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), screen.h, pixmap.h, cint(f)))
  fcQSplashScreen_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qsplashscreen_types.QSplashScreen,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQSplashScreen_vtable_callback_disconnectNotify
  let tmp = gen_qsplashscreen_types.QSplashScreen(h: fcQSplashScreen_new8(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h, pixmap.h))
  fcQSplashScreen_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qsplashscreen_types.QSplashScreen,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQSplashScreen_vtable_callback_disconnectNotify
  let tmp = gen_qsplashscreen_types.QSplashScreen(h: fcQSplashScreen_new9(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h, pixmap.h, cint(f)))
  fcQSplashScreen_vdata(tmp.h)[] = addr(vtbl[])
  tmp
