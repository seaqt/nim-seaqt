...
proc fcQCommandLinkButton_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.importc: "QCommandLinkButton_virtualbase_nativeEvent".}
...
proc fcQCommandLinkButton_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QCommandLinkButton_protectedbase_getDecodedMetricF".}
...
proc fcQCommandLinkButton_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QCommandLinkButtonVTable](fcQCommandLinkButton_vdata(self)[])
  let self = QCommandLinkButton(h: self)
...
proc fcQCommandLinkButton_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let inst = cast[VirtualQCommandLinkButton](fcQCommandLinkButton_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc getDecodedMetricF*(self: gen_qcommandlinkbutton_types.QCommandLinkButton, metricA: cint, metricB: cint): float64 =
  fcQCommandLinkButton_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
