...
proc fcQCommandLinkButton_trUtf8S(s: cstring): struct_seaqt_string {.importc: "QCommandLinkButton_trUtf8_s".}
...
proc fcQCommandLinkButton_trUtf8SC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QCommandLinkButton_trUtf8_s_c".}
proc fcQCommandLinkButton_trUtf8SCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QCommandLinkButton_trUtf8_s_c_n".}
...
proc fcQCommandLinkButton_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.importc: "QCommandLinkButton_virtualbase_nativeEvent".}
...
proc fcQCommandLinkButton_new(vtbl: pointer, vdata: csize_t): ptr cQCommandLinkButton {.importc: "QCommandLinkButton_new".}
proc fcQCommandLinkButton_new2(vtbl: pointer, vdata: csize_t, text: struct_seaqt_string): ptr cQCommandLinkButton {.importc: "QCommandLinkButton_new_text".}
proc fcQCommandLinkButton_new3(vtbl: pointer, vdata: csize_t, text: struct_seaqt_string, description: struct_seaqt_string): ptr cQCommandLinkButton {.importc: "QCommandLinkButton_new_text_description".}
proc fcQCommandLinkButton_new4(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQCommandLinkButton {.importc: "QCommandLinkButton_new_parent".}
...
proc trUtf8*(_: type gen_qcommandlinkbutton_types.QCommandLinkButton, s: cstring): string =
  let v_ms = fcQCommandLinkButton_trUtf8S(s)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc setDescription*(self: gen_qcommandlinkbutton_types.QCommandLinkButton, description: openArray[char]): void =
  fcQCommandLinkButton_setDescription(self.h, struct_seaqt_string(data: if len(description) > 0: addr description[0] else: nil, len: csize_t(len(description))))
...
proc QCommandLinkButtonnativeEvent*(self: gen_qcommandlinkbutton_types.QCommandLinkButton, eventType: openArray[byte], message: pointer, resultVal: ptr clong): bool =
  fcQCommandLinkButton_virtualbase_nativeEvent(self.h, struct_seaqt_string(data: if len(eventType) > 0: addr eventType[0] else: nil, len: csize_t(len(eventType))), message, resultVal)
...
proc fcQCommandLinkButton_vtable_callback_mouseMoveEvent(self: pointer, e: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QCommandLinkButtonVTable](fcQCommandLinkButton_vdata(self)[])
  let self = QCommandLinkButton(h: self)
  let slotval1 = gen_qevent_types.QMouseEvent(h: e, owned: false)
...
proc fcQCommandLinkButton_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let vtbl = cast[ptr QCommandLinkButtonVTable](fcQCommandLinkButton_vdata(self)[])
  let self = QCommandLinkButton(h: self)
...
proc fcQCommandLinkButton_method_callback_mouseMoveEvent(self: pointer, e: pointer): void {.cdecl.} =
  let inst = cast[VirtualQCommandLinkButton](fcQCommandLinkButton_vdata(self)[])
  let slotval1 = gen_qevent_types.QMouseEvent(h: e, owned: false)
...
proc fcQCommandLinkButton_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let inst = cast[VirtualQCommandLinkButton](fcQCommandLinkButton_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc create*(T: type gen_qcommandlinkbutton_types.QCommandLinkButton,
  ...
  let tmp = gen_qcommandlinkbutton_types.QCommandLinkButton(h: fcQCommandLinkButton_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
...
proc create*(T: type gen_qcommandlinkbutton_types.QCommandLinkButton,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQCommandLinkButton_vtable_callback_disconnectNotify
  let tmp = gen_qcommandlinkbutton_types.QCommandLinkButton(h: fcQCommandLinkButton_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text)))), owned: true)
  fcQCommandLinkButton_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qcommandlinkbutton_types.QCommandLinkButton,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQCommandLinkButton_vtable_callback_disconnectNotify
  let tmp = gen_qcommandlinkbutton_types.QCommandLinkButton(h: fcQCommandLinkButton_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), struct_seaqt_string(data: if len(description) > 0: addr description[0] else: nil, len: csize_t(len(description)))), owned: true)
  fcQCommandLinkButton_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qcommandlinkbutton_types.QCommandLinkButton,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQCommandLinkButton_vtable_callback_disconnectNotify
  let tmp = gen_qcommandlinkbutton_types.QCommandLinkButton(h: fcQCommandLinkButton_new4(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQCommandLinkButton_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qcommandlinkbutton_types.QCommandLinkButton,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQCommandLinkButton_vtable_callback_disconnectNotify
  let tmp = gen_qcommandlinkbutton_types.QCommandLinkButton(h: fcQCommandLinkButton_new5(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), parent.h), owned: true)
  fcQCommandLinkButton_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qcommandlinkbutton_types.QCommandLinkButton,
...
proc create*(T: type gen_qcommandlinkbutton_types.QCommandLinkButton,
  ...
  inst[].h = fcQCommandLinkButton_new(addr(cQCommandLinkButton_mvtbl), csize_t(sizeof(pointer)))
...
proc create*(T: type gen_qcommandlinkbutton_types.QCommandLinkButton,
    ...
    inst: VirtualQCommandLinkButton) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQCommandLinkButton_new2(addr(cQCommandLinkButton_mvtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))))
  fcQCommandLinkButton_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qcommandlinkbutton_types.QCommandLinkButton,
    ...
    inst: VirtualQCommandLinkButton) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQCommandLinkButton_new3(addr(cQCommandLinkButton_mvtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), struct_seaqt_string(data: if len(description) > 0: addr description[0] else: nil, len: csize_t(len(description))))
  fcQCommandLinkButton_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qcommandlinkbutton_types.QCommandLinkButton,
    ...
    inst: VirtualQCommandLinkButton) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQCommandLinkButton_new4(addr(cQCommandLinkButton_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQCommandLinkButton_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qcommandlinkbutton_types.QCommandLinkButton,
    ...
    inst: VirtualQCommandLinkButton) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQCommandLinkButton_new5(addr(cQCommandLinkButton_mvtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), parent.h)
  fcQCommandLinkButton_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qcommandlinkbutton_types.QCommandLinkButton,
    ...
    inst: VirtualQCommandLinkButton) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQCommandLinkButton_new6(addr(cQCommandLinkButton_mvtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), struct_seaqt_string(data: if len(description) > 0: addr description[0] else: nil, len: csize_t(len(description))), parent.h)
  fcQCommandLinkButton_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
