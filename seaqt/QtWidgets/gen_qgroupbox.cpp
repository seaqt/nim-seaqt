...
public:
	...
	friend bool QGroupBox_virtualbase_nativeEvent(VirtualQGroupBox* self, struct miqt_string eventType, void* message, intptr_t* result);
...
VirtualQGroupBox* QGroupBox_new(const QGroupBox_VTable* vtbl, size_t vdata, QWidget* parent) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQGroupBox>());
...
VirtualQGroupBox* QGroupBox_new3(const QGroupBox_VTable* vtbl, size_t vdata, struct miqt_string title) {
	QString title_QString = QString::fromUtf8(title.data, title.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQGroupBox>());
	return _mem_ ? new (_mem_)VirtualQGroupBox(vtbl, title_QString) : nullptr;
}

VirtualQGroupBox* QGroupBox_new4(const QGroupBox_VTable* vtbl, size_t vdata, struct miqt_string title, QWidget* parent) {
	QString title_QString = QString::fromUtf8(title.data, title.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQGroupBox>());
...
bool QGroupBox_virtualbase_nativeEvent(VirtualQGroupBox* self, struct miqt_string eventType, void* message, intptr_t* result) {
