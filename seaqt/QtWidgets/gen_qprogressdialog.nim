...
proc fcQProgressDialog_new2(vtbl: pointer, vdata: csize_t, labelText: struct_seaqt_string, cancelButtonText: struct_seaqt_string, minimum: cint, maximum: cint): ptr cQProgressDialog {.importc: "QProgressDialog_new2".}
proc fcQProgressDialog_new3(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQProgressDialog {.importc: "QProgressDialog_new3".}
