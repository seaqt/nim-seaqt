...
proc fcQProgressDialog_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.importc: "QProgressDialog_virtualbase_nativeEvent".}
...
proc fcQProgressDialog_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QProgressDialog_protectedbase_getDecodedMetricF".}
...
proc fcQProgressDialog_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QProgressDialogVTable](fcQProgressDialog_vdata(self)[])
  let self = QProgressDialog(h: self)
...
proc fcQProgressDialog_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let inst = cast[VirtualQProgressDialog](fcQProgressDialog_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc getDecodedMetricF*(self: gen_qprogressdialog_types.QProgressDialog, metricA: cint, metricB: cint): float64 =
  fcQProgressDialog_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
