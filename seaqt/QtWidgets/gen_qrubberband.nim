...
proc fcQRubberBand_trUtf8(s: cstring): struct_seaqt_string {.importc: "QRubberBand_trUtf8".}
...
proc fcQRubberBand_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QRubberBand_trUtf82".}
proc fcQRubberBand_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QRubberBand_trUtf83".}
