...
typedef struct QDateTimeEdit_VTable{
	...
	bool (*nativeEvent)(VirtualQDateTimeEdit* self, struct miqt_string eventType, void* message, intptr_t* result);
...
typedef struct QTimeEdit_VTable{
	...
	bool (*nativeEvent)(VirtualQTimeEdit* self, struct miqt_string eventType, void* message, intptr_t* result);
...
typedef struct QDateEdit_VTable{
	...
	bool (*nativeEvent)(VirtualQDateEdit* self, struct miqt_string eventType, void* message, intptr_t* result);
