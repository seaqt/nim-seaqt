...
typedef struct QTextEdit_VTable{
	...
	bool (*nativeEvent)(VirtualQTextEdit* self, struct miqt_string eventType, void* message, long* result);
...
const QTextEdit_VTable* QTextEdit_vtbl(const VirtualQTextEdit* self);
void* QTextEdit_vdata(const VirtualQTextEdit* self);
void QTextEdit_setVdata(VirtualQTextEdit* self, void* vdata);
