...
public:
	...
	friend bool QListView_virtualbase_nativeEvent(VirtualQListView* self, struct miqt_string eventType, void* message, intptr_t* result);
...
VirtualQListView* QListView_new(const QListView_VTable* vtbl, size_t vdata, QWidget* parent) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQListView>());
