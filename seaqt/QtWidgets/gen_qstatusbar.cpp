...
public:
	...
	friend bool QStatusBar_virtualbase_nativeEvent(VirtualQStatusBar* self, struct miqt_string eventType, void* message, intptr_t* result);
...
VirtualQStatusBar* QStatusBar_new(const QStatusBar_VTable* vtbl, size_t vdata, QWidget* parent) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQStatusBar>());
...
bool QStatusBar_virtualbase_nativeEvent(VirtualQStatusBar* self, struct miqt_string eventType, void* message, intptr_t* result) {
