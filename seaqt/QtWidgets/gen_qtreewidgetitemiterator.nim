...
proc create*(T: type gen_qtreewidgetitemiterator_types.QTreeWidgetItemIterator,
  ...
  let tmp = gen_qtreewidgetitemiterator_types.QTreeWidgetItemIterator(h: fcQTreeWidgetItemIterator_new(it.h))
  tmp
proc create*(T: type gen_qtreewidgetitemiterator_types.QTreeWidgetItemIterator,
    widget: gen_qtreewidget_types.QTreeWidget): gen_qtreewidgetitemiterator_types.QTreeWidgetItemIterator =
  let tmp = gen_qtreewidgetitemiterator_types.QTreeWidgetItemIterator(h: fcQTreeWidgetItemIterator_new2(widget.h))
  tmp
proc create*(T: type gen_qtreewidgetitemiterator_types.QTreeWidgetItemIterator,
    item: gen_qtreewidget_types.QTreeWidgetItem): gen_qtreewidgetitemiterator_types.QTreeWidgetItemIterator =
  let tmp = gen_qtreewidgetitemiterator_types.QTreeWidgetItemIterator(h: fcQTreeWidgetItemIterator_new3(item.h))
  tmp
proc create*(T: type gen_qtreewidgetitemiterator_types.QTreeWidgetItemIterator,
    widget: gen_qtreewidget_types.QTreeWidget, flags: cint): gen_qtreewidgetitemiterator_types.QTreeWidgetItemIterator =
  let tmp = gen_qtreewidgetitemiterator_types.QTreeWidgetItemIterator(h: fcQTreeWidgetItemIterator_new4(widget.h, cint(flags)))
  tmp
proc create*(T: type gen_qtreewidgetitemiterator_types.QTreeWidgetItemIterator,
    item: gen_qtreewidget_types.QTreeWidgetItem, flags: cint): gen_qtreewidgetitemiterator_types.QTreeWidgetItemIterator =
  let tmp = gen_qtreewidgetitemiterator_types.QTreeWidgetItemIterator(h: fcQTreeWidgetItemIterator_new5(item.h, cint(flags)))
  tmp
