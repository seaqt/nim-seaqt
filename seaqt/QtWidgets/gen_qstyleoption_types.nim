...
proc `=copy`(dest: var QStyleOptionHeaderV2, source: QStyleOptionHeaderV2) {.error.}
proc `=sink`(dest: var QStyleOptionHeaderV2, source: QStyleOptionHeaderV2) =
  `=destroy`(dest)
  wasMoved(dest)
  dest.h = source.h
  dest.owned = source.owned
...
type QStyleOptionMenuItemV2* = object of QStyleOptionMenuItem
proc `=copy`(dest: var QStyleOptionMenuItemV2, source: QStyleOptionMenuItemV2) {.error.}
proc `=sink`(dest: var QStyleOptionMenuItemV2, source: QStyleOptionMenuItemV2) =
  `=destroy`(dest)
  wasMoved(dest)
  dest.h = source.h
  dest.owned = source.owned
