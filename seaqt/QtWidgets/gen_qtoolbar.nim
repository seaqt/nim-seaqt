...
proc fcQToolBar_trUtf8(s: cstring): struct_seaqt_string {.importc: "QToolBar_trUtf8".}
...
proc fcQToolBar_addAction(self: pointer, text: struct_seaqt_string): pointer {.importc: "QToolBar_addAction".}
proc fcQToolBar_addAction2(self: pointer, icon: pointer, text: struct_seaqt_string): pointer {.importc: "QToolBar_addAction2".}
...
proc fcQToolBar_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QToolBar_trUtf82".}
proc fcQToolBar_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QToolBar_trUtf83".}
