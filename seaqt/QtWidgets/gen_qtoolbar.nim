...
proc create*(T: type gen_qtoolbar_types.QToolBar,
  ...
  let tmp = gen_qtoolbar_types.QToolBar(h: fcQToolBar_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title)))))
...
proc create*(T: type gen_qtoolbar_types.QToolBar,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQToolBar_vtable_callback_disconnectNotify
  let tmp = gen_qtoolbar_types.QToolBar(h: fcQToolBar_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer))))
  fcQToolBar_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qtoolbar_types.QToolBar,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQToolBar_vtable_callback_disconnectNotify
  let tmp = gen_qtoolbar_types.QToolBar(h: fcQToolBar_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), parent.h))
  fcQToolBar_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qtoolbar_types.QToolBar,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQToolBar_vtable_callback_disconnectNotify
  let tmp = gen_qtoolbar_types.QToolBar(h: fcQToolBar_new4(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h))
  fcQToolBar_vdata(tmp.h)[] = addr(vtbl[])
  tmp
