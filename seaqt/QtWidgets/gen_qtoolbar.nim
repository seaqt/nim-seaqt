...
proc fcQToolBar_new(vtbl: pointer, vdata: csize_t, title: struct_seaqt_string): ptr cQToolBar {.importc: "QToolBar_new".}
proc fcQToolBar_new2(vtbl: pointer, vdata: csize_t): ptr cQToolBar {.importc: "QToolBar_new2".}
proc fcQToolBar_new3(vtbl: pointer, vdata: csize_t, title: struct_seaqt_string, parent: pointer): ptr cQToolBar {.importc: "QToolBar_new3".}
proc fcQToolBar_new4(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQToolBar {.importc: "QToolBar_new4".}
