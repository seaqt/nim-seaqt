...
public:
	...
	friend bool QPushButton_virtualbase_nativeEvent(VirtualQPushButton* self, struct miqt_string eventType, void* message, intptr_t* result);
...
VirtualQPushButton* QPushButton_new(const QPushButton_VTable* vtbl, size_t vdata, QWidget* parent) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQPushButton>());
...
VirtualQPushButton* QPushButton_new3(const QPushButton_VTable* vtbl, size_t vdata, struct miqt_string text) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQPushButton>());
	return _mem_ ? new (_mem_)VirtualQPushButton(vtbl, text_QString) : nullptr;
}

VirtualQPushButton* QPushButton_new4(const QPushButton_VTable* vtbl, size_t vdata, QIcon* icon, struct miqt_string text) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQPushButton>());
	return _mem_ ? new (_mem_)VirtualQPushButton(vtbl, *icon, text_QString) : nullptr;
}

VirtualQPushButton* QPushButton_new5(const QPushButton_VTable* vtbl, size_t vdata, struct miqt_string text, QWidget* parent) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQPushButton>());
	return _mem_ ? new (_mem_)VirtualQPushButton(vtbl, text_QString, parent) : nullptr;
}

VirtualQPushButton* QPushButton_new6(const QPushButton_VTable* vtbl, size_t vdata, QIcon* icon, struct miqt_string text, QWidget* parent) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQPushButton>());
...
bool QPushButton_virtualbase_nativeEvent(VirtualQPushButton* self, struct miqt_string eventType, void* message, intptr_t* result) {
