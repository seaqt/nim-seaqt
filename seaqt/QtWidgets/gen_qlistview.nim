...
proc fcQListView_virtualbase_dataChanged(self: pointer, topLeft: pointer, bottomRight: pointer, roles: struct_seaqt_array): void {.importc: "QListView_virtualbase_dataChanged".}
...
proc fcQListView_virtualbase_selectedIndexes(self: pointer): struct_seaqt_array {.importc: "QListView_virtualbase_selectedIndexes".}
...
proc fcQListView_virtualbase_keyboardSearch(self: pointer, search: struct_seaqt_string): void {.importc: "QListView_virtualbase_keyboardSearch".}
...
proc fcQListView_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.importc: "QListView_virtualbase_nativeEvent".}
...
proc fcQListView_new(vtbl: pointer, vdata: csize_t): ptr cQListView {.importc: "QListView_new".}
proc fcQListView_new2(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQListView {.importc: "QListView_new_parent".}
...
proc indexesMoved*(self: gen_qlistview_types.QListView, indexes: openArray[gen_qabstractitemmodel_types.QModelIndex]): void =
  ...
  fcQListView_indexesMoved(self.h, struct_seaqt_array(len: csize_t(len(indexes)), data: if len(indexes) == 0: nil else: addr(indexes_CArray[0])))

type QListViewindexesMovedSlot* = proc(indexes: openArray[gen_qabstractitemmodel_types.QModelIndex])
proc fcQListView_slot_callback_indexesMoved(slot: int, indexes: struct_seaqt_array) {.cdecl.} =
...
type QListViewnativeEventProc* = proc(self: QListView, eventType: openArray[byte], message: pointer, resultVal: ptr clong): bool {.raises: [], gcsafe.}
...
proc QListViewdataChanged*(self: gen_qlistview_types.QListView, topLeft: gen_qabstractitemmodel_types.QModelIndex, bottomRight: gen_qabstractitemmodel_types.QModelIndex, roles: openArray[cint]): void =
  ...
  fcQListView_virtualbase_dataChanged(self.h, topLeft.h, bottomRight.h, struct_seaqt_array(len: csize_t(len(roles)), data: if len(roles) == 0: nil else: addr(roles_CArray[0])))
...
proc QListViewkeyboardSearch*(self: gen_qlistview_types.QListView, search: openArray[char]): void =
  fcQListView_virtualbase_keyboardSearch(self.h, struct_seaqt_string(data: if len(search) > 0: addr search[0] else: nil, len: csize_t(len(search))))
...
proc QListViewnativeEvent*(self: gen_qlistview_types.QListView, eventType: openArray[byte], message: pointer, resultVal: ptr clong): bool =
  fcQListView_virtualbase_nativeEvent(self.h, struct_seaqt_string(data: if len(eventType) > 0: addr eventType[0] else: nil, len: csize_t(len(eventType))), message, resultVal)
...
proc fcQListView_vtable_callback_dataChanged(self: pointer, topLeft: pointer, bottomRight: pointer, roles: struct_seaqt_array): void {.cdecl.} =
  let vtbl = cast[ptr QListViewVTable](fcQListView_vdata(self)[])
  let self = QListView(h: self)
...
proc fcQListView_vtable_callback_viewOptions(self: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QListViewVTable](fcQListView_vdata(self)[])
  let self = QListView(h: self)
...
proc fcQListView_vtable_callback_selectedIndexes(self: pointer): struct_seaqt_array {.cdecl.} =
  let vtbl = cast[ptr QListViewVTable](fcQListView_vdata(self)[])
  let self = QListView(h: self)
...
proc fcQListView_vtable_callback_keyboardSearch(self: pointer, search: struct_seaqt_string): void {.cdecl.} =
  let vtbl = cast[ptr QListViewVTable](fcQListView_vdata(self)[])
  let self = QListView(h: self)
...
proc fcQListView_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let vtbl = cast[ptr QListViewVTable](fcQListView_vdata(self)[])
  let self = QListView(h: self)
...
method nativeEvent*(self: VirtualQListView, eventType: openArray[byte], message: pointer, resultVal: ptr clong): bool {.base.} =
...
proc fcQListView_method_callback_dataChanged(self: pointer, topLeft: pointer, bottomRight: pointer, roles: struct_seaqt_array): void {.cdecl.} =
  let inst = cast[VirtualQListView](fcQListView_vdata(self)[])
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: topLeft, owned: false)
  let slotval2 = gen_qabstractitemmodel_types.QModelIndex(h: bottomRight, owned: false)
  var vroles_ma = roles
...
proc fcQListView_method_callback_viewOptions(self: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQListView](fcQListView_vdata(self)[])
...
proc fcQListView_method_callback_selectedIndexes(self: pointer): struct_seaqt_array {.cdecl.} =
  let inst = cast[VirtualQListView](fcQListView_vdata(self)[])
...
proc fcQListView_method_callback_keyboardSearch(self: pointer, search: struct_seaqt_string): void {.cdecl.} =
  let inst = cast[VirtualQListView](fcQListView_vdata(self)[])
  let vsearch_ms = search
  let vsearchx_ret = string.fromBytes(vsearch_ms)
  c_free(vsearch_ms.data)
...
proc fcQListView_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let inst = cast[VirtualQListView](fcQListView_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc create*(T: type gen_qlistview_types.QListView,
  ...
  if not isNil(vtbl[].viewOptions):
    vtbl[].vtbl.viewOptions = fcQListView_vtable_callback_viewOptions
  ...
  let tmp = gen_qlistview_types.QListView(h: fcQListView_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQListView_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qlistview_types.QListView,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQListView_vtable_callback_disconnectNotify
  let tmp = gen_qlistview_types.QListView(h: fcQListView_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQListView_vdata(tmp.h)[] = addr(vtbl[])
  tmp
const cQListView_mvtbl = cQListViewVTable(
  ...
  viewOptions: fcQListView_method_callback_viewOptions,
...
proc create*(T: type gen_qlistview_types.QListView,
  ...
  inst[].h = fcQListView_new(addr(cQListView_mvtbl), csize_t(sizeof(pointer)))
  fcQListView_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qlistview_types.QListView,
    ...
    inst: VirtualQListView) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQListView_new2(addr(cQListView_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQListView_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
