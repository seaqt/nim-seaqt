...
proc fcQLabel_trUtf8S(s: cstring): struct_seaqt_string {.importc: "QLabel_trUtf8_s".}
...
proc fcQLabel_trUtf8SC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QLabel_trUtf8_s_c".}
proc fcQLabel_trUtf8SCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QLabel_trUtf8_s_c_n".}
...
proc fcQLabel_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.importc: "QLabel_virtualbase_nativeEvent".}
...
proc fcQLabel_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let vtbl = cast[ptr QLabelVTable](fcQLabel_vdata(self)[])
  let self = QLabel(h: self)
...
proc fcQLabel_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let inst = cast[VirtualQLabel](fcQLabel_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
