...
proc fcQLabel_trUtf8(s: cstring): struct_seaqt_string {.importc: "QLabel_trUtf8".}
...
proc fcQLabel_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QLabel_trUtf82".}
proc fcQLabel_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QLabel_trUtf83".}
