...
proc fcQLabel_new(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQLabel {.importc: "QLabel_new".}
proc fcQLabel_new2(vtbl: pointer, vdata: csize_t): ptr cQLabel {.importc: "QLabel_new2".}
proc fcQLabel_new3(vtbl: pointer, vdata: csize_t, text: struct_seaqt_string): ptr cQLabel {.importc: "QLabel_new3".}
