...
proc fcQLabel_selectedText(self: pointer): struct_seaqt_string {.importc: "QLabel_selectedText".}
proc fcQLabel_selectionStart(self: pointer): cint {.importc: "QLabel_selectionStart".}
proc fcQLabel_setText(self: pointer, text: struct_seaqt_string): void {.importc: "QLabel_setText".}
...
proc fcQLabel_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.importc: "QLabel_virtualbase_nativeEvent".}
...
proc fcQLabel_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QLabel_protectedbase_getDecodedMetricF".}
...
proc setText*(self: gen_qlabel_types.QLabel, text: openArray[char]): void =
  fcQLabel_setText(self.h, struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))))
...
proc linkActivated*(self: gen_qlabel_types.QLabel, link: openArray[char]): void =
  fcQLabel_linkActivated(self.h, struct_seaqt_string(data: if len(link) > 0: addr link[0] else: nil, len: csize_t(len(link))))

type QLabellinkActivatedSlot* = proc(link: openArray[char])
proc fcQLabel_slot_callback_linkActivated(slot: int, link: struct_seaqt_string) {.cdecl.} =
...
proc linkHovered*(self: gen_qlabel_types.QLabel, link: openArray[char]): void =
  fcQLabel_linkHovered(self.h, struct_seaqt_string(data: if len(link) > 0: addr link[0] else: nil, len: csize_t(len(link))))

type QLabellinkHoveredSlot* = proc(link: openArray[char])
proc fcQLabel_slot_callback_linkHovered(slot: int, link: struct_seaqt_string) {.cdecl.} =
...
proc QLabelnativeEvent*(self: gen_qlabel_types.QLabel, eventType: openArray[byte], message: pointer, resultVal: ptr uint): bool =
  fcQLabel_virtualbase_nativeEvent(self.h, struct_seaqt_string(data: if len(eventType) > 0: addr eventType[0] else: nil, len: csize_t(len(eventType))), message, resultVal)
...
proc fcQLabel_vtable_callback_initStyleOption(self: pointer, option: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QLabelVTable](fcQLabel_vdata(self)[])
  let self = QLabel(h: self)
...
proc fcQLabel_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QLabelVTable](fcQLabel_vdata(self)[])
  let self = QLabel(h: self)
...
method initStyleOption*(self: VirtualQLabel, option: gen_qstyleoption_types.QStyleOptionFrame): void {.base.} =
  QLabelinitStyleOption(self[], option)
...
method enterEvent*(self: VirtualQLabel, event: gen_qevent_types.QEnterEvent): void {.base.} =
...
proc fcQLabel_method_callback_initStyleOption(self: pointer, option: pointer): void {.cdecl.} =
  let inst = cast[VirtualQLabel](fcQLabel_vdata(self)[])
  let slotval1 = gen_qstyleoption_types.QStyleOptionFrame(h: option, owned: false)
...
proc fcQLabel_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let inst = cast[VirtualQLabel](fcQLabel_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc getDecodedMetricF*(self: gen_qlabel_types.QLabel, metricA: cint, metricB: cint): float64 =
  fcQLabel_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
...
proc create*(T: type gen_qlabel_types.QLabel,
  ...
  if not isNil(vtbl[].initStyleOption):
    vtbl[].vtbl.initStyleOption = fcQLabel_vtable_callback_initStyleOption
  ...
  let tmp = gen_qlabel_types.QLabel(h: fcQLabel_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
...
proc create*(T: type gen_qlabel_types.QLabel,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQLabel_vtable_callback_disconnectNotify
  let tmp = gen_qlabel_types.QLabel(h: fcQLabel_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text)))), owned: true)
  fcQLabel_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qlabel_types.QLabel,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQLabel_vtable_callback_disconnectNotify
  let tmp = gen_qlabel_types.QLabel(h: fcQLabel_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQLabel_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qlabel_types.QLabel,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQLabel_vtable_callback_disconnectNotify
  let tmp = gen_qlabel_types.QLabel(h: fcQLabel_new4(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h, cint(f)), owned: true)
  fcQLabel_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qlabel_types.QLabel,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQLabel_vtable_callback_disconnectNotify
  let tmp = gen_qlabel_types.QLabel(h: fcQLabel_new5(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), parent.h), owned: true)
  fcQLabel_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qlabel_types.QLabel,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQLabel_vtable_callback_disconnectNotify
  let tmp = gen_qlabel_types.QLabel(h: fcQLabel_new6(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), parent.h, cint(f)), owned: true)
  fcQLabel_vdata(tmp.h)[] = addr(vtbl[])
  tmp
const cQLabel_mvtbl = cQLabelVTable(
  ...
  initStyleOption: fcQLabel_method_callback_initStyleOption,
...
proc create*(T: type gen_qlabel_types.QLabel,
  ...
  inst[].h = fcQLabel_new(addr(cQLabel_mvtbl), csize_t(sizeof(pointer)))
...
proc create*(T: type gen_qlabel_types.QLabel,
    ...
    inst: VirtualQLabel) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQLabel_new2(addr(cQLabel_mvtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))))
  fcQLabel_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qlabel_types.QLabel,
    ...
    inst: VirtualQLabel) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQLabel_new3(addr(cQLabel_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQLabel_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qlabel_types.QLabel,
    ...
    inst: VirtualQLabel) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQLabel_new5(addr(cQLabel_mvtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), parent.h)
  fcQLabel_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qlabel_types.QLabel,
    ...
    inst: VirtualQLabel) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQLabel_new6(addr(cQLabel_mvtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), parent.h, cint(f))
  fcQLabel_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
