...
proc fcQFormLayout_setRowVisibleRowOn(self: pointer, row: cint, on: bool): void {.importc: "QFormLayout_setRowVisible_row_on".}
proc fcQFormLayout_setRowVisibleWidgetOn(self: pointer, widget: pointer, on: bool): void {.importc: "QFormLayout_setRowVisible_widget_on".}
proc fcQFormLayout_setRowVisibleLayoutOn(self: pointer, layout: pointer, on: bool): void {.importc: "QFormLayout_setRowVisible_layout_on".}
proc fcQFormLayout_isRowVisibleRow(self: pointer, row: cint): bool {.importc: "QFormLayout_isRowVisible_row".}
proc fcQFormLayout_isRowVisibleWidget(self: pointer, widget: pointer): bool {.importc: "QFormLayout_isRowVisible_widget".}
proc fcQFormLayout_isRowVisibleLayout(self: pointer, layout: pointer): bool {.importc: "QFormLayout_isRowVisible_layout".}
...
proc fcQFormLayout_new(vtbl: pointer, vdata: csize_t): ptr cQFormLayout {.importc: "QFormLayout_new".}
proc fcQFormLayout_new2(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQFormLayout {.importc: "QFormLayout_new_parent".}
...
proc fcQFormLayoutTakeRowResult_fieldItem(self: pointer): pointer {.importc: "QFormLayout__TakeRowResult_fieldItem".}
proc fcQFormLayoutTakeRowResult_setFieldItem(self: pointer, fieldItem: pointer): void {.importc: "QFormLayout__TakeRowResult_setFieldItem".}
proc fcQFormLayoutTakeRowResult_new(): ptr cQFormLayoutTakeRowResult {.importc: "QFormLayout__TakeRowResult_new".}
proc fcQFormLayoutTakeRowResult_new2(fromVal: pointer): ptr cQFormLayoutTakeRowResult {.importc: "QFormLayout__TakeRowResult_new_from".}
...
proc create*(T: type gen_qformlayout_types.QFormLayout,
  ...
  let tmp = gen_qformlayout_types.QFormLayout(h: fcQFormLayout_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQFormLayout_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qformlayout_types.QFormLayout,
  ...
  if not isNil(vtbl[].spacerItem):
    vtbl[].vtbl.spacerItem = fcQFormLayout_vtable_callback_spacerItem
  let tmp = gen_qformlayout_types.QFormLayout(h: fcQFormLayout_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQFormLayout_vdata(tmp.h)[] = addr(vtbl[])
  tmp
...
proc create*(T: type gen_qformlayout_types.QFormLayout,
  ...
  inst[].h = fcQFormLayout_new(addr(cQFormLayout_mvtbl), csize_t(sizeof(pointer)))
...
proc create*(T: type gen_qformlayout_types.QFormLayout,
    ...
    inst: VirtualQFormLayout) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQFormLayout_new2(addr(cQFormLayout_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQFormLayout_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc labelItem*(self: gen_qformlayout_types.QFormLayoutTakeRowResult): gen_qlayoutitem_types.QLayoutItem =
  gen_qlayoutitem_types.QLayoutItem(h: fcQFormLayoutTakeRowResult_labelItem(self.h), owned: false)

proc setLabelItem*(self: gen_qformlayout_types.QFormLayoutTakeRowResult, labelItem: gen_qlayoutitem_types.QLayoutItem): void =
  fcQFormLayoutTakeRowResult_setLabelItem(self.h, labelItem.h)

proc fieldItem*(self: gen_qformlayout_types.QFormLayoutTakeRowResult): gen_qlayoutitem_types.QLayoutItem =
  gen_qlayoutitem_types.QLayoutItem(h: fcQFormLayoutTakeRowResult_fieldItem(self.h), owned: false)

proc setFieldItem*(self: gen_qformlayout_types.QFormLayoutTakeRowResult, fieldItem: gen_qlayoutitem_types.QLayoutItem): void =
  fcQFormLayoutTakeRowResult_setFieldItem(self.h, fieldItem.h)

proc create*(T: type gen_qformlayout_types.QFormLayoutTakeRowResult): gen_qformlayout_types.QFormLayoutTakeRowResult =
  let tmp = gen_qformlayout_types.QFormLayoutTakeRowResult(h: fcQFormLayoutTakeRowResult_new(), owned: true)
  tmp
proc create*(T: type gen_qformlayout_types.QFormLayoutTakeRowResult,
    fromVal: gen_qformlayout_types.QFormLayoutTakeRowResult): gen_qformlayout_types.QFormLayoutTakeRowResult =
  let tmp = gen_qformlayout_types.QFormLayoutTakeRowResult(h: fcQFormLayoutTakeRowResult_new2(fromVal.h), owned: true)
  tmp
