...
proc fcQCommonStyle_tr(s: cstring): struct_seaqt_string {.importc: "QCommonStyle_tr".}
proc fcQCommonStyle_trUtf8(s: cstring): struct_seaqt_string {.importc: "QCommonStyle_trUtf8".}
...
proc fcQCommonStyle_tr2(s: cstring, c: cstring): struct_seaqt_string {.importc: "QCommonStyle_tr2".}
proc fcQCommonStyle_tr3(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QCommonStyle_tr3".}
proc fcQCommonStyle_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QCommonStyle_trUtf82".}
proc fcQCommonStyle_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QCommonStyle_trUtf83".}
