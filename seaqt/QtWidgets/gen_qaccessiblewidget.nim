...
proc fcQAccessibleWidget_relations(self: pointer, match: cint): struct_seaqt_array {.importc: "QAccessibleWidget_relations".}
...
proc state*(self: gen_qaccessiblewidget_types.QAccessibleWidget): gen_qaccessible_types.QAccessibleState =
  gen_qaccessible_types.QAccessibleState(h: fcQAccessibleWidget_state(self.h), owned: true)
...
proc create*(T: type gen_qaccessiblewidget_types.QAccessibleWidget,
  ...
  let tmp = gen_qaccessiblewidget_types.QAccessibleWidget(h: fcQAccessibleWidget_new3(o.h, cint(r), struct_seaqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name)))), owned: true)
  tmp
