...
{.compile("gen_qitemdelegate.cpp", QtWidgetsCFlags).}
...
proc fcQItemDelegate_trUtf8S(s: cstring): struct_seaqt_string {.importc: "QItemDelegate_trUtf8_s".}
...
proc fcQItemDelegate_trUtf8SC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QItemDelegate_trUtf8_s_c".}
proc fcQItemDelegate_trUtf8SCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QItemDelegate_trUtf8_s_c_n".}
...
type cQItemDelegateVTable {.pure.} = object
  ...
  drawDisplay*: proc(self: pointer, painter: pointer, option: pointer, rect: pointer, text: struct_seaqt_string): void {.cdecl, raises: [], gcsafe.}
  ...
  paintingRoles*: proc(self: pointer): struct_seaqt_array {.cdecl, raises: [], gcsafe.}
...
proc fcQItemDelegate_virtualbase_drawDisplay(self: pointer, painter: pointer, option: pointer, rect: pointer, text: struct_seaqt_string): void {.importc: "QItemDelegate_virtualbase_drawDisplay".}
...
proc fcQItemDelegate_virtualbase_paintingRoles(self: pointer): struct_seaqt_array {.importc: "QItemDelegate_virtualbase_paintingRoles".}
...
proc fcQItemDelegate_protectedbase_textRectangle(self: pointer, painter: pointer, rect: pointer, font: pointer, text: struct_seaqt_string): pointer {.importc: "QItemDelegate_protectedbase_textRectangle".}
...
proc trUtf8*(_: type gen_qitemdelegate_types.QItemDelegate, s: cstring): string =
  let v_ms = fcQItemDelegate_trUtf8S(s)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc QItemDelegatedrawDisplay*(self: gen_qitemdelegate_types.QItemDelegate, painter: gen_qpainter_types.QPainter, option: gen_qstyleoption_types.QStyleOptionViewItem, rect: gen_qrect_types.QRect, text: openArray[char]): void =
  fcQItemDelegate_virtualbase_drawDisplay(self.h, painter.h, option.h, rect.h, struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))))
...
proc fcQItemDelegate_vtable_callback_metaObject(self: pointer): pointer {.cdecl.} =
...
proc fcQItemDelegate_vtable_callback_metacast(self: pointer, param1: cstring): pointer {.cdecl.} =
  let vtbl = cast[ptr QItemDelegateVTable](fcQItemDelegate_vdata(self)[])
  let self = QItemDelegate(h: self)
  let slotval1 = (param1)
...
proc fcQItemDelegate_vtable_callback_metacall(self: pointer, param1: cint, param2: cint, param3: pointer): cint {.cdecl.} =
  let vtbl = cast[ptr QItemDelegateVTable](fcQItemDelegate_vdata(self)[])
  let self = QItemDelegate(h: self)
...
proc fcQItemDelegate_vtable_callback_paint(self: pointer, painter: pointer, option: pointer, index: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QItemDelegateVTable](fcQItemDelegate_vdata(self)[])
  let self = QItemDelegate(h: self)
...
proc fcQItemDelegate_vtable_callback_sizeHint(self: pointer, option: pointer, index: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QItemDelegateVTable](fcQItemDelegate_vdata(self)[])
  let self = QItemDelegate(h: self)
...
proc fcQItemDelegate_vtable_callback_createEditor(self: pointer, parent: pointer, option: pointer, index: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QItemDelegateVTable](fcQItemDelegate_vdata(self)[])
  let self = QItemDelegate(h: self)
...
proc fcQItemDelegate_vtable_callback_setEditorData(self: pointer, editor: pointer, index: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QItemDelegateVTable](fcQItemDelegate_vdata(self)[])
  let self = QItemDelegate(h: self)
...
proc fcQItemDelegate_vtable_callback_setModelData(self: pointer, editor: pointer, model: pointer, index: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QItemDelegateVTable](fcQItemDelegate_vdata(self)[])
  let self = QItemDelegate(h: self)
  let slotval1 = gen_qwidget_types.QWidget(h: editor, owned: false)
...
proc fcQItemDelegate_vtable_callback_updateEditorGeometry(self: pointer, editor: pointer, option: pointer, index: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QItemDelegateVTable](fcQItemDelegate_vdata(self)[])
  let self = QItemDelegate(h: self)
  let slotval1 = gen_qwidget_types.QWidget(h: editor, owned: false)
  let slotval2 = gen_qstyleoption_types.QStyleOptionViewItem(h: option, owned: false)
...
proc fcQItemDelegate_vtable_callback_drawDisplay(self: pointer, painter: pointer, option: pointer, rect: pointer, text: struct_seaqt_string): void {.cdecl.} =
  let vtbl = cast[ptr QItemDelegateVTable](fcQItemDelegate_vdata(self)[])
  let self = QItemDelegate(h: self)
  let slotval1 = gen_qpainter_types.QPainter(h: painter, owned: false)
  let slotval2 = gen_qstyleoption_types.QStyleOptionViewItem(h: option, owned: false)
...
proc fcQItemDelegate_vtable_callback_drawDecoration(self: pointer, painter: pointer, option: pointer, rect: pointer, pixmap: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QItemDelegateVTable](fcQItemDelegate_vdata(self)[])
  let self = QItemDelegate(h: self)
  let slotval1 = gen_qpainter_types.QPainter(h: painter, owned: false)
  let slotval2 = gen_qstyleoption_types.QStyleOptionViewItem(h: option, owned: false)
...
proc fcQItemDelegate_vtable_callback_drawFocus(self: pointer, painter: pointer, option: pointer, rect: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QItemDelegateVTable](fcQItemDelegate_vdata(self)[])
  let self = QItemDelegate(h: self)
  let slotval1 = gen_qpainter_types.QPainter(h: painter, owned: false)
  let slotval2 = gen_qstyleoption_types.QStyleOptionViewItem(h: option, owned: false)
...
proc fcQItemDelegate_vtable_callback_drawCheck(self: pointer, painter: pointer, option: pointer, rect: pointer, state: cint): void {.cdecl.} =
  let vtbl = cast[ptr QItemDelegateVTable](fcQItemDelegate_vdata(self)[])
  let self = QItemDelegate(h: self)
  let slotval1 = gen_qpainter_types.QPainter(h: painter, owned: false)
  let slotval2 = gen_qstyleoption_types.QStyleOptionViewItem(h: option, owned: false)
...
proc fcQItemDelegate_vtable_callback_eventFilter(self: pointer, objectVal: pointer, event: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QItemDelegateVTable](fcQItemDelegate_vdata(self)[])
  let self = QItemDelegate(h: self)
...
proc fcQItemDelegate_vtable_callback_editorEvent(self: pointer, event: pointer, model: pointer, option: pointer, index: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QItemDelegateVTable](fcQItemDelegate_vdata(self)[])
  let self = QItemDelegate(h: self)
...
proc fcQItemDelegate_vtable_callback_destroyEditor(self: pointer, editor: pointer, index: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QItemDelegateVTable](fcQItemDelegate_vdata(self)[])
  let self = QItemDelegate(h: self)
  let slotval1 = gen_qwidget_types.QWidget(h: editor, owned: false)
  let slotval2 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
...
proc fcQItemDelegate_vtable_callback_helpEvent(self: pointer, event: pointer, view: pointer, option: pointer, index: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QItemDelegateVTable](fcQItemDelegate_vdata(self)[])
  let self = QItemDelegate(h: self)
...
proc fcQItemDelegate_vtable_callback_paintingRoles(self: pointer): struct_seaqt_array {.cdecl.} =
  let vtbl = cast[ptr QItemDelegateVTable](fcQItemDelegate_vdata(self)[])
  let self = QItemDelegate(h: self)
...
proc fcQItemDelegate_vtable_callback_event(self: pointer, event: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QItemDelegateVTable](fcQItemDelegate_vdata(self)[])
  let self = QItemDelegate(h: self)
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
...
proc fcQItemDelegate_vtable_callback_timerEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QItemDelegateVTable](fcQItemDelegate_vdata(self)[])
  let self = QItemDelegate(h: self)
  let slotval1 = gen_qcoreevent_types.QTimerEvent(h: event, owned: false)
  vtbl[].timerEvent(self, slotval1)

proc fcQItemDelegate_vtable_callback_childEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QItemDelegateVTable](fcQItemDelegate_vdata(self)[])
  let self = QItemDelegate(h: self)
  let slotval1 = gen_qcoreevent_types.QChildEvent(h: event, owned: false)
  vtbl[].childEvent(self, slotval1)

proc fcQItemDelegate_vtable_callback_customEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QItemDelegateVTable](fcQItemDelegate_vdata(self)[])
  let self = QItemDelegate(h: self)
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
  vtbl[].customEvent(self, slotval1)

proc fcQItemDelegate_vtable_callback_connectNotify(self: pointer, signal: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QItemDelegateVTable](fcQItemDelegate_vdata(self)[])
  let self = QItemDelegate(h: self)
  let slotval1 = gen_qmetaobject_types.QMetaMethod(h: signal, owned: false)
  vtbl[].connectNotify(self, slotval1)

proc fcQItemDelegate_vtable_callback_disconnectNotify(self: pointer, signal: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QItemDelegateVTable](fcQItemDelegate_vdata(self)[])
  let self = QItemDelegate(h: self)
  let slotval1 = gen_qmetaobject_types.QMetaMethod(h: signal, owned: false)
...
proc fcQItemDelegate_method_callback_metaObject(self: pointer): pointer {.cdecl.} =
...
proc fcQItemDelegate_method_callback_metacast(self: pointer, param1: cstring): pointer {.cdecl.} =
  let inst = cast[VirtualQItemDelegate](fcQItemDelegate_vdata(self)[])
  let slotval1 = (param1)
  var virtualReturn = inst.metacast(slotval1)
  virtualReturn

proc fcQItemDelegate_method_callback_metacall(self: pointer, param1: cint, param2: cint, param3: pointer): cint {.cdecl.} =
  let inst = cast[VirtualQItemDelegate](fcQItemDelegate_vdata(self)[])
  let slotval1 = cint(param1)
  let slotval2 = param2
  let slotval3 = param3
...
proc fcQItemDelegate_method_callback_paint(self: pointer, painter: pointer, option: pointer, index: pointer): void {.cdecl.} =
  let inst = cast[VirtualQItemDelegate](fcQItemDelegate_vdata(self)[])
  let slotval1 = gen_qpainter_types.QPainter(h: painter, owned: false)
  let slotval2 = gen_qstyleoption_types.QStyleOptionViewItem(h: option, owned: false)
  let slotval3 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
...
proc fcQItemDelegate_method_callback_sizeHint(self: pointer, option: pointer, index: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQItemDelegate](fcQItemDelegate_vdata(self)[])
  let slotval1 = gen_qstyleoption_types.QStyleOptionViewItem(h: option, owned: false)
  let slotval2 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
...
proc fcQItemDelegate_method_callback_createEditor(self: pointer, parent: pointer, option: pointer, index: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQItemDelegate](fcQItemDelegate_vdata(self)[])
  let slotval1 = gen_qwidget_types.QWidget(h: parent, owned: false)
  let slotval2 = gen_qstyleoption_types.QStyleOptionViewItem(h: option, owned: false)
  let slotval3 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
...
proc fcQItemDelegate_method_callback_setEditorData(self: pointer, editor: pointer, index: pointer): void {.cdecl.} =
  let inst = cast[VirtualQItemDelegate](fcQItemDelegate_vdata(self)[])
  let slotval1 = gen_qwidget_types.QWidget(h: editor, owned: false)
  let slotval2 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
  inst.setEditorData(slotval1, slotval2)

proc fcQItemDelegate_method_callback_setModelData(self: pointer, editor: pointer, model: pointer, index: pointer): void {.cdecl.} =
  let inst = cast[VirtualQItemDelegate](fcQItemDelegate_vdata(self)[])
  let slotval1 = gen_qwidget_types.QWidget(h: editor, owned: false)
  let slotval2 = gen_qabstractitemmodel_types.QAbstractItemModel(h: model, owned: false)
  let slotval3 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
...
proc fcQItemDelegate_method_callback_updateEditorGeometry(self: pointer, editor: pointer, option: pointer, index: pointer): void {.cdecl.} =
  let inst = cast[VirtualQItemDelegate](fcQItemDelegate_vdata(self)[])
  let slotval1 = gen_qwidget_types.QWidget(h: editor, owned: false)
  let slotval2 = gen_qstyleoption_types.QStyleOptionViewItem(h: option, owned: false)
  let slotval3 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
...
proc fcQItemDelegate_method_callback_drawDisplay(self: pointer, painter: pointer, option: pointer, rect: pointer, text: struct_seaqt_string): void {.cdecl.} =
  let inst = cast[VirtualQItemDelegate](fcQItemDelegate_vdata(self)[])
  let slotval1 = gen_qpainter_types.QPainter(h: painter, owned: false)
  let slotval2 = gen_qstyleoption_types.QStyleOptionViewItem(h: option, owned: false)
  let slotval3 = gen_qrect_types.QRect(h: rect, owned: false)
...
proc fcQItemDelegate_method_callback_drawDecoration(self: pointer, painter: pointer, option: pointer, rect: pointer, pixmap: pointer): void {.cdecl.} =
  let inst = cast[VirtualQItemDelegate](fcQItemDelegate_vdata(self)[])
  let slotval1 = gen_qpainter_types.QPainter(h: painter, owned: false)
  let slotval2 = gen_qstyleoption_types.QStyleOptionViewItem(h: option, owned: false)
  let slotval3 = gen_qrect_types.QRect(h: rect, owned: false)
...
proc fcQItemDelegate_method_callback_drawFocus(self: pointer, painter: pointer, option: pointer, rect: pointer): void {.cdecl.} =
  let inst = cast[VirtualQItemDelegate](fcQItemDelegate_vdata(self)[])
  let slotval1 = gen_qpainter_types.QPainter(h: painter, owned: false)
  let slotval2 = gen_qstyleoption_types.QStyleOptionViewItem(h: option, owned: false)
  let slotval3 = gen_qrect_types.QRect(h: rect, owned: false)
...
proc fcQItemDelegate_method_callback_drawCheck(self: pointer, painter: pointer, option: pointer, rect: pointer, state: cint): void {.cdecl.} =
  let inst = cast[VirtualQItemDelegate](fcQItemDelegate_vdata(self)[])
  let slotval1 = gen_qpainter_types.QPainter(h: painter, owned: false)
  let slotval2 = gen_qstyleoption_types.QStyleOptionViewItem(h: option, owned: false)
  let slotval3 = gen_qrect_types.QRect(h: rect, owned: false)
...
proc fcQItemDelegate_method_callback_eventFilter(self: pointer, objectVal: pointer, event: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQItemDelegate](fcQItemDelegate_vdata(self)[])
  let slotval1 = gen_qobject_types.QObject(h: objectVal, owned: false)
  let slotval2 = gen_qcoreevent_types.QEvent(h: event, owned: false)
...
proc fcQItemDelegate_method_callback_editorEvent(self: pointer, event: pointer, model: pointer, option: pointer, index: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQItemDelegate](fcQItemDelegate_vdata(self)[])
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
  let slotval2 = gen_qabstractitemmodel_types.QAbstractItemModel(h: model, owned: false)
  let slotval3 = gen_qstyleoption_types.QStyleOptionViewItem(h: option, owned: false)
...
proc fcQItemDelegate_method_callback_destroyEditor(self: pointer, editor: pointer, index: pointer): void {.cdecl.} =
  let inst = cast[VirtualQItemDelegate](fcQItemDelegate_vdata(self)[])
  let slotval1 = gen_qwidget_types.QWidget(h: editor, owned: false)
  let slotval2 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
  inst.destroyEditor(slotval1, slotval2)

proc fcQItemDelegate_method_callback_helpEvent(self: pointer, event: pointer, view: pointer, option: pointer, index: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQItemDelegate](fcQItemDelegate_vdata(self)[])
  let slotval1 = gen_qevent_types.QHelpEvent(h: event, owned: false)
  let slotval2 = gen_qabstractitemview_types.QAbstractItemView(h: view, owned: false)
  let slotval3 = gen_qstyleoption_types.QStyleOptionViewItem(h: option, owned: false)
...
proc fcQItemDelegate_method_callback_paintingRoles(self: pointer): struct_seaqt_array {.cdecl.} =
  let inst = cast[VirtualQItemDelegate](fcQItemDelegate_vdata(self)[])
...
proc fcQItemDelegate_method_callback_event(self: pointer, event: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQItemDelegate](fcQItemDelegate_vdata(self)[])
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
  var virtualReturn = inst.event(slotval1)
  virtualReturn

proc fcQItemDelegate_method_callback_timerEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQItemDelegate](fcQItemDelegate_vdata(self)[])
  let slotval1 = gen_qcoreevent_types.QTimerEvent(h: event, owned: false)
  inst.timerEvent(slotval1)

proc fcQItemDelegate_method_callback_childEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQItemDelegate](fcQItemDelegate_vdata(self)[])
  let slotval1 = gen_qcoreevent_types.QChildEvent(h: event, owned: false)
  inst.childEvent(slotval1)

proc fcQItemDelegate_method_callback_customEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQItemDelegate](fcQItemDelegate_vdata(self)[])
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
  inst.customEvent(slotval1)

proc fcQItemDelegate_method_callback_connectNotify(self: pointer, signal: pointer): void {.cdecl.} =
  let inst = cast[VirtualQItemDelegate](fcQItemDelegate_vdata(self)[])
  let slotval1 = gen_qmetaobject_types.QMetaMethod(h: signal, owned: false)
  inst.connectNotify(slotval1)

proc fcQItemDelegate_method_callback_disconnectNotify(self: pointer, signal: pointer): void {.cdecl.} =
  let inst = cast[VirtualQItemDelegate](fcQItemDelegate_vdata(self)[])
  let slotval1 = gen_qmetaobject_types.QMetaMethod(h: signal, owned: false)
...
proc selected*(self: gen_qitemdelegate_types.QItemDelegate, pixmap: gen_qpixmap_types.QPixmap, palette: gen_qpalette_types.QPalette, enabled: bool): gen_qpixmap_types.QPixmap =
  gen_qpixmap_types.QPixmap(h: fcQItemDelegate_protectedbase_selected(self.h, pixmap.h, palette.h, enabled), owned: false)
...
proc textRectangle*(self: gen_qitemdelegate_types.QItemDelegate, painter: gen_qpainter_types.QPainter, rect: gen_qrect_types.QRect, font: gen_qfont_types.QFont, text: openArray[char]): gen_qrect_types.QRect =
  gen_qrect_types.QRect(h: fcQItemDelegate_protectedbase_textRectangle(self.h, painter.h, rect.h, font.h, struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text)))), owned: true)
...
proc create*(T: type gen_qitemdelegate_types.QItemDelegate,
  ...
  if not isNil(vtbl[].metaObject):
    vtbl[].vtbl.metaObject = fcQItemDelegate_vtable_callback_metaObject
  if not isNil(vtbl[].metacast):
    vtbl[].vtbl.metacast = fcQItemDelegate_vtable_callback_metacast
  if not isNil(vtbl[].metacall):
    vtbl[].vtbl.metacall = fcQItemDelegate_vtable_callback_metacall
  if not isNil(vtbl[].paint):
    vtbl[].vtbl.paint = fcQItemDelegate_vtable_callback_paint
  if not isNil(vtbl[].sizeHint):
    vtbl[].vtbl.sizeHint = fcQItemDelegate_vtable_callback_sizeHint
  if not isNil(vtbl[].createEditor):
    vtbl[].vtbl.createEditor = fcQItemDelegate_vtable_callback_createEditor
  if not isNil(vtbl[].setEditorData):
    vtbl[].vtbl.setEditorData = fcQItemDelegate_vtable_callback_setEditorData
  if not isNil(vtbl[].setModelData):
    vtbl[].vtbl.setModelData = fcQItemDelegate_vtable_callback_setModelData
  if not isNil(vtbl[].updateEditorGeometry):
    vtbl[].vtbl.updateEditorGeometry = fcQItemDelegate_vtable_callback_updateEditorGeometry
  if not isNil(vtbl[].drawDisplay):
    vtbl[].vtbl.drawDisplay = fcQItemDelegate_vtable_callback_drawDisplay
  if not isNil(vtbl[].drawDecoration):
    vtbl[].vtbl.drawDecoration = fcQItemDelegate_vtable_callback_drawDecoration
  if not isNil(vtbl[].drawFocus):
    vtbl[].vtbl.drawFocus = fcQItemDelegate_vtable_callback_drawFocus
  if not isNil(vtbl[].drawCheck):
    vtbl[].vtbl.drawCheck = fcQItemDelegate_vtable_callback_drawCheck
  if not isNil(vtbl[].eventFilter):
    vtbl[].vtbl.eventFilter = fcQItemDelegate_vtable_callback_eventFilter
  if not isNil(vtbl[].editorEvent):
    vtbl[].vtbl.editorEvent = fcQItemDelegate_vtable_callback_editorEvent
  if not isNil(vtbl[].destroyEditor):
    vtbl[].vtbl.destroyEditor = fcQItemDelegate_vtable_callback_destroyEditor
  if not isNil(vtbl[].helpEvent):
    vtbl[].vtbl.helpEvent = fcQItemDelegate_vtable_callback_helpEvent
  if not isNil(vtbl[].paintingRoles):
    vtbl[].vtbl.paintingRoles = fcQItemDelegate_vtable_callback_paintingRoles
  if not isNil(vtbl[].event):
    vtbl[].vtbl.event = fcQItemDelegate_vtable_callback_event
  if not isNil(vtbl[].timerEvent):
    vtbl[].vtbl.timerEvent = fcQItemDelegate_vtable_callback_timerEvent
  if not isNil(vtbl[].childEvent):
    vtbl[].vtbl.childEvent = fcQItemDelegate_vtable_callback_childEvent
  if not isNil(vtbl[].customEvent):
    vtbl[].vtbl.customEvent = fcQItemDelegate_vtable_callback_customEvent
  if not isNil(vtbl[].connectNotify):
    vtbl[].vtbl.connectNotify = fcQItemDelegate_vtable_callback_connectNotify
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQItemDelegate_vtable_callback_disconnectNotify
  let tmp = gen_qitemdelegate_types.QItemDelegate(h: fcQItemDelegate_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQItemDelegate_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qitemdelegate_types.QItemDelegate,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQItemDelegate_vtable_callback_disconnectNotify
  let tmp = gen_qitemdelegate_types.QItemDelegate(h: fcQItemDelegate_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQItemDelegate_vdata(tmp.h)[] = addr(vtbl[])
  tmp
const cQItemDelegate_mvtbl = cQItemDelegateVTable(
  destructor: proc(self: pointer) {.cdecl.} =
    let inst = cast[ptr typeof(VirtualQItemDelegate()[])](self.fcQItemDelegate_vdata()[])
    inst[].h = nil
    inst[].owned = false,

  metaObject: fcQItemDelegate_method_callback_metaObject,
  metacast: fcQItemDelegate_method_callback_metacast,
  metacall: fcQItemDelegate_method_callback_metacall,
  paint: fcQItemDelegate_method_callback_paint,
  sizeHint: fcQItemDelegate_method_callback_sizeHint,
  createEditor: fcQItemDelegate_method_callback_createEditor,
  setEditorData: fcQItemDelegate_method_callback_setEditorData,
  setModelData: fcQItemDelegate_method_callback_setModelData,
  updateEditorGeometry: fcQItemDelegate_method_callback_updateEditorGeometry,
  drawDisplay: fcQItemDelegate_method_callback_drawDisplay,
  drawDecoration: fcQItemDelegate_method_callback_drawDecoration,
  drawFocus: fcQItemDelegate_method_callback_drawFocus,
  drawCheck: fcQItemDelegate_method_callback_drawCheck,
  eventFilter: fcQItemDelegate_method_callback_eventFilter,
  editorEvent: fcQItemDelegate_method_callback_editorEvent,
  destroyEditor: fcQItemDelegate_method_callback_destroyEditor,
  helpEvent: fcQItemDelegate_method_callback_helpEvent,
  paintingRoles: fcQItemDelegate_method_callback_paintingRoles,
  event: fcQItemDelegate_method_callback_event,
  timerEvent: fcQItemDelegate_method_callback_timerEvent,
  childEvent: fcQItemDelegate_method_callback_childEvent,
  customEvent: fcQItemDelegate_method_callback_customEvent,
  connectNotify: fcQItemDelegate_method_callback_connectNotify,
  disconnectNotify: fcQItemDelegate_method_callback_disconnectNotify,
)
proc create*(T: type gen_qitemdelegate_types.QItemDelegate,
    inst: VirtualQItemDelegate) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQItemDelegate_new(addr(cQItemDelegate_mvtbl), csize_t(sizeof(pointer)))
  fcQItemDelegate_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qitemdelegate_types.QItemDelegate,
    ...
    inst: VirtualQItemDelegate) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQItemDelegate_new2(addr(cQItemDelegate_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQItemDelegate_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
