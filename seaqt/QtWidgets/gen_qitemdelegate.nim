...
proc fcQItemDelegate_trUtf8(s: cstring): struct_seaqt_string {.importc: "QItemDelegate_trUtf8".}
...
proc fcQItemDelegate_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QItemDelegate_trUtf82".}
proc fcQItemDelegate_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QItemDelegate_trUtf83".}
