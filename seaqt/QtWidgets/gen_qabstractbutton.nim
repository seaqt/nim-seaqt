...
proc fcQAbstractButton_trUtf8S(s: cstring): struct_seaqt_string {.importc: "QAbstractButton_trUtf8_s".}
...
proc fcQAbstractButton_trUtf8SC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QAbstractButton_trUtf8_s_c".}
proc fcQAbstractButton_trUtf8SCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QAbstractButton_trUtf8_s_c_n".}
proc fcQAbstractButton_animateClickMsec(self: pointer, msec: cint): void {.importc: "QAbstractButton_animateClick_msec".}
...
proc fcQAbstractButton_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.importc: "QAbstractButton_virtualbase_nativeEvent".}
...
proc trUtf8*(_: type gen_qabstractbutton_types.QAbstractButton, s: cstring): string =
  let v_ms = fcQAbstractButton_trUtf8S(s)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret

proc setText*(self: gen_qabstractbutton_types.QAbstractButton, text: openArray[char]): void =
  fcQAbstractButton_setText(self.h, struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))))
...
proc QAbstractButtonnativeEvent*(self: gen_qabstractbutton_types.QAbstractButton, eventType: openArray[byte], message: pointer, resultVal: ptr clong): bool =
  fcQAbstractButton_virtualbase_nativeEvent(self.h, struct_seaqt_string(data: if len(eventType) > 0: addr eventType[0] else: nil, len: csize_t(len(eventType))), message, resultVal)
...
proc fcQAbstractButton_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let vtbl = cast[ptr QAbstractButtonVTable](fcQAbstractButton_vdata(self)[])
  let self = QAbstractButton(h: self)
...
proc fcQAbstractButton_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let inst = cast[VirtualQAbstractButton](fcQAbstractButton_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc create*(T: type gen_qabstractbutton_types.QAbstractButton,
  ...
  let tmp = gen_qabstractbutton_types.QAbstractButton(h: fcQAbstractButton_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
...
proc create*(T: type gen_qabstractbutton_types.QAbstractButton,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQAbstractButton_vtable_callback_disconnectNotify
  let tmp = gen_qabstractbutton_types.QAbstractButton(h: fcQAbstractButton_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQAbstractButton_vdata(tmp.h)[] = addr(vtbl[])
  tmp
...
proc create*(T: type gen_qabstractbutton_types.QAbstractButton,
  ...
  inst[].h = fcQAbstractButton_new(addr(cQAbstractButton_mvtbl), csize_t(sizeof(pointer)))
...
proc create*(T: type gen_qabstractbutton_types.QAbstractButton,
    ...
    inst: VirtualQAbstractButton) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQAbstractButton_new2(addr(cQAbstractButton_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQAbstractButton_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
