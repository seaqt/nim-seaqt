...
proc fcQAbstractButton_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.importc: "QAbstractButton_virtualbase_nativeEvent".}
...
proc fcQAbstractButton_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QAbstractButton_protectedbase_getDecodedMetricF".}
...
proc fcQAbstractButton_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QAbstractButtonVTable](fcQAbstractButton_vdata(self)[])
  let self = QAbstractButton(h: self)
...
proc fcQAbstractButton_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let inst = cast[VirtualQAbstractButton](fcQAbstractButton_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc getDecodedMetricF*(self: gen_qabstractbutton_types.QAbstractButton, metricA: cint, metricB: cint): float64 =
  fcQAbstractButton_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
