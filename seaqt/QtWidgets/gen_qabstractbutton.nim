...
proc fcQAbstractButton_trUtf8(s: cstring): struct_seaqt_string {.importc: "QAbstractButton_trUtf8".}
...
proc fcQAbstractButton_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QAbstractButton_trUtf82".}
proc fcQAbstractButton_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QAbstractButton_trUtf83".}
proc fcQAbstractButton_animateClickWithMsec(self: pointer, msec: cint): void {.importc: "QAbstractButton_animateClickWithMsec".}
...
proc animateClick*(self: gen_qabstractbutton_types.QAbstractButton, msec: cint): void =
  fcQAbstractButton_animateClickWithMsec(self.h, msec)
