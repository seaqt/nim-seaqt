...
proc fcQAbstractButton_new(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQAbstractButton {.importc: "QAbstractButton_new_parent".}
proc fcQAbstractButton_new2(vtbl: pointer, vdata: csize_t): ptr cQAbstractButton {.importc: "QAbstractButton_new".}
