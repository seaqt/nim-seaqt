...
proc create*(T: type gen_qabstractbutton_types.QAbstractButton,
  ...
  let tmp = gen_qabstractbutton_types.QAbstractButton(h: fcQAbstractButton_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))))
...
proc create*(T: type gen_qabstractbutton_types.QAbstractButton,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQAbstractButton_vtable_callback_disconnectNotify
  let tmp = gen_qabstractbutton_types.QAbstractButton(h: fcQAbstractButton_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h))
  fcQAbstractButton_vdata(tmp.h)[] = addr(vtbl[])
  tmp
