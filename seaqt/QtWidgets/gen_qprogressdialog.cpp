...
public:
	...
	friend bool QProgressDialog_virtualbase_nativeEvent(VirtualQProgressDialog* self, struct miqt_string eventType, void* message, long* result);
...
bool QProgressDialog_virtualbase_nativeEvent(VirtualQProgressDialog* self, struct miqt_string eventType, void* message, long* result) {
