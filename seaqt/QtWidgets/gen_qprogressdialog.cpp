...
VirtualQProgressDialog* QProgressDialog_new(const QProgressDialog_VTable* vtbl, size_t vdata, QWidget* parent) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQProgressDialog>());
...
VirtualQProgressDialog* QProgressDialog_new3(const QProgressDialog_VTable* vtbl, size_t vdata, struct miqt_string labelText, struct miqt_string cancelButtonText, int minimum, int maximum) {
...
VirtualQProgressDialog* QProgressDialog_new5(const QProgressDialog_VTable* vtbl, size_t vdata, struct miqt_string labelText, struct miqt_string cancelButtonText, int minimum, int maximum, QWidget* parent) {
	QString labelText_QString = QString::fromUtf8(labelText.data, labelText.len);
	QString cancelButtonText_QString = QString::fromUtf8(cancelButtonText.data, cancelButtonText.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQProgressDialog>());
...
VirtualQProgressDialog* QProgressDialog_new6(const QProgressDialog_VTable* vtbl, size_t vdata, struct miqt_string labelText, struct miqt_string cancelButtonText, int minimum, int maximum, QWidget* parent, int flags) {
	QString labelText_QString = QString::fromUtf8(labelText.data, labelText.len);
	QString cancelButtonText_QString = QString::fromUtf8(cancelButtonText.data, cancelButtonText.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQProgressDialog>());
