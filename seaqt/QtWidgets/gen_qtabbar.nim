...
proc fcQTabBar_tabText(self: pointer, index: cint): struct_seaqt_string {.importc: "QTabBar_tabText".}
proc fcQTabBar_setTabText(self: pointer, index: cint, text: struct_seaqt_string): void {.importc: "QTabBar_setTabText".}
...
proc fcQTabBar_setTabToolTip(self: pointer, index: cint, tip: struct_seaqt_string): void {.importc: "QTabBar_setTabToolTip".}
proc fcQTabBar_tabToolTip(self: pointer, index: cint): struct_seaqt_string {.importc: "QTabBar_tabToolTip".}
proc fcQTabBar_setTabWhatsThis(self: pointer, index: cint, text: struct_seaqt_string): void {.importc: "QTabBar_setTabWhatsThis".}
proc fcQTabBar_tabWhatsThis(self: pointer, index: cint): struct_seaqt_string {.importc: "QTabBar_tabWhatsThis".}
...
proc fcQTabBar_accessibleTabName(self: pointer, index: cint): struct_seaqt_string {.importc: "QTabBar_accessibleTabName".}
proc fcQTabBar_setAccessibleTabName(self: pointer, index: cint, name: struct_seaqt_string): void {.importc: "QTabBar_setAccessibleTabName".}
...
proc fcQTabBar_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.importc: "QTabBar_virtualbase_nativeEvent".}
...
proc fcQTabBar_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QTabBar_protectedbase_getDecodedMetricF".}
proc fcQTabBar_new(vtbl: pointer, vdata: csize_t): ptr cQTabBar {.importc: "QTabBar_new".}
proc fcQTabBar_new2(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQTabBar {.importc: "QTabBar_new_parent".}
...
proc setTabText*(self: gen_qtabbar_types.QTabBar, index: cint, text: openArray[char]): void =
  fcQTabBar_setTabText(self.h, index, struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))))
...
proc setTabToolTip*(self: gen_qtabbar_types.QTabBar, index: cint, tip: openArray[char]): void =
  fcQTabBar_setTabToolTip(self.h, index, struct_seaqt_string(data: if len(tip) > 0: addr tip[0] else: nil, len: csize_t(len(tip))))
...
proc setTabWhatsThis*(self: gen_qtabbar_types.QTabBar, index: cint, text: openArray[char]): void =
  fcQTabBar_setTabWhatsThis(self.h, index, struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))))
...
proc setAccessibleTabName*(self: gen_qtabbar_types.QTabBar, index: cint, name: openArray[char]): void =
  fcQTabBar_setAccessibleTabName(self.h, index, struct_seaqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name))))
...
proc QTabBarnativeEvent*(self: gen_qtabbar_types.QTabBar, eventType: openArray[byte], message: pointer, resultVal: ptr uint): bool =
  fcQTabBar_virtualbase_nativeEvent(self.h, struct_seaqt_string(data: if len(eventType) > 0: addr eventType[0] else: nil, len: csize_t(len(eventType))), message, resultVal)
...
proc fcQTabBar_vtable_callback_mouseDoubleClickEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self)[])
  let self = QTabBar(h: self)
  let slotval1 = gen_qevent_types.QMouseEvent(h: param1, owned: false)
...
proc fcQTabBar_vtable_callback_initStyleOption(self: pointer, option: pointer, tabIndex: cint): void {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self)[])
  let self = QTabBar(h: self)
...
proc fcQTabBar_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self)[])
  let self = QTabBar(h: self)
...
proc fcQTabBar_method_callback_mouseDoubleClickEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self)[])
  let slotval1 = gen_qevent_types.QMouseEvent(h: param1, owned: false)
...
proc fcQTabBar_method_callback_initStyleOption(self: pointer, option: pointer, tabIndex: cint): void {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self)[])
  let slotval1 = gen_qstyleoption_types.QStyleOptionTab(h: option, owned: false)
  let slotval2 = tabIndex
...
proc fcQTabBar_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc getDecodedMetricF*(self: gen_qtabbar_types.QTabBar, metricA: cint, metricB: cint): float64 =
  fcQTabBar_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
...
proc create*(T: type gen_qtabbar_types.QTabBar,
  ...
  if not isNil(vtbl[].initStyleOption):
    vtbl[].vtbl.initStyleOption = fcQTabBar_vtable_callback_initStyleOption
  ...
  let tmp = gen_qtabbar_types.QTabBar(h: fcQTabBar_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQTabBar_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qtabbar_types.QTabBar,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQTabBar_vtable_callback_disconnectNotify
  let tmp = gen_qtabbar_types.QTabBar(h: fcQTabBar_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQTabBar_vdata(tmp.h)[] = addr(vtbl[])
  tmp
const cQTabBar_mvtbl = cQTabBarVTable(
  ...
  initStyleOption: fcQTabBar_method_callback_initStyleOption,
...
proc create*(T: type gen_qtabbar_types.QTabBar,
  ...
  inst[].h = fcQTabBar_new(addr(cQTabBar_mvtbl), csize_t(sizeof(pointer)))
...
proc create*(T: type gen_qtabbar_types.QTabBar,
    ...
    inst: VirtualQTabBar) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQTabBar_new2(addr(cQTabBar_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQTabBar_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
