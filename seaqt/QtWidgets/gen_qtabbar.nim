...
type cQTabBarVTable {.pure.} = object
  ...
  initStyleOption*: proc(self: pointer, option: pointer, tabIndex: cint): void {.cdecl, raises: [], gcsafe.}
...
proc cQTabBar_slot_callback_currentChanged(slot: int, index: cint) {.cdecl.} =
  let nimfunc = cast[ptr QTabBarcurrentChangedSlot](cast[pointer](slot))
  let slotval1 = index

  nimfunc[](slotval1)

proc cQTabBar_slot_callback_currentChanged_release(slot: int) {.cdecl.} =
...
proc oncurrentChanged*(self: gen_qtabbar_types.QTabBar, slot: QTabBarcurrentChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQTabBar_connect_currentChanged(self.h, cast[int](addr tmp[]), cQTabBar_slot_callback_currentChanged, cQTabBar_slot_callback_currentChanged_release)
...
proc cQTabBar_slot_callback_tabCloseRequested(slot: int, index: cint) {.cdecl.} =
  let nimfunc = cast[ptr QTabBartabCloseRequestedSlot](cast[pointer](slot))
  let slotval1 = index

  nimfunc[](slotval1)

proc cQTabBar_slot_callback_tabCloseRequested_release(slot: int) {.cdecl.} =
...
proc ontabCloseRequested*(self: gen_qtabbar_types.QTabBar, slot: QTabBartabCloseRequestedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQTabBar_connect_tabCloseRequested(self.h, cast[int](addr tmp[]), cQTabBar_slot_callback_tabCloseRequested, cQTabBar_slot_callback_tabCloseRequested_release)
...
proc cQTabBar_slot_callback_tabMoved(slot: int, fromVal: cint, to: cint) {.cdecl.} =
...
proc cQTabBar_slot_callback_tabMoved_release(slot: int) {.cdecl.} =
...
proc ontabMoved*(self: gen_qtabbar_types.QTabBar, slot: QTabBartabMovedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQTabBar_connect_tabMoved(self.h, cast[int](addr tmp[]), cQTabBar_slot_callback_tabMoved, cQTabBar_slot_callback_tabMoved_release)
...
proc cQTabBar_slot_callback_tabBarClicked(slot: int, index: cint) {.cdecl.} =
  let nimfunc = cast[ptr QTabBartabBarClickedSlot](cast[pointer](slot))
  let slotval1 = index

  nimfunc[](slotval1)

proc cQTabBar_slot_callback_tabBarClicked_release(slot: int) {.cdecl.} =
...
proc ontabBarClicked*(self: gen_qtabbar_types.QTabBar, slot: QTabBartabBarClickedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQTabBar_connect_tabBarClicked(self.h, cast[int](addr tmp[]), cQTabBar_slot_callback_tabBarClicked, cQTabBar_slot_callback_tabBarClicked_release)
...
proc cQTabBar_slot_callback_tabBarDoubleClicked(slot: int, index: cint) {.cdecl.} =
  let nimfunc = cast[ptr QTabBartabBarDoubleClickedSlot](cast[pointer](slot))
  let slotval1 = index

  nimfunc[](slotval1)

proc cQTabBar_slot_callback_tabBarDoubleClicked_release(slot: int) {.cdecl.} =
...
proc ontabBarDoubleClicked*(self: gen_qtabbar_types.QTabBar, slot: QTabBartabBarDoubleClickedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQTabBar_connect_tabBarDoubleClicked(self.h, cast[int](addr tmp[]), cQTabBar_slot_callback_tabBarDoubleClicked, cQTabBar_slot_callback_tabBarDoubleClicked_release)
...
proc cQTabBar_vtable_callback_metaObject(self: pointer): pointer {.cdecl.} =
...
proc cQTabBar_vtable_callback_metacast(self: pointer, param1: cstring): pointer {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
  let slotval1 = (param1)
...
proc cQTabBar_vtable_callback_metacall(self: pointer, param1: cint, param2: cint, param3: pointer): cint {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
...
proc cQTabBar_vtable_callback_sizeHint(self: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
...
proc cQTabBar_vtable_callback_minimumSizeHint(self: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
...
proc cQTabBar_vtable_callback_tabSizeHint(self: pointer, index: cint): pointer {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
  let slotval1 = index
...
proc cQTabBar_vtable_callback_minimumTabSizeHint(self: pointer, index: cint): pointer {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
  let slotval1 = index
...
proc cQTabBar_vtable_callback_tabInserted(self: pointer, index: cint): void {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
  let slotval1 = index
...
proc cQTabBar_vtable_callback_tabRemoved(self: pointer, index: cint): void {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
  let slotval1 = index
...
proc cQTabBar_vtable_callback_tabLayoutChange(self: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
...
proc cQTabBar_vtable_callback_event(self: pointer, param1: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
...
proc cQTabBar_vtable_callback_resizeEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
...
proc cQTabBar_vtable_callback_showEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
...
proc cQTabBar_vtable_callback_hideEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
...
proc cQTabBar_vtable_callback_paintEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
...
proc cQTabBar_vtable_callback_mousePressEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
...
proc cQTabBar_vtable_callback_mouseMoveEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
  let slotval1 = gen_qevent_types.QMouseEvent(h: param1, owned: false)
...
proc cQTabBar_vtable_callback_mouseReleaseEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
  let slotval1 = gen_qevent_types.QMouseEvent(h: param1, owned: false)
...
proc cQTabBar_vtable_callback_mouseDoubleClickEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
  let slotval1 = gen_qevent_types.QMouseEvent(h: param1, owned: false)
...
proc cQTabBar_vtable_callback_wheelEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
...
proc cQTabBar_vtable_callback_keyPressEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
...
proc cQTabBar_vtable_callback_changeEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
  let slotval1 = gen_qcoreevent_types.QEvent(h: param1, owned: false)
...
proc cQTabBar_vtable_callback_timerEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
...
proc cQTabBar_vtable_callback_initStyleOption(self: pointer, option: pointer, tabIndex: cint): void {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
  let slotval1 = gen_qstyleoption_types.QStyleOptionTab(h: option, owned: false)
...
proc cQTabBar_vtable_callback_devType(self: pointer): cint {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
...
proc cQTabBar_vtable_callback_setVisible(self: pointer, visible: bool): void {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
...
proc cQTabBar_vtable_callback_heightForWidth(self: pointer, param1: cint): cint {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
  let slotval1 = param1
...
proc cQTabBar_vtable_callback_hasHeightForWidth(self: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
...
proc cQTabBar_vtable_callback_paintEngine(self: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
...
proc cQTabBar_vtable_callback_keyReleaseEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
...
proc cQTabBar_vtable_callback_focusInEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
...
proc cQTabBar_vtable_callback_focusOutEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
  let slotval1 = gen_qevent_types.QFocusEvent(h: event, owned: false)
...
proc cQTabBar_vtable_callback_enterEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
...
proc cQTabBar_vtable_callback_leaveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
...
proc cQTabBar_vtable_callback_moveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
...
proc cQTabBar_vtable_callback_closeEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
...
proc cQTabBar_vtable_callback_contextMenuEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
...
proc cQTabBar_vtable_callback_tabletEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
...
proc cQTabBar_vtable_callback_actionEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
...
proc cQTabBar_vtable_callback_dragEnterEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
...
proc cQTabBar_vtable_callback_dragMoveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
...
proc cQTabBar_vtable_callback_dragLeaveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
...
proc cQTabBar_vtable_callback_dropEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
...
proc cQTabBar_vtable_callback_nativeEvent(self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
...
proc cQTabBar_vtable_callback_metric(self: pointer, param1: cint): cint {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
  let slotval1 = cint(param1)
...
proc cQTabBar_vtable_callback_initPainter(self: pointer, painter: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
...
proc cQTabBar_vtable_callback_redirected(self: pointer, offset: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
...
proc cQTabBar_vtable_callback_sharedPainter(self: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
...
proc cQTabBar_vtable_callback_inputMethodEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
...
proc cQTabBar_vtable_callback_inputMethodQuery(self: pointer, param1: cint): pointer {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
  let slotval1 = cint(param1)
...
proc cQTabBar_vtable_callback_focusNextPrevChild(self: pointer, next: bool): bool {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
  let slotval1 = next
...
proc cQTabBar_vtable_callback_eventFilter(self: pointer, watched: pointer, event: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
...
proc cQTabBar_vtable_callback_childEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
...
proc cQTabBar_vtable_callback_customEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
...
proc cQTabBar_vtable_callback_connectNotify(self: pointer, signal: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
...
proc cQTabBar_vtable_callback_disconnectNotify(self: pointer, signal: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTabBarVTable](fcQTabBar_vdata(self))
  let self = QTabBar(h: self)
  let slotval1 = gen_qmetaobject_types.QMetaMethod(h: signal, owned: false)
...
proc cQTabBar_method_callback_metaObject(self: pointer): pointer {.cdecl.} =
...
proc cQTabBar_method_callback_metacast(self: pointer, param1: cstring): pointer {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
  let slotval1 = (param1)
...
proc cQTabBar_method_callback_metacall(self: pointer, param1: cint, param2: cint, param3: pointer): cint {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
  let slotval1 = cint(param1)
  let slotval2 = param2
  let slotval3 = param3
...
proc cQTabBar_method_callback_sizeHint(self: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
...
proc cQTabBar_method_callback_minimumSizeHint(self: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
...
proc cQTabBar_method_callback_tabSizeHint(self: pointer, index: cint): pointer {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
  let slotval1 = index
...
proc cQTabBar_method_callback_minimumTabSizeHint(self: pointer, index: cint): pointer {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
  let slotval1 = index
...
proc cQTabBar_method_callback_tabInserted(self: pointer, index: cint): void {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
  let slotval1 = index
...
proc cQTabBar_method_callback_tabRemoved(self: pointer, index: cint): void {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
  let slotval1 = index
...
proc cQTabBar_method_callback_tabLayoutChange(self: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
...
proc cQTabBar_method_callback_event(self: pointer, param1: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
  let slotval1 = gen_qcoreevent_types.QEvent(h: param1, owned: false)
...
proc cQTabBar_method_callback_resizeEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
  let slotval1 = gen_qevent_types.QResizeEvent(h: param1, owned: false)
...
proc cQTabBar_method_callback_showEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
  let slotval1 = gen_qevent_types.QShowEvent(h: param1, owned: false)
...
proc cQTabBar_method_callback_hideEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
  let slotval1 = gen_qevent_types.QHideEvent(h: param1, owned: false)
...
proc cQTabBar_method_callback_paintEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
  let slotval1 = gen_qevent_types.QPaintEvent(h: param1, owned: false)
...
proc cQTabBar_method_callback_mousePressEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
  let slotval1 = gen_qevent_types.QMouseEvent(h: param1, owned: false)
...
proc cQTabBar_method_callback_mouseMoveEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
  let slotval1 = gen_qevent_types.QMouseEvent(h: param1, owned: false)
...
proc cQTabBar_method_callback_mouseReleaseEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
  let slotval1 = gen_qevent_types.QMouseEvent(h: param1, owned: false)
  inst.mouseReleaseEvent(slotval1)

method mouseDoubleClickEvent*(self: VirtualQTabBar, param1: gen_qevent_types.QMouseEvent): void {.base.} =
  QTabBarmouseDoubleClickEvent(self[], param1)
proc cQTabBar_method_callback_mouseDoubleClickEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
  let slotval1 = gen_qevent_types.QMouseEvent(h: param1, owned: false)
...
proc cQTabBar_method_callback_wheelEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
  let slotval1 = gen_qevent_types.QWheelEvent(h: event, owned: false)
...
proc cQTabBar_method_callback_keyPressEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
  let slotval1 = gen_qevent_types.QKeyEvent(h: param1, owned: false)
...
proc cQTabBar_method_callback_changeEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
  let slotval1 = gen_qcoreevent_types.QEvent(h: param1, owned: false)
...
proc cQTabBar_method_callback_timerEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
  let slotval1 = gen_qcoreevent_types.QTimerEvent(h: event, owned: false)
  inst.timerEvent(slotval1)

method initStyleOption*(self: VirtualQTabBar, option: gen_qstyleoption_types.QStyleOptionTab, tabIndex: cint): void {.base.} =
  QTabBarinitStyleOption(self[], option, tabIndex)
proc cQTabBar_method_callback_initStyleOption(self: pointer, option: pointer, tabIndex: cint): void {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
  let slotval1 = gen_qstyleoption_types.QStyleOptionTab(h: option, owned: false)
  let slotval2 = tabIndex
...
method devType*(self: VirtualQTabBar): cint {.base.} =
  QTabBardevType(self[])
proc cQTabBar_method_callback_devType(self: pointer): cint {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
...
proc cQTabBar_method_callback_setVisible(self: pointer, visible: bool): void {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
  let slotval1 = visible
...
proc cQTabBar_method_callback_heightForWidth(self: pointer, param1: cint): cint {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
  let slotval1 = param1
...
proc cQTabBar_method_callback_hasHeightForWidth(self: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
...
proc cQTabBar_method_callback_paintEngine(self: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
...
proc cQTabBar_method_callback_keyReleaseEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
  let slotval1 = gen_qevent_types.QKeyEvent(h: event, owned: false)
...
proc cQTabBar_method_callback_focusInEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
  let slotval1 = gen_qevent_types.QFocusEvent(h: event, owned: false)
...
proc cQTabBar_method_callback_focusOutEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
  let slotval1 = gen_qevent_types.QFocusEvent(h: event, owned: false)
  inst.focusOutEvent(slotval1)

method enterEvent*(self: VirtualQTabBar, event: gen_qevent_types.QEnterEvent): void {.base.} =
  QTabBarenterEvent(self[], event)
proc cQTabBar_method_callback_enterEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
  let slotval1 = gen_qevent_types.QEnterEvent(h: event, owned: false)
...
proc cQTabBar_method_callback_leaveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
...
proc cQTabBar_method_callback_moveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
  let slotval1 = gen_qevent_types.QMoveEvent(h: event, owned: false)
...
proc cQTabBar_method_callback_closeEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
  let slotval1 = gen_qevent_types.QCloseEvent(h: event, owned: false)
...
proc cQTabBar_method_callback_contextMenuEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
  let slotval1 = gen_qevent_types.QContextMenuEvent(h: event, owned: false)
...
proc cQTabBar_method_callback_tabletEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
  let slotval1 = gen_qevent_types.QTabletEvent(h: event, owned: false)
...
proc cQTabBar_method_callback_actionEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
  let slotval1 = gen_qevent_types.QActionEvent(h: event, owned: false)
...
proc cQTabBar_method_callback_dragEnterEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
  let slotval1 = gen_qevent_types.QDragEnterEvent(h: event, owned: false)
...
proc cQTabBar_method_callback_dragMoveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
  let slotval1 = gen_qevent_types.QDragMoveEvent(h: event, owned: false)
...
proc cQTabBar_method_callback_dragLeaveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
  let slotval1 = gen_qevent_types.QDragLeaveEvent(h: event, owned: false)
...
proc cQTabBar_method_callback_dropEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
  let slotval1 = gen_qevent_types.QDropEvent(h: event, owned: false)
...
proc cQTabBar_method_callback_nativeEvent(self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc cQTabBar_method_callback_metric(self: pointer, param1: cint): cint {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
  let slotval1 = cint(param1)
...
proc cQTabBar_method_callback_initPainter(self: pointer, painter: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
  let slotval1 = gen_qpainter_types.QPainter(h: painter, owned: false)
...
proc cQTabBar_method_callback_redirected(self: pointer, offset: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
  let slotval1 = gen_qpoint_types.QPoint(h: offset, owned: false)
...
proc cQTabBar_method_callback_sharedPainter(self: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
...
proc cQTabBar_method_callback_inputMethodEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
  let slotval1 = gen_qevent_types.QInputMethodEvent(h: param1, owned: false)
...
proc cQTabBar_method_callback_inputMethodQuery(self: pointer, param1: cint): pointer {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
  let slotval1 = cint(param1)
...
proc cQTabBar_method_callback_focusNextPrevChild(self: pointer, next: bool): bool {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
  let slotval1 = next
...
proc cQTabBar_method_callback_eventFilter(self: pointer, watched: pointer, event: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
  let slotval1 = gen_qobject_types.QObject(h: watched, owned: false)
  let slotval2 = gen_qcoreevent_types.QEvent(h: event, owned: false)
...
proc cQTabBar_method_callback_childEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
  let slotval1 = gen_qcoreevent_types.QChildEvent(h: event, owned: false)
...
proc cQTabBar_method_callback_customEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
...
proc cQTabBar_method_callback_connectNotify(self: pointer, signal: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
  let slotval1 = gen_qmetaobject_types.QMetaMethod(h: signal, owned: false)
...
proc cQTabBar_method_callback_disconnectNotify(self: pointer, signal: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTabBar](fcQTabBar_vdata(self))
  let slotval1 = gen_qmetaobject_types.QMetaMethod(h: signal, owned: false)
...
proc create*(T: type gen_qtabbar_types.QTabBar,
  ...
  if not isNil(vtbl[].metaObject):
    vtbl[].vtbl.metaObject = cQTabBar_vtable_callback_metaObject
  if not isNil(vtbl[].metacast):
    vtbl[].vtbl.metacast = cQTabBar_vtable_callback_metacast
  if not isNil(vtbl[].metacall):
    vtbl[].vtbl.metacall = cQTabBar_vtable_callback_metacall
  if not isNil(vtbl[].sizeHint):
    vtbl[].vtbl.sizeHint = cQTabBar_vtable_callback_sizeHint
  if not isNil(vtbl[].minimumSizeHint):
    vtbl[].vtbl.minimumSizeHint = cQTabBar_vtable_callback_minimumSizeHint
  if not isNil(vtbl[].tabSizeHint):
    vtbl[].vtbl.tabSizeHint = cQTabBar_vtable_callback_tabSizeHint
  if not isNil(vtbl[].minimumTabSizeHint):
    vtbl[].vtbl.minimumTabSizeHint = cQTabBar_vtable_callback_minimumTabSizeHint
  if not isNil(vtbl[].tabInserted):
    vtbl[].vtbl.tabInserted = cQTabBar_vtable_callback_tabInserted
  if not isNil(vtbl[].tabRemoved):
    vtbl[].vtbl.tabRemoved = cQTabBar_vtable_callback_tabRemoved
  if not isNil(vtbl[].tabLayoutChange):
    vtbl[].vtbl.tabLayoutChange = cQTabBar_vtable_callback_tabLayoutChange
  if not isNil(vtbl[].event):
    vtbl[].vtbl.event = cQTabBar_vtable_callback_event
  if not isNil(vtbl[].resizeEvent):
    vtbl[].vtbl.resizeEvent = cQTabBar_vtable_callback_resizeEvent
  if not isNil(vtbl[].showEvent):
    vtbl[].vtbl.showEvent = cQTabBar_vtable_callback_showEvent
  if not isNil(vtbl[].hideEvent):
    vtbl[].vtbl.hideEvent = cQTabBar_vtable_callback_hideEvent
  if not isNil(vtbl[].paintEvent):
    vtbl[].vtbl.paintEvent = cQTabBar_vtable_callback_paintEvent
  if not isNil(vtbl[].mousePressEvent):
    vtbl[].vtbl.mousePressEvent = cQTabBar_vtable_callback_mousePressEvent
  if not isNil(vtbl[].mouseMoveEvent):
    vtbl[].vtbl.mouseMoveEvent = cQTabBar_vtable_callback_mouseMoveEvent
  if not isNil(vtbl[].mouseReleaseEvent):
    vtbl[].vtbl.mouseReleaseEvent = cQTabBar_vtable_callback_mouseReleaseEvent
  if not isNil(vtbl[].mouseDoubleClickEvent):
    vtbl[].vtbl.mouseDoubleClickEvent = cQTabBar_vtable_callback_mouseDoubleClickEvent
  if not isNil(vtbl[].wheelEvent):
    vtbl[].vtbl.wheelEvent = cQTabBar_vtable_callback_wheelEvent
  if not isNil(vtbl[].keyPressEvent):
    vtbl[].vtbl.keyPressEvent = cQTabBar_vtable_callback_keyPressEvent
  if not isNil(vtbl[].changeEvent):
    vtbl[].vtbl.changeEvent = cQTabBar_vtable_callback_changeEvent
  if not isNil(vtbl[].timerEvent):
    vtbl[].vtbl.timerEvent = cQTabBar_vtable_callback_timerEvent
  if not isNil(vtbl[].initStyleOption):
    vtbl[].vtbl.initStyleOption = cQTabBar_vtable_callback_initStyleOption
  if not isNil(vtbl[].devType):
    vtbl[].vtbl.devType = cQTabBar_vtable_callback_devType
  if not isNil(vtbl[].setVisible):
    vtbl[].vtbl.setVisible = cQTabBar_vtable_callback_setVisible
  if not isNil(vtbl[].heightForWidth):
    vtbl[].vtbl.heightForWidth = cQTabBar_vtable_callback_heightForWidth
  if not isNil(vtbl[].hasHeightForWidth):
    vtbl[].vtbl.hasHeightForWidth = cQTabBar_vtable_callback_hasHeightForWidth
  if not isNil(vtbl[].paintEngine):
    vtbl[].vtbl.paintEngine = cQTabBar_vtable_callback_paintEngine
  if not isNil(vtbl[].keyReleaseEvent):
    vtbl[].vtbl.keyReleaseEvent = cQTabBar_vtable_callback_keyReleaseEvent
  if not isNil(vtbl[].focusInEvent):
    vtbl[].vtbl.focusInEvent = cQTabBar_vtable_callback_focusInEvent
  if not isNil(vtbl[].focusOutEvent):
    vtbl[].vtbl.focusOutEvent = cQTabBar_vtable_callback_focusOutEvent
  if not isNil(vtbl[].enterEvent):
    vtbl[].vtbl.enterEvent = cQTabBar_vtable_callback_enterEvent
  if not isNil(vtbl[].leaveEvent):
    vtbl[].vtbl.leaveEvent = cQTabBar_vtable_callback_leaveEvent
  if not isNil(vtbl[].moveEvent):
    vtbl[].vtbl.moveEvent = cQTabBar_vtable_callback_moveEvent
  if not isNil(vtbl[].closeEvent):
    vtbl[].vtbl.closeEvent = cQTabBar_vtable_callback_closeEvent
  if not isNil(vtbl[].contextMenuEvent):
    vtbl[].vtbl.contextMenuEvent = cQTabBar_vtable_callback_contextMenuEvent
  if not isNil(vtbl[].tabletEvent):
    vtbl[].vtbl.tabletEvent = cQTabBar_vtable_callback_tabletEvent
  if not isNil(vtbl[].actionEvent):
    vtbl[].vtbl.actionEvent = cQTabBar_vtable_callback_actionEvent
  if not isNil(vtbl[].dragEnterEvent):
    vtbl[].vtbl.dragEnterEvent = cQTabBar_vtable_callback_dragEnterEvent
  if not isNil(vtbl[].dragMoveEvent):
    vtbl[].vtbl.dragMoveEvent = cQTabBar_vtable_callback_dragMoveEvent
  if not isNil(vtbl[].dragLeaveEvent):
    vtbl[].vtbl.dragLeaveEvent = cQTabBar_vtable_callback_dragLeaveEvent
  if not isNil(vtbl[].dropEvent):
    vtbl[].vtbl.dropEvent = cQTabBar_vtable_callback_dropEvent
  if not isNil(vtbl[].nativeEvent):
    vtbl[].vtbl.nativeEvent = cQTabBar_vtable_callback_nativeEvent
  if not isNil(vtbl[].metric):
    vtbl[].vtbl.metric = cQTabBar_vtable_callback_metric
  if not isNil(vtbl[].initPainter):
    vtbl[].vtbl.initPainter = cQTabBar_vtable_callback_initPainter
  if not isNil(vtbl[].redirected):
    vtbl[].vtbl.redirected = cQTabBar_vtable_callback_redirected
  if not isNil(vtbl[].sharedPainter):
    vtbl[].vtbl.sharedPainter = cQTabBar_vtable_callback_sharedPainter
  if not isNil(vtbl[].inputMethodEvent):
    vtbl[].vtbl.inputMethodEvent = cQTabBar_vtable_callback_inputMethodEvent
  if not isNil(vtbl[].inputMethodQuery):
    vtbl[].vtbl.inputMethodQuery = cQTabBar_vtable_callback_inputMethodQuery
  if not isNil(vtbl[].focusNextPrevChild):
    vtbl[].vtbl.focusNextPrevChild = cQTabBar_vtable_callback_focusNextPrevChild
  if not isNil(vtbl[].eventFilter):
    vtbl[].vtbl.eventFilter = cQTabBar_vtable_callback_eventFilter
  if not isNil(vtbl[].childEvent):
    vtbl[].vtbl.childEvent = cQTabBar_vtable_callback_childEvent
  if not isNil(vtbl[].customEvent):
    vtbl[].vtbl.customEvent = cQTabBar_vtable_callback_customEvent
  if not isNil(vtbl[].connectNotify):
    vtbl[].vtbl.connectNotify = cQTabBar_vtable_callback_connectNotify
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = cQTabBar_vtable_callback_disconnectNotify
...
const cQTabBar_mvtbl = cQTabBarVTable(
  destructor: proc(self: pointer) {.cdecl.} =
    ...
    inst[].h = nil
    inst[].owned = false,
  metaObject: cQTabBar_method_callback_metaObject,
  metacast: cQTabBar_method_callback_metacast,
  metacall: cQTabBar_method_callback_metacall,
  sizeHint: cQTabBar_method_callback_sizeHint,
  minimumSizeHint: cQTabBar_method_callback_minimumSizeHint,
  tabSizeHint: cQTabBar_method_callback_tabSizeHint,
  minimumTabSizeHint: cQTabBar_method_callback_minimumTabSizeHint,
  tabInserted: cQTabBar_method_callback_tabInserted,
  tabRemoved: cQTabBar_method_callback_tabRemoved,
  tabLayoutChange: cQTabBar_method_callback_tabLayoutChange,
  event: cQTabBar_method_callback_event,
  resizeEvent: cQTabBar_method_callback_resizeEvent,
  showEvent: cQTabBar_method_callback_showEvent,
  hideEvent: cQTabBar_method_callback_hideEvent,
  paintEvent: cQTabBar_method_callback_paintEvent,
  mousePressEvent: cQTabBar_method_callback_mousePressEvent,
  mouseMoveEvent: cQTabBar_method_callback_mouseMoveEvent,
  mouseReleaseEvent: cQTabBar_method_callback_mouseReleaseEvent,
  mouseDoubleClickEvent: cQTabBar_method_callback_mouseDoubleClickEvent,
  wheelEvent: cQTabBar_method_callback_wheelEvent,
  keyPressEvent: cQTabBar_method_callback_keyPressEvent,
  changeEvent: cQTabBar_method_callback_changeEvent,
  timerEvent: cQTabBar_method_callback_timerEvent,
  initStyleOption: cQTabBar_method_callback_initStyleOption,
  devType: cQTabBar_method_callback_devType,
  setVisible: cQTabBar_method_callback_setVisible,
  heightForWidth: cQTabBar_method_callback_heightForWidth,
  hasHeightForWidth: cQTabBar_method_callback_hasHeightForWidth,
  paintEngine: cQTabBar_method_callback_paintEngine,
  keyReleaseEvent: cQTabBar_method_callback_keyReleaseEvent,
  focusInEvent: cQTabBar_method_callback_focusInEvent,
  focusOutEvent: cQTabBar_method_callback_focusOutEvent,
  enterEvent: cQTabBar_method_callback_enterEvent,
  leaveEvent: cQTabBar_method_callback_leaveEvent,
  moveEvent: cQTabBar_method_callback_moveEvent,
  closeEvent: cQTabBar_method_callback_closeEvent,
  contextMenuEvent: cQTabBar_method_callback_contextMenuEvent,
  tabletEvent: cQTabBar_method_callback_tabletEvent,
  actionEvent: cQTabBar_method_callback_actionEvent,
  dragEnterEvent: cQTabBar_method_callback_dragEnterEvent,
  dragMoveEvent: cQTabBar_method_callback_dragMoveEvent,
  dragLeaveEvent: cQTabBar_method_callback_dragLeaveEvent,
  dropEvent: cQTabBar_method_callback_dropEvent,
  nativeEvent: cQTabBar_method_callback_nativeEvent,
  metric: cQTabBar_method_callback_metric,
  initPainter: cQTabBar_method_callback_initPainter,
  redirected: cQTabBar_method_callback_redirected,
  sharedPainter: cQTabBar_method_callback_sharedPainter,
  inputMethodEvent: cQTabBar_method_callback_inputMethodEvent,
  inputMethodQuery: cQTabBar_method_callback_inputMethodQuery,
  focusNextPrevChild: cQTabBar_method_callback_focusNextPrevChild,
  eventFilter: cQTabBar_method_callback_eventFilter,
  childEvent: cQTabBar_method_callback_childEvent,
  customEvent: cQTabBar_method_callback_customEvent,
  connectNotify: cQTabBar_method_callback_connectNotify,
  disconnectNotify: cQTabBar_method_callback_disconnectNotify,
)
proc create*(T: type gen_qtabbar_types.QTabBar,
    parent: gen_qwidget_types.QWidget,
    inst: VirtualQTabBar) =
