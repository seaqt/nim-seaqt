...
public:
	...
	friend bool QColumnView_virtualbase_nativeEvent(VirtualQColumnView* self, struct miqt_string eventType, void* message, intptr_t* result);
...
VirtualQColumnView* QColumnView_new(const QColumnView_VTable* vtbl, size_t vdata, QWidget* parent) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQColumnView>());
...
bool QColumnView_virtualbase_nativeEvent(VirtualQColumnView* self, struct miqt_string eventType, void* message, intptr_t* result) {
