...
public:
	...
	friend bool QDialogButtonBox_virtualbase_nativeEvent(VirtualQDialogButtonBox* self, struct miqt_string eventType, void* message, intptr_t* result);
...
VirtualQDialogButtonBox* QDialogButtonBox_new(const QDialogButtonBox_VTable* vtbl, size_t vdata, QWidget* parent) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQDialogButtonBox>());
...
bool QDialogButtonBox_virtualbase_nativeEvent(VirtualQDialogButtonBox* self, struct miqt_string eventType, void* message, intptr_t* result) {
