...
public:
	...
	friend bool QFrame_virtualbase_nativeEvent(VirtualQFrame* self, struct miqt_string eventType, void* message, long* result);
...
bool QFrame_virtualbase_nativeEvent(VirtualQFrame* self, struct miqt_string eventType, void* message, long* result) {
