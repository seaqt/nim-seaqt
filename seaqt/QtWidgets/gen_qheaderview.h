...
typedef struct QHeaderView_VTable{
	...
	void (*dataChanged)(VirtualQHeaderView* self, QModelIndex* topLeft, QModelIndex* bottomRight, struct miqt_array /* of int */  roles);
	...
	void (*keyboardSearch)(VirtualQHeaderView* self, struct miqt_string search);
	...
	struct miqt_array /* of QModelIndex* */  (*selectedIndexes)(const VirtualQHeaderView* self);
	...
	bool (*nativeEvent)(VirtualQHeaderView* self, struct miqt_string eventType, void* message, intptr_t* result);
...
const QHeaderView_VTable* QHeaderView_vtbl(const VirtualQHeaderView* self);
void* QHeaderView_vdata(const VirtualQHeaderView* self);
void QHeaderView_setVdata(VirtualQHeaderView* self, void* vdata);
