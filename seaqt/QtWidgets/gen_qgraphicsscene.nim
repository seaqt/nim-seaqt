...
proc fcQGraphicsScene_trUtf8S(s: cstring): struct_seaqt_string {.importc: "QGraphicsScene_trUtf8_s".}
...
proc fcQGraphicsScene_trUtf8SC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QGraphicsScene_trUtf8_s_c".}
proc fcQGraphicsScene_trUtf8SCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QGraphicsScene_trUtf8_s_c_n".}
...
proc fcQGraphicsScene_setSelectionAreaPathMode(self: pointer, path: pointer, mode: cint): void {.importc: "QGraphicsScene_setSelectionArea_path_mode".}
proc fcQGraphicsScene_setSelectionAreaPathModeDeviceTransform(self: pointer, path: pointer, mode: cint, deviceTransform: pointer): void {.importc: "QGraphicsScene_setSelectionArea_path_mode_deviceTransform".}
...
proc trUtf8*(_: type gen_qgraphicsscene_types.QGraphicsScene, s: cstring): string =
  let v_ms = fcQGraphicsScene_trUtf8S(s)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc setSelectionArea2*(self: gen_qgraphicsscene_types.QGraphicsScene, path: gen_qpainterpath_types.QPainterPath, mode: cint): void =
  fcQGraphicsScene_setSelectionAreaPathMode(self.h, path.h, cint(mode))
...
proc setSelectionArea*(self: gen_qgraphicsscene_types.QGraphicsScene, path: gen_qpainterpath_types.QPainterPath, mode: cint, deviceTransform: gen_qtransform_types.QTransform): void =
  fcQGraphicsScene_setSelectionAreaPathModeDeviceTransform(self.h, path.h, cint(mode), deviceTransform.h)
