...
proc miqt_exec_method_cQGraphicsScene_focusNextPrevChild(vtbl: pointer, inst: pointer, next: bool): bool {.cdecl.} =
  let vtbl = cast[VirtualQGraphicsScene](cast[uint](vtbl) - uint(offsetOf(VirtualQGraphicsScene, vtbl)))
  let slotval1 = next
...
proc create*(T: type gen_qgraphicsscene_types.QGraphicsScene,
  ...
  vtbl[].vtbl.focusNextPrevChild = miqt_exec_method_cQGraphicsScene_focusNextPrevChild
