...
proc fcQStyledItemDelegate_trUtf8S(s: cstring): struct_seaqt_string {.importc: "QStyledItemDelegate_trUtf8_s".}
...
proc fcQStyledItemDelegate_trUtf8SC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QStyledItemDelegate_trUtf8_s_c".}
proc fcQStyledItemDelegate_trUtf8SCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QStyledItemDelegate_trUtf8_s_c_n".}
...
type cQStyledItemDelegateVTable {.pure.} = object
  ...
  displayText*: proc(self: pointer, value: pointer, locale: pointer): struct_seaqt_string {.cdecl, raises: [], gcsafe.}
...
proc fcQStyledItemDelegate_virtualbase_displayText(self: pointer, value: pointer, locale: pointer): struct_seaqt_string {.importc: "QStyledItemDelegate_virtualbase_displayText".}
...
proc fcQStyledItemDelegate_virtualbase_paintingRoles(self: pointer): struct_seaqt_array {.importc: "QStyledItemDelegate_virtualbase_paintingRoles".}
...
proc trUtf8*(_: type gen_qstyleditemdelegate_types.QStyledItemDelegate, s: cstring): string =
  let v_ms = fcQStyledItemDelegate_trUtf8S(s)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc fcQStyledItemDelegate_vtable_callback_displayText(self: pointer, value: pointer, locale: pointer): struct_seaqt_string {.cdecl.} =
  let vtbl = cast[ptr QStyledItemDelegateVTable](fcQStyledItemDelegate_vdata(self)[])
  let self = QStyledItemDelegate(h: self)
...
proc fcQStyledItemDelegate_vtable_callback_paintingRoles(self: pointer): struct_seaqt_array {.cdecl.} =
  let vtbl = cast[ptr QStyledItemDelegateVTable](fcQStyledItemDelegate_vdata(self)[])
  let self = QStyledItemDelegate(h: self)
...
proc fcQStyledItemDelegate_method_callback_displayText(self: pointer, value: pointer, locale: pointer): struct_seaqt_string {.cdecl.} =
  let inst = cast[VirtualQStyledItemDelegate](fcQStyledItemDelegate_vdata(self)[])
  let slotval1 = gen_qvariant_types.QVariant(h: value, owned: false)
  let slotval2 = gen_qlocale_types.QLocale(h: locale, owned: false)
...
proc fcQStyledItemDelegate_method_callback_paintingRoles(self: pointer): struct_seaqt_array {.cdecl.} =
  let inst = cast[VirtualQStyledItemDelegate](fcQStyledItemDelegate_vdata(self)[])
...
proc create*(T: type gen_qstyleditemdelegate_types.QStyledItemDelegate,
  ...
  let tmp = gen_qstyleditemdelegate_types.QStyledItemDelegate(h: fcQStyledItemDelegate_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQStyledItemDelegate_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qstyleditemdelegate_types.QStyledItemDelegate,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQStyledItemDelegate_vtable_callback_disconnectNotify
  let tmp = gen_qstyleditemdelegate_types.QStyledItemDelegate(h: fcQStyledItemDelegate_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQStyledItemDelegate_vdata(tmp.h)[] = addr(vtbl[])
  tmp
