...
proc fcQStyledItemDelegate_trUtf8(s: cstring): struct_seaqt_string {.importc: "QStyledItemDelegate_trUtf8".}
...
proc fcQStyledItemDelegate_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QStyledItemDelegate_trUtf82".}
proc fcQStyledItemDelegate_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QStyledItemDelegate_trUtf83".}
