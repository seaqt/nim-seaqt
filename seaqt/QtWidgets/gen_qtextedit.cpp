...
VirtualQTextEdit* QTextEdit_new(const QTextEdit_VTable* vtbl, size_t vdata, QWidget* parent) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQTextEdit>());
...
VirtualQTextEdit* QTextEdit_new3(const QTextEdit_VTable* vtbl, size_t vdata, struct miqt_string text) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQTextEdit>());
	return _mem_ ? new (_mem_)VirtualQTextEdit(vtbl, text_QString) : nullptr;
}

VirtualQTextEdit* QTextEdit_new4(const QTextEdit_VTable* vtbl, size_t vdata, struct miqt_string text, QWidget* parent) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQTextEdit>());
