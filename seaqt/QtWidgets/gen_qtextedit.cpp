...
public:
	...
	friend bool QTextEdit_virtualbase_nativeEvent(VirtualQTextEdit* self, struct miqt_string eventType, void* message, long* result);
...
bool QTextEdit_virtualbase_nativeEvent(VirtualQTextEdit* self, struct miqt_string eventType, void* message, long* result) {
