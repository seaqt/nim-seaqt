...
proc fcQSystemTrayIcon_trUtf8(s: cstring): struct_seaqt_string {.importc: "QSystemTrayIcon_trUtf8".}
...
proc fcQSystemTrayIcon_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QSystemTrayIcon_trUtf82".}
proc fcQSystemTrayIcon_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QSystemTrayIcon_trUtf83".}
