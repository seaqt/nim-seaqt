...
proc miqt_exec_method_cQComboBox_metaObject(vtbl: pointer, inst: pointer): pointer {.cdecl.} =
  let vtbl = cast[VirtualQComboBox](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
...
proc miqt_exec_method_cQComboBox_metacast(vtbl: pointer, inst: pointer, param1: cstring): pointer {.cdecl.} =
  let vtbl = cast[VirtualQComboBox](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
  let slotval1 = (param1)
...
proc miqt_exec_method_cQComboBox_metacall(vtbl: pointer, inst: pointer, param1: cint, param2: cint, param3: pointer): cint {.cdecl.} =
  let vtbl = cast[VirtualQComboBox](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
  let slotval1 = cint(param1)
  let slotval2 = param2
  let slotval3 = param3
...
proc miqt_exec_method_cQComboBox_setModel(vtbl: pointer, inst: pointer, model: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQComboBox](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
  let slotval1 = gen_qabstractitemmodel_types.QAbstractItemModel(h: model, owned: false)
...
proc miqt_exec_method_cQComboBox_sizeHint(vtbl: pointer, inst: pointer): pointer {.cdecl.} =
  let vtbl = cast[VirtualQComboBox](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
...
proc miqt_exec_method_cQComboBox_minimumSizeHint(vtbl: pointer, inst: pointer): pointer {.cdecl.} =
  let vtbl = cast[VirtualQComboBox](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
...
proc miqt_exec_method_cQComboBox_showPopup(vtbl: pointer, inst: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQComboBox](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
  vtbl.showPopup()

method hidePopup*(self: VirtualQComboBox, ): void {.base.} =
  QComboBoxhidePopup(self[])
proc miqt_exec_method_cQComboBox_hidePopup(vtbl: pointer, inst: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQComboBox](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
  vtbl.hidePopup()

method event*(self: VirtualQComboBox, event: gen_qcoreevent_types.QEvent): bool {.base.} =
  QComboBoxevent(self[], event)
proc miqt_exec_method_cQComboBox_event(vtbl: pointer, inst: pointer, event: pointer): bool {.cdecl.} =
  let vtbl = cast[VirtualQComboBox](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
...
proc miqt_exec_method_cQComboBox_inputMethodQuery(vtbl: pointer, inst: pointer, param1: cint): pointer {.cdecl.} =
  let vtbl = cast[VirtualQComboBox](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
  let slotval1 = cint(param1)
...
proc miqt_exec_method_cQComboBox_focusInEvent(vtbl: pointer, inst: pointer, e: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQComboBox](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
  let slotval1 = gen_qevent_types.QFocusEvent(h: e, owned: false)
...
proc miqt_exec_method_cQComboBox_focusOutEvent(vtbl: pointer, inst: pointer, e: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQComboBox](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
  let slotval1 = gen_qevent_types.QFocusEvent(h: e, owned: false)
...
proc miqt_exec_method_cQComboBox_changeEvent(vtbl: pointer, inst: pointer, e: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQComboBox](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
  let slotval1 = gen_qcoreevent_types.QEvent(h: e, owned: false)
...
proc miqt_exec_method_cQComboBox_resizeEvent(vtbl: pointer, inst: pointer, e: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQComboBox](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
  let slotval1 = gen_qevent_types.QResizeEvent(h: e, owned: false)
...
proc miqt_exec_method_cQComboBox_paintEvent(vtbl: pointer, inst: pointer, e: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQComboBox](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
  let slotval1 = gen_qevent_types.QPaintEvent(h: e, owned: false)
...
proc miqt_exec_method_cQComboBox_showEvent(vtbl: pointer, inst: pointer, e: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQComboBox](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
  let slotval1 = gen_qevent_types.QShowEvent(h: e, owned: false)
...
proc miqt_exec_method_cQComboBox_hideEvent(vtbl: pointer, inst: pointer, e: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQComboBox](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
  let slotval1 = gen_qevent_types.QHideEvent(h: e, owned: false)
...
proc miqt_exec_method_cQComboBox_mousePressEvent(vtbl: pointer, inst: pointer, e: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQComboBox](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
  let slotval1 = gen_qevent_types.QMouseEvent(h: e, owned: false)
...
proc miqt_exec_method_cQComboBox_mouseReleaseEvent(vtbl: pointer, inst: pointer, e: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQComboBox](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
  let slotval1 = gen_qevent_types.QMouseEvent(h: e, owned: false)
...
proc miqt_exec_method_cQComboBox_keyPressEvent(vtbl: pointer, inst: pointer, e: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQComboBox](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
  let slotval1 = gen_qevent_types.QKeyEvent(h: e, owned: false)
...
proc miqt_exec_method_cQComboBox_keyReleaseEvent(vtbl: pointer, inst: pointer, e: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQComboBox](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
  let slotval1 = gen_qevent_types.QKeyEvent(h: e, owned: false)
...
proc miqt_exec_method_cQComboBox_wheelEvent(vtbl: pointer, inst: pointer, e: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQComboBox](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
  let slotval1 = gen_qevent_types.QWheelEvent(h: e, owned: false)
...
proc miqt_exec_method_cQComboBox_contextMenuEvent(vtbl: pointer, inst: pointer, e: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQComboBox](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
  let slotval1 = gen_qevent_types.QContextMenuEvent(h: e, owned: false)
...
proc miqt_exec_method_cQComboBox_inputMethodEvent(vtbl: pointer, inst: pointer, param1: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQComboBox](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
  let slotval1 = gen_qevent_types.QInputMethodEvent(h: param1, owned: false)
...
proc miqt_exec_method_cQComboBox_initStyleOption(vtbl: pointer, inst: pointer, option: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQComboBox](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
  let slotval1 = gen_qstyleoption_types.QStyleOptionComboBox(h: option, owned: false)
...
proc miqt_exec_method_cQComboBox_devType(vtbl: pointer, inst: pointer): cint {.cdecl.} =
  let vtbl = cast[VirtualQComboBox](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
...
proc miqt_exec_method_cQComboBox_setVisible(vtbl: pointer, inst: pointer, visible: bool): void {.cdecl.} =
  let vtbl = cast[VirtualQComboBox](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
  let slotval1 = visible
...
proc miqt_exec_method_cQComboBox_heightForWidth(vtbl: pointer, inst: pointer, param1: cint): cint {.cdecl.} =
  let vtbl = cast[VirtualQComboBox](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
  let slotval1 = param1
...
proc miqt_exec_method_cQComboBox_hasHeightForWidth(vtbl: pointer, inst: pointer): bool {.cdecl.} =
  let vtbl = cast[VirtualQComboBox](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
...
proc miqt_exec_method_cQComboBox_paintEngine(vtbl: pointer, inst: pointer): pointer {.cdecl.} =
  let vtbl = cast[VirtualQComboBox](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
...
proc miqt_exec_method_cQComboBox_mouseDoubleClickEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQComboBox](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
...
proc miqt_exec_method_cQComboBox_mouseMoveEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQComboBox](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
...
proc miqt_exec_method_cQComboBox_enterEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQComboBox](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
  let slotval1 = gen_qevent_types.QEnterEvent(h: event, owned: false)
...
proc miqt_exec_method_cQComboBox_leaveEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQComboBox](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
...
proc miqt_exec_method_cQComboBox_moveEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQComboBox](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
  let slotval1 = gen_qevent_types.QMoveEvent(h: event, owned: false)
...
proc miqt_exec_method_cQComboBox_closeEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQComboBox](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
  let slotval1 = gen_qevent_types.QCloseEvent(h: event, owned: false)
...
proc miqt_exec_method_cQComboBox_tabletEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQComboBox](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
  let slotval1 = gen_qevent_types.QTabletEvent(h: event, owned: false)
...
proc miqt_exec_method_cQComboBox_actionEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQComboBox](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
  let slotval1 = gen_qevent_types.QActionEvent(h: event, owned: false)
...
proc miqt_exec_method_cQComboBox_dragEnterEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQComboBox](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
  let slotval1 = gen_qevent_types.QDragEnterEvent(h: event, owned: false)
...
proc miqt_exec_method_cQComboBox_dragMoveEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQComboBox](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
  let slotval1 = gen_qevent_types.QDragMoveEvent(h: event, owned: false)
...
proc miqt_exec_method_cQComboBox_dragLeaveEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQComboBox](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
  let slotval1 = gen_qevent_types.QDragLeaveEvent(h: event, owned: false)
...
proc miqt_exec_method_cQComboBox_dropEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQComboBox](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
  let slotval1 = gen_qevent_types.QDropEvent(h: event, owned: false)
...
proc miqt_exec_method_cQComboBox_nativeEvent(vtbl: pointer, inst: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[VirtualQComboBox](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArrayByte(veventType_bytearray.data, 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc miqt_exec_method_cQComboBox_metric(vtbl: pointer, inst: pointer, param1: cint): cint {.cdecl.} =
  let vtbl = cast[VirtualQComboBox](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
  let slotval1 = cint(param1)
...
proc miqt_exec_method_cQComboBox_initPainter(vtbl: pointer, inst: pointer, painter: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQComboBox](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
  let slotval1 = gen_qpainter_types.QPainter(h: painter, owned: false)
...
proc miqt_exec_method_cQComboBox_redirected(vtbl: pointer, inst: pointer, offset: pointer): pointer {.cdecl.} =
  let vtbl = cast[VirtualQComboBox](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
  let slotval1 = gen_qpoint_types.QPoint(h: offset, owned: false)
...
proc miqt_exec_method_cQComboBox_sharedPainter(vtbl: pointer, inst: pointer): pointer {.cdecl.} =
  let vtbl = cast[VirtualQComboBox](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
...
proc miqt_exec_method_cQComboBox_focusNextPrevChild(vtbl: pointer, inst: pointer, next: bool): bool {.cdecl.} =
  let vtbl = cast[VirtualQComboBox](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
  let slotval1 = next
...
proc miqt_exec_method_cQComboBox_eventFilter(vtbl: pointer, inst: pointer, watched: pointer, event: pointer): bool {.cdecl.} =
  let vtbl = cast[VirtualQComboBox](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
  let slotval1 = gen_qobject_types.QObject(h: watched, owned: false)
  let slotval2 = gen_qcoreevent_types.QEvent(h: event, owned: false)
...
proc miqt_exec_method_cQComboBox_timerEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQComboBox](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
  let slotval1 = gen_qcoreevent_types.QTimerEvent(h: event, owned: false)
...
proc miqt_exec_method_cQComboBox_childEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQComboBox](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
  let slotval1 = gen_qcoreevent_types.QChildEvent(h: event, owned: false)
...
proc miqt_exec_method_cQComboBox_customEvent(vtbl: pointer, inst: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQComboBox](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
...
proc miqt_exec_method_cQComboBox_connectNotify(vtbl: pointer, inst: pointer, signal: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQComboBox](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
  let slotval1 = gen_qmetaobject_types.QMetaMethod(h: signal, owned: false)
...
proc miqt_exec_method_cQComboBox_disconnectNotify(vtbl: pointer, inst: pointer, signal: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQComboBox](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
  let slotval1 = gen_qmetaobject_types.QMetaMethod(h: signal, owned: false)
...
proc create*(T: type gen_qcombobox_types.QComboBox,
  ...
  gen_qcombobox_types.QComboBox(h: fcQComboBox_new(addr(vtbl[].vtbl), parent.h), owned: true)
...
proc create*(T: type gen_qcombobox_types.QComboBox,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = miqt_exec_callback_cQComboBox_disconnectNotify
  gen_qcombobox_types.QComboBox(h: fcQComboBox_new2(addr(vtbl[].vtbl), ), owned: true)

proc create*(T: type gen_qcombobox_types.QComboBox,
    parent: gen_qwidget_types.QWidget,
    vtbl: VirtualQComboBox) =

  vtbl[].vtbl.destructor = proc(vtbl: ptr cQComboBoxVTable, _: ptr cQComboBox) {.cdecl.} =
    let vtbl = cast[ptr typeof(VirtualQComboBox()[])](cast[uint](vtbl) - uint(offsetOf(VirtualQComboBox, vtbl)))
    vtbl[].h = nil
    vtbl[].owned = false
  vtbl[].vtbl.metaObject = miqt_exec_method_cQComboBox_metaObject
  vtbl[].vtbl.metacast = miqt_exec_method_cQComboBox_metacast
  vtbl[].vtbl.metacall = miqt_exec_method_cQComboBox_metacall
  vtbl[].vtbl.setModel = miqt_exec_method_cQComboBox_setModel
  vtbl[].vtbl.sizeHint = miqt_exec_method_cQComboBox_sizeHint
  vtbl[].vtbl.minimumSizeHint = miqt_exec_method_cQComboBox_minimumSizeHint
  vtbl[].vtbl.showPopup = miqt_exec_method_cQComboBox_showPopup
  vtbl[].vtbl.hidePopup = miqt_exec_method_cQComboBox_hidePopup
  vtbl[].vtbl.event = miqt_exec_method_cQComboBox_event
  vtbl[].vtbl.inputMethodQuery = miqt_exec_method_cQComboBox_inputMethodQuery
  vtbl[].vtbl.focusInEvent = miqt_exec_method_cQComboBox_focusInEvent
  vtbl[].vtbl.focusOutEvent = miqt_exec_method_cQComboBox_focusOutEvent
  vtbl[].vtbl.changeEvent = miqt_exec_method_cQComboBox_changeEvent
  vtbl[].vtbl.resizeEvent = miqt_exec_method_cQComboBox_resizeEvent
  vtbl[].vtbl.paintEvent = miqt_exec_method_cQComboBox_paintEvent
  vtbl[].vtbl.showEvent = miqt_exec_method_cQComboBox_showEvent
  vtbl[].vtbl.hideEvent = miqt_exec_method_cQComboBox_hideEvent
  vtbl[].vtbl.mousePressEvent = miqt_exec_method_cQComboBox_mousePressEvent
  vtbl[].vtbl.mouseReleaseEvent = miqt_exec_method_cQComboBox_mouseReleaseEvent
  vtbl[].vtbl.keyPressEvent = miqt_exec_method_cQComboBox_keyPressEvent
  vtbl[].vtbl.keyReleaseEvent = miqt_exec_method_cQComboBox_keyReleaseEvent
  vtbl[].vtbl.wheelEvent = miqt_exec_method_cQComboBox_wheelEvent
  vtbl[].vtbl.contextMenuEvent = miqt_exec_method_cQComboBox_contextMenuEvent
  vtbl[].vtbl.inputMethodEvent = miqt_exec_method_cQComboBox_inputMethodEvent
  vtbl[].vtbl.initStyleOption = miqt_exec_method_cQComboBox_initStyleOption
  vtbl[].vtbl.devType = miqt_exec_method_cQComboBox_devType
  vtbl[].vtbl.setVisible = miqt_exec_method_cQComboBox_setVisible
  vtbl[].vtbl.heightForWidth = miqt_exec_method_cQComboBox_heightForWidth
  vtbl[].vtbl.hasHeightForWidth = miqt_exec_method_cQComboBox_hasHeightForWidth
  vtbl[].vtbl.paintEngine = miqt_exec_method_cQComboBox_paintEngine
  vtbl[].vtbl.mouseDoubleClickEvent = miqt_exec_method_cQComboBox_mouseDoubleClickEvent
  vtbl[].vtbl.mouseMoveEvent = miqt_exec_method_cQComboBox_mouseMoveEvent
  vtbl[].vtbl.enterEvent = miqt_exec_method_cQComboBox_enterEvent
  vtbl[].vtbl.leaveEvent = miqt_exec_method_cQComboBox_leaveEvent
  vtbl[].vtbl.moveEvent = miqt_exec_method_cQComboBox_moveEvent
  vtbl[].vtbl.closeEvent = miqt_exec_method_cQComboBox_closeEvent
  vtbl[].vtbl.tabletEvent = miqt_exec_method_cQComboBox_tabletEvent
  vtbl[].vtbl.actionEvent = miqt_exec_method_cQComboBox_actionEvent
  vtbl[].vtbl.dragEnterEvent = miqt_exec_method_cQComboBox_dragEnterEvent
  vtbl[].vtbl.dragMoveEvent = miqt_exec_method_cQComboBox_dragMoveEvent
  vtbl[].vtbl.dragLeaveEvent = miqt_exec_method_cQComboBox_dragLeaveEvent
  vtbl[].vtbl.dropEvent = miqt_exec_method_cQComboBox_dropEvent
  vtbl[].vtbl.nativeEvent = miqt_exec_method_cQComboBox_nativeEvent
  vtbl[].vtbl.metric = miqt_exec_method_cQComboBox_metric
  vtbl[].vtbl.initPainter = miqt_exec_method_cQComboBox_initPainter
  vtbl[].vtbl.redirected = miqt_exec_method_cQComboBox_redirected
  vtbl[].vtbl.sharedPainter = miqt_exec_method_cQComboBox_sharedPainter
  vtbl[].vtbl.focusNextPrevChild = miqt_exec_method_cQComboBox_focusNextPrevChild
  vtbl[].vtbl.eventFilter = miqt_exec_method_cQComboBox_eventFilter
  vtbl[].vtbl.timerEvent = miqt_exec_method_cQComboBox_timerEvent
  vtbl[].vtbl.childEvent = miqt_exec_method_cQComboBox_childEvent
  vtbl[].vtbl.customEvent = miqt_exec_method_cQComboBox_customEvent
  vtbl[].vtbl.connectNotify = miqt_exec_method_cQComboBox_connectNotify
  vtbl[].vtbl.disconnectNotify = miqt_exec_method_cQComboBox_disconnectNotify
  if vtbl[].h != nil: delete(move(vtbl[]))
  vtbl[].h = fcQComboBox_new(addr(vtbl[].vtbl), parent.h)
  vtbl[].owned = true
...
proc create*(T: type gen_qcombobox_types.QComboBox,
  ...
  vtbl[].vtbl.disconnectNotify = miqt_exec_method_cQComboBox_disconnectNotify
  if vtbl[].h != nil: delete(move(vtbl[]))
  vtbl[].h = fcQComboBox_new2(addr(vtbl[].vtbl), )
  vtbl[].owned = true
