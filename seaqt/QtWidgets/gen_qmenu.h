...
typedef struct QMenu_VTable{
	...
	bool (*nativeEvent)(VirtualQMenu* self, struct miqt_string eventType, void* message, intptr_t* result);
...
VirtualQMenu* QMenu_new3(const QMenu_VTable* vtbl, size_t vdata, struct miqt_string title);
VirtualQMenu* QMenu_new4(const QMenu_VTable* vtbl, size_t vdata, struct miqt_string title, QWidget* parent);
