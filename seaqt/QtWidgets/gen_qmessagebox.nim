...
proc fcQMessageBox_trUtf8(s: cstring): struct_seaqt_string {.importc: "QMessageBox_trUtf8".}
...
proc fcQMessageBox_information3(parent: pointer, title: struct_seaqt_string, text: struct_seaqt_string, button0Text: struct_seaqt_string): cint {.importc: "QMessageBox_information3".}
proc fcQMessageBox_information4(parent: pointer, title: struct_seaqt_string, text: struct_seaqt_string, button0: cint): cint {.importc: "QMessageBox_information4".}
proc fcQMessageBox_question2(parent: pointer, title: struct_seaqt_string, text: struct_seaqt_string, button0: cint): cint {.importc: "QMessageBox_question2".}
proc fcQMessageBox_question3(parent: pointer, title: struct_seaqt_string, text: struct_seaqt_string, button0Text: struct_seaqt_string): cint {.importc: "QMessageBox_question3".}
proc fcQMessageBox_question4(parent: pointer, title: struct_seaqt_string, text: struct_seaqt_string, button0: cint, button1: cint): cint {.importc: "QMessageBox_question4".}
...
proc fcQMessageBox_warning3(parent: pointer, title: struct_seaqt_string, text: struct_seaqt_string, button0Text: struct_seaqt_string): cint {.importc: "QMessageBox_warning3".}
proc fcQMessageBox_warning4(parent: pointer, title: struct_seaqt_string, text: struct_seaqt_string, button0: cint, button1: cint): cint {.importc: "QMessageBox_warning4".}
...
proc fcQMessageBox_critical3(parent: pointer, title: struct_seaqt_string, text: struct_seaqt_string, button0Text: struct_seaqt_string): cint {.importc: "QMessageBox_critical3".}
proc fcQMessageBox_critical4(parent: pointer, title: struct_seaqt_string, text: struct_seaqt_string, button0: cint, button1: cint): cint {.importc: "QMessageBox_critical4".}
...
proc fcQMessageBox_setInformativeText(self: pointer, text: struct_seaqt_string): void {.importc: "QMessageBox_setInformativeText".}
proc fcQMessageBox_detailedText(self: pointer): struct_seaqt_string {.importc: "QMessageBox_detailedText".}
proc fcQMessageBox_setDetailedText(self: pointer, text: struct_seaqt_string): void {.importc: "QMessageBox_setDetailedText".}
proc fcQMessageBox_setWindowTitle(self: pointer, title: struct_seaqt_string): void {.importc: "QMessageBox_setWindowTitle".}
...
proc fcQMessageBox_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QMessageBox_trUtf82".}
proc fcQMessageBox_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QMessageBox_trUtf83".}
...
proc fcQMessageBox_information8(parent: pointer, title: struct_seaqt_string, text: struct_seaqt_string, button0: cint, button1: cint, button2: cint): cint {.importc: "QMessageBox_information8".}
proc fcQMessageBox_information9(parent: pointer, title: struct_seaqt_string, text: struct_seaqt_string, button0Text: struct_seaqt_string, button1Text: struct_seaqt_string): cint {.importc: "QMessageBox_information9".}
proc fcQMessageBox_information10(parent: pointer, title: struct_seaqt_string, text: struct_seaqt_string, button0Text: struct_seaqt_string, button1Text: struct_seaqt_string, button2Text: struct_seaqt_string): cint {.importc: "QMessageBox_information10".}
proc fcQMessageBox_information11(parent: pointer, title: struct_seaqt_string, text: struct_seaqt_string, button0Text: struct_seaqt_string, button1Text: struct_seaqt_string, button2Text: struct_seaqt_string, defaultButtonNumber: cint): cint {.importc: "QMessageBox_information11".}
proc fcQMessageBox_information12(parent: pointer, title: struct_seaqt_string, text: struct_seaqt_string, button0Text: struct_seaqt_string, button1Text: struct_seaqt_string, button2Text: struct_seaqt_string, defaultButtonNumber: cint, escapeButtonNumber: cint): cint {.importc: "QMessageBox_information12".}
proc fcQMessageBox_information13(parent: pointer, title: struct_seaqt_string, text: struct_seaqt_string, button0: cint, button1: cint): cint {.importc: "QMessageBox_information13".}
...
proc fcQMessageBox_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.importc: "QMessageBox_virtualbase_nativeEvent".}
...
proc fcQMessageBox_new(vtbl: pointer, vdata: csize_t): ptr cQMessageBox {.importc: "QMessageBox_new".}
proc fcQMessageBox_new2(vtbl: pointer, vdata: csize_t, icon: cint, title: struct_seaqt_string, text: struct_seaqt_string): ptr cQMessageBox {.importc: "QMessageBox_new2".}
proc fcQMessageBox_new3(vtbl: pointer, vdata: csize_t, title: struct_seaqt_string, text: struct_seaqt_string, icon: cint, button0: cint, button1: cint, button2: cint): ptr cQMessageBox {.importc: "QMessageBox_new3".}
proc fcQMessageBox_new4(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQMessageBox {.importc: "QMessageBox_new4".}
...
proc addButton*(self: gen_qmessagebox_types.QMessageBox, text: openArray[char], role: cint): gen_qpushbutton_types.QPushButton =
  gen_qpushbutton_types.QPushButton(h: fcQMessageBox_addButton2(self.h, struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), cint(role)))
...
proc setText*(self: gen_qmessagebox_types.QMessageBox, text: openArray[char]): void =
  fcQMessageBox_setText(self.h, struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))))
...
proc information*(_: type gen_qmessagebox_types.QMessageBox, parent: gen_qwidget_types.QWidget, title: openArray[char], text: openArray[char], button0: cint): cint =
  fcQMessageBox_information2(parent.h, struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), button0)
...
proc information2*(_: type gen_qmessagebox_types.QMessageBox, parent: gen_qwidget_types.QWidget, title: openArray[char], text: openArray[char], button0: cint): cint =
  cint(fcQMessageBox_information4(parent.h, struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), cint(button0)))
...
proc question*(_: type gen_qmessagebox_types.QMessageBox, parent: gen_qwidget_types.QWidget, title: openArray[char], text: openArray[char], button0: cint): cint =
  fcQMessageBox_question2(parent.h, struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), button0)
...
proc question*(_: type gen_qmessagebox_types.QMessageBox, parent: gen_qwidget_types.QWidget, title: openArray[char], text: openArray[char], button0Text: openArray[char]): cint =
  fcQMessageBox_question3(parent.h, struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), struct_seaqt_string(data: if len(button0Text) > 0: addr button0Text[0] else: nil, len: csize_t(len(button0Text))))
...
proc question*(_: type gen_qmessagebox_types.QMessageBox, parent: gen_qwidget_types.QWidget, title: openArray[char], text: openArray[char], button0: cint, button1: cint): cint =
  fcQMessageBox_question4(parent.h, struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), cint(button0), cint(button1))
...
proc warning*(_: type gen_qmessagebox_types.QMessageBox, parent: gen_qwidget_types.QWidget, title: openArray[char], text: openArray[char], button0: cint, button1: cint): cint =
  fcQMessageBox_warning2(parent.h, struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), button0, button1)
...
proc warning*(_: type gen_qmessagebox_types.QMessageBox, parent: gen_qwidget_types.QWidget, title: openArray[char], text: openArray[char], button0Text: openArray[char]): cint =
  fcQMessageBox_warning3(parent.h, struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), struct_seaqt_string(data: if len(button0Text) > 0: addr button0Text[0] else: nil, len: csize_t(len(button0Text))))
...
proc warning2*(_: type gen_qmessagebox_types.QMessageBox, parent: gen_qwidget_types.QWidget, title: openArray[char], text: openArray[char], button0: cint, button1: cint): cint =
  fcQMessageBox_warning4(parent.h, struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), cint(button0), cint(button1))
...
proc critical*(_: type gen_qmessagebox_types.QMessageBox, parent: gen_qwidget_types.QWidget, title: openArray[char], text: openArray[char], button0: cint, button1: cint): cint =
  fcQMessageBox_critical2(parent.h, struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), button0, button1)
...
proc critical*(_: type gen_qmessagebox_types.QMessageBox, parent: gen_qwidget_types.QWidget, title: openArray[char], text: openArray[char], button0Text: openArray[char]): cint =
  fcQMessageBox_critical3(parent.h, struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), struct_seaqt_string(data: if len(button0Text) > 0: addr button0Text[0] else: nil, len: csize_t(len(button0Text))))
...
proc critical2*(_: type gen_qmessagebox_types.QMessageBox, parent: gen_qwidget_types.QWidget, title: openArray[char], text: openArray[char], button0: cint, button1: cint): cint =
  fcQMessageBox_critical4(parent.h, struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), cint(button0), cint(button1))
...
proc setButtonText*(self: gen_qmessagebox_types.QMessageBox, button: cint, text: openArray[char]): void =
  fcQMessageBox_setButtonText(self.h, button, struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))))
...
proc setInformativeText*(self: gen_qmessagebox_types.QMessageBox, text: openArray[char]): void =
  fcQMessageBox_setInformativeText(self.h, struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))))
...
proc setDetailedText*(self: gen_qmessagebox_types.QMessageBox, text: openArray[char]): void =
  fcQMessageBox_setDetailedText(self.h, struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))))

proc setWindowTitle*(self: gen_qmessagebox_types.QMessageBox, title: openArray[char]): void =
  fcQMessageBox_setWindowTitle(self.h, struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))))
...
proc information2*(_: type gen_qmessagebox_types.QMessageBox, parent: gen_qwidget_types.QWidget, title: openArray[char], text: openArray[char], button0: cint, button1: cint): cint =
  fcQMessageBox_information7(parent.h, struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), button0, button1)
...
proc information*(_: type gen_qmessagebox_types.QMessageBox, parent: gen_qwidget_types.QWidget, title: openArray[char], text: openArray[char], button0: cint, button1: cint, button2: cint): cint =
  fcQMessageBox_information8(parent.h, struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), button0, button1, button2)
...
proc information3*(_: type gen_qmessagebox_types.QMessageBox, parent: gen_qwidget_types.QWidget, title: openArray[char], text: openArray[char], button0: cint, button1: cint): cint =
  cint(fcQMessageBox_information13(parent.h, struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), cint(button0), cint(button1)))
...
type QMessageBoxnativeEventProc* = proc(self: QMessageBox, eventType: openArray[byte], message: pointer, resultVal: ptr clong): bool {.raises: [], gcsafe.}
...
proc QMessageBoxnativeEvent*(self: gen_qmessagebox_types.QMessageBox, eventType: openArray[byte], message: pointer, resultVal: ptr clong): bool =
  fcQMessageBox_virtualbase_nativeEvent(self.h, struct_seaqt_string(data: if len(eventType) > 0: addr eventType[0] else: nil, len: csize_t(len(eventType))), message, resultVal)
...
proc fcQMessageBox_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let vtbl = cast[ptr QMessageBoxVTable](fcQMessageBox_vdata(self)[])
  let self = QMessageBox(h: self)
...
proc fcQMessageBox_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let inst = cast[VirtualQMessageBox](fcQMessageBox_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc create*(T: type gen_qmessagebox_types.QMessageBox,
  ...
  let tmp = gen_qmessagebox_types.QMessageBox(h: fcQMessageBox_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))))
  fcQMessageBox_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qmessagebox_types.QMessageBox,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQMessageBox_vtable_callback_disconnectNotify
  let tmp = gen_qmessagebox_types.QMessageBox(h: fcQMessageBox_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), cint(icon), struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text)))))
  fcQMessageBox_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qmessagebox_types.QMessageBox,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQMessageBox_vtable_callback_disconnectNotify
  let tmp = gen_qmessagebox_types.QMessageBox(h: fcQMessageBox_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), cint(icon), button0, button1, button2))
  fcQMessageBox_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qmessagebox_types.QMessageBox,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQMessageBox_vtable_callback_disconnectNotify
  let tmp = gen_qmessagebox_types.QMessageBox(h: fcQMessageBox_new4(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h))
  fcQMessageBox_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qmessagebox_types.QMessageBox,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQMessageBox_vtable_callback_disconnectNotify
  let tmp = gen_qmessagebox_types.QMessageBox(h: fcQMessageBox_new5(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), cint(icon), struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), cint(buttons)))
  fcQMessageBox_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qmessagebox_types.QMessageBox,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQMessageBox_vtable_callback_disconnectNotify
  let tmp = gen_qmessagebox_types.QMessageBox(h: fcQMessageBox_new6(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), cint(icon), struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), cint(buttons), parent.h))
  fcQMessageBox_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qmessagebox_types.QMessageBox,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQMessageBox_vtable_callback_disconnectNotify
  let tmp = gen_qmessagebox_types.QMessageBox(h: fcQMessageBox_new7(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), cint(icon), struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), cint(buttons), parent.h, cint(flags)))
  fcQMessageBox_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qmessagebox_types.QMessageBox,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQMessageBox_vtable_callback_disconnectNotify
  let tmp = gen_qmessagebox_types.QMessageBox(h: fcQMessageBox_new8(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), cint(icon), button0, button1, button2, parent.h))
  fcQMessageBox_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qmessagebox_types.QMessageBox,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQMessageBox_vtable_callback_disconnectNotify
  let tmp = gen_qmessagebox_types.QMessageBox(h: fcQMessageBox_new9(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), cint(icon), button0, button1, button2, parent.h, cint(f)))
  fcQMessageBox_vdata(tmp.h)[] = addr(vtbl[])
  tmp
...
proc create*(T: type gen_qmessagebox_types.QMessageBox,
  ...
  inst[].h = fcQMessageBox_new(addr(cQMessageBox_mvtbl), csize_t(sizeof(pointer)))
  fcQMessageBox_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qmessagebox_types.QMessageBox,
    ...
    inst: VirtualQMessageBox) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQMessageBox_new2(addr(cQMessageBox_mvtbl), csize_t(sizeof(pointer)), cint(icon), struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))))
  fcQMessageBox_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qmessagebox_types.QMessageBox,
    ...
    inst: VirtualQMessageBox) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQMessageBox_new3(addr(cQMessageBox_mvtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), cint(icon), button0, button1, button2)
  fcQMessageBox_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qmessagebox_types.QMessageBox,
    ...
    inst: VirtualQMessageBox) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQMessageBox_new4(addr(cQMessageBox_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQMessageBox_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qmessagebox_types.QMessageBox,
    ...
    inst: VirtualQMessageBox) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQMessageBox_new5(addr(cQMessageBox_mvtbl), csize_t(sizeof(pointer)), cint(icon), struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), cint(buttons))
  fcQMessageBox_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qmessagebox_types.QMessageBox,
    ...
    inst: VirtualQMessageBox) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQMessageBox_new6(addr(cQMessageBox_mvtbl), csize_t(sizeof(pointer)), cint(icon), struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), cint(buttons), parent.h)
  fcQMessageBox_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qmessagebox_types.QMessageBox,
    ...
    inst: VirtualQMessageBox) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQMessageBox_new7(addr(cQMessageBox_mvtbl), csize_t(sizeof(pointer)), cint(icon), struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), cint(buttons), parent.h, cint(flags))
  fcQMessageBox_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qmessagebox_types.QMessageBox,
    ...
    inst: VirtualQMessageBox) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQMessageBox_new8(addr(cQMessageBox_mvtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), cint(icon), button0, button1, button2, parent.h)
  fcQMessageBox_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qmessagebox_types.QMessageBox,
    ...
    inst: VirtualQMessageBox) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQMessageBox_new9(addr(cQMessageBox_mvtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), cint(icon), button0, button1, button2, parent.h, cint(f))
  fcQMessageBox_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
