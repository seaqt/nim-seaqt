...
proc fcQMessageBox_new3(vtbl: pointer, vdata: csize_t, icon: cint, title: struct_miqt_string, text: struct_miqt_string): ptr cQMessageBox {.importc: "QMessageBox_new3".}
proc fcQMessageBox_new4(vtbl: pointer, vdata: csize_t, title: struct_miqt_string, text: struct_miqt_string, icon: cint, button0: cint, button1: cint, button2: cint): ptr cQMessageBox {.importc: "QMessageBox_new4".}
proc fcQMessageBox_new5(vtbl: pointer, vdata: csize_t, icon: cint, title: struct_miqt_string, text: struct_miqt_string, buttons: cint): ptr cQMessageBox {.importc: "QMessageBox_new5".}
proc fcQMessageBox_new6(vtbl: pointer, vdata: csize_t, icon: cint, title: struct_miqt_string, text: struct_miqt_string, buttons: cint, parent: pointer): ptr cQMessageBox {.importc: "QMessageBox_new6".}
proc fcQMessageBox_new7(vtbl: pointer, vdata: csize_t, icon: cint, title: struct_miqt_string, text: struct_miqt_string, buttons: cint, parent: pointer, flags: cint): ptr cQMessageBox {.importc: "QMessageBox_new7".}
proc fcQMessageBox_new8(vtbl: pointer, vdata: csize_t, title: struct_miqt_string, text: struct_miqt_string, icon: cint, button0: cint, button1: cint, button2: cint, parent: pointer): ptr cQMessageBox {.importc: "QMessageBox_new8".}
proc fcQMessageBox_new9(vtbl: pointer, vdata: csize_t, title: struct_miqt_string, text: struct_miqt_string, icon: cint, button0: cint, button1: cint, button2: cint, parent: pointer, f: cint): ptr cQMessageBox {.importc: "QMessageBox_new9".}
...
proc addButton*(self: gen_qmessagebox_types.QMessageBox, text: string, role: cint): gen_qpushbutton_types.QPushButton =
  gen_qpushbutton_types.QPushButton(h: fcQMessageBox_addButton2(self.h, struct_miqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), cint(role)))
...
proc create*(T: type gen_qmessagebox_types.QMessageBox,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQMessageBox_vtable_callback_disconnectNotify
  let tmp = gen_qmessagebox_types.QMessageBox(h: fcQMessageBox_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), cint(icon), struct_miqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), struct_miqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text)))))
  fcQMessageBox_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qmessagebox_types.QMessageBox,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQMessageBox_vtable_callback_disconnectNotify
  let tmp = gen_qmessagebox_types.QMessageBox(h: fcQMessageBox_new4(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_miqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), struct_miqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), cint(icon), button0, button1, button2))
  fcQMessageBox_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qmessagebox_types.QMessageBox,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQMessageBox_vtable_callback_disconnectNotify
  let tmp = gen_qmessagebox_types.QMessageBox(h: fcQMessageBox_new5(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), cint(icon), struct_miqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), struct_miqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), cint(buttons)))
  fcQMessageBox_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qmessagebox_types.QMessageBox,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQMessageBox_vtable_callback_disconnectNotify
  let tmp = gen_qmessagebox_types.QMessageBox(h: fcQMessageBox_new6(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), cint(icon), struct_miqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), struct_miqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), cint(buttons), parent.h))
  fcQMessageBox_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qmessagebox_types.QMessageBox,
...
proc create*(T: type gen_qmessagebox_types.QMessageBox,
    ...
    inst: VirtualQMessageBox) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQMessageBox_new3(addr(cQMessageBox_mvtbl), csize_t(sizeof(pointer)), cint(icon), struct_miqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), struct_miqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))))
  fcQMessageBox_vdata(inst[].h)[] = addr inst[]
...
proc create*(T: type gen_qmessagebox_types.QMessageBox,
    ...
    inst: VirtualQMessageBox) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQMessageBox_new4(addr(cQMessageBox_mvtbl), csize_t(sizeof(pointer)), struct_miqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), struct_miqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), cint(icon), button0, button1, button2)
  fcQMessageBox_vdata(inst[].h)[] = addr inst[]
...
proc create*(T: type gen_qmessagebox_types.QMessageBox,
    ...
    inst: VirtualQMessageBox) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQMessageBox_new5(addr(cQMessageBox_mvtbl), csize_t(sizeof(pointer)), cint(icon), struct_miqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), struct_miqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), cint(buttons))
  fcQMessageBox_vdata(inst[].h)[] = addr inst[]
...
proc create*(T: type gen_qmessagebox_types.QMessageBox,
    ...
    inst: VirtualQMessageBox) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQMessageBox_new6(addr(cQMessageBox_mvtbl), csize_t(sizeof(pointer)), cint(icon), struct_miqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), struct_miqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), cint(buttons), parent.h)
  fcQMessageBox_vdata(inst[].h)[] = addr inst[]
...
proc create*(T: type gen_qmessagebox_types.QMessageBox,
    ...
    inst: VirtualQMessageBox) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQMessageBox_new7(addr(cQMessageBox_mvtbl), csize_t(sizeof(pointer)), cint(icon), struct_miqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), struct_miqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), cint(buttons), parent.h, cint(flags))
  fcQMessageBox_vdata(inst[].h)[] = addr inst[]
...
proc create*(T: type gen_qmessagebox_types.QMessageBox,
    ...
    inst: VirtualQMessageBox) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQMessageBox_new8(addr(cQMessageBox_mvtbl), csize_t(sizeof(pointer)), struct_miqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), struct_miqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), cint(icon), button0, button1, button2, parent.h)
  fcQMessageBox_vdata(inst[].h)[] = addr inst[]
...
proc create*(T: type gen_qmessagebox_types.QMessageBox,
    ...
    inst: VirtualQMessageBox) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQMessageBox_new9(addr(cQMessageBox_mvtbl), csize_t(sizeof(pointer)), struct_miqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), struct_miqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), cint(icon), button0, button1, button2, parent.h, cint(f))
  fcQMessageBox_vdata(inst[].h)[] = addr inst[]
