...
proc create*(T: type gen_qscrollbar_types.QScrollBar,
  ...
  let tmp = gen_qscrollbar_types.QScrollBar(h: fcQScrollBar_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))))
...
proc create*(T: type gen_qscrollbar_types.QScrollBar,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQScrollBar_vtable_callback_disconnectNotify
  let tmp = gen_qscrollbar_types.QScrollBar(h: fcQScrollBar_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), cint(param1)))
  fcQScrollBar_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qscrollbar_types.QScrollBar,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQScrollBar_vtable_callback_disconnectNotify
  let tmp = gen_qscrollbar_types.QScrollBar(h: fcQScrollBar_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h))
  fcQScrollBar_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qscrollbar_types.QScrollBar,
