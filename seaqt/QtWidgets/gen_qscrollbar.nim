...
proc fcQScrollBar_trUtf8S(s: cstring): struct_seaqt_string {.importc: "QScrollBar_trUtf8_s".}
...
proc fcQScrollBar_trUtf8SC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QScrollBar_trUtf8_s_c".}
proc fcQScrollBar_trUtf8SCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QScrollBar_trUtf8_s_c_n".}
...
proc fcQScrollBar_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.importc: "QScrollBar_virtualbase_nativeEvent".}
...
proc trUtf8*(_: type gen_qscrollbar_types.QScrollBar, s: cstring): string =
  let v_ms = fcQScrollBar_trUtf8S(s)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc fcQScrollBar_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let vtbl = cast[ptr QScrollBarVTable](fcQScrollBar_vdata(self)[])
  let self = QScrollBar(h: self)
...
method enterEvent*(self: VirtualQScrollBar, event: gen_qcoreevent_types.QEvent): void {.base.} =
...
proc fcQScrollBar_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let inst = cast[VirtualQScrollBar](fcQScrollBar_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
