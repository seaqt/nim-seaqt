...
proc fcQScrollBar_trUtf8(s: cstring): struct_seaqt_string {.importc: "QScrollBar_trUtf8".}
...
proc fcQScrollBar_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QScrollBar_trUtf82".}
proc fcQScrollBar_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QScrollBar_trUtf83".}
...
proc fcQScrollBar_new2(vtbl: pointer, vdata: csize_t, param1: cint): ptr cQScrollBar {.importc: "QScrollBar_new2".}
proc fcQScrollBar_new3(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQScrollBar {.importc: "QScrollBar_new3".}
