...
proc fcQScrollBar_createStandardContextMenu(self: pointer, position: pointer): pointer {.importc: "QScrollBar_createStandardContextMenu".}
...
proc fcQScrollBar_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.importc: "QScrollBar_virtualbase_nativeEvent".}
...
proc fcQScrollBar_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QScrollBar_protectedbase_getDecodedMetricF".}
proc fcQScrollBar_new(vtbl: pointer, vdata: csize_t): ptr cQScrollBar {.importc: "QScrollBar_new".}
proc fcQScrollBar_new2(vtbl: pointer, vdata: csize_t, param1: cint): ptr cQScrollBar {.importc: "QScrollBar_new_Qt_Orientation".}
proc fcQScrollBar_new3(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQScrollBar {.importc: "QScrollBar_new_QWidget".}
...
proc createStandardContextMenu*(self: gen_qscrollbar_types.QScrollBar, position: gen_qpoint_types.QPoint): gen_qmenu_types.QMenu =
  gen_qmenu_types.QMenu(h: fcQScrollBar_createStandardContextMenu(self.h, position.h), owned: false)
...
proc QScrollBarnativeEvent*(self: gen_qscrollbar_types.QScrollBar, eventType: openArray[byte], message: pointer, resultVal: ptr uint): bool =
  fcQScrollBar_virtualbase_nativeEvent(self.h, struct_seaqt_string(data: if len(eventType) > 0: addr eventType[0] else: nil, len: csize_t(len(eventType))), message, resultVal)
...
proc fcQScrollBar_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QScrollBarVTable](fcQScrollBar_vdata(self)[])
  let self = QScrollBar(h: self)
...
proc fcQScrollBar_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let inst = cast[VirtualQScrollBar](fcQScrollBar_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc getDecodedMetricF*(self: gen_qscrollbar_types.QScrollBar, metricA: cint, metricB: cint): float64 =
  fcQScrollBar_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
...
proc create*(T: type gen_qscrollbar_types.QScrollBar,
  ...
  let tmp = gen_qscrollbar_types.QScrollBar(h: fcQScrollBar_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
...
proc create*(T: type gen_qscrollbar_types.QScrollBar,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQScrollBar_vtable_callback_disconnectNotify
  let tmp = gen_qscrollbar_types.QScrollBar(h: fcQScrollBar_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), cint(param1)), owned: true)
  fcQScrollBar_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qscrollbar_types.QScrollBar,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQScrollBar_vtable_callback_disconnectNotify
  let tmp = gen_qscrollbar_types.QScrollBar(h: fcQScrollBar_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQScrollBar_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qscrollbar_types.QScrollBar,
...
proc create*(T: type gen_qscrollbar_types.QScrollBar,
  ...
  inst[].h = fcQScrollBar_new(addr(cQScrollBar_mvtbl), csize_t(sizeof(pointer)))
...
proc create*(T: type gen_qscrollbar_types.QScrollBar,
    ...
    inst: VirtualQScrollBar) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQScrollBar_new2(addr(cQScrollBar_mvtbl), csize_t(sizeof(pointer)), cint(param1))
  fcQScrollBar_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qscrollbar_types.QScrollBar,
    ...
    inst: VirtualQScrollBar) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQScrollBar_new3(addr(cQScrollBar_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQScrollBar_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
