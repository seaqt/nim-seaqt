...
proc fcQMouseEventTransition_trUtf8(s: cstring): struct_seaqt_string {.importc: "QMouseEventTransition_trUtf8".}
...
proc fcQMouseEventTransition_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QMouseEventTransition_trUtf82".}
proc fcQMouseEventTransition_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QMouseEventTransition_trUtf83".}
