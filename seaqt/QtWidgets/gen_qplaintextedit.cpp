...
VirtualQPlainTextEdit* QPlainTextEdit_new(const QPlainTextEdit_VTable* vtbl, size_t vdata, QWidget* parent) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQPlainTextEdit>());
...
VirtualQPlainTextEdit* QPlainTextEdit_new3(const QPlainTextEdit_VTable* vtbl, size_t vdata, struct miqt_string text) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQPlainTextEdit>());
	return _mem_ ? new (_mem_)VirtualQPlainTextEdit(vtbl, text_QString) : nullptr;
}

VirtualQPlainTextEdit* QPlainTextEdit_new4(const QPlainTextEdit_VTable* vtbl, size_t vdata, struct miqt_string text, QWidget* parent) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQPlainTextEdit>());
...
VirtualQPlainTextDocumentLayout* QPlainTextDocumentLayout_new(const QPlainTextDocumentLayout_VTable* vtbl, size_t vdata, QTextDocument* document) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQPlainTextDocumentLayout>());
