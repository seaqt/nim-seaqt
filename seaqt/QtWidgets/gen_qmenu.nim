...
proc fcQMenu_new3(vtbl: pointer, vdata: csize_t, title: struct_miqt_string): ptr cQMenu {.importc: "QMenu_new3".}
proc fcQMenu_new4(vtbl: pointer, vdata: csize_t, title: struct_miqt_string, parent: pointer): ptr cQMenu {.importc: "QMenu_new4".}
...
proc addMenu*(self: gen_qmenu_types.QMenu, title: string): gen_qmenu_types.QMenu =
  gen_qmenu_types.QMenu(h: fcQMenu_addMenuWithTitle(self.h, struct_miqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title)))))

proc addMenu*(self: gen_qmenu_types.QMenu, icon: gen_qicon_types.QIcon, title: string): gen_qmenu_types.QMenu =
  gen_qmenu_types.QMenu(h: fcQMenu_addMenu2(self.h, icon.h, struct_miqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title)))))
...
proc addSection*(self: gen_qmenu_types.QMenu, text: string): gen_qaction_types.QAction =
  gen_qaction_types.QAction(h: fcQMenu_addSection(self.h, struct_miqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text)))))

proc addSection*(self: gen_qmenu_types.QMenu, icon: gen_qicon_types.QIcon, text: string): gen_qaction_types.QAction =
  gen_qaction_types.QAction(h: fcQMenu_addSection2(self.h, icon.h, struct_miqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text)))))
...
proc insertSection*(self: gen_qmenu_types.QMenu, before: gen_qaction_types.QAction, text: string): gen_qaction_types.QAction =
  gen_qaction_types.QAction(h: fcQMenu_insertSection(self.h, before.h, struct_miqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text)))))
...
proc insertSection*(self: gen_qmenu_types.QMenu, before: gen_qaction_types.QAction, icon: gen_qicon_types.QIcon, text: string): gen_qaction_types.QAction =
  gen_qaction_types.QAction(h: fcQMenu_insertSection2(self.h, before.h, icon.h, struct_miqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text)))))
...
proc create*(T: type gen_qmenu_types.QMenu,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQMenu_vtable_callback_disconnectNotify
  let tmp = gen_qmenu_types.QMenu(h: fcQMenu_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_miqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title)))))
  fcQMenu_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qmenu_types.QMenu,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQMenu_vtable_callback_disconnectNotify
  let tmp = gen_qmenu_types.QMenu(h: fcQMenu_new4(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_miqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), parent.h))
  fcQMenu_vdata(tmp.h)[] = addr(vtbl[])
  tmp
...
proc create*(T: type gen_qmenu_types.QMenu,
    ...
    inst: VirtualQMenu) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQMenu_new3(addr(cQMenu_mvtbl), csize_t(sizeof(pointer)), struct_miqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))))
  fcQMenu_vdata(inst[].h)[] = addr inst[]
...
proc create*(T: type gen_qmenu_types.QMenu,
    ...
    inst: VirtualQMenu) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQMenu_new4(addr(cQMenu_mvtbl), csize_t(sizeof(pointer)), struct_miqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), parent.h)
  fcQMenu_vdata(inst[].h)[] = addr inst[]
