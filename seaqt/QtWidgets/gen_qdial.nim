...
proc fcQDial_new(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQDial {.importc: "QDial_new_parent".}
proc fcQDial_new2(vtbl: pointer, vdata: csize_t): ptr cQDial {.importc: "QDial_new".}
