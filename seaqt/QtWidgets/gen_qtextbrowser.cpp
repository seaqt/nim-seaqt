...
public:
	...
	friend bool QTextBrowser_virtualbase_nativeEvent(VirtualQTextBrowser* self, struct miqt_string eventType, void* message, intptr_t* result);
...
VirtualQTextBrowser* QTextBrowser_new(const QTextBrowser_VTable* vtbl, size_t vdata, QWidget* parent) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQTextBrowser>());
