...
proc create*(T: type gen_qabstractslider_types.QAbstractSlider,
  ...
  let tmp = gen_qabstractslider_types.QAbstractSlider(h: fcQAbstractSlider_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))))
...
proc create*(T: type gen_qabstractslider_types.QAbstractSlider,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQAbstractSlider_vtable_callback_disconnectNotify
  let tmp = gen_qabstractslider_types.QAbstractSlider(h: fcQAbstractSlider_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h))
  fcQAbstractSlider_vdata(tmp.h)[] = addr(vtbl[])
  tmp
