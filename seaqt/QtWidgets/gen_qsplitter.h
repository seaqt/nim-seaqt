...
typedef struct QSplitter_VTable{
	...
	bool (*nativeEvent)(VirtualQSplitter* self, struct miqt_string eventType, void* message, intptr_t* result);
...
typedef struct QSplitterHandle_VTable{
	...
	bool (*nativeEvent)(VirtualQSplitterHandle* self, struct miqt_string eventType, void* message, intptr_t* result);
