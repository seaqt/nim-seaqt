...
public:
	...
	friend bool QDial_virtualbase_nativeEvent(VirtualQDial* self, struct miqt_string eventType, void* message, long* result);
...
bool QDial_virtualbase_nativeEvent(VirtualQDial* self, struct miqt_string eventType, void* message, long* result) {
