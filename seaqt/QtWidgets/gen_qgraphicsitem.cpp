...
VirtualQGraphicsItem* QGraphicsItem_new(const QGraphicsItem_VTable* vtbl, size_t vdata) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQGraphicsItem>());
...
VirtualQGraphicsObject* QGraphicsObject_new(const QGraphicsObject_VTable* vtbl, size_t vdata) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQGraphicsObject>());
...
VirtualQAbstractGraphicsShapeItem* QAbstractGraphicsShapeItem_new(const QAbstractGraphicsShapeItem_VTable* vtbl, size_t vdata) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQAbstractGraphicsShapeItem>());
...
VirtualQGraphicsPathItem* QGraphicsPathItem_new(const QGraphicsPathItem_VTable* vtbl, size_t vdata) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQGraphicsPathItem>());
...
VirtualQGraphicsRectItem* QGraphicsRectItem_new(const QGraphicsRectItem_VTable* vtbl, size_t vdata) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQGraphicsRectItem>());
...
VirtualQGraphicsEllipseItem* QGraphicsEllipseItem_new(const QGraphicsEllipseItem_VTable* vtbl, size_t vdata) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQGraphicsEllipseItem>());
...
VirtualQGraphicsPolygonItem* QGraphicsPolygonItem_new(const QGraphicsPolygonItem_VTable* vtbl, size_t vdata) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQGraphicsPolygonItem>());
...
VirtualQGraphicsLineItem* QGraphicsLineItem_new(const QGraphicsLineItem_VTable* vtbl, size_t vdata) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQGraphicsLineItem>());
...
VirtualQGraphicsPixmapItem* QGraphicsPixmapItem_new(const QGraphicsPixmapItem_VTable* vtbl, size_t vdata) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQGraphicsPixmapItem>());
...
VirtualQGraphicsTextItem* QGraphicsTextItem_new(const QGraphicsTextItem_VTable* vtbl, size_t vdata) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQGraphicsTextItem>());
	return _mem_ ? new (_mem_)VirtualQGraphicsTextItem(vtbl) : nullptr;
}

VirtualQGraphicsTextItem* QGraphicsTextItem_new2(const QGraphicsTextItem_VTable* vtbl, size_t vdata, struct miqt_string text) {
...
VirtualQGraphicsTextItem* QGraphicsTextItem_new4(const QGraphicsTextItem_VTable* vtbl, size_t vdata, struct miqt_string text, QGraphicsItem* parent) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQGraphicsTextItem>());
...
VirtualQGraphicsSimpleTextItem* QGraphicsSimpleTextItem_new(const QGraphicsSimpleTextItem_VTable* vtbl, size_t vdata) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQGraphicsSimpleTextItem>());
	return _mem_ ? new (_mem_)VirtualQGraphicsSimpleTextItem(vtbl) : nullptr;
}

VirtualQGraphicsSimpleTextItem* QGraphicsSimpleTextItem_new2(const QGraphicsSimpleTextItem_VTable* vtbl, size_t vdata, struct miqt_string text) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQGraphicsSimpleTextItem>());
...
VirtualQGraphicsSimpleTextItem* QGraphicsSimpleTextItem_new4(const QGraphicsSimpleTextItem_VTable* vtbl, size_t vdata, struct miqt_string text, QGraphicsItem* parent) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQGraphicsSimpleTextItem>());
...
VirtualQGraphicsItemGroup* QGraphicsItemGroup_new(const QGraphicsItemGroup_VTable* vtbl, size_t vdata) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQGraphicsItemGroup>());
