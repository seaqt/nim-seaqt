...
proc fcQTextEdit_new2(vtbl: pointer, vdata: csize_t, text: struct_seaqt_string): ptr cQTextEdit {.importc: "QTextEdit_new2".}
proc fcQTextEdit_new3(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQTextEdit {.importc: "QTextEdit_new3".}
