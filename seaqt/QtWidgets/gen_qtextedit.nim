...
proc fcQTextEdit_new(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQTextEdit {.importc: "QTextEdit_new_parent".}
proc fcQTextEdit_new2(vtbl: pointer, vdata: csize_t): ptr cQTextEdit {.importc: "QTextEdit_new".}
proc fcQTextEdit_new3(vtbl: pointer, vdata: csize_t, text: struct_seaqt_string): ptr cQTextEdit {.importc: "QTextEdit_new_text".}
...
proc create*(T: type gen_qtextedit_types.QTextEdit,
  ...
  let tmp = gen_qtextedit_types.QTextEdit(h: fcQTextEdit_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
...
proc create*(T: type gen_qtextedit_types.QTextEdit,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQTextEdit_vtable_callback_disconnectNotify
  let tmp = gen_qtextedit_types.QTextEdit(h: fcQTextEdit_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQTextEdit_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qtextedit_types.QTextEdit,
    text: openArray[char],
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQTextEdit_vtable_callback_disconnectNotify
  let tmp = gen_qtextedit_types.QTextEdit(h: fcQTextEdit_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text)))), owned: true)
  fcQTextEdit_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qtextedit_types.QTextEdit,
...
proc create*(T: type gen_qtextedit_types.QTextEdit,
  ...
  inst[].h = fcQTextEdit_new(addr(cQTextEdit_mvtbl), csize_t(sizeof(pointer)), parent.h)
...
proc create*(T: type gen_qtextedit_types.QTextEdit,
    inst: VirtualQTextEdit) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQTextEdit_new2(addr(cQTextEdit_mvtbl), csize_t(sizeof(pointer)))
  fcQTextEdit_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qtextedit_types.QTextEdit,
    ...
    inst: VirtualQTextEdit) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQTextEdit_new3(addr(cQTextEdit_mvtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))))
  fcQTextEdit_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
