...
VirtualQRadioButton* QRadioButton_new(const QRadioButton_VTable* vtbl, size_t vdata, QWidget* parent) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQRadioButton>());
...
VirtualQRadioButton* QRadioButton_new3(const QRadioButton_VTable* vtbl, size_t vdata, struct miqt_string text) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQRadioButton>());
	return _mem_ ? new (_mem_)VirtualQRadioButton(vtbl, text_QString) : nullptr;
}

VirtualQRadioButton* QRadioButton_new4(const QRadioButton_VTable* vtbl, size_t vdata, struct miqt_string text, QWidget* parent) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQRadioButton>());
