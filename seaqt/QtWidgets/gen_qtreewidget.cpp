...
VirtualQTreeWidgetItem* QTreeWidgetItem_new(const QTreeWidgetItem_VTable* vtbl, size_t vdata) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQTreeWidgetItem>());
	return _mem_ ? new (_mem_)VirtualQTreeWidgetItem(vtbl) : nullptr;
}

VirtualQTreeWidgetItem* QTreeWidgetItem_new2(const QTreeWidgetItem_VTable* vtbl, size_t vdata, struct miqt_array /* of struct miqt_string */  strings) {
...
VirtualQTreeWidgetItem* QTreeWidgetItem_new4(const QTreeWidgetItem_VTable* vtbl, size_t vdata, QTreeWidget* treeview, struct miqt_array /* of struct miqt_string */  strings) {
	QStringList strings_QList;
	strings_QList.reserve(strings.len);
	struct miqt_string* strings_arr = static_cast<struct miqt_string*>(strings.data);
	for(size_t i = 0; i < strings.len; ++i) {
...
VirtualQTreeWidgetItem* QTreeWidgetItem_new7(const QTreeWidgetItem_VTable* vtbl, size_t vdata, QTreeWidgetItem* parent, struct miqt_array /* of struct miqt_string */  strings) {
	QStringList strings_QList;
	strings_QList.reserve(strings.len);
	struct miqt_string* strings_arr = static_cast<struct miqt_string*>(strings.data);
	for(size_t i = 0; i < strings.len; ++i) {
...
VirtualQTreeWidgetItem* QTreeWidgetItem_new11(const QTreeWidgetItem_VTable* vtbl, size_t vdata, struct miqt_array /* of struct miqt_string */  strings, int type) {
	QStringList strings_QList;
	strings_QList.reserve(strings.len);
	struct miqt_string* strings_arr = static_cast<struct miqt_string*>(strings.data);
	for(size_t i = 0; i < strings.len; ++i) {
...
VirtualQTreeWidgetItem* QTreeWidgetItem_new13(const QTreeWidgetItem_VTable* vtbl, size_t vdata, QTreeWidget* treeview, struct miqt_array /* of struct miqt_string */  strings, int type) {
	QStringList strings_QList;
	strings_QList.reserve(strings.len);
	struct miqt_string* strings_arr = static_cast<struct miqt_string*>(strings.data);
	for(size_t i = 0; i < strings.len; ++i) {
...
VirtualQTreeWidgetItem* QTreeWidgetItem_new16(const QTreeWidgetItem_VTable* vtbl, size_t vdata, QTreeWidgetItem* parent, struct miqt_array /* of struct miqt_string */  strings, int type) {
	QStringList strings_QList;
	strings_QList.reserve(strings.len);
	struct miqt_string* strings_arr = static_cast<struct miqt_string*>(strings.data);
	for(size_t i = 0; i < strings.len; ++i) {
...
public:
	...
	friend bool QTreeWidget_virtualbase_nativeEvent(VirtualQTreeWidget* self, struct miqt_string eventType, void* message, intptr_t* result);
...
VirtualQTreeWidget* QTreeWidget_new(const QTreeWidget_VTable* vtbl, size_t vdata, QWidget* parent) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQTreeWidget>());
...
bool QTreeWidget_virtualbase_nativeEvent(VirtualQTreeWidget* self, struct miqt_string eventType, void* message, intptr_t* result) {
