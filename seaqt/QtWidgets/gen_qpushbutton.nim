...
proc miqt_exec_method_cQPushButton_mouseMoveEvent(vtbl: pointer, inst: pointer, param1: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQPushButton](cast[uint](vtbl) - uint(offsetOf(VirtualQPushButton, vtbl)))
  let slotval1 = gen_qevent_types.QMouseEvent(h: param1, owned: false)
...
proc miqt_exec_method_cQPushButton_initStyleOption(vtbl: pointer, inst: pointer, option: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQPushButton](cast[uint](vtbl) - uint(offsetOf(VirtualQPushButton, vtbl)))
  let slotval1 = gen_qstyleoption_types.QStyleOptionButton(h: option, owned: false)
...
proc miqt_exec_method_cQPushButton_nativeEvent(vtbl: pointer, inst: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[VirtualQPushButton](cast[uint](vtbl) - uint(offsetOf(VirtualQPushButton, vtbl)))
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArrayByte(veventType_bytearray.data, 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc create*(T: type gen_qpushbutton_types.QPushButton,
  ...
  vtbl[].vtbl.initStyleOption = miqt_exec_method_cQPushButton_initStyleOption
