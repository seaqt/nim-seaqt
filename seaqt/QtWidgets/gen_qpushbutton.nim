...
proc create*(T: type gen_qpushbutton_types.QPushButton,
  ...
  let tmp = gen_qpushbutton_types.QPushButton(h: fcQPushButton_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))))
...
proc create*(T: type gen_qpushbutton_types.QPushButton,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQPushButton_vtable_callback_disconnectNotify
  let tmp = gen_qpushbutton_types.QPushButton(h: fcQPushButton_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text)))))
  fcQPushButton_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qpushbutton_types.QPushButton,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQPushButton_vtable_callback_disconnectNotify
  let tmp = gen_qpushbutton_types.QPushButton(h: fcQPushButton_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), icon.h, struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text)))))
  fcQPushButton_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qpushbutton_types.QPushButton,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQPushButton_vtable_callback_disconnectNotify
  let tmp = gen_qpushbutton_types.QPushButton(h: fcQPushButton_new4(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h))
  fcQPushButton_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qpushbutton_types.QPushButton,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQPushButton_vtable_callback_disconnectNotify
  let tmp = gen_qpushbutton_types.QPushButton(h: fcQPushButton_new5(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), parent.h))
  fcQPushButton_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qpushbutton_types.QPushButton,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQPushButton_vtable_callback_disconnectNotify
  let tmp = gen_qpushbutton_types.QPushButton(h: fcQPushButton_new6(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), icon.h, struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), parent.h))
  fcQPushButton_vdata(tmp.h)[] = addr(vtbl[])
  tmp
