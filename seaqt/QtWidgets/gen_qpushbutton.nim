...
proc fcQPushButton_new2(vtbl: pointer, vdata: csize_t, text: struct_seaqt_string): ptr cQPushButton {.importc: "QPushButton_new2".}
proc fcQPushButton_new3(vtbl: pointer, vdata: csize_t, icon: pointer, text: struct_seaqt_string): ptr cQPushButton {.importc: "QPushButton_new3".}
proc fcQPushButton_new4(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQPushButton {.importc: "QPushButton_new4".}
