...
proc create*(T: type gen_qstackedlayout_types.QStackedLayout,
  ...
  let tmp = gen_qstackedlayout_types.QStackedLayout(h: fcQStackedLayout_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))))
...
proc create*(T: type gen_qstackedlayout_types.QStackedLayout,
  ...
  if not isNil(vtbl[].spacerItem):
    vtbl[].vtbl.spacerItem = fcQStackedLayout_vtable_callback_spacerItem
  let tmp = gen_qstackedlayout_types.QStackedLayout(h: fcQStackedLayout_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h))
  fcQStackedLayout_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qstackedlayout_types.QStackedLayout,
