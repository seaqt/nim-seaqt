...
proc fcQStackedLayout_new(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQStackedLayout {.importc: "QStackedLayout_new".}
proc fcQStackedLayout_new2(vtbl: pointer, vdata: csize_t): ptr cQStackedLayout {.importc: "QStackedLayout_new2".}
