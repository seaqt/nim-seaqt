...
proc cQTextBrowser_vtable_callback_doSetSource(self: pointer, name: pointer, typeVal: cint): void {.cdecl.} =
  let vtbl = cast[ptr QTextBrowserVTable](fcQTextBrowser_vdata(self))
  let self = QTextBrowser(h: self)
...
proc cQTextBrowser_vtable_callback_initStyleOption(self: pointer, option: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTextBrowserVTable](fcQTextBrowser_vdata(self))
  let self = QTextBrowser(h: self)
...
proc cQTextBrowser_vtable_callback_nativeEvent(self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QTextBrowserVTable](fcQTextBrowser_vdata(self))
  let self = QTextBrowser(h: self)
...
proc cQTextBrowser_method_callback_doSetSource(self: pointer, name: pointer, typeVal: cint): void {.cdecl.} =
  let inst = cast[VirtualQTextBrowser](fcQTextBrowser_vdata(self))
  let slotval1 = gen_qurl_types.QUrl(h: name, owned: false)
  let slotval2 = cint(typeVal)
...
proc cQTextBrowser_method_callback_initStyleOption(self: pointer, option: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTextBrowser](fcQTextBrowser_vdata(self))
  let slotval1 = gen_qstyleoption_types.QStyleOptionFrame(h: option, owned: false)
...
proc cQTextBrowser_method_callback_nativeEvent(self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let inst = cast[VirtualQTextBrowser](fcQTextBrowser_vdata(self))
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc create*(T: type gen_qtextbrowser_types.QTextBrowser,
  ...
  if not isNil(vtbl[].doSetSource):
    vtbl[].vtbl.doSetSource = cQTextBrowser_vtable_callback_doSetSource
  ...
  if not isNil(vtbl[].initStyleOption):
    vtbl[].vtbl.initStyleOption = cQTextBrowser_vtable_callback_initStyleOption
...
const cQTextBrowser_mvtbl = cQTextBrowserVTable(
  ...
  doSetSource: cQTextBrowser_method_callback_doSetSource,
  ...
  initStyleOption: cQTextBrowser_method_callback_initStyleOption,
