...
proc fcQTextBrowser_slot_callback_highlightedWithQString(slot: int, param1: struct_miqt_string) {.cdecl.} =
...
proc fcQTextBrowser_vtable_callback_nativeEvent(self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let vtbl = cast[ptr QTextBrowserVTable](fcQTextBrowser_vdata(self))
  let self = QTextBrowser(h: self)
...
proc fcQTextBrowser_method_callback_nativeEvent(self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let inst = cast[VirtualQTextBrowser](fcQTextBrowser_vdata(self))
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
