...
proc fcQTextBrowser_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.importc: "QTextBrowser_virtualbase_nativeEvent".}
...
proc fcQTextBrowser_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QTextBrowser_protectedbase_getDecodedMetricF".}
...
proc fcQTextBrowser_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QTextBrowserVTable](fcQTextBrowser_vdata(self)[])
  let self = QTextBrowser(h: self)
...
proc fcQTextBrowser_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let inst = cast[VirtualQTextBrowser](fcQTextBrowser_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc getDecodedMetricF*(self: gen_qtextbrowser_types.QTextBrowser, metricA: cint, metricB: cint): float64 =
  fcQTextBrowser_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
