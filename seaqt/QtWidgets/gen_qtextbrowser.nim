...
proc create*(T: type gen_qtextbrowser_types.QTextBrowser,
  ...
  let tmp = gen_qtextbrowser_types.QTextBrowser(h: fcQTextBrowser_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
...
proc create*(T: type gen_qtextbrowser_types.QTextBrowser,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQTextBrowser_vtable_callback_disconnectNotify
  let tmp = gen_qtextbrowser_types.QTextBrowser(h: fcQTextBrowser_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQTextBrowser_vdata(tmp.h)[] = addr(vtbl[])
  tmp
...
proc create*(T: type gen_qtextbrowser_types.QTextBrowser,
  ...
  inst[].h = fcQTextBrowser_new(addr(cQTextBrowser_mvtbl), csize_t(sizeof(pointer)))
...
proc create*(T: type gen_qtextbrowser_types.QTextBrowser,
    ...
    inst: VirtualQTextBrowser) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQTextBrowser_new2(addr(cQTextBrowser_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQTextBrowser_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
