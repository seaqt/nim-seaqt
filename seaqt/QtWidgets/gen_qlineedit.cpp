...
VirtualQLineEdit* QLineEdit_new(const QLineEdit_VTable* vtbl, size_t vdata, QWidget* parent) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQLineEdit>());
...
VirtualQLineEdit* QLineEdit_new3(const QLineEdit_VTable* vtbl, size_t vdata, struct miqt_string param1) {
	QString param1_QString = QString::fromUtf8(param1.data, param1.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQLineEdit>());
	return _mem_ ? new (_mem_)VirtualQLineEdit(vtbl, param1_QString) : nullptr;
}

VirtualQLineEdit* QLineEdit_new4(const QLineEdit_VTable* vtbl, size_t vdata, struct miqt_string param1, QWidget* parent) {
	QString param1_QString = QString::fromUtf8(param1.data, param1.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQLineEdit>());
