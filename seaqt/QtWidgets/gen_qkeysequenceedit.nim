...
proc fcQKeySequenceEdit_maximumSequenceLength(self: pointer): int64 {.importc: "QKeySequenceEdit_maximumSequenceLength".}
...
proc fcQKeySequenceEdit_setFinishingKeyCombinations(self: pointer, finishingKeyCombinations: struct_seaqt_array): void {.importc: "QKeySequenceEdit_setFinishingKeyCombinations".}
proc fcQKeySequenceEdit_finishingKeyCombinations(self: pointer): struct_seaqt_array {.importc: "QKeySequenceEdit_finishingKeyCombinations".}
...
proc fcQKeySequenceEdit_setMaximumSequenceLength(self: pointer, count: int64): void {.importc: "QKeySequenceEdit_setMaximumSequenceLength".}
...
proc fcQKeySequenceEdit_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.importc: "QKeySequenceEdit_virtualbase_nativeEvent".}
...
proc fcQKeySequenceEdit_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QKeySequenceEdit_protectedbase_getDecodedMetricF".}
proc fcQKeySequenceEdit_new(vtbl: pointer, vdata: csize_t): ptr cQKeySequenceEdit {.importc: "QKeySequenceEdit_new".}
proc fcQKeySequenceEdit_new2(vtbl: pointer, vdata: csize_t, keySequence: pointer): ptr cQKeySequenceEdit {.importc: "QKeySequenceEdit_new_keySequence".}
proc fcQKeySequenceEdit_new3(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQKeySequenceEdit {.importc: "QKeySequenceEdit_new_parent".}
...
proc maximumSequenceLength*(self: gen_qkeysequenceedit_types.QKeySequenceEdit): int64 =
  fcQKeySequenceEdit_maximumSequenceLength(self.h)
...
proc setFinishingKeyCombinations*(self: gen_qkeysequenceedit_types.QKeySequenceEdit, finishingKeyCombinations: openArray[gen_qnamespace_types.QKeyCombination]): void =
  var finishingKeyCombinations_CArray = newSeq[pointer](len(finishingKeyCombinations))
  for i in 0..<len(finishingKeyCombinations):
    finishingKeyCombinations_CArray[i] = finishingKeyCombinations[i].h

  fcQKeySequenceEdit_setFinishingKeyCombinations(self.h, struct_seaqt_array(len: csize_t(len(finishingKeyCombinations)), data: if len(finishingKeyCombinations) == 0: nil else: addr(finishingKeyCombinations_CArray[0])))

proc finishingKeyCombinations*(self: gen_qkeysequenceedit_types.QKeySequenceEdit): seq[gen_qnamespace_types.QKeyCombination] =
  var v_ma = fcQKeySequenceEdit_finishingKeyCombinations(self.h)
  var vx_ret = newSeq[gen_qnamespace_types.QKeyCombination](int(v_ma.len))
  let v_outCast = cast[ptr UncheckedArray[pointer]](v_ma.data)
  for i in 0 ..< v_ma.len:
    vx_ret[i] = gen_qnamespace_types.QKeyCombination(h: v_outCast[i], owned: true)
  c_free(v_ma.data)
  vx_ret
...
proc setMaximumSequenceLength*(self: gen_qkeysequenceedit_types.QKeySequenceEdit, count: int64): void =
  fcQKeySequenceEdit_setMaximumSequenceLength(self.h, count)
...
proc QKeySequenceEditnativeEvent*(self: gen_qkeysequenceedit_types.QKeySequenceEdit, eventType: openArray[byte], message: pointer, resultVal: ptr uint): bool =
  fcQKeySequenceEdit_virtualbase_nativeEvent(self.h, struct_seaqt_string(data: if len(eventType) > 0: addr eventType[0] else: nil, len: csize_t(len(eventType))), message, resultVal)
...
proc fcQKeySequenceEdit_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QKeySequenceEditVTable](fcQKeySequenceEdit_vdata(self)[])
  let self = QKeySequenceEdit(h: self)
...
proc fcQKeySequenceEdit_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let inst = cast[VirtualQKeySequenceEdit](fcQKeySequenceEdit_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc getDecodedMetricF*(self: gen_qkeysequenceedit_types.QKeySequenceEdit, metricA: cint, metricB: cint): float64 =
  fcQKeySequenceEdit_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
...
proc create*(T: type gen_qkeysequenceedit_types.QKeySequenceEdit,
  ...
  let tmp = gen_qkeysequenceedit_types.QKeySequenceEdit(h: fcQKeySequenceEdit_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
...
proc create*(T: type gen_qkeysequenceedit_types.QKeySequenceEdit,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQKeySequenceEdit_vtable_callback_disconnectNotify
  let tmp = gen_qkeysequenceedit_types.QKeySequenceEdit(h: fcQKeySequenceEdit_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), keySequence.h), owned: true)
  fcQKeySequenceEdit_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qkeysequenceedit_types.QKeySequenceEdit,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQKeySequenceEdit_vtable_callback_disconnectNotify
  let tmp = gen_qkeysequenceedit_types.QKeySequenceEdit(h: fcQKeySequenceEdit_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQKeySequenceEdit_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qkeysequenceedit_types.QKeySequenceEdit,
...
proc create*(T: type gen_qkeysequenceedit_types.QKeySequenceEdit,
  ...
  inst[].h = fcQKeySequenceEdit_new(addr(cQKeySequenceEdit_mvtbl), csize_t(sizeof(pointer)))
...
proc create*(T: type gen_qkeysequenceedit_types.QKeySequenceEdit,
    ...
    inst: VirtualQKeySequenceEdit) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQKeySequenceEdit_new2(addr(cQKeySequenceEdit_mvtbl), csize_t(sizeof(pointer)), keySequence.h)
  fcQKeySequenceEdit_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qkeysequenceedit_types.QKeySequenceEdit,
    ...
    inst: VirtualQKeySequenceEdit) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQKeySequenceEdit_new3(addr(cQKeySequenceEdit_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQKeySequenceEdit_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
