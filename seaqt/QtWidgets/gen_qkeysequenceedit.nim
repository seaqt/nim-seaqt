...
proc create*(T: type gen_qkeysequenceedit_types.QKeySequenceEdit,
  ...
  let tmp = gen_qkeysequenceedit_types.QKeySequenceEdit(h: fcQKeySequenceEdit_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))))
...
proc create*(T: type gen_qkeysequenceedit_types.QKeySequenceEdit,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQKeySequenceEdit_vtable_callback_disconnectNotify
  let tmp = gen_qkeysequenceedit_types.QKeySequenceEdit(h: fcQKeySequenceEdit_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), keySequence.h))
  fcQKeySequenceEdit_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qkeysequenceedit_types.QKeySequenceEdit,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQKeySequenceEdit_vtable_callback_disconnectNotify
  let tmp = gen_qkeysequenceedit_types.QKeySequenceEdit(h: fcQKeySequenceEdit_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h))
  fcQKeySequenceEdit_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qkeysequenceedit_types.QKeySequenceEdit,
