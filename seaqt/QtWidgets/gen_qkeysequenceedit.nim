...
proc fcQKeySequenceEdit_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.importc: "QKeySequenceEdit_virtualbase_nativeEvent".}
...
proc fcQKeySequenceEdit_vtable_callback_focusOutEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QKeySequenceEditVTable](fcQKeySequenceEdit_vdata(self)[])
  let self = QKeySequenceEdit(h: self)
  let slotval1 = gen_qevent_types.QFocusEvent(h: event, owned: false)
...
proc fcQKeySequenceEdit_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let vtbl = cast[ptr QKeySequenceEditVTable](fcQKeySequenceEdit_vdata(self)[])
  let self = QKeySequenceEdit(h: self)
...
proc fcQKeySequenceEdit_method_callback_focusOutEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQKeySequenceEdit](fcQKeySequenceEdit_vdata(self)[])
  let slotval1 = gen_qevent_types.QFocusEvent(h: event, owned: false)
...
proc fcQKeySequenceEdit_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let inst = cast[VirtualQKeySequenceEdit](fcQKeySequenceEdit_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
