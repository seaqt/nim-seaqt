...
public:
	...
	friend bool QScrollBar_virtualbase_nativeEvent(VirtualQScrollBar* self, struct miqt_string eventType, void* message, long* result);
...
bool QScrollBar_virtualbase_nativeEvent(VirtualQScrollBar* self, struct miqt_string eventType, void* message, long* result) {
