...
proc fcQPlainTextEdit_new(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQPlainTextEdit {.importc: "QPlainTextEdit_new".}
proc fcQPlainTextEdit_new2(vtbl: pointer, vdata: csize_t): ptr cQPlainTextEdit {.importc: "QPlainTextEdit_new2".}
proc fcQPlainTextEdit_new3(vtbl: pointer, vdata: csize_t, text: struct_seaqt_string): ptr cQPlainTextEdit {.importc: "QPlainTextEdit_new3".}
