...
proc fcQPlainTextEdit_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QPlainTextEdit_protectedbase_getDecodedMetricF".}
...
proc getDecodedMetricF*(self: gen_qplaintextedit_types.QPlainTextEdit, metricA: cint, metricB: cint): float64 =
  fcQPlainTextEdit_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
