...
proc fcQPlainTextEdit_placeholderText(self: pointer): struct_seaqt_string {.importc: "QPlainTextEdit_placeholderText".}
...
proc fcQPlainTextEdit_setDocumentTitle(self: pointer, title: struct_seaqt_string): void {.importc: "QPlainTextEdit_setDocumentTitle".}
proc fcQPlainTextEdit_documentTitle(self: pointer): struct_seaqt_string {.importc: "QPlainTextEdit_documentTitle".}
...
proc fcQPlainTextEdit_insertPlainText(self: pointer, text: struct_seaqt_string): void {.importc: "QPlainTextEdit_insertPlainText".}
proc fcQPlainTextEdit_appendPlainText(self: pointer, text: struct_seaqt_string): void {.importc: "QPlainTextEdit_appendPlainText".}
proc fcQPlainTextEdit_appendHtml(self: pointer, html: struct_seaqt_string): void {.importc: "QPlainTextEdit_appendHtml".}
...
proc fcQPlainTextEdit_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.importc: "QPlainTextEdit_virtualbase_nativeEvent".}
...
proc fcQPlainTextEdit_new(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQPlainTextEdit {.importc: "QPlainTextEdit_new_parent".}
proc fcQPlainTextEdit_new2(vtbl: pointer, vdata: csize_t): ptr cQPlainTextEdit {.importc: "QPlainTextEdit_new".}
proc fcQPlainTextEdit_new3(vtbl: pointer, vdata: csize_t, text: struct_seaqt_string): ptr cQPlainTextEdit {.importc: "QPlainTextEdit_new_text".}
...
proc fcQPlainTextDocumentLayout_new(vtbl: pointer, vdata: csize_t, document: pointer): ptr cQPlainTextDocumentLayout {.importc: "QPlainTextDocumentLayout_new".}
...
proc setPlaceholderText*(self: gen_qplaintextedit_types.QPlainTextEdit, placeholderText: openArray[char]): void =
  fcQPlainTextEdit_setPlaceholderText(self.h, struct_seaqt_string(data: if len(placeholderText) > 0: addr placeholderText[0] else: nil, len: csize_t(len(placeholderText))))
...
proc setDocumentTitle*(self: gen_qplaintextedit_types.QPlainTextEdit, title: openArray[char]): void =
  fcQPlainTextEdit_setDocumentTitle(self.h, struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))))
...
proc setExtraSelections*(self: gen_qplaintextedit_types.QPlainTextEdit, selections: openArray[gen_qtextedit_types.QTextEditExtraSelection]): void =
  ...
  fcQPlainTextEdit_setExtraSelections(self.h, struct_seaqt_array(len: csize_t(len(selections)), data: if len(selections) == 0: nil else: addr(selections_CArray[0])))
...
proc insertPlainText*(self: gen_qplaintextedit_types.QPlainTextEdit, text: openArray[char]): void =
  fcQPlainTextEdit_insertPlainText(self.h, struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))))

proc appendPlainText*(self: gen_qplaintextedit_types.QPlainTextEdit, text: openArray[char]): void =
  fcQPlainTextEdit_appendPlainText(self.h, struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))))

proc appendHtml*(self: gen_qplaintextedit_types.QPlainTextEdit, html: openArray[char]): void =
  fcQPlainTextEdit_appendHtml(self.h, struct_seaqt_string(data: if len(html) > 0: addr html[0] else: nil, len: csize_t(len(html))))
...
proc QPlainTextEditnativeEvent*(self: gen_qplaintextedit_types.QPlainTextEdit, eventType: openArray[byte], message: pointer, resultVal: ptr clong): bool =
  fcQPlainTextEdit_virtualbase_nativeEvent(self.h, struct_seaqt_string(data: if len(eventType) > 0: addr eventType[0] else: nil, len: csize_t(len(eventType))), message, resultVal)
...
proc fcQPlainTextEdit_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let vtbl = cast[ptr QPlainTextEditVTable](fcQPlainTextEdit_vdata(self)[])
  let self = QPlainTextEdit(h: self)
...
proc fcQPlainTextEdit_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let inst = cast[VirtualQPlainTextEdit](fcQPlainTextEdit_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc create*(T: type gen_qplaintextedit_types.QPlainTextEdit,
  ...
  let tmp = gen_qplaintextedit_types.QPlainTextEdit(h: fcQPlainTextEdit_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQPlainTextEdit_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qplaintextedit_types.QPlainTextEdit,
    vtbl: ref QPlainTextEditVTable = nil): gen_qplaintextedit_types.QPlainTextEdit =
  let vtbl = if vtbl == nil: new QPlainTextEditVTable else: vtbl
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQPlainTextEdit_vtable_callback_disconnectNotify
  let tmp = gen_qplaintextedit_types.QPlainTextEdit(h: fcQPlainTextEdit_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQPlainTextEdit_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qplaintextedit_types.QPlainTextEdit,
    text: openArray[char],
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQPlainTextEdit_vtable_callback_disconnectNotify
  let tmp = gen_qplaintextedit_types.QPlainTextEdit(h: fcQPlainTextEdit_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text)))), owned: true)
  fcQPlainTextEdit_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qplaintextedit_types.QPlainTextEdit,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQPlainTextEdit_vtable_callback_disconnectNotify
  let tmp = gen_qplaintextedit_types.QPlainTextEdit(h: fcQPlainTextEdit_new4(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), parent.h), owned: true)
  fcQPlainTextEdit_vdata(tmp.h)[] = addr(vtbl[])
  tmp
...
proc create*(T: type gen_qplaintextedit_types.QPlainTextEdit,
  ...
  inst[].h = fcQPlainTextEdit_new(addr(cQPlainTextEdit_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQPlainTextEdit_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true

proc create*(T: type gen_qplaintextedit_types.QPlainTextEdit,
    inst: VirtualQPlainTextEdit) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQPlainTextEdit_new2(addr(cQPlainTextEdit_mvtbl), csize_t(sizeof(pointer)))
  fcQPlainTextEdit_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qplaintextedit_types.QPlainTextEdit,
    ...
    inst: VirtualQPlainTextEdit) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQPlainTextEdit_new3(addr(cQPlainTextEdit_mvtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))))
  fcQPlainTextEdit_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qplaintextedit_types.QPlainTextEdit,
    ...
    inst: VirtualQPlainTextEdit) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQPlainTextEdit_new4(addr(cQPlainTextEdit_mvtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), parent.h)
  fcQPlainTextEdit_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qplaintextedit_types.QPlainTextDocumentLayout,
  ...
  let tmp = gen_qplaintextedit_types.QPlainTextDocumentLayout(h: fcQPlainTextDocumentLayout_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), document.h), owned: true)
  fcQPlainTextDocumentLayout_vdata(tmp.h)[] = addr(vtbl[])
  tmp
...
proc create*(T: type gen_qplaintextedit_types.QPlainTextDocumentLayout,
  ...
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQPlainTextDocumentLayout_new(addr(cQPlainTextDocumentLayout_mvtbl), csize_t(sizeof(pointer)), document.h)
  fcQPlainTextDocumentLayout_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
