...
proc fcQPlainTextEdit_find2(self: pointer, exp: struct_seaqt_string, options: cint): bool {.importc: "QPlainTextEdit_find2".}
proc fcQPlainTextEdit_find3(self: pointer, exp: pointer, options: cint): bool {.importc: "QPlainTextEdit_find3".}
...
proc fcQPlainTextEdit_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.importc: "QPlainTextEdit_virtualbase_nativeEvent".}
...
proc find*(self: gen_qplaintextedit_types.QPlainTextEdit, exp: openArray[char], options: cint): bool =
  fcQPlainTextEdit_find2(self.h, struct_seaqt_string(data: if len(exp) > 0: addr exp[0] else: nil, len: csize_t(len(exp))), cint(options))
...
proc find*(self: gen_qplaintextedit_types.QPlainTextEdit, exp: gen_qregularexpression_types.QRegularExpression, options: cint): bool =
  fcQPlainTextEdit_find3(self.h, exp.h, cint(options))
...
proc fcQPlainTextEdit_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QPlainTextEditVTable](fcQPlainTextEdit_vdata(self)[])
  let self = QPlainTextEdit(h: self)
...
proc fcQPlainTextEdit_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let inst = cast[VirtualQPlainTextEdit](fcQPlainTextEdit_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
