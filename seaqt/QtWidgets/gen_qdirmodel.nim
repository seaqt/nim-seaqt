...
proc fcQDirModel_mimeTypes(self: pointer): struct_seaqt_array {.importc: "QDirModel_mimeTypes".}
proc fcQDirModel_mimeData(self: pointer, indexes: struct_seaqt_array): pointer {.importc: "QDirModel_mimeData".}
...
proc fcQDirModel_setNameFilters(self: pointer, filters: struct_seaqt_array): void {.importc: "QDirModel_setNameFilters".}
proc fcQDirModel_nameFilters(self: pointer): struct_seaqt_array {.importc: "QDirModel_nameFilters".}
...
proc fcQDirModel_filePath(self: pointer, index: pointer): struct_seaqt_string {.importc: "QDirModel_filePath".}
proc fcQDirModel_fileName(self: pointer, index: pointer): struct_seaqt_string {.importc: "QDirModel_fileName".}
...
proc fcQDirModel_virtualbase_mimeTypes(self: pointer): struct_seaqt_array {.importc: "QDirModel_virtualbase_mimeTypes".}
proc fcQDirModel_virtualbase_mimeData(self: pointer, indexes: struct_seaqt_array): pointer {.importc: "QDirModel_virtualbase_mimeData".}
...
proc fcQDirModel_virtualbase_itemData(self: pointer, index: pointer): struct_seaqt_map {.importc: "QDirModel_virtualbase_itemData".}
proc fcQDirModel_virtualbase_setItemData(self: pointer, index: pointer, roles: struct_seaqt_map): bool {.importc: "QDirModel_virtualbase_setItemData".}
...
proc fcQDirModel_virtualbase_match(self: pointer, start: pointer, role: cint, value: pointer, hits: cint, flags: cint): struct_seaqt_array {.importc: "QDirModel_virtualbase_match".}
proc fcQDirModel_virtualbase_span(self: pointer, index: pointer): pointer {.importc: "QDirModel_virtualbase_span".}
proc fcQDirModel_virtualbase_roleNames(self: pointer): struct_seaqt_map {.importc: "QDirModel_virtualbase_roleNames".}
...
proc fcQDirModel_protectedbase_changePersistentIndexList(self: pointer, fromVal: struct_seaqt_array, to: struct_seaqt_array): void {.importc: "QDirModel_protectedbase_changePersistentIndexList".}
proc fcQDirModel_protectedbase_persistentIndexList(self: pointer): struct_seaqt_array {.importc: "QDirModel_protectedbase_persistentIndexList".}
...
proc mimeData*(self: gen_qdirmodel_types.QDirModel, indexes: openArray[gen_qabstractitemmodel_types.QModelIndex]): gen_qmimedata_types.QMimeData =
  ...
  gen_qmimedata_types.QMimeData(h: fcQDirModel_mimeData(self.h, struct_seaqt_array(len: csize_t(len(indexes)), data: if len(indexes) == 0: nil else: addr(indexes_CArray[0]))))
...
proc setNameFilters*(self: gen_qdirmodel_types.QDirModel, filters: openArray[string]): void =
  ...
  fcQDirModel_setNameFilters(self.h, struct_seaqt_array(len: csize_t(len(filters)), data: if len(filters) == 0: nil else: addr(filters_CArray[0])))
...
proc index*(self: gen_qdirmodel_types.QDirModel, path: openArray[char]): gen_qabstractitemmodel_types.QModelIndex =
  gen_qabstractitemmodel_types.QModelIndex(h: fcQDirModel_indexWithPath(self.h, struct_seaqt_string(data: if len(path) > 0: addr path[0] else: nil, len: csize_t(len(path)))))
...
proc mkdir*(self: gen_qdirmodel_types.QDirModel, parent: gen_qabstractitemmodel_types.QModelIndex, name: openArray[char]): gen_qabstractitemmodel_types.QModelIndex =
  gen_qabstractitemmodel_types.QModelIndex(h: fcQDirModel_mkdir(self.h, parent.h, struct_seaqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name)))))
...
proc index*(self: gen_qdirmodel_types.QDirModel, path: openArray[char], column: cint): gen_qabstractitemmodel_types.QModelIndex =
  gen_qabstractitemmodel_types.QModelIndex(h: fcQDirModel_index2(self.h, struct_seaqt_string(data: if len(path) > 0: addr path[0] else: nil, len: csize_t(len(path))), column))
...
proc QDirModelmimeData*(self: gen_qdirmodel_types.QDirModel, indexes: openArray[gen_qabstractitemmodel_types.QModelIndex]): gen_qmimedata_types.QMimeData =
  ...
  gen_qmimedata_types.QMimeData(h: fcQDirModel_virtualbase_mimeData(self.h, struct_seaqt_array(len: csize_t(len(indexes)), data: if len(indexes) == 0: nil else: addr(indexes_CArray[0]))))
...
proc QDirModelsetItemData*(self: gen_qdirmodel_types.QDirModel, index: gen_qabstractitemmodel_types.QModelIndex, roles: Table[cint,gen_qvariant_types.QVariant]): bool =
  ...
  fcQDirModel_virtualbase_setItemData(self.h, index.h, struct_seaqt_map(len: csize_t(len(roles)),keys: if len(roles) == 0: nil else: addr(roles_Keys_CArray[0]), values: if len(roles) == 0: nil else: addr(roles_Values_CArray[0]),))
...
proc fcQDirModel_vtable_callback_mimeTypes(self: pointer): struct_seaqt_array {.cdecl.} =
  let vtbl = cast[ptr QDirModelVTable](fcQDirModel_vdata(self)[])
  let self = QDirModel(h: self)
...
proc fcQDirModel_vtable_callback_mimeData(self: pointer, indexes: struct_seaqt_array): pointer {.cdecl.} =
  let vtbl = cast[ptr QDirModelVTable](fcQDirModel_vdata(self)[])
  let self = QDirModel(h: self)
...
proc fcQDirModel_vtable_callback_itemData(self: pointer, index: pointer): struct_seaqt_map {.cdecl.} =
  let vtbl = cast[ptr QDirModelVTable](fcQDirModel_vdata(self)[])
  let self = QDirModel(h: self)
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index)
...
proc fcQDirModel_vtable_callback_setItemData(self: pointer, index: pointer, roles: struct_seaqt_map): bool {.cdecl.} =
  let vtbl = cast[ptr QDirModelVTable](fcQDirModel_vdata(self)[])
  let self = QDirModel(h: self)
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index)
  var vroles_mm = roles
...
proc fcQDirModel_vtable_callback_match(self: pointer, start: pointer, role: cint, value: pointer, hits: cint, flags: cint): struct_seaqt_array {.cdecl.} =
  let vtbl = cast[ptr QDirModelVTable](fcQDirModel_vdata(self)[])
  let self = QDirModel(h: self)
...
proc fcQDirModel_vtable_callback_roleNames(self: pointer): struct_seaqt_map {.cdecl.} =
  let vtbl = cast[ptr QDirModelVTable](fcQDirModel_vdata(self)[])
  let self = QDirModel(h: self)
...
proc fcQDirModel_method_callback_mimeTypes(self: pointer): struct_seaqt_array {.cdecl.} =
  let inst = cast[VirtualQDirModel](fcQDirModel_vdata(self)[])
...
proc fcQDirModel_method_callback_mimeData(self: pointer, indexes: struct_seaqt_array): pointer {.cdecl.} =
  let inst = cast[VirtualQDirModel](fcQDirModel_vdata(self)[])
  var vindexes_ma = indexes
  var vindexesx_ret = newSeq[gen_qabstractitemmodel_types.QModelIndex](int(vindexes_ma.len))
  let vindexes_outCast = cast[ptr UncheckedArray[pointer]](vindexes_ma.data)
...
proc fcQDirModel_method_callback_itemData(self: pointer, index: pointer): struct_seaqt_map {.cdecl.} =
  let inst = cast[VirtualQDirModel](fcQDirModel_vdata(self)[])
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index)
...
proc fcQDirModel_method_callback_setItemData(self: pointer, index: pointer, roles: struct_seaqt_map): bool {.cdecl.} =
  let inst = cast[VirtualQDirModel](fcQDirModel_vdata(self)[])
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index)
  var vroles_mm = roles
  var vrolesx_ret: Table[cint, gen_qvariant_types.QVariant]
...
proc fcQDirModel_method_callback_match(self: pointer, start: pointer, role: cint, value: pointer, hits: cint, flags: cint): struct_seaqt_array {.cdecl.} =
  let inst = cast[VirtualQDirModel](fcQDirModel_vdata(self)[])
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: start)
  let slotval2 = role
  let slotval3 = gen_qvariant_types.QVariant(h: value)
...
proc fcQDirModel_method_callback_roleNames(self: pointer): struct_seaqt_map {.cdecl.} =
  let inst = cast[VirtualQDirModel](fcQDirModel_vdata(self)[])
...
proc encodeData*(self: gen_qdirmodel_types.QDirModel, indexes: openArray[gen_qabstractitemmodel_types.QModelIndex], stream: gen_qdatastream_types.QDataStream): void =
  ...
  fcQDirModel_protectedbase_encodeData(self.h, struct_seaqt_array(len: csize_t(len(indexes)), data: if len(indexes) == 0: nil else: addr(indexes_CArray[0])), stream.h)
...
proc changePersistentIndexList*(self: gen_qdirmodel_types.QDirModel, fromVal: openArray[gen_qabstractitemmodel_types.QModelIndex], to: openArray[gen_qabstractitemmodel_types.QModelIndex]): void =
  ...
  fcQDirModel_protectedbase_changePersistentIndexList(self.h, struct_seaqt_array(len: csize_t(len(fromVal)), data: if len(fromVal) == 0: nil else: addr(fromVal_CArray[0])), struct_seaqt_array(len: csize_t(len(to)), data: if len(to) == 0: nil else: addr(to_CArray[0])))
...
proc create*(T: type gen_qdirmodel_types.QDirModel,
  ...
  let tmp = gen_qdirmodel_types.QDirModel(h: fcQDirModel_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_seaqt_array(len: csize_t(len(nameFilters)), data: if len(nameFilters) == 0: nil else: addr(nameFilters_CArray[0])), cint(filters), cint(sort)))
  fcQDirModel_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qdirmodel_types.QDirModel,
    vtbl: ref QDirModelVTable = nil): gen_qdirmodel_types.QDirModel =
  let vtbl = if vtbl == nil: new QDirModelVTable else: vtbl
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQDirModel_vtable_callback_disconnectNotify
  let tmp = gen_qdirmodel_types.QDirModel(h: fcQDirModel_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer))))
  fcQDirModel_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qdirmodel_types.QDirModel,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQDirModel_vtable_callback_disconnectNotify
  let tmp = gen_qdirmodel_types.QDirModel(h: fcQDirModel_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_seaqt_array(len: csize_t(len(nameFilters)), data: if len(nameFilters) == 0: nil else: addr(nameFilters_CArray[0])), cint(filters), cint(sort), parent.h))
  fcQDirModel_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qdirmodel_types.QDirModel,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQDirModel_vtable_callback_disconnectNotify
  let tmp = gen_qdirmodel_types.QDirModel(h: fcQDirModel_new4(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h))
  fcQDirModel_vdata(tmp.h)[] = addr(vtbl[])
  tmp
...
proc create*(T: type gen_qdirmodel_types.QDirModel,
  ...
  inst[].h = fcQDirModel_new(addr(cQDirModel_mvtbl), csize_t(sizeof(pointer)), struct_seaqt_array(len: csize_t(len(nameFilters)), data: if len(nameFilters) == 0: nil else: addr(nameFilters_CArray[0])), cint(filters), cint(sort))
  fcQDirModel_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true

proc create*(T: type gen_qdirmodel_types.QDirModel,
    inst: VirtualQDirModel) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQDirModel_new2(addr(cQDirModel_mvtbl), csize_t(sizeof(pointer)))
  fcQDirModel_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qdirmodel_types.QDirModel,
  ...
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQDirModel_new3(addr(cQDirModel_mvtbl), csize_t(sizeof(pointer)), struct_seaqt_array(len: csize_t(len(nameFilters)), data: if len(nameFilters) == 0: nil else: addr(nameFilters_CArray[0])), cint(filters), cint(sort), parent.h)
  fcQDirModel_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qdirmodel_types.QDirModel,
    ...
    inst: VirtualQDirModel) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQDirModel_new4(addr(cQDirModel_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQDirModel_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
