...
proc fcQToolBox_trUtf8(s: cstring): struct_seaqt_string {.importc: "QToolBox_trUtf8".}
...
proc fcQToolBox_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QToolBox_trUtf82".}
proc fcQToolBox_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QToolBox_trUtf83".}
