...
proc fcQToolBox_trUtf8S(s: cstring): struct_seaqt_string {.importc: "QToolBox_trUtf8_s".}
...
proc fcQToolBox_trUtf8SC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QToolBox_trUtf8_s_c".}
proc fcQToolBox_trUtf8SCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QToolBox_trUtf8_s_c_n".}
...
proc fcQToolBox_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.importc: "QToolBox_virtualbase_nativeEvent".}
...
proc fcQToolBox_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let vtbl = cast[ptr QToolBoxVTable](fcQToolBox_vdata(self)[])
  let self = QToolBox(h: self)
...
proc fcQToolBox_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let inst = cast[VirtualQToolBox](fcQToolBox_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
