...
proc fcQLCDNumber_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QLCDNumber_protectedbase_getDecodedMetricF".}
...
proc getDecodedMetricF*(self: gen_qlcdnumber_types.QLCDNumber, metricA: cint, metricB: cint): float64 =
  fcQLCDNumber_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
...
proc create*(T: type gen_qlcdnumber_types.QLCDNumber,
  ...
  inst[].h = fcQLCDNumber_new(addr(cQLCDNumber_mvtbl), csize_t(sizeof(pointer)))
...
proc create*(T: type gen_qlcdnumber_types.QLCDNumber,
    ...
    inst: VirtualQLCDNumber) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQLCDNumber_new2(addr(cQLCDNumber_mvtbl), csize_t(sizeof(pointer)), numDigits)
  fcQLCDNumber_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qlcdnumber_types.QLCDNumber,
    ...
    inst: VirtualQLCDNumber) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQLCDNumber_new3(addr(cQLCDNumber_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQLCDNumber_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
