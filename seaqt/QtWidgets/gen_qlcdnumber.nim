...
proc fcQLCDNumber_new(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQLCDNumber {.importc: "QLCDNumber_new".}
proc fcQLCDNumber_new2(vtbl: pointer, vdata: csize_t): ptr cQLCDNumber {.importc: "QLCDNumber_new2".}
proc fcQLCDNumber_new3(vtbl: pointer, vdata: csize_t, numDigits: cuint): ptr cQLCDNumber {.importc: "QLCDNumber_new3".}
