...
public:
	...
	friend bool QCommandLinkButton_virtualbase_nativeEvent(VirtualQCommandLinkButton* self, struct miqt_string eventType, void* message, intptr_t* result);
...
VirtualQCommandLinkButton* QCommandLinkButton_new(const QCommandLinkButton_VTable* vtbl, size_t vdata, QWidget* parent) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQCommandLinkButton>());
...
VirtualQCommandLinkButton* QCommandLinkButton_new3(const QCommandLinkButton_VTable* vtbl, size_t vdata, struct miqt_string text) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQCommandLinkButton>());
	return _mem_ ? new (_mem_)VirtualQCommandLinkButton(vtbl, text_QString) : nullptr;
}

VirtualQCommandLinkButton* QCommandLinkButton_new4(const QCommandLinkButton_VTable* vtbl, size_t vdata, struct miqt_string text, struct miqt_string description) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
...
VirtualQCommandLinkButton* QCommandLinkButton_new5(const QCommandLinkButton_VTable* vtbl, size_t vdata, struct miqt_string text, QWidget* parent) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQCommandLinkButton>());
	return _mem_ ? new (_mem_)VirtualQCommandLinkButton(vtbl, text_QString, parent) : nullptr;
}

VirtualQCommandLinkButton* QCommandLinkButton_new6(const QCommandLinkButton_VTable* vtbl, size_t vdata, struct miqt_string text, struct miqt_string description, QWidget* parent) {
	QString text_QString = QString::fromUtf8(text.data, text.len);
	QString description_QString = QString::fromUtf8(description.data, description.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQCommandLinkButton>());
...
bool QCommandLinkButton_virtualbase_nativeEvent(VirtualQCommandLinkButton* self, struct miqt_string eventType, void* message, intptr_t* result) {
