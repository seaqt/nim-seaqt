...
proc fcQFocusFrame_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.importc: "QFocusFrame_virtualbase_nativeEvent".}
...
proc fcQFocusFrame_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QFocusFrame_protectedbase_getDecodedMetricF".}
...
proc fcQFocusFrame_vtable_callback_initStyleOption(self: pointer, option: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QFocusFrameVTable](fcQFocusFrame_vdata(self)[])
  let self = QFocusFrame(h: self)
...
proc fcQFocusFrame_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QFocusFrameVTable](fcQFocusFrame_vdata(self)[])
  let self = QFocusFrame(h: self)
...
proc fcQFocusFrame_method_callback_initStyleOption(self: pointer, option: pointer): void {.cdecl.} =
  let inst = cast[VirtualQFocusFrame](fcQFocusFrame_vdata(self)[])
  let slotval1 = gen_qstyleoption_types.QStyleOption(h: option, owned: false)
...
proc fcQFocusFrame_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let inst = cast[VirtualQFocusFrame](fcQFocusFrame_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc getDecodedMetricF*(self: gen_qfocusframe_types.QFocusFrame, metricA: cint, metricB: cint): float64 =
  fcQFocusFrame_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
...
proc create*(T: type gen_qfocusframe_types.QFocusFrame,
  ...
  if not isNil(vtbl[].initStyleOption):
    vtbl[].vtbl.initStyleOption = fcQFocusFrame_vtable_callback_initStyleOption
...
const cQFocusFrame_mvtbl = cQFocusFrameVTable(
  ...
  initStyleOption: fcQFocusFrame_method_callback_initStyleOption,
