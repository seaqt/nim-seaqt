...
proc fcQFocusFrame_trUtf8S(s: cstring): struct_seaqt_string {.importc: "QFocusFrame_trUtf8_s".}
...
proc fcQFocusFrame_trUtf8SC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QFocusFrame_trUtf8_s_c".}
proc fcQFocusFrame_trUtf8SCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QFocusFrame_trUtf8_s_c_n".}
...
proc fcQFocusFrame_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.importc: "QFocusFrame_virtualbase_nativeEvent".}
...
proc fcQFocusFrame_new(vtbl: pointer, vdata: csize_t): ptr cQFocusFrame {.importc: "QFocusFrame_new".}
proc fcQFocusFrame_new2(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQFocusFrame {.importc: "QFocusFrame_new_parent".}
...
proc trUtf8*(_: type gen_qfocusframe_types.QFocusFrame, s: cstring): string =
  let v_ms = fcQFocusFrame_trUtf8S(s)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
type QFocusFramenativeEventProc* = proc(self: QFocusFrame, eventType: openArray[byte], message: pointer, resultVal: ptr clong): bool {.raises: [], gcsafe.}
...
proc QFocusFramenativeEvent*(self: gen_qfocusframe_types.QFocusFrame, eventType: openArray[byte], message: pointer, resultVal: ptr clong): bool =
  fcQFocusFrame_virtualbase_nativeEvent(self.h, struct_seaqt_string(data: if len(eventType) > 0: addr eventType[0] else: nil, len: csize_t(len(eventType))), message, resultVal)
...
proc fcQFocusFrame_vtable_callback_metaObject(self: pointer): pointer {.cdecl.} =
...
proc fcQFocusFrame_vtable_callback_metacast(self: pointer, param1: cstring): pointer {.cdecl.} =
  let vtbl = cast[ptr QFocusFrameVTable](fcQFocusFrame_vdata(self)[])
  let self = QFocusFrame(h: self)
  let slotval1 = (param1)
...
proc fcQFocusFrame_vtable_callback_metacall(self: pointer, param1: cint, param2: cint, param3: pointer): cint {.cdecl.} =
  let vtbl = cast[ptr QFocusFrameVTable](fcQFocusFrame_vdata(self)[])
  let self = QFocusFrame(h: self)
...
proc fcQFocusFrame_vtable_callback_event(self: pointer, e: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QFocusFrameVTable](fcQFocusFrame_vdata(self)[])
  let self = QFocusFrame(h: self)
...
proc fcQFocusFrame_vtable_callback_eventFilter(self: pointer, param1: pointer, param2: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QFocusFrameVTable](fcQFocusFrame_vdata(self)[])
  let self = QFocusFrame(h: self)
...
proc fcQFocusFrame_vtable_callback_paintEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QFocusFrameVTable](fcQFocusFrame_vdata(self)[])
  let self = QFocusFrame(h: self)
  let slotval1 = gen_qevent_types.QPaintEvent(h: param1, owned: false)
  vtbl[].paintEvent(self, slotval1)

proc fcQFocusFrame_vtable_callback_devType(self: pointer): cint {.cdecl.} =
  let vtbl = cast[ptr QFocusFrameVTable](fcQFocusFrame_vdata(self)[])
  let self = QFocusFrame(h: self)
  var virtualReturn = vtbl[].devType(self)
  virtualReturn

proc fcQFocusFrame_vtable_callback_setVisible(self: pointer, visible: bool): void {.cdecl.} =
  let vtbl = cast[ptr QFocusFrameVTable](fcQFocusFrame_vdata(self)[])
  let self = QFocusFrame(h: self)
  let slotval1 = visible
  vtbl[].setVisible(self, slotval1)

proc fcQFocusFrame_vtable_callback_sizeHint(self: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QFocusFrameVTable](fcQFocusFrame_vdata(self)[])
  let self = QFocusFrame(h: self)
...
proc fcQFocusFrame_vtable_callback_minimumSizeHint(self: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QFocusFrameVTable](fcQFocusFrame_vdata(self)[])
  let self = QFocusFrame(h: self)
...
proc fcQFocusFrame_vtable_callback_heightForWidth(self: pointer, param1: cint): cint {.cdecl.} =
  let vtbl = cast[ptr QFocusFrameVTable](fcQFocusFrame_vdata(self)[])
  let self = QFocusFrame(h: self)
  let slotval1 = param1
...
proc fcQFocusFrame_vtable_callback_hasHeightForWidth(self: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QFocusFrameVTable](fcQFocusFrame_vdata(self)[])
  let self = QFocusFrame(h: self)
  var virtualReturn = vtbl[].hasHeightForWidth(self)
  virtualReturn

proc fcQFocusFrame_vtable_callback_paintEngine(self: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QFocusFrameVTable](fcQFocusFrame_vdata(self)[])
  let self = QFocusFrame(h: self)
...
proc fcQFocusFrame_vtable_callback_mousePressEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QFocusFrameVTable](fcQFocusFrame_vdata(self)[])
  let self = QFocusFrame(h: self)
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
  vtbl[].mousePressEvent(self, slotval1)

proc fcQFocusFrame_vtable_callback_mouseReleaseEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QFocusFrameVTable](fcQFocusFrame_vdata(self)[])
  let self = QFocusFrame(h: self)
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
  vtbl[].mouseReleaseEvent(self, slotval1)

proc fcQFocusFrame_vtable_callback_mouseDoubleClickEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QFocusFrameVTable](fcQFocusFrame_vdata(self)[])
  let self = QFocusFrame(h: self)
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
  vtbl[].mouseDoubleClickEvent(self, slotval1)

proc fcQFocusFrame_vtable_callback_mouseMoveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QFocusFrameVTable](fcQFocusFrame_vdata(self)[])
  let self = QFocusFrame(h: self)
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
  vtbl[].mouseMoveEvent(self, slotval1)

proc fcQFocusFrame_vtable_callback_wheelEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QFocusFrameVTable](fcQFocusFrame_vdata(self)[])
  let self = QFocusFrame(h: self)
  let slotval1 = gen_qevent_types.QWheelEvent(h: event, owned: false)
  vtbl[].wheelEvent(self, slotval1)

proc fcQFocusFrame_vtable_callback_keyPressEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QFocusFrameVTable](fcQFocusFrame_vdata(self)[])
  let self = QFocusFrame(h: self)
  let slotval1 = gen_qevent_types.QKeyEvent(h: event, owned: false)
  vtbl[].keyPressEvent(self, slotval1)

proc fcQFocusFrame_vtable_callback_keyReleaseEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QFocusFrameVTable](fcQFocusFrame_vdata(self)[])
  let self = QFocusFrame(h: self)
  let slotval1 = gen_qevent_types.QKeyEvent(h: event, owned: false)
  vtbl[].keyReleaseEvent(self, slotval1)

proc fcQFocusFrame_vtable_callback_focusInEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QFocusFrameVTable](fcQFocusFrame_vdata(self)[])
  let self = QFocusFrame(h: self)
  let slotval1 = gen_qevent_types.QFocusEvent(h: event, owned: false)
  vtbl[].focusInEvent(self, slotval1)

proc fcQFocusFrame_vtable_callback_focusOutEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QFocusFrameVTable](fcQFocusFrame_vdata(self)[])
  let self = QFocusFrame(h: self)
  let slotval1 = gen_qevent_types.QFocusEvent(h: event, owned: false)
  vtbl[].focusOutEvent(self, slotval1)

proc fcQFocusFrame_vtable_callback_enterEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QFocusFrameVTable](fcQFocusFrame_vdata(self)[])
  let self = QFocusFrame(h: self)
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
  vtbl[].enterEvent(self, slotval1)

proc fcQFocusFrame_vtable_callback_leaveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QFocusFrameVTable](fcQFocusFrame_vdata(self)[])
  let self = QFocusFrame(h: self)
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
  vtbl[].leaveEvent(self, slotval1)

proc fcQFocusFrame_vtable_callback_moveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QFocusFrameVTable](fcQFocusFrame_vdata(self)[])
  let self = QFocusFrame(h: self)
  let slotval1 = gen_qevent_types.QMoveEvent(h: event, owned: false)
  vtbl[].moveEvent(self, slotval1)

proc fcQFocusFrame_vtable_callback_resizeEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QFocusFrameVTable](fcQFocusFrame_vdata(self)[])
  let self = QFocusFrame(h: self)
  let slotval1 = gen_qevent_types.QResizeEvent(h: event, owned: false)
  vtbl[].resizeEvent(self, slotval1)

proc fcQFocusFrame_vtable_callback_closeEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QFocusFrameVTable](fcQFocusFrame_vdata(self)[])
  let self = QFocusFrame(h: self)
  let slotval1 = gen_qevent_types.QCloseEvent(h: event, owned: false)
  vtbl[].closeEvent(self, slotval1)

proc fcQFocusFrame_vtable_callback_contextMenuEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QFocusFrameVTable](fcQFocusFrame_vdata(self)[])
  let self = QFocusFrame(h: self)
  let slotval1 = gen_qevent_types.QContextMenuEvent(h: event, owned: false)
  vtbl[].contextMenuEvent(self, slotval1)

proc fcQFocusFrame_vtable_callback_tabletEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QFocusFrameVTable](fcQFocusFrame_vdata(self)[])
  let self = QFocusFrame(h: self)
  let slotval1 = gen_qevent_types.QTabletEvent(h: event, owned: false)
  vtbl[].tabletEvent(self, slotval1)

proc fcQFocusFrame_vtable_callback_actionEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QFocusFrameVTable](fcQFocusFrame_vdata(self)[])
  let self = QFocusFrame(h: self)
  let slotval1 = gen_qevent_types.QActionEvent(h: event, owned: false)
  vtbl[].actionEvent(self, slotval1)

proc fcQFocusFrame_vtable_callback_dragEnterEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QFocusFrameVTable](fcQFocusFrame_vdata(self)[])
  let self = QFocusFrame(h: self)
  let slotval1 = gen_qevent_types.QDragEnterEvent(h: event, owned: false)
  vtbl[].dragEnterEvent(self, slotval1)

proc fcQFocusFrame_vtable_callback_dragMoveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QFocusFrameVTable](fcQFocusFrame_vdata(self)[])
  let self = QFocusFrame(h: self)
  let slotval1 = gen_qevent_types.QDragMoveEvent(h: event, owned: false)
  vtbl[].dragMoveEvent(self, slotval1)

proc fcQFocusFrame_vtable_callback_dragLeaveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QFocusFrameVTable](fcQFocusFrame_vdata(self)[])
  let self = QFocusFrame(h: self)
  let slotval1 = gen_qevent_types.QDragLeaveEvent(h: event, owned: false)
  vtbl[].dragLeaveEvent(self, slotval1)

proc fcQFocusFrame_vtable_callback_dropEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QFocusFrameVTable](fcQFocusFrame_vdata(self)[])
  let self = QFocusFrame(h: self)
  let slotval1 = gen_qevent_types.QDropEvent(h: event, owned: false)
  vtbl[].dropEvent(self, slotval1)

proc fcQFocusFrame_vtable_callback_showEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QFocusFrameVTable](fcQFocusFrame_vdata(self)[])
  let self = QFocusFrame(h: self)
  let slotval1 = gen_qevent_types.QShowEvent(h: event, owned: false)
  vtbl[].showEvent(self, slotval1)

proc fcQFocusFrame_vtable_callback_hideEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QFocusFrameVTable](fcQFocusFrame_vdata(self)[])
  let self = QFocusFrame(h: self)
  let slotval1 = gen_qevent_types.QHideEvent(h: event, owned: false)
  vtbl[].hideEvent(self, slotval1)

proc fcQFocusFrame_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let vtbl = cast[ptr QFocusFrameVTable](fcQFocusFrame_vdata(self)[])
  let self = QFocusFrame(h: self)
...
proc fcQFocusFrame_vtable_callback_changeEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QFocusFrameVTable](fcQFocusFrame_vdata(self)[])
  let self = QFocusFrame(h: self)
  let slotval1 = gen_qcoreevent_types.QEvent(h: param1, owned: false)
  vtbl[].changeEvent(self, slotval1)

proc fcQFocusFrame_vtable_callback_metric(self: pointer, param1: cint): cint {.cdecl.} =
  let vtbl = cast[ptr QFocusFrameVTable](fcQFocusFrame_vdata(self)[])
  let self = QFocusFrame(h: self)
  let slotval1 = cint(param1)
...
proc fcQFocusFrame_vtable_callback_initPainter(self: pointer, painter: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QFocusFrameVTable](fcQFocusFrame_vdata(self)[])
  let self = QFocusFrame(h: self)
  let slotval1 = gen_qpainter_types.QPainter(h: painter, owned: false)
  vtbl[].initPainter(self, slotval1)

proc fcQFocusFrame_vtable_callback_redirected(self: pointer, offset: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QFocusFrameVTable](fcQFocusFrame_vdata(self)[])
  let self = QFocusFrame(h: self)
...
proc fcQFocusFrame_vtable_callback_sharedPainter(self: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QFocusFrameVTable](fcQFocusFrame_vdata(self)[])
  let self = QFocusFrame(h: self)
...
proc fcQFocusFrame_vtable_callback_inputMethodEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QFocusFrameVTable](fcQFocusFrame_vdata(self)[])
  let self = QFocusFrame(h: self)
  let slotval1 = gen_qevent_types.QInputMethodEvent(h: param1, owned: false)
  vtbl[].inputMethodEvent(self, slotval1)

proc fcQFocusFrame_vtable_callback_inputMethodQuery(self: pointer, param1: cint): pointer {.cdecl.} =
  let vtbl = cast[ptr QFocusFrameVTable](fcQFocusFrame_vdata(self)[])
  let self = QFocusFrame(h: self)
  let slotval1 = cint(param1)
...
proc fcQFocusFrame_vtable_callback_focusNextPrevChild(self: pointer, next: bool): bool {.cdecl.} =
  let vtbl = cast[ptr QFocusFrameVTable](fcQFocusFrame_vdata(self)[])
  let self = QFocusFrame(h: self)
  let slotval1 = next
...
proc fcQFocusFrame_vtable_callback_timerEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QFocusFrameVTable](fcQFocusFrame_vdata(self)[])
  let self = QFocusFrame(h: self)
  let slotval1 = gen_qcoreevent_types.QTimerEvent(h: event, owned: false)
  vtbl[].timerEvent(self, slotval1)

proc fcQFocusFrame_vtable_callback_childEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QFocusFrameVTable](fcQFocusFrame_vdata(self)[])
  let self = QFocusFrame(h: self)
  let slotval1 = gen_qcoreevent_types.QChildEvent(h: event, owned: false)
  vtbl[].childEvent(self, slotval1)

proc fcQFocusFrame_vtable_callback_customEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QFocusFrameVTable](fcQFocusFrame_vdata(self)[])
  let self = QFocusFrame(h: self)
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
  vtbl[].customEvent(self, slotval1)

proc fcQFocusFrame_vtable_callback_connectNotify(self: pointer, signal: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QFocusFrameVTable](fcQFocusFrame_vdata(self)[])
  let self = QFocusFrame(h: self)
  let slotval1 = gen_qmetaobject_types.QMetaMethod(h: signal, owned: false)
  vtbl[].connectNotify(self, slotval1)

proc fcQFocusFrame_vtable_callback_disconnectNotify(self: pointer, signal: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QFocusFrameVTable](fcQFocusFrame_vdata(self)[])
  let self = QFocusFrame(h: self)
  let slotval1 = gen_qmetaobject_types.QMetaMethod(h: signal, owned: false)
...
method enterEvent*(self: VirtualQFocusFrame, event: gen_qcoreevent_types.QEvent): void {.base.} =
...
method nativeEvent*(self: VirtualQFocusFrame, eventType: openArray[byte], message: pointer, resultVal: ptr clong): bool {.base.} =
...
proc fcQFocusFrame_method_callback_metacall(self: pointer, param1: cint, param2: cint, param3: pointer): cint {.cdecl.} =
  let inst = cast[VirtualQFocusFrame](fcQFocusFrame_vdata(self)[])
  let slotval1 = cint(param1)
  let slotval2 = param2
  let slotval3 = param3
...
proc fcQFocusFrame_method_callback_event(self: pointer, e: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQFocusFrame](fcQFocusFrame_vdata(self)[])
  let slotval1 = gen_qcoreevent_types.QEvent(h: e, owned: false)
  var virtualReturn = inst.event(slotval1)
  virtualReturn

proc fcQFocusFrame_method_callback_eventFilter(self: pointer, param1: pointer, param2: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQFocusFrame](fcQFocusFrame_vdata(self)[])
  let slotval1 = gen_qobject_types.QObject(h: param1, owned: false)
  let slotval2 = gen_qcoreevent_types.QEvent(h: param2, owned: false)
...
proc fcQFocusFrame_method_callback_paintEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let inst = cast[VirtualQFocusFrame](fcQFocusFrame_vdata(self)[])
  let slotval1 = gen_qevent_types.QPaintEvent(h: param1, owned: false)
  inst.paintEvent(slotval1)

proc fcQFocusFrame_method_callback_devType(self: pointer): cint {.cdecl.} =
  let inst = cast[VirtualQFocusFrame](fcQFocusFrame_vdata(self)[])
  var virtualReturn = inst.devType()
  virtualReturn

proc fcQFocusFrame_method_callback_setVisible(self: pointer, visible: bool): void {.cdecl.} =
  let inst = cast[VirtualQFocusFrame](fcQFocusFrame_vdata(self)[])
  let slotval1 = visible
...
proc fcQFocusFrame_method_callback_hasHeightForWidth(self: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQFocusFrame](fcQFocusFrame_vdata(self)[])
...
proc fcQFocusFrame_method_callback_mouseReleaseEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQFocusFrame](fcQFocusFrame_vdata(self)[])
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
  inst.mouseReleaseEvent(slotval1)

proc fcQFocusFrame_method_callback_mouseDoubleClickEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQFocusFrame](fcQFocusFrame_vdata(self)[])
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
  inst.mouseDoubleClickEvent(slotval1)

proc fcQFocusFrame_method_callback_mouseMoveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQFocusFrame](fcQFocusFrame_vdata(self)[])
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
  inst.mouseMoveEvent(slotval1)

proc fcQFocusFrame_method_callback_wheelEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQFocusFrame](fcQFocusFrame_vdata(self)[])
  let slotval1 = gen_qevent_types.QWheelEvent(h: event, owned: false)
  inst.wheelEvent(slotval1)

proc fcQFocusFrame_method_callback_keyPressEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQFocusFrame](fcQFocusFrame_vdata(self)[])
  let slotval1 = gen_qevent_types.QKeyEvent(h: event, owned: false)
  inst.keyPressEvent(slotval1)

proc fcQFocusFrame_method_callback_keyReleaseEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQFocusFrame](fcQFocusFrame_vdata(self)[])
  let slotval1 = gen_qevent_types.QKeyEvent(h: event, owned: false)
  inst.keyReleaseEvent(slotval1)

proc fcQFocusFrame_method_callback_focusInEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQFocusFrame](fcQFocusFrame_vdata(self)[])
  let slotval1 = gen_qevent_types.QFocusEvent(h: event, owned: false)
  inst.focusInEvent(slotval1)

proc fcQFocusFrame_method_callback_focusOutEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQFocusFrame](fcQFocusFrame_vdata(self)[])
  let slotval1 = gen_qevent_types.QFocusEvent(h: event, owned: false)
  inst.focusOutEvent(slotval1)

proc fcQFocusFrame_method_callback_enterEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQFocusFrame](fcQFocusFrame_vdata(self)[])
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
  inst.enterEvent(slotval1)

proc fcQFocusFrame_method_callback_leaveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQFocusFrame](fcQFocusFrame_vdata(self)[])
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
  inst.leaveEvent(slotval1)

proc fcQFocusFrame_method_callback_moveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQFocusFrame](fcQFocusFrame_vdata(self)[])
  let slotval1 = gen_qevent_types.QMoveEvent(h: event, owned: false)
  inst.moveEvent(slotval1)

proc fcQFocusFrame_method_callback_resizeEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQFocusFrame](fcQFocusFrame_vdata(self)[])
  let slotval1 = gen_qevent_types.QResizeEvent(h: event, owned: false)
  inst.resizeEvent(slotval1)

proc fcQFocusFrame_method_callback_closeEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQFocusFrame](fcQFocusFrame_vdata(self)[])
  let slotval1 = gen_qevent_types.QCloseEvent(h: event, owned: false)
  inst.closeEvent(slotval1)

proc fcQFocusFrame_method_callback_contextMenuEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQFocusFrame](fcQFocusFrame_vdata(self)[])
  let slotval1 = gen_qevent_types.QContextMenuEvent(h: event, owned: false)
  inst.contextMenuEvent(slotval1)

proc fcQFocusFrame_method_callback_tabletEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQFocusFrame](fcQFocusFrame_vdata(self)[])
  let slotval1 = gen_qevent_types.QTabletEvent(h: event, owned: false)
  inst.tabletEvent(slotval1)

proc fcQFocusFrame_method_callback_actionEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQFocusFrame](fcQFocusFrame_vdata(self)[])
  let slotval1 = gen_qevent_types.QActionEvent(h: event, owned: false)
  inst.actionEvent(slotval1)

proc fcQFocusFrame_method_callback_dragEnterEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQFocusFrame](fcQFocusFrame_vdata(self)[])
  let slotval1 = gen_qevent_types.QDragEnterEvent(h: event, owned: false)
  inst.dragEnterEvent(slotval1)

proc fcQFocusFrame_method_callback_dragMoveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQFocusFrame](fcQFocusFrame_vdata(self)[])
  let slotval1 = gen_qevent_types.QDragMoveEvent(h: event, owned: false)
  inst.dragMoveEvent(slotval1)

proc fcQFocusFrame_method_callback_dragLeaveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQFocusFrame](fcQFocusFrame_vdata(self)[])
  let slotval1 = gen_qevent_types.QDragLeaveEvent(h: event, owned: false)
  inst.dragLeaveEvent(slotval1)

proc fcQFocusFrame_method_callback_dropEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQFocusFrame](fcQFocusFrame_vdata(self)[])
  let slotval1 = gen_qevent_types.QDropEvent(h: event, owned: false)
  inst.dropEvent(slotval1)

proc fcQFocusFrame_method_callback_showEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQFocusFrame](fcQFocusFrame_vdata(self)[])
  let slotval1 = gen_qevent_types.QShowEvent(h: event, owned: false)
  inst.showEvent(slotval1)

proc fcQFocusFrame_method_callback_hideEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQFocusFrame](fcQFocusFrame_vdata(self)[])
  let slotval1 = gen_qevent_types.QHideEvent(h: event, owned: false)
  inst.hideEvent(slotval1)

proc fcQFocusFrame_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let inst = cast[VirtualQFocusFrame](fcQFocusFrame_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc fcQFocusFrame_method_callback_changeEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let inst = cast[VirtualQFocusFrame](fcQFocusFrame_vdata(self)[])
  let slotval1 = gen_qcoreevent_types.QEvent(h: param1, owned: false)
  inst.changeEvent(slotval1)

proc fcQFocusFrame_method_callback_metric(self: pointer, param1: cint): cint {.cdecl.} =
  let inst = cast[VirtualQFocusFrame](fcQFocusFrame_vdata(self)[])
  let slotval1 = cint(param1)
  var virtualReturn = inst.metric(slotval1)
  virtualReturn

proc fcQFocusFrame_method_callback_initPainter(self: pointer, painter: pointer): void {.cdecl.} =
  let inst = cast[VirtualQFocusFrame](fcQFocusFrame_vdata(self)[])
  let slotval1 = gen_qpainter_types.QPainter(h: painter, owned: false)
  inst.initPainter(slotval1)

proc fcQFocusFrame_method_callback_redirected(self: pointer, offset: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQFocusFrame](fcQFocusFrame_vdata(self)[])
  let slotval1 = gen_qpoint_types.QPoint(h: offset, owned: false)
...
proc fcQFocusFrame_method_callback_inputMethodQuery(self: pointer, param1: cint): pointer {.cdecl.} =
  let inst = cast[VirtualQFocusFrame](fcQFocusFrame_vdata(self)[])
  let slotval1 = cint(param1)
...
proc fcQFocusFrame_method_callback_timerEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQFocusFrame](fcQFocusFrame_vdata(self)[])
  let slotval1 = gen_qcoreevent_types.QTimerEvent(h: event, owned: false)
  inst.timerEvent(slotval1)

proc fcQFocusFrame_method_callback_childEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQFocusFrame](fcQFocusFrame_vdata(self)[])
  let slotval1 = gen_qcoreevent_types.QChildEvent(h: event, owned: false)
  inst.childEvent(slotval1)

proc fcQFocusFrame_method_callback_customEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQFocusFrame](fcQFocusFrame_vdata(self)[])
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
  inst.customEvent(slotval1)

proc fcQFocusFrame_method_callback_connectNotify(self: pointer, signal: pointer): void {.cdecl.} =
  let inst = cast[VirtualQFocusFrame](fcQFocusFrame_vdata(self)[])
  let slotval1 = gen_qmetaobject_types.QMetaMethod(h: signal, owned: false)
  inst.connectNotify(slotval1)

proc fcQFocusFrame_method_callback_disconnectNotify(self: pointer, signal: pointer): void {.cdecl.} =
  let inst = cast[VirtualQFocusFrame](fcQFocusFrame_vdata(self)[])
  let slotval1 = gen_qmetaobject_types.QMetaMethod(h: signal, owned: false)
...
proc create*(T: type gen_qfocusframe_types.QFocusFrame,
  ...
  if not isNil(vtbl[].metaObject):
    vtbl[].vtbl.metaObject = fcQFocusFrame_vtable_callback_metaObject
  if not isNil(vtbl[].metacast):
    vtbl[].vtbl.metacast = fcQFocusFrame_vtable_callback_metacast
  if not isNil(vtbl[].metacall):
    vtbl[].vtbl.metacall = fcQFocusFrame_vtable_callback_metacall
  if not isNil(vtbl[].event):
    vtbl[].vtbl.event = fcQFocusFrame_vtable_callback_event
  if not isNil(vtbl[].eventFilter):
    vtbl[].vtbl.eventFilter = fcQFocusFrame_vtable_callback_eventFilter
  if not isNil(vtbl[].paintEvent):
    vtbl[].vtbl.paintEvent = fcQFocusFrame_vtable_callback_paintEvent
  if not isNil(vtbl[].devType):
    vtbl[].vtbl.devType = fcQFocusFrame_vtable_callback_devType
  if not isNil(vtbl[].setVisible):
    vtbl[].vtbl.setVisible = fcQFocusFrame_vtable_callback_setVisible
  if not isNil(vtbl[].sizeHint):
    vtbl[].vtbl.sizeHint = fcQFocusFrame_vtable_callback_sizeHint
  if not isNil(vtbl[].minimumSizeHint):
    vtbl[].vtbl.minimumSizeHint = fcQFocusFrame_vtable_callback_minimumSizeHint
  if not isNil(vtbl[].heightForWidth):
    vtbl[].vtbl.heightForWidth = fcQFocusFrame_vtable_callback_heightForWidth
  if not isNil(vtbl[].hasHeightForWidth):
    vtbl[].vtbl.hasHeightForWidth = fcQFocusFrame_vtable_callback_hasHeightForWidth
  if not isNil(vtbl[].paintEngine):
    vtbl[].vtbl.paintEngine = fcQFocusFrame_vtable_callback_paintEngine
  if not isNil(vtbl[].mousePressEvent):
    vtbl[].vtbl.mousePressEvent = fcQFocusFrame_vtable_callback_mousePressEvent
  if not isNil(vtbl[].mouseReleaseEvent):
    vtbl[].vtbl.mouseReleaseEvent = fcQFocusFrame_vtable_callback_mouseReleaseEvent
  if not isNil(vtbl[].mouseDoubleClickEvent):
    vtbl[].vtbl.mouseDoubleClickEvent = fcQFocusFrame_vtable_callback_mouseDoubleClickEvent
  if not isNil(vtbl[].mouseMoveEvent):
    vtbl[].vtbl.mouseMoveEvent = fcQFocusFrame_vtable_callback_mouseMoveEvent
  if not isNil(vtbl[].wheelEvent):
    vtbl[].vtbl.wheelEvent = fcQFocusFrame_vtable_callback_wheelEvent
  if not isNil(vtbl[].keyPressEvent):
    vtbl[].vtbl.keyPressEvent = fcQFocusFrame_vtable_callback_keyPressEvent
  if not isNil(vtbl[].keyReleaseEvent):
    vtbl[].vtbl.keyReleaseEvent = fcQFocusFrame_vtable_callback_keyReleaseEvent
  if not isNil(vtbl[].focusInEvent):
    vtbl[].vtbl.focusInEvent = fcQFocusFrame_vtable_callback_focusInEvent
  if not isNil(vtbl[].focusOutEvent):
    vtbl[].vtbl.focusOutEvent = fcQFocusFrame_vtable_callback_focusOutEvent
  if not isNil(vtbl[].enterEvent):
    vtbl[].vtbl.enterEvent = fcQFocusFrame_vtable_callback_enterEvent
  if not isNil(vtbl[].leaveEvent):
    vtbl[].vtbl.leaveEvent = fcQFocusFrame_vtable_callback_leaveEvent
  if not isNil(vtbl[].moveEvent):
    vtbl[].vtbl.moveEvent = fcQFocusFrame_vtable_callback_moveEvent
  if not isNil(vtbl[].resizeEvent):
    vtbl[].vtbl.resizeEvent = fcQFocusFrame_vtable_callback_resizeEvent
  if not isNil(vtbl[].closeEvent):
    vtbl[].vtbl.closeEvent = fcQFocusFrame_vtable_callback_closeEvent
  if not isNil(vtbl[].contextMenuEvent):
    vtbl[].vtbl.contextMenuEvent = fcQFocusFrame_vtable_callback_contextMenuEvent
  if not isNil(vtbl[].tabletEvent):
    vtbl[].vtbl.tabletEvent = fcQFocusFrame_vtable_callback_tabletEvent
  if not isNil(vtbl[].actionEvent):
    vtbl[].vtbl.actionEvent = fcQFocusFrame_vtable_callback_actionEvent
  if not isNil(vtbl[].dragEnterEvent):
    vtbl[].vtbl.dragEnterEvent = fcQFocusFrame_vtable_callback_dragEnterEvent
  if not isNil(vtbl[].dragMoveEvent):
    vtbl[].vtbl.dragMoveEvent = fcQFocusFrame_vtable_callback_dragMoveEvent
  if not isNil(vtbl[].dragLeaveEvent):
    vtbl[].vtbl.dragLeaveEvent = fcQFocusFrame_vtable_callback_dragLeaveEvent
  if not isNil(vtbl[].dropEvent):
    vtbl[].vtbl.dropEvent = fcQFocusFrame_vtable_callback_dropEvent
  if not isNil(vtbl[].showEvent):
    vtbl[].vtbl.showEvent = fcQFocusFrame_vtable_callback_showEvent
  if not isNil(vtbl[].hideEvent):
    vtbl[].vtbl.hideEvent = fcQFocusFrame_vtable_callback_hideEvent
  if not isNil(vtbl[].nativeEvent):
    vtbl[].vtbl.nativeEvent = fcQFocusFrame_vtable_callback_nativeEvent
  if not isNil(vtbl[].changeEvent):
    vtbl[].vtbl.changeEvent = fcQFocusFrame_vtable_callback_changeEvent
  if not isNil(vtbl[].metric):
    vtbl[].vtbl.metric = fcQFocusFrame_vtable_callback_metric
  if not isNil(vtbl[].initPainter):
    vtbl[].vtbl.initPainter = fcQFocusFrame_vtable_callback_initPainter
  if not isNil(vtbl[].redirected):
    vtbl[].vtbl.redirected = fcQFocusFrame_vtable_callback_redirected
  if not isNil(vtbl[].sharedPainter):
    vtbl[].vtbl.sharedPainter = fcQFocusFrame_vtable_callback_sharedPainter
  if not isNil(vtbl[].inputMethodEvent):
    vtbl[].vtbl.inputMethodEvent = fcQFocusFrame_vtable_callback_inputMethodEvent
  if not isNil(vtbl[].inputMethodQuery):
    vtbl[].vtbl.inputMethodQuery = fcQFocusFrame_vtable_callback_inputMethodQuery
  if not isNil(vtbl[].focusNextPrevChild):
    vtbl[].vtbl.focusNextPrevChild = fcQFocusFrame_vtable_callback_focusNextPrevChild
  if not isNil(vtbl[].timerEvent):
    vtbl[].vtbl.timerEvent = fcQFocusFrame_vtable_callback_timerEvent
  if not isNil(vtbl[].childEvent):
    vtbl[].vtbl.childEvent = fcQFocusFrame_vtable_callback_childEvent
  if not isNil(vtbl[].customEvent):
    vtbl[].vtbl.customEvent = fcQFocusFrame_vtable_callback_customEvent
  if not isNil(vtbl[].connectNotify):
    vtbl[].vtbl.connectNotify = fcQFocusFrame_vtable_callback_connectNotify
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQFocusFrame_vtable_callback_disconnectNotify
  let tmp = gen_qfocusframe_types.QFocusFrame(h: fcQFocusFrame_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQFocusFrame_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qfocusframe_types.QFocusFrame,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQFocusFrame_vtable_callback_disconnectNotify
  let tmp = gen_qfocusframe_types.QFocusFrame(h: fcQFocusFrame_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQFocusFrame_vdata(tmp.h)[] = addr(vtbl[])
  tmp
const cQFocusFrame_mvtbl = cQFocusFrameVTable(
  ...
  metaObject: fcQFocusFrame_method_callback_metaObject,
  metacast: fcQFocusFrame_method_callback_metacast,
  metacall: fcQFocusFrame_method_callback_metacall,
  event: fcQFocusFrame_method_callback_event,
  eventFilter: fcQFocusFrame_method_callback_eventFilter,
  paintEvent: fcQFocusFrame_method_callback_paintEvent,
  devType: fcQFocusFrame_method_callback_devType,
  setVisible: fcQFocusFrame_method_callback_setVisible,
  sizeHint: fcQFocusFrame_method_callback_sizeHint,
  minimumSizeHint: fcQFocusFrame_method_callback_minimumSizeHint,
  heightForWidth: fcQFocusFrame_method_callback_heightForWidth,
  hasHeightForWidth: fcQFocusFrame_method_callback_hasHeightForWidth,
  paintEngine: fcQFocusFrame_method_callback_paintEngine,
  mousePressEvent: fcQFocusFrame_method_callback_mousePressEvent,
  mouseReleaseEvent: fcQFocusFrame_method_callback_mouseReleaseEvent,
  mouseDoubleClickEvent: fcQFocusFrame_method_callback_mouseDoubleClickEvent,
  mouseMoveEvent: fcQFocusFrame_method_callback_mouseMoveEvent,
  wheelEvent: fcQFocusFrame_method_callback_wheelEvent,
  keyPressEvent: fcQFocusFrame_method_callback_keyPressEvent,
  keyReleaseEvent: fcQFocusFrame_method_callback_keyReleaseEvent,
  focusInEvent: fcQFocusFrame_method_callback_focusInEvent,
  focusOutEvent: fcQFocusFrame_method_callback_focusOutEvent,
  enterEvent: fcQFocusFrame_method_callback_enterEvent,
  leaveEvent: fcQFocusFrame_method_callback_leaveEvent,
  moveEvent: fcQFocusFrame_method_callback_moveEvent,
  resizeEvent: fcQFocusFrame_method_callback_resizeEvent,
  closeEvent: fcQFocusFrame_method_callback_closeEvent,
  contextMenuEvent: fcQFocusFrame_method_callback_contextMenuEvent,
  tabletEvent: fcQFocusFrame_method_callback_tabletEvent,
  actionEvent: fcQFocusFrame_method_callback_actionEvent,
  dragEnterEvent: fcQFocusFrame_method_callback_dragEnterEvent,
  dragMoveEvent: fcQFocusFrame_method_callback_dragMoveEvent,
  dragLeaveEvent: fcQFocusFrame_method_callback_dragLeaveEvent,
  dropEvent: fcQFocusFrame_method_callback_dropEvent,
  showEvent: fcQFocusFrame_method_callback_showEvent,
  hideEvent: fcQFocusFrame_method_callback_hideEvent,
  nativeEvent: fcQFocusFrame_method_callback_nativeEvent,
  changeEvent: fcQFocusFrame_method_callback_changeEvent,
  metric: fcQFocusFrame_method_callback_metric,
  initPainter: fcQFocusFrame_method_callback_initPainter,
  redirected: fcQFocusFrame_method_callback_redirected,
  sharedPainter: fcQFocusFrame_method_callback_sharedPainter,
  inputMethodEvent: fcQFocusFrame_method_callback_inputMethodEvent,
  inputMethodQuery: fcQFocusFrame_method_callback_inputMethodQuery,
  focusNextPrevChild: fcQFocusFrame_method_callback_focusNextPrevChild,
  timerEvent: fcQFocusFrame_method_callback_timerEvent,
  childEvent: fcQFocusFrame_method_callback_childEvent,
  customEvent: fcQFocusFrame_method_callback_customEvent,
  connectNotify: fcQFocusFrame_method_callback_connectNotify,
  disconnectNotify: fcQFocusFrame_method_callback_disconnectNotify,
)
proc create*(T: type gen_qfocusframe_types.QFocusFrame,
    inst: VirtualQFocusFrame) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQFocusFrame_new(addr(cQFocusFrame_mvtbl), csize_t(sizeof(pointer)))
...
proc create*(T: type gen_qfocusframe_types.QFocusFrame,
    ...
    inst: VirtualQFocusFrame) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQFocusFrame_new2(addr(cQFocusFrame_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQFocusFrame_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
