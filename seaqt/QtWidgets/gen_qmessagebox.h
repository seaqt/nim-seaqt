...
const QMessageBox_VTable* QMessageBox_vtbl(const VirtualQMessageBox* self);
void* QMessageBox_vdata(const VirtualQMessageBox* self);
void QMessageBox_setVdata(VirtualQMessageBox* self, void* vdata);
