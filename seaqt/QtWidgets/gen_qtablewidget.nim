...
proc fcQTableWidget_new(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQTableWidget {.importc: "QTableWidget_new".}
proc fcQTableWidget_new2(vtbl: pointer, vdata: csize_t): ptr cQTableWidget {.importc: "QTableWidget_new2".}
proc fcQTableWidget_new3(vtbl: pointer, vdata: csize_t, rows: cint, columns: cint): ptr cQTableWidget {.importc: "QTableWidget_new3".}
