...
proc fcQTableWidgetSelectionRange_operatorAssign(self: pointer, fromVal: pointer): void {.importc: "QTableWidgetSelectionRange_operatorAssign".}
...
proc fcQTableWidgetSelectionRange_new3(fromVal: pointer): ptr cQTableWidgetSelectionRange {.importc: "QTableWidgetSelectionRange_new_from".}
...
proc fcQTableWidgetItem_text(self: pointer): struct_seaqt_string {.importc: "QTableWidgetItem_text".}
proc fcQTableWidgetItem_setText(self: pointer, text: struct_seaqt_string): void {.importc: "QTableWidgetItem_setText".}
...
proc fcQTableWidgetItem_statusTip(self: pointer): struct_seaqt_string {.importc: "QTableWidgetItem_statusTip".}
proc fcQTableWidgetItem_setStatusTip(self: pointer, statusTip: struct_seaqt_string): void {.importc: "QTableWidgetItem_setStatusTip".}
proc fcQTableWidgetItem_toolTip(self: pointer): struct_seaqt_string {.importc: "QTableWidgetItem_toolTip".}
proc fcQTableWidgetItem_setToolTip(self: pointer, toolTip: struct_seaqt_string): void {.importc: "QTableWidgetItem_setToolTip".}
proc fcQTableWidgetItem_whatsThis(self: pointer): struct_seaqt_string {.importc: "QTableWidgetItem_whatsThis".}
proc fcQTableWidgetItem_setWhatsThis(self: pointer, whatsThis: struct_seaqt_string): void {.importc: "QTableWidgetItem_setWhatsThis".}
...
proc fcQTableWidget_trUtf8S(s: cstring): struct_seaqt_string {.importc: "QTableWidget_trUtf8_s".}
...
proc fcQTableWidget_setVerticalHeaderLabels(self: pointer, labels: struct_seaqt_array): void {.importc: "QTableWidget_setVerticalHeaderLabels".}
proc fcQTableWidget_setHorizontalHeaderLabels(self: pointer, labels: struct_seaqt_array): void {.importc: "QTableWidget_setHorizontalHeaderLabels".}
...
proc fcQTableWidget_selectedRanges(self: pointer): struct_seaqt_array {.importc: "QTableWidget_selectedRanges".}
proc fcQTableWidget_selectedItems(self: pointer): struct_seaqt_array {.importc: "QTableWidget_selectedItems".}
...
proc fcQTableWidget_trUtf8SC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QTableWidget_trUtf8_s_c".}
proc fcQTableWidget_trUtf8SCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QTableWidget_trUtf8_s_c_n".}
...
type cQTableWidgetVTable {.pure.} = object
  ...
  mimeData*: proc(self: pointer, items: struct_seaqt_array): pointer {.cdecl, raises: [], gcsafe.}
  ...
  keyboardSearch*: proc(self: pointer, search: struct_seaqt_string): void {.cdecl, raises: [], gcsafe.}
  ...
  dataChanged*: proc(self: pointer, topLeft: pointer, bottomRight: pointer, roles: struct_seaqt_array): void {.cdecl, raises: [], gcsafe.}
...
proc fcQTableWidget_virtualbase_mimeTypes(self: pointer): struct_seaqt_array {.importc: "QTableWidget_virtualbase_mimeTypes".}
proc fcQTableWidget_virtualbase_mimeData(self: pointer, items: struct_seaqt_array): pointer {.importc: "QTableWidget_virtualbase_mimeData".}
...
proc fcQTableWidget_virtualbase_selectedIndexes(self: pointer): struct_seaqt_array {.importc: "QTableWidget_virtualbase_selectedIndexes".}
...
proc fcQTableWidget_virtualbase_keyboardSearch(self: pointer, search: struct_seaqt_string): void {.importc: "QTableWidget_virtualbase_keyboardSearch".}
...
proc fcQTableWidget_virtualbase_dataChanged(self: pointer, topLeft: pointer, bottomRight: pointer, roles: struct_seaqt_array): void {.importc: "QTableWidget_virtualbase_dataChanged".}
...
proc fcQTableWidget_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.importc: "QTableWidget_virtualbase_nativeEvent".}
...
proc fcQTableWidget_protectedbase_items(self: pointer, data: pointer): struct_seaqt_array {.importc: "QTableWidget_protectedbase_items".}
proc fcQTableWidget_protectedbase_indexFromItem_const_pcQTableWidgetItem(self: pointer, item: pointer): pointer {.importc: "QTableWidget_protectedbase_indexFromItem_const_pcQTableWidgetItem".}
proc fcQTableWidget_protectedbase_indexFromItem_const_pQTableWidgetItem(self: pointer, item: pointer): pointer {.importc: "QTableWidget_protectedbase_indexFromItem_const_pQTableWidgetItem".}
...
proc fcQTableWidget_new(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQTableWidget {.importc: "QTableWidget_new_parent".}
proc fcQTableWidget_new2(vtbl: pointer, vdata: csize_t): ptr cQTableWidget {.importc: "QTableWidget_new".}
proc fcQTableWidget_new3(vtbl: pointer, vdata: csize_t, rows: cint, columns: cint): ptr cQTableWidget {.importc: "QTableWidget_new_rows_columns".}
...
proc operatorAssign*(self: gen_qtablewidget_types.QTableWidgetSelectionRange, fromVal: gen_qtablewidget_types.QTableWidgetSelectionRange): void =
  fcQTableWidgetSelectionRange_operatorAssign(self.h, fromVal.h)
...
proc create*(T: type gen_qtablewidget_types.QTableWidgetSelectionRange): gen_qtablewidget_types.QTableWidgetSelectionRange =
  let tmp = gen_qtablewidget_types.QTableWidgetSelectionRange(h: fcQTableWidgetSelectionRange_new(), owned: true)
  tmp
proc create*(T: type gen_qtablewidget_types.QTableWidgetSelectionRange,
  ...
  let tmp = gen_qtablewidget_types.QTableWidgetSelectionRange(h: fcQTableWidgetSelectionRange_new2(top, left, bottom, right), owned: true)
  tmp
proc create*(T: type gen_qtablewidget_types.QTableWidgetSelectionRange,
    fromVal: gen_qtablewidget_types.QTableWidgetSelectionRange): gen_qtablewidget_types.QTableWidgetSelectionRange =
  let tmp = gen_qtablewidget_types.QTableWidgetSelectionRange(h: fcQTableWidgetSelectionRange_new3(fromVal.h), owned: true)
  tmp
...
proc setText*(self: gen_qtablewidget_types.QTableWidgetItem, text: openArray[char]): void =
  fcQTableWidgetItem_setText(self.h, struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))))
...
proc setStatusTip*(self: gen_qtablewidget_types.QTableWidgetItem, statusTip: openArray[char]): void =
  fcQTableWidgetItem_setStatusTip(self.h, struct_seaqt_string(data: if len(statusTip) > 0: addr statusTip[0] else: nil, len: csize_t(len(statusTip))))
...
proc setToolTip*(self: gen_qtablewidget_types.QTableWidgetItem, toolTip: openArray[char]): void =
  fcQTableWidgetItem_setToolTip(self.h, struct_seaqt_string(data: if len(toolTip) > 0: addr toolTip[0] else: nil, len: csize_t(len(toolTip))))
...
proc setWhatsThis*(self: gen_qtablewidget_types.QTableWidgetItem, whatsThis: openArray[char]): void =
  fcQTableWidgetItem_setWhatsThis(self.h, struct_seaqt_string(data: if len(whatsThis) > 0: addr whatsThis[0] else: nil, len: csize_t(len(whatsThis))))
...
proc fcQTableWidgetItem_vtable_callback_clone(self: pointer): pointer {.cdecl.} =
...
proc fcQTableWidgetItem_vtable_callback_data(self: pointer, role: cint): pointer {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetItemVTable](fcQTableWidgetItem_vdata(self)[])
  let self = QTableWidgetItem(h: self)
  let slotval1 = role
...
proc fcQTableWidgetItem_vtable_callback_setData(self: pointer, role: cint, value: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetItemVTable](fcQTableWidgetItem_vdata(self)[])
  let self = QTableWidgetItem(h: self)
  let slotval1 = role
...
proc fcQTableWidgetItem_vtable_callback_operatorLesser(self: pointer, other: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetItemVTable](fcQTableWidgetItem_vdata(self)[])
  let self = QTableWidgetItem(h: self)
...
proc fcQTableWidgetItem_vtable_callback_read(self: pointer, inVal: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetItemVTable](fcQTableWidgetItem_vdata(self)[])
  let self = QTableWidgetItem(h: self)
  let slotval1 = gen_qdatastream_types.QDataStream(h: inVal, owned: false)
  vtbl[].read(self, slotval1)

proc fcQTableWidgetItem_vtable_callback_write(self: pointer, outVal: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetItemVTable](fcQTableWidgetItem_vdata(self)[])
  let self = QTableWidgetItem(h: self)
...
proc fcQTableWidgetItem_method_callback_clone(self: pointer): pointer {.cdecl.} =
...
proc fcQTableWidgetItem_method_callback_data(self: pointer, role: cint): pointer {.cdecl.} =
  let inst = cast[VirtualQTableWidgetItem](fcQTableWidgetItem_vdata(self)[])
  let slotval1 = role
...
proc fcQTableWidgetItem_method_callback_setData(self: pointer, role: cint, value: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTableWidgetItem](fcQTableWidgetItem_vdata(self)[])
  let slotval1 = role
  let slotval2 = gen_qvariant_types.QVariant(h: value, owned: false)
  inst.setData(slotval1, slotval2)

proc fcQTableWidgetItem_method_callback_operatorLesser(self: pointer, other: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQTableWidgetItem](fcQTableWidgetItem_vdata(self)[])
  let slotval1 = gen_qtablewidget_types.QTableWidgetItem(h: other, owned: false)
  var virtualReturn = inst.operatorLesser(slotval1)
  virtualReturn

proc fcQTableWidgetItem_method_callback_read(self: pointer, inVal: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTableWidgetItem](fcQTableWidgetItem_vdata(self)[])
  let slotval1 = gen_qdatastream_types.QDataStream(h: inVal, owned: false)
  inst.read(slotval1)

proc fcQTableWidgetItem_method_callback_write(self: pointer, outVal: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTableWidgetItem](fcQTableWidgetItem_vdata(self)[])
  let slotval1 = gen_qdatastream_types.QDataStream(h: outVal, owned: false)
  inst.write(slotval1)
...
proc create*(T: type gen_qtablewidget_types.QTableWidgetItem,
  ...
  if not isNil(vtbl[].clone):
    vtbl[].vtbl.clone = fcQTableWidgetItem_vtable_callback_clone
  if not isNil(vtbl[].data):
    vtbl[].vtbl.data = fcQTableWidgetItem_vtable_callback_data
  if not isNil(vtbl[].setData):
    vtbl[].vtbl.setData = fcQTableWidgetItem_vtable_callback_setData
  if not isNil(vtbl[].operatorLesser):
    vtbl[].vtbl.operatorLesser = fcQTableWidgetItem_vtable_callback_operatorLesser
  ...
  let tmp = gen_qtablewidget_types.QTableWidgetItem(h: fcQTableWidgetItem_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
...
proc create*(T: type gen_qtablewidget_types.QTableWidgetItem,
  ...
  if not isNil(vtbl[].write):
    vtbl[].vtbl.write = fcQTableWidgetItem_vtable_callback_write
  let tmp = gen_qtablewidget_types.QTableWidgetItem(h: fcQTableWidgetItem_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text)))), owned: true)
  fcQTableWidgetItem_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qtablewidget_types.QTableWidgetItem,
  ...
  if not isNil(vtbl[].write):
    vtbl[].vtbl.write = fcQTableWidgetItem_vtable_callback_write
  let tmp = gen_qtablewidget_types.QTableWidgetItem(h: fcQTableWidgetItem_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), icon.h, struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text)))), owned: true)
  fcQTableWidgetItem_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qtablewidget_types.QTableWidgetItem,
...
proc create*(T: type gen_qtablewidget_types.QTableWidgetItem,
  ...
  if not isNil(vtbl[].write):
    vtbl[].vtbl.write = fcQTableWidgetItem_vtable_callback_write
  let tmp = gen_qtablewidget_types.QTableWidgetItem(h: fcQTableWidgetItem_new5(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), typeVal), owned: true)
  fcQTableWidgetItem_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qtablewidget_types.QTableWidgetItem,
    text: openArray[char], typeVal: cint,
    vtbl: ref QTableWidgetItemVTable = nil): gen_qtablewidget_types.QTableWidgetItem =
  let vtbl = if vtbl == nil: new QTableWidgetItemVTable else: vtbl
  GC_ref(vtbl)
  vtbl[].vtbl.destructor = proc(self: pointer) {.cdecl.} =
  ...
  if not isNil(vtbl[].write):
    vtbl[].vtbl.write = fcQTableWidgetItem_vtable_callback_write
  let tmp = gen_qtablewidget_types.QTableWidgetItem(h: fcQTableWidgetItem_new6(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), typeVal), owned: true)
  fcQTableWidgetItem_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qtablewidget_types.QTableWidgetItem,
    icon: gen_qicon_types.QIcon, text: openArray[char], typeVal: cint,
    vtbl: ref QTableWidgetItemVTable = nil): gen_qtablewidget_types.QTableWidgetItem =
  let vtbl = if vtbl == nil: new QTableWidgetItemVTable else: vtbl
  GC_ref(vtbl)
  vtbl[].vtbl.destructor = proc(self: pointer) {.cdecl.} =
  ...
  if not isNil(vtbl[].write):
    vtbl[].vtbl.write = fcQTableWidgetItem_vtable_callback_write
  let tmp = gen_qtablewidget_types.QTableWidgetItem(h: fcQTableWidgetItem_new7(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), icon.h, struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), typeVal), owned: true)
  fcQTableWidgetItem_vdata(tmp.h)[] = addr(vtbl[])
  tmp
const cQTableWidgetItem_mvtbl = cQTableWidgetItemVTable(
  ...
  clone: fcQTableWidgetItem_method_callback_clone,
  data: fcQTableWidgetItem_method_callback_data,
  setData: fcQTableWidgetItem_method_callback_setData,
  operatorLesser: fcQTableWidgetItem_method_callback_operatorLesser,
  read: fcQTableWidgetItem_method_callback_read,
  write: fcQTableWidgetItem_method_callback_write,
)
proc create*(T: type gen_qtablewidget_types.QTableWidgetItem,
    inst: VirtualQTableWidgetItem) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQTableWidgetItem_new(addr(cQTableWidgetItem_mvtbl), csize_t(sizeof(pointer)))
...
proc create*(T: type gen_qtablewidget_types.QTableWidgetItem,
    ...
    inst: VirtualQTableWidgetItem) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQTableWidgetItem_new2(addr(cQTableWidgetItem_mvtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))))
  fcQTableWidgetItem_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qtablewidget_types.QTableWidgetItem,
    ...
    inst: VirtualQTableWidgetItem) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQTableWidgetItem_new3(addr(cQTableWidgetItem_mvtbl), csize_t(sizeof(pointer)), icon.h, struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))))
  fcQTableWidgetItem_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qtablewidget_types.QTableWidgetItem,
    ...
    inst: VirtualQTableWidgetItem) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQTableWidgetItem_new5(addr(cQTableWidgetItem_mvtbl), csize_t(sizeof(pointer)), typeVal)
  fcQTableWidgetItem_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qtablewidget_types.QTableWidgetItem,
    ...
    inst: VirtualQTableWidgetItem) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQTableWidgetItem_new6(addr(cQTableWidgetItem_mvtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), typeVal)
  fcQTableWidgetItem_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qtablewidget_types.QTableWidgetItem,
    ...
    inst: VirtualQTableWidgetItem) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQTableWidgetItem_new7(addr(cQTableWidgetItem_mvtbl), csize_t(sizeof(pointer)), icon.h, struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), typeVal)
  fcQTableWidgetItem_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc trUtf8*(_: type gen_qtablewidget_types.QTableWidget, s: cstring): string =
  let v_ms = fcQTableWidget_trUtf8S(s)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc setVerticalHeaderLabels*(self: gen_qtablewidget_types.QTableWidget, labels: openArray[string]): void =
  var labels_CArray = newSeq[struct_seaqt_string](len(labels))
  for i in 0..<len(labels):
    labels_CArray[i] = struct_seaqt_string(data: if len(labels[i]) > 0: addr labels[i][0] else: nil, len: csize_t(len(labels[i])))

  fcQTableWidget_setVerticalHeaderLabels(self.h, struct_seaqt_array(len: csize_t(len(labels)), data: if len(labels) == 0: nil else: addr(labels_CArray[0])))

proc setHorizontalHeaderLabels*(self: gen_qtablewidget_types.QTableWidget, labels: openArray[string]): void =
  var labels_CArray = newSeq[struct_seaqt_string](len(labels))
  for i in 0..<len(labels):
    labels_CArray[i] = struct_seaqt_string(data: if len(labels[i]) > 0: addr labels[i][0] else: nil, len: csize_t(len(labels[i])))

  fcQTableWidget_setHorizontalHeaderLabels(self.h, struct_seaqt_array(len: csize_t(len(labels)), data: if len(labels) == 0: nil else: addr(labels_CArray[0])))
...
proc findItems*(self: gen_qtablewidget_types.QTableWidget, text: openArray[char], flags: cint): seq[gen_qtablewidget_types.QTableWidgetItem] =
  var v_ma = fcQTableWidget_findItems(self.h, struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), cint(flags))
  var vx_ret = newSeq[gen_qtablewidget_types.QTableWidgetItem](int(v_ma.len))
  let v_outCast = cast[ptr UncheckedArray[pointer]](v_ma.data)
  for i in 0 ..< v_ma.len:
    vx_ret[i] = gen_qtablewidget_types.QTableWidgetItem(h: v_outCast[i], owned: false)
...
proc fcQTableWidget_slot_callback_itemPressed(slot: int, item: pointer) {.cdecl.} =
...
proc fcQTableWidget_slot_callback_itemPressed_release(slot: int) {.cdecl.} =
...
proc onItemPressed*(self: gen_qtablewidget_types.QTableWidget, slot: QTableWidgetitemPressedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQTableWidget_connect_itemPressed(self.h, cast[int](addr tmp[]), fcQTableWidget_slot_callback_itemPressed, fcQTableWidget_slot_callback_itemPressed_release)
...
proc fcQTableWidget_slot_callback_itemClicked(slot: int, item: pointer) {.cdecl.} =
  let nimfunc = cast[ptr QTableWidgetitemClickedSlot](cast[pointer](slot))
  let slotval1 = gen_qtablewidget_types.QTableWidgetItem(h: item, owned: false)

  nimfunc[](slotval1)

proc fcQTableWidget_slot_callback_itemClicked_release(slot: int) {.cdecl.} =
...
proc onItemClicked*(self: gen_qtablewidget_types.QTableWidget, slot: QTableWidgetitemClickedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQTableWidget_connect_itemClicked(self.h, cast[int](addr tmp[]), fcQTableWidget_slot_callback_itemClicked, fcQTableWidget_slot_callback_itemClicked_release)
...
proc fcQTableWidget_slot_callback_itemDoubleClicked(slot: int, item: pointer) {.cdecl.} =
  let nimfunc = cast[ptr QTableWidgetitemDoubleClickedSlot](cast[pointer](slot))
  let slotval1 = gen_qtablewidget_types.QTableWidgetItem(h: item, owned: false)

  nimfunc[](slotval1)

proc fcQTableWidget_slot_callback_itemDoubleClicked_release(slot: int) {.cdecl.} =
...
proc onItemDoubleClicked*(self: gen_qtablewidget_types.QTableWidget, slot: QTableWidgetitemDoubleClickedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQTableWidget_connect_itemDoubleClicked(self.h, cast[int](addr tmp[]), fcQTableWidget_slot_callback_itemDoubleClicked, fcQTableWidget_slot_callback_itemDoubleClicked_release)
...
proc fcQTableWidget_slot_callback_itemActivated(slot: int, item: pointer) {.cdecl.} =
  let nimfunc = cast[ptr QTableWidgetitemActivatedSlot](cast[pointer](slot))
  let slotval1 = gen_qtablewidget_types.QTableWidgetItem(h: item, owned: false)

  nimfunc[](slotval1)

proc fcQTableWidget_slot_callback_itemActivated_release(slot: int) {.cdecl.} =
...
proc onItemActivated*(self: gen_qtablewidget_types.QTableWidget, slot: QTableWidgetitemActivatedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQTableWidget_connect_itemActivated(self.h, cast[int](addr tmp[]), fcQTableWidget_slot_callback_itemActivated, fcQTableWidget_slot_callback_itemActivated_release)
...
proc fcQTableWidget_slot_callback_itemEntered(slot: int, item: pointer) {.cdecl.} =
  let nimfunc = cast[ptr QTableWidgetitemEnteredSlot](cast[pointer](slot))
  let slotval1 = gen_qtablewidget_types.QTableWidgetItem(h: item, owned: false)

  nimfunc[](slotval1)

proc fcQTableWidget_slot_callback_itemEntered_release(slot: int) {.cdecl.} =
...
proc onItemEntered*(self: gen_qtablewidget_types.QTableWidget, slot: QTableWidgetitemEnteredSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQTableWidget_connect_itemEntered(self.h, cast[int](addr tmp[]), fcQTableWidget_slot_callback_itemEntered, fcQTableWidget_slot_callback_itemEntered_release)
...
proc fcQTableWidget_slot_callback_itemChanged(slot: int, item: pointer) {.cdecl.} =
  let nimfunc = cast[ptr QTableWidgetitemChangedSlot](cast[pointer](slot))
  let slotval1 = gen_qtablewidget_types.QTableWidgetItem(h: item, owned: false)

  nimfunc[](slotval1)

proc fcQTableWidget_slot_callback_itemChanged_release(slot: int) {.cdecl.} =
...
proc onItemChanged*(self: gen_qtablewidget_types.QTableWidget, slot: QTableWidgetitemChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQTableWidget_connect_itemChanged(self.h, cast[int](addr tmp[]), fcQTableWidget_slot_callback_itemChanged, fcQTableWidget_slot_callback_itemChanged_release)
...
proc fcQTableWidget_slot_callback_currentItemChanged(slot: int, current: pointer, previous: pointer) {.cdecl.} =
...
proc fcQTableWidget_slot_callback_currentItemChanged_release(slot: int) {.cdecl.} =
...
proc onCurrentItemChanged*(self: gen_qtablewidget_types.QTableWidget, slot: QTableWidgetcurrentItemChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQTableWidget_connect_currentItemChanged(self.h, cast[int](addr tmp[]), fcQTableWidget_slot_callback_currentItemChanged, fcQTableWidget_slot_callback_currentItemChanged_release)
...
proc fcQTableWidget_slot_callback_itemSelectionChanged(slot: int) {.cdecl.} =
  let nimfunc = cast[ptr QTableWidgetitemSelectionChangedSlot](cast[pointer](slot))
  nimfunc[]()

proc fcQTableWidget_slot_callback_itemSelectionChanged_release(slot: int) {.cdecl.} =
...
proc onItemSelectionChanged*(self: gen_qtablewidget_types.QTableWidget, slot: QTableWidgetitemSelectionChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQTableWidget_connect_itemSelectionChanged(self.h, cast[int](addr tmp[]), fcQTableWidget_slot_callback_itemSelectionChanged, fcQTableWidget_slot_callback_itemSelectionChanged_release)
...
proc fcQTableWidget_slot_callback_cellPressed(slot: int, row: cint, column: cint) {.cdecl.} =
...
proc fcQTableWidget_slot_callback_cellPressed_release(slot: int) {.cdecl.} =
...
proc onCellPressed*(self: gen_qtablewidget_types.QTableWidget, slot: QTableWidgetcellPressedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQTableWidget_connect_cellPressed(self.h, cast[int](addr tmp[]), fcQTableWidget_slot_callback_cellPressed, fcQTableWidget_slot_callback_cellPressed_release)
...
proc fcQTableWidget_slot_callback_cellClicked(slot: int, row: cint, column: cint) {.cdecl.} =
...
proc fcQTableWidget_slot_callback_cellClicked_release(slot: int) {.cdecl.} =
...
proc onCellClicked*(self: gen_qtablewidget_types.QTableWidget, slot: QTableWidgetcellClickedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQTableWidget_connect_cellClicked(self.h, cast[int](addr tmp[]), fcQTableWidget_slot_callback_cellClicked, fcQTableWidget_slot_callback_cellClicked_release)
...
proc fcQTableWidget_slot_callback_cellDoubleClicked(slot: int, row: cint, column: cint) {.cdecl.} =
...
proc fcQTableWidget_slot_callback_cellDoubleClicked_release(slot: int) {.cdecl.} =
...
proc onCellDoubleClicked*(self: gen_qtablewidget_types.QTableWidget, slot: QTableWidgetcellDoubleClickedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQTableWidget_connect_cellDoubleClicked(self.h, cast[int](addr tmp[]), fcQTableWidget_slot_callback_cellDoubleClicked, fcQTableWidget_slot_callback_cellDoubleClicked_release)
...
proc fcQTableWidget_slot_callback_cellActivated(slot: int, row: cint, column: cint) {.cdecl.} =
...
proc fcQTableWidget_slot_callback_cellActivated_release(slot: int) {.cdecl.} =
...
proc onCellActivated*(self: gen_qtablewidget_types.QTableWidget, slot: QTableWidgetcellActivatedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQTableWidget_connect_cellActivated(self.h, cast[int](addr tmp[]), fcQTableWidget_slot_callback_cellActivated, fcQTableWidget_slot_callback_cellActivated_release)
...
proc fcQTableWidget_slot_callback_cellEntered(slot: int, row: cint, column: cint) {.cdecl.} =
...
proc fcQTableWidget_slot_callback_cellEntered_release(slot: int) {.cdecl.} =
...
proc onCellEntered*(self: gen_qtablewidget_types.QTableWidget, slot: QTableWidgetcellEnteredSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQTableWidget_connect_cellEntered(self.h, cast[int](addr tmp[]), fcQTableWidget_slot_callback_cellEntered, fcQTableWidget_slot_callback_cellEntered_release)
...
proc fcQTableWidget_slot_callback_cellChanged(slot: int, row: cint, column: cint) {.cdecl.} =
...
proc fcQTableWidget_slot_callback_cellChanged_release(slot: int) {.cdecl.} =
...
proc onCellChanged*(self: gen_qtablewidget_types.QTableWidget, slot: QTableWidgetcellChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQTableWidget_connect_cellChanged(self.h, cast[int](addr tmp[]), fcQTableWidget_slot_callback_cellChanged, fcQTableWidget_slot_callback_cellChanged_release)
...
proc fcQTableWidget_slot_callback_currentCellChanged(slot: int, currentRow: cint, currentColumn: cint, previousRow: cint, previousColumn: cint) {.cdecl.} =
...
proc fcQTableWidget_slot_callback_currentCellChanged_release(slot: int) {.cdecl.} =
...
type QTableWidgetmimeDataProc* = proc(self: QTableWidget, items: openArray[gen_qtablewidget_types.QTableWidgetItem]): gen_qmimedata_types.QMimeData {.raises: [], gcsafe.}
...
type QTableWidgetkeyboardSearchProc* = proc(self: QTableWidget, search: openArray[char]): void {.raises: [], gcsafe.}
...
type QTableWidgetdataChangedProc* = proc(self: QTableWidget, topLeft: gen_qabstractitemmodel_types.QModelIndex, bottomRight: gen_qabstractitemmodel_types.QModelIndex, roles: openArray[cint]): void {.raises: [], gcsafe.}
...
type QTableWidgetnativeEventProc* = proc(self: QTableWidget, eventType: openArray[byte], message: pointer, resultVal: ptr clong): bool {.raises: [], gcsafe.}
...
proc QTableWidgetmimeData*(self: gen_qtablewidget_types.QTableWidget, items: openArray[gen_qtablewidget_types.QTableWidgetItem]): gen_qmimedata_types.QMimeData =
  var items_CArray = newSeq[pointer](len(items))
  for i in 0..<len(items):
    items_CArray[i] = items[i].h

  gen_qmimedata_types.QMimeData(h: fcQTableWidget_virtualbase_mimeData(self.h, struct_seaqt_array(len: csize_t(len(items)), data: if len(items) == 0: nil else: addr(items_CArray[0]))), owned: false)
...
proc QTableWidgetkeyboardSearch*(self: gen_qtablewidget_types.QTableWidget, search: openArray[char]): void =
  fcQTableWidget_virtualbase_keyboardSearch(self.h, struct_seaqt_string(data: if len(search) > 0: addr search[0] else: nil, len: csize_t(len(search))))
...
proc QTableWidgetdataChanged*(self: gen_qtablewidget_types.QTableWidget, topLeft: gen_qabstractitemmodel_types.QModelIndex, bottomRight: gen_qabstractitemmodel_types.QModelIndex, roles: openArray[cint]): void =
  var roles_CArray = newSeq[cint](len(roles))
  for i in 0..<len(roles):
    roles_CArray[i] = roles[i]

  fcQTableWidget_virtualbase_dataChanged(self.h, topLeft.h, bottomRight.h, struct_seaqt_array(len: csize_t(len(roles)), data: if len(roles) == 0: nil else: addr(roles_CArray[0])))
...
proc QTableWidgetnativeEvent*(self: gen_qtablewidget_types.QTableWidget, eventType: openArray[byte], message: pointer, resultVal: ptr clong): bool =
  fcQTableWidget_virtualbase_nativeEvent(self.h, struct_seaqt_string(data: if len(eventType) > 0: addr eventType[0] else: nil, len: csize_t(len(eventType))), message, resultVal)
...
proc fcQTableWidget_vtable_callback_metaObject(self: pointer): pointer {.cdecl.} =
...
proc fcQTableWidget_vtable_callback_metacast(self: pointer, param1: cstring): pointer {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  let slotval1 = (param1)
...
proc fcQTableWidget_vtable_callback_metacall(self: pointer, param1: cint, param2: cint, param3: pointer): cint {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
...
proc fcQTableWidget_vtable_callback_event(self: pointer, e: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
...
proc fcQTableWidget_vtable_callback_mimeTypes(self: pointer): struct_seaqt_array {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
...
proc fcQTableWidget_vtable_callback_mimeData(self: pointer, items: struct_seaqt_array): pointer {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  var vitems_ma = items
...
proc fcQTableWidget_vtable_callback_dropMimeData(self: pointer, row: cint, column: cint, data: pointer, action: cint): bool {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  let slotval1 = row
  let slotval2 = column
...
proc fcQTableWidget_vtable_callback_supportedDropActions(self: pointer): cint {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  var virtualReturn = vtbl[].supportedDropActions(self)
  cint(virtualReturn)

proc fcQTableWidget_vtable_callback_dropEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  let slotval1 = gen_qevent_types.QDropEvent(h: event, owned: false)
  vtbl[].dropEvent(self, slotval1)

proc fcQTableWidget_vtable_callback_setRootIndex(self: pointer, index: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
  vtbl[].setRootIndex(self, slotval1)

proc fcQTableWidget_vtable_callback_setSelectionModel(self: pointer, selectionModel: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
...
proc fcQTableWidget_vtable_callback_doItemsLayout(self: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  vtbl[].doItemsLayout(self)

proc fcQTableWidget_vtable_callback_visualRect(self: pointer, index: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
...
proc fcQTableWidget_vtable_callback_scrollTo(self: pointer, index: pointer, hint: cint): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
...
proc fcQTableWidget_vtable_callback_indexAt(self: pointer, p: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
...
proc fcQTableWidget_vtable_callback_scrollContentsBy(self: pointer, dx: cint, dy: cint): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  let slotval1 = dx
  let slotval2 = dy
...
proc fcQTableWidget_vtable_callback_viewOptions(self: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
...
proc fcQTableWidget_vtable_callback_paintEvent(self: pointer, e: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  let slotval1 = gen_qevent_types.QPaintEvent(h: e, owned: false)
  vtbl[].paintEvent(self, slotval1)

proc fcQTableWidget_vtable_callback_timerEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  let slotval1 = gen_qcoreevent_types.QTimerEvent(h: event, owned: false)
  vtbl[].timerEvent(self, slotval1)

proc fcQTableWidget_vtable_callback_horizontalOffset(self: pointer): cint {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  var virtualReturn = vtbl[].horizontalOffset(self)
  virtualReturn

proc fcQTableWidget_vtable_callback_verticalOffset(self: pointer): cint {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  var virtualReturn = vtbl[].verticalOffset(self)
  virtualReturn

proc fcQTableWidget_vtable_callback_moveCursor(self: pointer, cursorAction: cint, modifiers: cint): pointer {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
...
proc fcQTableWidget_vtable_callback_setSelection(self: pointer, rect: pointer, command: cint): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
...
proc fcQTableWidget_vtable_callback_visualRegionForSelection(self: pointer, selection: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
...
proc fcQTableWidget_vtable_callback_selectedIndexes(self: pointer): struct_seaqt_array {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
...
proc fcQTableWidget_vtable_callback_updateGeometries(self: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  vtbl[].updateGeometries(self)

proc fcQTableWidget_vtable_callback_viewportSizeHint(self: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
...
proc fcQTableWidget_vtable_callback_sizeHintForRow(self: pointer, row: cint): cint {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  let slotval1 = row
...
proc fcQTableWidget_vtable_callback_sizeHintForColumn(self: pointer, column: cint): cint {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  let slotval1 = column
...
proc fcQTableWidget_vtable_callback_verticalScrollbarAction(self: pointer, action: cint): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  let slotval1 = action
  vtbl[].verticalScrollbarAction(self, slotval1)

proc fcQTableWidget_vtable_callback_horizontalScrollbarAction(self: pointer, action: cint): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  let slotval1 = action
  vtbl[].horizontalScrollbarAction(self, slotval1)

proc fcQTableWidget_vtable_callback_isIndexHidden(self: pointer, index: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
...
proc fcQTableWidget_vtable_callback_selectionChanged(self: pointer, selected: pointer, deselected: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
...
proc fcQTableWidget_vtable_callback_currentChanged(self: pointer, current: pointer, previous: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
...
proc fcQTableWidget_vtable_callback_keyboardSearch(self: pointer, search: struct_seaqt_string): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
...
proc fcQTableWidget_vtable_callback_inputMethodQuery(self: pointer, query: cint): pointer {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
...
proc fcQTableWidget_vtable_callback_reset(self: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  vtbl[].reset(self)

proc fcQTableWidget_vtable_callback_selectAll(self: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  vtbl[].selectAll(self)

proc fcQTableWidget_vtable_callback_dataChanged(self: pointer, topLeft: pointer, bottomRight: pointer, roles: struct_seaqt_array): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
...
proc fcQTableWidget_vtable_callback_rowsInserted(self: pointer, parent: pointer, start: cint, endVal: cint): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
...
proc fcQTableWidget_vtable_callback_rowsAboutToBeRemoved(self: pointer, parent: pointer, start: cint, endVal: cint): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: parent, owned: false)
  let slotval2 = start
...
proc fcQTableWidget_vtable_callback_updateEditorData(self: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  vtbl[].updateEditorData(self)

proc fcQTableWidget_vtable_callback_updateEditorGeometries(self: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  vtbl[].updateEditorGeometries(self)

proc fcQTableWidget_vtable_callback_verticalScrollbarValueChanged(self: pointer, value: cint): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  let slotval1 = value
  vtbl[].verticalScrollbarValueChanged(self, slotval1)

proc fcQTableWidget_vtable_callback_horizontalScrollbarValueChanged(self: pointer, value: cint): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  let slotval1 = value
  vtbl[].horizontalScrollbarValueChanged(self, slotval1)

proc fcQTableWidget_vtable_callback_closeEditor(self: pointer, editor: pointer, hint: cint): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
...
proc fcQTableWidget_vtable_callback_commitData(self: pointer, editor: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  let slotval1 = gen_qwidget_types.QWidget(h: editor, owned: false)
  vtbl[].commitData(self, slotval1)

proc fcQTableWidget_vtable_callback_editorDestroyed(self: pointer, editor: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
...
proc fcQTableWidget_vtable_callback_startDrag(self: pointer, supportedActions: cint): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  let slotval1 = cint(supportedActions)
  vtbl[].startDrag(self, slotval1)

proc fcQTableWidget_vtable_callback_focusNextPrevChild(self: pointer, next: bool): bool {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  let slotval1 = next
...
proc fcQTableWidget_vtable_callback_viewportEvent(self: pointer, event: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
...
proc fcQTableWidget_vtable_callback_mousePressEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
  vtbl[].mousePressEvent(self, slotval1)

proc fcQTableWidget_vtable_callback_mouseMoveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
  vtbl[].mouseMoveEvent(self, slotval1)

proc fcQTableWidget_vtable_callback_mouseReleaseEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
  vtbl[].mouseReleaseEvent(self, slotval1)

proc fcQTableWidget_vtable_callback_mouseDoubleClickEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
  vtbl[].mouseDoubleClickEvent(self, slotval1)

proc fcQTableWidget_vtable_callback_dragEnterEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  let slotval1 = gen_qevent_types.QDragEnterEvent(h: event, owned: false)
  vtbl[].dragEnterEvent(self, slotval1)

proc fcQTableWidget_vtable_callback_dragMoveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  let slotval1 = gen_qevent_types.QDragMoveEvent(h: event, owned: false)
  vtbl[].dragMoveEvent(self, slotval1)

proc fcQTableWidget_vtable_callback_dragLeaveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  let slotval1 = gen_qevent_types.QDragLeaveEvent(h: event, owned: false)
  vtbl[].dragLeaveEvent(self, slotval1)

proc fcQTableWidget_vtable_callback_focusInEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  let slotval1 = gen_qevent_types.QFocusEvent(h: event, owned: false)
  vtbl[].focusInEvent(self, slotval1)

proc fcQTableWidget_vtable_callback_focusOutEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  let slotval1 = gen_qevent_types.QFocusEvent(h: event, owned: false)
  vtbl[].focusOutEvent(self, slotval1)

proc fcQTableWidget_vtable_callback_keyPressEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  let slotval1 = gen_qevent_types.QKeyEvent(h: event, owned: false)
  vtbl[].keyPressEvent(self, slotval1)

proc fcQTableWidget_vtable_callback_resizeEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  let slotval1 = gen_qevent_types.QResizeEvent(h: event, owned: false)
  vtbl[].resizeEvent(self, slotval1)

proc fcQTableWidget_vtable_callback_inputMethodEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  let slotval1 = gen_qevent_types.QInputMethodEvent(h: event, owned: false)
  vtbl[].inputMethodEvent(self, slotval1)

proc fcQTableWidget_vtable_callback_eventFilter(self: pointer, objectVal: pointer, event: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
...
proc fcQTableWidget_vtable_callback_minimumSizeHint(self: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
...
proc fcQTableWidget_vtable_callback_sizeHint(self: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
...
proc fcQTableWidget_vtable_callback_setupViewport(self: pointer, viewport: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  let slotval1 = gen_qwidget_types.QWidget(h: viewport, owned: false)
  vtbl[].setupViewport(self, slotval1)

proc fcQTableWidget_vtable_callback_wheelEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  let slotval1 = gen_qevent_types.QWheelEvent(h: param1, owned: false)
  vtbl[].wheelEvent(self, slotval1)

proc fcQTableWidget_vtable_callback_contextMenuEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  let slotval1 = gen_qevent_types.QContextMenuEvent(h: param1, owned: false)
  vtbl[].contextMenuEvent(self, slotval1)

proc fcQTableWidget_vtable_callback_changeEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  let slotval1 = gen_qcoreevent_types.QEvent(h: param1, owned: false)
  vtbl[].changeEvent(self, slotval1)

proc fcQTableWidget_vtable_callback_devType(self: pointer): cint {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  var virtualReturn = vtbl[].devType(self)
  virtualReturn

proc fcQTableWidget_vtable_callback_setVisible(self: pointer, visible: bool): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  let slotval1 = visible
  vtbl[].setVisible(self, slotval1)

proc fcQTableWidget_vtable_callback_heightForWidth(self: pointer, param1: cint): cint {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  let slotval1 = param1
...
proc fcQTableWidget_vtable_callback_hasHeightForWidth(self: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  var virtualReturn = vtbl[].hasHeightForWidth(self)
  virtualReturn

proc fcQTableWidget_vtable_callback_paintEngine(self: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
...
proc fcQTableWidget_vtable_callback_keyReleaseEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  let slotval1 = gen_qevent_types.QKeyEvent(h: event, owned: false)
  vtbl[].keyReleaseEvent(self, slotval1)

proc fcQTableWidget_vtable_callback_enterEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
  vtbl[].enterEvent(self, slotval1)

proc fcQTableWidget_vtable_callback_leaveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
  vtbl[].leaveEvent(self, slotval1)

proc fcQTableWidget_vtable_callback_moveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  let slotval1 = gen_qevent_types.QMoveEvent(h: event, owned: false)
  vtbl[].moveEvent(self, slotval1)

proc fcQTableWidget_vtable_callback_closeEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  let slotval1 = gen_qevent_types.QCloseEvent(h: event, owned: false)
  vtbl[].closeEvent(self, slotval1)

proc fcQTableWidget_vtable_callback_tabletEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  let slotval1 = gen_qevent_types.QTabletEvent(h: event, owned: false)
  vtbl[].tabletEvent(self, slotval1)

proc fcQTableWidget_vtable_callback_actionEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  let slotval1 = gen_qevent_types.QActionEvent(h: event, owned: false)
  vtbl[].actionEvent(self, slotval1)

proc fcQTableWidget_vtable_callback_showEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  let slotval1 = gen_qevent_types.QShowEvent(h: event, owned: false)
  vtbl[].showEvent(self, slotval1)

proc fcQTableWidget_vtable_callback_hideEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  let slotval1 = gen_qevent_types.QHideEvent(h: event, owned: false)
  vtbl[].hideEvent(self, slotval1)

proc fcQTableWidget_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
...
proc fcQTableWidget_vtable_callback_metric(self: pointer, param1: cint): cint {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  let slotval1 = cint(param1)
...
proc fcQTableWidget_vtable_callback_initPainter(self: pointer, painter: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  let slotval1 = gen_qpainter_types.QPainter(h: painter, owned: false)
  vtbl[].initPainter(self, slotval1)

proc fcQTableWidget_vtable_callback_redirected(self: pointer, offset: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
...
proc fcQTableWidget_vtable_callback_sharedPainter(self: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
...
proc fcQTableWidget_vtable_callback_childEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  let slotval1 = gen_qcoreevent_types.QChildEvent(h: event, owned: false)
  vtbl[].childEvent(self, slotval1)

proc fcQTableWidget_vtable_callback_customEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
  vtbl[].customEvent(self, slotval1)

proc fcQTableWidget_vtable_callback_connectNotify(self: pointer, signal: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  let slotval1 = gen_qmetaobject_types.QMetaMethod(h: signal, owned: false)
  vtbl[].connectNotify(self, slotval1)

proc fcQTableWidget_vtable_callback_disconnectNotify(self: pointer, signal: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  let slotval1 = gen_qmetaobject_types.QMetaMethod(h: signal, owned: false)
...
method mimeData*(self: VirtualQTableWidget, items: openArray[gen_qtablewidget_types.QTableWidgetItem]): gen_qmimedata_types.QMimeData {.base.} =
...
method keyboardSearch*(self: VirtualQTableWidget, search: openArray[char]): void {.base.} =
...
method dataChanged*(self: VirtualQTableWidget, topLeft: gen_qabstractitemmodel_types.QModelIndex, bottomRight: gen_qabstractitemmodel_types.QModelIndex, roles: openArray[cint]): void {.base.} =
...
method nativeEvent*(self: VirtualQTableWidget, eventType: openArray[byte], message: pointer, resultVal: ptr clong): bool {.base.} =
...
proc fcQTableWidget_method_callback_metaObject(self: pointer): pointer {.cdecl.} =
...
proc fcQTableWidget_method_callback_metacast(self: pointer, param1: cstring): pointer {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = (param1)
  var virtualReturn = inst.metacast(slotval1)
  virtualReturn

proc fcQTableWidget_method_callback_metacall(self: pointer, param1: cint, param2: cint, param3: pointer): cint {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = cint(param1)
  let slotval2 = param2
  let slotval3 = param3
...
proc fcQTableWidget_method_callback_event(self: pointer, e: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qcoreevent_types.QEvent(h: e, owned: false)
  var virtualReturn = inst.event(slotval1)
  virtualReturn

proc fcQTableWidget_method_callback_mimeTypes(self: pointer): struct_seaqt_array {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
...
proc fcQTableWidget_method_callback_mimeData(self: pointer, items: struct_seaqt_array): pointer {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  var vitems_ma = items
  var vitemsx_ret = newSeq[gen_qtablewidget_types.QTableWidgetItem](int(vitems_ma.len))
  let vitems_outCast = cast[ptr UncheckedArray[pointer]](vitems_ma.data)
...
proc fcQTableWidget_method_callback_dropMimeData(self: pointer, row: cint, column: cint, data: pointer, action: cint): bool {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = row
  let slotval2 = column
  let slotval3 = gen_qmimedata_types.QMimeData(h: data, owned: false)
...
proc fcQTableWidget_method_callback_supportedDropActions(self: pointer): cint {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  var virtualReturn = inst.supportedDropActions()
  cint(virtualReturn)

proc fcQTableWidget_method_callback_dropEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QDropEvent(h: event, owned: false)
  inst.dropEvent(slotval1)

proc fcQTableWidget_method_callback_setRootIndex(self: pointer, index: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
  inst.setRootIndex(slotval1)

proc fcQTableWidget_method_callback_setSelectionModel(self: pointer, selectionModel: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qitemselectionmodel_types.QItemSelectionModel(h: selectionModel, owned: false)
  inst.setSelectionModel(slotval1)

proc fcQTableWidget_method_callback_doItemsLayout(self: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  inst.doItemsLayout()

proc fcQTableWidget_method_callback_visualRect(self: pointer, index: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
...
proc fcQTableWidget_method_callback_scrollTo(self: pointer, index: pointer, hint: cint): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
  let slotval2 = cint(hint)
  inst.scrollTo(slotval1, slotval2)

proc fcQTableWidget_method_callback_indexAt(self: pointer, p: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qpoint_types.QPoint(h: p, owned: false)
...
proc fcQTableWidget_method_callback_scrollContentsBy(self: pointer, dx: cint, dy: cint): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = dx
  let slotval2 = dy
  inst.scrollContentsBy(slotval1, slotval2)

proc fcQTableWidget_method_callback_viewOptions(self: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
...
proc fcQTableWidget_method_callback_paintEvent(self: pointer, e: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QPaintEvent(h: e, owned: false)
  inst.paintEvent(slotval1)

proc fcQTableWidget_method_callback_timerEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qcoreevent_types.QTimerEvent(h: event, owned: false)
  inst.timerEvent(slotval1)

proc fcQTableWidget_method_callback_horizontalOffset(self: pointer): cint {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  var virtualReturn = inst.horizontalOffset()
  virtualReturn

proc fcQTableWidget_method_callback_verticalOffset(self: pointer): cint {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  var virtualReturn = inst.verticalOffset()
  virtualReturn

proc fcQTableWidget_method_callback_moveCursor(self: pointer, cursorAction: cint, modifiers: cint): pointer {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = cint(cursorAction)
  let slotval2 = cint(modifiers)
...
proc fcQTableWidget_method_callback_setSelection(self: pointer, rect: pointer, command: cint): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qrect_types.QRect(h: rect, owned: false)
  let slotval2 = cint(command)
  inst.setSelection(slotval1, slotval2)

proc fcQTableWidget_method_callback_visualRegionForSelection(self: pointer, selection: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qitemselectionmodel_types.QItemSelection(h: selection, owned: false)
...
proc fcQTableWidget_method_callback_selectedIndexes(self: pointer): struct_seaqt_array {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
...
proc fcQTableWidget_method_callback_updateGeometries(self: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  inst.updateGeometries()

proc fcQTableWidget_method_callback_viewportSizeHint(self: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
...
proc fcQTableWidget_method_callback_sizeHintForRow(self: pointer, row: cint): cint {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = row
  var virtualReturn = inst.sizeHintForRow(slotval1)
  virtualReturn

proc fcQTableWidget_method_callback_sizeHintForColumn(self: pointer, column: cint): cint {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = column
  var virtualReturn = inst.sizeHintForColumn(slotval1)
  virtualReturn

proc fcQTableWidget_method_callback_verticalScrollbarAction(self: pointer, action: cint): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = action
  inst.verticalScrollbarAction(slotval1)

proc fcQTableWidget_method_callback_horizontalScrollbarAction(self: pointer, action: cint): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = action
  inst.horizontalScrollbarAction(slotval1)

proc fcQTableWidget_method_callback_isIndexHidden(self: pointer, index: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
  var virtualReturn = inst.isIndexHidden(slotval1)
  virtualReturn

proc fcQTableWidget_method_callback_selectionChanged(self: pointer, selected: pointer, deselected: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qitemselectionmodel_types.QItemSelection(h: selected, owned: false)
  let slotval2 = gen_qitemselectionmodel_types.QItemSelection(h: deselected, owned: false)
  inst.selectionChanged(slotval1, slotval2)

proc fcQTableWidget_method_callback_currentChanged(self: pointer, current: pointer, previous: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: current, owned: false)
  let slotval2 = gen_qabstractitemmodel_types.QModelIndex(h: previous, owned: false)
  inst.currentChanged(slotval1, slotval2)

proc fcQTableWidget_method_callback_keyboardSearch(self: pointer, search: struct_seaqt_string): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let vsearch_ms = search
  let vsearchx_ret = string.fromBytes(vsearch_ms)
  c_free(vsearch_ms.data)
...
proc fcQTableWidget_method_callback_inputMethodQuery(self: pointer, query: cint): pointer {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = cint(query)
...
proc fcQTableWidget_method_callback_reset(self: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  inst.reset()

proc fcQTableWidget_method_callback_selectAll(self: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  inst.selectAll()

proc fcQTableWidget_method_callback_dataChanged(self: pointer, topLeft: pointer, bottomRight: pointer, roles: struct_seaqt_array): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: topLeft, owned: false)
  let slotval2 = gen_qabstractitemmodel_types.QModelIndex(h: bottomRight, owned: false)
  var vroles_ma = roles
...
proc fcQTableWidget_method_callback_rowsInserted(self: pointer, parent: pointer, start: cint, endVal: cint): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: parent, owned: false)
  let slotval2 = start
  let slotval3 = endVal
...
proc fcQTableWidget_method_callback_rowsAboutToBeRemoved(self: pointer, parent: pointer, start: cint, endVal: cint): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: parent, owned: false)
  let slotval2 = start
  let slotval3 = endVal
...
proc fcQTableWidget_method_callback_updateEditorData(self: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  inst.updateEditorData()

proc fcQTableWidget_method_callback_updateEditorGeometries(self: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  inst.updateEditorGeometries()

proc fcQTableWidget_method_callback_verticalScrollbarValueChanged(self: pointer, value: cint): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = value
  inst.verticalScrollbarValueChanged(slotval1)

proc fcQTableWidget_method_callback_horizontalScrollbarValueChanged(self: pointer, value: cint): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = value
  inst.horizontalScrollbarValueChanged(slotval1)

proc fcQTableWidget_method_callback_closeEditor(self: pointer, editor: pointer, hint: cint): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qwidget_types.QWidget(h: editor, owned: false)
  let slotval2 = cint(hint)
  inst.closeEditor(slotval1, slotval2)

proc fcQTableWidget_method_callback_commitData(self: pointer, editor: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qwidget_types.QWidget(h: editor, owned: false)
  inst.commitData(slotval1)

proc fcQTableWidget_method_callback_editorDestroyed(self: pointer, editor: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qobject_types.QObject(h: editor, owned: false)
...
proc fcQTableWidget_method_callback_selectionCommand(self: pointer, index: pointer, event: pointer): cint {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
  let slotval2 = gen_qcoreevent_types.QEvent(h: event, owned: false)
...
proc fcQTableWidget_method_callback_startDrag(self: pointer, supportedActions: cint): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = cint(supportedActions)
  inst.startDrag(slotval1)

proc fcQTableWidget_method_callback_focusNextPrevChild(self: pointer, next: bool): bool {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = next
  var virtualReturn = inst.focusNextPrevChild(slotval1)
  virtualReturn

proc fcQTableWidget_method_callback_viewportEvent(self: pointer, event: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
  var virtualReturn = inst.viewportEvent(slotval1)
  virtualReturn

proc fcQTableWidget_method_callback_mousePressEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
  inst.mousePressEvent(slotval1)

proc fcQTableWidget_method_callback_mouseMoveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
  inst.mouseMoveEvent(slotval1)

proc fcQTableWidget_method_callback_mouseReleaseEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
  inst.mouseReleaseEvent(slotval1)

proc fcQTableWidget_method_callback_mouseDoubleClickEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
  inst.mouseDoubleClickEvent(slotval1)

proc fcQTableWidget_method_callback_dragEnterEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QDragEnterEvent(h: event, owned: false)
  inst.dragEnterEvent(slotval1)

proc fcQTableWidget_method_callback_dragMoveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QDragMoveEvent(h: event, owned: false)
  inst.dragMoveEvent(slotval1)

proc fcQTableWidget_method_callback_dragLeaveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QDragLeaveEvent(h: event, owned: false)
  inst.dragLeaveEvent(slotval1)

proc fcQTableWidget_method_callback_focusInEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QFocusEvent(h: event, owned: false)
  inst.focusInEvent(slotval1)

proc fcQTableWidget_method_callback_focusOutEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QFocusEvent(h: event, owned: false)
  inst.focusOutEvent(slotval1)

proc fcQTableWidget_method_callback_keyPressEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QKeyEvent(h: event, owned: false)
  inst.keyPressEvent(slotval1)

proc fcQTableWidget_method_callback_resizeEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QResizeEvent(h: event, owned: false)
  inst.resizeEvent(slotval1)

proc fcQTableWidget_method_callback_inputMethodEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QInputMethodEvent(h: event, owned: false)
  inst.inputMethodEvent(slotval1)

proc fcQTableWidget_method_callback_eventFilter(self: pointer, objectVal: pointer, event: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qobject_types.QObject(h: objectVal, owned: false)
  let slotval2 = gen_qcoreevent_types.QEvent(h: event, owned: false)
...
proc fcQTableWidget_method_callback_minimumSizeHint(self: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
...
proc fcQTableWidget_method_callback_sizeHint(self: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
...
proc fcQTableWidget_method_callback_setupViewport(self: pointer, viewport: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qwidget_types.QWidget(h: viewport, owned: false)
  inst.setupViewport(slotval1)

proc fcQTableWidget_method_callback_wheelEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QWheelEvent(h: param1, owned: false)
  inst.wheelEvent(slotval1)

proc fcQTableWidget_method_callback_contextMenuEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QContextMenuEvent(h: param1, owned: false)
  inst.contextMenuEvent(slotval1)

proc fcQTableWidget_method_callback_changeEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qcoreevent_types.QEvent(h: param1, owned: false)
  inst.changeEvent(slotval1)

proc fcQTableWidget_method_callback_devType(self: pointer): cint {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  var virtualReturn = inst.devType()
  virtualReturn

proc fcQTableWidget_method_callback_setVisible(self: pointer, visible: bool): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = visible
  inst.setVisible(slotval1)

proc fcQTableWidget_method_callback_heightForWidth(self: pointer, param1: cint): cint {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = param1
  var virtualReturn = inst.heightForWidth(slotval1)
  virtualReturn

proc fcQTableWidget_method_callback_hasHeightForWidth(self: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  var virtualReturn = inst.hasHeightForWidth()
  virtualReturn

proc fcQTableWidget_method_callback_paintEngine(self: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
...
proc fcQTableWidget_method_callback_keyReleaseEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QKeyEvent(h: event, owned: false)
  inst.keyReleaseEvent(slotval1)

proc fcQTableWidget_method_callback_enterEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
  inst.enterEvent(slotval1)

proc fcQTableWidget_method_callback_leaveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
  inst.leaveEvent(slotval1)

proc fcQTableWidget_method_callback_moveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QMoveEvent(h: event, owned: false)
  inst.moveEvent(slotval1)

proc fcQTableWidget_method_callback_closeEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QCloseEvent(h: event, owned: false)
  inst.closeEvent(slotval1)

proc fcQTableWidget_method_callback_tabletEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QTabletEvent(h: event, owned: false)
  inst.tabletEvent(slotval1)

proc fcQTableWidget_method_callback_actionEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QActionEvent(h: event, owned: false)
  inst.actionEvent(slotval1)

proc fcQTableWidget_method_callback_showEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QShowEvent(h: event, owned: false)
  inst.showEvent(slotval1)

proc fcQTableWidget_method_callback_hideEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QHideEvent(h: event, owned: false)
  inst.hideEvent(slotval1)

proc fcQTableWidget_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc fcQTableWidget_method_callback_metric(self: pointer, param1: cint): cint {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = cint(param1)
  var virtualReturn = inst.metric(slotval1)
  virtualReturn

proc fcQTableWidget_method_callback_initPainter(self: pointer, painter: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qpainter_types.QPainter(h: painter, owned: false)
  inst.initPainter(slotval1)

proc fcQTableWidget_method_callback_redirected(self: pointer, offset: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qpoint_types.QPoint(h: offset, owned: false)
...
proc fcQTableWidget_method_callback_sharedPainter(self: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
...
proc fcQTableWidget_method_callback_childEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qcoreevent_types.QChildEvent(h: event, owned: false)
  inst.childEvent(slotval1)

proc fcQTableWidget_method_callback_customEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
  inst.customEvent(slotval1)

proc fcQTableWidget_method_callback_connectNotify(self: pointer, signal: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qmetaobject_types.QMetaMethod(h: signal, owned: false)
  inst.connectNotify(slotval1)

proc fcQTableWidget_method_callback_disconnectNotify(self: pointer, signal: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qmetaobject_types.QMetaMethod(h: signal, owned: false)
...
proc indexFromItem*(self: gen_qtablewidget_types.QTableWidget, item: gen_qtablewidget_types.QTableWidgetItem): gen_qabstractitemmodel_types.QModelIndex =
  gen_qabstractitemmodel_types.QModelIndex(h: fcQTableWidget_protectedbase_indexFromItem_const_pcQTableWidgetItem(self.h, item.h), owned: true)

proc indexFromItem*(self: gen_qtablewidget_types.QTableWidget, item: gen_qtablewidget_types.QTableWidgetItem): gen_qabstractitemmodel_types.QModelIndex =
  gen_qabstractitemmodel_types.QModelIndex(h: fcQTableWidget_protectedbase_indexFromItem_const_pQTableWidgetItem(self.h, item.h), owned: true)
...
proc create*(T: type gen_qtablewidget_types.QTableWidget,
  ...
  if not isNil(vtbl[].metaObject):
    vtbl[].vtbl.metaObject = fcQTableWidget_vtable_callback_metaObject
  if not isNil(vtbl[].metacast):
    vtbl[].vtbl.metacast = fcQTableWidget_vtable_callback_metacast
  if not isNil(vtbl[].metacall):
    vtbl[].vtbl.metacall = fcQTableWidget_vtable_callback_metacall
  if not isNil(vtbl[].event):
    vtbl[].vtbl.event = fcQTableWidget_vtable_callback_event
  if not isNil(vtbl[].mimeTypes):
    vtbl[].vtbl.mimeTypes = fcQTableWidget_vtable_callback_mimeTypes
  if not isNil(vtbl[].mimeData):
    vtbl[].vtbl.mimeData = fcQTableWidget_vtable_callback_mimeData
  if not isNil(vtbl[].dropMimeData):
    vtbl[].vtbl.dropMimeData = fcQTableWidget_vtable_callback_dropMimeData
  if not isNil(vtbl[].supportedDropActions):
    vtbl[].vtbl.supportedDropActions = fcQTableWidget_vtable_callback_supportedDropActions
  if not isNil(vtbl[].dropEvent):
    vtbl[].vtbl.dropEvent = fcQTableWidget_vtable_callback_dropEvent
  if not isNil(vtbl[].setRootIndex):
    vtbl[].vtbl.setRootIndex = fcQTableWidget_vtable_callback_setRootIndex
  if not isNil(vtbl[].setSelectionModel):
    vtbl[].vtbl.setSelectionModel = fcQTableWidget_vtable_callback_setSelectionModel
  if not isNil(vtbl[].doItemsLayout):
    vtbl[].vtbl.doItemsLayout = fcQTableWidget_vtable_callback_doItemsLayout
  if not isNil(vtbl[].visualRect):
    vtbl[].vtbl.visualRect = fcQTableWidget_vtable_callback_visualRect
  if not isNil(vtbl[].scrollTo):
    vtbl[].vtbl.scrollTo = fcQTableWidget_vtable_callback_scrollTo
  if not isNil(vtbl[].indexAt):
    vtbl[].vtbl.indexAt = fcQTableWidget_vtable_callback_indexAt
  if not isNil(vtbl[].scrollContentsBy):
    vtbl[].vtbl.scrollContentsBy = fcQTableWidget_vtable_callback_scrollContentsBy
  if not isNil(vtbl[].viewOptions):
    vtbl[].vtbl.viewOptions = fcQTableWidget_vtable_callback_viewOptions
  if not isNil(vtbl[].paintEvent):
    vtbl[].vtbl.paintEvent = fcQTableWidget_vtable_callback_paintEvent
  if not isNil(vtbl[].timerEvent):
    vtbl[].vtbl.timerEvent = fcQTableWidget_vtable_callback_timerEvent
  if not isNil(vtbl[].horizontalOffset):
    vtbl[].vtbl.horizontalOffset = fcQTableWidget_vtable_callback_horizontalOffset
  if not isNil(vtbl[].verticalOffset):
    vtbl[].vtbl.verticalOffset = fcQTableWidget_vtable_callback_verticalOffset
  if not isNil(vtbl[].moveCursor):
    vtbl[].vtbl.moveCursor = fcQTableWidget_vtable_callback_moveCursor
  if not isNil(vtbl[].setSelection):
    vtbl[].vtbl.setSelection = fcQTableWidget_vtable_callback_setSelection
  if not isNil(vtbl[].visualRegionForSelection):
    vtbl[].vtbl.visualRegionForSelection = fcQTableWidget_vtable_callback_visualRegionForSelection
  if not isNil(vtbl[].selectedIndexes):
    vtbl[].vtbl.selectedIndexes = fcQTableWidget_vtable_callback_selectedIndexes
  if not isNil(vtbl[].updateGeometries):
    vtbl[].vtbl.updateGeometries = fcQTableWidget_vtable_callback_updateGeometries
  if not isNil(vtbl[].viewportSizeHint):
    vtbl[].vtbl.viewportSizeHint = fcQTableWidget_vtable_callback_viewportSizeHint
  if not isNil(vtbl[].sizeHintForRow):
    vtbl[].vtbl.sizeHintForRow = fcQTableWidget_vtable_callback_sizeHintForRow
  if not isNil(vtbl[].sizeHintForColumn):
    vtbl[].vtbl.sizeHintForColumn = fcQTableWidget_vtable_callback_sizeHintForColumn
  if not isNil(vtbl[].verticalScrollbarAction):
    vtbl[].vtbl.verticalScrollbarAction = fcQTableWidget_vtable_callback_verticalScrollbarAction
  if not isNil(vtbl[].horizontalScrollbarAction):
    vtbl[].vtbl.horizontalScrollbarAction = fcQTableWidget_vtable_callback_horizontalScrollbarAction
  if not isNil(vtbl[].isIndexHidden):
    vtbl[].vtbl.isIndexHidden = fcQTableWidget_vtable_callback_isIndexHidden
  if not isNil(vtbl[].selectionChanged):
    vtbl[].vtbl.selectionChanged = fcQTableWidget_vtable_callback_selectionChanged
  if not isNil(vtbl[].currentChanged):
    vtbl[].vtbl.currentChanged = fcQTableWidget_vtable_callback_currentChanged
  if not isNil(vtbl[].keyboardSearch):
    vtbl[].vtbl.keyboardSearch = fcQTableWidget_vtable_callback_keyboardSearch
  if not isNil(vtbl[].inputMethodQuery):
    vtbl[].vtbl.inputMethodQuery = fcQTableWidget_vtable_callback_inputMethodQuery
  if not isNil(vtbl[].reset):
    vtbl[].vtbl.reset = fcQTableWidget_vtable_callback_reset
  if not isNil(vtbl[].selectAll):
    vtbl[].vtbl.selectAll = fcQTableWidget_vtable_callback_selectAll
  if not isNil(vtbl[].dataChanged):
    vtbl[].vtbl.dataChanged = fcQTableWidget_vtable_callback_dataChanged
  if not isNil(vtbl[].rowsInserted):
    vtbl[].vtbl.rowsInserted = fcQTableWidget_vtable_callback_rowsInserted
  if not isNil(vtbl[].rowsAboutToBeRemoved):
    vtbl[].vtbl.rowsAboutToBeRemoved = fcQTableWidget_vtable_callback_rowsAboutToBeRemoved
  if not isNil(vtbl[].updateEditorData):
    vtbl[].vtbl.updateEditorData = fcQTableWidget_vtable_callback_updateEditorData
  if not isNil(vtbl[].updateEditorGeometries):
    vtbl[].vtbl.updateEditorGeometries = fcQTableWidget_vtable_callback_updateEditorGeometries
  if not isNil(vtbl[].verticalScrollbarValueChanged):
    vtbl[].vtbl.verticalScrollbarValueChanged = fcQTableWidget_vtable_callback_verticalScrollbarValueChanged
  if not isNil(vtbl[].horizontalScrollbarValueChanged):
    vtbl[].vtbl.horizontalScrollbarValueChanged = fcQTableWidget_vtable_callback_horizontalScrollbarValueChanged
  if not isNil(vtbl[].closeEditor):
    vtbl[].vtbl.closeEditor = fcQTableWidget_vtable_callback_closeEditor
  ...
  if not isNil(vtbl[].startDrag):
    vtbl[].vtbl.startDrag = fcQTableWidget_vtable_callback_startDrag
  if not isNil(vtbl[].focusNextPrevChild):
    vtbl[].vtbl.focusNextPrevChild = fcQTableWidget_vtable_callback_focusNextPrevChild
  if not isNil(vtbl[].viewportEvent):
    vtbl[].vtbl.viewportEvent = fcQTableWidget_vtable_callback_viewportEvent
  if not isNil(vtbl[].mousePressEvent):
    vtbl[].vtbl.mousePressEvent = fcQTableWidget_vtable_callback_mousePressEvent
  if not isNil(vtbl[].mouseMoveEvent):
    vtbl[].vtbl.mouseMoveEvent = fcQTableWidget_vtable_callback_mouseMoveEvent
  if not isNil(vtbl[].mouseReleaseEvent):
    vtbl[].vtbl.mouseReleaseEvent = fcQTableWidget_vtable_callback_mouseReleaseEvent
  if not isNil(vtbl[].mouseDoubleClickEvent):
    vtbl[].vtbl.mouseDoubleClickEvent = fcQTableWidget_vtable_callback_mouseDoubleClickEvent
  if not isNil(vtbl[].dragEnterEvent):
    vtbl[].vtbl.dragEnterEvent = fcQTableWidget_vtable_callback_dragEnterEvent
  if not isNil(vtbl[].dragMoveEvent):
    vtbl[].vtbl.dragMoveEvent = fcQTableWidget_vtable_callback_dragMoveEvent
  if not isNil(vtbl[].dragLeaveEvent):
    vtbl[].vtbl.dragLeaveEvent = fcQTableWidget_vtable_callback_dragLeaveEvent
  if not isNil(vtbl[].focusInEvent):
    vtbl[].vtbl.focusInEvent = fcQTableWidget_vtable_callback_focusInEvent
  if not isNil(vtbl[].focusOutEvent):
    vtbl[].vtbl.focusOutEvent = fcQTableWidget_vtable_callback_focusOutEvent
  if not isNil(vtbl[].keyPressEvent):
    vtbl[].vtbl.keyPressEvent = fcQTableWidget_vtable_callback_keyPressEvent
  if not isNil(vtbl[].resizeEvent):
    vtbl[].vtbl.resizeEvent = fcQTableWidget_vtable_callback_resizeEvent
  if not isNil(vtbl[].inputMethodEvent):
    vtbl[].vtbl.inputMethodEvent = fcQTableWidget_vtable_callback_inputMethodEvent
  if not isNil(vtbl[].eventFilter):
    vtbl[].vtbl.eventFilter = fcQTableWidget_vtable_callback_eventFilter
  if not isNil(vtbl[].minimumSizeHint):
    vtbl[].vtbl.minimumSizeHint = fcQTableWidget_vtable_callback_minimumSizeHint
  if not isNil(vtbl[].sizeHint):
    vtbl[].vtbl.sizeHint = fcQTableWidget_vtable_callback_sizeHint
  if not isNil(vtbl[].setupViewport):
    vtbl[].vtbl.setupViewport = fcQTableWidget_vtable_callback_setupViewport
  if not isNil(vtbl[].wheelEvent):
    vtbl[].vtbl.wheelEvent = fcQTableWidget_vtable_callback_wheelEvent
  if not isNil(vtbl[].contextMenuEvent):
    vtbl[].vtbl.contextMenuEvent = fcQTableWidget_vtable_callback_contextMenuEvent
  if not isNil(vtbl[].changeEvent):
    vtbl[].vtbl.changeEvent = fcQTableWidget_vtable_callback_changeEvent
  if not isNil(vtbl[].devType):
    vtbl[].vtbl.devType = fcQTableWidget_vtable_callback_devType
  if not isNil(vtbl[].setVisible):
    vtbl[].vtbl.setVisible = fcQTableWidget_vtable_callback_setVisible
  if not isNil(vtbl[].heightForWidth):
    vtbl[].vtbl.heightForWidth = fcQTableWidget_vtable_callback_heightForWidth
  if not isNil(vtbl[].hasHeightForWidth):
    vtbl[].vtbl.hasHeightForWidth = fcQTableWidget_vtable_callback_hasHeightForWidth
  if not isNil(vtbl[].paintEngine):
    vtbl[].vtbl.paintEngine = fcQTableWidget_vtable_callback_paintEngine
  if not isNil(vtbl[].keyReleaseEvent):
    vtbl[].vtbl.keyReleaseEvent = fcQTableWidget_vtable_callback_keyReleaseEvent
  if not isNil(vtbl[].enterEvent):
    vtbl[].vtbl.enterEvent = fcQTableWidget_vtable_callback_enterEvent
  if not isNil(vtbl[].leaveEvent):
    vtbl[].vtbl.leaveEvent = fcQTableWidget_vtable_callback_leaveEvent
  if not isNil(vtbl[].moveEvent):
    vtbl[].vtbl.moveEvent = fcQTableWidget_vtable_callback_moveEvent
  if not isNil(vtbl[].closeEvent):
    vtbl[].vtbl.closeEvent = fcQTableWidget_vtable_callback_closeEvent
  if not isNil(vtbl[].tabletEvent):
    vtbl[].vtbl.tabletEvent = fcQTableWidget_vtable_callback_tabletEvent
  if not isNil(vtbl[].actionEvent):
    vtbl[].vtbl.actionEvent = fcQTableWidget_vtable_callback_actionEvent
  if not isNil(vtbl[].showEvent):
    vtbl[].vtbl.showEvent = fcQTableWidget_vtable_callback_showEvent
  if not isNil(vtbl[].hideEvent):
    vtbl[].vtbl.hideEvent = fcQTableWidget_vtable_callback_hideEvent
  if not isNil(vtbl[].nativeEvent):
    vtbl[].vtbl.nativeEvent = fcQTableWidget_vtable_callback_nativeEvent
  if not isNil(vtbl[].metric):
    vtbl[].vtbl.metric = fcQTableWidget_vtable_callback_metric
  if not isNil(vtbl[].initPainter):
    vtbl[].vtbl.initPainter = fcQTableWidget_vtable_callback_initPainter
  if not isNil(vtbl[].redirected):
    vtbl[].vtbl.redirected = fcQTableWidget_vtable_callback_redirected
  if not isNil(vtbl[].sharedPainter):
    vtbl[].vtbl.sharedPainter = fcQTableWidget_vtable_callback_sharedPainter
  if not isNil(vtbl[].childEvent):
    vtbl[].vtbl.childEvent = fcQTableWidget_vtable_callback_childEvent
  if not isNil(vtbl[].customEvent):
    vtbl[].vtbl.customEvent = fcQTableWidget_vtable_callback_customEvent
  if not isNil(vtbl[].connectNotify):
    vtbl[].vtbl.connectNotify = fcQTableWidget_vtable_callback_connectNotify
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQTableWidget_vtable_callback_disconnectNotify
  let tmp = gen_qtablewidget_types.QTableWidget(h: fcQTableWidget_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQTableWidget_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qtablewidget_types.QTableWidget,
    vtbl: ref QTableWidgetVTable = nil): gen_qtablewidget_types.QTableWidget =
  let vtbl = if vtbl == nil: new QTableWidgetVTable else: vtbl
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQTableWidget_vtable_callback_disconnectNotify
  let tmp = gen_qtablewidget_types.QTableWidget(h: fcQTableWidget_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQTableWidget_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qtablewidget_types.QTableWidget,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQTableWidget_vtable_callback_disconnectNotify
  let tmp = gen_qtablewidget_types.QTableWidget(h: fcQTableWidget_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), rows, columns), owned: true)
  fcQTableWidget_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qtablewidget_types.QTableWidget,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQTableWidget_vtable_callback_disconnectNotify
  let tmp = gen_qtablewidget_types.QTableWidget(h: fcQTableWidget_new4(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), rows, columns, parent.h), owned: true)
  fcQTableWidget_vdata(tmp.h)[] = addr(vtbl[])
  tmp
const cQTableWidget_mvtbl = cQTableWidgetVTable(
  ...
  metaObject: fcQTableWidget_method_callback_metaObject,
  metacast: fcQTableWidget_method_callback_metacast,
  metacall: fcQTableWidget_method_callback_metacall,
  event: fcQTableWidget_method_callback_event,
  mimeTypes: fcQTableWidget_method_callback_mimeTypes,
  mimeData: fcQTableWidget_method_callback_mimeData,
  dropMimeData: fcQTableWidget_method_callback_dropMimeData,
  supportedDropActions: fcQTableWidget_method_callback_supportedDropActions,
  dropEvent: fcQTableWidget_method_callback_dropEvent,
  setRootIndex: fcQTableWidget_method_callback_setRootIndex,
  setSelectionModel: fcQTableWidget_method_callback_setSelectionModel,
  doItemsLayout: fcQTableWidget_method_callback_doItemsLayout,
  visualRect: fcQTableWidget_method_callback_visualRect,
  scrollTo: fcQTableWidget_method_callback_scrollTo,
  indexAt: fcQTableWidget_method_callback_indexAt,
  scrollContentsBy: fcQTableWidget_method_callback_scrollContentsBy,
  viewOptions: fcQTableWidget_method_callback_viewOptions,
  paintEvent: fcQTableWidget_method_callback_paintEvent,
  timerEvent: fcQTableWidget_method_callback_timerEvent,
  horizontalOffset: fcQTableWidget_method_callback_horizontalOffset,
  verticalOffset: fcQTableWidget_method_callback_verticalOffset,
  moveCursor: fcQTableWidget_method_callback_moveCursor,
  setSelection: fcQTableWidget_method_callback_setSelection,
  visualRegionForSelection: fcQTableWidget_method_callback_visualRegionForSelection,
  selectedIndexes: fcQTableWidget_method_callback_selectedIndexes,
  updateGeometries: fcQTableWidget_method_callback_updateGeometries,
  viewportSizeHint: fcQTableWidget_method_callback_viewportSizeHint,
  sizeHintForRow: fcQTableWidget_method_callback_sizeHintForRow,
  sizeHintForColumn: fcQTableWidget_method_callback_sizeHintForColumn,
  verticalScrollbarAction: fcQTableWidget_method_callback_verticalScrollbarAction,
  horizontalScrollbarAction: fcQTableWidget_method_callback_horizontalScrollbarAction,
  isIndexHidden: fcQTableWidget_method_callback_isIndexHidden,
  selectionChanged: fcQTableWidget_method_callback_selectionChanged,
  currentChanged: fcQTableWidget_method_callback_currentChanged,
  keyboardSearch: fcQTableWidget_method_callback_keyboardSearch,
  inputMethodQuery: fcQTableWidget_method_callback_inputMethodQuery,
  reset: fcQTableWidget_method_callback_reset,
  selectAll: fcQTableWidget_method_callback_selectAll,
  dataChanged: fcQTableWidget_method_callback_dataChanged,
  rowsInserted: fcQTableWidget_method_callback_rowsInserted,
  rowsAboutToBeRemoved: fcQTableWidget_method_callback_rowsAboutToBeRemoved,
  updateEditorData: fcQTableWidget_method_callback_updateEditorData,
  updateEditorGeometries: fcQTableWidget_method_callback_updateEditorGeometries,
  verticalScrollbarValueChanged: fcQTableWidget_method_callback_verticalScrollbarValueChanged,
  horizontalScrollbarValueChanged: fcQTableWidget_method_callback_horizontalScrollbarValueChanged,
  ...
  viewportEvent: fcQTableWidget_method_callback_viewportEvent,
  mousePressEvent: fcQTableWidget_method_callback_mousePressEvent,
  mouseMoveEvent: fcQTableWidget_method_callback_mouseMoveEvent,
  mouseReleaseEvent: fcQTableWidget_method_callback_mouseReleaseEvent,
  mouseDoubleClickEvent: fcQTableWidget_method_callback_mouseDoubleClickEvent,
  dragEnterEvent: fcQTableWidget_method_callback_dragEnterEvent,
  dragMoveEvent: fcQTableWidget_method_callback_dragMoveEvent,
  dragLeaveEvent: fcQTableWidget_method_callback_dragLeaveEvent,
  focusInEvent: fcQTableWidget_method_callback_focusInEvent,
  focusOutEvent: fcQTableWidget_method_callback_focusOutEvent,
  keyPressEvent: fcQTableWidget_method_callback_keyPressEvent,
  resizeEvent: fcQTableWidget_method_callback_resizeEvent,
  inputMethodEvent: fcQTableWidget_method_callback_inputMethodEvent,
  eventFilter: fcQTableWidget_method_callback_eventFilter,
  minimumSizeHint: fcQTableWidget_method_callback_minimumSizeHint,
  sizeHint: fcQTableWidget_method_callback_sizeHint,
  setupViewport: fcQTableWidget_method_callback_setupViewport,
  wheelEvent: fcQTableWidget_method_callback_wheelEvent,
  contextMenuEvent: fcQTableWidget_method_callback_contextMenuEvent,
  changeEvent: fcQTableWidget_method_callback_changeEvent,
  devType: fcQTableWidget_method_callback_devType,
  setVisible: fcQTableWidget_method_callback_setVisible,
  heightForWidth: fcQTableWidget_method_callback_heightForWidth,
  hasHeightForWidth: fcQTableWidget_method_callback_hasHeightForWidth,
  paintEngine: fcQTableWidget_method_callback_paintEngine,
  keyReleaseEvent: fcQTableWidget_method_callback_keyReleaseEvent,
  enterEvent: fcQTableWidget_method_callback_enterEvent,
  leaveEvent: fcQTableWidget_method_callback_leaveEvent,
  moveEvent: fcQTableWidget_method_callback_moveEvent,
  closeEvent: fcQTableWidget_method_callback_closeEvent,
  tabletEvent: fcQTableWidget_method_callback_tabletEvent,
  actionEvent: fcQTableWidget_method_callback_actionEvent,
  showEvent: fcQTableWidget_method_callback_showEvent,
  hideEvent: fcQTableWidget_method_callback_hideEvent,
  nativeEvent: fcQTableWidget_method_callback_nativeEvent,
  metric: fcQTableWidget_method_callback_metric,
  initPainter: fcQTableWidget_method_callback_initPainter,
  redirected: fcQTableWidget_method_callback_redirected,
  sharedPainter: fcQTableWidget_method_callback_sharedPainter,
  childEvent: fcQTableWidget_method_callback_childEvent,
  customEvent: fcQTableWidget_method_callback_customEvent,
  connectNotify: fcQTableWidget_method_callback_connectNotify,
  disconnectNotify: fcQTableWidget_method_callback_disconnectNotify,
)
proc create*(T: type gen_qtablewidget_types.QTableWidget,
    parent: gen_qwidget_types.QWidget,
    inst: VirtualQTableWidget) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQTableWidget_new(addr(cQTableWidget_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQTableWidget_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true

proc create*(T: type gen_qtablewidget_types.QTableWidget,
    inst: VirtualQTableWidget) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQTableWidget_new2(addr(cQTableWidget_mvtbl), csize_t(sizeof(pointer)))
  fcQTableWidget_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qtablewidget_types.QTableWidget,
    ...
    inst: VirtualQTableWidget) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQTableWidget_new3(addr(cQTableWidget_mvtbl), csize_t(sizeof(pointer)), rows, columns)
  fcQTableWidget_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qtablewidget_types.QTableWidget,
    ...
    inst: VirtualQTableWidget) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQTableWidget_new4(addr(cQTableWidget_mvtbl), csize_t(sizeof(pointer)), rows, columns, parent.h)
  fcQTableWidget_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
