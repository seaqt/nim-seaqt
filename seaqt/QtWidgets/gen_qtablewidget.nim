...
proc cQTableWidget_vtable_callback_viewOptions(self: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self))
  let self = QTableWidget(h: self)
...
proc cQTableWidget_vtable_callback_nativeEvent(self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self))
  let self = QTableWidget(h: self)
...
proc cQTableWidget_method_callback_viewOptions(self: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self))
...
proc cQTableWidget_method_callback_nativeEvent(self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self))
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc create*(T: type gen_qtablewidget_types.QTableWidget,
  ...
  if not isNil(vtbl[].viewOptions):
    vtbl[].vtbl.viewOptions = cQTableWidget_vtable_callback_viewOptions
...
const cQTableWidget_mvtbl = cQTableWidgetVTable(
  ...
  viewOptions: cQTableWidget_method_callback_viewOptions,
