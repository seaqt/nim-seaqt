...
proc fcQTableWidget_items(self: pointer, data: pointer): struct_seaqt_array {.importc: "QTableWidget_items".}
...
proc fcQTableWidget_supportedDragActions(self: pointer): cint {.importc: "QTableWidget_supportedDragActions".}
proc fcQTableWidget_setSupportedDragActions(self: pointer, actions: cint): void {.importc: "QTableWidget_setSupportedDragActions".}
...
proc fcQTableWidget_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.importc: "QTableWidget_virtualbase_nativeEvent".}
...
proc fcQTableWidget_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QTableWidget_protectedbase_getDecodedMetricF".}
...
proc supportedDragActions*(self: gen_qtablewidget_types.QTableWidget): cint =
  cint(fcQTableWidget_supportedDragActions(self.h))

proc setSupportedDragActions*(self: gen_qtablewidget_types.QTableWidget, actions: cint): void =
  fcQTableWidget_setSupportedDragActions(self.h, cint(actions))
...
type QTableWidgetnativeEventProc* = proc(self: QTableWidget, eventType: openArray[byte], message: pointer, resultVal: ptr uint): bool {.raises: [], gcsafe.}
...
proc QTableWidgetnativeEvent*(self: gen_qtablewidget_types.QTableWidget, eventType: openArray[byte], message: pointer, resultVal: ptr uint): bool =
...
proc fcQTableWidget_vtable_callback_initViewItemOption(self: pointer, option: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
...
proc fcQTableWidget_vtable_callback_itemDelegateForIndex(self: pointer, index: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
...
proc fcQTableWidget_vtable_callback_initStyleOption(self: pointer, option: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
...
proc fcQTableWidget_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QTableWidgetVTable](fcQTableWidget_vdata(self)[])
  let self = QTableWidget(h: self)
...
method nativeEvent*(self: VirtualQTableWidget, eventType: openArray[byte], message: pointer, resultVal: ptr uint): bool {.base.} =
...
proc fcQTableWidget_method_callback_initViewItemOption(self: pointer, option: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qstyleoption_types.QStyleOptionViewItem(h: option, owned: false)
...
proc fcQTableWidget_method_callback_itemDelegateForIndex(self: pointer, index: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
...
proc fcQTableWidget_method_callback_initStyleOption(self: pointer, option: pointer): void {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  let slotval1 = gen_qstyleoption_types.QStyleOptionFrame(h: option, owned: false)
...
proc fcQTableWidget_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let inst = cast[VirtualQTableWidget](fcQTableWidget_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc getDecodedMetricF*(self: gen_qtablewidget_types.QTableWidget, metricA: cint, metricB: cint): float64 =
  fcQTableWidget_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
...
proc create*(T: type gen_qtablewidget_types.QTableWidget,
  ...
  if not isNil(vtbl[].initViewItemOption):
    vtbl[].vtbl.initViewItemOption = fcQTableWidget_vtable_callback_initViewItemOption
  ...
  if not isNil(vtbl[].itemDelegateForIndex):
    vtbl[].vtbl.itemDelegateForIndex = fcQTableWidget_vtable_callback_itemDelegateForIndex
  ...
  if not isNil(vtbl[].initStyleOption):
    vtbl[].vtbl.initStyleOption = fcQTableWidget_vtable_callback_initStyleOption
...
const cQTableWidget_mvtbl = cQTableWidgetVTable(
  ...
  initViewItemOption: fcQTableWidget_method_callback_initViewItemOption,
  ...
  itemDelegateForIndex: fcQTableWidget_method_callback_itemDelegateForIndex,
  ...
  initStyleOption: fcQTableWidget_method_callback_initStyleOption,
