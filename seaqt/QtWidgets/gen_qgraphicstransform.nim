...
proc fcQGraphicsTransform_trUtf8(s: cstring): struct_seaqt_string {.importc: "QGraphicsTransform_trUtf8".}
...
proc fcQGraphicsTransform_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QGraphicsTransform_trUtf82".}
proc fcQGraphicsTransform_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QGraphicsTransform_trUtf83".}
...
proc fcQGraphicsScale_trUtf8(s: cstring): struct_seaqt_string {.importc: "QGraphicsScale_trUtf8".}
...
proc fcQGraphicsScale_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QGraphicsScale_trUtf82".}
proc fcQGraphicsScale_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QGraphicsScale_trUtf83".}
...
proc fcQGraphicsRotation_trUtf8(s: cstring): struct_seaqt_string {.importc: "QGraphicsRotation_trUtf8".}
...
proc fcQGraphicsRotation_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QGraphicsRotation_trUtf82".}
proc fcQGraphicsRotation_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QGraphicsRotation_trUtf83".}
