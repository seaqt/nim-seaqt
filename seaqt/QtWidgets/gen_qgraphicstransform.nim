...
proc fcQGraphicsTransform_trUtf8S(s: cstring): struct_seaqt_string {.importc: "QGraphicsTransform_trUtf8_s".}
...
proc fcQGraphicsTransform_trUtf8SC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QGraphicsTransform_trUtf8_s_c".}
proc fcQGraphicsTransform_trUtf8SCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QGraphicsTransform_trUtf8_s_c_n".}
...
proc fcQGraphicsScale_trUtf8S(s: cstring): struct_seaqt_string {.importc: "QGraphicsScale_trUtf8_s".}
...
proc fcQGraphicsScale_trUtf8SC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QGraphicsScale_trUtf8_s_c".}
proc fcQGraphicsScale_trUtf8SCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QGraphicsScale_trUtf8_s_c_n".}
...
proc fcQGraphicsRotation_trUtf8S(s: cstring): struct_seaqt_string {.importc: "QGraphicsRotation_trUtf8_s".}
...
proc fcQGraphicsRotation_trUtf8SC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QGraphicsRotation_trUtf8_s_c".}
proc fcQGraphicsRotation_trUtf8SCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QGraphicsRotation_trUtf8_s_c_n".}
...
proc trUtf8*(_: type gen_qgraphicstransform_types.QGraphicsTransform, s: cstring): string =
  let v_ms = fcQGraphicsTransform_trUtf8S(s)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc trUtf8*(_: type gen_qgraphicstransform_types.QGraphicsScale, s: cstring): string =
  let v_ms = fcQGraphicsScale_trUtf8S(s)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc trUtf8*(_: type gen_qgraphicstransform_types.QGraphicsRotation, s: cstring): string =
  let v_ms = fcQGraphicsRotation_trUtf8S(s)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
