...
proc fcQDialog_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.importc: "QDialog_virtualbase_nativeEvent".}
...
proc fcQDialog_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QDialog_protectedbase_getDecodedMetricF".}
...
proc fcQDialog_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QDialogVTable](fcQDialog_vdata(self)[])
  let self = QDialog(h: self)
...
proc fcQDialog_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let inst = cast[VirtualQDialog](fcQDialog_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc getDecodedMetricF*(self: gen_qdialog_types.QDialog, metricA: cint, metricB: cint): float64 =
  fcQDialog_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
