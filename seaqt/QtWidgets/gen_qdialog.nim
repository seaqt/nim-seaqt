...
proc create*(T: type gen_qdialog_types.QDialog,
  ...
  let tmp = gen_qdialog_types.QDialog(h: fcQDialog_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))))
...
proc create*(T: type gen_qdialog_types.QDialog,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQDialog_vtable_callback_disconnectNotify
  let tmp = gen_qdialog_types.QDialog(h: fcQDialog_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h))
  fcQDialog_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qdialog_types.QDialog,
