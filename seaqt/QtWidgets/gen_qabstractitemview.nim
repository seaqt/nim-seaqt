...
proc fcQAbstractItemView_trUtf8(s: cstring): struct_seaqt_string {.importc: "QAbstractItemView_trUtf8".}
...
proc fcQAbstractItemView_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QAbstractItemView_trUtf82".}
proc fcQAbstractItemView_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QAbstractItemView_trUtf83".}
...
proc fcQAbstractItemView_new(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQAbstractItemView {.importc: "QAbstractItemView_new".}
proc fcQAbstractItemView_new2(vtbl: pointer, vdata: csize_t): ptr cQAbstractItemView {.importc: "QAbstractItemView_new2".}
