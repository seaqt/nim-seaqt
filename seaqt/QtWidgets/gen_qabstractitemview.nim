...
proc fcQAbstractItemView_trUtf8S(s: cstring): struct_seaqt_string {.importc: "QAbstractItemView_trUtf8_s".}
...
proc fcQAbstractItemView_trUtf8SC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QAbstractItemView_trUtf8_s_c".}
proc fcQAbstractItemView_trUtf8SCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QAbstractItemView_trUtf8_s_c_n".}
...
proc fcQAbstractItemView_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.importc: "QAbstractItemView_virtualbase_nativeEvent".}
...
proc fcQAbstractItemView_new(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQAbstractItemView {.importc: "QAbstractItemView_new_parent".}
proc fcQAbstractItemView_new2(vtbl: pointer, vdata: csize_t): ptr cQAbstractItemView {.importc: "QAbstractItemView_new".}
...
proc trUtf8*(_: type gen_qabstractitemview_types.QAbstractItemView, s: cstring): string =
  let v_ms = fcQAbstractItemView_trUtf8S(s)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc fcQAbstractItemView_vtable_callback_viewOptions(self: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QAbstractItemViewVTable](fcQAbstractItemView_vdata(self)[])
  let self = QAbstractItemView(h: self)
...
proc fcQAbstractItemView_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let vtbl = cast[ptr QAbstractItemViewVTable](fcQAbstractItemView_vdata(self)[])
  let self = QAbstractItemView(h: self)
...
proc fcQAbstractItemView_method_callback_viewOptions(self: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQAbstractItemView](fcQAbstractItemView_vdata(self)[])
...
proc fcQAbstractItemView_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let inst = cast[VirtualQAbstractItemView](fcQAbstractItemView_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc create*(T: type gen_qabstractitemview_types.QAbstractItemView,
  ...
  if not isNil(vtbl[].viewOptions):
    vtbl[].vtbl.viewOptions = fcQAbstractItemView_vtable_callback_viewOptions
  ...
  let tmp = gen_qabstractitemview_types.QAbstractItemView(h: fcQAbstractItemView_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
...
proc create*(T: type gen_qabstractitemview_types.QAbstractItemView,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQAbstractItemView_vtable_callback_disconnectNotify
  let tmp = gen_qabstractitemview_types.QAbstractItemView(h: fcQAbstractItemView_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQAbstractItemView_vdata(tmp.h)[] = addr(vtbl[])
  tmp
const cQAbstractItemView_mvtbl = cQAbstractItemViewVTable(
  ...
  viewOptions: fcQAbstractItemView_method_callback_viewOptions,
