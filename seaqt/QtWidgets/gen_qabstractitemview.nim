...
proc miqt_exec_method_cQAbstractItemView_viewOptions(vtbl: pointer, inst: pointer): pointer {.cdecl.} =
  let vtbl = cast[VirtualQAbstractItemView](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractItemView, vtbl)))
...
method nativeEvent*(self: VirtualQAbstractItemView, eventType: seq[byte], message: pointer, resultVal: ptr clong): bool {.base.} =
  QAbstractItemViewnativeEvent(self[], eventType, message, resultVal)
proc miqt_exec_method_cQAbstractItemView_nativeEvent(vtbl: pointer, inst: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let vtbl = cast[VirtualQAbstractItemView](cast[uint](vtbl) - uint(offsetOf(VirtualQAbstractItemView, vtbl)))
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArrayByte(veventType_bytearray.data, 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc create*(T: type gen_qabstractitemview_types.QAbstractItemView,
  ...
  vtbl[].vtbl.viewOptions = miqt_exec_method_cQAbstractItemView_viewOptions
