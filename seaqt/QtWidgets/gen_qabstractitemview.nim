...
proc fcQAbstractItemView_keyboardSearch(self: pointer, search: struct_seaqt_string): void {.importc: "QAbstractItemView_keyboardSearch".}
...
proc fcQAbstractItemView_updateThreshold(self: pointer): cint {.importc: "QAbstractItemView_updateThreshold".}
proc fcQAbstractItemView_setUpdateThreshold(self: pointer, threshold: cint): void {.importc: "QAbstractItemView_setUpdateThreshold".}
proc fcQAbstractItemView_keyboardSearchFlags(self: pointer): cint {.importc: "QAbstractItemView_keyboardSearchFlags".}
proc fcQAbstractItemView_setKeyboardSearchFlags(self: pointer, searchFlags: cint): void {.importc: "QAbstractItemView_setKeyboardSearchFlags".}
...
proc fcQAbstractItemView_virtualbase_keyboardSearch(self: pointer, search: struct_seaqt_string): void {.importc: "QAbstractItemView_virtualbase_keyboardSearch".}
...
proc fcQAbstractItemView_virtualbase_dataChanged(self: pointer, topLeft: pointer, bottomRight: pointer, roles: struct_seaqt_array): void {.importc: "QAbstractItemView_virtualbase_dataChanged".}
...
proc fcQAbstractItemView_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.importc: "QAbstractItemView_virtualbase_nativeEvent".}
...
proc fcQAbstractItemView_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QAbstractItemView_protectedbase_getDecodedMetricF".}
...
proc keyboardSearch*(self: gen_qabstractitemview_types.QAbstractItemView, search: openArray[char]): void =
  fcQAbstractItemView_keyboardSearch(self.h, struct_seaqt_string(data: if len(search) > 0: addr search[0] else: nil, len: csize_t(len(search))))
...
proc updateThreshold*(self: gen_qabstractitemview_types.QAbstractItemView): cint =
  fcQAbstractItemView_updateThreshold(self.h)

proc setUpdateThreshold*(self: gen_qabstractitemview_types.QAbstractItemView, threshold: cint): void =
  fcQAbstractItemView_setUpdateThreshold(self.h, threshold)

proc keyboardSearchFlags*(self: gen_qabstractitemview_types.QAbstractItemView): cint =
  cint(fcQAbstractItemView_keyboardSearchFlags(self.h))

proc setKeyboardSearchFlags*(self: gen_qabstractitemview_types.QAbstractItemView, searchFlags: cint): void =
  fcQAbstractItemView_setKeyboardSearchFlags(self.h, cint(searchFlags))
...
proc QAbstractItemViewkeyboardSearch*(self: gen_qabstractitemview_types.QAbstractItemView, search: openArray[char]): void =
  fcQAbstractItemView_virtualbase_keyboardSearch(self.h, struct_seaqt_string(data: if len(search) > 0: addr search[0] else: nil, len: csize_t(len(search))))
...
proc QAbstractItemViewdataChanged*(self: gen_qabstractitemview_types.QAbstractItemView, topLeft: gen_qabstractitemmodel_types.QModelIndex, bottomRight: gen_qabstractitemmodel_types.QModelIndex, roles: openArray[cint]): void =
  ...
  fcQAbstractItemView_virtualbase_dataChanged(self.h, topLeft.h, bottomRight.h, struct_seaqt_array(len: csize_t(len(roles)), data: if len(roles) == 0: nil else: addr(roles_CArray[0])))
...
proc QAbstractItemViewnativeEvent*(self: gen_qabstractitemview_types.QAbstractItemView, eventType: openArray[byte], message: pointer, resultVal: ptr uint): bool =
  fcQAbstractItemView_virtualbase_nativeEvent(self.h, struct_seaqt_string(data: if len(eventType) > 0: addr eventType[0] else: nil, len: csize_t(len(eventType))), message, resultVal)
...
proc fcQAbstractItemView_vtable_callback_keyboardSearch(self: pointer, search: struct_seaqt_string): void {.cdecl.} =
  let vtbl = cast[ptr QAbstractItemViewVTable](fcQAbstractItemView_vdata(self)[])
  let self = QAbstractItemView(h: self)
...
proc fcQAbstractItemView_vtable_callback_dataChanged(self: pointer, topLeft: pointer, bottomRight: pointer, roles: struct_seaqt_array): void {.cdecl.} =
  let vtbl = cast[ptr QAbstractItemViewVTable](fcQAbstractItemView_vdata(self)[])
  let self = QAbstractItemView(h: self)
...
proc fcQAbstractItemView_vtable_callback_selectedIndexes(self: pointer): struct_seaqt_array {.cdecl.} =
  let vtbl = cast[ptr QAbstractItemViewVTable](fcQAbstractItemView_vdata(self)[])
  let self = QAbstractItemView(h: self)
...
proc fcQAbstractItemView_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QAbstractItemViewVTable](fcQAbstractItemView_vdata(self)[])
  let self = QAbstractItemView(h: self)
...
proc fcQAbstractItemView_method_callback_keyboardSearch(self: pointer, search: struct_seaqt_string): void {.cdecl.} =
  let inst = cast[VirtualQAbstractItemView](fcQAbstractItemView_vdata(self)[])
  let vsearch_ms = search
  let vsearchx_ret = string.fromBytes(vsearch_ms)
  c_free(vsearch_ms.data)
...
proc fcQAbstractItemView_method_callback_dataChanged(self: pointer, topLeft: pointer, bottomRight: pointer, roles: struct_seaqt_array): void {.cdecl.} =
  let inst = cast[VirtualQAbstractItemView](fcQAbstractItemView_vdata(self)[])
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: topLeft, owned: false)
  let slotval2 = gen_qabstractitemmodel_types.QModelIndex(h: bottomRight, owned: false)
  var vroles_ma = roles
...
proc fcQAbstractItemView_method_callback_selectedIndexes(self: pointer): struct_seaqt_array {.cdecl.} =
  let inst = cast[VirtualQAbstractItemView](fcQAbstractItemView_vdata(self)[])
...
proc fcQAbstractItemView_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let inst = cast[VirtualQAbstractItemView](fcQAbstractItemView_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc getDecodedMetricF*(self: gen_qabstractitemview_types.QAbstractItemView, metricA: cint, metricB: cint): float64 =
  fcQAbstractItemView_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
...
proc create*(T: type gen_qabstractitemview_types.QAbstractItemView,
  ...
  let tmp = gen_qabstractitemview_types.QAbstractItemView(h: fcQAbstractItemView_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQAbstractItemView_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qabstractitemview_types.QAbstractItemView,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQAbstractItemView_vtable_callback_disconnectNotify
  let tmp = gen_qabstractitemview_types.QAbstractItemView(h: fcQAbstractItemView_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQAbstractItemView_vdata(tmp.h)[] = addr(vtbl[])
  tmp
...
proc create*(T: type gen_qabstractitemview_types.QAbstractItemView,
  ...
  inst[].h = fcQAbstractItemView_new(addr(cQAbstractItemView_mvtbl), csize_t(sizeof(pointer)))
...
proc create*(T: type gen_qabstractitemview_types.QAbstractItemView,
    ...
    inst: VirtualQAbstractItemView) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQAbstractItemView_new2(addr(cQAbstractItemView_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQAbstractItemView_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
