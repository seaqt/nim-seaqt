...
proc fcQStyleOptionHeaderV2_operatorAssign(self: pointer, param1: pointer): void {.importc: "QStyleOptionHeaderV2_operatorAssign".}
...
proc operatorAssign*(self: gen_qstyleoption_types.QStyleOptionHeaderV2, param1: gen_qstyleoption_types.QStyleOptionHeaderV2): void =
  fcQStyleOptionHeaderV2_operatorAssign(self.h, param1.h)
...
proc create*(T: type gen_qstyleoption_types.QStyleOptionHeaderV2): gen_qstyleoption_types.QStyleOptionHeaderV2 =
  let tmp = gen_qstyleoption_types.QStyleOptionHeaderV2(h: fcQStyleOptionHeaderV2_new())
  tmp
proc create*(T: type gen_qstyleoption_types.QStyleOptionHeaderV2,
  ...
  let tmp = gen_qstyleoption_types.QStyleOptionHeaderV2(h: fcQStyleOptionHeaderV2_new2(other.h))
  tmp
