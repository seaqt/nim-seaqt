...
template MinimumSizeHint*(_: type QStyleOptionTabTabFeatureEnum): untyped = 2
...
type QStyleOptionMenuItemV2StyleOptionVersionEnum* = distinct cint
template Version*(_: type QStyleOptionMenuItemV2StyleOptionVersionEnum): untyped = 2
...
template IsDecoratedRootColumn*(_: type QStyleOptionViewItemViewItemFeatureEnum): untyped = 32
template IsDecorationForRootColumn*(_: type QStyleOptionViewItemViewItemFeatureEnum): untyped = 64
...
type cQStyleOptionMenuItemV2*{.exportc: "QStyleOptionMenuItemV2", incompleteStruct.} = object
...
proc fcQStyleOptionMenuItemV2_operatorAssign(self: pointer, fromVal: pointer): void {.importc: "QStyleOptionMenuItemV2_operatorAssign".}
proc fcQStyleOptionMenuItemV2_mouseDown(self: pointer): bool {.importc: "QStyleOptionMenuItemV2_mouseDown".}
proc fcQStyleOptionMenuItemV2_setMouseDown(self: pointer, mouseDown: bool): void {.importc: "QStyleOptionMenuItemV2_setMouseDown".}
proc fcQStyleOptionMenuItemV2_unused(self: pointer): cint {.importc: "QStyleOptionMenuItemV2_unused".}
proc fcQStyleOptionMenuItemV2_setUnused(self: pointer, unused: cint): void {.importc: "QStyleOptionMenuItemV2_setUnused".}
proc fcQStyleOptionMenuItemV2_new(): ptr cQStyleOptionMenuItemV2 {.importc: "QStyleOptionMenuItemV2_new".}
proc fcQStyleOptionMenuItemV2_new2(fromVal: pointer): ptr cQStyleOptionMenuItemV2 {.importc: "QStyleOptionMenuItemV2_new_from".}
...
proc create*(T: type gen_qstyleoption_types.QStyleOptionMenuItem,
  ...
  tmp
proc operatorAssign*(self: gen_qstyleoption_types.QStyleOptionMenuItemV2, fromVal: gen_qstyleoption_types.QStyleOptionMenuItemV2): void =
  fcQStyleOptionMenuItemV2_operatorAssign(self.h, fromVal.h)

proc mouseDown*(self: gen_qstyleoption_types.QStyleOptionMenuItemV2): bool =
  fcQStyleOptionMenuItemV2_mouseDown(self.h)

proc setMouseDown*(self: gen_qstyleoption_types.QStyleOptionMenuItemV2, mouseDown: bool): void =
  fcQStyleOptionMenuItemV2_setMouseDown(self.h, mouseDown)

proc unused*(self: gen_qstyleoption_types.QStyleOptionMenuItemV2): cint =
  fcQStyleOptionMenuItemV2_unused(self.h)

proc setUnused*(self: gen_qstyleoption_types.QStyleOptionMenuItemV2, unused: cint): void =
  fcQStyleOptionMenuItemV2_setUnused(self.h, unused)

proc create*(T: type gen_qstyleoption_types.QStyleOptionMenuItemV2): gen_qstyleoption_types.QStyleOptionMenuItemV2 =
  let tmp = gen_qstyleoption_types.QStyleOptionMenuItemV2(h: fcQStyleOptionMenuItemV2_new(), owned: true)
  tmp
proc create*(T: type gen_qstyleoption_types.QStyleOptionMenuItemV2,
    fromVal: gen_qstyleoption_types.QStyleOptionMenuItemV2): gen_qstyleoption_types.QStyleOptionMenuItemV2 =
  let tmp = gen_qstyleoption_types.QStyleOptionMenuItemV2(h: fcQStyleOptionMenuItemV2_new2(fromVal.h), owned: true)
  tmp
