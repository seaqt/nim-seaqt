...
proc fcQGraphicsSceneMouseEvent_new2(typeVal: cint): ptr cQGraphicsSceneMouseEvent {.importc: "QGraphicsSceneMouseEvent_new_type".}
...
proc fcQGraphicsSceneWheelEvent_new2(typeVal: cint): ptr cQGraphicsSceneWheelEvent {.importc: "QGraphicsSceneWheelEvent_new_type".}
...
proc fcQGraphicsSceneContextMenuEvent_new2(typeVal: cint): ptr cQGraphicsSceneContextMenuEvent {.importc: "QGraphicsSceneContextMenuEvent_new_type".}
...
proc fcQGraphicsSceneHoverEvent_new2(typeVal: cint): ptr cQGraphicsSceneHoverEvent {.importc: "QGraphicsSceneHoverEvent_new_type".}
...
proc fcQGraphicsSceneHelpEvent_new2(typeVal: cint): ptr cQGraphicsSceneHelpEvent {.importc: "QGraphicsSceneHelpEvent_new_type".}
...
proc fcQGraphicsSceneDragDropEvent_new2(typeVal: cint): ptr cQGraphicsSceneDragDropEvent {.importc: "QGraphicsSceneDragDropEvent_new_type".}
...
proc create*(T: type gen_qgraphicssceneevent_types.QGraphicsSceneEvent,
  ...
  let tmp = gen_qgraphicssceneevent_types.QGraphicsSceneEvent(h: fcQGraphicsSceneEvent_new(cint(typeVal)), owned: true)
  tmp
...
proc create*(T: type gen_qgraphicssceneevent_types.QGraphicsSceneMouseEvent): gen_qgraphicssceneevent_types.QGraphicsSceneMouseEvent =
  let tmp = gen_qgraphicssceneevent_types.QGraphicsSceneMouseEvent(h: fcQGraphicsSceneMouseEvent_new(), owned: true)
  tmp
proc create*(T: type gen_qgraphicssceneevent_types.QGraphicsSceneMouseEvent,
  ...
  let tmp = gen_qgraphicssceneevent_types.QGraphicsSceneMouseEvent(h: fcQGraphicsSceneMouseEvent_new2(cint(typeVal)), owned: true)
  tmp
...
proc create*(T: type gen_qgraphicssceneevent_types.QGraphicsSceneWheelEvent): gen_qgraphicssceneevent_types.QGraphicsSceneWheelEvent =
  let tmp = gen_qgraphicssceneevent_types.QGraphicsSceneWheelEvent(h: fcQGraphicsSceneWheelEvent_new(), owned: true)
  tmp
proc create*(T: type gen_qgraphicssceneevent_types.QGraphicsSceneWheelEvent,
  ...
  let tmp = gen_qgraphicssceneevent_types.QGraphicsSceneWheelEvent(h: fcQGraphicsSceneWheelEvent_new2(cint(typeVal)), owned: true)
  tmp
...
proc create*(T: type gen_qgraphicssceneevent_types.QGraphicsSceneContextMenuEvent): gen_qgraphicssceneevent_types.QGraphicsSceneContextMenuEvent =
  let tmp = gen_qgraphicssceneevent_types.QGraphicsSceneContextMenuEvent(h: fcQGraphicsSceneContextMenuEvent_new(), owned: true)
  tmp
proc create*(T: type gen_qgraphicssceneevent_types.QGraphicsSceneContextMenuEvent,
  ...
  let tmp = gen_qgraphicssceneevent_types.QGraphicsSceneContextMenuEvent(h: fcQGraphicsSceneContextMenuEvent_new2(cint(typeVal)), owned: true)
  tmp
...
proc create*(T: type gen_qgraphicssceneevent_types.QGraphicsSceneHoverEvent): gen_qgraphicssceneevent_types.QGraphicsSceneHoverEvent =
  let tmp = gen_qgraphicssceneevent_types.QGraphicsSceneHoverEvent(h: fcQGraphicsSceneHoverEvent_new(), owned: true)
  tmp
proc create*(T: type gen_qgraphicssceneevent_types.QGraphicsSceneHoverEvent,
  ...
  let tmp = gen_qgraphicssceneevent_types.QGraphicsSceneHoverEvent(h: fcQGraphicsSceneHoverEvent_new2(cint(typeVal)), owned: true)
  tmp
...
proc create*(T: type gen_qgraphicssceneevent_types.QGraphicsSceneHelpEvent): gen_qgraphicssceneevent_types.QGraphicsSceneHelpEvent =
  let tmp = gen_qgraphicssceneevent_types.QGraphicsSceneHelpEvent(h: fcQGraphicsSceneHelpEvent_new(), owned: true)
  tmp
proc create*(T: type gen_qgraphicssceneevent_types.QGraphicsSceneHelpEvent,
  ...
  let tmp = gen_qgraphicssceneevent_types.QGraphicsSceneHelpEvent(h: fcQGraphicsSceneHelpEvent_new2(cint(typeVal)), owned: true)
  tmp
...
proc create*(T: type gen_qgraphicssceneevent_types.QGraphicsSceneDragDropEvent): gen_qgraphicssceneevent_types.QGraphicsSceneDragDropEvent =
  let tmp = gen_qgraphicssceneevent_types.QGraphicsSceneDragDropEvent(h: fcQGraphicsSceneDragDropEvent_new(), owned: true)
  tmp
proc create*(T: type gen_qgraphicssceneevent_types.QGraphicsSceneDragDropEvent,
  ...
  let tmp = gen_qgraphicssceneevent_types.QGraphicsSceneDragDropEvent(h: fcQGraphicsSceneDragDropEvent_new2(cint(typeVal)), owned: true)
  tmp
...
proc create*(T: type gen_qgraphicssceneevent_types.QGraphicsSceneResizeEvent): gen_qgraphicssceneevent_types.QGraphicsSceneResizeEvent =
  let tmp = gen_qgraphicssceneevent_types.QGraphicsSceneResizeEvent(h: fcQGraphicsSceneResizeEvent_new(), owned: true)
  tmp
...
proc create*(T: type gen_qgraphicssceneevent_types.QGraphicsSceneMoveEvent): gen_qgraphicssceneevent_types.QGraphicsSceneMoveEvent =
  let tmp = gen_qgraphicssceneevent_types.QGraphicsSceneMoveEvent(h: fcQGraphicsSceneMoveEvent_new(), owned: true)
  tmp
