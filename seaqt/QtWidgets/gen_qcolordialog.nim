...
template NoEyeDropperButton*(_: type QColorDialogColorDialogOptionEnum): untyped = 8
...
proc fcQColorDialog_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QColorDialog_protectedbase_getDecodedMetricF".}
...
proc getDecodedMetricF*(self: gen_qcolordialog_types.QColorDialog, metricA: cint, metricB: cint): float64 =
  fcQColorDialog_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
