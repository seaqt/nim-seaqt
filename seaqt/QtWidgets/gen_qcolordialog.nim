...
proc create*(T: type gen_qcolordialog_types.QColorDialog,
  ...
  let tmp = gen_qcolordialog_types.QColorDialog(h: fcQColorDialog_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
...
proc create*(T: type gen_qcolordialog_types.QColorDialog,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQColorDialog_vtable_callback_disconnectNotify
  let tmp = gen_qcolordialog_types.QColorDialog(h: fcQColorDialog_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), initial.h), owned: true)
  fcQColorDialog_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qcolordialog_types.QColorDialog,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQColorDialog_vtable_callback_disconnectNotify
  let tmp = gen_qcolordialog_types.QColorDialog(h: fcQColorDialog_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQColorDialog_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qcolordialog_types.QColorDialog,
