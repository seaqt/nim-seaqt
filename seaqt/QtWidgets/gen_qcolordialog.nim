...
proc create*(T: type gen_qcolordialog_types.QColorDialog,
  ...
  let tmp = gen_qcolordialog_types.QColorDialog(h: fcQColorDialog_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))))
...
proc create*(T: type gen_qcolordialog_types.QColorDialog,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQColorDialog_vtable_callback_disconnectNotify
  let tmp = gen_qcolordialog_types.QColorDialog(h: fcQColorDialog_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), initial.h))
  fcQColorDialog_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qcolordialog_types.QColorDialog,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQColorDialog_vtable_callback_disconnectNotify
  let tmp = gen_qcolordialog_types.QColorDialog(h: fcQColorDialog_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h))
  fcQColorDialog_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qcolordialog_types.QColorDialog,
...
proc create*(T: type gen_qcolordialog_types.QColorDialog,
  ...
  inst[].h = fcQColorDialog_new(addr(cQColorDialog_mvtbl), csize_t(sizeof(pointer)))
...
proc create*(T: type gen_qcolordialog_types.QColorDialog,
    ...
    inst: VirtualQColorDialog) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQColorDialog_new2(addr(cQColorDialog_mvtbl), csize_t(sizeof(pointer)), initial.h)
  fcQColorDialog_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qcolordialog_types.QColorDialog,
    ...
    inst: VirtualQColorDialog) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQColorDialog_new3(addr(cQColorDialog_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQColorDialog_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
