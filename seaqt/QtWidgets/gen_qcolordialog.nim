...
proc fcQColorDialog_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.importc: "QColorDialog_virtualbase_nativeEvent".}
...
proc fcQColorDialog_new(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQColorDialog {.importc: "QColorDialog_new".}
proc fcQColorDialog_new2(vtbl: pointer, vdata: csize_t): ptr cQColorDialog {.importc: "QColorDialog_new2".}
proc fcQColorDialog_new3(vtbl: pointer, vdata: csize_t, initial: pointer): ptr cQColorDialog {.importc: "QColorDialog_new3".}
...
proc getColor*(_: type gen_qcolordialog_types.QColorDialog, initial: gen_qcolor_types.QColor): gen_qcolor_types.QColor =
  gen_qcolor_types.QColor(h: fcQColorDialog_getColorWithInitial(initial.h))
...
proc getColor*(_: type gen_qcolordialog_types.QColorDialog, initial: gen_qcolor_types.QColor, parent: gen_qwidget_types.QWidget, title: openArray[char]): gen_qcolor_types.QColor =
  gen_qcolor_types.QColor(h: fcQColorDialog_getColor3(initial.h, parent.h, struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title)))))
...
proc getColor*(_: type gen_qcolordialog_types.QColorDialog, initial: gen_qcolor_types.QColor, parent: gen_qwidget_types.QWidget, title: openArray[char], options: cint): gen_qcolor_types.QColor =
  gen_qcolor_types.QColor(h: fcQColorDialog_getColor4(initial.h, parent.h, struct_seaqt_string(data: if len(title) > 0: addr title[0] else: nil, len: csize_t(len(title))), cint(options)))
...
type QColorDialognativeEventProc* = proc(self: QColorDialog, eventType: openArray[byte], message: pointer, resultVal: ptr clong): bool {.raises: [], gcsafe.}
...
proc QColorDialognativeEvent*(self: gen_qcolordialog_types.QColorDialog, eventType: openArray[byte], message: pointer, resultVal: ptr clong): bool =
  fcQColorDialog_virtualbase_nativeEvent(self.h, struct_seaqt_string(data: if len(eventType) > 0: addr eventType[0] else: nil, len: csize_t(len(eventType))), message, resultVal)
...
proc fcQColorDialog_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let vtbl = cast[ptr QColorDialogVTable](fcQColorDialog_vdata(self)[])
  let self = QColorDialog(h: self)
...
method nativeEvent*(self: VirtualQColorDialog, eventType: openArray[byte], message: pointer, resultVal: ptr clong): bool {.base.} =
...
proc fcQColorDialog_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let inst = cast[VirtualQColorDialog](fcQColorDialog_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc create*(T: type gen_qcolordialog_types.QColorDialog,
  ...
  let tmp = gen_qcolordialog_types.QColorDialog(h: fcQColorDialog_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h))
  fcQColorDialog_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qcolordialog_types.QColorDialog,
    vtbl: ref QColorDialogVTable = nil): gen_qcolordialog_types.QColorDialog =
  let vtbl = if vtbl == nil: new QColorDialogVTable else: vtbl
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQColorDialog_vtable_callback_disconnectNotify
  let tmp = gen_qcolordialog_types.QColorDialog(h: fcQColorDialog_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer))))
  fcQColorDialog_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qcolordialog_types.QColorDialog,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQColorDialog_vtable_callback_disconnectNotify
  let tmp = gen_qcolordialog_types.QColorDialog(h: fcQColorDialog_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), initial.h))
  fcQColorDialog_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qcolordialog_types.QColorDialog,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQColorDialog_vtable_callback_disconnectNotify
  let tmp = gen_qcolordialog_types.QColorDialog(h: fcQColorDialog_new4(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), initial.h, parent.h))
  fcQColorDialog_vdata(tmp.h)[] = addr(vtbl[])
  tmp
...
proc create*(T: type gen_qcolordialog_types.QColorDialog,
  ...
  inst[].h = fcQColorDialog_new(addr(cQColorDialog_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQColorDialog_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true

proc create*(T: type gen_qcolordialog_types.QColorDialog,
    inst: VirtualQColorDialog) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQColorDialog_new2(addr(cQColorDialog_mvtbl), csize_t(sizeof(pointer)))
  fcQColorDialog_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qcolordialog_types.QColorDialog,
    ...
    inst: VirtualQColorDialog) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQColorDialog_new3(addr(cQColorDialog_mvtbl), csize_t(sizeof(pointer)), initial.h)
  fcQColorDialog_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qcolordialog_types.QColorDialog,
    ...
    inst: VirtualQColorDialog) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQColorDialog_new4(addr(cQColorDialog_mvtbl), csize_t(sizeof(pointer)), initial.h, parent.h)
  fcQColorDialog_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
