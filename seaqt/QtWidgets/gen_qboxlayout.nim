...
proc miqt_exec_method_cQBoxLayout_spacing(vtbl: pointer, inst: pointer): cint {.cdecl.} =
  let vtbl = cast[VirtualQBoxLayout](cast[uint](vtbl) - uint(offsetOf(VirtualQBoxLayout, vtbl)))
...
proc miqt_exec_method_cQBoxLayout_setSpacing(vtbl: pointer, inst: pointer, spacing: cint): void {.cdecl.} =
  let vtbl = cast[VirtualQBoxLayout](cast[uint](vtbl) - uint(offsetOf(VirtualQBoxLayout, vtbl)))
  let slotval1 = spacing
...
proc miqt_exec_method_cQBoxLayout_replaceWidget(vtbl: pointer, inst: pointer, fromVal: pointer, to: pointer, options: cint): pointer {.cdecl.} =
  let vtbl = cast[VirtualQBoxLayout](cast[uint](vtbl) - uint(offsetOf(VirtualQBoxLayout, vtbl)))
  let slotval1 = gen_qwidget_types.QWidget(h: fromVal, owned: false)
  let slotval2 = gen_qwidget_types.QWidget(h: to, owned: false)
  let slotval3 = cint(options)
...
proc create*(T: type gen_qboxlayout_types.QBoxLayout,
  ...
  vtbl[].vtbl.spacing = miqt_exec_method_cQBoxLayout_spacing
  vtbl[].vtbl.setSpacing = miqt_exec_method_cQBoxLayout_setSpacing
  ...
  vtbl[].vtbl.replaceWidget = miqt_exec_method_cQBoxLayout_replaceWidget
...
proc miqt_exec_method_cQHBoxLayout_spacing(vtbl: pointer, inst: pointer): cint {.cdecl.} =
  let vtbl = cast[VirtualQHBoxLayout](cast[uint](vtbl) - uint(offsetOf(VirtualQHBoxLayout, vtbl)))
  var virtualReturn = vtbl.spacing()
  virtualReturn
...
proc miqt_exec_method_cQHBoxLayout_setSpacing(vtbl: pointer, inst: pointer, spacing: cint): void {.cdecl.} =
  let vtbl = cast[VirtualQHBoxLayout](cast[uint](vtbl) - uint(offsetOf(VirtualQHBoxLayout, vtbl)))
  let slotval1 = spacing
  vtbl.setSpacing(slotval1)
...
proc miqt_exec_method_cQHBoxLayout_replaceWidget(vtbl: pointer, inst: pointer, fromVal: pointer, to: pointer, options: cint): pointer {.cdecl.} =
  let vtbl = cast[VirtualQHBoxLayout](cast[uint](vtbl) - uint(offsetOf(VirtualQHBoxLayout, vtbl)))
  let slotval1 = gen_qwidget_types.QWidget(h: fromVal, owned: false)
  let slotval2 = gen_qwidget_types.QWidget(h: to, owned: false)
  let slotval3 = cint(options)
...
proc create*(T: type gen_qboxlayout_types.QHBoxLayout,
  ...
  vtbl[].vtbl.spacing = miqt_exec_method_cQHBoxLayout_spacing
  vtbl[].vtbl.setSpacing = miqt_exec_method_cQHBoxLayout_setSpacing
  ...
  vtbl[].vtbl.replaceWidget = miqt_exec_method_cQHBoxLayout_replaceWidget
...
proc miqt_exec_method_cQVBoxLayout_spacing(vtbl: pointer, inst: pointer): cint {.cdecl.} =
  let vtbl = cast[VirtualQVBoxLayout](cast[uint](vtbl) - uint(offsetOf(VirtualQVBoxLayout, vtbl)))
  var virtualReturn = vtbl.spacing()
  virtualReturn
...
proc miqt_exec_method_cQVBoxLayout_setSpacing(vtbl: pointer, inst: pointer, spacing: cint): void {.cdecl.} =
  let vtbl = cast[VirtualQVBoxLayout](cast[uint](vtbl) - uint(offsetOf(VirtualQVBoxLayout, vtbl)))
  let slotval1 = spacing
  vtbl.setSpacing(slotval1)
...
proc miqt_exec_method_cQVBoxLayout_replaceWidget(vtbl: pointer, inst: pointer, fromVal: pointer, to: pointer, options: cint): pointer {.cdecl.} =
  let vtbl = cast[VirtualQVBoxLayout](cast[uint](vtbl) - uint(offsetOf(VirtualQVBoxLayout, vtbl)))
  let slotval1 = gen_qwidget_types.QWidget(h: fromVal, owned: false)
  let slotval2 = gen_qwidget_types.QWidget(h: to, owned: false)
  let slotval3 = cint(options)
...
proc create*(T: type gen_qboxlayout_types.QVBoxLayout,
  ...
  vtbl[].vtbl.spacing = miqt_exec_method_cQVBoxLayout_spacing
  vtbl[].vtbl.setSpacing = miqt_exec_method_cQVBoxLayout_setSpacing
  ...
  vtbl[].vtbl.replaceWidget = miqt_exec_method_cQVBoxLayout_replaceWidget
