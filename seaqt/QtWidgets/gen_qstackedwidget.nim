...
proc fcQStackedWidget_trUtf8(s: cstring): struct_seaqt_string {.importc: "QStackedWidget_trUtf8".}
...
proc fcQStackedWidget_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QStackedWidget_trUtf82".}
proc fcQStackedWidget_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QStackedWidget_trUtf83".}
...
proc fcQStackedWidget_new2(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQStackedWidget {.importc: "QStackedWidget_new2".}
