...
proc fcQStackedWidget_trUtf8S(s: cstring): struct_seaqt_string {.importc: "QStackedWidget_trUtf8_s".}
...
proc fcQStackedWidget_trUtf8SC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QStackedWidget_trUtf8_s_c".}
proc fcQStackedWidget_trUtf8SCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QStackedWidget_trUtf8_s_c_n".}
...
proc fcQStackedWidget_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.importc: "QStackedWidget_virtualbase_nativeEvent".}
...
proc trUtf8*(_: type gen_qstackedwidget_types.QStackedWidget, s: cstring): string =
  let v_ms = fcQStackedWidget_trUtf8S(s)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
type QStackedWidgetnativeEventProc* = proc(self: QStackedWidget, eventType: openArray[byte], message: pointer, resultVal: ptr clong): bool {.raises: [], gcsafe.}
...
proc QStackedWidgetnativeEvent*(self: gen_qstackedwidget_types.QStackedWidget, eventType: openArray[byte], message: pointer, resultVal: ptr clong): bool =
...
proc fcQStackedWidget_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let vtbl = cast[ptr QStackedWidgetVTable](fcQStackedWidget_vdata(self)[])
  let self = QStackedWidget(h: self)
...
method nativeEvent*(self: VirtualQStackedWidget, eventType: openArray[byte], message: pointer, resultVal: ptr clong): bool {.base.} =
...
proc fcQStackedWidget_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let inst = cast[VirtualQStackedWidget](fcQStackedWidget_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
