...
public:
	...
	friend bool QMessageBox_virtualbase_nativeEvent(VirtualQMessageBox* self, struct miqt_string eventType, void* message, intptr_t* result);
...
VirtualQMessageBox* QMessageBox_new(const QMessageBox_VTable* vtbl, size_t vdata, QWidget* parent) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQMessageBox>());
...
VirtualQMessageBox* QMessageBox_new3(const QMessageBox_VTable* vtbl, size_t vdata, int icon, struct miqt_string title, struct miqt_string text) {
...
VirtualQMessageBox* QMessageBox_new4(const QMessageBox_VTable* vtbl, size_t vdata, struct miqt_string title, struct miqt_string text, int icon, int button0, int button1, int button2) {
	QString title_QString = QString::fromUtf8(title.data, title.len);
	QString text_QString = QString::fromUtf8(text.data, text.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQMessageBox>());
...
VirtualQMessageBox* QMessageBox_new5(const QMessageBox_VTable* vtbl, size_t vdata, int icon, struct miqt_string title, struct miqt_string text, int buttons) {
	QString title_QString = QString::fromUtf8(title.data, title.len);
	QString text_QString = QString::fromUtf8(text.data, text.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQMessageBox>());
...
VirtualQMessageBox* QMessageBox_new6(const QMessageBox_VTable* vtbl, size_t vdata, int icon, struct miqt_string title, struct miqt_string text, int buttons, QWidget* parent) {
	QString title_QString = QString::fromUtf8(title.data, title.len);
	QString text_QString = QString::fromUtf8(text.data, text.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQMessageBox>());
...
VirtualQMessageBox* QMessageBox_new7(const QMessageBox_VTable* vtbl, size_t vdata, int icon, struct miqt_string title, struct miqt_string text, int buttons, QWidget* parent, int flags) {
	QString title_QString = QString::fromUtf8(title.data, title.len);
	QString text_QString = QString::fromUtf8(text.data, text.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQMessageBox>());
...
VirtualQMessageBox* QMessageBox_new8(const QMessageBox_VTable* vtbl, size_t vdata, struct miqt_string title, struct miqt_string text, int icon, int button0, int button1, int button2, QWidget* parent) {
	QString title_QString = QString::fromUtf8(title.data, title.len);
	QString text_QString = QString::fromUtf8(text.data, text.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQMessageBox>());
...
VirtualQMessageBox* QMessageBox_new9(const QMessageBox_VTable* vtbl, size_t vdata, struct miqt_string title, struct miqt_string text, int icon, int button0, int button1, int button2, QWidget* parent, int f) {
	QString title_QString = QString::fromUtf8(title.data, title.len);
	QString text_QString = QString::fromUtf8(text.data, text.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQMessageBox>());
...
bool QMessageBox_virtualbase_nativeEvent(VirtualQMessageBox* self, struct miqt_string eventType, void* message, intptr_t* result) {
