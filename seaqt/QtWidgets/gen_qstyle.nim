...
template SH_ComboBox_ListMouseTracking_Current*(_: type QStyleStyleHintEnum): untyped = 19
...
template SH_ComboBox_ListMouseTracking_Active*(_: type QStyleStyleHintEnum): untyped = 120
