...
public:
	...
	friend bool QUndoView_virtualbase_nativeEvent(VirtualQUndoView* self, struct miqt_string eventType, void* message, intptr_t* result);
...
VirtualQUndoView* QUndoView_new(const QUndoView_VTable* vtbl, size_t vdata, QWidget* parent) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQUndoView>());
