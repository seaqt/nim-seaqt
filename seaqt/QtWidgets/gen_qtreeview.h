...
typedef struct QTreeView_VTable{
	...
	void (*keyboardSearch)(VirtualQTreeView* self, struct miqt_string search);
	...
	void (*dataChanged)(VirtualQTreeView* self, QModelIndex* topLeft, QModelIndex* bottomRight, struct miqt_array /* of int */  roles);
	...
	struct miqt_array /* of QModelIndex* */  (*selectedIndexes)(const VirtualQTreeView* self);
	...
	bool (*nativeEvent)(VirtualQTreeView* self, struct miqt_string eventType, void* message, long* result);
...
const QTreeView_VTable* QTreeView_vtbl(const VirtualQTreeView* self);
void* QTreeView_vdata(const VirtualQTreeView* self);
void QTreeView_setVdata(VirtualQTreeView* self, void* vdata);
