...
public:
	...
	friend bool QToolBar_virtualbase_nativeEvent(VirtualQToolBar* self, struct miqt_string eventType, void* message, intptr_t* result);
...
VirtualQToolBar* QToolBar_new(const QToolBar_VTable* vtbl, size_t vdata, QWidget* parent) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQToolBar>());
	return _mem_ ? new (_mem_)VirtualQToolBar(vtbl, parent) : nullptr;
}

VirtualQToolBar* QToolBar_new2(const QToolBar_VTable* vtbl, size_t vdata, struct miqt_string title) {
...
VirtualQToolBar* QToolBar_new4(const QToolBar_VTable* vtbl, size_t vdata, struct miqt_string title, QWidget* parent) {
	QString title_QString = QString::fromUtf8(title.data, title.len);
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQToolBar>());
