...
proc fcQSlider_trUtf8S(s: cstring): struct_seaqt_string {.importc: "QSlider_trUtf8_s".}
...
proc fcQSlider_trUtf8SC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QSlider_trUtf8_s_c".}
proc fcQSlider_trUtf8SCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QSlider_trUtf8_s_c_n".}
