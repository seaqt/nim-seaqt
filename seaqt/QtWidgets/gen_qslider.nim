...
proc fcQSlider_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.importc: "QSlider_virtualbase_nativeEvent".}
...
proc fcQSlider_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QSlider_protectedbase_getDecodedMetricF".}
...
proc fcQSlider_vtable_callback_initStyleOption(self: pointer, option: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QSliderVTable](fcQSlider_vdata(self)[])
  let self = QSlider(h: self)
...
proc fcQSlider_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QSliderVTable](fcQSlider_vdata(self)[])
  let self = QSlider(h: self)
...
proc fcQSlider_method_callback_initStyleOption(self: pointer, option: pointer): void {.cdecl.} =
  let inst = cast[VirtualQSlider](fcQSlider_vdata(self)[])
  let slotval1 = gen_qstyleoption_types.QStyleOptionSlider(h: option, owned: false)
...
proc fcQSlider_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let inst = cast[VirtualQSlider](fcQSlider_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc getDecodedMetricF*(self: gen_qslider_types.QSlider, metricA: cint, metricB: cint): float64 =
  fcQSlider_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
...
proc create*(T: type gen_qslider_types.QSlider,
  ...
  if not isNil(vtbl[].initStyleOption):
    vtbl[].vtbl.initStyleOption = fcQSlider_vtable_callback_initStyleOption
  ...
  let tmp = gen_qslider_types.QSlider(h: fcQSlider_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
...
proc create*(T: type gen_qslider_types.QSlider,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQSlider_vtable_callback_disconnectNotify
  let tmp = gen_qslider_types.QSlider(h: fcQSlider_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), cint(orientation)), owned: true)
  fcQSlider_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qslider_types.QSlider,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQSlider_vtable_callback_disconnectNotify
  let tmp = gen_qslider_types.QSlider(h: fcQSlider_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQSlider_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qslider_types.QSlider,
...
const cQSlider_mvtbl = cQSliderVTable(
  ...
  initStyleOption: fcQSlider_method_callback_initStyleOption,
