...
proc fcQSlider_new(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQSlider {.importc: "QSlider_new".}
proc fcQSlider_new2(vtbl: pointer, vdata: csize_t): ptr cQSlider {.importc: "QSlider_new2".}
