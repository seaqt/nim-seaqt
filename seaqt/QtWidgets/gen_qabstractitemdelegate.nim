...
proc fcQAbstractItemDelegate_handleEditorEvent(self: pointer, objectVal: pointer, event: pointer): bool {.importc: "QAbstractItemDelegate_handleEditorEvent".}
...
proc fcQAbstractItemDelegate_virtualbase_paintingRoles(self: pointer): struct_seaqt_array {.importc: "QAbstractItemDelegate_virtualbase_paintingRoles".}
...
proc handleEditorEvent*(self: gen_qabstractitemdelegate_types.QAbstractItemDelegate, objectVal: gen_qobject_types.QObject, event: gen_qcoreevent_types.QEvent): bool =
  fcQAbstractItemDelegate_handleEditorEvent(self.h, objectVal.h, event.h)
...
proc fcQAbstractItemDelegate_vtable_callback_paintingRoles(self: pointer): struct_seaqt_array {.cdecl.} =
  let vtbl = cast[ptr QAbstractItemDelegateVTable](fcQAbstractItemDelegate_vdata(self)[])
  let self = QAbstractItemDelegate(h: self)
...
proc fcQAbstractItemDelegate_method_callback_paintingRoles(self: pointer): struct_seaqt_array {.cdecl.} =
  let inst = cast[VirtualQAbstractItemDelegate](fcQAbstractItemDelegate_vdata(self)[])
...
proc create*(T: type gen_qabstractitemdelegate_types.QAbstractItemDelegate,
  ...
  let tmp = gen_qabstractitemdelegate_types.QAbstractItemDelegate(h: fcQAbstractItemDelegate_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQAbstractItemDelegate_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qabstractitemdelegate_types.QAbstractItemDelegate,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQAbstractItemDelegate_vtable_callback_disconnectNotify
  let tmp = gen_qabstractitemdelegate_types.QAbstractItemDelegate(h: fcQAbstractItemDelegate_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQAbstractItemDelegate_vdata(tmp.h)[] = addr(vtbl[])
  tmp
