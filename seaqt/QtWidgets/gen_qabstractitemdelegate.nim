...
proc cQAbstractItemDelegate_slot_callback_commitData(slot: int, editor: pointer) {.cdecl.} =
...
proc cQAbstractItemDelegate_slot_callback_commitData_release(slot: int) {.cdecl.} =
...
proc oncommitData*(self: gen_qabstractitemdelegate_types.QAbstractItemDelegate, slot: QAbstractItemDelegatecommitDataSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQAbstractItemDelegate_connect_commitData(self.h, cast[int](addr tmp[]), cQAbstractItemDelegate_slot_callback_commitData, cQAbstractItemDelegate_slot_callback_commitData_release)
...
proc cQAbstractItemDelegate_slot_callback_closeEditor(slot: int, editor: pointer) {.cdecl.} =
  let nimfunc = cast[ptr QAbstractItemDelegatecloseEditorSlot](cast[pointer](slot))
  let slotval1 = gen_qwidget_types.QWidget(h: editor, owned: false)

  nimfunc[](slotval1)

proc cQAbstractItemDelegate_slot_callback_closeEditor_release(slot: int) {.cdecl.} =
...
proc oncloseEditor*(self: gen_qabstractitemdelegate_types.QAbstractItemDelegate, slot: QAbstractItemDelegatecloseEditorSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQAbstractItemDelegate_connect_closeEditor(self.h, cast[int](addr tmp[]), cQAbstractItemDelegate_slot_callback_closeEditor, cQAbstractItemDelegate_slot_callback_closeEditor_release)
...
proc cQAbstractItemDelegate_slot_callback_sizeHintChanged(slot: int, param1: pointer) {.cdecl.} =
...
proc cQAbstractItemDelegate_slot_callback_sizeHintChanged_release(slot: int) {.cdecl.} =
...
proc onsizeHintChanged*(self: gen_qabstractitemdelegate_types.QAbstractItemDelegate, slot: QAbstractItemDelegatesizeHintChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQAbstractItemDelegate_connect_sizeHintChanged(self.h, cast[int](addr tmp[]), cQAbstractItemDelegate_slot_callback_sizeHintChanged, cQAbstractItemDelegate_slot_callback_sizeHintChanged_release)
...
proc cQAbstractItemDelegate_slot_callback_closeEditor2(slot: int, editor: pointer, hint: cint) {.cdecl.} =
...
proc cQAbstractItemDelegate_slot_callback_closeEditor2_release(slot: int) {.cdecl.} =
...
proc oncloseEditor*(self: gen_qabstractitemdelegate_types.QAbstractItemDelegate, slot: QAbstractItemDelegatecloseEditor2Slot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQAbstractItemDelegate_connect_closeEditor2(self.h, cast[int](addr tmp[]), cQAbstractItemDelegate_slot_callback_closeEditor2, cQAbstractItemDelegate_slot_callback_closeEditor2_release)
...
proc cQAbstractItemDelegate_vtable_callback_metaObject(self: pointer): pointer {.cdecl.} =
...
proc cQAbstractItemDelegate_vtable_callback_metacast(self: pointer, param1: cstring): pointer {.cdecl.} =
  let vtbl = cast[ptr QAbstractItemDelegateVTable](fcQAbstractItemDelegate_vdata(self))
  let self = QAbstractItemDelegate(h: self)
  let slotval1 = (param1)
...
proc cQAbstractItemDelegate_vtable_callback_metacall(self: pointer, param1: cint, param2: cint, param3: pointer): cint {.cdecl.} =
  let vtbl = cast[ptr QAbstractItemDelegateVTable](fcQAbstractItemDelegate_vdata(self))
  let self = QAbstractItemDelegate(h: self)
...
proc cQAbstractItemDelegate_vtable_callback_paint(self: pointer, painter: pointer, option: pointer, index: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QAbstractItemDelegateVTable](fcQAbstractItemDelegate_vdata(self))
  let self = QAbstractItemDelegate(h: self)
...
proc cQAbstractItemDelegate_vtable_callback_sizeHint(self: pointer, option: pointer, index: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QAbstractItemDelegateVTable](fcQAbstractItemDelegate_vdata(self))
  let self = QAbstractItemDelegate(h: self)
...
proc cQAbstractItemDelegate_vtable_callback_createEditor(self: pointer, parent: pointer, option: pointer, index: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QAbstractItemDelegateVTable](fcQAbstractItemDelegate_vdata(self))
  let self = QAbstractItemDelegate(h: self)
...
proc cQAbstractItemDelegate_vtable_callback_destroyEditor(self: pointer, editor: pointer, index: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QAbstractItemDelegateVTable](fcQAbstractItemDelegate_vdata(self))
  let self = QAbstractItemDelegate(h: self)
  let slotval1 = gen_qwidget_types.QWidget(h: editor, owned: false)
  let slotval2 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
...
proc cQAbstractItemDelegate_vtable_callback_setEditorData(self: pointer, editor: pointer, index: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QAbstractItemDelegateVTable](fcQAbstractItemDelegate_vdata(self))
  let self = QAbstractItemDelegate(h: self)
  let slotval1 = gen_qwidget_types.QWidget(h: editor, owned: false)
  let slotval2 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
...
proc cQAbstractItemDelegate_vtable_callback_setModelData(self: pointer, editor: pointer, model: pointer, index: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QAbstractItemDelegateVTable](fcQAbstractItemDelegate_vdata(self))
  let self = QAbstractItemDelegate(h: self)
  let slotval1 = gen_qwidget_types.QWidget(h: editor, owned: false)
...
proc cQAbstractItemDelegate_vtable_callback_updateEditorGeometry(self: pointer, editor: pointer, option: pointer, index: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QAbstractItemDelegateVTable](fcQAbstractItemDelegate_vdata(self))
  let self = QAbstractItemDelegate(h: self)
  let slotval1 = gen_qwidget_types.QWidget(h: editor, owned: false)
  let slotval2 = gen_qstyleoption_types.QStyleOptionViewItem(h: option, owned: false)
...
proc cQAbstractItemDelegate_vtable_callback_editorEvent(self: pointer, event: pointer, model: pointer, option: pointer, index: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QAbstractItemDelegateVTable](fcQAbstractItemDelegate_vdata(self))
  let self = QAbstractItemDelegate(h: self)
...
proc cQAbstractItemDelegate_vtable_callback_helpEvent(self: pointer, event: pointer, view: pointer, option: pointer, index: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QAbstractItemDelegateVTable](fcQAbstractItemDelegate_vdata(self))
  let self = QAbstractItemDelegate(h: self)
...
proc cQAbstractItemDelegate_vtable_callback_paintingRoles(self: pointer): struct_miqt_array {.cdecl.} =
  let vtbl = cast[ptr QAbstractItemDelegateVTable](fcQAbstractItemDelegate_vdata(self))
  let self = QAbstractItemDelegate(h: self)
...
proc cQAbstractItemDelegate_vtable_callback_event(self: pointer, event: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QAbstractItemDelegateVTable](fcQAbstractItemDelegate_vdata(self))
  let self = QAbstractItemDelegate(h: self)
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
...
proc cQAbstractItemDelegate_vtable_callback_eventFilter(self: pointer, watched: pointer, event: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QAbstractItemDelegateVTable](fcQAbstractItemDelegate_vdata(self))
  let self = QAbstractItemDelegate(h: self)
...
proc cQAbstractItemDelegate_vtable_callback_timerEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QAbstractItemDelegateVTable](fcQAbstractItemDelegate_vdata(self))
  let self = QAbstractItemDelegate(h: self)
...
proc cQAbstractItemDelegate_vtable_callback_childEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QAbstractItemDelegateVTable](fcQAbstractItemDelegate_vdata(self))
  let self = QAbstractItemDelegate(h: self)
...
proc cQAbstractItemDelegate_vtable_callback_customEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QAbstractItemDelegateVTable](fcQAbstractItemDelegate_vdata(self))
  let self = QAbstractItemDelegate(h: self)
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
...
proc cQAbstractItemDelegate_vtable_callback_connectNotify(self: pointer, signal: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QAbstractItemDelegateVTable](fcQAbstractItemDelegate_vdata(self))
  let self = QAbstractItemDelegate(h: self)
...
proc cQAbstractItemDelegate_vtable_callback_disconnectNotify(self: pointer, signal: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QAbstractItemDelegateVTable](fcQAbstractItemDelegate_vdata(self))
  let self = QAbstractItemDelegate(h: self)
  let slotval1 = gen_qmetaobject_types.QMetaMethod(h: signal, owned: false)
...
proc cQAbstractItemDelegate_method_callback_metaObject(self: pointer): pointer {.cdecl.} =
...
proc cQAbstractItemDelegate_method_callback_metacast(self: pointer, param1: cstring): pointer {.cdecl.} =
  let inst = cast[VirtualQAbstractItemDelegate](fcQAbstractItemDelegate_vdata(self))
  let slotval1 = (param1)
...
proc cQAbstractItemDelegate_method_callback_metacall(self: pointer, param1: cint, param2: cint, param3: pointer): cint {.cdecl.} =
  let inst = cast[VirtualQAbstractItemDelegate](fcQAbstractItemDelegate_vdata(self))
  let slotval1 = cint(param1)
  let slotval2 = param2
  let slotval3 = param3
...
method paint*(self: VirtualQAbstractItemDelegate, painter: gen_qpainter_types.QPainter, option: gen_qstyleoption_types.QStyleOptionViewItem, index: gen_qabstractitemmodel_types.QModelIndex): void {.base.} =
  raiseAssert("missing implementation of QAbstractItemDelegate_virtualbase_paint")
proc cQAbstractItemDelegate_method_callback_paint(self: pointer, painter: pointer, option: pointer, index: pointer): void {.cdecl.} =
  let inst = cast[VirtualQAbstractItemDelegate](fcQAbstractItemDelegate_vdata(self))
  let slotval1 = gen_qpainter_types.QPainter(h: painter, owned: false)
  let slotval2 = gen_qstyleoption_types.QStyleOptionViewItem(h: option, owned: false)
  let slotval3 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
...
method sizeHint*(self: VirtualQAbstractItemDelegate, option: gen_qstyleoption_types.QStyleOptionViewItem, index: gen_qabstractitemmodel_types.QModelIndex): gen_qsize_types.QSize {.base.} =
  raiseAssert("missing implementation of QAbstractItemDelegate_virtualbase_sizeHint")
proc cQAbstractItemDelegate_method_callback_sizeHint(self: pointer, option: pointer, index: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQAbstractItemDelegate](fcQAbstractItemDelegate_vdata(self))
  let slotval1 = gen_qstyleoption_types.QStyleOptionViewItem(h: option, owned: false)
  let slotval2 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
...
proc cQAbstractItemDelegate_method_callback_createEditor(self: pointer, parent: pointer, option: pointer, index: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQAbstractItemDelegate](fcQAbstractItemDelegate_vdata(self))
  let slotval1 = gen_qwidget_types.QWidget(h: parent, owned: false)
  let slotval2 = gen_qstyleoption_types.QStyleOptionViewItem(h: option, owned: false)
  let slotval3 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
...
proc cQAbstractItemDelegate_method_callback_destroyEditor(self: pointer, editor: pointer, index: pointer): void {.cdecl.} =
  let inst = cast[VirtualQAbstractItemDelegate](fcQAbstractItemDelegate_vdata(self))
  let slotval1 = gen_qwidget_types.QWidget(h: editor, owned: false)
  let slotval2 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
...
proc cQAbstractItemDelegate_method_callback_setEditorData(self: pointer, editor: pointer, index: pointer): void {.cdecl.} =
  let inst = cast[VirtualQAbstractItemDelegate](fcQAbstractItemDelegate_vdata(self))
  let slotval1 = gen_qwidget_types.QWidget(h: editor, owned: false)
  let slotval2 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
...
proc cQAbstractItemDelegate_method_callback_setModelData(self: pointer, editor: pointer, model: pointer, index: pointer): void {.cdecl.} =
  let inst = cast[VirtualQAbstractItemDelegate](fcQAbstractItemDelegate_vdata(self))
  let slotval1 = gen_qwidget_types.QWidget(h: editor, owned: false)
  let slotval2 = gen_qabstractitemmodel_types.QAbstractItemModel(h: model, owned: false)
  let slotval3 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
...
proc cQAbstractItemDelegate_method_callback_updateEditorGeometry(self: pointer, editor: pointer, option: pointer, index: pointer): void {.cdecl.} =
  let inst = cast[VirtualQAbstractItemDelegate](fcQAbstractItemDelegate_vdata(self))
  let slotval1 = gen_qwidget_types.QWidget(h: editor, owned: false)
  let slotval2 = gen_qstyleoption_types.QStyleOptionViewItem(h: option, owned: false)
  let slotval3 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
...
proc cQAbstractItemDelegate_method_callback_editorEvent(self: pointer, event: pointer, model: pointer, option: pointer, index: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQAbstractItemDelegate](fcQAbstractItemDelegate_vdata(self))
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
  let slotval2 = gen_qabstractitemmodel_types.QAbstractItemModel(h: model, owned: false)
  let slotval3 = gen_qstyleoption_types.QStyleOptionViewItem(h: option, owned: false)
...
proc cQAbstractItemDelegate_method_callback_helpEvent(self: pointer, event: pointer, view: pointer, option: pointer, index: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQAbstractItemDelegate](fcQAbstractItemDelegate_vdata(self))
  let slotval1 = gen_qevent_types.QHelpEvent(h: event, owned: false)
  let slotval2 = gen_qabstractitemview_types.QAbstractItemView(h: view, owned: false)
  let slotval3 = gen_qstyleoption_types.QStyleOptionViewItem(h: option, owned: false)
...
proc cQAbstractItemDelegate_method_callback_paintingRoles(self: pointer): struct_miqt_array {.cdecl.} =
  let inst = cast[VirtualQAbstractItemDelegate](fcQAbstractItemDelegate_vdata(self))
...
proc cQAbstractItemDelegate_method_callback_event(self: pointer, event: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQAbstractItemDelegate](fcQAbstractItemDelegate_vdata(self))
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
...
proc cQAbstractItemDelegate_method_callback_eventFilter(self: pointer, watched: pointer, event: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQAbstractItemDelegate](fcQAbstractItemDelegate_vdata(self))
  let slotval1 = gen_qobject_types.QObject(h: watched, owned: false)
  let slotval2 = gen_qcoreevent_types.QEvent(h: event, owned: false)
...
proc cQAbstractItemDelegate_method_callback_timerEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQAbstractItemDelegate](fcQAbstractItemDelegate_vdata(self))
  let slotval1 = gen_qcoreevent_types.QTimerEvent(h: event, owned: false)
...
proc cQAbstractItemDelegate_method_callback_childEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQAbstractItemDelegate](fcQAbstractItemDelegate_vdata(self))
  let slotval1 = gen_qcoreevent_types.QChildEvent(h: event, owned: false)
...
proc cQAbstractItemDelegate_method_callback_customEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQAbstractItemDelegate](fcQAbstractItemDelegate_vdata(self))
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
...
proc cQAbstractItemDelegate_method_callback_connectNotify(self: pointer, signal: pointer): void {.cdecl.} =
  let inst = cast[VirtualQAbstractItemDelegate](fcQAbstractItemDelegate_vdata(self))
  let slotval1 = gen_qmetaobject_types.QMetaMethod(h: signal, owned: false)
...
proc cQAbstractItemDelegate_method_callback_disconnectNotify(self: pointer, signal: pointer): void {.cdecl.} =
  let inst = cast[VirtualQAbstractItemDelegate](fcQAbstractItemDelegate_vdata(self))
  let slotval1 = gen_qmetaobject_types.QMetaMethod(h: signal, owned: false)
...
proc create*(T: type gen_qabstractitemdelegate_types.QAbstractItemDelegate,
  ...
  if not isNil(vtbl[].metaObject):
    vtbl[].vtbl.metaObject = cQAbstractItemDelegate_vtable_callback_metaObject
  if not isNil(vtbl[].metacast):
    vtbl[].vtbl.metacast = cQAbstractItemDelegate_vtable_callback_metacast
  if not isNil(vtbl[].metacall):
    vtbl[].vtbl.metacall = cQAbstractItemDelegate_vtable_callback_metacall
  if not isNil(vtbl[].paint):
    vtbl[].vtbl.paint = cQAbstractItemDelegate_vtable_callback_paint
  if not isNil(vtbl[].sizeHint):
    vtbl[].vtbl.sizeHint = cQAbstractItemDelegate_vtable_callback_sizeHint
  if not isNil(vtbl[].createEditor):
    vtbl[].vtbl.createEditor = cQAbstractItemDelegate_vtable_callback_createEditor
  if not isNil(vtbl[].destroyEditor):
    vtbl[].vtbl.destroyEditor = cQAbstractItemDelegate_vtable_callback_destroyEditor
  if not isNil(vtbl[].setEditorData):
    vtbl[].vtbl.setEditorData = cQAbstractItemDelegate_vtable_callback_setEditorData
  if not isNil(vtbl[].setModelData):
    vtbl[].vtbl.setModelData = cQAbstractItemDelegate_vtable_callback_setModelData
  if not isNil(vtbl[].updateEditorGeometry):
    vtbl[].vtbl.updateEditorGeometry = cQAbstractItemDelegate_vtable_callback_updateEditorGeometry
  if not isNil(vtbl[].editorEvent):
    vtbl[].vtbl.editorEvent = cQAbstractItemDelegate_vtable_callback_editorEvent
  if not isNil(vtbl[].helpEvent):
    vtbl[].vtbl.helpEvent = cQAbstractItemDelegate_vtable_callback_helpEvent
  if not isNil(vtbl[].paintingRoles):
    vtbl[].vtbl.paintingRoles = cQAbstractItemDelegate_vtable_callback_paintingRoles
  if not isNil(vtbl[].event):
    vtbl[].vtbl.event = cQAbstractItemDelegate_vtable_callback_event
  if not isNil(vtbl[].eventFilter):
    vtbl[].vtbl.eventFilter = cQAbstractItemDelegate_vtable_callback_eventFilter
  if not isNil(vtbl[].timerEvent):
    vtbl[].vtbl.timerEvent = cQAbstractItemDelegate_vtable_callback_timerEvent
  if not isNil(vtbl[].childEvent):
    vtbl[].vtbl.childEvent = cQAbstractItemDelegate_vtable_callback_childEvent
  if not isNil(vtbl[].customEvent):
    vtbl[].vtbl.customEvent = cQAbstractItemDelegate_vtable_callback_customEvent
  if not isNil(vtbl[].connectNotify):
    vtbl[].vtbl.connectNotify = cQAbstractItemDelegate_vtable_callback_connectNotify
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = cQAbstractItemDelegate_vtable_callback_disconnectNotify
...
const cQAbstractItemDelegate_mvtbl = cQAbstractItemDelegateVTable(
  destructor: proc(self: pointer) {.cdecl.} =
    ...
    inst[].h = nil
    inst[].owned = false,
  metaObject: cQAbstractItemDelegate_method_callback_metaObject,
  metacast: cQAbstractItemDelegate_method_callback_metacast,
  metacall: cQAbstractItemDelegate_method_callback_metacall,
  paint: cQAbstractItemDelegate_method_callback_paint,
  sizeHint: cQAbstractItemDelegate_method_callback_sizeHint,
  createEditor: cQAbstractItemDelegate_method_callback_createEditor,
  destroyEditor: cQAbstractItemDelegate_method_callback_destroyEditor,
  setEditorData: cQAbstractItemDelegate_method_callback_setEditorData,
  setModelData: cQAbstractItemDelegate_method_callback_setModelData,
  updateEditorGeometry: cQAbstractItemDelegate_method_callback_updateEditorGeometry,
  editorEvent: cQAbstractItemDelegate_method_callback_editorEvent,
  helpEvent: cQAbstractItemDelegate_method_callback_helpEvent,
  paintingRoles: cQAbstractItemDelegate_method_callback_paintingRoles,
  event: cQAbstractItemDelegate_method_callback_event,
  eventFilter: cQAbstractItemDelegate_method_callback_eventFilter,
  timerEvent: cQAbstractItemDelegate_method_callback_timerEvent,
  childEvent: cQAbstractItemDelegate_method_callback_childEvent,
  customEvent: cQAbstractItemDelegate_method_callback_customEvent,
  connectNotify: cQAbstractItemDelegate_method_callback_connectNotify,
  disconnectNotify: cQAbstractItemDelegate_method_callback_disconnectNotify,
)
proc create*(T: type gen_qabstractitemdelegate_types.QAbstractItemDelegate,
