...
proc miqt_exec_method_cQTreeView_viewOptions(vtbl: pointer, inst: pointer): pointer {.cdecl.} =
  let vtbl = cast[VirtualQTreeView](cast[uint](vtbl) - uint(offsetOf(VirtualQTreeView, vtbl)))
...
proc miqt_exec_method_cQTreeView_changeEvent(vtbl: pointer, inst: pointer, param1: pointer): void {.cdecl.} =
  let vtbl = cast[VirtualQTreeView](cast[uint](vtbl) - uint(offsetOf(VirtualQTreeView, vtbl)))
  let slotval1 = gen_qcoreevent_types.QEvent(h: param1, owned: false)
...
proc miqt_exec_method_cQTreeView_nativeEvent(vtbl: pointer, inst: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let vtbl = cast[VirtualQTreeView](cast[uint](vtbl) - uint(offsetOf(VirtualQTreeView, vtbl)))
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArrayByte(veventType_bytearray.data, 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc create*(T: type gen_qtreeview_types.QTreeView,
  ...
  vtbl[].vtbl.viewOptions = miqt_exec_method_cQTreeView_viewOptions
