...
proc fcQSplitter_new2(vtbl: pointer, vdata: csize_t, param1: cint): ptr cQSplitter {.importc: "QSplitter_new2".}
proc fcQSplitter_new3(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQSplitter {.importc: "QSplitter_new3".}
