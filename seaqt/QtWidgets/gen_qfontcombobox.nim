...
proc create*(T: type gen_qfontcombobox_types.QFontComboBox,
  ...
  let tmp = gen_qfontcombobox_types.QFontComboBox(h: fcQFontComboBox_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))))
...
proc create*(T: type gen_qfontcombobox_types.QFontComboBox,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQFontComboBox_vtable_callback_disconnectNotify
  let tmp = gen_qfontcombobox_types.QFontComboBox(h: fcQFontComboBox_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h))
  fcQFontComboBox_vdata(tmp.h)[] = addr(vtbl[])
  tmp
