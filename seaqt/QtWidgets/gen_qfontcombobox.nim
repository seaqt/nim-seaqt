...
proc fcQFontComboBox_new(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQFontComboBox {.importc: "QFontComboBox_new_parent".}
proc fcQFontComboBox_new2(vtbl: pointer, vdata: csize_t): ptr cQFontComboBox {.importc: "QFontComboBox_new".}
...
proc create*(T: type gen_qfontcombobox_types.QFontComboBox,
  ...
  let tmp = gen_qfontcombobox_types.QFontComboBox(h: fcQFontComboBox_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
...
proc create*(T: type gen_qfontcombobox_types.QFontComboBox,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQFontComboBox_vtable_callback_disconnectNotify
  let tmp = gen_qfontcombobox_types.QFontComboBox(h: fcQFontComboBox_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQFontComboBox_vdata(tmp.h)[] = addr(vtbl[])
  tmp
...
proc create*(T: type gen_qfontcombobox_types.QFontComboBox,
  ...
  inst[].h = fcQFontComboBox_new(addr(cQFontComboBox_mvtbl), csize_t(sizeof(pointer)), parent.h)
...
proc create*(T: type gen_qfontcombobox_types.QFontComboBox,
    inst: VirtualQFontComboBox) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQFontComboBox_new2(addr(cQFontComboBox_mvtbl), csize_t(sizeof(pointer)))
  fcQFontComboBox_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
