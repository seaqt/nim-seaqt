...
proc fcQFontComboBox_trS(s: cstring): struct_seaqt_string {.importc: "QFontComboBox_tr_s".}
...
proc fcQFontComboBox_setSampleTextForSystem(self: pointer, writingSystem: cint, sampleText: struct_seaqt_string): void {.importc: "QFontComboBox_setSampleTextForSystem".}
proc fcQFontComboBox_sampleTextForSystem(self: pointer, writingSystem: cint): struct_seaqt_string {.importc: "QFontComboBox_sampleTextForSystem".}
proc fcQFontComboBox_setSampleTextForFont(self: pointer, fontFamily: struct_seaqt_string, sampleText: struct_seaqt_string): void {.importc: "QFontComboBox_setSampleTextForFont".}
proc fcQFontComboBox_sampleTextForFont(self: pointer, fontFamily: struct_seaqt_string): struct_seaqt_string {.importc: "QFontComboBox_sampleTextForFont".}
proc fcQFontComboBox_setDisplayFont(self: pointer, fontFamily: struct_seaqt_string, font: pointer): void {.importc: "QFontComboBox_setDisplayFont".}
...
proc fcQFontComboBox_trSC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QFontComboBox_tr_s_c".}
proc fcQFontComboBox_trSCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QFontComboBox_tr_s_c_n".}
proc fcQFontComboBox_vdata(self: pointer): ptr pointer {.importc: "QFontComboBox_vdata".}
proc fvdata_cQFontComboBox(self: pointer): pointer {.importc: "vdata_QFontComboBox".}
...
proc fcQFontComboBox_virtualbase_inputMethodQuery_Qt_InputMethodQuery(self: pointer, param1: cint): pointer {.importc: "QFontComboBox_virtualbase_inputMethodQuery_Qt_InputMethodQuery".}
...
proc fcQFontComboBox_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.importc: "QFontComboBox_virtualbase_nativeEvent".}
...
proc fcQFontComboBox_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QFontComboBox_protectedbase_getDecodedMetricF".}
proc fcQFontComboBox_new(vtbl: pointer, vdata: csize_t): ptr cQFontComboBox {.importc: "QFontComboBox_new".}
proc fcQFontComboBox_new2(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQFontComboBox {.importc: "QFontComboBox_new_parent".}
...
proc tr*(_: type gen_qfontcombobox_types.QFontComboBox, s: cstring): string =
  let v_ms = fcQFontComboBox_trS(s)
...
proc setSampleTextForSystem*(self: gen_qfontcombobox_types.QFontComboBox, writingSystem: cint, sampleText: openArray[char]): void =
  fcQFontComboBox_setSampleTextForSystem(self.h, cint(writingSystem), struct_seaqt_string(data: if len(sampleText) > 0: addr sampleText[0] else: nil, len: csize_t(len(sampleText))))
...
proc setSampleTextForFont*(self: gen_qfontcombobox_types.QFontComboBox, fontFamily: openArray[char], sampleText: openArray[char]): void =
  fcQFontComboBox_setSampleTextForFont(self.h, struct_seaqt_string(data: if len(fontFamily) > 0: addr fontFamily[0] else: nil, len: csize_t(len(fontFamily))), struct_seaqt_string(data: if len(sampleText) > 0: addr sampleText[0] else: nil, len: csize_t(len(sampleText))))

proc sampleTextForFont*(self: gen_qfontcombobox_types.QFontComboBox, fontFamily: openArray[char]): string =
  let v_ms = fcQFontComboBox_sampleTextForFont(self.h, struct_seaqt_string(data: if len(fontFamily) > 0: addr fontFamily[0] else: nil, len: csize_t(len(fontFamily))))
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret

proc setDisplayFont*(self: gen_qfontcombobox_types.QFontComboBox, fontFamily: openArray[char], font: gen_qfont_types.QFont): void =
  fcQFontComboBox_setDisplayFont(self.h, struct_seaqt_string(data: if len(fontFamily) > 0: addr fontFamily[0] else: nil, len: csize_t(len(fontFamily))), font.h)
...
type QFontComboBoxinputMethodQuery_Qt_InputMethodQueryProc* = proc(self: QFontComboBox, param1: cint): gen_qvariant_types.QVariant {.raises: [], gcsafe.}
...
type QFontComboBoxVTable* {.inheritable, pure.} = object
  ...
  inputMethodQuery_Qt_InputMethodQuery*: QFontComboBoxinputMethodQuery_Qt_InputMethodQueryProc
...
proc QFontComboBoxinputMethodQuery*(self: gen_qfontcombobox_types.QFontComboBox, param1: cint): gen_qvariant_types.QVariant =
  gen_qvariant_types.QVariant(h: fcQFontComboBox_virtualbase_inputMethodQuery_Qt_InputMethodQuery(self.h, cint(param1)), owned: true)
...
proc QFontComboBoxnativeEvent*(self: gen_qfontcombobox_types.QFontComboBox, eventType: openArray[byte], message: pointer, resultVal: ptr uint): bool =
  fcQFontComboBox_virtualbase_nativeEvent(self.h, struct_seaqt_string(data: if len(eventType) > 0: addr eventType[0] else: nil, len: csize_t(len(eventType))), message, resultVal)
...
proc fcQFontComboBox_vtable_callback_setModel(self: pointer, model: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QFontComboBoxVTable](fcQFontComboBox_vdata(self)[])
  let self = QFontComboBox(h: self)
...
proc fcQFontComboBox_vtable_callback_inputMethodQuery_Qt_InputMethodQuery(self: pointer, param1: cint): pointer {.cdecl.} =
  let vtbl = cast[ptr QFontComboBoxVTable](fcQFontComboBox_vdata(self)[])
  let self = QFontComboBox(h: self)
  let slotval1 = cint(param1)
...
proc fcQFontComboBox_vtable_callback_initStyleOption(self: pointer, option: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QFontComboBoxVTable](fcQFontComboBox_vdata(self)[])
  let self = QFontComboBox(h: self)
...
proc fcQFontComboBox_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QFontComboBoxVTable](fcQFontComboBox_vdata(self)[])
  let self = QFontComboBox(h: self)
...
proc fcQFontComboBox_method_callback_setModel(self: pointer, model: pointer): void {.cdecl.} =
  let inst = cast[VirtualQFontComboBox](fcQFontComboBox_vdata(self)[])
  let slotval1 = gen_qabstractitemmodel_types.QAbstractItemModel(h: model, owned: false)
...
proc fcQFontComboBox_method_callback_inputMethodQuery_Qt_InputMethodQuery(self: pointer, param1: cint): pointer {.cdecl.} =
  let inst = cast[VirtualQFontComboBox](fcQFontComboBox_vdata(self)[])
  let slotval1 = cint(param1)
...
proc fcQFontComboBox_method_callback_initStyleOption(self: pointer, option: pointer): void {.cdecl.} =
  let inst = cast[VirtualQFontComboBox](fcQFontComboBox_vdata(self)[])
  let slotval1 = gen_qstyleoption_types.QStyleOptionComboBox(h: option, owned: false)
...
proc fcQFontComboBox_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let inst = cast[VirtualQFontComboBox](fcQFontComboBox_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc getDecodedMetricF*(self: gen_qfontcombobox_types.QFontComboBox, metricA: cint, metricB: cint): float64 =
  fcQFontComboBox_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
...
proc create*(T: type gen_qfontcombobox_types.QFontComboBox,
  ...
  if not isNil(vtbl[].setModel):
    vtbl[].vtbl.setModel = fcQFontComboBox_vtable_callback_setModel
  ...
  if not isNil(vtbl[].inputMethodQuery_Qt_InputMethodQuery):
    vtbl[].vtbl.inputMethodQuery_Qt_InputMethodQuery = fcQFontComboBox_vtable_callback_inputMethodQuery_Qt_InputMethodQuery
  ...
  if not isNil(vtbl[].initStyleOption):
    vtbl[].vtbl.initStyleOption = fcQFontComboBox_vtable_callback_initStyleOption
  ...
  let tmp = gen_qfontcombobox_types.QFontComboBox(h: fcQFontComboBox_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQFontComboBox_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qfontcombobox_types.QFontComboBox,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQFontComboBox_vtable_callback_disconnectNotify
  let tmp = gen_qfontcombobox_types.QFontComboBox(h: fcQFontComboBox_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQFontComboBox_vdata(tmp.h)[] = addr(vtbl[])
  tmp
const cQFontComboBox_mvtbl = cQFontComboBoxVTable(
  ...
  setModel: fcQFontComboBox_method_callback_setModel,
  ...
  inputMethodQuery_Qt_InputMethodQuery: fcQFontComboBox_method_callback_inputMethodQuery_Qt_InputMethodQuery,
  ...
  initStyleOption: fcQFontComboBox_method_callback_initStyleOption,
...
proc create*(T: type gen_qfontcombobox_types.QFontComboBox,
  ...
  inst[].h = fcQFontComboBox_new(addr(cQFontComboBox_mvtbl), csize_t(sizeof(pointer)))
  fcQFontComboBox_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qfontcombobox_types.QFontComboBox,
    ...
    inst: VirtualQFontComboBox) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQFontComboBox_new2(addr(cQFontComboBox_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQFontComboBox_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
