...
proc fcQCalendarWidget_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.importc: "QCalendarWidget_virtualbase_nativeEvent".}
...
type QCalendarWidgetnativeEventProc* = proc(self: QCalendarWidget, eventType: openArray[byte], message: pointer, resultVal: ptr clong): bool {.raises: [], gcsafe.}
...
proc QCalendarWidgetnativeEvent*(self: gen_qcalendarwidget_types.QCalendarWidget, eventType: openArray[byte], message: pointer, resultVal: ptr clong): bool =
...
proc fcQCalendarWidget_vtable_callback_paintCell(self: pointer, painter: pointer, rect: pointer, date: pointer): void {.cdecl.} =
  ...
  let slotval3 = gen_qdatetime_types.QDate(h: date, owned: false)
...
proc fcQCalendarWidget_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let vtbl = cast[ptr QCalendarWidgetVTable](fcQCalendarWidget_vdata(self)[])
  let self = QCalendarWidget(h: self)
...
method enterEvent*(self: VirtualQCalendarWidget, event: gen_qcoreevent_types.QEvent): void {.base.} =
...
method nativeEvent*(self: VirtualQCalendarWidget, eventType: openArray[byte], message: pointer, resultVal: ptr clong): bool {.base.} =
...
proc fcQCalendarWidget_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let inst = cast[VirtualQCalendarWidget](fcQCalendarWidget_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
