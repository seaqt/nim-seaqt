...
proc fcQUndoGroup_trUtf8S(s: cstring): struct_seaqt_string {.importc: "QUndoGroup_trUtf8_s".}
...
proc fcQUndoGroup_trUtf8SC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QUndoGroup_trUtf8_s_c".}
proc fcQUndoGroup_trUtf8SCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QUndoGroup_trUtf8_s_c_n".}
...
proc trUtf8*(_: type gen_qundogroup_types.QUndoGroup, s: cstring): string =
  let v_ms = fcQUndoGroup_trUtf8S(s)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc create*(T: type gen_qundogroup_types.QUndoGroup,
  ...
  let tmp = gen_qundogroup_types.QUndoGroup(h: fcQUndoGroup_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
...
proc create*(T: type gen_qundogroup_types.QUndoGroup,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQUndoGroup_vtable_callback_disconnectNotify
  let tmp = gen_qundogroup_types.QUndoGroup(h: fcQUndoGroup_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQUndoGroup_vdata(tmp.h)[] = addr(vtbl[])
  tmp
