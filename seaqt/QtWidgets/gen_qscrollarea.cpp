...
public:
	...
	friend bool QScrollArea_virtualbase_nativeEvent(VirtualQScrollArea* self, struct miqt_string eventType, void* message, intptr_t* result);
...
VirtualQScrollArea* QScrollArea_new(const QScrollArea_VTable* vtbl, size_t vdata, QWidget* parent) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQScrollArea>());
