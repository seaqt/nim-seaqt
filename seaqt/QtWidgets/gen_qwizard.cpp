...
public:
	...
	friend bool QWizard_virtualbase_nativeEvent(VirtualQWizard* self, struct miqt_string eventType, void* message, intptr_t* result);
...
VirtualQWizard* QWizard_new(const QWizard_VTable* vtbl, size_t vdata, QWidget* parent) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQWizard>());
...
public:
	...
	friend bool QWizardPage_virtualbase_nativeEvent(VirtualQWizardPage* self, struct miqt_string eventType, void* message, intptr_t* result);
...
VirtualQWizardPage* QWizardPage_new(const QWizardPage_VTable* vtbl, size_t vdata, QWidget* parent) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQWizardPage>());
