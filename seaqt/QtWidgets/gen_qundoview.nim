...
proc fcQUndoView_new(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQUndoView {.importc: "QUndoView_new".}
proc fcQUndoView_new2(vtbl: pointer, vdata: csize_t): ptr cQUndoView {.importc: "QUndoView_new2".}
proc fcQUndoView_new3(vtbl: pointer, vdata: csize_t, stack: pointer): ptr cQUndoView {.importc: "QUndoView_new3".}
proc fcQUndoView_new4(vtbl: pointer, vdata: csize_t, group: pointer): ptr cQUndoView {.importc: "QUndoView_new4".}
