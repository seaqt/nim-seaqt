...
proc create*(T: type gen_qundoview_types.QUndoView,
  ...
  let tmp = gen_qundoview_types.QUndoView(h: fcQUndoView_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))))
...
proc create*(T: type gen_qundoview_types.QUndoView,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQUndoView_vtable_callback_disconnectNotify
  let tmp = gen_qundoview_types.QUndoView(h: fcQUndoView_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), stack.h))
  fcQUndoView_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qundoview_types.QUndoView,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQUndoView_vtable_callback_disconnectNotify
  let tmp = gen_qundoview_types.QUndoView(h: fcQUndoView_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), group.h))
  fcQUndoView_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qundoview_types.QUndoView,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQUndoView_vtable_callback_disconnectNotify
  let tmp = gen_qundoview_types.QUndoView(h: fcQUndoView_new4(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h))
  fcQUndoView_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qundoview_types.QUndoView,
