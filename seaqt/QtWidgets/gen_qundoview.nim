...
proc fcQUndoView_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.importc: "QUndoView_virtualbase_nativeEvent".}
...
type QUndoViewnativeEventProc* = proc(self: QUndoView, eventType: openArray[byte], message: pointer, resultVal: ptr clong): bool {.raises: [], gcsafe.}
...
proc QUndoViewviewOptions*(self: gen_qundoview_types.QUndoView): gen_qstyleoption_types.QStyleOptionViewItem =
  gen_qstyleoption_types.QStyleOptionViewItem(h: fcQUndoView_virtualbase_viewOptions(self.h), owned: true)
...
proc QUndoViewnativeEvent*(self: gen_qundoview_types.QUndoView, eventType: openArray[byte], message: pointer, resultVal: ptr clong): bool =
...
proc fcQUndoView_vtable_callback_viewOptions(self: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QUndoViewVTable](fcQUndoView_vdata(self)[])
  let self = QUndoView(h: self)
...
proc fcQUndoView_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let vtbl = cast[ptr QUndoViewVTable](fcQUndoView_vdata(self)[])
  let self = QUndoView(h: self)
...
method viewOptions*(self: VirtualQUndoView): gen_qstyleoption_types.QStyleOptionViewItem {.base.} =
  QUndoViewviewOptions(self[])
...
method enterEvent*(self: VirtualQUndoView, event: gen_qcoreevent_types.QEvent): void {.base.} =
...
method nativeEvent*(self: VirtualQUndoView, eventType: openArray[byte], message: pointer, resultVal: ptr clong): bool {.base.} =
...
proc fcQUndoView_method_callback_viewOptions(self: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQUndoView](fcQUndoView_vdata(self)[])
...
proc fcQUndoView_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let inst = cast[VirtualQUndoView](fcQUndoView_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc create*(T: type gen_qundoview_types.QUndoView,
  ...
  if not isNil(vtbl[].viewOptions):
    vtbl[].vtbl.viewOptions = fcQUndoView_vtable_callback_viewOptions
...
const cQUndoView_mvtbl = cQUndoViewVTable(
  ...
  viewOptions: fcQUndoView_method_callback_viewOptions,
