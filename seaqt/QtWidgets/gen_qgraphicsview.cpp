...
public:
	...
	friend bool QGraphicsView_virtualbase_nativeEvent(VirtualQGraphicsView* self, struct miqt_string eventType, void* message, intptr_t* result);
...
VirtualQGraphicsView* QGraphicsView_new(const QGraphicsView_VTable* vtbl, size_t vdata, QWidget* parent) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQGraphicsView>());
...
bool QGraphicsView_virtualbase_nativeEvent(VirtualQGraphicsView* self, struct miqt_string eventType, void* message, intptr_t* result) {
