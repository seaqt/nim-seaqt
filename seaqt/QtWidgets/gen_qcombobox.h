...
typedef struct QComboBox_VTable{
	...
	bool (*nativeEvent)(VirtualQComboBox* self, struct miqt_string eventType, void* message, long* result);
...
const QComboBox_VTable* QComboBox_vtbl(const VirtualQComboBox* self);
void* QComboBox_vdata(const VirtualQComboBox* self);
void QComboBox_setVdata(VirtualQComboBox* self, void* vdata);
