...
VirtualQGesture* QGesture_new(const QGesture_VTable* vtbl, size_t vdata) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQGesture>());
...
VirtualQPanGesture* QPanGesture_new(const QPanGesture_VTable* vtbl, size_t vdata) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQPanGesture>());
...
VirtualQPinchGesture* QPinchGesture_new(const QPinchGesture_VTable* vtbl, size_t vdata) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQPinchGesture>());
...
VirtualQSwipeGesture* QSwipeGesture_new(const QSwipeGesture_VTable* vtbl, size_t vdata) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQSwipeGesture>());
...
VirtualQTapGesture* QTapGesture_new(const QTapGesture_VTable* vtbl, size_t vdata) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQTapGesture>());
...
VirtualQTapAndHoldGesture* QTapAndHoldGesture_new(const QTapAndHoldGesture_VTable* vtbl, size_t vdata) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQTapAndHoldGesture>());
...
VirtualQGestureEvent* QGestureEvent_new(const QGestureEvent_VTable* vtbl, size_t vdata, struct miqt_array /* of QGesture* */  gestures) {
	...
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQGestureEvent>());
