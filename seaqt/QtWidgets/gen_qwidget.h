...
typedef struct QWidget_VTable{
	...
	bool (*nativeEvent)(VirtualQWidget* self, struct miqt_string eventType, void* message, intptr_t* result);
...
const QWidget_VTable* QWidget_vtbl(const VirtualQWidget* self);
void* QWidget_vdata(const VirtualQWidget* self);
void QWidget_setVdata(VirtualQWidget* self, void* vdata);
