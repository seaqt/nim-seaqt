...
proc fcQListWidget_new(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQListWidget {.importc: "QListWidget_new_parent".}
proc fcQListWidget_new2(vtbl: pointer, vdata: csize_t): ptr cQListWidget {.importc: "QListWidget_new".}
...
proc create*(T: type gen_qlistwidget_types.QListWidget,
  ...
  let tmp = gen_qlistwidget_types.QListWidget(h: fcQListWidget_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
...
proc create*(T: type gen_qlistwidget_types.QListWidget,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQListWidget_vtable_callback_disconnectNotify
  let tmp = gen_qlistwidget_types.QListWidget(h: fcQListWidget_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQListWidget_vdata(tmp.h)[] = addr(vtbl[])
  tmp
...
proc create*(T: type gen_qlistwidget_types.QListWidget,
  ...
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQListWidget_new(addr(cQListWidget_mvtbl), csize_t(sizeof(pointer)), parent.h)
...
proc create*(T: type gen_qlistwidget_types.QListWidget,
    inst: VirtualQListWidget) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQListWidget_new2(addr(cQListWidget_mvtbl), csize_t(sizeof(pointer)))
  fcQListWidget_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
