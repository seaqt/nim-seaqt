...
proc cQListWidget_vtable_callback_initViewItemOption(self: pointer, option: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QListWidgetVTable](fcQListWidget_vdata(self))
  let self = QListWidget(h: self)
...
proc cQListWidget_vtable_callback_itemDelegateForIndex(self: pointer, index: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QListWidgetVTable](fcQListWidget_vdata(self))
  let self = QListWidget(h: self)
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
...
proc cQListWidget_vtable_callback_initStyleOption(self: pointer, option: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QListWidgetVTable](fcQListWidget_vdata(self))
  let self = QListWidget(h: self)
...
proc cQListWidget_vtable_callback_nativeEvent(self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QListWidgetVTable](fcQListWidget_vdata(self))
  let self = QListWidget(h: self)
...
proc cQListWidget_method_callback_initViewItemOption(self: pointer, option: pointer): void {.cdecl.} =
  let inst = cast[VirtualQListWidget](fcQListWidget_vdata(self))
  let slotval1 = gen_qstyleoption_types.QStyleOptionViewItem(h: option, owned: false)
...
proc cQListWidget_method_callback_itemDelegateForIndex(self: pointer, index: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQListWidget](fcQListWidget_vdata(self))
  let slotval1 = gen_qabstractitemmodel_types.QModelIndex(h: index, owned: false)
...
proc cQListWidget_method_callback_initStyleOption(self: pointer, option: pointer): void {.cdecl.} =
  let inst = cast[VirtualQListWidget](fcQListWidget_vdata(self))
  let slotval1 = gen_qstyleoption_types.QStyleOptionFrame(h: option, owned: false)
...
proc cQListWidget_method_callback_nativeEvent(self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let inst = cast[VirtualQListWidget](fcQListWidget_vdata(self))
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc create*(T: type gen_qlistwidget_types.QListWidget,
  ...
  if not isNil(vtbl[].initViewItemOption):
    vtbl[].vtbl.initViewItemOption = cQListWidget_vtable_callback_initViewItemOption
  ...
  if not isNil(vtbl[].itemDelegateForIndex):
    vtbl[].vtbl.itemDelegateForIndex = cQListWidget_vtable_callback_itemDelegateForIndex
  ...
  if not isNil(vtbl[].initStyleOption):
    vtbl[].vtbl.initStyleOption = cQListWidget_vtable_callback_initStyleOption
...
const cQListWidget_mvtbl = cQListWidgetVTable(
  ...
  initViewItemOption: cQListWidget_method_callback_initViewItemOption,
  ...
  itemDelegateForIndex: cQListWidget_method_callback_itemDelegateForIndex,
  ...
  initStyleOption: cQListWidget_method_callback_initStyleOption,
