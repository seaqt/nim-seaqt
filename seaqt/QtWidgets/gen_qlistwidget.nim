...
proc fcQListWidget_new(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQListWidget {.importc: "QListWidget_new".}
proc fcQListWidget_new2(vtbl: pointer, vdata: csize_t): ptr cQListWidget {.importc: "QListWidget_new2".}
