...
typedef struct QCheckBox_VTable{
	...
	bool (*nativeEvent)(VirtualQCheckBox* self, struct miqt_string eventType, void* message, intptr_t* result);
...
VirtualQCheckBox* QCheckBox_new3(const QCheckBox_VTable* vtbl, size_t vdata, struct miqt_string text);
VirtualQCheckBox* QCheckBox_new4(const QCheckBox_VTable* vtbl, size_t vdata, struct miqt_string text, QWidget* parent);
