...
public:
	...
	friend bool QToolButton_virtualbase_nativeEvent(VirtualQToolButton* self, struct miqt_string eventType, void* message, intptr_t* result);
...
VirtualQToolButton* QToolButton_new(const QToolButton_VTable* vtbl, size_t vdata, QWidget* parent) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQToolButton>());
