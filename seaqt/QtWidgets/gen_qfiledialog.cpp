...
VirtualQFileDialog* QFileDialog_new(const QFileDialog_VTable* vtbl, size_t vdata, QWidget* parent) {
	void* _mem_ = malloc(seaqt_aligned_sizeof<VirtualQFileDialog>());
...
VirtualQFileDialog* QFileDialog_new4(const QFileDialog_VTable* vtbl, size_t vdata, QWidget* parent, struct miqt_string caption) {
...
VirtualQFileDialog* QFileDialog_new5(const QFileDialog_VTable* vtbl, size_t vdata, QWidget* parent, struct miqt_string caption, struct miqt_string directory) {
	QString caption_QString = QString::fromUtf8(caption.data, caption.len);
...
VirtualQFileDialog* QFileDialog_new6(const QFileDialog_VTable* vtbl, size_t vdata, QWidget* parent, struct miqt_string caption, struct miqt_string directory, struct miqt_string filter) {
	QString caption_QString = QString::fromUtf8(caption.data, caption.len);
	QString directory_QString = QString::fromUtf8(directory.data, directory.len);
