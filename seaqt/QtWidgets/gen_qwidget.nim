...
proc fcQWidgetData_widgetAttributes(self: pointer): cuint {.importc: "QWidgetData_widgetAttributes".}
proc fcQWidgetData_setWidgetAttributes(self: pointer, widget_attributes: cuint): void {.importc: "QWidgetData_setWidgetAttributes".}
proc fcQWidgetData_windowFlags(self: pointer): cint {.importc: "QWidgetData_windowFlags".}
proc fcQWidgetData_setWindowFlags(self: pointer, window_flags: cint): void {.importc: "QWidgetData_setWindowFlags".}
proc fcQWidgetData_windowState(self: pointer): cuint {.importc: "QWidgetData_windowState".}
proc fcQWidgetData_setWindowState(self: pointer, window_state: cuint): void {.importc: "QWidgetData_setWindowState".}
proc fcQWidgetData_focusPolicy(self: pointer): cuint {.importc: "QWidgetData_focusPolicy".}
proc fcQWidgetData_setFocusPolicy(self: pointer, focus_policy: cuint): void {.importc: "QWidgetData_setFocusPolicy".}
proc fcQWidgetData_sizehintForced(self: pointer): cuint {.importc: "QWidgetData_sizehintForced".}
proc fcQWidgetData_setSizehintForced(self: pointer, sizehint_forced: cuint): void {.importc: "QWidgetData_setSizehintForced".}
proc fcQWidgetData_isClosing(self: pointer): cuint {.importc: "QWidgetData_isClosing".}
proc fcQWidgetData_setIsClosing(self: pointer, is_closing: cuint): void {.importc: "QWidgetData_setIsClosing".}
proc fcQWidgetData_inShow(self: pointer): cuint {.importc: "QWidgetData_inShow".}
proc fcQWidgetData_setInShow(self: pointer, in_show: cuint): void {.importc: "QWidgetData_setInShow".}
proc fcQWidgetData_inSetWindowState(self: pointer): cuint {.importc: "QWidgetData_inSetWindowState".}
proc fcQWidgetData_setInSetWindowState(self: pointer, in_set_window_state: cuint): void {.importc: "QWidgetData_setInSetWindowState".}
proc fcQWidgetData_fstrutDirty(self: pointer): cuint {.importc: "QWidgetData_fstrutDirty".}
proc fcQWidgetData_setFstrutDirty(self: pointer, fstrut_dirty: cuint): void {.importc: "QWidgetData_setFstrutDirty".}
proc fcQWidgetData_contextMenuPolicy(self: pointer): cuint {.importc: "QWidgetData_contextMenuPolicy".}
proc fcQWidgetData_setContextMenuPolicy(self: pointer, context_menu_policy: cuint): void {.importc: "QWidgetData_setContextMenuPolicy".}
proc fcQWidgetData_windowModality(self: pointer): cuint {.importc: "QWidgetData_windowModality".}
proc fcQWidgetData_setWindowModality(self: pointer, window_modality: cuint): void {.importc: "QWidgetData_setWindowModality".}
proc fcQWidgetData_inDestructor(self: pointer): cuint {.importc: "QWidgetData_inDestructor".}
proc fcQWidgetData_setInDestructor(self: pointer, in_destructor: cuint): void {.importc: "QWidgetData_setInDestructor".}
...
proc fcQWidget_trUtf8(s: cstring): struct_seaqt_string {.importc: "QWidget_trUtf8".}
...
proc fcQWidget_trUtf82(s: cstring, c: cstring): struct_seaqt_string {.importc: "QWidget_trUtf82".}
proc fcQWidget_trUtf83(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QWidget_trUtf83".}
...
proc fcQWidget_new(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQWidget {.importc: "QWidget_new".}
proc fcQWidget_new2(vtbl: pointer, vdata: csize_t): ptr cQWidget {.importc: "QWidget_new2".}
...
proc create*(T: type gen_qwidget_types.QWidgetData,
  ...
  let tmp = gen_qwidget_types.QWidgetData(h: fcQWidgetData_new(param1.h), owned: true)
  tmp
