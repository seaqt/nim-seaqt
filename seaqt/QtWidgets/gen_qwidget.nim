...
proc fcQWidgetData_winid(self: pointer): uint {.importc: "QWidgetData_winid".}
proc fcQWidgetData_setWinid(self: pointer, winid: uint): void {.importc: "QWidgetData_setWinid".}
proc fcQWidgetData_widgetAttributes(self: pointer): cuint {.importc: "QWidgetData_widget_attributes".}
proc fcQWidgetData_setWidgetAttributes(self: pointer, widget_attributes: cuint): void {.importc: "QWidgetData_setWidget_attributes".}
proc fcQWidgetData_windowFlags(self: pointer): cint {.importc: "QWidgetData_window_flags".}
proc fcQWidgetData_setWindowFlags(self: pointer, window_flags: cint): void {.importc: "QWidgetData_setWindow_flags".}
proc fcQWidgetData_windowState(self: pointer): cuint {.importc: "QWidgetData_window_state".}
proc fcQWidgetData_setWindowState(self: pointer, window_state: cuint): void {.importc: "QWidgetData_setWindow_state".}
proc fcQWidgetData_focusPolicy(self: pointer): cuint {.importc: "QWidgetData_focus_policy".}
proc fcQWidgetData_setFocusPolicy(self: pointer, focus_policy: cuint): void {.importc: "QWidgetData_setFocus_policy".}
proc fcQWidgetData_sizehintForced(self: pointer): cuint {.importc: "QWidgetData_sizehint_forced".}
proc fcQWidgetData_setSizehintForced(self: pointer, sizehint_forced: cuint): void {.importc: "QWidgetData_setSizehint_forced".}
proc fcQWidgetData_isClosing(self: pointer): cuint {.importc: "QWidgetData_is_closing".}
proc fcQWidgetData_setIsClosing(self: pointer, is_closing: cuint): void {.importc: "QWidgetData_setIs_closing".}
proc fcQWidgetData_inShow(self: pointer): cuint {.importc: "QWidgetData_in_show".}
proc fcQWidgetData_setInShow(self: pointer, in_show: cuint): void {.importc: "QWidgetData_setIn_show".}
proc fcQWidgetData_inSetWindowState(self: pointer): cuint {.importc: "QWidgetData_in_set_window_state".}
proc fcQWidgetData_setInSetWindowState(self: pointer, in_set_window_state: cuint): void {.importc: "QWidgetData_setIn_set_window_state".}
proc fcQWidgetData_fstrutDirty(self: pointer): cuint {.importc: "QWidgetData_fstrut_dirty".}
proc fcQWidgetData_setFstrutDirty(self: pointer, fstrut_dirty: cuint): void {.importc: "QWidgetData_setFstrut_dirty".}
proc fcQWidgetData_contextMenuPolicy(self: pointer): cuint {.importc: "QWidgetData_context_menu_policy".}
proc fcQWidgetData_setContextMenuPolicy(self: pointer, context_menu_policy: cuint): void {.importc: "QWidgetData_setContext_menu_policy".}
proc fcQWidgetData_windowModality(self: pointer): cuint {.importc: "QWidgetData_window_modality".}
proc fcQWidgetData_setWindowModality(self: pointer, window_modality: cuint): void {.importc: "QWidgetData_setWindow_modality".}
proc fcQWidgetData_inDestructor(self: pointer): cuint {.importc: "QWidgetData_in_destructor".}
proc fcQWidgetData_setInDestructor(self: pointer, in_destructor: cuint): void {.importc: "QWidgetData_setIn_destructor".}
proc fcQWidgetData_unused(self: pointer): cuint {.importc: "QWidgetData_unused".}
proc fcQWidgetData_setUnused(self: pointer, unused: cuint): void {.importc: "QWidgetData_setUnused".}
proc fcQWidgetData_crect(self: pointer): pointer {.importc: "QWidgetData_crect".}
proc fcQWidgetData_setCrect(self: pointer, crect: pointer): void {.importc: "QWidgetData_setCrect".}
proc fcQWidgetData_pal(self: pointer): pointer {.importc: "QWidgetData_pal".}
proc fcQWidgetData_setPal(self: pointer, pal: pointer): void {.importc: "QWidgetData_setPal".}
proc fcQWidgetData_fnt(self: pointer): pointer {.importc: "QWidgetData_fnt".}
proc fcQWidgetData_setFnt(self: pointer, fnt: pointer): void {.importc: "QWidgetData_setFnt".}
proc fcQWidgetData_wrect(self: pointer): pointer {.importc: "QWidgetData_wrect".}
proc fcQWidgetData_setWrect(self: pointer, wrect: pointer): void {.importc: "QWidgetData_setWrect".}
proc fcQWidgetData_operatorAssign(self: pointer, fromVal: pointer): void {.importc: "QWidgetData_operatorAssign".}
proc fcQWidgetData_new(fromVal: pointer): ptr cQWidgetData {.importc: "QWidgetData_new".}
...
proc fcQWidget_trUtf8S(s: cstring): struct_seaqt_string {.importc: "QWidget_trUtf8_s".}
...
proc fcQWidget_styleSheet(self: pointer): struct_seaqt_string {.importc: "QWidget_styleSheet".}
proc fcQWidget_windowTitle(self: pointer): struct_seaqt_string {.importc: "QWidget_windowTitle".}
...
proc fcQWidget_setWindowIconText(self: pointer, windowIconText: struct_seaqt_string): void {.importc: "QWidget_setWindowIconText".}
proc fcQWidget_windowIconText(self: pointer): struct_seaqt_string {.importc: "QWidget_windowIconText".}
proc fcQWidget_setWindowRole(self: pointer, windowRole: struct_seaqt_string): void {.importc: "QWidget_setWindowRole".}
proc fcQWidget_windowRole(self: pointer): struct_seaqt_string {.importc: "QWidget_windowRole".}
proc fcQWidget_setWindowFilePath(self: pointer, filePath: struct_seaqt_string): void {.importc: "QWidget_setWindowFilePath".}
proc fcQWidget_windowFilePath(self: pointer): struct_seaqt_string {.importc: "QWidget_windowFilePath".}
...
proc fcQWidget_setToolTip(self: pointer, toolTip: struct_seaqt_string): void {.importc: "QWidget_setToolTip".}
proc fcQWidget_toolTip(self: pointer): struct_seaqt_string {.importc: "QWidget_toolTip".}
...
proc fcQWidget_setStatusTip(self: pointer, statusTip: struct_seaqt_string): void {.importc: "QWidget_setStatusTip".}
proc fcQWidget_statusTip(self: pointer): struct_seaqt_string {.importc: "QWidget_statusTip".}
proc fcQWidget_setWhatsThis(self: pointer, whatsThis: struct_seaqt_string): void {.importc: "QWidget_setWhatsThis".}
proc fcQWidget_whatsThis(self: pointer): struct_seaqt_string {.importc: "QWidget_whatsThis".}
proc fcQWidget_accessibleName(self: pointer): struct_seaqt_string {.importc: "QWidget_accessibleName".}
proc fcQWidget_setAccessibleName(self: pointer, name: struct_seaqt_string): void {.importc: "QWidget_setAccessibleName".}
proc fcQWidget_accessibleDescription(self: pointer): struct_seaqt_string {.importc: "QWidget_accessibleDescription".}
proc fcQWidget_setAccessibleDescription(self: pointer, description: struct_seaqt_string): void {.importc: "QWidget_setAccessibleDescription".}
...
proc fcQWidget_windowIconTextChanged(self: pointer, iconText: struct_seaqt_string): void {.importc: "QWidget_windowIconTextChanged".}
proc fcQWidget_connect_windowIconTextChanged(self: pointer, slot: int, callback: proc (slot: int, iconText: struct_seaqt_string) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QWidget_connect_windowIconTextChanged".}
...
proc fcQWidget_trUtf8SC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QWidget_trUtf8_s_c".}
proc fcQWidget_trUtf8SCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QWidget_trUtf8_s_c_n".}
...
proc fcQWidget_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.importc: "QWidget_virtualbase_nativeEvent".}
...
proc fcQWidget_new(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQWidget {.importc: "QWidget_new_parent".}
proc fcQWidget_new2(vtbl: pointer, vdata: csize_t): ptr cQWidget {.importc: "QWidget_new".}
...
proc winid*(self: gen_qwidget_types.QWidgetData): uint =
  fcQWidgetData_winid(self.h)

proc setWinid*(self: gen_qwidget_types.QWidgetData, winid: uint): void =
  fcQWidgetData_setWinid(self.h, winid)

proc widgetAttributes*(self: gen_qwidget_types.QWidgetData): cuint =
  fcQWidgetData_widgetAttributes(self.h)

proc setWidgetAttributes*(self: gen_qwidget_types.QWidgetData, widget_attributes: cuint): void =
  fcQWidgetData_setWidgetAttributes(self.h, widget_attributes)

proc windowFlags*(self: gen_qwidget_types.QWidgetData): cint =
  cint(fcQWidgetData_windowFlags(self.h))

proc setWindowFlags*(self: gen_qwidget_types.QWidgetData, window_flags: cint): void =
  fcQWidgetData_setWindowFlags(self.h, cint(window_flags))

proc windowState*(self: gen_qwidget_types.QWidgetData): cuint =
  fcQWidgetData_windowState(self.h)

proc setWindowState*(self: gen_qwidget_types.QWidgetData, window_state: cuint): void =
  fcQWidgetData_setWindowState(self.h, window_state)

proc focusPolicy*(self: gen_qwidget_types.QWidgetData): cuint =
  fcQWidgetData_focusPolicy(self.h)

proc setFocusPolicy*(self: gen_qwidget_types.QWidgetData, focus_policy: cuint): void =
  fcQWidgetData_setFocusPolicy(self.h, focus_policy)

proc sizehintForced*(self: gen_qwidget_types.QWidgetData): cuint =
  fcQWidgetData_sizehintForced(self.h)

proc setSizehintForced*(self: gen_qwidget_types.QWidgetData, sizehint_forced: cuint): void =
  fcQWidgetData_setSizehintForced(self.h, sizehint_forced)

proc isClosing*(self: gen_qwidget_types.QWidgetData): cuint =
  fcQWidgetData_isClosing(self.h)

proc setIsClosing*(self: gen_qwidget_types.QWidgetData, is_closing: cuint): void =
  fcQWidgetData_setIsClosing(self.h, is_closing)

proc inShow*(self: gen_qwidget_types.QWidgetData): cuint =
  fcQWidgetData_inShow(self.h)

proc setInShow*(self: gen_qwidget_types.QWidgetData, in_show: cuint): void =
  fcQWidgetData_setInShow(self.h, in_show)

proc inSetWindowState*(self: gen_qwidget_types.QWidgetData): cuint =
  fcQWidgetData_inSetWindowState(self.h)

proc setInSetWindowState*(self: gen_qwidget_types.QWidgetData, in_set_window_state: cuint): void =
  fcQWidgetData_setInSetWindowState(self.h, in_set_window_state)

proc fstrutDirty*(self: gen_qwidget_types.QWidgetData): cuint =
  fcQWidgetData_fstrutDirty(self.h)

proc setFstrutDirty*(self: gen_qwidget_types.QWidgetData, fstrut_dirty: cuint): void =
  fcQWidgetData_setFstrutDirty(self.h, fstrut_dirty)

proc contextMenuPolicy*(self: gen_qwidget_types.QWidgetData): cuint =
  fcQWidgetData_contextMenuPolicy(self.h)

proc setContextMenuPolicy*(self: gen_qwidget_types.QWidgetData, context_menu_policy: cuint): void =
  fcQWidgetData_setContextMenuPolicy(self.h, context_menu_policy)

proc windowModality*(self: gen_qwidget_types.QWidgetData): cuint =
  fcQWidgetData_windowModality(self.h)

proc setWindowModality*(self: gen_qwidget_types.QWidgetData, window_modality: cuint): void =
  fcQWidgetData_setWindowModality(self.h, window_modality)

proc inDestructor*(self: gen_qwidget_types.QWidgetData): cuint =
  fcQWidgetData_inDestructor(self.h)

proc setInDestructor*(self: gen_qwidget_types.QWidgetData, in_destructor: cuint): void =
  fcQWidgetData_setInDestructor(self.h, in_destructor)

proc unused*(self: gen_qwidget_types.QWidgetData): cuint =
  fcQWidgetData_unused(self.h)

proc setUnused*(self: gen_qwidget_types.QWidgetData, unused: cuint): void =
  fcQWidgetData_setUnused(self.h, unused)

proc crect*(self: gen_qwidget_types.QWidgetData): gen_qrect_types.QRect =
  gen_qrect_types.QRect(h: fcQWidgetData_crect(self.h), owned: true)

proc setCrect*(self: gen_qwidget_types.QWidgetData, crect: gen_qrect_types.QRect): void =
  fcQWidgetData_setCrect(self.h, crect.h)

proc pal*(self: gen_qwidget_types.QWidgetData): gen_qpalette_types.QPalette =
  gen_qpalette_types.QPalette(h: fcQWidgetData_pal(self.h), owned: true)

proc setPal*(self: gen_qwidget_types.QWidgetData, pal: gen_qpalette_types.QPalette): void =
  fcQWidgetData_setPal(self.h, pal.h)

proc fnt*(self: gen_qwidget_types.QWidgetData): gen_qfont_types.QFont =
  gen_qfont_types.QFont(h: fcQWidgetData_fnt(self.h), owned: true)

proc setFnt*(self: gen_qwidget_types.QWidgetData, fnt: gen_qfont_types.QFont): void =
  fcQWidgetData_setFnt(self.h, fnt.h)

proc wrect*(self: gen_qwidget_types.QWidgetData): gen_qrect_types.QRect =
  gen_qrect_types.QRect(h: fcQWidgetData_wrect(self.h), owned: true)

proc setWrect*(self: gen_qwidget_types.QWidgetData, wrect: gen_qrect_types.QRect): void =
  fcQWidgetData_setWrect(self.h, wrect.h)

proc operatorAssign*(self: gen_qwidget_types.QWidgetData, fromVal: gen_qwidget_types.QWidgetData): void =
  fcQWidgetData_operatorAssign(self.h, fromVal.h)

proc create*(T: type gen_qwidget_types.QWidgetData,
    fromVal: gen_qwidget_types.QWidgetData): gen_qwidget_types.QWidgetData =
  let tmp = gen_qwidget_types.QWidgetData(h: fcQWidgetData_new(fromVal.h), owned: true)
  tmp
...
proc setWindowTitle*(self: gen_qwidget_types.QWidget, windowTitle: openArray[char]): void =
  fcQWidget_setWindowTitle(self.h, struct_seaqt_string(data: if len(windowTitle) > 0: addr windowTitle[0] else: nil, len: csize_t(len(windowTitle))))

proc setStyleSheet*(self: gen_qwidget_types.QWidget, styleSheet: openArray[char]): void =
  fcQWidget_setStyleSheet(self.h, struct_seaqt_string(data: if len(styleSheet) > 0: addr styleSheet[0] else: nil, len: csize_t(len(styleSheet))))
...
proc setWindowIconText*(self: gen_qwidget_types.QWidget, windowIconText: openArray[char]): void =
  fcQWidget_setWindowIconText(self.h, struct_seaqt_string(data: if len(windowIconText) > 0: addr windowIconText[0] else: nil, len: csize_t(len(windowIconText))))
...
proc setWindowRole*(self: gen_qwidget_types.QWidget, windowRole: openArray[char]): void =
  fcQWidget_setWindowRole(self.h, struct_seaqt_string(data: if len(windowRole) > 0: addr windowRole[0] else: nil, len: csize_t(len(windowRole))))
...
proc setWindowFilePath*(self: gen_qwidget_types.QWidget, filePath: openArray[char]): void =
  fcQWidget_setWindowFilePath(self.h, struct_seaqt_string(data: if len(filePath) > 0: addr filePath[0] else: nil, len: csize_t(len(filePath))))
...
proc setToolTip*(self: gen_qwidget_types.QWidget, toolTip: openArray[char]): void =
  fcQWidget_setToolTip(self.h, struct_seaqt_string(data: if len(toolTip) > 0: addr toolTip[0] else: nil, len: csize_t(len(toolTip))))
...
proc setStatusTip*(self: gen_qwidget_types.QWidget, statusTip: openArray[char]): void =
  fcQWidget_setStatusTip(self.h, struct_seaqt_string(data: if len(statusTip) > 0: addr statusTip[0] else: nil, len: csize_t(len(statusTip))))
...
proc setWhatsThis*(self: gen_qwidget_types.QWidget, whatsThis: openArray[char]): void =
  fcQWidget_setWhatsThis(self.h, struct_seaqt_string(data: if len(whatsThis) > 0: addr whatsThis[0] else: nil, len: csize_t(len(whatsThis))))
...
proc setAccessibleName*(self: gen_qwidget_types.QWidget, name: openArray[char]): void =
  fcQWidget_setAccessibleName(self.h, struct_seaqt_string(data: if len(name) > 0: addr name[0] else: nil, len: csize_t(len(name))))
...
proc setAccessibleDescription*(self: gen_qwidget_types.QWidget, description: openArray[char]): void =
  fcQWidget_setAccessibleDescription(self.h, struct_seaqt_string(data: if len(description) > 0: addr description[0] else: nil, len: csize_t(len(description))))
...
proc restoreGeometry*(self: gen_qwidget_types.QWidget, geometry: openArray[byte]): bool =
  fcQWidget_restoreGeometry(self.h, struct_seaqt_string(data: if len(geometry) > 0: addr geometry[0] else: nil, len: csize_t(len(geometry))))
...
proc addActions*(self: gen_qwidget_types.QWidget, actions: openArray[gen_qaction_types.QAction]): void =
  ...
  fcQWidget_addActions(self.h, struct_seaqt_array(len: csize_t(len(actions)), data: if len(actions) == 0: nil else: addr(actions_CArray[0])))
...
proc insertActions*(self: gen_qwidget_types.QWidget, before: gen_qaction_types.QAction, actions: openArray[gen_qaction_types.QAction]): void =
  ...
  fcQWidget_insertActions(self.h, before.h, struct_seaqt_array(len: csize_t(len(actions)), data: if len(actions) == 0: nil else: addr(actions_CArray[0])))
...
proc fcQWidget_slot_callback_windowTitleChanged(slot: int, title: struct_seaqt_string) {.cdecl.} =
...
proc fcQWidget_slot_callback_windowTitleChanged_release(slot: int) {.cdecl.} =
...
proc onWindowTitleChanged*(self: gen_qwidget_types.QWidget, slot: QWidgetwindowTitleChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQWidget_connect_windowTitleChanged(self.h, cast[int](addr tmp[]), fcQWidget_slot_callback_windowTitleChanged, fcQWidget_slot_callback_windowTitleChanged_release)
...
proc fcQWidget_slot_callback_windowIconChanged(slot: int, icon: pointer) {.cdecl.} =
  let nimfunc = cast[ptr QWidgetwindowIconChangedSlot](cast[pointer](slot))
  let slotval1 = gen_qicon_types.QIcon(h: icon, owned: false)

  nimfunc[](slotval1)

proc fcQWidget_slot_callback_windowIconChanged_release(slot: int) {.cdecl.} =
...
proc onWindowIconChanged*(self: gen_qwidget_types.QWidget, slot: QWidgetwindowIconChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQWidget_connect_windowIconChanged(self.h, cast[int](addr tmp[]), fcQWidget_slot_callback_windowIconChanged, fcQWidget_slot_callback_windowIconChanged_release)

proc windowIconTextChanged*(self: gen_qwidget_types.QWidget, iconText: openArray[char]): void =
  fcQWidget_windowIconTextChanged(self.h, struct_seaqt_string(data: if len(iconText) > 0: addr iconText[0] else: nil, len: csize_t(len(iconText))))

type QWidgetwindowIconTextChangedSlot* = proc(iconText: openArray[char])
proc fcQWidget_slot_callback_windowIconTextChanged(slot: int, iconText: struct_seaqt_string) {.cdecl.} =
...
proc fcQWidget_slot_callback_windowIconTextChanged_release(slot: int) {.cdecl.} =
...
proc onWindowIconTextChanged*(self: gen_qwidget_types.QWidget, slot: QWidgetwindowIconTextChangedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQWidget_connect_windowIconTextChanged(self.h, cast[int](addr tmp[]), fcQWidget_slot_callback_windowIconTextChanged, fcQWidget_slot_callback_windowIconTextChanged_release)
...
proc fcQWidget_slot_callback_customContextMenuRequested(slot: int, pos: pointer) {.cdecl.} =
...
proc fcQWidget_slot_callback_customContextMenuRequested_release(slot: int) {.cdecl.} =
...
proc onCustomContextMenuRequested*(self: gen_qwidget_types.QWidget, slot: QWidgetcustomContextMenuRequestedSlot) =
  ...
  tmp[] = slot
  GC_ref(tmp)
  fcQWidget_connect_customContextMenuRequested(self.h, cast[int](addr tmp[]), fcQWidget_slot_callback_customContextMenuRequested, fcQWidget_slot_callback_customContextMenuRequested_release)
...
type QWidgetnativeEventProc* = proc(self: QWidget, eventType: openArray[byte], message: pointer, resultVal: ptr clong): bool {.raises: [], gcsafe.}
...
proc QWidgetnativeEvent*(self: gen_qwidget_types.QWidget, eventType: openArray[byte], message: pointer, resultVal: ptr clong): bool =
  fcQWidget_virtualbase_nativeEvent(self.h, struct_seaqt_string(data: if len(eventType) > 0: addr eventType[0] else: nil, len: csize_t(len(eventType))), message, resultVal)
...
proc fcQWidget_vtable_callback_metaObject(self: pointer): pointer {.cdecl.} =
...
proc fcQWidget_vtable_callback_metacast(self: pointer, param1: cstring): pointer {.cdecl.} =
  let vtbl = cast[ptr QWidgetVTable](fcQWidget_vdata(self)[])
  let self = QWidget(h: self)
  let slotval1 = (param1)
...
proc fcQWidget_vtable_callback_metacall(self: pointer, param1: cint, param2: cint, param3: pointer): cint {.cdecl.} =
  let vtbl = cast[ptr QWidgetVTable](fcQWidget_vdata(self)[])
  let self = QWidget(h: self)
...
proc fcQWidget_vtable_callback_devType(self: pointer): cint {.cdecl.} =
  let vtbl = cast[ptr QWidgetVTable](fcQWidget_vdata(self)[])
  let self = QWidget(h: self)
  var virtualReturn = vtbl[].devType(self)
  virtualReturn

proc fcQWidget_vtable_callback_setVisible(self: pointer, visible: bool): void {.cdecl.} =
  let vtbl = cast[ptr QWidgetVTable](fcQWidget_vdata(self)[])
  let self = QWidget(h: self)
  let slotval1 = visible
  vtbl[].setVisible(self, slotval1)

proc fcQWidget_vtable_callback_sizeHint(self: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QWidgetVTable](fcQWidget_vdata(self)[])
  let self = QWidget(h: self)
...
proc fcQWidget_vtable_callback_minimumSizeHint(self: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QWidgetVTable](fcQWidget_vdata(self)[])
  let self = QWidget(h: self)
...
proc fcQWidget_vtable_callback_heightForWidth(self: pointer, param1: cint): cint {.cdecl.} =
  let vtbl = cast[ptr QWidgetVTable](fcQWidget_vdata(self)[])
  let self = QWidget(h: self)
  let slotval1 = param1
...
proc fcQWidget_vtable_callback_hasHeightForWidth(self: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QWidgetVTable](fcQWidget_vdata(self)[])
  let self = QWidget(h: self)
  var virtualReturn = vtbl[].hasHeightForWidth(self)
  virtualReturn

proc fcQWidget_vtable_callback_paintEngine(self: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QWidgetVTable](fcQWidget_vdata(self)[])
  let self = QWidget(h: self)
...
proc fcQWidget_vtable_callback_event(self: pointer, event: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QWidgetVTable](fcQWidget_vdata(self)[])
  let self = QWidget(h: self)
...
proc fcQWidget_vtable_callback_mousePressEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QWidgetVTable](fcQWidget_vdata(self)[])
  let self = QWidget(h: self)
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
  vtbl[].mousePressEvent(self, slotval1)

proc fcQWidget_vtable_callback_mouseReleaseEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QWidgetVTable](fcQWidget_vdata(self)[])
  let self = QWidget(h: self)
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
  vtbl[].mouseReleaseEvent(self, slotval1)

proc fcQWidget_vtable_callback_mouseDoubleClickEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QWidgetVTable](fcQWidget_vdata(self)[])
  let self = QWidget(h: self)
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
  vtbl[].mouseDoubleClickEvent(self, slotval1)

proc fcQWidget_vtable_callback_mouseMoveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QWidgetVTable](fcQWidget_vdata(self)[])
  let self = QWidget(h: self)
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
  vtbl[].mouseMoveEvent(self, slotval1)

proc fcQWidget_vtable_callback_wheelEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QWidgetVTable](fcQWidget_vdata(self)[])
  let self = QWidget(h: self)
  let slotval1 = gen_qevent_types.QWheelEvent(h: event, owned: false)
  vtbl[].wheelEvent(self, slotval1)

proc fcQWidget_vtable_callback_keyPressEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QWidgetVTable](fcQWidget_vdata(self)[])
  let self = QWidget(h: self)
  let slotval1 = gen_qevent_types.QKeyEvent(h: event, owned: false)
  vtbl[].keyPressEvent(self, slotval1)

proc fcQWidget_vtable_callback_keyReleaseEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QWidgetVTable](fcQWidget_vdata(self)[])
  let self = QWidget(h: self)
  let slotval1 = gen_qevent_types.QKeyEvent(h: event, owned: false)
  vtbl[].keyReleaseEvent(self, slotval1)

proc fcQWidget_vtable_callback_focusInEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QWidgetVTable](fcQWidget_vdata(self)[])
  let self = QWidget(h: self)
  let slotval1 = gen_qevent_types.QFocusEvent(h: event, owned: false)
  vtbl[].focusInEvent(self, slotval1)

proc fcQWidget_vtable_callback_focusOutEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QWidgetVTable](fcQWidget_vdata(self)[])
  let self = QWidget(h: self)
  let slotval1 = gen_qevent_types.QFocusEvent(h: event, owned: false)
  vtbl[].focusOutEvent(self, slotval1)

proc fcQWidget_vtable_callback_enterEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QWidgetVTable](fcQWidget_vdata(self)[])
  let self = QWidget(h: self)
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
  vtbl[].enterEvent(self, slotval1)

proc fcQWidget_vtable_callback_leaveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QWidgetVTable](fcQWidget_vdata(self)[])
  let self = QWidget(h: self)
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
  vtbl[].leaveEvent(self, slotval1)

proc fcQWidget_vtable_callback_paintEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QWidgetVTable](fcQWidget_vdata(self)[])
  let self = QWidget(h: self)
  let slotval1 = gen_qevent_types.QPaintEvent(h: event, owned: false)
  vtbl[].paintEvent(self, slotval1)

proc fcQWidget_vtable_callback_moveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QWidgetVTable](fcQWidget_vdata(self)[])
  let self = QWidget(h: self)
  let slotval1 = gen_qevent_types.QMoveEvent(h: event, owned: false)
  vtbl[].moveEvent(self, slotval1)

proc fcQWidget_vtable_callback_resizeEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QWidgetVTable](fcQWidget_vdata(self)[])
  let self = QWidget(h: self)
  let slotval1 = gen_qevent_types.QResizeEvent(h: event, owned: false)
  vtbl[].resizeEvent(self, slotval1)

proc fcQWidget_vtable_callback_closeEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QWidgetVTable](fcQWidget_vdata(self)[])
  let self = QWidget(h: self)
  let slotval1 = gen_qevent_types.QCloseEvent(h: event, owned: false)
  vtbl[].closeEvent(self, slotval1)

proc fcQWidget_vtable_callback_contextMenuEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QWidgetVTable](fcQWidget_vdata(self)[])
  let self = QWidget(h: self)
  let slotval1 = gen_qevent_types.QContextMenuEvent(h: event, owned: false)
  vtbl[].contextMenuEvent(self, slotval1)

proc fcQWidget_vtable_callback_tabletEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QWidgetVTable](fcQWidget_vdata(self)[])
  let self = QWidget(h: self)
  let slotval1 = gen_qevent_types.QTabletEvent(h: event, owned: false)
  vtbl[].tabletEvent(self, slotval1)

proc fcQWidget_vtable_callback_actionEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QWidgetVTable](fcQWidget_vdata(self)[])
  let self = QWidget(h: self)
  let slotval1 = gen_qevent_types.QActionEvent(h: event, owned: false)
  vtbl[].actionEvent(self, slotval1)

proc fcQWidget_vtable_callback_dragEnterEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QWidgetVTable](fcQWidget_vdata(self)[])
  let self = QWidget(h: self)
  let slotval1 = gen_qevent_types.QDragEnterEvent(h: event, owned: false)
  vtbl[].dragEnterEvent(self, slotval1)

proc fcQWidget_vtable_callback_dragMoveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QWidgetVTable](fcQWidget_vdata(self)[])
  let self = QWidget(h: self)
  let slotval1 = gen_qevent_types.QDragMoveEvent(h: event, owned: false)
  vtbl[].dragMoveEvent(self, slotval1)

proc fcQWidget_vtable_callback_dragLeaveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QWidgetVTable](fcQWidget_vdata(self)[])
  let self = QWidget(h: self)
  let slotval1 = gen_qevent_types.QDragLeaveEvent(h: event, owned: false)
  vtbl[].dragLeaveEvent(self, slotval1)

proc fcQWidget_vtable_callback_dropEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QWidgetVTable](fcQWidget_vdata(self)[])
  let self = QWidget(h: self)
  let slotval1 = gen_qevent_types.QDropEvent(h: event, owned: false)
  vtbl[].dropEvent(self, slotval1)

proc fcQWidget_vtable_callback_showEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QWidgetVTable](fcQWidget_vdata(self)[])
  let self = QWidget(h: self)
  let slotval1 = gen_qevent_types.QShowEvent(h: event, owned: false)
  vtbl[].showEvent(self, slotval1)

proc fcQWidget_vtable_callback_hideEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QWidgetVTable](fcQWidget_vdata(self)[])
  let self = QWidget(h: self)
  let slotval1 = gen_qevent_types.QHideEvent(h: event, owned: false)
  vtbl[].hideEvent(self, slotval1)

proc fcQWidget_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let vtbl = cast[ptr QWidgetVTable](fcQWidget_vdata(self)[])
  let self = QWidget(h: self)
...
proc fcQWidget_vtable_callback_changeEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QWidgetVTable](fcQWidget_vdata(self)[])
  let self = QWidget(h: self)
  let slotval1 = gen_qcoreevent_types.QEvent(h: param1, owned: false)
  vtbl[].changeEvent(self, slotval1)

proc fcQWidget_vtable_callback_metric(self: pointer, param1: cint): cint {.cdecl.} =
  let vtbl = cast[ptr QWidgetVTable](fcQWidget_vdata(self)[])
  let self = QWidget(h: self)
  let slotval1 = cint(param1)
...
proc fcQWidget_vtable_callback_initPainter(self: pointer, painter: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QWidgetVTable](fcQWidget_vdata(self)[])
  let self = QWidget(h: self)
  let slotval1 = gen_qpainter_types.QPainter(h: painter, owned: false)
  vtbl[].initPainter(self, slotval1)

proc fcQWidget_vtable_callback_redirected(self: pointer, offset: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QWidgetVTable](fcQWidget_vdata(self)[])
  let self = QWidget(h: self)
...
proc fcQWidget_vtable_callback_sharedPainter(self: pointer): pointer {.cdecl.} =
  let vtbl = cast[ptr QWidgetVTable](fcQWidget_vdata(self)[])
  let self = QWidget(h: self)
...
proc fcQWidget_vtable_callback_inputMethodEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QWidgetVTable](fcQWidget_vdata(self)[])
  let self = QWidget(h: self)
  let slotval1 = gen_qevent_types.QInputMethodEvent(h: param1, owned: false)
  vtbl[].inputMethodEvent(self, slotval1)

proc fcQWidget_vtable_callback_inputMethodQuery(self: pointer, param1: cint): pointer {.cdecl.} =
  let vtbl = cast[ptr QWidgetVTable](fcQWidget_vdata(self)[])
  let self = QWidget(h: self)
  let slotval1 = cint(param1)
...
proc fcQWidget_vtable_callback_focusNextPrevChild(self: pointer, next: bool): bool {.cdecl.} =
  let vtbl = cast[ptr QWidgetVTable](fcQWidget_vdata(self)[])
  let self = QWidget(h: self)
  let slotval1 = next
...
proc fcQWidget_vtable_callback_eventFilter(self: pointer, watched: pointer, event: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QWidgetVTable](fcQWidget_vdata(self)[])
  let self = QWidget(h: self)
...
proc fcQWidget_vtable_callback_timerEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QWidgetVTable](fcQWidget_vdata(self)[])
  let self = QWidget(h: self)
  let slotval1 = gen_qcoreevent_types.QTimerEvent(h: event, owned: false)
  vtbl[].timerEvent(self, slotval1)

proc fcQWidget_vtable_callback_childEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QWidgetVTable](fcQWidget_vdata(self)[])
  let self = QWidget(h: self)
  let slotval1 = gen_qcoreevent_types.QChildEvent(h: event, owned: false)
  vtbl[].childEvent(self, slotval1)

proc fcQWidget_vtable_callback_customEvent(self: pointer, event: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QWidgetVTable](fcQWidget_vdata(self)[])
  let self = QWidget(h: self)
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
  vtbl[].customEvent(self, slotval1)

proc fcQWidget_vtable_callback_connectNotify(self: pointer, signal: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QWidgetVTable](fcQWidget_vdata(self)[])
  let self = QWidget(h: self)
  let slotval1 = gen_qmetaobject_types.QMetaMethod(h: signal, owned: false)
  vtbl[].connectNotify(self, slotval1)

proc fcQWidget_vtable_callback_disconnectNotify(self: pointer, signal: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QWidgetVTable](fcQWidget_vdata(self)[])
  let self = QWidget(h: self)
  let slotval1 = gen_qmetaobject_types.QMetaMethod(h: signal, owned: false)
...
method nativeEvent*(self: VirtualQWidget, eventType: openArray[byte], message: pointer, resultVal: ptr clong): bool {.base.} =
...
proc fcQWidget_method_callback_metaObject(self: pointer): pointer {.cdecl.} =
...
proc fcQWidget_method_callback_metacast(self: pointer, param1: cstring): pointer {.cdecl.} =
  let inst = cast[VirtualQWidget](fcQWidget_vdata(self)[])
  let slotval1 = (param1)
  var virtualReturn = inst.metacast(slotval1)
  virtualReturn

proc fcQWidget_method_callback_metacall(self: pointer, param1: cint, param2: cint, param3: pointer): cint {.cdecl.} =
  let inst = cast[VirtualQWidget](fcQWidget_vdata(self)[])
  let slotval1 = cint(param1)
  let slotval2 = param2
  let slotval3 = param3
...
proc fcQWidget_method_callback_devType(self: pointer): cint {.cdecl.} =
  let inst = cast[VirtualQWidget](fcQWidget_vdata(self)[])
  var virtualReturn = inst.devType()
  virtualReturn

proc fcQWidget_method_callback_setVisible(self: pointer, visible: bool): void {.cdecl.} =
  let inst = cast[VirtualQWidget](fcQWidget_vdata(self)[])
  let slotval1 = visible
  inst.setVisible(slotval1)

proc fcQWidget_method_callback_sizeHint(self: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQWidget](fcQWidget_vdata(self)[])
...
proc fcQWidget_method_callback_minimumSizeHint(self: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQWidget](fcQWidget_vdata(self)[])
...
proc fcQWidget_method_callback_heightForWidth(self: pointer, param1: cint): cint {.cdecl.} =
  let inst = cast[VirtualQWidget](fcQWidget_vdata(self)[])
  let slotval1 = param1
  var virtualReturn = inst.heightForWidth(slotval1)
  virtualReturn

proc fcQWidget_method_callback_hasHeightForWidth(self: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQWidget](fcQWidget_vdata(self)[])
  var virtualReturn = inst.hasHeightForWidth()
  virtualReturn

proc fcQWidget_method_callback_paintEngine(self: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQWidget](fcQWidget_vdata(self)[])
...
proc fcQWidget_method_callback_event(self: pointer, event: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQWidget](fcQWidget_vdata(self)[])
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
  var virtualReturn = inst.event(slotval1)
  virtualReturn

proc fcQWidget_method_callback_mousePressEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQWidget](fcQWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
  inst.mousePressEvent(slotval1)

proc fcQWidget_method_callback_mouseReleaseEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQWidget](fcQWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
  inst.mouseReleaseEvent(slotval1)

proc fcQWidget_method_callback_mouseDoubleClickEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQWidget](fcQWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
  inst.mouseDoubleClickEvent(slotval1)

proc fcQWidget_method_callback_mouseMoveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQWidget](fcQWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QMouseEvent(h: event, owned: false)
  inst.mouseMoveEvent(slotval1)

proc fcQWidget_method_callback_wheelEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQWidget](fcQWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QWheelEvent(h: event, owned: false)
  inst.wheelEvent(slotval1)

proc fcQWidget_method_callback_keyPressEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQWidget](fcQWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QKeyEvent(h: event, owned: false)
  inst.keyPressEvent(slotval1)

proc fcQWidget_method_callback_keyReleaseEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQWidget](fcQWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QKeyEvent(h: event, owned: false)
  inst.keyReleaseEvent(slotval1)

proc fcQWidget_method_callback_focusInEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQWidget](fcQWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QFocusEvent(h: event, owned: false)
  inst.focusInEvent(slotval1)

proc fcQWidget_method_callback_focusOutEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQWidget](fcQWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QFocusEvent(h: event, owned: false)
  inst.focusOutEvent(slotval1)

proc fcQWidget_method_callback_enterEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQWidget](fcQWidget_vdata(self)[])
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
  inst.enterEvent(slotval1)

proc fcQWidget_method_callback_leaveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQWidget](fcQWidget_vdata(self)[])
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
  inst.leaveEvent(slotval1)

proc fcQWidget_method_callback_paintEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQWidget](fcQWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QPaintEvent(h: event, owned: false)
  inst.paintEvent(slotval1)

proc fcQWidget_method_callback_moveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQWidget](fcQWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QMoveEvent(h: event, owned: false)
  inst.moveEvent(slotval1)

proc fcQWidget_method_callback_resizeEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQWidget](fcQWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QResizeEvent(h: event, owned: false)
  inst.resizeEvent(slotval1)

proc fcQWidget_method_callback_closeEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQWidget](fcQWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QCloseEvent(h: event, owned: false)
  inst.closeEvent(slotval1)

proc fcQWidget_method_callback_contextMenuEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQWidget](fcQWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QContextMenuEvent(h: event, owned: false)
  inst.contextMenuEvent(slotval1)

proc fcQWidget_method_callback_tabletEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQWidget](fcQWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QTabletEvent(h: event, owned: false)
  inst.tabletEvent(slotval1)

proc fcQWidget_method_callback_actionEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQWidget](fcQWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QActionEvent(h: event, owned: false)
  inst.actionEvent(slotval1)

proc fcQWidget_method_callback_dragEnterEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQWidget](fcQWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QDragEnterEvent(h: event, owned: false)
  inst.dragEnterEvent(slotval1)

proc fcQWidget_method_callback_dragMoveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQWidget](fcQWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QDragMoveEvent(h: event, owned: false)
  inst.dragMoveEvent(slotval1)

proc fcQWidget_method_callback_dragLeaveEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQWidget](fcQWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QDragLeaveEvent(h: event, owned: false)
  inst.dragLeaveEvent(slotval1)

proc fcQWidget_method_callback_dropEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQWidget](fcQWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QDropEvent(h: event, owned: false)
  inst.dropEvent(slotval1)

proc fcQWidget_method_callback_showEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQWidget](fcQWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QShowEvent(h: event, owned: false)
  inst.showEvent(slotval1)

proc fcQWidget_method_callback_hideEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQWidget](fcQWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QHideEvent(h: event, owned: false)
  inst.hideEvent(slotval1)

proc fcQWidget_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let inst = cast[VirtualQWidget](fcQWidget_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc fcQWidget_method_callback_changeEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let inst = cast[VirtualQWidget](fcQWidget_vdata(self)[])
  let slotval1 = gen_qcoreevent_types.QEvent(h: param1, owned: false)
  inst.changeEvent(slotval1)

proc fcQWidget_method_callback_metric(self: pointer, param1: cint): cint {.cdecl.} =
  let inst = cast[VirtualQWidget](fcQWidget_vdata(self)[])
  let slotval1 = cint(param1)
  var virtualReturn = inst.metric(slotval1)
  virtualReturn

proc fcQWidget_method_callback_initPainter(self: pointer, painter: pointer): void {.cdecl.} =
  let inst = cast[VirtualQWidget](fcQWidget_vdata(self)[])
  let slotval1 = gen_qpainter_types.QPainter(h: painter, owned: false)
  inst.initPainter(slotval1)

proc fcQWidget_method_callback_redirected(self: pointer, offset: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQWidget](fcQWidget_vdata(self)[])
  let slotval1 = gen_qpoint_types.QPoint(h: offset, owned: false)
...
proc fcQWidget_method_callback_sharedPainter(self: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQWidget](fcQWidget_vdata(self)[])
...
proc fcQWidget_method_callback_inputMethodEvent(self: pointer, param1: pointer): void {.cdecl.} =
  let inst = cast[VirtualQWidget](fcQWidget_vdata(self)[])
  let slotval1 = gen_qevent_types.QInputMethodEvent(h: param1, owned: false)
  inst.inputMethodEvent(slotval1)

proc fcQWidget_method_callback_inputMethodQuery(self: pointer, param1: cint): pointer {.cdecl.} =
  let inst = cast[VirtualQWidget](fcQWidget_vdata(self)[])
  let slotval1 = cint(param1)
...
proc fcQWidget_method_callback_focusNextPrevChild(self: pointer, next: bool): bool {.cdecl.} =
  let inst = cast[VirtualQWidget](fcQWidget_vdata(self)[])
  let slotval1 = next
  var virtualReturn = inst.focusNextPrevChild(slotval1)
  virtualReturn

proc fcQWidget_method_callback_eventFilter(self: pointer, watched: pointer, event: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQWidget](fcQWidget_vdata(self)[])
  let slotval1 = gen_qobject_types.QObject(h: watched, owned: false)
  let slotval2 = gen_qcoreevent_types.QEvent(h: event, owned: false)
...
proc fcQWidget_method_callback_timerEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQWidget](fcQWidget_vdata(self)[])
  let slotval1 = gen_qcoreevent_types.QTimerEvent(h: event, owned: false)
  inst.timerEvent(slotval1)

proc fcQWidget_method_callback_childEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQWidget](fcQWidget_vdata(self)[])
  let slotval1 = gen_qcoreevent_types.QChildEvent(h: event, owned: false)
  inst.childEvent(slotval1)

proc fcQWidget_method_callback_customEvent(self: pointer, event: pointer): void {.cdecl.} =
  let inst = cast[VirtualQWidget](fcQWidget_vdata(self)[])
  let slotval1 = gen_qcoreevent_types.QEvent(h: event, owned: false)
  inst.customEvent(slotval1)

proc fcQWidget_method_callback_connectNotify(self: pointer, signal: pointer): void {.cdecl.} =
  let inst = cast[VirtualQWidget](fcQWidget_vdata(self)[])
  let slotval1 = gen_qmetaobject_types.QMetaMethod(h: signal, owned: false)
  inst.connectNotify(slotval1)

proc fcQWidget_method_callback_disconnectNotify(self: pointer, signal: pointer): void {.cdecl.} =
  let inst = cast[VirtualQWidget](fcQWidget_vdata(self)[])
  let slotval1 = gen_qmetaobject_types.QMetaMethod(h: signal, owned: false)
...
proc create*(T: type gen_qwidget_types.QWidget,
  ...
  if not isNil(vtbl[].metaObject):
    vtbl[].vtbl.metaObject = fcQWidget_vtable_callback_metaObject
  if not isNil(vtbl[].metacast):
    vtbl[].vtbl.metacast = fcQWidget_vtable_callback_metacast
  if not isNil(vtbl[].metacall):
    vtbl[].vtbl.metacall = fcQWidget_vtable_callback_metacall
  if not isNil(vtbl[].devType):
    vtbl[].vtbl.devType = fcQWidget_vtable_callback_devType
  if not isNil(vtbl[].setVisible):
    vtbl[].vtbl.setVisible = fcQWidget_vtable_callback_setVisible
  if not isNil(vtbl[].sizeHint):
    vtbl[].vtbl.sizeHint = fcQWidget_vtable_callback_sizeHint
  if not isNil(vtbl[].minimumSizeHint):
    vtbl[].vtbl.minimumSizeHint = fcQWidget_vtable_callback_minimumSizeHint
  if not isNil(vtbl[].heightForWidth):
    vtbl[].vtbl.heightForWidth = fcQWidget_vtable_callback_heightForWidth
  if not isNil(vtbl[].hasHeightForWidth):
    vtbl[].vtbl.hasHeightForWidth = fcQWidget_vtable_callback_hasHeightForWidth
  if not isNil(vtbl[].paintEngine):
    vtbl[].vtbl.paintEngine = fcQWidget_vtable_callback_paintEngine
  if not isNil(vtbl[].event):
    vtbl[].vtbl.event = fcQWidget_vtable_callback_event
  if not isNil(vtbl[].mousePressEvent):
    vtbl[].vtbl.mousePressEvent = fcQWidget_vtable_callback_mousePressEvent
  if not isNil(vtbl[].mouseReleaseEvent):
    vtbl[].vtbl.mouseReleaseEvent = fcQWidget_vtable_callback_mouseReleaseEvent
  if not isNil(vtbl[].mouseDoubleClickEvent):
    vtbl[].vtbl.mouseDoubleClickEvent = fcQWidget_vtable_callback_mouseDoubleClickEvent
  if not isNil(vtbl[].mouseMoveEvent):
    vtbl[].vtbl.mouseMoveEvent = fcQWidget_vtable_callback_mouseMoveEvent
  if not isNil(vtbl[].wheelEvent):
    vtbl[].vtbl.wheelEvent = fcQWidget_vtable_callback_wheelEvent
  if not isNil(vtbl[].keyPressEvent):
    vtbl[].vtbl.keyPressEvent = fcQWidget_vtable_callback_keyPressEvent
  if not isNil(vtbl[].keyReleaseEvent):
    vtbl[].vtbl.keyReleaseEvent = fcQWidget_vtable_callback_keyReleaseEvent
  if not isNil(vtbl[].focusInEvent):
    vtbl[].vtbl.focusInEvent = fcQWidget_vtable_callback_focusInEvent
  if not isNil(vtbl[].focusOutEvent):
    vtbl[].vtbl.focusOutEvent = fcQWidget_vtable_callback_focusOutEvent
  if not isNil(vtbl[].enterEvent):
    vtbl[].vtbl.enterEvent = fcQWidget_vtable_callback_enterEvent
  if not isNil(vtbl[].leaveEvent):
    vtbl[].vtbl.leaveEvent = fcQWidget_vtable_callback_leaveEvent
  if not isNil(vtbl[].paintEvent):
    vtbl[].vtbl.paintEvent = fcQWidget_vtable_callback_paintEvent
  if not isNil(vtbl[].moveEvent):
    vtbl[].vtbl.moveEvent = fcQWidget_vtable_callback_moveEvent
  if not isNil(vtbl[].resizeEvent):
    vtbl[].vtbl.resizeEvent = fcQWidget_vtable_callback_resizeEvent
  if not isNil(vtbl[].closeEvent):
    vtbl[].vtbl.closeEvent = fcQWidget_vtable_callback_closeEvent
  if not isNil(vtbl[].contextMenuEvent):
    vtbl[].vtbl.contextMenuEvent = fcQWidget_vtable_callback_contextMenuEvent
  if not isNil(vtbl[].tabletEvent):
    vtbl[].vtbl.tabletEvent = fcQWidget_vtable_callback_tabletEvent
  if not isNil(vtbl[].actionEvent):
    vtbl[].vtbl.actionEvent = fcQWidget_vtable_callback_actionEvent
  if not isNil(vtbl[].dragEnterEvent):
    vtbl[].vtbl.dragEnterEvent = fcQWidget_vtable_callback_dragEnterEvent
  if not isNil(vtbl[].dragMoveEvent):
    vtbl[].vtbl.dragMoveEvent = fcQWidget_vtable_callback_dragMoveEvent
  if not isNil(vtbl[].dragLeaveEvent):
    vtbl[].vtbl.dragLeaveEvent = fcQWidget_vtable_callback_dragLeaveEvent
  if not isNil(vtbl[].dropEvent):
    vtbl[].vtbl.dropEvent = fcQWidget_vtable_callback_dropEvent
  if not isNil(vtbl[].showEvent):
    vtbl[].vtbl.showEvent = fcQWidget_vtable_callback_showEvent
  if not isNil(vtbl[].hideEvent):
    vtbl[].vtbl.hideEvent = fcQWidget_vtable_callback_hideEvent
  if not isNil(vtbl[].nativeEvent):
    vtbl[].vtbl.nativeEvent = fcQWidget_vtable_callback_nativeEvent
  if not isNil(vtbl[].changeEvent):
    vtbl[].vtbl.changeEvent = fcQWidget_vtable_callback_changeEvent
  if not isNil(vtbl[].metric):
    vtbl[].vtbl.metric = fcQWidget_vtable_callback_metric
  if not isNil(vtbl[].initPainter):
    vtbl[].vtbl.initPainter = fcQWidget_vtable_callback_initPainter
  if not isNil(vtbl[].redirected):
    vtbl[].vtbl.redirected = fcQWidget_vtable_callback_redirected
  if not isNil(vtbl[].sharedPainter):
    vtbl[].vtbl.sharedPainter = fcQWidget_vtable_callback_sharedPainter
  if not isNil(vtbl[].inputMethodEvent):
    vtbl[].vtbl.inputMethodEvent = fcQWidget_vtable_callback_inputMethodEvent
  if not isNil(vtbl[].inputMethodQuery):
    vtbl[].vtbl.inputMethodQuery = fcQWidget_vtable_callback_inputMethodQuery
  if not isNil(vtbl[].focusNextPrevChild):
    vtbl[].vtbl.focusNextPrevChild = fcQWidget_vtable_callback_focusNextPrevChild
  if not isNil(vtbl[].eventFilter):
    vtbl[].vtbl.eventFilter = fcQWidget_vtable_callback_eventFilter
  if not isNil(vtbl[].timerEvent):
    vtbl[].vtbl.timerEvent = fcQWidget_vtable_callback_timerEvent
  if not isNil(vtbl[].childEvent):
    vtbl[].vtbl.childEvent = fcQWidget_vtable_callback_childEvent
  if not isNil(vtbl[].customEvent):
    vtbl[].vtbl.customEvent = fcQWidget_vtable_callback_customEvent
  if not isNil(vtbl[].connectNotify):
    vtbl[].vtbl.connectNotify = fcQWidget_vtable_callback_connectNotify
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQWidget_vtable_callback_disconnectNotify
  let tmp = gen_qwidget_types.QWidget(h: fcQWidget_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQWidget_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qwidget_types.QWidget,
    vtbl: ref QWidgetVTable = nil): gen_qwidget_types.QWidget =
  let vtbl = if vtbl == nil: new QWidgetVTable else: vtbl
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQWidget_vtable_callback_disconnectNotify
  let tmp = gen_qwidget_types.QWidget(h: fcQWidget_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQWidget_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qwidget_types.QWidget,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQWidget_vtable_callback_disconnectNotify
  let tmp = gen_qwidget_types.QWidget(h: fcQWidget_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h, cint(f)), owned: true)
  fcQWidget_vdata(tmp.h)[] = addr(vtbl[])
  tmp
const cQWidget_mvtbl = cQWidgetVTable(
  ...
  metaObject: fcQWidget_method_callback_metaObject,
  metacast: fcQWidget_method_callback_metacast,
  metacall: fcQWidget_method_callback_metacall,
  devType: fcQWidget_method_callback_devType,
  setVisible: fcQWidget_method_callback_setVisible,
  sizeHint: fcQWidget_method_callback_sizeHint,
  minimumSizeHint: fcQWidget_method_callback_minimumSizeHint,
  heightForWidth: fcQWidget_method_callback_heightForWidth,
  hasHeightForWidth: fcQWidget_method_callback_hasHeightForWidth,
  paintEngine: fcQWidget_method_callback_paintEngine,
  event: fcQWidget_method_callback_event,
  mousePressEvent: fcQWidget_method_callback_mousePressEvent,
  mouseReleaseEvent: fcQWidget_method_callback_mouseReleaseEvent,
  mouseDoubleClickEvent: fcQWidget_method_callback_mouseDoubleClickEvent,
  mouseMoveEvent: fcQWidget_method_callback_mouseMoveEvent,
  wheelEvent: fcQWidget_method_callback_wheelEvent,
  keyPressEvent: fcQWidget_method_callback_keyPressEvent,
  keyReleaseEvent: fcQWidget_method_callback_keyReleaseEvent,
  focusInEvent: fcQWidget_method_callback_focusInEvent,
  focusOutEvent: fcQWidget_method_callback_focusOutEvent,
  enterEvent: fcQWidget_method_callback_enterEvent,
  leaveEvent: fcQWidget_method_callback_leaveEvent,
  paintEvent: fcQWidget_method_callback_paintEvent,
  moveEvent: fcQWidget_method_callback_moveEvent,
  resizeEvent: fcQWidget_method_callback_resizeEvent,
  closeEvent: fcQWidget_method_callback_closeEvent,
  contextMenuEvent: fcQWidget_method_callback_contextMenuEvent,
  tabletEvent: fcQWidget_method_callback_tabletEvent,
  actionEvent: fcQWidget_method_callback_actionEvent,
  dragEnterEvent: fcQWidget_method_callback_dragEnterEvent,
  dragMoveEvent: fcQWidget_method_callback_dragMoveEvent,
  dragLeaveEvent: fcQWidget_method_callback_dragLeaveEvent,
  dropEvent: fcQWidget_method_callback_dropEvent,
  showEvent: fcQWidget_method_callback_showEvent,
  hideEvent: fcQWidget_method_callback_hideEvent,
  nativeEvent: fcQWidget_method_callback_nativeEvent,
  changeEvent: fcQWidget_method_callback_changeEvent,
  metric: fcQWidget_method_callback_metric,
  initPainter: fcQWidget_method_callback_initPainter,
  redirected: fcQWidget_method_callback_redirected,
  sharedPainter: fcQWidget_method_callback_sharedPainter,
  inputMethodEvent: fcQWidget_method_callback_inputMethodEvent,
  inputMethodQuery: fcQWidget_method_callback_inputMethodQuery,
  focusNextPrevChild: fcQWidget_method_callback_focusNextPrevChild,
  eventFilter: fcQWidget_method_callback_eventFilter,
  timerEvent: fcQWidget_method_callback_timerEvent,
  childEvent: fcQWidget_method_callback_childEvent,
  customEvent: fcQWidget_method_callback_customEvent,
  connectNotify: fcQWidget_method_callback_connectNotify,
  disconnectNotify: fcQWidget_method_callback_disconnectNotify,
)
proc create*(T: type gen_qwidget_types.QWidget,
    parent: gen_qwidget_types.QWidget,
    inst: VirtualQWidget) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQWidget_new(addr(cQWidget_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQWidget_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true

proc create*(T: type gen_qwidget_types.QWidget,
    inst: VirtualQWidget) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQWidget_new2(addr(cQWidget_mvtbl), csize_t(sizeof(pointer)))
  fcQWidget_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qwidget_types.QWidget,
    ...
    inst: VirtualQWidget) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQWidget_new3(addr(cQWidget_mvtbl), csize_t(sizeof(pointer)), parent.h, cint(f))
  fcQWidget_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
