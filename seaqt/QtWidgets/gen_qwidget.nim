...
proc fcQWidget_accessibleIdentifier(self: pointer): struct_seaqt_string {.importc: "QWidget_accessibleIdentifier".}
proc fcQWidget_setAccessibleIdentifier(self: pointer, identifier: struct_seaqt_string): void {.importc: "QWidget_setAccessibleIdentifier".}
...
proc fcQWidget_setTabOrder_QWidget_QWidget(param1: pointer, param2: pointer): void {.importc: "QWidget_setTabOrder_QWidget_QWidget".}
...
proc fcQWidget_childAtIntInt(self: pointer, x: cint, y: cint): pointer {.importc: "QWidget_childAt_int_int".}
proc fcQWidget_childAt_QPoint(self: pointer, p: pointer): pointer {.importc: "QWidget_childAt_QPoint".}
proc fcQWidget_childAt_QPointF(self: pointer, p: pointer): pointer {.importc: "QWidget_childAt_QPointF".}
...
proc fcQWidget_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QWidget_protectedbase_getDecodedMetricF".}
...
proc accessibleIdentifier*(self: gen_qwidget_types.QWidget): string =
  let v_ms = fcQWidget_accessibleIdentifier(self.h)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret

proc setAccessibleIdentifier*(self: gen_qwidget_types.QWidget, identifier: openArray[char]): void =
  fcQWidget_setAccessibleIdentifier(self.h, struct_seaqt_string(data: if len(identifier) > 0: addr identifier[0] else: nil, len: csize_t(len(identifier))))
...
proc setTabOrder*(_: type gen_qwidget_types.QWidget, param1: gen_qwidget_types.QWidget, param2: gen_qwidget_types.QWidget): void =
  fcQWidget_setTabOrder_QWidget_QWidget(param1.h, param2.h)
...
proc childAt*(self: gen_qwidget_types.QWidget, x: cint, y: cint): gen_qwidget_types.QWidget =
  gen_qwidget_types.QWidget(h: fcQWidget_childAtIntInt(self.h, x, y), owned: false)

proc childAt*(self: gen_qwidget_types.QWidget, p: gen_qpoint_types.QPoint): gen_qwidget_types.QWidget =
  gen_qwidget_types.QWidget(h: fcQWidget_childAt_QPoint(self.h, p.h), owned: false)

proc childAt*(self: gen_qwidget_types.QWidget, p: gen_qpoint_types.QPointF): gen_qwidget_types.QWidget =
  gen_qwidget_types.QWidget(h: fcQWidget_childAt_QPointF(self.h, p.h), owned: false)
...
proc getDecodedMetricF*(self: gen_qwidget_types.QWidget, metricA: cint, metricB: cint): float64 =
  fcQWidget_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
...
proc create*(T: type gen_qwidget_types.QWidget,
  ...
  let tmp = gen_qwidget_types.QWidget(h: fcQWidget_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
...
proc create*(T: type gen_qwidget_types.QWidget,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQWidget_vtable_callback_disconnectNotify
  let tmp = gen_qwidget_types.QWidget(h: fcQWidget_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQWidget_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qwidget_types.QWidget,
...
proc create*(T: type gen_qwidget_types.QWidget,
  ...
  inst[].h = fcQWidget_new(addr(cQWidget_mvtbl), csize_t(sizeof(pointer)))
...
proc create*(T: type gen_qwidget_types.QWidget,
    ...
    inst: VirtualQWidget) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQWidget_new2(addr(cQWidget_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQWidget_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
