...
proc fcQWidget_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.importc: "QWidget_virtualbase_nativeEvent".}
...
proc addAction*(self: gen_qwidget_types.QWidget, text: openArray[char]): gen_qaction_types.QAction =
  gen_qaction_types.QAction(h: fcQWidget_addActionWithText(self.h, struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text)))))

proc addAction*(self: gen_qwidget_types.QWidget, icon: gen_qicon_types.QIcon, text: openArray[char]): gen_qaction_types.QAction =
  gen_qaction_types.QAction(h: fcQWidget_addAction2(self.h, icon.h, struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text)))))
...
proc addAction*(self: gen_qwidget_types.QWidget, text: openArray[char], shortcut: gen_qkeysequence_types.QKeySequence): gen_qaction_types.QAction =
  gen_qaction_types.QAction(h: fcQWidget_addAction3(self.h, struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), shortcut.h))
...
proc addAction*(self: gen_qwidget_types.QWidget, icon: gen_qicon_types.QIcon, text: openArray[char], shortcut: gen_qkeysequence_types.QKeySequence): gen_qaction_types.QAction =
  gen_qaction_types.QAction(h: fcQWidget_addAction4(self.h, icon.h, struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), shortcut.h))
...
proc fcQWidget_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QWidgetVTable](fcQWidget_vdata(self)[])
  let self = QWidget(h: self)
...
proc fcQWidget_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let inst = cast[VirtualQWidget](fcQWidget_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
