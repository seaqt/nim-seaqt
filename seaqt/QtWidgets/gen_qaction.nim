...
proc fcQAction_associatedWidgets(self: pointer): struct_seaqt_array {.importc: "QAction_associatedWidgets".}
proc fcQAction_associatedGraphicsWidgets(self: pointer): struct_seaqt_array {.importc: "QAction_associatedGraphicsWidgets".}
