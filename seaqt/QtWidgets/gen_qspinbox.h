...
typedef struct QSpinBox_VTable{
	...
	bool (*nativeEvent)(VirtualQSpinBox* self, struct miqt_string eventType, void* message, long* result);
...
typedef struct QDoubleSpinBox_VTable{
	...
	bool (*nativeEvent)(VirtualQDoubleSpinBox* self, struct miqt_string eventType, void* message, long* result);
