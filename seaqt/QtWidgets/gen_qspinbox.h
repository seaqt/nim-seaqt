...
typedef struct QSpinBox_VTable{
	...
	int (*validate)(const VirtualQSpinBox* self, struct miqt_string input, int* pos);
	int (*valueFromText)(const VirtualQSpinBox* self, struct miqt_string text);
	struct miqt_string (*textFromValue)(const VirtualQSpinBox* self, int val);
	void (*fixup)(const VirtualQSpinBox* self, struct miqt_string str);
	...
	bool (*nativeEvent)(VirtualQSpinBox* self, struct miqt_string eventType, void* message, intptr_t* result);
...
const QSpinBox_VTable* QSpinBox_vtbl(const VirtualQSpinBox* self);
void* QSpinBox_vdata(const VirtualQSpinBox* self);
void QSpinBox_setVdata(VirtualQSpinBox* self, void* vdata);
...
typedef struct QDoubleSpinBox_VTable{
	...
	int (*validate)(const VirtualQDoubleSpinBox* self, struct miqt_string input, int* pos);
	double (*valueFromText)(const VirtualQDoubleSpinBox* self, struct miqt_string text);
	struct miqt_string (*textFromValue)(const VirtualQDoubleSpinBox* self, double val);
	void (*fixup)(const VirtualQDoubleSpinBox* self, struct miqt_string str);
	...
	bool (*nativeEvent)(VirtualQDoubleSpinBox* self, struct miqt_string eventType, void* message, intptr_t* result);
...
const QDoubleSpinBox_VTable* QDoubleSpinBox_vtbl(const VirtualQDoubleSpinBox* self);
void* QDoubleSpinBox_vdata(const VirtualQDoubleSpinBox* self);
void QDoubleSpinBox_setVdata(VirtualQDoubleSpinBox* self, void* vdata);
