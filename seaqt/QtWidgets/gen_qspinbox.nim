...
proc fcQSpinBox_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.importc: "QSpinBox_virtualbase_nativeEvent".}
...
proc fcQSpinBox_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QSpinBox_protectedbase_getDecodedMetricF".}
...
proc fcQDoubleSpinBox_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.importc: "QDoubleSpinBox_virtualbase_nativeEvent".}
...
proc fcQDoubleSpinBox_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QDoubleSpinBox_protectedbase_getDecodedMetricF".}
...
proc fcQSpinBox_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QSpinBoxVTable](fcQSpinBox_vdata(self)[])
  let self = QSpinBox(h: self)
...
proc fcQSpinBox_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let inst = cast[VirtualQSpinBox](fcQSpinBox_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc getDecodedMetricF*(self: gen_qspinbox_types.QSpinBox, metricA: cint, metricB: cint): float64 =
  fcQSpinBox_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
...
proc create*(T: type gen_qspinbox_types.QSpinBox,
  ...
  if not isNil(vtbl[].initStyleOption):
    vtbl[].vtbl.initStyleOption = fcQSpinBox_vtable_callback_initStyleOption
...
const cQSpinBox_mvtbl = cQSpinBoxVTable(
  ...
  initStyleOption: fcQSpinBox_method_callback_initStyleOption,
...
proc fcQDoubleSpinBox_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QDoubleSpinBoxVTable](fcQDoubleSpinBox_vdata(self)[])
  let self = QDoubleSpinBox(h: self)
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
...
proc fcQDoubleSpinBox_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let inst = cast[VirtualQDoubleSpinBox](fcQDoubleSpinBox_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc getDecodedMetricF*(self: gen_qspinbox_types.QDoubleSpinBox, metricA: cint, metricB: cint): float64 =
  fcQDoubleSpinBox_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
...
proc create*(T: type gen_qspinbox_types.QDoubleSpinBox,
  ...
  if not isNil(vtbl[].initStyleOption):
    vtbl[].vtbl.initStyleOption = fcQDoubleSpinBox_vtable_callback_initStyleOption
  if not isNil(vtbl[].stepEnabled):
...
const cQDoubleSpinBox_mvtbl = cQDoubleSpinBoxVTable(
  ...
  initStyleOption: fcQDoubleSpinBox_method_callback_initStyleOption,
