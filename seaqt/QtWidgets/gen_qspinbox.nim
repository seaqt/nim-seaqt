...
proc fcQSpinBox_trUtf8S(s: cstring): struct_seaqt_string {.importc: "QSpinBox_trUtf8_s".}
...
proc fcQSpinBox_suffix(self: pointer): struct_seaqt_string {.importc: "QSpinBox_suffix".}
proc fcQSpinBox_setSuffix(self: pointer, suffix: struct_seaqt_string): void {.importc: "QSpinBox_setSuffix".}
proc fcQSpinBox_cleanText(self: pointer): struct_seaqt_string {.importc: "QSpinBox_cleanText".}
...
proc fcQSpinBox_valueChangedInt(self: pointer, param1: cint): void {.importc: "QSpinBox_valueChanged_int".}
proc fcQSpinBox_connect_valueChangedInt(self: pointer, slot: int, callback: proc (slot: int, param1: cint) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QSpinBox_connect_valueChanged_int".}
...
proc fcQSpinBox_valueChanged_QString(self: pointer, param1: struct_seaqt_string): void {.importc: "QSpinBox_valueChanged_QString".}
proc fcQSpinBox_connect_valueChanged_QString(self: pointer, slot: int, callback: proc (slot: int, param1: struct_seaqt_string) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QSpinBox_connect_valueChanged_QString".}
...
proc fcQSpinBox_trUtf8SC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QSpinBox_trUtf8_s_c".}
proc fcQSpinBox_trUtf8SCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QSpinBox_trUtf8_s_c_n".}
...
type cQSpinBoxVTable {.pure.} = object
  ...
  valueFromText*: proc(self: pointer, text: struct_seaqt_string): cint {.cdecl, raises: [], gcsafe.}
  textFromValue*: proc(self: pointer, val: cint): struct_seaqt_string {.cdecl, raises: [], gcsafe.}
  fixup*: proc(self: pointer, str: struct_seaqt_string): void {.cdecl, raises: [], gcsafe.}
...
proc fcQSpinBox_virtualbase_validate(self: pointer, input: struct_seaqt_string, pos: ptr cint): cint {.importc: "QSpinBox_virtualbase_validate".}
proc fcQSpinBox_virtualbase_valueFromText(self: pointer, text: struct_seaqt_string): cint {.importc: "QSpinBox_virtualbase_valueFromText".}
proc fcQSpinBox_virtualbase_textFromValue(self: pointer, val: cint): struct_seaqt_string {.importc: "QSpinBox_virtualbase_textFromValue".}
proc fcQSpinBox_virtualbase_fixup(self: pointer, str: struct_seaqt_string): void {.importc: "QSpinBox_virtualbase_fixup".}
...
proc fcQSpinBox_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.importc: "QSpinBox_virtualbase_nativeEvent".}
...
proc fcQSpinBox_new(vtbl: pointer, vdata: csize_t): ptr cQSpinBox {.importc: "QSpinBox_new".}
proc fcQSpinBox_new2(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQSpinBox {.importc: "QSpinBox_new_parent".}
...
proc fcQDoubleSpinBox_trUtf8S(s: cstring): struct_seaqt_string {.importc: "QDoubleSpinBox_trUtf8_s".}
...
proc fcQDoubleSpinBox_suffix(self: pointer): struct_seaqt_string {.importc: "QDoubleSpinBox_suffix".}
proc fcQDoubleSpinBox_setSuffix(self: pointer, suffix: struct_seaqt_string): void {.importc: "QDoubleSpinBox_setSuffix".}
proc fcQDoubleSpinBox_cleanText(self: pointer): struct_seaqt_string {.importc: "QDoubleSpinBox_cleanText".}
...
proc fcQDoubleSpinBox_validate(self: pointer, input: struct_seaqt_string, pos: ptr cint): cint {.importc: "QDoubleSpinBox_validate".}
proc fcQDoubleSpinBox_valueFromText(self: pointer, text: struct_seaqt_string): float64 {.importc: "QDoubleSpinBox_valueFromText".}
proc fcQDoubleSpinBox_textFromValue(self: pointer, val: float64): struct_seaqt_string {.importc: "QDoubleSpinBox_textFromValue".}
proc fcQDoubleSpinBox_fixup(self: pointer, str: struct_seaqt_string): void {.importc: "QDoubleSpinBox_fixup".}
proc fcQDoubleSpinBox_setValue(self: pointer, val: float64): void {.importc: "QDoubleSpinBox_setValue".}
proc fcQDoubleSpinBox_valueChangedDouble(self: pointer, param1: float64): void {.importc: "QDoubleSpinBox_valueChanged_double".}
proc fcQDoubleSpinBox_connect_valueChangedDouble(self: pointer, slot: int, callback: proc (slot: int, param1: float64) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QDoubleSpinBox_connect_valueChanged_double".}
...
proc fcQDoubleSpinBox_valueChanged_QString(self: pointer, param1: struct_seaqt_string): void {.importc: "QDoubleSpinBox_valueChanged_QString".}
proc fcQDoubleSpinBox_connect_valueChanged_QString(self: pointer, slot: int, callback: proc (slot: int, param1: struct_seaqt_string) {.cdecl.}, release: proc(slot: int) {.cdecl.}) {.importc: "QDoubleSpinBox_connect_valueChanged_QString".}
...
proc fcQDoubleSpinBox_trUtf8SC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QDoubleSpinBox_trUtf8_s_c".}
proc fcQDoubleSpinBox_trUtf8SCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QDoubleSpinBox_trUtf8_s_c_n".}
...
type cQDoubleSpinBoxVTable {.pure.} = object
  ...
  metacall*: proc(self: pointer, param1: cint, param2: cint, param3: pointer): cint {.cdecl, raises: [], gcsafe.}
  validate*: proc(self: pointer, input: struct_seaqt_string, pos: ptr cint): cint {.cdecl, raises: [], gcsafe.}
  valueFromText*: proc(self: pointer, text: struct_seaqt_string): float64 {.cdecl, raises: [], gcsafe.}
  textFromValue*: proc(self: pointer, val: float64): struct_seaqt_string {.cdecl, raises: [], gcsafe.}
  fixup*: proc(self: pointer, str: struct_seaqt_string): void {.cdecl, raises: [], gcsafe.}
  sizeHint*: proc(self: pointer): pointer {.cdecl, raises: [], gcsafe.}
  minimumSizeHint*: proc(self: pointer): pointer {.cdecl, raises: [], gcsafe.}
  event*: proc(self: pointer, event: pointer): bool {.cdecl, raises: [], gcsafe.}
...
proc fcQDoubleSpinBox_virtualbase_validate(self: pointer, input: struct_seaqt_string, pos: ptr cint): cint {.importc: "QDoubleSpinBox_virtualbase_validate".}
proc fcQDoubleSpinBox_virtualbase_valueFromText(self: pointer, text: struct_seaqt_string): float64 {.importc: "QDoubleSpinBox_virtualbase_valueFromText".}
proc fcQDoubleSpinBox_virtualbase_textFromValue(self: pointer, val: float64): struct_seaqt_string {.importc: "QDoubleSpinBox_virtualbase_textFromValue".}
proc fcQDoubleSpinBox_virtualbase_fixup(self: pointer, str: struct_seaqt_string): void {.importc: "QDoubleSpinBox_virtualbase_fixup".}
...
proc fcQDoubleSpinBox_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.importc: "QDoubleSpinBox_virtualbase_nativeEvent".}
...
proc fcQDoubleSpinBox_new(vtbl: pointer, vdata: csize_t): ptr cQDoubleSpinBox {.importc: "QDoubleSpinBox_new".}
proc fcQDoubleSpinBox_new2(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQDoubleSpinBox {.importc: "QDoubleSpinBox_new_parent".}
...
proc setPrefix*(self: gen_qspinbox_types.QSpinBox, prefix: openArray[char]): void =
  fcQSpinBox_setPrefix(self.h, struct_seaqt_string(data: if len(prefix) > 0: addr prefix[0] else: nil, len: csize_t(len(prefix))))
...
proc setSuffix*(self: gen_qspinbox_types.QSpinBox, suffix: openArray[char]): void =
  fcQSpinBox_setSuffix(self.h, struct_seaqt_string(data: if len(suffix) > 0: addr suffix[0] else: nil, len: csize_t(len(suffix))))
...
proc valueChanged*(self: gen_qspinbox_types.QSpinBox, param1: cint): void =
  fcQSpinBox_valueChangedInt(self.h, param1)

type QSpinBoxvalueChangedIntSlot* = proc(param1: cint)
proc fcQSpinBox_slot_callback_valueChangedInt(slot: int, param1: cint) {.cdecl.} =
  let nimfunc = cast[ptr QSpinBoxvalueChangedIntSlot](cast[pointer](slot))
  let slotval1 = param1

  nimfunc[](slotval1)

proc fcQSpinBox_slot_callback_valueChangedInt_release(slot: int) {.cdecl.} =
  let nimfunc = cast[ref QSpinBoxvalueChangedIntSlot](cast[pointer](slot))
  GC_unref(nimfunc)

proc onValueChanged*(self: gen_qspinbox_types.QSpinBox, slot: QSpinBoxvalueChangedIntSlot) =
  var tmp = new QSpinBoxvalueChangedIntSlot
  tmp[] = slot
  GC_ref(tmp)
  fcQSpinBox_connect_valueChangedInt(self.h, cast[int](addr tmp[]), fcQSpinBox_slot_callback_valueChangedInt, fcQSpinBox_slot_callback_valueChangedInt_release)

proc textChanged*(self: gen_qspinbox_types.QSpinBox, param1: openArray[char]): void =
  fcQSpinBox_textChanged(self.h, struct_seaqt_string(data: if len(param1) > 0: addr param1[0] else: nil, len: csize_t(len(param1))))

type QSpinBoxtextChangedSlot* = proc(param1: openArray[char])
proc fcQSpinBox_slot_callback_textChanged(slot: int, param1: struct_seaqt_string) {.cdecl.} =
...
proc valueChanged*(self: gen_qspinbox_types.QSpinBox, param1: openArray[char]): void =
  fcQSpinBox_valueChanged_QString(self.h, struct_seaqt_string(data: if len(param1) > 0: addr param1[0] else: nil, len: csize_t(len(param1))))

type QSpinBoxvalueChanged_QStringSlot* = proc(param1: openArray[char])
proc fcQSpinBox_slot_callback_valueChanged_QString(slot: int, param1: struct_seaqt_string) {.cdecl.} =
  let nimfunc = cast[ptr QSpinBoxvalueChanged_QStringSlot](cast[pointer](slot))
  let vparam1_ms = param1
  let vparam1x_ret = string.fromBytes(vparam1_ms)
  c_free(vparam1_ms.data)
  let slotval1 = vparam1x_ret
...
proc fcQSpinBox_slot_callback_valueChanged_QString_release(slot: int) {.cdecl.} =
  let nimfunc = cast[ref QSpinBoxvalueChanged_QStringSlot](cast[pointer](slot))
  GC_unref(nimfunc)

proc onValueChanged*(self: gen_qspinbox_types.QSpinBox, slot: QSpinBoxvalueChanged_QStringSlot) =
  var tmp = new QSpinBoxvalueChanged_QStringSlot
  tmp[] = slot
  GC_ref(tmp)
  fcQSpinBox_connect_valueChanged_QString(self.h, cast[int](addr tmp[]), fcQSpinBox_slot_callback_valueChanged_QString, fcQSpinBox_slot_callback_valueChanged_QString_release)
...
proc QSpinBoxvalidate*(self: gen_qspinbox_types.QSpinBox, input: openArray[char], pos: ptr cint): cint =
  cint(fcQSpinBox_virtualbase_validate(self.h, struct_seaqt_string(data: if len(input) > 0: addr input[0] else: nil, len: csize_t(len(input))), pos))

proc QSpinBoxvalueFromText*(self: gen_qspinbox_types.QSpinBox, text: openArray[char]): cint =
  fcQSpinBox_virtualbase_valueFromText(self.h, struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))))
...
proc QSpinBoxfixup*(self: gen_qspinbox_types.QSpinBox, str: openArray[char]): void =
  fcQSpinBox_virtualbase_fixup(self.h, struct_seaqt_string(data: if len(str) > 0: addr str[0] else: nil, len: csize_t(len(str))))
...
proc QSpinBoxnativeEvent*(self: gen_qspinbox_types.QSpinBox, eventType: openArray[byte], message: pointer, resultVal: ptr clong): bool =
  fcQSpinBox_virtualbase_nativeEvent(self.h, struct_seaqt_string(data: if len(eventType) > 0: addr eventType[0] else: nil, len: csize_t(len(eventType))), message, resultVal)
...
proc fcQSpinBox_vtable_callback_validate(self: pointer, input: struct_seaqt_string, pos: ptr cint): cint {.cdecl.} =
  let vtbl = cast[ptr QSpinBoxVTable](fcQSpinBox_vdata(self)[])
  let self = QSpinBox(h: self)
  let vinput_ms = input
...
proc fcQSpinBox_vtable_callback_valueFromText(self: pointer, text: struct_seaqt_string): cint {.cdecl.} =
  let vtbl = cast[ptr QSpinBoxVTable](fcQSpinBox_vdata(self)[])
  let self = QSpinBox(h: self)
  let vtext_ms = text
...
proc fcQSpinBox_vtable_callback_textFromValue(self: pointer, val: cint): struct_seaqt_string {.cdecl.} =
  let vtbl = cast[ptr QSpinBoxVTable](fcQSpinBox_vdata(self)[])
  let self = QSpinBox(h: self)
  let slotval1 = val
...
proc fcQSpinBox_vtable_callback_fixup(self: pointer, str: struct_seaqt_string): void {.cdecl.} =
  let vtbl = cast[ptr QSpinBoxVTable](fcQSpinBox_vdata(self)[])
  let self = QSpinBox(h: self)
  let vstr_ms = str
...
proc fcQSpinBox_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let vtbl = cast[ptr QSpinBoxVTable](fcQSpinBox_vdata(self)[])
  let self = QSpinBox(h: self)
...
proc fcQSpinBox_method_callback_validate(self: pointer, input: struct_seaqt_string, pos: ptr cint): cint {.cdecl.} =
  let inst = cast[VirtualQSpinBox](fcQSpinBox_vdata(self)[])
  let vinput_ms = input
  let vinputx_ret = string.fromBytes(vinput_ms)
  c_free(vinput_ms.data)
...
proc fcQSpinBox_method_callback_valueFromText(self: pointer, text: struct_seaqt_string): cint {.cdecl.} =
  let inst = cast[VirtualQSpinBox](fcQSpinBox_vdata(self)[])
  let vtext_ms = text
  let vtextx_ret = string.fromBytes(vtext_ms)
  c_free(vtext_ms.data)
...
proc fcQSpinBox_method_callback_textFromValue(self: pointer, val: cint): struct_seaqt_string {.cdecl.} =
  let inst = cast[VirtualQSpinBox](fcQSpinBox_vdata(self)[])
  let slotval1 = val
...
proc fcQSpinBox_method_callback_fixup(self: pointer, str: struct_seaqt_string): void {.cdecl.} =
  let inst = cast[VirtualQSpinBox](fcQSpinBox_vdata(self)[])
  let vstr_ms = str
  let vstrx_ret = string.fromBytes(vstr_ms)
  c_free(vstr_ms.data)
...
proc fcQSpinBox_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let inst = cast[VirtualQSpinBox](fcQSpinBox_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc create*(T: type gen_qspinbox_types.QSpinBox,
  ...
  let tmp = gen_qspinbox_types.QSpinBox(h: fcQSpinBox_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
...
proc create*(T: type gen_qspinbox_types.QSpinBox,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQSpinBox_vtable_callback_disconnectNotify
  let tmp = gen_qspinbox_types.QSpinBox(h: fcQSpinBox_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQSpinBox_vdata(tmp.h)[] = addr(vtbl[])
  tmp
...
proc create*(T: type gen_qspinbox_types.QSpinBox,
  ...
  inst[].h = fcQSpinBox_new(addr(cQSpinBox_mvtbl), csize_t(sizeof(pointer)))
...
proc create*(T: type gen_qspinbox_types.QSpinBox,
    ...
    inst: VirtualQSpinBox) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQSpinBox_new2(addr(cQSpinBox_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQSpinBox_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc trUtf8*(_: type gen_qspinbox_types.QDoubleSpinBox, s: cstring): string =
  let v_ms = fcQDoubleSpinBox_trUtf8S(s)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc setPrefix*(self: gen_qspinbox_types.QDoubleSpinBox, prefix: openArray[char]): void =
  fcQDoubleSpinBox_setPrefix(self.h, struct_seaqt_string(data: if len(prefix) > 0: addr prefix[0] else: nil, len: csize_t(len(prefix))))
...
proc setSuffix*(self: gen_qspinbox_types.QDoubleSpinBox, suffix: openArray[char]): void =
  fcQDoubleSpinBox_setSuffix(self.h, struct_seaqt_string(data: if len(suffix) > 0: addr suffix[0] else: nil, len: csize_t(len(suffix))))
...
proc validate*(self: gen_qspinbox_types.QDoubleSpinBox, input: openArray[char], pos: ptr cint): cint =
  cint(fcQDoubleSpinBox_validate(self.h, struct_seaqt_string(data: if len(input) > 0: addr input[0] else: nil, len: csize_t(len(input))), pos))

proc valueFromText*(self: gen_qspinbox_types.QDoubleSpinBox, text: openArray[char]): float64 =
  fcQDoubleSpinBox_valueFromText(self.h, struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))))
...
proc fixup*(self: gen_qspinbox_types.QDoubleSpinBox, str: openArray[char]): void =
  fcQDoubleSpinBox_fixup(self.h, struct_seaqt_string(data: if len(str) > 0: addr str[0] else: nil, len: csize_t(len(str))))
...
proc valueChanged*(self: gen_qspinbox_types.QDoubleSpinBox, param1: float64): void =
  fcQDoubleSpinBox_valueChangedDouble(self.h, param1)

type QDoubleSpinBoxvalueChangedDoubleSlot* = proc(param1: float64)
proc fcQDoubleSpinBox_slot_callback_valueChangedDouble(slot: int, param1: float64) {.cdecl.} =
  let nimfunc = cast[ptr QDoubleSpinBoxvalueChangedDoubleSlot](cast[pointer](slot))
  let slotval1 = param1

  nimfunc[](slotval1)

proc fcQDoubleSpinBox_slot_callback_valueChangedDouble_release(slot: int) {.cdecl.} =
  let nimfunc = cast[ref QDoubleSpinBoxvalueChangedDoubleSlot](cast[pointer](slot))
  GC_unref(nimfunc)

proc onValueChanged*(self: gen_qspinbox_types.QDoubleSpinBox, slot: QDoubleSpinBoxvalueChangedDoubleSlot) =
  var tmp = new QDoubleSpinBoxvalueChangedDoubleSlot
  tmp[] = slot
  GC_ref(tmp)
  fcQDoubleSpinBox_connect_valueChangedDouble(self.h, cast[int](addr tmp[]), fcQDoubleSpinBox_slot_callback_valueChangedDouble, fcQDoubleSpinBox_slot_callback_valueChangedDouble_release)

proc textChanged*(self: gen_qspinbox_types.QDoubleSpinBox, param1: openArray[char]): void =
  fcQDoubleSpinBox_textChanged(self.h, struct_seaqt_string(data: if len(param1) > 0: addr param1[0] else: nil, len: csize_t(len(param1))))

type QDoubleSpinBoxtextChangedSlot* = proc(param1: openArray[char])
proc fcQDoubleSpinBox_slot_callback_textChanged(slot: int, param1: struct_seaqt_string) {.cdecl.} =
...
proc valueChanged*(self: gen_qspinbox_types.QDoubleSpinBox, param1: openArray[char]): void =
  fcQDoubleSpinBox_valueChanged_QString(self.h, struct_seaqt_string(data: if len(param1) > 0: addr param1[0] else: nil, len: csize_t(len(param1))))

type QDoubleSpinBoxvalueChanged_QStringSlot* = proc(param1: openArray[char])
proc fcQDoubleSpinBox_slot_callback_valueChanged_QString(slot: int, param1: struct_seaqt_string) {.cdecl.} =
  let nimfunc = cast[ptr QDoubleSpinBoxvalueChanged_QStringSlot](cast[pointer](slot))
  let vparam1_ms = param1
  let vparam1x_ret = string.fromBytes(vparam1_ms)
  c_free(vparam1_ms.data)
  let slotval1 = vparam1x_ret
...
proc fcQDoubleSpinBox_slot_callback_valueChanged_QString_release(slot: int) {.cdecl.} =
  let nimfunc = cast[ref QDoubleSpinBoxvalueChanged_QStringSlot](cast[pointer](slot))
  GC_unref(nimfunc)

proc onValueChanged*(self: gen_qspinbox_types.QDoubleSpinBox, slot: QDoubleSpinBoxvalueChanged_QStringSlot) =
  var tmp = new QDoubleSpinBoxvalueChanged_QStringSlot
  tmp[] = slot
  GC_ref(tmp)
  fcQDoubleSpinBox_connect_valueChanged_QString(self.h, cast[int](addr tmp[]), fcQDoubleSpinBox_slot_callback_valueChanged_QString, fcQDoubleSpinBox_slot_callback_valueChanged_QString_release)
...
proc QDoubleSpinBoxvalidate*(self: gen_qspinbox_types.QDoubleSpinBox, input: openArray[char], pos: ptr cint): cint =
  cint(fcQDoubleSpinBox_virtualbase_validate(self.h, struct_seaqt_string(data: if len(input) > 0: addr input[0] else: nil, len: csize_t(len(input))), pos))

proc QDoubleSpinBoxvalueFromText*(self: gen_qspinbox_types.QDoubleSpinBox, text: openArray[char]): float64 =
  fcQDoubleSpinBox_virtualbase_valueFromText(self.h, struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))))
...
proc QDoubleSpinBoxfixup*(self: gen_qspinbox_types.QDoubleSpinBox, str: openArray[char]): void =
  fcQDoubleSpinBox_virtualbase_fixup(self.h, struct_seaqt_string(data: if len(str) > 0: addr str[0] else: nil, len: csize_t(len(str))))
...
proc QDoubleSpinBoxnativeEvent*(self: gen_qspinbox_types.QDoubleSpinBox, eventType: openArray[byte], message: pointer, resultVal: ptr clong): bool =
  fcQDoubleSpinBox_virtualbase_nativeEvent(self.h, struct_seaqt_string(data: if len(eventType) > 0: addr eventType[0] else: nil, len: csize_t(len(eventType))), message, resultVal)
...
proc fcQDoubleSpinBox_vtable_callback_validate(self: pointer, input: struct_seaqt_string, pos: ptr cint): cint {.cdecl.} =
  let vtbl = cast[ptr QDoubleSpinBoxVTable](fcQDoubleSpinBox_vdata(self)[])
  let self = QDoubleSpinBox(h: self)
  let vinput_ms = input
  let vinputx_ret = string.fromBytes(vinput_ms)
...
proc fcQDoubleSpinBox_vtable_callback_valueFromText(self: pointer, text: struct_seaqt_string): float64 {.cdecl.} =
  let vtbl = cast[ptr QDoubleSpinBoxVTable](fcQDoubleSpinBox_vdata(self)[])
  let self = QDoubleSpinBox(h: self)
  let vtext_ms = text
  let vtextx_ret = string.fromBytes(vtext_ms)
...
proc fcQDoubleSpinBox_vtable_callback_textFromValue(self: pointer, val: float64): struct_seaqt_string {.cdecl.} =
  let vtbl = cast[ptr QDoubleSpinBoxVTable](fcQDoubleSpinBox_vdata(self)[])
  let self = QDoubleSpinBox(h: self)
  let slotval1 = val
  var virtualReturn = vtbl[].textFromValue(self, slotval1)
...
proc fcQDoubleSpinBox_vtable_callback_fixup(self: pointer, str: struct_seaqt_string): void {.cdecl.} =
  let vtbl = cast[ptr QDoubleSpinBoxVTable](fcQDoubleSpinBox_vdata(self)[])
  let self = QDoubleSpinBox(h: self)
  let vstr_ms = str
  let vstrx_ret = string.fromBytes(vstr_ms)
...
proc fcQDoubleSpinBox_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let vtbl = cast[ptr QDoubleSpinBoxVTable](fcQDoubleSpinBox_vdata(self)[])
  let self = QDoubleSpinBox(h: self)
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
...
proc fcQDoubleSpinBox_method_callback_validate(self: pointer, input: struct_seaqt_string, pos: ptr cint): cint {.cdecl.} =
  let inst = cast[VirtualQDoubleSpinBox](fcQDoubleSpinBox_vdata(self)[])
  let vinput_ms = input
  let vinputx_ret = string.fromBytes(vinput_ms)
  c_free(vinput_ms.data)
...
proc fcQDoubleSpinBox_method_callback_valueFromText(self: pointer, text: struct_seaqt_string): float64 {.cdecl.} =
  let inst = cast[VirtualQDoubleSpinBox](fcQDoubleSpinBox_vdata(self)[])
  let vtext_ms = text
  let vtextx_ret = string.fromBytes(vtext_ms)
  c_free(vtext_ms.data)
...
proc fcQDoubleSpinBox_method_callback_textFromValue(self: pointer, val: float64): struct_seaqt_string {.cdecl.} =
  let inst = cast[VirtualQDoubleSpinBox](fcQDoubleSpinBox_vdata(self)[])
  let slotval1 = val
  var virtualReturn = inst.textFromValue(slotval1)
  var virtualReturn_copy = if len(virtualReturn) > 0: c_malloc(csize_t(len(virtualReturn))) else: nil
...
proc fcQDoubleSpinBox_method_callback_fixup(self: pointer, str: struct_seaqt_string): void {.cdecl.} =
  let inst = cast[VirtualQDoubleSpinBox](fcQDoubleSpinBox_vdata(self)[])
  let vstr_ms = str
  let vstrx_ret = string.fromBytes(vstr_ms)
  c_free(vstr_ms.data)
...
proc fcQDoubleSpinBox_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let inst = cast[VirtualQDoubleSpinBox](fcQDoubleSpinBox_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc create*(T: type gen_qspinbox_types.QDoubleSpinBox,
  ...
  let tmp = gen_qspinbox_types.QDoubleSpinBox(h: fcQDoubleSpinBox_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
...
proc create*(T: type gen_qspinbox_types.QDoubleSpinBox,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQDoubleSpinBox_vtable_callback_disconnectNotify
  let tmp = gen_qspinbox_types.QDoubleSpinBox(h: fcQDoubleSpinBox_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQDoubleSpinBox_vdata(tmp.h)[] = addr(vtbl[])
  tmp
...
proc create*(T: type gen_qspinbox_types.QDoubleSpinBox,
  ...
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQDoubleSpinBox_new(addr(cQDoubleSpinBox_mvtbl), csize_t(sizeof(pointer)))
...
proc create*(T: type gen_qspinbox_types.QDoubleSpinBox,
    ...
    inst: VirtualQDoubleSpinBox) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQDoubleSpinBox_new2(addr(cQDoubleSpinBox_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQDoubleSpinBox_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
