...
proc create*(T: type gen_qspinbox_types.QSpinBox,
  ...
  let tmp = gen_qspinbox_types.QSpinBox(h: fcQSpinBox_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))))
...
proc create*(T: type gen_qspinbox_types.QSpinBox,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQSpinBox_vtable_callback_disconnectNotify
  let tmp = gen_qspinbox_types.QSpinBox(h: fcQSpinBox_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h))
  fcQSpinBox_vdata(tmp.h)[] = addr(vtbl[])
  tmp
...
proc create*(T: type gen_qspinbox_types.QDoubleSpinBox,
  ...
  let tmp = gen_qspinbox_types.QDoubleSpinBox(h: fcQDoubleSpinBox_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))))
...
proc create*(T: type gen_qspinbox_types.QDoubleSpinBox,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQDoubleSpinBox_vtable_callback_disconnectNotify
  let tmp = gen_qspinbox_types.QDoubleSpinBox(h: fcQDoubleSpinBox_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h))
  fcQDoubleSpinBox_vdata(tmp.h)[] = addr(vtbl[])
  tmp
