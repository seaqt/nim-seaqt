...
proc create*(T: type gen_qradiobutton_types.QRadioButton,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQRadioButton_vtable_callback_disconnectNotify
  let tmp = gen_qradiobutton_types.QRadioButton(h: fcQRadioButton_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text)))), owned: true)
  fcQRadioButton_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qradiobutton_types.QRadioButton,
...
proc create*(T: type gen_qradiobutton_types.QRadioButton,
  ...
  inst[].h = fcQRadioButton_new(addr(cQRadioButton_mvtbl), csize_t(sizeof(pointer)), parent.h)
...
proc create*(T: type gen_qradiobutton_types.QRadioButton,
    inst: VirtualQRadioButton) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQRadioButton_new2(addr(cQRadioButton_mvtbl), csize_t(sizeof(pointer)))
  fcQRadioButton_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qradiobutton_types.QRadioButton,
    ...
    inst: VirtualQRadioButton) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQRadioButton_new3(addr(cQRadioButton_mvtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))))
  fcQRadioButton_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
