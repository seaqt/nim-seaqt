...
proc cQRadioButton_vtable_callback_initStyleOption(self: pointer, button: pointer): void {.cdecl.} =
  let vtbl = cast[ptr QRadioButtonVTable](fcQRadioButton_vdata(self))
  let self = QRadioButton(h: self)
...
proc cQRadioButton_vtable_callback_nativeEvent(self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QRadioButtonVTable](fcQRadioButton_vdata(self))
  let self = QRadioButton(h: self)
...
proc cQRadioButton_method_callback_initStyleOption(self: pointer, button: pointer): void {.cdecl.} =
  let inst = cast[VirtualQRadioButton](fcQRadioButton_vdata(self))
  let slotval1 = gen_qstyleoption_types.QStyleOptionButton(h: button, owned: false)
...
proc cQRadioButton_method_callback_nativeEvent(self: pointer, eventType: struct_miqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let inst = cast[VirtualQRadioButton](fcQRadioButton_vdata(self))
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc create*(T: type gen_qradiobutton_types.QRadioButton,
  ...
  if not isNil(vtbl[].initStyleOption):
    vtbl[].vtbl.initStyleOption = cQRadioButton_vtable_callback_initStyleOption
...
const cQRadioButton_mvtbl = cQRadioButtonVTable(
  ...
  initStyleOption: cQRadioButton_method_callback_initStyleOption,
