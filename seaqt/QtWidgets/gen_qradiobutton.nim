...
proc fcQRadioButton_new2(vtbl: pointer, vdata: csize_t, text: struct_seaqt_string): ptr cQRadioButton {.importc: "QRadioButton_new2".}
proc fcQRadioButton_new3(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQRadioButton {.importc: "QRadioButton_new3".}
