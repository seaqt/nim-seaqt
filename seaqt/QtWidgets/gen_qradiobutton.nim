...
proc fcQRadioButton_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.importc: "QRadioButton_virtualbase_nativeEvent".}
...
proc fcQRadioButton_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QRadioButton_protectedbase_getDecodedMetricF".}
proc fcQRadioButton_new(vtbl: pointer, vdata: csize_t): ptr cQRadioButton {.importc: "QRadioButton_new".}
proc fcQRadioButton_new2(vtbl: pointer, vdata: csize_t, text: struct_seaqt_string): ptr cQRadioButton {.importc: "QRadioButton_new_text".}
proc fcQRadioButton_new3(vtbl: pointer, vdata: csize_t, parent: pointer): ptr cQRadioButton {.importc: "QRadioButton_new_parent".}
...
proc QRadioButtonnativeEvent*(self: gen_qradiobutton_types.QRadioButton, eventType: openArray[byte], message: pointer, resultVal: ptr uint): bool =
  fcQRadioButton_virtualbase_nativeEvent(self.h, struct_seaqt_string(data: if len(eventType) > 0: addr eventType[0] else: nil, len: csize_t(len(eventType))), message, resultVal)
...
proc fcQRadioButton_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QRadioButtonVTable](fcQRadioButton_vdata(self)[])
  let self = QRadioButton(h: self)
...
proc fcQRadioButton_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let inst = cast[VirtualQRadioButton](fcQRadioButton_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc getDecodedMetricF*(self: gen_qradiobutton_types.QRadioButton, metricA: cint, metricB: cint): float64 =
  fcQRadioButton_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
...
proc create*(T: type gen_qradiobutton_types.QRadioButton,
  ...
  let tmp = gen_qradiobutton_types.QRadioButton(h: fcQRadioButton_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
...
proc create*(T: type gen_qradiobutton_types.QRadioButton,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQRadioButton_vtable_callback_disconnectNotify
  let tmp = gen_qradiobutton_types.QRadioButton(h: fcQRadioButton_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text)))), owned: true)
  fcQRadioButton_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qradiobutton_types.QRadioButton,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQRadioButton_vtable_callback_disconnectNotify
  let tmp = gen_qradiobutton_types.QRadioButton(h: fcQRadioButton_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQRadioButton_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qradiobutton_types.QRadioButton,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQRadioButton_vtable_callback_disconnectNotify
  let tmp = gen_qradiobutton_types.QRadioButton(h: fcQRadioButton_new4(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), parent.h), owned: true)
  fcQRadioButton_vdata(tmp.h)[] = addr(vtbl[])
  tmp
...
proc create*(T: type gen_qradiobutton_types.QRadioButton,
  ...
  inst[].h = fcQRadioButton_new(addr(cQRadioButton_mvtbl), csize_t(sizeof(pointer)))
  fcQRadioButton_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qradiobutton_types.QRadioButton,
    ...
    inst: VirtualQRadioButton) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQRadioButton_new2(addr(cQRadioButton_mvtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))))
  fcQRadioButton_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qradiobutton_types.QRadioButton,
    ...
    inst: VirtualQRadioButton) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQRadioButton_new3(addr(cQRadioButton_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQRadioButton_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qradiobutton_types.QRadioButton,
    ...
    inst: VirtualQRadioButton) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQRadioButton_new4(addr(cQRadioButton_mvtbl), csize_t(sizeof(pointer)), struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))), parent.h)
  fcQRadioButton_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
