...
proc fcQStatusBar_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.importc: "QStatusBar_virtualbase_nativeEvent".}
...
proc fcQStatusBar_protectedbase_getDecodedMetricF(self: pointer, metricA: cint, metricB: cint): float64 {.importc: "QStatusBar_protectedbase_getDecodedMetricF".}
...
proc fcQStatusBar_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let vtbl = cast[ptr QStatusBarVTable](fcQStatusBar_vdata(self)[])
  let self = QStatusBar(h: self)
...
proc fcQStatusBar_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr uint): bool {.cdecl.} =
  let inst = cast[VirtualQStatusBar](fcQStatusBar_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc getDecodedMetricF*(self: gen_qstatusbar_types.QStatusBar, metricA: cint, metricB: cint): float64 =
  fcQStatusBar_protectedbase_getDecodedMetricF(self.h, cint(metricA), cint(metricB))
