...
proc fcQStatusBar_trUtf8S(s: cstring): struct_seaqt_string {.importc: "QStatusBar_trUtf8_s".}
...
proc fcQStatusBar_trUtf8SC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QStatusBar_trUtf8_s_c".}
proc fcQStatusBar_trUtf8SCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QStatusBar_trUtf8_s_c_n".}
...
proc fcQStatusBar_virtualbase_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.importc: "QStatusBar_virtualbase_nativeEvent".}
...
proc trUtf8*(_: type gen_qstatusbar_types.QStatusBar, s: cstring): string =
  let v_ms = fcQStatusBar_trUtf8S(s)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc messageChanged*(self: gen_qstatusbar_types.QStatusBar, text: openArray[char]): void =
  fcQStatusBar_messageChanged(self.h, struct_seaqt_string(data: if len(text) > 0: addr text[0] else: nil, len: csize_t(len(text))))

type QStatusBarmessageChangedSlot* = proc(text: openArray[char])
proc fcQStatusBar_slot_callback_messageChanged(slot: int, text: struct_seaqt_string) {.cdecl.} =
...
proc fcQStatusBar_slot_callback_messageChanged_release(slot: int) {.cdecl.} =
...
proc QStatusBarnativeEvent*(self: gen_qstatusbar_types.QStatusBar, eventType: openArray[byte], message: pointer, resultVal: ptr clong): bool =
  fcQStatusBar_virtualbase_nativeEvent(self.h, struct_seaqt_string(data: if len(eventType) > 0: addr eventType[0] else: nil, len: csize_t(len(eventType))), message, resultVal)
...
proc fcQStatusBar_vtable_callback_metacast(self: pointer, param1: cstring): pointer {.cdecl.} =
  let vtbl = cast[ptr QStatusBarVTable](fcQStatusBar_vdata(self)[])
  let self = QStatusBar(h: self)
  let slotval1 = (param1)
...
proc fcQStatusBar_vtable_callback_metacall(self: pointer, param1: cint, param2: cint, param3: pointer): cint {.cdecl.} =
  let vtbl = cast[ptr QStatusBarVTable](fcQStatusBar_vdata(self)[])
  let self = QStatusBar(h: self)
...
proc fcQStatusBar_vtable_callback_devType(self: pointer): cint {.cdecl.} =
  let vtbl = cast[ptr QStatusBarVTable](fcQStatusBar_vdata(self)[])
  let self = QStatusBar(h: self)
  var virtualReturn = vtbl[].devType(self)
  virtualReturn

proc fcQStatusBar_vtable_callback_setVisible(self: pointer, visible: bool): void {.cdecl.} =
  let vtbl = cast[ptr QStatusBarVTable](fcQStatusBar_vdata(self)[])
  let self = QStatusBar(h: self)
...
proc fcQStatusBar_vtable_callback_heightForWidth(self: pointer, param1: cint): cint {.cdecl.} =
  let vtbl = cast[ptr QStatusBarVTable](fcQStatusBar_vdata(self)[])
  let self = QStatusBar(h: self)
  let slotval1 = param1
...
proc fcQStatusBar_vtable_callback_hasHeightForWidth(self: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QStatusBarVTable](fcQStatusBar_vdata(self)[])
  let self = QStatusBar(h: self)
...
proc fcQStatusBar_vtable_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let vtbl = cast[ptr QStatusBarVTable](fcQStatusBar_vdata(self)[])
  let self = QStatusBar(h: self)
...
proc fcQStatusBar_vtable_callback_metric(self: pointer, param1: cint): cint {.cdecl.} =
  let vtbl = cast[ptr QStatusBarVTable](fcQStatusBar_vdata(self)[])
  let self = QStatusBar(h: self)
  let slotval1 = cint(param1)
...
proc fcQStatusBar_vtable_callback_focusNextPrevChild(self: pointer, next: bool): bool {.cdecl.} =
  let vtbl = cast[ptr QStatusBarVTable](fcQStatusBar_vdata(self)[])
  let self = QStatusBar(h: self)
  let slotval1 = next
...
proc fcQStatusBar_method_callback_metaObject(self: pointer): pointer {.cdecl.} =
...
proc fcQStatusBar_method_callback_metacast(self: pointer, param1: cstring): pointer {.cdecl.} =
  let inst = cast[VirtualQStatusBar](fcQStatusBar_vdata(self)[])
  let slotval1 = (param1)
  var virtualReturn = inst.metacast(slotval1)
  virtualReturn

proc fcQStatusBar_method_callback_metacall(self: pointer, param1: cint, param2: cint, param3: pointer): cint {.cdecl.} =
  let inst = cast[VirtualQStatusBar](fcQStatusBar_vdata(self)[])
  let slotval1 = cint(param1)
  let slotval2 = param2
  let slotval3 = param3
...
proc fcQStatusBar_method_callback_devType(self: pointer): cint {.cdecl.} =
  let inst = cast[VirtualQStatusBar](fcQStatusBar_vdata(self)[])
  var virtualReturn = inst.devType()
  virtualReturn

proc fcQStatusBar_method_callback_setVisible(self: pointer, visible: bool): void {.cdecl.} =
  let inst = cast[VirtualQStatusBar](fcQStatusBar_vdata(self)[])
  let slotval1 = visible
  inst.setVisible(slotval1)

proc fcQStatusBar_method_callback_sizeHint(self: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQStatusBar](fcQStatusBar_vdata(self)[])
...
proc fcQStatusBar_method_callback_minimumSizeHint(self: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQStatusBar](fcQStatusBar_vdata(self)[])
...
proc fcQStatusBar_method_callback_heightForWidth(self: pointer, param1: cint): cint {.cdecl.} =
  let inst = cast[VirtualQStatusBar](fcQStatusBar_vdata(self)[])
  let slotval1 = param1
  var virtualReturn = inst.heightForWidth(slotval1)
  virtualReturn

proc fcQStatusBar_method_callback_hasHeightForWidth(self: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQStatusBar](fcQStatusBar_vdata(self)[])
  var virtualReturn = inst.hasHeightForWidth()
  virtualReturn

proc fcQStatusBar_method_callback_paintEngine(self: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQStatusBar](fcQStatusBar_vdata(self)[])
...
proc fcQStatusBar_method_callback_nativeEvent(self: pointer, eventType: struct_seaqt_string, message: pointer, resultVal: ptr clong): bool {.cdecl.} =
  let inst = cast[VirtualQStatusBar](fcQStatusBar_vdata(self)[])
  var veventType_bytearray = eventType
  var veventTypex_ret = @(toOpenArray(cast[ptr UncheckedArray[byte]](veventType_bytearray.data), 0, int(veventType_bytearray.len)-1))
  c_free(veventType_bytearray.data)
...
proc fcQStatusBar_method_callback_metric(self: pointer, param1: cint): cint {.cdecl.} =
  let inst = cast[VirtualQStatusBar](fcQStatusBar_vdata(self)[])
  let slotval1 = cint(param1)
...
proc fcQStatusBar_method_callback_sharedPainter(self: pointer): pointer {.cdecl.} =
  let inst = cast[VirtualQStatusBar](fcQStatusBar_vdata(self)[])
...
proc fcQStatusBar_method_callback_inputMethodQuery(self: pointer, param1: cint): pointer {.cdecl.} =
  let inst = cast[VirtualQStatusBar](fcQStatusBar_vdata(self)[])
  let slotval1 = cint(param1)
...
proc fcQStatusBar_method_callback_focusNextPrevChild(self: pointer, next: bool): bool {.cdecl.} =
  let inst = cast[VirtualQStatusBar](fcQStatusBar_vdata(self)[])
  let slotval1 = next
...
proc create*(T: type gen_qstatusbar_types.QStatusBar,
  ...
  if not isNil(vtbl[].metaObject):
    vtbl[].vtbl.metaObject = fcQStatusBar_vtable_callback_metaObject
  if not isNil(vtbl[].metacast):
    vtbl[].vtbl.metacast = fcQStatusBar_vtable_callback_metacast
  if not isNil(vtbl[].metacall):
    vtbl[].vtbl.metacall = fcQStatusBar_vtable_callback_metacall
  if not isNil(vtbl[].showEvent):
    vtbl[].vtbl.showEvent = fcQStatusBar_vtable_callback_showEvent
  if not isNil(vtbl[].paintEvent):
    vtbl[].vtbl.paintEvent = fcQStatusBar_vtable_callback_paintEvent
  if not isNil(vtbl[].resizeEvent):
    vtbl[].vtbl.resizeEvent = fcQStatusBar_vtable_callback_resizeEvent
  if not isNil(vtbl[].event):
    vtbl[].vtbl.event = fcQStatusBar_vtable_callback_event
  if not isNil(vtbl[].devType):
    vtbl[].vtbl.devType = fcQStatusBar_vtable_callback_devType
  if not isNil(vtbl[].setVisible):
    vtbl[].vtbl.setVisible = fcQStatusBar_vtable_callback_setVisible
  if not isNil(vtbl[].sizeHint):
    vtbl[].vtbl.sizeHint = fcQStatusBar_vtable_callback_sizeHint
  if not isNil(vtbl[].minimumSizeHint):
    vtbl[].vtbl.minimumSizeHint = fcQStatusBar_vtable_callback_minimumSizeHint
  if not isNil(vtbl[].heightForWidth):
    vtbl[].vtbl.heightForWidth = fcQStatusBar_vtable_callback_heightForWidth
  if not isNil(vtbl[].hasHeightForWidth):
    vtbl[].vtbl.hasHeightForWidth = fcQStatusBar_vtable_callback_hasHeightForWidth
  if not isNil(vtbl[].paintEngine):
    vtbl[].vtbl.paintEngine = fcQStatusBar_vtable_callback_paintEngine
  if not isNil(vtbl[].mousePressEvent):
    vtbl[].vtbl.mousePressEvent = fcQStatusBar_vtable_callback_mousePressEvent
  if not isNil(vtbl[].mouseReleaseEvent):
    vtbl[].vtbl.mouseReleaseEvent = fcQStatusBar_vtable_callback_mouseReleaseEvent
  if not isNil(vtbl[].mouseDoubleClickEvent):
    vtbl[].vtbl.mouseDoubleClickEvent = fcQStatusBar_vtable_callback_mouseDoubleClickEvent
  if not isNil(vtbl[].mouseMoveEvent):
    vtbl[].vtbl.mouseMoveEvent = fcQStatusBar_vtable_callback_mouseMoveEvent
  if not isNil(vtbl[].wheelEvent):
    vtbl[].vtbl.wheelEvent = fcQStatusBar_vtable_callback_wheelEvent
  if not isNil(vtbl[].keyPressEvent):
    vtbl[].vtbl.keyPressEvent = fcQStatusBar_vtable_callback_keyPressEvent
  if not isNil(vtbl[].keyReleaseEvent):
    vtbl[].vtbl.keyReleaseEvent = fcQStatusBar_vtable_callback_keyReleaseEvent
  if not isNil(vtbl[].focusInEvent):
    vtbl[].vtbl.focusInEvent = fcQStatusBar_vtable_callback_focusInEvent
  if not isNil(vtbl[].focusOutEvent):
    vtbl[].vtbl.focusOutEvent = fcQStatusBar_vtable_callback_focusOutEvent
  if not isNil(vtbl[].enterEvent):
    vtbl[].vtbl.enterEvent = fcQStatusBar_vtable_callback_enterEvent
  if not isNil(vtbl[].leaveEvent):
    vtbl[].vtbl.leaveEvent = fcQStatusBar_vtable_callback_leaveEvent
  if not isNil(vtbl[].moveEvent):
    vtbl[].vtbl.moveEvent = fcQStatusBar_vtable_callback_moveEvent
  if not isNil(vtbl[].closeEvent):
    vtbl[].vtbl.closeEvent = fcQStatusBar_vtable_callback_closeEvent
  if not isNil(vtbl[].contextMenuEvent):
    vtbl[].vtbl.contextMenuEvent = fcQStatusBar_vtable_callback_contextMenuEvent
  if not isNil(vtbl[].tabletEvent):
    vtbl[].vtbl.tabletEvent = fcQStatusBar_vtable_callback_tabletEvent
  if not isNil(vtbl[].actionEvent):
    vtbl[].vtbl.actionEvent = fcQStatusBar_vtable_callback_actionEvent
  if not isNil(vtbl[].dragEnterEvent):
    vtbl[].vtbl.dragEnterEvent = fcQStatusBar_vtable_callback_dragEnterEvent
  if not isNil(vtbl[].dragMoveEvent):
    vtbl[].vtbl.dragMoveEvent = fcQStatusBar_vtable_callback_dragMoveEvent
  if not isNil(vtbl[].dragLeaveEvent):
    vtbl[].vtbl.dragLeaveEvent = fcQStatusBar_vtable_callback_dragLeaveEvent
  if not isNil(vtbl[].dropEvent):
    vtbl[].vtbl.dropEvent = fcQStatusBar_vtable_callback_dropEvent
  if not isNil(vtbl[].hideEvent):
    vtbl[].vtbl.hideEvent = fcQStatusBar_vtable_callback_hideEvent
  if not isNil(vtbl[].nativeEvent):
    vtbl[].vtbl.nativeEvent = fcQStatusBar_vtable_callback_nativeEvent
  if not isNil(vtbl[].changeEvent):
    vtbl[].vtbl.changeEvent = fcQStatusBar_vtable_callback_changeEvent
  if not isNil(vtbl[].metric):
    vtbl[].vtbl.metric = fcQStatusBar_vtable_callback_metric
  if not isNil(vtbl[].initPainter):
    vtbl[].vtbl.initPainter = fcQStatusBar_vtable_callback_initPainter
  if not isNil(vtbl[].redirected):
    vtbl[].vtbl.redirected = fcQStatusBar_vtable_callback_redirected
  if not isNil(vtbl[].sharedPainter):
    vtbl[].vtbl.sharedPainter = fcQStatusBar_vtable_callback_sharedPainter
  if not isNil(vtbl[].inputMethodEvent):
    vtbl[].vtbl.inputMethodEvent = fcQStatusBar_vtable_callback_inputMethodEvent
  if not isNil(vtbl[].inputMethodQuery):
    vtbl[].vtbl.inputMethodQuery = fcQStatusBar_vtable_callback_inputMethodQuery
  if not isNil(vtbl[].focusNextPrevChild):
    vtbl[].vtbl.focusNextPrevChild = fcQStatusBar_vtable_callback_focusNextPrevChild
  if not isNil(vtbl[].eventFilter):
    vtbl[].vtbl.eventFilter = fcQStatusBar_vtable_callback_eventFilter
  if not isNil(vtbl[].timerEvent):
    vtbl[].vtbl.timerEvent = fcQStatusBar_vtable_callback_timerEvent
  if not isNil(vtbl[].childEvent):
    vtbl[].vtbl.childEvent = fcQStatusBar_vtable_callback_childEvent
  if not isNil(vtbl[].customEvent):
    vtbl[].vtbl.customEvent = fcQStatusBar_vtable_callback_customEvent
  ...
  let tmp = gen_qstatusbar_types.QStatusBar(h: fcQStatusBar_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
...
proc create*(T: type gen_qstatusbar_types.QStatusBar,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQStatusBar_vtable_callback_disconnectNotify
  let tmp = gen_qstatusbar_types.QStatusBar(h: fcQStatusBar_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
  fcQStatusBar_vdata(tmp.h)[] = addr(vtbl[])
  tmp
const cQStatusBar_mvtbl = cQStatusBarVTable(
  ...
  metacall: fcQStatusBar_method_callback_metacall,
  showEvent: fcQStatusBar_method_callback_showEvent,
  paintEvent: fcQStatusBar_method_callback_paintEvent,
  resizeEvent: fcQStatusBar_method_callback_resizeEvent,
  event: fcQStatusBar_method_callback_event,
  devType: fcQStatusBar_method_callback_devType,
  setVisible: fcQStatusBar_method_callback_setVisible,
  sizeHint: fcQStatusBar_method_callback_sizeHint,
  minimumSizeHint: fcQStatusBar_method_callback_minimumSizeHint,
  heightForWidth: fcQStatusBar_method_callback_heightForWidth,
  hasHeightForWidth: fcQStatusBar_method_callback_hasHeightForWidth,
  paintEngine: fcQStatusBar_method_callback_paintEngine,
  mousePressEvent: fcQStatusBar_method_callback_mousePressEvent,
  mouseReleaseEvent: fcQStatusBar_method_callback_mouseReleaseEvent,
  mouseDoubleClickEvent: fcQStatusBar_method_callback_mouseDoubleClickEvent,
  mouseMoveEvent: fcQStatusBar_method_callback_mouseMoveEvent,
  wheelEvent: fcQStatusBar_method_callback_wheelEvent,
  keyPressEvent: fcQStatusBar_method_callback_keyPressEvent,
  keyReleaseEvent: fcQStatusBar_method_callback_keyReleaseEvent,
  focusInEvent: fcQStatusBar_method_callback_focusInEvent,
  focusOutEvent: fcQStatusBar_method_callback_focusOutEvent,
  enterEvent: fcQStatusBar_method_callback_enterEvent,
  leaveEvent: fcQStatusBar_method_callback_leaveEvent,
  moveEvent: fcQStatusBar_method_callback_moveEvent,
  closeEvent: fcQStatusBar_method_callback_closeEvent,
  contextMenuEvent: fcQStatusBar_method_callback_contextMenuEvent,
  tabletEvent: fcQStatusBar_method_callback_tabletEvent,
  actionEvent: fcQStatusBar_method_callback_actionEvent,
  dragEnterEvent: fcQStatusBar_method_callback_dragEnterEvent,
  dragMoveEvent: fcQStatusBar_method_callback_dragMoveEvent,
  dragLeaveEvent: fcQStatusBar_method_callback_dragLeaveEvent,
  dropEvent: fcQStatusBar_method_callback_dropEvent,
  hideEvent: fcQStatusBar_method_callback_hideEvent,
  nativeEvent: fcQStatusBar_method_callback_nativeEvent,
  changeEvent: fcQStatusBar_method_callback_changeEvent,
  metric: fcQStatusBar_method_callback_metric,
  initPainter: fcQStatusBar_method_callback_initPainter,
  redirected: fcQStatusBar_method_callback_redirected,
  sharedPainter: fcQStatusBar_method_callback_sharedPainter,
  inputMethodEvent: fcQStatusBar_method_callback_inputMethodEvent,
  inputMethodQuery: fcQStatusBar_method_callback_inputMethodQuery,
  focusNextPrevChild: fcQStatusBar_method_callback_focusNextPrevChild,
  eventFilter: fcQStatusBar_method_callback_eventFilter,
  timerEvent: fcQStatusBar_method_callback_timerEvent,
  childEvent: fcQStatusBar_method_callback_childEvent,
  customEvent: fcQStatusBar_method_callback_customEvent,
  connectNotify: fcQStatusBar_method_callback_connectNotify,
  disconnectNotify: fcQStatusBar_method_callback_disconnectNotify,
)
proc create*(T: type gen_qstatusbar_types.QStatusBar,
    inst: VirtualQStatusBar) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQStatusBar_new(addr(cQStatusBar_mvtbl), csize_t(sizeof(pointer)))
  fcQStatusBar_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qstatusbar_types.QStatusBar,
    ...
    inst: VirtualQStatusBar) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQStatusBar_new2(addr(cQStatusBar_mvtbl), csize_t(sizeof(pointer)), parent.h)
  fcQStatusBar_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
