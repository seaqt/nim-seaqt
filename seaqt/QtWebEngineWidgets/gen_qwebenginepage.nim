...
{.compile("gen_qwebenginepage.cpp", QtWebEngineWidgetsCFlags).}
...
import
  ...
  ../QtWebEngineCore/gen_qwebenginefindtextresult_types,
  ../QtWebEngineCore/gen_qwebenginehttprequest_types,
  ../QtWebEngineCore/gen_qwebengineregisterprotocolhandlerrequest_types,
...
proc fcQWebEnginePage_trUtf8S(s: cstring): struct_seaqt_string {.importc: "QWebEnginePage_trUtf8_s".}
...
proc fcQWebEnginePage_setWebChannel_QWebChannel(self: pointer, webChannel: pointer): void {.importc: "QWebEnginePage_setWebChannel_QWebChannel".}
proc fcQWebEnginePage_setWebChannel_QWebChannelUint(self: pointer, param1: pointer, worldId: cuint): void {.importc: "QWebEnginePage_setWebChannel_QWebChannel_uint".}
...
proc fcQWebEnginePage_trUtf8SC(s: cstring, c: cstring): struct_seaqt_string {.importc: "QWebEnginePage_trUtf8_s_c".}
proc fcQWebEnginePage_trUtf8SCN(s: cstring, c: cstring, n: cint): struct_seaqt_string {.importc: "QWebEnginePage_trUtf8_s_c_n".}
...
type cQWebEnginePageVTable {.pure.} = object
  ...
  certificateError*: proc(self: pointer, certificateError: pointer): bool {.cdecl, raises: [], gcsafe.}
...
proc trUtf8*(_: type gen_qwebenginepage_types.QWebEnginePage, s: cstring): string =
  let v_ms = fcQWebEnginePage_trUtf8S(s)
  let vx_ret = string.fromBytes(v_ms)
  c_free(v_ms.data)
  vx_ret
...
proc view*(self: gen_qwebenginepage_types.QWebEnginePage): gen_qwidget_types.QWidget =
  gen_qwidget_types.QWidget(h: fcQWebEnginePage_view(self.h), owned: false)
...
proc setWebChannel*(self: gen_qwebenginepage_types.QWebEnginePage, webChannel: gen_qwebchannel_types.QWebChannel): void =
  fcQWebEnginePage_setWebChannel_QWebChannel(self.h, webChannel.h)
...
proc setWebChannel*(self: gen_qwebenginepage_types.QWebEnginePage, param1: gen_qwebchannel_types.QWebChannel, worldId: cuint): void =
  fcQWebEnginePage_setWebChannel_QWebChannelUint(self.h, param1.h, worldId)
...
proc contextMenuData*(self: gen_qwebenginepage_types.QWebEnginePage): gen_qwebenginecontextmenudata_types.QWebEngineContextMenuData =
  gen_qwebenginecontextmenudata_types.QWebEngineContextMenuData(h: fcQWebEnginePage_contextMenuData(self.h), owned: false)
...
proc fcQWebEnginePage_vtable_callback_certificateError(self: pointer, certificateError: pointer): bool {.cdecl.} =
  let vtbl = cast[ptr QWebEnginePageVTable](fcQWebEnginePage_vdata(self)[])
  let self = QWebEnginePage(h: self)
  let slotval1 = gen_qwebenginecertificateerror_types.QWebEngineCertificateError(h: certificateError, owned: false)
  var virtualReturn = vtbl[].certificateError(self, slotval1)
  virtualReturn
...
method certificateError*(self: VirtualQWebEnginePage, certificateError: gen_qwebenginecertificateerror_types.QWebEngineCertificateError): bool {.base.} =
  QWebEnginePagecertificateError(self[], certificateError)
...
proc fcQWebEnginePage_method_callback_certificateError(self: pointer, certificateError: pointer): bool {.cdecl.} =
  let inst = cast[VirtualQWebEnginePage](fcQWebEnginePage_vdata(self)[])
  let slotval1 = gen_qwebenginecertificateerror_types.QWebEngineCertificateError(h: certificateError, owned: false)
  var virtualReturn = inst.certificateError(slotval1)
  virtualReturn
...
proc create*(T: type gen_qwebenginepage_types.QWebEnginePage,
  ...
  if not isNil(vtbl[].certificateError):
    vtbl[].vtbl.certificateError = fcQWebEnginePage_vtable_callback_certificateError
...
const cQWebEnginePage_mvtbl = cQWebEnginePageVTable(
  ...
  certificateError: fcQWebEnginePage_method_callback_certificateError,
