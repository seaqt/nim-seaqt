...
proc fcQWebEngineView_new3(vtbl: pointer, vdata: csize_t, profile: pointer): ptr cQWebEngineView {.importc: "QWebEngineView_new_profile".}
proc fcQWebEngineView_new4(vtbl: pointer, vdata: csize_t, page: pointer): ptr cQWebEngineView {.importc: "QWebEngineView_new_page".}
...
proc create*(T: type gen_qwebengineview_types.QWebEngineView,
  ...
  let tmp = gen_qwebengineview_types.QWebEngineView(h: fcQWebEngineView_new(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), parent.h), owned: true)
...
proc create*(T: type gen_qwebengineview_types.QWebEngineView,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQWebEngineView_vtable_callback_disconnectNotify
  let tmp = gen_qwebengineview_types.QWebEngineView(h: fcQWebEngineView_new2(addr(vtbl[].vtbl), csize_t(sizeof(pointer))), owned: true)
  fcQWebEngineView_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qwebengineview_types.QWebEngineView,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQWebEngineView_vtable_callback_disconnectNotify
  let tmp = gen_qwebengineview_types.QWebEngineView(h: fcQWebEngineView_new3(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), profile.h), owned: true)
  fcQWebEngineView_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qwebengineview_types.QWebEngineView,
  ...
  if not isNil(vtbl[].disconnectNotify):
    vtbl[].vtbl.disconnectNotify = fcQWebEngineView_vtable_callback_disconnectNotify
  let tmp = gen_qwebengineview_types.QWebEngineView(h: fcQWebEngineView_new4(addr(vtbl[].vtbl), csize_t(sizeof(pointer)), page.h), owned: true)
  fcQWebEngineView_vdata(tmp.h)[] = addr(vtbl[])
  tmp
proc create*(T: type gen_qwebengineview_types.QWebEngineView,
...
proc create*(T: type gen_qwebengineview_types.QWebEngineView,
  ...
  inst[].h = fcQWebEngineView_new(addr(cQWebEngineView_mvtbl), csize_t(sizeof(pointer)), parent.h)
...
proc create*(T: type gen_qwebengineview_types.QWebEngineView,
    inst: VirtualQWebEngineView) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQWebEngineView_new2(addr(cQWebEngineView_mvtbl), csize_t(sizeof(pointer)))
  fcQWebEngineView_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qwebengineview_types.QWebEngineView,
    ...
    inst: VirtualQWebEngineView) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQWebEngineView_new3(addr(cQWebEngineView_mvtbl), csize_t(sizeof(pointer)), profile.h)
  fcQWebEngineView_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
...
proc create*(T: type gen_qwebengineview_types.QWebEngineView,
    ...
    inst: VirtualQWebEngineView) =
  if inst[].h != nil: delete(move(inst[]))
  inst[].h = fcQWebEngineView_new4(addr(cQWebEngineView_mvtbl), csize_t(sizeof(pointer)), page.h)
  fcQWebEngineView_vdata(inst[].h)[] = addr inst[]
  inst[].owned = true
