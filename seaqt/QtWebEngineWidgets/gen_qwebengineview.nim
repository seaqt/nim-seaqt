...
proc fcQWebEngineView_new3(vtbl: pointer, vdata: csize_t, profile: pointer): ptr cQWebEngineView {.importc: "QWebEngineView_new3".}
proc fcQWebEngineView_new4(vtbl: pointer, vdata: csize_t, page: pointer): ptr cQWebEngineView {.importc: "QWebEngineView_new4".}
